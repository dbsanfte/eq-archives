...
<tr>
	...
	<form method="post" action="EQStats_Config.asp" name="main">
	<table border="0" cellpadding="2" cellspacing="0" width="100%">
		<tr>
			<td width="100%" colspan="2"><font face="Verdana" size="2"><b>EverQuest Server Status</b> - Status Layout Configuration Page</font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			The server status plugin is 100% compatible with browsers such as Netscape and Internet Explorer. When placed
			on a website, it will expand to the width page or table. Our system updates the server status every minute and 
			historical data every 15 minutes. That information can be found by clicking one of the server links.
			</td>
		</tr>
		<tr>
			<td width="100%" colspan="2">&nbsp;</td>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">1. Font Size</font></td>
			<td width="68%"><input type="text" name="FontS" value="2" size="25">
<select name="FontS_DD" size="1" onChange="this.form.FontS.value=this.form.FontS_DD[form.FontS_DD.selectedIndex].value;">
<option value ="">
...
<option value="12" >12</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">2. Font Type</font></td>
			<td width="68%"><input type="text" name="FontT" value="Verdana" size="25">
<select name="FontT_DD" size="1" onChange="this.form.FontT.value=this.form.FontT_DD[form.FontT_DD.selectedIndex].value;">
<option value ="">
...
<option value="Verdana" >Verdana</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">3. Font Color</font></font></td>
			<td width="68%"><font face="Verdana" size="2">Hex Code:&nbsp;</font><input type="text" name="FontC" value="#000000" size="15">
<select name="FontC_DD" size="1" onChange="this.form.FontC.value=this.form.FontC_DD[form.FontC_DD.selectedIndex].value;">
<option value ="">
...
<option value="#00FFFF" >Aqua Blue</option>
...
<option value="#808000" >Olive</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">4. Link Color</font></td>
			<td width="68%"><font face="Verdana" size="2">Hex Code:&nbsp;</font><input type="text" name="LinkC" value="#3A66AF" size="15">
<select name="LinkC_DD" size="1" onChange="this.form.LinkC.value=this.form.LinkC_DD[form.LinkC_DD.selectedIndex].value;">
<option value ="">
<option value="#FFFFFF" >White</option>
<option value="#000000" >Black</option>
<option value="#808080" >Grey</option>
...
<option value="#808000" >Olive</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">5. Background Color</font></td>
			<td width="68%"><font face="Verdana" size="2">Hex Code:&nbsp;</font><input type="text" name="BackC" value="#FFFFFF" size="15">
<select name="BackC_DD" size="1" onChange="this.form.BackC.value=this.form.BackC_DD[form.BackC_DD.selectedIndex].value;">
<option value ="">
<option value="#FFFFFF" >White</option>
<option value="#000000" >Black</option>
<option value="#808080" >Grey</option>
...
<option value="#808000" >Olive</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">6. Border Color</font></td>
			<td width="68%"><font face="Verdana" size="2">Hex Code:&nbsp;</font><input type="text" name="BorderC" value="#000000" size="15">
<select name="BorderC_DD" size="1" onChange="this.form.BorderC.value=this.form.BorderC_DD[form.BorderC_DD.selectedIndex].value;">
<option value ="">
<option value="#FFFFFF" >White</option>
<option value="#000000" >Black</option>
<option value="#808080" >Grey</option>
...
<option value="#808000" >Olive</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">7. Menu Color</font></td>
			<td width="68%"><font face="Verdana" size="2">Hex Code:&nbsp;</font><input type="text" name="MenuC" value="#AEAD84" size="15">
<select name="MenuC_DD" size="1" onChange="this.form.MenuC.value=this.form.MenuC_DD[form.MenuC_DD.selectedIndex].value;">
<option value ="">
<option value="#FFFFFF" >White</option>
<option value="#000000" >Black</option>
<option value="#808080" >Grey</option>
...
<option value="#808000" >Olive</option>
		...
		<tr>
			<td width="32%"><font face="Verdana" size="2">8. Server Display Options</font></td>
			<td width="68%">
<select name="ServerF" size="1">
<option value ="">All Servers</option>

<option value="39" >Ayonae Ro</option>

<option value="17" >Bertoxxulous</option>

<option value="22" >Brell Serilis</option>

<option value="25" >Bristlebane</option>

<option value="12" >Cazic-Thule</option>

<option value="1" >Chat Server</option>

<option value="36" >Drinal</option>

<option value="30" >Druzzil Ro</option>

<option value="9" >E'ci</option>

<option value="19" >Erollisi Marr</option>

<option value="6" >Fennin Ro</option>

<option value="15" >Innoruuk</option>

<option value="14" >Karana</option>

<option value="28" >Lanys T'Vyl</option>

<option value="29" >Luclin</option>

<option value="13" >Mithaniel Marr</option>

<option value="32" >Morell-Thule</option>

<option value="8" >Povar</option>

<option value="20" >Prexus</option>

<option value="21" >Quellious</option>

<option value="3" >Rallos Zek (PvP)</option>

<option value="18" >Rodcet Nife</option>

<option value="33" >Saryrn</option>

<option value="11" >Solusek Ro</option>

<option value="42" >Sullon Zek</option>

<option value="23" >Tallon Zek (PvP)</option>

<option value="7" >Tarew Marr</option>

<option value="35" >Terris-Thule</option>

<option value="2" >Test Server</option>

<option value="27" >The Nameless</option>

<option value="5" >The Rathe</option>

<option value="34" >The Seventh Hammer</option>

<option value="26" >The Tribunal</option>

<option value="37" >Tholuxe Paells</option>

<option value="31" >Torvonnilous</option>

<option value="16" >Tunare</option>

<option value="24" >Vallon Zek (PvP)</option>

<option value="40" >Vazaelle</option>

<option value="10" >Veeshan</option>

<option value="4" >Xegony</option>
...
<option value="41" >Zebuxoruk</option>
		...
		<tr>
			<td width="32%">&nbsp;</td>
			<td width="68%"><input type="submit" name="Submit" value="Save Selection"></td>
		</tr>
		<tr>
			<td width="100%" colspan="2">&nbsp;</td>
		</tr>
		<tr>
			<td width="100%" colspan="2"><font face="Verdana" size="2">Copy the code below and insert it anywhere on your website:</font></td>
		</tr>
		<tr>
			<td width="100%" colspan="2"><textarea rows="5" cols="62">&lt;!-- START EverQuest Status Code --&gt;
&lt;script src=http://www.everlore.com/EQStats.asp?FontC=%23000000&FontS=2&FontT=Verdana&LinkC=%233A66AF&BackC=%23FFFFFF&BorderC=%23000000&MenuC=%23AEAD84&ServerF=all&gt;&lt;/script&gt;
&lt;!-- END EverQuest Status Code --&gt;</textarea></td>
		</tr>
		<tr>
			<td width="100%" colspan="2">&nbsp;</td>
		</tr>
		<tr>
			<td width="100%" colspan="2"><font face="Verdana" size="2">Below is a preview of the server status component:</font></td>
		</tr>
		<tr>
			<td width="100%" colspan="2">
				<table border="0" cellpadding="2" cellspacing="0" width="650">
					<tr>
						<td colspan="2"><script src='http://www.everlore.com/EQStats.asp?FontC=%23000000&FontS=2&FontT=Verdana&LinkC=%233A66AF&BackC=%23FFFFFF&BorderC=%23000000&MenuC=%23AEAD84&ServerF=all'></script></td>
					</tr>
				</table>
			</td>
		</tr>
