...
.graybox{white-space:nowrap;margin-bottom:20px;padding:15px;font-size:11px;height:147px;width:452px;background-image:linear-gradient(bottom,#ffffff,#D3D3D3);background-image:-o-linear-gradient(bottom,#ffffff,#D3D3D3);background-image:-moz-linear-gradient(bottom,#ffffff,#D3D3D3);background-image:-webkit-linear-gradient(bottom,#ffffff,#D3D3D3);background-image:-ms-linear-gradient(bottom,#ffffff,#D3D3D3);background-image:-webkit-gradient(linear,left bottom,left top,color-stop(#ffffff),color-stop(#D3D3D3));filter:progid:DXImageTransform.Microsoft.gradient(enabled='true',startColorstr='#D3D3D3', endColorstr='#ffffff', GradientType=0);border:1px solid #BBBBBB;border-radius:5px;}
...
.PodTextHeadingSearch{margin-top:0px;height:24px;width:442px;font-size:30px;color:#000;line-height:36px;text-align:center;font-family:Crete Round,Arial,Helvetica;}
...
var relatedSearches='';
var kotValue='';
var loc1=handler2+'?7c9932424c5dd37d5cf0ad7944b59568=325467165&6fa970d50480e816942b6fab7c4e7a23=506683626&5f17a83ba43604eb3d1c06f73d82e119=634955950830568663';
var loc2=handler2+'?0f41fdd8c9af62a4027fda82d597062a=1623525913&7c9932424c5dd37d5cf0ad7944b59568=2344573&f67ff3454420ebb255fe4f673cf8cf0b=AwZ0BGH1BGHjBQZjAGL4AwHj-1';
...
var onclickScript = '';
onclickScript = 'onclick="processClick(\'' + 'Wzp9ZwRjZvMxCFMwCGNznG0zMG0zow0zL3MkCF02ZGHlZGDmBQH1ZQHjZmD1ZmplWzIaCGVjZGZjZwN0ZGpkBQNmWzA5CGRzrQ0zqTp9ZvMzM3N9ZPMhrw0jWzMjCGVmBPMbozp9ZFMjpQ1VEvM0Mw02-1\');"';
...
<div id="searchbox"><form name="search" action="/default.aspx" method="post" >
...
<div class="grnbox" style="height:113px"><div style="background-position: 0px 0px;" class="thumbsTop"></div><div class="PodTextHeading">Free Domain Name with Website<br />Builder Purchase!*</div><div class="PodText">Your business deserves a beautiful website.<br />Our design wizard makes it as easy as drag<br />and drop!</div><div style="margin-left:370px;margin-top:-67px;margin-bottom:48px;"><a class="OrgBtn" target="_top" href="http://www.godaddy.com/hosting/website-builder.aspx?isc=GPPT02KWB2&ci=75900&domain=everlore.com">Shop Now</a></div></div>
<div style="border-color:#ffffff;margin-bottom:15px;"><img src="http://ak2.imgaft.com/images/out_5.jpg" style="border-color:#ffffff;" usemap="#outMap"/><div class="clear"></div><div style="position:absolute;margin-left:267px;margin-top:-35px;margin-bottom:44px;"><a class="GrnBtn" target="_top" href="http://www.godaddy.com/accounting/accounting-software.aspx?isc=GPPT02K202&ci=78220&domain=everlore.com">Learn More</a></div><map id="Map2"name="outMap"><area shape="rect" coords="0,0,480,116" alt="outright" target="_top" href="http://www.godaddy.com/accounting/accounting-software.aspx?isc=GPPT02K202&ci=78220&domain=everlore.com"/></map></div>
</div>
...
<script type="text/javascript">	function openICANNPopup() { var win = window.open('https://www.godaddy.com/domains/popups/icannfee.aspx?isc=GPPT02K202&ci=71675&domain=everlore.com&app%5Fhdr=99', 'icann', 'left=50,top=50,resizable=yes,scrollbars=yes,width=400,height=250'); }</script>
   ...
   <script type="text/javascript" src="http://ak2.imgaft.com/script/jquery-1.3.1.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
    	...
    	if (impspacer) { impspacer.src = '/img.aspx?q=L3MkWGAkYGLkAGVkAQZ4AGHjAGNmAQHmAmVyZwMaWGAkZwRjZvHlAzHyZ3RyZwMhWGAkZPHlAzZyZ3RjWGV2MJLyZ3RjWGV2MvHmpFHlAzIaWGAkZwNkZmNlZQDkAmR4ZQZyZwMwrFHmpGRyZwM0MlHmpGVyZwM4WGAkWGV2MzqjWGAkZPHlAz56WGAkZPHlAzMjWGAkZwZ4WGV2nT5aWGAkZFHlAaEzWGAkAvHlAaOjWGAkFRLyZwMwnPHmpGR=-1'; }
    </script>
