...
<head>
    ...
    <style type="text/css">
            ...
            .srchsprite {width:102px;background-repeat:repeat-y;background-image:url('http://images-pw.secureserver.net/images/pw_mp_search_middle.png');_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://images-pw.secureserver.net/images/pw_mp_search_middle.png', sizingMethod='scale');_background-image:none;}
            .tldbottomimage{background-image:url('http://images-pw.secureserver.net/images/pw_mp_search_bottom.png');width:102px;height:21px;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://images-pw.secureserver.net/images/pw_mp_search_bottom.png', sizingMethod='scale');_background-image:none;}
            .srcharrow2{position:relative;float:right;height:26px;font-size:1px;width:21px;cursor:pointer;background-color:#fff;background-image:url('http://images-pw.secureserver.net/images/pw_mp_search_dwnarrow.png');background-repeat:no-repeat; -webkit-appearance:none;top:-1px;}
            .srcharrow1{position:relative;float:right;height:26px;font-size:1px;width:21px;cursor:pointer;background-color:#fff;background-image:url('http://images-pw.secureserver.net/images/pw_mp_search_uparrow.png');background-repeat:no-repeat; -webkit-appearance:none;}
            .availtlds{}
			...
			#logo1 {position: absolute; left: 20px; top: 20px; }
...
var google_afd_request = {
  client: 'ca-dp-godaddy2_xml',  channel: 'numads_control',
  domain_name: 'www.everlore.com',
  hl: 'en',
  num_radlinks: '0',
  s: 'everlore.com'
}
...
var handler = '/ct.html?';
var handler2 = 'http://everlore.com';
var ads = '';
var popularCategories = '';
var relatedSearches = '';
var kotValue = '';

var loc1 = handler2 + '?7c9932424c5dd37d5cf0ad7944b59568=325467165&6fa970d50480e816942b6fab7c4e7a23=506683626&5f17a83ba43604eb3d1c06f73d82e119=634377149671813914';
var loc2 = handler2 + '?0f41fdd8c9af62a4027fda82d597062a=1623525913&7c9932424c5dd37d5cf0ad7944b59568=2344573&f67ff3454420ebb255fe4f673cf8cf0b=AwZ0Zmp3ZGD5AwpkBQRmBGNk-1';
...
function google_afd_ad_request_done(google_afd_response) {
   ...
   if (google_ads.length > 0) {
      ...
      ads += '<div style="width: 435px;"><div style="font-size: 14px; font-weight: bold; color: #000; padding-left: 10px; padding-top:5px; padding-bottom: 5px;">';
      ...
      for (var i = 0; i < google_ads.length; i++) {
         var onclickScript = '';
            ...
            onclickScript = 'onclick="processClick(\'' + handler + 'u=' + encodeURIComponent(google_ads[i].url) +'&e=Wzp9ZwRjZvMxCFMwCGNznG0zMG0zow0zL3MkCF02AwplZmDjZGxkAmt3AmN4ZwN5WzIaCGVjZGRjAQN2ZGxlBGV3WzA5CGRzrQ0zqTp9ZvMzM3N9ZPMhrw0jWzMjCGVmBPMbozp9ZFMjpQ1VEvM0Mw02WaOmCGL2AmVmAQNkBGR3BQp3ZQtlZQx=-1\'); return false;"';
...
<script type="text/javascript" language="JavaScript" >
        ...
        if (domainNamesTextBox.length && ddlTLDList.length) {
            ...
            if (selectedTLD) {
                ...
                if (url.indexOf("?") > 0)
                    ...
                    url = url + "?";
                var isccode = "GPPT02C009";  if (selectedTLD == '.co') isccode = "GPPT02C042";  
                location.href = url + 'isc=' + isccode + '&checkAvail=1&domain=everlore.com&domainToCheck=' + escape(domainToCheck) + '&tld=' + escape(selectedTLD);
            }
        }
    }
	...
	document.getElementById ? evt.keyCode : 0;
        ...
        if (keyCode == 40) {
            if (highltd.length == 0) {
                $("div.tldshown").eq(0).addClass("highlighted");
            }
            else {
            ...
            if ($(".highlighted").html() == null) {
                ...
                $("#selectedtld").val($(".highlighted").html());
            }
        }
        else if (keyCode == 38) {
            var highltd = $(".highlighted");
            if (highltd.length == 0) {
                $(".availtlds").eq(0).addClass("highlighted");
            }
            else {
    ...
    function setFont() {
        if (navigator.platform != "Win32") {
            ...
            if ((slctdtld == ".com.mx") || (slctdtld == ".com.tw") ||
		(slctdtld == ".com.bz") || (slctdtld == ".nom.es") ||
		(slctdtld == ".nom.co")) {
                $("#selectedtld").css("fontSize", "14px");
            }
            else {
                $("#selectedtld").css("fontSize", "16px");
            }
        }
    }
    ...
    $(document).ready(function() {
        if (($.browser.msie) && ($.browser.version < 8)) {
            $("#domainNameInput").css("height", "20px");
        }
        if (($.browser.msie) && ($.browser.version < 7)) {
            $("#selectedtld").css("height", "20px");
        }
        initialTLD = true;
        ...
        $(document).bind("click.availtlds", function(event) {
            ...
            if ((event.target.id != "selectedtld") && (event.target.id != "srcharrowdiv")) {
                setFont();
                hidetldlist();
            }
        });
...
<a href="/st.aspx"><img src="http://images-pw.secureserver.net/images/061703/spc_trans.gif" style="border:none" height="1" width="1" alt="" /></a>
        ...
        <div style="float:left; width: 1024px;">
			...
			<div id="logo1"><a href="http://www.godaddy.com?isc=gppt02C001&domain=everlore.com"><img src="http://images-pw.secureserver.net/images/log_gd_3.gif" usemap="#lmap" border="0" alt="This web page is parked FREE, courtesy of GoDaddy.com" ></a></div>
				<map id="lMap" name="lMap">
					<area shape="poly" coords="0,0,150,0,150,80,80,80,80,60,0,60,0,0" alt="GoDaddy.com" href="http://www.godaddy.com?isc=gppt02C001&domain=everlore.com"/>
					<area shape="rect" coords="14,60,80,85" alt="GoDaddy.com" href="http://www.godaddy.com?logolinks=true&isc=gppt02C001&domain=everlore.com"/>
				</map>
				<div></div>
			<div id="Search" style="margin-top: 30px; background-image: url('http://images-pw.secureserver.net/images/img_searchbox.gif'); background-repeat: no-repeat; color: #000; font-weight: bold; margin-left: 195px; height:77px; font-size: 14px; ">
			...
			<div id="domainname1">
			    ...
			    <input type="image" style="float: left; margin-left: 15px; margin-top: 20px;" value="" src="http://images-pw.secureserver.net/images/btnPWSearch.png">
				
				<script type="text/javascript">				    document.write(kotValue);</script> 
				</form></div>
			</div>
            <div id="yourdomainbanner" >
			    <a style="text-decoration: none; font-size: 16px; color: #eb1d28; font-weight: bold;" href="http://www.godaddy.com/domains/activate.aspx?isc=gppt02C030&domain=everlore.com"><div>Is this your domain?<div style="font-size:14px; font-weight: normal;">Add hosting, email and more.</div><div id="yourdomainbannerGObtn"><img src="http://images-pw.secureserver.net/images/btn_red_go.png" border="0" /></div></div></a>
			</div>
			...
			<div style="padding-left: 20px;padding-right: 10px">
			    <div style="margin-left: 0px; margin-top: 25px; float: left;"> <!-- left container -->
		            ...
		            <div style="margin: 5px;">
		                <img src="http://images-pw.secureserver.net/images/ban_NASCAR_Game.gif" style="border-color:#ffffff; " usemap="#ngMap"/>
	                    <map id="ngMap" name="ngMap">
		                    <area shape="rect" coords="0,0,434,54" alt="GoDaddy.com" target="_blank" href="http://nascarthegame.com"/>
	                    </map>
		            </div>
					    ...
					    <img src="http://images-pw.secureserver.net/images/gd/49574_gdd_trialpay.gif" style="border-color:#ffffff; " usemap="#tpMap"/>
				            <map id="tpMap" name="tpMap">
					            <area shape="rect" coords="0,0,434,54" alt="GoDaddy.com" href="/ct.html?u=http%3a%2f%2fwww.trialpay.com%2fstores%2fgodaddy%2ftwodomains%3ftid%3d6rG-kb1&e=Mm0lZGNlWzD9WzH9WzA2pG0gAwL3ZwZ0ZQR5ZGp4AmpjBQVjBFMyMm0lZQRkZQDjAwR5ZwxlAlMwrG0kWat9WaOapQ01WzuhMm0kWz56CGNzMaN9ZwZ4WaOjCHuT-1"/>
				            </map>
                            </div>
					    
					        <div style="margin: 5px;">
					            <img src="http://images-pw.secureserver.net/images/Verisign-for-PCC_com.jpg" style="border-color:#ffffff; " usemap="#vsMap2"/>
				                <map id="vsMap2" name="vsMap2">
					                <area shape="rect" coords="0,0,434,54" alt="GoDaddy.com" href="http://www.DotCOMforSmallBiz.com?cid=260001"/>
				                </map>
					        </div>
			    ...
			    <!-- RIGHT SIDEBAR BLOCK -->
                    ...
                    <div style="padding-bottom:5px; text-align:center; font-size: 14px; font-family: Arial, Helvetica, sans-serif;"><b>Want to buy this domain?</b> Our <a href="https://www.godaddy.com/gdshop/broker/landing.asp?isc=gppt02C029&domaintocheck=everlore.com" >Domain Buy Service</a> can help you get it.</div>
				    <div class="clear"></div>
				    <div style="white-space:nowrap; position:absolute; margin-top: 94px; margin-left: 106px; font-size: 11px">
				    <div>&#149; Register <a href="http://www.godaddy.com/domains/search.aspx?isc=gppt02C006&domain=everlore.com" >domain names</a> &ndash; up to 70% less with the world's #1 registrar!</div>
				    <div>&#149; <a href="https://auctions.godaddy.com?isc=gppt02C007&domain=everlore.com" >Go Daddy Auctions&reg;</a> – bid on, buy and sell domains.</div>
				    </div>
				    <div style="white-space:nowrap; position:absolute; margin-top: 314px; margin-left: 111px; font-size: 11px">
				    <div>&#149; Build it yourself with one of our easy <a href="http://www.godaddy.com/hosting/website-builder.aspx?isc=gppt02C011&domain=everlore.com" >sitebuilders!</a></div>
				    <div>&#149; Reliable <a href="http://www.godaddy.com/Hosting/Legacy.aspx?isc=gppt02C012&domain=everlore.com" >website hosting</a> keeps your site up and running.</div>
				    <div>&#149; Let our <a href="http://www.godaddy.com/gdshop/hosting/dream_website.asp?isc=gppt02C013&domain=everlore.com" >web pros</a> build your website, logo, banners and more.</div>
				    </div>
				    
				    <div style="white-space:nowrap; position:absolute; text-align:center; margin-top: 379px; margin-left: 368px; "><a style="font-size: 18px; font-weight: bold; color: #fff; font-family: Arial,Helvetica; text-decoration:none;" href="http://www.godaddy.com/Hosting/web-hosting-4gh.aspx?isc=gppt02C144&domain=everlore.com" >Starting at</a></div>
                    <div style="white-space:nowrap; position:absolute; text-align:center; margin-top: 400px; margin-left: 374px; "><a style="font-size: 22px; font-weight: bold; color: #fff; font-family: Arial,Helvetica; text-decoration:none;" href="http://www.godaddy.com/Hosting/web-hosting-4gh.aspx?isc=gppt02C144&domain=everlore.com" >$4.99<span style="font-size: 16px; color: #fff; font-family: Arial,Helvetica; text-decoration:none;">/mo</span></a></div>
				    
				    <div style="white-space:nowrap; position:absolute; margin-top: 186px; margin-left: 45px; font-weight: bold; font-size: 15px; color: #000000; font-family: Arial,Helvetica; ">
				    <div>Register a new .COM for $11.99* per year!</div>
...
<div style="position: relative; float: left; left: 8px; top: 6px; width: 420px; height: 26px; padding-left: 10px;" id="RoundSearch">
    <table cellspacing="0" cellpadding="0" border="0" style="width: 411px;">
        <tbody>
            <tr>
				...
				<td>
				    ...
				    <div style=" position:absolute; margin-top: 463px; margin-left: 207px; font-size: 11px">
				        <a href="http://www.bobparsons.me?isc=gppt02C026&domain=everlore.com" style="text-decoration:none; color:#000;"><div style="font-size:11px; color:#000; overflow:hidden; text-decoration:none; padding-top:13px; height:43px; cursor:pointer;">Alligators nipping at your ass?<br/>How to hang in there &amp; enjoy the ride.<br/>PLUS a smoking hot crazy blond.</div></a>
				    </div>
				    <div style="white-space:nowrap; position:absolute; margin-top: 575px; margin-left: 110px; font-size: 11px">
				    <div>&#149; <a href="http://www.godaddy.com/ssl/ssl-certificates.aspx?isc=gppt02C016&domain=everlore.com" >SSL Certificates</a> protect your customers from online threats.</div>
				    <div>&#149; <a href="http://www.godaddy.com/email/email-hosting.aspx?isc=gppt02C017&domain=everlore.com" >Fast, spam-free email</a> with a memorable email address.</div>
				    <div>&#149; <a href="http://www.godaddy.com/Business/business-hosting.aspx?isc=gppt02C018&domain=everlore.com" >Marketing tools</a> help you promote your business online.</div>
				    <div>&#149; Sell online with 2009’s <a href="http://www.godaddy.com/gdshop/ecommerce/shopping-cart.asp?isc=gppt02C019&domain=everlore.com" >“Most Popular Shopping Cart”.</a>+</div>
				    </div>
				    <div style="white-space:nowrap; position:absolute; margin-top: 690px; margin-left: 37px; font-size: 11px" font-family: Arial,Helvetica; >
				    <div>&#149; Create a unique email address based on your domain</div>
				    <div>&#149; Open on iPhone&reg, Blackberry&reg, Droid&reg and more</div>
				    <div>&#149; Free Calendar &amp Online File Folder&reg</div>
 				    </div>
				    <div style="white-space:nowrap; position:absolute; text-align:center; margin-top: 660px; margin-left: 360px; "><a style="font-size: 22px; font-weight: bold; color: #ff0000; font-family: Arial,Helvetica; text-decoration:none;" href="http://www.godaddy.com/email/email-hosting.aspx?isc=gppt02C035&domain=everlore.com" >Starting at</a></div>
                    <div style="white-space:nowrap; position:absolute; text-align:center; margin-top: 685px; margin-left: 366px; "><a style="font-size: 22px; font-weight: bold; color: #ff0000; font-family: Arial,Helvetica; text-decoration:none;" href="http://www.godaddy.com/email/email-hosting.aspx?isc=gppt02C035&domain=everlore.com" >$1.19<span style="font-size: 22px; color: #eb1d28; font-family: Arial,Helvetica; text-decoration:none;">/mo</span></a></div>
				    
				    
				     <div><img class="rightclear" src="http://images-pw.secureserver.net/images/sidbar_co.gif" usemap="#dsMap" /></div>
				    
				    <map id="Map1" name="dsMap">
					    <area shape="rect" coords="15,5,158,67" alt="GoDaddy.com" href="http://www.godaddy.com?isc=gppt02C004&domain=everlore.com"/>
					    <area shape="rect" coords="420,35,500,52" alt="GoDaddy.com" href="http://www.godaddy.com?isc=gppt02C003&domain=everlore.com"/>
					    <area shape="poly" coords="23,70,190,70,190,94,95,94,95,130,23,130,23,70" alt="Domains" href="http://www.godaddy.com/domains/search.aspx?isc=gppt02C005&domain=everlore.com"/>
					     
					    <area shape="rect" coords="24,130,495,174" alt="Get the domain you really want with a .CO!" href="http://www.godaddy.com/tlds/co-domain.aspx?isc=gppt02C042&domain=everlore.com"/>
					    
					    <area shape="rect" coords="439,213,476,236" alt="Go" onclick="validateTLD();redirectToDomainSearch();" />
					    <area shape="poly" coords="23,288,195,288,195,309,105,309,105,348,23,348,23,288" alt="Websites" href="http://www.godaddy.com/hosting/website-builder.aspx?isc=gppt02C010&domain=everlore.com"/>
					    <area shape="rect" coords="24,365,495,444" alt="Affordable web hosting" href="http://www.godaddy.com/Hosting/web-hosting-4gh.aspx?isc=gppt02C144&domain=everlore.com"/>
					    <area shape="rect" coords="19,460,498,527" alt="www.bobparsons.me" href="http://www.bobparsons.me?isc=gppt02C026&domain=everlore.com"/>
					    <area shape="poly" coords="23,548,320,548,320,574,105,574,105,608,23,608,23,548" alt="Everything in between" href="http://www.godaddy.com/Business/business-hosting.aspx?isc=gppt02C015&domain=everlore.com"/>
					    <area shape="rect" coords="24,639,495,741" alt="Fast, Personalized Email" href="http://www.godaddy.com/email/email-hosting.aspx?isc=gppt02C035&domain=everlore.com"/>
				    </map>
			        </div>
        ...
        <div style="margin-top: 10px; float: left; margin-left: 20px; margin-right: 10px; width: 964px; text-align: center; font-size: 12px; background-color: rgb(243, 243, 243); padding-bottom: 5px; padding-top: 10px;">
			...
			<a href="http://www.godaddy.com?isc=gppt02C022&domain=everlore.com"><img src="http://images-pw.secureserver.net/images/img_footertext2.png" border="0"/></a><br/><br/>
			<span style="color: #000; font-weight: bold;">Visit GoDaddy.com for the best values on:</span><br/>
			<a class="footerlink2" href="http://www.godaddy.com/domains/search.aspx?isc=gppt02C023&domain=everlore.com">Domain names</a><img src="http://images-pw.secureserver.net/images/bul_blacksquare.png" class="blackbullet"/><a class="footerlink2" href="http://www.godaddy.com/Hosting/Legacy.aspx?isc=gppt02C023&domain=everlore.com">Web hosting</a><img src="http://images-pw.secureserver.net/images/bul_blacksquare.png" class="blackbullet"/><a class="footerlink2" href="http://www.godaddy.com/hosting/website-builder.aspx?isc=gppt02C023&domain=everlore.com">Website builders</a><img src="http://images-pw.secureserver.net/images/bul_blacksquare.png" class="blackbullet"/><a class="footerlink2" href="http://www.godaddy.com/email/email-hosting.aspx?isc=gppt02C023&domain=everlore.com">Email accounts</a><img src="http://images-pw.secureserver.net/images/bul_blacksquare.png" class="blackbullet"/><a class="footerlink2" href="http://www.godaddy.com/ssl/ssl-certificates.aspx?isc=gppt02C023&domain=everlore.com">SSL Certificates</a><img src="http://images-pw.secureserver.net/images/bul_blacksquare.png" class="blackbullet"/><a class="footerlink2" href="http://www.godaddy.com/gdshop/ecommerce/shopping-cart.asp?isc=gppt02C023&domain=everlore.com">eCommerce tools</a><img src="http://images-pw.secureserver.net/images/bul_blacksquare.png" class="blackbullet"/><a class="footerlink2" href="http://www.godaddy.com/gdshop/catalog.asp?isc=gppt02C023&domain=everlore.com">See product catalog</a>
		</div>
		<div class="clear"></div>
		<div style="float: left; margin-left: 20px; margin-right: 10px; width: 964px; text-align: center; font-size: 12px; background-color: rgb(243, 243, 243); padding-bottom: 10px;">
			<br/>
			<a href="http://videos.godaddy.com/super-bowl-commercials.aspx?isc=gppt02C024&domain=everlore.com" class="footerlink1">Go Daddy Super Bowl&reg; Commercial</a><img src="http://images-pw.secureserver.net/images/bul_bluesquare.png" class="blackbullet"/><a href="http://videos.godaddy.com/danica-media.aspx?isc=gppt02C024&domain=everlore.com" class="footerlink1">Danica Patrick</a><img src="http://images-pw.secureserver.net/images/bul_bluesquare.png" class="blackbullet"/><a href="http://videos.godaddy.com/dale_video.aspx?isc=gppt02C024&domain=everlore.com" class="footerlink1">Dale Jr</a><img src="http://images-pw.secureserver.net/images/bul_bluesquare.png" class="blackbullet"/><a href="http://videos.godaddy.com/girls.aspx?isc=gppt02C024&domain=everlore.com" class="footerlink1">Go Daddy Girls&reg;</a>
		</div>
		<div class="clear"></div>
		<div style="float: left; margin-left: 20px; margin-right: 10px; width: 964px; text-align: center; font-size: 10px; padding-top: 10px; padding-bottom: 20px;">
			* Plus <a href="javascript:void(openICANNPopup())" >ICANN fee</a> of 18 cents per domain name year.<br/>
			+Practical eCommerce survey, 2009.<br/>
			...
			<span style=" font-size: 8px; top:-3px; position: relative;">1</span>&nbsp;GoDaddy.com is rated the world's largest hostname provider according to Netcraft&reg;.<br/>
			&dagger;&dagger; New .COs $10.99, first year only.  Discount based on new one-year registration prices as of 3/31/2011 with sale price reflected in your shopping cart at checkout. Discount applies to new registrations first year only. Domains purchased through this offer will renew at regular price after the initial term has expired. Offer ends April 30, 2011.<br />
            ...
            <script type="text/javascript">
                function openICANNPopup() {
                    var win = window.open('https://www.godaddy.com/domains/popups/icannfee.aspx?isc=gppt02C025&domain=everlore.com&app%5Fhdr=99', 'icann', 'left=50,top=50,resizable=yes,scrollbars=yes,width=400,height=250');
                }
            </script>
		</div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        if(impspacer) {impspacer.src = '/images/spacer.gif?q=L3MkWGAkYGL2AmVmAQNkBGR3BQp3ZQtlZQxyZwMaWGAkZwRjZvHlAzHyZ3RyZwMhWGAkZPHlAzZyZ3RjWGV2MJLyZ3RjWGV2MvHmpFHlAzIaWGAkZwNkZGN0ZQLkBGV5ZwpyZwMwrFHmpGRyZwM0MlHmpGVyZwM4WGAkWGV2MzqjWGAkZPHlAz56WGAkZPHlAzMjWGAkZwZ4WGV2nT5aWGAkZFHlAaEzWGAkAvHlAaOjWGAkFRLyZwMwnPHmpGR=-1';}
    </script>
