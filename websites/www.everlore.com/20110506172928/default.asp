...
var google_afd_request = {
  client: 'ca-dp-godaddy2_xml',  channel: 'numads_testB',
...
var loc1 = handler2 + '?7c9932424c5dd37d5cf0ad7944b59568=325467165&6fa970d50480e816942b6fab7c4e7a23=506683626&5f17a83ba43604eb3d1c06f73d82e119=634402745676064317';
var loc2 = handler2 + '?0f41fdd8c9af62a4027fda82d597062a=1623525913&7c9932424c5dd37d5cf0ad7944b59568=2344573&f67ff3454420ebb255fe4f673cf8cf0b=AwZ0AQNlAmD1Awp2ZQL0ZmN0-1';
   ...
   if (google_ads.length > 0) {
      ...
      for (var i = 0; i < google_ads.length; i++) {
         var onclickScript = '';
            ...
            onclickScript = 'onclick="processClick(\'' + handler + 'u=' + encodeURIComponent(google_ads[i].url) +'&e=Wzp9ZwRjZvMxCFMwCGNznG0zMG0zow0zL3MkCGtlAQp1AwR1BGN0AwNlBQRmZQDzMJp9ZwNkZGN1ZQLkZQV5ZwpzL3x9ZFM4CFM0Mm0lWzMapQ0jWz56CGNzMaN9ZwZ4WzuhMm0kWaOjCHuTWaEzCGLzpUZ9BQV0AmH2ZGH5ZQD2ZQV4ZGZjAN==-1\'); return false;"';
            ...
            var selectedTLD = $('#selectedtld').val();
                ...
                if (selectedTLD) {
                    ...
                    if (url.indexOf("?") > 0)
                        ...
                        url = url + "?";
                    var isccode = "PARKED749"; if (selectedTLD == '.co') isccode = "GPPT02C042";  
		            ...
		            <div style="margin: 5px;">
					    ...
					    <img src="http://images-pw.secureserver.net/images/gd/49574_gdd_trialpay.gif" style="border-color:#ffffff; " usemap="#tpMap"/>
				            <map id="tpMap" name="tpMap">
					            <area shape="rect" coords="0,0,434,54" alt="GoDaddy.com" href="/ct.html?u=http%3a%2f%2fwww.trialpay.com%2fstores%2fgodaddy%2ftwodomains%3ftid%3d6rG-kb1&e=Mm0lZGNlWzD9WzH9WzA2pG04ZwD3AGLkAGxjAQLjZwtkZmN0WzIaCGVjZGRjAGN2ZGNlBGV3WzA5CGRzrQ0zpTqjCGHznT5aCGRzoab9ZPMzpQ0lZmtzpUN9FRL=-1"/>
				            </map>
                            </div>
...
<div style="position: relative; float: left; left: 8px; top: 6px; width: 420px; height: 26px; padding-left: 10px;" id="RoundSearch">
    <table cellspacing="0" cellpadding="0" border="0" style="width: 411px;">
		...
		<div style="float: left; margin-left: 20px; margin-right: 10px; width: 964px; text-align: center; font-size: 10px; padding-top: 10px; padding-bottom: 20px;">
			*&nbsp;New .COMs $7.49/yr plus 18 cents/yr <a href="javascript:void(openICANNPopup())" >ICANN</a> fee.  Discount based on new one-year registration prices as of 4/8/2011 with sale price reflected in your shopping cart at checkout. Discount applies to new registrations and renewals and cannot be used in conjunction with any other offer or promotion. Domains purchased through this offer will renew at regular price after the initial term has expired.<br/>Offer ends May 31, 2011 5:00 pm (MST).<br/>
			...
			<span style=" font-size: 8px; top:-3px; position: relative;">1</span>&nbsp;GoDaddy.com is rated the world's largest hostname provider according to Netcraft&reg;.<br/>&dagger;&dagger; New .COs $10.99, first year only.  Discount based on new one-year registration prices as of 3/31/2011 with sale price reflected in your shopping cart at checkout. Discount applies to new registrations first year only. Domains purchased through this offer will renew at regular price after the initial term has expired. Offer ends May 31, 2011.<br />
    ...
    <script type="text/javascript" language="javascript">
        ...
        if(impspacer) {impspacer.src = '/images/spacer.gif?q=L3MkWGAkBQV0AmH2ZGH5ZQD2ZQV4ZGZjAPHlAzpyZ3RlZGNlWGV2MFHmpFHlAz4yZ3RjWGV2LlHmpGNyZwMyMvHmpGNyZwMzWGAkWGV2MJpyZ3RlZQRkZQHjAwRjZwxlAlHlAzA5WGAkZFHlAaEaWGAkZvHlAatyZ3RyZwMzM3NyZ3RjWGV2oabyZ3RjWGV2MaNyZ3RlZmtyZwMbozpyZ3RkWGV2qTLyZ3R2WGV2pUNyZ3SVEvHlAzAbWGAkZD==-1';}
    </script>
