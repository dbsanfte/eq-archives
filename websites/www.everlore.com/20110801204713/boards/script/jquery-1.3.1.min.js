...
<head>
    ...
    <style type="text/css">
            ...
            .PodText{position:relative;top:0px;height:50px;width:230px;font-size:12px;color:#434343;line-height:13px; text-align:left;}
...
var google_afd_request = {
  client: 'ca-dp-godaddy2_xml',  domain_name: 'www.everlore.com',
  hl: 'en',
  num_radlinks: '10',
  s: 'everlore.com'
}
...
var loc1 = handler2 + '?7c9932424c5dd37d5cf0ad7944b59568=325467165&6fa970d50480e816942b6fab7c4e7a23=506683626&5f17a83ba43604eb3d1c06f73d82e119=634478032342249386';
var loc2 = handler2 + '?0f41fdd8c9af62a4027fda82d597062a=1623525913&7c9932424c5dd37d5cf0ad7944b59568=2344573&f67ff3454420ebb255fe4f673cf8cf0b=AwZ0AQp4ZQZlZmDlZwD5Zmpm-1';
   ...
   if (google_ads.length > 0) {
      ...
      for (var i = 0; i < google_ads.length; i++) {
         var onclickScript = '';
            ...
            onclickScript = 'onclick="processClick(\'' + handler + 'u=' + encodeURIComponent(google_ads[i].url) +'&e=Wzp9ZwRjZPMxCFMwCGNznG0zMG0zow0zL3MkCGD5BGDmAmVmZGL1ZmtkAGNkZmHzMJp9ZwNkZGN4ZQRkZmD3ZGDzL3x9ZFM4CFM0Mm0lWzMapQ0jWz56CGNzMaN9ZwZ4WzuhMm0kWaOjCHuTWaEzCGLzpUZ9AQx5AQZ3ZwZkAwHmBQR1ZQRmAD==-1\'); return false;"';
...
<a href="/st.aspx">&nbsp;</a>
        ...
        <div style="float:left; width: 1024px;">
			...
			<div id="logo1"><a href="http://www.godaddy.com?isc=GPPT02C001&domain=everlore.com"><img src="http://images-pw.secureserver.net/images/logo_gd.png" usemap="#lmap" border="0" alt="This web page is parked FREE, courtesy of GoDaddy.com" ></a></div>
			...
			<div style="padding-left: 20px;padding-right: 10px">
		            ...
		            <div style="margin: 5px;">
					    ...
					    <img src="http://images-pw.secureserver.net/images/gd/49574_gdd_trialpay.gif" style="border-color:#ffffff; " usemap="#tpMap"/>
				            <map id="tpMap" name="tpMap">
					            <area shape="rect" coords="0,0,434,54" alt="GoDaddy.com" href="/ct.html?u=http%3a%2f%2fwww.trialpay.com%2fstores%2fgodaddy%2ftwodomains%3ftid%3d6rG-kb1&e=Mm0lZGNjWzD9WzH9WzA2pG00BGx0ZmplZmR2AGZ4ZGHjZGZ1WzIaCGVjZGRjBQNkZGZ0AmR0WzA5CGRzrQ0zpTqjCGHznT5aCGRzoab9ZPMzpQ0lZmtzpUN9FRL=-1"/>
				            </map>
                            </div>
			    ...
			    <div>&#149; Let our <a href="http://www.godaddy.com/gdshop/hosting/dream_website.asp?isc=gppt02C013&domain=everlore.com" >Web pros</a> build your website, logo and more.</div>
			    </div>
			    ...
			    <div>Register a new .COM for <span style="text-decoration:line-through;">$11.99</span> <span style=" color:#eb1d28; ">$7.49*</span> per year! <span style=" color:#eb1d28; ">Save 37%*</span></div>
...
<div style="position: relative; float: left; left: 8px; top: 6px; width: 420px; height: 26px; padding-left: 10px;" id="RoundSearch">
    <table cellspacing="0" cellpadding="0" border="0" style="width: 411px;">
        <tbody>
            <tr>
			    ...
			    <div style=" position:absolute; margin-top: 466px; margin-left: 261px; font-size: 11px">
                    <a href="http://www.godaddy.com/hosting/website-builder.aspx?isc=gppt02C050&domain=everlore.com" style="text-decoration:none; color:#000;">
                    <div style="height:16px;" class="PodTextHeading">Point. Click. Design.</div>
                    <div style="height: 52px;" class="PodText">WebSite Tonight&reg; makes it easy.<br /><span style="color:#f00; font-weight:bold;">ON SALE!</span><br /><b>As low as $2.99/mo.</b></div>
                    </a>
			    </div>
			    

			    <div style=" position:absolute; margin-top: 541px; margin-left: 207px; font-size: 11px">
			        <a href="http://www.bobparsons.me?isc=gppt02C026&domain=everlore.com" style="text-decoration:none; color:#000;"><div style="font-size:11px; color:#000; overflow:hidden; text-decoration:none; padding-top:13px; height:55px; cursor:pointer;">How to overcome one of the <br/>Internet's worst nightmares.<br/>PLUS a hot new brunette.</div></a>
			    </div>
			    <div style="white-space:nowrap; position:absolute; margin-top: 663px; margin-left: 110px; font-size: 11px">
                ...
                <img style="position:absolute; margin-top: 738px; margin-left:178px;" src="http://images-pw.secureserver.net/images/img_PPC_RedTag.png"/>
			    <div style=" position:absolute; margin-top: 747px; margin-left: 226px; font-size: 11px">
                    <a href="http://www.godaddy.com/ecommerce/shopping-cart.aspx?isc=gppt02C051&domain=everlore.com" style="text-decoration:none; color:#000;">
                    <div style="height:16px;" class="PodTextHeading">Open an online store.</div>
                    <div style="height: 52px;" class="PodText">Quick Shopping Cart&reg; now<br /><span style="color:#f00; font-weight:bold;">ON SALE!</span><br /><b>As low as $6.49/mo.</b></div>
                    </a>
			    </div>
			    
			    <div><img class="rightclear" src="http://images-pw.secureserver.net/images/img_Searchsidebar_dotCOf.gif" usemap="#dsMap" /></div>
			    
			    <map id="Map3" name="dsMap">
				    ...
				    <area shape="rect" coords="24,130,495,174" alt="Get the domain you really want with a .CO!" href="http://www.godaddy.com/tlds/co-domain.aspx?isc=gppt02C036&domain=everlore.com"/>
				    ...
				    <area shape="rect" coords="18,454,498,534" alt="WebSite Tonight&reg;" href="http://www.godaddy.com/hosting/website-builder.aspx?isc=gppt02C050&domain=everlore.com"/>
				    <area shape="rect" coords="19,538,498,613" alt="www.bobparsons.me" href="http://www.bobparsons.me?isc=gppt02C026&domain=everlore.com"/>
				    <area shape="poly" coords="23,626,320,626,320,658,105,658,105,686,23,686,23,626" alt="Everything in between" href="http://www.godaddy.com/Business/business-hosting.aspx?isc=gppt02C015&domain=everlore.com"/>
				    <area shape="rect" coords="18,739,498,816" alt="Quick Shopping Cart&reg;" href="http://www.godaddy.com/ecommerce/shopping-cart.aspx?isc=gppt02C051&domain=everlore.com"/>
			    </map>
		        </div>
		...
		<div style="float: left; margin-left: 20px; margin-right: 10px; width: 964px; text-align: center; font-size: 10px; padding-top: 10px; padding-bottom: 20px;">
			*&nbsp;New .COMs $7.49/yr plus 18 cents/yr <a href="javascript:void(openICANNPopup())" >ICANN</a> fee.  Discount based on new one-year registration prices as of 4/8/2011 with sale price reflected in your shopping cart at checkout. Discount applies to new registrations and renewals and cannot be used in conjunction with any other offer or promotion. Domains purchased through this offer will renew at regular price after the initial term has expired.<br/>Offer ends May 31, 2012 5:00 pm (MST).<br/>
    ...
    <script type="text/javascript" language="javascript">
        ...
        if(impspacer) {impspacer.src = '/images/spacer.gif?q=L3MkWGAkAQx5AQZ3ZwZkAwHmBQR1ZQRmAFHlAzpyZ3RlZGNjWGV2MFHmpFHlAz4yZ3RjWGV2LlHmpGNyZwMyMvHmpGNyZwMzWGAkWGV2MJpyZ3RlZQRkZQtjZGRmAQpkAPHlAzA5WGAkZFHlAaEaWGAkZvHlAatyZ3RyZwMzM3NyZ3RjWGV2oabyZ3RjWGV2MaNyZ3RlZmtyZwMbozpyZ3RkWGV2qTLyZ3R2WGV2pUNyZ3SVEvHlAzAbWGAkZD==-1';}
    </script>
