...
<TITLE>Novae Forums - Send Password</TITLE>
</HEAD>
...
<table width="95%" border="0" cellspacing="2" cellpadding="2" align="center"><tr><td align="right" valign="top"></TD></TR></table><FORM ACTION="/forum/sendpassword.php" METHOD=POST><TABLE BORDER=0 WIDTH="95%" CELLPADDING=1 CELLSPACING=0 ALIGN=CENTER VALIGN=TOP><TR><TD BGCOLOR="#050505"><TABLE BORDER=0 CELLPADDING=1 CELLSPACING=1 WIDTH="100%"><TR BGCOLOR="#000000" ALIGN=LEFT><TD COLSPAN=2 ALIGN=CENTER><b>Email Mot de Passe Perdu</b><br>Veuillez remplir ce formulaire, un nouveau mot de passe va être envoyé à votre adresse Email</TR><TR ALIGN=LEFT><TD BGCOLOR="#000000">Nom d'Utilisateur:</TD><TD BGCOLOR="#1e1e1e"><INPUT TYPE=TEXT NAME=user VALUE="" SIZE=35 MAXLENGHT=50></TD></TR><TR ALIGN=LEFT><TD BGCOLOR="#000000">Adresse Email:</TD><TD BGCOLOR="#1e1e1e"><INPUT TYPE=TEXT NAME=email SIZE=35 MAXLENGTH=100></TD></TR><TR BGCOLOR="#000000" ALIGN=LEFT><TD COLSPAN=2 ALIGN=CENTER><INPUT TYPE=SUBMIT NAME=submit VALUE="Envoyer Mot de Passe"></TD></TR></TABLE></TABLE>
...
&nbsp;&nbsp;&nbsp;<font face='arial' size='-2'>Page créée en 0.021576 secondes.</font>
</TD>
