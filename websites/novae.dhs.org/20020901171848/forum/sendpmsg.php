...
<TITLE>Novae Forums - Send Private Message</TITLE>
</HEAD>
...
<table width="95%" border="0" cellspacing="2" cellpadding="2" align="center"><tr><td align="right" valign="top"></TD></TR></table><FORM ACTION="/forum/sendpmsg.php" METHOD=POST>
<table border="0" width="95%" cellspacing="1" cellpadding="0" align="center" valign="top">
                <tr bgcolor="#050505">
                        <td>
<table cellspacing="1" cellpadding="4" width="100%" border="0">
                <tr bgcolor="#1e1e1e">
<TD width=25%><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <b>About Posting</b> </FONT>
</TD>
<TD>
<FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> Tous les membres <b>Enregistrés</b> peut envoyer des Messages Privés</TD></TR>
<TR ALIGN=LEFT><TD BGCOLOR="#000000" width=25%><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <b>Votre Nom d'Utilisateur:<b> </FONT>
</TD><TD BGCOLOR="#1e1e1e"><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <INPUT TYPE="TEXT" NAME="fromusername" SIZE="25" MAXLENGTH="40" VALUE=""> 
 </FONT></TD></TR>    <TR ALIGN="LEFT"> 
        <TD BGCOLOR="#000000" width=25%><b>Mot de Passe:</b></TD> 
        <TD BGCOLOR="#1e1e1e"><INPUT TYPE="PASSWORD" NAME="password" SIZE="25" MAXLENGTH="25"></TD> 
    </TR> 
<TR ALIGN=LEFT><TD BGCOLOR="#000000" width=25%><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <b>Nom d'Utilisateur du Destinataire:<b> </FONT></TD><TD BGCOLOR="#1e1e1e"><INPUT TYPE=TEXT NAME=tousername SIZE=25 MAXLENGTH=40 VALUE=""></TD></TR><TR ALIGN=LEFT><TD BGCOLOR="#000000" width=25%><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <b>Corps du Message:</b><br><br></FONT> <font size=-1> HTML est: Off<BR>
BBcode est:On<br>
 </font></TD><TD BGCOLOR="#1e1e1e"><TEXTAREA NAME=message ROWS=15 COLS=80 WRAP=VIRTUAL></TEXTAREA></TD></TR><TR ALIGN=LEFT><TD BGCOLOR="#000000" width=25%><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <b>Options:</b> </FONT></TD><TD BGCOLOR="#1e1e1e"><FONT FACE="arial" SIZE="2" COLOR="#FFFFFF"> <INPUT TYPE="CHECKBOX" NAME="bbcode">Désactiver <a href="faq.php#bbcode" target="_blank"><i>BBcode</i></a> sur ce Message<BR><INPUT TYPE="CHECKBOX" NAME="smile">Désactiver <a href="faq.php#smilies" target="_blank"><i>Smilies</i></a> sur ce Message.<BR> <INPUT TYPE=CHECKBOX NAME=sig>Montrer la signature <font size=-2>(Ceci peut être modifié ou ajouté à votre profil)</font></font><BR> </FONT></TD></TR><TR><TD BGCOLOR="#000000" colspan=2 ALIGN=CENTER><INPUT TYPE=SUBMIT NAME=submit VALUE="Poster"></TR></TABLE></TD></TR></TABLE></FORM>
...
&nbsp;&nbsp;&nbsp;<font face='arial' size='-2'>Page créée en 0.041668 secondes.</font>
</TD>
