  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> 
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        ...
        <tr onMouseOver="pviiClassNew(this,'undefined')" onMouseOut="pviiClassNew(this,'undefined')"> 
          <td class="mencell" width="30%" onMouseOver="pviiClassNew(this,'mencellover')" onMouseOut="pviiClassNew(this,'mencell')"><A HREF="memberdetails.asp?ID=1">Benjen</A></td>
          <td class="mencell" width="17%">Thane</td>
          <td class="mencell" width="20%">Dwarf</td>
          <td class="mencell" width="14%">7</td>
