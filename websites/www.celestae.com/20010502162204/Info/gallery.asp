...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> <!-- #BeginEditable "maintext" --> 
      <p class="mediumheading"><img src="../images/misc/darkelf1.gif" width="52" height="44" align="middle">&nbsp;Gallery</p>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable" colspan="3">Xalgoz and his minions are beaten in 
            Kaesora </td>
        </tr>
        <tr align="center" valign="middle"> 
          <td class="mencell" width="32%"><img src="../images/Raids/Celestae-Kaesora-6sm.jpg" width="155" height="113" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Kaesora-6.jpg','452','330','Kaesora1','10','10')"></td>
          <td class="mencell" width="38%"><img src="../images/Raids/Celestae-Kaesora-12sm.jpg" width="125" height="113" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Kaesora-12.jpg','640','579','Kaesora2','10','10')"></td>
          <td class="mencell" width="30%"><img src="../images/Raids/Celestae-Kaesora-15sm.jpg" width="64" height="113" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Kaesora-15.jpg','238','419','Kaesora3','10','10')"></td>
        </tr>
        <tr align="center" valign="middle"> 
          <td class="mencell" width="32%">Tanks from Celestae battle undead</td>
          <td class="mencell" width="38%">The Raiders of Celestae in Kaesora</td>
          <td class="mencell" width="30%">Nazrash awarded his Blade of Xalgoz</td>
        </tr>
      </table>
      <br>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable" colspan="3">The Vampires of Mistmoore Get a Visit 
            From Celestae</td>
        </tr>
        <tr align="center" valign="middle"> 
          <td class="mencell" width="32%"><img src="../images/Raids/Celestae-Mistmoore-1sm.jpg" width="150" height="110" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Mistmoore-1.jpg','600','440','Mistmoore1','10','10')"></td>
          <td class="mencell" width="38%"><img src="../images/Raids/Celestae-Mistmoore-6sm.jpg" width="150" height="104" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Mistmoore-6.jpg','640','442','Mistmoore2','10','10')"></td>
          <td class="mencell" width="30%"><img src="../images/Raids/Celestae-Mistmoore-8sm.jpg" width="150" height="113" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Mistmoore-8.jpg','640','480','Mistmoore3','10','10')"></td>
        </tr>
        <tr align="center" valign="middle"> 
          <td class="mencell" width="32%">Initial Prep outside of Mistmoore</td>
          <td class="mencell" width="38%">Shastis takes a seat on the throne</td>
          <td class="mencell" width="30%">An Unsuccessful break</td>
        </tr>
      </table>
      <br>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable" colspan="3">Attack on the goblins of the Death 
            Mountain Clan</td>
        </tr>
        <tr align="center" valign="middle"> 
          <td class="mencell" width="32%"><img src="../images/Raids/Celestae-Droga-1sm.jpg" width="150" height="144" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Droga-1.jpg','499','480','Droga1','10','10')"></td>
          <td class="mencell" width="38%"><img src="../images/Raids/Celestae-Droga-2sm.jpg" width="150" height="113" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Droga-2.jpg','640','480','Droga2','10','10')"></td>
          <td class="mencell" width="30%"><img src="../images/Raids/Celestae-Droga-4sm.jpg" width="150" height="113" class="pickicon" onClick="openPictureWindow_Fever('../images/Raids/Celestae-Droga-4.jpg','640','480','Droga3','10','10')"></td>
        </tr>
        <tr align="center" valign="middle"> 
          <td class="mencell" width="32%">Preparation for the raid on the hill 
            outside Droga</td>
          <td class="mencell" width="38%">After the first encounter - all is going 
            as planned</td>
          <td class="mencell" width="30%">Delving deeper...</td>
        </tr>
      </table>
