...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> <!-- #BeginEditable "maintext" --> 
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">Celestae Moves to Dark Ages of Camelot</td>
        </tr>
        <tr> 
          <td class="mencell" valign="top">Celestae moves from EverQuest to Dark 
            Age of Camelot. Some members stay behind and join other EQ guilds. 
            Celestae will welcome them back with open arms when they are through 
            playing EQ and join us in DAOC.</td>
        </tr>
      </table>
      <!-- #EndEditable --> </td>
  </tr>
