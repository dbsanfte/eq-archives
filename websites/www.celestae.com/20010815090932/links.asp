...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> 
      ...
      <p class="mediumheading"><img src="images/misc/mhuman1.gif" width="64" height="65" align="middle">&nbsp;Links</p>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">Dark Age Of Camelot Sites</td>
        </tr>
        <tr> 
          <td class="mencell"><a href="http://camelothq.com/" target="_blank" class="altlinks">CamelotHQ</a></td>
        </tr>
        <tr> 
          <td class="mencell"><a href="http://camelotvault.ign.com/" target="_blank" class="altlinks">CamelotVault</a></td>
        </tr>
        <tr>
          <td class="mencell"><a href="http://www.darkageofcamelot.com/" target="_blank" class="altlinks">Offical 
            Dark Age of Camelot Web Site</a></td>
        </tr>
      </table>
      <br>
      <br>
