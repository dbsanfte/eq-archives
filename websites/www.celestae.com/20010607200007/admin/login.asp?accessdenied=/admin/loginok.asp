    ...
    <tr>
      <td>
        <table width="142" border="0" cellspacing="6" cellpadding="3" class="mentable">
          ...
          <tr> 
            <td class="mencell" onMouseOver="this.className='mencellover'" onMouseOut="this.className='mencell'" onMouseDown="MM_goToURL('parent','loginok.asp');return document.MM_returnValue"><a href="loginok.asp">Modify 
              Character</a> </td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td class="mencell" onMouseOver="this.className='mencellover'" onMouseOut="this.className='mencell'" onMouseDown="MM_goToURL('parent','memberlist.asp');return document.MM_returnValue"><a href="memberlist.asp">Member 
              List Management</a></td>
          </tr>
          <tr> 
            <td class="mencell" onMouseOver="this.className='mencellover'" onMouseOut="this.className='mencell'" onMouseDown="MM_goToURL('parent','addnews.asp');return document.MM_returnValue"><a href="addnews.asp">Add 
              News</a></td>
          </tr>
        </table>
      </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> 
      ...
      <p class="mediumheading"><img src="../images/misc/gnome1.gif" width="52" height="44" align="middle">&nbsp;Login</p>
      <p>Please type your username and password here. If you do not know this 
        information please contact the <a href="mailto:webmaster@celestae.com" class="altlinks">webmaster</a>.</p>
      <form name="LoginForm" method="post" action="/admin/login.asp?accessdenied=/admin/loginok.asp">
        <table width="24%" border="0" cellspacing="5" cellpadding="5">
          <tr> 
            <td class="menheadi" width="19%">Username:</td>
            <td width="81%" class="mencell"> 
              <input type="text" name="username">
            </td>
          </tr>
          <tr> 
            <td class="menheadi" width="19%">Password:</td>
            <td width="81%" class="mencell"> 
          ...
          <tr align="right"> 
            <td colspan="2"> 
              <input type="submit" name="Submit" value="Log In" class="menheadi" onClick="MM_validateForm('username','','R','password','','R');return document.MM_returnValue">
            </td>
          </tr>
        </table>
      </form>
      <p>If you have reached this page after logging in that means you are not 
        an admin and cannot access the Add News or Modify Member List.</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
