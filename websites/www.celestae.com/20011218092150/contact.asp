...
<title>Celestae - A Dark Age of Camelot Guild</title>
<!-- #EndEditable --> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <tr> 
    ...
    <td class="maincontentbox" colspan="2" align="center" width="93%">A Dark Age 
      of Camelot Guild</td>
  </tr>
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> 
      <!-- #BeginEditable "maintext" --> 
      <p class="mediumheading"><img src="images/misc/mtroll.gif" width="66" height="70" align="middle">&nbsp;Contact 
        Celestae</p>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable" width="12%">E-Mail</td>
          <td class="mentable" width="88%">Reason</td>
        </tr>
        <tr> 
          <td class="mencell"><a href="mailto:webmaster@celestae.com" class="altlinks">WebMaster</a></td>
          <td class="mencell">Web Related Issues</td>
        </tr>
        <tr> 
          <td class="mencell"><a href="mailto:coldsun@qwest.net" class="altlinks">Shastis 
            (Leader)</a></td>
          <td class="mencell">Guild Related Issues</td>
        </tr>
      </table>
      <br>
      <p>&nbsp;</p>
