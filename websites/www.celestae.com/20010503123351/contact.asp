...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> 
      ...
      <p class="mediumheading"><img src="images/misc/gnome2.gif" width="52" height="44" align="middle">&nbsp;Contact 
        Celestae</p>
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable" width="12%">IRC Channel</td>
          <td class="mentable" width="88%">IRC Server</td>
        </tr>
        <tr> 
          <td class="mencell">#vazaelle</td>
          <td class="mencell">irc.gamesnet.net</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
