    ...
    <tr> 
      <td> 
        <table width="142" border="0" cellspacing="6" cellpadding="3" class="mentable" bgcolor="#666666">
          ...
          <tr> 
            <td class="mencell" onMouseOver="this.className='mencellover';MM_showHideLayers('menmmedia','','hide','mendirector','','hide')" onMouseOut="this.className='mencell'" onMouseDown="MM_goToURL('parent','charter.asp');return document.MM_returnValue"><a href="charter.asp" onFocus="if(this.blur)this.blur()" onMouseOver="MM_showHideLayers('menmmedia','','hide','mendirector','','hide')">Charter 
              </a></td>
          </tr>
          <tr> 
            <td class="mencell" onMouseOver="this.className='mencellover';MM_showHideLayers('menmmedia','','hide','mendirector','','hide')" onMouseOut="this.className='mencell'" onMouseDown="MM_goToURL('parent','history.asp');return document.MM_returnValue"><a href="history.asp" onFocus="if(this.blur)this.blur()" onMouseOver="MM_showHideLayers('menmmedia','','hide','mendirector','','hide')">History 
              </a></td>
          </tr>
          <tr> 
            <td class="mencell" onMouseOver="this.className='mencellover';MM_showHideLayers('menmmedia','','hide')" onMouseOut="this.className='mencell'" onMouseDown="MM_goToURL('parent','gallery.asp');return document.MM_returnValue"><a href="gallery.asp" onFocus="if(this.blur)this.blur()" onMouseOver="MM_showHideLayers('menmmedia','','hide')">Gallery</a></td>
          </tr>
        </table>
      </td>
    </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  ...
  <tr> 
    <td class="maincontent" valign="top" colspan="2" width="93%"> <!-- #BeginEditable "maintext" --> 
      <p class="mediumheading"><img src="../images/misc/darkelf2.gif" width="52" height="44" align="middle">&nbsp;Guild 
        History</p>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">So Our Story Begins...</td>
        </tr>
        <tr> 
          <td class="mencell">Celestial Alliance was born on Thursday December 
            21st, 2000. Wicc, Krayzon, and Cathodelysis set forth to create a 
            guild in the spirit of what was Shade on Lanys T'vyl... 
            <p>Our goal is to create a <b>tightly knit</b> (most important), experienced, 
              and raid capable guild - without losing sight of the most imortant 
              thing -<i><b> having fun</b></i>. </p>
          </td>
        </tr>
      </table>
      <br>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">Restructuring</td>
        </tr>
        <tr> 
          <td class="mencell"> 
            <p>With the departure of Wicc, the previous guild leader, and the 
              promotion of Shastis as GuildMaster the guild went through many 
              changes. We are proud to say at this time the guild is growing rapidly 
              with quality players. </p>
            <p>The many changes included a new officer organization system, better 
              group tracking to keep members in guild groups and happy, and more 
              planned raids.</p>
          </td>
        </tr>
      </table>
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">Attack on the goblins of the Death Mountain Clan</td>
        </tr>
        <tr> 
          <td class="mencell">Celestae, led by the capable raid leaders Shastis 
            and Furrios, attacked the Temple of Droga and fought as deep as the 
            gateway to the chief's lair. The hard work and excellent skills displayed 
            by the members resulted in a Shroud of Nature, certainly one of the 
            few on this server. Well done! Further conquest of this zone is planned 
            in the future.</td>
        </tr>
      </table>
      <br>
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">The Vampires of Mistmoore Vanquished by Celestae</td>
        </tr>
        <tr> 
          <td class="mencell">Four full groups of Celestae members attacked Mistmoore 
            Castle and were met with great resistance. After initial failures, 
            Celestae sent the minions of Mistmoore to their final graves. Special 
            thanks to the cleric known as Cure who brought many brave Celestae 
            members back from the dead. Loot dropped were 1 Nightshade Wreath, 
            2 Advisor Robes, Werewolves Talons for all Warrios who were present, 
            Dark Cauldrons for our Paladin's Armor Quest and other minor items. 
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr> 
          <td class="mentable">Xalgoz Falls Before Celestae</td>
        </tr>
        <tr> 
          <td class="mencell" valign="top">The forces of Celestae delved deep 
            into Kaesora to destroy Xalgoz and his minions. With very few casualties 
            and tremendous luck in drops for a single run-through our guild received: 
            Blade of Xalgoz, Kylong Hunting Knife, Icy Blade, 3 weight reduction 
            bags and numerous other drops. Creatures all across the face of Norrath 
            speak of Celestae now. Even the great and evil dragon Lord Nagafen 
            has spoken to his followers about our coming. When Celestae comes 
            for the dragon it will be his demise!</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <!-- #EndEditable --> </td>
