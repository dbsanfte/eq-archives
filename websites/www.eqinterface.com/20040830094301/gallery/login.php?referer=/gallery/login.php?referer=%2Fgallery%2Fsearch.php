...
<!-- BEGIN login -->
                        <a href="login.php?referer=%2Fgallery%2Flogin.php%3Freferer%3D%252Fgallery%252Flogin.php%253Freferer%253D%25252Fgallery%25252Fsearch.php">Login</a>
<!-- END login -->
...
<table align="center" width="600" cellspacing="1" cellpadding="0" class="maintable">
        <tr>
                <td class="tableh1" colspan="2"><h2>Enter your username and password to login</h2></td>
                  ...
                  <tr>
                    <form action="login.php?referer=%2Fgallery%2Flogin.php%3Freferer%3D%252Fgallery%252Fsearch.php" method="post" name="loginbox">
