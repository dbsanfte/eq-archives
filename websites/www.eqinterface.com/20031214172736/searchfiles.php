...
<form method="post" action="searchfiles.php"> 
<input type="hidden" name="submit" value="search"> 

<table cellpadding="0" cellspacing="0" border="0" bgcolor="#D2D4D5"  width="100%" align="center"><tr><td>
<table cellpadding="4" cellspacing="1" border="0"  width="100%">
<tr>
	<td bgcolor="#0577A6" colspan="2"><font face="verdana, arial, helvetica" size="2"  color="#FFFFFF"><b>
	Eqinterface File Database Search Engine
	</b></font></td>
</tr>
<tr>
	<td bgcolor="#1A5673"><font face="verdana,arial,helvetica" size="1"  color="#E0E0E0"><b>Search for...</b></font></td>
	<td bgcolor="#1A5673"><font face="verdana,arial,helvetica" size="1"  color="#E0E0E0"><b>Filters & Sorting</b></font></td>
</tr>
<tr valign="top">
	<td bgcolor="#FBFBFB"><font face="verdana,arial,helvetica" size="1" >
	<br><input type="text" class="bginput" name="keyword" value="" size="35">
	<br><br>
	<b>Basic query:</b>
	...
	<tr>
	<td><font face="verdana,arial,helvetica" size="1" ><input type="radio" name="searchby" value="uploadusername">Author Name</font></td>
	<td><font face="verdana,arial,helvetica" size="1" ><input type="radio" name="searchby" value="name" >File Name</font></td>
	</tr>
	<tr>
	<td><font face="verdana,arial,helvetica" size="1" ><input type="radio" name="searchby" value="description" >Description</font></td>
	<td><font face="verdana,arial,helvetica" size="1" ><input type="radio" name="searchby" value="everything" checked >Use all terms</font></td>
	</tr></table>
	<br />
	Sort Results by:<br />
	<select name="sortby">
		<option value="uploadusername">Author Name</option>
		<option value="name">File Name</option>
		<option value="date" selected>Date</option>
		<option value="hits">Download Hits</option>
...
EQinterface.com Copyright ©2002<br>
	<br>
	Page generated in 0.55213702 seconds (99.61% PHP - 0.39% MySQL) with 11 queries.</center><br>
