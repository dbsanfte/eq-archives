...
<center><b>You are not authorized to view this file...</b><br><i>You must have an <b>activated</b> account with eqinterface.com or the eqgui.com forum</i></center><br><center><form action="../forums/member.php" method="post"><input type="hidden" name="action" value="login"><input type="hidden" name="s" value=""><input type="hidden" name="url" value="../sdownload/fileinfo.php?s=&id="><table border="0" cellpadding="8" cellspacing="0"><tr><td>Username: </smallfont> <INPUT TYPE="TEXT" class="bginput" NAME="username" SIZE=12><br><br><smallfont>Password: </smallfont> <INPUT TYPE="PASSWORD" class="bginput" NAME="password" SIZE=12><br><br><center></td><td nowrap valign="top" align="center">Don't have an account? <br><a href="http://www.eqgui.com/register.php?action=signup">Register</a> for one now!<br><br><a href="http://www.eqgui.com/member.php">Lost Password</a></td></tr><tr><td colspan="2" align="center"><input type="submit" value="Login!"><br><br>If you are still haveing trouble read the download <a href="http://www.eqinterface.com/modules.php?op=modload&name=FAQ&file=index&myfaq=yes&id_cat=5&categories=Downloading+Skins">FAQ</a>.<br></td></tr></table></center></form></td></tr></table></td></tr></table>
</td></tr></table>
...
EQinterface.com Copyright ©2002<br>
	<br>
	Page generated in 0.20089495 seconds (98.73% PHP - 1.27% MySQL) with 12 queries.</center><br>
