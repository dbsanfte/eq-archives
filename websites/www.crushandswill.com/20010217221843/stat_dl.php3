...
<CENTER><a href='http://www.CrushandSwill.com'><IMG SRC='/images/cslogo.jpg' NOSAVE border=0></a><BR><center><font size=-2 face='Arial, Helvetica' color='#007700'>Quellious is Up. There are 2189 players online and all zones are running.</font></center><center><font size=-2 face='Arial, Helvetica' color='#FF6600'>Banner Msg: </font></center>
<FONT FACE='Arial,Helvetica' COLOR='<? echo #990000 ?>'><? echo Crush and Swill Company:: EQStat - EQ Server Status Script ?></font><BR>
<img src='images/hr.jpg' border=0 width='80%' height='1'><BR><DIV CLASS='normaltext' align='Center'>EQStat - EQ Server Status Script</div><center>
