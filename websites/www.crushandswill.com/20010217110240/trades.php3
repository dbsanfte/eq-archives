<SCRIPT LANG="javascript">
        ...
        function Check_Form(MemForm) {

        	if(!MemForm.trade.value){
        		alert("You must enter a trade skill to search for.");
        		return false;
        	}
        return true;
        }
...
<head>
   ...
   <title>Crush and Swill Company::  Trade Skill Search</title>
...
<CENTER><a href='http://www.CrushandSwill.com'><IMG SRC='/images/cslogo.jpg' NOSAVE border=0></a><BR><center><font size=-2 face='Arial, Helvetica' color='#007700'>Quellious is Up. There are 736 players online and all zones are running.</font></center><center><font size=-2 face='Arial, Helvetica' color='#FF6600'>Banner Msg: </font></center>
<FONT FACE='Arial,Helvetica' COLOR='<? echo #990000 ?>'><? echo Crush and Swill Company::  Trade Skill Search ?></font><BR>
<img src='images/hr.jpg' border=0 width='80%' height='1'><BR><DIV CLASS='normaltext' align='Center'> Trade Skill Search</div><center>You must be logged in to use this feature</center><center><table border=0 cellspacing=0 cellpadding=0><tr><td colspan=2 align=center><DIV CLASS='tiny'>Please Log In:<form method='post' action='login.php3'</div></td></tr><tr><td><DIV CLASS='tiny'>Name</div></td><td><DIV CLASS='tiny'><input type='text' name='csuser' size=10></div></td></tr><tr><td><DIV CLASS='tiny'>Pass</div></td><td><DIV CLASS='tiny'><input type='password' name='cspass' size=10></div></td></tr><tr><td colspan=2 align=center><DIV CLASS='tiny'><input type='submit' name='login' value='Log In' size=10></div></td></tr></table></center>
