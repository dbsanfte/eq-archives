...
<a href = "/webmail" target="_New">Rallos Zek Web Mail</a>
 |
<a href = "/yankeewarriors" target="_New">Yankee Warriors (PS)</a>
</td>
</tr>
...
<tr>
<td class="darktable">
Enter your Login Name and Password to login.  If you have not yet registered,  you can 
 <a href="http://www.ralloszek.net/ubbthreads/newuser.php?Cat=">register here</a>.
</td>
</tr>
<tr>
<td class="lighttable">
<form method="post" action="http://www.ralloszek.net/ubbthreads/start_page.php">
...
<br />
<br />
<input type="checkbox" name="rememberme" value="1" class="formboxes" /> Remember me on each visit.<br /><br />
<input type="hidden" name="firstlogin" value="1" />
<input type="submit" name="buttlogin" value="Login" class="buttons" />
</form>
...
<br />
<br />
<input type="submit" name="buttforgot" value="I forgot my password" class="buttons" />
</form>
