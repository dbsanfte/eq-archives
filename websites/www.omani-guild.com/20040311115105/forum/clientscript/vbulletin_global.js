...
{
	return window.open("reputation.php?" + SESSIONURL + "p=" + postid, "Reputation", "toolbar=no, scrollbars=yes, resizable=yes, width=400, height=241");
}
...
function js_toggle_all(formobj, formtype, option, exclude, setto)
{
	for (var i =0; i < formobj.elements.length; i++)
	{
		...
		if (elm.type == formtype && in_array(elm.name, exclude, false) == -1 && (option == '' || elm.value == option))
		{
			switch (formtype)
			{
				case "select-one":
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 12:45, Thu Jan 8th 2004
|| # CVS: $RCSfile: vbulletin_global.js,v $ - $Revision: 1.76 $
|| ####################################################################
\*======================================================================*/