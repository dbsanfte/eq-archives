...
<p align=center><font face="Verdana, Arial, Helvetica" size=4>Password Reminder</p>
<form action="pword.asp?mode=doit" method="post">
<div align="center">
<TABLE background="" bgColor="#54412C" border=1 cellPadding=0
cellSpacing=0 width=70%>
<TBODY>
<TR>
<TD width=50%><FONT face="Verdana, Arial, Helvetica" size=2>User Name </TD>
<TD width=50%><FONT face="Verdana, Arial, Helvetica" size=3>
<INPUT name=Name size=30> </FONT></TD>
<TR>
<TD><FONT face="Verdana, Arial, Helvetica" size=2>Email</TD>
