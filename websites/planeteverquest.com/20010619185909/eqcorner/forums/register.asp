...
<p><font size=4>Register For EQ Tavern</font></p>
...
<font face="Verdana, Arial, Helvetica">
	...
	<li>Your password will be e-mailed to you upon completing this form.

	<li>You must be at least 13 years old to participate in our forums.</li>
    <li>Fields mark with
   ...
   <TABLE border=1 cellPadding=3 cellSpacing=0 width=100% background="">

                <TR>
                    <TD bgcolor="#6F6559" width="50%"><font face="Verdana, Arial, Helvetica" size=2>User Name <FONT color=#ff0000>*</FONT></td>
                    <TD bgcolor="#6F6559" width="50%"><font face="Verdana, Arial, Helvetica" size=3>
                        <INPUT name="Name" size="30"  value=""> </td>
                </TR>

                <TR>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=2>Email Address <FONT color=#ff0000 face="">*</FONT></td>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=3>
                        <INPUT  name="email" size="30" value=""></td>
                <TR>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=2>Home Page </td>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=3>
                        <INPUT name="homepage" size="30" value=""></td>
                <TR>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=2>ICQ Number </td>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=3>
                        <INPUT name="ICQ" size="30" value=""></td>                        
                <TR>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=2>Country</td>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=3>
 ...
 <TR>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=2>Signature</td>
                    <TD bgcolor="#6F6559"><font face="Verdana, Arial, Helvetica" size=3>
                        <textarea name="sig" cols="30" rows=5></textarea></td>
</TR>
	<td bgcolor="#6F6559" colspan=2 align="center"><INPUT type="submit" value="Submit"  name=submit1></td>
