...
<h4>Pet Cannibalization Analysis - Updated for the 12/18/2003 Nerf</h4>


<p class="warn">Note: From initial testing -- I'll do more in the coming weekend -- it appears that VI is storing the 
pet's mana cost when summoned.&nbsp; If this is the case then VI really wanted to make mages the only pure caster with 
no class-based mana regen ability -- and did so quite effectively.&nbsp; I am not seeing mana gains after the patch.&nbsp; 
The assumption used in this calculator (stated mana cost) was incorrect.</p>
...
<p>For kicks, you can compare to the <a href="/mageguide/petcanni_pn.asp">pre-nerf 
calculator here</a>.</p>


<form method="POST" action="petcanni.asp">
	</p>
...
<p align="center">
<a href="/mageguide/petcanni.asp?petfocus=">Bookmark or copy this link to save this scenario</a>
</p>
<div align="center">
  <center>
