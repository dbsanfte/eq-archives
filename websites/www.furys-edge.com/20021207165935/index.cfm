...
<table border="0" width="580" cellspacing="0" cellpadding="0">
 <tr>
  <td class="tblhead" width="520" height="20">
   <!-- Start News Title -->Website Construction &nbsp;&nbsp;&nbsp; -update by Draekk<!-- End News Title -->
  </td>
  ...
  <!-- Start Update Input -->
  The website will be under construction for the next few weeks. It will 
remain fully functional during that time and, hopefully, will show a great 
improvement in the end. Thanks for your patience.
  <!-- End Update Input -->
  </td>
 </tr>
...
<table border="0" width="580" cellspacing="0" cellpadding="0">
 <tr>
  <td class="tblhead" width="520" height="20">
   <!-- Start News Title -->Mithaniel Marr dies. &nbsp;&nbsp;&nbsp; -update by Draekk<!-- End News Title -->
  </td>
  <td class="tblhead" width="60" height="20">
  <!-- Start News Date -->
  11/25/2002
  ...
  <!-- Start Update Input -->
  <p align=center>
Click on the pic to go to the news forum.
</p>

<center>
<a href=http://pub96.ezboard.com/ffurysedge82244frm11>
<img src=http://www.furys-edge.com/update/112402/mithmarr.jpg border=0>
</a>
</center>
  <!-- End Update Input -->
  </td>
