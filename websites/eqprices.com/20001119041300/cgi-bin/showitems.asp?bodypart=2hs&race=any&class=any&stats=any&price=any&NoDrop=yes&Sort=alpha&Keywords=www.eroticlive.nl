...
<OPTION value="2hs"SELECTED>Weapon - 2HS
...
<SELECT name="price">
<OPTION value="any"SELECTED>No Price Necessary
...
<SELECT name="nodrop">
<OPTION value="yes"SELECTED>-------Include------
<OPTION value="no">----Don't Include---
            ...
            <B>7 - Sort By</B><BR>
            <SELECT name="sort">
              <OPTION value="alpha" SELECTED>-----Alphabetical----
              <OPTION value="ac">AC
...
<input type="text" name="keywords" VALUE=www.eroticlive.nl size="20">
...
<INPUT TYPE=submit VALUE="Search Database">
    ...
    <TD vAlign=top width=625>
      <TABLE bgColor=#122134 border=0 cellPadding=0 cellSpacing=0>
		...
		<TR><TD COLSPAN=3><HR></TD></TR><BR><B><BIG>No matching items found.</B><BR><BR><CENTER>Try a <B><a href="global.asp?query=www.eroticlive.nl" onMouseOver="return overlib('Search our entire database for anything matching your search.', FGCOLOR, '#122134', BGCOLOR, '#FFFFFF', TEXTCOLOR, '#B7B8C9');" onMouseOut="nd();">Global Search</a></B> for this item.</CENTER><BR><BR><center><big></big></center>          </TBODY>
         </TABLE>
