...
<HTML><HEAD><TITLE>EQPrices.Com - Site Login</TITLE>
...
var myScroller1 = new Scroller(0, 0, 480, 32, 1, 8);
myScroller1.setColors("#FFFFFF", "#122134", "#FFFFFF");
myScroller1.setFont("Verdana,Arial,Helvetica", 2);
myScroller1.addItem("<center><b>EQPrices.Com Recently Updated Items</b></center>");
myScroller1.addItem("<center><b><a href='http://www.eqprices.com/cgi-bin/showitems.asp?itemcode=3189'>Barbed Ringmail</a></b> - Average Price: 24,900</center>");
myScroller1.addItem("<center><b><a href='http://www.eqprices.com/cgi-bin/showitems.asp?itemcode=188'>A Dark Reaver</a></b> - Average Price: 290</center>");
myScroller1.addItem("<center><b><a href='http://www.eqprices.com/cgi-bin/showitems.asp?itemcode=3945'>Reaver</a></b> - Average Price: 25,700</center>");
myScroller1.addItem("<center><b><a href='http://www.eqprices.com/cgi-bin/showitems.asp?itemcode=4280'>Ring of Dain Frostreaver IV</a></b> - Average Price: NO DROP</center>");
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="300" height="50" colspan="5" align="center" valign="top">
      <b>The page you are trying to access is part</b><br>
      <b>of the Flashlink Premium Gaming Network!</b><br>
      ( please read <a href="../whyflashlink.shtml">this page</a> to find out why )
      </td>
  </tr>
  <tr>
    <td width="300" height="20" colspan="5" bgcolor="#000033"><img src="http://www.flashlink.com/img/key.gif" width="16" height="16" align="left" hspace="5"><b>FLASHLINK LOGIN</b></td>
  </tr>
  <tr>
    <td width="2" bgcolor="#000033" rowspan="3"><img src="http://www.flashlink.com/img/dot.gif"></td>
    <td width="75" height="32" align="right" bgcolor="#666666"><b>User Name:</b></td>
    <td width="221" align="center" colspan="2" bgcolor="#666666"><input type="text" name="username" size="20" maxlength="20"></td>
    <td width="2" bgcolor="#000033" rowspan="3"><img src="http://www.flashlink.com/img/dot.gif"></td>
  </tr>
  <tr>
    <td width="75" height="32" align="right" bgcolor="#666666"><b>Password:</b></td>
    <td width="221" align="center" colspan="2" bgcolor="#666666"><input type="password" name="password" size="20" maxlength="20"></td>
  </tr>
  <tr>
    <td width="75" height="30" align="right" bgcolor="#666666"><input type="checkbox" name="save"></td>
    <td width="100" bgcolor="#666666">  save</td>
    <td width="121" bgcolor="#666666"><input type="submit" name="submit" value="Login"></td>
  </tr>
  <tr>
    <td colspan="5" height="2" bgcolor="#000033"><img src="http://www.flashlink.com/img/dot.gif"></td>
  </tr>
  <tr>
    <td width="300" colspan="5"><br>
      <li>New user? <a href="http://www.flashlink.com/index.php?p=signup&s=43">Sign-up now</a> to get instant access!
      <li>Existing users please login above or by <a href="https://www.flashlink.com/index.php?p=login&s=43">secure login</a>
      <li>Forgot your password? Have it <a href="http://www.flashlink.com/index.php?p=sendpass&s=43">sent</a> to you.
    </td>
  </tr>
</table>
</form>
...
<hr width="600">
<br>
<b>More About Flashlink</b>
<br><br>
When you join FlashLink, you gain full access over 35 independently owned and operated gaming websites.
By bringing together only the highest quality sites, you know that when visiting a Flashlink member site
you will always find the latest gaming news, interviews, cheats, maps, and much more. Running a premium
quality website is very expensive, and the money from your Flashlink subscription will help webmasters pay
for server costs, bandwidth, staff, and other expenses associated with bringing you this top quality
information. Simply put, without your help in joining Flashlink, many of our member sites would have
to go offline.
<br><br>
Joining Flashlink is just like getting a subscription to a gaming magazine - except Flashlink is a lot
less expensive and offers more information. All new subscribers to Flashlink will get a <b>FREE 14 day trial</b>
and can visit all Flashlink sites with absolutely no risk. If you sign up for your free trial between now and
June 1st, 2001 you will automatically be entered for a chance to win a free
<a href="http://www.flashlink.com/index.php?p=geforce3&s=43">GeForce 3 graphics card</a>, a free
2 year subscription to Flashlink, and other prizes. That's a pretty good deal just for signing up: a chance
to win a GeForce 3 graphics card and a 14 day trial to access all Flashlink sites free of charge!
<br><br>
If you want to know more about Flashlink and it's many great benefits,
<a href="http://www.flashlink.com/index.php?p=whyjoin&s=43">click here</a>.
