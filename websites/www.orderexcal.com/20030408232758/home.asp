...
<tr>
	...
	<table border="0" align="center" cellspacing="0" cellpadding="0">
	<tr>
		<td class="whitedetailtext"><b>Tuesday,&nbsp;4/8/2003</b></td>
	</tr>
	</table>
	...
	<tr>
		<td>
			...
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=13">Texas Ren Fest</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=12">Office Of Internal Affairs</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=11">Screenshots Available!!</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=9">Articles</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=10">Mirroring Articles, Server Status, etc...</a></td>
			</tr>
