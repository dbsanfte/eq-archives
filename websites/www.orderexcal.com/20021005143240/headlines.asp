		...
		<td>
			...
			<tr>
				<td>
					...
					<tr>
						<td background="images/gold.gif" class="reddetailtext">Front Page #1 - <a href="headlinesDetail.asp?hid=6">Application For Membership</a></td>
					...
					<tr>
						<td background="images/gold.gif" class="reddetailtext">Front Page #2 - <a href="headlinesDetail.asp?hid=13">Texas Ren Fest</a></td>
						<td background="images/gold.gif" class="reddetailtext">
					...
					<tr>
						<td background="images/gold.gif" class="reddetailtext">Front Page #3 - <a href="headlinesDetail.asp?hid=12">Office Of Internal Affairs</a></td>
						<td background="images/gold.gif" class="reddetailtext">
					...
					<tr>
						<td background="images/gold.gif" class="reddetailtext">Front Page #4 - <a href="headlinesDetail.asp?hid=11">Screenshots Available!!</a></td>
						<td background="images/gold.gif" class="reddetailtext">
					...
					<tr>
						<td background="images/gold.gif" class="reddetailtext">Front Page #5 - <a href="headlinesDetail.asp?hid=9">Articles</a></td>
						<td background="images/gold.gif" class="reddetailtext">
					...
					<tr>
						<td background="images/gold.gif" class="reddetailtext">Front Page #6 - <a href="headlinesDetail.asp?hid=10">Mirroring Articles, Server Status, etc...</a></td>
						<td background="images/gold.gif" class="reddetailtext">
