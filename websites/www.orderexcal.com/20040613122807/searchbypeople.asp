...
<html>
<head>
	<title>Excalibur -!- Member Search</title>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<td class="title">EMBER SEARCH</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" width="100%">
					<form action="SearchPeoplePage.asp" method="post" name="form01">
					<table width="100%" border="0" align="center">
					<tr>
						<td colspan="2">
							<table align="center">
							<tr>
								<td class="whitedetailtext">
									<p><b>Quick Hints:</b> You can search based on several types of criteria.  We will use "John Smith" in our example.<br>
									<ul>
										<li>Search based on full or partial first name only (i.e. John, J, Joh, etc.).
										<li>Search based on full or partial last name only (i.e. Smith, S, Smi, etc.).
										<li>Search based on full or partial first and last names (i.e. John Smith, J Smith, John S, Joh Smi, etc.).
										<li>If you leave the first and last name blank, you will get a list of everyone.
									</ul>
									<p><b>Note:</b> Use of the traditional "wildcard" character "asterisk" (*) is supported but is not necessary.</p>
								</td>
							</tr>
							</table>
						</td>
					...
					<tr>
						<td class="whitedetailtext" align="right">
							First Name: <input type="text" name="FirstName" tabindex="1">&nbsp;&nbsp;
						</td>
						<td class="whitedetailtext">Display&nbsp;
							<select name="numDispRecs">
					...
					<tr>
						...
						<td class="whitedetailtext">Sort By: 
							<select name="SortByField" tabindex="4">
					...
					<tr>
						<td align="center" colspan="2"><input type="submit" value="Submit Name" tabindex="3"></td>
					</tr>
					</table>
					</form>
				</td>
