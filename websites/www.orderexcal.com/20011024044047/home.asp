...
function moveLayerBy(layer,dx,dy){
	...
	if(isMinIE4){
		layer.style.pixelLeft+=dx;layer.style.pixelTop+=dy;
	}
}
...
function getTop(layer){
	...
	if(isMinIE4)return layer.style.pixelTop;return-1;
}
...
function getHeight(layer){
	if(isMinNS4){
		...
		layer.clip.bottom-layer.clip.top;
	}
	if(isMinIE4){
...
function getClipLeft(layer){
	...
	if(isMinIE4){
		var str=layer.style.clip;if(!str)return 0;
...
function getClipRight(layer){
	...
	if(isMinIE4){
		...
		var clip=getIEClipValues(layer.style.clip);return clip[1];
	}
	return-1;
}
...
function navBarCreate(){
	...
	for(i=0; i<this.menus.length; i++){
		...
		high='<table border=0 cellpadding='+this.padding+' cellspacing=0'+(this.menus[i].hdrWidth>0?' width='+this.menus[i].hdrWidth:'')+'><tr><td background="images/gold.gif"'+(this.menus[i].hdrWidth==0?' nowrap=1'+this.menus[i].hdrWidth:'')+'><span style="color:'+this.hdrHiFgColor+'; font-family:'+this.hdrFontFamily+'; font-size:'+this.hdrFontSize+'; font-style:'+this.hdrFontStyle+'; font-weight:'+this.hdrFontWeight+';">';
	...
	norm='<table border=0 cellpadding='+this.padding+' cellspacing=0 width="100%"><tr><td background="images/silver.gif"><span style="color:'+this.itmFgColor+'; font-family:'+this.itmFontFamily+'; font-size:'+this.itmFontSize+'; font-style:'+this.itmFontStyle+'; font-weight:'+this.itmFontWeight+';">';
	high='<table border=0 cellpadding='+this.padding+' cellspacing=0 width="100%"><tr><td background="images/gold.gif"><span style="color:'+this.itmHiFgColor+'; font-family:'+this.itmFontFamily+'; font-size:'+this.itmFontSize+'; font-style:'+this.itmFontStyle+'; font-weight:'+this.itmFontWeight+';">';
	end='</span></td></tr></table>';
	for(i=0; i<this.menus.length; i++){
...
<script language="JavaScript">
	...
	*/
	...
	var menuCount = 7
	var menuwidth = 170
	var mainmenuwidth = 114
	//define menu items (first parameter of NavBarMenu specifies main category width, second specifies sub category width in pixels)
	//add more menus simply by adding more "blocks" of same code below
	
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/home.jpg' height='24' width='105' border='1' alt='Home'>", "home.asp"));
	myNavBar1.addMenu(dhtmlMenu);
	
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/orders.jpg' height='24' width='105' border='1' alt='Home'>", ""));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Royalty</b>", "orders/royalty"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Office of the Regent</b>", "orders/regent"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Guardians of Camelot</b>", "orders/camelot"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Knights Order of Honour</b>", "orders/honour"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Mystic Order of Old</b>", "orders/old"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of Enlightenment</b>", "orders/enlightenment"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Cross</b>", "orders/cross"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Crucible</b>", "orders/crucible"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Flame</b>", "orders/flame"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Queen's Dragon</b>", "orders/dragon"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Rose</b>", "orders/rose"));
	
	myNavBar1.addMenu(dhtmlMenu);
	
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/generalinfo.jpg' height='24' width='105' border='1' alt='Home'>", ""));
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Calendar</b>", "calendar.asp"));
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Headlines</b>", "headlines.asp"));
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Code & Bylaws</b>", "codeandbylaws.asp"));
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Code of Chivalry</b>", "codeofchivalry.asp"));
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Excalibur Roster Search</b>", "searchbypeople.asp"));
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Guild Archives</b>", "javascript:alert('This option is still under construction.  Please try again later.')"));
	myNavBar1.addMenu(dhtmlMenu);

	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/forums.jpg' height='24' width='105' border='1' alt='Home'>", ""));

	dhtmlMenu.addItem(new NavBarMenuItem("<b>Open Posting</b>", "bb_viewforum.asp?forumid=6"));

	myNavBar1.addMenu(dhtmlMenu);
	
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/misc.jpg' height='24' width='105' border='1' alt='Home'>", ""));

	dhtmlMenu.addItem(new NavBarMenuItem("<b>Log In</b>", "login.asp"));

	dhtmlMenu.addItem(new NavBarMenuItem("<b>Email Webmaster</b>", "mailto:excalwebmaster@orderexcal.com"));
	//dhtmlMenu.addItem(new NavBarMenuItem("<b>The Queen's Pages</b>", "javascript:window.open('http://lonestar.texas.net/~vader', 'queenpages', '')"));
	//dhtmlMenu.addItem(new NavBarMenuItem("<b>Font Test</b>", "test.asp"));
	myNavBar1.addMenu(dhtmlMenu);

	
	
	//set menu colors
	myNavBar1.setColors("#990000", "#000000", "#990000", "#ffffff", "#000000", "#000000", "#EBEBEB", "#990000", "#FFCC66")
...
<body onload="init()" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0" bgcolor="#000000">
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">

<tr>
	<td valign="bottom" colspan="2" bgcolor="#990000"><img src="/images/spacer.gif" width="1" height="37" alt="" border="0"></td>
</tr>
...
<!---->
	...
	<tr>
		...
		<td class="title">ight and Noble Order of Excalibur</td>
	</tr>
	<tr>
	...
	<table border="0" align="center" cellspacing="0" cellpadding="0">
	<tr>
		<td class="whitedetailtext"><b>Tuesday,&nbsp;10/23/2001</b></td>
	</tr>
	</table>
	...
	<tr>
		<td>
			...
			<tr>
		  		<td align="center" class="redtablecell"><b>Front Page Headlines</b></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=6">Application for Membership</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=5">DAoC Servers!</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=4">Website Login Accounts</a></td>
			</tr>
			
			<tr>
				<td background="images/gold.gif">&nbsp;<a href="headlinesDetail.asp?hid=1">New Website Goes Live!</a></td>
			</tr>
	...
	<br>
	<table width="90%" bordercolor="#990000" align="center" border="1" cellspacing="0" cellpadding="0"> 
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="2" cellpadding="4">
			<tr>
				<td align="center"  class="redtablecell"><b>There are No Events Scheduled for Today</b></td>
			</tr>
			</table>
		</td>
	</tr>
	...
	<p align="center" class="whitedetailtext">You can view all of the stories, articles and events for the Right	and Noble<br>
	Order of Excalibur at the Headlines and Calendar links under the General Info menu button.</p>
