...
<script language="JavaScript">
	...
	*/
	...
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/home.jpg' border='1' alt='Home'>", "home.asp"));
	myNavBar1.addMenu(dhtmlMenu);
	
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/orders.jpg' border='1' alt='Home'>", ""));
	...
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/generalinfo.jpg' border='1' alt='Home'>", ""));
	...
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/forums.jpg' border='1' alt='Home'>", ""));
	...
	dhtmlMenu = new NavBarMenu(mainmenuwidth, menuwidth);
	dhtmlMenu.addItem(new NavBarMenuItem("<img src='/images/misc.jpg' border='1' alt='Home'>", ""));
...
<!---->
	...
	<table border="0" align="center" cellspacing="0" cellpadding="0">
	<tr>
		<td class="whitedetailtext"><b>Thursday,&nbsp;8/2/2001</b></td>
	</tr>
	</table>
