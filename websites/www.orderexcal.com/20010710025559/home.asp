...
<script language="JavaScript">
	...
	*/
	...
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Royalty</b>", "royalty"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Office of the Regent</b>", "regent"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Guardians of Camelot</b>", "camelot"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Knights Order of Honour</b>", "honour"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Mystic Order of Old</b>", "old"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of Enlightenment</b>", "enlightenment"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Cross</b>", "cross"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Crucible</b>", "crucible"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Flame</b>", "flame"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Queen's Dragon</b>", "dragon"));
	
	dhtmlMenu.addItem(new NavBarMenuItem("<b>Order of the Rose</b>", "rose"));
...
<!---->
	...
	<table border="0" align="center" cellspacing="0" cellpadding="0">
	<tr>
		<td class="whitedetailtext"><b>Monday,&nbsp;7/9/2001</b></td>
	</tr>
	</table>
