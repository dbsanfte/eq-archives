...
<head>
	...
	<script language="javascript">
		function ProcessURL(strService, strClickURL, strSiteURL, strDFactor)
		{
			...
			document.CollectInfo.ClientIPAddress.value = "209.237.238.159"
...
<!-- FindWhat: http://216.216.246.31/bin/findwhat.dll?getresults&base=&dc=22&aff_id=47057&ip_addr=209.237.238.159&df=1&mt= -->
<!-- Google: http://www.google.com:80/search?q=&num=10&client=netster&output=xml_no_dtd&adtest=off&ip=209.237.238.159&useragent=ia%5Farchiver&ie=utf8&oe=utf8&adsafe=off&spelling=suggestion+ -->
<!-- MyGeek: http://xmlsearch.mygeek.com/feed.jsp?partnerid=98531&pagesize=7&adultfilter=off&query=&ip=209.237.238.159 -->
