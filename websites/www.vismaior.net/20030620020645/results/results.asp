...
<head>
	...
	<script language="javascript">
		function ProcessURL(strService, strClickURL, strSiteURL, strDFactor)
		{
			...
			document.CollectInfo.ClientIPAddress.value = "209.237.238.175"
...
<!-- FindWhat: http://netster.xmlsearch.findwhat.com/bin/findwhat.dll?getresults&base=0&dc=12&aff_id=47057&ip_addr=209.237.238.175&df=1&mt= -->
<!-- FindWhat2: http://netster.xmlsearch.findwhat.com/bin/findwhat.dll?getresults&base=0&dc=10&aff_id=47606&ip_addr=209.237.238.175&df=1&mt= -->
<!-- Google: http://www.google.com:80/search?q=&num=10&client=netster&output=xml_no_dtd&adtest=off&ip=209.237.238.175&useragent=ia%5Farchiver&ie=utf8&oe=utf8&adsafe=off&spelling=suggestion+ -->
<!-- MyGeek: http://xmlsearch.mygeek.com/feed.jsp?partnerid=98531&pagesize=7&adultfilter=off&query=&ip=209.237.238.175 -->
