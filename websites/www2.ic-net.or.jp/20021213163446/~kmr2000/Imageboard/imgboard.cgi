...
<FONT SIZE="+1" COLOR="#FF0000"><B>ひさびさ。EzBoard用にさ。</B></FONT>
 名前：<FONT COLOR="#00FF00"><B><A HREF="mailto: no_email">muha-</A></B></FONT>
[2002/11/13,13:09:41] 
<BLOCKQUOTE>
	てへ。PoD。<!-- user： gatekeeper23.sony.co.jp--> <!-- imgsize skip success!! -->
</BLOCKQUOTE>

<BLOCKQUOTE> 画　像： 
 <A HREF="./img-box/img20021113130941.jpg" TARGET="top">
  <img src="./img-box/img20021113130941.jpg" width=77 height=86 border="0">
   img20021113130941.jpg
 </A>-(90 KB) 
</BLOCKQUOTE>
