...
<html dir="{lang_dir}">
<head>
<title>The Scout's Sanctuary Screenshots - Error</title>
  ...
  <tr>
    <td width="778" height="61" valign="middle" align="right" background="themes/hardwired/images/hw_01.gif">
        <table width="73%" height="32" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="94%" height="22" valign="bottom" align="right"><span class="gal_name">The Scout's Sanctuary Screenshots</span></td>
            <td width="6%"></td>
          </tr>
        </table>
      </td>
...
<!-- BEGIN login -->
                                        ...
                                        <td background="themes/hardwired/images/buttoncenter.gif">
                                                <a href="login.php?referer=%2Fcoppermine%2Fdisplayimage.php">Login</a>
                                        </td>
...
<table align="center" width="600" cellspacing="1" cellpadding="0" class="maintable">
        ...
        <tr>
                <td class="tableb" height="300" align="center">
                        <font size="2"><b>The selected album/file does not exist !</b></font>
