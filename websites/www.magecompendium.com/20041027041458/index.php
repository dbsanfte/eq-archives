...
<tr>
<td width="100%">
<font size="2" color="#FFFFFF">The Conjurer&#39;s Tower is Now Open&#33;</font><font size="2"> - 10-26-2004 17:12</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2"><a href=http://eq2.magecompendium.com>The Conjurer&#39;s Tower</a> is the new EverQuest II forum dedicated to the Conjurer Class.</font><br><br></td>
</tr>
<tr>
...
<hr color="#660066" size="20"><a id="fus_65" name=""><br>
<div align="center">
<center>
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%">
<tr>
<td width="100%">
<font size="2" color="#FFFFFF">October 13th, 2004</font><font size="2"> - 10-17-2004 08:09</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">- Summoned pets no longer vanish when their owner turns invisible <br>- Froglok animations are now fixed, seriously, no really we mean it this time. <br>- Continue the Adventure&#33; Read the first in the new series of EQ Novels. <br><br>Warrior Epic <br>----------------------- <br>- Modified the way Decaying Lord Galuk Drek is spawned in Veksar. He should now be more approachable and less of a bottleneck for those warriors at this step. <br>- Lowered the respawn time of the Dragorn Champion in Wall of Slaughter significantly. We have also lowered his aggro and help radius. <br><br>Bard Epic <br>----------------------- <br>- Corrected an issue in the Dragons Necropolis that caused more NPCs to be present than was planned for. <br>- The Kithicor Forest encounter should now reset properly. <br><br>Ranger Epic <br>----------------------- <br>- Rangers triggering the Senvial, Grinbik and Uisima events for their Epic quest will need to have the trigger item on their person. <br>- It should no longer be possible for a ranger with Senvial’’s Blessing to get the reward for the Senvial event. <br><br>Druid Epic <br>----------------------- <br>- Corrected an issue with the Coven spawn in South Karana. <br>- The Blackened Dryad event in Kithicor should now respawn correctly after a failed attempt. <br>- Only the druid who initiates the Goblin Hide and Seek event will be allowed to the loot the bag upon completion. <br>- More than one Druid can now summon and talk to the Compelled Spirit. <br>- We have increased the drop rate of the carved Prexus totem. <br><br>Magician Epic <br>----------------------- <br>- The Path for finding the air essence should last a bit longer. <br>- Magicians will now receive a message when the air essence is not available. <br><br>Gates of Discord <br>----------------------- <br>There’s a new NPC in Natimbi that will make traveling to Qvic much easier. Speak with her for a small teleport. <br><br>Tradeskills <br>----------------------- <br>- Alchemists can now create Amber Resin. <br>- The Feran Glove and Boot recipes will now combine and return their intended items. <br>- The recipe for the 56th level Necromancer spell, Servant of Bones, should now combine correctly. <br>- The Dagger Blade Mold, used in Gates smithing recipes, has been renamed to a Knife Blade Mold. <br><br>Items <br>----------------------- <br>- Seething Fists of Slaughter- Previously this item had no equipped slots. This now has primary and secondary equippable slots<br>- Fangs of the Serpent- Previously this item had no equipped slots. This now has primary and secondary equippable slots.<br>- Bone Plated Sledge - This item now has 36% haste instead of +36 atk. <br>- Boots of Shifting Time - Previously these boots had a worn leather graphic. They are now a worn plate graphic instead.<br>- Zulaqua&#39;s Cloak - Added 30 AC to this item<br>- Crystal Dagger - This item now has a +12% backstab mod.<br>- Tome of New Beginnings - Berserkers now can equip this item. <br>- Lambent Stone of Focus - This item is now a type 7 and type 8 augmentation.<br>- Crystal Mail Sleeves - This item now has berserkers as usable classes. We have removed Beastlords from this items usable classes.<br><br>AAs<br>-----------------------<br>Altered Spell Casting Reinforcement and Spell Casting Reinforcement Mastery so they will no longer increase the duration of the following spells.<br><br>- Flame of Redemption<br>- Hawk Strike<br>- Fateseer’s Boon<br>- Protection of the Eye<br>- Savage Wildcaller’s Blessing<br>- Flames of the Valiant<br>- Falcon Strike<br>- Prophet’s Gift of the Ruchu<br>- Aegis of Abstraction<br>- Might of the Wild Spirits<br>Altered Healing Adept, Advanced Healing Adept, and Healing Adept Mastery so they will no longer increase the healing of the following spells.<br>- Harmonic Balance<br>- Divine Balance<br><br>Misc<br>-----------------------<br>- Added a new option to turn off the loading screen when zoning. You will still see the progress bar.<br>- Added a new shadow command to allow you to turn off the shadows in your text bar. The command is /shadow<br>- Changed the Dynamic Zone window to show player status in the member list. Online players are yellow, Link Dead players are red, Offline players are blue.<br>- Hide / Sneak will now remain active across zone lines.<br>- All NPCs in Omens of War expedition zones are now KOS. Beware&#33; <br>- Summoned pets will no longer vanish when their owner uses invisibility&#33; Rejoice&#33;<br>- Vallon Zek should no longer assist Tallon Zek.<br><br>The Rogues Hour&#33;<br>-----------------------<br>RA Salvatore presents a brand new series of EverQuest fantasy novels. Explore the ever-expanding world of Norrath in the first book, EverQuest: The Rogue’s Hour, available in stores soon.<br><br>-- The EverQuest Team</font><br><br></td>
</tr>
<tr>
...
<hr color="#660066" size="20"><a id="fus_64" name=""><br>
<div align="center">
<center>
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%">
<tr>
<td width="100%">
<font size="2" color="#FFFFFF">September 23rd, 2004</font><font size="2"> - 09-23-2004 16:15</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">Monk Epic <br>--------------------- <br>- Speaking to certain monk epic mobs will no longer reset the monk&#39;s progression. <br><br>- Monks that turned in their letters will now be able to continue the quest from where they currently are. <br><br>- Monks should have an easier time locating the lost Disciple. <br><br>Warrior Epic <br>--------------------- <br>- Corrected an issue with the Decomposing Pages in Dranik&#39;s Scar. They should now respawn in an appropriate amount of time. <br><br>Guild Tribute <br>--------------------- <br>- Players with Gates, but not Omens, should now be able to open the Guild Tribute Master to both opt-in and donate for Guild Tribute Benefits. <br><br>- Suspended pets will no longer vanish when their owner turns invisible. <br><br>- Skies will now show correctly for Windows 98/ME users. <br><br>- Warriors will be reimbursed for their Press the Attack AA. They can buy the ability with its new range if they wish. <br><br>- Salvage will no longer return items that would be returned normally.<br><br>-- The EverQuest Team</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">- <a href="mailto:ronaldor@magecompendium.com">Ronaldor Vladimir</a></font><br><br></td>
</tr>
...
<hr color="#660066" size="20"><a id="fus_63" name=""><br>
<div align="center">
<center>
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%">
<tr>
<td width="100%">
<font size="2" color="#FFFFFF">Staff of Elemental Essence</font><font size="2"> - 09-22-2004 19:01</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">Congratulations to Celecar on the Mithaniel Marr server for being the first magician to wield the Magician 1.5 Epic, the Staff of Elemental Essence&#33;<br><br><P><img src=/library/epic2/images/mage_epic_15.jpg></font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">- <a href="mailto:xalmat@magecompendium.com">Xalmat Lunaire</a></font><br><br></td>
</tr>
...
<hr color="#660066" size="20"><a id="fus_62" name=""><br>
<div align="center">
<center>
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%">
<tr>
<td width="100%">
<font size="2" color="#FFFFFF">September 14, 2004</font><font size="2"> - 09-15-2004 06:15</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">Headlines <br>------------------- <br>Omens of War is live&#33; <br>New Teleportation Spells to Barindu. <br>Just me and my shadooooow&#33; <br>Reflective Water? <br>Register now for the New Orleans Fan Faire. <br><br><br>Omens of War <br>-------------------- <br>- Explore the war torn lands of Kuua and reap the benefits of new AAs, spells and items including the new, powerful, Epic 2.0. Lush new areas, filled with beautiful creatures and vibrant, living landscapes await you at every turn. We hope you enjoy all that EverQuest: Omens of War brings to the game. <br><br>Level 70 <br>-------------------- <br>Earn your way from level 65 to 70 and learn new spells and abilities along the way. <br><br>Travel to the Omens Zones <br>------------------- <br>The Priests of Discord in Norrath believe they have been granted a gift. A unique knowledge has been bestowed upon them which they believe was granted as a reward for preaching the way of Discord. That gift, they claim, is the knowledge of a way to a world that is enveloped by Discord itself -- an ethereal poison that wreaks havoc and strife upon all it touches. <br><br>Speak to a Priest of Discord to learn how to enter the World of Kuua. <br><br>The Task System <br>------------------- <br>Only have a short time to play or are you waiting for a group or raid? Immerse yourself in a Task. You can find Task Masters all over Norrath. They can be found in most home cities as well as in places like the East Commonlands, the Butcherblock Mountains, Toxxulia Forest and the Swamp of No Hope. For the more daring individuals, the most challenging tasks can be found by speaking with Task Masters in the Dreadlands and the Overthere. <br><br>You can open the task window by hitting Alt+Q and start enjoying this new game-play style and enhancement to the EverQuest experience. <br><br>Be mindful of turning in task items in stacks, as with all quests in EQ, please separate the items before turning them in for a reward. <br><br>Epic Weapons 2.0 <br>------------------- <br>Will you be the first of your class to earn these powerful new items? <br><br>Guild Tribute <br>------------------- <br>Omens of War expansion brings a new Guild Tribute system. This system will allow guild members to donate items/cash for Tribute points, and allow officers to select benefits that the entire guild will receive, deducting the cost from the guild’’s tribute pool. <br><br>Guild Tribute is an extension of the tribute system introduced in Gates of Discord and purchasers of either expansion, will be able to reap the new benefits. <br><br>Retail Claim Item <br>------------------- <br>Those of you who purchased the retail version of EverQuest: Omens of War will need to use the /claim command in-game to receive your in-game items. Enjoy&#33; <br><br>Select your title <br>------------------- <br>You can hit Shift+T to bring up the new Title selection UI which will allow you to choose from the titles you have earned, through AAs, levels or accomplishments, to be shown with your character name in-game. <br><br>Voice Macros <br>------------------- <br>Using Ctrl+V will bring up the new Voice Macro UI. There you will see a list of available voice macros as well as the options of Play, Tell, Group and Raid. Selecting a macro and play will play the macro for you only. Selecting a macro and using one of the other options will send the voice macro to either a tell (using the person you have targeted as the recipient), group or raid. <br><br>To create your own voice macros, make a sound file using the same name as one of the existing voice macros, which can be found in your EverQuest>Voice>Default directory and place it in your EverQuest>Voice>User directory. <br><br>You can create hot keys of your favorite Voice Macros by selecting the macro you would like and clicking and holding on the Tell, Raid or Group button until the icon appears on your cursor. <br><br>We hope you enjoy this new way to immerse yourself into the EverQuest experience. <br><br>New Spell Slot <br>------------------- <br>For the first time in EQ, you can open up a new spell slot by learning the Mnemonic Retention AA ability. 9 Spell slots&#33; Wow, Why I remember in the early days of EQ, we only had 8 spell slots and we liked it. We cast spells all day, going uphill both ways. You whippersnappers have it easy =) <br><br>More Buff Slots <br>------------------- <br>If you find that you need more room for beneficial buffs on your character, activate the Mystical Attuning AA and open up more room in your buff slot window. <br><br>Live Changes <br>------------------- <br><br>Improved Customization for Graphics <br>------------------- <br>-There are now 3 sets of options (Spell, Environment, and Actor). All 3 sets have similar options that affect each type of particle. These options allow for more customization when setting up your display and filters. <br><br>-An "advanced" button has been added under the display tab in the options window. This will allow you to toggle some of the new settings, for our new customizable graphics and effects. You will most likely need to expand the options window to see the new Advanced button. <br><br>- Shadows; Toggles the new dynamic shadows. <br>- Water Swap*: Switches between old style water, and new reflective water the next time you zone. <br>- 2.X Pixel Shaders: Toggles the use of pixel shaders 2.0. <br>- 1.X Pixel Shaders: Toggles the use of pixel shaders 1.0. <br>- Vertex Shaders: Toggles the use of vertex shaders. <br>- Dynamic Update Interval: Control the CPU costs of the dynamic reflection by adjusting how often to update the reflection texture <br>- Dynamic Sky Reflection Size*: Allows you to control how large the reflection texture is. <br>(The * indicates a setting that will take effect next time you zone). <br><br>- You can now see real time shadows within the world of Norrath. Use the shadows option in options>Display>advanced to turn them off and on. Now, even when soloing, you will never be alone. Those of you with older video cards may have some performance issues when attempting to use shadows. If your machine does not meet the recommended system specifications, we suggest that you play with shadows off. <br><br>- Enjoy sunsets and moonrises viewed above EverQuest&#39;s new reflective water which is available for everyone, wherever there is static water, e.g. Oceans, seas and lakes. You can toggle the new water shaders on and off using the Water Swap button, under options>display>advanced. <br><br>Zoning Screen <br>------------------- <br>When zoning, you will now see the loading splash screen. You have not crashed, do not be alarmed. <br><br>New Improved Particles <br>------------------- <br>-You will now be affected by the environment around you, be sure to check out these effects especially under water, in frigid weather, dry climates and upon death. <br><br>Spells <br>------------------- <br>- Symbol and Aegolism spell lines no longer require reagents. Clerics and Paladins rejoice. <br>- Necromancer pets will no longer require peridots. <br>- The beastlord spell, Tureptan Spirit, now has a healing component. <br>- New transportation spells are available in the Abysmal Sea. Check with your transportation spell contact for more information. <br>- Bard PBAoE spells will no longer damage targets that are moving, however any other spell effects from the PBAoE spell will still be applied to the targets as usual. <br>- Beneficial spells can now be used in the EverQuest tutorial. <br><br>Skill Cap Changes <br>------------------- <br>- Piercing now caps at 250 at level 60 for warriors, rangers and beastlords. <br>- 1h Blunt and 2h Blunt now cap at 250 at level 60 for beastlords <br>- Druids and Bards that exceeded their tracking skill limits, have had their tracking skill reset to the appropriate value. <br><br>Items <br>------------------- <br>- The Timespinner pet will no longer cast spells. <br>- The Dagger of Death has had its AC value reduced. <br>- Some of the new Omens of War items will now display an "Attunable" attribute, which means that they can be traded freely until they become are equipped or augmented. Attunable augments will become no-drop flagged when added to an augment slot, attunable items will become no-drop when equipped. You will not be able to auto-equip an attunable item that has not been attuned to your character. Please be mindful of the new Attunable flag before equipping or augmenting new items. <br>- Some rogue items have had their backstab modifier changed. We found that the items with a 12% modifier correctly took backstab to the limit of the skill, while the 15% merely reached that same limit. The extra 3% was found to have no affect on the skill, so all of the items have been standardized at a 12% backstab modifier. <br><br>Alternate Advancement Abilities <br>------------------- <br>- Berserkers have received some new AAs. This should bring their AA selection up to par with comparable melee classes. <br>- Added the ability for shadow knights to train the Gates of Discord ability Improved Theft of Life and the Planes of Power ability Suspended Minion. <br>- The healing wards that priests can summon using their Gates of Discord AAs are now immune to most spells. <br>- Lowered the reuse time on the Magician ability Host of the Elements to 15 minutes. <br>- Added the ability to train Quick Damage to Magicians as a Luclin Class ability. <br>- Increased the critical hit chance for the Wizard Gates of Discord AA Frenzied Devastation. <br><br>Fan Faire <br>------------------- <br>We are proud to announce the Halloween, New Orleans Fan Faire&#33; The event dates are October 28-30, 2004, and space is going fast&#33; The last day to guarantee your spot by pre-registering is October 11th. For more information, please go to http://everquest.station.sony.com/fanfaire/. See you in New Orleans&#33; <br><br>UI Changes <br>------------------- <br>The following XML files are new or have been modified: <br><br>- EQUI_Animations.xml <br>- EQUI_BuffWindow.xml <br>- EQUI_CastSpellWnd.xml <br>- EQUI_DynamicZoneWnd.xml <br>- EQUI_GuildManagementWnd.xml <br>- EQUI_GuildTributeMasterWnd.xml <br>- EQUI_OptionsWindow.xml <br>- EQUI_TaskSelectWnd.xml <br>- EQUI_TaskWnd.xml <br>- EQUI_TitleWnd.xml <br>- EQUI_TributeBenefitWnd.xml <br>- EQUI_VoiceMacroWnd.xml <br>- EQUI.xml <br>- EQUI_AAWindow.xml <br>- EQUI_AdvancedDisplayOptionsWnd.xml <br><br>-- The EverQuest Team</font><br><br></td>
</tr>
<tr>
<td width="100%"><font size="2">- <a href="mailto:ronaldor@magecompendium.com">Ronaldor Vladimir</a></font><br><br></td>
</tr>
...
<hr color="#660066" size="20"><a id="fus_61" name=""><br>
<div align="center">
<center>
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%">
<tr>
