...
<BR>
Topic: <FONT COLOR="#00ff00">Mission Settings</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Stimmed on 01-03-2002 07:54 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I was just wondering what settings every1 does for missions to get the best items/tokens so what do u put the mission settings to?
...
Middle
Left
-- It gives 3 find item missions that also give tokens and the item isnt like a weird bomb/isotope. So it gives pretty good items...
...
all money
rest middle
--It also gives find item missions but no token but can get some better things, I beleive most Stigmas are found on this setting..

So what are ur settings and why?
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Mission Settings">
...
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000205.cgi">
