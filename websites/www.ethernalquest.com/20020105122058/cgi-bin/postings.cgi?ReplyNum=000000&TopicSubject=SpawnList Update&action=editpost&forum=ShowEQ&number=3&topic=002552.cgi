...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by ThePowerTool on 12-09-2001 02:28 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I have the latest SEQ3.1.2 running.  It updates showing mobs in the zone with level detail.

I've noticed a discrepancy between mobs shown on the map and mobs registered in the SpawnList.

1.  The SpawnList doesn't have an "all" any more.
2.  The NPC section of the SpawnList doesn't show all NPCs in the zone (that appear on the map).
3.  I can hold my mouse over some NPCs, see correct name, level, and other details, but when I look at the SpawnList, it's not there.

I noticed this first when I was searching for Guard Leif recently (shawl quest).  I knew roughly where he was, but was putting SEQ through it's paces.  I noticed Guard Leif appeared on the map and I could hold my cursor over him and see the information display correctly.  I also noticed that Guard Leif didn't appear in the SpawnList.  Next, I targeted Guard Leif and hit "c" -- which selected Guard Leif on the map, but didn't show him in the SpawnList (because the SpawnList didn't have his name).  This left me confused.  If SEQ has the data to display in a "mouseover," why doesn't it have the data show in the SpawnList.

I've searched quite a bit using 'SpawnList', but found nothing like this problem reported.

Thanks in advance for the help!</TEXTAREA>
</td></tr>
