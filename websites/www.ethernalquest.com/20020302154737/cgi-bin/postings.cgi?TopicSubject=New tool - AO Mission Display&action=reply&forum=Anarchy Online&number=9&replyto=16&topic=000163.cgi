...
[B]well, you could always write the app to not use WinPcap/Packetx by monitoring the Winsock Send/SendTo/Recv/RecvFrom functions.. perhaps you could use the DLL from a packet sniffer/editor to work with AOMD.. i will give it a try right now[/B][/QUOTE]
