...
<td align=center>
<table border=0>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Forum:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">HackersQuest Main Forum</FONT></td></tr>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Tzung Macro?</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Tzung Macro?">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="HackersQuest Main Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="004098.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Tru2game99</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I jus reformatted my computer, anyone with the old school Tzung Macro ? My email is shocke8308@hotmail.com <P>------------------<BR>Never fight a dummy.  He will pull you down to his level and beat you with experience</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Kuku_for_Koko</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Dunno if it still works but here's a link.<P>http://eqsimx.hypermart.net/files.html<P>Also try Xylobot</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Cartmage</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">it still works, its just a PITA to get to work on windowsME<P>EDIT: A little info on getting it to work on windowsME.. If you try to rename/replace anything in the windows\system file winME will change it back to normal within 3 seconds..  now there is a long pain in the ass way to turn this off, but it is much more simple to do the following:<P>make a copy of dinput.dll that is in your windows/system folder...  rename it to dinput2.dll like it says in the instructions from Tzung, but then DO NOT put it back in the windows\system folder...  instead put the new dinput2.dll and the dinput.dll from tzung directly into your everquest folder.<P>works like a charm   <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif"><P>[This message has been edited by Cartmage (edited 10-04-2001).]<p>[This message has been edited by Cartmage (edited 10-04-2001).]</FONT></TD></TR></TABLE>
</FONT>
