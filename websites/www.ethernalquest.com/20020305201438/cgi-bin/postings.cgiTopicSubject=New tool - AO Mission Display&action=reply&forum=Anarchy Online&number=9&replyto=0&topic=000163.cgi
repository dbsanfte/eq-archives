...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Muzzleflash:
[B]Hi,

I've created a new tool that helps with getting the missions you want. It displays a summary of all missions currently being offered by the mission generator, to save time when you're hunting for a particular item you're after.

I've got it working on my machine, but was wondering if someone else could give it a try, and let me know if it works properly.

It is available at my web site: [URL=http://muzzleflash.da.ru]http://muzzleflash.da.ru[/URL] 

Rgds,
Muzzleflash


[This message has been edited by Muzzleflash (edited 12-07-2001).][/B][/QUOTE]
