...
<BR>
Topic: <FONT COLOR="#00ff00">Odin's Eye - Part 06</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Slicer on 12-03-2001 04:30 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Cleaned up a few minor things.. I'm now ready for a few alpha testers. If you want to alpha test, make sure that you have installed RedHat 7.2 and downloaded and compiled Qt 3.0 as per earlier instructions, then come on IRC and talk to me.
Once we go Beta, you'll be able to use any distro, but at the moment RH 7.2 is a requirement, not an option.
</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Odin's Eye - Part 06">
...
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000031.cgi">
