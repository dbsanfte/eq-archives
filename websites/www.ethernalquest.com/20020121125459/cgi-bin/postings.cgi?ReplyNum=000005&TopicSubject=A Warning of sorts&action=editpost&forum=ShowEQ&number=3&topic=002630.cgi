...
<BR>
Topic: <FONT COLOR="#00ff00">A Warning of sorts</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Ratt on 12-29-2001 10:14 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">If that were the case, it would have happened already.

The fact of the matter is, the ones wanting to make money off of it are too technically inept to do much but follow Adenine's guide to installing SEQ.

SEQ v4.x or even 3.x are NOT hard to install for the moderately competent person, the current rash of "it's too hard" will die down once everything gets into place and an established protocol for updating your system is devised.

If anything, it prevents the cocksuckers selling SEQ on Ebay from doing so, which is a good thing.

In fact, there should be a message that comes up with SEQ stating that if you paid for SEQ in any way, you got ripped off...
