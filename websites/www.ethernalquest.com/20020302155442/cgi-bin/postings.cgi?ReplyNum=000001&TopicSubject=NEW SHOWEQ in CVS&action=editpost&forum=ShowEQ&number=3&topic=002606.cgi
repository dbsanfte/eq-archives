...
<BR>
Topic: <FONT COLOR="#00ff00">NEW SHOWEQ in CVS</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Beaver3 on 12-20-2001 05:06 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Just downloaded it, compiled it (no problems on a Mandrake 8.1 box. I had followed the mandrake guide before).

But starting it, it still says Disabling decoder due to showeq.conf preferences. ***DECRYPTATION DISABLED***

...

Hmm, never mind. Its still saying version 3.1.2 when I try and start it. Guess something wasnt right after all.</TEXTAREA>
</td></tr>
