...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">AO Mission Display v1.2</FONT></td></tr></table>
</td></tr>
...
is there a way to make it show the "item to be found", since that's usually the more valued item?
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Muzzleflash</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Firstly, *huge* thanks to Gloog for showing me how to access item descriptions from AO directly. This has allowed me to release v1.2 which does away with maintaining a separate item database, and you will no longer get 'Unknown' items.<P>You can download it from:<BR> <A HREF="http://muzzleflash.da.ru" TARGET=_blank>http://muzzleflash.da.ru</A> <BR></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">seniordingdong</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">hey bro, im almost done with my DLL hook for wsock32.dll and you should be able to parse out mission info from incoming packets with it.. i dont know about how bad the lag will be, etc, but it should work with all AO installations (might have to change some stuff around for win9x wsock32.dll if its different from w2k)</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Supreme</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">is there anyway to have one for 56k users aswell?</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">ReetBob</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">this kicks ass<P>is there a way to make it show the "item to be found", since that's usually the more valued item?<P></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Zerosignal</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">for some reason the program crashes after sorting the 4th mission, just about everytime.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Zerosignal</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">AOMD caused an invalid page fault in<BR>module AOMD.DLL at 0167:1000139a.<BR>Registers:<BR>EAX=000010ba CS=0167 EIP=1000139a EFLGS=00010217<BR>EBX=fffffffe SS=016f ESP=0219ff30 EBP=0000003c<BR>ECX=3fffb17e DS=016f ESI=01807c94 FS=760f<BR>EDX=fffffffe ES=016f EDI=10020000 GS=0000<BR>Bytes at CS:EIP:<BR>f3 a5 8b cb 83 e1 03 81 fd de 05 00 00 f3 a4 a3 <BR>Stack dump:<BR>00000012 017f4240 00000000 0000003c 01399770 00000000 017f4240 017f4252 01900a90 00000000 100012e0 00000000 017f428e 01399b12 01900a90 00000000 </FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">FirstHit</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">AOMD only show the 1st Missionreward.<BR>The fields for mission 2-5 stay empty.<P>I use Win2k sp2 and tried it with WinPcap2.2 and WinPcap2.3beta.<P>Any idea ?<BR>Maybe the Client13.4 changed something ?</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Kir</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">No, i have got the same problem with the patch 13.2, only the first mission is displayed. AOMD works, but it didnt ever show me more than one mission at a time.<P>Win2K SP2 <BR>WinpCap 2.2 & beta 2.3<BR>packetX etc... <BR>On my DLINK 530TX <BR>or on my virtual PPPoE device (ADSL)<BR></FONT></TD></TR></TABLE>
</FONT>
