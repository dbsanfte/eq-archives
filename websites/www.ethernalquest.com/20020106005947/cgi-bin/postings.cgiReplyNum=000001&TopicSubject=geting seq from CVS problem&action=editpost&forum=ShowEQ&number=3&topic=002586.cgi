...
<BR>
Topic: <FONT COLOR="#00ff00">geting seq from CVS problem</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by ThePowerTool on 12-17-2001 05:37 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Looks like you might need to install CVS.

Did you do a full development server install of Mandrake?  I've noticed if you aren't careful about selecting this during the install, you can run into significant problems getting SEQ to compile.  There are other posts here that cover this.
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="geting seq from CVS problem">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000001">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002586.cgi">
