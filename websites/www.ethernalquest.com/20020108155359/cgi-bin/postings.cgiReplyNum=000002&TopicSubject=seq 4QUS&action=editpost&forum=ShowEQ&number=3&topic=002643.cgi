...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by joojooga on 01-03-2002 06:07 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">There's an idiot's guide posted that should work for all 7.x releases.

Give it a whirl verbatim.</TEXTAREA>
</td></tr>
