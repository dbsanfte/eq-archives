...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by sickboy on 12-09-2001 02:03 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Go into your Windows\System or Windows\System32 directory (whichever has the file PacketX.DLL) and type 'regsvr32 /u PacketX.DLL', then delete the file
type 'regsvr32 /u PacketX.DLL' where ?</TEXTAREA>
</td></tr>
