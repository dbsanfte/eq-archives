...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Ratt on 12-12-2001 12:04 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Getting much longer in the encryption key length is problematical from a legal standpoint as well as a technical one.

There's better solutions than that at this point, but they all come with associated baggage that Verant may not want to take on the burden of.

Regardless, as I've said before, the key will get to the client, one way or another, and because of that simple fact, they can never, really, have totally secure communications.

Eliminating SEQ is going to be virutally impossible, it's just the nature of the beast.  Reducing it's usefulness... there's an avenue they are currently exploring.  As I've already demonstrated, I'm willing to work with them on certain content related issues, such as expansions, etc...  It will make thier life easier, and our life easier.  It's only a real benefit to them, however, as SEQ has effectively unlimited resources to throw at a problem, Verant, even backed by Sony, does not.

It's fairly interesting they've turned to guerilla tactics to harass SEQ, as opposed to the brute force frontal attack, which simply can't work given a long enough time frame.  Guerilla tactics won't work either, for the most part.</TEXTAREA>
</td></tr>
