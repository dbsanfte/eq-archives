...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by seniordingdong on 12-18-2001 11:43 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">OMG duh, that is a good idea. I am an idiot.. always taking the hard way  [IMG]http://www.ethernalquest.com/ubb/wink.gif[/IMG] my winsock hook isin't working yet.. but it would just be simple, hook only the necessary functions like Send and Recv to parse the packets, but right now I could really use the help of a good programmer (c++) to look over my DLL and tell me why it doesnt work.. i even went to the trouble of getting the ordinals the same for all the exports.. i think theproblem lies in wsock32.dll itself, as its basically a wrapper.. it points to ws2_32.dll and winsock.dll for virtually all functions anyways.. i can mail you my source, even if you just want to take a look..
orange@archaeology.csumb.edu</TEXTAREA>
</td></tr>
