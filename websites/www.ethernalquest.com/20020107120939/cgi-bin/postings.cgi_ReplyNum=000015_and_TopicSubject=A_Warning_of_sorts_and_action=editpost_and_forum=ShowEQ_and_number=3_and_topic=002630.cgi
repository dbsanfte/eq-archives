...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Monchichi on 01-02-2002 01:06 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Yeah right dude, go back to your can of paint chips.  There alreadu *IS* a concise guide to installing SEQ 4 from at least a Redhat 7.1 / 7.2 distro, and honestly.. if someone is so slow they can't follow those instructions to get SEQ running on a fresh installation of SEQ they should check into quitting EQ alltogether if they can't play without the crutches.</TEXTAREA>
</td></tr>
