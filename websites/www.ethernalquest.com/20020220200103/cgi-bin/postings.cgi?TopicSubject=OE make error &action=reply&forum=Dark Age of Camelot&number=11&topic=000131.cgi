...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">OE make error </FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="OE make error ">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Dark Age of Camelot">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="11">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000131.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">p1nkfl0yd</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">/usr/bin/ld: cannot find -lglut<BR>collect2: ld returned 1 exit status<BR>make: *** [odinseye] Error 1<P>BTW- I'm on Mandrake and im pretty sure I have Glut installed because previously i was getting a Glut.h error but that cleared up *shrug*<P></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Suse</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">well i am a n00b when it comes to unix and make-stuff but i think u should recheck all the mesa and glut stuff for ur installation. if u installed it and the compiler cant find it it might not be installed correctly in ur lib path. also there seems to be a diff between mesa-dev and mesa (or glut and glut-dev) which i dont exactly know because i installed all to be safe (using Suse 7.1 myself)   <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif"><P>..but not sure on all of that (just a rough guess)   <IMG SRC="http://www.ethernalquest.com/ubb/wink.gif"><p>[This message has been edited by Suse (edited 01-08-2002).]</FONT></TD></TR></TABLE>
</FONT>
