...
<BR>
Topic: <FONT COLOR="#00ff00">Problem with EmuLog</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by HawaiianCow on 12-18-2001 01:08 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">eqhost.txt file...

There seems to be 2 kinds of these... I tried putting the new eqhost.txt in my EthernalQuest folder. It works just as fine as deleting the eqhost.txt... If you delete the eqhost.txt, it automatically generates a new file that just has the main address of the 989 studios login server.

conclusion- i somehow doubt that eqhost.txt is the cause of the problem. but try deleting it anyway, does no harm, maybe it just might work.
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Problem with EmuLog">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="EthernalQuest">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000010">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="2">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002696.cgi">
