...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Verant_Hater_II on 01-05-2002 06:04 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">No, its true. Those companies are about to catch a lot of heat. I read it on FoxNEWS.

Im checking for trojans now then uninstalling Kazaa. You have a nice programs, then god damn assholes have to fuck it up. Kinda like EQ!</TEXTAREA>
</td></tr>
