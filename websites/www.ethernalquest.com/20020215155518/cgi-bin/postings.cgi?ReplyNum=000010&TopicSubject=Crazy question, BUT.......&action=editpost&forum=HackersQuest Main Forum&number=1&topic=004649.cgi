...
<BR>
Topic: <FONT COLOR="#00ff00">Crazy question, BUT.......</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by LincolnsAura on 01-05-2002 11:15 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">nah, i just want to "deathmatch" it, or maybe do a capture the flag sorta thing, no zoning, or any crap like that.

ok, so EQinside for the textures!

maybe zoneconverter for the zone layout? then 3d studio max or something to convert again? dunno... any ideas?

thanks again for helpful info

|_ /\

edit: tux, does your site have the newest version of zoneconverter and eqinside?

[This message has been edited by LincolnsAura (edited 01-05-2002).]</TEXTAREA>
</td></tr>
