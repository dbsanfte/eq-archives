...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">MACROS?</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by NeoGodzilla:
[B]Go to the About Box and double click on the Insight Image and a name/serial box will appear. Hopefully this helps you out  :)
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="MACROS?">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Dark Age of Camelot">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="11">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000011.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">wertwert</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Any way to have the `1` button pushed automatically every 2 minutes?  I've tried the Tzung macro program for EQ (in XP) to no avail.... any idea how to get this to work?  Anyone had any succcess?<P>TRADESKILLS ARE A BITCH.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Tzung_the_Banned</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Is that old program still around???</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Willremainnameless</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">LOL tzung it still works with eq..... =) so ya its stil laroud nworks on xp just fine for me Wert</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">DestinyX</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Need to change the scan code for most keys to H28 in order to simulate a keyboard event in DAoC, if you can do that with your program.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">wertwert</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I don't want it to work with EQ, i want it to work with DAoC =)  Has anyone SUCCESSFULLY tried it?<P>What's the deal with scan-codes and needing to change them, destinyX??</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">wertwert</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">What i mean to say is, has anyone gotten ANY type of keypressing program to work with Camelog? (not just Tzung's)<P>Tradeskilling really is a bore =/</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">DestinyX</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Yes, I can simulate any keypress in DAoC.  Not sure what the scan code is.  Just know it's not normally H28 so you have to change it to that in the API function used to simulate keyboard events.<P>If you like Ill whip up a simple macro program, nothing fancy though.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Willremainnameless</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">plz do =)</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">HackieSmackie</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I would like a copy of it as well. <P>Thanks!</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Xandar</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Any updates DestinyX ?</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">DestinyX</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial"> <A HREF="http://kinist.hypermart.net/DAoC/KeyboardMacroPlayer2Setup.exe" TARGET=_blank>http://kinist.hypermart.net/DAoC/KeyboardMacroPlayer2Setup.exe</A> </FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">phazer</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I did some quick tests with Macro Express 2000 (you can download it from download.com (and astalavista.box.sk has a key generator)) which appears to work quite well with pretty much every program. This should work very well for all crafters, you can make multiple macros with different delays and loops..<P>I made a test macro (ctrl+f12):<P>&lt;REP3:01:000001:000001:0010:0:01:&gt;8&lt;DELAY:10.00&gt;&lt;ENDREP&gt;<P>Which means: Repeat (10x) key '8', wait 10 sec.<BR>Adjust the repeat and delay as needed.<BR></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">NetWalker</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Hmm .. Where can I apply the key to Macro Express ? Sorry for the stupid question.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">NeoGodzilla</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Go to the About Box and double click on the Insight Image and a name/serial box will appear. Hopefully this helps you out  <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif"><P>-NeoGodzilla</FONT></TD></TR></TABLE>
</FONT>
