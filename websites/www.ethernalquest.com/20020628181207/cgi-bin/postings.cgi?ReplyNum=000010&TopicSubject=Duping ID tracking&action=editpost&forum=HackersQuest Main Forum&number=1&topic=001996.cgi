...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by JustSomeChump on 02-09-2001 01:49 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Well,

back before the *synchronization delay* I had a blast with my 2 accounts, 2 PC's, cable modem and lots of free time.

One of my favorite items to dupe were exp giving quest items. The temple ro items were really good to this end. Spend time to get the item it, dupe it and start turning em in.

In the end that's probably what sank me. I was tossed because I was monitored using the sow hack. Me and the GM had a nice discussion about bugs/cheats/dupes etc.. now the interesting thing is, at the time I was under *suspect* as he put it, for suspicious activity, but they had no proof.

I found it hard to believe they weren't able to track the duping of quest items, but in fact, it's was just probably easier to catch me running at light speed, then to parse huge trading/selling logs.

I think they've updated their monitoring procedures since then, so be careful. Best advice, just don't go nuts with it. Stick to unpopulated zones and dupe mundane non stackables.

JSC
--You'll never believe this, it must be a bug, a had 2 druids cast Spirit of Cheetah on me and they stacked.
**You were running faster than SOC my friend.
--Would you believe Spirit of Ferrari?

**Little snip from my conversation with GM** +)
