...
<BR>
Topic: <FONT COLOR="#00ff00">Small problem with EQW</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Dante_00 on 12-17-2001 10:21 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Since I downloaded EQW2.2, it's been working fine.  However, as of yesterday, I open EQW, and it opens up with a title bar and a frame (like it usually does when it's loading up the EULA accept/decline screen inside the frame), then after a few seconds, I get an error message saying "CreateSurface (Primary) failed! (88760091)", and EQW shuts down.  Rebooting does nothing, re-installing EQW does nothing.

Anyone have any ideas?  I really miss being able to use EQW :/  Thanks in advance.</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Small problem with EQW">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="HackersQuest Main Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000000">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="004556.cgi">
