...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by aidanz2 on 12-16-2001 12:18 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Whenever i try to acess the server to get SEQ it wont let me login. I do the  export CVSROOT= :pserver:anonymous@cvs.seq.sourceforge.net:/cvsroot/seq
and then when i type in cvs login it says it is an invalid commmand. I'm currently on mandrake 8.1. A little help wopuld be apreciated</TEXTAREA>
</td></tr>
