...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by darkangelx on 12-18-2001 08:30 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">welp mine works 100% latest patch and maps look for my thread on latest SEQ3.1.2.tar.gz

but yes exp window seems to be the only one not working at the moment</TEXTAREA>
</td></tr>
