...
<BR>
Topic: <FONT COLOR="#00ff00">DXWINDOWS   FOR    DUMMIES</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by punk on 02-02-2001 06:00 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">can you stop all typing from copying ot EQ when in another window?</TEXTAREA>
</td></tr>
