...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by HawaiianCow on 12-18-2001 12:59 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">try reading through my how to on this link... i've updated it recently, so some new problems and possible fixes have been added to the post.

http://www.ethernalquest.com/ubb/Forum2/HTML/002662.html

HC

DrMadd- I think your using the emulogin.exe... try using the emulog instead. the emulogin is for hackersquest server which does not seem to be online, or working properly.

-For those of you experiencing an EQHOST error after login/password screen, try deleting the EQHOST.txt file from your directory.</TEXTAREA>
</td></tr>
