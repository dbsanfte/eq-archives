...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by batsmacker on 12-12-2001 04:05 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Its realy pretty simple.
from what I understand Ratt is not the only one with the libeq.a source code. 

libeq.a source is gonna get leaked and then its all over.

SEQ for windows need I say more.
you go from 1% of the user base useing it to 50%+ overnight.

If I was Verant, I would leave us the hell alone.
