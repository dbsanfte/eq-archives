...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Gilgalaad on 12-08-2001 03:00 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Is this program works with an ADSL connection ?
I didnt been able to use this program. Only NdisWan adapter and Netgear are listed, not my network card...
