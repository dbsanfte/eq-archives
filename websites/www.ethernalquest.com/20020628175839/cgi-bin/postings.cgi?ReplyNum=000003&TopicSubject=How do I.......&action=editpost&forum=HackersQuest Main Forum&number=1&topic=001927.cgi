...
<BR>
Topic: <FONT COLOR="#00ff00">How do I.......</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Spider_Monkey on 01-25-2001 08:45 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Well I will disapoint.....

It converts the zones into a 3d model that can be viewed in another aplication, as far as off line exploration, not really. for that you can use the emulation server.

the zone converter has documentation that will explain what it does and how to use it.
