...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Hooking Camelot's DX Interface.</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Hooking Camelot's DX Interface.">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Panduck</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Has anyone been able to hook Camelot's DX Interface yet?  <P>I've been trying to hook the call to create the interface.  I've scanned the IATs of all the .bins, .dlls, .exes in the Camelot folder and the closest import I could find was a DirectDrawEnumerateA off DDRAW.DLL from game.dll.  Unless DirectDrawEnumerateA has some super-powers I'm not aware of, I think I'm missing something.<P>I've hooked LoadLibrary and GetProcAddress API calls and ran the game (Just for the hell of it), as well, and I don't think I've gotten anything either, though I should check again to make sure.<P><P>------------------<BR>Fueled by Orange Juice.</FONT></TD></TR></TABLE>
</FONT>
