...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Lunix on 01-06-2002 04:41 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I always get this error when i do a make for showeq. Yet i did ./configure -thread and it said i was supporting threads but then when i did my make it said I wasn't then at the very end it gives me this error. Anyone know what the problem is?

qt:
./configure -thread
   Worked fine threads said support ok
make
   Told me at the begiing threads wernt supported

seq:
make install
   At the end gave me an error
