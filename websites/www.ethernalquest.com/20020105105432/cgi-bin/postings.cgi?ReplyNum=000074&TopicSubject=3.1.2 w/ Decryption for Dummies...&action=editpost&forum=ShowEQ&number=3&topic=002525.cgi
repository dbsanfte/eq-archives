...
<BR>
Topic: <FONT COLOR="#00ff00">3.1.2 w/ Decryption for Dummies...</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by RH-n00b on 12-05-2001 11:39 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Dark, is that tar complete to run on RH7.2 or do I still need to fish around for some additional files?

-thx for the help so far</TEXTAREA>
</td></tr>
