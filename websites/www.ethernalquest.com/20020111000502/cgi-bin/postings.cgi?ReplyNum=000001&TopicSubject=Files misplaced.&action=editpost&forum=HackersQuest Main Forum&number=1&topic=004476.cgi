...
<BR>
Topic: <FONT COLOR="#00ff00">Files misplaced.</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Les on 12-06-2001 04:02 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Yeah there is. Check your shortcut and make sure it's pointing to the right directory. The only time it patches all the files to desktop is in this scenario.</TEXTAREA>
</td></tr>
