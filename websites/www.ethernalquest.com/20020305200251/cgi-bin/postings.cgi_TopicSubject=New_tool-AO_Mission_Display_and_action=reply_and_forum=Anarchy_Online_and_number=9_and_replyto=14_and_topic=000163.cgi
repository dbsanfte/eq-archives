...
[B]I deleted both packet.dll and packetx.dll then installed wincap and packetx then ran the ao mission term program selected the second option and the program opened but never worked.  I am guessing it is because I am not running wincap but I do not see where you can run it I installed it but nothing seemed to happen that I can see.[/B][/QUOTE]
