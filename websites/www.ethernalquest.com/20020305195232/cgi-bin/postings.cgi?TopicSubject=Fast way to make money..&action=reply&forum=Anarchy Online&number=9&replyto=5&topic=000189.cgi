...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Megabio:
[B]Since they modified the stores. At first we could only buy from Map/Cluster, et cetera, but now we just cannot buy your clothes, nanos, and implant augmentations.   [IMG]http://www.ethernalquest.com/ubb/smile.gif[/IMG] 
~Chris[/B][/QUOTE]
