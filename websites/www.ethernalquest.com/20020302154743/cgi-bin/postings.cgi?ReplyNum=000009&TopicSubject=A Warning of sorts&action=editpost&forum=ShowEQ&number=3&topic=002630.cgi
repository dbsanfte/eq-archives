...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Povarian on 12-30-2001 06:40 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> This is exactly what I said a month ago in these threads and in sourceforge. WINSEQ will raise the user percentage of SEQ from about 2% (if that) to about 30% or more. This will turn heads. and its easy for them to change some of the decyrptions on a weekly basis. Are they fixable? yes. But usually takes a week to get them down. Now the devs will have to chase their tail to keep up with the new opcodes and whatnot. VI isn't at war with SEQ and probably could care less because of the small percentage that have it working and use it. What I am hoping for is that after a few changes the people who developed WINSEQ won't have the patience to keep up with the updates and it will fail. If this happens I for one will be smiling. Ratt and the others at sourceforge made something nice and available without crossing the line.

And a note to the WINSEQ people here and in Sourceforge, Please get your own MB. This is not a place for you to debate. This is a Linux SEQ support forum.</TEXTAREA>
</td></tr>
