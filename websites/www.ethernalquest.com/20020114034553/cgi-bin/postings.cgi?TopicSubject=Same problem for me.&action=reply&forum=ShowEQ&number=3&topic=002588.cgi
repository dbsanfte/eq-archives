...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Same problem for me.</FONT></td></tr></table>
</td></tr>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">fuqjak</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I am experiencing the same problem where everything shows up in the zone but is not listed in the spawn list.  If I zone and come back SOMETIMES that seems to fix the problem.  Is this a decoding problem or just a random occurence?<P>Thanks for all the great help and the Awesome program. I am in AWE of your "l33t Skillz"</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">fuqjak</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">So sorry - this should be under the Spawn List problem...Hit the wrong button.<P>Damn stupid newbie......(that would be me)...</FONT></TD></TR></TABLE>
</FONT>
