...
<BR>
Topic: <FONT COLOR="#00ff00">dropping the no drop</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Biocraze on 11-20-2001 10:58 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Got Cable!  How do you slow the connection speed.  Also Speedhack program allows you to slow packets as well as increase them.(from my understanding) I tried this a few times before the patch but the lag I created was as if it was lagging only on my system.  Can this be used to create lag or can the speedhack program not be used anymore with the new patch.  Is there still a use for creating lag? I've also heard of a "respectable" guild inside of AO and I would be interested in joining. If you know who you are drop me an email.</TEXTAREA>
</td></tr>
