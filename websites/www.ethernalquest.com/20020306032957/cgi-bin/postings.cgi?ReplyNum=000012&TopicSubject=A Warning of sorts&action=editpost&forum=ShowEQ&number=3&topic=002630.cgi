...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Ancient_Cyclops_001 on 01-01-2002 02:20 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Actually, I've recently come across what appears to be WinShowEQ on an obscure website. Won't post the link here out of deference to popular opinion - but the file was about 733kb in size, zipped. No binary was included - it appears to be a lump of source. I haven't compiled it as of yet, but I thought it was an interesting find.

I may play with it a bit later just to see if it's worth a damn...
