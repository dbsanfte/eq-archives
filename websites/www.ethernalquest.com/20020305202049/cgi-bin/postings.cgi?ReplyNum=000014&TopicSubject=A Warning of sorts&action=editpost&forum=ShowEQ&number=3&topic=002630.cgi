...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by SNEAKY on 01-01-2002 08:32 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Of all the people I know that run SEQ (about 30) only ONE uses their linux box for something else. By making SEQ more complicated to install (and it is VASTLY more complex because none of the Linux Distros come complete with all the RPMs. I could load a new load of redhat 7.0 AND SEQ from scratch in about 90 minutes. I have tried 5 times to get version 4 working and always I have errors. I don;t know if it is something I am doing OR bugs in the CVS version or bugs in the RPMs or what. People are getting frustrated. Even though many people have posted guides and tips on this and the new SEQ message boards, they are confusing or incomplete. Some of them even contradict themselves. 

By maiking statements like "if you can't get it running, you shouldn't be using it" you are playing right into the hands of the WINSEQ developers. They WILL make a WINSEQ and it WILL impact SEQ

All someone has to do is post a CONCISE guide on how to make it work, (adding steps for redhat and mandrake) and the problem would be virtually eliminated. If you think for a minute that you are preventing something by making the install complicated and time consuming you are only going to destroy SEQ. 

OR you could write a guide to making the 3.1.2 distro fully functional for those who dont care about CPU useage...</TEXTAREA>
</td></tr>
