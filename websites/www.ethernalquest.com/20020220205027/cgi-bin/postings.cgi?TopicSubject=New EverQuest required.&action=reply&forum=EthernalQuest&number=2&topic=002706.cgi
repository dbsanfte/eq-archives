...
<td align=center>
<table border=0>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Forum:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">EthernalQuest</FONT></td></tr>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">New EverQuest required.</FONT></td></tr></table>
</td></tr>
...
*HTML is OFF<BR>
<A HREF="http://www.hackersquest.org/ubb/ubbcode.html" target=_blank>*UBB Code is OFF</A><BR>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="New EverQuest required.">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="EthernalQuest">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="2">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002706.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">RivalTaunt</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I got the v2.2, But im getting a message new Everquest ver required. This is my first time.<BR>I downloaded the EmuLogin v2.2 [EMULOGIN v2.2] , Created a copy of my EQ folder, and exstracted the file there, and ran it. And i got the error. Any idea? what am i doing wrong?</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">HawaiianCow</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">[execute EMULOG.exe]<BR>EMULOG!<BR>ERROR: file = 1839104 | cmp = 2140160<BR>WRONG VERSION -- Please get the newest version of EverQuest!<P>-Download eqfiles.zip from this link. (Thanks EQMatrix)<BR>http://www.avalon.net/~cyberdoc/eqfiles.zip<P>-Unzip/extract the eqmain.dll and eqgame.exe in to your EthernalQuest directory.<P>HC</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">RivalTaunt</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Ok I did something i found in another forum, "how to get your own server running" It works, but how can i play with other people, also, I'm finding myself testting every #summonitem &lt;num&gt;, Is there a place where i can get a list of whats what on what number? I sorted em out best i could but still cant find swords., <P>I got this EmuLogin but get the following error, "File=2140160|cmp=1830912"<P>The server works great, i love it, now only if the link for the file that told me how to work it worked, I could summon monsters and stuff, also playing with others would be fun.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">HawaiianCow</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Use the Emulog that came with the EthernalQuest zip file. The Emulogin from the homepage of hackersquest is for the hackersquest EthernalQuest server login, but that obviously doesnt work so dont use it at all.<P>As for having other players connect, I don't think HackersQuest emulator has that ability. Try the AGX emulator. It's rumored to have connectivity (but people ghost instead of walk) and NPC's cannot move. AGX also has combat.<P>HC</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Rehmahd</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">It does have connectivity, and people sorta walk.</FONT></TD></TR></TABLE>
</FONT>
