...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by fodder on 12-15-2001 07:57 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Fantastic!!!  Works like a charm.  I would like to say I am impressed.
I do have one question.  When I exited DAoC and was looking at my OE machine I noticed a line
No Direct Render - This will be SLOW
I am guessing this is an OpenGL reference.  Maybe I am missing something (software wise) as I have a Riva128 in this box.  Any suggestions?
Again if you are looking for cons and coloring I will start to submit some if it will be helpfull.</TEXTAREA>
</td></tr>
