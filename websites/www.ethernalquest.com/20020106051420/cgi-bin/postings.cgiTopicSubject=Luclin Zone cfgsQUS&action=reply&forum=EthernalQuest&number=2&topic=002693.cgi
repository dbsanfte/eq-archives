...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Luclin Zone cfgs?</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Luclin Zone cfgs?">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="EthernalQuest">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="2">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002693.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Verbatim</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Anyone makin some Luclin cfgs, or is it possible? I was gonna download that old CFG program Scruffy made and try to make them but the link was broken =/ Not sure if it would even work though, since it really uses a whole new graphics engine...*shrug*</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Icon</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">That's not the only problem.  The new graphics are also 32-bit while the older models are all 16-bit.  Which adds a whole slew of complications.  It's also one of the reasons EQW broke.<P>Sorry.  Agx people are working hard at accepting luclin.  But I cannot guarantee anything as it is an *extremely* hard thing to do.<P>At least we don't have to take down 20 live popular servers for 30 or so hours while we update though  <IMG SRC="http://www.ethernalquest.com/ubb/wink.gif">.<P> - Icon<BR>------------------<BR>In memory of MasTerKeyZ.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Aerisweet</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Maybe I can help with the programming.  I know some stuff about it.  You interested?<P>Aerisweet</FONT></TD></TR></TABLE>
</FONT>
