...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">why i have not been around for a few weeks</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by seniordingdong:
[B]my internet provider decided to cancel my dialup account due to me owing them $260  [IMG]http://www.ethernalquest.com/ubb/wink.gif[/IMG]
as soon as I find a descent free/cheap ISP that supports my area, i will be back online and update aoloader to work with the current version of anarchy. on another note, I have successfully fixed my wsock32 proxy to inject itself between AO/winsock. im working on decoding the data stream so you can edit it, etc. i will probally make a standalone program to support configuration of the proxy dll, or simply a .cfg file to change the settings.[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="why i have not been around for a few weeks">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Anarchy Online">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="9">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000200.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">seniordingdong</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">my internet provider decided to cancel my dialup account due to me owing them $260  <IMG SRC="http://www.ethernalquest.com/ubb/wink.gif"><BR>as soon as I find a descent free/cheap ISP that supports my area, i will be back online and update aoloader to work with the current version of anarchy. on another note, I have successfully fixed my wsock32 proxy to inject itself between AO/winsock. im working on decoding the data stream so you can edit it, etc. i will probally make a standalone program to support configuration of the proxy dll, or simply a .cfg file to change the settings.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Exxon</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Sounds good...<BR>Keep it up  <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif"></FONT></TD></TR></TABLE>
</FONT>
