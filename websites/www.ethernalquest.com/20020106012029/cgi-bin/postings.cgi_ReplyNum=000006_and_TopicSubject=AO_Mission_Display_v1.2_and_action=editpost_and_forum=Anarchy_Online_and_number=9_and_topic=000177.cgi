...
<BR>
Topic: <FONT COLOR="#00ff00">AO Mission Display v1.2</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by FirstHit on 12-20-2001 11:34 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">AOMD only show the 1st Missionreward.
The fields for mission 2-5 stay empty.

I use Win2k sp2 and tried it with WinPcap2.2 and WinPcap2.3beta.

Any idea ?
Maybe the Client13.4 changed something ?</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="AO Mission Display v1.2">
