...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Neologic on 02-14-2001 02:07 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Hello everyone. I came across the site while searching for "EverQuest Server". I was interested in finding out if there were any way to setup our own servers "at home". I'm a network engineer by trade so I have access to resources and hardware. (not to mention my own "home" server). Anyway..enough about me. 
I've read a bit about the ability to dupe and I was hoping I could add my name to the list to receive info on how to do this. I love the game but damn it seems to take FOREVER to get anywhere...I don't mind a little extra "edge" if you know what I mean. 

Ciao,
Neologic

neologic@hotmail.com</TEXTAREA>
</td></tr>
