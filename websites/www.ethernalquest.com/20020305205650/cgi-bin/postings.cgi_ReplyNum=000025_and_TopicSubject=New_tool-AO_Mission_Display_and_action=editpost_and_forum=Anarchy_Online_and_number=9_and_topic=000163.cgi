...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Oz on 12-26-2001 06:54 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">When i try to run AOMD it says that i'm missing the required file AOMD.dll
What is the problem here?</TEXTAREA>
</td></tr>
