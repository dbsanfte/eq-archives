...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Need help with EverHack</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Need help with EverHack">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="HackersQuest Main Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="001998.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">LaZZer086</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have EverHack. I downloaded DxWindows so I have EverQuest running and I can run EverHack at the same time. What I need to know is how do you work EverHack. How do I use the item editor and imort the items onto my character. <IMG SRC="http://www.ethernalquest.org/ubb/confused.gif"> Anything about the program would greatly help me.<P>Thanks,<BR>LaZZer<P>p.s. If you want the program E-Mail me.  <IMG SRC="http://www.ethernalquest.org/ubb/wink.gif"></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Rahvin</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Everhack MC (mastercode, I assume what you're using) does not have the correct offsets, and therefore dosen't work at all. Furthermore, almost all of it's functions (including all item editing) don't do anything, not client controlled.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Fire</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Use the speed hack i posted, more safe.</FONT></TD></TR></TABLE>
</FONT>
