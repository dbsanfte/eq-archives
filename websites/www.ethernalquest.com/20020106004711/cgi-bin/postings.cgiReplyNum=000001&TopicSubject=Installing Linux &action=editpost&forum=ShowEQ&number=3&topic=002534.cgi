...
<BR>
Topic: <FONT COLOR="#00ff00">Installing Linux </FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by BlueAdept on 12-03-2001 03:34 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I really would suggest getting a book on linux and doing a bit of reading. 

You can also go to www.linuxdoc.org. They have a good selection of How-Tos and such.

It really is a good stable operating system. Too bad there are so many flavors of it and because of that, so many incompatibilities.

The 3 biggest seem to be Red Hat, BSD and Debian. I suggest Red Hat if your new to linux and want an easy SEQ install.

BTW if you are dual booting linux and 9x, you wont be able to run SEQ. SEQ requires a separate machine. 

Also, just do a full install of RH 7.1 or 7.2, it will pretty much take care of your partitions for you. Just boot off of the CD.</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Installing Linux ">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000001">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002534.cgi">
