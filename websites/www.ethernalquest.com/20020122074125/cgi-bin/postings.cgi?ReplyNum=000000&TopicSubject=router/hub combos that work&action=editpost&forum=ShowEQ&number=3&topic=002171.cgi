...
<BR>
Topic: <FONT COLOR="#00ff00">router/hub combos that work</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by eqismyaddiction on 09-05-2001 07:43 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I looked through the forum but did not see a post that would answer the question.

I was wondering if i could get a list of hub/router combos that work with showeq, and possibly a list of those that do not.

From personal experience, i can say that my Linksys setup is not working for me.
...
Linksys BEFSR11 (router)
    or
Linksys EFAH05W (4 port hub)</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="router/hub combos that work">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000000">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002171.cgi">
