...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">I have a confession and need some help</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="I have a confession and need some help">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002582.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">SNEAKY</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I don't know how to get and instal WGET. When I try to use it it tells me its an invalid command so I am assuming it is a utility that has to be installed. I am using redhat 7.0 and I can find no reference to it. I have some linux exp but apparently not enough. Any help would be appreciated</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Pratchett</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">SNEAKY.. im going to spare you the condisending tone ive read in some of your posts. Were not all perfect.<P>Go to http://www.rpmfind.net/linux/RPM/ and type in wget and search. Find the little green line that has your version of redhat and download the rpm.<P>Open GnoRPM in your system folder on the start menu thing &gt; programs &gt; system.<P>Click "install" button and click "add" button. Find your RPM file,  and select it.<P>Install the RPM and presto. wget works at command prompt.<P>-me</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">SNEAKY</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Thanks<P></FONT></TD></TR></TABLE>
</FONT>
