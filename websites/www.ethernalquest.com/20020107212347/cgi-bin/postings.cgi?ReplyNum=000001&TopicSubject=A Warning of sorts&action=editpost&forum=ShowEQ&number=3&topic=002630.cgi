...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by FrozenInTime on 12-29-2001 02:32 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I think it's good that SEQ actually requires some thought when it comes to installing.  Just learning to install it can teach others about an OS other than WinBlows and get them away from the point-and-click world.

If you can't work through the steps to install SEQ, then maybe you shouldn't be using it.  Ratt seems to like think that this is the way it should be, and in this regard I would have to agree with him.</TEXTAREA>
</td></tr>
