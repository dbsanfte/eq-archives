...
<BR>
Topic: <FONT COLOR="#00ff00">Mandrake 8.1 build woes</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by bsdnetman on 01-07-2002 06:17 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">&gt; i've also heard that doing "export 
&gt; CC=gcc-3.0.1" and "export CXX=g++-3.0.1"
&gt; helps  <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif">

Sorry to report that doesn't do it.  Seq will compile properly with the CC/CXX vars set, but Qt ignores them and will still use the gcc/g++ symlinks.  

It might be a good idea to 1) list this in the INSTALL file and 2) test for gcc 3.x libs in configure.  One of the posts here had compiling Qt with gcc 2.96 and then setting CC and CXX to build seq, but that didn't work for me.  

Anyway I got it running and it's fantastic!  Kudos to the entire seq team!  Now if I coud just get my wife of DAoC...  <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif"></TEXTAREA>
</td></tr>
