...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Famin:
[B]Thanks for making a mirror to the WinPcap file.

I've installed both WinPcap and AOMD and I can start the program without problems. It even sees my ethernet card.

But when I'm running the program and use the missions terminals.... Nothing Happens...

I get no items, no money rewards, no pictures.... nothing

Do you have any idea what could be the problem?[/B][/QUOTE]
