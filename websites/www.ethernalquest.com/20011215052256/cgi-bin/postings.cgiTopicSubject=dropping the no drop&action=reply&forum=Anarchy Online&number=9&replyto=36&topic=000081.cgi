...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">dropping the no drop</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Biocraze:
[B]Got Cable!  How do you slow the connection speed.  Also Speedhack program allows you to slow packets as well as increase them.(from my understanding) I tried this a few times before the patch but the lag I created was as if it was lagging only on my system.  Can this be used to create lag or can the speedhack program not be used anymore with the new patch.  Is there still a use for creating lag? I've also heard of a "respectable" guild inside of AO and I would be interested in joining. If you know who you are drop me an email.[/B][/QUOTE]
...
<A HREF="http://www.ethernalquest.com/ubb/Forum9/HTML/000081.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
