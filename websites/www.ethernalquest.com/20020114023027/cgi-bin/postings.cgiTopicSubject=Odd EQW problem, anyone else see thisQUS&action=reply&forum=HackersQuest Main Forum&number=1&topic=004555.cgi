...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Odd EQW problem, anyone else see this?</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Odd EQW problem, anyone else see this?">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="HackersQuest Main Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="004555.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Cradossk Trandoshan</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">EQW has been running great for me since the release. Now that I can get it full screen I don't even bother playing the old route heh. <P>Last night while zoning I alt tabbed out to look at something and got some super slowness in seeing a webpage. After that I tried to go back to EQW and couldn't get it to maximize. It stayed in the taskbar. So I CTRL-ALT-DEL, end task on it. I went to run it again and after the server screen it would hop down to the task bar and again I was unable to maximize it. I could hear the music and hear the character select screen even.  I rebooted. That didn't help. I re-unzipped EQW but nothing doing there either.  Anyone else have a similar problem and solve it? My next step will be to reinstall EQ then reinstall EQW but I'd rather not do that if I can help it.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">wildcard</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Sort of the same thing happened to me.  I click 'Start EQ' on the disclaimer, and EQW just appears minimized, though it's not.<P>Anyway, reinstalled it and nothing, thinking about reinstalling EQ just to see what happens.<P>Wildcard</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Cradossk Trandoshan</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I reinstalled EQ and that fixed it. Running like it was before. Some weird bug. </FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">wildcard</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Fancy that, I was hoping it wouldn't come to that.  I unfortunately only pull in about 4k a second from my dial up modem.  Time to hit up an old friend with DSL.<P>Wildcard</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Exoramm</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">The screen is not minimized.. What happens is the eqw.ini file gets updated somehow and changes your window position so that it is actually open but out of screen area, effectively taking it out of view. You can fix this by editing the eqw.ini file and resetting all window resolution start coordinates to x=0, y=0. Why this happens I don't know but it only happened to me once and I havent had a problem since. Hope it helps.</FONT></TD></TR></TABLE>
</FONT>
