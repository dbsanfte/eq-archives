...
<BR>
Topic: <FONT COLOR="#00ff00">To Verant (we know you read this stuff)</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by SNEAKY on 12-11-2001 09:33 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">OK so you keep breaking and we keep fixing. We know you read here to see if we have found a fix so you can break it again. That's fine, if you want to play we can play right along with you. There are more of us than there are of you. I only ask you to think about one thing...

While you are busy using your programmers talent trying to break a program that maybe 1% of your customers use, MOST of your players are suffering under huge zone lag, Constant link death, Screen freezing, content bugs and other problems. I am sure that your PAYING customers would LOVE to know that their money (and time) are being used to try to break SEQ on a daily basis instead of fixing the REAL problems with the game. 

Just food for thought. Do what you like..</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="To Verant (we know you read this stuff)">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000000">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002570.cgi">
