...
<BR>
Topic: <FONT COLOR="#00ff00">Recent EBAY Crackdown</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by anotherone on 01-18-2001 05:31 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Doesn't look like the crackdown is working.
 <A HREF="http://search.ebay.com/search/search.dll?MfcISAPICommand=GetResult&ht=1&SortProperty=MetaEndSort&query=everquest" TARGET=_blank>http://search.ebay.com/search/search.dll?MfcISAPICommand=GetRe sult&ht=1&SortProperty=MetaEndSort&query=everquest</A> 

Edit:
Actually most of the links are dead.



[This message has been edited by anotherone (edited 01-18-2001).]</TEXTAREA>
</td></tr>
