...
<BR>
Topic: <FONT COLOR="#00ff00">website (2)</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Rahvin on 02-10-2001 04:04 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">While everyone is looking here, please post -ANYTHING- you can think of that checks -DISTANCE- (mostly hackable). I'll start:

1. Melee Range (when attacking)
2. Ranged Attack (bow shot, thrown weaps)
3. Spell Range (Offensive, group/AoE don't think so)
4. Proximity to doors/switches/etc
5. Proximity to PC/NPCs for skills (bindwound,beg,disarm,etc)

Just can't think of many now</TEXTAREA>
</td></tr>
