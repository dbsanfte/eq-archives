...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Ice on 01-12-2001 03:53 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">To harass the actual GMs themselves  <IMG SRC="http://www.ethernalquest.org/ubb/wink.gif">

I know this may sound like one of those |33+ |-|4k0r ideas but, if the actual GMs (not the guides) are using ICQ at Verant headquarters,  you can download a program called "ICQ IP sniffer"  which gives you the IP of the ICQ user, regardless if they have the option to make it appear on or off.  Then you can use it for who knows what needs.  But then again, it wouldnt work if they had firewalls and im guessing Verant is not THAT stupid and would but some up.</TEXTAREA>
</td></tr>
