...
<BR>
Topic: <FONT COLOR="#00ff00">Problem detecting GCC</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by dkflt on 01-03-2002 06:26 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Fixed.. thought I included the -thread option in the compile for QT, but I guess I missed it.  I recompiled it just to be sure and SEQ built after that</TEXTAREA>
</td></tr>
