...
<BR>
Topic: <FONT COLOR="#00ff00">EQ Keyboard Macro</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Tzung_the_Banned on 05-31-2000 10:00 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">included the dxguid.lib.. and got a good link.. Thanks for ALL the help!  guess I will see if it works tonight while I play... 

If anyone is interested, maybe I can generalize it so that a CTRL + LETTER will turn on a one sec or so push and any number.. you just set up the hotboxes how you like..
