...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Cynical on 02-09-2001 02:33 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I do all my "Work" in Erudin.  There is on average of 3 people there.  if that.  And most of the time it's either a newbie traveling from erudin to qeynos. or someone from qeynos getting smithing supplies.

Pretty quiet place. And very little threat of mobs.(if any!)</TEXTAREA>
</td></tr>
