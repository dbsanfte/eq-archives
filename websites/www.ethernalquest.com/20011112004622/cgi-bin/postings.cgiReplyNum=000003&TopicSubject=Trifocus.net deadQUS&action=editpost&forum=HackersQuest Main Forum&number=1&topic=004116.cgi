...
<BR>
Topic: <FONT COLOR="#00ff00">Trifocus.net dead?</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by pballgi2 on 10-04-2001 08:59 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I drop by irc all the time. Irc is working fine its just I cant access the website it self.</TEXTAREA>
</td></tr>
