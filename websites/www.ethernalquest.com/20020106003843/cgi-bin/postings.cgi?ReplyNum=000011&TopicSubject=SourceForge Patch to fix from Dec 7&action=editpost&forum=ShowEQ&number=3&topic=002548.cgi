...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by linux n00b on 12-10-2001 07:55 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">all that does is rename the distributed (.dist) filters.conf.  has nothing to do on why i am still getting seg faults.  thanks for trying though. 
