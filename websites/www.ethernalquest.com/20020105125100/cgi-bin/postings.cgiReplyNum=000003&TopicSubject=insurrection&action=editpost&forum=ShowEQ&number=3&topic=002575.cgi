...
<BR>
Topic: <FONT COLOR="#00ff00">insurrection</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Povarian on 12-14-2001 05:30 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Oh thats cool =)
 just frustraded cause I've been crash coursing as much as I can and have a pregnant wife and work to deal with. I see what your saying. It is chaos. someone should Tar a full working one and just let the forum go a few days. Then those helping get more detailed. I know as I see stuff changed on sourceforge and I know whats going on I'll start doing like necro is doing. Kinda walkthrough the new code and changed. Then every so often (soon as I get one fully working) host a new tar every few changed. This way people learn abit and the new people have a place to start. I will gladly host a working tar. I have an ftp up and running now I could put it on. Then just post a new thread with the address and let everyone get up and going and we can re-start the chaos with fixes and whatnot from scratch instead of what we have in the last few threads. I may not be able to program yet but I can at least host a fully functional copy and all the latest maps included. I just recruited a C++ guru on EQ to load redhat on 2nd machine and study the code so he can help the devs. 

So anyone reading this. if you want to take the time to tar a working full version I will add all my maps and host it.</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="insurrection">
