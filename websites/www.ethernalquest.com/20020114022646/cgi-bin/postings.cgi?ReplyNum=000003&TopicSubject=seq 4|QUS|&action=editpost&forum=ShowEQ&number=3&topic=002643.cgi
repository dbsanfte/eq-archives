...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by SNEAKY on 01-03-2002 04:28 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">If you follow it verbatim you will be stopped cold in the first 3 lines. the FTP where the RPMS are listed gives a 404 error.</TEXTAREA>
</td></tr>
