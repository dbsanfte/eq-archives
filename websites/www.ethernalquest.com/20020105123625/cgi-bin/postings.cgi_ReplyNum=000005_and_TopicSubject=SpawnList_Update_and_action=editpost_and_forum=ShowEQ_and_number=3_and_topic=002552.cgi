...
<BR>
Topic: <FONT COLOR="#00ff00">SpawnList Update</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by ThePowerTool on 12-17-2001 01:26 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Now I notice that all NPCs under the SpawnList show in black text rather than their correct con color as they used to.  Have I again overlooked some setting?  I've combed through my showeq.conf without success.
