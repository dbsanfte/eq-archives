...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by hack_attack on 12-04-2001 10:48 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">well since right now all the emu is good for is a 3d map i say we set a site up and shit and have a little service whare people can connect to us and use it as a map so they dont have to worry about using them damn 2d maps that are harder then hell to work. ill make the site if you all want. i'm good with with html and shit. and i could make a site that was good looking lol.  well people tell me what ya think of this latter k bye

------------------
-------------------------
experenced hacker watch out</TEXTAREA>
</td></tr>
