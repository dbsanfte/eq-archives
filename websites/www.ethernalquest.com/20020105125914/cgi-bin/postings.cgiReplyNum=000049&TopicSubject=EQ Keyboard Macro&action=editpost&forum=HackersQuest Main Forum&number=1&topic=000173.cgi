...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by just some dude on 05-31-2000 10:35 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Ya that's pretty much how it works.  The mouse macro is just a basic thing I used to buy bandages, food, etc.  Every time you press CTRL P it will add 20 left button clicks and CTRL C will cancel all scheduled button clicks.  To use it just position the cursor over the purchase button and press CTRL P for each stack you want to buy.

The only problem is the button clicks have to be delayed a few frames for eq to recognize them (depending on how fast or slow your computer is going at the time).  For me 4 frames worked pretty well as long as there weren't a bunch of people standing around.</TEXTAREA>
</td></tr>
