...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Mission Settings</FONT></td></tr></table>
</td></tr>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Stimmed</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I was just wondering what settings every1 does for missions to get the best items/tokens so what do u put the mission settings to?<P>I normally go<P>Left<BR>Right<BR>Right<BR>Right<BR>Middle<BR>Left<BR>-- It gives 3 find item missions that also give tokens and the item isnt like a weird bomb/isotope. So it gives pretty good items...<P>also<P>all bad<BR>all money<BR>rest middle<BR>--It also gives find item missions but no token but can get some better things, I beleive most Stigmas are found on this setting..<P>So what are ur settings and why?<P></FONT></TD></TR></TABLE>
</FONT>
