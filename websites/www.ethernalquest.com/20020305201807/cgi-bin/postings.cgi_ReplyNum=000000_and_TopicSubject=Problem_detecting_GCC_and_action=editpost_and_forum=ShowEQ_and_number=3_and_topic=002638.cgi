...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by dkflt on 01-02-2002 01:24 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I downloaded all of the RPMs listed and tried to install them.  For most of the RPMs, RPM said they were already installed.  I did the 'ln --symbolic' commands and got all the way to where I have to run ./configure.  When I run that command though, it still claims that I dont have GCC 3 installed.

I queried RPM; it says GCC 3 is installed.  I ran 'gcc -dumpversion' and it looks good there too.  I'm running on RedHat 7.2, just installed.  Does anyone have any ideas on what is wrong ?
