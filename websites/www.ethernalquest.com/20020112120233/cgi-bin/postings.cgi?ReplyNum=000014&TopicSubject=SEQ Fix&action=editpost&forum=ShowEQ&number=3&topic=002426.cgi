...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by h0bbit on 11-12-2001 11:18 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Forgive me if this is a lame question, but I have everything (i think) working with 3.1.2 but its my first time using showEQ so im not sure. The spawnlist shows all unknowns except for new spawns? Is this how it works?</TEXTAREA>
</td></tr>
