...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by seniordingdong on 12-18-2001 12:44 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">sounds cool bro..
im working on a wsock32.dll hook (my dll is built, just not functioning right) that will hopefully open some doors to coding in AO packet stuff, etc.. i will let you know how it goes. im thinking about releasing the sourcecode very soon so that someone with some essential winsock/dll proxy knowledge can help me (its c++ btw)</TEXTAREA>
</td></tr>
