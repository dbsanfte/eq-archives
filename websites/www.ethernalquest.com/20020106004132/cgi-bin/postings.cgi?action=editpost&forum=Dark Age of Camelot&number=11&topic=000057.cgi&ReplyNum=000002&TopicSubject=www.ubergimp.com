...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by heiffer on 12-18-2001 11:57 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I don't think it's a scam.

Their pricing is out of whack though.  If they think a level in DAoC should cost as much as a level in EQ, they have some serious problems measuring time and effort.  There are lots of other people offering services like this for DAoC that are much more reasonably priced.

I really don't see why Mythic doesn't offer this feature at the login screen as some sort of "store" option.  They would make a fortune.  It's obvious people are willing to pay for it.  Imagine how many people would pay for it once the risk associated with gving up account and password is removed.

[This message has been edited by heiffer (edited 12-18-2001).]</TEXTAREA>
</td></tr>
