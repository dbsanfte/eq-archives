...
<BR>
Topic: <FONT COLOR="#00ff00">DaoC thoughts...</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Verant_Hater_II on 10-02-2001 03:06 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">this game sucks hard

"the quest system in beta is already a million times better than EQ"

NPCs tell you EXACTLY what they want you to do to finish a quest, go here go there go here go back to start, boom done quest. wow, so difficult!</TEXTAREA>
</td></tr>
