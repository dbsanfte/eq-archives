...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by MKaath on 12-21-2001 12:42 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">As I said before I want to make sure Funcom is OK with the idea of bots like these.  I hope they are, as it adds a good deal of enjoyment to people and reduces their coding.

If that's the case I'll release my Delphi AOChat component and an ActiveX so people don't have to dick around with the packet formats.  I've certainly been coding it in a nicely usable way oriented towards public release.  Dunno about releasing the actual bot code and database, but I probably could be convinced.  I certainly would if for some reason I stopped working on it.  Basically it's a pile of string parsing and database work, with the chat code it shouldn't take anyone more than a couple days to write. At least I don't need a UI, bleah!

Unfortunately if Funcom _doesn't_ like the idea then I'd be a bit more wary of making the chat interface more easily available.  I think OmniBot and my OmniAuction provide a quite useful service, regardless of Funcom's attitude, and would be hesitant to do anything that would endanger their existence.
