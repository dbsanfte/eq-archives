...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Program to change combat music</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Sixx0r:
[B]Title says it all...

download at: [URL=http://home.attbi.com/~sixx0r]http://home.attbi.com/~sixx0r[/URL] 

-Sixx



[This message has been edited by Sixx0r (edited 12-15-2001).][/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Program to change combat music">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Sixx0r</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Title says it all...<P>download at: <A HREF="http://home.attbi.com/~sixx0r" TARGET=_blank>http://home.attbi.com/~sixx0r</A> <P>-Sixx<P><p>[This message has been edited by Sixx0r (edited 12-15-2001).]</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Sparr</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Neat program.  I dont have the tools here to check if its legit so all you paranoid people out there will have to wait a bit to have someone post "its safe".</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Sixx0r</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Its a simple program, if yer paranoid, read the "readme.txt" i think it will dispell some of your fears.<P>if yer too lazy to do that, heres a summary.<P>Its 1 meg+ in size, because it combines the msvbvm60.dll and some ocx's in the exe file for easy distribution. <P>Included in the zip file is also the non-combined version which is 22k in size all you have to do is rename it from a .bak to a .exe and then run it. (purposly included for the paraniod, of which i am one)<P>And to go a step further, its compressed to stop lamers from hex'ing the strings. If you need it unpacked, im sure procdump will do you nicely.<P>enjoy, non-10minute version coming soon to allow changing many more songs.<P>-Sixx</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Sixx0r</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">also, failure to follow the steps outlined in the "readme.txt" may cause loss of your mp3 files.  <IMG SRC="http://www.ethernalquest.com/ubb/smile.gif"><P>copy the mp3 files you intend to use into the combatswapper directory so that you are working with copies, not the one and only.<P></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">yay</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">what a joke, a meg program to change the combat music?   just make a batch file in dos  to copy over the combat music with the music you want to listen to , run daoc, run the batch, your set.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Sparr</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Sure yay, and then you write another batch program to stop DAOC from patching those files when their checksums dont match, right?</FONT></TD></TR></TABLE>
</FONT>
