...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by MKaath on 12-18-2001 05:29 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Bah, I bet you could figure it out.  [IMG]http://www.ethernalquest.com/ubb/wink.gif[/IMG]

I can use VC or VB, I just don't wanna. VC would take twice as long, and the thought of parsing a data stream with VB makes me ill...

So far I've ported code from C++, VB, and Perl(which I don't even know) to Delphi. If I can guess at Perl enough to port Slicer's code, you can figure out Pascal. :P

I can also toss stuff into DLLs or ActiveX easily enough.
</TEXTAREA>
</td></tr>
