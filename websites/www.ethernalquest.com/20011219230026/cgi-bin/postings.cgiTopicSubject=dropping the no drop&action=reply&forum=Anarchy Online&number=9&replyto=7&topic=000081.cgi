...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Gyro:
[B]Please don't tell us publicly!!!  FunCom will fix it the very next day.  I'd rather not know how, and hope to find it one day, rather than know that FunCom fixed it.

So, I implore you, please do not publicly post how to do it!  If you leave AO, be kind to those of us still playing, we will join up with you in DAoC soon and we'll be kind back to you there. 

In my opinion, the reason you can not trade cars is to keep cheaters from just finding cars in missions and selling them.  It seems like if you validly want to give a car to someone, you are being punished by anti-exploit measures.  Lets keep this "trading a no-drop item" a secret so we will not be punished by anti-exploit measures when we are not trying to be exploiters. [/B][/QUOTE]
