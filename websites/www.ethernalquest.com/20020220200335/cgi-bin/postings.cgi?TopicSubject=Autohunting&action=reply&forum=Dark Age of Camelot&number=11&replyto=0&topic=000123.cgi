...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Autohunting</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by eloi:
[B]I've been working on a program.  Pretty much just reading the log to tell what's going on, have some files with events, commands, and hotkeys that are read in, and the events are compared with the log file.  The commands are tied in with the events remotely, need to come up with a simple scripting language though.  Just reading the log file, etc now, and of course I'm not having any problem sending keystrokes to daoc.  I'm pretty lazy about it though so it migth be a while before I'm done.[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Autohunting">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">eloi</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I've been working on a program.  Pretty much just reading the log to tell what's going on, have some files with events, commands, and hotkeys that are read in, and the events are compared with the log file.  The commands are tied in with the events remotely, need to come up with a simple scripting language though.  Just reading the log file, etc now, and of course I'm not having any problem sending keystrokes to daoc.  I'm pretty lazy about it though so it migth be a while before I'm done.</FONT></TD></TR></TABLE>
</FONT>
