...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Scuffed on 12-03-2001 11:18 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Currently running 7.1 downloading the latest ISO to upgrade when I get home, ok the rest of my questions about the alpha version.

My current Linux machine is a P166 128 megs of ram, voodoo banshee video card. think this is enough or should I build a new system (thats currently my slowest system next is a 400, im using for a data storage, 200gigs of data I wont wipe)Is the 166 fast enough?

"I've set up #odinseye on irc.trifocus.net as our chat home." Is this on port 6667? If so looks like they blocked it from work.

and the last question, have you ever considered linking multiple EO machines up, so they could share data?
</TEXTAREA>
</td></tr>
