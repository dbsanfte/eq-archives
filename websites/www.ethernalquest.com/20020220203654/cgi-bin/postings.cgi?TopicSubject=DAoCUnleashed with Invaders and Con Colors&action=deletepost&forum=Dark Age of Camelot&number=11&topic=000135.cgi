...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="DAoCUnleashed with Invaders and Con Colors">
...
<TR bgcolor="#000000"><TD colspan=2><FONT FACE="Verdana, Arial" SIZE="2" COLOR="#00ff00"><b>To delete this entire topic, identify yourself below.  Do not press the SUBMIT button unless you are positive that you want to delete this entire topic!<P>Topic: DAoCUnleashed with Invaders and Con Colors</FONT></B></td></tr>
