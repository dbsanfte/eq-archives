...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Scuffed on 12-04-2001 02:33 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I was actually thinking of 2 seperate linux machines running EO connecting to each other using the internet.  Transfering just some simple information, like the user loc, maybe group member locs.  mob information isnt really needed, and would just slow down the connection.  Just a way to find your friends, and point you in there direction.</TEXTAREA>
</td></tr>
