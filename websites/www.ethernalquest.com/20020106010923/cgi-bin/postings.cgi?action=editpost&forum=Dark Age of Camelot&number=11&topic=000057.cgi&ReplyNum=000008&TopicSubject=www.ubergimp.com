...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by DestinyX on 12-20-2001 02:58 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">If I work for 2 hours I make 20 dollars (im  19).  It would take me more then 2 hours to gain a 10-15 level in DAoC.  So it's worth it in that regard.  However, your kinda missing the point of a game if you take this logic to heart.  It's supposed to be fun to earn these levels, if it's not, you shouldn't be playing.</TEXTAREA>
</td></tr>
