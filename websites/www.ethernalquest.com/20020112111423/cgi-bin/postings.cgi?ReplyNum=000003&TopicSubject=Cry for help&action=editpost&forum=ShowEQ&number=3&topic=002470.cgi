...
<BR>
Topic: <FONT COLOR="#00ff00">Cry for help</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Povarian on 11-17-2001 09:40 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Also had it so all 3 machines on Router were open to the net and still same thing. All 3 have different IPs. But the Linux box isn't getting the data from EQ client machine.</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Cry for help">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000003">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002470.cgi">
