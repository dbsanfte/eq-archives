...
<BR>
Topic: <FONT COLOR="#00ff00">Can someone PLEASE HELP!</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Prime_Evil on 01-04-2002 09:39 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I have been trying to complie Seq 5
with the libEq.a file that has the md5sum of
whyd03sitn0twork4me .... I am having a few problems 
1) my turbo C++ compiler says that it can not find /usr/local/qt-2.3.2 directory.

2)I keep getting a windows DLL runtime error saying "Can not locate bashrc or one of its components" 

3)When I use the visual basic complier I get no errors it complies fine, but when i try to run it it says not enough memorey, I have 64 MEGS OF RAM!!!!!. I have more then enough!.

As you can see from the above post i'm not stupid. I just cant figure out this instalation of this program it wouldn't be so bad but It did cost me $49.99 and thus i would like to get it to work. For the record my linux box is running slackware 1.0
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Can someone PLEASE HELP!">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="ShowEQ">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000000">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002652.cgi">
