...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by carnnage on 12-21-2001 03:23 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Battlesuit camping can be very profitable but anarchy his introduced a new database system that checks ids.. I had bought a battlesuit from a player a while back and when I went to sell it it just disappeared.  After much bitching to a gm he told me that everything on ao has an id and when I tried to sell the suit in a shop the server knew the id to be the same as another so it would not allow the item to pass...so if you could dupe items it is better to sell them to players...just my two cents
</TEXTAREA>
</td></tr>
