...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Zeppo on 12-03-2001 05:18 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I think he was trying to say that you cannot have the machine you use to play EQ dual boot. with Linux running SEQ.
I think you can see why that would not work.
I have a machine that dual boots between Win98 and RH and another machine with just Windows that I play EQ on.
Works fine.
Another place to check out is 
http://www.linuxnewbie.org/
Got some good things there as well.
Oh, another thing:
The machine I use for SEQ has a 3com NIC with a modem and NIC on one card.
While booting I do get an error that says "Waiting for ETH0 Initialization-- Failed"
But, it still works anyways.
I am too lazy to try and figure out why.
