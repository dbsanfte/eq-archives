...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Assembler texts</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Assembler texts">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Bushman</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Any of you old timers out there recommend any good books or texts on assemly language, preferably at the beginner levels.. I know C but assembler is seriouse greek  :)<p>Peace<br>from deep in the bush.
</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">LaZZer086</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Yes I can!<P>Go to <A HREF="http://www.amazon.com" TARGET=_blank>www.amazon.com</A> <P>type in c++</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Malaclypse</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Not sure what level of depth your looking for as far as assembly is concerned, but an excellent resource if your interested in begining to understand the lowest levels of pc hardware is "The 80x86 IBM PC & Compatible Computers, Assembly Language, Design, and Interfacing" by Muhammad Ali Mazidi. Not sure if its still in print or not, but its an excellent begining if your interested in assembly. It will take you not only through the concepts of programming at the register lvl but will explain how the hardware works and give you an understanding of what the language is doing physically. The architecture has changed, and there is ALOT more to it now, but learning how it evolved is, in my opinion at least, the best way to understand why things are the way they are. hehe there is even a schematic at the end of the original 80286 proccesor. </FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Barog</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Hi<P>Ah.. i remember back in the day's when I was coding using A86 and TASM =) No big API's.. just lot's of crappy INT's.. <P>Anyway.. I recently looked for an ASM tutorial for a workmate who never witnessed the old DOS days and found this pretty good tutorial.. <BR> <A HREF="http://webster.cs.ucr.edu/Page_asm/ArtofAssembly/ArtofAsm.html" TARGET=_blank>http://webster.cs.ucr.edu/Page_asm/ArtofAssembly/ArtofAsm.html</A> <P>Free and everything seems to be in it.. For reference material check out <A HREF="http://developer.intel.com" TARGET=_blank>http://developer.intel.com</A>  and download one of the manual set's.. they are great reference if your wondering what the microcode is up to or if you need an opcode.<P>Have fun! </FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">BlueAdept</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Are you looking to learn assembly enough to program in or are you looking for just enough to know what is going on in a program and to hack it?<P>If it is the later, there are some fairly good asm online books. Ill have to dig up the links when I get home if your interested.</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">kaoruAngel</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Firstly, I second Barog's reference to the Art of Assembly 'book'. You can get it in PDF format (to print, if you'd like), and it goes through the entire explanation of workings of your computer that you will be messign with in ASM.<P>However, for an all around resource, with good tutorials, I urge you to head over to THE assembly site, <A HREF="http://members.nbci.com/_XMCM/winasm/index.html" TARGET=_blank>Iczelion's</A>. You can then make your way on over to <A HREF="http://www.azillionmonkeys.com/qed/asm.html" TARGET=_blank>Paul's site</A> for reference, articles, and optimization tips when you're ready.<P><B>- kaoruAngel</B></FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Malaclypse</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Nice site Kaoru, I haven't really done a whole lot with asm since the days of dos... Nice to see an online resource with a comprehensive description of it uses in Win32 environments.<P>-Mal</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Fire</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">C++ for dummies?<p>[This message has been edited by Fire (edited 02-11-2001).]</FONT></TD></TR></TABLE>
</FONT>
