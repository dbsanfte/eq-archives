...
<BR>
Topic: <FONT COLOR="#00ff00">AO Mission Display v1.1</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Muzzleflash on 12-17-2001 01:58 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">The first thing to determine is if it is an AOMD or WinPcap problem. To do this, please try 'Analyzer', a free WinPcap packet capture & view utility by the people who made WinPcap. It is available at  [URL=http://netgroup-serv.polito.it/analyzer/]http://netgroup-serv.polito.it/analyzer/[/URL] . If that utility doesn't work either, then it is a WinPcap problem, and you might like to check the WinPcap FAQ at  [URL=http://netgroup-serv.polito.it/winpcap/misc/faq.htm]http://netgroup-serv.polito.it/winpcap/misc/faq.htm[/URL]  to determine why it isn't working with your network card. One possible reason is you are running WinXP and didn't install the latest WinPcap v2.3beta, the only one that supports WinXP.

If Analyzer *does* work and captures/displays packets correctly, then please let me know, as it would be an AOMD problem.
</TEXTAREA>
</td></tr>
