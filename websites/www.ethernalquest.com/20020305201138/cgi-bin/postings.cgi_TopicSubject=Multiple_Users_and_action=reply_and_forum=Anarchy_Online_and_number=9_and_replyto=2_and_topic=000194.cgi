...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Multiple Users</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by nzwilson:
[B]Thanks 
But does this work with any other games like Ever Quest and AC?[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Multiple Users">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Anarchy Online">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="9">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000194.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#000000"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#00ff00" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">nzwilson</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Can you have Multiple players online at the same time with the one account?<P>Like if me and my brother had a lan and we both connect with the same account can we still play or do we have to have 2 accounts?</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">MKaath</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">This info is on the board here somewhere,  it is possible with a little luck.<P>The trick is to start the app and do the login nearly simultaneously at both machines(or the same machine).  Don't try to log in the same character, that does some seriously screwy things.<P>MKaath</FONT></TD></TR><TR bgcolor="#1f1f1f"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">nzwilson</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Thanks <BR>But does this work with any other games like Ever Quest and AC?</FONT></TD></TR></TABLE>
</FONT>
