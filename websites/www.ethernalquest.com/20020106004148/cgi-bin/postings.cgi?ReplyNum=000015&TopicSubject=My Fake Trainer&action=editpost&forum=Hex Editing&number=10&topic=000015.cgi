...
<B>
Forum: <FONT COLOR="#00ff00">Hex Editing </FONT>
<BR>
Topic: <FONT COLOR="#00ff00">My Fake Trainer</FONT>
</B>
</FONT>
...
*HTML is OFF<BR>
*UBB Code is ON<BR>
[IMG] UBB Code Not Allowed!<p><A HREF="http://www.ethernalquest.com/ubb/smilies.html" target=_blank>Smilies Legend</A></font></td>
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Russo on 09-10-2001 12:49 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Mularos, crawl back into whatever hole you came out of and die.

[This message has been edited by Russo (edited 09-10-2001).]</TEXTAREA>
</td></tr>
