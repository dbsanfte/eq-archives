...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by seniordingdong on 12-10-2001 09:25 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">well, you could always write the app to not use WinPcap/Packetx by monitoring the Winsock Send/SendTo/Recv/RecvFrom functions.. perhaps you could use the DLL from a packet sniffer/editor to work with AOMD.. i will give it a try right now</TEXTAREA>
</td></tr>
