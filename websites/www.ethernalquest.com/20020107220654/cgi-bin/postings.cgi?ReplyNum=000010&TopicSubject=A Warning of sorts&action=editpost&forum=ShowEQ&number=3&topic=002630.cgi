...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by BlueAdept on 12-30-2001 03:24 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Well if WSEQ ever does make a re-appearance, Verant will put an end to it quickly by changing the encryption...unfortunately it will also break SEQ.

If that happened and if I was the one who wrote libEQ.a, I might not release it to the public. Only give out to trustworthy people and tell them to keep it to themselves. Then no one would have to worry about WSEQ rearing its ugly head again. 

I bet your glad that I didnt write libEQ.a  :)</TEXTAREA>
</td></tr>
