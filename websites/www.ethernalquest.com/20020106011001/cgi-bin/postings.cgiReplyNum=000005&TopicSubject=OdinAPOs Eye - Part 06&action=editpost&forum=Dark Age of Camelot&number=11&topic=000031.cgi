...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by gathalian on 12-03-2001 10:52 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">so.. I have to set up a linux machine to sniff this? before hitting my DAOC machine?
thus needing two nic card right? or would it work via hub?
