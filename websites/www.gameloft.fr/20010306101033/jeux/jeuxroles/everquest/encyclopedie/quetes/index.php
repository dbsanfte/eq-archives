...
function validate2(){
	if (is_name() && is_quest() && isValidLevel())
  {
...
function isValidLevel(){
    if (document.forms[0].levels.value != ""){
  		if(isNaN(parseInt(document.forms[0].levels.value)))
			{ 
			alert("Vous avez entré: "+document.forms[0].levels.value+" pour le champs Niveau de la quête !  Vous devez entrer un nombre");
			return false;
			}
		}
		return true;
...
function is_name(){
	if (document.forms[0].item_name.value == "") {
			alert("Vous devez entrer un nom pour l'objet !");return false;}		
	return true;
}

function is_quest(){
	if (document.forms[0].quest_name.value == "") {
			alert("Vous devez entrer un nom pour la quête !");return false;}		
	return true;
}
...
<img src="../../images/navflech.gif" width="16" height="8"><a href="../competence/index.html">Comp&eacute;tences</a><br>
              <img src="../../images/navflech.gif" width="16" height="8"><a href="index.html">Qu&ecirc;tes</a><br>
...
&gt; <i>Encyclop&eacute;die &gt; Qu&ecirc;tes</i></font></font></td>
...
<td colspan="3" background="../../images/textfond2.gif" bgcolor="#364334"><img src="../../images/encquetes.gif" width="105" height="55" align="middle">&nbsp;<b><font class="titre">QU&Ecirc;TES</font></b><font class="date"></font></td>
...
<td colspan="2" bgcolor="#364334" valign="top"> <!-- php script here --> 
				       ...
				       <form enctype="multipart/form-data" action=index.php name=formtype method=Post> 
            <input type=hidden name=item_type value="Quest">
		           <INPUT TYPE=hidden NAME=item_type VALUE=Quest>
 							 <INPUT TYPE=hidden NAME=fini VALUE=1>
							 <table width=100% cellpadding=0 cellspacing=0>
							 <tr> 
    								<td width="30%" height="37"><div align="right">Nom de la quête : </div></td>
    								<td width="70%" height="37"><input type="text" name="quest_name"></td>
                   </tr>
							 <tr> 
    		 		<td width="30%" height="38"><div align="right">Votre nom : </div></td>
            <td width="70%" height="38"><input type="text" name="apply_by" size="30" maxlength="30"></td>
				 </tr>
				 <tr> 
    		 		<td width="30%" height="38"><div align="right">Objet concerné : </div></td>
            <td width="70%" height="38"><input type="text" name="item_name"></td>
					</tr>
					
							 
							 <tr> 
    						<td width="30%" height="27"><div align="right">Zone concernée : </div></td>
    						<td width="70%" height="27"><select name=zone><option value=' '></option><option value="AK@Anon">AK'Anon</option><option value="All_Norrath">All Norrath</option><option value="Antonica">Antonica</option><option value="Arena">Arena</option><option value="Befallen">Befallen</option><option value="Black_Burrow">Black Burrow</option><option value="BlackBurrow_Level2">BlackBurrow Level2</option><option value="Butcherblock_Mountains">Butcherblock Mountains</option><option value="Cazic_Thule">Cazic Thule</option><option value="Crushbone">Crushbone</option><option value="Dagnor@s_Cauldron">Dagnor's Cauldron</option><option value="Dagnor@s_Cauldron">Dagnor's Cauldron</option><option value="East_Commonlands">East Commonlands</option><option value="East_Freeport">East Freeport</option><option value="East_Karana">East Karana</option><option value="Erudin">Erudin</option><option value="Eruds_Crossing">Eruds Crossing</option><option value="Estate_of_Unrest">Estate of Unrest</option><option value="Everfrost">Everfrost</option><option value="Faydwer">Faydwer</option><option value="Feerrott">Feerrott</option><option value="Felwithe">Felwithe</option><option value="Freeport">Freeport</option><option value="Gorge_of_King_Xorbb">Gorge of King Xorbb</option><option value="Greater_Faydark">Greater Faydark</option><option value="Grobb">Grobb</option><option value="Halas">Halas</option><option value="High_Hold_Keep">High Hold Keep</option><option value="Highpass_Hold">Highpass Hold</option><option value="Innothule_Swamp">Innothule Swamp</option><option value="Kaladim">Kaladim</option><option value="Kelethin">Kelethin</option><option value="Kerra_Isle">Kerra Isle</option><option value="Kerra_Ridge">Kerra Ridge</option><option value="Kithicor_Woods">Kithicor Woods</option><option value="Lair_of_Split_Paw">Lair of Split Paw</option><option value="Lake_Rathetear">Lake Rathetear</option><option value="Lavastorm_Mountains">Lavastorm Mountains</option><option value="Lesser_Faydark">Lesser Faydark</option><option value="Lower_Guk">Lower Guk</option><option value="Mistmoore_Castle">Mistmoore Castle</option><option value="Misty_Thicket">Misty Thicket</option><option value="Najena">Najena</option><option value="Nektulos_Forest">Nektulos Forest</option><option value="Neriak">Neriak</option><option value="Neriak_Commons">Neriak Commons</option><option value="Neriak_Foreign_Qtr">Neriak Foreign Qtr</option><option value="Neriak_Third_Gate">Neriak Third Gate</option><option value="North_Freeport">North Freeport</option><option value="North_Kaladim">North Kaladim</option><option value="North_Karana">North Karana</option><option value="North_Qeynos">North Qeynos</option><option value="North_Qeynos">North Qeynos</option><option value="Northern_Ro">Northern Ro</option><option value="Oasis_of_Marr">Oasis of Marr</option><option value="Ocean_of_Tears">Ocean of Tears</option><option value="Odus">Odus</option><option value="Oggok">Oggok</option><option value="Paneel">Paneel</option><option value="Permafrost">Permafrost</option><option value="Plane_of_Fear">Plane of Fear</option><option value="Plane_of_Hate">Plane of Hate</option><option value="Plane_of_Sky">Plane of Sky</option><option value="Qeysnos">Qeysnos</option><option value="Qeysnos_Catacombs">Qeysnos Catacombs</option><option value="Qeynos_Hills">Qeynos Hills</option><option value="Rathe_Mountains">Rathe Mountains</option><option value="Rivervale">Rivervale</option><option value="Runny_Eye_Citidel">Runny Eye Citidel</option><option value="Solusek_A">Solusek A</option><option value="South_Kaladim">South Kaladim</option><option value="South_Karana">South Karana</option><option value="South_Qeynos">South Qeynos</option><option value="Southern_Ro">Southern Ro</option><option value="Steamfont_Mountains">Steamfont Mountains</option><option value="Surefall_Glade">Surefall Glade</option><option value="Temple_of_Solusek_Ro">Temple of Solusek Ro</option><option value="Toxxulia_Forest">Toxxulia Forest</option><option value="Upper_Guk">Upper Guk</option><option value="West_Commonlands">West Commonlands</option><option value="West_Freeport">West Freeport</option><option value="West_Karana">West Karana</option></select>
				 			 </td>
              </tr>
							 <tr> 
    		 		<td width="30%" height="38"><div align="right">PNJ : </div></td>
            <td width="70%" height="38"><input type="text" name="npc_name"></td>
				 </tr>
							 <tr>
									<td width="30%" height="33"><div align="right">Niveau de la quête : </div></td>
                  <td width="70%" height="33">
									<select name="levels">
									  <option value="">
										...
										<option value=4>niveau 4
										<option value=5>niveau 5
										<option value=6>niveau 6
										<option value=7>niveau 7
										<option value=8>niveau 8
										<option value=9>niveau 9
										<option value=10>niveau 10
										<option value=11>niveau 11
										<option value=12>niveau 12
										<option value=13>niveau 13
										<option value=14>niveau 14
										<option value=15>niveau 15
										<option value=16>niveau 16
										<option value=17>niveau 17
										<option value=18>niveau 18
										<option value=19>niveau 19
										<option value=20>niveau 20
										<option value=21>niveau 21
										<option value=22>niveau 22
										<option value=23>niveau 23
										<option value=24>niveau 24
										<option value=25>niveau 25
										<option value=26>niveau 26
										<option value=27>niveau 27
										<option value=28>niveau 28
										<option value=29>niveau 29
										<option value=30>niveau 30
										<option value=31>niveau 31
										<option value=32>niveau 32
										<option value=33>niveau 33
										<option value=34>niveau 34
										<option value=35>niveau 35
										<option value=36>niveau 36
										<option value=37>niveau 37
										<option value=38>niveau 38
										<option value=39>niveau 39
										<option value=40>niveau 40
										<option value=41>niveau 41
										<option value=42>niveau 42
										<option value=43>niveau 43
										<option value=44>niveau 44
										<option value=45>niveau 45
										<option value=46>niveau 46
										<option value=47>niveau 47
										<option value=48>niveau 48
										<option value=49>niveau 49
										<option value=50>niveau 50
										<option value=51>niveau 51
										<option value=52>niveau 52
										<option value=53>niveau 53
										<option value=54>niveau 54
										<option value=55>niveau 55
										<option value=56>niveau 56
										<option value=57>niveau 57
										<option value=58>niveau 58
										<option value=59>niveau 59
										<option value=60>niveau 60
										<option value=0>Tous les niveaux
										</select>
									</td>
				    	 <tr>
									<td width="30%" height="33">
										<div align="right">Récompense : </div></td>
                  <td width="70%" height="33">
										<input type="text" name="quest_loot" size=25 maxlength=30></td>
							 <tr> 
    							<td width="30%" height="140" valign="top">
										<div align="right">Tâches à effectuer :</div></td>
    							<td width="70%" height="140" valign="top">
										<textarea name="quest_walk_throught" cols=30 rows=6 ></textarea></td>
                </tr>
							 <tr> 
    							<td width="30%" height="140" valign="top">
										<div align="right">Commentaires :</div></td>
    							<td width="70%" height="140" valign="top">
										<textarea name="description" cols=30 rows=6 ></textarea></td>
                </tr>
							 
							<tr> 
    						<td width="30%" height="30"><div align="right"></div></td>
    						<td width="70%" height="30">&nbsp;</td>
						  </tr>
							<tr> 
    						<td width="30%" height="30"><div align="right"></div></td>
    						<td width="70%" height="30"><a href=javascript:validate2()>
									<img src=../../images/soumettre.gif border=0></a></td>
							</tr>
