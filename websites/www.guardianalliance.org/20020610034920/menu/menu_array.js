...
function open_chat() {
	window.open('http://www.guardianalliance.org/chat.html', 'chat', 'width=620,height=470,scrollbars=no');
	return false;
}
...
,"Miscellaneous","show-menu=misc",,"",1
	...
	,"<img src=http://www.guardianalliance.org/menu/forum.gif border=0> Descending Darkness","http://ddbb.proboards.com/index.cgi target=new",,,1
