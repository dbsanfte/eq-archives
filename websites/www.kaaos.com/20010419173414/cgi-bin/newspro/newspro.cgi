...
-->
	...
	<div align="center">
	  <table width="60%" border="1" bordercolor="#666666" cellpadding="4" cellspacing="0" align="center" class="nptitle">
	    <tr bgcolor="#000099"> 
	      <td>
	        <div align="center"><b><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFCC33">Kaaos.com: NewsPro Login (Authorized Users Only)</font></b></div>
	      </td>
	    </tr>
	  </table>
<br>
      ...
      <td>
		...
		<form action="http://www.kaaos.com/cgi-bin/newspro/newspro.cgi?login" method="post">
