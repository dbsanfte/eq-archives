...
<table width="140" border="0" cellspacing="0" cellpadding="5" bgcolor="#003333">
	...
	<tr><td valign="top" align="center">
		...
		<table bgcolor="#FFFFFF" border=1 align="center" width="75"><tr><td align="center"><font face="arial" size="-2" color="#303030">2997</td></tr></table>
			...
			<table width="90%" border=0 cellspacing="0" cellpadding="0" align="center">
				<tr>
					<td align="left" valign="top">
						<center><font face="arial" size="+2"><u>Boiscan Server Stats</u></center>
						<br><br>
						<font face="arial" size="-1">Boiscan was created so that there was an ease in collecting Server Status information from the
						EverQuest servers, and centralizing it to a database. This allows other web sites to pull frequent "updates" 
						without hundreds of pages all polling the update server. The Boistat plugin allows any webpage access
						to that information without having to decode the binary UDP information as well.  Here are the directions to add the plugin 
						to your web site!<br><br>
						
						<font face="arial" size="-1">The plugin (add this to your site's HTML):
							<p align="left"><textarea cols=50 rows=5><!-- Start of Boiscan Server Stats - brought to you by Innoruuk.Com www.innoruuk.com -->
<script src="http://www.innoruuk.com/boistat.asp">
</script>
<!-- End of Innoruuk.Com Code --></textarea></p>

						<font face="arial" size="-1">The main script src is:<br><br>

						<b>http://www.innoruuk.com/boistat.asp?sid=#&<i>flag</i>=######</b><br><br>
					
						eg: To display only the information for Innoruuk, you would change the script src to be:<br><br>

						<b>http://www.innoruuk.com/boistat.asp?sid=14&bg=003333</b><br><br>

						eg: To display a black background display without the Scrolling Update:<br><br>

						<b>http://www.innoruuk.com/boistat.asp?sid=14&bg=000000&ot=FFFFFF&it=FFFFFF&zc=909090&ic=000000&rs=1</b><br><br>
						

						<br><br>
						The variables to add after the url are:<br><br>

						<b>sid (Server ID's):</b><br><br>

						The default is to list the Chat Server and all servers. If you set an sid, it will only show the Chat Server and the other server you specify.<br><br>
						...
						20  Quellious  <br>
						21  Brell Serilis  <br>
						22  Tallon Zek (PvP)  <br>
						23  Vallon Zek (PvP)  <br>
						24  Bristlebane  <br>
						25  The Tribunal  <br>
						26  The Nameless  <br>
						27  Lanys T'Vyl  <br>
						...
						31  Morell-Thule  <br>
						32  Saryrn  <br>
						33  The Seventh Hammer  <br>
						34  Terris-Thule  <br>
						35  Drinal <br>
						36  Tholuxe Paells <br><br>

						<b>bg (Background "Outer" Color):</b><br><br>

						This is a hex value of what color you want. The default is 003333 which is green-blue.<br><br>

						<b>ic (Inner "Box" Color):</b><br><br>

						This is a hex value of what color you want. The default is FFFFFF which is white.<br><br>

						<b>ot (Outer Text Color):</b><br><br>

						This is a hex value of what color you want. The default is FFFFFF which is white.<br><br>

						<b>it (Inner Text Color):</b><br><br>

						This is a hex value of what color you want. The default is 003333 which is green-blue.<br><br>

						<b>zc (Inner Zone "Info" Color):</b><br><br>

						This is a hex value of what color you want. The default is 909090 which is grey.<br><br>

						<b>rs (Remove Scrolling Text):</b><br><br>

						Set to "1" if you do not want the Update Server Status Message and Last Polled Update. If there is no update message, it will default to the Last Polled.<br><br>

						<br>
						If you have any problems or questions, email us at : <a href="mailto:boiscan@innoruuk.com">boiscan@innoruuk.com</a><br><br>

						<font face="arial" size="-2">Boiscan was developed by Boisvert Bladesong for the use of Innoruuk.com and the Crimson Dragons. Copyright © 2000 Boisvert Bladesong.<br>
						Boistat was developed by Cymric for public use. Copyright © 2000 Cymric. <br>
						Everquest is a Trademark of Verant Interactive.<br><br>
					</td>
				</tr>
			</table>
		</td>
		<td valign="top" align="right">
			...
			<!-- End of Innoruuk.Com Code --><br><br>
			<!-- Start of Boiscan Server Stats - brought to you by Innoruuk.Com www.innoruuk.com -->
			<script src="http://www.innoruuk.com/boistat2.asp">
			</script>
