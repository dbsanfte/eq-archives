...
<option value="01">中古車情報<option value="01_01">中古車情報:売ります<option value="01_02">中古車情報:買います<option value="02">不動産情報<option value="02_01">不動産情報:売ります<option value="02_02">不動産情報:買います	</select><br>　
...
<ul>
	...
	使用する検索エンジンを指定します。<br>
	<b>延岡中古車・不動産情報</b>以外の検索エンジンではその他の条件を指定できない場合があります
