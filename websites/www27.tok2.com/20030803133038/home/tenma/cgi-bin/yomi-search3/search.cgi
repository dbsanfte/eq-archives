        ...
        <TBODY>
          <TR>
            ...
            <TABLE border="0" bgcolor="#000000" width="150">
              <TBODY>
                <TR>
                  <TD width="150" align="center" bgcolor="#ff0033"><FONT size="-1" color="#ccff33"><A href="http://ninkirank.misty.ne.jp/14/enter.cgi?id=4444444" target="_blank"><FONT color="#ffffff">人気ゲームランキング</FONT></A></FONT></TD>
                </TR>
              </TBODY>
            </TABLE>
            </TD>
...
<A href="http://egame.mine.nu/index.php?name=無料WEBゲームランキングサイト&int=★★1時間ごとにランキングを更新しているので、面白いゲーム！人気ゲームがすぐわかる！すぐに遊べる！★★&url=http://www.wainet.ne.jp/~ahiru/"><FONT color="#ffffff" size="-1">無料ゲームランキング</FONT></A>
            ...
            <TABLE border="0" bgcolor="#000000" width="150">
              <TBODY>
                <TR>
                  <TD bgcolor="#ccff00" align="center">
...
<A href="http://tr.acz.jp/gtranking/ranklink.cgi?id=4444444"><FONT size="-1" color="#ffffff">面白ゲームランキング</FONT></A>
            ...
            <TABLE border="0" bgcolor="#000000" width="150">
              <TBODY>
                <TR>
                  <TD bgcolor="#ffcccc" align="center"><FONT size="-1" color="#ffcccc"><A href="http://www.geimu.net/rankem.php?id=4444" target="_blank">人気GAME投票COM！</A></FONT></TD>
                </TR>
              </TBODY>
            </TABLE>
            </TD>
...
<TR>
      <TD bgcolor="#0033cc" align="center"><B><FONT color="#ffffff" size="-1">このカジノであなたは勝てるかな？</FONT></B><BR>
