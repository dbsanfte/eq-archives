...
<br>
<ul>
<li>管理者に「<b>studio D.O.C</b>」についての通知を行います<br>
...
<form action="regist_ys.cgi" method=post target="">
  ...
  <input type=hidden name=title value="studio D.O.C">
	...
	[通知種別]<br>
		...
		<input type=checkbox name=type_ill value="4">規約違反[<a href="http://www16.tok2.com/home/tenma/cgi-bin/yomi-search/regist_ys.cgi?mode=new">規約はこちら</a>]<br>
