...
<p align=center>Top List</p>
          <p align=center>Add a site:</p><div align=center>
        <center>
        ...
        </div><p align=center>Menu:</p><p align=center><a href=add.php>Add your site</a> | <a href=edit.php>Edit your site</a> | <a href=lostpass.php>Lost password</a> | <a href=mailto:webmaster@darkshadowdragons.com?Subject=TopList>Contact</a> | <a href=tell.php>Tell a friend</a> | <a href="javascript:new_window('rules.php')">Rules</a><br><a href=lostcode.php>Lost HTML code</a> | <a href=banner-upload.php>Your banner on our server</a> | <a href=news.php>News</a> | <a href=viewstats.php>View stats</a> | <a href=index.php>Home</a><br><a href="javascript:window.external.AddFavorite('http://www.darkshadowdragons.com/toplist')">Add this toplist to bookmarks</a> | <a href="#" onclick="if (this.style) { this.style.behavior='url(#default#homepage)'; this.setHomePage('http://www.darkshadowdragons.com/toplist') }">Set as your home page</a> | <a href=admin.php>Administration menu</a></p><br><br><script language="JavaScript">
