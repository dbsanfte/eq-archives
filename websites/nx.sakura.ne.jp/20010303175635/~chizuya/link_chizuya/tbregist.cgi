...
<TD NOWRAP><FONT SIZE="2"><INPUT TYPE="checkbox" NAME="gcode" VALUE="NE:">News（EQの最新情報）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="SO:">総合情報（EQに関する総合的なデータのあるWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="EI:">装備･アイテム（装備品やアイテムに詳しいWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="NK:">日記（EQのプレイ日記のあるWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="CL:">各クラス（クラス情報に特化したWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="QE:">Quest情報系（Questの情報が詳しいWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="GU:">GuildのWeb（EQのプレイヤーギルドのWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="MP:">地図情報（地図情報の載ってるWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="SP:">何か極めたWeb（その方面に特化したお役立Web）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="SK:">鹿（鹿を極めたWeb）<BR>
<INPUT TYPE="checkbox" NAME="gcode" VALUE="BB:">掲示板系（掲示板などコミュニティーのWeb）<BR>
</FONT></TD></TR>
