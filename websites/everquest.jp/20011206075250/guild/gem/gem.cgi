...
<TD nowrap width=30% align=right>[<a href="http://www19.pos.to/~evergreen/" target='_top'>トップに戻る</a>]
...
<TD><input type="text" size="3" class="gem" name="way2" value="8" onFocus="this.select()" tabindex="3"></TD>
