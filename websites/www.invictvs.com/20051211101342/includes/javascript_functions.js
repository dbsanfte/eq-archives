...
// **********************************************************************************************************************************************************
//	<-- Begin Custom Checkbox functions:
...
// **********************************************************************************************************************************************************
//	<-- Begin Lucy pop-up window function:
// Opens Lucy item link in small pop-up window

	function viewItem(lucyID)
	{
		var strURL = 'http://lucy.allakhazam.com/item.html?id=' + lucyID;
		window.open(strURL, 'itemWindow', 'height=420,width=720,menubar=no,toolbar=no,status=no,location=no,scrollbars=yes,left=50,top=50');
	}

//	--> End Lucy pop-up window function
// **********************************************************************************************************************************************************


// **********************************************************************************************************************************************************
//	<-- Begin Magelo pop-up window function:
// Opens Magelo character link in small pop-up window
...
// **********************************************************************************************************************************************************
//	<-- Begin character detail submit function:
// Function called to submit the current form and re-direct the user to the character detail page based on the character id passed to the function.
	
	
	function characterDetail(charID)
	{
		window.document.forms[0].txtCharacterID.value = charID;
		window.document.forms[0].action = "character_detail.asp";
		window.document.forms[0].method = "post";
		window.document.forms[0].submit();
	}
	
	
//	--> character detail submit function
// **********************************************************************************************************************************************************	
