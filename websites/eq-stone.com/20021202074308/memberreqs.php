...
<!--
var myMsg =  "/GUILDMOTD - ";
    myMsg += ": Happy Hollidays!  May your life be filled with peace and joy =)                                           ";
var i = 0;
function scrollMsg() {
...
<span class='content-title'>Level</span><br>
 Your primary character (i.e. the one that is applying for membership) must have attained a minimum level of 58. 
 Alternate characters of Initiates (those players that have been tagged on a trial basis) will not be allowed to 
 be tagged until such time as the player is voted into the guild.
...
<span class='content-title'>Faction Alignments</span><br>
 Although faction alignment has not yet been detailed as a reason for exclusion, keep in mind that if you are KOS 
 to the stuff we aren't, this could be a problem when wanting to raid with us on Velious. We do kill dragons in 
 Western Wastes, but we constantly work to raise our CoV faction back up. Stone is currently:<br>
 <b>&#183;</b> Allied with Claws of Veeshan<br>
 <b>&#183;</b> Non-KOS with Coldain<br>
 <b>&#183;</b> Not yet decided about PoG faction<br>
 <b>&#183;</b> Not yet decided about Luclin factions<br>
