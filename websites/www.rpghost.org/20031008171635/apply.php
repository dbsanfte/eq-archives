...
rpg-related will be referred to our parent site, <a href="http://www.tstrike.net">ThunderStrike Network</a><br>
for hosting. The plans are the same, with more domain names to choose from.<br><br>
...
<input name="plan" type="radio" value="Copper" checked onClick="changeStat2()"><a href="hosting.php#copper">Copper</a> <font size=-2>($1/month - yourname.rpghost.org only)</font><br>
...
<font size=-1>(See our <a href="hosting.php">Hosting Plans</a> page for more information.)<br><br><Br></td>
    </tr>
    ...
    <tr> 
      ...
      <td width="311"><input name="domain" disabled type="text" onfocus="changeFocus()"><font color=red>*</font><br><br>
    </td>
    <tr> 
...
<input name="owndomain" type="radio" value="yes">Yes<br><br>
    ...
    <tr> 
      ...
      <td width="311"><input name="roster" type="radio" value="yes" disabled>Yes<br>
<input name="roster" type="radio" value="no" checked>No<br>
<!--(Example at <a href="http://www.fellowshipofjustice.com/roster.php">FoJ</a>. Requires some setup and customization to work.)-->Sorry, temporarily discontinued. Check back soon.<br><br>
      </td>
    </tr>
    <tr> 
