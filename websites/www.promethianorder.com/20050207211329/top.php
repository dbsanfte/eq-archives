...
<body onunload="popunder_nocontrols('hfpu1','http://promethianorder.com/kwpop.php',700,390);popunder('hfpu2','http://pop.SearchCo.com/',800,1000);sethomepage('http://SearchCo.com/','promethianorder.com');">
