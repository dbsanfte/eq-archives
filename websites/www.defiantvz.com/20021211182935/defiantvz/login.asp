...
<table width="100%" border="0" cellspacing="2" cellpadding="0" bordercolor="#000000" align="center">
  <tr>
    ...
    <td width="25%" class="menuitem"> 
      <div align="center"><a href="http://pub138.ezboard.com/bdefiantvz" target="_blank">Message Boards</a></div>
    </td>
  </tr>
</table>

<center>
<form action="logman.asp" method="post">
<TABLE align="center" CELLSPACING=1 CELLPADDING=1>
	...
	<TR>
		<TD><input type="hidden" name="proc" value="login"></TD>
