...
<BODY bgcolor="#FFFFFF" text="#006699" link="#FF00FF" vlink="#9900FF" alink="#FF0033" >
<!--#MENU-->
...
<TR>
<TD nowrap>
　　　　│　　　<FONT color="">今回バージョンアップで対応しました</FONT><BR>
　　　　│　　　<FONT color="">但し・・・当然のことながら、sendmailコマンドの使用を許可していないサーバでは利用できません。</FONT><BR>
