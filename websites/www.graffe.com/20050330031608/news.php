...
<a href="#" onclick="toggleView('notab', 'main200', 2);return false;" title="Click to Expand">6th Anniversary Patch Message - 3/16/05</a> &raquo;
...
<a href="#" onclick="toggleView('notab', 'main201', 2);return false;" title="Click to Expand">Class Re-envisioning posted</a> &raquo;
...
<br><table border=2 class=menu width="100%"><td nowrap class=menuhead width=100%>
<a href="#" onclick="toggleView('notab', 'main202', 2);return false;" title="Click to Expand">Patch Message - 3/3/05</a> &raquo;
