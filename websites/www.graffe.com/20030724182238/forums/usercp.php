...
<tr>
  <td valign="top" align="left" background="images/menu_background.gif"><!-- a href="index.php?s=b68731d1c14a29d218c3f59a20d6c8b1" --><a href="http://www.graffe.com/"><img src="images/graffes.gif" border="0" alt=" Graffe Forums"></a></td>
  <td valign="bottom" align="right" nowrap background="images/menu_background.gif">
   <!-- toplinks -->
   <a href="usercp.php?s=b68731d1c14a29d218c3f59a20d6c8b1"><img src="images/top_profile.gif" alt="Here you can view your subscribed threads, work with private messages and edit your profile and preferences" border="0"></a>
   <a href="register.php?s=b68731d1c14a29d218c3f59a20d6c8b1&action=signup"><img src="images/top_register.gif" alt="Registration is free!" border="0"></a>
   <a href="calendar.php?s=b68731d1c14a29d218c3f59a20d6c8b1"><img src="images/top_calendar.gif" alt="Calendar" border="0"></a>
   <a href="memberlist.php?s=b68731d1c14a29d218c3f59a20d6c8b1"><img src="images/top_members.gif" alt="Find other members" border="0"></a>
   <a href="misc.php?s=b68731d1c14a29d218c3f59a20d6c8b1&action=faq"><img src="images/top_faq.gif" alt="Frequently Asked Questions" border="0"></a>
   <a href="search.php?s=b68731d1c14a29d218c3f59a20d6c8b1"><img src="images/top_search.gif" alt="Search" border="0"></a>
   <a href="index.php?s=b68731d1c14a29d218c3f59a20d6c8b1"><img src="images/top_home.gif" alt="Home" border="0"></a>
   <!-- <a href="member.php?s=b68731d1c14a29d218c3f59a20d6c8b1&action=logout"><img src="images/top_logout.gif" alt="Logout" border="0"></a>  -->
   &nbsp;
   <!-- /toplinks -->
  </td>
</tr>
...
<form action="member.php" method="post"><input type="hidden" name="s" value="b68731d1c14a29d218c3f59a20d6c8b1">
<tr valign="top">
...
<tr valign="top">
	...
	<td bgcolor="#F1F1F1"><font face="verdana, arial, helvetica" size="2" ><input type="password" class="bginput" name="password" value="" size="25">
		&nbsp;&nbsp;</font>
		<font face="verdana,arial,helvetica" size="1" ><a href="member.php?s=b68731d1c14a29d218c3f59a20d6c8b1&action=lostpw">Forgotten your password?</a>
	</font></td>
</tr>
...
<a href="register.php?s=b68731d1c14a29d218c3f59a20d6c8b1&action=signup">register</a> before you can view this page.
</font></p></font></td>
</tr>
</table>
</td></tr></table>
...
<form action="forumdisplay.php" method="get"><tr><td>
	...
	<input type="hidden" name="s" value="b68731d1c14a29d218c3f59a20d6c8b1">
	<input type="hidden" name="daysprune" value="">
	<b>Forum Jump:</b><br>
	<select name="forumid"
	onchange="window.location=('forumdisplay.php?s=b68731d1c14a29d218c3f59a20d6c8b1&daysprune=&forumid='+this.options[this.selectedIndex].value)">
