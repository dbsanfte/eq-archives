...
<div class="MenuSub"><a href="category_news.asp?IDCategory=53">General Links</div>
		

		
		

<div class="MenuSub"><a href="category_news.asp?IDCategory=52">General Information</div>
...
<div class="MenuSub"><a href="category_news.asp?IDCategory=49">Officers</div>
		

		
		

<div class="MenuSub"><a href="category_news.asp?IDCategory=48">Raid Info</div>
...
<div class="MenuSub"><a href="category_news.asp?IDCategory=46">Quests</div>
...
<div class="MenuSub"><a href="category_news.asp?IDCategory=43">Useless Info</div>
...
<div class="MenuSub"><a href="category_news.asp?IDCategory=37">Guild News</div>
		

		
		

<div class="MenuSub"><a href="category_news.asp?IDCategory=36">Guild Charter</div>
...
-->
    ...
    <td align="center" width="100%">
		...
		<form action="news_search.asp?mode=doit" method="post">
		<table class="Main" width="450" border="0" cellspacing="0" cellpadding="0" align="center">
		  <tr>
		    <td>
		    <table class="Main" border="0" width="100%" cellspacing="1" cellpadding="4">
		      <tr>
		        <td class="Head" colspan="2">
		          <b>EverquestGuild.com Site Search</b>
		        </td>				        
		      </tr>
		      <tr>
		        <td colspan="2" valign="top">
		          <b>Specify your search</b>
		        </td>
		      </tr>
		      <tr>
		        <td colspan="2" valign="top">
			  ...
			  <tr>
				...
				<td valign="top">
				  <input type="text" name="SearchString" size="50" maxlength="100">
				</td>
		      </tr>
		      <tr>
		        <td colspan="2">
		      ...
		      <tr>
		        <td valign="top" align="right">
				  <input type="checkbox" name="SearchHeader" value="yes" checked>
				</td>
				<td valign="top">					  
				  search in headlines?
				</td>
		      ...
		      <tr>
		        <td valign="top" align="right">
				  <input type="checkbox" name="SearchText" value="yes" checked>
				</td>
				<td valign="top">					  
				  search in newstext?
				</td>
		        ...
		        <td valign="top" align="right">			      	
		          <select name="Author">
					...
					<option value="0">All Authors</option>
						...
						<option value="42">Anonymous</option>
						<option value="41">Dextor</option>
						<option value="34">suki</option>	      
				  </select>
				</td>
				<td valign="top">
				  only news of this author!	      
				</td>
		      </tr>	        
		      <tr>			
