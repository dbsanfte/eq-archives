...
<TR>
	...
	<TR><TD COLSPAN=7 VALIGN=TOP ALIGN=CENTER><font size=1><a href="/calendar/calendar.pl?Month=1&Year=2001&config=calendar.cfg">January&nbsp;2001</a></font></TD></TR>
...
<option value='2003' >2003
	...
	<font size="-1" color="white">Click on any date to view details for that day.
    For changes to any entries please email </font><a href="mailto:Sargol@wiredweb.com">
	
	<font size="-1" color="#FFFFFF">Sargol@wiredweb.com</font></a>
	
	<font size="-1" color="white">&nbsp;</font></i>
	</TD>
	<TD ALIGN=CENTER BGCOLOR=#000080>
		<TABLE BORDER=1 CELLPADDING=0 cellspacing=0 BGCOLOR=white>
	<TR><TD COLSPAN=7 VALIGN=TOP ALIGN=CENTER><font size=1><a href="/calendar/calendar.pl?Month=3&Year=2001&config=calendar.cfg">March&nbsp;2001</a></font></TD></TR>
...
<br>&nbsp;<br>&nbsp;<br>&nbsp;
	...
	<FONT SIZE="-2"><br>
		FKON HALFLING FOOTFUR HUGATHON<br>
<br>&nbsp;<br>&nbsp;<br>&nbsp;
	</FONT>
	</TD>
...
<TABLE BORDER=1 CELLSPACING=0 CELLPADDING=3>
	...
	<TR>
		...
		<TD BGCOLOR="#CCCCCC">
			<input name="Month" size=2 maxlength=2 value="2"> / <input name="Date" size=2 maxlength=2 value="15"> / <input name="Year" size=4 maxlength=4 value="2001"><br>
