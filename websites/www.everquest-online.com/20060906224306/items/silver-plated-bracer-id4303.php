...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 6, 2006</div>
	</div>
		<div id="navleft">
<div class="navbox">
		...
		<div id="navright">
		  <div class="navbox">
			...
			<div class="content">
			   <div align="center" class="randomscreen"><a href=http://www.everquest-online.com/content/images/gallery/screenshots/eqn041><img src="http://www.everquest-online.com/content/images/gallery/albums/screenshots/eqn041.thumb.jpg" width=160 height=120  alt="In the Ry`gorr Orc fortress in the middle of the Eastern Wastes of Velious" border="0" /></a><br />In the Ry`gorr Orc fortress in the middle of the Eastern Wastes of Velious<br />From: <a href=http://www.everquest-online.com/content/images/gallery/screenshots>Screenshots</a></div>
			</div>
		  </div>
		  <div class="navbox">
