...
<div id="wrapper">
	<div id="main">
		<div class="content">
<div align="center">
<div id="google-frontpage-banner"></div><div id="beacon_34" style="position: absolute; left: 0px; top: 0px; visibility: hidden;"><img src='http://adserver.mpogonline.com/adlog.php?bannerid=34&amp;clientid=21&amp;zoneid=36&amp;source=&amp;block=0&amp;capping=0&amp;cb=048f735b9ddf159cd856c4e9d46daed1' width='0' height='0' alt='' style='width: 0px; height: 0px;'></div></div>
...
<hr><br />
<div id="google-frontpage-textlinks"></div>
<script language="JavaScript" type="text/javascript">
<!--
function google_ad_request_done(google_ads) {
	...
	if (google_ads[0].type == 'text') {
		...
		for(var i = 0; i < google_ads.length; ++i) {
			...
			if (i == 2) {
				second_ad_unit += '<div id="google-adsense-textlinks">';

				// Print "Ads By Google" -- include link to Google feedback page if available
				second_ad_unit += '<div align="center">';
				if (google_info.feedback_url) { second_ad_unit += '<a href="' + google_info.feedback_url + '" class="adsby">'; }
				second_ad_unit += game_name + ' ';
				second_ad_unit += 'Ads By Google';
				if (google_info.feedback_url) {	second_ad_unit += '</a>'; }
				second_ad_unit += '</div><br />';
			}
			if (i >= 2) {
				second_ad_unit += '<a href="' + google_ads[i].url + '" class="subject">' + google_ads[i].line1 + '</a><br />' 
				+ '<a href="' +  google_ads[i].url + '" class="desc">' + google_ads[i].line2 + ' ' + google_ads[i].line3 + '</a>' 
				+ ' - <a href="' + google_ads[i].url + '" class="url">' + google_ads[i].visible_url + '</a><br /><br />';
			}
			if (((i+1) == google_ads.length) && (i >= 2)) {
				second_ad_unit += '</div>';
			}
		}
		document.getElementById("google-frontpage-banner").innerHTML += first_ad_unit;
		document.getElementById("google-frontpage-textlinks").innerHTML += second_ad_unit;
	}
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">December 25, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
