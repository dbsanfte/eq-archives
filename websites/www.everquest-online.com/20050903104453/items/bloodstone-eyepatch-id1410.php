...
<head>
<title>EQ Everquest Bloodstone Eyepatch</title>
...
var who = "Bloodstone Eyepatch - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 3, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
