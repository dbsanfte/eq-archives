...
<head>
<title>EQ Everquest Klandicar's Talisman</title>
...
var who = "Klandicar's Talisman - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">January 16, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
		...
		<div id="navright">
		  <div class="navbox">
			...
			<div class="content">
			   <div align="center" class="randomscreen"><a href=http://www.everquest-online.com/content/images/gallery/screenshots/eq002><img src="http://www.everquest-online.com/content/images/gallery/albums/screenshots/eq002.thumb.jpg" width=160 height=120  alt="Sunset in the Rathe Mountains. It's best to be inside when the sun goes down" border="0" /></a><br />Sunset in the Rathe Mountains. It's best to be inside when the sun goes down<br />From: <a href=http://www.everquest-online.com/content/images/gallery/screenshots>Screenshots</a></div>
			</div>
		  </div>
		  <div class="navbox">
