...
function google_ad_request_done(google_ads) {
	...
	if (google_ads[0].type == 'text') {
		...
		if (document.getElementById("google-frontpage-banner")) { document.getElementById("google-frontpage-banner").innerHTML += first_ad_unit; }
		if (document.getElementById("google-frontpage-textlinks")) { document.getElementById("google-frontpage-textlinks").innerHTML += second_ad_unit; }
	}
