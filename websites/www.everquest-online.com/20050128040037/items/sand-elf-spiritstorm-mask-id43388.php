...
<head>
<title>EQ Everquest Sand Elf Spiritstorm Mask</title>
...
var who = "Sand Elf Spiritstorm Mask - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">January 27, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
