...
<head>
<title>EQ Everquest Velium Emerald Ring</title>
...
var who = "Velium Emerald Ring - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">January 11, 2006</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
