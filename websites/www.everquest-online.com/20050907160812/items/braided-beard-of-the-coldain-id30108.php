...
<head>
<title>EQ Everquest Braided Beard of the Coldain</title>
...
var who = "Braided Beard of the Coldain - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 7, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
		...
		<div id="navright">
		  <div class="navbox">
			...
			<div class="content">
			   <div align="center" class="randomscreen"><a href=http://www.everquest-online.com/content/images/gallery/screenshots/eq088><img src="http://www.everquest-online.com/content/images/gallery/albums/screenshots/eq088.thumb.jpg" width=160 height=120  alt="Meet an all new Shadowbow with some new duds!" border="0" /></a><br />Meet an all new Shadowbow with some new duds!<br />From: <a href=http://www.everquest-online.com/content/images/gallery/screenshots>Screenshots</a></div>
			</div>
		  </div>
		  <div class="navbox">
