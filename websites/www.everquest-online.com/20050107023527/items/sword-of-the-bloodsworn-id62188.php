...
<head>
<title>EQ Everquest Sword of the Bloodsworn</title>
...
var who = "Sword of the Bloodsworn - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">January 6, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
