...
<head>
<title>EQ Everquest Add Guide</title>
...
<script language="JavaScript" type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js"></script><div id="beacon_36" style="position: absolute; left: 0px; top: 0px; visibility: hidden;"><img src='http://adserver.mpogonline.com/adlog.php?bannerid=36&amp;clientid=21&amp;zoneid=26&amp;source=&amp;block=0&amp;capping=0&amp;cb=ab406293540846ceded145073d1c5ee9' width='0' height='0' alt='' style='width: 0px; height: 0px;'></div></div>
<div align="center"><h1>EQ Everquest Add Guide</h1></div><br />Submit your <b>Everquest Guide</b> to us here using the form below. You must include your name or the name of the guide's author if it isn't you and a contact e-mail which has to be real or we won't be able to contact you regarding the guide. Your guide can be in <i>.txt</i>, <i>.htm</i>, <i>.html</i>, <i>.doc</i>, and <i>.rtf</i> format. We do not accept any other document type. If your guide has seperate images with it, then upload them after you upload your guide, use the same name and e-mail. We allow GIF, JPEG, PNG, and BMP format images, up to 1600x1200 pixels in size. If you are uploading someone else's guide, you must have their prior consent to do so. If you wish to re-submit your guide then upload it again using the same name and e-mail that you used last time.<br /><br /><b>Note:</b> Do not submit other people's work and claim it as your own, this is illegal and will have serious consequences.<br /><br />	<form enctype="multipart/form-data" action="/content/everquest-addguide.php" method="POST">
	<input type="hidden" name="submitted" value="true">
		<b>Author's Name:</b>&nbsp;<input type="text" name="Author" size="30" value="" /><br />
		<br />
		<b>E-Mail Address:</b>&nbsp;<input type="text" name="EMail" size="30" value="" /><br />
		<br />
		<b>Upload File:</b>&nbsp;<input name="userfile" type="file"><br />
		<br />
		<span style="color: #FF0000; font-size: 10px;">We only accept Text Files (.txt), Word Documents (.doc), HTML Files (.htm, .html), and Rich Text Files (.rtf)</span><br />
		<span style="color: #FF0000; font-size: 10px;">For images, only .gif, .jpg, .png and .bmp formats are accepted. There is a 5 MB limit per file upload.</span><br />
		<br />
		<input type="hidden" name="language" value="en" />
		<input type="submit" value="Upload Guide">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #FF0000; font-size: 10px;">(Click on Upload Guide once only and wait for the confirmation page)</span>
	</form>
	
<br /><br /><b><a href='http://adserver.mpogonline.com/adclick.php?bannerid=3&amp;zoneid=6&amp;source=&amp;dest=http%3A%2F%2Fwetrack.it%2Fyantis%2Faf.cgi%3Faid%3D919%26redirect%3Dhttp%253A%252F%252Fwww.mysupersales.com%252FMG%252F%253Fgid%253D33' target='_self' onMouseOver="self.status='http://www.mysupersales.com/MG/?gid=33'; return true;" onMouseOut="self.status='';return true;">MySuperSales</a> is the best place for the cheapest Platinum and top items at the lowest prices</b><div id="beacon_3" style="position: absolute; left: 0px; top: 0px; visibility: hidden;"><img src='http://adserver.mpogonline.com/adlog.php?bannerid=3&amp;clientid=2&amp;zoneid=6&amp;source=&amp;block=0&amp;capping=0&amp;cb=15fec1a437fb3faf655e8b7b22a6ecd2' width='0' height='0' alt='' style='width: 0px; height: 0px;'></div>			<br />
		</div>
		<div id="footer">
EverQuest, You're in Our World Now, The Ruins of Kunark and The Scars of Velious are registered trademarks and The Shadows of Luclin, The Planes of Power, and Online Adventures are trademarks of Sony Computer Entertainment America Inc. "PlayStation" and the "PS" Family logo are registered trademarks of Sony Computer Entertainment Inc. SOE, the SOE logo and Station.com are registered trademarks or trademarks of Sony Online Entertainment Inc. All Rights Reserved. All other trademarks are properties of their respective owners.
	...
	<div id="header">
	  ...
	  <div id="slogan" style="left: 50px; color: #FFFFFF;">EQ Everquest Online - &nbsp;(<a style="color: #FFFFFF;" href="#" onClick="this.style.behavior='url(#default#homepage)'; this.setHomePage('http://www.everquest-online.com/content/everquest-addguide.php');">Make Homepage</a>
<script>
var url = "http://www.everquest-online.com/content/everquest-addguide.php";

// caption to appear with bookmark
var who = "Add Guide - EQ Everquest Online"
