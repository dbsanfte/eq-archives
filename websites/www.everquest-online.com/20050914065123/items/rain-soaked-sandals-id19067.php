...
<head>
<title>EQ Everquest Rain Soaked Sandals</title>
...
var who = "Rain Soaked Sandals - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 14, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
