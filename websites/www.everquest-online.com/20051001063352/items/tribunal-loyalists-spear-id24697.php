...
<head>
<title>EQ Everquest Tribunal Loyalist's Spear</title>
...
var who = "Tribunal Loyalist's Spear - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">October 1, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
