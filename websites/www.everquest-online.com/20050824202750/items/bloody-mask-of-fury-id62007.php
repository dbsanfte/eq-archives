...
<head>
<title>EQ Everquest Bloody Mask of Fury</title>
...
var who = "Bloody Mask of Fury - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">August 24, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
		...
		<div id="navright">
		  <div class="navbox">
			...
			<div class="content">
			   <div align="center" class="randomscreen"><a href=http://www.everquest-online.com/content/images/gallery/screenshots/eq018><img src="http://www.everquest-online.com/content/images/gallery/albums/screenshots/eq018.thumb.jpg" width=160 height=120  alt="Far off in the distance can be seen two adventurers in the Karanas" border="0" /></a><br />Far off in the distance can be seen two adventurers in the Karanas<br />From: <a href=http://www.everquest-online.com/content/images/gallery/screenshots>Screenshots</a></div>
			</div>
		  </div>
		  <div class="navbox">
