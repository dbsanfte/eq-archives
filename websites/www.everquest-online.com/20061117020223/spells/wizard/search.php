...
<head>
<title>EQ Everquest Search Wizardspells</title>
...
<div align="center"><h1>EQ Everquest Search Wizardspells</h1></div><br /><div align="center"><form action="search.php" method="post">
<b>Search&nbsp;Wizardspells:</b>&nbsp;
<input type="text" name="index" size="20" />&nbsp;
<input type="submit" name="submit" value="Search" />
</div><br /><br /><div align="center" style="font-size: 9px; text-transform: uppercase;">Spell data courtesy of Lucy</div>
			<br />
		</div>
		<div id="footer">
...
var who = "Search Wizardspells - EQ Everquest Online"
