...
<head>
<title>EQ Everquest Velium Spiked Skull Helm</title>
...
var who = "Velium Spiked Skull Helm - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">January 29, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
