...
<head>
<title>EQ Everquest Coldain Skin Gloves</title>
...
var who = "Coldain Skin Gloves - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 19, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
