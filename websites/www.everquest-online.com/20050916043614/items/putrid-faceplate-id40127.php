...
<head>
<title>EQ Everquest Putrid Faceplate</title>
...
var who = "Putrid Faceplate - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 15, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
		...
		<div id="navright">
		  <div class="navbox">
			...
			<div class="content">
			   <div align="center" class="randomscreen"><a href=http://www.everquest-online.com/content/images/gallery/screenshots/eq239><img src="http://www.everquest-online.com/content/images/gallery/albums/screenshots/eq239.thumb.jpg" width=160 height=120  alt="To the Crypt of Dalnir to hopefully outfit herself in some Crescent gear. Enemies are all over!" border="0" /></a><br />To the Crypt of Dalnir to hopefully outfit herself in some Crescent gear. Enemies are all over!<br />From: <a href=http://www.everquest-online.com/content/images/gallery/screenshots>Screenshots</a></div>
			</div>
		  </div>
		  <div class="navbox">
