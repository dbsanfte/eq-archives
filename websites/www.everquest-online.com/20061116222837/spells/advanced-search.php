...
<head>
<title>EQ Everquest Search Spells</title>
...
<div align="center"><h1>EQ Everquest Advanced Search Spells</h1></div><br /><table align="center" cellspacing="5" cellpadding="0" border="0"><form action="advanced-search-results.php" method="post"><tr><td align="right"><b>Spell Name:</b></td><td valign="top"><input type="text" name="sname" size="30" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td colspan="3">&nbsp;</td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Class:</b></td><td valign="top"><select name="sclasses"><option value="" selected="selected">Any Class</option><option value="BRD">Bard</option><option value="BST">Beastlord</option><option value="BER">Berserker</option><option value="CLR">Cleric</option><option value="DRU">Druid</option><option value="ENC">Enchanter</option><option value="MAG">Magician</option><option value="MNK">Monk</option><option value="NEC">Necromancer</option><option value="PAL">Paladin</option><option value="RNG">Ranger</option><option value="ROG">Rogue</option><option value="SHD">Shadow Knight</option><option value="SHM">Shaman</option><option value="WAR">Warrior</option><option value="WIZ">Wizard</option><option value="None">NPC / No Class</option></select>&nbsp;<input type="checkbox" name="sclassesonly" />&nbsp;<b>Only</b></td><td><b>Spell Level:</b></td><td><select name="sspllvlcmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="sspllvl" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Spell Class:</b></td><td valign="top"><select name="ssplclasses"><option value="" selected="selected">Any Spell Class</option><option value="Abjuration">Abjuration</option><option value="Alteration">Alteration</option><option value="Brass">Brass</option><option value="Conjuration">Conjuration</option><option value="Divination">Divination</option><option value="Evocation">Evocation</option><option value="Innate">Innate</option><option value="Percussion">Percussion</option><option value="Singing">Singing</option><option value="Stringed">Stringed</option><option value="Wind">Wind</option></select></td><td><b>Mana Used:</b></td><td><select name="ssplmanacmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="ssplmana" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Spell Type:</b></td><td valign="top"><select name="sspltypes"><option value="" selected="selected">Any Spell Type</option><option value="Beneficial">Beneficial</option><option value="Beneficial, Group Only">Beneficial, Group Only</option><option value="Detrimental">Detrimental</option></select></td><td><b>Range:</b></td><td><select name="ssplrangecmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="ssplrange" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Spell Target:</b></td><td valign="top"><select name="sspltargets"><option value="" selected="selected">Any Target</option><option value="Animal">Animal</option><option value="AE PC">Area Effect - Player</option><option value="AE Summoned">Area Effect - Summoned</option><option value="Targeted AE">Area Effect - Targeted</option><option value="AE Undead">Area Effect - Undead</option><option value="Corpse">Corpse</option><option value="Uber Dragons">Dragons</option><option value="Uber Giants">Giants</option><option value="Group">Group</option><option value="Lifetap">Lifetap</option><option value="Line of Sight">Line of Sight</option><option value="Pet">Pet</option><option value="Plant">Plant</option><option value="Self">Self</option><option value="Single">Single</option><option value="Summoned">Summoned</option><option value="Undead">Undead</option></select></td><td><b>AE Range:</b></td><td><select name="ssplaerangecmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="ssplaerange" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Resist:</b></td><td valign="top"><select name="ssplresists"><option value="" selected="selected">Any Resist</option><option value="Chromatic">Chromatic</option><option value="Cold">Cold</option><option value="Disease">Disease</option><option value="Fire">Fire</option><option value="Magic">Magic</option><option value="Poison">Poison</option><option value="Prismatic">Prismatic</option><option value="Unresistable">Unresistable</option></select></td><td><b>Casting Time:</b></td><td><select name="ssplcstcmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="ssplcst" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Location:</b></td><td valign="top"><select name="sspllocations"><option value="" selected="selected">----------</option><option value="Any">Any</option><option value="Dungeons">Dungeons</option><option value="Outdoors">Outdoors</option></select></td><td><b>Recast Delay:</b></td><td><select name="ssplrcstcmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="ssplrcst" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td align="right"><b>Time of Day:</b></td><td valign="top"><select name="sspltimes"><option value="" selected="selected">----------</option><option value="Any">Any</option><option value="Nighttime">Nighttime</option></select></td><td><b>Fizzle Time:</b></td><td><select name="ssplfzlcmp"><option value="=" selected="selected">=</option><option value="&gt;">&gt;</option><option value="&lt;">&lt;</option></select></td><td><input type="text" name="ssplfzl" size="3" /></td><td colspan="3">&nbsp;</td></tr><tr><td colspan="2">&nbsp;</td><td colspan="2"><b>No. of Results:</b></td><td><select name="sresults"><option value="25" selected="selected">25</option><option value="50">50</option><option value="75">75</option><option value="100">100</option></select></td><td colspan="3">&nbsp;</td></tr><tr><td colspan="8" align="center"><input type="submit" name="ssubmit" value="Search Spells" /></td></tr></form></table><br /><div align="center" style="font-size: 9px; text-transform: uppercase;">Spell data courtesy of Lucy</div>
			<br />
		</div>
		<div id="footer">
...
var who = "Search Spells - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">November 16, 2006</div>
	</div>
		<div id="navleft">
<div class="navbox">
		...
		<div id="navright">
		  <div class="navbox">
			...
			<div class="content">
			   <div align="center" class="randomscreen"><a href=http://www.everquest-online.com/content/images/gallery/screenshots/eq403><img src="http://www.everquest-online.com/content/images/gallery/albums/screenshots/eq403.thumb.jpg" width=160 height=120  alt="Back in the Crystal Caverns, the group gets back to business" border="0" /></a><br />Back in the Crystal Caverns, the group gets back to business<br />From: <a href=http://www.everquest-online.com/content/images/gallery/screenshots>Screenshots</a></div>
			</div>
		  </div>
		  <div class="navbox">
