...
<head>
<title>EQ Everquest Rallican's Stone Bracelet</title>
...
var who = "Rallican's Stone Bracelet - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">September 9, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
