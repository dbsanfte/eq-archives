...
<head>
<title>EQ Everquest Spell: Spell Shield</title>
...
var who = "Spell: Spell Shield - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">November 24, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
