...
<head>
<title>EQ Everquest Tishan's Discord</title>
	...
	if (google_ads[0].type == 'text') {
		...
		for(var i = 0; i < google_ads.length; ++i) {
			...
			if (i <= 1) {
				...
				+ '<a href="' +  google_ads[i].url + '" class="desc">' + google_ads[i].line2 + '<br />' + google_ads[i].line3 + '</a>';
...
var who = "Tishan's Discord - EQ Everquest Online"
