...
<head>
<title>EQ Everquest Cleric</title>
...
<div id="wrapper">
	<div id="main">
		<div class="content">
<div align="center"><h1>EQ Everquest Cleric</h1></div><br />The <b>Cleric</b> is a servant of god, a holy man or women born with the special power to heal others. Through the prayer to a deity, the Cleric can summon power to heal, or even hurt his or her enemies. Clerics gain powerful healing and enhancement spells, greatly increasing the health and defenses of their group, while keeping them healed in the most dangerous battles. While other priest classes have healing spells, no one can match up with the power and efficiency of clerical healing.<br /><br />Along with the use of healing spells, the <i>Cleric</i> also shows great strength when fighting the undead. Many offensive spells will eliminate undead targets extremely fast that the Cleric possesses. Clerics are one of the most essential parts of a group, especially later in the game, as their healing powers are needed to conquer the fiercest of monsters.
...
EverQuest, You're in Our World Now, The Ruins of Kunark and The Scars of Velious are registered trademarks and The Shadows of Luclin, The Planes of Power, and Online Adventures are trademarks of Sony Computer Entertainment America Inc. "PlayStation" and the "PS" Family logo are registered trademarks of Sony Computer Entertainment Inc. SOE, the SOE logo and Station.com are registered trademarks or trademarks of Sony Online Entertainment Inc. All Rights Reserved. All other trademarks are properties of their respective owners.
	...
	<div id="header">
	  ...
	  <div id="slogan" style="left: 50px; color: #FFFFFF;">EQ Everquest Online - &nbsp;(<a style="color: #FFFFFF;" href="#" onClick="this.style.behavior='url(#default#homepage)'; this.setHomePage('http://www.everquest-online.com/content/classes-cleric.php');">Make Homepage</a>
<script>
var url = "http://www.everquest-online.com/content/classes-cleric.php";

// caption to appear with bookmark
var who = "Cleric - EQ Everquest Online"
