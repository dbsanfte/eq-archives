...
<head>
<title>EQ Everquest Burynai Hide Bracelets</title>
...
var who = "Burynai Hide Bracelets - EQ Everquest Online"
...
if ((ver == "Microsoft Internet Explorer")&&(num >= 4)) {
   document.write(' | <a style="color: #FFFFFF;" href="javascript:window.external.AddFavorite(url,who);">Add Bookmark</a>'); }</script>)
	  ...
	  <div id="date">August 17, 2005</div>
	</div>
		<div id="navleft">
		  <div class="navbox">
