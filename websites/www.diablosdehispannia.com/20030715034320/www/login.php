				  ...
				  <tr>
					  <td valign="center" align="center">
						  <table border="0" width="118">
							  <tr>
  <td align="center">&nbsp;&nbsp;<a href="#" onclick="Popup=window.open('screen.php?screen=50_Fuegos artificiales del 4 de Julio.jpg','Popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes'); return false;"><img src="files/screenshots/thumb/50_Fuegos artificiales del 4 de Julio.jpg" border="0"></a></td>								</tr>
							</table>															
						</td>
					</tr>
				</table>	
