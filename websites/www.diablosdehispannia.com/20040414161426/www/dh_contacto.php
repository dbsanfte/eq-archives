...
<td width="*" valign="top"><br>	<SCRIPT LANGUAGE="JavaScript">
	...
	function checkData() {
		...
		var t1 = f1.contacto_email;
		if (t1.value == "" || t1.value == " ") {
			wm += "Email\r\n";
			noerror = 0;
		}
	
		var t1 = f1.contacto_asunto;
		if (t1.value == "" || t1.value == " ") {
			wm += "Asunto\r\n";
			noerror = 0;
		}
		
		var t1 = f1.contacto_texto;
		if (t1.value == "" || t1.value == " ") {
			wm += "Contenido\r\n";
			noerror = 0;
		}
  ...
  <tr><td bgcolor="black" class="texto">
  	...
  	<form name="ingreso" method="post" action="/www/dh_contacto.php" onSubmit="return checkData()">
  	<tr>
  		<td class="texto" align="center">
    		Para :
    	</td>
    	<td align="left" class="texto">
    	  <label><input type="radio" name="contacto_para" value="webmaster" class="formulario"  checked>Webmaster</label>
    	  &nbsp;&nbsp;
    		<label><input type="radio" name="contacto_para" value="consejodh" class="formulario">Consejo DH</label>
    	</td>
    	</tr>
    	<tr>
    	<td class="texto" align="center">
    	...
    	<td>
    	  <input type="text" name="contacto_nick" class="formulario" size="55">
    	</td>
      </tr>
      <tr>
    	<td class="texto" align="center">
    	...
    	<td>
    	  <input type="text" name="contacto_email" class="formulario" size="55">
    	</td>
      </tr>
      <td class="texto" align="center">
    		Asunto
    	...
    	<td>
    	  <input type="text" name="contacto_asunto" class="formulario" size="55">
    	</td>
      </tr>
     	<tr>
    	<td class="texto" align="center">
    	...
    	<td>
    	    <textarea name="contacto_texto" class="formulario" style="background-color: #FFFFFF;" cols="55" rows="6"></textarea>
    	</td>
      </tr>
      <tr>
				  ...
				  <tr>
					  <td valign="center" align="center">
						  <table border="0" width="118">
							  <tr>
  <td align="center">&nbsp;&nbsp;<a href="#" onclick="Popup=window.open('screen.php?screen=24_TurkaOWNS.jpg','Popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes'); return false;"><img src="files/screenshots/thumb/24_TurkaOWNS.jpg" border="0"></a></td>								</tr>
							</table>															
						</td>
					</tr>
				</table>	
