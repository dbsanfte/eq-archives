...
<td width="150" height="600" background="imagenes/main/motivocol1.gif" valign="top">
	...
	<!-- PARTE CENTRAL //-->
<td width="*" valign="top"><br><table border="0" width="91%" align="center" cellpadding="0" cellspacing="0"> <tr><td width="10"><img src="imagenes/motivodat.gif"></td><td background="imagenes/motivodat3.gif" class="titulofecha">Futuros Miembros DH</td><td width="10"><img src="imagenes/motivodat2.gif"></td></tr></table><br><table border="0" bgcolor="#464646" width="90%" cellpadding="10" align="center"><tr align="center"><td bgcolor="black" class="texto" width="20%">Add</td><td bgcolor="black" class="texto" width="20%">Arthanis</td><td bgcolor="black" class="texto" width="20%">Bilbo</td><td bgcolor="black" class="texto" width="20%">Calgar</td><td bgcolor="black" class="texto" width="20%">ChenchoMataCerdos</td></tr><tr align="center"><td bgcolor="black" class="texto" width="20%">Delios</td><td bgcolor="black" class="texto" width="20%">Gotrek</td><td bgcolor="black" class="texto" width="20%">Hacechador</td><td bgcolor="black" class="texto" width="20%">Izaru</td><td bgcolor="black" class="texto" width="20%">Karbono</td></tr><tr align="center"><td bgcolor="black" class="texto" width="20%">Kharas</td><td bgcolor="black" class="texto" width="20%">krazy</td><td bgcolor="black" class="texto" width="20%">ljxx</td><td bgcolor="black" class="texto" width="20%">lordantonio</td><td bgcolor="black" class="texto" width="20%">Loryen</td></tr><tr align="center"><td bgcolor="black" class="texto" width="20%">menndo</td><td bgcolor="black" class="texto" width="20%">Mistica</td><td bgcolor="black" class="texto" width="20%">Nanyllo</td><td bgcolor="black" class="texto" width="20%">nightmare</td><td bgcolor="black" class="texto" width="20%">shadowchan</td></tr><tr align="center"><td bgcolor="black" class="texto" width="20%">sharevock</td><td bgcolor="black" class="texto" width="20%">TempusDark</td><td bgcolor="black" class="texto" width="20%">wizy</td><td bgcolor="black" class="texto" width="20%">wizy</td><td bgcolor="black" class="texto" width="20%">Zano</td></tr></table><table width="90%" border="0" cellspacing="0" cellpadding="0"><tr class="texto"><td align="left"><br><br><br></td><td align="right"></td></tr></table></td>
				  ...
				  <tr>
					  <td valign="center" align="center">
						  <table border="0" width="118">
							  <tr>
  <td align="center">&nbsp;&nbsp;<a href="#" onclick="Popup=window.open('screen.php?screen=84_dungeon.jpg','Popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes'); return false;"><img src="files/screenshots/thumb/84_dungeon.jpg" border="0"></a></td>								</tr>
							</table>															
						</td>
					</tr>
				</table>	
