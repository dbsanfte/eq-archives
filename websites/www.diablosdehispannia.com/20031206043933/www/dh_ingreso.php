...
<td width="*" valign="top"><br>	<SCRIPT LANGUAGE="JavaScript">
	...
	function checkData() {
		...
		var t1 = f1.ingreso_email;
		if (t1.value == "" || t1.value == " ") {
			wm += "Email\r\n";
			noerror = 0;
		}
	
		var t1 = f1.ingreso_texto;
		if (t1.value == "" || t1.value == " ") {
			wm += "Cuenta algo sobre ti\r\n";
			noerror = 0;
		}
  ...
  <table border="0" width="410" align="center" cellpadding="0" cellspacing="0"> 
    ...
    Solicitud de Ingreso en el Clan
    </td>
  ...
  <tr><td bgcolor="black" class="texto">
  	...
  	<form name="ingreso" method="post" action="/www/dh_ingreso.php" onSubmit="return checkData()">
    	<tr>
    	<td class="texto" align="center">
    		¿Quien eres?
    	</td>
    	<td>
    	  <input type="text" name="ingreso_nick" class="formulario" size="55">
    	</td>
      </tr>
      <tr>
    	<td class="texto" align="center">
    	...
    	<td>
    	  <input type="text" name="ingreso_email" class="formulario" size="55">
    	</td>
      </tr>
     	<tr>
    	<td class="texto" align="center">
    	...
    	<td>
    	  <input type="text" name="ingreso_como" class="formulario" size="55">
    	</td>
      </tr>
     	<tr>
    	<td class="texto" colspan="2" align="center">
    		Cuentanos algo de ti y las razones por las que quieres ingresar
    	</td>
      </tr>
     	<tr>
    	<td colspan="2" align="center">
    	    <textarea name="ingreso_texto" class="formulario" style="background-color: #FFFFFF;" cols="60" rows="6"></textarea>
    	</td>
      </tr>
      <tr>
    	<td colspan="2" align="center" class="texto">
    	      <input type="checkbox" name="ingreso_aceptar" class="formulario">
    	      Comprendo y acepto las <a href="dh_normas.php">normas</a> de este clan
    	</td>
      </tr>
      <tr>
    	<td colspan="2" align="center">
    	    <input type="submit" name="Submit" value="Enviar" class="formulario">
    	</td>
      </tr>
    </form>
    </table>
				  ...
				  <tr>
					  <td valign="center" align="center">
						  <table border="0" width="118">
							  <tr>
  <td align="center">&nbsp;&nbsp;<a href="#" onclick="Popup=window.open('screen.php?screen=11_sshot036.jpg','Popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes'); return false;"><img src="files/screenshots/thumb/11_sshot036.jpg" border="0"></a></td>								</tr>
							</table>															
						</td>
					</tr>
				</table>	
