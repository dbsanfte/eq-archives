        ...
        <tr>
          ...
          <td width="601" height="350" valign="top">
            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="200" valign="top"><b></b><br>
¤ Continent: <br>
¤ Landscape: <br>
¤ Level Range:  - <br>
<img src="images/print_w.gif" width="17" height="17" align="left"> <a href="infosheet.php3?tag=" target="_blank">Zone Info Sheet</a></td>
...
&nbsp;<a href="JavaScript:popSubmitLM('')">add</a></td>
  ...
  <option>Unique Items - 0
</select>
</td>
                <td align="center" valign="top"><select name="npc" onChange="loadZ('&npc=', this)">
  <option>Unique NPC's - 1
  <option value="-1">a_voidnpc
</select>
</td>
              </tr>
              <tr><td colspan="3"><hr width="100%" size="1"></td></tr>
              <tr><td colspan="3"><b>Sorry, No Description Available!</b> <a href="mailto:niteraven@eqmaps.com?subject=Description for ">submit one</a></td></tr>
            </table>
            <br><br>
	    <table width="600" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td width="340" bgcolor="#0D1B28"><b>Player Comments</b> [ showing: 0 to 0 ] [ total: 0 ]</td>
    <td width="120" bgcolor="#0D1B28" align="right"><img src="images/post.gif" width="18" height="17"></td>
    <td width="140" bgcolor="#0D1B28" align="left"><a href="JavaScript:popComment('comment.php3?type=zone&tid=')"><strong>Add Comment</strong></a></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#0D1B28" align="center"></td>
  </tr>
</table>            </form>
          </td>
