      ...
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
		  ...
		  <select NAME="eqrace" onChange="fillClass()">
                    ...
                    <option value="FRG">Froglok</option>
...
<option value="MANA">MANA</option>
                ...
                <td align="right">from: <input type="text" name="boo_min" size="2" maxlength="3" value="1"> - <input type="text" name="boo_max" size="2" maxlength="3" value="250"></td>
                ...
                <td align="right">Focus <input type="text" name="focus_effect" size="10" maxlength="30" value=""></td>
	      </tr>
              <tr>
                <td align="right">
...
<option value="SVP">SVP</option>
                ...
                <td align="right">from: <input type="text" name="res_min" size="2" maxlength="3" value="1"> - <input type="text" name="res_max" size="2" maxlength="3" value="250"></td>
...
<option value="befallen">Befallen
<option value="blackburrow">Blackburrow
<option value="brokenskull">Broken Skull Rock
<option value="burningwoods">Burning Woods
<option value="butcher">Butcherblock Mtns
...
<option value="dawnshroud">Dawnshroud Peaks
<option value="deepguk">Deepest Guk
<option value="pofire">Doomfire, The Burning Lands
<option value="necropolis">Dragon Necropolis
<option value="dreadlands">Dreadlands
<option value="dlab">Drovrag's Labryrinth
<option value="potactics">Drunder, Fortress of Zek
<option value="dulak">Dulak's Harbor
...
<option value="erudnext">Erudin Docks
<option value="erudnint">Erudin Palace
<option value="poair">Eryslai, the Kingdom of Wind
...
<option value="povalor">Plane of Valor
<option value="powar">Plane of War
<option value="popower">Planes of Power
<option value="qcat">Qeynos Catacombs
<option value="qeytoqrg">Qeynos Hills
<option value="poearthb">Ragrax, Stronghold of Twelve
...
<option value="vpeak">Veeshan's Peak
<option value="poeartha">Vegarlson, the Earthen Badland
<option value="veksar">Veksar
<option value="velious">Velious
