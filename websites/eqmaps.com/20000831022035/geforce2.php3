<html>
<head>
<title>Win a GeForce2 GTS!</title>
    ...
    <td width="625" valign="top">
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
          ...
          <center><font class="headline">Win a GeForce2 GTS from EQmaps.com!</font></center><br><br>
          Starting on July 25th EQmaps.com will hold a <font class="price">two week drawing</font> that ends on Tuesday
	  August 8th for a GeForce2 GTS graphics card from <a href="http://www.creativelabs.com/" target="_blank">Creative Labs</a> called the
	  <a href="http://www.americas.creative.com/graphics/3db-annihilator2/" target="_blank">3D Blaster Annihilator 2</a>
	  delivered to the winner's door! If the winner cannot use the GeForce2 because their computer does not have an AGP
	  slot or they already have the card etc. they can opt for a prize of $250 US Dollars instead. The purpose of
	  this drawing is to promote the use of our new <font class="price">Price Details Tool</font> that allows players to
	  post prices they have seen a particular item sell for on their server to help others in their purchasing
	  decisions. The Price Detail Tool can be found using the link in the <font class="price">Additional Info</font>
	  section of every item that is not flagged as "NO DROP". When a player enters a price into the database using
	  the form provided they are automatically entered into the drawing, an e-mail address
	  is also required so we can contact you should you win. The more you submit the better chance you have to win!
	  On August 8th I will pick a random entry from the database off all price entries that have a valid e-mail address.
	  I will then contact that person by e-mail and give them one (1) day to respond. If they don't respond in 24 hours I will
	  pick another entry and contact that person and continue to do so until a winner responds. I will also post the winner
	  in a news post on August 8th in case their e-mail isn't working for some reason. Please read over the following
          rules of the drawing.<br><br>
          <center><font class="headline">DRAWING RULES</font></center><br>
          <ol>
	    <li>Player must enter a valid e-mail address to win.</li>
	    <li>The winner must respond within one (1) day after they are announced.</li>
	    <li>The winning entry must not be a bogus price. If a player is found to enter a bogus
	    price or prices all of their entries will be deleted. All data will be reviewed carefully
	    before taking drastic measure such as deleting all entries.</li>
            <li>Bogus price detection has been programmed into the script to reduce bad entries. Also other
            players can submit bogus prices they find which will be reviewed by the staff.</li>
	    <li>The winner cannot be a EQmaps.com staff member nor can it be family or friend of the staff.</li>
	  </ol>
          </td>
