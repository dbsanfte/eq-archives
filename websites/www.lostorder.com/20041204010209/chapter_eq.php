...
<html>
<head>
<title>EverQuest II Chapter</title>
...
<body>
	<div id="header">
		...
		<form action="http://www.lostorder.com/vforums/login.php" method="POST" onsubmit="md5hash(vb_login_password,vb_login_md5password,vb_login_md5password_utf)">
			...
			<input type="hidden" name="url" value="http://www.lostorder.com/chapter_eq.php">
...
<h2>Our Worlds</h2><li class="navmenuselected"><a href="chapter_eq.php">EverQuest II</a></li><li><a href="chapter_wow.php">World of Warcraft</a></li><li><a href="chapter_coh.php">City of Heroes</a></li><li><a href="chapter_swg.php">Star Wars Galaxies</a></li><li><a href="chapter_daoc.php">Dark Age of Camelot</a></li><li><a href="chapter_ffxi.php">Final Fantasy XI</a></li><li><a href="chapter_hz.php">Horizons</a></li><li><a href="chapter_ps.php">PlanetSide</a></li></ul>
	...
	<div id="maincontent">
		...
		<div class="content">
			<ul>
  <dt><strong>Chapter Name:</strong></dt>
  <dd>EverQuest II</dd>
  <dt><strong>Forum:</strong></dt>
  <dd><a href="http://www.lostorder.com/vforums/forumdisplay.php?f=18">Jump to 
    Forum</a></dd>
  <dt><strong>Chapter Status:</strong></dt>
  <dd>Official</dd>
  <dt><strong>Server:</strong></dt>
  <dd>Permafrost</dd>
  <dt><strong>Chapter Alignment:</strong></dt>
  <dd>Mixed</dd>
  <dt><strong>Chapter Focus:</strong></dt>
  <dd>Social, family environment and raiding.</dd>
  <dt><strong>Race or Class Restrictions:</strong></dt>
  <dd>None</dd>
</ul>
...
The Avatar system coded by <a href="mailto:freejack@lostorder.com">Sam Brown</a>.
		...
		<div class="pagestats">
Page generated using 8 queries in 0.2553 seconds.<br>
		</div>
