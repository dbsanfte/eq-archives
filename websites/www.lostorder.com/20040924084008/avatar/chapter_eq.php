...
<div class="infoboxprimary">
	<h2>Users Online</h2>
	<a href="http://www.lostorder.com/vforums/member.php?u=46" title="View user profile"><b><font color="#002C59">Avalloc</font></b></a>
</div></div>
...
Backend site code by Sam Brown.
		...
		<div class="pagestats">
Page generated using 7 queries in 0.2905 seconds.<br>
		</div>
...
(
    ...
    [7] => SELECT * FROM usergroup, session LEFT JOIN user AS user ON (user.userid = session.userid) WHERE session.lastactivity > 1096014075 AND user.usergroupid = usergroup.usergroupid ORDER BY username ASC<br>
