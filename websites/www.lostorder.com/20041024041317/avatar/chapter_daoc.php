...
<body>
	<div id="header">
		...
		<input type="hidden" name="url" value="http://www.lostorder.com/avatar/chapter_daoc.php">
...
Backend site code by Sam Brown.
		...
		<div class="pagestats">
Page generated using 7 queries in 0.0746 seconds.<br>
		</div>
		<div class="pageglobals">
Queries used=[Array
(
    [1] => SELECT * FROM pages WHERE page_id = 19<br>
    ...
    [7] => SELECT * FROM usergroup, session LEFT JOIN user AS user ON (user.userid = session.userid) WHERE session.lastactivity > 1098590010 AND user.usergroupid = usergroup.usergroupid ORDER BY username ASC<br>
