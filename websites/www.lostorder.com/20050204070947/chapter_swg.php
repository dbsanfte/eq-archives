...
<html>
<head>
<title>Star Wars Galaxies Chapter</title>
...
<body>
	<div id="header">
		...
		<form action="http://www.lostorder.com/vforums/login.php" method="POST" onsubmit="md5hash(vb_login_password,vb_login_md5password,vb_login_md5password_utf)">
			...
			<input type="hidden" name="url" value="http://www.lostorder.com/chapter_swg.php">
...
<div class="navmenu">
<ul>
<h2>Our Worlds</h2><li><a href="chapter_eq.php">EverQuest II</a></li><li><a href="chapter_wow.php">World of Warcraft</a></li><li><a href="chapter_coh.php">City of Heroes</a></li><li class="navmenuselected"><a href="chapter_swg.php">Star Wars Galaxies</a></li><li><a href="chapter_daoc.php">Dark Age of Camelot</a></li><li><a href="chapter_ffxi.php">Final Fantasy XI</a></li><li><a href="chapter_hz.php">Horizons</a></li><li><a href="chapter_ps.php">PlanetSide</a></li></ul>
</div>
	...
	<div id="maincontent">
		...
		<div class="content">
			<ul>
  <dt><strong>Chapter Name:</strong></dt><dd>Star Wars Galaxies</dd>
  <dt><strong>Forum:</strong></dt><dd><a href="http://www.lostorder.com/vforums/forumdisplay.php?f=20">Jump to Forum</a></dd>
  <dt><strong>Chapter Status:</strong></dt><dd>Unofficial</dd>
  <dt><strong>Server:</strong></dt><dd>Gorath</dd>
  <dt><strong>Where to find guild members:</strong></dt><dd>Corelia - New Haven. Chat channel is Chat - Akalabeth (or some derivative).</dd>
  <dt><strong>Chapter Alignment:</strong></dt><dd>All allowed. (Imp, Rebel and Neutral; overt and covert)</dd>
  <dt><strong>Chapter Focus:</strong></dt><dd>Non-roleplay, but we are working on making it more 50/50</dd>
...
The Avatar system coded by <a href="mailto:freejack@lostorder.com">Sam Brown</a>.
		...
		<div class="pagestats">
Page generated using 9 queries in 0.3180 seconds.<br>
		</div>
