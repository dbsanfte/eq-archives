...
<html>
<head>
<title>LOA World of Warcraft Page</title>
...
<body>
	<div id="header">
		...
		<form action="http://www.lostorder.com/vforums/login.php" method="POST" onsubmit="md5hash(vb_login_password,vb_login_md5password,vb_login_md5password_utf)">
			...
			<input type="hidden" name="url" value="http://www.lostorder.com/chapter_wow.php">
...
<h2>Our Worlds</h2><li><a href="chapter_eq.php">EverQuest II</a></li><li class="navmenuselected"><a href="chapter_wow.php">World of Warcraft</a></li><li><a href="chapter_coh.php">City of Heroes</a></li><li><a href="chapter_swg.php">Star Wars Galaxies</a></li><li><a href="chapter_daoc.php">Dark Age of Camelot</a></li><li><a href="chapter_ffxi.php">Final Fantasy XI</a></li><li><a href="chapter_hz.php">Horizons</a></li><li><a href="chapter_ps.php">PlanetSide</a></li></ul>
	...
	<div id="maincontent">
		...
		<div class="content">
			<img src="http://www.lostorder.com/memberphotos/albums/userpics/10003/loa_wow_chpimage.jpg">
<center><a href="http://www.lostorder.com/vforums/forumdisplay.php?f=24">Jump to our World of Warcraft forum</a></center>
			<div class="copyright">
...
The Avatar system coded by <a href="mailto:freejack@lostorder.com">Sam Brown</a>.
		...
		<div class="pagestats">
Page generated using 8 queries in 0.2518 seconds.<br>
		</div>
