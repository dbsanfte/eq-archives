...
<div class="contentbody">
	<p>While the forums are a great form of communication for the entire guild, many users also use what's known as Internet Relay Chat, or IRC, to chat. Think of the difference as the forums being like sending emails, and IRC as being in a telephone conversation.</p>
	<p>To connect with us to IRC, you can take a few paths.</p>
	...
	<p>There you go! All set for mIRC.</p>
	<p>If you would prefer to enter your own information into mIRC, here is the server that we use, as well as some alternatives (in case one server is experiencing problems):</p>
	<ul>
		<li><span class="texthighlight">network.mystical.net </span>
		<li><span class="texthighlight">calgary2.ab.ca.mystical.net </span>
		<li><span class="texthighlight">surreal.tx.us.mystical.net </span>
		<li><span class="texthighlight">mystic.mystical.net </span> 
	</ul>
	...
	<p>If you are behind a firewall that blocks the ports needed by IRC, or would prefer not to download and install a program, or would just like to see the web based IRC client, you can browse to the <a href="http://www.mystical.net">Mystical</a> homepage.</p>
	<p>On the right side you will see places where you can enter your nickname (must 
	be letter and numbers only, no spaces) and the channel you wish to join (<span class="texthighlight">type 
	#akalabeth here</span>). You can also chose a different scheme, or leave it 
	as default (this really has no affect on your ability to chat).</p>
...
The Avatar system coded by <a href="mailto:freejack@lostorder.com">Sam Brown</a>.
		...
		<div class="pagestats">
Page generated using 9 queries in 0.1991 seconds.<br>
		</div>
