    ...
    <table border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        ...
        <select name="SearchMember">
          ...
          <option value="516">Chrismable</option>
          <option value="517">Cimmeriandoug</option>
          <option value="332">cinz</option>
          <option value="337">cloud</option>
          <option value="273">Conner</option>
          <option value="524">Coreidan</option>
          ...
          <option value="519">Darkbackward</option>
          ...
          <option value="522">googlesoft</option>
          ...
          <option value="523">ninjastyle</option>
          ...
          <option value="525">Ordasis</option>
          ...
          <option value="518">Stephon</option>
          ...
          <option value="520">tjc1040</option>
...
<!-- timer
<center>
<font face="Verdana, Arial, Helvetica" size="1">85450.78</font>
</center>
end timer -->
</html>
