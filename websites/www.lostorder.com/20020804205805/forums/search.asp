    ...
    <table border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        ...
        <select name="Forum" size="1">
          ...
          <option value="53">Veeshan Alliance (Raid Forum)</option>
          <option value="54">Veeshan Alliance (Epic Forum)</option>
          ...
          <option value="55">Veeshan Alliance (Diplomacy Forum)</option>
          <option value="43">Screenshots/Images from all our Chapters</option>
          <option value="60">NWN General Discussion - Public Access</option>
          <option value="52">Veeshan Alliance (General Discussion)</option>
          <option value="61">NWN Dungeon Master - Registered Users</option>
          <option value="62">Contact Lost Order of Akalabeth - General</option>
      ...
      <tr>
        ...
        <select name="SearchMember">
          ...
          <option value="460">deadringer</option>
          <option value="307">Deathwish Dragon</option>
          <option value="385">Dekan</option>
          <option value="326">Delfrain</option>
          <option value="304">Demeter</option>
          <option value="61">Denwar</option>
          <option value="102">Diencet</option>
          <option value="315">dindolary</option>
          <option value="200">Djalinn</option>
          <option value="226">Dniper</option>
          <option value="341">Doccus</option>
          <option value="331">drak</option>
          <option value="188">DrBuzz_LOA</option>
          <option value="271">Drex</option>
          <option value="329">Dudemar</option>
          <option value="211">Durff Bladeswinger</option>
          <option value="439">Dweia Emerald</option>
          <option value="461">dweia silverbane</option>
          <option value="339">dyslexicdog</option>
          ...
          <option value="435">Elroth</option>
          ...
          <option value="463">EternalSoul</option>
          <option value="466">Eyeke</option>
          <option value="108">Falamil</option>
          <option value="371">Fallanthas Woodhelven</option>
          <option value="432">Faramir of Westerbrook</option>
          <option value="423">faran</option>
          <option value="106">Fawnea</option>
          <option value="472">Fert</option>
          <option value="443">Feyden</option>
          <option value="454">FinalWarning</option>
          <option value="480">Fippel</option>
          <option value="55">Fistan</option>
          <option value="444">Fizzled</option>
          <option value="411">flubber</option>
          <option value="361">Folenor</option>
          ...
          <option value="415">Galivan</option>
          <option value="277">Gambit</option>
          <option value="330">Gamei Vendaval</option>
          <option value="245">Gammon</option>
          <option value="384">Garen Moonshadow</option>
          <option value="178">Garet</option>
          <option value="437">Garmoon</option>
          <option value="484">Gaul</option>
          <option value="157">Gawain</option>
          <option value="450">Geist</option>
          ...
          <option value="376">GizziFurrfoot</option>
          <option value="216">Glamm</option>
          <option value="318">Glane</option>
          <option value="353">Golconda</option>
          <option value="343">GoldenArrow</option>
          <option value="349">gonzo</option>
          <option value="11">Gooba</option>
          <option value="405">goon</option>
          <option value="29">Gradishar</option>
          <option value="406">GraeSotC</option>
          <option value="186">Greyson</option>
          <option value="465">Greywind</option>
          <option value="407">Guerin</option>
          <option value="144">Gwar-STC</option>
          <option value="34">Gwenneth</option>
          <option value="9">Gwippen</option>
          <option value="446">habib</option>
          <option value="104">Hakadek</option>
          <option value="344">hal900x</option>
          <option value="177">Hawklin</option>
          <option value="317">Hawkshadow</option>
          <option value="493">Headcrusher</option>
          <option value="153">Helek</option>
          <option value="259">hena hacksalot</option>
          <option value="228">HibernianInvader</option>
          <option value="500">Hojo</option>
          <option value="238">Holdan</option>
          <option value="155">horizon-tp</option>
          <option value="323">Huzbub</option>
          <option value="202">Ian Stormbringer</option>
          <option value="424">iclubcops4fun</option>
          ...
          <option value="455">jackatt</option>
          <option value="13">Jade</option>
          <option value="491">Jadzia</option>
          <option value="257">Jared</option>
          <option value="403">JeanneDarque</option>
          <option value="63">Jediit</option>
          <option value="473">Jennifer Akins</option>
          <option value="445">Jennivere</option>
          <option value="364">Jestermin</option>
          <option value="433">Jezzmin</option>
          <option value="386">Jice</option>
          <option value="242">jolster</option>
          <option value="409">Jomayla</option>
          ...
          <option value="348">Mekkun_BCK</option>
          <option value="389">Melrin_Specclaster</option>
          <option value="249">Mengsk</option>
          <option value="44">Merad</option>
          <option value="258">Mestopheles</option>
          <option value="475">Methril</option>
          ...
          <option value="390">montesque</option>
          <option value="79">Morlife</option>
          <option value="68">Mornica</option>
          <option value="363">Morpheen</option>
          ...
          <option value="355">Musk</option>
          <option value="354">Mysticdrew</option>
          <option value="26">Nadian</option>
          <option value="490">nagaraja.p</option>
          <option value="398">nalin</option>
          ...
          <option value="495">Neebear</option>
          ...
          <option value="350">Nizudn</option>
          <option value="31">Nocixel</option>
          <option value="413">Nomad Orion</option>
          <option value="76">Noony</option>
          <option value="479">Norman</option>
          ...
          <option value="328">R03W</option>
          <option value="272">Rachelle</option>
          <option value="481">Rachgier</option>
          <option value="486">rahdon</option>
          <option value="336">Raifin</option>
          <option value="199">Rainbearer</option>
          <option value="67">Ralineth</option>
          <option value="459">Ranbas</option>
          <option value="464">Ranic Warchild</option>
          <option value="130">Rask</option>
          <option value="301">Raul</option>
          <option value="139">Ravenhill</option>
          <option value="185">Relfo</option>
          <option value="404">Rhiannon</option>
          <option value="320">Rift</option>
          <option value="121">RizzWulfgard</option>
          <option value="232">Rowan</option>
          <option value="478">rshipp</option>
          <option value="20">Ruccus</option>
          <option value="310">Runilden Tinuviel</option>
          <option value="241">Rycovias</option>
          <option value="456">Sabremaster</option>
          <option value="417">Saegan</option>
          <option value="268">sagal.hunglo</option>
          <option value="197">Sagittarius</option>
          <option value="514">sandman</option>
          <option value="122">Santiago</option>
          <option value="501">Saron</option>
          <option value="235">Sayuri</option>
          <option value="367">scrounger</option>
          <option value="254">SeaJade</option>
          <option value="284">senatorb</option>
          <option value="505">Senth</option>
          <option value="345">Sephiroth</option>
          ...
          <option value="485">Shaylee</option>
          <option value="401">Shevria</option>
          <option value="452">shmak</option>
          <option value="462">SimonDeMonfort</option>
          <option value="511">Sinthetic</option>
          ...
          <option value="342">Sleeping</option>
          ...
          <option value="325">somitheo</option>
          <option value="189">Soulmirror</option>
          <option value="380">Spanky</option>
          <option value="489">Stirek</option>
          <option value="502">Stormcrow</option>
          <option value="346">Stray</option>
          <option value="147">Strider</option>
          <option value="306">Stryker</option>
          <option value="324">Sumakin_TK</option>
          ...
          <option value="482">Taeg</option>
          <option value="381">Taja</option>
          <option value="255">Taleswapper</option>
          <option value="448">Talshar</option>
          <option value="8">Tambur Treeskin</option>
          <option value="488">Tara</option>
          <option value="513">Tarcon</option>
          <option value="373">Tarin</option>
          <option value="372">TarinL0A</option>
          ...
          <option value="400">Wras</option>
          <option value="23">Wryliak Walaryn</option>
          <option value="297">Wutan Ironblood</option>
          <option value="388">WuTangYang</option>
          <option value="399">WyldFyre</option>
          <option value="36">Wynnie Walaryn</option>
          <option value="498">Xandre</option>
          <option value="288">Xaul</option>
          <option value="494">Xavier</option>
          <option value="387">Xendax</option>
          <option value="43">Xor</option>
          <option value="499">xxtommyxx69</option>
          ...
          <option value="369">Zeena</option>
          <option value="434">Zemas Frostbane</option>
          <option value="176">Zenith</option>
          <option value="506">zerocool2024</option>
          <option value="14">Zlater</option>
          <option value="469">Zoltan</option>
...
<!-- timer
<center>
<font face="Verdana, Arial, Helvetica" size="1">53925.18</font>
</center>
end timer -->
</html>
