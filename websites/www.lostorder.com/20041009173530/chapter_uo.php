...
<html>
<head>
<title>Ultima Online Chapter</title>
...
<body>
	<div id="header">
		...
		<form action="http://www.lostorder.com/vforums/login.php" method="POST" onsubmit="md5hash(vb_login_password,vb_login_md5password,vb_login_md5password_utf)">
			...
			<input type="hidden" name="url" value="http://www.lostorder.com/chapter_uo.php">
...
<div class="navmenu">
<ul>
<h2>Our Worlds</h2><li><a href="chapter_eq.php">EverQuest</a></li><li><a href="chapter_daoc.php">Dark Age of Camelot</a></li><li><a href="chapter_swg.php">Star Wars Galaxies</a></li><li><a href="chapter_hz.php">Horizons</a></li><li><a href="chapter_ffxi.php">Final Fantasy XI</a></li><li><a href="chapter_ps.php">PlanetSide</a></li><li><a href="chapter_coh.php">City of Heroes</a></li><li class="navmenuselected"><a href="chapter_uo.php">Ultima Online</a></li></ul>
</div>
	...
	<div id="maincontent">
		...
		<div class="content">
			<ul>
  <dt><strong>Chapter Name:</strong></dt><dd>Ultima Online</dd>
  <dt><strong>Forum:</strong></dt><dd><a href="http://www.lostorder.com/vforums/forumdisplay.php?f=56">Jump to Forum</a></dd>
  <dt><strong>Chapter Status:</strong></dt><dd>Unofficial</dd>
  <dt><strong>Server:</strong></dt><dd>Atlantic</dd>
  <dt><strong>Where to find guild members:</strong></dt><dd>Yew, Felucca</dd>
  <dt><strong>Chapter Alignment:</strong></dt><dd>Good</dd>
  <dt><strong>Chapter Focus:</strong></dt><dd>To serve Yew and the RPing community, raids, and events with our allied guilds</dd>
</ul>
			<div class="copyright">
...
The Avatar system coded by <a href="mailto:freejack@lostorder.com">Sam Brown</a>.
		...
		<div class="pagestats">
Page generated using 9 queries in 0.2181 seconds.<br>
		</div>
