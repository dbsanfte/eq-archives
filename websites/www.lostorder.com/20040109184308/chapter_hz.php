...
<h2>Our Worlds</h2><li><a href="chapter_eq.php">EverQuest</a></li><li><a href="chapter_daoc.php">Dark Age of Camelot</a></li><li><a href="chapter_swg.php">Star Wars Galaxies</a></li><li class="navmenuselected"><a href="chapter_hz.php">Horizons</a></li><li><a href="chapter_ffxi.php">Final Fantasy XI</a></li><li><a href="chapter_sb.php">ShadowBane</a></li><li><a href="chapter_ps.php">PlanetSide</a></li></ul>
  ...
  <dt><strong>Chapter Leaders:</strong></dt><dd><ul><li>Sokar On`Nakal(Gileean)/Unofficial Chapter Leader</li><li>Demeth Mentor/Asst. Chapter Leader & LOI</li><li>Lostinthewood Ak`Bal/Chapter Advisor</li><li>Druegan Steelgrip(Agavar)/Prime Quartermaster</li></ul></dd>
  <dt><strong>Mission Statement:</strong></dt><dd></dd>
  <dt><strong>Chapter Status:</strong></dt><dd>Unofficial</dd>
  <dt><strong>Server:</strong></dt><dd>Dawn</dd>
  <dt><strong>Where to find guild members:</strong></dt><dd>New Koraelia</dd>
...
Backend site code by Sam Brown.
		...
		<div class="pagestats">
Page generated using 7 queries in 0.0815 seconds.<br>
		</div>
