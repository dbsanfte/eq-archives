...
<html>
<head>
<title>ShadowBane Chapter</title>
...
<body>
	<div id="header">
		...
		<input type="hidden" name="url" value="http://www.lostorder.com/avatar/chapter_sb.php">
...
<h2>Our Worlds</h2><li><a href="chapter_eq.php">EverQuest</a></li><li><a href="chapter_daoc.php">Dark Age of Camelot</a></li><li><a href="chapter_swg.php">Star Wars Galaxies</a></li><li><a href="chapter_hz.php">Horizons</a></li><li><a href="chapter_ffxi.php">Final Fantasy XI</a></li><li class="navmenuselected"><a href="chapter_sb.php">ShadowBane</a></li></ul>
	...
	<div id="maincontent">
		...
		<div class="content">
			<ul>
  <dt><strong>Chapter Name:</strong></dt><dd>ShadowBane</dd>
  <dt><strong>Mission Statement:</strong></dt><dd></dd>
  <dt><strong>Chapter Status:</strong></dt><dd>Unofficial</dd>
  <dt><strong>Server:</strong></dt><dd></dd>
  <dt><strong>Where to find guild members:</strong></dt><dd></dd>
  <dt><strong>Chapter Alignment:</strong></dt><dd></dd>
  <dt><strong>Chapter Focus:</strong></dt><dd></dd>
  <dt><strong>Race or Class Restrictions:</strong></dt><dd></dd>
</ul>
		</div>
	<div class="copyright">
...
Backend site code by Sam Brown.
		...
		<div class="pagestats">
Page generated using 7 queries in 0.0829 seconds.<br>
		</div>
		<div class="pageglobals">
Queries used=[Array
(
    [1] => SELECT * FROM pages WHERE page_id = 36<br>
    ...
    [7] => SELECT * FROM usergroup, session LEFT JOIN user AS user ON (user.userid = session.userid) WHERE session.lastactivity > 1098590014 AND user.usergroupid = usergroup.usergroupid ORDER BY username ASC<br>
