...
Select roster to display: 	<select name="chapterfilter" onchange="this.form.submit();"><option value="Entire Guild" selected>Entire Guild</option><option value="None" >None</option><option value="Guild Leadership" >Guild Leadership</option><option value="Asherons Call 2" >Asherons Call 2</option><option value="Battlefield 2" >Battlefield 2</option><option value="City Of Heroes / Villains" >City Of Heroes / Villains</option><option value="Dark Age of Camelot" >Dark Age of Camelot</option><option value="Dungeons and Dragons Online" >Dungeons and Dragons Online</option><option value="EverQuest II" >EverQuest II</option><option value="Final Fantasy XI" >Final Fantasy XI</option><option value="Guild Wars" >Guild Wars</option><option value="Lord of the Rings Online" >Lord of the Rings Online</option><option value="Pirates of the Burning Seas" >Pirates of the Burning Seas</option><option value="Shadowbane" >Shadowbane</option><option value="Star Wars Galaxies" >Star Wars Galaxies</option><option value="Ultima Online" >Ultima Online</option><option value="World of Warcraft" >World of Warcraft</option></select>
 <input type="submit" class="button" value="Go"></form>
<center><h2>Roster for: Entire Guild</h2></center>
<center><h4>Number of Members: 312</h4></center>
<center><table>
<thead><tr><td>Member</td><td>Rank</td><td>Chapter</td></tr></thead>
	...
	<tr><td><a href="http://www.lostorder.com/vforums/member.php?u=953">Awildabee</a></td><td>Member</td><td>World of Warcraft</td></tr>
	...
	<tr><td><a href="http://www.lostorder.com/vforums/member.php?u=960">cayouche</a></td><td>Member</td><td>World of Warcraft</td></tr>
	...
	<tr><td><a href="http://www.lostorder.com/vforums/member.php?u=172">LostintheWood</a></td><td>Member</td><td>World of Warcraft</td></tr>
	...
	<tr><td><a href="http://www.lostorder.com/vforums/member.php?u=35">uncle solf</a></td><td>Member</td><td>None</td></tr>
...
The Avatar system coded by <a href="http://www.lostorder.com/vforums/sendmessage.php?do=mailmember&u=96">Sam Brown</a>.
		...
		<div class="pagestats">
Page generated using 10 queries in 0.5536 seconds.<br>
		</div>
