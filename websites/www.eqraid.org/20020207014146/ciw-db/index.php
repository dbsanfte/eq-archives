...
<td width="140" class=normal bgcolor=#cccccc>
	<b><u><center>Menu</center></u></b><br>
	<li> <a href="index.php">Top</a>
	<li> <a href="login.php">Login</a>
	<li> <a href="memberslist.php">Members List</a>
	<li> <a href="searchmemberform.php">Search Members</a>
	<li> <a href="trade.php?action=viewitem">CIW Trade/Sell</a>
	<li> <a href="logout.php">Log Off</a>
</td>
<td width=5 nowrap></td>
<td>
		Welcome to the Clan Icewind Profile Page.<br>
		If you are a registered user, <a href="login.php">click here to login.</a><br>
</td>
</tr>
</table>
