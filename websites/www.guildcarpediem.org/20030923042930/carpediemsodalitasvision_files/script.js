...
var gDocTable = new Array(
   ...
   new hrefList("slide0292.htm", 1, 3),
   new hrefList("slide0291.htm", 1, 4),
   new hrefList("slide0293.htm", 1, 5),
   new hrefList("slide0294.htm", 1, 6),
   new hrefList("slide0290.htm", 1, 7),
   new hrefList("slide0306.htm", 1, 8),
   new hrefList("slide0305.htm", 1, 9),
   new hrefList("slide0300.htm", 1, 10),
   new hrefList("slide0296.htm", 1, 11),
   new hrefList("slide0313.htm", 1, 12),
   new hrefList("slide0301.htm", 1, 13),
   new hrefList("slide0310.htm", 1, 14),
   new hrefList("slide0283.htm", 1, 15),
   new hrefList("slide0308.htm", 1, 16),
   new hrefList("slide0311.htm", 1, 17),
   new hrefList("slide0312.htm", 1, 18)
);
