<!-- www.eqdiva.com/quests/default.asp page downloaded on 3/5/01 7:41:29 AM
  //  Designed by Kocho Divah ~ kocho@eqdiva.com	//-->

<html>
<head>
	<title>EQdiva.com - Dedicated to Everquest Bards &nbsp;&nbsp;&nbsp;EQDiva Bard Quests</title>
			...
			<td height="1"><img src="/images/trans.gif" height="1" width="1"></td>
					...
					<td width="100%" valign="top" bgcolor="white">	
						<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
							<tr bgcolor="#FFFFCC">
								<td width="10">&nbsp;</td>	
								<td><b>Monday, March 05, 2001</b></td>
