...
<META name="keywords" content="everquest, eq, bard, bards, song, songs, eqdiva, eqdivas, epic, singing short sword, guides, ldon, items, instruments, illusions, armor, weapons, links, maps, zones, roleplaying, minstrel, kocho, diva, troubadour, virtuoso">
	...
	<body leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" marginheight="0" marginwidth="0">
		<form name="_ctl0" method="post" action="bards.aspx" id="_ctl0">
<input type="hidden" name="__VIEWSTATE" value="dDwzNzA2NzcxNDt0PDtsPGk8Mz47PjtsPHQ8O2w8aTw1Pjs+O2w8dDw7bDxpPDA+Oz47bDx0PDtsPGk8OT47PjtsPHQ8QDA8Ozs7Ozs7Ozs7Oz47Oz47Pj47Pj47Pj47Pj47PhtnZWFCk5F0zbv5gYJMPwKlVHq7" />
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Site_Header">
	<tr>
		...
		<td align="right" valign="top"><span class="SmallBoldWhiteText"></span><span class="SmallBoldWhiteText">April 2 10:57 AM</span>&nbsp;</td>
	</tr>
...
<script language="javascript">
			<!-- 
			function popupMagelo (magelo) {
				var Window = window.open('http://www.magelo.com/eq_view_profile.html?num='+magelo,'magelo','width=800,height=600');
			}
			-->
</script>
<select name="_ctl1:_ctl0:Server" id="_ctl1__ctl0_Server">
	<option value="-">-</option>
	<option value="Al'Kabor">Al'Kabor</option>
	...
	<option value="Morden Rasp">Morden Rasp</option>
...
<select name="_ctl1:_ctl0:Sort" id="_ctl1__ctl0_Sort">
...
<select name="_ctl1:_ctl0:Order" id="_ctl1__ctl0_Order">
	<option value="DESC">DESC</option>
	<option value="ASC">ASC</option>

</select>
<br><br>
<input type="submit" name="_ctl1:_ctl0:Search" value="Search for Bards!" id="_ctl1__ctl0_Search" />
<br><br>
...
<table cellSpacing="0" cellPadding="0" width="100%" class="OnlinePanel">
	<tr>
      ...
      <br>
      <b>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalVisitors">171</span></b> visitors in the last 20 minutes: 	
		<b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_UsersOnline">39</span></b> of <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalUsers">6,443</span></b> EQDiva members, <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_AnonymousUsers">132</span></b> anonymous<b>
		<br>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_Users"><a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Impbard">Impbard</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Sapper">Sapper</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Haard">Haard</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kythiara">Kythiara</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Elbereth">Elbereth</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Waeland">Waeland</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=skynard">skynard</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Elliot">Elliot</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=IrenaAdler">IrenaAdler</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=CeleadorKB">CeleadorKB</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kirico">Kirico</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kelami">Kelami</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Greylok">Greylok</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Mose">Mose</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Ascher">Ascher</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=ayena">ayena</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Rennea">Rennea</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=fiddler">fiddler</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Dilas">Dilas</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Haxaw">Haxaw</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Wynn">Wynn</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Banilos">Banilos</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=mampas">mampas</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Rapsody">Rapsody</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kokapelly">Kokapelly</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Gerr">Gerr</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Maelstrom">Maelstrom</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Dimitrius">Dimitrius</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Valya">Valya</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Scored">Scored</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=ResolErus">ResolErus</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=manlyent">manlyent</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Jennysys">Jennysys</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Quiz">Quiz</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Banidin">Banidin</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kareoke">Kareoke</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Qeystra">Qeystra</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Zildjian">Zildjian</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kaeluan">Kaeluan</a></span><br>
