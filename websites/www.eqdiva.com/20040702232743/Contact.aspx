...
<input type="hidden" name="__VIEWSTATE" value="dDwtMjA5NTgxNjA0NTs7PpEkfVpW1pAsIVZO00pLpU1dTFLG" />
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Site_Header">
	<tr>
		...
		<td align="right" valign="top"><span class="SmallBoldWhiteText"></span><span class="SmallBoldWhiteText">July 2 7:27 PM</span>&nbsp;</td>
	</tr>
		...
		<td id="SideMenu1__ctl0_Tablecell1" class="PanelBody" valign="Top" NAME="Tablecell1">
			...
			<a href="http://pub142.ezboard.com/beqdivabardsofeverquest" class="menuTextLink">Old EZBoards</a><br>
					...
					<td width="100%" valign="top">
						...
						<span id="Contact">
<br>
<table class="PanelBorder" cellSpacing="1" cellPadding="2" width="450">
	<tr>
	...
	<tr>
		<td class="PanelBody" valign="top" colspan="2">
		I want to hear from you about everything! Do you love the site? Looking for something you can't find? Having problems logging in? Get in touch with me here!<br><br>
		
		
		<table id="Contact__ctl0_ContactForm" align="Center" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td align="Center">
	
			<table cellspacing="1" border="0" cellpadding="2">
				<tr>
					<td align="right" class="FormLabel" width="25%">Your name:</td>
					<td>
						<input name="Contact:_ctl0:Name" type="text" maxlength="100" size="20" id="Contact__ctl0_Name" />
						
					</td>
				</tr>
				<tr>
					<td align="right" class="FormLabel">Your email:
					</td>
					<td>
						<input name="Contact:_ctl0:Email" type="text" maxlength="200" size="20" id="Contact__ctl0_Email" />
				...
				<tr>
					...
					<td>
					<select name="Contact:_ctl0:Subject" id="Contact__ctl0_Subject">
		...
		<option value="Bard Information">Bard Information</option>
		<option value="Submit Bard Humor">Submit Bard Humor</option>
		<option value="Other">Other</option>
				...
				<tr>
					...
					<textarea name="Contact:_ctl0:Message" rows="7" cols="40" id="Contact__ctl0_Message"></textarea>
					</td>
				</tr>
				<tr>
					<td>&nbsp;<br></td>
					<td><br>
						<input type="submit" name="Contact:_ctl0:contactButton" value="Send Message" onclick="if (typeof(Page_ClientValidate) == 'function') Page_ClientValidate(); " language="javascript" id="Contact__ctl0_contactButton" />
						<br><br>
					</td>
				</tr>
			</table>
...
<table cellSpacing="0" cellPadding="0" width="100%" class="OnlinePanel">
	<tr>
      ...
      <br>
      <b>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalVisitors">130</span></b> visitors in the last 20 minutes: 	
		<b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_UsersOnline">24</span></b> of <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalUsers">8,555</span></b> EQDiva members, <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_AnonymousUsers">106</span></b> anonymous<b>
		<br>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_Users"><a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kilanna">Kilanna</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Skyai">Skyai</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Naiku">Naiku</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Billham">Billham</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Eladuel">Eladuel</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Eored">Eored</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=yzyh">yzyh</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Llythir">Llythir</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Janrocker">Janrocker</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Mulluwen">Mulluwen</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=guld">guld</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=aikl">aikl</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Pleads">Pleads</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Heydidl">Heydidl</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Attolia">Attolia</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Dancelot">Dancelot</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=SeaOfHoles">SeaOfHoles</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Sonnatta">Sonnatta</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Rottstein">Rottstein</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Feralize">Feralize</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=barbai">barbai</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=krayle24">krayle24</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=misdanote">misdanote</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=reallyroln">reallyroln</a></span><br>
