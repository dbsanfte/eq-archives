...
<META name="keywords" content="everquest, eq, bard, bards, song, songs, eqdiva, eqdivas, epic, singing short sword, guides, ldon, items, instruments, illusions, armor, weapons, links, maps, zones, roleplaying, minstrel, kocho, diva, troubadour, virtuoso">
	...
	<body leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" marginheight="0" marginwidth="0">
		<form name="Form1" method="post" action="instruments.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDw2MzE4NTExMDA7Oz5yGLR6ea8sEaerCtzV2LmMrHK6Zg==" />
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Site_Header">
	<tr>
		...
		<td align="right" valign="top"><span class="SmallBoldWhiteText"></span><span class="SmallBoldWhiteText">July 3 8:35 PM</span>&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td id="SideMenu1__ctl0_Tablecell1" class="PanelBody" valign="Top" NAME="Tablecell1">
			...
			<a href="http://pub142.ezboard.com/beqdivabardsofeverquest" class="menuTextLink">Old EZBoards</a><br>
					...
					<br>
						<span id="Items">
<h4>Instruments and Items with Instrument Modifiers</h4>
Type:<select name="Items:_ctl0:ItemTypes" id="Items__ctl0_ItemTypes">
	<option selected="selected" value="10">All</option>
	<option value="0">Instruments Only</option>
	<option value="1">Non-Instruments</option>

</select>
Skill:<select name="Items:_ctl0:Skills" id="Items__ctl0_Skills">
	<option value="10">Any</option>
	<option value="1">Brass</option>
	<option value="2">Singing</option>
	<option value="3">Stringed</option>
	<option selected="selected" value="4">Percussion</option>
	<option value="5">Wind</option>
	<option value="0">All</option>

</select><br>
Sort by: <select name="Items:_ctl0:SortBy" id="Items__ctl0_SortBy">
	<option value="0">Bard Mod</option>
	<option value="1">Skill</option>
	<option value="2">Name</option>

</select>
<select name="Items:_ctl0:OrderBy" id="Items__ctl0_OrderBy">
	<option selected="selected" value="false">ASC</option>
	<option value="true">DESC</option>

</select>

<input type="submit" name="Items:_ctl0:Search" value="Go" id="Items__ctl0_Search" />
			

</span>
						<br><br>
						<span class="SmallText">Invaluable thanks goes to Calliopeia for help in maintaining this list. <br />
						Other thanks goes to Tinnor, www.obstinate.org/bard (not sure who this is), <br />
						and all bards who've helped gather bardic info.</span>
						<br><br>						
					</td>
					<td width="10"><img src="/images/trans.gif" height="1" width="10"></td>
				</tr>
...
<table cellSpacing="0" cellPadding="0" width="100%" class="OnlinePanel">
	<tr>
      ...
      <br>
      <b>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalVisitors">104</span></b> visitors in the last 20 minutes: 	
		<b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_UsersOnline">16</span></b> of <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalUsers">8,570</span></b> EQDiva members, <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_AnonymousUsers">88</span></b> anonymous<b>
		<br>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_Users"><a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=asmarthus">asmarthus</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=badfinger">badfinger</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Tludar">Tludar</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=BCB">BCB</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Rattan">Rattan</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Lyrr">Lyrr</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=gwydion">gwydion</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=iegaden">iegaden</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=alerka">alerka</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Mellodez">Mellodez</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kartoffel">Kartoffel</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=charmmar">charmmar</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=nissmo">nissmo</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Relvis">Relvis</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Glissa">Glissa</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Wadawen">Wadawen</a></span><br>
