...
<META name="keywords" content="everquest, eq, bard, bards, song, songs, eqdiva, eqdivas, epic, singing short sword, guides, ldon, items, instruments, illusions, armor, weapons, links, maps, zones, roleplaying, minstrel, kocho, diva, troubadour, virtuoso">
	...
	<body leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" marginheight="0" marginwidth="0">
		<form name="Form1" method="post" action="staff.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTk3NTQyNDQ4Mzs7PnAwBlMT3v2NagfJ9QbCoS1M8sLr" />
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Site_Header">
	<tr>
		...
		<td align="right" valign="top"><span class="SmallBoldWhiteText"></span><span class="SmallBoldWhiteText">May 4 4:17 AM</span>&nbsp;</td>
	</tr>
		...
		<td id="SideMenu1__ctl0_Tablecell1" class="PanelBody" valign="Top" NAME="Tablecell1">
			...
			<a href="http://pub142.ezboard.com/beqdivabardsofeverquest" class="menuTextLink">Old EZBoards</a><br>
					...
					<td width="100%" valign="top">
						<br>
						<h4>EQDiva Admins and Moderators</h4>
						<p>A big thanks goes out to all the people who've helped me create and
							maintain this site! </p>
						<h4>Forum Moderators</h4>
						<ul>
							<li>Dennovin</li>
							<li>Espio</li>
							<li>Keiz</li>
							...
							<li>Velvett</li>
							<li>Zelandakh</li></ul>
						<h4>Song Admins (so far maintaining Song Locations)</h4>
						<ul>
							<li>Espio</li>
							<li>Kocho</li>
							<li>Reed (also for his wonderful Song Spreadsheet)</li></ul>
						<p>I have a few other ideas on bringing a few more members on board to
							help out with the site. There will be lots more roles to fill as I work on
							more parts of the site - I'll be adding Forum Administrator roles and
							promoting some of the moderators there, and I'll be adding Guide
							Admins.</p>
						<p>A special thanks to some smart bards who've helped me with a few
							technical questions: Gaedan, Elavis, Talabus, and the bards in my private
							"Coder Forums" - &nbsp;Teladur and Zenatal the necro.</p>
						<p>As always, thanks to all of you, so many have helped in so many ways -
							I couldn't list them all here, but here's who comes to mind immediately:
							Calliopeia, Payd, Taiisien, Darsarin, Ascher, and everyone who has
							contributed a guide, posted to the forums, sent donations, reported bugs,
							or sent me feedback!</p>
...
<table cellSpacing="0" cellPadding="0" width="100%" class="OnlinePanel">
	<tr>
      ...
      <b>
		...
		<b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_UsersOnline">15</span></b> of <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalUsers">7,221</span></b> EQDiva members, <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_AnonymousUsers">141</span></b> anonymous<b>
		<br>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_Users"><a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Realobs">Realobs</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Rakoloss">Rakoloss</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Tlail">Tlail</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Aslaan">Aslaan</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Tamilia">Tamilia</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Tirga">Tirga</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kilanna">Kilanna</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Pumok">Pumok</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Nemesis">Nemesis</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Muzac">Muzac</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Tuney">Tuney</a> · <a class="moderatorOnlineLinkBold" href="/User/UserProfile.aspx?UserName=keiz">keiz</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Poofie">Poofie</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Purrgatory">Purrgatory</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Lazien">Lazien</a></span><br>
