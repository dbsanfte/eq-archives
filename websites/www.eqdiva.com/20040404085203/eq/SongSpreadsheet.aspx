...
<META name="keywords" content="everquest, eq, bard, bards, song, songs, eqdiva, eqdivas, epic, singing short sword, guides, ldon, items, instruments, illusions, armor, weapons, links, maps, zones, roleplaying, minstrel, kocho, diva, troubadour, virtuoso">
	...
	<body leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" marginheight="0" marginwidth="0">
		<form name="_ctl0" method="post" action="SongSpreadsheet.aspx" id="_ctl0">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTk3NTQyNDQ4Mzs7PvtROhS82P1QlM37ii9+ujjpIhgf" />
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Site_Header">
	<tr>
		...
		<td align="right" valign="top"><span class="SmallBoldWhiteText"></span><span class="SmallBoldWhiteText">April 4 4:54 AM</span>&nbsp;</td>
	</tr>
...
Thanks to Reed Stormwind, who has put this wonderful spreadsheet together! Enter in your level and instrument bonus, skills, and see how all your songs are affected!
<br><br>
Download Latest Version: 4.23b, release 3/24/2004:</b>
<br><br>
Compressed Zip File (541 kb): <br>
<a href="/files/BardSong.4.23b.zip">BardSong.4.23b.zip</a>
<br><br>
Uncompressed Excel File (2.3 MB): <br> 
<a href="/files/BardSong.4.23b.xls">BardSong.4.23b.xls</a>
<br><br><br>
========================================<br>
<h4>Changes in 4.23:  </h4>
<ul>
<li>In the details spreadsheet (2nd page), the Item instead of none will be used to calculate the sung value. (This was a heavily requested modification.)
<li>Added a new DoT calculator at the bottom of the quick reference page. Click on the blue areas for the dots you're using. Select either "None", Item" or "Instrument". It's not too smart and just does simple math. It also doesn't check stacking rules, or song droppings, etc. This was another highly requested feature ;) There is a small table to the right of it as well that just shows the item/instrument values that might be useful as well.
<li>The instrument "mod/max mod" table will show you your current mod uncropped; if you exceed the max, the cell will turn red.
<li>The item/instrument values were switched for the 34 Cantata, and also shouldn't have a value when holding in instrument (thanks again Glrdinial!). Made similar fixes to the 50/60 Ervaj, Occ(55).
<li>Our 64 mez (thule) mezzes up to level 65 mobs, not 64 mobs (thanks Polara).
<li>Fixed the fearless disc. time on the details page (Thanks Polara).
<li>Added notes about haste, slow, mez and snare stacking to the details page (thanks Shpiffey and Jimmay for bringing this up).
<li>Neatened up the Song Details page somewhat.
<li> Added Deathcaller's Stonewind (3.7) instrument.
<li>Added Muramite Fife of Battle (3.2).
<li>Added Painted Primal Mask (1.4) - Thanks Gordinial.
<li>Added Gilded Ixt Spear(2.0). 
...
<table cellSpacing="0" cellPadding="0" width="100%" class="OnlinePanel">
	<tr>
      ...
      <br>
      <b>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalVisitors">75</span></b> visitors in the last 20 minutes: 	
		<b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_UsersOnline">14</span></b> of <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_TotalUsers">6,479</span></b> EQDiva members, <b><span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_AnonymousUsers">61</span></b> anonymous<b>
		<br>
		<span id="SiteFooter__ctl0_WhoIsOnline2__ctl0_Users"><a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Kanarin">Kanarin</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Trikazz">Trikazz</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Trucker">Trucker</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Parnicail">Parnicail</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Aviendah">Aviendah</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Feralize">Feralize</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Sandarien">Sandarien</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Lumi">Lumi</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=KendaricEQ">KendaricEQ</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Nitaka">Nitaka</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=rixi">rixi</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Echodyne">Echodyne</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Flungmuk">Flungmuk</a> · <a class="userOnlineLinkBold" href="/User/UserProfile.aspx?UserName=Zelo">Zelo</a></span><br>
