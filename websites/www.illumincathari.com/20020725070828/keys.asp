...
<html>
<head>
	<title>.: Illumin Cathari Key Lists :.</title>
...
sub SetZone()
	sKey = Document.Forms("fmZones").Elements("Zones").Value
	Document.URL = "keys.asp?KeyID=" & sKey
end sub
</script>
<table width="100%" border=0 cellpadding=0 cellspacing=0>
