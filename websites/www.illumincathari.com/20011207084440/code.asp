...
<span style="display:none" style=&{head};> 
	...
	are subject to the same trial period as a regular initiate.</font>
</span>

<font class=BarHeading><h5 style="cursor:hand" onClick="doit(document.all[this.sourceIndex+1])">[ New Members ]</h5></font>
<span style="display:none" style=&{head};> 
	<font class=FieldValue>All potential members will contact the officers to discuss induction, where at 
