...
<tr>
	...
	<a href="participants.asp?EventID=77" onClick="PopUp(this.href,'Detail','300','215','yes');return false">Fear Meh</a>&nbsp;]</font>
	</td>
	</tr>
	<tr>
	<td noWrap align=left><font class=FieldValue>10/16/2002&nbsp;7:00:00 PM&nbsp;CST</font></td>
	<td noWrap align=center><font class=FieldValue>PoF</font></td>
	<td noWrap align=center><font class=FieldValue>46</font></td>
	<td noWrap align=center><font class=FieldValue>48/18</font></td>
	</tr>
	<tr><td colSpan=4 style="border-bottom:1 solid #ECB611;">
		<font class=FieldLabel>Info:</font> <font class=FieldValue>Well, we did our long Air run, now its time for Fear.  Going to try to stay long enough for **2** rounds of golems, break in is on a Thursday so hopefully we get in before the weekend crowd.,<P>Guests are welcome, hate to see armor rot.  If you cant make it the first day, the portal will be cleared each day, so come when you can. <p>
<b> EDIT:  Starting WEDNESDAY after the patch.  Plan on staying until the following MONDAY at the earliest. </b>
		<br>[<a href="cgi-bin/raidsignup.asp?EventID=77" onClick="PopUp(this.href,'SignUp','250','300','no');return false">I wanna go!</a>] 
		</font></td>
	</tr>
