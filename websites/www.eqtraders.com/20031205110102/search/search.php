    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
		  <td width="3"></td>
          <td class="mainbody">
Note: If there is an  '  in what you want to search for, do a partial word search instead as it will not search correctly with a ' in it.  For example, to search on "Ak'anon" search instead for "anon" to get hits more like what you wish to search for.
<form method="POST">
  <p>Item: 
