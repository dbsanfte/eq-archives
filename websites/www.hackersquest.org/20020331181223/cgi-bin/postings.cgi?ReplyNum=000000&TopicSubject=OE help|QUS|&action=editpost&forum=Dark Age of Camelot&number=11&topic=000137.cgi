...
<BR>
Topic: <FONT COLOR="#00ff00">OE help?</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#00ff00">Originally posted by Mox on 01-08-2002 04:27 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I've ran ShowEQ in the past and didn't have a problem with it, it installed and worked great.

Fresh FULL install of RedHat 7.2 followed the directions to the "t" 3 times now starting with a fresh format each time.  It seems I don't have a command named "lynx".

When I'm supposed to type in the following line:

4) lynx -source [URL=http://www.hackersquest.org/daoc/src/odinseye-latest.tar.gz]http://www.hackersquest.org/daoc/src/odinseye-latest.tar.gz[/URL]  | tar xvvfz -

I get "unknown command".

I tried just typing "lynx" and I get unknown command.
...
[This message has been edited by Mox (edited 01-08-2002).]</TEXTAREA>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="OE help?">
