...
<HTML>
<HEAD>
<TITLE>The Crimson Rose Forums - FAQ</TITLE>
</HEAD>
...
<table border="0" width="95%" bgcolor="#001100">
  <TR><TD>
<table border="0" width="100%" bgcolor=>
    <tr bgcolor="#6C706D">
        <td><font size="+1" face="sans-serif" color="#FFFFFF"><b>Frequently
          Asked Questions</font></b></td>
    </tr>
    <tr bgcolor="#2E4460">
        <td>
          <font size="2" face="sans-serif" color="#11C6BD">
	  ...
	  <a href="#profile">Can I change my profile?</a><br>
          ...
          <a href="#ranks">What are the ranks in the The Crimson Rose Forums?</a><br>
          <a href="#rednumbers">Why are icons flaming in the topic view?</a></p></font>
        </td>
    </tr>
    <tr bgcolor="#6C706D">
        <td>
        <font color="#FFFFFF" size="2" face="sans-serif">
	...
	<a href="/phpBB/bb_register.php?mode=agreement">here</a></font>
	</td>
    </tr>
    <tr bgcolor="#6C706D">
        <td>
	...
	<table width="50%" ALIGN="CENTER" BGCOLOR="#001100" CELLSPACEING=1 BORDER="0">
	  <TR><TD>
	  <TABLE WIDTH="100%" BORDER="0">
		...
		<td width="55">
			<IMG SRC="/phpBB/images/smiles/icon_cool.gif">
		</td></tr>
		 <TR BGCOLOR="#2E4460">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#FFFFFF">
		...
		<td width="55">
			<IMG SRC="/phpBB/images/smiles/icon_mad.gif">
		</td></tr>
		 <TR BGCOLOR="#2E4460">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#FFFFFF">
		...
		<td width="55">
			<IMG SRC="/phpBB/images/smiles/icon_redface.gif">
		</td></tr>
		 <TR BGCOLOR="#2E4460">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#FFFFFF">
		...
		<td width="55">
			<IMG SRC="/phpBB/images/smiles/icon_cry.gif">
		</td></tr>
		 <TR BGCOLOR="#2E4460">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#FFFFFF">
		...
		<td width="55">
			<IMG SRC="/phpBB/images/smiles/icon_evil.gif">
		</td></tr>
		 <TR BGCOLOR="#2E4460">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#FFFFFF">
		...
		<td width="55">
			<IMG SRC="/phpBB/images/smiles/icon_rolleyes.gif">
		</td></tr>
		 <TR BGCOLOR="#2E4460">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#FFFFFF">
...
<table border=0 cellpadding=0 cellspacing=0 width="95%" align="CENTER"><TR><td bgcolor="#FFFFFF">
<table border=0 cellpadding=4 border=0 cellspacing=1 width=100%>
<TR bgcolor="#6C706D">
<TD>
<FONT SIZE="2" FACE="Verdana, Arial">
URL Hyperlinking</FONT></td></tr>
<TR bgcolor="#2E4460"><TD><FONT SIZE="2" FACE="Verdana, Arial">
...
<tr bgcolor="#6C706D"><td>
<FONT SIZE="2" FACE="Verdana, Arial">
Email Links</FONT></td></tr>
<TR bgcolor="#2E4460"><TD>
<FONT SIZE="2" FACE="Verdana, Arial">
...
<P>
    ...
    <tr bgcolor="#2E4460">
	    ...
	    Moderators control individual
          ...
          <p>Anyone who posts just to increase their The Crimson Rose Forums stats or post topics out of
	...
	<a name="ranks">
	<font color="#FFFFFF" size="2" face="sans-serif">
	<b>What are the ranks for the The Crimson Rose Forums?</b></font></a>
	</td>
    </tr>
    <tr bgcolor="#2E4460">
        <td>
	<font size="2" face="sans-serif" color="#FFFFFF">
	The The Crimson Rose Forums have established
	methods to classify their users by activity through the number of posts.</p>
	<br>
	The current ranks are as follows:<br>

		<br><TABLE BORDER="0" WIDTH="95%" CELLPADDING="1" CELLSPACING="0" ALIGN="CENTER" VALIGN="TOP"><TR><TD BGCOLOR="#001100">
	<TABLE BORDER="0" CELLPADDING="1" CELLSPACING="1" WIDTH="100%">
	<TR BGCOLOR="#6C706D" ALIGN="CENTER">
	<TD><font face="sans-serif" size="2" color="#FFFFFF">&nbsp;Rank Title&nbsp;</font></TD>
	<TD><font face="sans-serif" size="2" color="#FFFFFF">&nbsp;Minimum Posts&nbsp;</font></TD>
	<TD><font face="sans-serif" size="2" color="#FFFFFF">&nbsp;Maximum Posts&nbsp;</font></TD>
        <TD><font face="sans-serif" size="2" color="#FFFFFF">&nbsp;Rank Image&nbsp;</font></TD>
	</TR>
	<TR BGCOLOR="#2E4460" ALIGN="CENTER"><TD><font face="<?php echo sans-serif?>" size="2" color="#FFFFFF">Temporary Board Member</font></TD><TD><font face="<?php echo sans-serif?>" size="2" color="#FFFFFF">1</font></TD><TD><font face="<?php echo sans-serif?>" size="2" color="#FFFFFF">99999</font></TD><TD>&nbsp;</TD></TR>	</TABLE></TABLE></font>
	<br>
	<font size="2" face="sans-serif" color="#FFFFFF">
	...
	<font color="#FF0033" size="2" face="sans-serif">
	<b>flaming</b>
	</font>
	<font color="#FFFFFF" size="2" face="sans-serif">
...
<center><font size=-2>phpBB Created this page in 0.292952 seconds.</font></center>
</FONT>
</BODY>
</HTML>
