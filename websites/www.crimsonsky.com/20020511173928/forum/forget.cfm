...
        if  (!_CF_onError(_CF_this, _CF_this.email, _CF_this.email.value, "Please enter the E-mail address you used to join the forums"))
...
10:37 AM 
							...
							<option value="categories.cfm?catid=2&zb=6890614" >Tavern
							...
							<option value="categories.cfm?catid=3&zb=6004094" >Dark Ages of Camelot
							...
							<option value="categories.cfm?catid=4&zb=5512756" >Shadowbane
							...
							<option value="categories.cfm?catid=5&zb=1995840" >Neverwinter Nights
							...
							<option value="categories.cfm?catid=6&zb=1609386" >Beta News
...
<center>
	<table border="0" cellpadding="3" cellspacing="1" width="97%">
		<tr>
			<td class="ftheaderbar" colspan="2"><font class="ftheaderbartextlarge"><b>Type in your email address and we will send your login information to you</b></font></td>
		</tr>
		

		
		<tr>
			<td valign="top" class="ftstatuscell"><br><center><img src="i/icons/active_status_icon_off.gif" border="0"></td>
								...
								<table border="0">
									<tr>
										<td>
												...
												<br><br>
												<P>
												<FORM NAME="CFForm_1" ACTION="forget.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
												E-mail address:</font><INPUT TYPE="text" NAME="email" CLASS="ftforminput" SIZE="45">
												<p>
												<input type="submit" value="Submit" class="ftformbutton">
												<input type="hidden" name="FT_ACTION" value="SendEmail">
												</FORM>
		...
		<tr>
			<td class="ftheaderbar" colspan="2" align="right"><font class="ftheaderbartextlarge">You are in 'Send login information' mode</td>
		</tr>
	</table>
</center>
