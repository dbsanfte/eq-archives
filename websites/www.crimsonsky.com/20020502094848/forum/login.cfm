...
<html>
<head>
	<title>Login To The Forums</title>
	<style type="text/css">
		
	
	.ftbody {background-color:ffffff;}
	
	.ftstatusfunctioncell {background-color: #DCDCDC;}
	...
	.ftheaderbar {background-color: #282828;}
	...
	a.ftbackgroundlink:hover {color: navy;text-decoration: underline;}
...
    if  (!_CF_hasValue(_CF_this.FTVAR_USERNAMEFRM, "TEXT" )) 
        {
        if  (!_CF_onError(_CF_this, _CF_this.FTVAR_USERNAMEFRM, _CF_this.FTVAR_USERNAMEFRM.value, "Please enter your forum username"))
            {
            return false; 
            }
        }

    if  (!_CF_hasValue(_CF_this.FTVAR_PASSWORDFRM, "PASSWORD" )) 
        {
        if  (!_CF_onError(_CF_this, _CF_this.FTVAR_PASSWORDFRM, _CF_this.FTVAR_PASSWORDFRM.value, "Please enter your forum password"))
...
<form>
	<tr>
		<td>
			<font class="ftbackgroundtext" style=""><b> 
Navigation:

</b>
			<select name="url" class="ftinputtext" style="font-size:9px;" OnChange="location.href=form.url.options[form.url.selectedIndex].value">
			<option value=".">Select
			
	


<option value="whoson.cfm"> 
WHO'S ON:
...
2:47 AM 
							...
							<option value="categories.cfm?catid=2&zb=4723271" >Tavern
							...
							<option value="categories.cfm?catid=3&zb=2553655" >Dark Ages of Camelot
							...
							<option value="categories.cfm?catid=4&zb=7800501" >Shadowbane
							...
							<option value="categories.cfm?catid=5&zb=5692649" >Neverwinter Nights
							...
							<option value="categories.cfm?catid=6&zb=7707739" >Beta News
...
<table border="0" cellpadding="2" cellspacing="2">
	<tr>
		...
		<a href="customize.cfm" class="ftmenulink" title="Customize your settings"> 
customize
			...
			<td class="ftmenusurroundtd"><table border="0" cellpadding="2" cellspacing="0"><tr><td class="ftmenutd" id="menuopt6" onmouseover="changestyleover('menuopt6');" onmouseout="changestyleout('menuopt6');"><a href="search.cfm" class="ftmenulink" title="Search Crimson Sky Empire forums"> 
search

</a></td></tr></table></td>
		
			<td class="ftmenusurroundtd"><table border="0" cellpadding="2" cellspacing="0"><tr><td class="ftmenutd" id="menuopt8" onmouseover="changestyleover('menuopt8');" onmouseout="changestyleout('menuopt8');"><a href="today.cfm" class="ftmenulink" title="View the Crimson Sky Empire today page"> 
today

</a></td></tr></table></td>
						
		<td class="ftmenusurroundtd"><table border="0" cellpadding="2" cellspacing="0"><tr><td class="ftmenutd" id="menuopt9" onmouseover="changestyleover('menuopt9');" onmouseout="changestyleout('menuopt9');"><a href="javascript:winopen('help/index.cfm','help',720,540);" class="ftmenulink" title="Get help with the forums"> 
help

</a></td></tr></table></td>
		
			<td class="ftmenusurroundtd"><table border="0" cellpadding="2" cellspacing="0"><tr><td class="ftmenutd" id="menuopt10" onmouseover="changestyleover('menuopt10');" onmouseout="changestyleout('menuopt10');"><a href="faq.cfm" class="ftmenulink" title="View the Crimson Sky Empire faq"> 
faq

</a></td></tr></table></td>
		
			<td class="ftmenusurroundtd"><table border="0" cellpadding="2" cellspacing="0"><tr><td class="ftmenutd" id="menuopt11" onmouseover="changestyleover('menuopt11');" onmouseout="changestyleout('menuopt11');"><a href="index.cfm?NoCookies=Yes" class="ftmenulink" title="Go to the Crimson Sky Empire home"> 
home
			...
			<td class="ftmenusurroundtd"><table border="0" cellpadding="2" cellspacing="0"><tr><td class="ftmenutd" id="menuopt13" onmouseover="changestyleover('menuopt13');" onmouseout="changestyleout('menuopt13');">
				...
				<a href="login.cfm" class="ftmenulink" title="Login to Crimson Sky Empire forums"> 
login
...
<table border="0" cellpadding="3" cellspacing="1" width="97%">
	<tr>
		<td class="ftheaderbar" width="" colspan="2"><font class="ftheaderbartextlarge"><b>Type your username and password to login to the Forums</b></font></td>
	</tr>
			
	<tr>
		<td valign="top" class="ftstatuscell" width="7%"><center><img src="i/icons/logfold.gif" border="0"></td>
		<td valign="top" class="ftstatusfunctioncell">
	...
	<FORM NAME="CFForm_1" ACTION="login.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
		<table border="0">
			<tr>
				<td><font class="ftlargecontent"><b>Username:</b></font></td>
				<td><INPUT TYPE="text" NAME="FTVAR_USERNAMEFRM" CLASS="ftforminput"></td>
			</tr>
			<tr>
				<td><font class="ftlargecontent"><b>Password:</b></font></td>
				<td><INPUT TYPE="password" NAME="FTVAR_PASSWORDFRM" CLASS="ftforminput"></td>
			</tr>
			<tr>
				<td colspan="2" align="right"><br><font class="ftsmallcontent">Remember my login<input type="checkbox" name="FTVAR_COOKIEFRM"></td>
			</tr>
			<tr>
				<td colspan="2" align="right">
					<br><input type="submit" value="Login" class="ftformbutton">
					<input type="button" value="Cancel" onclick="window.location='index.cfm?NoCookies=Yes';" class="ftformbutton">
					<br><br>
					<a href="forget.cfm" class="ftlinksmall">Forget your login information?</a>
				</td>
			</tr>
		</table>
		<input type="hidden" name="FT_ACTION" value="login">
		<input type="hidden" name="FTVAR_REDIRECTURLFRM" value="index.cfm">
	</FORM>
	<br><br><br>
	...
	<tr>
		<td class="ftheaderbar" colspan="2"><font class="ftheaderbartextlarge">You are in 'login' mode</td>
	</tr>
</table>
</center>
