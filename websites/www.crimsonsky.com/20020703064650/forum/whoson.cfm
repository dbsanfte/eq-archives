...
<option value="whoson.cfm">WHO'S ON: 11:44 PM 
							...
							<option value="categories.cfm?catid=3&zb=3115871" >Tavern 
							...
							<option value="categories.cfm?catid=2&zb=3869330" >Shadowbane 
							...
							<option value="categories.cfm?catid=4&zb=8669930" >Neverwinter Nights 
							...
							<option value="categories.cfm?catid=5&zb=2104112" >Beta News 
...
<table border="0" cellpadding="3" cellspacing="1" width="97%">
	<tr>
		<td class="ftheaderbar" colspan=2 align="left" nowrap>
		<font class="ftheaderbartextlarge">Who's On : Number of users logged in that match <b>A</b>: 0
		</td>
	</tr>
</table>
...
<table border="0" cellpadding="3" cellspacing="1" width="97%">
	<tr>
		<td class="ftstatusfunctioncell" colspan="2">
		<br>
		<font class="ftlargecontent"><b>Alphabetical Quick Search</b></font><br><br>
		
	
		<table border="0" cellpadding="1" cellspacing="0">
			<tr><form action="whoson.cfm" method="post">
				 
					<td><input type="submit" value=" A " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" B " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" C " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" D " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" E " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" F " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" G " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" H " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" I " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" J " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" K " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" L " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" M " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" N " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" O " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" P " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" Q " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" R " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" S " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" T " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" U " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" V " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" W " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" X " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" Y " class="ftalphabet" name="letter"></td>
				 
					<td><input type="submit" value=" Z " class="ftalphabet" name="letter"></td>
				
				<td><input type="submit" value="all" class="ftalphabet" name="letter"></td>
				<td><input type="submit" value="other" class="ftalphabet" name="letter"></td>
			</tr>
		</table>
...
<tr>
	<td colspan="2" class="ftheaderbar"><font class="ftheaderbartextlarge"><b>Users Matching: a</td>
</tr>

	<tr>
		<td colspan="2" class="ftstatusfunctioncell"><br><br><br><br>
			<center>
			<font class="ftlargecontent"> There are currently no users logged in to the <b>Crimson Sky Empire</b> forum with a name beginning with <b>a</b>.
...
<table border="0" cellpadding="3" cellspacing="1" width="97%">
	<tr>
		<td class="ftheaderbar" colspan=5 align="right"><font class="ftheaderbartextlarge">[ <a href="index.cfm?NoCookies=Yes" class="ftheaderbarlink">FORUMS</a> ]</td>
	</tr>
</table>
