...
<BODY lang="ja">
<DIV align="center">
	<IMG src="../img/logo_mini.gif">～ <A href="../">TOP</A> ～ <A href="../chara/">My Character</A> ～ <SPAN style="font-size:11pt; font-weight:bold">About CLR</SPAN> ～ <A href="../tips/">CLR Tips</A> ～ <A href="../diary/">Diary</A> ～ <A href="../bbs/dbbs.php">BBS</A> ～ <A href="../link/">Links</A> ～
</DIV>
<P class="hline">.</P>
<DIV align="center">
	<DIV style="margin:30px 0 5px 0; width:400px;" class="title1">
		<DIV class="title2">CLRについて</DIV>
	</DIV>
	<TABLE width="400" border="0" cellspacing="0" cellpadding="0">
        <TR> 
            <TD class="box2_1"> <A href="./make_chara.php" onMouseOver="this.className='onmenu'" onMouseOut="this.className='outmenu'">キャラクタ作成</A></TD>
            <TD class="box2_2"> 
                <DIV>キャラクタ作成時のPoint</DIV>
            </TD>
        </TR>
				<TR> 
            ...
            <TD  style="height :5px;font-size:1px;">.</TD>
				...
				<TR> 
            <TD class="box2_1"> <A href="./spell.php?rank=0" onMouseOver="this.className='onmenu'" onMouseOut="this.className='outmenu'">Spell</A></TD>
            <TD class="box2_2"> 
                <DIV>CLR Spell一覧表</DIV>
            </TD>
        </TR>
				<TR> 
            <TD  style="height :5px;font-size:1px;">.</TD>
            <TD  style="height :5px;font-size:1px;">.</TD>
				...
				<TR> 
            <TD class="box2_1"> <A href="./ability.php" onMouseOver="this.className='onmenu'" onMouseOut="this.className='outmenu'">Ability</A></TD>
            <TD class="box2_2"> 
                <DIV>CLR Ability一覧表</DIV>
            </TD>
        </TR>
	</TABLE>
</DIV>
