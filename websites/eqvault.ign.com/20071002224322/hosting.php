...
<!-- GOOGLE SEARCH END --><SPAN id=iAd><table border="0" cellpadding="2" width="304" height="254" align="right"><tr><td>
<script language="javascript">
...
<iframe valign=top WIDTH=300 HEIGHT=250 MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no BORDERCOLOR="#000000" SRC="http://wrapper.ign.com/a?pagetype=vn_content&size=300x250&sizew=300&sizeh=250&js=false">
 ...
 <div><h1 class="hunderline">Get Hosted by EverQuest Vault -- EQ !</h1>
<p>Would you like your site to be part of the largest video game network in the universe?

<p>Our goal is to be the best and most comprehensive network of game-related sites, if you are a passionate gamer and have a unique site, you might be a great fit.


<p>Hosting with us includes many benefits, including the following:

<p>• Linkage to your site in relevant locations across the IGN network.<br />
• News promotion for unique content from hosted sites<br />
• Search benefits of a huge network (1,800+ hosted sites plus Gamespy/IGN, etc)<br />
• Modern control panel supporting php/mysql<br />
• Reliable support from dedicated staff and hosting team<br />
• 10 years of experience hosting game fansites!<br />
• It's free! No fees for bandwidth or server space, in exchange for one ad per page.<br />

<p>For Guild and toolset sites, we offer a set of preselected applications which should make running and managing your site much easier. If you have special needs, we are happy to set up what you need to run a good site.

<p><b>Instructions:</b>
<br />All fields are required except Additional Comments.

<p>* Your current site must be complete. This is required so that we can review your site's content.

<p>* For any questions about what kinds of sites we consider for hosting, please check the <a href="/hosting.php?action=FAQ">Hosting FAQ</a>.

<p>* We welcome questions about our hosting, simply include them in the comments section of your application.

<p>
<form name="hostingform" action="hosting.php" method="post">
<table border="0">
<tr>
<td>
<b>Full Name:</b>
...
<td>
<input type="text" name="cemail" value="" size="30" />
</td>
</tr>
...
<td>
<input type="text" name="referralsource" value="" size="30" />
</td>
</tr>
...
<td>
<input type="text" name="sitename" value="" size="30" />
</td>
</tr>
...
<tr>
<td>
<b>Are you 18 years of age or older?:</b>
</td>
<td>YES: <INPUT TYPE="radio" NAME="ageverification" value="Yes">  NO: <INPUT TYPE="radio" NAME="ageverification" value="No"> 
<span style="font-size:7pt">(If you are not 18, and we accept your application, your parent or legal guardian will need to fill out forms)</span>
</td>
</tr>
...
<td>
<img src="captcha.php" width="200" height="60" alt="CAPTCHA code" /><br />
<input type="text" name="captcha_code" value="" style="width: 200px; margin-top: 1px;" />
</td>
</tr>
...
<input type="submit" name="submit" value="Submit Application!" />&nbsp;&nbsp;<input type="reset" name="reset" value="Reset Form" />
</td>
</tr>
</table>
</form>

<p>We look forward to reviewing your application, expect to hear from us shortly.</td></tr></table></DIV>
...
<!-- FOOTER NETWORK -->
</DIV></TD></TR></TABLE><script src="http://www.google-analytics.com/urchin.js" type="text/javascript">
</script>
