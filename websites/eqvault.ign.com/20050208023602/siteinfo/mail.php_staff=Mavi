...
<a HREF="http://dndvault.ign.com/" CLASS="menu" title="Dungeons & Dragons Vault">&#183; Dungeons & Dragons</a><br>
...
<a HREF="http://uovault.ign.com/" CLASS="menu" title="Ultima Online Vault">&#183; Ultima Online</a><br>
<a HREF="http://wishvault.ign.com" CLASS="menu" title="Wish Vault">&#183; Wish</a><br>
<a HREF="http://wowvault.ign.com/" CLASS="menu" title="World of Warcraft Vault">&#183; World of Warcraft</a><br>
<IMG SRC="http://eqvault.ign.com//skins/default/spacer.gif" WIDTH=115></TD><TD ALIGN=LEFT BACKGROUND="http://eqvault.ign.com//skins/default/NavigationRightTrim.jpg"><IMG SRC="http://eqvault.ign.com//skins/default/spacer.gif" WIDTH=15></TD><TD WIDTH="100%" VALIGN="TOP" ALIGN=CENTER><DIV CLASS="Main"><TABLE  BORDER=0 CELLPADDING=6 CELLSPACING=0  WIDTH="100%"><TR><TD  VALIGN="TOP">
<div align="center"><b><font size="5">Mail Submission Form</font></b> 
  <form action="" method="POST" enctype="multipart/form-data">
    <table width="75%" border="0">
      <tr> 
        ...
        <td width="80%"> 
          <input type="text" name="from_name" size="80">
        </td>
      </tr>
      <tr> 
        <td width="20%"> 
      ...
      <tr> 
        ...
        <td width="80%"> 
          <select name="send_to">
		<option value=eqnews!vaultnetwork!dot!com>News</option><option value=eqsubmissions!vaultnetwork!dot!com>Submissions</option><option value="draknorr!vaultnetwork!dot!com">Draknorr</option>
<option value="hicksb!wlu!dot!edu">Alizar</option>
          </select>
        </td>
      </tr>
      <tr> 
        ...
        <td width="80%">Please select a staff member from the list above, or &quot;News&quot; if you aren't sure who to send it to.</td>
      </tr>
      <tr> 
        <td width="20%"> 
        ...
        <td width="80%"> 
          <input type="text" name="subject" size="80" value="">
        </td>
      </tr>
      <tr> 
        <td width="20%"> 
          <div align="right">Message Body</div>
        </td>
        <td width="80%"> 
      ...
      <tr>
        <td width="20%">
          <div align="right">File Attachment</div>
        </td>
        <td width="80%">
...
document.write("<"+"script type='text/javascript' src='http://wrapper.ign.com/a?pagetype=unmatched&size=text'>");
document.write("<"+"/script>");
</script>
<noscript> <iframe valign=top style="height:1.2em; width:64ex" MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no BORDERCOLOR="#000000" SRC="http://wrapper.ign.com/a?pagetype=unmatched&size=text&sizew=128&sizeh=30&js=false"> </iframe> </noscript></center><center>
<table>
        <tr>
                <td><a href="http://corp.ign.com/" target="_blank"><img src="http://actionvault.ign.com/images/ignent110x65_blk.gif" border=0></a></td>
                <td align=left>
                        <BR><div class=footer>
                        Copyright 2004, IGN Entertainment, Inc.<BR>
                        <a href="http://corp.igngamespy.com/">Corporate Info</a> |
                        <a href="http://corp.igngamespy.com/ad.html">Advertise</a> |
                        <a href="http://corp.igngamespy.com/privacy.html">Privacy Policy</a> |
                        <a href="http://corp.igngamespy.com/user_agreement.html">User Agreement</a> |
...
</DIV></TD><TD ALIGN=CENTER VALIGN=TOP BACKGROUND="http://eqvault.ign.com//skins/default/Skyscraper.jpg"><br><script language="javascript">
document.write("<"+"script type='text/javascript' src='http://wrapper.ign.com/a?pagetype=unmatched&size=skyscraper'>");
document.write("<"+"/script>");
</script>
<noscript>
<iframe valign=top WIDTH=160 HEIGHT=600 MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no BORDERCOLOR="#000000" SRC="http://wrapper.ign.com/a?pagetype=unmatched&size=skyscraper&sizew=160&sizeh=600&js=false">
</iframe>
</noscript><IMG SRC="http://eqvault.ign.com//skins/default/spacer.gif"  WIDTH=201></TD><TD ALIGN=RIGHT BACKGROUND="http://eqvault.ign.com//skins/default/SkyscraperRightTrim.jpg"><IMG SRC="http://eqvault.ign.com//skins/default/spacer.gif" WIDTH=6></TD></TR></TABLE></BODY></HTML>