  ...
  <form action="" method="POST" enctype="multipart/form-data">
    <table width="75%" border="0">
      ...
      <tr> 
        ...
        <td width="80%"> 
          <select name="send_to">
		<option value=eqnews!vaultnetwork!dot!com>News</option><option value=eqsubmissions!vaultnetwork!dot!com>Submissions</option><option value="macabrediablo!aol!dot!com">h13alt</option>
