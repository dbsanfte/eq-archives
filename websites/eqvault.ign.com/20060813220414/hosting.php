...
<iframe valign=top WIDTH=300 HEIGHT=250 MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no BORDERCOLOR="#000000" SRC="http://wrapper.ign.com/a?pagetype=vn_content&size=300x250&sizew=300&sizeh=250&js=false">
 ...
 <div><h1 class="hunderline">Get Hosted by EverQuest Vault -- EQ !</h1><a name="top"></a>
<b class="title1">EverQuest Vault -- EQ  Hosting</b><br><br>

Own a web site related to the topic of EverQuest Vault -- EQ ? Want to be associated with one of the best entertainment networks around? You've come to the right place! A few of our benefits are:
<ul>
<li>Virtually unlimited FTP space and lots of bandwidth</li>
<li>Hosting Control Panel for full control</li>
<li>Your own subdomain of eqvault.ign.com</li>
<li>E-mail accounts, mailboxes, forwarding, and mailing lists -- username@yoursite.eqvault.ign.com</li>
<li>Support for latest technologies: PHP, MySQL, and auto-installation of scripts such as phpBB</li>
<li>Access to your site's statistics</li>
<li>Effective, timely technical support</li>
<li>Promotion across the Vault Network</li>
<li>All of the above for Free!</li>
</ul>

We sat down and thought up every question you could possibly ask about getting hosted on the Vault Network and their answers. So if you have a question about hosting, check the list. 
<br><br>

<b>Think your site meets our requirements?</b><br>
Fill out a <strong><a href="hosting.php?action=form">Hosting Application</a></strong> for hosting at EverQuest Vault -- EQ . Once we receive a completed application, we will review your site and get back to you.
<br><br><br>


<b>General Hosting Questions</b>

<ol>
<li> <a href="#general1">Do I have to pay for hosting on the Vault Network?</a></li>
<li> <a href="#general2">What kind of sites do you host?</a></li>
<li> <a href="#general3">What types of sites don't you host?</a></li>
<li> <a href="#general4">How do you determine if a site will be hosted?</a></li>
<li> <a href="#general5">I run a site I think you should host but I'm not sure where it belongs and it does not fall under a specific Planet/Vault/Brain. How do I ask for hosting?</a></li>
<li> <a href="#general6">Will you guys help me make a site?</a></li>
<li> <a href="#general7">My site's going to be great, but I don't want to go to the trouble of making it if you guys aren't going to host it. So why should I make one?</a></li>
<li> <a href="#general8">Can I host other sites on my own hosted site?</a></li>
<li> <a href="#general9">I'm going to make a mod for Game X, but I have to get coders, modelers, and mappers. We haven't worked on it yet. Can I get hosting?</a></li>
<li> <a href="#general10">I have a general gaming news Web site. Can I get it hosted?</a></li>
<li> <a href="#general11">You already have a site dedicated to the same game my site is. Can I still get hosted?</a></li>
<li> <a href="#general12">I want to make a site and I want you to host it, but I don't have any Web space to put it up so you guys can look at it. Help!</a></li>
<li> <a href="#general13">Can I just zip up my entire site and e-mail it to you?</a></li>
<li> <a href="#general14">Once my site is hosted, can I get any exposure on the Vault Network to increase my hits?</a></li>
</ol>

<b>Technical Questions</b>

<ol>
<li> <a href="#tech1">How much Web/FTP space will I have?</a></li>
<li> <a href="#tech2">Will I get an e-mail account, too?</a></li>
<li> <a href="#tech3">I want to do PHP scripts, etc. on my site -- can I do that?</a></li>
<li> <a href="#tech4">Can I put forums on my site?</a></li>
<li> <a href="#tech5">Can I have a domain name for my site?</a></li>
<li> <a href="#tech6">Does the Vault Network use Windows or Linux servers?</a></li>
</ol>

<b>Advertising Requirements and Affiliations</b>

<ol>
<li> <a href="#adbanners1">Will IGN own my content?</a></li>
<li> <a href="#adbanners2">Do I have to run your ads?</a></li>
<li> <a href="#adbanners4">I'm trying to make some money running my site. Can I put non-IGN ads on it?</a></li>
<li> <a href="#adbanners5">Can we sell ads or be part of a paid affiliation program on our site?</a></li>
</ol>

<b>Flagship Site Questions</b>

<ol>
<li> <a href="#planet1">I want to run a Planet/Vault/Brain site. How can I do that?</a></li>
<li> <a href="#planet2">I want my site to be Planet/Vault/Brain GameName. Can I do that?</a></li>
<li> <a href="#planet3">What's the difference between a hosted site and a Planet/Vault/Brain site?</a></li>
</ol>

<b>More Questions?</b><br><br>

<ol>
<li> <a href="#final1">This FAQ didn't answer ANY of my questions. What do I do now?!</a></li>
<li> <a href="#final2">I applied for hosting a few days ago and haven't heard back from you. Are you ignoring me?</a></li>
</ol>

<br>

<b class="title1">General Hosting Questions</b><br><br>

<a name="general1"></a><b>1.	Do I have to pay for hosting on the Vault Network?</b><br><br>

Nope - hosting is completely free! We have only a few rules we ask that you abide by, such as running our ads on your site. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general2"></a><b>2.	What kind of sites do you host?</b><br><br>

Mainly, we look for two types of Web sites: sites devoted to specific games, movies or topics, and sites devoted to projects and creative content for those games and entertainment. Some examples of the kind of sites we look for can be found by looking at any of our big sites, like <a href="http://planetquake.gamespy.com/">Planet Quake</a>, <a href="http://planetthesims.gamespy.com/">Planet The Sims</a>, <a href="http://haloplanet.gamespy.com/">Halo Planet</a>, <a href="http://mevault.ign.com/">Middle Earth Vault</a>, and <a href="http://strategyplanet.gamespy.com/">Strategy Planet</a>. If you have a well-run, content-rich entertainment related site you believe we should host, send it in!. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general3"></a><b>3.	What types of sites don't you host?</b><br><br>

As already mentioned, if we already cover a topic well on our Network, we are not likely to host sites that provide the same function, such as general news sites. If you have unique content or a unique viewpoint about a topic for which we already host a site, please submit - we place value on diversity.  We do not host tools, trainers, or programs that could be used to cheat in games online. Warez sites are also not welcome on our Network. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general4"></a><b>4.	How do you determine if a site will be hosted?</b><br><br>

We want a certain measure of quality among sites that we host because, after all, they're associated with the Vault Network name. We look at every site that comes into our hosting system carefully to see if they meet a few criteria:<br><br>

<blockquote>
<b>1.	The site has to look nice.</b> Yeah, we know that's kind of subjective, but we're pretty sure that everyone thinks lime green background colors with red 20-point blinking fonts are just annoying.<br><br>

<b>2.	The site must fit into our network appropriately.</b> That means that it should be focused on a particular game or topic that we don't have a flagship site for already, or it should be focused on mods, maps, or other add-ons for a particular game. It can also be something totally unique -- maybe your site is dedicated to fan fiction based on TRIBES! <br><br>

To get an idea of what we're looking for, cruise around our network and take a look at our hosted sites. What we're not interested in are general news sites, general mod or level download sites, or sites that already do what our Planet, Vault, or Brain sites do -- we've got all that covered. If that's what interests you, we're always looking for more staff. Contact the Site Director for the particular site you're interested in working for. Drop by the <a href="http://vault.ign.com/">Vault Network Hub</a> for a listing of all our sites!<br><br>

<b>3.	The site must have a lot of content.</b> We understand that it's a lot of work to create a site for something, and you don't want to put in all that work if there's a chance you won't be hosted. However, too many times people will have what they think is a great idea for a site and then never follow through. Therefore, you must have a fully developed site that we can look at. Having lots of "coming soon" sections is probably going to get a "no" on hosting.<br><br>

<b>4.	The site must be updated regularly.</b> One of the qualities of a good Web site is that it be updated regularly so that visitors always see something new.<br><br>

<b>5. The site must be in English.</b> No, that's not because we're nationalistic, isolationist American pigs, though that we may be. It's because those of us working on the Vault Network speak English primarily, and we need to be able to understand what's on our hosted sites.
</blockquote>

If you applied for hosting and were turned down, don't worry -- work on your site and make it the best site you can make it, and then re-apply. Some of our hosted sites were turned down the first time, but that only made them work harder on their site until it qualified for hosting. We're always willing to look at a site a second time if you've put a lot of work into improving it. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general5"></a><b>5.	I run a site I think you should host but I'm not sure where it belongs and it does not fall under a specific Planet/Vault/Brain. How do I ask for hosting?</b><br><br>

It depends on the focus of your site really and we are open to many types of gaming and entertainment sites. So, if your site is devoted to one specific topic that we don't have a flagship site for already, make your application in the Vault Network hub. If your site is devoted to things like maps, mods, fan fiction, or content like that for a game or topic that we have a flagship site for, then you should apply for hosting at that particular site. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general6"></a><b>6.	Will you guys help me make a site?</b><br><br>

Hosted sites develop and maintain their own content - and they own the copyright to any original material on their sites. Therefore we do not offer direct assistance in building your site. We do supply number of great, easy-to-use tools that can really help you get your site up and running quickly. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general7"></a><b>7.	My site's going to be great, but I don't want to go to the trouble of making it if you guys aren't going to host it. So why should I make one?</b><br><br>

Like <a href="#general4">Question 4</a> says, too many times we've been told that someone has a terrific idea for a site and they know it's going to be really cool. But many times, they don't follow through on their idea, and we're left with an empty directory. To prevent that, we need to see a fully developed site before we can consider hosting. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general8"></a><b>8.	Can I host other sites on my own hosted site?</b><br><br>

No. You can allow folks to maintain a subdirectory within your site, under your supervision, but we do not allow subhosting. Site owners are responsible for all content on their sites. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general9"></a><b>9.	I'm going to make a mod for Game X, but I have to get coders, modelers, and mappers. We haven't worked on it yet. Can I get hosting? </b><br><br>

The answer to this question is a lot like the answer to some previous questions: we need to see some work before we can host you. Lots of people have great ideas for mods, but getting the mod done is usually the hard part. We recommend that you get a team and at least get a small working beta with some screenshots that we can see. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general10"></a><b>10.	I have a general gaming news Web site. Can I get it hosted?</b><br><br>

No, these sites are redundant to us since our flagship sites do this already. But if you have a site for a game we do not cover, please submit it under the Vault Network Hub. We are always looking to expand and host unique sites. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general11"></a><b>11.	You already have a site dedicated to the same game my site is. Can I still get hosted?</b><br><br>

We will consider hosting more than one informational site for a given subject. Sites that have different approaches to the same topic are of interest, especially if they are complementary to one another. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>


<a name="general12"></a><b>12.	I want to make a site and I want you to host it, but I don't have any Web space to put it up so you guys can look at it. Help!</b><br><br>

There are a few low bandwidth free web-space providers that you should check out -- <a href="http://www.geocities.com/">GeoCities</a>, <a href="http://www.50megs.com/">50megs</a>, and <a href="http://free.prohosting.com/">ProHosting</a> are just a couple we can name right off the bat. You should get your complete site uploaded to one of these free Web hosts so that you can include a URL in your hosting e-mail for us to check out. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general13"></a><b>13.	Can I just zip up my entire site and e-mail it to you?</b><br><br>

For the love of all that is holy, NO. Please don't. That will strain our e-mail clients, our resources, and our patience. Please put your site on a free Web host and then give us a URL to look at. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="general14"></a><b>14.	Once my site is hosted, can I get any exposure on the Vault Network to increase my hits?</b><br><br>

Absolutely! In fact, we specialize in that. One of the greatest features of our network is the tight structure and community. There are several ways to get exposure across the Vault Network. First, you need to be sure and let your parent site know whenever you've got something cool -- they'll post news about it on the site.<br><br>

There's also plenty of opportunity for you to get exposure for your site using <a href="http://www.gamespyarcade.com">GameSpy Arcade</a>, our free multiplayer gaming service. Your site will also be linked anywhere there's an opportunity for it.<br><br> 

It boils down to this: the more work you put into your site, the more promotion and exposure we give you. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<br>

<b class="title1">Technical Questions</b><br><br>

<a name="tech1"></a><b>1.	How much Web and FTP space will I have?</b><br><br>

You get virtually unlimited Web space and FTP space. That's one of the cool advantages you get for being hosted by the Vault Network. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="tech2"></a><b>2.	Will I get an e-mail account, too?</b><br><br>

Yes, you can set up e-mail addresses, mailboxes, mailing lists, and forwarding in your control panel. E-mail addresses are in the form username@yoursite.eqvault.ign.com <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="tech3"></a><b>3.	I want to do PHP scripts, etc. on my site. Can I do that?</b><br><br>

Yes you can! We support PHP4 and MySQL. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="tech4"></a><b>4.	Can I put forums on my site?</b><br><br>

Of course, feel free to install a PHP forums system. Our hosting platform can auto-install some systems for you, such as phpBB. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="tech5"></a><b>5.	Can I have a domain name for my site?</b><br><br>

Only for "special sites", as configuring this up in our backend is a nightmare. However, you are welcome to purchase a domain and redirect it to your site at site.eqvault.ign.com! <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="tech6"></a><b>6.	Does the Vault Network use Windows or Linux servers?</b><br><br>

All of our servers are Linux based. We no longer support Windows. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<br>

<b class="title1">Advertising Requirements and Affiliations</b><br><br>

<a name="adbanners1"></a><b>1. Will IGN own my content?</b><br><br>

Hosted sites own all original material and also bear responsibility for the content they publish on their site. IGN retains the domain names utilized by the hosted site, as they are part of the Vault Network (unless agreed otherwise in writing). Example hosted site: <a href="http://simsshowcase.planetthesims.gamespy.com/">http://simsshowcase.planetthesims.gamespy.com/</a> <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="adbanners2"></a><b>2.	Do I have to run your ads?</b><br><br>

Yes, running our ads is one of the few unbendable rules in being hosted on the Vault Network. Ads must appear near the top of every page and not be in a static frame. You can choose the size of the ad from leaderboard, skyscraper, and box ad / medrect (all IAB standards). <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="adbanners4"></a><b>3.	I'm trying to make some money running my site. Can I put non-IGN ads on it?</b><br><br>

We don't allow our sites to run non-IGN ads. We know that some people want to make money with their sites, but running someone else's ads would compete with our own business commitments. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="adbanners5"></a><b>4. Can we sell ads or be part of paid affiliation program on our site?</b><br><br>

No. IGN handles all the advertising for the Vault Network and, thus, you can't run other ads or paid affiliations (such as Amazon.com or AllAdvantage UNLESS we offer them to you). If another company is interested on advertising on our network, have them contact <a href="http://corp.ign.com/advertising-solutions.html">our ad team</a>. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<br>

<b class="title1">Flagship Site Questions</b><br><br>

<a name="planet1"></a><b>1.	I want to run a Planet/Vault/Brain site. How can I do that?</b><br><br>

If we have a Planet, Vault, or Brain site you're interested in working on, you should e-mail that site's Site Director and let him or her know you'd like to help out. Many of our sites have volunteers, just doing it because they love the game and want to run a site on a respected network and get exposure for it. They're usually very happy to get interested people to help out with the site.<br><br>

If you're interested in running a site we don't have yet, e-mail <a href="mailto:hosting@gamespy.com">hosting@gamespy.com</a> and let us know you're interested and why you think you'd be a good candidate. We don't make Planet and Vault sites for every game, but if we've got one on our radar, we might be on the lookout for people who would be good candidates to run it. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="planet2"></a><b>2.	I want my site to be Planet/Vault/Brain GameName. Can I do that?</b><br><br>

Some of our hosted sites have become some of the best Planet and Vault sites on our network. An example is <a href="http://planetavp.gamespy.com/">Planet AvP</a>, which used to be AvP World, a hosted fan site on <a href="http://3dactionplanet.gamespy.com/">3D Action Planet</a>. The game had become so popular and the staff had done such great work on the site that we worked with them to turn it into Planet AvP.  This was also true of AoE Atrium, which became <a href="http://planetageofempires.gamespy.com/">Planet Age of Empires</a>, and of <a href="http://www.rpgplanet.com/deusex/">Deus Ex Incarnate</a>, which became <a href="http://planetdeusex.gamespy.com/">Planet Deus Ex</a>.<br><br>

We almost never take a new hosted site and immediately make it a Planet or Vault site. A lot of thought, work, and planning goes into the making of our flagship sites because they're our star sites. So the short answer you're looking for is probably no, at least not right away. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="planet3"></a><b>3.	What's the difference between a hosted site and a Planet/Vault/Brain site?</b><br><br>

Planet, Vault, and Brain sites are IGN owned and operated. Hosted sites on the other hand are independent, and are managed by the people who created them.  <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<br>


<b class="title1">And Finally...</b><br><br>

<a name="final1"></a><b>1. This FAQ didn't answer my questions. What do I do now?!</b><br><br>

If you're still in the dark about something, have no fear - we're here to help you. Send your question to <a href="mailto:hosting@vaultnetwork.com">hosting@vaultnetwork.com</a> and we'll get it answered right away. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

<a name="final2"></a><b>2. I applied for hosting a few days ago and haven't heard back from you. Are you ignoring me?</b><br><br>

We get many hosting requests every day. A slow response might mean that we are so swamped with work that we haven't had a chance to look at it yet. Alternatively, if the site clearly does not meet our requirements as outlined above, we may not reply. <span class="smalltext">[<a href="#top">back to top</a>]</span><br><br>

Whew! After all that, if you think you've got a site that rocks, fill out a <strong><a href="hosting.php?action=form">Hosting Application</a></strong> and we'll get the ball rolling!</td></tr></table></DIV>
...
<li>08-10 <a href="http://eqvault.ign.com/wiki/index.php/Main_Page">Main Page (Maximus)</a></li>
</div>
<div class="rightcolumn">
<li>08-09 <a href="http://eqvault.ign.com/wiki/index.php/Main_Page">Main Page (Boomer1981)</a></li>
</div>
</div>
