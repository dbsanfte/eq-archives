...
<html dir="{lang_dir}">
<head>
<title>thedruidsgrove.org - Search the image collection</title>
  ...
  <tr>
    <td width="778" height="61" valign="middle" align="right" background="themes/hardwired/images/hw_01.gif">
        <table width="73%" height="32" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="94%" height="22" valign="bottom" align="right"><span class="gal_name">thedruidsgrove.org</span></td>
            <td width="6%"></td>
          </tr>
        </table>
      </td>
