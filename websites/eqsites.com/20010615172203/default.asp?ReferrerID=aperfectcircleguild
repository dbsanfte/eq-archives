...
<META name="keywords" content="everquest gaming,everquest sites,banner exchange,banner advertising,web site promotion,web site advertising,multiple tier,two tier, internet advertising">
	...
	<script language="JavaScript">
		<!--
		function openWindow() {
		popupWin = window.open('/privacy.asp', 'termswindow', 'scrollbars,dependent,width=425,height=450,left=150,top=50')
		}
		//-->
	</script>
...
Try the new EqSites <a href="http://63.227.215.220
/search.asp" target="_blank">Full-Text Beta Search</a><br>

<P>Promote your&nbsp;EverQuest site for free on EqSites.com!&nbsp; Do you have 
site about a certain class<BR>or race?&nbsp; An item database or quest 
info?&nbsp; Does your guild have a home page?&nbsp; Promote it for<BR>free on 
our EQ-Only directory and banner exchange.&nbsp; </P>
<UL>
  <LI>
  <H2>500 Free Credits</H2></LI></UL>
<P>To help get you started, earn 500 ad credits just for signing up!</P>
<UL>
  <LI>
  <H2> Community Driven</H2></LI></UL>
<P>Do you have a friend with an EQ web site?&nbsp; Earn 
bonuses for signing up friends, <STRONG>you earn a<BR> full 25% of all your 
referral traffic!</STRONG>       </P>
<UL></UL>
<UL></UL>
<UL>
  <LI>
  <H2>Free Real Time Statistics</H2></LI></UL>
<P>Measure your traffic and banner ad effectiveness in real time.</P>
<UL>
  <LI>
  <H2>Simple Setup</H2></LI></UL>
<P>All you need is a web site with EverQuest content and about 10 minutes to 
start promoting.</P>
<H2>Ready to get started?&nbsp; Head to the <A href="signup.asp">signup</A> 
page.</H2>
<A class=roll href="javascript:openWindow();">Privacy Statement</A>.<br>
</BODY>
</HTML>
