          ...
          <form>
            <td><span class="text">Show Active Topics since</span> 
              <select name="show" onChange=ShowTopics(this)>
                <option value="1" >Last visit on June 08 2003 at 4:43pm</option>
...
<td bgcolor="#FBFBF6" background="" colspan="6" class="text">There are no Active Topics since Yesterday to display</td>
   </table>
  </td>
 </tr>
</table>
