          ...
          <form>
            <td><span class="text">Show Active Topics since</span> 
              <select name="show" onChange=ShowTopics(this)>
                <option value="1" >Last visit on June 10 2003 at 9:48am</option>
...
<td bgcolor="#E7E7E7" background="" colspan="6" class="tiHeading">A Guides Guide to Guides</td>
    <tr> 
     ...
     <td bgcolor="#F8F7EF" background="" width="41%" class="text"><a href="display_topic_threads.asp?ForumID=6&TopicID=430&PagePosition=1&showActive=7&ReturnPage=Active" target="_self">Beginner Magic Manual</a></td>
     <td bgcolor="#F8F7EF" background="" width="15%" class="text"><a href="JavaScript:openWin('pop_up_profile.asp?profile=5&ForumID=6','profile','toolbar=0,location=0,status=0,menubar=0,scrollbars=0,resizable=1,width=440,height=370')">Statia</a></td>
     <td bgcolor="#F8F7EF" background="" width="7%" align="center" class="text">1</td>
     <td bgcolor="#F8F7EF" background="" width="7%" align="center" class="text">20</td>
     <td bgcolor="#F8F7EF" background="" width="29%" class="text" align="right">June 09 2003&nbsp;at&nbsp;1:36pm
      <br>By <a href="JavaScript:openWin('pop_up_profile.asp?profile=3&ForumID=6','profile','toolbar=0,location=0,status=0,menubar=0,scrollbars=0,resizable=1,width=440,height=370')">Batal</a> <a href="display_topic_threads.asp?ReturnPage=Active&ForumID=6&TopicID=430&PagePosition=1&get=last#2855" target="_self"><img src="forum_images/right_arrow.gif" align="absmiddle" border="0" alt="View Last Post"></a></td>
    </tr>
   </table>
  </td>
 </tr>
...
<form>
	...
	<span class="text">Forum Jump</span>
	 <select onChange="ForumJump(this)" name="SelectJumpForum">
		...
		<option value="display_forum_topics.asp?ForumID=2">&nbsp;&nbsp;-&nbsp;General Discussion</option>
		<option value="">Members Forums</option>
		<option value="display_forum_topics.asp?ForumID=6">&nbsp;&nbsp;-&nbsp;A Guides Guide to Guides</option>
		<option value="">Leaders Forums</option>
         </select>
            </td>
