...
<TR>
	...
	<TR><TD COLSPAN=7 VALIGN=TOP ALIGN=CENTER><font size=1><a href="/cal3/calendar.pl?Month=2&Year=2001&config=calendar.cfg">February&nbsp;2001</a></font></TD></TR>
...
<option value='2003' >2003
	...
	<TD ALIGN=CENTER BGCOLOR=#000080>
		<TABLE BORDER=1 CELLPADDING=0 cellspacing=0 BGCOLOR=white>
	<TR><TD COLSPAN=7 VALIGN=TOP ALIGN=CENTER><font size=1><a href="/cal3/calendar.pl?Month=4&Year=2001&config=calendar.cfg">April&nbsp;2001</a></font></TD></TR>
...
<TABLE BORDER=1 CELLSPACING=0 ALIGN=CENTER CELLPADDING=3>
	...
	<TR>
		...
		<TD BGCOLOR="#CCCCCC">
			<input name="Month" size=2 maxlength=2 value="3"> / <input name="Date" size=2 maxlength=2 value="8"> / <input name="Year" size=4 maxlength=4 value="2001"><br>
