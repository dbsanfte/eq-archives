...
<tr>
	<td class="bodyline">
		...
		<td> <a href="index.php?sid=c65057a5581b5328b48f03f17ba6665c"><img src="templates/DarkEQ/images/logo_phpBB.gif" border="0" alt="BuchiOnline フォーラムインデックス" vspace="1" /></a>
		</td>
		...
		<td align="center" width="100%" valign="middle"><span class="maintitle">BuchiOnline</span><br />
		  ...
		  <table cellspacing="0" cellpadding="2" border="0">
			<tr>
			  <td valign="top" nowrap="nowrap" align="center"><span class="mainmenu">&nbsp;<a href="faq.php?sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_faq.gif" width="12" height="13" border="0" alt="FAQ" hspace="3" />FAQ</a></span><span class="mainmenu">&nbsp;&nbsp;&nbsp;<a href="search.php?sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_search.gif" width="12" height="13" border="0" alt="検索" hspace="3" />検索</a>&nbsp;&nbsp;&nbsp;<a href="memberlist.php?sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_members.gif" width="12" height="13" border="0" alt="メンバーリスト" hspace="3" />メンバーリスト</a>&nbsp;&nbsp;&nbsp;<a href="groupcp.php?sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_groups.gif" width="12" height="13" border="0" alt="ユーザグループ" hspace="3" />ユーザグループ</a>&nbsp;&nbsp;&nbsp;<a href="profile.php?mode=register&amp;sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_register.gif" width="12" height="13" border="0" alt="登録" hspace="3" />登録</a></span></td>
			</tr>
			<tr>
			  <td nowrap="nowrap" valign="top" height="25" align="center"><span class="mainmenu">&nbsp;<a href="profile.php?mode=editprofile&amp;sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_profile.gif" width="12" height="13" border="0" alt="プロフィール" hspace="3" />プロフィール</a>&nbsp;&nbsp;&nbsp;<a href="privmsg.php?folder=inbox&amp;sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_message.gif" width="12" height="13" border="0" alt="プライベートメッセージをみるにはログインが必要です" hspace="3" />プライベートメッセージをみるにはログインが必要です</a>&nbsp;&nbsp;&nbsp;<a href="login.php?sid=c65057a5581b5328b48f03f17ba6665c" class="mainmenu"><img src="templates/DarkEQ/images/icon_mini_login.gif" width="12" height="13" border="0" alt=" ログイン " hspace="3" /> ログイン </a></span></td>
			</tr>
		  </table>
			</td>
			</tr>
...
<form action="search.php?mode=results&amp;sid=c65057a5581b5328b48f03f17ba6665c" method="POST"><table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr>
		<td align="left"><span class="nav"><a href="index.php?sid=c65057a5581b5328b48f03f17ba6665c" class="nav">BuchiOnline フォーラムインデックス</a></span></td>
	</tr>
</table>
...
<form method="GET" name="jumpbox" action="viewforum.php?sid=c65057a5581b5328b48f03f17ba6665c">
  <table cellspacing="0" cellpadding="0" border="0">
	<tr>
	  <td nowrap="nowrap"><span class="gensmall">移動：:&nbsp;<select name="f" onChange="if(this.options[this.selectedIndex].value != -1){ forms['jumpbox'].submit() }"><option value="-1">フォーラムを選択</option><option value="-1">&nbsp;</option><option value="-1">Public</option><option value="-1">----------------</option><option value="1">General Forum</option><option value="-1">&nbsp;</option><option value="-1">EverQuest</option><option value="-1">----------------</option><option value="2">EverQuest Players</option><option value="-1">&nbsp;</option><option value="-1">FINAL FANTASY XI ONLINE</option><option value="-1">----------------</option><option value="3">FF11 Pub</option></select><input type="hidden" name="sid" value="sid=c65057a5581b5328b48f03f17ba6665c" />&nbsp;
