    ...
    <table border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        ...
        <select name="Forum" size="1">
          ...
          <option value="46">Allianzforum</option>
          ...
          <option value="37">Hibernia</option>
      ...
      <tr>
        ...
        <select name="SearchMember">
          ...
          <option value="95">Densaar</option>
...
<!-- timer
<center>
<font face="Verdana, Arial, Helvetica" size="1">69844.55</font>
</center>
end timer -->
</html>
