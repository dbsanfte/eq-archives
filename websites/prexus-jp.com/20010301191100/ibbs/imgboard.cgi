...
<INPUT TYPE="CHECKBOX" NAME="rm_number_9" VALUE="1">
 <!--img_icon-->
<!--記事レイアウト テキスト記事、テキストリンク表示、アイコンサイズ表示用-->
<FONT SIZE="+1" COLOR="#FF0000"><B>でけええええ</B></FONT>
 名前：<FONT COLOR="#00FF00"><B><A HREF="mailto: no_email">Desp</A></B></FONT>
[2000/12/10,08:07:24] 
<BLOCKQUOTE>
	Jpn主導によるJuggRaid初成功<BR>こいつはTrakanonLair入り口にいるゴーレムのでかいの(汗<BR>meleeで430ダメージとか喰らった。<BR>痛かった。最後水に落ちて、水中戦を制してKilled。<BR><BR>このあとTrapmjを殺しTrakanonを探しましたがポップしてませんでした(汗<!-- user： h172.p485.iij4u.or.jp--> <!-- imgsize skip success!! -->
</BLOCKQUOTE>

<BLOCKQUOTE> 画　像： 
 <A HREF="./imgzbox/img20001210080724.jpg" TARGET="top">
  <img src="./imgzbox/img20001210080724.jpg" width=85 height=64 border="0">
   Jugg Raid成功
 </A>-(46 KB) 
</BLOCKQUOTE>
...
<INPUT TYPE="CHECKBOX" NAME="rm_number_10" VALUE="1">
 <!--img_icon-->
<!--記事レイアウト テキスト記事、テキストリンク表示、アイコンサイズ表示用-->
<FONT SIZE="+1" COLOR="#FF0000"><B>あの人の正体が今明らかに!</B></FONT>
 名前：<FONT COLOR="#00FF00"><B><A HREF="mailto: no_email">Desp</A></B></FONT>
[2000/12/09,22:46:27] 
<BLOCKQUOTE>
	名前見にくかったので修正アンド再投稿<!-- user： h172.p485.iij4u.or.jp--> <!-- imgsize skip success!! -->
</BLOCKQUOTE>

<BLOCKQUOTE> 画　像： 
 <A HREF="./imgzbox/img20001209224627.jpg" TARGET="top">
  <img src="./imgzbox/img20001209224627.jpg" width=73 height=101 border="0">
   img20001209224627.jpg
 </A>-(48 KB) 
</BLOCKQUOTE>
