...
<tr>
<td>
<p class="text">Original credit of the jewelcraft charts goto <a href="http://www.eqtraders.com" target="_blank"><font color="#FFFF00">EQ Traders Corner</font></a> for the item information and <a href="http://eq.castersrealm.com" target="_blank"><font color="#FFFF00">EQ Castersrealm</font></a> for item trivial information and "base cost price" of all ingredients in the recepe's. A special thanks to <a href="http://pub13.ezboard.com/ulaurefin.showPublicProfile?language=EN" target="_blank"><font color="#FFFF00">Laurefin</font></a> for her hard work and discovering a formula for determining success rate in tradeskills. The exact thread about this topic can be found <a href="http://pub13.ezboard.com/feqtraderscornerfrm13.showMessageRange?topicID=1242.topic&start=41&stop=60" target=_blank>Here</a>.
</td>
</tr>
</table>
...
<tr>
	<td class=white colspan=
	4
	>
		<form name="skillsel" action="/gumkak/jewelcraft.asp" method="POST">
		<p class="text">Your skill&nbsp;:&nbsp;
		<input type="text" size=5 name="skill" value=0>
		<input type="hidden" name="sel" value=recepe>
		<input type="hidden" name="gem" value=0>
		<input type="hidden" name="show" value=recepe>
		<input type="hidden" name="price" value=>
		<input type="hidden" name="recepe_imbued" value=>
		<input type="button" name="" value="Personalize" OnClick="document.skillsel.submit();">
		</form>	
	</td>
</tr>
</table>
