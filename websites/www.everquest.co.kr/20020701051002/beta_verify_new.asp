				...
				<tr>
					<td background="live_shot_img/live_scrinbg.gif" valign="top" >
						...
						<table cellpadding="0" cellspacing="0" border="0" style="color:#dddddd">
							...
							<tr>
					<td width="30" >&nbsp;</td>
					<td style="padding-left:10px; padding-right:30px;">신청시 입력하신 주민등록번호와 이름을 입력하여 에버퀘스트 클로즈 베타테스터로 선정이 <br>되었는지 확인해 주시기 바랍니다.<br> 베타테스트에 대한 안내는 홈페이지의 공지사항을 참조해 주십시오.<br><br><b><font color="#eba418">※ 베타테스터로 선정되신 분들은 바로 계정생성화면으로 이동됩니다.</font></b><br><br><br>
</td>
				</tr>
				<tr>
					<td colspan="2"  align="center"><img src="live_account_img/live_acbr.gif" width="582" height="6" alt="" border="0"></td>
							...
							<tr>
								<td height="20" align="center">성 명</TD>
							</tr>
							<tr>
