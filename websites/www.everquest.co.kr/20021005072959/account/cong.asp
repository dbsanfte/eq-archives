...
<html>
<head><meta http-equiv="refresh" content="10;URL=http://www.everquest.co.kr">
...
<body style="margin:0 0 0 0" background="common_img/intro_rockbg.jpg">
	 ...
	 <tr>
	  <td></td>
		...
		<!--가운데 -->
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td><img src="http://www.everquest.co.kr/live_account_img/live_actitle.gif" width="587" height="28" alt="" border="0"></td>
					...
					<td background="live_shot_img/live_scrinbg.gif" valign="top" >
						...
						<table cellpadding="0" cellspacing="0" border="0" style="color:#dddddd">
							...
							<tr>
								<Td width="24"></TD>
								<td width="539">
								게시판의 주제에 맞지 않거나 타인의 욕설, 비방등에 대한 글은 통보하지 않고 삭제됩니다.
								</td>
							</tr>
							
							<tr>
								<td colspan="2" valign="top" align="center"><br><br><!-- 테이블 시작-->
								  <table cellpadding="0" cellspacing="0" border="0"  width="386" height="189">
								   <tr>
								    <td><font color="#f2bb37" style="font-size:12pt"><b>축하드립니다. !!</b></font><br><br>
									에버퀘스트 베타테스터 계정이 성공적으로 등록 되었습니다.<br>
베타테스트에 대한 자세한 내용은 공지사항을 참조하시기 바랍니다.<br><br><Br><Br>
10초 후 자동으로 메인 페이지로 이동 합니다.<br>
									</td>
								   </tr>
								  </table>
								<!-- 테이블 시작-->								
