...
<body style="margin:0 0 0 0" background="https://secure.everquest.co.kr/images/common_img/intro_rockbg.jpg">
...
<!--페이지 전체 테이블-->
	<table cellpadding="0" cellspacing="0" border="0">
	 <tr>
	   <td><img src="https://secure.everquest.co.kr/images/live_main_img/live_mnlogo01.gif" width="179" height="84" alt="" border="0"></td>
		...
		<td valign="top" colspan="2" bgcolor="#071429">		
		   <!--가운데-->
			<table cellpadding="0" cellspacing="0" border="0" bgcolor="#071429">
			 <tr>
			   <td valign="top"><img src="https://secure.everquest.co.kr/images/error_img/eqlive_img01.gif" width="480" height="56" alt="" border="0"></td>
			   </tr>
			   <tr>
			    <td width="440" style="background-image:url(https://secure.everquest.co.kr/images/error_img/eqlive_imgbg.gif); background-repeat:repeat-y; padding:10 20 10 20" align="center">
				<table cellpadding="0" cellspacing="0" border="0" width="440">
				
				 <tr>
				 <!-- Error Title Start -->
				  <td align="center">
					<img src="https://secure.everquest.co.kr/images/error_img/eqlive_imgbu01.gif" width="48" height="18" alt="" border="0" align="absbottom"> 
					<b>오류</b>
					<img src="https://secure.everquest.co.kr/images/error_img/eqlive_imgbu02.gif" width="48" height="18" alt="" border="0" align="absbottom">
				  </td>
				 <!-- Error Title End -->
				 </tr>
				...
				<tr>
					<td><img src="https://secure.everquest.co.kr/images/error_img/eqlive_img02.jpg" width="480" height="176" alt="" border="0"></td>
				</tr>
				<tr>
