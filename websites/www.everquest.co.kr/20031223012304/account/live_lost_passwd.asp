...
<a href="http://bbs.everquest.co.kr/bbs2002se/list.asp?group=bbs1&bbs=guild" onMouseOver="imgChg('https://secure.everquest.co.kr/common/inc/menu/live_mu24','0','on');" onMouseOut="imgChg('https://secure.everquest.co.kr/common/inc/menu/live_mu24','0','off');" onfocus="blur()"><img name="https://secure.everquest.co.kr/common/inc/menu/live_mu24" src="https://secure.everquest.co.kr/common/inc/menu/live_mu24_off.gif" width="121" height="18" alt="" border="0"></a><br>		   	   	   
	   ...
	   <tr>
	   <td align="left"   height="19" style="padding-left:30;" valign="top"><img src="https://secure.everquest.co.kr/common/inc/menu/live_mu50_on.gif" width="121" height="18" alt="" border="0"><br>
		<a href="end_refund.asp" onfocus="blur()"><img src="https://secure.everquest.co.kr/common/inc/menu/live_mu51_off.gif" border="0" style="margin:0 0 0 0;" onmouseover="this.src='https://secure.everquest.co.kr/common/inc/menu/live_mu51_on.gif'" onmouseout="this.src='https://secure.everquest.co.kr/common/inc/menu/live_mu51_off.gif'"></a><br>
		<a href="end_transfer.asp" onfocus="blur()"><img src="https://secure.everquest.co.kr/common/inc/menu/live_mu52_off.gif" border="0" style="margin:0 0 0 0;" onmouseover="this.src='https://secure.everquest.co.kr/common/inc/menu/live_mu52_on.gif'" onmouseout="this.src='https://secure.everquest.co.kr/common/inc/menu/live_mu52_off.gif'"></a><br>
	   </td>
	   </tr>
								...
								<td colspan="2" valign="top" align="center"><br><br><!-- 테이블 시작-->
								  <table cellpadding="0" cellspacing="0" border="0" background="../live_bbs_img/live_acf2img01.gif"  width="386" height="189">
								   <tr>
									...
									<td style="padding-left:40; padding-top:14" valign="top">주민등록번호: </td><td valign="top" style="padding-top:10"><input type="text" name="ssn1" maxlength=6 size="13" style="border-top:1 solid #656e72; border-left:1 solid #656e72; border-bottom:1 solid #656e72; border-right:1 solid #656e72; background-color:#1a3547; color:white"> - <input type="password" name="ssn2" maxlength=7 size="13" style="border-top:1 solid #656e72; border-left:1 solid #656e72; border-bottom:1 solid #656e72; border-right:1 solid #656e72; background-color:#1a3547; color:white"></td>
								   </tr>
								   <tr>
...
Used with permission. All rights reserved.<br></font></td>
	   ...
	   <tr>
	   <td style="font-size:9pt;" align="center"><font color="#4c5b73" style="font-size:8pt; letter-spacing:0">서울특별시 삼성동 143-8 승광빌딩 (우)135-090 ㈜엔씨소프트 / 대표이사: 김택진  대표 전화 : 02-2186-3582</font></td>
       </tr>
	  <tr>
