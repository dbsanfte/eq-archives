...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Chat Room Help!</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Chat Room Help!">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Dirt Scratches">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000106.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Brooks47</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Is it just me or does anyone else have trouble getting a straight answer from "GMs" in the chat rooms? Please let me know if I'm just going "POSTAL" for no reason?</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Khaili</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have been able to get a straight response when needed. Of course I have never required any major aid.  I have had to repost the message a few times, but that is understandable given the numorous people in the rooms and the constant flow of messages.  I am generally pleased with all assistance I have received from guides and GM's.</FONT></TD></TR></TABLE>
</FONT>
