...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by vizco:
[B]In general, I would recommend having /loc as a hotkey, and keeping /log on. Then you can whack loc whenever you get in an iffy fight, and have a hardcopy record of it for that corpse run. The log file ends up in the same place as a screenshot would, and is called eqlog.txt.

If you can spare the disk space for a screenshot, you can spare the space for a log, and besides, then you can keep track of your skill increases real easily.
