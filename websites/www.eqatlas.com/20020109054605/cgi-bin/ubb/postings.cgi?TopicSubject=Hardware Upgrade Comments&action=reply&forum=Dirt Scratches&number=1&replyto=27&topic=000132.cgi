...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Hardware Upgrade Comments</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Dumathoin:
[B] <BLOCKQUOTE><font size="1" face="Verdana, Arial">quote:</font><HR>Originally posted by Feressa:
[b]Muse, I really hope you aren't jumping on the 'kick Verant for making the game better' bandwagon. [/b]<HR></BLOCKQUOTE>

Nah. 

Having read Muse' pose, he was fair not to pre-judge Verant. In fact, he simply asked the forum if WE in the forum thought if the (upgrade) expectations from Verant are reasonable or not. 

For myself, my answer to Muse would be:

Yes, Verant's requirements and expectations on system requirements are very fair, very realistic. 

EQ after the patch does NOT require a top of the line PC. It works perfectly with a mediocre low-end 500 MHz Celeron (which are now considered entry level cheapo machines).

Add a Voodoo3 card (under $100) and increase RAM a bit, and you got a perfectly decent machine that can handle EQ. 

I think Verant is on-target with what people should have to be able to play EQ. These requirements are neither excessive nor harsh. 
...
<A HREF="http://www.eqatlas.com/ubb/Forum1/HTML/000132.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
