...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Key to The Hole</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Illusianato:
[B]Ok, for those of you that actually care...

I found the Key to the Hole in an "inn" vendor inside Paineel.. the key looks like a bag.  so it's really easy to pass up.[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Key to The Hole">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Illusianato</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I read in the description to The Hole that you can either Lockpick or use a key to get past the boulder in the entrance to The Hole.  I was wondering where it was by chance, so I don't have to spend 10 min trying to squeez my was past that silly thing.  <IMG SRC="http://www.eqatlas.com/ubb/wink.gif"></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Illusianato</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Ok, for those of you that actually care...<P>I found the Key to the Hole in an "inn" vendor inside Paineel.. the key looks like a bag.  so it's really easy to pass up.</FONT></TD></TR></TABLE>
</FONT>
