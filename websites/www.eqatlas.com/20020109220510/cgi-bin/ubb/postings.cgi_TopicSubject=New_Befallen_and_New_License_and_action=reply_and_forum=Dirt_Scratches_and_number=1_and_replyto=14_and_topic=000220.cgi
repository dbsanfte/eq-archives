...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by wizzumwalt:
[B]Well, there is the liscense.text with worthless junk in it,then there is the more important eqliscense.txt, I think everyone should read it.

And to add more fire to upper levels who want to level, the labrynth just got a boost, meaning what was green at the enterance to a 59 is now blue, yes blue... The gargolyes used ot hit me for dual 30 to 40, now hit for quad 100's.

This the the labrynth in the great divide.[/B][/QUOTE]
