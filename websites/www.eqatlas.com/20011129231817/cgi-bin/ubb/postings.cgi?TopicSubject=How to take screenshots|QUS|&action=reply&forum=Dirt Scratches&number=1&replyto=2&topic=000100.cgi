...
[B]It's actually pretty simple to take screenshots....

You just need to hit the "-" minus key, on the top of the numberpad. 

The only problem with using this for corpse retrieval is that you will need to exit the game to view pics... They are store inside the Everquest folder, under programs in your computer. Easiest way to find them is using Windows Explorer.

I usually can't leave a corpse in game before I log, so leaving to view a pic of my death might not work for me... Also, your picture might not go through because of the Loading message when you die...Better to just keep a pad for scribling locs, names, and pertinent info. 

A loathsome individual punches YOU for 36 pts
You have been slain by a_loathsome_individual
You have lost a level...
You are now level 19!
LOADING PLEASE WAIT!!    :)[/B][/QUOTE]
