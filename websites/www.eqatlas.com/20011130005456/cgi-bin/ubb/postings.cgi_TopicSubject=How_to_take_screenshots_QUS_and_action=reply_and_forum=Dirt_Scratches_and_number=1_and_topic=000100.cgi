...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">How to take screenshots?</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="How to take screenshots?">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Dirt Scratches">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000100.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Dumathoin</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I know... this is a stupid newbie question. But I'd love to know how you folks take screenshots of the game screen. <P>One of the reasons I want to take snapshots of the game screen is so I can quickly take a picture right before I die. That way, the screenshot gives me an idea of the location I died in, and the LOC coordinates on the screen (if I had pressed /loc) would also appear on the screenshot  <IMG SRC="http://www.eqatlas.com/ubb/smile.gif"> <P>thanks in advance <P><P>------------------<BR>Dumathoin<BR>Paladin of Underfoot<BR>Kaladim of Luclin Server<BR>7th season...no, rabbit season!</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Gixme</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Use the - key on the number pad (on the left of ye keyboard, not one next to the zero)</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">taobob</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">It's actually pretty simple to take screenshots....<P>You just need to hit the "-" minus key, on the top of the numberpad. <P>The only problem with using this for corpse retrieval is that you will need to exit the game to view pics... They are store inside the Everquest folder, under programs in your computer. Easiest way to find them is using Windows Explorer.<P>I usually can't leave a corpse in game before I log, so leaving to view a pic of my death might not work for me... Also, your picture might not go through because of the Loading message when you die...Better to just keep a pad for scribling locs, names, and pertinent info. <P>A loathsome individual punches YOU for 36 pts<BR>You have been slain by a_loathsome_individual<BR>You have lost a level...<BR>You are now level 19!<BR>LOADING PLEASE WAIT!!    <IMG SRC="http://www.eqatlas.com/ubb/smile.gif"><BR></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">vizco</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">In general, I would recommend having /loc as a hotkey, and keeping /log on. Then you can whack loc whenever you get in an iffy fight, and have a hardcopy record of it for that corpse run. The log file ends up in the same place as a screenshot would, and is called eqlog.txt.<P>If you can spare the disk space for a screenshot, you can spare the space for a log, and besides, then you can keep track of your skill increases real easily.<P>   -- Vizco<BR></FONT></TD></TR></TABLE>
</FONT>
