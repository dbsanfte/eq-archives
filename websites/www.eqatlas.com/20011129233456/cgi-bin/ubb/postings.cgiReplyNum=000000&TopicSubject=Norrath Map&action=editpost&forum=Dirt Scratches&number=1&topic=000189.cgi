...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Lionfrog on 04-01-2001 09:37 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">OK, For awile now I have had an old map of Antonica, Faydwer, and Odus. Its been very helpful yet it could be much better. I think the EQ atlas staff should do something similar, make a map of all of Norrath that shows what zones are connected to what and such. The map I have has saved me hours of research/Trial and error, and looking at each individual zone map is kind of time consuming. So In all I think if you did do this kind of thing It would make travleing much easier for all of Norrath. 
