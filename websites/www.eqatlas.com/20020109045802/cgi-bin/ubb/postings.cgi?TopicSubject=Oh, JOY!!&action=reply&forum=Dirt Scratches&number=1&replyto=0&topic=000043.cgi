...
[B]Servers down again.

Not wanting to sound like a whinger, but it seems that server maintainance always seems to happen when I ome home from work; cutting into my EQ time.

Why not stagger the times for maintainance?  And instead of patching for trivial things, spend the scripters time making the servers more secure.

PS  And improve the Ranger class?  Why not allow Rangers and Druids to charm animals with the lull spell to act as pets?[/B][/QUOTE]
