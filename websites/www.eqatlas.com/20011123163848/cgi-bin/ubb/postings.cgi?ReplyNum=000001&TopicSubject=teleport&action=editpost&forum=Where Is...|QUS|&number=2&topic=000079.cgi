...
<BR>
Topic: <FONT COLOR="#871f78">teleport</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Jarren on 04-13-2001 12:33 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Unless you are friendly with the druid/wizard, they will usually charge a fee of 10pp.  It's not too bad, I suppose...

As a bard, I've rarely used a teleport.  If you cannot find any druids/wizards available for ports, perhaps you can find a bard that is running across the continent and ask that you be allowed to "tag along"...

I was running from Freeport to Qeynos one time and picked up about 4 extra passengers on the way.  Was actually kinda fun outrunning the druids with SOW...hehehehe...
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="teleport">
