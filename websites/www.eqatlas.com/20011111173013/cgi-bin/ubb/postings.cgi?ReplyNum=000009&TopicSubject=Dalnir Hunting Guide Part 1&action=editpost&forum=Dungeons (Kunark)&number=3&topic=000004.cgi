...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Grimveld on 11-02-2001 11:53 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]Originally posted by Grazer8:
[b]As a final note: if you count on invis to scout places out DON'T drop down to the 3rd level unless you have both reg invis and invis to undead up.[/b][/QUOTE]Regular invis and IVU don't stack, FYI. I never cease to be surprised by the numbers of players who don't know this.

Rogue sneak/hide will work against both living and undead mobs tho.</TEXTAREA>
</td></tr>
