...
<BR>
Topic: <FONT COLOR="#871f78">Fishing</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Telen on 03-26-2001 04:15 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Fishing is a skill and you need these items to use the skill. I have never fished but I assume the if you click on the fishing pole you can put a lure on it. Then I bet you just click on the fishing skill icon when near the water.

I will give it a test when I get Home to see if this is how it works.

Telen Walkingbear
Barbarian Shaman 21 winter</TEXTAREA>
</td></tr>
