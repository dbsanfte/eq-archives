...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Everfrost Guards</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by ScareCrow:
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">ScareCrow</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I'm just wondering if the guards of Everfrost will kill a human Necro.  Some of my friends want to hunt there, and I don't want to make the trip if I'm just going to be KOS.  Thanks in advance for any info you can give me.<P>------------------<BR>Vanian<BR>Luclin Server</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Oakshot</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">They very well may, but you're a necro.  Use Gather Shadows and run past them.  They don't wander, but be aware, Karg Icebear, Marter Icebear, Tundra Jack, and Iceberg DO wander.  Just watch your tail, and you should be fine.</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">ScareCrow</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">thanks for the info<P></FONT></TD></TR></TABLE>
</FONT>
