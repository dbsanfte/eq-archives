...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">mapping program</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="mapping program">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Dirt Scratches">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000317.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Fattyfat</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Hey, fattyfat here Just saw your front-page and It said you were looking for a custom program job. <P>Many times I'm bored at work so I was thinking about maybe working on a project like this ... if you could post me a sample log of lets say 10-100 lines of consecutive loc commands I would appreciate it.<P>Like go map out a square in some zone or somethign with loc.<P></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Fattyfat</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">forgot to add, if anyone could just post me 1 or 2 lines of their log file with the response from a /loc command I would appreciate it.<BR></FONT></TD></TR></TABLE>
</FONT>
