...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Fattyfat:
[B]forgot to add, if anyone could just post me 1 or 2 lines of their log file with the response from a /loc command I would appreciate it.[/B][/QUOTE]
