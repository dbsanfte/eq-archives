...
[B]Actually, there are zone connection maps for every part of the world on my site, although for some reason (which I haven't figured out) people don't see them.  They're located directly beside the cities on the page with the list of the zones, under Zone Connection Maps.  The Kunark one is done bubble style, the others are done using the smaller images of the zones (when available).  These haven't been updated in quite a while, though.
