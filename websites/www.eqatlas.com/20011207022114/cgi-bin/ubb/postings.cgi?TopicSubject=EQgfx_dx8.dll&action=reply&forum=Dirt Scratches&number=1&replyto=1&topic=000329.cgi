...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">EQgfx_dx8.dll</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by [GS]TheOne:
[B]Silly question, have you downloaded DirectX 8 ??
Everquest now needs it to run

Go to Everquest.com for more information: [URL=http://everquest.station.sony.com/support/luclin/directx8_install.jsp]http://everquest.station.sony.com/support/luclin/directx8_install.jsp[/URL]

Or to download DirectX go to:
[URL=http://www.microsoft.com/directx/homeuser/downloads/default.asp]http://www.microsoft.com/directx/homeuser/downloads/default.asp[/URL] 
and download the appropiate file for your operating system
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="EQgfx_dx8.dll">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Dirt Scratches">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000329.cgi">
<CENTER>
<p>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">kevdaug</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I just bought everquest. Tried to connect, got the patch update, but when I try to start the game it says failed to load EQgfx_dx8.dll. I uninstalled and tried again several times with no success.<P>Any Ideas?<P>Thanks</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">[GS]TheOne</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Silly question, have you downloaded DirectX 8 ??<BR>Everquest now needs it to run<P>Go to Everquest.com for more information: <A HREF="http://everquest.station.sony.com/support/luclin/directx8_install.jsp" TARGET=_blank>http://everquest.station.sony.com/support/luclin/directx8_install.jsp</A><P>Or to download DirectX go to:<BR><A HREF="http://www.microsoft.com/directx/homeuser/downloads/default.asp" TARGET=_blank>http://www.microsoft.com/directx/homeuser/downloads/default.asp</A> <BR>and download the appropiate file for your operating system<P>------------------<BR>TheOne</FONT></TD></TR></TABLE>
</FONT>
