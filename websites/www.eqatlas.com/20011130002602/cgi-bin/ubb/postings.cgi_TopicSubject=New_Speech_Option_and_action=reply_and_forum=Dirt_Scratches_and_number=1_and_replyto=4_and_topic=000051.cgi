...
[B]The voice activation option for EQ is specifically for hotkeys and basic keyboard commands, not chat or typing.

Taobob's right, go check out Roger Wilco if you want voice chat.  Worked fine when I tested it out.  Unfortunately, none of my normal hunting partners have it, so I haven't tried it within EQ, but a couple guild mates were able to successfully use it.[/B][/QUOTE]
