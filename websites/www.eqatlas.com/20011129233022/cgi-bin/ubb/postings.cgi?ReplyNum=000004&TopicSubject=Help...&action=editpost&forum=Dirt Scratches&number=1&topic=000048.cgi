...
<BR>
Topic: <FONT COLOR="#871f78">Help...</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by taobob on 08-31-2000 05:14 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">It also can depend on the processor speed of your machine...

I have heard that doing a runnign jump into the zone doorway is a way to decrease the amount of loading time, but I didn't actually notice a difference when trying this...
