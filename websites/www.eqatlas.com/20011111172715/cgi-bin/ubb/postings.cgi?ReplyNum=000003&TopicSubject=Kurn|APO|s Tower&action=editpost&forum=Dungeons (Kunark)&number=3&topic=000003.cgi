...
<BR>
Topic: <FONT COLOR="#871f78">Kurn's Tower</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Lalkin on 07-10-2001 03:01 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Hm

Well I personally have camped the forager (same spawn as the jester) for about 10 hours. During that time the jester spawned twice (FS sword). I was the only one in the zone and there was a thickboned skellie in the cook spawn and I wasn't killing anything except roamers in the stables.

I personally think the jester is just a random spawn, just keep killing his placeholders. I have seen the jester spawn in two locations, both in the hallway of the stables.

Of course I was looking for the forager. Anyone know how to get the forager to spawn or is he just even rarer than the jester?
</TEXTAREA>
</td></tr>
