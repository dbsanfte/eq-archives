...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Where did the Atlas go?</FONT></td></tr></table>
</td></tr>
...
[B]I have never seen a map of that ilk here on the Atlas...

Another poster such as youself referenced the same crappy map one other time as a template that Muse should use to create one.... 

As far as I know there has never been a zone connection map here on the Atlas...
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Where did the Atlas go?">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">laovel</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">There used to be an Atlas on this page with all the zones showing.  It was much better then the smaller zone connection maps. Can you re-post or show a better link to it if I'm just missing it?<BR>Thanks!<P>Newbie<BR>Cleric<BR>Mage<BR>Monk<BR></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">taobob</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">From the main page  <A HREF="http://www.eqatlas.com" TARGET=_blank>www.eqatlas.com</A>  you can click on the top left option to take you to the main atlas page... <P>or you could follow this direct link...<BR> <A HREF="http://www.eqatlas.com/atlas.html" TARGET=_blank>http://www.eqatlas.com/atlas.html</A> <P>Some really good advice is to add this to your favorites so you can get directly to the maps page...<P><P>------------------<BR>Blackivar Backbiter<BR>aka Blackivar the Cunning<BR>Halfling Rogue<BR>21st Season<BR>Druzzil Ro Server</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">laovel</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Nope, that is a LIST of all the zones,cities, and zone connection maps.<P>What I'm talking about was a really great MAP with lines to mark connections of, what I thought, was all the zones.<P>Kinda like this; <A HREF="http://www.loreseekers.com/map_detail.php3?url=http://www.loreseekers.com/maps/ot_travel_map.jpg&zone=Norrath&creator=Arcke%20of%20Povar" TARGET=_blank>http://www.loreseekers.com/map_detail.php3?url=http://www.loreseekers.com/maps/ot_travel_map.jpg&zone=Norrath&creator=Arcke%20of%20Povar</A> <P>but MUCH better, seeing on how it was done by MUSE.<BR></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">taobob</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have never seen a map of that ilk here on the Atlas...<P>Another poster such as youself referenced the same crappy map one other time as a template that Muse should use to create one.... <P>As far as I know there has never been a zone connection map here on the Atlas...<P>------------------<BR>Blackivar Backbiter<BR>aka Blackivar the Cunning<BR>Halfling Rogue<BR>21st Season<BR>Druzzil Ro Server</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">laovel</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Found it. After looking though my history file for awhile (and lots of bad maps). I found what I think is a very nice zone connection map<P> <A HREF="http://www.everlore.com/geography/" TARGET=_blank>http://www.everlore.com/geography/</A> </FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Muse</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Actually, there are zone connection maps for every part of the world on my site, although for some reason (which I haven't figured out) people don't see them.  They're located directly beside the cities on the page with the list of the zones, under Zone Connection Maps.  The Kunark one is done bubble style, the others are done using the smaller images of the zones (when available).  These haven't been updated in quite a while, though.<P>------------------<BR>Muse<BR>Bard and Cartographer</FONT></TD></TR></TABLE>
</FONT>
