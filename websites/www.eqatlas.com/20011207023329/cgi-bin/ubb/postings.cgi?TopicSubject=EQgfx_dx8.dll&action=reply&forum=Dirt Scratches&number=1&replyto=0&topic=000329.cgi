...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by kevdaug:
[B]I just bought everquest. Tried to connect, got the patch update, but when I try to start the game it says failed to load EQgfx_dx8.dll. I uninstalled and tried again several times with no success.
