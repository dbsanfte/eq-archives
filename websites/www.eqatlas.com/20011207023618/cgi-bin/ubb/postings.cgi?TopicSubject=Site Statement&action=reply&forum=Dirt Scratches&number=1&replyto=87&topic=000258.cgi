...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Site Statement</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Queschun Mahrk:
[B]Muse

Post an address Muse or send me an email with an address or P.O. Box. I no longer play the game, but used your maps daily for over two years. I will gladly shell out a bit if cash to help continue the map making. Your maps made the game so much more enjoyable.

As an Architect, I can really appreciate the time it takes to research the zones, taking coordinates all the way, then transpose the information into a user friendly map.
...
...doh, Congratulations on surviving your internship![/B][/QUOTE]
...
<A HREF="http://www.eqatlas.com/ubb/Forum1/HTML/000258.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
