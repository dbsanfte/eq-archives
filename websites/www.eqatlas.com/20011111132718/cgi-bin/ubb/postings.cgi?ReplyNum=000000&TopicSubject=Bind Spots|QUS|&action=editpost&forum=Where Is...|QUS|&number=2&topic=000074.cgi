...
<BR>
Topic: <FONT COLOR="#871f78">Bind Spots?</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Chulak on 04-01-2001 08:16 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Does anybody know where I can a list of all the known bind spots?

Does one even exist?

If not how about adding one muse?  Doesn't have to be exact, just the zones would be good enough, I can travel around and /ooc to where they are.  But I would like to know at least where to start  :D!</TEXTAREA>
</td></tr>
