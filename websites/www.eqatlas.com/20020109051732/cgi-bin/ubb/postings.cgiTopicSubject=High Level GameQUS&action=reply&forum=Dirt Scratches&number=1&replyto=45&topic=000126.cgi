...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">High Level Game?</FONT></td></tr></table>
</td></tr>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by SolClaryn:
[B]I think that at level 26 I have some consept of what leveling is like. I have noted that there is a certain image forming of the "Vision" of Verant, and many players/customers don't like it. 
1. you can hunt an ENDLESS line of the SAME monsters with random death from highbie monsters(which I think is STUPID and sadistic of Verant), Oasis is the PERFECT example of a BAD zone, CRAP loot, Excellent xp BUT random death from "trained" highbie specs or Sand Giants. 
2. the other way to level is to KILL guards, or other NPC(ok honestly I did a THOUSAND of those bard quests(eq postal service) so I could kill the BB one), if they didn't intend this to be WHY are there just SO many of them that can be kited into oblivion??? And why are they the best, fastest and EASIEST xp from 25 to 35???
   My MAIN pet peeve is the Ubber Highbie, you know him, he is in YOUR zone SCREAMING for a Rez because he just "got killed by lag" or "the zone crashed and he got killed" and D*MN it he aint gonna go through it all again to get that level back. Then he complains about how HARD it is to get a group at his level without the UBBER UBBER stuff(one on Fennin Ro last night actually called a FBSS a piece of CRAP!!). They go on to call people of 25th to 55th level NEWBS(I mean PLEASE!!!) and tell us how STUPID we are. Then he has the NARDS to DEMAND a sow AND rez. LOL I KNOW they aren't ALL that sour and full of themselves, BUT if that is what level 50 plus is like, count ME OUT.[/B][/QUOTE]
...
<A HREF="http://www.eqatlas.com/ubb/Forum1/HTML/000126.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
