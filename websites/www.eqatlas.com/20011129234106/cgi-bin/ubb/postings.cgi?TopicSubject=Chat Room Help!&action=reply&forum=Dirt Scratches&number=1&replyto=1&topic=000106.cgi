...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Khaili:
[B]I have been able to get a straight response when needed. Of course I have never required any major aid.  I have had to repost the message a few times, but that is understandable given the numorous people in the rooms and the constant flow of messages.  I am generally pleased with all assistance I have received from guides and GM's.[/B][/QUOTE]
