...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Matrickz:
[B]Muse:

First to the user who said he has a 2" thick binder ... I need to expand to the larger 3".  secondly - Why ... because of the maps and information I get from your site.  (thank goodness I can use the company printer LOL).  Figured I have 400 plus pages of maps notes hints, quests and other data now (and that is for only one class -monk- and 1 skill- jewelry).  All of the other sites maps are junk.  Hand drawn pen scratches while yours are cartographic masterpieces.  Don't know how ya do it but it has been the difference between safety and "... loading, please wait". Paypal works for me budd.  BTW I always though you DOCS got the big buxx LOL.[/B][/QUOTE]
