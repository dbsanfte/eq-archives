...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Might as well be the one to start this</FONT></td></tr></table>
</td></tr>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Might as well be the one to start this">
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Xanthias</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Ok lets try and figure out where these SUPER quest items start<BR>I think the monk one starts in SRO at the entrance to Innothule<P>Anyone with knowledge on ranger one I'd be appreciative.<P>Xanthias Draconious<BR>"For The Fallen"<BR>Ranger of Morell-Thule</FONT></TD></TR></TABLE>
</FONT>
