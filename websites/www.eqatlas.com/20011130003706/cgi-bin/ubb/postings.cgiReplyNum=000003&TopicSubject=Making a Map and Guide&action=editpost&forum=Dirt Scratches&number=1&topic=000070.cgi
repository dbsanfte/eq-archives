...
<BR>
Topic: <FONT COLOR="#871f78">Making a Map and Guide</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by Nephtu on 09-15-2000 02:18 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">To answer your question, no, using a log parser is not going to get you banned.  Technically it probably is a violation of the Eula, but El Gordo has said they don't object to log parsers any more than slideshows from screenshots.  

Joystick macros, SoW hacks, etc. are a WHOLE different story.
