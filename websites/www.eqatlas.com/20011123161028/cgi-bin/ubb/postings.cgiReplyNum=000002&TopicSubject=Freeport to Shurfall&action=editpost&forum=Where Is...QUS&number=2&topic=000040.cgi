...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#871f78">Originally posted by taobob on 10-06-2000 03:27 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">The best advice I can give is to get a map of Highhold (as this is the major obstacle you will need to traverse) and be sure to have SOW on you... When you travel through HH trya dn chose a time where the orcs and gnolls will be camped there (primetime), and run like hell.....

The rest of the trip is not exceedingly hard, if you are good at avoiding enemies.... In the Karanas (North and East) always run directly at the monsters that are indifferent to you (spiders, beetles, snakes) and get as far from the cats and griffawns (and everything else) as you can.... 

Also be careful on the cliff headed down from Highhold, as fallign from here will mean a quick death...
