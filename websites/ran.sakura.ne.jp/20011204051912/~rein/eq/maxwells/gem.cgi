...
<body>
<DIV align="right"><b>更新日 2001/11/12 19:43</b></DIV><p>
<TABLE ALIGN="center" BORDER="2" CELLSPACING="1" CELLPADDING="1">
  ...
  <TR>
    ...
    <TD><span onMouseover="msgShow(event.x,event.y,14)" onMouseout="msgHide()">Crushed Coral</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,14)" onMouseout="msgHide()">Flawless Diamond</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,9)" onMouseout="msgHide()">Flawed Emerald</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,9)" onMouseout="msgHide()">Crushed Flame Emerald</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,1)" onMouseout="msgHide()">Crushed Topaz</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,4)" onMouseout="msgHide()">Flawed Sea Sapphire</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,11)" onMouseout="msgHide()">Crushed Black Marble</span></TD></TR>
  <TR>
    ...
    <TD><span onMouseover="msgShow(event.x,event.y,9)" onMouseout="msgHide()">Black Marble</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,13)" onMouseout="msgHide()">Jaundice Gem</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,5)" onMouseout="msgHide()">Crushed Opal</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,9)" onMouseout="msgHide()">Crushed Lava Ruby</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,6)" onMouseout="msgHide()">Chipped Onyx Sapphire</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,9)" onMouseout="msgHide()">Crushed Flame Emerald</span></TD></TR>
  <TR>
    <TD ALIGN="center" bgColor="#FFC68C">WIZ/ENC<br>MAG/NEC</TD>
    <TD><span onMouseover="msgShow(event.x,event.y,15)" onMouseout="msgHide()">Crushed Flame Opal</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,8
)" onMouseout="msgHide()">Pristine Emerald</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,15)" onMouseout="msgHide()">Flawed Topaze</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,8)" onMouseout="msgHide()">Crushed Onyx Sapphire</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,1)" onMouseout="msgHide()">Crushed Topaze</span></TD>
    <TD><span onMouseover="msgShow(event.x,event.y,11)" onMouseout="msgHide()">Nephrites</span></TD>
...
<TABLE align=left border=1>
  ...
  <TR><TD bgColor=#FFC68C>Black Marble</TD>         <TD align=middle width=20><B>9</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Chipped Onyx Sapphire</TD><TD align=middle width=20><B>6</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Black Marble</TD> <TD align=middle width=20><B>11</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Coral</TD>        <TD align=middle width=20><B>14</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Flame Emerald</TD><TD align=middle width=20><B>9</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Flame Opal</TD>   <TD align=middle width=20><B>15</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Jaundice Gem</TD> <TD align=middle width=20><B>11</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Lava Ruby</TD>    <TD align=middle width=20><B>9</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Onyx Sapphire</TD><TD align=middle width=20><B>8</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Opal</TD>         <TD align=middle width=20><B>5</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Crushed Topaz</TD>        <TD align=middle width=20><B>1</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Flawless Diamond</TD>     <TD align=middle width=20><B>14</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Flawed Emerald</TD>       <TD align=middle width=20><B>9</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Flawed Sea Sapphire</TD>  <TD align=middle width=20><B>4</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Flawed Topaz</TD>         <TD align=middle width=20><B>15</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Jaundice Gem</TD>         <TD align=middle width=20><B>13</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Nephrite</TD>             <TD align=middle width=20><B>11</B></TD></TR>
  <TR><TD bgColor=#FFC68C>Pristine Emerald</TD>     <TD align=middle width=20><B>8
</B></TD></TR>
  </TABLE>
<CENTER>
<TABLE border=1>
