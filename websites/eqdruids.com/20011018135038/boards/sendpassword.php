...
<TITLE>Eq Druids Forums - Send Password</TITLE>
</HEAD>
...
<TR>
	<TD ALIGN="CENTER">
     ...
     <FORM ACTION="/boards/sendpassword.php" METHOD="POST">
     <TABLE BORDER="0" WIDTH="95%" CELLPADDING="1" CELLSPACING="0" ALIGN="CENTER" VALIGN="TOP"><TR><TD BGCOLOR="#000000">
     ...
     <TR ALIGN="LEFT">
       <TD BGCOLOR="#e6ebd7">Username:</TD>
       <TD BGCOLOR="#f7f5e6"><INPUT TYPE="TEXT" NAME="user" VALUE="" SIZE="35" MAXLENGHT="50"></TD>
     </TR>
     <TR ALIGN="LEFT">
       <TD BGCOLOR="#e6ebd7">Email Address:</TD>
       <TD BGCOLOR="#f7f5e6"><INPUT TYPE="TEXT" NAME="email" SIZE="35" MAXLENGTH="100"></TD>
     </TR>
     <TR BGCOLOR="#e6ebd7" ALIGN="LEFT">
...
<center><font size=-2>phpBB Created this page in 0.009289 seconds.</font></center>
</FONT>
</BODY>
</HTML>
