...
<title>EQRankings - Find Guilds</title>
...
<A href="/index.php?p=add">Add/Update Profile</a> - <A href="/index.php?p=overview">Overview</A> - <a href="/index.php?p=search" onmouseover="ypSlideOutMenu.showMenu('menu1');" onmouseout="ypSlideOutMenu.hideMenu('menu1')">Search</a> - <A href="/index.php?p=popular">Popular Profiles</A> - <A href="/index.php?p=resist">Resist Freaks</A> - <a href="/guilds" onmouseover="ypSlideOutMenu.showMenu('menu2');" onmouseout="ypSlideOutMenu.hideMenu('menu2')">Guilds</a> - <A href="/index.php?p=faq">FAQ</A> - <A href="/forums/">Forums</A>    </td>
  </tr>
  <tr>
  ...
  <tr> 
    ...
    <br>
		...
		<center>
		<form method="post" action="/search.php?p=post">
		<table width="400" cellpadding="0" cellspacing="0">
		<tr><td colspan="2">Are you looking for a Guild? Complete the following fields and click 'Search' to see what Guilds will accept you.<br><br><br></td></tr>
		...
		<tr><td>Level:</td><td><input type="text" name="level" value="65" size="2"></td></tr>
		<tr><td>Total AA:</td><td><input type="text" name="minaa" size="4"></td></tr>
		<tr><td>Time Zone:</td><td><input type="text" name="timezone" size="3"> (EST, CST, PST, etc..)</td></tr>
		<tr><td colspan=2><br><br>Only show guilds flagged for the following...</td></tr>
		<tr><td><br>Flagged:</td><td><br><select name="guildkills">
		<option value="All">All</option>
		<option value="elementals">Elementals</option>
		<option value="potime">Plane of Time</option>
		<option value="uqua">Uqua</option>
		<option value="qvic">Qvic</option>
		<option value="inktuta">Inktu`Ta</option>
		<option value="txevu">Txevu</option>
		<option value="tacvi">Tacvi</option>
		<option value="anguish">Citadel of Anguish</option>
		</select>
		</td></tr>
		<tr><td></td><td><br><input type="submit" value="Search"></td></tr>
		</table>
		<br>
