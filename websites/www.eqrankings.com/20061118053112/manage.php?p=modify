...
<title>EQRankings - Guild Management</title>
...
<A href="/index.php?p=add">Add/Update Profile</a> - <A href="/index.php?p=overview">Overview</A> - <a href="/index.php?p=search" onmouseover="ypSlideOutMenu.showMenu('menu1');" onmouseout="ypSlideOutMenu.hideMenu('menu1')">Search</a> - <A href="/index.php?p=popular">Popular Profiles</A> - <A href="/index.php?p=resist">Resist Freaks</A> - <a href="/guilds" onmouseover="ypSlideOutMenu.showMenu('menu2');" onmouseout="ypSlideOutMenu.hideMenu('menu2')">Guilds</a> - <A href="/index.php?p=faq">FAQ</A>    </td>
  ...
  <tr> 
    <td class="content" background="/img/contentbk.jpg">
			...
			<form method=post action="http://www.eqrankings.com/manage.php?p=id&action=login">


			<table width=225 cellpadding=1 cellspacing=0>

			<tr>

			<td width=50%>Username:</td><td><input type="text" name="username"></td>

			</tr>

			<tr>

			<td width=50%>Password:</td><td><input type="password" name="password"></td>

			</tr>

			<tr>

			<td width=50%></td><td><br><input type="submit" value="Login"></td>
        ...
        <tr>
        <td background="/img/menubk.jpg" style="padding-bottom: 3px; padding-top: 3px;"><center><a href="http://www.eqrankings.com/manage.php?p=modify">Account Settings</a> - <a href="http://www.eqrankings.com/manage.php?p=addmember">Add Member</a>
	 - <a href="http://www.eqrankings.com/manage.php?p=deletemember">Delete Member</a>
	</center></td>
        </tr>
        <tr>
        <td background="/img/contentbk.jpg" class="content">
        <center>
        <br>You are not currently logged in.<br>
