...
LogSplit 1.7 - EQ Log File Splitter

LogSplit will take the eqlog_xx_charname.txt and eqlog_charname_xx.txt
files produced by Everquest, and split them up into more manageable
chunks.  It can split by year, month, week, day, and individual play
session.
