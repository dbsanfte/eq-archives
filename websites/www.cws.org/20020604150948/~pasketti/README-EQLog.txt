...
top.  The main tabs are:  MESSAGES, GENERAL, DAMAGE, PETS, and BENCHMARKS.
...
Heals		How many time you were healed
...
Right-click to select histograms by hits, hit damage, hit delay, and a DPS
DPS report.
...
The DPS report will show your damage per second.  Just find your weapon
delay on the list, and you'll see the DPS.  For delays that are lower than
your actual weapon delay, you'll see some pretty ludicrous numbers, but
once you get to the actual weapon delay, the DPS will level out and get
remarkably consistent for the rest of the report.  I don't know your weapon
delay, so I just calculate the DPS for each delay from 10 to 300 in steps of
10.  Has to be steps of 10, since there's a one-second granularity in the time
in the log.
...
Right-click to select histograms by hits, hit damage, hit delay, and the DPS
report.
...
The DPS report shows the Damage per Second for various weapon delays.
...
Right-click to select histograms by hits, hit damage, hit delay, and DPS
report.
