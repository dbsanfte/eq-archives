...
<body onunload="popunder_nocontrols('hfpu1','http://landing.hitfarm.com/kwpop.php?d=tritonguild.com&source=6&epop=true',700,390);popunder('hfpu2','http://pop.WebFile.com/?epop=true',800,1000);sethomepage('http://WebFile.com/','tritonguild.com');">
<p><img border="0" src="/uniques.php?d=tritonguild.com" width="0" height="0" alt="" /></p>
</body>
</html>