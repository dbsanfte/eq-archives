...
<h2>The Ring FAQ - Revision 2004.01.10</h2>
...
a.)	A member of the "Rogue" class (Rogue, Rake, Blackguard, Assassin or Deceiver).<br>
...
c.)	Willing to meet with the server Warden within thirty (30) days of application to be verified of class and level.</p>
...
c. Warden(s) will confirm the rogue's status within thirty (30) days via in-game contact.<br>
...
<p>To enter The Root Cellar, use the current Root Cellar password contained within your original Ring registration confirmation email. If you've forgotten the password and no longer have the email, contact the Keeper of the Ring (shadowcross@thesafehouse.org) and we'll work something out.</p>
...
<p>The Keeper of the Ring is Shadowcross Bladesong (<a href="mailto:shadowcross@thesafehouse.org">Shadowcross@thesafehouse.org</a>)</p>
