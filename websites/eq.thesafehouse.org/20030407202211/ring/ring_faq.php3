...
<p>To enter The Root Cellar, use the current Root Cellar password contained within your original Ring registration confirmation email. If you've forgotten the password and no longer have the email, contact the Keeper of the Ring (glip@thesafehouse.org) and we'll work something out.</p>
