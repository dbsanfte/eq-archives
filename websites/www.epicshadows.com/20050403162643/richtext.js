...
function AddImage(rte) {
	...
	//oRTE.focus();*/
	window.open("addimg.cfm?rte="+rte,"addImage","toolbar=no,status=yes,scrollbars=yes,resizable=1,copyhistory=0,width=500,height=200"); 
}

//Function to process add image
function ProcessAddImage(rte,imagePath) {
	var oRTE;
	if (document.all) {
		oRTE = frames[rte];
