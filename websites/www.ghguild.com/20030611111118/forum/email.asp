...
<script language="JavaScript" src="js/resizeBody.js"></script>
...
if (opener==null || opener.closed){
	...
	setInterval("if (!(opener==null || opener.closed)) opener.location.reload();",1000*60*59)
}
  ...
  <form method="post" name="postform" onsubmit="return validateForm(this)">
	<tr> 
	  <td bgcolor="004580"> 
          ...
          <tr> 
            <td nowrap  bgcolor="dedede"  colspan="2" align="center" class="subhead">This function requires you to login as a qualified member first.<br><br></td>
          </tr>
