...
<body scroll="no" onload="document.postform.email.focus();"   style="margin:0px 0px 0px 0px">
<form method="post" action="lostpass.asp" onsubmit="return validateReg(this)" name="postform">
