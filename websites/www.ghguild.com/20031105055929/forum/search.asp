...
function checkIfAdvanced(){
	...
	if (theForm.advancedMatch.checked){
		theForm.fuzzyMatch.disabled = "true";
		theForm.criteria.disabled = "true";
	}else{
		theForm.fuzzyMatch.disabled = false;
		theForm.criteria.disabled = false;
	}
}
// -->
</script>
...
<body onload="if (document.sform) document.sform.phrase.focus();" >
...
<br><br>
  ...
  <tr>
	...
	<br><font color="ffffff">0.008</font><br>
