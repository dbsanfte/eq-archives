...
// -- End Hiding Here -->
	...
	<td width="100%" valign="top">
		...
		<td width=100% align="center" valign="top">
			<!-- MENU -->
			<table border="0" cellpadding="0" cellspacing="0">
			<tr><td width="69"><A HREF="/index.php?s=ca896dea65ec885c449e7b6df9e1de5f" onmouseover="imgOn('img1')" onmouseout="imgOff('img1')" ><img name="img1" border=0 SRC="/forums/images/layout/home.gif" width="69" height="26"></A></td>
			<td width="72"><A HREF="/forums/index.php?s=ca896dea65ec885c449e7b6df9e1de5f" onmouseover="imgOn('img2')" onmouseout="imgOff('img2')" ><img name="img2" border=0 SRC="/forums/images/layout/forum.gif" width="72" height="26"></A></td>
			<td width="73"><A HREF="/forums/usercp.php?s=ca896dea65ec885c449e7b6df9e1de5f" onmouseover="imgOn('img3')" onmouseout="imgOff('img3')" ><img name="img3" border=0 SRC="/forums/images/layout/usercp.gif"  width="73" height="26"></A></td>
			<td width="73"><A HREF="/forums/calendar.php?s=ca896dea65ec885c449e7b6df9e1de5f" onmouseover="imgOn('img4')" onmouseout="imgOff('img4')" ><img name="img4" border=0 SRC="/forums/images/layout/calendar.gif" width="73" height="26"></A></td>
			<td width="74"><A HREF="/forums/memberselect.php?s=ca896dea65ec885c449e7b6df9e1de5f" onmouseover="imgOn('img5')" onmouseout="imgOff('img5')" ><img name="img5" border=0 SRC="/forums/images/layout/members.gif" width="74" height="26"></A></td>
			<td width="72"><A HREF="/forums/misc.php?s=ca896dea65ec885c449e7b6df9e1de5f&action=faq" onmouseover="imgOn('img6')" onmouseout="imgOff('img6')" ><img name="img6" border=0 SRC="/forums/images/layout/faq.gif" width="72" height="26"></A></td>
			<td width="68"><A HREF="/forums/search.php?s=ca896dea65ec885c449e7b6df9e1de5f" onmouseover="imgOn('img7')" onmouseout="imgOff('img7')" ><img name="img7" border=0 SRC="/forums/images/layout/search.gif" width="68" height="26"></A></td>
			</tr></table>
		</td>
...
<input type="hidden" name="s" value="ca896dea65ec885c449e7b6df9e1de5f">
...
<tr>
	...
	<a href="register.php?s=ca896dea65ec885c449e7b6df9e1de5f&action=signup&who=coppa&url=index.php">this registration form</a>.</font></p>
...
Page generated in 0.16001701 seconds (62.09% PHP - 37.91% MySQL) with 7 queries.
</font></center>
<br>
