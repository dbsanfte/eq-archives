...
<head>
<title>Guardians of Veeshan - Gov WoW Application : Information</title>
...
<tr>
	<td class="alt1" width="100%">
			...
			<tr valign="bottom">
				...
				<td><span class="navbar"><a href="index.php?">Guardians of Veeshan</a></span> 
	<span class="navbar">&gt; <a href="joininfo.php?"> WoW Application</a></span>

</td>
			</tr>
			<tr>
				<td class="navbar" style="font-size:10pt; padding-top:1px" colspan="2"><a href="/forums/joininfo3.php"><img class="inlineimg" src="/forums/images/misc/navbits_finallink.gif" alt="Reload this Page" border="0" /></a> <strong>
	WoW Application Information
...
<tr>
	<td class="tcat" align="right">
		<span style="float:left">GoV Word of Warcraft Application Information</span>
	</td>
</tr>
<tr>
...
<p>Before you continue with the application we are going to need you to register with our webpage. The way applications are handled and to reduce phony applications we must have you register. Besides after you register you will also have access to take part in the discussions on our public forum.</p>

<p>Just a note before you go and register. You must have a valid email address because after you register the forum will send you an email with some activation codes or a link to follow. So it is very important that you use a valid email address. Don't worry your email is private and will never be given out.</p>

<p>Click on the register link in the top menu to register an account with the site. Once your done with that process come back here and there will be new instructions (must refresh page).</p>
