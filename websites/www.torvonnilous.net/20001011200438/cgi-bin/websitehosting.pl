<html>
 <head>
  <title>Torvonnilous.net - Free Web Space for Guilds on the Torvonnilous Server</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_green_01.jpg"><center><b>Free Web Space for Guilds on the Torvonnilous Server</td>
		</tr>
		<tr>
		 <td>                            
	                                   

  We are not giving out web space at this time in order to allow us to get caught up on all the previous requests for webspace.<br>
  <br>
  Please check back in about one week.<br>
  <br>
