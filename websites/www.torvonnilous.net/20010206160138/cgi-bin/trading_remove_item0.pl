<html>
 <head>
  <title>Torvonnilous.net - Remove Items from the Have/Want List</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_green_01.jpg"><center><b>Remove Items from the Have/Want List</td>
		</tr>
		<tr>
		 <td>                            
