<html>
 <head>
  <title>Torvonnilous.net - Submit Event</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_green_01.jpg"><center><b>Submit Event</td>
		</tr>
		<tr>
		 <td>                            
      ...
      <center>
        <form action="/cgi-bin/addarticle2.pl" method="post">
      <table border=0 cellspacing=3 cellpadding=0>
        <tr><td>Your Name</td>       <td><input type="text" name="submitter" size="40"></td></tr>
        <tr><td>Email*</td>       <td><input type="text" name="email" size="40"></td></tr>
        <tr><td>Name of Event</td><td><input type="text" name="title" size="40"></td></tr>
        <tr><td>Event Date</td>      
		    <td><select name="eventmonth">
			    <option>
        ...
        <tr><td>Start Time</td>      <td><input type="text" name="starttime" size="40"></td></tr>
        <tr><td>End Time</td>        <td><input type="text" name="endtime" size="40"></td></tr>
        <tr><td colspan=2><center>Description/Story</center><textarea name="article" cols=50 rows=10></textarea></td></tr>
