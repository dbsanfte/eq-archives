<html>
 <head>
  <title>Torvonnilous.net - Submit News</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_green_01.jpg"><center><b>Submit News</td>
		</tr>
		<tr>
		 <td>                            
      ...
      <table border=0 cellspacing=3 cellpadding=0>
        ...
        <tr><td>Article Title</td><td><input type="text" name="title" size="40"></td></tr>
        ...
        * Email address is optional, but if there is a problem with your message and you do not include an email address, the message will be discarded.<br>
		<br>
		If you are adding an Event, be sure to use <a href="/cgi-bin/addevent.pl">Submit Event</a>.  This screen is for adding news articles only.<br>
