<html>
 <head>
  <title>Torvonnilous.net - Submit Guild</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_green_01.jpg"><center><b>Submit Guild</td>
		</tr>
		<tr>
		 <td>                            
	                                   

        <center>Fill out the information below to have your guild added to the <a href="/cgi-bin/guilds.pl">Guilds</a> page.<br>
	    <br>
		</center>
		<font color="00dd00"><i>New!</i></font> To request a deletion or correction to your guild link, click <a href="mailto:Twygg@Torvonnilous.net?subject=GUILDLINK-CORRECTION">Here</a>.  Make sure the subject is "GUILDLINK-CORRECTION".  Previously, many request were being lost in the over-100-a-day message I receive.  Using the same Subject for all of them allows me to sort by Subject and fix them all at once.  Be sure to include clear details of the correction in your request.  Corrections will be made once a week.<br>
		<br>
		<center>
	    <form action="/cgi-bin/addguild2.pl" method="post">
        <table border=0 cellspacing=3 cellpadding=0>
          <tr><td>Guild Name</td>        <td><input type="text" name="guildname" size="40"></td></tr>
          <tr><td>URL</td>               <td><input type="text" name="url" size="40" value="http://"></td></tr>
          <tr><td></td>					 <td>Leave the field above <font color="00dd00"><b>empty</b></font> if your guild does not have a web site.</td></tr>
        ...
        Email address is optional, but if there is a problem with your message and you do not include an email address, the message will be discarded.<br>
		<br>
		<font color="00dd00">Warning!</font> Entering inappropriate information above can lead to immediate and permanent banning from both viewing and posting on this website.  Please you this site as it is intended to be used.  IP addresses are recorded with each submission.<br>
