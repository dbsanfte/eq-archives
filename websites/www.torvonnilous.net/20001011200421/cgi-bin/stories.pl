<html>
 <head>
  <title>Torvonnilous.net - Tales and Adventures</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_green_01.jpg"><center><b>Tales and Adventures</td>
		</tr>
		<tr>
		 <td>                            
	  	...
	  	<table>
		  <tr>
		    <td valign="top"><a href="/cgi-bin/stories_toc.pl?series=phoenix">The Phoenix Chronicles</a></td><td>The ongoing saga of The Order of the Phoenix, as seen through the eyes of Eshkin, their master tracker.  He recounts his life from childhood to the present, telling tales of adventure, romance, and sorrow.</td>
          </tr>
		  <tr>
		    <td valign="top"><a href="/cgi-bin/stories_toc.pl?series=dreamsofmagic">Dreams of Magic</a></td><td>Various tales involving the mysterious enchanter, Enhasa. Some are by people who know him, some are by long gone bards, and some are historical accounts taken from Heroes of the Age of Turmoil (often cited as the greatest source of biographies of that era).</td>
          </tr>
		...
		<br>
		<br>
		<a href="mailto:stories@Torvonnilous.net">Submit</a> your stories to have them displayed here!<br>
