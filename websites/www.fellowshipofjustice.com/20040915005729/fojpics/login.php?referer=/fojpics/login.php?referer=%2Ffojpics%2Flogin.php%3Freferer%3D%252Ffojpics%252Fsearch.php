...
<html dir="{lang_dir}">
<head>
<title>FoJ Picture Gallery - Login</title>
...
<table width="778" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td background="../fojpics/themes/hardwired/images/hw_04.gif" width=100% height=13px></td>
  </tr><tr>
...
<br>
	...
	<td width="35%" valign="bottom" align="right">
		<span class="gal_name">FoJ Picture Gallery</span></td>
	<td width=5%></td>
          </tr>
        </table>
      </td>
...
<!-- BEGIN login -->
                                        ...
                                        <td><img name="buttonleft" src="themes/hardwired/images/buttonleft.gif" width="17" height="25" border="0" id="buttonleft" alt="" /></td>
                                        <td background="themes/hardwired/images/buttoncenter.gif">
                                                <a href="login.php?referer=%2Ffojpics%2Flogin.php%3Freferer%3D%252Ffojpics%252Flogin.php%253Freferer%253D%25252Ffojpics%25252Flogin.php%25253Freferer%25253D%2525252Ffojpics%2525252Fsearch.php">Login</a>
                                        </td>
                                        <td><img name="buttonright" src="themes/hardwired/images/buttonright.gif" width="7" height="25" border="0" id="buttonright" alt="" /></td>
<!-- END login -->
...
<table align="center" width="600" cellspacing="1" cellpadding="0" class="maintable">
        <tr>
		  ...
		  <tr>
		    <form action="login.php?referer=%2Ffojpics%2Flogin.php%3Freferer%3D%252Ffojpics%252Flogin.php%253Freferer%253D%25252Ffojpics%25252Fsearch.php" method="post">
		  ...
		  <tr>
		    <td colspan="2" align="center" class="tablef"><input name="submitted" type="submit" class="button" value="Login"></td>
		    </form>
		  </tr>
</table>
<!-- End standard table -->
