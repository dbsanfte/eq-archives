...
4,						// Menu Item Padding
"http://www.eqguild.net/guilds/MysticalTravelers/Menu/arrow.gif",			// Sub Menu Image (Leave this blank if not needed)
,						// 3D Border & Separator bar
"66ffff",				// 3D High Color
"000066",				// 3D Low Color
"Purple",				// Current Page Item Font Color (leave this blank to disable)
"pink",					// Current Page Item Background Color (leave this blank to disable)
"http://www.eqguild.net/guilds/MysticalTravelers/Menu/arrowdn.gif",			// Top Bar image (Leave this blank to disable)
...
// function open_edit() {
	// window.open('http://www.MysticalTravelers.abc/cgi-bin/edit.pl', 'editnews', 'width=540,height=530,scrollbars=no');
	// return false;
// }
function open_roster() {
	window.open('http://www.eqguild.net/MysticalTravelers/cgi-bin/roster/db.cgi', 'roster', width=670,height=470,scrollbars=yes');
	return false;
 }
// function open_upload() {
	// window.open('http://www.MysticalTravelers.abc/upload.html', 'upload', 'width=480,height=500,scrollbars=no');
	// return false;
// }
// function open_chat() {
	// window.open('http://www.MysticalTravelers.abc/chat.html', 'chat', 'width=620,height=470,scrollbars=no');
	// return false;
// }
addmenu(menu=[		// This is the array that contains your menu properties and details
"mainmenu",			// Menu Name - This is needed in order for the menu to be called
280,					// Menu Top - The Top position of the menu in pixels
...
,					// Reserved for future use
,					// Reserved for future use
,"Home","http://www.eqguild.net/guilds/MysticalTravelers/index.html",,"Back to the home page",1 
// "Description Text", "URL", "Alternate URL", "Status", "Separator Bar"
,"Guild Documents","show-menu=guilddocs",,"",1
,"Guild Roster","show-menu=guildroster",,"",1
,"Guild Forums","http://www.eqguild.net/cgi-bin/forum/ikonboard.cgi?s=3d064c9206c9ffff;act=SC;c=39",,"",1
// ,"<a onclick=open_chat()>Guild Chat Program<\/a>","",,"",1
,"Calendar","http://www.eqguild.net/cgi-bin/calendar/calendar.pl?calendar=mysticaltravelers",,"",1
// ,"Gallery","http://www.eqguild.net/guilds/MysticalTravelers/index.html",,"",1
...
,"Miscellaneous","show-menu=misc",,"",1
	...
	,"Guild Charter","http://www.eqguild.net/guilds/MysticalTravelers/charter.html",,,1
	,"Guild Application","http://www.eqguild.net/guilds/MysticalTravelers/application.html",,,1
	])

	addmenu(menu=["guildroster",
	,,120,1,"",style1,,"left",effect,,,,,,,,,,,,
	,"View","http://www.eqguild.net/guilds/MysticalTravelers/cgi-bin/roster/db.cgi?db=default&uid=default&view_records=1&key=*&sb=3&so=descend",,,1
	...
	,"Reign Of Thunder","http://www.guildportal.com/guildHome.asp?GuildID=1768",,"",1
	,"                   ","http://www.eqguild.net/guilds/MysticalTravelers/",,"",1
	...
	,"                 ","http://www.2amstudios.com/eq/",,"",1
		...
		,"Wizard","show-menu=wizard",,"",1
			...
			addmenu(menu=["druid",
			,,150,1,"",style1,,"",effect,,,,,,,,,,,,
			,"Druid Pages", "http://www.eqdruids.com/",,,1
			])
	...
	,"Best Viewed with","show-menu=viewed",,"",1
		,"web site © 2002, Mistical Travelers","# type=header;align=center;",,,1
	])
		addmenu(menu=["credits",
		,,250,1,"",style1,,"left",effect,,,,,,,,,,,,
		,"Author: Dave Templeton (Bottin)<hr size=2>Special thanks to:<br>Bykken<br> For giving me this assignment<hr size=2>Created with: <A HREF=\"http://www.notepad.org\" target=_top>Notepad<\/A>","# type=header;align=center;",,,1
		])
		addmenu(menu=["viewed",
		,,250,1,"",style1,,"left",effect,,,,,,,,,,,,
