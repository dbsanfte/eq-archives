		...
		<tr>
			<td>
				...
				<div class="dynacontent">	
					---------------------------
				12/16/2002 <br>
					<A href="javascript: newWindow('http://www.divinesanction.com/event_details.cfm?event_id=87')">Alt Night NO Mains allowed<br>
					(click for info)</a> <br>
					---------------------------
					
					
				12/19/2002 <br>
					<A href="javascript: newWindow('http://www.divinesanction.com/event_details.cfm?event_id=88')">Legion 3 visits TOFS<br>
					(click for info)</a> <br>
					---------------------------
