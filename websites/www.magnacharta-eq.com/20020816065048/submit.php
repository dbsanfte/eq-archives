...
<table width="180" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr> 
      <td colspan="3" background="themes/Aqua/images/cadre/fond.gif"  align="left"  width="180" >
      <BR><B><FONT size=2 color=black><CENTER>There are currently, 9 guest(s) and 1 member(s) that are online.<br><br>You are Anonymous user. You can register for free by clicking <a href="user.php">here</a>.</center><BR></B></FONT>
      </td>
  </tr>
  <tr> 
    <td width="15" height="15" background="themes/Aqua/images/cadre/coininfg.gif"><img src="themes/Aqua/images/space15_15.gif" width="15" height="15"></td>
...
<font size=4><b>Nachricht absenden</b><font size=2><p><FORM action="submit.php" method=post><b>Ihr Name</b>  <font size=2>[ <a href="user.php">neuer Benutzer</a> ]</font>	<P><B>Titel</B>
	(Beschreibend, einfach und klar)<BR>
	<input class=textbox type="text" NAME="subject" SIZE=70 maxlength=80><BR><FONT size=2>(Schlechte Titel sind zum Beispiel <I>'Testen Sie das!'</I> oder <I>'Ein Artikel'</I>.)</FONT>
	<BR>
	<p><b>Thema</b> <SELECT class=textbox NAME=topic>
	<OPTION VALUE="">Thema ausw&auml;hlen</option>
<option  value="33">Fun News</option>
<option  value="35">Geschichten</option>
<option  value="32">Gilden Chronik</option>
<option  value="31">Magna Charta allgemein</option>
<option  value="30">Tibby</option>
<option  value="34">Zergling</option>
	</select>
	<P><B>Text</B>
	(Sie k&ouml;nnen HTML benutzen, aber stellen Sie sicher, da&szlig; alle HTML Tags und URLs im Text richtig sind!)<BR>
	<TEXTAREA class=textbox wrap=virtual cols=70 rows=12 name=story></TEXTAREA><BR>
	<FONT size=2>(Bitte noch einmal auf Rechtschreibfehler testen.)</FONT><P>
	<INPUT type=submit name=op value="Preview"> (Sie m&uuml;ssen sich erst eine Vorschau ansehen, bevor Sie den Artikel abschicken k&ouml;nnen)</FORM>
	</td></tr></table></td></tr></table>
</td></tr></table></td></tr></table>
    <center><font size=1>
