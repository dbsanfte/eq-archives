...
<img src=images/pix.gif border=0 width=180 height=1></td><td width=100% valign=top><table border=0 cellpadding=8><tr><td><font size=3><li> <a href="pollBooth.php?pollID=2">Findest Du, dass Mawe stinkt?</a> (<a href="pollBooth.php?op=results&pollID=2&mode=&order=&thold=">Ergebnisse</a> - 54 Stimmen)
<li> <a href="pollBooth.php?pollID=3">Möchtest Du lieber wieder die alte Homepage?</a> (<a href="pollBooth.php?op=results&pollID=3&mode=&order=&thold=">Ergebnisse</a> - 48 Stimmen)
<li> <a href="pollBooth.php?pollID=4">Wieviel Zeit verbringst Du täglich mit EQ?</a> (<a href="pollBooth.php?op=results&pollID=4&mode=&order=&thold=">Ergebnisse</a> - 72 Stimmen)
<li> <a href="pollBooth.php?pollID=5">Wie wichtig ist Dir Faction in EverQuest?</a> (<a href="pollBooth.php?op=results&pollID=5&mode=&order=&thold=">Ergebnisse</a> - 80 Stimmen)
<li> <a href="pollBooth.php?pollID=6">Welches Online-Rollenspiel wird für Dich EverQuest ablösen?</a> (<a href="pollBooth.php?op=results&pollID=6&mode=&order=&thold=">Ergebnisse</a> - 71 Stimmen)
<li> <a href="pollBooth.php?pollID=7">Gute Items...</a> (<a href="pollBooth.php?op=results&pollID=7&mode=&order=&thold=">Ergebnisse</a> - 80 Stimmen)
<li> <a href="pollBooth.php?pollID=8">Wer ist schuld?</a> (<a href="pollBooth.php?op=results&pollID=8&mode=&order=&thold=">Ergebnisse</a> - 28 Stimmen)
<li> <a href="pollBooth.php?pollID=9">Wie beurteilst Du die Veränderungen der Plaines (PoF/PoH) ?</a> (<a href="pollBooth.php?op=results&pollID=9&mode=&order=&thold=">Ergebnisse</a> - 71 Stimmen)
