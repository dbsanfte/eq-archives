...
Note: The only fields required are the username and password fields.<br> 
Unless you are a member of PD, you dont have a reason to register.
...
What timezone do you live in (EST, GMT etc)<BR>
<INPUT TYPE="Text" NAME="player_timezone" SIZE="15"><BR><BR>
<!--
<input type="Checkbox" name="logMeIn"> Log me in automaticly!<br><br>
-->
Paradigm password: (hint: same as the private messageboard.)<BR>
...
<font class="lightTxt">
<font color=white face=verdana size=1><b>Total hits: </b>73220
					</td>
				</tr>
			</table>
		</td>
