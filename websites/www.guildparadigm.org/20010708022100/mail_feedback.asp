...
<table width="80" border="0" cellspacing="2" cellpadding="0">
	...
	<td><font face="Verdana" size="1" color="#ffffff"><a class="lightLink" href="Javascript:sendVoteYes()">yes</a>&nbsp;</td>
		<td>
				...
				<tr>
					<td align="right">
						<table width="80" border="0" cellspacing="0" cellpadding="1" bgcolor="#ffffff">
							<tr>
								<td>
									<table width="86%" border="0" cellspacing="0" cellpadding="0" bgcolor="#1d2332">
										<tr>
			...
			<td><font face="Verdana" size="1" color="#ffffff">&nbsp;86.3%</td>
		</tr>
		<tr>
		...
		<tr>
					...
					<tr>
						<td align="right">
							<table width="80" border="0" cellspacing="0" cellpadding="1" bgcolor="#ffffff">
								<tr>
									<td>
										<table width="13%" border="0" cellspacing="0" cellpadding="0" bgcolor="#1d2332">
											<tr>
												<td><img src="/img/blank.gif" width=1 height=8 alt="" border="0"></td>
											</tr>
										</table>
			...
			<td><font face="Verdana" size="1" color="#ffffff">&nbsp;13.6%</td>
		</tr>
	</Tr>
</table>
...
<font class="lightTxt">
<font color=white face=verdana size=1><b>Total hits: </b>146806
					</td>
				</tr>
			</table>
		</td>
