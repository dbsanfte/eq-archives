...
<form action="polls_vote.asp" method="post" name="vote_yes" id="vote_yes">
	...
	<input type="Hidden" name="number" value="191">
</form>
...
<form action="polls_vote.asp" method="post" name="vote_no" id="vote_no">
	...
	<input type="Hidden" name="number" value="253">
</form>
			<b>Quick poll:</b><br>
			Should the level cap be raised?
...
<table width="80" border="0" cellspacing="2" cellpadding="0">
	...
	<td><font face="Verdana" size="1" color="#ffffff"><a class="lightLink" href="Javascript:sendVoteYes()">yes</a>&nbsp;</td>
		<td>
				...
				<tr>
					<td align="right">
						<table width="80" border="0" cellspacing="0" cellpadding="1" bgcolor="#ffffff">
							<tr>
								<td>
									<table width="42%" border="0" cellspacing="0" cellpadding="0" bgcolor="#1d2332">
										<tr>
			...
			<td><font face="Verdana" size="1" color="#ffffff">&nbsp;42.9%</td>
		</tr>
		<tr>
		...
		<tr>
					...
					<tr>
						<td align="right">
							<table width="80" border="0" cellspacing="0" cellpadding="1" bgcolor="#ffffff">
								<tr>
									<td>
										<table width="57%" border="0" cellspacing="0" cellpadding="0" bgcolor="#1d2332">
											<tr>
												<td><img src="/img/blank.gif" width=1 height=8 alt="" border="0"></td>
											</tr>
										</table>
			...
			<td><font face="Verdana" size="1" color="#ffffff">&nbsp;57.0%</td>
		</tr>
	</Tr>
</table>
...
<font class="lightTxt">
<font color=white face=verdana size=1><b>Total hits: </b>118571
					</td>
				</tr>
			</table>
		</td>
