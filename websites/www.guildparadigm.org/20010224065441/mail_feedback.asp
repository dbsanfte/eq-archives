...
Contact us about:<br>
Recruitment <input type="radio" name="contact" value="recruitment"> | Other <input type="radio" name="contact" value="other" checked><br><br>
...
<table width="80" border="0" cellspacing="2" cellpadding="0">
	...
	<td><font face="Verdana" size="1" color="#ffffff"><a class="lightLink" href="Javascript:sendVoteYes()">yes</a>&nbsp;</td>
		<td>
			...
			<td><font face="Verdana" size="1" color="#ffffff">&nbsp;67.9%</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><font face="Verdana" size="1" color="#ffffff">&nbsp;32.0%</td>
		</tr>
	</Tr>
</table>
...
<font class="lightTxt">
<font color=white face=verdana size=1><b>Total hits: </b>73222
					</td>
				</tr>
			</table>
		</td>
