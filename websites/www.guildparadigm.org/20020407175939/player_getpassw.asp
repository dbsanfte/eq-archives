...
If you have forgot your password just enter your username in the field below and a mail with your password will be sent to your email address. 
<br><BR>


<FORM ACTION="player_getpassw.asp" METHOD="POST">
Username:<BR>
...
<INPUT TYPE="Submit" VALUE="Submit!" class="formbutton">
		...
		<a href="setright.asp?action=off&url=/player_getpassw.asp?"><img src="/img/rbar_off.gif" width="14" height="14" border="0" alt="Hide the toolbar"></a>
			<table>
				<tr>
					<td width="10">&nbsp;</td>
...
<form action="polls_vote.asp" method="post" name="vote_yes" id="vote_yes">
	<input type="Hidden" name="url" value="/player_getpassw.asp?">
						...
						<BR><br>
							...
							<FORM ACTION="/player_login.asp" METHOD="POST">
								...
								Password<BR>
									...
									<input type="Hidden" name="urlStr" value="/player_getpassw.asp">
...
<font class="lightTxt">
<font color=white face=verdana size=1><b>Total hits: </b>289317
					</td>
				</tr>
			</table>
		</td>
