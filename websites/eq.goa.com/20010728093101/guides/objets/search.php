...
<tr bgcolor=#000000>
	<td><font face=Arial color=white size=3>&nbsp;&nbsp;<b>Equipement - <font size=2>8356 objets répertoriés</font><b></font></td>
</tr>
</table>
...
<form method="GET" action="/guides/objets/search.php">
...
<tr><th width=100>Classe</th>
<td class=rcell2>
<select name="classes">
<option value=""     >Quelconque
<option value="1"    >Guerrier
<option value="4"    >Paladin
<option value="8"    >Ranger
<option value="16"   >ShadowKnight
<option value="64"   >Moine
<option value="256"  >Voleur
<option value="128"  >Barde
<option value="2"    >Clerc
<option value="32"   >Druide
<option value="512"  >Shaman
<option value="1024" >Necromancien
<option value="2048" >Wizard
<option value="4096" >Magicien
<option value="8192" >Enchanteur
<option value="16384" >Beast Lord
...
<select name="races">
<option value="">Quelconque
<option value="1"    >Humain
<option value="2"    >Barbare
<option value="4"    >Erudit
<option value="8"    >Elfe Sylvain
<option value="16"   >Haut Elfe
<option value="32"   >Elfe Noir
<option value="64"   >Demi Elfe
<option value="128"  >Nain
<option value="256"  >Troll
<option value="512"  >Ogre
<option value="1024" >Hobbit
<option value="2048" >Gnome
<option value="4096" >Iksar
<option value="8192" >Vah Shir
</select>

</td>
</tr>
<tr>
<th>Texte</th><td class=rcell2><INPUT TYPE="text" NAME="name" MAXLENGTH=32 LENGTH="32" VALUE=""></td>
</tr>
</table>
...
<table border=0 width=100%>
<tr><th width=100>Emplacement</th>
<td class=rcell2>
<select name="slots">
<option value=""        >Quelconque
<option value="2"       >Oreilles
<option value="4"       >Tête
<option value="8"       >Visage
<option value="32"      >Cou
<option value="128"     >Bras
<option value="64"      >Epaules
<option value="1024"    >Poignets
<option value="4096"    >Mains
<option value="8192"    >Main Droite
<option value="16384"   >Main Gauche
<option value="32768"   >Doigts
<option value="131072"  >Buste
<option value="256"     >Dos
<option value="1048576" >Ceinture
<option value="262144"  >Jambes
<option value="524288"  >Pieds
<option value="2048"    >Jet
<option value="2097152" >Munitions
</select>

</td>
</tr>

<tr><th width=100>Composante</th>
<td class=rcell2>
<select name="composante">
<option value="">Quelconque
<option value="AC"   >Armure (AC)
<option value="STR_" >Force (STR)
<option value="STA_" >Vitalité (STA)
<option value="DEX_" >Dextérité (DEX)
<option value="AGI_" >Agilité (AGI)
<option value="INT_" >Intelligence (INT)
<option value="WIS_" >Sagesse (WIS)
<option value="CHA_" >Charisme (CHA)
<option value="RF"   >Résistance au Feu
<option value="RC"   >Résistance au Froid
<option value="RM"   >Résistance à la Magie
<option value="RP"   >Résistance au Poison
<option value="RD"   >Résistance à la Maladie
<option value="HP"   >Points de Vie
<option value="Mana" >Mana
<option value="LightLevel" >Lumière
</select>

</td>
</tr>

<tr><th width=100>Catégorie</th>
<td class=rcell2>
<select name="categorie">
<option value="">Quelconque
<option value="0"  >Tranchant à 1 main
<option value="1"  >Tranchant à 2 mains
<option value="2"  >Transperçant
<option value="35" >Transperçant à 2 mains
<option value="3"  >Contendant à 1 main
<option value="4"  >Contendant à 2 mains
<option value="5"  >Arc
<option value="7"  >Lancé (1)
<option value="19" >Lancé (2)
<option value="8"  >Bouclier
<option value="23" >Instrument à Vent
<option value="24" >Instrument à Cordes
<option value="25" >Instrument à Cuivre
<option value="26" >Instrument à Percussion
<option value="14" >Nourriture
<option value="15" >Boisson
<option value="21" >Potion
<option value="38" >Alcool
<option value="18" >Soin
<option value="16" >Source de Lumière
<option value="36" >Canne à Pêche
<option value="37" >Appat
<option value="29" >Joaillerie
<option value="33" >Clef (1)
<option value="39" >Clef (2)
<option value="20" >Parchemin
<option value="17" >Réactif
<option value="12" >Lockpick
<option value="27" >Flèches
<option value="34" >Pièces
<option value="40" >Boussole
<option value="42" >Fiole de Poison
<option value="10" >Armure
<option value="11" >Objet de quête
...
<table border=0 width=100%>
<tr><th valign=top width=100>Marqueurs</th>
<td class=rcell2>
<INPUT TYPE="checkbox" NAME="magic"  >MAGIC&nbsp;&nbsp;&nbsp;
<INPUT TYPE="checkbox" NAME="lore"   >LORE&nbsp;&nbsp;&nbsp;
<INPUT TYPE="checkbox" NAME="nodrop" >NODROP
</td>
</tr>
</table>
...
<br>
<div class=texte>Consultez la liste des derniers objets entrés dans la base sur <a href="/guides/objets/new.php">la page des nouveautés</a>.</div>
<br>
