...
<html>
<head>
	<title>Jeux Online - EverQuest</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<meta name="description" content="La plus grande Encyclopédie en français sur EverQuest">
	<meta name="keywords" content="Everquest, EQ, everquest, Luclin, Shadows of Luclin, Kunark, ruins of kunark, RoK, Velious, Scars of Velious, SoV, français, francophone, france, forums, RPG, MMORPG, JDR, actualité, nouvelles, news, norrath, verant, Verant, sony, aide, bestiaire, encyclopédie, guide, liens, Aradune, Gordon, Absor, board, message board, forum, discussion, communauté, débutant, races, classes, cartes, maps, sorts, spells, magie, spoiler, soluce, cheat, skills, quest, quêtes, beastlord, necromancer, enchanter, wizard, magician, cleric, shaman, druid, bard, vah shir, erudian, human, elf, iksar, hobbit, halflings, troll, ogre, dwarf, dark elf, gnome, barbarian, plane of sky, plane of fear, plane of hate, veeshan peak, sebilis, chardok, internet, multijoueurs, online, multi-joueurs">
...
<div align="center"><img src="/images/EQ-JOG.gif" alt="EverQuest - JeuxOnline"></div>
...
<tr>
	...
	<tr>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/guides/magie/liste.php?class=15" class="lien1">Beast Lord</a><br>		
...
<table border="0" align="center" width="95%" cellspacing="0">
  <tr bgcolor="black">
    <td><font face="Arial" color="white" size="3">&nbsp;&nbsp;<b>Equipement - Kit Résist</b></font></td>
  </tr>
</table>

<br>

<form method="GET" action="/guides/objets/resist.php">

<table width="95%" border="0" align="center" cellspacing="0" class="relief">
  <tr>
    <td valign="top" width="50%">
      ...
      <table border="0" width="100%" cellspacing="0">
        <tr>
          ...
          <td class="c2">
            <select name="classes" style="width: 100%;">
              ...
              <option value="1" >WAR - Guerrier</option>
              <option value="2" >CLR - Clerc</option>
              <option value="4" >PAL - Paladin</option>
              <option value="8" >RNG - Rôdeur</option>
              <option value="16" >SHD - Anti-Paladin</option>
              <option value="32" >DRU - Druide</option>
              <option value="64" >MNK - Moine</option>
              <option value="128" >BRD - Barde</option>
              <option value="256" >ROG - Voleur</option>
              <option value="512" >SHM - Chaman</option>
              <option value="1024" >NEC - Necromancien</option>
              <option value="2048" >WIZ - Sorcier</option>
              <option value="4096" >MAG - Magicien</option>
              <option value="8192" >ENC - Enchanteur</option>
        ...
        <tr>
          ...
          <td class="c2">
            <select name="races" style="width: 100%">
              <option value="">Quelconque</option>
              <option value="2" selected>HUM - Humain</option>
              <option value="4" selected>BAR - Barbare</option>
              <option value="8" selected>ERU - Erudien</option>
              <option value="16" selected>ELF - Elfe Sylvain</option>
              <option value="32" selected>HIE - Haut Elfe</option>
              <option value="64" selected>DEF - Elfe Noir</option>
              <option value="128" selected>HEF - Demi Elfe</option>
              <option value="256" selected>DWF - Nain</option>
              <option value="512" selected>TRL - Troll</option>
              <option value="1024" selected>OGR - Ogre</option>
              <option value="2048" selected>HLF - Hobbit</option>
              <option value="4096" selected>GNM - Gnome</option>
              <option value="8192" selected>IKS - Iksar</option>
              <option value="16384" selected>VSH - Vah Shir</option>
            </select>
          </td>
        </tr>
      </table>
    ...
    <td valign="top" width="50%">
      ...
      <table border="0" width="100%" cellspacing="0">
        <tr>
          <th class="c1" width="100">Emplacement</th>
          <td class="c2">
            <select name="slots" style="width: 100%">
              <option value="">Quelconque</option>
              <option value="2" >Oreilles</option>
              <option value="4" >Tête</option>
              <option value="8" >Visage</option>
              <option value="32" >Cou</option>
              <option value="128" >Bras</option>
              <option value="64" >Epaules</option>
              <option value="1024" >Poignets</option>
              <option value="4096" >Mains</option>
              <option value="8192" >Main Droite</option>
              <option value="16384" >Main Gauche</option>
              <option value="32768" >Doigts</option>
              <option value="131072" >Buste</option>
              <option value="256" >Dos</option>
              <option value="1048576" >Ceinture</option>
              <option value="262144" >Jambes</option>
              <option value="524288" >Pieds</option>
              <option value="2048" >Jet</option>
              <option value="2097152" >Munitions</option>
            </select>
          </td>
        </tr>
        <tr>
          <th width="100">Résistance</th>
          <td class="rcell2">
            <select name="resistance">
              <option value="ALL">Toutes</option>
              <option value="RF"   >Feu</option>
              <option value="RC"   >Froid</option>
              <option value="RM"   >Magie</option>
              <option value="RP"   >Poison</option>
              <option value="RD"   >Maladie</option>
            </select>
          </td>
        </tr>
      </table>
...
<div class="texte">
<img src="/lettrines/a.gif" align="left" alt="A">lors graine d'aventurier ! Un vent d'héroïsme ou d'inconscience te pousse à vouloir affronter les plus redoutables dragons de Norrath ? Il te faudra un équipement adapté pour résister à la puissante magie qu'ils emploient. Tu trouveras ici les objets qu'il te faut pour aborder ces défis dans les meilleures conditions. Bonne chance !
</div>
