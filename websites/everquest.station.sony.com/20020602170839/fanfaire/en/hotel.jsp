...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/hotel.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="center"> 
                                    <P class="bold">Join us for the Boston Fan 
                                      Faire! </P>
                                    <p class="bold"><a href="http://www.bostonparkplaza.com" class="bold2">Boston 
                                      Park Plaza Hotel</a></p>
                                    <p class="bold">64 Arlington St.</p>
                                    <p class="bold">Boston, MA 02116<br>
                                      Tel: 1-800-225-2008 </p>
                                    <p><span class="bold">Reservations can be 
                                      made now with the hotel by calling 1-800-225-2008. 
                                      If you tell them you are with the EverQuest 
                                      Fan Faire, you will get our group rate of 
                                      $100 per night.<br>
                                      <br>
                                      Make your reservations early, before the 
                                      rooms are all sold out!</span><br>
                                    </p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
