...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/winners_dallas_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="128,46,246,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/winners_dallas_de.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"><span class="bold">Liste 
                                      der Gewinner </span> </div>
                                    <p class="bold">LiveQuest<img src="screenshots/ff_dallas/article_images/Dsc00993.jpg" width="320" height="240" align="right"><br>
                                      <br>
                                      Server: Tarew Marr<br>
                                      Gilde: <a href="http://www.blackcompany.cc/" target="_blank" class="bold2">Black 
                                      Company </a></p>
                                    <p class="bold">Citaria (Gildenf&uuml;hrer)<br>
                                      Lujan <br>
                                      Tierra<br>
                                      Rennol<br>
                                      Hakeshar<br>
                                      ...
                                      *Arnaxus<br>
                                      **Vaslin</p>
                                    <p class="bold">*Arnaxus war ein zus&auml;tzliches 
                                      Mitglied im Team und ist derzeit ohne Gildenzugeh&ouml;rigkeit.<br>
                                      **Vaslin vom <a href="http://www.thesafehouse.org/" target="_blank" class="bold2">Safehouse</a> 
                                      war ein zus&auml;tzliches Mitglied im Team, 
                                      ist aber kein Mitglied der Black Company-Gilde.</p>
                                    <p><span class="bold"><br>
                                      <br>
                                      GeForce 3-Videokarte von <a href="http://www.pny.com/home/products/vcard_index.cfm" target="_blank" class="bold2">PNY 
                                      </a><br>
                                      <br>
                                      Charnas<br>
                                      Souls Forged<br>
