...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>92109 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="../de/images/faqhead.gif" width="103" height="49">
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="left"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      <span class="bold3">Was ist eine Fanmesse?</span><span class="bold"><br>
                                      Die EverQuest-Fanmesse ist ein von Verant 
                                      gesponsertes Ereignis, das Spielern die 
                                      M&ouml;glichkeit geben soll, sich nicht 
                                      nur untereinander zu treffen, sondern auch 
                                      zahlreiche der bekannteren Verant-Pers&ouml;nlichkeiten 
                                      kennenzulernen. Auf jeden Fall ist es eine 
                                      tolle Gelegenheit, den Online-Verk&ouml;rperungen 
                                      ein Gesicht und eine wirkliche Person zu 
                                      geben. Obwohl die Anwesenden dabei viel 
                                      Zeit haben, sich untereinander zu mischen 
                                      und neue Freundschaften zu schlie&szlig;en, 
                                      wird ihnen auch die Gelegenheit gegeben, 
                                      an einer bestimmten Anzahl von Podiumsdiskussionen 
                                      und spielbezogenen Live-Veranstaltungen 
                                      teilzunehmen.</span></b></font> 
                                      <p></p>
                                      <p class="bold"><span class="bold3">Wo und 
                                        wann werden Fanmessen veranstaltet?</span><br>
                                        Fanmessen werden an verschiedenen Orten 
                                        abgehalten und finden alle 3-4 Monate 
                                        statt. Wir versuchen, Veranstaltungsorte 
                                        auszuw&auml;hlen, die f&uuml;r so viele 
                                        Spieler wie m&ouml;glich g&uuml;nstig 
                                        sind. Zur Zeit ist es unser Ziel, in den USA j&auml;hrlich mindestens eine Fanmesse an den Ost- und Westk&uuml;sten, als auch 
                                        an einem zentralgelegenen Ort abzuhalten. 
                                        Von Zeit zu Zeit kann es sein, dass wir 
                                        Sie bei Umfragen auf dieser Website darum 
                                        bitten, zuk&uuml;nftige Orte f&uuml;r 
                                        Fanmessen anzugeben.<br>
                                        <br>
                                        <span class="bold3">Was erhalte ich f&uuml;r 
                                        meine Registrierungsgeb&uuml;hr?</span><br>
                                        Sie werden am Freitag an einem privaten 
                                        Empfang mit anderen Spielern teilnehmen. 
                                        Am Samstag k&ouml;nnen Sie Verant-Repr&auml;sentanten 
                                        treffen. Es finden Wettbewerbe und Verlosungen 
                                        statt bei denen Preise vergeben werden 
                                        und Sie k&ouml;nnen Podiumsdiskussionen 
                                        mit EQ-Repr&auml;sentanten beiwohnen. 
                                        Sie erhalten auch ein in limitierter Auflage 
                                        hergestelltes T-Shirt. Au&szlig;erdem 
                                        k&ouml;nnen Sie die einzigartige Erfahrung 
                                        machen Hunderte Einwohner von Norrath 
                                        zu treffen! <br>
                                      </p>
                                      <p class="bold"><span class="bold3">Ich 
                                        schaffe es nicht rechtzeitig f&uuml;r 
                                        die fr&uuml;he Registrierung. Kann ich 
                                        meinen Spielerausweis auch noch erhalten 
                                        wenn ich ankomme?</span><br>
                                        Ja, melden Sie sich bitte sobald Sie ankommen. 
                                      </p>
                                      <p class="bold"><span class="bold3">K&ouml;nnen 
                                        Kinder der Veranstaltung beiwohnen? </span><br>
                                        Kinder k&ouml;nnen der Veranstaltung beiwohnen, 
                                        doch alle Minderj&auml;hrigen m&uuml;ssen 
                                        von einem Erwachsenen begleitet werden. 
                                        Der Preis f&uuml;r Kinder ist derselbe 
                                        wie f&uuml;r die Erwachsenen. </p>
                                      <p class="bold"><span class="bold3">Meine 
                                        Frau und ich spielen beide EverQuest. 
                                        Sollten wir einen von uns als Gast angeben?</span><br>
                                        Nein. Ein Gast ist jemand, der nicht EverQuest 
                                        spielt. Jeder Spieler sollte sich individuell 
                                        registrieren lassen, um seinen pers&ouml;nlichen 
                                        Spielerausweis zu erhalten.</p>
                                      <p class="bold"><span class="bold3">Meine 
                                        Frau spielt nicht EverQuest, m&ouml;chte 
                                        mich jedoch begleiten. Wie ist der Tarif 
                                        f&uuml;r diejenigen, die keine EQ-Spieler 
                                        sind? </span><br>
                                        Der Tarif f&uuml;r diejenigen, die nicht 
                                        EverQuest spielen, ist derselbe wie f&uuml;r 
                                        die Spieler. Wir m&uuml;ssen noch immer 
                                        alle unsere Ausgaben f&uuml;r alle Anwesenden 
                                        bestreiten. Geben Sie sie einfach nur 
                                        in dem Registrierungsformular als G&auml;ste 
                                        an. </p>
                                      <p class="bold"><span class="bold3">Wie 
                                        l&auml;uft das mit meiner Hotelunterkunft?</span> 
                                        <br>
                                        Sie sind selber f&uuml;r Ihre Hotel- und 
                                        Reisevorkehrungen verantwortlich. Selbstverst&auml;ndlich 
                                        k&ouml;nnen Sie von den Spezialtarifen 
                                        profitieren, die wir mit dem Gastgeberhotel 
                                        f&uuml;r unsere Gruppe vereinbart haben. 
                                      </p>
                                      <p class="bold"><span class="bold3">Welche 
                                        Art von Preisen wird bei den Verlosungen 
                                        vergeben? </span><br>
                                        Bei den Wettbewerben werden Sie spieleigene 
                                        Sch&auml;tze gewinnen k&ouml;nnen! Falls 
                                        Sie zu den Siegern geh&ouml;ren, werden 
                                        Sie mit einem Gegenstand belohnt, den 
                                        Sie nur bei einer offiziellen Fanmesse 
                                        erlangen k&ouml;nnen!</p>
                                      <p class="bold"><span class="bold3">Ich 
                                        muss meine Reservation absagen. Kann ich 
                                        mir meine Ausgaben zur&uuml;ckerstatten 
                                        lassen?</span><br>
                                        R&uuml;ckerstattungen sind nur bis zum 
                                        Endtermin der Registrierung m&ouml;glich.</p>
                                      <p class="bold"><span class="bold3"><br>
                                        Ich bin ein Guide. Soll ich mich unter 
                                        meinem Guidenamen oder meinem Spielernamen 
                                        registrieren lassen? </span><br>
                                        Bitte schauen Sie f&uuml;r Informationen 
                                        zu diesem Thema immer mal wieder auf der 
                                        Guide-Webseite nach. </p>
                                      <p align="center"><span class="bold"><br>
                                        Falls Sie weitere Fragen haben sollten, schicken Sie uns bitte eine E-Mail an</span><br>
                                        <a href="mailto:fanfaire@station.sony.com" class="bold3">fanfaire@station.sony.com</a> 
                                      </p>
                                      <br>
                                    </div>
                                    <div align="left"></div>
