...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_sanfran_photos.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_sanfran_photos.jsp');">
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr> 
                      <td valign=top> <center>
                          <p><a href="screenshots/sanfran/screenshots.jsp?id=Chaos2" onClick="MM_openBrWindow('screenshots/sanfran/screenshots.jsp?id=Chaos2','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/sanfran/thumbs/Chaos2.jpg" width="200" height="133" border="0"></a><br>
                          </p>
                          <br>
                        </center></td>
                      <td> <center>
                          <p><a href="screenshots/sanfran/screenshots.jsp?id=Intel-GiveAway1" onClick="MM_openBrWindow('screenshots/sanfran/screenshots.jsp?id=Intel-GiveAway1','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/sanfran/thumbs/Intel-GiveAway1.jpg" width="200" height="133" border="0"></a><br>
                          </p>
                          <br>
                        </center></td>
                    </tr>
                    <tr> 
                      <td> <center>
                          <p><a href="screenshots/sanfran/screenshots.jsp?id=Intel-GiveAway2" onClick="MM_openBrWindow('screenshots/sanfran/screenshots.jsp?id=Intel-GiveAway2','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/sanfran/thumbs/Intel-GiveAway2.jpg" width="200" height="133" border="0"></a><br>
                          </p>
                          <br>
                        </center></td>
                      <td valign=top> <center>
                          <p><a href="screenshots/sanfran/screenshots.jsp?id=Metreon" onClick="MM_openBrWindow('screenshots/sanfran/screenshots.jsp?id=Metreon','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/sanfran/thumbs/Metreon.jpg" width="200" height="133" border="0"></a><br>
                          </p>
                          <br>
                        </center></td>
                    </tr>
                    <tr> 
                      <td> <div align="center"> 
                          <p><a href="screenshots/sanfran/screenshots.jsp?id=Panel1" onClick="MM_openBrWindow('screenshots/sanfran/screenshots.jsp?id=Panel1','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/sanfran/thumbs/Panel1.jpg" width="200" height="133" border="0"></a><br>
                          </p>
                          <br>
                        </div></td>
                      <td valign=top> <center>
                          <p><a href="screenshots/sanfran/screenshots.jsp?id=Panel-Audience" onClick="MM_openBrWindow('screenshots/sanfran/screenshots.jsp?id=Panel-Audience','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/sanfran/thumbs/Panel-Audience.jpg" width="200" height="133" border="0"></a><br>
                          </p>
                          <br>
                        </center></td>
                    </tr>
