...
<html><!-- #BeginTemplate "/Templates/indexpage_esp.dwt" -->
<head>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/index_esp.jsp?null');">
              ...
              <tr>
                ...
                <td width="161">
                  ...
                  <table width="156" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td> 
                  <div align="center"><a href="http://www.station.sony.com/everquest" onMouseOut="MM_swapImgRestore();nd()" onMouseOver="MM_swapImage('Image13','','images/backtoeq_on.gif',1);return overlib('Esto te devolver&aacute; auna p&aacute;gina en ingles.')"><img name="Image13" border="0" src="images/backtoeq_off.gif" width="115" height="11"></a></div>
                      </td>
                    </tr>
                  </table>
                </td>
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          <td width="398" valign="top">
            <div align="center"> 
              <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/fanfaire.jpg" width="228" height="213" align="top" vspace="7"><br>
                <br>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            <div align="center" class="bold">
              <p>La inscripci&oacute;n para Fan Faire ya termin&oacute;</p>
              <p><br>
                La inscripci&oacute;n para Fan Faire de Seattle que se llevar&aacute; 
                a cabo el 19 de abril ya ha terminado. Esperamos ver a todos en 
                este evento, &iexcl;que estar&aacute; totalmente lleno </p>
            </div>
