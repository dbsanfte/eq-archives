...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/faq_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/faq_fr.jsp');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/faqhead.gif" width="103" height="49"> <br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div 
align="justify"> 
                                      <p class="bold"><span class="bold3">O&ugrave; 
                                        ont lieu les Fan Faires et quand ? </span><br>
                                        Les Fan Faires sont organis&eacute;es 
                                        dans divers lieux, tous les 3 &agrave; 
                                        4 mois. Nous essayons de choisir des lieux 
                                        qui pourront recevoir autant de joueurs 
                                        que possible. Notre objectif actuel est 
                                        d'organiser au moins 1 Fan Faire par an 
                                        sur les c&ocirc;tes Est et Ouest et dans 
                                        le centre des &Eacute;tats-Unis. Il peut 
                                        arriver que nous sollicitions votre avis 
                                        sur l'emplacement des futures Fan Faires, 
                                        au moyen d'un vote sur ce site. </p>
                                      <p class="bold"><span class="bold3">&Agrave; 
                                        quoi ai-je droit en contrepartie de mes 
                                        frais de participation ? </span><br>
                                        Vous assisterez &agrave; une r&eacute;ception 
                                        priv&eacute;e avec les autres joueurs 
                                        le Vendredi soir. Puis, le Samedi, vous 
                                        pourrez rencontrer des repr&eacute;sentants 
                                        de Verant. Il y aura des concours et des 
                                        tirages au sort r&eacute;compens&eacute;s 
                                        par des prix. Vous pourrez participer 
                                        &agrave; des d&eacute;bats avec les repr&eacute;sentants 
                                        de EQ. Vous recevrez un T-Shirt en tirage 
                                        limit&eacute; et serez l'h&ocirc;te du 
                                        d&icirc;ner du Samedi soir. Vous aurez 
                                        ainsi la chance de rencontrer des centaines 
                                        d'autres citoyens de Norrath ! </p>
                                      <p class="bold"><span class="bold3">Je ne 
                                        peux &ecirc;tre sur place pour la pr&eacute;-inscription. 
                                        Est-ce que je peux quand m&ecirc;me recevoir 
                                        mon Player Passport et entrer &agrave; 
                                        mon arriv&eacute;e ?</span><br>
                                        Oui... il vous suffit de passer au comptoir 
                                        d'enregistrement &agrave; votre arriv&eacute;e. 
                                      </p>
                                      <p class="bold"><span class="bold3">Les 
                                        enfants peuvent-ils assister au rassemblement 
                                        ? </span><br>
                                        Les enfants peuvent assister &agrave; 
                                        ce rassemblement, mais tous les mineurs 
                                        doivent &ecirc;tre accompagn&eacute;s 
                                        par un adulte. Les frais de participation 
                                        sont les m&ecirc;mes que pour les adultes. 
                                      </p>
                                      <p class="bold"><span class="bold3">Ma femme 
                                        et moi jouons tous les deux &agrave; EQ. 
                                        Est-ce que l'un de nous doit &ecirc;tre 
                                        inscrit comme invit&eacute; ?</span><br>
                                        Non. Un invit&eacute; est quelqu'un qui 
                                        ne joue pas &agrave; EQ. Chaque joueur 
                                        doit s'inscrire individuellement pour 
                                        obtenir son Player Passport personnalis&eacute;.</p>
                                      <p class="bold"><span class="bold3">Ma femme 
                                        ne joue pas &agrave; EQ mais veut m'accompagner. 
                                        Quels sont les frais de participation 
                                        pour quelqu'un qui ne joue pas ? </span><br>
                                        Les frais pour quelqu'un qui ne joue pas 
                                        sont identiques &agrave; ceux pay&eacute;s 
                                        par un joueur. Nous devons rentrer dans 
                                        nos frais pour tous les participants au 
                                        rassemblement. Il suffit de mentionner 
                                        vos invit&eacute;s sur le formulaire d'enregistrement. 
                                      </p>
                                      <p class="bold"><span class="bold3">Avez-vous 
                                        des renseignements sur l'h&eacute;bergement 
                                        ? </span><br>
                                        Vous devez organiser vous-m&ecirc;me votre 
                                        transport et votre h&eacute;bergement. 
                                        Vous pouvez &eacute;ventuellement profiter 
                                        des dispositions prises avec l'h&ocirc;tel 
                                        qui h&eacute;berge notre groupe.</p>
                                      <!--<p class="bold"><span class="bold3">Quels 
                                        sont les types de prix offerts aux gagnants 
                                        des concours ? </span><br>
                                        Les r&eacute;compenses pour ce concours 
                                        vont &ecirc;tre de v&eacute;ritables artefacts 
                                        existant dans le jeu ! Si vous avez la 
                                        chance d'&ecirc;tre parmi les vainqueurs, 
                                        vous gagnerez un prix qui ne peut &ecirc;tre 
                                        obtenu que lors d'une Fan Faire Officielle 
                                        !</p>-->
                                      <p class="bold"><span class="bold3">Comment annuler mon inscription ? Puis-je me faire rembourser ?</span><br>
                                        Les frais de participation peuvent &ecirc;tre 
                                        rembours&eacute;s jusqu'&agrave; la date 
                                        limite d'inscription.</p>
                                      <p class="bold"><span class="bold3">Je suis 
                                        un guide. Est-ce que je m'inscris sous 
                                        mon nom de guide ou sous mon nom de joueur 
                                        ? </span><br>
                                        Pour annuler votre inscription, veuillez 
                                        envoyer votre demande par courrier électronique 
                                        à <a href="mailto:carchuleta@soe.sony.com" class="bold3">carchuleta@soe.sony.com</a>. 
                                        Veillez à y indiquer votre nom station. 
                                        Les remboursements ne seront acceptés 
                                        que jusqu'à la clôture des inscriptions.</p>
                                      <p class="bold">Si vous vous posez d'autres 
                                        questions, envoyez un email &agrave; l'adresse 
                                        <a href="mailto:carchuleta@soe.sony.com" class="bold3">carchuleta@soe.sony.com</a><br>
                                      </p>
                                      <br>
                                    </div>
                                    <!-- #EndEditable --></td>
