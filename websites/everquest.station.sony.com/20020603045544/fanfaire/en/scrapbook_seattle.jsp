...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_seattle.jsp?null');">
                    ...
                    <tr> 
                      <td> 
                        <table width="151" border="0" cellspacing="0" cellpadding="0" background="">
                          ...
                          <tr> 
                            <td><a href="info.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../images/diamond_on.gif',1)"><img name="Image4" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">General 
                              Info</span></a></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td><a href="hotel.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../images/diamond_on.gif',1)"><img name="Image6" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Hotel 
                              Info</span></a></td>
                          </tr>
                          <tr> 
                            <td><a href="event.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','../images/diamond_on.gif',1)"><img name="Image7" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Event 
                              Schedule</span></a></td>
                          </tr>
                          <tr> 
                            <td><a href="sponsors.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','../images/diamond_on.gif',1)"><img name="Image8" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Sponsors 
                              and &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vendors</span></a></td>
                          </tr>
                          <tr> 
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      ...
                                      <p align="justify"><a href="report_seattle.jsp" class="bold2">The 
                                        Mennix Report</a><span class="bold"> - 
                                        In his own unique way, Mennix fills everyone 
                                        in on his impressions of the Seattle Fan 
                                        Faire.</span></p>
                                      <p align="justify"><a href="winners_seattle.jsp" class="bold2">List 
                                        of Winners</a><span class="bold"> - Join 
                                        us in congratulating a big list of winners 
                                        for this Fan Faire. Kudos to Team Rathe 
                                        1 for their Live Quest Victory.</span></p>
                                      <p align="center" ><b><font color="#000000" size="3"><a href="scrapbook_seattle_photos.jsp" target="_top" class="bold2"><font size="3">Photo 
