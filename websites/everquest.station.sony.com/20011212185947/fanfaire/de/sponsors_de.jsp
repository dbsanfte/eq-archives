...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>51401 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->                                    
                                    <div align="center" class="bold">Herzlichen 
                                      Dank unseren Sponsoren und Verk&auml;ufern, 
                                      welche der Fanmesse in Dallas beiwohnten 
                                      sowie herzlichen Dank an alle die dort waren 
                                      und sich die Waren angesehen haben </div>
                                    <center>
                                      <br>
...
target="_blank" class="bold2">Keith Parkinson</a> </font><br>
                                        <br>
