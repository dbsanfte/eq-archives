...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="75%" border="0" cellspacing="0" cellpadding="8">
        <tr align="center">
          <td colspan="2" align="center">
            <font color="#FFFFFF"><font face="Verdana, Arial, Helvetica, sans-serif"><font size="-2">8/3/01<br>
            <form name="form1">
  <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
    ...
    <option value="screenshots_042301.jsp">April 23, 2001</option>
        ...
        <tr>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/01.html','640')"><img src="screenshots/080301/EQ000017_lo.jpg" width="200" height="160" border="0"></a></td>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/02.html','640')"><img src="screenshots/080301/EQ000024_lo.jpg" width="200" height="160" border="0"></a></td>
        </tr>
        <tr>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/03.html','640')"><img src="screenshots/080301/EQ000025_lo.jpg" width="200" height="160" border="0"></a></td>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/04.html','640')"><img src="screenshots/080301/EQ000034_lo.jpg" width="200" height="160" border="0"></a></td>
        </tr>
        <tr>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/05.html','640')"><img src="screenshots/080301/EQ000038_lo.jpg" width="200" height="160" border="0"></a></td>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/06.html','640')"><img src="screenshots/080301/EQ000040_lo.jpg" width="200" height="160" border="0"></a></td>
        </tr>
        <tr>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/07.html','640')"><img src="screenshots/080301/EQ000043_lo.jpg" width="200" height="160" border="0"></a></td>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/080301/08.html','640')"><img src="screenshots/080301/EQ000044_lo.jpg" width="200" height="160" border="0"></a></td>
        </tr>
        <tr align="center">
          <td colspan="2" align="center"><a href="javascript:openWindow('screenshots/080301/09.html','640')"><img src="screenshots/080301/EQ000050_lo.jpg" width="200" height="160" border="0"></a></td>
        </tr>
      </table>
      <p>&nbsp;</p>
    </td>
