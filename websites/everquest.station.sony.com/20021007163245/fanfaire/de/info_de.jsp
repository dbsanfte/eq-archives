...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/info_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="128,46,246,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/info_de.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="left"><br>
                                      <span class="bold">Die EverQuest-Fanmesse 
                                      ist ein Real Life-Gesellschaftsereignis, 
                                      das mehrmals j&auml;hrlich in verschiedenen 
                                      Regionen und zwar &uuml;ber das gesamte 
                                      Land verteilt stattfindet. Die Fanmesse 
                                      ist dazu bestimmt, EverQuest-Spielern die 
                                      M&ouml;glichkeit zu bieten, Gleichgesinnte 
                                      in einer spa&szlig;igen Umgebung zu treffen 
                                      und sich mit verschiedenen SOE-Angestellten 
                                      unter das Volk zu mischen. Obwohl das gegenseitige 
                                      Kennenlernen und somit das Schlie&szlig;en 
                                      von Freundschaften wohl im Vordergrund steht, 
                                      werden Sie &uuml;berdies die Gelegenheit 
                                      haben, zahlreichen Podiumsdiskussionen und 
                                      spielbezogenen Live-Veranstaltungen beizuwohnen. 
                                      Bei vergangenen Veranstaltungen wurden Live 
                                      Quests mit Freiwilligen veranstaltet, die 
                                      verschiedene NPCs darstellten und R&auml;tsel 
                                      sowie Aufgaben an die Teilnehmer stellten. 
                                      Ebenso wurde es erm&ouml;glicht, den Ablauf 
                                      einer gegenw&auml;rtigen In-Game-Veranstaltung 
                                      zu verfolgen, die auf einen gro&szlig;en 
                                      Bildschirm projiziert wurde. Jede weitere 
                                      Messe scheint noch gr&ouml;&szlig;er und 
                                      besser zu werden. Was die Zukunft wohl mit 
                                      sich bringen wird, wer wei&szlig; das schon?<br>
                                      </span> 
                                    <p align="left">&nbsp; 
                                    <p align="left"><span class="bold"> </span> 
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
