...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>34828 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" --> 
                        <div align="center"><br>
                          <font COLOR="#0851A0" size=6><b>Enregistrement terminé 
                          </b></font> </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="left"><span class="bold">Bonjour 
                                      &agrave; tous, </span> </div>
                                    <p class="bold" align="left">Sony Online Entertainment 
                                      et Ubi Soft ont annonc&eacute; aujourd'hui 
                                      le report de la Fan Faire europ&eacute;enne. 
                                      <br>
                                      La communaut&eacute; europ&eacute;enne de 
                                      joueurs d'EverQuest&reg; a connu une r&eacute;elle 
                                      croissance tout au long de l'ann&eacute;e. 
                                      Nous sommes vraiment tr&egrave;s heureux 
                                      de toutes les initiatives qui nous pourrons 
                                      prendre sur ce continent et ailleurs.<br>
                                      Bien que nous soyons oblig&eacute;s de reporter 
                                      un &eacute;v&eacute;nement qui a &eacute;t&eacute; 
                                      un tel succ&egrave;s aux &Eacute;tats-Unis, 
                                      nous savons que tous nos projets internationaux 
                                      ne feront qu'&eacute;largir les exp&eacute;riences 
                                      des joueurs, accro&icirc;tre le nombre de 
                                      fans et nous conduire vers de nouveaux continents 
                                      dans les mois &agrave; venir.</p>
                                    <p class="bold" align="left">Nous souhaitons 
                                      remercier tous les fans qui avaient pr&eacute;vu 
                                      de participer &agrave; cet &eacute;v&eacute;nement. 
                                      Nous leur retournerons dans les plus brefs 
                                      d&eacute;lais le remboursement de leur r&eacute;servation 
                                      accompagn&eacute; d'un cadeau de la part 
                                      de toute l'&eacute;quipe de la Fan Faire. 
                                      <br>
                                      Bien que nous soyons d&eacute;&ccedil;us 
                                      de ne pas pouvoir vous rencontrer le mois 
                                      prochain, nous esp&eacute;rons que notre 
                                      pr&eacute;sence continuera de cro&icirc;tre 
                                      en Europe. Nous sommes d&eacute;sol&eacute;s 
                                      pour ce contre temps mais gr&acirc;ce au 
                                      report de cet &eacute;v&eacute;nement &agrave; 
                                      une date ult&eacute;rieure, nous serons 
                                      en mesure de mieux vous servir. </p>
                                    <p class="bold" align="left">EverQuest est 
                                      fier de ses 410.000 joueurs bas&eacute;s 
                                      autour du monde y compris en Angleterre, 
                                      France, Italie, Allemagne, Canada, Singapore, 
                                      Zimbabwe, Arabie Saoudite, Nouvelle Z&eacute;lande 
                                      et USA. Nous avons r&eacute;cemment annonc&eacute; 
                                      la sortie internationale des &quot;Game 
                                      Cards&quot;, donnant la possibilit&eacute; 
                                      aux d&eacute;tenteurs de liquidit&eacute; 
                                      de jouer 90 jours.<br>
                                      De plus, la phase initiale de la localisation 
                                      mettant en sc&egrave;ne des ressources humaines 
                                      et des traducteurs automatiques, en commen&ccedil;ant 
                                      par le fran&ccedil;ais, l'allemand, le japonais 
                                      et le cor&eacute;en, suit son cours. Sony 
                                      Online Entertainment continue de construire 
                                      des liens entre les nations et travaille 
                                      activement au d&eacute;ploiement de serveurs 
                                      en Europe.</p>
                                    <p class="bold" align="left">Durant l'hiver, 
                                      les joueurs d'EverQuest pourront suivre 
                                      le lancement de &quot;EverQuest: The Shadows 
                                      of Luclin&quot;. Ce nouvel add-on vous emm&egrave;nera 
                                      vers des paysages lunaires, de nouvelles 
                                      r&eacute;gions, de nouveaux objets, cr&eacute;atures, 
                                      une nouvelle race de personnage &agrave; 
                                      s'offrir. </p>
                                    <p class="bold" align="left">Merci pour votre 
                                      soutien toujours actif !</p>
                                    <p class="bold" align="left">Cindy Archuleta</p>
                                    <p class="bold" align="left">Responsable Relations 
                                      de la Communaut&eacute; </p>
                                    <p align="left"><span class="bold">Sony Online 
