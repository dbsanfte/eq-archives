...
<html><!-- #BeginTemplate "/Templates/indexpage_fr.dwt" -->
<head>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/index_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/index_fr.jsp');">
        ...
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            <table width="100%" border="0">
              <tr>
                <td valign="top"> 
                  <P class="bold" align="center">Merci pour votre participation 
                    &agrave; la Fan Faire de Seattle. N'h&eacute;sitez pas &agrave; 
                    revenir sur cette page pour obtenir des informations concernant 
                    les futures Fan Faires.</P>
                  </td>
              </tr>
            </table>
