...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>88134 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
...
align="justify"> 
                                      ...
                                      <p class="bold"><span class="bold3">Quels 
                                        ...
                                        !</p>
                                      <p class="bold"><span class="bold3">Je dois 
                                        annuler mes projets. Est-ce que je peux 
                                        &ecirc;tre rembours&eacute; ?</span><br>
                                      ...
                                      <p class="bold"><span class="bold3">Je suis 
                                        ...
                                        ? </span><br>
                                        Le Forum des guides affichera r&eacute;guli&egrave;rement 
                                        des informations sur ce sujet. </p>
                                      <p class="bold">Si vous vous posez d'autres 
                                        questions, envoyez un email &agrave; l'adresse 
                                        <a href="mailto:fanfaire@station.sony.com" class="bold3">fanfaire@station.sony.com</a><br>
                                      </p>
                                      <br>
                                    </div>
                                    <!-- #EndEditable --></td>
