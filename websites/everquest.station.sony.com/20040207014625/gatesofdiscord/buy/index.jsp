          ...
          <td><table width="478" border="0" cellspacing="0" cellpadding="0">
                ...
                <td valign="top" class="buycontentbackground"> <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr> 
                      <td height="84">No waiting in lines! Forget traffic jams! 
                        Pre-order the digital download version of EverQuest: Gates 
                        of Discord exclusively from the Station Store and be one 
                        of the first to experience the chaos and devastation of 
                        the once peaceful continent of Taelosia. On launch day, 
                        you will be adventuring while others slog through checkout 
                        lines.</td>
                    </tr>
                  </table></td>
              </tr>
              ...
              <tr> 
                <td valign="top"> <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr> 
                      <td>Or, pre-order or purchase the boxed version of EverQuest: 
                        ...
                        boxed versions of the expansion.</td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                ...
                <td valign="top"> <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr> 
                      <td><p>Regardless of your choice, digital download or boxed 
                        ...
                        <p align="center"><img src="images/available.jpg" width="229" height="17"></p>
...
<map name="Store" id="Store">
  <area shape="rect" coords="134,2,330,43" href="https://store.station.sony.com/digitalDistribution/god/digitalDistribution.jsp?SKU=EQGOD-DD-SW0203-GODPRE">
</map>
<map name="Store2" id="Store2">
  <area shape="rect" coords="10,17,171,260" href="https://store.station.sony.com/digitalDistribution/god/digitalDistribution.jsp?SKU=EQGOD-DD-SW0203-GODPRE">
