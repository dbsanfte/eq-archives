...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/index.jsp?null');">
...
if (navigator.appVersion.indexOf("Mac")!=-1)
{
	document.write('<img src="images/spacer.gif" border="0" height="13" width=1><br>');
        ...
        <div id="stretch" style="width:640px; height:365;"> <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="640" height="360">
            <param name=movie value="images/pop_justice.swf">
            <param name=quality value=high>
            <param name=menu value=false>
            <embed src="images/pop_justice.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="640" height="360" menu="false">
            </embed> 
          </object></div>
      </td>
	...
	<tr>
		<td align="center">
		<span style="font-size: 10px; color: white;">Select Language</span><br>
		<img border="0" src="images/flag_en_on.gif" width="25" height="17" vspace="3" hspace="2"><a href="http://everquest.station.sony.com/fr/power/index.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image51','','images/flag_fr_on.gif',1)"><img name="Image51" border="0" src="images/flag_fr.gif" width="25" height="17" vspace="3" hspace="2"></a><a href="http://everquest.station.sony.com/de/power/index.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image50','','images/flag_de_on.gif',1)"><img name="Image50" border="0" src="images/flag_de.gif" width="25" height="17" vspace="3" hspace="2"></a><a href="http://everquest.station.sony.com/ja/power/index.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image53','','images/flag_ja_on.gif',1)"><img name="Image53" border="0" src="images/flag_ja.gif" width="25" height="17" vspace="3" hspace="2"></a>
		</td>
	</tr>
	<tr>
    ...
    <tr> 
      <td colspan="2"  height="368" width=780 valign="top"> 
        <table border="0" cellpadding="0" cellspacing="0" width="640" height="305">
          <tr valign="top">
            <td colspan="2" align="center" height="20"><img src="images2/caption_justice.jpg" width="178" height="20" align="top"></td>
          </tr>
          <tr valign="top"> 
