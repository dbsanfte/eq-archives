...
<div align="center"> 
<div align="center"> 
<div align="center"><b><font face="Georgia, Times New Roman, Times, serif" color="#FF9900" size="4"><span class="header">Gnome</span></font></b></div>
<table border="0" width="100%" cellpadding="10">
<tr> 
<td align="center"><a href="JavaScript:imageSwitch('male')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_gnomemale.gif" width="167" height="254" name="male" border="0"></a></td>
...
<td align="center"><a href="JavaScript:imageSwitch('female')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_gnomefemale.gif" width="167" height="254" name="female" border="0"></a></td>
<tr> 
<td align="center" colspan="3"> 
<div align="justify"><font face="Arial, Helvetica, sans-serif">Gnomes spend most 
of their lives in their underground burrows and rarely come to the surface. They 
resemble Dwarves to some extent, but have a ruddy brown skin and are more wiry 
and gnarled. Their hair is white, and somewhat sparse. </font></div>
</td>
</table>
</div>
</div>
