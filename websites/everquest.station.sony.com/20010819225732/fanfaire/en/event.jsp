...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">105169 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
...
<!--**********************************************-->
                         ...
                         <td><a href="http://www.station.sony.com/services/stationid.jhtml" target="_blank" onClick="open_servwin('http://www.station.sony.com/services/stationid.jhtml');return false">
                            <img src="/common/images/global_nav/en//nav_comstation.gif" width="47" height="15" border="0" alt="" vspace=2>
                            <img src="/common/images/global_nav/en//nav_dish.gif" width=15 height="15" border=0 alt="" vspace=2>
                          </a></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/event.gif" width="296" height="49"> <br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                        <tr> 
                                          <td class="bold" width="50%"> 
                                            <div align="right">Attendees registration: 
                                              <br>
                                              Breakfast served during registration 
                                              <br>
                                            </div>
                                          </td>
                                          <td class="bold">10 :00 am to 11.30AM</td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">General Session 
                                              <br>
                                              Welcome and introductions<br>
                                            </div>
                                          </td>
                                          <td class="bold">11.30AM to 12.30PM</td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">Lunch break:<br>
                                              Lunch provided at a small charge<br>
                                            </div>
                                          </td>
                                          <td class="bold"> 12.30PM to 1.30PM</td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">Coming Attractions 
                                              !<br>
                                              First peek at Luclin and other special 
                                              presentations !<br>
                                            </div>
                                          </td>
                                          <td class="bold"> 1.30PM to 2.00PM</td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">Real Life Quest: 
                                            </div>
                                          </td>
                                          <td class="bold">2.00PM to 4.00PM</td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">Panel discussion: 
                                              <br>
                                              Online Quest Demonstration<br>
                                            </div>
                                          </td>
                                          <td class="bold"> 4.00PM to 6.00PM</td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">Break: </div>
                                          </td>
                                          <td class="bold">6.00PM to 7.00PM </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold"> 
                                            <div align="right">Medieval Buffet: 
                                              <br>
                                              (prizes awarded during dinner)<br>
                                            </div>
                                          </td>
                                          <td class="bold">7.00PM to 9.00PM</td>
                                        </tr>
                                        <tr> 
                                          <td colspan="2" class="bold">
                                            <div align="center">Stroll through 
                                              a medieval village and pause to 
                                              watch sword fights, marvel at falconers 
                                              and fire-eaters, and laugh at the 
                                              jugglers! You will also have the 
                                              opportunity throughout the day to 
                                              check out Shadows of Luclin, visit 
                                              with representatives from Sony Online, 
                                              and meet Firiona Vie in person!</div>
                                          </td>
                                        </tr>
                                      </table>
                                    </div>
