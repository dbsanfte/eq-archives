...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/index.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/index.jsp');">
...
<center>
  <table border="0" cellpadding="0" cellspacing="0" width="780">
    <tr> 
      <td height="1"><img src="images/spacer.gif" height="69" width="10"></td>
    </tr>
    <tr> 
...
if ( MM_FlashCanPlay ) {
	...
	document.write(' <PARAM NAME=movie VALUE="media/Chapt9.swf"> <PARAM NAME=menu VALUE=false> <PARAM NAME=quality VALUE=best> <PARAM NAME=bgcolor VALUE=#000000>  '); 
