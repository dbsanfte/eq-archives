...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">92,526 Players Online</div>
...
<table width="780" border="0" cellspacing="0" cellpadding="0" align="center" height="100%">
  ...
  <tr>
                <td> <p class="text"><a href="scrapbook_sanfran.jsp" class="links">The 
                    2002 EverQuest San Francisco Fan Faire</a> was held on November 
                    8-9 at the Sony Metreon and the San Francisco Marriott. Check 
                    out an attendee&#8217;s diary with photos, plus a cool movie 
                    from this exciting event</p>
                  <p>&nbsp;</p></td>
  </tr>
</table>
                ...
                <td>
                  <div align="center">
                    <p><a href="scrapbook_boston_photos.jsp"><img src="images/photo_strip.gif" width="559" height="73" border="0"></a><br>
                      <a href="scrapbook_sanfran_photos.jsp" class="links">Photo 
                      Gallery</a></p>
                    <p>
