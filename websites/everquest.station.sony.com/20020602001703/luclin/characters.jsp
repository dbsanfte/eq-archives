  ...
  <tr>
    ...
    <td width="100%" valign="top" align="center"><br>
      <table width="75%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>EverQuest&reg;: The Shadows of Luclin&#153; features an enhanced 3D engine that is going to give EverQuest a fantastic visual upgrade.  The new engine allows for a major increase in character model detail by upping their polygon counts and supporting the layering of textures on models for greater realism, improvements previously impossible due to the constraints of the current engine.  Your favorite characters of Norrath will truly take on new life. Check back often for updates here. As we inch closer to the release of the Shadows of Luclin expansion, we'll have new character screenshots to share with you.</td>
        </tr>
      </table>
