...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_orlando.jsp?null');">
...
<p align="justify" class="bold"><a href="wedding_orlando.jsp" class="bold2">Love is in the air...</a> 
- On October 6th, two EverQuest players, Krissy and Dave, got married in real life. On October 20th, in front of hundreds of Fan Faire attendees, their characters were married in-game on the Luclin server.</p>
										                                      <p align="justify" class="bold"><a href="report_orlando.jsp" class="bold2">The 
                                        Mennix Report</a> <span class="bold">- 
                                        Once again, Steve &quot;Mennix&quot; Fuller 
                                        attended another EverQuest Fan Faire and 
                                        recaps his thoughts, in his own particular 
                                        way, on much of went on in Orlando.<br>
                                        </span></p>
                                      <p align="justify" class="bold"><a href="devbytes_orlando.jsp" class="bold2">Designer 
                                        Sound Bytes </a> <span class="bold">- 
                                        Jeff Butler and Bill Coyle fielded questions 
                                        ranging from class balance issues to Luclin 
                                        game features in the Producer's discussion 
                                        panel conducted at the Fan Faire. Hear 
                                        some selected out takes, in MP3 format, 
                                        of just a few of their answers.</span></p>
                                      <p align="justify" class="bold"><span class="bold2"><a href="winners_orlando.jsp" class="bold2">List of Winners</a></span><span class="bold"> - Team X of Mithaniel Marr won the Live Quest conducted at the Orlando Fan Faire. Each member of the team will be receiving a copy of the Shadows of Luclin once the expansion is released this December. Winners of the random drawing will also be getting their copy of Luclin.<br>
                                        </span></p>
<p align="center"><a href="scrapbook_orlando_photos.jsp" class="bold2"><font face="Arial, Helvetica, sans-serif" size="3">Photo Gallery</font></a></p>
                                      </div>
									  <!-- #EndEditable --></td>
                                </tr>
                              </table>
