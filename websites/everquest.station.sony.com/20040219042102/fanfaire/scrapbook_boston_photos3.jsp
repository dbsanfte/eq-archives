	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston_photos3.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston_photos3.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                ...
                <td> 
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr> 
                      <td valign=top> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=infant" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=infant','','width=480,height=640'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/infant_thumb.jpg" width="150" height="200" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=infant" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=infant','','width=480,height=640'); return false;" target="_blank" class="links">EQ Infant <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=massage" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=massage','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/massage_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=massage" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=massage','','width=640,height=480'); return false;" target="_blank" class="links">Halfling Therapy <br>
                            </a><br>
                          </p>
                        </center>
                      </td>
                    ...
                    <tr> 
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=quest" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=quest','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/quest_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=quest" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=quest','','width=640,height=480'); return false;" target="_blank" class="links">Group Effort <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                      <td valign=top> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=ranger" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=ranger','','width=480,height=640'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/ranger_thumb.jpg" width="150" height="200" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=ranger" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=ranger','','width=480,height=640'); return false;" target="_blank" class="links">Taking Aim <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                    ...
                    <tr> 
                      <td> 
                        <div align="center"> 
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=registration" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=registration','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/registration_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=registration" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=registration','','width=640,height=480'); return false;" target="_blank" class="links">Registration <br>
                            </a></p>
                          <br>
                        </div>
                      </td>
                      <td valign=top> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=rpgwear" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=rpgwear','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/rpgwear_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=rpgwear" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=rpgwear','','width=640,height=480'); return false;" target="_blank" class="links">RPGwear <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                    ...
                    <tr> 
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=welcome" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=welcome','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/welcome_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=welcome" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=welcome','','width=640,height=480'); return false;" target="_blank" class="links">Welcome <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=wwolf" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=wwolf','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/wwolf_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=wwolf" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=wwolf','','width=640,height=480'); return false;" target="_blank" class="links">White Wolf <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                  ...
                  <p align="center"><a href="scrapbook_boston.jsp" class="links">Back 
                    to Scrapbook</a></p>
                                    </td>
              </tr>
            </table>
