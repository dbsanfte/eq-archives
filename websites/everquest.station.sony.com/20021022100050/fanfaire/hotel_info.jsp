        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr>
                <td>
                  <div align="center"><img src="images/hotel_info_header.gif"></div>
                </td>
              </tr>
              <tr>
                <td>
                  <p class="bold"><span class="text">Join us for the San Francisco 
                    Fan Faire!<br>
                    <br>
                    <a href="http://www.marriott.com/epp/default.asp?MarshaCode=SFODT" target="_blank" class="links">San 
                    Francisco Marriott</a><br>
                    55 Fourth Street<br>
                    San Francisco, CA 94103<br>
                    Tel: (800) 228-9290<br>
                    <br>
                    The San Francisco Marriott is right across the street from 
                    the Metreon. You'll find activities in both places throughout 
                    the weekend. We have been given a group rate of $139--just 
                    ask for the EverQuest Fan Faire rate. You can call and make 
                    your reservations now at (800) 228-9290. Remember, the last 
                    Fan Faire hotel sold out of rooms weeks before the event. 
                    Hurry and make your reservations now!</span></p>
                  <p class="bold"><span class="text">You may now book your room 
                    at the San Francisco Marriott online with the special Fan 
                    Faire group rate with the following links:</span></p>
                  <p class="bold"><span class="text"><a href="https://www.marriott.com/reservations/init.asp?marshacode=sfodt&path=marriott&gc=effeffa" class="links" target="_blank">Single 
                    or double - $139.00</a><br>
                    <a href="https://www.marriott.com/reservations/init.asp?marshacode=sfodt&path=marriott&gc=effeffb" target="_blank" class="links">Triple 
                    - $159.00</a><br>
                    <a href="https://www.marriott.com/reservations/init.asp?marshacode=sfodt&path=marriott&gc=effeffc" target="_blank" class="links">Quadruple 
                    - $179.00</a></span></p>
                  <p class="bold"><span class="text">Through the Marriott.com 
                    online reservation system, you may:<br>
                    &middot; Confirm reservations 24 hours a day from your computer<br>
                    &middot; Receive instant confirmation<br>
                    &middot; Cancel and reconfirm reservations online<br>
                    &middot; Enter up to two names on a reservation</span></p>
                  <p class="bold"><span class="text">Marriott.com FAQ:</span></p>
                  <p class="bold"><span class="textBold">Q: Can I book a reservation 
                    online without a credit card?</span><span class="text"><br>
                    A: No, a credit card is required for all reservations.</span></p>
                  <p class="bold"><span class="textBold">Q: Can I modify reservations 
                    online when booked through Marriott.com?</span><span class="text"><br>
                    A: No, you should call the hotel for changes--(800) 228-9290</span></p>
                  <p class="bold"><span class="textBold">Q: Can I confirm more 
                    than one room at the same hotel?</span><span class="text"><br>
                    A: Yes, there is a repeat reservation option.</span></p>
                  <p class="text">Note: The site has a security feature that limits 
                    how often a single credit card can be used to book a hotel 
                    for the same dates.</p>
                                    </td>
              </tr>
            </table>
            <!-- #EndEditable --></td>
