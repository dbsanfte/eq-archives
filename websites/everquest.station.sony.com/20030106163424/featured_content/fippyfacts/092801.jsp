...
//-->
                    ...
                    <table width="60%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p align="center">The beings of Norrath speak many languages, each beginning with their own native tongue and acquiring more through study and interaction with others.  What percentage of characters have advanced at least one step in learning each language?  How many have mastered each language?  Fippy once again shows his facility with data by giving us a linguistic breakdown:</p>
                        </td>
                      </tr>
                    ...
                    <div align="center">
                      <TABLE CELLSPACING=0 BORDER=1 WIDTH=400>
                        <TR align="center">
                          ...
                          <TD WIDTH="24%" VALIGN="MIDDLE" HEIGHT=21>
                            <P><b>% of characters that have advanced at least ONE level in&nbsp;the language.</b>
                          </TD>
                          <TD WIDTH="4%" VALIGN="MIDDLE" HEIGHT=21>
                            <P align="center"></P>
                          </TD>
                          <TD WIDTH="24%" VALIGN="MIDDLE" HEIGHT=21>
                            <P><b>Number of characters that have achieved Mastery (top!) level in the language.</b>
                          </TD>
                          <TD WIDTH="24%" VALIGN="MIDDLE" HEIGHT=21>
                            <P><b>Number of people that have achieved Excellence in the language.</b>
                          </TD>
                        </TR>
                        <TR align="center">
                          <TD WIDTH="24%" VALIGN="MIDDLE" HEIGHT=17>
                            Barbarian
                          </TD>
                          <TD WIDTH="24%" VALIGN="MIDDLE" HEIGHT=17>
                            2.5 %
                          </TD>
                          <TD WIDTH="4%" VALIGN="MIDDLE" HEIGHT=17>
                            <P align="center"></P>
                          </TD>
                          <TD WIDTH="24%" VALIGN="MIDDLE" HEIGHT=17>
                      ...
                      <tr>
                        <td>
                          ...
                          <ol>
                            ...
                            <li>Common has been excluded since every character speaks it.</li>
                            <li>Native languages have been filtered out. e.g. Trolls speaking Troll, Wood Elves speaking Elvish, etc.</li>
                            <li>Rogues have been removed from the Thieves Cant data too, since all Rogues are Masters at the language.</li>
                            <li>GMs are not included.</li>
                            <li>Level 1 characters are not included.</li>
                          </ol>
                          <p>&nbsp;</p>
                          <p>Conclusions:</p>
                          <ol>

                            <li>More characters have advanced in Elvish, Dark Elvish and Elder Elvish than any other language.</li>
                            <li>Orcish is the least spoken language.&nbsp;Only 159 characters across all servers have achieved Mastery in Orcish!</li>
                            <li>Of all the non-native languages, the most Mastered language is Dragon!</li>
                            <li>Only&nbsp;4000 people across all servers can hold a decent conversation with Fippy!</li>
                          </ol>
                        </td>
                      </tr>
  ...
  <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
	...
	<option value="011802.jsp">January 18, 2002 - The Vah Shir</option>
