...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>72341 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
        ...
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            ...
            <center>
              ...
              <p class="bold"><br>
                Orlando, en Floride, sera le site de la prochaine Fan Faire d'EverQuest<sup>®</sup> 
                ! Rejoignez-nous, les 19 et 20 Octobre, au <a href="http://www.omnirosen.com" class="bold2" target="_blank">Rosen 
                Centre</a>, situ&eacute; &agrave; quelques minutes de Disney World 
                et des nombreuses attractions formidables de la r&eacute;gion 
                ! Gr&acirc;ce &agrave; nos tarifs sp&eacute;ciaux pour cet &eacute;v&eacute;nement, 
                cela pourrait &ecirc;tre une parfaite occasion pour amener toute 
                la famille s'amuser ensemble ! </p>
              <p class="bold">L'inscription se termine le 7 octobre 2001 &agrave; 
                minuit, heure du Pacifique (&Eacute;tats-Unis). Le tarif est de 
                85 dollars am&eacute;ricains </p>
              <p class="bold"><img src="../images/Disney%20logo.jpg" width="200" height="102"><br>
              </p>
              <p class="bold"><span class="bold">Si vous participez &agrave; la 
                Fan Faire d'Orlando, vous pouvez b&eacute;n&eacute;ficier de billets 
                d'entr&eacute;e &agrave; Disney World &agrave; tarif sp&eacute;cial 
                !</span></p>
              <p class="bold"><span class="bold">Ils ont g&eacute;n&eacute;reusement 
                offert des billets &agrave; tarif r&eacute;duit pour les participants 
                de la Fan Faire ! Pour plus de renseignements concernant ces tarifs 
                et pour commander ces billets, allez sur</span> <a href="https://secure.hes-services.com/wdwticket/everquest.asp" onMouseOut="nd()" onMouseOver="return overlib('Ce lien va vous diriger vers une page en anglais.')" target="_blank" class="bold2">https://secure.hes-services.com/wdwticket/everquest.asp</a></p>
              <p>&nbsp; </p>
