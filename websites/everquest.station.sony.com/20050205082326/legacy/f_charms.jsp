...
<title>EverQuest&reg;: The Legacy of Ykesha&#153; - New Magic Item Slot: Charms</title>
<!-- InstanceEndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/f_charms.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/f_charms.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="672" valign="top" style="background-image:  url(images/sub_bg.jpg); background-repeat: no-repeat;"> 
        <!-- InstanceBeginEditable name="Header Image" --><img src="images/f_charms_head.jpg" width="672" height="56" alt="" border="0"><br><!-- InstanceEndEditable -->
		<table width="672" border="0" cellspacing="0" cellpadding="0" background="">
          <tr> 
            ...
            <td width="607" background="images/parch_tile.jpg" bgcolor="#928E73">
				...
				<p>The Legacy of Ykesha&#153; introduces a new inventory slot and a slew of new items that can be worn there.</p>
				<p>Here is an exciting picture of the charm inventory slot!</p>
				<div align="center"><img src="images/f_charms_screen.jpg" width="428" height="409" alt="" border="0"></div>
				<p>Ok, so a picture of an inventory slot isn't all that exciting.  But the charms themselves are very exciting.</p>
				<p>Charms can take many forms.  They can be broaches, cape clasps, pendants and other such adornments.  They vary in appearance, but they all share one property.  Charms are more than just simple magic items.  They interact with the world around them and often with their owner.  Charms are aware of their surroundings, at least in some limited way.  This limited perception is usually directed, or aimed at a specific purpose, though that is not always the case.</p>
				<p>A charm, for example, may have been created by a druid after a lifetime of battles with the forces of Blackburrow or the Coldpaw Clan.  She may have imbued her charms with the power to grant strength to those that kill her lifelong enemies, and that strength may grow with the owner's dedication to the charm's cause.  Or perhaps there is an ancient Dwarven charm, blessed by Brell, that grants a boon - but only to Dwarves.</p>
				<p>And of course there are rumors that some of these charms only work with arms or armor created by the same weapon or armor smith, and that their magic grows stronger with every piece of the armor set the owner wears.</p>
				<p>Charms are an entirely new breed of magical items that are aware of certain situations and conditions around them.  Some even believe that the magic in them is alive, given the way they seem to react differently to each owner. We've discovered three example charms to show you. Unlike the fictitious charms mentioned above, these charms might just resemble what you can find in Norrath:</p>
				<div align="center">
				<p><img src="images/f_charms_screen1.jpg" width="398" height="210" alt="" border="0"><br>
				<strong>Cloth Doll</strong></p>
				<p>The description of each charm will tell you what that charm is attuned to.</p>
				<br><br>
				<p><img src="images/f_charms_screen2.jpg" width="398" height="210" alt="" border="0"><br>
				<strong>Gold Disc</strong></p>
				<p>As the charm's surroundings become closer to what it wants, it grows in strength.</p>
				<br><br>
				<p><img src="images/f_charms_screen3.jpg" width="398" height="210" alt="" border="0"><br>
				<strong>Mark of Stealth</strong></p>
				<p>These are just samples, though, and there may be other mysteries about charms still to be discovered.</p>
				</div>
				<p>&nbsp;</p>
                </div>
				<p>&nbsp;</p>
