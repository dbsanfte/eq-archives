...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">45406 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td align="center" valign="top" background="images/BG.jpg"> 
            ...
            <p class="header">EverQuest Wallpaper</p>
            <table width="80%" border="0" cellspacing="5" cellpadding="5">

              <tr>

                <td align="center" width="50%"><a href="wallpaper/01.htm" target="_blank"><img src="wallpaper/eqLOGO15bit_sml.jpg" width="200" height="150" border="0"></a></td>
                <td align="center" width="50%"><a href="wallpaper/02.htm" target="_blank"><img src="wallpaper/eqo_sml.jpg" width="200" height="150" border="0"></a></td>
              </tr>

              <tr>

                <td align="center" width="50%"><a href="wallpaper/03.htm" target="_blank"><img src="wallpaper/EQtitle_sml.jpg" width="200" height="150" border="0"></a></td>
                <td align="center" width="50%"><a href="wallpaper/04.htm" target="_blank"><img src="wallpaper/load_sml.jpg" width="200" height="150" border="0"></a></td>
              </tr>

              <tr>

                <td align="center" colspan="2"><a href="wallpaper/05.htm" target="_blank"><img src="wallpaper/logo03b_sml.jpg" width="200" height="150" border="0"></a></td>
              </tr>
