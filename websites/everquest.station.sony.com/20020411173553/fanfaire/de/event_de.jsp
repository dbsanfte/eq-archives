...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/event_de.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"> 
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=337 ALIGN="center" HSPACE=9>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2> 
                                            <P ALIGN="CENTER" class="bold"><b>Freitag, 
                                              19. April</b> 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">18:00 - 20:00 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">Check-in und Registrierung 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">20:00 - 22:00 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">Empfang 
                                          </TD>
                                        </TR>
                                      </TABLE>
                                    </div>
                                    <div align="center"> <span class="bold"><br>
                                      </span> 
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2> 
                                            <P ALIGN="CENTER" class="bold"><b>Samstag, 
                                              20. April</b> 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">13:00 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">FanFest Beginn! 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">13:30-15:30 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">Live Quest 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">16:00-17:15 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">Workshop I 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">17:30-18:45 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">Workshop II 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="44%" VALIGN="TOP"> 
                                            <P class="bold">19:00 Uhr 
                                          </TD>
                                          <TD WIDTH="56%" VALIGN="TOP"> 
                                            <P class="bold">Abendessen und Preisverleih 
                                          </TD>
                                        </TR>
                                      </TABLE>
                                    </div>
                                    <P align="center" class="bold">Die Workshops 
                                      konzentrieren sich auf verschiedene Themen, 
                                      wie Magie, Wie entstehen bessere Gilden, 
                                      F&auml;higkeiten f&uuml;r den Handel und 
                                      die Herstellung von Produkten sowie die 
                                      Entwicklung von EverQuest.</P>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
