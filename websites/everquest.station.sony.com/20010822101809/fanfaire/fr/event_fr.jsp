...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">34223 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
...
//-->
	...
	<a href="http://www.station.sony.com/store" onMouseOut="nd()" onMouseOver="return overlib('Ce lien va vous diriger vers une page en anglais.')" target="_top">Achats</a> |
                    ...
                    <tr>
                      <td>
                        <table width="151" border="0" cellspacing="0" cellpadding="0" background="">
                          ...
                          <tr>
                            <td><a href="http://everquest.station.sony.com/fanfaire/fr/fanfaireAttendeeList.jsp?sku=EQALL-EV-EV0901-FANFRE-PARIS" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','../images/diamond_on.gif',1)"><img name="Image10" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Participants</span></a></td>
                          </tr>
                          <tr>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"><font color="#000000" fa="fa" 
ce="Arial, Helvetica, sans-serif" 
size="2"><b><br>
                                      </b></font> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <div align="right">R&eacute;ception 
                                              des participants : <br>
                                              Un petit d&eacute;jeuner sera servi 
                                              pendant la r&eacute;ception.<br>
                                            </div>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">10h00 &agrave; 11h30</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <div align="right">Session G&eacute;n&eacute;rale<br>
                                              Accueil et introduction<br>
                                            </div>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">11h30 &agrave; 12h30</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="50%"> 
                                            <div align="right">Pose d&eacute;jeuner 
                                              : <br>
                                              Le d&eacute;jeuner est fourni moyennant 
                                              une petite participation<br>
                                            </div>
                                          </td>
                                          <td class="bold" width="50%"> 
                                            <div align="left">12h30 &agrave; 13:30</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <div align="right">Des animations 
                                              sp&eacute;ciales ! <br>
                                              Premi&egrave;re de Luclin ainsi 
                                              que d'autres pr&eacute;sentations 
                                              sp&eacute;ciales !<br>
                                            </div>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">13h30 &agrave; 14h00</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <div align="right">Qu&ecirc;tes grandeur 
                                              nature :</div>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">14h00 to 16h00</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <p align="right">Discussions - D&eacute;bats 
                                              : <br>
                                            <p align="right">Qu&ecirc;tes en ligne 
                                              - D&eacute;monstration </p>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">16h00 &agrave; 18h00</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <div align="right">Pause : </div>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">18h00 &agrave; 19h00 
                                            </div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td class="bold" width="61%"> 
                                            <div align="right">Buffet M&eacute;di&eacute;val 
                                              : <br>
                                              (Attribution des prix pendant le 
                                              d&icirc;ner)<br>
                                            </div>
                                          </td>
                                          <td class="bold" width="39%"> 
                                            <div align="left">19h00 &agrave; 21h00</div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td colspan="2" class="bold"> 
                                            <div align="center">Fl&acirc;nez dans 
                                              le village m&eacute;di&eacute;val 
                                              et contemplez les combats d'&eacute;p&eacute;es... 
                                              &Eacute;merveillez-vous des dresseurs 
                                              de faucons et des cracheurs de feu 
                                              ! Riez des jongleurs ! Vous aurez 
                                              &eacute;galement l'opportunit&eacute; 
                                              de suivre les responsables de Sony 
                                              Online et de rencontrer Firiona 
                                              Vie en personne !<br>
                                            </div>
                                          </td>
                                        </tr>
