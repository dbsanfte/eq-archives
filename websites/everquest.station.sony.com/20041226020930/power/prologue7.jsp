	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/prologue7.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/prologue7.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/prologue7.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
      ...
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> 
            ...
            <p class="link2">The Meeting</p>
            <p align="center"> <a href="index_prologue7.jsp"><img src="images/Meeting_window.jpg" width="415" height="169" border="0"></a> 
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td height="11"><a href="wallpapers.jsp#themeeting" class="link2small">Click 
                  for Wallpaper</a></td>
                <td width="50%" align="right" height="11"><a href="index_prologue7.jsp" class="link2small">Click for Flash movie</a> </td>
              </tr>
            </table>
            ...
            <p class="link">&quot;Time has accelerated,&quot; announces the elder 
              over the din. &quot;Uncertainty, fear, anticipation, and now this&#133;. 
