...
var os = "Unknown"
if (navigator.appVersion.indexOf("Windows 95") != -1) os = "Win95"
if (navigator.appVersion.indexOf("Win95") != -1) os = "Win95"
if (navigator.appVersion.indexOf("Windows 98") != -1) os = "Win98"
if (navigator.appVersion.indexOf("Win98") != -1) os = "Win98"
if (navigator.appVersion.indexOf("Windows NT 4") != -1) os = "WinNT4"
if (navigator.appVersion.indexOf("Windows NT 5") != -1) os = "Win2000"
if (navigator.appVersion.indexOf("WinNT") != -1) os = "WinNT"
...
function wow(totalSize, log_ver) {
	log_ver = log_ver + "01";  // new cookie name
	...
	if (!isCookie) {
		...
		littleImage.src= '/common/detector/98734hdlfjbas86d523jh.jsp?flashVer=' + flashVer + '&browser=' + browser + '&os=' + os + '&bw=' + bw + '&log_ver='+log_ver;
//		alert('flashVer=' + flashVer + '&browser=' + browser + '&os=' + os + '&bw=' + bw + '&log_ver='+log_ver);
