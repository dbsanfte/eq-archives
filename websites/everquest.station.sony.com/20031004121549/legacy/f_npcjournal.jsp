...
<title>EverQuest&reg;: The Legacy of Ykesha&#153; - NPC Conversation Journal</title>
<!-- InstanceEndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/f_npcjournal.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/f_npcjournal.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="672" valign="top" style="background-image:  url(images/sub_bg.jpg); background-repeat: no-repeat;"> 
        <!-- InstanceBeginEditable name="Header Image" --><img src="images/f_npcjournal_head.jpg" width="672" height="56" alt="" border="0"><br><!-- InstanceEndEditable -->
		<table width="672" border="0" cellspacing="0" cellpadding="0" background="">
          <tr> 
            ...
            <td width="607" background="images/parch_tile.jpg" bgcolor="#928E73">
				...
				<p>There are a lot of quests in EverQuest.  Keeping track of the information that you gather while you're doing these quests can be a daunting task.  The NPC Conversation Journal will provide you with an easy way to store and organize quest dialogues.  Here is the NPC Journal Window that shows you all of the non-player characters (NPCs) whose text you have recorded (the windows shown here may change).</p>
				<div align="center"><img src="images/f_npcjournal-npc.jpg" width="486" height="229" alt="" border="0"></div>
				<p>Once enabled, the journal will keep track of what each NPC has said to you.  NPCs listed in the journal window can be sorted by the NPC Name, the zone where the NPC was found or the date and time of the most recent conversation with an NPC. A player can delete any of these NPCs (along with any text that the NPC has recorded in the journal) if he desires. There is also an option that allows the player to filter the list by category (more about categories later). Clicking on any of these NPC names will open up a window that displays all of the text that the NPC has recorded in the journal.</p>
				<p>For example, here is all of the information that our journal has from Kazlo Naedra.</p>
				<div align="center"><img src="images/f_npcjournal-dialog.jpg" width="486" height="277" alt="" border="0"></div>
				<p>The list of journal entries for each NPC can be sorted by date and time or category.  Clicking on an item on the list will display the text for that journal entry.  Individual journal entries can be deleted by selecting them and clicking Delete.  A player can use this window to assign a category to any of the items on the list.</p>
				<p>Clicking on the Categories button in the NPC Journal Window will open up the Categories window.</p>
				<div align="center"><img src="images/f_npcjournal-category.jpg" width="358" height="232" alt="" border="0"></div>
				<p>By using categories, a player will be able to follow their quests from start to finish.  To add a category, just type the Name and Description of the new category into the fields provided and click Add.  Clicking on an existing category will allow you to edit that category (and any edits will be propagated to all uses of that category in the journal).</p>
				<p>Players will be able to set any of these categories to be the default category.  Any new journal entries will automatically be assigned that category, making it easy to keep track of the quest you are working on at the moment.</p>
				<p>Hopefully this feature of The Legacy of Ykesha&#153; extension will save a fair number of trees and ink cartridges.  We wouldn't want ink cartridges to become extinct.</p>
                </div>
				<p>&nbsp;</p>
				<!-- InstanceEndEditable -->
			</td>
