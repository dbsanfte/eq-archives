...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_minneapolis_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_minneapolis_fr.jsp');">
                                  ...
                                  <td><!-- #BeginEditable "content" -->			
                                    ...
                                    <div align="justify"> 
                                      <p align="center"><b><font color="#000000"><br>
                                        <span class="bold"><font size="3">Articles
</font></span></font></b></p>
                                      <p align="justify" class="bold"><a 
href="report_minneapolis_fr.jsp" class="bold2">
Le rapport Mennix</a> <span class="bold">- Steve « Mennix » Fuller nous fait une fois encore part de ses impressions sur une autre Fan Faire. Dans cet aperçu, Steve détaille tout le weekend dans son style personnel et irrévérencieux.<br>
                                        </span></p>
                                      <p align="justify"><a 
href="chicken_minneapolis_fr.jsp" class="bold2">La communauté et le Poulet en caoutchouc</a> <span class="bold">- Gbear avait un plan ; il mettait en scène un Poulet en caoutchouc. 
Voyez comment un membre de la communauté de  la Fan Faire a rassemblé ses amis virtuels.</span>
</p>
                                      <p align="justify"><a 
href="sponsors_minneapolis_fr.jsp" class="bold2">Et maintenant un mot de nos sponsors</a> <span class="bold">- La Fan Faire de Minneapolis a vu l'augmentation du nombre de sociétés sponsors et des commerçants présents. Steve « Mennix » Fuller nous fait part de ses impressions.</span>
</p>
                                      <p align="justify"><a 
href="winners_minneapolis_fr.jsp" class="bold2">Liste des gagnants</a> <span class="bold">- L'équipe de Bristlebane, avec deux membres supplémentaires de Seventh Hammer, a remporté la Live Quest. Chaque gagnant recevra une &Eacute;p&eacute;e du Rassemblement ou un B&acirc;ton du Rassemblement accord&eacute; &agrave; l'un de ses personnages. Les gagnants de la Live Quest ne seront pas les seuls &agrave; recevoir cet artefact sp&eacute;cial &agrave; la Fan Faire ; quatre heureux gagnants d&eacute;sign&eacute;s par le tirage au sort d&eacute;cideront aussi lequel de leurs personnages portera une nouvelle arme.<br>
                                        </span></p>
                                      <p align="center"><a 
href="scrapbook_minneapolis_photos_fr.jsp" class="bold2">
<font face="Arial, Helvetica, sans-serif" size="3">Album photos</font></a></p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
