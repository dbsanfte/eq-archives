...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/scrapbook_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/scrapbook_esp.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p><a href="scrapbook_dallas_esp.jsp" class="bold2">EverQuest Fan Faire de Dallas </a><span class="bold"> 
                                      - El Adam's Mark Hotel, situado en el precioso corazón de Dallas, Texas, en el distrito de las Artes y las Finanzas, fue la sede de la EverQuest Fan Faire de enero. Los asistentes participaron en una aventura de la vida real, conocieron a la gente de EverQuest y estuvieron en distintos talleres. Fue otra exitosa Fan Faire.</span></p>								  
                                    <p><a href="scrapbook_orlando_esp.jsp" class="bold2">EverQuest 
                                      Orlando Fan Faire</a><span class="bold"> 
                                      - Durante esta &eacute;poca de crisis nacional, 
                                      en la que Estados Unidos y sus aliados est&aacute;n 
                                      en guerra contra el terrorismo, m&aacute;s 
                                      de 1200 fans de EverQuest se reunieron en 
                                      el Rosen Centre en Orlando Florida para 
                                      demostrar que, a pesar de todo, pueden divertirse 
                                      con todos los que comparten su pasi&oacute;n 
                                      por EverQuest.</span></p>
                                    <p><a href="scrapbook_minneapolis_esp.jsp" class="bold2">Fan 
                                      Faire de EverQuest en Minneapolis</a><span class="bold"> 
                                      - M&aacute;s de 1.200 jugadores de EverQuest 
                                      se reunieron en el Marriott City Center 
                                      de Minneapolis el 15 y el 16 de junio para 
                                      participar en la tercera Fan Faire de EverQuest. 
                                      Jugadores y visitantes pudieron ver un adelanto 
                                      de la pr&oacute;xima expansi&oacute;n del 
                                      juego, llamada EverQuest: The Shadows of 
                                      Luclin. </span></p>
                                    <p> <a href="scrapbook_sandiego_esp.jsp" class="bold2">Fan 
                                      Faire de EverQuest en San Diego</a><span class="bold"> 
                                      - La segunda Fan Faire, celebrada en el 
                                      Sheraton San Diego Hotel and Marina el 6 
                                      y el 7 de abril, fue todo un &eacute;xito. 
                                      Esta Fan Faire fue especial, ya que muchos 
                                      Game Masters (maestros del juego) y empleados 
                                      de Verant/SOE pudieron asistir y conocer 
                                      a los jugadores de EverQuest. </span> </p>
                                    <p><a href="scrapbook_baltimore_esp.jsp" class="bold2"><b><font face="Arial, Helvetica, sans-serif" size="2">Fan 
                                      Faire de EverQuest en Baltimore</font></b></a><span class="bold">- 
                                      La Fan Faire de EverQuest en Baltimore, 
                                      realizada el 2 y el 3 de febrero de 2001 
                                      en el BWI Airport Marriott, &iexcl;result&oacute; 
                                      ser la m&aacute;s exitosa de todas! Fue 
                                      la primera para la que se vendieron todas 
                                      las entradas, que sumaban m&aacute;s de 
                                      1.200, sin contar a las numerosas personalidades 
                                      de los medios de comunicaci&oacute;n que 
                                      tambi&eacute;n asistieron.</span> </p>
                                    <p align="justify"><a href="scrapbook_velious_esp.jsp" class="bold2"><b><font face="Arial, Helvetica, sans-serif" size="2">Fiesta 
                                      de Lanzamiento de Velious</font></b></a><font face="Arial, Helvetica, sans-serif" size="2"> 
                                      <span class="bold">- <font color="#000000"><b>La 
                                      Fiesta de Lanzamiento de Velious, celebrada 
                                      en Las Vegas, Nevada, el 5 y el 6 de noviembre, 
                                      dio a la prensa y al p&uacute;blico la posibilidad 
                                      de conocer personalmente la &uacute;ltima 
                                      expansi&oacute;n del creciente mundo de 
                                      EverQuest antes de su lanzamiento oficial.</b></font></span></font></p>
                                    <p align="justify">&nbsp;</p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
