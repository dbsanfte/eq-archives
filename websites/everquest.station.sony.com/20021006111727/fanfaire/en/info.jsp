...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/info.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/info.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="left"><br>
                                      <span class="bold">Fan Faire is the real-life 
                                      social event for players of EverQuest. The 
                                      event is held several times each year in 
                                      regions throughout the country. Fan Faire 
                                      is a great place to</span>
                                    <p class="bold">&middot; Meet other players 
                                      in a fun environment<br>
                                      &middot; Mingle with Sony Online Entertainment 
                                      employees involved with the game<br>
                                      &middot; Participate in panel discussion 
                                      on many game-related topics<br>
                                      &middot; Play EverQuest-themed live events<br>
                                      &middot; Win great prizes<br>
                                      &middot; Buy collectible EverQuest items, 
                                      T-shirts, and more!</p>
                                    <p class="bold">Events from past Fan Faires 
                                      have included the Live Quest, with volunteers 
                                      portraying non-player characters who hand 
                                      out puzzles and tasks for participants to 
                                      complete, and an actual in-game event that 
                                      was projected onto a big screen for attendees 
                                      to enjoy.</p>
                                    <p><span class="bold">Fan Faire gets bigger 
                                      and bigger with each event, so who knows 
                                      what the future will hold? Check back for 
                                      events to be held near you and join in the 
                                      fun!</span><br>
                                    </p>
                                    <p align="left"><br>
                                    <p align="left">&nbsp; 
