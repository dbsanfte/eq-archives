	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_dallas.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_dallas.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_dallas.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td> 
                  ...
                  <p align="justify" class="text"><a href="report_dallas.jsp" class="links">The 
                    Mennix Report </a> - The Adam's Mark Hotel in beautiful downtown 
                    Dallas welcomed hundreds of EQ players for the fifth EverQuest 
                    Fan Faire conducted on January 25-26, and Mennix was once 
                    again on hand to provide his unique take on the event.</p>
                  <p class="text"><a href="winners_dallas.jsp" class="links">List 
                    of Winners</a> - Congratulations to team Black Company of 
                    the Tarew Marr server for winning the Real Life Quest held 
                    at the Dallas Fan Faire. Each member of the team will now 
                    be forever immortalized in the world of Norrath as EQ NPCs 
                    tell of their grand achievement. </p>
                  <p class="text"><a href="poem_dallas.jsp" class="links">EQ R 
                    Uber </a> - Einaugenwilly of the Iron Tower guild on Vallon 
                    Zek graced the Dallas Fan Faire audience with his poetry skills. 
                    With his permission, we are proud to present to everyone, 
                    EQ R Uber, an original work. </p>
                  <p class="text"><a href="guilds_dallas.jsp" class="links">Building 
                    Better Guilds </a> - One of the workshops at the Dallas Fan 
                    Faire was a discussion on how to build a better guild conducted 
                    by Brian "Auric" DeMarco. Brian provided guidelines on what 
                    makes a guild successful and what features players should 
                    look for when contemplating joining one. </p>
                  <p class="text"><a href="media/Dallas%20Fan%20Faire.mov" class="links">The 
                    Fan Faire Movie</a> - Get a feel for EverQuest Fan Faire with 
                    this short movie we put together with footage taken in Dallas. 
                    Special thanks to Don &quot;GM Pelegorian&quot; Conley and 
                    his wife Alexandra for providing the video.<br>
                  </p>
                  <p align="center" class="text" ><span class="links"><b><a href="scrapbook_dallas_photos.jsp" target="_top" class="links">Photo 
                    Gallery</a></b></span></p>
                                    </td>
              </tr>
            </table>
