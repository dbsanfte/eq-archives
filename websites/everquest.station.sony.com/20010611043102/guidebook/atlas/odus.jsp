...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">81931 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                        ...
                        <td> 
                          ...
                          <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr> 
                              ...
                              <td width="228" height="273" rowspan="3"><img src="images/map_odus_hi.gif" width="228" height="273" usemap="#cities" border="0"><map name="cities"><area shape="rect" coords="118,15,161,32" href="erudin.jsp"></map></td>
                              <td> 
                          ...
                          <table border="0" width="100%" cellpadding="20" cellspacing="0">
                            ...
                            <tr> 
                              ...
                              <td><font color="#333333">Odus was founded by 
                                  a human named Erud who, along with his followers, 
                                  left Antonica searching for a place to establish 
                                  a new enlightened society. Like any "enlightened" 
                                  conquerors, the Erudites took it upon themselves 
                                  to forcibly relocate the native inhabitants 
                                  of Odus. The Kerra, a once proud and noble feline 
                                  race, have been pushed from their lush homeland 
                                  to a small island off the western coast of Odus.</font></td>
                              <td> 
