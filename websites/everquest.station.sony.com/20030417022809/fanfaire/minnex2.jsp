...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/minnex2.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/minnex2.jsp');">
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr>
                <td> 
                  <b><span class="textBold"><br>
                    Saturday - And let Fan Faire Begin</span></b>
<p class="bold"><span class="text">Don&#146;t EQ players ever 
                    sleep? I had to get up early Saturday morning and when I got 
                    downstairs, I ran into a seething wave of human flesh and 
                    Fan Faire nametags. I saw how Friday night was celebrated, 
                    and I could not believe this many people would be up so early. 
                    Not only were they up, they were loud. Not loud in a loud 
                    sort of way, but loud in a there are so many people talking 
                    at the same time sort of way. Of course, many were talking 
                    about the previous night&#146;s exploits. </span></p>
                  <p class="bold"><span class="text">Cindy Archuleta began the 
                    day&#146;s events by introducing us Sony Verant people. You 
                    know how those things go. She would say our names, we would 
                    step up to the mic and say who were are and what we do. Sometimes 
                    one of us would try to throw in a bit more, try to get a laugh 
                    without getting things thrown at us. No one was really surprised 
                    that Lady Daegarmo was a dude.</span></p>
                  <p class="bold"><span class="text">After the introductions, 
                    the real life quest began. I can&#146;t really comment much 
                    on this quest. I spent most of my time staying out of the 
                    way. Everyone was so intent on finding all the items and NPCs, 
                    rushing back and forth, trying not to let other groups see 
                    what they were up to, no one had time to worry about a simple 
                    writer with a digital camera. If I was in the way, I think 
                    the common perception was that by being in the way I gave 
                    implicit permission to mow me down. Not that it happened. 
                    I be quick on me feet! </span></p>
                  <p class="bold"><span class="text">The real life quest ended 
                    with Drinal claiming victory. Congrats to the Drinal crew!</span></p>
                  <p class="bold"><span class="text">After the real life quest, 
                    various reps from Sony Verant broke off from the crowd to 
                    take part in panel discussions. I actually took part in one 
                    of these. I was on the EQ Personalities panel consisting of 
                    Lady Daegarmo, Ester the Tester, Absor, and Arkriss. No matter 
                    how many times Ester had to remind some people that we were 
                    not game designers, we still got a slew of questions that 
                    we had no idea how to answer. That&#146;s why we are considered 
                    &#147;EQ Personalities&#148;. Ester fielded many questions 
                    regarding EQ testing, and Lady D took the &#147;why did you 
                    make that event rule&#148; type grilling. Absor and Arkriss 
                    spoke about the message boards, while I sat there and did 
                    that chin-grabbing, nodding head motion that made me look 
                    like I knew exactly what everyone was talking about. Oh, I 
                    did get my Harpy&#146;s Head Tavern plugs in too.</span></p>
                  <p class="bold"><span class="text">The panels came to and end 
                    and preparations began for the trivia quest. Where the real 
                    life quest consisted of groups created by server name, the 
                    trivia quest groups were divided by class. What was the trivia 
                    quest? Well, to put it simply, it was trivia. The Rangers 
                    won&#133;again. Just like they did at the Vegas Gathering. 
                    Who said Rangers are worthless?</span></p>
                  <p class="bold"><span class="text">Dinner was then served. Well, 
                    not just then. Everyone had to wait in the hall before the 
                    ballroom doors were opened again, this time with dinner tables 
                    set up. Sorry everyone, Cindy had the wait staff working as 
                    fast as they could to get dinner ready thus causing a bit 
                    of delay and a very thick waiting line. </span></p>
                  <p class="bold"><span class="text">I grabbed a seat with a group 
                    from Karana and actually sat down for the first time all day. 
                    Dinner was good, but there were some comments about the lack 
                    of selection. No &#147;chicken or beef&#148; choices this 
                    time. Don&#146;t worry, those comments were heard and will 
                    be addressed. Once dinner ended, I thanked my Karana hosts 
                    and got up to finish up a few more things like taking some 
                    more pics, which I just looked at and found most of them are 
                    blurred.</span></p>
                  <p class="bold"><span class="text">The official Fan Faire ended, 
                    but it was Saturday night and not many people were ready to 
                    go home. Still had another weekend night to celebrate. And 
                    celebrate they did.</span></p>
                  <p class="bold"><span class="text">How do I get talked into 
                    these things?</span></p>
                  <p class="bold"><span class="text">Heading into the Inner Harbor 
                    was out of the question. No need to go into details why. I 
                    found myself being offered a seat with some Xegony folks in 
                    Champions Sports Bar. We sat around and talked about our previous 
                    Xegony exploits&#133; no, not game exploits&#133; and had 
                    a good time. Sad thing was, they had some other things to 
                    do and left me there by myself&#133;for about two minutes 
                    until Tarew Marr&#146;s Dogs of War called me over. Who was 
                    I to turn them down? The Dogs of War taught me many things 
                    that Saturday night. I learned that if you camp a table all 
                    night, the spawn rate of beverages increases, especially when 
                    a credit card is offered up to cover the tab. I learned that 
                    no matter how many times I explain that I am a writer, I am 
                    still asked very detailed game design questions. Can&#146;t 
                    even count how many times I had to fall back to my standard 
                    answer of, &#147;I don&#146;t know&#148;. Overall, the Dogs 
                    of War made great hosts! Thanks!</span></p>
                  <p class="bold"><span class="text">One would think that once 
                    the Champions manager declared to the room, &#147;Champions 
                    is officially closed for the evening, thankfully&#148;, the 
                    night was over. Oh no, far from it. Time to camp the lobby 
                    and continue with what was being discussed. What was being 
                    discussed? Someone fill me in please. I did hear that the 
                    Champion servers made more in tips that one night then they 
                    normally do in three months.</span></p>
                  <p class="bold"><span class="text">Exhaustion was taking its 
                    toll. Sleep tugged at the very fabric of my being. I raced 
                    sunrise to my room and just beat it by the slimmest of margins. 
                    Never has a hotel bed looked more inviting.</span></p>
                  <p class="bold"><span class="textBold">Recuperation</span></p>
                  <p class="bold"><span class="text">It was Sunday. The Fan Faire 
                    over and no appointments to keep. Sometime after the noon 
                    hour, I arose from my tomb, saw the dreary winter light peeking 
                    through the curtains, and smiled. To me, the Fan Faire was 
                    a great success. There was not one single moment that I did 
                    not have fun. When I was a GM, I always bragged about how 
                    cool the players were (hey, I like the EQ players ok?) Having 
                    met some of them in person, I look forward to the next Fan 
                    Faire in San Diego this coming April.</span></p>
                  <p class="text">After I smiled, I went back to sleep.<br>
                  </p>
                  <p align="justify"><span class="text">Steve &quot;Mennix Fuzzknuckle&quot; 
                    Fuller<br>
