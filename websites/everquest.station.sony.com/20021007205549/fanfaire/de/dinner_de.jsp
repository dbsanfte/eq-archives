...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/dinner_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="128,46,246,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/dinner_de.jsp');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->                                    
                                    <div align="justify"> 
                                      ...
                                      <p align="center"><font size="4"><b>Schenken 
                                        Sie diesen Guides eine Runde Applaus</b></font></p>
                                      <p class="bold" align="justify">Wie es bereits 
                                        bei den letzten paar Fanmessen &uuml;blich 
                                        war, sah die Freitag Nacht das Zusammentreffen 
                                        von zahlreichen EverQuest-Guides zum Anlass 
                                        des Dinners zur Anerkennung der Guides, das von 
                                        Verant f&uuml;r das Guide-Programm organisiert 
                                        wurde, bereits kommen. Dieses Dinner hat 
                                        einzig und allein folgenden Grund: Verants Art ein 
                                        &quot;Dankesch&ouml;n&quot; auszusprechen 
                                        an alle Freiwilligen, die ihre Zeit opferten, 
                                        um ihren Mitspielern hilfreich zur Seite 
                                        zu stehen. Begleitet vom Erscheinen zahlreicher 
                                        &quot;Verant-Ber&uuml;hmtheiten&quot;, 
                                        GMs und anderen anderer Verant-Angestellten, 
                                        hatten die Anwesenden die M&ouml;glichkeit, 
                                        diese auch pers&ouml;nlich kennen zu lernen 
                                        - f&uuml;r das Gros der Anwesenden war 
                                        dies die erste M&ouml;glichkeit dazu - 
                                        um somit anschlie&szlig;end Gesichter 
                                        mit Namen verbinden zu k&ouml;nnen.</p>
                                      <p class="bold" align="justify"><span class="bold">Um 
                                        das Eis zu brechen, begann der Abend mit 
                                        einem Spiel. Jede Person hatte ein kleines 
                                        Anh&auml;ngeschildchen, das an der R&uuml;ckseite 
                                        von Hemden oder Kr&auml;gen angebracht 
                                        war. Die Schildchen waren mit einer kurzen 
                                        Phrase beschrieben, die in irgendeiner 
                                        Weise etwas mit EverQuest zu tun hatte. 
                                        Die Idee bestand darin, die Anwesenden 
                                        untereinander zu vermischen, so dass sie 
                                        sich untereinander befragen mussten. Die 
                                        Fragen konnten entweder mit &quot;Ja&quot; 
                                        oder &quot;Nein&quot; beantwortet werden 
                                        und daraufhin mussten die Anwesenden alle 
                                        Informationen nutzen, um daraus zu folgern, 
                                        was jeder Einzelne denn genau darstelle. 
                                        Einige Aufgaben waren leicht, andere jedoch 
                                        unglaublich schwer zu l&ouml;sen... und 
                                        all dies war abh&auml;ngig von dem Wissen, 
                                        das die jeweilige Person in Hinblick auf 
                                        das Spiel aufweisen konnte. Ich bin besch&auml;mt, 
                                        mitteilen zu m&uuml;ssen, dass ich mit 
                                        meinem - so wie ich denn erw&auml;ge - 
                                        ernormen<img src="screenshots/MVC00052_sml.jpg" width="200" height="150" align="left" vspace="10" hspace="10"> 
                                        Wissen &uuml;ber das Spiel doch einige 
                                        Zeit damit zu k&auml;mpfen hatte herauszufinden, 
                                        dass ich ein Dragoon Dolch war (um hier 
                                        dann doch fair zu sein, der Gro&szlig;teil der 
                                        Zeit wurde damit verbracht, als ich die 
                                        Sache endlich auf einen allgemeinen Begriff 
                                        eingrenzen konnte, da es doch einige non-proc'ing 
                                        magischen Dolche im Spiel gibt). Unser 
                                        eigener Absor war nicht nur ein NPC, sondern 
                                        auch eine &quot;Zone&quot;. K&ouml;nnen 
                                        Sie vermuten, wer/was er war? Wenn Sie 
                                        auf Najena getippt h&auml;tten, w&auml;ren 
                                        Sie richtig gelegen.</span></p>
                                      <p class="bold" align="justify">&Uuml;ber 
                                        mehr als ein Dutzend Tische verteilt und 
                                        jeder Tisch mit ungef&auml;hr einem Dutzend 
                                        Sitzpl&auml;tzen best&uuml;ckt, erfreute 
                                        sich jedermann an einem exzellenten Mahl 
                                        mit erstklassigen Rippchen, gekochten 
                                        Kartoffeln und Gem&uuml;se, das von einem 
                                        Kirsch-Creme Dessert, serviert in einer 
                                        &uuml;ppigen Muschel aus dunkler Schokolade, 
                                        abgeschlossen wurde. Zwischen den einzelnen 
                                        Men&uuml;g&auml;ngen wurden die Anwesenden 
                                        zu einem Update des NSS (Norrathian Secret 
                                        Service, ein fiktiver Name f&uuml;r die 
                                        Guides und GMs) geladen, worauf eine Aufmachung 
                                        einer fiktiven Nachrichtensendung folgte. 
                                        Die Anwesenden lauschten zu Unterhaltungsnachrichten 
                                        &uuml;ber die &quot;Shammies&quot;, die 
                                        Auszeichnungen verliehen f&uuml;r Songs 
                                        wie &quot;Stop Dragging My Corpse Around&quot;, 
                                        &quot;Like a Newbie&quot; und &quot;Midnight 
                                        Train to Mistmoore&quot;. In den &uuml;brigen, 
                                        wichtigeren Nachrichten, lie&szlig; der 
                                        aktuellste Wetterbericht verlauten, dass 
                                        es auf dem Kontinent Velious zu einem 
                                        K&auml;lteeinbruch kam, der heftige Schneef&auml;lle 
                                        mit sich brachte. Die NSS, die den Wetterservice 
                                        von Norrath leitet, lie&szlig; verlauten, 
                                        dass von der K&auml;lte und dem Schnee 
                                        lediglich erwartet wird, dass beide auf 
                                        ewig anhalten werden und dass es nun doch 
                                        wirlich keine Gr&uuml;nde f&uuml;r einen 
                                        Alarm g&auml;be.</p>
                                      <p class="bold" align="justify"><span class="bold">Um 
                                        ein weiteres Kennenlernen untereinander 
                                        zu erleichtern, sorgte die Event-Koordinatorin 
                                        Cindy Archuleta daf&uuml;r, dass sich 
                                        s&auml;mtliche Mitarbeiter von Verant 
                                        den Anwesenden selbst vorstellten. Es 
                                        ist nicht gerade verwunderlich, dass der 
                                        meiste Applaus vertrauten Namen wie Absor 
                                        oder Akriss Flamewalker geb&uuml;hrte, 
                                        w&auml;hrend die Begr&uuml;&szlig;ung 
                                        f&uuml;r die &uuml;brigen, die nicht sehr 
                                        viel Kontakt mit dem Publikum hatten, 
                                        ein wenig k&uuml;hler ausfiel - wie jedoch 
                                        auch erwartet werden kann. Die Begr&uuml;&szlig;ung 
                                        der GMs und Senior-<img src="screenshots/MVC00055_sml.jpg" width="200" height="150" align="right" vspace="10" hspace="10">Guides, 
                                        fiel weitaus w&auml;rmer aus, da zahlreiche 
                                        G&auml;ste durch ihre Zusammenarbeit im 
                                        Hinblick auf die Bearbeitung von Eingabepetitionen 
                                        bereits Online-Freundschaften untereinander 
                                        geschlossen haben. </span></p>
                                      <p class="bold" align="justify">Als die 
                                        Einleitungen sowie das Dinner dem Ende 
                                        nahe kamen, betrat der Elder-Guide Semiramis 
                                        das Podium, um seinen pers&ouml;nlichen 
                                        und besonderen Dank an alle Guides auszusprechen, 
                                        die ihre Zeit opfernd zur Verf&uuml;gung 
                                        stellten. Wenn die Guides, die ihre Zeit 
                                        so ehrw&uuml;rdig anbieten, dies nicht 
                                        praktizieren w&uuml;rden, um ihren Mitspielern 
                                        bei allen Anliegen - von feststeckenden 
                                        Leichen bis zu strittigen Belagerungen 
                                        - behilflich zu sein, w&auml;re Norrath 
                                        ein weitaus weniger freundlicher Ort. 
                                        So, das n&auml;chste Mal, wenn Sie ein 
                                        Thema beim Spielen und eine Petition an 
                                        einen Guide haben, denken Sie bitte daran, 
                                        wer auf der Empf&auml;ngerseite dieser 
                                        Petition zu finden ist. Ein Guide ist 
                                        ein Spieler genau wie Sie es einer sind 
                                        und er erh&auml;lt keinerlei monet&auml;re 
                                        Bezahlung f&uuml;r das, was er tut. Sie 
                                        stellen ihre Zeit zur Verf&uuml;gung, 
                                        nur um aus Norrath einen besseren Ort 
                                        zu machen und aus dem Grund, sich ab und 
                                        zu ein wenig Anerkennung zu verdienen.</p>
                                      <p class="bold" align="justify"><font size="1"><i> 
                                        </i><br>
                                        </font></p>
                                      <p>&nbsp;</p>
                                    </div>
