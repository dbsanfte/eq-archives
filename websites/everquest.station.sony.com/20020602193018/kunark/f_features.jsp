      ...
      <table width="159" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td valign="top" width="159" background="images/main_column_tile.jpg"> 
            <center>
              <p align="center"><img src="images/m_features1.gif" width="80" height="24" name="b1" border="0" alt="FEATURES">
...
<center>
      ...
      <ul>
        <li><p>An entire new continent, called Kunark, located south of Faydwer.</p></li>
        <li><p>20+ Brand New Zones, including newbie zones all the way up to zones filled with dragons.</p></li>
        <li><p>A huge array of new, even more visually stunning NPCs.</p></li>
        <li><p>A more detailed world, using more polygons and larger textures.</p></li>
        <li><p>More animation of objects throughout the new continent.</p></li>
        <li><p>New Playable Race, the Iksar (Lizardman).</p></li>
        <li><p>Lizardmen are neutral/evil and can be Monks.</p></li>
        <li><p>New ships will sail from both Antonica and Faydwer to Kunark.</p></li>
        <li><p>New cover and box art by famous fantasy artist Keith Parkinson.</p></li>
        <li><p>The ability for players to exceed the previous level 50 limit.</p></li>
      </ul>
