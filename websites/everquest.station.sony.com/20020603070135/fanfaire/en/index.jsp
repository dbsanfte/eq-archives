      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr> 
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" --> 
            <div align="center" class="bold">Make plans now to join us on August 
              2-3 in Boston at the <a href="hotel.jsp" class="bold2">Boston Park 
              Plaza Hotel</a> for Fan Faire! <br>
              <br>
              The registration deadline is July 22nd, but <a href="https://store.station.sony.com/fanfaire/en/registration.jsp" class="bold2">make 
              your reservations</a> early. Our Seattle Fan Faire sold out in record 
              time, and there's a lot of interest in this one, so don't miss out!<br>
            </div>
            <div align="center"> 
