	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/dinner.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/dinner.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/dinner.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <p align="center"><b>Give Those Guides a Round of Applause</b></p>
                  <p class="bold" align="justify"><span class="text">As has been 
                    the custom for the last few fan events, Friday night saw the 
                    coming together of many EverQuest guides for the Guide Appreciation 
                    Dinner thrown by Verant for the Guide Program. The dinner 
                    is just that: Verant&#146;s way of saying &#147;thank you&#148; 
                    to all of the volunteers who donate their time to help their 
                    fellow players. Joined by a handful of &#147;Verant celebrities&#148;, 
                    GMs, and other Verant employees, attendees had the opportunity 
                    to meet face to face, many for the first time ever, and finally 
                    put faces to names.</span></p>
                  <p class="bold" align="justify"><span class="text">The evening 
                    began with a game designed to break the ice. Each person had 
                    a small tag pinned to the backs of their shirts or collars 
                    upon which was a phrase having something to do with EverQuest. 
                    The idea was to mingle with others and ask questions that 
                    could be answered with a &#147;yes&#148; or a &#147;no&#148; 
                    and then use that information to try to deduce just exactly 
                    what you were. Some were easy, some were unbelievably difficult&#133; 
                    and all of them depended upon the person&#146;s knowledge 
                    of the game. I am ashamed to admit that with what I consider 
                    to be my relatively vast <img src="screenshots/MVC00052_sml.jpg" width="200" height="150" align="left" vspace="10" hspace="10">knowledge 
                    of the game, it took me quite a while to discover that I was 
                    a Dragoon Dirk (to be fair here, most of the time was spent 
                    once I was able to narrow it down to a general item because 
                    there are quite a few non-proc&#146;ing magical daggers in 
                    the game). Our very own Absor was not only an NPC, but also 
                    a zone. Can you guess who/what he was? If you guessed Najena, 
                    you&#146;d be right.</span></p>
                  <p class="bold" align="justify"><span class="text">Filling over 
                    a dozen tables, each with about a dozen seats a piece, everyone 
                    enjoyed an excellent meal of prime rib, boiled potatoes, and 
                    vegetables, which was followed by a cherry cr&egrave;me dessert 
                    in a rich, dark-chocolate shell. In between courses, guests 
                    were treated to an update from the NSS (Norrathian Secret 
                    Service, a fictitious name for the Guides and GMs), which 
                    followed the format of a fictional newscast. Attendees were 
                    treated to entertainment news about the &#147;Shammies&#148; 
                    which granted awards to songs such as &#147;Stop Dragging 
                    My Corpse Around&#148;, &#147;Like a Newbie&#148;, and &#147;Midnight 
                    Train to Mistmoore.&#148; In other, more important, news, 
                    the most current weather report stated that a cold snap had 
                    occurred on the continent of Velious causing heavy snow. The 
                    NSS, which oversees the Norrathian Weather Service, announced 
                    that the cold and snow was only expected to last forever and 
                    that there was no cause for alarm.</span></p>
                  <p class="bold" align="justify"><span class="text">To further 
                    facilitate everyone getting to know one another, event coordinator 
                    Cindy Archuleta had all Verant employees introduce themselves 
                    to the room. Not surprisingly, the most applause went to familiar 
                    names like Absor and Akriss Flamewalker, while reception was 
                    a little cooler for other folks that really don&#146;t have 
                    much contact with the public, as can be expected. Reception 
                    was much warmer for the GMs and Senior <img src="screenshots/MVC00055_sml.jpg" width="200" height="150" align="right" vspace="10" hspace="10">Guides, 
                    as many folks had already formed online friendships with one 
                    another by working the petition queues together.</span></p>
                  <p class="bold" align="justify"><span class="text">Once introductions 
                    were finished and dinner was done, Elder Guide Semiramis took 
                    to the podium to offer a special personal thanks to all of 
                    the guides who volunteer their time. If not for the guides 
                    who graciously offer their time to help their fellow players 
                    with everything from stuck corpses to disputed camps, Norrath 
                    would be a much less friendly place. So, next time you have 
                    an issue in game and /petition for a guide, remember who&#146;s 
                    on the receiving end of that petition. A guide is a player 
                    just like you, and they don&#146;t get paid monetarily for 
                    what they do. They donate their time just to make Norrath 
                    a better place and because of that, they deserve some appreciation 
                    now and then.</span></p>
