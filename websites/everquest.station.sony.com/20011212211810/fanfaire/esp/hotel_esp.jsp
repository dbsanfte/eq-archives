...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>60505 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <tr> 
                            <td width="98%"  background="../images/translucent2.gif" valign=top height="291"> 
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> <span class="bold">Haga 
                                    planes ya mismo para estar con nosotros en 
                                    Dallas del 25 al 26 de enero en <a href="http://www.adamsmark.com/dallas/index.asp" target="_blank" class="bold2">el 
                                    hotel Adam&Otilde;s Mark</a>. &iexcl;Inscr&iacute;base 
                                    cuanto antes para no desaprovechar una gran 
                                    oportunidad de pasarlo bien! </span> 
                                    <p align="left"><span class="bold"> . Hemos 
                                      acordado con el hotel una tarifa especial 
                                      para quienes asistan a la Fan Faire. Al 
                                      reservar tu habitaci&oacute;n, menciona 
                                      que participar&aacute;s en la Fan Faire 
                                      de EverQuest y de ese modo pagar&aacute;s 
                                      $99 por noche. Por m&aacute;s informaci&oacute;n 
                                      visita su <a href="http://www.adamsmark.com/dallas/index.asp" target="_blank" class="bold2">sitio</a>.<br>
                                      </span><br>
                                    </p>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr> 
