	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/general_info.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/general_info.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr>
                <td>
                  <div align="center"><img src="images/general_info_header.gif"></div>
                </td>
              </tr>
              <tr>
                <td>
                  <p align="left"><br>
                    <span class="text">Fan Faire is the real-life social event for players of EverQuest. The event is held several times each year in regions throughout the country. Fan Faire is a great place to </span>
                  <p class="bold"><span class="text">&middot; Meet other players 
                    in a fun environment<br>
                    &middot; Mingle with many of the master minds behind the game 
                    from SOE.<br>
                    &middot; Participate in panel discussion on many game-related 
                    topics<br>
                    &middot; Play EverQuest and EverQuest II themed live events<br>
                    &middot; Win great prizes<br>
                    &middot; Buy collectible EverQuest items, T-shirts, and more!</span></p>
                  <p class="bold"><span class="text">Events from past Fan Faires 
                    have included the Live Quest, with volunteers portraying non-player 
                    characters who hand out puzzles and tasks for participants 
                    to complete, and an actual in-game event that was projected 
                    onto a big screen for attendees to enjoy.</span></p>
                  <p><span class="text">Fan Faire gets bigger and bigger with 
                    each event, so who knows what the future will hold? Check 
                    back for events to be held near you and join in the fun!</span><br>
                  </p>
                                    </td>
              </tr>
            </table>
