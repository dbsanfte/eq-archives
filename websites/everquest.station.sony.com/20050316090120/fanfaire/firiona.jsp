	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/firiona.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/firiona.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/firiona.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td> 
                  <p class="bold" align="justify"><span class="text">Firiona Vie 
                    plays Firiona Vie with Firiona Vie in Firiona Vie!</span></p>
                  <p class="bold" align="justify"><span class="text">Whew! Don't 
                    try to say that more than once. What does it mean?</span></p>
                  <p class="bold" align="justify"><span class="text">At the Fan 
                    Faire in Baltimore, Quest Masters Tunso (Mark Halash) and 
                    Zatozia (Lydia Pope) had a blast! We were able to perform 
                    an in-game Quest for the enjoyment of the fans during the 
                    Quest Team panel discussion. Two lucky fans, Donny and Steve, 
                    were selected to play the part of Fluffy the Bear, a diseased 
                    pet roaming around in Misty Thicket. The Quest was performed 
                    on The Torvonnilous and The Rathe servers.</span></p>
                  <p class="bold" align="justify"><span class="text">We began 
                    with only about a hundred players surrounding us. By the end 
                    of the Quest's second run, the Grand Ballroom was filled with 
                    sounds of cheers for Fluffy the Bear! Many wanted Fluffy to 
                    kill the poor innocent halflings, but there were just as many 
                    cheers for the in-game player heroes who brought Fluffy a 
                    cure from its owner. At the end, players were given the opportunity 
                    to get answers to questions about dynamic Quests. </span></p>
                  <p class="bold" align="justify"><span class="text">Late Saturday 
                    night after the Fan Faire Events, Denise Harris, the &quot;real 
                    life&quot; Firiona Vie, got to play EverQuest for the first 
                    time at the Quest Troupe Party. Denise roleplayed with the 
                    players as one of the Quest Troupe actors that portrays Firiona 
                    Vie in-game coached her to portray Firiona Vie in the zone 
                    Firiona Vie. She did an excellent job at roleplaying. After 
                    killing an Iksar attacker (a Quest Troupe actor) with the 
                    sword Nature's Defender, Firiona Vie remarked, &quot;This 
                    sword is sweet!&quot;</span></p>
                  <p class="bold" align="justify"><span class="text">Denise wanted 
                    to thank everyone for allowing her this opportunity and states 
                    that she will be playing EverQuest again!</span></p>
                  <p class="bold" align="justify"><span class="text"><br>
                    Lydia Pope<br>
                    Quest Master<br>
                    ~ Zatozia the Torturess ~</span></p>
                          ...
                          <p><a href="screenshots/Party1Mark.jpg" class="links"><b>Quest 
                            Master &quot;Tunso&quot; - Mark Halash</b></a> </p>
                                            </center>
                                          </td>
                                          <td>
                                            <center>
                          ...
                          <p><a href="screenshots/Party2Lydia.jpg" class="links"><b>Quest 
                            Master &quot;Zatozia the Torturess&quot; - Lydia Pope</b></a> 
                          </p>
                                            </center>
                                          </td>
                                        </tr>
                          ...
                          <p><a href="screenshots/Party3Firionas.jpg" class="links"><b>Quest 
                            Troupe member Shiria and Firiona Vie</b> </a> </p>
                                            </center>
                                          </td>
                                          <td valign=top>
                                            <center>
                          ...
                          <p><a href="screenshots/Party4Denise1.jpg" class="links"><b>Firiona 
                            Vie - Denise Harris </b></a></p>
                                            </center>
                                          </td>
                                        </tr>
                                        <tr>
                        ...
                        <div align="center"> 
                          ...
                          <p><a href="screenshots/Party5Denise2.jpg" class="links"><b>Denise 
                            being trained by Quest Troupe member Shiria</b></a><b><br>
                                                </b><b>
                                                </b>
                                              </p>
                                            </div>
                          ...
                          <p><a href="screenshots/Party6Denise3.jpg" class="links"><b>Firiona 
                            Vie as Firiona Vie in Firiona Vie</b></a> </p>
                                            </center>
                                          </td>
                                        </tr>
                                        <tr>
                          ...
                          <p><a href="screenshots/Party7qtroupe.jpg" class="links"><b>Some 
                            members of the EverQuest Acting Troupe</b><br>
                                                </a>
                                                                                            </p>
                                            </center>
                                          </td>
