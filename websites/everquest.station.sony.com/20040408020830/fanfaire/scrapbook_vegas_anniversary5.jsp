	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_vegas_anniversary5.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_vegas_anniversary5.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_vegas_anniversary5.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
              ...
              <tr> 
                <td valign="top">
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr> 
                      <td align="center" valign="top"> <p><a href="/common/images/img_view.jsp?collection=EQ_vegas_fanfaire&name=IMG_6019.jpg" target="_new" onclick="return imgViewPopUp('EQ_vegas_fanfaire', 'IMG_6019.jpg');" class="links"><br>
                          <img src="images/vegas_photos/thumbs/IMG_6019t.jpg" width="200" height="133" border="0"></a></p>
                        <br> <br> </td>
                      <td align="center" valign="top"> <p><a href="/common/images/img_view.jsp?collection=EQ_vegas_fanfaire&name=new_engine.jpg" target="_new" onclick="return imgViewPopUp('EQ_vegas_fanfaire', 'new_engine.jpg');" class="links"><br>
                          <img src="images/vegas_photos/thumbs/new_enginet.jpg" width="200" height="133" border="0"></a></p>
                        <br> <br> </td>
                    </tr>
                  </table>
