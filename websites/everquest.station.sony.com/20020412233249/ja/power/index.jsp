...
<html DIR=LTR>
<head>
<title>EverQuest - Planes of Power-  Home</title>
...
<body bgcolor="#000000" text="#B64606"  onresize="resize();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/scrollbar_rollover_on.jpg');wow(1,'POWER');" background="images/flame_tile.jpg">
...
<div id="gnav_main" style="position:absolute; top:0px;left:0;width:780;height:88; z-index:1;">
			    <img src="/common/images/global_nav/ja//globalnav_main.gif" width="780" height="88" usemap="#Map" border="0">
</div>
...
if ( plugin && (navigator.userAgent.indexOf("MSIE")>=0)) {
	...
	document.write('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="302" height="47">');
  	document.write('	<param name=movie value="/common/images/global_nav/ja//stationlogo.swf?samewindow=true">');
  	document.write('	<param name=quality value=high>');
  	document.write('	<param name="LOOP" value="false">');
  	document.write('	<embed src="/common/images/global_nav/ja//stationlogo.swf?samewindow=true" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="302" height="47" loop="false">');
  	document.write('	</embed>');
	document.write('</object>');

} else{
	// Non-flash code
	document.write('<IMG SRC="/common/images/global_nav/ja//ident.gif" width="302" height="47" border="0">');
}
//-->
</SCRIPT></div>
...
<div id="gnav_welcome" style="position:absolute; top:64;left:26;width:120;height:9; z-index:2;"><img src="/common/images/global_nav/ja//welcome.gif" border="0" width="150" height="9"></div>
...
<div id="gnav_commstation" style="position:absolute; top:64;left:240;width:75;height:21; z-index:2;">
				...
				<a href="javascript:gnav_call('http://www.station.sony.com/commstation/commstation_fs.jhtml');">
				    <img src="/common/images/global_nav/ja//comm_off.gif" border="0" width="75" height="21">
				</a>
...
<div id="gnav_ad" style="position:absolute; top:2;left:310;width:470;height:60; z-index:4;">
				...
				if(IE4){
					...
					document.write('<img src="/common/images/global_nav/ja//seethru.gif" width=1 height=60>');
				}
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="72,46,145,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?lang=ja&returnURL=http://everquest.station.sony.com/ja/power/index.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="149,46,225,63" href="javascript:gnav_call('http://www.station.sony.com/services/ja/register.jhtml');">

  <!-- Play Games --><area shape="rect" coords="320,66,383,83" href="javascript:gnav_call('http://www2.station.sony.com/ja/');" onmouseover="gnav_showmenu();" onmouseout="gnav_hidemenu();">
  <!-- Win        --><area shape="rect" coords="385,66,437,83" href="javascript:gnav_call('http://www2.station.sony.com/ja/win/');">
  <!-- Community  --><area shape="rect" coords="439,66,552,83" href="javascript:gnav_call('http://www2.station.sony.com/ja/talk.jsp');">
  <!-- Shop       --><area shape="rect" coords="554,66,626,83" href="javascript:gnav_call('https://store.station.sony.com');">
  <!-- My Account --><area shape="rect" coords="628,66,714,83" href="javascript:gnav_call('http://www.station.sony.com/services/accountinfo.jhtml');">
  <!-- Help       --><area shape="rect" coords="716,66,779,83" href="javascript:gnav_call('http://services.station.sony.com/ja/help.jsp');">
</map>
...
<center>
  <table border="0" cellpadding="0" cellspacing="0" width="780" height="811" bgcolor="#000000">
    <tr> 
      <td height="88" colspan="3"><img src="images/spacer.gif" height="88" width="1"></td>
    </tr>
    <tr> 
      <td valign="top" width="640"><br>
	  <script language="JavaScript">
...
<script language="JavaScript" type="text/javascript">
    ...
    <tr> 
      <td colspan="2" align="center" height="368" valign="top"> 
        <table border="0" cellpadding="0" cellspacing="0" width="660" height="305">
          <tr valign="top"> 
            <td colspan="2" align="center" height="17"><img src="images/ja_planeofflame.jpg" width="144" height="41"> 
            </td>
          </tr>
          <tr valign="top">
            <td colspan="2" align="center" height="59"><img src="images/ja_scrollbar_left.jpg" width="239" height="82"><a href="http://everquest.station.sony.com" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/scrollbar_rollover_on.jpg',1)"><img src="images/scrollbar_rollover.jpg" width="155" height="82" border="0" name="Image1"><img src="images/ja_scrollbar_right.jpg" width="243" height="82" border="0"></a></td>
          </tr>
          <tr valign="top"> 
            <td width="196" align="center" height="169"><img src="images/POPcover_sm.jpg" width="100" height="115"><br>
              <a href="http://www.keithparkinson.com" class="link">Keith Parkinson<br>
           のボックス アート</a></td>
            <td class="link" height="169" width="464">古代のパワーの王国を超えて行こう。そこでは伝説のクリーチャが古くから隠された秘密を守っている。 
              EverQuest: The Planes of Power は現世の物語ではない。これまでない大きな宝と挑戦がある。さらに、神々に直接対峙することができる。覚悟はよいか。プレーンが待っている。</td>
          </tr>
        </table>
...
<p align="center"><font color="#B64606" class="legal">EverQuest は Sony Computer Entertainment America Inc. の登録商標です。<br> &copy; 2002 Sony Computer Entertainment America Inc. すべての権利を留保する。 </font></p>
