...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/sorry_de.jsp?null');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <font color="#0851A0" size=6><b>Anmeldungen abgeschlossen</b></font> 
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="left"><span class="bold">Sehr 
                                      geehrte Damen und Herren, liebe EverQuest-Spieler 
                                      </span> </div>
                                    <p class="bold" align="left">Sony Online Entertainement 
                                      und Ubi Soft k&uuml;ndigten heute die Verschiebung 
                                      der europ&auml;ischen Fanmesse an. Unsere 
                                      europ&auml;ische Gemeinschaft von EverQuest&reg;-Spielern, 
                                      ist im letzten Jahr stark gewachsen, und 
                                      wir freuen uns sehr &uuml;ber all unsere 
                                      Initiative in diesem Markt und dar&uuml;ber 
                                      hinaus. Obwohl wir die Verschiebung eines 
                                      Anlasses, der in den USA einzigartig und 
                                      sehr erfolgreich ist, au&szlig;erordentlich 
                                      bedauern, sind wir davon &uuml;berzeugt, 
                                      dass unsere internationalen Bestrebungen 
                                      auch weiterhin den Spielspass f&ouml;rdern, 
                                      unsere internationale Fangemeinde erh&ouml;hen 
                                      und uns in den kommenden Monaten vermehrt 
                                      nach &Uuml;bersee f&uuml;hren werden. </p>
                                    <p class="bold" align="left">Wir m&ouml;chten 
                                      allen unseren Fans, die an diesem Er&ouml;ffnungsanlass 
                                      teilnehmen wollten, ganz herzlich danken 
                                      und werden Ihnen zus&auml;tzlich zu einer 
                                      vollen R&uuml;ckverg&uuml;tung ein spezielles 
                                      Geschenk unseres Fanmesse-Teams zukommen 
                                      lassen. Auch wir sind entt&auml;uscht, dass 
                                      wir Sie n&auml;chsten Monat nun doch nicht 
                                      treffen k&ouml;nnen, hoffen aber, dass unsere 
                                      Pr&auml;senz in Europa weiter zunehmen wird. 
                                      Die Verschiebung der Fanmesse wird uns helfen, 
                                      besser auf Ihre Bed&uuml;rfnisse eingehen 
                                      zu k&ouml;nnen und diesen Anlass zu einem 
                                      passenderen Zeitpunkt und an einem besser 
                                      geeigneten Ort abzuhalten. F&uuml;r allf&auml;llige 
                                      Unannehmlichkeiten m&ouml;chten wir uns 
                                      hiermit entschuldigen. </p>
                                    <p class="bold" align="left">EverQuest verf&uuml;gt 
                                      &uuml;ber mehr als 410'000 Spieler weltweit, 
                                      unter anderem in L&auml;ndern wie den USA, 
                                      England, Frankreich, Italien, Deutschland, 
                                      Kanada, Singapur, Zimbabwe, Saudi-Arabien 
                                      und Neuseeland. Erst k&uuml;rzlich k&uuml;ndigten 
                                      wir den Verkauf von Spielkarten an, welche 
                                      weltweit im Handel erh&auml;ltlich sind 
                                      und ihre Besitzer 90 Tage lang spielen lassen. 
                                      Au&szlig;erdem befinden wir uns in der Einf&uuml;hrungsphase 
                                      zum Einsatz eines menschlichen und automatischen 
                                      &Uuml;bersetzungsdienstes, vorerst f&uuml;r 
                                      die Sprachen Franz&ouml;sisch, Deutsch, 
                                      Japanisch und Koreanisch. </p>
                                    <p class="bold" align="left">Sony Online Entertainment 
                                      wird sich auch k&uuml;nftig daf&uuml;r einsetzen, 
                                      eine Br&uuml;cke zwischen den Nationen zu 
                                      schlagen und plant neue Servereins&auml;tze, 
                                      mit dem Hauptziel Europa. </p>
                                    <p class="bold" align="left">In diesem Winter, 
                                      k&ouml;nnen sich alle EverQuest-Spieler 
                                      auf die Einf&uuml;hrung von EverQuest: The 
                                      Shadows of Luclin(tm) freuen. Dieses neue 
                                      Erweiterungspaket verf&uuml;gt &uuml;ber 
                                      zauberhafte Mondlandschaften, spannende 
                                      Abenteuerzonen, neue Gegenst&auml;nde, Kreaturen 
                                      sowie Zauberspr&uuml;che, eine neue spielbare 
                                      Rasse und vieles mehr. </p>
                                    <p class="bold" align="left">Herzlichen Dank 
                                      f&uuml;r Ihre Unterst&uuml;tzung heute und 
                                      in Zukunft. </p>
                                    <p class="bold" align="left"> Cindy Archuleta<br>
