	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston_photos2.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston_photos2.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston_photos2.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                ...
                <td> 
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr> 
                      <td valign=top> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=altec" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=altec','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/altec_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=altec" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=altec','','width=640,height=480'); return false;" target="_blank" class="links">Altec Lansing <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=banner" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=banner','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/banner_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=banner" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=banner','','width=640,height=480'); return false;" target="_blank" class="links">Fan Faire Banner <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                    ...
                    <tr> 
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=brell" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=brell','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/brell_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=brell" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=brell','','width=640,height=480'); return false;" target="_blank" class="links">LFG <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                      <td valign=top> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=costume_a" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=costume_a','','width=480,height=640'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/costume_a_thumb.jpg" width="150" height="200" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=costume_a" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=costume_a','','width=480,height=640'); return false;" target="_blank" class="links">Rare Spawn <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                    ...
                    <tr> 
                      <td> 
                        <div align="center"> 
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=crealm" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=crealm','','width=480,height=640'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/crealm_thumb.jpg" width="150" height="200" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=crealm" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=crealm','','width=480,height=640'); return false;" target="_blank" class="links">Casters Realm <br>
                            </a></p>
                          <br>
                        </div>
                      </td>
                      <td valign=top> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=crowd_lower" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=crowd_lower','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/crowd_lower_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=crowd_lower" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=crowd_lower','','width=640,height=480'); return false;" target="_blank" class="links">Hill Giant Perspective <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                    ...
                    <tr> 
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=duck" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=duck','','width=480,height=640'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/duck_thumb.jpg" width="150" height="200" border="0"></a><br>
                           <a href="screenshots/ff_boston/screenshots.jsp?id=duck" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=duck','','width=480,height=640'); return false;" target="_blank" class="links"> An Epic? <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                      <td> 
                        <center>
                          <p><a href="screenshots/ff_boston/screenshots.jsp?id=foundry" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=foundry','','width=640,height=480'); return false;" target="_blank" class="links"><img src="screenshots/ff_boston/foundry_thumb.jpg" width="200" height="150" border="0"></a><br>
                            <a href="screenshots/ff_boston/screenshots.jsp?id=foundry" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=foundry','','width=640,height=480'); return false;" target="_blank" class="links">Fellowship Foundry <br>
                            </a></p>
                          <br>
                        </center>
                      </td>
                  ...
                  <p align="center"><a href="scrapbook_boston_photos3.jsp" class="links">Page 
                    3</a></p>
                                    </td>
              </tr>
            </table>
