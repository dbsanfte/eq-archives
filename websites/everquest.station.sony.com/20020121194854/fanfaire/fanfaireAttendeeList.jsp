...
<!--
  function openAttendeeWindow(box){
    var url = "attendees.jsp?sku=null&server="+box;
	...
	<td>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" background="">
		...
		<tr> 
			...
			<td rowspan="2" width="1"><img src="/common/images/global_nav//ff_logo.gif" width="154" height="105" border="0" usemap="#Logo"></td>
