...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/scrapbook_orlando_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="128,46,246,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/scrapbook_orlando_de.jsp');">
                                  ...
                                  <td><!-- #BeginEditable "content" -->								    
                                    <div align="justify"> 
                                      <p align="center"><b><font color="#000000"><br>
                                        Artikel </font></b></p>
<p align="justify" class="bold"><a href="wedding_orlando.jsp" class="bold2">Liebe ist in der Luft...</a>
- Am 6. Oktober, gaben sich zwei EverQuest-Spieler, Krissy und Dave das Ja-Wort im wirklichen Leben. Am 20. Oktober verheirateten sich auch ihre Spielfiguren auf dem Luclin-Server, und das vor Hunderten von Fanmesse-Besuchern. </p>
										                                      <p align="justify" class="bold"><a href="report_orlando_de.jsp" class="bold2">Der 
                                        Mennix Report</a> <span class="bold">- 
                                        Einmal mehr hat auch, Steve "Mennix" Fuller 
                                        die EverQuest-Fanmesse besucht und fasst 
                                        hier seine Gedanken über alles was so 
                                        in Orlando abging, in seiner ganz eigenen 
                                        Art und Weise zusammen. <br>
                                        </span></p>
                                      <p align="justify" class="bold"><a href="devbytes_orlando_de.jsp" class="bold2">Designer 
                                        Ton-Ausschnitte </a> <span class="bold">- 
                                        Im Produzenten-Diskussionsforum an der 
                                        Fanmesse, beantworteten Jeff Butler und 
                                        Bill Coyle alle m&ouml;glichen Fragen 
                                        von Klassenausgewogenheit bis zu den neuen 
                                        Inhalten von Luclin. H&ouml;ren Sie sich 
                                        einige Ausschnitte im MP3-Format an, oder 
                                        einfach ein paar ihrer Antworten. </span></p>
                                      <p align="justify" class="bold"><span class="bold"><a href="winners_orlando_de.jsp" class="bold2">Siegerliste</a> - Das Team X von Mithaniel Marr gewann die Live-Quest an der Fanmesse in Orlando. Jedes Mitglied dieser Gruppe wird eine Kopie von &#132;Shadows of Luclin&quot; erhalten, sobald die Erweiterung im Dezember erscheint. Gewinner der Lotterie werden Ihre Kopie von Luclin ebenfalls dann erhalten. <br>
                                        </span></p>
                                      <p align="center"><a href="scrapbook_orlando_photos.jsp" class="bold2"><font face="Arial, Helvetica, sans-serif" size="3">Fotogalerie</font></a></p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
