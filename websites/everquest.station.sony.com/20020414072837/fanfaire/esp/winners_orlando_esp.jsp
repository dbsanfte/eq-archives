...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/winners_orlando_esp.jsp?null');">
          ...
          <td> 
            <table width="75" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
				...
				<td><a href="index_esp.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image18','','../images/flag_sp_on.gif',1)"><img name="Image18" border="0" src="../images/flag_sp.gif" width="25" height="17"></a></td>
              </tr>
            </table>
          </td>
        </tr>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center"><b>Fan Faire de Orlando : Lista de ganadores</b>
                                    </div>
                                    <p align="center"><br>
                                      <b>Ganadores de la Live Quest</b><br>
                                      ...
                                      James Miller<br>
                                      Tina Stafford</p>
                                    <p align="center"><b>Ganadores en el sorteo de la suerte</b><br>
                                      James Imlay<br>
                                      Faye Johnston<br>
                                      Bud Anderegg<br>
                                      Glen Smith<br>
