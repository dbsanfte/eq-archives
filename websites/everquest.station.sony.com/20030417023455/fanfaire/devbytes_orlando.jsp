...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/devbytes_orlando.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/devbytes_orlando.jsp');">
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td><span class="text">EverQuest Producer Jeff Butler and Assistant 
                  Producer Bill Coyle answer question during the Producer's Discussion 
                  Panel at the Orlando Fan Faire. </span> 
                  <p class="bold"> <a href="sounds/01-L1CM.mp3" class="links">Bill 
                    Coyle talks about the balance between PvP and PvE.</a></p>
                  <p class="bold">
                    <a href="sounds/02-L1CM.mp3" class="links">Jeff Butler 
                    says player houses not on the list for development.</a></p>
                  <p class="bold"> <a href="sounds/03-L1CM.mp3" class="links">More 
                    on player owned housing.</a></p>
                  <p class="bold"> <a href="sounds/04-L1CM.mp3" class="links">Money 
                    sinks, and wanted features</a></p>
                  <p class="bold"> <a href="sounds/05-L1CM.mp3" class="links">Jousting 
                    competitions would be cool!</a></p>
                  <p class="bold"> <a href="sounds/06-L1CM.mp3" class="links">Go 
                    ask Lawrence, but here's my opinion anyway.</a></p>
                  <p class="bold"> <a href="sounds/07-L1CM.mp3" class="links">Spawn 
                    times, European guilds, and server moves.</a></p>
                  <p class="bold"> <a href="sounds/08-L1CM.mp3" class="links">PvP 
                    race wars and cross teaming.</a></p>
                  <p class="bold"> <a href="sounds/09-L1CM.mp3" class="links">Cleric 
                    burn out at high levels.</a></p>
                  <p class="bold"> <a href="sounds/10-L1CM.mp3" class="links">More 
                    fun things to do with a cleric.</a></p>
                  <p class="bold"> <a href="sounds/11-L1CM.mp3" class="links">Sailing 
                    the great blue sea, and sailing, and sailing, and sailing.</a></p>
                  <p class="bold"><span class="bold">
                    </span> <a href="sounds/12-L1CM.mp3" class="links">Pathing 
                    in Luclin</a> </p>
                                    </td>
              </tr>
            </table>
