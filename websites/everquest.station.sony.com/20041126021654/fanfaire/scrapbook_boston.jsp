	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_boston.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  ...
                  <p align="justify" class="text"><a class="links" href="report_boston.jsp">The 
                    Mennix Report</a> - Didn't make it to Boston for the Fan Faire? 
                    Have no fear, Mennix was there! Check out his brief recap 
                    of all the fun.</p>
                  <p align="justify" class="text"><a href="winners_boston.jsp" class="links">List 
                    of Winners</a> - Congratulations to team Knights of the Tribunal 
                    for winning the Live Quest. Check out the entire List of Winners</p>
                  <p align="justify" class="text"><a href="media/EQ_FanFaire_Boston.wmv" class="links">Boston 
                    Fan Faire Movie</a> - Experience the sites and sounds of the 
                    EverQuest Boston Fan Faire</p>
                  <p align="center" class="text"><b><a href="scrapbook_boston_photos.jsp" target="_top" class="links">Photo 
                    Gallery</a></b></p>
                                    </td>
              </tr>
            </table>
