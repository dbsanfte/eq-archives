...
<style type="text/css">
<!--
#flashLayer		{position: absolute; visibility: hidden; z-index: 1000; left:0;  top: 85; clip:rect( ); height: 1px; width: 1px;}
...
//<!--
	...
	function gnav_showmenu()
	{
		 ...
		 var flashFile = InternetExplorer ? document.flashmovie : document.embeds[0];
		 var movie_ready = "false";
		 if(movie_ready == "false") {
		  while(movie_ready == "false")
		  {
		   if(flashFile.PercentLoaded() == 100) {
		    flashFile.TGotoLabel("_level0/gamesMenu/","open");
		    movie_ready = "true";
		   }
		  }
		 } else {
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/index.jsp?null');">
...
<div id="mainLayer"> 
  <table width="780" height="1395" border="0" cellspacing="0" cellpadding="0" align="center" background="new_images/test_bg.gif">
	<tr> 
	  <td valign="top"> 
		<table width="780" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="4"><img src="new_images/spacer.gif" width="780" height="387"></td>
	</tr>
	<tr>
	...
	<tr> 
	  <td align="center" background="new_images/test_bg.gif"valign="bottom">
	   ...
	   <font size="-2" color="3A485F">EverQuest, 
		...
		&copy; 2002 Sony Online Entertainment Inc. All rights reserved.</font> 
	  </td>
	</tr>
  </table>
</div>
<div id="leftLayer"> 
  <table width="1" height="100%" border="0" cellspacing="0" cellpadding="0" background="new_images/test_bg.gif">
	<tr> 
	  <td valign="top"><img src="new_images/eq_left.jpg" width="112" height="879"></td>
	</tr>
  </table>
</div>
<div id="rightLayer"> 
  <table width="1" height="100%" border="0" cellspacing="0" cellpadding="0" background="new_images/test_bg.gif">
	<tr> 
	  <td valign="top"><img src="new_images/eq_right.jpg" width="112" height="879"></td>
	</tr>
  </table>
</div>
<div id="contentLayer"> 
<table width="780" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
      ...
      <td align="center" background="" height="1"> 
        <a href="https://store.station.sony.com/eq_char_renames/"><img src="images/service_namechange.jpg" width="220" height="80" alt="" border="0" vspace="1"></a><a href="https://store.station.sony.com/eq_char_moves/"><img src="images/service_charactertransfer.jpg" width="220" height="80" alt="" border="0" vspace="1"></a>
              ...
              <tr> 
                ...
                <td colspan="7" height="170" rowspan="2" align="center">
                  ...
                  <table width="96%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
		              <td><b><a href="/eqlive/index.jsp#50201">Reduced Support Hours, Wednesday July 31</a></b></td>
                    </tr>
                  </table>
                  ...
                  <table width="96%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
		              <td><b><a href="/eqlive/index.jsp#49952">News of the Bazaar</a></b></td>
                    </tr>
                  </table>
                  <img src="/new_images/spacer.gif" width="10" height="10">
                  ...
                  <table width="96%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
		              <td><b><a href="/eqlive/index.jsp#49944">Cross Server Chat - An Unannounced Feature</a></b></td>
                    </tr>
                  </table>
                  <img src="/new_images/spacer.gif" width="10" height="10">
                  ...
                  <table width="96%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
		              <td><b><a href="/eqlive/index.jsp#49891">Character Transfer Service Update - PvP Moves now available!</a></b></td>
                    </tr>
                  </table>
                  <img src="/new_images/spacer.gif" width="10" height="10">
                  ...
                  <table width="96%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
		              <td><b><a href="/eqlive/index.jsp#49841">Update on the EQ Invasion Tour</a></b></td>
                    </tr>
                  </table>
                  <img src="/new_images/spacer.gif" width="10" height="10">
