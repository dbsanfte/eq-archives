...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>62143 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      ...
                                      <p align="justify" class="bold"><a href="report_minneapolis_esp.jsp" class="bold2">El 
                                        Informe Mennix</a> <span class="bold">- 
                                        Una vez m&aacute;s, Steve &quot;Mennix&quot; 
                                        Fuller nos cuenta sus impresiones de otra 
                                        Fan Faire. En este resumen, Steve analiza 
                                        todo el fin de semana con su particular 
                                        e irreverente estilo.<br>
                                        </span></p>
                                      <p align="justify"><a href="chicken_minneapolis_esp.jsp" class="bold2">La 
                                        Comunidad y una Gallina de Goma</a> <span class="bold">- 
                                        Gbear ten&iacute;a un plan que inclu&iacute;a 
                                        una gallina de goma. Refleja c&oacute;mo 
                                        un miembro de la comunidad Fan Faire reuni&oacute; 
                                        a sus amigos del juego online.</span></p>
                                      <p align="justify"><a href="sponsors_minneapolis_esp.jsp" class="bold2">Y 
                                        Ahora, Unas Palabras Sobre Nuestros Patrocinadores 
                                        </a> <span class="bold">- La Fan Faire 
                                        de Minneapolis registr&oacute; un incremento 
                                        en patrocinadores corporativos y vendedores. 
                                        Steve &quot;Mennix&quot; Fuller nos cuenta 
                                        sus impresiones sobre cada uno.</span></p>
                                      <p align="justify"><a href="winners_minneapolis_esp.jsp" class="bold2">Lista 
                                        de Ganadores</a> <span class="bold">- 
                                        El ganador de la Live Quest (misi&oacute;n 
                                        en vivo) fue el quipo Bristlebane, con 
                                        dos miembros adicionales de Seventh Hammer. 
                                        Cada ganador obtendr&aacute; una Espada 
                                        del Encuentro o un Cetro del Encuentro 
                                        que ofrecer&aacute; a uno de sus personajes. 
                                        Los ganadores de la Live Quest no son 
                                        los &uacute;nicos que reciben este art&iacute;culo 
                                        especial del juego en la Fan Faire; cuatro 
                                        afortunados jugadores que ganaron el concurso 
                                        de dibujo tambi&eacute;n tendr&aacute;n 
                                        la posibilidad de decidir cu&aacute;l 
                                        de sus personajes ostentar&aacute; un 
                                        arma nueva.<br>
                                        </span></p>
                                      <p align="center"><a href="scrapbook_minneapolis_photos_esp.jsp" class="bold2"><font face="Arial, Helvetica, sans-serif" size="3">Galer&iacute;a 
