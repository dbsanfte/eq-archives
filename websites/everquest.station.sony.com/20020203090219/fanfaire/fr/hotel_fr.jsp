...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>86802 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <tr> 
                            <td width="98%"  background="../images/translucent2.gif" valign=top height="291"> 
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> <span class="bold">Merci 
                                    pour votre participation &agrave; la Fan Faire 
                                    de Dallas. N'h&eacute;sitez pas &agrave; revenir 
                                    sur cette page pour obtenir des informations 
                                    concernant les futures Fan Faires</span>.<!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
