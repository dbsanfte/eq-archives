      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td background="images/tile.jpg" width="100%" align="right">
            ...
            <div align="center"><font color="#000000"><b><i>Journal Entry 6</i></b></font></div>
        ...
        <tr>
          ...
          <td colspan="3" background="images/tile.jpg">
            ...
            <p><font color="#000000">After several tests on the quadroliths, my experiments have finally proven to be successful once again.  When conducting translocation experiments with pieces of portal fragments, I discovered the correct incantation to perform a translocation to the dragon circles on the continent of Velious.  Unfortunately, I was not alone when I made this discovery, so no doubt news of my discovery will travel fast.</font></p>
            <p><font color="#000000">While I do not wish to discourage practitioners of wizardry from continuing with such useful research, I feel that I must advise them to use extreme caution with this study.  There are inherent dangers associated with the usage of the portal fragments.  The quadroliths will not be able to withstand years of chipping away.  I am attempting to develop a method of extracting the power by other means.</font></p>
            <p><font color="#000000">Using the journals that were in the magical chest that the foolish gypsy woman sent me, I was able to decipher the unique language that was in portions of ancient tomes that I had already obtained long ago. While this language was not that of the Combine Empire, it appeared somewhat similar.</font></p>
            <p><font color="#000000">After deciphering the symbols, maps, and scientific drawings of experiments that the Combine Empire detailed in their journals, I unearthed something very interesting about the Combine Empire.  Not only did the Combine know that they were about to disappear, they had actually planned on it.</font></p>
            <p><font color="#000000">The experiments or rituals, as less scientific minds might refer to them, that are detailed in the journals draft out unusual usage of power.  Remembering the body of glowing ore that I came across in the Burning Woods of Kunark, I decided to attempt to use the power from within it to re-create one of these experiments.</font></p>
            <p><font color="#000000">I immediately sent a message to my most trusted assistant, Makil Rargon, who was continuing with my fusibility research out in the vast Western Wastes of Velious.  I sent him to fetch one of the scrolls that I obtained from the ruins of Kunark, and a magical wand from my laboratory. Makil sent a somewhat trustworthy and quite useful individual to deliver the vital items to me so that he could continue with the fusibility research.</font></p>
            <p><font color="#000000">Once I received the items, I was prepared to conduct the experiment.  Of course, I could not test the experiment on myself.  Instead, I used the very messenger that was sent by my assistant as the test subject of the experiment.  In order to contain the power of the ore I gave the subject one of my runes, along with portal fragments, which were used as additional power sources.</font></p>
            <p><font color="#000000">With a series of draining and forceful spells, the power from within the glowing ore was transferred into my rune. A small portal began to open.  However, it did not remain open long enough to study it. Unfortunately, the power within the ore is stronger than a mortal can withstand.  The subject was resurrected by the powers of a priest, and dismissed.</font></p>
            <p><font color="#000000">Even with the portal closing, I do not claim that this experiment was a failure.  I plan to use the results to assist me with the re-creation of another experiment that was detailed in the ancient tomes of the Combine Empire.</font></p>
            <p><font color="#000000">My research continues...<br>
              </font>
            </p>
            <p>&nbsp;</p>
