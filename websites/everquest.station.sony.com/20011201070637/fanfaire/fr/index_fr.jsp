...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>81572 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" --> 
            <div align="center" class="bold">À la demande générale, la Fan Faire 
              d'EverQuest se dirige vers le Texas !!<br>
              <br>
              Faites dès maintenant des projets pour nous rejoindre les 25 et 
              26 janvier à <a href="http://www.adamsmark.com/dallas/index.asp" target="_blank" class="bold2">l'Hôtel 
              Adam's Mark de Dallas</a>. Inscrivez-vous à l'avance pour éviter 
              de manquer ces fabuleux moments ! </div>
            <!-- #EndEditable --></td>
        </tr>
      </table>
    </td>
