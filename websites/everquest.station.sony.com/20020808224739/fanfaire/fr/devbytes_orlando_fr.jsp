...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/devbytes_orlando_fr.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center">
                                      <p align="left" class="bold">Le producteur 
                                        d'EverQuest Jeff Butler et l'assistant 
                                        producteur Bill Coyle r&eacute;pondent 
                                        aux questions lors de la table ronde des 
                                        Producteurs pendant la Fan Faire d'Orlando.</p>
                                      <p align="left" class="bold"><br>
                                     
                                        <a href="../sounds/01-L1CM.mp3" class="bold2">Bill 
                                        Coyles parle de l'&eacute;quilibre entre 
                                        PvP et PvE.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/02-L1CM.mp3" class="bold2">Jeff 
                                        Butler indique que les maisons de joueurs 
                                        ne figurent pas sur la liste de d&eacute;veloppement.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/03-L1CM.mp3" class="bold2">Encore 
                                        quelques mots sur les maisons des joueurs.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/04-L1CM.mp3" class="bold2">Questions 
                                        d'argent et fonctionnalit&eacute;s souhait&eacute;es.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/05-L1CM.mp3" class="bold2">Des 
                                        joutes seraient les bienvenues !</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/06-L1CM.mp3" class="bold2">Demande 
                                        &agrave; Lawrence, mais voici ce que j'en 
                                        pense.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/07-L1CM.mp3" class="bold2">D&eacute;lais 
                                        de d&eacute;veloppement, Guildes europ&eacute;ennes 
                                        et changements sur les serveurs.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/08-L1CM.mp3" class="bold2">Guerres 
                                        des races PvP et croisement des &eacute;quipes.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/09-L1CM.mp3" class="bold2">Les 
                                        clercs s'&eacute;puisent aux niveaux &eacute;lev&eacute;s.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/10-L1CM.mp3" class="bold2">Comment 
                                        s'amuser avec un clerc.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/11-L1CM.mp3" class="bold2">En 
                                        voguant sur la grande bleue...</a></p>
                                      <p align="left"><span class="bold">
                                        <a href="../sounds/12-L1CM.mp3" class="bold2">Les 
                                        chemins de Luclin.</a><br>
                                        </span> </p>
                                      <p align="left"><br>
                                      </p>
                                    </div>
