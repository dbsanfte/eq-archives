...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>90724 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="left"><span class="bold">La Fan 
                                      Faire de Orlando se realizar&aacute; en 
                                      <a href="http://www.omnirosen.com" target="_blank" class="bold2">The 
                                      Rosen Centre</a>, situado a pocos minutos 
                                      de Disney World y otras fant&aacute;sticas 
                                      atracciones en el &aacute;rea. Hemos acordado 
                                      con el hotel una tarifa especial para quienes 
                                      asistan a la Fan Faire. Al reservar tu habitaci&oacute;n, 
                                      menciona que participar&aacute;s en la Fan 
                                      Faire de EverQuest y de ese modo pagar&aacute;s 
                                      $99 por noche. Por m&aacute;s informaci&oacute;n 
                                      visita su <a href="http://www.omnirosen.com" target="_blank" class="bold2">sitio 
                                      web</a> . <br>
                                      </span><br>
                                    </p>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
