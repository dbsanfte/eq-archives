        ...
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            <table width="100%" border="0">
              <tr>
                <td valign="top"> 
                  <P class="bold" align="center">Les inscriptions pour la Fan 
                    Faire de Seattle du 19 avril sont maintenant closes.</P>
                  <P class="bold" align="center"> Nous esp&eacute;rons voir tout 
                    le monde &agrave; cette manifestation ! </P>
                  </td>
              </tr>
            </table>
