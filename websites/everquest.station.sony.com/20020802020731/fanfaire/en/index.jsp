...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/index.jsp?null');">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td background="../images/global_bg.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr> 
          <td width="398" valign="top"> 
            <div align="center"> 
              <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/fanfaire.jpg" width="228" height="213" align="top" vspace="9"><br>
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.intel.com"><img src="../images/intel.jpg" width="120" height="83" border="0"></a> 
              </p>
            </div>
          </td>
          <td width="206" valign="top"><!-- #BeginEditable "right" --> 
            <div align="center" class="bold">The Boston Fan Faire has sold out! 
              Stay tuned to this site for the announcement of our next location 
              after August 3rd!<br>
            </div>
            <div align="center"> 
              <p>&nbsp;</p>
              <p><span class="bold3">Please use the Sign In button in the top 
                left corner of this page to sign in with your EverQuest log in 
                name and password, just like you are logging into the game.</span><span class="bold"><br>
                </span> </p>
            </div>
            <div align="center" class="bold"></div>
        ...
        <tr> 
          <td colspan="2" valign="top" class="bold">Fan Faire is a real-life event 
            for EverQuest players and their guests to meet other players, participate 
            in events, and win prizes. Check out <a href="http://everquest.station.sony.com/fanfaire/en/info.jsp" class="bold2">General 
            Information</a> and the<a href="http://everquest.station.sony.com/fanfaire/en/faq.jsp" class="bold2"> 
            Fan Faire FAQ</a> for further details!</td>
        </tr>
      </table>
    </td>
  </tr>
