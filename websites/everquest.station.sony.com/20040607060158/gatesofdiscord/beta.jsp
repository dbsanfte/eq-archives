...
<title>EverQuest: Gates of Discord Beta</title>
<!-- InstanceEndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<table width="780" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="627" valign="top" style="background:  url(images/contentBG.jpg) no-repeat;">
        <div align="center"><!-- InstanceBeginEditable name="header" --><img src="images/headerBeta.gif" alt="Beta" width="169" height="41"><!-- InstanceEndEditable --></div>
      <!-- InstanceBeginEditable name="content" -->
      <div style="padding: 0px 15px 0px 15px;" align="center">
        <p><a href="/gatesofdiscord/beta_reg/register.jsp"><img src="images/betaButtonApply.gif" alt="Apply for Beta" width="286" height="110" border="0"></a></p>
        <br>
        <p><a href="/beta/"><img src="images/betaButtonSignIn.gif" alt="Beta Members Sign-In" width="286" height="110" border="0"></a></p>
      </div>
