...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">59,662 Players Online</div>
        ...
        <tr> 
          <td height="100%" valign="top"><!-- #BeginEditable "Text" --> 
            ...
            <p><img src="images/hdr_movies.jpg" alt="Movies" width="435" height="34" border="0"></p>
              <p><embed src="media/planes_of_power003.mov" width="400" height="316">
                </embed></p>
              </div>
