...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/movies/luclin.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/movies/luclin.jsp');">
                              ...
                              <td>
                                ...
                                <table width="468" border="0" cellspacing="0" cellpadding="0" height="180" background="">
                                  ...
                                  <td colspan="3" align="center" height="156"> 
                                    <p><a href="http://everquest.station.sony.com/luclin/trailer.jsp"><img src="../new_images/luclin.jpg" width="424" height="104" border="0"></a></p>
...
HEIGHT="240" CODEBASE="http://www.apple.com/qtactivex/qtplugin.cab">
                                              ...
                                              <EMBED SRC="Luclin_Instore.mov" WIDTH="320" HEIGHT="240" AUTOPLAY="true"
CONTROLLER="false"
