	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_minneapolis.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_minneapolis.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_minneapolis.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <p align="center"><b><span class="textBold">Minneapolis Fan 
                    Faire Winners</span></b></p>
                  <p align="CENTER"></p>
                  <p class="bold" align="center"><span class="text"><br>
                    <u class="textBold">Live Quest Winners</u><br>
                    ...
                    <br>
                    <u class="textBold">Random Drawing Winners</u><br>
                    Shadowsturm - Cazic Thule<br>
                    Frater - Vazaelle<br>
                    Somondre - Povar<br>
                    Nasye - Erollisi Marr<br>
                    </span><span class="textBold"><br>
                    <u>Door Prizes</u></span><span class="text"><br>
                    Crusha of Brell Sirilis, Anime collection<br>
                    Murn of Luclin, GeForce3</span><br>
                  </p>
                                    </td>
              </tr>
            </table>
