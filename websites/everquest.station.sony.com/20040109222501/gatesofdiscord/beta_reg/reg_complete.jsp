	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta_reg/reg_complete.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta_reg/reg_complete.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta_reg/reg_complete.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<p align="justify"> Thank you for your interest in the <b>EverQuest&reg;: Gates of Discord&#153; Beta </b></p>
<p>You will be receiving an email detailing the next step in your involvement in the Beta in the coming weeks. </p>
<p>Click <a href="edit.jsp"><b>here</b></a> to edit your <b>EverQuest: Gates of Discord</b> Beta registration data. </p>
<p>Click <a href="../index.jsp"><b>here</b></a> to return to the <b>EverQuest: Gates of Discord</b> homepage. </p>
