  ...
  <tr> 
	<td>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" background="">
		<tr> 
			<td rowspan="2" width="1"><img src="/common/images/global_nav//intel_gn.gif" width="154" height="105" border="0" usemap="#Logo"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="1" background="../images/header_r_tile.gif"><a href="http://eqlive.station.sony.com/"><img src="/images/eq_live_intel.gif" width="201" height="72" border="0"></a></td>
    <td width="100%"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../images/header_r_tile.gif">
        <tr> 
          <td><img src="../images/intel_top.gif" width="517" height="72"></td>
        </tr>
      </table>
    </td>
  </tr>
          ...
          <td rowspan="2" valign="top" height="1"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../images/nav_bg.gif">
              <tr valign="top" align="right"> 
                <td> 
                  <p> 
                    <img src="../images/intel_chip.gif"><table width="130" border="0" cellspacing="0" cellpadding="0" background="">
  <tr> 
    ...
    <td width="100%"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top"> 
          <td width="0" height="0"><img src="../images/arm_yourself.jpg" usemap="#Map2" border="0" width="568" height="169"><br>
            <br>
            <table width="568" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="200"><img src="../images/spacer.gif" width="23" height="8">Game 
                  Features </td>
                <td width="176">Pentium&reg; 4 Processor Power</td>
                <td width="192"> 
                  <div align="right">Customer Benefits<img src="../images/spacer.gif" width="17" height="1"></div>
                </td>
              </tr>
            </table>
            <table width="534" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td colspan="3" height="2"><img src="../images/intel_table_top.gif" width="568" height="7"></td>
              </tr>
              <tr> 
                <td width="23" valign="top" background="../images/intel_table_left_bg.gif" height="286"><img src="../images/spacer.gif" width="23" height="1"></td>
                <td width="528" valign="top" height="286"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="177" background="../images/intel_light_bg.jpg" height="147"> 
                        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
    <td>
                              <div align="left"><b>EQ offers hundreds of playable 
                                character combinations</b>, including the new 
                                Vah Shir race and BeastLord character class. Luclin 
                                brings to EverQuest entirely re-designed player 
                                character models with high-res armor and equipment, 
                                featuring over four times the number of polygons 
                                of older character models.</div>
                            </td>
  </tr>
</table>
                      </td>
                      <td rowspan="3" width="176" background="../images/intel_darK_bg.jpg"> 
                        <div align="center"><img src="../images/spacer.gif" width="176" height="1"><br>
                          <br>
                          <a href="http://www.intel.com/home/" target="_blank"><img src="../images/intel.jpg" width="72" height="88" border="0"></a><br>
                          <img src="../images/intel_text01.gif"> 
                        </div>
                      </td>
                      <td width="175" background="../images/intel_light_bg.jpg" height="147"> 
                        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td> 
                              <div align="left"><b>With the power of a Pentium&reg; 
                                4 processor</b>, players can experience the wonders 
                                of the worlds of EverQuest like never before</div>
                            </td>
  </tr>
</table>
                      </td>
                    ...
                    <tr> 
                      <td width="177" background="../images/intel_light_bg.jpg"> 
                        <div align="center"><img src="../images/intel_table_rule.gif" width="177" height="15"></div>
                      </td>
                      <td width="175" background="../images/intel_light_bg.jpg"> 
                        <div align="center"><img src="../images/intel_table_rule.gif" width="175" height="15"></div>
                      </td>
                    </tr>
                    <tr> 
                      <td width="177" background="../images/intel_light_bg.jpg"> 
                        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td> 
                              <div align="left"><b>With over 140 exciting zones 
                                to explore,</b> EverQuest offers challenges for 
                                all levels of expertise. Already the #1 massively 
                                multiplayer online game available, Luclin promises 
                                over 24 new mind-boggling zones.</div>
                            </td>
  </tr>
</table>
                      </td>
                      <td width="175" background="../images/intel_light_bg.jpg"> 
                        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td> 
                              <div align="left"><b>Experience smoother animations 
                                </b>and frame rates<b> </b>with a multitude of 
                                creatures and players onscreen</div>
                            </td>
  </tr>
</table>
                      </td>
                ...
                <td width="17" background="../images/intel_table_right_bg.gif" height="286"><img src="../images/spacer.gif" width="17" height="8"></td>
              </tr>
            </table>
			<table width="568" border="0" cellspacing="0" cellpadding="0">
  <tr>
                <td><img src="../images/intel_center.jpg" width="568" height="156"></td>
  </tr>
</table>
            <table width="568" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="23" valign="top" background="../images/intel_table_left_bg.gif" height="165"><img src="../images/spacer.gif" width="23" height="1"></td>
                <td width="568" valign="top" height="165">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width=177 background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>Take part in an enormous 
                                  world with thousands of in-game quests</b>, 
                                  and a dynamically progressing story in which 
                                  you play an active role.</div>
                              </td>
                            </tr>
                          </table>
                        </div>
                      </td>
                      <td width=175 background="../images/intel_darK_bg.jpg"> 
                        <div align="center"><img src="../images/intel_text02.gif" width="134" height="37"></div>
                      </td>
                      <td width="176" background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>Everquest is optimized to 
                                  take advantage </b>of the Pentium&reg; 4 processor&#146;s 
                                  fast processing power.</div>
                              </td>
                            </tr>
                          </table>
                        </div>
                    ...
                    <tr> 
                      ...
                      <td width=175 background="../images/intel_darK_bg.jpg"> 
                        <div align="center"><img src="../images/intel_table_rule.gif" width="176" height="15"></div>
                      </td>
                      <td width="176" background="../images/intel_light_bg.jpg"> 
                        <div align="center"><img src="../images/intel_table_rule.gif" width="175" height="15"></div>
                      </td>
                    ...
                    <tr> 
                      <td width=177 background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>Join hundreds of thousands 
                                  of real people</b> and play cooperatively or 
                                  competitively as you strive for honor, fame, 
                                  and fortune.</div>
                              </td>
                            </tr>
                          </table>
                      ...
                      <td width="175" background="../images/intel_darK_bg.jpg"> 
                        <div align="center"><img src="../images/intel_text03.gif" width="145" height="73"></div>
                      </td>
                      <td width="176" background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>400,000+ EverQuest players 
                                  </b>and growing. This is one party you don't 
                    ...
                    <tr> 
                      <td width="177" background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>Mount up, and cover great 
                                  distances</b> with the newly added horses.</div>
                              </td>
                            </tr>
                          </table>
                        </div>
                      ...
                      <td width="175" background="../images/intel_darK_bg.jpg"> 
                        <div align="center"><b><img src="../images/intel_text04.gif" width="165" height="58"><br>
                          </b></div>
                      </td>
                      <td width="176" background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>The smoother transitions</b>, 
                                  quicker load times and faster frame rates will 
                                  amaze you!</div>
                              </td>
                            </tr>
                          </table>
                    ...
                    <tr> 
                      <td width="177" background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>The complete 3D overhaul</b> 
                                  in The Shadows of Luclin will leave you breathless 
                                  as the entire world of EverQuest takes on new 
                                  clarity and detail.</div>
                              </td>
                            </tr>
                          </table>
                        </div>
                      ...
                      <td width="175" background="../images/intel_darK_bg.jpg"> 
                        <div align="center"><img src="../images/intel_text05.gif" width="148" height="53"></div>
                      </td>
                      <td width="176" background="../images/intel_light_bg.jpg"> 
                        <div align="center"> 
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td> 
                                <div align="left"><b>The world</b> of Norrath 
                                  has never looked better!</div>
                              </td>
                            </tr>
                          </table>
                        </div>
                ...
                <td width="10" background="../images/intel_table_right_bg.gif" height="165"><img src="../images/spacer.gif" width="17" height="8"></td>
              </tr>
            </table>
            <table width="568" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="2"><img src="../images/intel_table_top.gif" width="568" height="7"></td>
              </tr>
            </table>
            <table width="568" border="0" cellspacing="0" cellpadding="0">
  <tr>
                <td><img src="../images/intel_page_bottom.gif" width="568" height="61" usemap="#Map" border="0" href="http://www.falcon-nw.com/"></td>
  </tr>
</table>
          </td>
        </tr>
...
<map name="Map"> 
  <area shape="rect" coords="109,10,195,57" href="http://www.gateway.com/home/deals/offers/everquest.shtml" alt="Gatewat" title="Gatewat" target="_blank">
  <area shape="rect" coords="374,5,452,59" href="http://www.falcon-nw.com/eq_intel_special_page.asp" target="_blank" alt="Falcon" title="Falcon">
</map>
<map name="Map2"> 
  <area shape="rect" coords="252,23,253,24" href="#">
  <area shape="rect" coords="251,24,325,112" href="http://www.intel.com/home/" target="_blank" alt="intel" title="intel">
</map>
</body>
</html>
