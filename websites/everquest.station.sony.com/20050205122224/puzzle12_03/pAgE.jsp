...
<link href="puz.css" rel="stylesheet" type="text/css">
</head>
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/puzzle12_03/pAgE.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/puzzle12_03/pAgE.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/puzzle12_03/pAgE.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<table width="780" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="1" colspan="3"><img src="images/top.jpg" width="780" height="153"></td>
  </tr>
  <tr> 
    <td height="1" colspan="3"> <table width="780" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="1" valign="top" background="images/left.jpg"><img src="images/left.jpg" width="17" height="510"></td>
          <td><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="745" height="510" id="GoD_main" align="middle">
              <param name="allowScriptAccess" value="sameDomain" />
              <param name="movie" value="http://www.everquest.com/puzzle12_03/RtN12l/c/GoD_main.swf" />
              <param name="quality" value="high" />
              <param name="bgcolor" value="#000000" />
              <embed src="http://www.everquest.com/puzzle12_03/RtN12l/c/GoD_main.swf" quality="high" bgcolor="#000000" width="745" height="510" name="GoD_main" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /> 
            </object></td>
          <td width="1" valign="top" background="images/right.jpg"><img src="images/right.jpg" width="18" height="510"></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td width="5" valign="top" background="images/border_tile.jpg"bgcolor="#210A0A"><img src="images/border_tile.jpg" width="5" height="8"> 
    </td>
    <td width="770" valign="top"bgcolor="#210A0A" class="bottom_bkgd"> 
      <div style="font-size: 10px; color: white; font-family: Arial, Helvetica, sans-serif; padding: 33px 20px 0px 20px;"> 
              <p align="center"><a href="http://eqlive.station.sony.com" target="_blank"><img src="images/spacer.gif" alt="EverQuest Live" width="360" height="55" border="0"></a></p>
              <p align="center"><a href="http://sonyonline.com" target="_blank" class="ToS"><img src="images/soe_logo.gif" alt="Sony Online Entertainment" width="100" height="62" border="0"></a></p>
              <div align="center"> 
                <p class="ToS"><a href="http://www.station.sony.com/web_feedback.jsp" target="_blank" class="ToS">Contact 
                  The Web Master</a> <span style="color: #FFFFFF;">|</span> <a href="http://sonyonline.com/tos/privacy.jsp" target="_blank" class="ToS">Sony 
                  Online Privacy Policy</a> <span style="color: #FFFFFF;">|</span> 
                  <a href="http://sonyonline.com/tos/tos.jsp" target="_blank" class="ToS">Sony 
                  Online Terms Of Service</a> </p>
              </div>
            </div>
            
      <p align="center" class="legal">EverQuest is a registered trademark of Sony 
        Computer Entertainment America Inc.<br>
        &copy; 2003 Sony Computer Entertainment America Inc. SOE and the SOE logo 
        are<br>
        registered trademarks of Sony Online Entertainment Inc. All rights reserved.<br>
        <br>
      </p></td>
    <td width="5" valign="top" background="images/border_tile_right.jpg"bgcolor="#210A0A"><img src="images/border_tile_right.jpg" width="5" height="8"></td>
  </tr>
