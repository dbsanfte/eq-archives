...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">48820 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<div align="center"> 
<div align="center"> 
<div align="center"><b><font face="Georgia, Times New Roman, Times, serif" color="#FF9900" size="4"><span class="header">Woodland 
Elf</span></font></b></div>
<table border="0" width="100%" cellpadding="10">
<tr> 
<td align="center"><a href="JavaScript:imageSwitch('male')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_woodelfmale.gif" width="167" height="254" name="male" border="0"></a></td>
...
<td align="center"><a href="JavaScript:imageSwitch('female')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_woodelffemale.gif" width="167" height="254" name="female" border="0"></a></td>
<tr> 
<td align="center" colspan="3"> 
<div align="justify"><font face="Arial, Helvetica, sans-serif">The Elves appear somewhat 
human at first glance, but their very sharp features and pointed ears set them 
apart. Elves are weaker than humans, but more than make up for this with their 
amazing agility and superior dexterity. They equal the High Man in their intelligence 
and wisdom, but are much more fair and charismatic. </font></div>
</td>
</table>
</div>
</div>
