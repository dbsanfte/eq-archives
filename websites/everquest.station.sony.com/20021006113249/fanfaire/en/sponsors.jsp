...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/sponsors.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/sponsors.jsp');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/sponsors.gif" width="385" height="50">
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"><span class="bold">We 
                                      are pleased to welcome the following sponsors 
                                      to the Boston Fan Faire. </span> </div>
                                    <center>
                                      <br>
...
target="_blank" class="bold2"><img src="../images/RPGwear_logo.gif" width="200" height="48" border=0> 
                                    ...
                                    <div align="center"> 
                                      ...
                                      <p><a href="http://www.alteclansing.com/index_flash.asp"><img src="../images/Altec-Stacked-Logo-CURRENT.gif" width="200" height="45" border="0"></a> 
                                      </p>
