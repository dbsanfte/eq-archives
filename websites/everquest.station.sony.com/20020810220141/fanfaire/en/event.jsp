...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/event.jsp?null');">
                                  ...
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center" class="bold">
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2 class="bold"> 
                                            <P ALIGN="CENTER">Friday, August 2 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP" class="bold"> 
                                            <P>Early Bird Check in 
                                          </TD>
                                        </TR>
                                        <TR>
                                          <TD WIDTH="36%" VALIGN="TOP" class="bold">6:00-8:00 
                                            p.m. </TD>
                                          <TD WIDTH="64%" VALIGN="TOP" class="bold">Check-in 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP" class="bold"> 
                                      ...
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2 class="bold"> 
                                            <P ALIGN="CENTER">Saturday, August 
                                              3 
                                          </TD>
                                        </TR>
                                        <TR> 
                                        ...
                                        <TR>
                                          <TD WIDTH="36%" VALIGN="TOP" class="bold">5:30-6:45 
                                            p.m.</TD>
                                          <TD WIDTH="64%" VALIGN="TOP" class="bold">Workshop 
                                            II </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP" class="bold"> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP" class="bold"> 
                                            <P>Dinner and awarding of prizes! 
                                          </TD>
                                        </TR>
                                      </TABLE>

<P>Workshops will focus on many topics such as Magic, Building Stronger Guilds, Trade Skills and Production and development of EverQuest</P>
</div>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
