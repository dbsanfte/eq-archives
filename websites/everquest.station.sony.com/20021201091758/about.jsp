  ...
  <tr> 
    <td colspan="3"> 
      <p>Welcome to the world of EverQuest&reg;, a real 3D massively multiplayer 
        fantasy roleplaying game. Prepare to enter an enormous virtual environment-an 
        entire world with its own diverse species, economic systems, alliances, 
        and politics. Choose from a variety of races and classes, customize your 
        character, and begin your quest in any number of cities of villages throughout 
        multiple continents. Equip yourself for adventure, seek allies and knowledge, 
        and experience a rich world of dungeons, towers, crypts, evil abbeys-anything 
        is possible-even planes and realities beyond your imagination. Meet new 
        friends from around the world to face epic challenges. Make yourself a 
        noble human knight, a vicious dark elf thief, a greedy dwarven merchant, 
        or whatever suits your desire.</p>
                                    <ul>
                                      ...
                                      <li>Choose from <a href="http://eqlive.station.sony.com/library/races.jsp">14 
                                        ...
                                        trolls, rangers, wizards, and rogues. 
                                        <a href="http://everquest.station.sony.com/luclin.jsp">The 
                                        Shadows of Luclin</a> Expansion will introduce 
                                        a new race known as the Vah Shir, and 
                                        the new class, The Beastlord.<br>
                                        <br>
                                      </li>
                                      ...
                                      <li>Hundreds of spells to learn, with five 
