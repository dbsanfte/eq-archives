...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>62570 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/scrapbook.gif" width="321" 
height="50"> <br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->		
                                    ...
                                    <div align="justify"> 
                                      <p align="center"><b><font color="#
000000"><span class="bold"><font 
size="3">Articles</font></span></font></b></p>
                                      <p align="justify"><a href="youth_fr.jsp" 
class="bold2">L'impertinence de la jeunesse</a><span class="bold"> - Steve « Mennix » Fuller prévoyait simplement de s'amuser à la Fan Faire de San Diego. Mais non, il fallait qu'un espèce de halfling parvenu lui lance un défi.</span></p>
                                      <p><a href="life_fr.jsp" class="bold2">
EverQuest rencontre la Vie réelle</a> <span 
class="bold">- La Fan Faire est la rencontre de deux mondes, le monde du jeu et le Monde réel. La Fan Faire de ce Printemps à San Diego fut le théâtre de deux événements spéciaux, la Real Life Quest et un mariage jeu de rôle.</span></p>
                                      <p><a href="denise_fr.jsp"><span 
class="bold2">Comment on devient Firiona</span>
</a><span class="bold"> - Pendant les Fan Faires, on demande souvent à Denise Harris comment elle est devenue Firiona 
Vie. Dans cette interview, Denise explique comment elle a obtenu le rôle de couverture de EverQuest et nous fait partager sa réaction en voyant son image sur la couverture du Guide TV.</span> </p>
                                      <p><a href="fippy_fr.jsp" class="bold2">Fippy 
/contemple les joueurs présents</a><span class="bold"> - Le gnoll préféré de tous, Fippy, était à la Fan Faire de San Diego et s'y est bien amusé. Lisez ici ses réflexions sur la Faire et ses participants... et ne vous en faites pas, pour un gnoll, il est très éloquent.</span></p>
                                      <p align="center" ><b><font color="#
000000" size="3"><a 
href="scrapbook_sandiego_photos_fr.jsp" target="_top" class="link">L'Album photos
</a></font></b>
</p>
                                    </div>
                                    <!-- #EndEditable --></td>
