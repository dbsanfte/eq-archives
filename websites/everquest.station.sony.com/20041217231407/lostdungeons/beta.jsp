...
<title>EverQuest&reg; Lost Dungeons of Norrath&#8482; Beta</title>
<!-- InstanceEndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/lostdungeons/beta.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/lostdungeons/beta.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/lostdungeons/beta.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
  ...
  <table width="780" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td valign="top" style="background-image: url(images1103/contentBG.jpg); background-repeat: no-repeat;"><img src="images1103/header.jpg" alt="Lost Dungeons of Norrath" width="532" height="85"><br>
	    <!-- InstanceBeginEditable name="header" --><div align="center"><img src="images1103/headerBeta.gif" alt="BETA"></div><!-- InstanceEndEditable -->
		<!-- InstanceBeginEditable name="content" --> 
                  Interested in participating in the Lost Dungeons of Norrath 
                  beta? <a href="beta/register.jsp">Apply here</a>. 
                  <p>Already a beta member? <a href="beta/news.jsp">Login here</a>.</p>
                  <p>&nbsp;</p>
                  <!-- InstanceEndEditable -->
      </td>
