...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/movies/eq_lotr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/movies/eq_lotr.jsp');">
                              ...
                              <td>
                                ...
                                <table width="468" border="0" cellspacing="0" cellpadding="0" height="180" background="">
                                  ...
                                  <td colspan="3" align="center" height="156"> 
                                    <p><img src="../new_images/eq_lotr_a.gif" width="424" height="104"></p>
...
HEIGHT="246" CODEBASE="http://www.apple.com/qtactivex/qtplugin.cab">
                                              <PARAM name="SRC" VALUE="eq_lotr.mov">
                                              <PARAM name="AUTOPLAY" VALUE="true">
                                              <PARAM name="CONTROLLER" VALUE="false">
                                              <EMBED SRC="eq_lotr.mov" WIDTH="320" HEIGHT="246" AUTOPLAY="true"
