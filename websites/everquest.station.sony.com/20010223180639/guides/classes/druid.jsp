...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">44028 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_druid.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p class="header">Druid 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                A Druid is completely at home in the outdoors, 
                                and is a friend to all animals. Because of this, 
                                no animal will ever attack him unless first attacked 
                                by the Druid. They are spellcasters whose focus 
                                is all things natural, allowing them to call upon 
                                nature for aid. They share some woodland skills 
                                with their Ranger brothers.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
                        </table>
