	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/sponsors_minneapolis.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/sponsors_minneapolis.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/sponsors_minneapolis.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <div align="center"><b><span class="textBold">And now, a word 
                    from our sponsors </span></b> </div>
                  <p class="bold"><span class="text">We saw more sponsors at the 
                    Minneapolis Fan Faire, and trust me they were kept busy. From 
                    selling shirts to showing off new technologies, the various 
                    company representatives added flavor to an already exciting 
                    Fan Faire. </span></p>
                  <p class="text"><a href="http://rpgwear.com" target="_blank" class="links">RPGwear 
                    </a> </p>
                  <p class="bold"><span class="text">RPGwear specializes in providing 
                    RPG and online gaming apparel and accessories. They are the 
                    ones who make all those cool EQ shirts that you always see 
                    at Fan Faires and provide the t-shirt that comes with the 
                    Fan Faire registration price. Cory Rafiner, Mr. RPGwear himself, 
                    is dedicated. Due to a glitch in transporting the merchandise 
                    to Minneapolis, he rented a truck at the last minute and drove 
                    his wares from Utah. </span></p>
                  <p class="text"><br>
                    <a href="http://www.keithparkinson.com/" target="_blank" class="links">Keith 
                    Parkinson </a></p>
                  <p class="bold"><span class="text">This world-renown artist 
                    is truly amazing, a master of his craft. He has had a long-standing 
                    relationship with EverQuest, and no amount of praise is enough 
                    to cover what he has accomplished. Don't believe me? Head 
                    over to his site and check it out.</span></p>
                  <p class="text"><br>
                    <a href="http://www.olympus-eye-trek.com/" target="_blank" class="links">Olympus 
                    </a></p>
                  <p class="bold"><span class="text">Ok, here were these guys 
                    with these eyeglass-looking thingies on their table. They 
                    are their Eye-Trek products. Gadgets! Who doesn't like gadgets? 
                    Of course, I checked them out, and was blown away. The Eye-Trek 
                    presents video and TV-films impressively large, as if you 
                    were watching a 52&quot; screen from 2m distance. They hooked 
                    the Eye-Trek into a PlayStation2 and&#133;OMG! Everyone needs 
                    to head over to their site and check these things out. They're 
                    already on my shopping list.</span></p>
                  <p class="text"><br>
                    <span class="links"><a href="http://www.pny.com"_blank" class="links" target="_blank">PNY 
                    </a> <a href=http://www.nvidia.com/ target="_blank" class="links">and 
                    NVIDIA </a></span></p>
                  <p class="bold"><span class="text">I use a GeForce2 in my work 
                    computer. I specifically requested this graphics card since 
                    I have to be able to play--er, I mean, research--any of our 
                    games at any given time (I won't say what I'm using on my 
                    home computer). Needless to say, since I don't have the graphic 
                    power at home, I don't get to play many of the resource heavy 
                    games these days. Nancy Larson of PNY Technologies, a global 
                    leader in the design, manufacture and distribution of memory 
                    upgrade products for desktops, notebooks, servers, workstations, 
                    printers, digital cameras, handheld PCs, and other customized 
                    memory applications, was on hand to show off the GeForce3 
                    by NVIDIA. This card ROCKS! And from what many of the Fan 
                    Faire participants were saying, this was going to be the graphics 
                    card of choice for the next evolution of online gaming.</span></p>
                  <p class="text"><br>
                    <a href="http://gucomics.everlore.com/" target="_blank" class="links">/gu 
                    Comics </a></p>
                  <p class="bold"><span class="text">Woody Hearn of GUComics had 
                    a table to show off his work. Ok, I didn't hear this directly, 
                    but some people were asking Woody game balance questions. 
                    Uhm, Woody doesn't work for us. If he did, do you think we 
                    would let some of those /gu... cartoons get out? Many of us 
                    at the office check out his comic every time a new one comes 
                    out. Woody has been able to capture that &quot;special&quot; 
                    thing that reminds us all that we can laugh at ourselves.</span></p>
                  <p class="text"><br>
                    <a href="http://www.wizards.com/" target="_blank" class="links">Wizards 
                    of the Coast </a></p>
                  <p class="bold"><span class="text">Who doesn't know who these 
                    guys? Wizards of the Coast was on hand to host matches of 
                    Magic, the Gathering. I popped into their room as matches 
                    were taking place. The turn out was great. No matter the field, 
                    everyone enjoys a great game. That's why we still have Magic, 
                    the Gathering tournaments around the office here.</span></p>
                  <p class="text"><br>
                    <a href="http://www.thestompinggrounds.com/" target="_blank" class="links">The 
                    Stomping Ground</a></p>
                  <p class="bold"><span class="text">For 96 hours straight, The 
                    Stomping Ground was dedicated to EverQuest Players. The Stomping 
                    Grounds is a world-class LAN (Local Area network) Gaming Center 
                    located in downtown Minneapolis. With over 29 computers and 
                    a blazing fast point-to-point T1 connection, TSG is Minneapolis's 
                    destination for community online gaming.</span></p>
                  <p class="text"><br>
                    <a href="http://www.bestbuy.com" target="_blank" class="links">Best 
                    Buy </a></p>
                  <p class="bold"><span class="text">I am originally from Dayton 
                    Ohio area, and Best Buy is where I did a vast majority of 
                    my shopping. It was great to have this back home memory as 
                    part of the Fan Faire.</span></p>
                  <p><span class="text"><br>
                    Steve &quot;Mennix&quot; Fuller (<a href="mailto:sfuller@soe.sony.com" class="links">sfuller@soe.sony.com</a>)</span><br>
                  </p>
                                    </td>
              </tr>
            </table>
