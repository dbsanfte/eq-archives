...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/hotel_info.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/hotel_info.jsp');">
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><div align="center"><span class="text"><strong>Join us for 
                    the Las Vegas Fan Faire! </strong> </span> </div>
                  <p align="center" class="text"><a href="http://www.parkplace.com/hilton/lasvegas/" target="_blank" class="links">Las 
                    Vegas Hilton</a><br>
                    3000 Paradise Road<br>
                    Las Vegas, NV 89109<br>
                    Tel: 1-888-732-7117</p>
                  <p align="center" class="text">You'll find activities at the 
                    Las Vegas Hilton throughout the weekend. We have been given 
                    a group rate of $109 - just ask for the EverQuest rate. You 
                    can call and make your reservations now at 1-888-732-7117. 
                    Remember, the last Fan Faire hotel sold out of rooms weeks 
                    before the event. Hurry and make your reservations now!</p>
                  <p class="text" align="center"> </p>
                  <p class="text" align="center"></p>
                  <p class="text" align="center">The Las Vegas Hilton is on the 
                    north end of Vegas, a little off the Las Vegas Strip. You'll 
                    find activities in the Hilton throughout the weekend. We have 
                    been given a group rate of $109--just ask for the Sony Online 
                    rate. Or you can reference Rate Code SVSONY3. You can call 
                    and make your reservations now at (888) 732-7117. Remember, 
                    the last Fan Faire hotel sold out of rooms weeks before the 
                    event. Hurry and make your reservations now! </p>
                  <p class="text" align="center">Also, we have secured a group 
                    rate for Airfare for all of you to use with Southwest Airlines. 
                    Here is the information from Southwest:</p>
                  <p class="text" align="center">&quot;Southwest Airlines offers 
                    up to 10% off of most fares for air travel to and from Fan 
                    Faire, with the convenience of Ticketless Travel. To qualify, 
                    call Southwest Airlines Group and Meetings Reservations at 
                    (800) 433-5368 and reference ID Code #G0149. Reservations 
                    sales agents are available from 7:00am - 8:00pm, Monday - 
                    Friday, or 8:30am - 5:30 pm, Saturday - Sunday, Central Standard 
                    Time.&quot;</p>
                  <p class="text" align="center">This discount applies to all 
                    travel from March 22, 2003 to April 4, 2003.</p>
                </td>
              </tr>
            </table>
