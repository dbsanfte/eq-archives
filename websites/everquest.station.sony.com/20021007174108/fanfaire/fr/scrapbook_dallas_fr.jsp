...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_dallas_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_dallas_fr.jsp');">
...
size="3">Articles</font></span></font></b></p>
                                      <p align="justify"><a href="report_dallas_fr.jsp" 
class="bold2">Le Rapport Mennix </a><span class="bold"> - L'hôtel Adam's Mark, 
                                        dans le beau centre de Dallas, a accueilli 
                                        des centaines de joueurs d'EQ pour la 
                                        cinquième Fan Faire d'EverQuest qui a 
                                        eu lieu les 25 et 26 janvier ; une fois 
                                        de plus Mennix était présent pour nous 
                                        rapporter sa vision unique de l'événement</span></p>
                                      <p><a href="winners_dallas_fr.jsp" class="bold2">Liste 
                                        des gagnants</a> <span 
class="bold">- Félicitation à l'équipe Black Company du serveur Tarew Marr qui 
                                        a remporté la Quête du monde réel de la 
                                        Fan Faire de Dallas. Chaque membre de 
                                        l'équipe sera immortalisé à tout jamais 
                                        dans le monde de Norrath lorsque les PNJ 
                                        d'EQ raconteront ses grands exploits. 
                                        </span></p>
                                      <p><a href="poem_dallas_fr.jsp" 
class="bold2">EQ R Uber </a><span class="bold"> - Einaugenwilly, de la Guilde 
                                        Iron Tower sur Vallon Zek a fait profiter 
                                        le public de la Fan Faire de Dallas par 
                                        son talent poétique. Avec sa permission, 
                                        nous sommes fiers de présenter à tous 
                                        l'œuvre originale EQ R Uber. </span> </p>
                                      <p><a href="guilds_dallas_fr.jsp" class="bold2">Formation 
                                        de meilleures Guildes </a><span class="bold"> 
                                        - Un des atelier de la Dallas Fan Faire 
                                        fut une discussion sur la manière de créer 
                                        une meilleure Guilde, atelier dirigé par 
                                        Brian « Auric » DeMarco. Brian a fourni 
                                        des indications sur la manière de réussir 
                                        une Guilde et les caractéristiques que 
                                        devraient rechercher les joueurs lorsqu'ils 
                                        envisagent de rejoindre une Guilde. </span></p>
                                      <p><a href="../media/Dallas%20Fan%20Faire.mov" class="bold2">Le 
                                        Film de la Fan faire</a> <span class="bold">- 
                                        Vous aurez un aper&ccedil;u de la Fan 
                                        Faire gr&acirc;ce &agrave; ce petit film 
                                        compos&eacute; de s&eacute;quences tourn&eacute;es 
                                        &agrave; Dallas. Merci mille fois &agrave; 
                                        Don &quot;GM Pelegorian&quot; Conley et 
                                        &agrave; sa femme Alexandra pour la vid&eacute;o.</span><br>
                                      </p>
                                      <p align="center" ><b><font color="#
000000" size="3"><a 
