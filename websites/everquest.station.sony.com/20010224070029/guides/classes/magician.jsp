                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_magician.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p class="header">Magician 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                Magicians are the summoners of the arcane arts, 
                                and wield the power to call forth everything from 
                                a loaf of bread to a huge Fire Elemental to fight 
                                for them. While not as adept at offensive spells 
                                as the Wizards, Magicians still wield considerable 
                                power in this area as well.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
                        </table>
