	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_baltimore.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_baltimore.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_baltimore.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr>
                <td> 
                  <div align="center"><b><span class="textBold">Articles</span></b> 
                  </div>
                  <p align="justify" class="text"><a href="minnex1.jsp" class="links">The 
                    Mennix Report</a> - He went, he saw, and he survived. Steve 
                    &quot;Mennix&quot; Fuller recaps his thoughts on the Baltimore 
                    Fan Faire. </p>
                  <p align="justify" class="text"><span class="text"><a href="minnex2.jsp" class="links">The 
                    Mennix Report: Part II</a> - Steve &quot;Mennix&quot; Fuller 
                    concludes his thoughts on the Baltimore Fan Faire and talks 
                    about being fleet of foot and camping bar tables.</span></p>
                  <p align="justify" class="text"><span class="text"><a href="firiona.jsp" class="links">Firiona 
                    Vie plays Firiona Vie with Firiona Vie in Firiona Vie!</a> 
                    - On the second day of the Baltimore Fan Faire, the EverQuest 
                    Quest Masters and Quest Troupe ran an actual quest online 
                    and let Faire attendees see what it's like from the other 
                    side of the screen.</span></p>
                  <p align="justify" class="text"><span class="text"><a href="npc.jsp" class="links">I 
                    Was an EverQuest NPC</a> - Xeraxa got to see life from the 
                    other side of the screen, so to speak, when she participated 
                    as an NPC in the Real Life Quest at the Baltimore Fan Faire.</span></p>
                  <p align="justify" class="text"><span class="text"><a href="dinner.jsp" class="links">Guide 
                    Appreciation Dinner</a> - Xeraxa, a former guide herself, 
                    gives you an inside look at the Friday night dinner thrown 
                    by Verant in appreciation for the EverQuest Guide Program.</span></p>
                  <p align="justify" class="text"><span class="text"><a href="winners.jsp" class="links">Fan 
                    Faire Winners</a> - See who came out on top of the Real Life 
                    Quest and other events held at Fan Faire, and take a gander 
                    at the prizes they received!</span></p>
                  <p align="justify" class="text"><span class="text"><a href="world.jsp" class="links">EverQuest 
                    Around the World</a> - Who traveled the furthest to attend 
                    the Baltimore Fan Faire? This is one of the questions Steve 
                    &quot;Mennix&quot; Fuller wanted to answer as part of his 
                    Fan Faire coverage. And from Switzerland, Steve found Ellegon 
                    of the Xegony server.</span></p>
                  <p align="center" class="text" ><span class="text"><b><a href="scrapbook_baltimore_photos.jsp" target="_top" class="links">Photo 
                    Gallery</a></b></span></p>
                                    </td>
              </tr>
            </table>
