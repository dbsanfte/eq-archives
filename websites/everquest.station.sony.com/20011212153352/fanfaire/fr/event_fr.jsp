...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>37362 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center" class="bold">N'h&eacute;sitez pas &agrave; revenir sur cette page plus tard pour obtenir des informations sur la prochaine Fan Faire.<!--
                                      <table BORDER cellspacing=1 cellpadding=7width=590 bordercolor="#000000">
                                        <tr bgcolor="#000000"> 
                                          <td valign="TOP" colspan=2 background=""> 
                                            <p align="CENTER"><b><font color="#FFFFFF" fa="fa" ce="Arial, Helvetica, sans-serif" size="2">Vendredi 
                                              19 octobre</font></b> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold"> 
                                              Inscription anticip&eacute;e</span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>17 
                                              &agrave; 20 heures </b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>R&eacute;ception</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>20 
                                              &agrave; 22 heures </b></font> 
                                          </td>
                                        </tr>
                                        <tr bgcolor="#000000"> 
                                          <td valign="TOP" colspan=2 background=""> 
                                            <p align="CENTER"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold"><font color="#FFFFFF">Samedi 20 octobre</font> </span></b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>Inscription 
                                              tardive</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>midi 
                                              &agrave; 13 heures </b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>La 
                                              Fan Faire commence!</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>1:00 
                                              </b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>Real 
                                              Life Quest</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>13 
                                              h 30 &agrave; 15 h 30 </b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>D&eacute;bats 
                                              et Qu&ecirc;tes dans le jeu</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>15 
                                              h 30 &agrave; 17 heures </b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>D&icirc;ner 
                                              et remise</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>19 
                                              heures </b></font> 
                                          </td>
                                        </tr>
                                      </table>-->
