...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/winners_dallas.jsp?null');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    ...
                                    <p class="bold">LiveQuest<img src="screenshots/ff_dallas/article_images/Dsc00993.jpg" width="320" height="240" align="right"><br>
                                      ...
                                      Guild: <a href="http://www.blackcompany.cc/" target="_blank" class="bold2">Black 
                                      Company </a></p>
                                    <p class="bold">Citaria (Guild Leader)<br>
                                      Lujan <br>
                                      Tierra<br>
                                      Rennol<br>
                                      Hakeshar<br>
                                      ...
                                      *Arnaxus<br>
                                      **Vaslin </p>
                                    <p class="bold">*Arnaxus was an additional 
                                      member of the team and is currently guildless.<br>
                                      **Vaslin of the <a href="http://www.thesafehouse.org/" target="_blank" class="bold2">Safehouse</a> 
                                      was an additional member of the team and 
                                      is not a member of the Black Company guild.</p>
                                    <p class="bold"><br>
                                      <br>
                                      GeForce 3 Video Card from <a href="http://www.pny.com/home/products/vcard_index.cfm" target="_blank" class="bold2">PNY 
                                      </a><br>
                                      <br>
                                      Charnas<br>
                                      Forged Souls<br>
