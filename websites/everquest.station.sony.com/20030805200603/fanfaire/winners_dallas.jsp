	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_dallas.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_dallas.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_dallas.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <p class="bold" align="center"><span class="textBold">List of 
                    Winners</span></p>
                  <p class="bold"><span class="text">LiveQuest<img src="screenshots/ff_dallas/article_images/Dsc00993.jpg" width="320" height="240" align="right"><br>
                    <br>
                    Server: Tarew Marr<br>
                    Guild: <a href="http://www.blackcompany.cc/" target="_blank" class="links">Black 
                    Company </a></span></p>
                  <p class="bold"><span class="text">Citaria (Guild Leader)<br>
                    Lujan <br>
                    Tierra<br>
                    Rennol<br>
                    Hakeshar<br>
                    ...
                    *Arnaxus<br>
                    **Vaslin </span></p>
                  <p class="bold"><span class="text">*Arnaxus was an additional 
                    member of the team and is currently guildless.<br>
                    **Vaslin of the <a href="http://www.thesafehouse.org/" target="_blank" class="links">Safehouse</a> 
                    was an additional member of the team and is not a member of 
                    the Black Company guild.</span></p>
                  <p class="bold"><span class="text"><br>
                    <br>
                    GeForce 3 Video Card from <a href="http://www.pny.com/home/products/vcard_index.cfm" target="_blank" class="links">PNY 
                    </a><br>
                    <br>
                    Charnas<br>
                    Forged Souls<br>
