...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/hotel.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/hotel.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p class="bold">Join us for the San Francisco 
                                      Fan Faire!<br>
                                      <br>
                                      <a href="http://www.marriott.com/epp/default.asp?MarshaCode=SFODT" target="_blank" class="bold2">San 
                                      Francisco Marriott</a><br>
                                      55 Fourth Street<br>
                                      San Francisco, CA 94103<br>
                                      Tel: (800) 228-9290<br>
                                      <br>
                                      The San Francisco Marriott is right across 
                                      the street from the Metreon. You'll find 
                                      activities in both places throughout the 
                                      weekend. We have been given a group rate 
                                      of $139--just ask for the EverQuest Fan 
                                      Faire rate. You can call and make your reservations 
                                      now at (800) 228-9290. Remember, the last 
                                      Fan Faire hotel sold out of rooms weeks 
                                      before the event. Hurry and make your reservations 
                                      now!</p>
                                    <p class="bold">You may now book your room 
                                      at the San Francisco Marriott online with 
                                      the special Fan Faire group rate with the 
                                      following links:</p>
                                    <p class="bold"><a href="https://www.marriott.com/reservations/init.asp?marshacode=sfodt&path=marriott&gc=effeffa" class="bold2" target="_blank">Single 
                                      or double - $139.00</a><br>
                                      <a href="https://www.marriott.com/reservations/init.asp?marshacode=sfodt&path=marriott&gc=effeffb" target="_blank" class="bold2">Triple 
                                      - $159.00</a><br>
                                      <a href="https://www.marriott.com/reservations/init.asp?marshacode=sfodt&path=marriott&gc=effeffc" target="_blank" class="bold2">Quadruple 
                                      - $179.00</a></p>
                                    <p class="bold">Through the Marriott.com online 
                                      reservation system, you may:<br>
                                      &middot; Confirm reservations 24 hours a 
                                      day from your computer<br>
                                      &middot; Receive instant confirmation<br>
                                      &middot; Cancel and reconfirm reservations 
                                      online<br>
                                      &middot; Enter up to two names on a reservation</p>
                                    <p class="bold">Marriott.com FAQ:</p>
                                    <p class="bold">Q: Can I book a reservation 
                                      online without a credit card?<br>
                                      A: No, a credit card is required for all 
                                      reservations.</p>
                                    <p class="bold">Q: Can I modify reservations 
                                      online when booked through Marriott.com?<br>
                                      A: No, you should call the hotel for changes--(800) 
                                      228-9290</p>
                                    <p class="bold">Q: Can I confirm more than 
                                      one room at the same hotel?<br>
                                      A: Yes, there is a repeat reservation option.</p>
                                    <p><span class="bold">Note: The site has a 
                                      security feature that limits how often a 
                                      single credit card can be used to book a 
                                      hotel for the same dates.<br>
                                      </span> </p>
                                    <p><br>
                                    </p>
                                    <!-- #EndEditable --></td>
