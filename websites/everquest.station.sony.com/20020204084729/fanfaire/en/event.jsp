...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>64118 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center" class="bold"><FONT SIZE=2>
<P>&nbsp;</P>
                                      </FONT> Thank you for attending the Dallas 
                                      Fan Faire. Please check back here for future 
                                      Fan Faire information.</div>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
