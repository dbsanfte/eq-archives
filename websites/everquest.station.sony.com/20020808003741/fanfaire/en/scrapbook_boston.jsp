...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston.jsp?null');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      ...
                                      <p align="justify"><a class="bold2">The 
                                        Mennix Report</a><span class="bold"> - 
                                        Coming Soon!</span></p>
                                      <p align="justify"><a class="bold2">List 
                                        of Winners</a><span class="bold"> - 
										Coming Soon!</span></p>
                                      <p align="center" ><b><font color="#000000" size="3"><a href="scrapbook_boston_photos.jsp" target="_top" class="bold2"><font size="3">Photo 
