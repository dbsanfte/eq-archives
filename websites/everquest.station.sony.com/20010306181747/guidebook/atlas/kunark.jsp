...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">4584 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr> 
                              ...
                              <td width="80%" height="256" rowspan="3"> 
                                ...
                                <center>
                                  <img src="images/map_kunark_hi.gif" width="400" height="363" usemap="#cities" border="0"><map name="cities"><area shape="rect" coords="274,165,322,185" href="cabalis.jsp"></map> 
                                </center>
                              </td>
                              <td width="20%"> 
