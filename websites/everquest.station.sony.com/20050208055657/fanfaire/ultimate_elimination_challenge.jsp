	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/ultimate_elimination_challenge.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/ultimate_elimination_challenge.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/ultimate_elimination_challenge.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr>
                <td>
                  <div align="center"><img src="images/final_eq2uec.gif"></div>
                </td>
              </tr>
              <tr>
                <td> <p align="center"><br>
                    <span class="text"><font size="5">THE EVERQUEST II ULTIMATE 
                    ELIMINATION CHALLENGE!</font></span> 
                  <p align="center"><font size="3"><strong>Deadline for entries 
                    extended to October 20, 2004.</strong></font> 
                  <p align="center">Marathon is now 24 hours long (instead of 
                    48) so participants can attend the other Fan Faire events 
                    on Saturday!
<p>New Orleans Fan Faire attendees, take THE EVERQUEST II ULTIMATE 
                    ELIMINATION CHALLENGE! </p>
                  <p>The EverQuest II Ultimate Elimination Challenge is a 24 hour 
                    EverQuest II beta gaming marathon, a race to see who can get 
                    the most experience over a 24 hour time period.</p>
                  <p>Tell us in 300 words or less why you're THE ULTIMATE EQ II 
                    GAMER and you could be one of the lucky finalists chosen to 
                    participate from the U.S. (3 European finalists will be selected 
                    via separate promotions conducted in Europe). Essays will 
                    be judged on humor, creativity and dedication to the EverQuest 
                    community.</p>
                  <p>The 30 finalists will play EverQuest II at New Orleans Fan 
                    Faire from 10:00am October 29th to 10:00am October 3oth with 
                    the winner taking home a brand new Alienware PC.</p>
                  <p>Have fun! Be creative! Submit your essay via email to <strong>FanFaire@soe.sony.com</strong> 
                    with the subject &#8220;EQII Ultimate Elimination Challenge&#8221; 
                    by Wednesday, October 20th. Finalists will be selected by 
                    the Fan Faire team, who will be looking for the best, most 
                    imaginative and amusing essays based upon the criteria in 
                    the official rules. Sony Online Entertainment will post the 
                    names of the participants on or about October 22nd.</p>
                  <p>NO PURCHASE NECESSARY TO ENTER OR WIN. Must be 18 years of 
                    age and a legal U.S. resident. Must be a registered Fan Faire 
                    attendee as of October 7, 2004, and Finalists must attend 
                    in person in order to play or win. For more information and 
                    a full set of the official rules, go to <a href="http://everquest.station.sony.com/fanfaire/elimination_challenge_rules.jsp">http://everquest.station.sony.com/fanfaire/elimination_challenge_rules.jsp</a>. 
                    Eligibility is subject to compliance with the terms of the 
                    EQ2 beta agreement.</p>
                  <p>For more information and rules, <a href="http://everquest.station.sony.com/fanfaire/elimination_challenge_rules.jsp">go 
                    here</a>. <br>
                  </p>
                  <p align="left"><br>
                </td>
