...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston.jsp');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      ...
                                      <p align="justify"><a class="bold2" href="report_boston.jsp">The 
                                        Mennix Report</a><span class="bold"> - 
                                        Didn't make it to Boston for the Fan Faire? 
                                        Have no fear, Mennix was there! Check 
                                        out his brief recap of all the fun.</span></p>
                                      <p align="justify"><a href="winners_boston.jsp" class="bold2">List of Winners</a><span class="bold"> - 
										Congratulations to team Knights of the Tribunal for winning the Live Quest. Check out the entire List of Winners</span></p>
                                      <p align="justify"><a href="../media/EQ_FanFaire_Boston.wmv" class="bold2">Boston Fan Faire Movie</a><span class="bold"> - 
										Experience the sites and sounds of the EverQuest Boston Fan Faire</span></p>
