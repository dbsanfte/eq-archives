...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/scrapbook_orlando_esp.jsp?null');">
...
<p align="justify" class="bold"><a href="wedding_orlando.jsp" class="bold2">El amor se respira en el ambiente...</a>
- El 6 de octubre, dos jugadores de EverQuest, Krissy y Dave, se casaron en la vida real. El 20 de octubre, en presencia de cientos de personas de Fan Faire, sus personajes se casaron en el juego del servidor Luclin.</p>
                                      <p align="justify" class="bold"><a href="report_orlando_esp.jsp" class="bold2">El 
                                        Informe Mennix</a> <span class="bold">- 
                                        Una vez m&aacute;s, Steve &quot;Mennix&quot; 
                                        Fuller asisti&oacute; a otra Fan Faire 
                                        de EverQuest y resume sus sensaciones, 
                                        en su estilo personal, sobre mucho de 
                                        lo que pas&oacute; en Orlando.<br>
                                        </span></p>
									  <p align="justify" class="bold"><a href="devbytes_orlando_esp.jsp" class="bold2">Muestras 
                                        de sonido del creador</a> <span class="bold">- 
                                        Jeff Butler y Bill Coyle expusieron preguntas 
                                        que fueron desde temas relacionados con 
                                        el equilibrio de clases hasta las particularidades 
                                        del juego Luclin durante el panel de debate 
                                        del Productor realizado en el Fan Faire. 
                                        Escuche algunas de las opciones seleccionadas, 
                                        en formato MP3, de tan s&oacute;lo unas 
                                        pocas respuestas.</span></p>
                                      <p align="justify" class="bold"><span class="bold"><a href="winners_orlando_esp.jsp" class="bold2">Lista de ganadores</a> - El equipo X de Mithaniel Marr gan&oacute; la prueba Live Quest que se llev&oacute; a cabo en la Fan Faire de Orlando. Cada componente del equipo recibir&aacute; una copia de Shadows of Luclin cuando se publique la ampliaci&oacute;n en Diciembre. Las personas que resultaron ganadoras en el sorteo de la suerte tambi&eacute;n recibir&aacute;n su copia de Luclin.<br>
                                        </span></p>
                                      <p align="center"><a href="scrapbook_orlando_photos.jsp" class="bold2"><font face="Arial, Helvetica, sans-serif" size="3">Galer&iacute;a 
                                        de Fotograf&iacute;as</font></a></p>
                                      </div>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
