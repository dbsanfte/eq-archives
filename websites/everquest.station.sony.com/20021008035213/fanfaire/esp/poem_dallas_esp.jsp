...
<div id="gnav_commstation" style="position:absolute; top:64;left:240;width:75;height:21; z-index:2;">
	          ...
	          <a href="javascript:gnav_call('http://www.station.sony.com/en/commstation/stationgram.jsp');"><img src="/common/images/global_nav/esp/comm_off.gif" border="0" width="75" height="21"></a>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/poem_dallas_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/poem_dallas_esp.jsp');">

  <!-- Play Games --><area shape="rect" coords="322,66,431,83" href="javascript:gnav_call('http://www.station.sony.com/esp/');" onmouseover="gnav_showmenu();" onmouseout="gnav_hidemenu();">
              ...
              <tr>
                ...
                <td width="161">
                  ...
                  <table width="148" border="0" cellspacing="0" cellpadding="0" background="../images/scroll_tile.gif">
                    ...
                    <tr>
                      <td><a href="http://everquest.station.sony.com/fanfaire/esp/fanfaireAttendeeList.jsp?sku=EQALL-EV-EV1102-FANFRE-SNFRN" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','../images/diamond_on.gif',1)"><img name="Image10" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Asistentes</span></a></td>
                    </tr>
                    <tr>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center" class="bold">EQ R UBER 
                                    </div>
                                    <p align="center" class="bold"><br>
                                      Hola, soy Dan y &eacute;sta es mi rima.<br>
                                      Es ya de hace mucho tiempo y repetirla no 
                                      me da grima.<br>
                                      Yo buscaba un juego para jugar y divertirme.<br>
                                      Si llego a saber c&oacute;mo engancha, habr&iacute;a 
                                      optado por irme.<br>
                                      Fent, mi hermanito dec&iacute;a: &quot;EverQuest 
                                      mola un mont&oacute;n&quot;.<br>
                                      &quot;Y con la conexi&oacute;n T-1 del colegio, 
                                      puedes jugar mogoll&oacute;n&quot;.</p>
                                    <p align="center" class="bold">As&iacute; 
                                      fue c&oacute;mo me compr&eacute; mi primer 
                                      juego de Everquest.<br>
                                      Lo instal&eacute;, jugu&eacute;, y me sirvi&oacute; 
                                      a modo de test.<br>
                                      Decid&iacute; que Lanys ser&iacute;a el 
                                      servidor con el que jugar&iacute;a<br>
                                      y me convert&iacute; en un pillo elfo oscuro, 
                                      sin esperar un s&oacute;lo d&iacute;a.<br>
                                      Me cost&oacute; un poco pillar al juego 
                                      el truco<br>
                                      pero para el nivel 13, yo ya era el m&aacute;s 
                                      cuco.</p>
                                    <p align="center" class="bold">As&iacute; 
                                      fue como cambi&eacute; de servidor a Vallon 
                                      Zek<br>
                                      me convert&iacute; en Enaugenwilly, esto 
                                      es mejor que Star Trek.<br>
                                      Con mi espada, la carta de la cofrad&iacute;a, 
                                      la cantimplora y el pan.<br>
                                      As&iacute; comenz&oacute; mi adicci&oacute;n, 
                                      ahora ya soy todo un fan.<br>
                                      Del nivel uno al diez todo fue muy deprisa.<br>
                                      Aunque ten&iacute;a s&oacute;lo un ojo, 
                                      a nadie le entr&oacute; la risa.</p>
                                    <p align="center" class="bold">Muy pronto, 
                                      mis amigos empezaron a decir,<br>
                                      &quot;Dan, siempre con tu ordenador, ya 
                                      nunca quieres salir.<br>
                                      Descubr&iacute; un lugar llamado Norrath, 
                                      perfecto para explorar.<br>
                                      Los gr&aacute;ficos son fant&aacute;sticos 
                                      y siempre hay sitios donde entrar.<br>
                                      Pronto, mis amigos tambi&eacute;n lo compraron<br>
                                      Y en muy poco tiempo, a EverQuest se engancharon.</p>
                                    <p align="center" class="bold">&quot;Cread 
                                      vuestros personajes y como yo empezad&quot;.<br>
                                      &quot;Dan, tenemos miedo, de estos enemigos 
                                      sin piedad&quot;.<br>
                                      &quot;S&oacute;lo ten&eacute;is que luchar 
                                      y empezar ya con la justa&quot;.<br>
                                      &quot;Perdona, Dan, somos buenos chicos 
                                      y la violencia no nos gusta&quot;.<br>
                                      As&iacute; escaparon a Vazaelle, como un 
                                      pu&ntilde;ado de principiantes.<br>
                                      Huyendo igual que Zek, condenados a ser 
                                      errantes.</p>
                                    <p align="center" class="bold">Pronto comenc&eacute; 
                                      a asar, preparar bebidas y el hierro trabajar<br>
                                      incluso consegu&iacute; unas sandalias viejas, 
                                      para con ellas pescar.<br>
                                      Entonces, un Lord llamado FalKonn un error 
                                      fue a cometer.<br>
                                      Dijo a sus amigos: &quot;en mi cofrad&iacute;a, 
                                      a este dorf he de meter&quot;.<br>
                                      &iexcl;Y con la Torre del Hierro, muchos 
                                      sitios recorr&iacute;!<br>
                                      &iexcl;Mis amigos ya pensaban que majara 
                                      me volv&iacute;!</p>
                                    <p align="center" class="bold">&iexcl;A Xanit 
                                      DE PKed me FEF cura!<br>
                                      Mi lenguaje secreto me llev&oacute; hasta 
                                      la locura.<br>
                                      Las incursiones del fin semana a mi novia 
                                      mosqueaban,<br>
                                      un jugador de EverQuest, no es eso lo que 
                                      esperaban.<br>
                                      (Por cierto, ahora estoy soltero y buscando 
                                      una mujer humana)<br>
                                      Pronto me junt&eacute; con Velious y a North 
                                      Ro nos fuimos,<br>
                                      para encontrar un barco, y a la nieve nos 
                                      vinimos.</p>
                                    <p align="center" class="bold">Salt&eacute; 
                                      del barco y me encontr&eacute; con los gnomos 
                                      piratas.<br>
                                      Conoc&iacute; Thurgadin con el Coldain, 
                                      as&iacute; como sus casas.<br>
                                      Mat&eacute; a gigantes y a orcos, y con 
                                      uno o dos dragones pude acabar .<br>
                                      Cuando al fin reun&iacute; un grupo, en 
                                      Velk's nos reunimos para copas tomar.<br>
                                      El verano pasado, a la Fan Faire de Minneapolis 
                                      asist&iacute;.<br>
                                      All&iacute; me divert&iacute; y algunos 
                                      GMs y piratas conoc&iacute;.</p>
                                    <p align="center" class="bold">Al llegar el 
                                      se&ntilde;or de la bestia, y la noche lanzar 
                                      su veneno,<br>
                                      Fue como la tortura, de esperar de Luclin 
                                      el estreno<br>
                                      Las estanter&iacute;a estaban llenas, pronto 
                                      las vaciaron los compradores.<br>
                                      Todos nos apuntamos para poder ser los ganadores.<br>
                                      Los gr&aacute;ficos son fant&aacute;sticos, 
                                      el sistema es muy bueno.<br>
                                      Abrazar&iacute;a al programador, si no pegara 
                                      &eacute;l luego.</p>
                                    <p align="center"><span class="bold">Me querr&iacute;a 
                                      detener ahora en la labor de estos desarrolladores<br>
                                      y agradecerles su esfuerzo en nombre de 
                                      los jugadores.<br>
                                      Me alegro de que todos vosotros jugu&eacute;is 
                                      a EverQuest con un servidor,<br>
                                      a pesar de que muchos me consider&aacute;is 
                                      un perdedor.<br>
                                      Disfrutemos de este momento en el que Norrath 
                                      y la Tierra son tan s&oacute;lo uno.<br>
                                      Y perdonadme tambi&eacute;n, si hubiera 
                                      sido inoportuno.</span><br>
                                    </p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
