...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/devbytes_orlando_de.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center"> 
                                      <p align="left" class="bold"><span class="bold">EverQuest 
                                        Produzent Jeff Butler und Produktionsassistent 
                                        Bill Coyle beantworten Fragen im Produzenten-Diskussionsforum 
                                        an der Fanmesse in Orlando.</span></p>
                                      <p align="left" class="bold"><br>
                                        <a href="../sounds/01-L1CM.mp3" class="bold2">Bill 
                                        Coyle spricht &uuml;ber die Ausgewogenheit 
                                        zwischen PvP und PvE.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/02-L1CM.mp3" class="bold2">Jeff 
                                        Butler erkl&auml;rt, dass H&auml;user 
                                        f&uuml;r Spieler nicht geplant sind.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/03-L1CM.mp3" class="bold2">Mehr 
                                        &uuml;ber spielereigene H&auml;user.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/04-L1CM.mp3" class="bold2">Geld 
                                        sinkt und verschiedene W&uuml;nsche.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/05-L1CM.mp3" class="bold2">Turniere 
                                        w&auml;ren klasse!</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/06-L1CM.mp3" class="bold2">Fragt 
                                        Lawrence, aber hier ist meine Meinung.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/07-L1CM.mp3" class="bold2">Auftauch-Zeiten, 
                                        europ&auml;ische Gilden und Wechsel zu 
                                        anderen Servern.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/08-L1CM.mp3" class="bold2">PvP-Rassen-Kriege 
                                        und &Uuml;berkreuz-Gruppierungen.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/09-L1CM.mp3" class="bold2">Ausgebrannte 
                                        Kleriker h&ouml;herer Stufen.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/10-L1CM.mp3" class="bold2">Mehr 
                                        spa&szlig;ige Dinge, die man mit einem 
                                        Kleriker machen kann.</a></p>
                                      <p align="left" class="bold">
                                        <a href="../sounds/11-L1CM.mp3" class="bold2">&Uuml;bers 
                                        sch&ouml;ne blaue Meer segeln &#133; und 
                                        segeln, und segeln, und segeln.</a></p>
                                      <p align="left"><span class="bold">
                                        <a href="../sounds/12-L1CM.mp3" class="bold2">Pfadprogrammierung 
                                        in Luclin</a><br>
                                        </span> </p>
                                    </div>
                                    <!-- #EndEditable --></td>
