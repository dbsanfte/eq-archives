...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/dinner_esp.jsp?null');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      ...
                                      <p align="center"><font size="4"><b><font color="#000000">Demos 
                                        a estos gu&iacute;as un fuerte aplauso</font></b></font></p>
                                      <p class="bold" align="justify"><span class="bold">Tal 
                                        como ha sucedido en los &uacute;ltimos 
                                        encuentros de fan&aacute;ticos, la Cena 
                                        en Honor de los Gu&iacute;as celebrada 
                                        la noche del viernes por Verant para el 
                                        Programa de Gu&iacute;as, reuni&oacute; 
                                        a un gran n&uacute;mero de gu&iacute;as 
                                        de EverQuest. La cena es justamente eso: 
                                        la manera de Verant de decir &quot;gracias&quot; 
                                        a todos los voluntarios que donaron su 
                                        tiempo para ayudar a sus compa&ntilde;eros 
                                        jugadores. Acompa&ntilde;ados por numerosas 
                                        &quot;celebridades de Verant&quot;, GM 
                                        (maestros del juego) y otros empleados 
                                        de Verant, quienes concurrieron al encuentro 
                                        tuvieron la oportunidad de conocerse personalmente, 
                                        muchos de ellos por primera vez, y asociar 
                                        finalmente un nombre con una cara.</span></p>
                                      <p class="bold" align="justify"><span class="bold">La 
                                        velada comenz&oacute; con un juego pensado 
                                        para romper el hielo. Cada persona ten&iacute;a 
                                        una peque&ntilde;a etiqueta pegada en 
                                        la espalda o cuello de la ropa, en la 
                                        que estaba escrita una frase relacionada 
                                        con EverQuest. La idea era relacionarse 
                                        con otros y hacer preguntas que pudieran 
                                        contestarse con &quot;s&iacute;&quot; 
                                        o &quot;no&quot; y usar luego la informaci&oacute;n 
                                        para intentar deducir quién o qué se era. 
                                        A veces era f&aacute;cil adivinar, otras 
                                        increíblemente dif&iacute;cil... y siempre 
                                        depend&iacute;a de cu&aacute;nto sab&iacute;a 
                                        la persona del juego. Me avergüenza admitir 
                                        que, a pesar de considerar que pose&iacute;a 
                                        un conocimiento bastante <img src="screenshots/MVC00052_sml.jpg" width="200" height="150" align="left" vspace="10" hspace="10">amplio 
                                        del juego, me tom&oacute; un tiempo descubrir 
                                        que yo era un Drag&oacute;n Dirk (para 
                                        ser honesto, la mayor parte del tiempo 
                                        transcurri&oacute; luego de que logr&eacute; 
                                        reducir las posibilidades a un elemento 
                                        general, pues en el juego hay muchas dagas 
                                        m&aacute;gicas). Nuestro propio Absor 
                                        era, no solo un NPC (personaje no jugador), 
                                        sino tambi&eacute;n una zona. &iquest;Puedes 
                                        adivinar qui&eacute;n/qu&eacute; era? 
                                        Si contestaste Najena, entonces estabas 
                                        en lo correcto.</span></p>
                                      <p class="bold" align="justify"><span class="bold">Ocupando 
                                        m&aacute;s de una docena de mesas, cada 
                                        una con aproximadamente doce personas, 
                                        todo el mundo disfrut&oacute; de una excelente 
                                        cena compuesta de costillas, patatas hervidas 
                                        y vegetales, todo seguido de un postre 
                                        de crema de cerezas servida en una caparaz&oacute;n 
                                        de chocolate amargo. Entre plato y plato, 
                                        los invitados recibieron las &uacute;ltimas 
                                        noticias del NSS (Norrathian Secret Service 
                                        - servicio secreto de Norrath - nombre 
                                        ficticio para los Gu&iacute;as y GMs) 
                                        presentadas como un bolet&iacute;n informativo 
                                        de ficci&oacute;n. Los participantes se 
                                        divirtieron con noticias sobre los &quot;Shammies&quot; 
                                        que premiaban canciones como &quot;Deja 
                                        de arrastrar mi cad&aacute;ver por todos 
                                        lados&quot;, &quot;Como un Newbie&quot; 
                                        y &quot;Tren de medianoche a Mistmoore&quot;. 
                                        Entre otras noticias m&aacute;s importantes, 
                                        el informe m&aacute;s reciente del clima 
                                        se&ntilde;alaba que una ola de fr&iacute;o 
                                        azotaba el continente de Velious causando 
                                        fuertes nevadas. El NSS, que supervisa 
                                        el Servicio Climatol&oacute;gico de Norrath, 
                                        anunci&oacute; que esperaban que el fr&iacute;o 
                                        y nevadas solo duraran para siempre y 
                                        que no hab&iacute;a motivos para alarmarse. 
                                        </span></p>
                                      <p class="bold" align="justify"><span class="bold">Para 
                                        facilitar a&uacute;n m&aacute;s el que 
                                        todos se conocieran, Cindy Archuleta, 
                                        coordinadora del encuentro, pidi&oacute; 
                                        a todos los empleados de Verant que se 
                                        presentaran al p&uacute;blico. No result&oacute; 
                                        sorprendente que los personajes m&aacute;s 
                                        familiares, como por ejemplo, Absor y 
                                        Akriss Flamewalker, recibieran m&aacute;s 
                                        aplausos y como era de esperarse, quienes 
                                        no tienen tanto contacto con el p&uacute;blico 
                                        tuvieron un recibimiento m&aacute;s fr&iacute;o. 
                                        Mucho m&aacute;s caluroso fue el recibimiento 
                                        de los GMs y Gu&iacute;as <img src="screenshots/MVC00055_sml.jpg" width="200" height="150" align="right" vspace="10" hspace="10">Principales, 
                                        puesto que muchos de los concurrentes 
                                        ya hab&iacute;an entablado amistad online 
                                        mientras esperaban para la solicitud. 
                                        </span></p>
                                      <p class="bold" align="justify"><span class="bold">Una 
                                        vez finalizadas las presentaciones y la 
                                        cena, el Gu&iacute;a Mayor Semiramis subi&oacute; 
                                        al podio para agradecer personalmente 
                                        a todos los gu&iacute;as voluntarios. 
                                        De no ser por los gu&iacute;as que generosamente 
                                        ofrecen su tiempo para ayudar a sus compa&ntilde;eros 
                                        jugadores con todo tipo de cosas, desde 
                                        cad&aacute;veres atascados hasta disputas 
                                        de acampadas, Norrath ser&iacute;a un 
                                        lugar mucho menos amistoso. As&iacute; 
                                        que, la pr&oacute;xima vez que tengas 
                                        un problema o un reclamo para un gu&iacute;a, 
                                        recuerda qui&eacute;n est&aacute; del 
                                        otro lado de la pantalla. Un gu&iacute;a 
                                        es otro jugador como t&uacute;, y ellos 
                                        no reciben pago alguno por la tarea que 
                                        desempe&ntilde;an. Dedican su tiempo para 
                                        hacer de Norrath un lugar mejor, y por 
                                        ello, merecen nuestro agradecimiento, 
                                        ahora y siempre. </span></p>
                                      <p class="bold" align="justify"><font size="1"></font></p>
                                      <p>&nbsp;</p>
                                    </div>
