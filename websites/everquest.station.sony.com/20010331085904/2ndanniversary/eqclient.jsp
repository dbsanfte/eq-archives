      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td align="center" valign="top" background="images/BG.jpg"> 
            <p class="header">Early EQ Client</p>
            <p align="left">This is a very early EverQuest client.  The technical term in the industry is &quot;proof of concept.&quot;  A total of less than 2 megs zipped up, this program will let you walk around, switch between two different views, and see a couple of NPCs!</p>
            <p align="left"><b>Instructions</b></p>
            <div align="left">
              <ul>
                <li><a href="media/oldeq.zip">Click here to Download the EQ client</a>. </li>
                <li>Make a new directory on your hard drive and unzip the contents of the file into that directory.  All files must be in the same directory.</li>
                <li>Set your desktop to 256 colors.  It won't run in anything higher.</li>
                <li>Double click &quot;everquest.exe&quot;</li>
                <li>Login is: solo</li>
                <li>Leave the password field blank.</li>
                <li>The client will start in a window.  Hit &quot;<b>F2</b>&quot; to go to full-screen mode.</li>
                <li>To exit the client, hit your <b>escape</b> key.</li>
              </ul>
              <p>Move around using the arrow keys.  To jump, hit the + key on your keypad.  You can even set the &quot;power&quot; of your jump by typing jump xxx where xxx is a number.   Be aware you can literally fly off the map this way. :)</p>
              <p>Thanks to Uenelr Flamefist of Druzzil Ro and Nanlayan D'Vrynn of Tarew Marr for writing in with the info about the jump options!</p>
            </div>
            <p align="left">Thanks to Brad McQuaid, Jeff Butler, and Gordon Wrinn for helping us to acquire this little gem!<br>
            </p>
            <p class="header"><br>
