...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">19387 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
...
<FONT SIZE=2>
              ...
              <P><a href="#_Toc514496643">DirectX 7.0a or Higher Required</a></P>
              <FONT SIZE=2>
...
<I><FONT FACE="Arial">
            ...
            <P><B><A NAME="_Toc514496643">DirectX 7.0a or Higher Required</A></B></P>
            </font></i></font></I><FONT FACE="Arial" SIZE=2>
            ...
            <DIR>
              ...
              <DIR>
                ...
                <P>EverQuest now requires that clients have DirectX 7.0a or higher installed.  </P>
            ...
            <OL>
              ...
              <OL>
                ...
                <LI>Go up to the run box.</LI>
                <LI>In the Run window, type DXDIAG then hit ok. This will launch the DirectX diagnostics tool. </LI>
              </OL>
            </OL>
            <DIR>
              ...
              <DIR>
                ...
                <P>Your version of DirectX will be listed at the bottom of System Information.  Version 7.0a is listed as "DirectX 7.0 (4.07.00.0716)"</P>
            ...
            <OL>
              ...
              <OL>
                ...
                <LI>Go to <A HREF="http://download.microsoft.com/download/win98SE/Update/7.0a/W9X/EN-US/DX7Aeng.exe"><FONT FACE="Arial" SIZE=2>http://download.microsoft.com/download/win98SE/Update/7.0a/W9X/EN-US/DX7Aeng.exe</FONT></A><FONT FACE="Arial" SIZE=2> and install the latest DirectX drivers for your operating system.  </font></LI>
                <LI>Go to the website for your 3D accelerator. There are a number of different manufacturers, and it is preferred that you visit the website for the manufacturer of your card.  You can, at your option, go to the chipset manufacturer site.  Most will be able to use either <A HREF="http://www.3dfx.com/"><FONT FACE="Arial" SIZE=2>www.3dfx.com</FONT></A><FONT FACE="Arial" SIZE=2> (for Voodoo cards) or </FONT><A HREF="http://www.nvidia.com/"><FONT FACE="Arial" SIZE=2>www.nvidia.com</FONT></A><FONT FACE="Arial" SIZE=2> (for TNT/GeForce cards).  Download and install the latest drivers for your card and operating system.  See our Video FAQ: (</FONT><A HREF="http://everquest.station.sony.com/support/audio_video/index.jsp"><U><FONT FACE="Arial" SIZE=2 COLOR="#0000ff">http://everquest.station.sony.com/support/audio_video/index.jsp</font></U></A><FONT FACE="Arial" SIZE=2>) for more details.</font></LI>
                <LI>Go to the website for your sound card manufacturer and do the same.  If you do not know what brand of sound card you have, you can right-click on &quot;My Computer&quot;, go to properties, click on &quot;Device Manager&quot;, and open &quot;Sound, Video, and Game Controllers&quot;.  If you use a SBLive sound card, you can run &quot;LiveUpdate&quot; from the Windows Control Panel off of your start menu.  View our Sound FAQ: (<A HREF="http://everquest.station.sony.com/support/audio_video/general_audio_troubleshooting.jsp"><FONT FACE="Arial" SIZE=2>http://everquest.station.sony.com/support/audio_video/general_audio_troubleshooting.jsp</FONT></A><FONT FACE="Arial" SIZE=2> ) for driver locations and more details.</font></LI>
              </OL>
            </OL>
            <DIR>
            ...
            <OL>
              ...
              <OL>
                ...
                <LI>Run DXDIAG.EXE from your Start menu (click start, run, then type dxdiag.exe)</LI>
                <LI>Click the &quot;Save all Information&quot; button at the bottom of the program window.</LI>
                <LI>Save the file as dxdiag.txt</LI>
              </OL>
            </OL>
            <P>&nbsp;</P>
            <DIR>
              ...
              <DIR>
                ...
                <P>Copy the contents of that file into the form at <A HREF="http://www.station.sony.com/services/everquest-technical.jhtml"><FONT FACE="Arial" SIZE=2>http://www.station.sony.com/services/everquest-technical.jhtml</FONT></A><FONT FACE="Arial" SIZE=2> along with a complete description of your problem, any text from any error messages that are presented, and a phone number that you can be reached at if you are willing to assist our testing department over the phone.</font></P>
                <P>Also, if you experience a crash to the desktop while running EverQuest, please email your dbg.txt file from your EverQuest directory to <A HREF="mailto:EQtech@station.sony.com"><FONT FACE="Arial" SIZE=2>EQtech@station.sony.com</FONT></A><FONT FACE="Arial" SIZE=2>.</font></P>
              </DIR>
            </DIR>
            </FONT>
<I><FONT FACE="Arial">
