<html><!-- #BeginTemplate "/Templates/justice_template.dwt" --><!-- DW6 -->
<head>
...
<body onResize="gnav_init();" text="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" background="images2/justice_tile.jpg" onLoad="MM_preloadImages('images/home_on.jpg','images/features_on.jpg','images/media_on.jpg','images/FAQ_on.jpg','images/planes_on.jpg','images/return_on.jpg','images/prologue_on.jpg')">
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/features.jsp?null');">
...
<table bgcolor="#000000" width="757" border="0" cellspacing="0" cellpadding="0" height="610" align="center">
  ...
  <tr> 
    <td colspan="3" height="41"><!-- #BeginEditable "Bar" --><img src="images2/bluebar_features.jpg" width="661" height="40"><!-- #EndEditable --></td>
...
document.write('<IFRAME SRC="http://ad.doubleclick.net/adi/games.everquest.spde.dart/home_120x600;!category=popup;' +prof  + 'pwrhm=pwrhm_13;sz=120x600;tile=13;ord=' + ord + '?" width="120" height="600" frameborder="no" border="0" MARGINWIDTH="0" MARGINHEIGHT="0" SCROLLING="no">');
document.write('<A HREF="http://ad.doubleclick.net/jump/games.everquest.spde.dart/home_120x600;!category=popup;' + prof  + 'pwrhm=pwrhm_13;sz=120x600;tile=13;ord=' + ord + '?"><IMG SRC="http://ad.doubleclick.net/ad/games.everquest.spde.dart/home_120x600;!category=popup;' + prof + 'pwrhm=pwrhm_13;sz=120x600;tile=13;ord=' + ord + '?" border=0 height="600" width="120"></A>');
document.write('</IFRAME>');
document.write('</NOLAYER>');
document.write('<ILAYER id="layer13" width=120 height=600></ILAYER>');
...
<script language="JavaScript" type="text/javascript">
  ...
  <tr> 
    ...
    <td height="30" width="193" valign="top" align="left"> <table width="193" height="323" cellpadding="0" cellspacing="0" border="0">
        <tr> 
        ...
        <tr> 
          <td align="left"><img src="images/menu_legs.jpg" width="193" height="84"></td>
        </tr>
        <tr> 
    ...
    <td height="30" width="467" valign="top"> <!-- #BeginEditable "Text" --><span class="link2"><br>
      The Planes of Power<font color="#CCCCCC">&#153;</font></span> 
      <p class="link">The launch of EverQuest<sup><font color="#CCCCCC">&reg;</font></sup> in March 1999 changed the world 
        of massively multiplayer online gaming forever. Since then we have brought 
        you a new playable race of lizard men called the Iksar in EverQuest: The 
        Ruins of Kunark<font color="#CCCCCC">&#153;</font>, ancient enemies and new adventures on the frozen 
        continent of Velious in EverQuest: The Scars of Velious<font color="#CCCCCC">&#153;</font>, and a completely 
        graphically overhauled world, the enchanting moonscape of Luclin, mounts, 
        and a new playable race of noble cat people, the Vah Shir, in EverQuest: 
        The Shadows of Luclin<font color="#CCCCCC">&#153;</font>. Now players will soon be able to face the 
        most powerful deities in all of Norrath. We are excited to announce the 
        next installment in the best-selling, critically acclaimed EverQuest series, 
        EverQuest: The Planes of Power<font color="#CCCCCC">&#153;</font>. </p>
      <p class="link">An arcing storyline takes players on an epic adventure through 
        the Planes of Power, home of the Gods of Norrath. Veteran players will 
        face new challenges in each of up to 18 newly discovered planes. Players 
        of all levels will benefit from the Plane of Knowledge that hosts scores 
        of new quests and opens portals to Norrath making travel easier than ever. 
        Hundreds of new items, quests and encounters will keep even the most veteran 
        of players challenged and enthralled. </p>
      <p class="link">Battle the minions of Rallos Zek in the Plane of War; help 
        Karana regain control of the Plane of Storms; overcome vile pestilence 
        in the Plane of Disease!</p>
      <p class="link">You're in their worlds now!</p>
      <p class="link"><br>
        <b><u>EverQuest: The Planes of Power Features List:</u></b></p>
      <span class="link">
     <ul><li>Up to 20 new planar zones that push your teamwork 
        abilities to the limit
      <li>Hundreds of new items and monsters
      <li>Exciting new quests and challenges await even the 
        most experienced players
      <li>Two planar cities that provide hubs for travel and 
        player interaction
      <li>A central storyline links the content from every 
        zone into one compelling quest.
      <li>Further character progression making players even 
        more powerful
     </ul></span>
        <br>
        <p>&nbsp; </p>
...
<SCRIPT LANGUAGE="JavaScript">
<!--
document.write('<layer src="http://ad.doubleclick.net/adl/games.everquest.spde.dart/home_120x600;!category=popup;' + prof  + 'pwrhm=pwrhm_13;sz=120x600;tile=13;ord=' + ord + '?" width="120" height="600"  onload="moveToAbsolute(layer13.pageX,layer13.pageY); visibility=\'show\';" clip="120,600"></layer>');
//-->
</SCRIPT>
</body>
<!-- #EndTemplate --></html>
