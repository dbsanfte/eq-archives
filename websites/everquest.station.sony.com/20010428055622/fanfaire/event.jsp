...
<script language="JavaScript" ssrc="http://www.station.sony.com/common/comm_opener.js">
<!--
...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">78927 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                ...
                <td rowspan="2" valign=top>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td> 
                        <div align="center"><br>
                          <img src="images/event.gif" width="296" height="49"> 
                        </div>
                      </td>
                    </tr>
                    <tr> 
...
padding="8" background=asdf align="center">
                                      <tr>
                                        <td>
                                          <div align="center"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      
                                      </b></font>
                                            <table BORDER cellspacing=1 cellpadding=7
width=590 bordercolor="#000000">
                                              <tr bgcolor="#000000">
                                                <td valign="TOP" colspan=2>

                                                  <p align="CENTER"><b><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><span class="bold"><font color="#FFFFFF">Friday, June, 15</font>
                                            </span></font></b>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td width="50%" valign="TOP">
                                                  ...
                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Early Registration
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP">

                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">5-8:00 p.m.
                                            </span></b></font>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td width="50%" valign="TOP">
                                                  ...
                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Reception
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP">

                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">8-10:00 p.m.
                                            </span></b></font>
                                                </td>
                                              </tr>
                                              <tr bgcolor="#000000">
                                                <td valign="TOP" colspan=2>
                                                  <p align="CENTER"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold"><font color="#FFFFFF">Saturday, June 16</font>

                                          </span></b></font>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td width="50%" valign="TOP" class="bo
ld">

                                                  <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Late Registration
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP" class="bo
ld">

                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">12-1:00 p.m.
                                            </span></b></font>
                                                </td>
                                              </tr>
...
ld">
                                                  ...
                                                  <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Fan Faire Begins!
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP" class="bo
ld">

                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">1:00
                                            </span></b></font>
                                                </td>
                                              </tr>
                                              <tr>
...
ld">
                                                  ...
                                                  <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Real Life Quest
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP" class="bo
ld">

                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">1:30-3:30
                                            </span></b></font>
                                                </td>
                                              </tr>
                                              <tr>
...
ld">
                                                  ...
                                                  <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Discussion panels and in-game quest
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP" class="bo
ld">

                                                  <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">3:30-5:00
                                            </span></b></font>
                                                </td>
                                              </tr>
                                              <tr>
...
ld">
                                                  ...
                                                  <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Dinner and prizes awarded
                                            </span></b></font>
                                                </td>
                                                <td width="50%" valign="TOP" class="bo
ld">

                                                  <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">7:00
                                            </span></b></font>
                                                </td>
                                              </tr>
                                            </table>
