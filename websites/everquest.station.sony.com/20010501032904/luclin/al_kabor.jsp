...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">86973 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td background="images/tile.jpg" width="100%" align="right">
            <img src="images/scroll_04.gif" width="230" height="52"></td>
        ...
        <tr>
          ...
          <td colspan="2" background="images/tile.jpg">
            <p>&nbsp;</p>
