...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/winners_dallas_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/winners_dallas_fr.jsp');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"><span class="bold">Liste 
                                      des gagnants </span> </div>
                                    <p class="bold">LiveQuest<img src="screenshots/ff_dallas/article_images/Dsc00993.jpg" width="320" height="240" align="right"><br>
                                      <br>
                                      Serveur : Tarew Marr<br>
                                      Guilde : <a href="http://www.blackcompany.cc/" target="_blank" class="bold2">Black 
                                      Company </a></p>
                                    <p class="bold">Citaria (Ma&icirc;tre de Guilde)<br>
                                      Lujan <br>
                                      Tierra<br>
                                      Rennol<br>
                                      Hakeshar<br>
                                      ...
                                      *Arnaxus<br>
                                      **Vaslin </p>
                                    <p class="bold">*Arnaxus &eacute;tait un membre 
                                      suppl&eacute;mentaire de l'&eacute;quipe, 
                                      actuellement sans Guilde.<br>
                                      **Vaslin de la Guilde <a href="http://www.thesafehouse.org/" target="_blank" class="bold2">Safehouse</a> 
                                      &eacute;tait un membre suppl&eacute;mentaire 
                                      de l'&eacute;quipe et ne fait pas partie 
                                      de la Guilde Black Company.</p>
                                    <p><span class="bold"><br>
                                      <br>
                                      Carte Graphique GeForce 3 de <a href="http://www.pny.com/home/products/vcard_index.cfm" target="_blank" class="bold2">PNY 
                                      </a><br>
                                      <br>
                                      Charnas<br>
                                      Souls Forged<br>
                                      ...
                                      <br>
                                      Banni&egrave;re de la Fan Faire<br>
                                      <br>
                                      Alcnea<br>
                                      Mystic Gathering<br>
                                      E'Ci<br>
