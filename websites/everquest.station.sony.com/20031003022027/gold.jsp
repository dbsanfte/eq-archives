	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gold.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gold.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/gold.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                              ...
                              <td>
                                <table width="468" border="0" cellspacing="0" cellpadding="0" height="180" background="">
                                  ...
                                  <tr>
                                    ...
                                    <p><img src="new_images/Gold_banner.jpg" width="430" height="131"></p>
                                    <!-- InstanceEndEditable -->
                                    </td>
            ...
            <table width="467" border="0" cellspacing="0" cellpadding="0">
              <tr>
                    ...
                    <tr align="center"> 
                        ...
                        <td width="65%" align="left">EverQuest&reg;: Gold is truly 
                          a unique offering for the EverQuest fan. The best collectibles 
                          from EverQuest have been gathered together into this 
                          one limited edition package, as well as the EverQuest 
                          expansion packs The Ruins of Kunark(tm), The Scars of 
                          Velious(tm), The Shadows of Luclin(tm) and The Planes 
                          of Power(tm). All of this is stored in a striking gold 
                          metallic tin package. Whether you're a casual EQer or 
                          a die-hard fan, there is something for you in the EverQuest: 
                          Gold Collector's Edition!</td>
                        <td width="35%"><a href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-HG-SW1102-EQGOLD"><img src="new_images/software_eqgoldbox01.gif" width="151" height="119" border="0"></a><br>
                        <a href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-HG-SW1102-EQGOLD"><br>
                        Buy It!</a></td>
                    </tr>
                  ...
                  <table width="430" border="0" cellspacing="0" cellpadding="4" background="">
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/eq/01.jsp','565')"><img src="new_screenshots/eq/01_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/eq/02.jsp','565')"><img src="new_screenshots/eq/02_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/eq/03.jsp','565')"><img src="new_screenshots/eq/03_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/eq/04.jsp','565')"><img src="new_screenshots/eq/04_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/eq/05.jsp','565')"><img src="new_screenshots/eq/05_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/eq/06.jsp','565')"><img src="new_screenshots/eq/06_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/eq/07.jsp','565')"><img src="new_screenshots/eq/07_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/eq/08.jsp','565')"><img src="new_screenshots/eq/08_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                    
                  </table>
                  <p><center>
                        <a href="http://www.esrb.org"><img src="images/rating_t.gif" alt="Animated Blood &amp; Gore
Violence
Suggestive Themes" width="38" height="53" border="0"></a>
</center></p>
