...
<head>
<!-- #BeginEditable "title" --> 
<title>EverQuest: The Planes of Power - Media</title>
<!-- #EndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/media.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/media.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/media.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td><!-- #BeginEditable "header" --><img src="images4/headers_media.jpg" width="577" height="51"><!-- #EndEditable --></td>
    ...
    <td background="images4/main_bg.jpg" valign="top"> <!-- #BeginEditable "Content" --> 
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> 
            <br>
            <p align="center"><a href="screenshots.jsp"><img src="images/media_screenshots.gif" border="0" width="440" height="34"></a></p>
            <p class="link" align="center">Get a glimpse of what awaits in the 
              Planes of Power.</p>
            <p align="center"><a href="concept_art.jsp"><img src="images/media_concept_art.gif" border="0" width="440" height="34"></a></p>
            <p class="link" align="center">From the drawing board to the game, 
              the evolution of Planes of Power art.</p>
            <p align="center"><a href="wallpapers.jsp"><img src="images/media_wallpaper.gif" border="0" width="440" height="34"></a></p>
            <p class="link" align="center">Paper your desktop with stunning artwork 
              from The Planes of Power.</p>
            <p align="center"><a href="movies.jsp"><img src="images/media_movies.gif" border="0" width="440" height="34"></a></p>
            <p class="link" align="center">Experience the action and artistry 
              of The Planes of Power</p>
            <p class="link3">&nbsp;</p>
          </td>
        </tr>
        <tr> 
