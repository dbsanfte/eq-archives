...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_orlando_fr.jsp?null');">
...
<p align="justify" class="bold"><a href="wedding_orlando.jsp" class="bold2"> Il y a de l'amour dans l'air...</a>
- Le 6 octobre , deux joueurs d'EverQuest, Krissy et Dave, se sont mari&eacute;s pour de vrai. Le 20 octobre, devant des centaines de participants &agrave; la Fan Faire, leurs personnages se sont mari&eacute;s dans le jeu sur le serveur &quot;Luclin&quot;.</p>
                                      <p align="justify" class="bold"><a 
href="report_orlando_fr.jsp" class="bold2"> Le rapport Mennix</a> <span class="bold">- 
                                        Cette fois encore, Steve &laquo; Mennix &raquo; Fuller a assist&eacute; &agrave; une autre Fan Faire EverQuest et nous confie ses r&eacute;flexions, dans son style bien particulier, sur ce qui s'est pass&eacute; &agrave; Orlando.<br>
                                        </span></p>
                                      <p align="justify" class="bold"><a 
href="devbytes_orlando_fr.jsp" class="bold2">Enregistrement des designers </a> 
                                        <span class="bold">- Lors de la Fan Faire, 
                                        &agrave; la table ronde des Producteurs, 
                                        Jeff Butler and Bill Coyle ont fait face 
                                        &agrave; des questions qui allaient des 
                                        probl&egrave;mes d'&eacute;quilibre entre 
                                        les classes aux fonctionnalit&eacute;s 
                                        de jeu de Luclin. &Eacute;coutez quelques 
                                        prises s&eacute;lectionn&eacute;es, au 
                                        format MP3, de leurs r&eacute;ponses.</span></p>
                                      <p align="justify" class="bold"><span class="bold"><a href="winners_orlando_fr.jsp" class="bold2">Listes des vainqueurs</a> - L'&eacute;quipe X de Mithaniel Marr a gagn&eacute; la Qu&ecirc;te organis&eacute; lors de la Fan Faire. Chaque membre de l'&eacute;quipe va recevoir une version de &quot;EverQuest : Shadows of Luclin&quot; d&egrave;s qu'elle sera disponible en d&eacute;cembre. Les vainqueurs des loteries recevront &eacute;galement leur version de Luclin.<br>
                                        </span></p>
                                      <p align="center"><a href="scrapbook_orlando_photos.jsp" class="bold2">
