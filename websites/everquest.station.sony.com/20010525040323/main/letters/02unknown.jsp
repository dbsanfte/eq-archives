...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">83515 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <td>
                            ...
                            <form name="form1">
                              <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                                ...
                                <option value="/main/letter.jsp">March 1, 2001 - George Scotto - Improving Customer Service</option>
