...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">48,002 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/index.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/index.jsp');">
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr>
                <td>
                  <div align="center"><img src="images/home_header.gif"></div>
                </td>
  </tr>
  <tr>
    <td>
                  <p class="text">The Fan Faire is heading to San Francisco! Join 
                    us at the <a href="http://metreon.com/" class="links" target="_blank">Sony 
                    Metreon</a> and the <a href="http://www.marriott.com/epp/default.asp?MarshaCode=SFODT" class="links" target="_blank">San 
                    Francisco Marriott</a> on November 8-9! Come and enjoy all 
                    that San Francisco and the Sony Metreon have to offer!</p>
                  <p class="textBold"><span class="text">The San Francisco Marriott 
                    is right across the street from the Metreon. You'll find activities 
                    in both places throughout the weekend. We have been given 
                    a group rate of $139--just ask for the EverQuest Fan Faire 
                    rate. You can call and make your reservations now at (800) 
                    228-9290. Remember, the last Fan Faire hotel sold out of rooms 
                    weeks before the event. Hurry and make your reservations now!</span></p>
                  <p class="text">Registration is now open. Click <a href="https://store.station.sony.com/fanfaire/en/registration.jsp" class="links">here</a> 
                    to sign up. Cost is $89.00. Space is limited and we are close 
                    to selling out, so sign up soon. See you in San Francisco!</p>
                  </td>
  </tr>
</table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  <div align="center"><img src="images/spacer.gif" width="2" height="15"></div>
                </td>
              </tr>
              <tr>
                <td>
                  <div align="center">
                    <p><a href="scrapbook_boston_photos.jsp"><img src="images/photo_strip.gif" width="559" height="73" border="0"></a><br>
                      <a href="scrapbook_boston_photos.jsp" class="links">Photo 
                      Gallery</a></p>
                    <p>
                      <span class="textBold">Fan Faire is a real-life event for 
                      EverQuest players <br>
