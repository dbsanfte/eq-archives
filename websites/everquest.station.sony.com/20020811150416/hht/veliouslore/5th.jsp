          ...
          <td><!-- #BeginEditable "body" --> 
            <center>
              ...
              <center>
                ...
                The Coldain City</span> 
                <p>&nbsp;</p>
                <p align="left" class="subHeader"> Day 5</p>
                <p align="left"><a href="javascript:openWindow('screenshots/day5_1.html', '775')"><img src="images/day5_1_lo.jpg" width="320" height="240" align="left" border="0" hspace="8"></a>One 
                  might expect an underground city, carved out of rock and ice 
                  , to be filled with dust and dampness, but the adventurers report 
                  that the city is quite remarkable. As one can see in the image 
                  here, the Coldain are very talented artists, and reverent of 
                  their ancestors. The ice sculptures in Remembrance Park bear 
                  silent witness to the deeds of Colin Dain, their ancient leader, 
                  Glight Snowchipper, hero and savior of the early settlement.</p>
                <br clear=all>
                <p align="left"><a href="javascript:openWindow('screenshots/day5_4.html', '775')"><img src="images/day5_4_lo.jpg" width="320" height="240" align="right" border="0" hspace="8"></a>Just 
                  outside the mines are many small houses. This area is of poorer 
                  quality than the majority of the city, and serves as residential 
                  property for the miners and smiths. The most renowned bar of 
                  Thurgadin is also in this area. Known as the Velium Keg, it 
                  boasts alcohol of extreme potency. In fact, the missive returned 
                  to us on this particular day began to grow somewhat scribbled 
                  at this point in the tale, and another of the party had to finish 
                  the writing.</p>
                <br clear=all>
                <p align="left">Mines have been dug deeply into the rock and velium 
                  of the mountain range. A Coldain miner the explorers met as 
                  they toured explained that his crew had recently excavated rather 
                  extensive mine shafts which broke into a series of caves. The 
                  miner’s eyes widened as he recounted their excitement at the 
                  discovery. When asked if the caverns were inhabited, the miner 
                  scoffed and boasted that if they had been, he and his men would 
                  have had no problem taking care of them. Of course, one of the 
                  tour guides did happen to cough strangely right about that time, 
                  which was noted in particular by one of the perspicacious gnome 
                  travelers. As it turns out, some of those who had gone in to 
                  explore are still missing.</p>
                <br clear=all>
                <p align="left"><a href="javascript:openWindow('screenshots/day5_2.html', '775')"><img src="images/day5_2_lo.jpg" width="320" height="240" align="left" border="0" hspace="8"></a>There 
                  is a district devoted to faith in Thurgadin, located through 
                  a tunnel to the west of the main city proper. An edifice they 
                  identified as the Temple of Lore, situated here is a shrine 
                  to both Brell Serilis and the history of the Coldain. We have 
                  learned that the priests of the temple are also loremasters 
                  and each one is an expert in a separate chapter of Coldain history. 
                  Tapestries line the walls of the temple depicting great moments 
                  in Coldain history. The temple also contains the only library 
                  in the city, where the scrolls of the ancestors are preserved 
                  and cared for. It was clear to all concerned that the Coldain 
                  are passionately devoted to preserving their heritage.</p>
                <br clear=all>
                <p align="left"><a href="javascript:openWindow('screenshots/day5_3.html', '775')"><img src="images/day5_3_lo.jpg" width="320" height="240" align="right" border="0" hspace="8"></a>A 
                  guild hall and training center for the IceRagers is nearby in 
                  the church district. The reports we have received depict these 
                  paladins as extreme zealots said to be quite formidable in combat. 
                  Their training is exhaustive and continual, as they must be 
                  highly vigilant against the many threats posed by the inhabitants 
                  of the ice continent.</p>
                <br clear=all>
                <p align="left">When questioned about disciplinary procedures, 
                  the Coldain appeared to be at a loss. It seems they have very 
                  little crime or even negligence of any sort among their race. 
                  Once the concept was explained successfully, and related to 
                  punishment of invaders, they nodded in understanding and made 
                  an oblique reference to something called &quot;The Pit,&quot; 
                  which comment was apparently accompanied by satisfied smirks. 
                  Though the party has not yet learned the nature of this &quot;pit,&quot; 
                  they got the impression that it was a very dangerous place to 
                  be.</p>
                <br clear=all>
              </center>
              <!-- #EndEditable --> 
              <div align="center"><img src="../../images/spacer.gif" width="15" height="25"><a href="4th.jsp">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="6th.jsp">Next</a></div>
          </center>
            <!-- #EndEditable --></td>
        </tr>
      </table>
