...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/scrapbook_dallas_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/scrapbook_dallas_esp.jsp');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      ...
                                      <p align="justify"><a href="report_dallas_esp.jsp" class="bold2">El 
                                        Informe Mennix </a><span class="bold"> 
                                        - El Adam's Mark Hotel en el precioso 
                                        corazón de Dallas recibió a cientos de 
                                        jugadores de EQ en la quinta EverQuest 
                                        Fan Faire que tuvo lugar los días 25 y 
                                        26 de enero, y Mennix volvía estar allí 
                                        para ofrecernos su opinión particular 
                                        sobre el evento.</span></p>
                                      <p><a href="winners_dallas_esp.jsp" class="bold2">Lista 
                                        de ganadores</a> <span class="bold">- 
                                        Enhorabuena al equipo Black Company del 
                                        servidor Tarew Marr por haber Ganado la 
                                        Competición Real Life celebrada en la 
                                        Fan Faire de Dallas. Cada miembro del 
                                        equipo estará a partir de ahora inmortalizado 
                                        en el mundo de Norrath cuando EQ NPCs 
                                        informen de su gran logro. </span></p>
                                      <p><a href="poem_dallas_esp.jsp" class="bold2">EQ 
                                        R Uber </a><span class="bold"> - Einaugenwilly 
                                        de la cofradía de la Torre de Hierro en 
                                        Vallon Zek honró a los asistentes a la 
                                        Fan Faire de Dallas con su talento para 
                                        la poesía. Con su permiso, nos sentimos 
                                        orgullosos de presentar a todo el mundo, 
                                        EQ R Uber, una obra original.</span> </p>
                                      <p><a href="guilds_dallas_esp.jsp" class="bold2">Crear 
                                        mejores cofradías</a><span class="bold"> 
                                        - uno de los paneles de discusión en la 
                                        Fan Faire de Dallas fue una discusión 
                                        sobre cómo crear una cofradía mejor, moderada 
                                        por Brian "Auric" DeMarco. Brian ofreció 
                                        una líneas maestras sobre qué hace que 
                                        una cofradía tenga éxito y qué características 
                                        deben observar jugadores a la hora de 
                                        unirse a una de ellas. </span></p>
                                      <p><a href="../media/Dallas%20Fan%20Faire.mov" class="bold2">The 
                                        Fan Faire Movie</a><span class="bold"> 
                                        - Sienta Everquest Fan Faire con esta 
                                        corta pel&iacute;cula que hemos filmado 
                                        en Dallas. Nuestro agradecimiento a Don 
                                        &quot;GM Pelegorian&quot; Conley y su 
                                        esposa Alexandra por proveer el video.</span></p>
