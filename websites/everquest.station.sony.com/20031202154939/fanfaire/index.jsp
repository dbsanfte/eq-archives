	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
  ...
  <tr valign="top"> 
    ...
    <td width="606" background="images/right_bg.jpg"> <table width="604" border="0" cellspacing="0" cellpadding="0" height="100%" background="">
        <tr> 
          ...
          <br>
            <div align="center">
              <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="558" height="330">
                <param name="movie" value="media/Chicago_Fanfaire_2003_2.swf">
                <param name="quality" value="high">
				 <param name="wmode" value="transparent">
  				<PARAM NAME="menu" VALUE="false">
                <embed src="media/Chicago_Fanfaire_2003_2.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="558" height="330"></embed></object>
            </div>
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr> 
                <td valign="top"> <p class="text"><i>Coming to Fan Faire? How 
                    would like to appear on national TV? Good Day Live, the Fox 
                    morning show, will be doing a segment on EverQuest on Friday, 
                    Sept. 26. If you're attending Fan Faire in costume or are 
                    planning to take part in the costume contest that evening, 
                    now is your chance to be on TV. If you'd like to take part, 
                    join us in the Arm Yourself For Adventure gaming room (Chicago 
                    Ballroom 8) at 10:30 AM. We're looking for the best dressed 
                    people to get on TV. See you there!</i></p>
                  <p class="text">Sony Online Entertainment is proud to announce 
                    the Fall 2003 Fan Faire! We will be hosting the Chicago Fan 
                    Faire at the Sheraton Chicago Hotel &amp; Towers on September 
                    26-28, 2003.</p>
                  <p>We have space at the Sheraton to make this the largest Fan 
                    Faire ever! We'll be admitting up to 2,500 to this Fan Faire, 
                    so register now to reserve your spot at the biggest Fan Faire 
                    event ever! The price for this event is the same as the Las 
                    Vegas Event, $89 for pre-registered attendees and $100 at 
                    the door.</p>
                  </td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> <div align="center"><img src="images/spacer.gif" width="2" height="15"></div></td>
              </tr>
              <tr> 
                <td> <div align="center"> 
                    <p><a href="scrapbook_chicago.jsp"><img src="images/photo_strip_chicago.jpg" width="559" height="73" border="0"></a><br>
                      <a href="scrapbook_chicago.jsp" class="links">Chicago Photo 
                      Gallery</a></p>
                    <p> <span class="textBold">Fan Faire is a real-life event 
                      for EverQuest players <br>
                      and their guests to meet other players, participate in events, 
                      and win prizes. <br>
                      Check out <a href="general_info.jsp" class="links"><b>General 
                      Information</b></a> and the <a href="faq.jsp" class="links"><b>Fan 
                      Faire FAQ</b></a> for further details</span></p>
                  </div></td>
              </tr>
            </table>
            <!-- #EndEditable --></td>
