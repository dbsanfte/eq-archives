...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_fr.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
								    <p><a href="scrapbook_dallas_fr.jsp" 
class="bold2">Fan Fan EverQuest de Dallas </a><span class="bold">- L'hôtel Adam's 
                                      Mark, situé dans le centre de Dallas au 
                                      Texas, dans le beau quartier des Arts et 
                                      de la Finance, a accueilli la Fan Faire 
                                      EverQuest de janvier. L'assistance a participé 
                                      à une Quête dans le monde réel, a pu rencontrer 
                                      l'équipe d'EverQuest et assister à divers 
                                      ateliers. Encore une Fan Faire réussie !</span></p>
                                    <p><a href="scrapbook_orlando_fr.jsp" 
class="bold2">Fan Faire EverQuest &agrave; Orlando </a><span class="bold">- En cette 
                                      p&eacute;riode de crise nationale o&ugrave; 
                                      les &Eacute;tats-Unis et ses alli&eacute;s 
                                      sont en guerre contre les forces du terrorisme, 
                                      plus de 1 200 fans d'EverQuest se sont rassembl&eacute;s 
                                      au Rosen Center d'Orlando en Floride pour 
                                      se d&eacute;tendre et s'amuser avec ceux 
                                      qui partagent leur passion pour EverQuest.</span></p>
                                    <p><a href="scrapbook_minneapolis_fr.jsp" 
class="bold2">Fan Faire EverQuest à Minneapolis </a><span class="bold"> - Plus 
                                      de 1200 joueurs d'EverQuest se sont rassemblés 
                                      au Marriott City Center de Minneapolis les 
                                      15 et 16 juin pour participer à la troisième 
                                      Fan Faire Everquest. Les joueurs et leurs 
                                      invités purent y voir un aperçu des bases 
                                      de la future extension du jeu, EverQuest: 
                                      The Shadows of Luclin. </span></p>
                                    <p> <a href="scrapbook_sandiego_fr.jsp" class="bold2">Fan 
                                      Faire EverQuest à San Diego </a><span class="bold"> 
                                      - La deuxième Fan Faire, qui s'est tenue 
                                      à l'hôtel et Marina Sheraton de San Diego 
                                      les 6 et 7 avril, fut le témoin d'un succès 
                                      croissant. Cette Fan Faire fut spéciale 
                                      car de nombreux Game Masters et employés 
                                      de Verant/SOE purent y assister et rencontrer 
                                      les joueurs d'EverQuest. </span> </p>
                                    <p><a href="scrapbook_baltimore_fr.jsp" class="bold2"><b><font face="Arial, 
Helvetica, sans-serif" size="2">Fan Faire EverQuest de Baltimore</font></b></a><span 
class="bold">- La Fan Faire EverQuest de Baltimore, qui s'est tenue les 2 et 3 
                                      février 2001 au Marriott de l'aéroport BWI, 
                                      fut de loin la plus réussie ! Ce fut le 
                                      premier rassemblement officiel de fans à 
                                      se tenir à guichets fermés avec plus de 
                                      1200 participants, sans compter de nombreuses 
                                      personnalités des médias.</span> </p>
                                    <p align="justify"><a href="scrapbook_velious_fr.jsp" class="bold2"><b><font 
face="Arial, Helvetica, sans-serif" size="2">Réception de lancement de Velious</font></b> 
                                      </a><font 
face="Arial, Helvetica, sans-serif" size="2"> <span class="bold"></span></font><font 
face="Arial, Helvetica, sans-serif" size="2"><span class="bold">- <font color="#000000"><b> 
                                      La réception de lancement de Velious, organisée 
                                      à Las Vegas au Nevada, les 5 et 6 novembre, 
                                      donna à la presse et au public un aperçu 
                                      de la toute dernière extension du monde 
                                      en pleine croissance d'EverQuest avant sa 
                                      sortie officielle.</b></font></span> </font></p>
                                    <p align="justify">&nbsp;</p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
