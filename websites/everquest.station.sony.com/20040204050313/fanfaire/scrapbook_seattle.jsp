	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_seattle.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_seattle.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_seattle.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
              ...
              <tr> 
                <td> 
                  <div align="justify"> 
                    ...
                    <p align="justify" class="text"><a href="report_seattle.jsp" class="links">The 
                      Mennix Report</a> - In his own unique way, Mennix fills 
                      everyone in on his impressions of the Seattle Fan Faire.</p>
                    <p align="justify" class="text"><a href="winners_seattle.jsp" class="links">List 
                      of Winners</a> - Join us in congratulating a big list of 
                      winners for this Fan Faire. Kudos to Team Rathe 1 for their 
                      Live Quest Victory.</p>
                    <p align="center" class="text" ><b><a href="scrapbook_seattle_photos.jsp" target="_top" class="bold2"><span class="links">Photo 
                      Gallery</span></a></b></p>
                  </div>
                  <p align="center">&nbsp;</p>
                  </td>
