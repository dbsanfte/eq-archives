		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/faq.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/faq.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
              ...
              <tr>
                <td><p class="text"><strong>What is a Fan Faire?</strong> <br>
                  ...
                  <p><strong>What if I need to cancel my registration? Can I get 
                    ...
                    can only be issued before the close of registration. <strong>Once 
                    registration is closed we must guarantee the number of attendees 
                    with the venue hosting the event. After September 8th there 
                    will be no changes to registrations, cancellations, or refunds.</strong></p>
