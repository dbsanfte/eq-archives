		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr> 
                <td valign="top"> <p class="text">Sony Online Entertainment is 
                    proud to announce the Fall 2003 Fan Faire! We will be hosting 
                    the Chicago Fan Faire at the Sheraton Chicago Hotel &amp; 
                    Towers on September 26-28, 2003.</p>
                  <p><span class="text">We have space at the Sheraton to make 
                    this the largest Fan Faire ever! We&#8217;ll be admitting 
                    up to 2,500 to this Fan Faire, so register now to reserve 
                    your spot at the biggest Fan Faire event ever! </span> </p>
		    </td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td> <div align="center"> 
                    <p><a href="scrapbook_vegas_photos.jsp"><img src="images/photo_strip.gif" width="559" height="73" border="0"></a><br>
                      <a href="scrapbook_vegas_photos.jsp" class="links">Las 
                      Vegas Photo Gallery</a></p>
