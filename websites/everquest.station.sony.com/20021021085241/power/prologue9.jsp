...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">44,450 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/prologue9.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/prologue9.jsp');">
...
<table bgcolor="#000000" width="757" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
  ...
  <tr> 
    <td colspan="3" height="1"><img src="images2/bluebar_prologue_long.jpg" width="780" height="40" border="0"></td>
  </tr>
  <tr> 
