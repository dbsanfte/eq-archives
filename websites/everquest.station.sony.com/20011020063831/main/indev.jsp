      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" --> 
            ...
            <p>&nbsp;</p>
            <p><b>DESIGN DOCUMENT SUPPLEMENT- ALTERNATIVE ADVANCEMENT SYSTEM FOR 
              EVERQUST: THE SHADOWS OF LUCLIN</b></p>
            <p><b>Date: October 4th, 2001</b></p>
            <p><br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The alternative 
              advancement system will allow anyone who has purchased and installed 
              Shadows of Luclin to further customize their high level (51+) characters. 
              Customized features may include such advantages as minor permanent 
              statistic and resistance boosts, unique skills based on your class 
              or archetype (fighter, magic user, priest), and general skills available 
              to everyone. These skills may include anything from an enhanced 
              metabolism, to improvements in skills already available to your 
              class. You may also find some unique skills not yet available to 
              anyone. Some enhancements may add a title to your character based 
              on what choices you have made in enhancing your character; these 
              titles will be visible to other players. </p>
            <p><br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In order to attain 
              these skills, you will be able to toggle your experience into the 
              alternative advancement pool. When you do this, your experience 
              will be allocated to this pool in lieu of your &quot;leveling&quot; 
              experience bar. Once a certain amount of experience has entered 
              the alternative advancement pool, you will receive training points 
              that may be used to acquire your enhancements. When you earn the 
              proper amount of training points, you will have the option of choosing 
              which enhancement you wish to gain, although some enhancements may 
              have pre-requisites that will need to be obtained before you are 
              able to acquire it.</p>
            <p><br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Players will have 
              the option of toggling between the normal experience pool to gain 
              levels, and the alternative enhancement pool to gain enhancements 
              whenever they wish (although this may require you to zone after 
              you have toggled your switch). Switching between the two pools will 
              not cause you to lose experience. Experience loss due to death suffered 
              by the character will be taken from the &quot;Leveling&quot; experience 
              pool, but it will not impact your alternative advancement pool. 
            </p>
            <p><br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The alternative 
              advancement system presents players with a variety of enhancements 
              to choose from for each class. Those who chose to enhance their 
              character with this system may find a higher level of individuality 
            ...
            <center>
              <center>
                ...
                <FONT SIZE=2></FONT>
                <P align="left"><font size="2"><b>EVERQUEST TECH DOCUMENT</b></font></P>
                <P align="left"><b><font size="2">OCTOBER 4, 2001</font></b></P>
                <div align="left"></div>
                <P align="left"><font size="2">EverQuest: The Shadows of Luclin 
                  includes a completely new graphics engine that allows us to 
                  push the art we created for Luclin to levels not before seen 
                  in EverQuest. In addition, the basic engine enhancements optimize 
                  the way data is displayed to the user. The end result is that 
                  in Luclin we can display more polygons and textures at framerates 
                  similar to that experienced in EverQuest: The Scars of Velious, 
                  while making that and former expansion zones display at even 
                  higher levels of performance.</font></P>
                <P align="left"><font size="2">Engine features and art production 
                  technology are intricately linked. Advancements in one area 
                  allow the other to be pushed further. A new engine alone does 
                  not make the art look innately better, except perhaps in cases 
                  where n-patching or pixel-shaders are used. That said, EverQuest: 
                  The Shadows of Luclin will also include art improvements such 
                  as the complete retexturing of the old world.</font></P>
                <P align="left"><font size="2">The feature list for the new engine 
                  includes:</font></P>
                <div align="left"> 
                  <UL>
                      <LI><font size="2" color="#000000">A rewritten rendering 
                        pipeline using DirectX 8. This allows us to take advantage 
                        of several new features, and buys us a good performance 
                        increase even on cards without hardware T&amp;L.</font></LI>
                      <LI><font size="2" color="#000000">Hardware T&amp;L utilization 
                        where available. As above, this will improve performance 
                        across all EverQuest locales if you have a Hardware T&amp;L 
                        card.</font></LI>
                      <LI><font size="2" color="#000000">Processor specific optimizations 
                        to the collision and physics code. This will help in crowded 
                        areas the most.</font></LI>
                      <LI><font size="2" color="#000000">Enhanced support for 
                        DDS Texture compression. This will result in smaller zone 
                        files, faster loading times, and a greater diversity of 
                        textures in the world. Plus, the quality of the textures 
                        is often better than our older 16bit/8bit textures.</font></LI>
                      <LI><font size="2" color="#000000">Support for large textures. 
                        Up to 1024x1024. More detail in the world.</font></LI>
                      <LI><font size="2" color="#000000">Support for layering 
                        textures on models. This will allow us to create more 
                        realistic- looking clothing for character models in-game. 
                        We also use this on the new items in-game, allowing us 
                        to have, for example, a sword whose blade tints but its 
                        hilt does not. This will allow us to have something like 
                        a red-bladed sword show without having a whole new texture.</font></LI>
                      <LI><font size="2" color="#000000">Detail texturing. Very 
                        high resolution textures in a radius around the camera 
                        which have the effect of enhancing the quality of the 
                        ground textures outside.</font></LI>
                      <LI><font size="2" color="#000000">Enhancements to the animation 
                        system that will help make character movements look smoother.</font></LI>
                      <LI><font size="2" color="#000000">Radial flora in outdoor 
                        zones adding to the realism of the ground cover.</font></LI>
                      <LI><font size="2" color="#000000">New LOD (level of detail) 
                        system for characters and objects. This will help with 
                        frame rates, plus fix the problems with the old ones where 
                        they tend to disassociate with their primary components 
                        when viewed at a distance.</font></LI>
                      <LI><font size="2" color="#000000">Engine extensibility, 
                        which allows us to include advanced features such as hardware 
                        n-patching in the future. If integrated, this will improve 
                        the look of old content as well as new.</font></LI>
                      <LI><font size="2" color="#000000">Pixel-shaders, when available 
                        will enhance the look of several things, such as the metal 
                        in your swords by making them shine more realistically.</font></LI>
                  </UL>
                  <FONT FACE="Arial" SIZE=2> </FONT></div>
                <P align="left">These enhancements will improve performance and 
                  once again raise the bar on the level of immersiveness a Massively-Multiplayer 
                  Online Role-Playing Game can provide.</P>
