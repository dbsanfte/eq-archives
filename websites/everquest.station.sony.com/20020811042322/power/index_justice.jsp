...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/index_justice.jsp?null');">
...

{
	...
	document.write('<img src="images/spacer.gif" border="0" height="13" width=1><br>');
        ...
        <div id="stretch" style="width:640px; height:365;"> 
