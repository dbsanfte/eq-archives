...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">71402 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<table width="130" border="0" cellspacing="0" cellpadding="0" background="">
  <tr> 
    <td width="130" valign="top" align="right" class="menu"> 
	  ...
	  <a href="/guidebook/firionavie.jsp">Firiona Vie Sever Rules <img src="/images/1d.gif" width="16" height="14" border="0" align="absmiddle"></a><br>
      <!-- End Guidebook -->
      <br>
      <!-- Begin Stats -->
      <br>
