...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>50589 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center" class="bold">Please check back later for future Fan Faire information.<!--
                                      <table BORDER cellspacing=1 cellpadding=7 width=590 bordercolor="#000000">
                                        <tr bgcolor="#000000"> 
                                          <td valign="TOP" colspan=2 background=""> 
                                            <p align="CENTER"><b><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><span class="bold"><font color="#FFFFFF">Friday, 
                                              October, 19</font> </span></font></b> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold"> 
                                              Registration </span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">6-8:00 
                                              p.m. </span></b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          ...
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">8-10:00 
                                              p.m. </span></b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td valign="TOP" colspan=2 bgcolor="#000000" background="">
                                            <center>
                                              <b><font color="#FFFFFF" face="Arial, Helvetica, sans-serif" size="2">Saturday, 
                                              October 20</font></b> 
                                            </center>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Late 
                                              Registration </span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">12-1:00 
                                              p.m. </span></b></font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Fan 
                                              Faire Begins! </span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                        ...
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Real 
                                              Life Quest </span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                        ...
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Discussion 
                                              panels and in-game quest </span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
                                        ...
                                        <tr> 
                                          <td width="50%" valign="TOP" class="bold"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Dinner 
                                              and prizes awarded </span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bold"> 
