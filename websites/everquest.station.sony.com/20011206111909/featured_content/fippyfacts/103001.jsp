...
//-->
              ...
              <table width="95%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td align="center"> 
                    ...
                    <p align="center"><img src="images/fippy_logo_final.gif" width="212" height="75"></p>
                    <table width="60%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p align="left">Fippy recently spent time with the Game Masters and Guides of Norrath to understand whom these brave Protectors are, and from what parts of the world they hail. Fippy took much amusement from pointing out to Mennix that Halflings were barely more popular than Ogres! Looking at the Class information, it appears that Guides prefer to be Rangers and Warriors, whilst GM’s tend towards the extremes of Paladin and Shadow Knight, both wonderfully suitable careers for all-powerful GM’s.</p>
                          <p align="left">Here is what Fippy found:</p>
                        </td>
                      </tr>
                    ...
                    <div align="center">
                      <table width="400" border="1" cellspacing="0" cellpadding="0">
                        <tr align="center">
                          <td colspan="3"><b>All GM’s and Guides of all Ranks</b></td>
                        </tr>
                        <tr align="center">
                          <td width="33%"><b>Race</b></td>
                          <td width="34%"><b>Class</b></td>
                          <td width="33%"><b>Male/Female</b></td>
                        </tr>
                        <tr align="center">
                          <td valign="top" width="33%">
                            <table width="98%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="47%" align="left">Wood Elf</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">19 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Dark Elf</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">19 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Human</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">13 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Half Elf</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">8 %
                            </td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Iksar</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">8 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Gnome</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">7 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">High Elf</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">7 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Erudite</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">5 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Barbarian</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">4 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Dwarf</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">3 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Troll</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">3 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Halfling</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">2 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Ogre</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">2 %</td>
                              </tr>
                            </table>
                          ...
                          <td width="34%">
                            <table width="98%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="47%" align="left">Ranger</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">14 %&#9;</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Warrior</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">12 %&#9;</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Monk</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">11 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Druid&#9;&#9;</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">9 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Rogue</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">8 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Paladin</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">8 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Bard</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">7 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Shadow Kt</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">7 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Enchanter&#9;</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">6 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Cleric</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">5 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Wizard</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">5 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Shaman</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">3 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Necro</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">3 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Magician</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">2 %</td>
                              </tr>
                            </table>
                          ...
                          <td width="33%">
                            <table width="98%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="47%" align="left">Male</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">64 %</td>
                              </tr>
                              <tr>
                                <td width="47%" align="left">Female</td>
                                <td width="4%">&nbsp;</td>
                                <td width="47%">36 %</td>
                              </tr>
                      ...
                      <table width="400" border="1" cellspacing="0" cellpadding="0">
                        <tr align="center">
                          <td colspan="3"><b>Game Masters</b></td>
                        </tr>
                        <tr align="center">
                          <td width="33%"><b>Race</b></td>
                          <td width="34%"><b>Class</b></td>
                      ...
                      <table width="400" border="1" cellspacing="0" cellpadding="0">
                        <tr align="center">
                          <td colspan="3"><b>Guides of all Ranks</b></td>
                        </tr>
                        <tr align="center">
                          <td width="33%"><b>Race</b></td>
                          <td width="34%"><b>Class</b></td>
                      ...
                      <p><font size="-2">(Note:  These data represent the race and class choices by GMs and Guides for their GM or Guide avatars.  These do not represent their choices in actual play characters.)</font></p>
                    </div>
                    <DIR></DIR>
                    <p align="center"><br>
  ...
  <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
    <option selected>The Fippy's Facts Archives:</option>
	<option value="103001.jsp">October 30, 2001 - The Protectors</option>
	<option value="092801.jsp">September 28, 2001 - The Languages</option>
	<option value="082901.jsp">August 29, 2001 - The Races</option>
	<option value="081401.jsp">August 14, 2001 - The Gods</option>
  </select>
</form>
                    </p>
                    <p>&nbsp;</p>
