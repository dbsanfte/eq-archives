...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>98099 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            <div align="center"> 
              <p><span class="bold">Gracias por asistir a la Fan Faire de Dallas. Para más información acerca de la Fan Faire, consulte esta dirección.</span>
              </p>
            </div>
            <!-- #EndEditable --></td>
        </tr>
