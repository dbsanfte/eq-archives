...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/scrapbook_velious_esp.jsp?null');">
                                  ...
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"> 
                                      <p><b><font color="#000000"><br>
                                        <span class="bold">La Fiesta de Lanzamiento 
                                        de Velious, celebrada en el elegante Bellagio 
                                        Hotel en Las Vegas, fue un extravagante 
                                        evento que duró dos días y ofreció debates, 
                                        demostraciones, concursos y la oportunidad 
                                        de conocer a algunos de los principales 
                                        desarrolladores que han contribuido a 
                                        hacer de EverQuest el juego de roles multijugador 
                                        masivo en línea más popular hasta la fecha. 
                                        Sin embargo, la verdadera estrella del 
                                        encuentro fue la muy esperada expansión 
                                        EverQuest, The Scars of Velious. Veinticinco 
                                        estaciones colocadas en diversos lugares 
                                        a lo largo de la pared externa del salón 
                                        de reuniones, permitieron a los fanáticos 
                                        jugar con personajes ya creados y experimentar, 
                                        de primera mano, el helado y prohibido 
                                        continente del Sur. </span></font></b> 
                                      </p>
                                      <p align=center><img src="images/costumes_sm.jpg" width="200" height="150"> 
                                      </p>
                                    </div>
                                    <p align="center"><a href="scrapbook_velious_photos_esp.jsp" class="bold2"><b>Album 
                                      de fotografías de la fiesta de lanzamiento 
                                      de Velious </b></a></p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
