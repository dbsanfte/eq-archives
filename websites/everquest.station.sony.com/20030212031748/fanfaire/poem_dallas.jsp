...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/poem_dallas.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/poem_dallas.jsp');">
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <div align="center" class="bold"><span class="textBold">EQ R 
                    UBER </span></div>
                  <p align="center" class="bold"><span class="text"><br>
                    Hello I'm Dan and this is my Rhyme.<br>
                    It begins a long time ago when I had spare time.<br>
                    I was looking for a game to play and have fun.<br>
                    Little did I know what I had begun.<br>
                    Fent, my little brother said &quot;EverQuest looks cool.&quot;<br>
                    &quot;Besides you have a T-1 connection at school.&quot;</span></p>
                  <p align="center" class="bold"><span class="text">So I went 
                    out and bought my first EverQuest box.<br>
                    I installed it, played it, and decided it rocks.<br>
                    I decided Lanys was the server to play<br>
                    and made a dark elf rogue the very same day.<br>
                    It took me a while to get the hang of the game<br>
                    but by level thirteen, a calm happy world was only a shame.</span></p>
                  <p align="center" class="bold"><span class="text">So I switched 
                    servers to Vallon Zek<br>
                    and made myself Einaugenwilly, a paladin peck.<br>
                    With my newbie sword, guild letter, water skin and bread.<br>
                    I began my addiction that was by EverQuest fed.<br>
                    Levels one through ten passed quickly by.<br>
                    I was a rather good paladin for only having one eye.</span></p>
                  <p align="center" class="bold"><span class="text">Soon my friends 
                    started to say,<br>
                    &quot;Dan, why is your computer your interest all day?&quot;<br>
                    I found this place Norrath and it is fun to explore.<br>
                    The graphics are great and it is never a bore!<br>
                    Away they ran as if they had SoW!<br>
                    They each bought EverQuest and asked &quot;What now?&quot;</span></p>
                  <p align="center" class="bold"><span class="text">&quot;Make 
                    characters and start off like me.&quot;<br>
                    &quot;Dan we're all scared of this thing called PvP.&quot;<br>
                    &quot;Just fight with skill and don't be a griever.&quot;<br>
                    &quot;Sorry Dan, we're all nice guys and don't like violence 
                    either.&quot;<br>
                    So they fled to Vazaelle as a bunch of newbies.<br>
                    Fleeing the ways of Zek, doomed to be bluebies!</span></p>
                  <p align="center" class="bold"><span class="text">Soon I started 
                    baking, brewing and smithing<br>
                    and even got some tattered sandals while fishing.<br>
                    Then a grave lord named Falkonn made a mistake.<br>
                    He told all his friends &quot;into my guild this dorf I will 
                    take.&quot;<br>
                    So with Iron Tower I raided all over; even a plane!<br>
                    My friends started to think I had gone insane!</span></p>
                  <p align="center" class="bold"><span class="text">A Xanit DE 
                    PKed me that FEF!<br>
                    My secret language had assured that my sanity had left.<br>
                    Late night weekend raids made my girlfriend wonder,<br>
                    if dating an EverQuest player was possibly a blunder.<br>
                    (BTW I'm single now and looking for a female human)<br>
                    I soon added Velious and went to North Ro,<br>
                    to catch a boat bound to the land of snow.</span></p>
                  <p align="center" class="bold"><span class="text">I ran off 
                    the boat and met pirate gnomes.<br>
                    I found Thurgadin with the Coldain and their homes.<br>
                    I killed giants, bashed orcs, and even a dragon or two.<br>
                    When I could actually get a group, I XPed in Velk's for two 
                    yellow and one blue.<br>
                    Last summer I went to the Minneapolis Fan Faire.<br>
                    I met GMs, had fun and even saw some pirates there!</span></p>
                  <p align="center" class="bold"><span class="text">With the moon 
                    soon to come and the lord of the beast,<br>
                    it was like torture waiting for the Luclin release.<br>
                    The shelves were all stocked then cleared out by the buyers.<br>
                    We all logged on and raced off to the Ancient Combine Spires.<br>
                    The graphics are great and the skill system so good.<br>
                    If I could hug a developer, trust me I would!</span></p>
                  <p align="center" class="text">So now for the developers I'd 
                    like to take a slight pause<br>
                    and say thanks for the expansion with a round of applause.<br>
                    I'm glad all of you play EverQuest with me,<br>
                    even if eighty percent of you don't like PvP.<br>
                    So let us enjoy this time where Norrath and Earth become one 
                    for a day.<br>
                    Pardon me now, I hate being AFK.</p>
                                    </td>
              </tr>
            </table>
            <!-- #EndEditable --></td>
