...
//-->
				...
				<td align="center" width="150" nowrap> <a href="http://www.sony.com" target="_blank"><img src="/common/images/global_nav/de//world_sony.gif" border="0"></a>
...
<a href="http://www.station.sony.com/commstation/commstation_fs" target="commFrame" onClick="open_servwin('http://www.station.sony.com/commstation/commstation_fs.jhtml'); return false;"><img src="/common/images/global_nav/de//nav_dish.gif" WIDTH=15 HEIGHT=15 BORDER=0 ALT="" vspace=2>
                          </a></td>
...
//alert("NS4 or IE4");
	...
	document.write("<a href=\"http:\/\/www.station.sony.com\/\" onMouseover=\"if(document.layers) return dropit(event,dropmenu0,true)\" onMouseout=\"if(document.layers) return hidemenu()\">Spiele<\/a>&nbsp;|");
	document.write("<\/span>");
	document.write("<\/span>");
...
//alert("Neither");
	document.write("<a href=\"http:\/\/www.station.sony.com\/\">Spiele<\/a>&nbsp;|");
}
//-->
</script>
<noscript><a href="http://www.station.sony.com/">Spiele</a>&nbsp;|</noscript>
<!----------Menu 1 ends here---------->
</td>
<script language="JavaScript" type="text/javascript">
<!--
...
//-->
	...
	<a href="http://www.station.sony.com/en/community.jsp" onMouseOut="nd()" onMouseOver="return overlib('Dieser Link leitet Sie an eine englische Seite weiter.')" target="_top">Chat</a> |
	...
	<a href="https://www.station.sony.com/secure/en/registration/edit.jsp" onMouseOut="nd()" onMouseOver="return overlib('Dieser Link leitet Sie an eine englische Seite weiter.')" onClick="open_servwin('https://www.station.sony.com/secure/en/registration/edit.jsp'); return false" target="_blank">Mein Konto</a> |
                ...
                <td height="302" valign=top > 
                  <table width="556" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="98%"  background="../../images/translucent2.gif" valign=top height="516"> 
                          ...
                          <tr> 
                            ...
                            <td>
                              ...
                              <div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      <img src="P1010033.jpg" width="640" height="480"></b></font></div>
                            </td>
                          </tr>
                  ...
                  <p align="center"><span class="bold">... und andere, die auf 
                    den gro&szlig;en Moment warten.<br>
                    </span> <a href="screen_31.jsp"><b><font color="#FF0033">&lt;- 
                    Vorheriges</font></b></a>&nbsp;<a href="../../scrapbook_minneapolis_photos_de.jsp"><b><font color="#FF0033">Zur&uuml;ck</font></b></a>&nbsp;&nbsp;<a href="screen_34.jsp"><b><font color="#FF0033">N&auml;chstes-&gt;</font></b></a></p>
                </td>
              </tr>
            </table>
          </td>
