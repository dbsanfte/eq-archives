...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/winners_dallas_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/winners_dallas_esp.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center"><span class="bold">Lista 
                                      de ganadores </span> </div>
                                    <p class="bold">Misi&oacute;n en vivo<img src="screenshots/ff_dallas/article_images/Dsc00993.jpg" width="320" height="240" align="right"><br>
                                      <br>
                                      Servidor: Tarew Marr<br>
                                      Cofrad&iacute;a: <a href="http://www.blackcompany.cc/" target="_blank" class="bold2">Black 
                                      Company </a></p>
                                    <p class="bold">Citaria (L&iacute;der de la 
                                      cofrad&iacute;a)<br>
                                      Lujan <br>
                                      Tierra<br>
                                      Rennol<br>
                                      ...
                                      *Arnaxus<br>
                                      **Vaslin </p>
                                    <p class="bold">*Arnaxus era un miembro adicional 
                                      del equipo y actualmente no pertenece a 
                                      ninguna cofrad&iacute;a.<br>
                                      **Vaslin de <a href="http://www.thesafehouse.org/" target="_blank" class="bold2">Safehouse</a> 
                                      era un miembro adicional del equipo y no 
                                      pertenece a la cofrad&iacute;a Black Company.</p>
                                    <p><span class="bold"><br>
                                      <br>
                                      Tarjeta gr&aacute;fica GeForce 3 de <a href="http://www.pny.com/home/products/vcard_index.cfm" target="_blank" class="bold2">PNY 
                                      </a><br>
                                      <br>
                                      Charnas<br>
                                      Almas fundidas (Souls Forged)<br>
                                      El s&eacute;ptimo martillo (The Seventh 
                                      Hammer)<br>
                                      <br>
                                      Fan Faire Banner<br>
                                      <br>
                                      Alcnea<br>
                                      Reuni&oacute;n m&iacute;stica (Mysthic Gathering)<br>
                                      E'Ci </span><br>
                                    </p>
                                    <!-- #EndEditable --></td>
                                </tr>
