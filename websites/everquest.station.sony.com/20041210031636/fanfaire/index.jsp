        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table border="0" cellspacing="0" cellpadding="0" background="images/homePageBG.jpg">
              <tr>
                <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="596" height="405">
                  <param name="movie" value="media/NewOrleans_04.swf">
                  <param name="quality" value="high">
                  <embed src="media/NewOrleans_04.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="596" height="405"></embed>
                </object></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr> 
                <td valign="top"> <p class="text">Sony Online Entertainment is proud to announce the New Orleans Fan Faire! We will be hosting the event in New Orleans, Louisiana, at the New Orleans Riverside Hilton on October 28-30, 2004.  That’s right, New Orleans, the home of Voodoo, Bourbon Street, Cajun Food, Gambling, and all sorts of fun.  What better place to have the ultimate party – Fan Faire!</p>
<p>The New Orleans Riverside Hilton is located right along the banks of the mighty Mississippi River, across the street from New Orleans Harrah’s Casino, and 1 block from the French Quarter.  Bourbon street is a mere 4 block walk down scenic Canal Street.  Centrally located for an amazing time in New Orleans!</p>
<p>The expanded Game Room will have over 80 machines for you to use and will be wired with WiFi (b/g) for you to bring your own rig and play if you like, all courtesy of Intel!</p>
<p>We have space at the Hilton to make this the largest Fan Faire ever! We'll be admitting up to 3,000 Norrathians to this Fan Faire, so register now to reserve your spot at this exciting event. The price for this event is $100 for pre-registered attendees and $110 at the door.</p>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td> <div align="center"> 
                    <p><a href="/common/images/img_view.jsp?collection=fanfaire_new_orleans_scrapbook&name=HS4Y8824.jpg" target="_new" onclick="return imgViewPopUp('fanfaire_new_orleans_scrapbook', 'HS4Y8824.jpg');"><img src="images/photo_strip_new_orleans.jpg" width="559" height="73" border="0"></a><br>
                      <a href="/common/images/img_view.jsp?collection=fanfaire_new_orleans_scrapbook&name=HS4Y8824.jpg" target="_new" onclick="return imgViewPopUp('fanfaire_new_orleans_scrapbook', 'HS4Y8824.jpg');" class="links">New Orleans Photo 
                    Gallery</a></p>
