...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/faq.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->								    
                                    <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><span class="bold3"><br>
                                      </span></b></font> 
                                      <div align="justify"><span class="bold3">What 
                                        is a Fan Faire? </span> <span class="bold"><br>
                                        The EverQuest Fan Faire is a Sony Online 
                                        Entertainment sponsored event designed 
                                        to allow players the chance not only to 
                                        meet one another, but also to meet many 
                                        of the more prominent SOE personalities. 
                                        It's a great opportunity to meet the real 
                                        people behind the online avatars and the 
                                        game itself. Though attendees will have 
                                        plenty of opportunity to mingle freely 
                                        with one another and make new friends, 
                                        they'll also have the chance to participate 
                                        in a number of panel discussions and game-themed 
                                        live events. </span> 
                                        <p class="bold"><span class="bold3">When 
                                          and where are the Fan Faire events held?</span><br>
                                          Fan Faire events are held in various 
                                          regions throughout the U.S. and occur 
                                          every 3-4 months. We try to choose locations 
                                          that will accommodate as many players 
                                          as possible. Our current goal is to 
                                          hold at least one Fan Faire per year 
                                          on the U.S. East and West coasts as 
                                          well as a central location in the United 
                                          States. Every so often, we may solicit 
                                          your input on future locations of Fan 
                                          Faire via polls on this site. </p>
                                        <p class="bold"><span class="bold3">What 
                                          do I get for my registration fee? </span><br>
                                          You may attend a private reception with 
                                          other players Friday evening. Then on 
                                          Saturday, you will be able to meet representatives 
                                          from SOE, and participate in any of 
                                          several discussion panels with EQ representatives. 
                                          There will be contests and drawings 
                                          for prizes, plus you will receive a 
                                          T-shirt and be served dinner Saturday 
                                          evening. And best of all, you will get 
                                          the unique experience of meeting hundreds 
                                          of other Norrathian citizens!</p>
                                        <p class="bold"><span class="bold3">I 
                                          did not receive a confirmation email 
                                          after I registered. Am I really registered?</span><br>
                                          If you did not receive a confirmation 
                                          email after you registered, your registration 
                                          likely did not go through. Please contact 
                                          Cindy Bowens (cbowens@soe.sony.com) 
                                          to check on your registration status. 
                                          Also, be sure that you have an active 
                                          current email address.</p>
                                        <p class="bold"><span class="bold3">I 
                                          can't get there in time for the early 
                                          registration. Can I still get my Player 
                                          Passport and get in when I arrive?</span><br>
                                          Yes! Just check in when you get there. 
                                        </p>
                                        <p class="bold"><span class="bold3">Can 
                                          children attend this event? </span><br>
                                          Children can attend this event, but 
                                          an adult must accompany all minors. 
                                          The cost for children is the same as 
                                          for adults. </p>
                                        <p class="bold"><span class="bold3">My 
                                          spouse and I both play EQ. Should we 
                                          list one of us as a guest?</span><br>
                                          No. A guest is someone that does not 
                                          play EQ. Each player should register 
                                          individually to get his or her personalized 
                                          Player Passport.</p>
                                        <p class="bold"><span class="bold3">My 
                                          spouse does not play EQ but wants to 
                                          come with me. What is the fee for someone 
                                          that does not play? </span><br>
                                          The fee is the same for players and 
                                          non-players. Just list them as your 
                                          guest on the registration form. </p>
                                        <p class="bold"><span class="bold3">What 
                                          about my hotel accommodations? </span><br>
                                          You are responsible for making your 
                                          own hotel and travel arrangements. We 
                                          have arranged special accommodations 
                                          with the hotel hosting our event, and 
                                          you may wish to take advantage of these.</p>
                                        <p class="bold"><span class="bold3">What 
                                          if I need to cancel my registration? 
                                          Can I get a refund?</span><br>
                                          To cancel your registration, please 
                                          email your request to <a href="mailto:cbowens@soe.sony.com" class="bold3">cbowens@soe.sony.com</a>. 
                                          Please include your Station name with 
                                          your email. Refunds can only be issued 
                                          before the close of registration.</p>
                                        <p class="bold"><span class="bold3">I 
                                          am a guide. Do I register under my guide 
                                          name or my player name? </span><br>
                                          Please refer to the guide board periodically 
                                          for information on this. </p>
                                        <p><span class="bold">If you still have 
                                          questions, please email Cindy Bowens 
                                          at <a href="mailto:cbowens@soe.sony.com" class="bold3">cbowens@soe.sony.com</a>.</span><br>
                                        </p>
                                        <br>
                                      </div>
                                      </div>
