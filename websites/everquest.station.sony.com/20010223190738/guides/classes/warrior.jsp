...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">47214 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_warrior.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p><font face="Arial, Helvetica, sans-serif" color="#FF9900" size="+2"><font face="Georgia, Times New Roman, Times, serif"> 
                                <span class="header">Warrior</span></font></font> 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                Warriors are the masters of armed combat, in all 
                                its many forms. They are at home on the battlefield, 
                                and are trained to take punishment as much as 
                                dole it out, so their Hit Points are the highest 
                                of any class.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
