                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_bard.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p><span class="header">Bard</span> 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                The Bard&#146;s stock-in-trade is his ability 
                                to play songs. His songs are actually spells of 
                                a sort, and their magical affects last as long 
                                as the Bard continues to sing and play the correct 
                                instrument. They have some passing knowledge of 
                                the Warrior ways (mainly for self-defense), but 
                                their main focus is always their art, and so they 
                                will never be as skillful as Warriors.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
                        </table>
