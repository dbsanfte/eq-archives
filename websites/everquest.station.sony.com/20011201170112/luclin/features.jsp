    ...
    <td width="100%" valign="top" align="center">
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>When EverQuest originally shipped in 1999, the development team 
            ...
            texture resolution featured in EverQuest: The Shadows of Luclin will 

            be 256 x 256 pixels and occasionally as large as 512 x 512 pixels. 

            This vast improvement in quality will make Norrath appear more vibrant 

            and detailed than ever before. Check out this <a href="http://www.verant.com/press/luclintextures100501.html" target="_blank">Media 

            Alert</a> for more information.</td>
      ...
      <table width="40%" border="0" cellspacing="10" cellpadding="0">
        ...
        <tr> 
          ...
          <td colspan="7">
            ...
            <div align="center">Click on an image below to view a larger version</div>
        ...
        <tr> 
          ...
          <td width="7%"><a href="#"><img src="screenshots/100401/mini/new02.jpg" width="50" height="38" border=0 onMouseDown="MM_openBrWindow('screenshots/100401/newtextures2.html','','width=666,height=600')"></a></td>

          <td width="7%"><a href="#"><img src="screenshots/100401/mini/new04.jpg" width="50" height="38" border="0" onMouseDown="MM_openBrWindow('screenshots/100401/newtextures4.html','','width=666,height=600')"></a></td>

          <td width="7%"><a href="#"><img src="screenshots/100401/mini/new05.jpg" width="50" height="38" border="0" onMouseDown="MM_openBrWindow('screenshots/100401/newtextures5.html','','width=666,height=600')"></a></td>

          <td width="7%"><img src="screenshots/100401/mini/new07.jpg" width="50" height="38" border="0" onMouseDown="MM_openBrWindow('screenshots/100401/newtextures7.html','','width=666,height=600')"></td>

          <td width="7%"><img src="screenshots/100401/mini/new13.jpg" width="50" height="38" border="0" onMouseDown="MM_openBrWindow('screenshots/100401/newtextures13.html','','width=666,height=600')"></td>

          <td width="7%"><img src="screenshots/100401/mini/new14.jpg" width="50" height="38" border="0" onMouseDown="MM_openBrWindow('screenshots/100401/newtextures14.html','','width=666,height=600')"></td>

          <td width="1%"><a href="#"><img src="screenshots/100401/mini/new17.jpg" width="50" height="38" border="0" onMouseDown="MM_openBrWindow('screenshots/100401/newtextures17.html','','width=666,height=600')"></a></td>
      ...
      <p><img src="images/divider.gif" width="174" height="10"></p>
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
            ...
            &middot; Additional non-level-based advancement options for those above level 50<br>
