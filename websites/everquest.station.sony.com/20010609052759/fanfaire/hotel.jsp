...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">83091 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->								    
                                      <div align="center">
                                      <p><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      Minneapolis Fan Faire<br>
                                        </b></font><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b>June 15-16<br>
                                        <br>
                                        <a href="http://www.marriotthotels.com/dpp/PropertyPage.asp?MarshaCode=MSPCC" class="bold2" target="_blank">Minneapolis Marriott City Center</a>
<br>
                                        30 South 7th Street<br>
...
<br>
                                        <br>
                                        Special rate is $99 per night if you mention you're with the EverQuest Fan Faire.  The number of rooms at this special rate is limited, so reserve yours soon!</b></font>
                                      </p>
                                      </div>
                                    <!-- #EndEditable --></td>
                                </tr>
