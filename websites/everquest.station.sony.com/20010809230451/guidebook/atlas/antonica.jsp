...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">87309 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                        ...
                        <td> 
                          ...
                          <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr> 
                              ...
                              <td width="780" height="426" rowspan="3"><img src="images/map_antonica_hi.gif" width="350" height="426" border="0" usemap="#Map"><map name="Map"><area shape="rect" coords="109,-8,149,16" href="halas.jsp"><area shape="rect" coords="1,169,49,188" href="qeynos.jsp"><area shape="rect" coords="122,139,182,157" href="rivervale.jsp"><area shape="rect" coords="306,104,348,120" href="neriak.jsp"><area shape="rect" coords="293,199,346,215" href="freeport.jsp"><area shape="rect" coords="161,292,206,309" href="oggok.jsp"><area shape="rect" coords="280,398,323,416" href="grobb.jsp"></map></td>
                              <td width="8"> 
                          ...
                          <table border="0" width="100%" cellpadding="20" cellspacing="0">
                            ...
                            <tr> 
                              ...
                              <td><font color="#000000">Antonica is the largest 
                                  and most populated continent on Norrath. The 
                                  continent was known as Tunaria, until it was 
                                  recently renamed by the human ruler of the Free 
                                  City of Qeynos, Antonius Bayle. It is on Antonica 
                                  where Tunare first placed Her High Elves. Antonica 
                                  is also the birthplace of the Halflings, Trolls, 
                                  Ogres, and Humans. The evil stain of Innoruuk, 
                                  the Dark Elves, also call Antonica home.</font></td>
                              <td> 
