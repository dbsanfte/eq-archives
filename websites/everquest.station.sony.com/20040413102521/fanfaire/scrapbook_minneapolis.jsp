	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_minneapolis.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_minneapolis.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_minneapolis.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td> 
                  ...
                  <p align="justify" class="bold"><a href="report_minneapolis.jsp" class="links">The 
                    Mennix Report</a><span class="text"> - Steve &quot;Mennix&quot; 
                    Fuller once again writes about his impressions of another 
                    Fan Faire. In this overview, Steve breaks down the entire 
                    weekend in his own irreverent way.<br>
                    </span></p>
                  <p align="justify" class="text"><a href="chicken_minneapolis.jsp" class="links">Community 
                    and a Rubber Chicken</a> - Gbear had a plan, and it involved 
                    a rubber chicken. Witness how one Fan Faire community member 
                    brought together his online friends.</p>
                  <p align="justify" class="text"><a href="sponsors_minneapolis.jsp" class="links">And 
                    Now a Word From our Sponsors</a> - The Minneapolis Fan Faire 
                    saw an increase in corporate sponsors and vendors. Steve &quot;Mennix&quot; 
                    Fuller gives his impressions on each.</p>
                  <p align="justify" class="text"><a href="winners_minneapolis.jsp" class="links">List 
                    of Winners</a> - The Bristlebane team, with an additional 
                    two members from the Seventh Hammer, won the Live Quest. Each 
                    winner will have either a Sword of the Gathering or Staff 
                    of the Gathering bestowed upon one of their characters. The 
                    winners of the Live Quest are not the only ones to receive 
                    this special Fan Faire in-game item; four lucky players who 
                    won the random drawings will also be deciding which of their 
                    characters will be sporting a new weapon.<br>
                  </p>
                  <p align="center" class="text"><span class="links"><a href="scrapbook_minneapolis_photos.jsp" class="links">Photo 
                    Gallery</a></span></p>
                                      </td>
              </tr>
            </table>
