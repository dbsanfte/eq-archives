...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_velious_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_velious_fr.jsp');">
                                  ...
                                  <td><!-- #BeginEditable "content" -->			
                                    ...
                                    <div align="justify"> 
                                      <p><b><font color="#000000"><br>
                                        <span class="bold">La réception de lancement de Velious, qui s'est déroulée dans l'élégant Hôtel Bellagio de Las Vegas, fut une extravagance de deux jours, avec des débats, des démonstrations, des concours et l'occasion de rencontrer certains des principaux développeurs qui ont aider à faire d'EverQuest le jeu de rôle multi-joueurs le plus populaire à ce jour. La véritable star de l'événement, cependant, était essentiellement l'extension très attendue du monde d'EverQuest, The Scars of Velious. Vingt-cinq « stations de jeu » disposées le long du mur extérieur du hall de rassemblement permettaient aux fans de s'identifier avec des personnages pré-définis et de faire l'expérience de ce continent gelé et sinistre du Sud.</span></font></b> </p>
                                      <p align=center><img 
src="images/costumes_sm.jpg" width="200" height="150"> 
                                      </p>
                                    </div>
                                    <p align="center"><a 
href="scrapbook_velious_photos_fr.jsp"><font color="#FF3333">
<b>Album photos de la réception de lancement</b></font></a></p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
