...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">19316 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->					
                                    ...
                                    <p align="left"><span class="bold">La Fan Faire européenne aura lieu au Château de Malesherbes. Ce n'est pas un hôtel, c'est... un château ! Situ&eacute; &agrave; 40 km de l'a&eacute;roport international d'Orly et &agrave; 60 km de Paris, c'est un endroit qui offre une 	atmosph&egrave;re m&eacute;di&eacute;vale des plus appropri&eacute;e. Une recherche bien menée sur Internet vous permettra d'afficher quelques photos (vous pouvez aussi suivre : <a href="http://www.google.com/search?sourceid=navclient&q=%22chateau+de+malesherbes%22">ce lien chez Google</a> pour commencer).  La plupart des pages sont en Français, elles ne devraient donc pas vous poser de problème de compréhension. 
 Nous sommes désolés, mais la Faire se déroulant en Europe cette fois-ci, nous ne sommes pas en mesure d'offrir de tarifs spéciaux pour l'hébergement dans les hôtels proches du lieu du rassemblement.</span>
<span class="bold">Nous sommes d&eacute;sol&eacute;s mais, parce qu'il s'agit d'une Fan Faire en Europe, nous ne pouvons pas vous proposer les offres sp&eacute;ciales s&eacute;curis&eacute;es des h&ocirc;tels voisins. Cependant, nous vous avons pr&eacute;par&eacute; une liste compl&egrave;te des h&ocirc;tels avec leurs coordonn&eacute;es pour vous aider dans vos recherches.</span></p>
                                    <div align="center">
                                      <Table border class="bold">
                                        <TR ALIGN="center">
                                          <TD valign="bottom"><FONT FACE="Arial"><B>HÔTEL</B></FONT></TD>
                                          <TD valign="bottom"><FONT FACE="Arial"><B>TARIFS</B></FONT></TD>
                                          <TD valign="bottom"><FONT FACE="Arial"><B>Nombre de chambres</B></FONT>
</TD>
                                          <TD valign="bottom"><FONT FACE="Arial"><B>Numéro de téléphone</B></FONT></TD>
                                        </TR>
                                        <TR ALIGN="center">
                                          <TD height="51" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Bercy Expo</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>19 
place des vins de France</FONT></div>
                                          </TD>
                                          <TD height="51" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: /  Double : 475 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD height="51" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>123
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD height="51" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 49 28 06 06</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Maine Montparnasse</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>160 rue 
du Ch&acirc;teau</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: 430 FF / Double : 480 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>90
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 43 22 00 09</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD height="37" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Alésia Montparnasse</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>49 rue 
des Plantes</FONT></div>
                                          </TD>
                                          <TD height="37" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: / Double : 410 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD height="37" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>66
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD height="37" valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 53 90 40 00</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Ledru Rollin</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>41/43 
avenue Ledru Rollin</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: / Double : 530 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>10
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 53 02 30 30</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
NOVOTEL Les Halles</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>8 
place Marguerite de Navarre</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Simple : 1200 FF / Double : 1300 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>197
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 42 21 31 31</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>ETAP 
HOTEL Porte de Pantin</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>96 
avenue du G&eacute;n&eacute;ral Leclerc</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Simple : 250 FF / Double : 270 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 24 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>40
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 48 40 33 42</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>ETAP 
HOTEL Porte de Bagnolet</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: 260 FF / Double  : 280 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 24 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>50
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 43 60 26 26</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Porte de Bagnolet</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: / Double : 360 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>100
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 43 60 02 76</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Bastille</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>15 rue 
Breguet</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: / Double : 525 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                          ...
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 43 29 20 20</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Republique</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>9 rue 
Leon Jouhaux</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Double 
: 525 FF / Triple : 620 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                          ...
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 42 40 40 50</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Porte de Montreuil</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: / Double : 390 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                          ...
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 43 63 31 32</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>ETAP 
HOTEL Paris Vincennes</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>2 avenue 
L&eacute;on Gaumont</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: 270 FF / Double : 290 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 24 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>170
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 56 93 30 00</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>RELAIS 
MERCURE Nation</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: 505 FF / Double : 555 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 60 FF</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>24
</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                          <TD valign="bottom">
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 43 45 41 38</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
                                        ...
                                        <TR ALIGN="center">
                                          <TD>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>IBIS 
Paris M&eacute;nilmontant</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>80 rue 
de la Folie R&eacute;gnault</FONT></div>
                                          </TD>
                                          <TD>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>Simple 
: 500 FF / Double : 540 FF</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>
Petit-déjeuner : 39 FF</FONT></div>
                                          </TD>
                                          <TD>
                                          ...
                                          <TD>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>01 53 36 82 92</FONT></div>
                                            <div align="center"><FONT FACE="Arial" SIZE=-1>&nbsp;
</FONT></div>
                                          </TD>
                                        </TR>
										<TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>KYRIAD ORLY</B></FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple : /  Double :425 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 38 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>72</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 41 80 75 75</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>B B CITY ORLY</B></FONT><FONT FACE="Arial" SIZE=-1>4 r Mond&eacute;tour Zone H&ocirc;teli&egrave;re</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple : /  Double :270 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 32 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>80</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 56 70 13 13</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>Grand MERCURE ORLY</B></FONT><FONT FACE="Arial" SIZE=-1>20Ave. Charles Lindbergh</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple : /  Double :800 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 80 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>52</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 56 70 56 70</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>MERCURE</B></FONT><FONT FACE="Arial" SIZE=-1>Orly ouest 429</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple : 700 FF  Double : /</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : /</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>161</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 46 87 23 37</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>EURO HOTEL</B></FONT><FONT FACE="Arial" SIZE=-1>Ave. Parc M&eacute;dicis</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple:350 FF Double :450 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 45 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>9</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 49 84 91 40</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>HOTEL DE L'ESCALE</B></FONT><FONT FACE="Arial" SIZE=-1>15 Rue P et M Curie</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple: / Double :350 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 40 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>47</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 69 38 60 56</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>HILTON</B></FONT><FONT FACE="Arial" SIZE=-1>A&eacute;rogare Sud</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple : 630 FF Double :720 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 70 / 100 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>210</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 45 12 45 12</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                        
                                        <TR ALIGN="center">
                                          <TD><FONT FACE="Arial" SIZE=-1><B>IBIS ORLY</B></FONT><FONT FACE="Arial" SIZE=-1>Orly Sud</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>Simple : /  Double : 365 FF</FONT><FONT FACE="Arial" SIZE=-1>Petit-d&eacute;jeuner : 39 FF</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>293</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                          <TD><FONT FACE="Arial" SIZE=-1>01 56 70 50 60</FONT><FONT FACE="Arial" SIZE=-1>&nbsp;</FONT></TD>
                                        </TR>
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td colspan="2">
                                            <div align="center" class="bold"><font size="4">Comment acc&eacute;der &agrave; la fan faire</font></div>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <div align="center"><a href="by_rer.jsp" class="bold2">Accès par le train</a></div>
                                          </td>
                                          <td>
                                            <div align="center"><a href="bycar.jsp" class="bold2">Accès par la route</a></div>
                                          </td>
                                        </tr>
                                      </table>
                                    </div>
