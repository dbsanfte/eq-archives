	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_boston.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_boston.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <p class="bold"><span class="textBold">Live Quest Winners</span></p>
                  <p class="text">Congratulations to the team Knights of the Tribunal 
                    from the Tribunal server for claiming victory in the Live 
                    Quest. Each team member received an in-game item for their 
                    character.</p>
                  <p class="text">Inkel<br>
                    Iadas<br>
                    Chikarin<br>
                    Pabst<br>
                    Romuleus<br>
                    ...
                    Tamarai<br>
                    Xavious</p>
                  <p class="bold"><span class="textBold">In-game Prizes</span></p>
                  <p class="text">Three more in-game prizes were raffled off at 
                    the close of Fan Faire. Congrats to:</p>
                  <p class="text">Aaladine of Innoruuk<br>
                    Haelrauen of Terris Thule<br>
                    Rungless of Rodcet Nife</p>
                  <p class="bold"><span class="text">Other Winners</span></p>
                  <p class="text">Thanks to our sponsors and vendors, we had more 
                    great stuff to give away.</p>
                  <p class="bold"><span class="text"><a href="http://www.alteclansing.com/" class="links" target="_blank">Altec 
                    Lansing</a> </span><span class="textBold">Speakers</span></p>
                  <p class="text">Jason F.<br>
                    Aaron R.<br>
                    Nancy L.<br>
                    Lawrence D.<br>
                    Jose R.<br>
                    ...
                    Adam B.<br>
                    Kim B.</p>
                  <p class="bold"><span class="text"><a href="http://everquest.allakhazam.com/" class="links" target="_blank">Allakazam</a> 
                    </span><span class="textBold">Premium 3 Month Subscription</span></p>
                  <p class="text">Anne C.<br>
                    Mike G.<br>
                    Roger D.<br>
                    Randy B.<br>
                    Igor P.<br>
                    ...
                    Rick F.<br>
                    Sharon</p>
                  <p class="bold"><span class="text"><a href="http://eq.crgaming.com/" class="links" target="_blank">Casters 
                    Realm</a> </span><span class="textBold">Book Cover</span></p>
                  <p class="text">Paul F.<br>
                    Doug H.</p>
                  <p class="bold"><span class="textBold">Hand Crafted Chalice 
                    from</span><span class="text"> <a href="http://www.fellowshipfoundry.com/" class="links" target="_blank">Fellowship 
                    Foundry</a></span></p>
                  <p class="text">Elyse T.</p>
                  <p class="bold"><span class="text"><a href="http://www.eqrpg.com/" class="links" target="_blank">EverQuest 
                    RPG</a></span><span class="textBold">: Player's Handbook from 
                    White Wolf</span></p>
                  <p class="text">Beth S.<br>
                    Jeff F.</p>
                  <p class="bold"><span class="text">Ball cap</span></p>
                  <p class="text">Juan A.<br>
                    Patrick M.<br>
                    Sid S.</p>
                  <p class="bold"><span class="textBold">T-Shirt from</span><span class="text"> 
                    <a href="http://www.rpgwear.com/" class="links" target="_blank">RPGwear</a></span></p>
                  <p class="text">Wade M.<br>
                    Sarrena G.<br>
                    Jonathon S.<br>
                    Helen G.<br>
                    Rich T.</p>
