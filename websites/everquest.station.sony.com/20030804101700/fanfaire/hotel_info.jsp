	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/hotel_info.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/hotel_info.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/hotel_info.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
              <tr>
                <td><div align="center"><img src="images/hotel_info_header.gif" width="208" height="60"></div></td>
              </tr>
              <tr>
                <td class="text">
<div align="center"> 
                    <p align=center style='text-align:center'><strong>Join 
                      us for the Chicago Fan Faire!</strong></p>
                    <p align="left">We will be hosting the Chicago Fan Faire at 
                      the Sheraton Hotel &amp; Towers from September 26-28, 2003.  
                    </p>
                    <p align="left">We have secured a group rate of $109 per night 
                      for our Fan Faire attendees, and this is an incredible price 
                      for Downtown Chicago.  To book your rooms, you have two 
                      choices:</p>
                    <p align="left">Below is the website address that is used 
                      to book rooms through the internet.&nbsp; Make 
                      sure to change the default date to reflect your desired
                      arrival and departure dates in September.&nbsp;&nbsp;</p>
                    <p align="left"><a
href="http://www.starwood.com/sheraton/meetings/pre_decider_all.html?bn=sheraton&amp;rcc=SI&amp;rac=SI&amp;city=chicago&amp;stateProvince=IL&amp;country=US&amp;groupBlockID=9081&amp;requestedChainCode=&amp;requestedAffiliationCode=&amp;hcount=0&amp;fromSearch=78XX&amp;propertyID=196&amp;maximumReservationRoo" class="links">Book 
                      your reservation here!</a></p>
                    <p align="left">If you would like to call and make reservations 
                      over the phone, or confirm a reservation, the Sheraton’s 
                      phone number is 1-800-233-4100.   You can refer to the EverQuest 
                      Fan Faire Rate, or Booking ID# 9081</p>
                    <p><strong>AIRFARE</strong></p>
                    <p align="left">Also, we have secured a group rate for Airfare 
                      for all of you to use with Southwest Airlines, United Airlines 
                      and American Airlines</p>
                    <p align="left"><b>Southwest Airlines Discount Information</b></p>
                    <p align="left">&quot;Southwest Airlines offers up to 10% 
                      off of most fares for air travel to and from Fan Faire, 
                      with the convenience of Ticketless Travel. To qualify, call 
                      Southwest Airlines Group and Meetings Reservations at (800) 
                      433-5368 and reference ID Code #Y0234. Reservations sales 
                      agents are available from 7:00am - 8:00pm, Monday - Friday, 
                      or 8:30am - 5:30 pm, Saturday - Sunday, Central Standard 
                      Time.&quot;</p>
                    <p align="left">This discount applies to all travel from September 
                      21, 2003 to October 2, 2003.</p>
                    <p align="left"><b>American Airlines Information</b></p>
                    <p align="left"><ins
cite="mailto:scottmcdaniel" datetime="2003-05-27T14:59">“</ins>The Fan Faire American 
                      Airlines Discount is valid September 21 –October 1, 2003, 
                      for travel to Chicago, IL.  The STARfile authorization number 
                      for Fan Faire Attendees is <b>3193AM</b>.  To make a discount 
                      reservation, please<del cite="mailto:scottmcdaniel" datetime="2003-05-27T14:59"> 
                      </del>call our Meeting Services Desk at <b>1-800-433-1790 
                      </b>and refer to the STARfile number.</p>
                    <p align="left"><a name="Discount_Air_Fares"></a>American 
                      Airlines Discount Air Fares Explanation</p>
                    <p align="left">Meeting attendees can receive 5% off any published 
                      fare or 10% off Full Coach, Business or First Class air 
                      fare.</p>
                    <p align="left">American Airlines</ins> Bonus 
                      Discount</p>
                    <p align="left">AAssociation Fares include a 5% advance purchase 
                      discount for tickets purchased a minimum of 30 days prior 
                      to departure. This bonus discount is in addition to the 
                      percentage discount or zone fares already offered.</p>
                    <p align="left"><b>United Airlines Information</b></p>
                    <p align="left">United Airlines offers Fan Faire 
                      discount flight from 9/22/03 through 10/2/03.  To book your 
                      flight call 1-800-521-4041 (Refer to meeting #523DS) and 
                      you will receive a 5% discount off the lowest applicable 
                      discount fare, including First Class, or a 10% discount 
                      off mid-week coach fares, purchased 7 days in advance.  
                      An additional 5% discount will apply when tickets are purchased 
                      at least 30 days in advance of your travel date.</p>
                    <p align="left"><br>
                    </p>
                  </div>
                    </td>
            ...
            <div align="center"><span class="text"><strong> </strong></span><br>
            </div>
            <!-- #EndEditable --></td>
