...
<title>EverQuest&reg;: The Legacy of Ykesha&#153; - In Pursuit of the Stone</title>
<!-- InstanceEndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/lore.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/lore.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="672" valign="top" style="background-image:  url(images/sub_bg.jpg); background-repeat: no-repeat;"> 
        <!-- InstanceBeginEditable name="Header Image" --><img src="images/lore_ch6-head.jpg" width="672" height="56" alt="" border="0"><br><!-- InstanceEndEditable -->
                ...
                <table width="447" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr> 
                    <td align="center">
						...
						<area coords="3,21,48,70" href="lore.jsp?ch=1" alt="Lore Chapter1 - Prophecy of Grozmok">
						<area coords="77,21,122,70" href="lore.jsp?ch=2" alt="Lore Chapter2 - The Stone is Stolen">
						<area coords="152,21,194,70" href="lore.jsp?ch=3" alt="Lore Chapter3 - Mithaniel Marr's Blessing">
						<area coords="226,21,270,70" href="lore.jsp?ch=4" alt="Lore Chapter4 - The Fall of Grobb">
						<area coords="300,21,342,70" href="lore.jsp?ch=5" alt="Lore Chapter5 - The Exodus to Neriak">
						<area coords="374,21,418,70" href="lore.jsp?ch=6" alt="Lore Chapter6 - Pursuit of the Stone">
						</map>
					</td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    <td align="center" class="text"><img src="images/lore_ch6-teaser.jpg" width="415" height="169" alt="" border="0" hspace="2"><br><a href="index.jsp?ch=6">Click for Flash movie</a></td>
                  </tr>
                </table>
