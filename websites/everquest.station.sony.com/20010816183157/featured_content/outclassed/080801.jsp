...
//-->
          ...
          <td><!-- #BeginEditable "body" -->
            <div align="center">
              <table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                    <p align="left"><img src="images/outclassed.gif" width="273" height="78"></p>
                    <p><img src="images/outclassed_080801.jpg" width="550" height="389"></p>
  ...
  <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
    ...
    <option value="072001.jsp">July 20, 2001 - Nose Horn Blind-Spot</option>
                    ...
                    <p>Email Poca: <a href="mailto:EQcartoon@station.sony.com">EQcartoon@station.sony.com</a><br>
