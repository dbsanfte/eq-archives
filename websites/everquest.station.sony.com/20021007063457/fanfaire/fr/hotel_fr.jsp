...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/hotel_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/hotel_fr.jsp');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/hotel.gif" width="196" height="49"> <br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <P class="bold">Rejoignez-nous &agrave; Seattle 
                                      pour la Fan Faire! </P>
                                    <P class="bold"><a href="http://www.doubletree.com/en/dt/hotels/index.jhtml?ctyhocn=CTAC-DT&amp;bhjs=1&amp;bhsw=1024&amp;bhsh=768&amp;bhswi=1007&amp;bhshi=596&amp;bhflver=5&amp;bhdir=1&amp;bhje=1&amp;bhcold=32&amp;bhrl=0&amp;bhqt=1&amp;bhmp=1&amp;bhab=-1&amp;bhmpex=6,4,7,1112&amp;bhflex=5,0,42,0&amp;bhdirex=&amp;bhcont=lan" target="_blank" class="bold2">Doubletree 
                                      Hotel Seattle Airport</a></P>
                                    <P class="bold">18740 Pacific Highway South</P>
                                    <P class="bold">Seattle, WA 98188<BR>
                                      Tel: 1-206-246-8600 </P>
                                    <P class="bold">L'h&ocirc;tel nous propose 
                                      un tarif de $99 la nuit. Veillez &agrave; 
                                      pr&eacute;ciser que vous participez &agrave; 
                                      la Fan Faire EverQuest. Notre code de r&eacute;servation 
                                      est SOE. L'h&ocirc;tel est situ&eacute; 
                                      &agrave; proximit&eacute; de l'a&eacute;roport 
                                      et dispose d'une navette gratuite.</P>
                                    <P class="bold">R&eacute;servez rapidement 
                                      votre chambre, avant qu'elles soient toutes 
                                      prises&nbsp;!</P>
<!-- #EndEditable --></td>
                                </tr>
                              </table>
