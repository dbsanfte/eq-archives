	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_orlando.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_orlando.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_orlando.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td> 
                  ...
                  <p align="justify" class="bold"><span class="text"><a href="wedding_orlando.jsp" class="links">Love 
                    is in the air...</a> - On October 6th, two EverQuest players, 
                    Krissy and Dave, got married in real life. On October 20th, 
                    in front of hundreds of Fan Faire attendees, their characters 
                    were married in-game on the Luclin server.</span></p>
                  <p align="justify" class="bold"><span class="text"><a href="report_orlando.jsp" class="links">The 
                    Mennix Report</a> - Once again, Steve &quot;Mennix&quot; Fuller 
                    attended another EverQuest Fan Faire and recaps his thoughts, 
                    in his own particular way, on much of went on in Orlando.<br>
                    </span></p>
                  <p align="justify" class="bold"><span class="text"><a href="devbytes_orlando.jsp" class="links">Designer 
                    Sound Bytes </a> - Jeff Butler and Bill Coyle fielded questions 
                    ranging from class balance issues to Luclin game features 
                    in the Producer's discussion panel conducted at the Fan Faire. 
                    Hear some selected out takes, in MP3 format, of just a few 
                    of their answers.</span></p>
                  <p align="justify" class="bold"><span class="text"><a href="winners_orlando.jsp" class="links">List 
                    of Winners</a> - Team X of Mithaniel Marr won the Live Quest 
                    conducted at the Orlando Fan Faire. Each member of the team 
                    will be receiving a copy of the Shadows of Luclin once the 
                    expansion is released this December. Winners of the random 
                    drawing will also be getting their copy of Luclin.<br>
                    </span></p>
                  <p align="center" class="text"><a href="scrapbook_orlando_photos.jsp" class="links">Photo 
                    Gallery</a></p>
                                      </td>
              </tr>
            </table>
