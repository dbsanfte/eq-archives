...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">86374 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<!-- #EndEditable --></p></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="10">
			<tr valign="top">
              ...
              <tr>
                <td>
					<b>New and Changed Features</b><br><br>- Guild Message of the Day.  Guild Officers and Leaders will be able to type /guildmotd <text> to set up a Guild Message of the Day (GMotD).  From then on any time a member of that guild logs in they will see the message with the name of the message sender added at the front, so you will know who sent the message.  Any guild member will also be able to read the GMotD by typing just /guildmotd and the message will be displayed again.  The GMotD will be erased if the server comes down, however.  You will have to reset the GMotD when the server comes back up.<br><br>- /assist changed and improved.  It should be much more reliable now.  It also will target whatever the assisted person has targeted.  The assisted person does not need to have auto-attack on for /assist to work.<br><br>- Fixed a problem with /corpse that kept it from working on corpses that were too far above or below you.<br><br><br><b>Skill Change</b><br><br>- Foraging changed so that if you are getting the hungry and thirsty messages, your next successful forage will always be drink or food.  We have also decreased the chance of foraging fishing grubs a bit and increased the chance that you will forage water.<br><br><br><b>Spell Changes</b><br><br>- Acumen now overwrites See Invisible.<br><br>- Translocate now has the proper spell gem.<br><br><br><b>Bug Fix</b><br><br>- Fixed many crash problems for Windows 2000 users.  This fix will most likely also aid some folks that are not using Windows 2000 that are having problems.<br><br><br><b>Item Changes</b><br><br>- Velious racial plate helm quests have been added that will allow you to 'trade in' your existing helms for ones with textures.  We have decided to allow the players (or their characters) to chose whether they wish to have the new helmet textures or to continue to use helmets that show no graphics.<br><br>- Five and ten charge versions of Potions of the Bone Field have been added.<br><br>- Kilva's Skin of Flame potion has been changed.  It no longer has the same effect as the Kilva's Blistering Flesh potion.<br><br>- Removed the tinting from Dark Forge and Resonant armors.  Tinting was never really intended to be on those pieces and, frankly, they look better without it.<br><br><br><b>Miscellaneous Items</b><br><br>- Reduced the 'bottleneck' for getting Howling Stone keys by increasing the availability of one of the quest items.<br><br>- Erudite guards will now be much less friendly to Kobolds.<br><br>- Vendors are once again selling the Coldain Tanner's Kit.<br><br><br><b>'Combine' container changes</b><br><br>We've made a change to 'combine' containers.  In order to prevent people from accidentally destroying items, all containers with a 'combine' button will not combine any items that do not form a complete recipe.  This will be a huge boon to craftspeople all across Norrath.  But this removes the only drawback to using trade containers as backpacks.  Their reduced weight and often greater carrying capacity made them more desirable as bags, with the compensating risk that you might just lose something if you made a mistake.<br><br>We will be increasing the weight of portable 'combine' containers somewhat.  Where some of these containers weighed under 1 pound, they will now weigh as much as 4 pounds for the largest sewing kit.<br><br>Along with this we are making a change to tailor made backpacks.  In case you didn't know, most tailor made packs have a built in weight reduction of 5%.  We are raising that to 10%.  We will also be displaying the weight reduction of all containers with the information shown on a right click.<br><br>- The EverQuest Team
				</td>
              </tr>
            </table>
            <br>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="10">&nbsp; </td>
                      	<td class="subHeader" width="100%">
							EQ Classic to Hit Store Shelves
						</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td>
					The classic edition of EverQuest is back, this time for the standard retail price of $9.99.  It will be available in both jewel case and mini box versions at retail stores nationwide.<br><br>“EverQuest has sold over one million units to date, and we expect this number to continually grow,” said Don Vercelli, Vice President of Sales and Marketing. “While the hard-core gaming community has brought EverQuest to the pinnacle of online gaming, the new value price will appeal to casual gamers allowing them to experience the world of Norrath for the first time.”<br><br>If you can't wait for it to show up at your favorite local retailer, check out the <a href="http://www.station.sony.com/store/">Station Store</a> and order your copy direct!
				</td>
              </tr>
            </table>
            <br>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="10">&nbsp; </td>
                      	<td class="subHeader" width="100%">
							Second move log for E'ci and The Rathe
						</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td>
					Since there is still plenty of room on the new server, we will be opening a second move log for people to move from The Rathe and E'ci to Zebuxoruk.  This will give those who missed the move another chance to get to the new server.  We'll open the log at noon on Friday and close it at noon on Monday, so you will have the weekend to execute the /movelog command.
				</td>
              </tr>
            </table>
            <br>
...
<!--
function openWindow() {
eqpoll = window.open("http://poll.station.sony.com/cgi-bin/viewpollr.cgi?p=409","eqpoll","height=620,width=390,resizable=yes"
);
}
//-->
</script>

<p align="center"><b>Better than Cloth Armor...</b></p>
<p>If you could purchase a new EQ T-shirt, which color would you prefer?</p>

<form action="http://poll.station.sony.com/cgi-bin/pollsubmit.cgi" onSubmit="openWindow()" method="post" target="eqpoll">

<input type=hidden name=poll_id value=409>
	<div align="left">
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1019"></td>
		<td>Black</td>
	</tr>
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1020"></td>
		<td>White</td>
	</tr>
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1021"></td>
		<td>Grey</td>
	</tr>
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1022"></td>
		<td>Medium-Blue</td>
	</tr>
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1023"></td>
		<td>Dark Green</td>
	</tr>
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1024"></td>
		<td>Bright Red</td>
	</tr>
	
	<tr>
		<td valign=top><input type="radio" name="answer_id" value="1025"></td>
		<td>Royal Purple</td>
	</tr>
	...
	<a href="http://poll.station.sony.com/cgi-bin/viewpollr.cgi?p=409" onclick="openWindow(); return false" target="_blank">See results</a>
	</center>
	</p>
	</div>
</form>
...
<tr><td align="left"><b>Total Online:</td><td align="right">82982</b></td></tr><br>
<tr><td align="left"><span class="sidebar">Chat Server</span></td><td align="right"><span class="sidebar"><font color="green"><b>196</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Ayonae Ro</span></td><td align="right"><span class="sidebar"><font color="green"><b>1964</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Bertoxxulous</span></td><td align="right"><span class="sidebar"><font color="green"><b>2402</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Brell Serilis</span></td><td align="right"><span class="sidebar"><font color="green"><b>2188</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Bristlebane</span></td><td align="right"><span class="sidebar"><font color="green"><b>2499</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Cazic-Thule</span></td><td align="right"><span class="sidebar"><font color="green"><b>2151</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Drinal</span></td><td align="right"><span class="sidebar"><font color="green"><b>2132</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Druzzil Ro</span></td><td align="right"><span class="sidebar"><font color="green"><b>2144</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">E'ci</span></td><td align="right"><span class="sidebar"><font color="green"><b>2145</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Erollisi Marr</span></td><td align="right"><span class="sidebar"><font color="green"><b>2092</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Fennin Ro</span></td><td align="right"><span class="sidebar"><font color="green"><b>2414</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Innoruuk</span></td><td align="right"><span class="sidebar"><font color="green"><b>2363</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Karana</span></td><td align="right"><span class="sidebar"><font color="green"><b>2352</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Lanys T'Vyl</span></td><td align="right"><span class="sidebar"><font color="green"><b>1977</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Luclin</span></td><td align="right"><span class="sidebar"><font color="green"><b>1961</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Mithaniel Marr</span></td><td align="right"><span class="sidebar"><font color="green"><b>2044</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Morell-Thule</span></td><td align="right"><span class="sidebar"><font color="green"><b>2168</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Povar</span></td><td align="right"><span class="sidebar"><font color="green"><b>2010</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Prexus</span></td><td align="right"><span class="sidebar"><font color="green"><b>2415</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Quellious</span></td><td align="right"><span class="sidebar"><font color="green"><b>2147</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Rallos Zek </span></td><td align="right"><span class="sidebar"><font color="green"><b>1666</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Rodcet Nife</span></td><td align="right"><span class="sidebar"><font color="green"><b>2125</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Saryrn</span></td><td align="right"><span class="sidebar"><font color="green"><b>1909</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Solusek Ro</span></td><td align="right"><span class="sidebar"><font color="green"><b>2306</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Tallon Zek </span></td><td align="right"><span class="sidebar"><font color="green"><b>1839</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Tarew Marr</span></td><td align="right"><span class="sidebar"><font color="green"><b>2408</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Terris-Thule</span></td><td align="right"><span class="sidebar"><font color="green"><b>2080</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Test Server</span></td><td align="right"><span class="sidebar"><font color="green"><b>469</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">The Nameless</span></td><td align="right"><span class="sidebar"><font color="green"><b>2110</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">The Rathe</span></td><td align="right"><span class="sidebar"><font color="green"><b>2031</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">The Seventh Hammer</span></td><td align="right"><span class="sidebar"><font color="green"><b>2009</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">The Tribunal</span></td><td align="right"><span class="sidebar"><font color="green"><b>2258</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Tholuxe Paells</span></td><td align="right"><span class="sidebar"><font color="green"><b>2049</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Torvonnilous</span></td><td align="right"><span class="sidebar"><font color="green"><b>1986</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Tunare</span></td><td align="right"><span class="sidebar"><font color="green"><b>2296</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Vallon Zek </span></td><td align="right"><span class="sidebar"><font color="green"><b>1735</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Vazaelle</span></td><td align="right"><span class="sidebar"><font color="green"><b>1975</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Veeshan</span></td><td align="right"><span class="sidebar"><font color="green"><b>2112</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Xegony</span></td><td align="right"><span class="sidebar"><font color="green"><b>2304</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Xev</span></td><td align="right"><span class="sidebar"><font color="green"><b>1848</b></font></span></td></tr>
<tr><td align="left"><span class="sidebar">Zebuxoruk</span></td><td align="right"><span class="sidebar"><font color="green"><b>1899</b></font></span></td></tr>
</table>
