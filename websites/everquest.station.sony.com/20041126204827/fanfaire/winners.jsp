	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td> 
                  <p align="center"><b><span class="textBold">Baltimore Fan Faire 
                    Winners</span></b></p>
                  <p align="CENTER"></p>
                  <p class="bold"><span class="text">As many of you know, in game 
                    prizes were given out for winners of the Real Life Quest as 
                    well as the Trivia Quest. A random drawing was also held at 
                    the end of the dinner on Saturday. Below is a list of the 
                    lucky recipients!</span></p>
                  <p class="bold">&nbsp;</p>
                  <p align="CENTER" class="bold"><span class="text"><b>Real Life 
                    Quest Winners - Drinal</b></span></p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="text">Amoxacilla</span></p>
                  <p align="CENTER" class="bold"><span class="text">Clamity</span></p>
                  <p align="CENTER" class="bold"><span class="text">Alinon</span></p>
                  <p align="CENTER" class="bold"><span class="text">Trillsurge</span></p>
                  <p align="CENTER" class="bold"><span class="text">Axxe</span></p>
                  <p align="CENTER" class="bold"><span class="text">Guillen</span></p>
                  <p align="CENTER" class="bold"><span class="text">Craized</span></p>
                  <p align="CENTER" class="bold"><span class="text">Ooggulgar</span></p>
                  <p align="CENTER" class="bold"><span class="text">Whisperwolf</span></p>
                  <p align="CENTER" class="bold"><span class="text">Nimmue</span></p>
                  <p class="bold"><span class="text">**Mezmeridion and Dokk were 
                    on the Drinal team, but had to leave to go to work according 
                    to the other team members.</span></p>
                  <p class="bold">&nbsp;</p>
                  <p align="CENTER" class="bold"><span class="text"><b>TriviaQuest 
                    Winners - Rangers</b></span></p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="text">Group Name 
                    - Anonymous</span></p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="text">Xoref - Rodcet 
                    Nife</span></p>
                  <p align="CENTER" class="bold"><span class="text">Kaitlinh - 
                    Cazic Thule</span></p>
                  <p align="CENTER" class="bold"><span class="text">Elonwie - 
                    The Rathe</span></p>
                  <p align="CENTER" class="bold"><span class="text">Namrah - Brell 
                    Serilis</span></p>
                  <p align="CENTER" class="bold"><span class="text">Cyenwien - 
                    Brell Serilis</span></p>
                  <p align="CENTER" class="bold"><span class="text">Aethdor - 
                    Lanys T'Vyl</span></p>
                  <p align="CENTER" class="bold"><span class="text">Driftwood 
                    - Bristlebane</span></p>
                  <p align="CENTER" class="bold"><span class="text">Draayke - 
                    Bristlebane</span></p>
                  <p align="CENTER" class="bold"><span class="text">Rendail - 
                    Luclin</span></p>
                  <p align="CENTER" class="bold">&nbsp;</p>
                  <p align="CENTER" class="bold"><span class="text"><b>EverQuest 
                    Jeopardy Winner</b></span></p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="text">Branr - Fennin 
                    Ro</span></p>
                  <p align="CENTER" class="bold">&nbsp;</p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="textBold"><b>Random 
                    Drawing Winners</b></span></p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="text">Vagner - Brell 
                    Serilis</span></p>
                  <p align="CENTER" class="bold"><span class="text">Stalmage - 
                    Innoruuk</span></p>
                  <p align="CENTER" class="bold">&nbsp;</p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="textBold"><b>Grand 
                    Prize Winners of Uber Weapons</b></span></p>
                  <p align="CENTER"></p>
                  <p align="CENTER" class="bold"><span class="text">Starrdancer 
                    - Tarew Marr</span></p>
                  <p align="CENTER" class="bold"><span class="text">Leilla - Brell 
                    Serilis</span></p>
                  <p align="CENTER" class="bold"><span class="text">Kendahl - 
                    Povar</span></p>
                  <p align="CENTER" class="bold"><span class="text">Aymber - Brell 
                    Serilis</span></p>
                                    </td>
              </tr>
            </table>
