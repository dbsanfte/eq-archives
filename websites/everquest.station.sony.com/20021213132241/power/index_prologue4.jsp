...
<body bgcolor="#000000" text="#B64606"  onresize="resize();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">39,249 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/index_prologue4.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/index_prologue4.jsp');">
...
<center>
  ...
  <table bgcolor="#000000" border="0" cellpadding="0" cellspacing="0" width="780" background="images4/home_bg.jpg">
    <tr> 
...

{
	...
	document.write('<img src="images/spacer.gif" border="0" height="13" width=1><br>');
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="1"><img src="images/spacer.gif" width="70" height="8"></td>
            <td> 
              <div id="stretch" style="width:640px; height:365;"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="640" height="360">
                  <param name=movie value="media/pop_rallos.swf">
                  <param name=quality value=high>
                  <param name=menu value=false>
                  <embed src="media/pop_rallos.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="640" height="360" menu="false">
                  </embed> 
                </object> </div>
            </td>
            <td width="1"><img src="images/spacer.gif" width="70" height="8"></td>
    ...
    <tr> 
      <td height="368" width=780 valign="top"> 
