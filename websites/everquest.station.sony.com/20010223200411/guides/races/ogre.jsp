...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">50841 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<div align="center"> 
<div align="center"> 
<div align="center"><b><font face="Georgia, Times New Roman, Times, serif" color="#FF9900" size="4"><span class="header">Ogre</span></font></b></div>
<table border="0" width="100%" cellpadding="10">
<tr> 
<td align="center"><a href="JavaScript:imageSwitch('male')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_ogremale.gif" width="167" height="254" name="male" border="0"></a></td>
...
<td align="center"><a href="JavaScript:imageSwitch('female')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_ogrefemale.gif" width="167" height="254" name="female" border="0"></a></td>
<tr> 
<td colspan="3"><font face="Arial, Helvetica, sans-serif">Ogres are incredibly 
massive beings, with their average height being about 10', and weigh well over 
four hundred pounds, which makes them a truly immovable object. Due to their size, 
they are the strongest of all the races and are tied with the Trolls in pure Stamina. 
Conversely, they are the stupidest race, whose lives mostly consist of smashing 
things and eating them. </font></td>
</table>
</div>
</div>
</div>
