...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>98208 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --><span class="bold"> 
                                    EverQuest Producer Jeff Butler and Assistant 
                                    Producer Bill Coyle answer question during 
                                    the Producer's Discussion Panel at the Orlando 
                                    Fan Faire. </span> 
                                    <p class="bold">
                                      <a href="../sounds/01-L1CM.mp3" class="bold2">Bill 
                                      Coyle talks about the balance between PvP 
                                      and PvE.</a></p>
                                    <p class="bold"><br>
                                      <a href="../sounds/02-L1CM.mp3" class="bold2">Jeff 
                                      Butler says player houses not on the list 
                                      for development.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/03-L1CM.mp3" class="bold2">More 
                                      on player owned housing.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/04-L1CM.mp3" class="bold2">Money 
                                      sinks, and wanted features</a></p>
                                    <p class="bold">
                                      <a href="../sounds/05-L1CM.mp3" class="bold2">Jousting 
                                      competitions would be cool!</a></p>
                                    <p class="bold">
                                      <a href="../sounds/06-L1CM.mp3" class="bold2">Go 
                                      ask Lawrence, but here's my opinion anyway.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/07-L1CM.mp3" class="bold2">Spawn 
                                      times, European guilds, and server moves.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/08-L1CM.mp3" class="bold2">PvP 
                                      race wars and cross teaming.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/09-L1CM.mp3" class="bold2">Cleric 
                                      burn out at high levels.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/10-L1CM.mp3" class="bold2">More 
                                      fun things to do with a cleric.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/11-L1CM.mp3" class="bold2">Sailing 
                                      the great blue sea, and sailing, and sailing, 
                                      and sailing.</a></p>
                                    <p class="bold"><span class="bold"><br>
                                      </span> <a href="../sounds/12-L1CM.mp3" class="bold2">Pathing 
                                      in Luclin</a>
                                    </p>
                                    <!-- #EndEditable --></td>
                                </tr>
