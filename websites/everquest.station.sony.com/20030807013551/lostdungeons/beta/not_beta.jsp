...
<html><!-- InstanceBegin template="/Templates/beta.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
<head>
...
<link rel="StyleSheet" href="includes/beta.css" type="text/css">
<!-- InstanceBeginEditable name="head" --><!-- InstanceEndEditable -->
</head>

<body bgcolor="black" text="white" link="#ffcc00" vlink="#ffcc00" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0">
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/lostdungeons/beta/not_beta.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/lostdungeons/beta/not_beta.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/lostdungeons/beta/not_beta.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<table width="780" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000505">
<tr>
	<td width="179"valign="top" background="images/bottom_bg.jpg"><img src="images/left_side.jpg" width="179" height="496" alt="" border="0"></td>
	<td width="601" height="1" valign="top" style="background-image:   url(images/body_norepeat.jpg); background-repeat: no-repeat">
		<img src="images/top.jpg" width="601" height="45" alt="EverQuest&reg; Lost Dungeons of Norrath&#153; Beta" border="0">
<div style="padding: 0px 15px 0px 15px;">
<p align="center" class="navlinks"><a href="news.jsp">NEWS</a> &middot; <a href="nda.jsp">NDA</a></p>
          <!-- InstanceBeginEditable name="Content" -->
                                    <h5>Not Registered for Beta</h5>
                                    <p>I'm sorry, but you are not registered for beta. </p>
          <!-- InstanceEndEditable --></div>
	</td>
</tr>
<tr>
	<td height="1" colspan="2" align="center" style="background-image:   url(images/bottom_bg.jpg); background-repeat: repeat-y">
<hr width="95%" size="1" color="#003333" noshade>
		<table border="0" cellspacing="0" cellpadding="20" align="center">
		<tr>
			<td><a href="http://www.esrb.com/" target="_blank"><img src="images/logo_esrb_rp.gif" width="56" height="78" alt="ESRB Rating Pending" border="0"></a></td>
			<td><a href="http://sonyonline.com/tos/privacy.jsp" target="_tosWin" onclick="return openToS('http://sonyonline.com/tos/privacy.jsp');"><img src="http://www.station.sony.com/common/images/esrb_privacy.jpg" alt="ESRB&#153; Privacy Certified - click to privacy statement" width="116" height="43" border="0"></a></td>
			<td><a href="http://sonyonline.com/"><img src="images/logo_soe.jpg" width="91" height="62" alt="Sony Online Entertainment" border="0"></a></td>
		</tr>
		</table>
		<br>
<script language="JavaScript">
...
<a href="http://sonyonline.com/tos/tos.jsp" target="_tosWin" onclick="return openToS('http://sonyonline.com/tos/tos.jsp');" class="ToS">Sony Online Terms Of Service</a>
		...
		<p class="legal">EverQuest is a registered trademark and Lost Dungeons of Norrath is a trademark of Sony Computer Entertainment America Inc. &copy; 2003 Sony Computer<br>
		Entertainment America Inc. SOE and the SOE logo are registered trademarks of Sony Online Entertainment Inc. All rights reserved.</p>
	</td>
</tr>
</table>
</div>
