...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/info_fr.jsp?null');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/info.gif" width="240" height="49"> <br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p 
align="left"><span class="bold">La Fan Faire d'EverQuest est un &eacute;v&eacute;nement 
                                      social de la vie r&eacute;elle qui a lieu 
                                      plusieurs fois par an dans diverses r&eacute;gions 
                                      du pays. La Fan Faire doit permettre aux 
                                      joueurs d'EverQuest de rencontrer d'autre 
                                      joueurs dans un environnement agr&eacute;able, 
                                      aussi bien que d'approcher les divers employ&eacute;s 
                                      de SOE qui sont impliqu&eacute;s dans le 
                                      jeu. Bien que les participants aient de 
                                      nombreuses occasions de se rencontrer et 
                                      de se faire de nouveaux amis, ils pourront 
                                      aussi participer &agrave; de nombreuses 
                                      r&eacute;unions de discussion et autres 
                                      manifestations sur le th&egrave;me du jeu. 
                                      Les rassemblements pr&eacute;c&eacute;dents 
                                      ont mis en sc&egrave;ne des Live Quests, 
                                      avec divers personnages non joueurs volontaires 
                                      qui remettaient des &eacute;nigmes &agrave; 
                                      r&eacute;soudre et des t&acirc;ches &agrave; 
                                      accomplir aux participants, et le d&eacute;roulement 
                                      d'un &eacute;v&eacute;nement de jeu r&eacute;el, 
                                      projet&eacute; sur grand &eacute;cran, pour 
                                      le plus grand plaisir des spectateurs. Chaque 
                                      Fan Faire successive semble devenir plus 
                                      fr&eacute;quent&eacute;e et plus excitante. 
                                      Ainsi, quant &agrave; savoir ce que l'avenir 
                                      nous r&eacute;serve, qui vivra verra !</span><br>
