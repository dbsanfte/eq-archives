	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta_reg/reg_closed.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/beta_reg/reg_closed.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<p><strong>Welcome to the EverQuest&reg;: Gates of Discord&#153; beta registration page. Thank you for your interest in EverQuest: Gates of Discord beta testing program. Currently, we are not accepting beta applications. If we need additional beta testers, we will make the announcement in-game and re-open our beta registration home page.</strong></p>
<p><strong>For information on this game, visit the <a href="../index.jsp">EverQuest: Gates of Discord homepage.</a></strong></p>
