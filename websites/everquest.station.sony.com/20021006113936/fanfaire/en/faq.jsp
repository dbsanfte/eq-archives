...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/faq.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/faq.jsp');">
                                    ...
                                    <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><span class="bold3"><br>
                                      ...
                                      <div align="justify"><span class="bold3">What 
                                        ...
                                        <p class="bold"><span class="bold3">I 
                                          ...
                                          the FanFaire Team (fanfaire@soe.sony.com) 
                                        ...
                                        <p class="bold"><span class="bold3">What 
                                          ...
                                          email your request to <a href="mailto:fanfaire@soe.sony.com" class="bold3">fanfaire@soe.sony.com</a>. 
                                          Please include your Station name with 
                                          your email. <span class="bold3"><font size="2">Refunds 
                                          can only be issued before the close 
                                          of registration. </font></span>Once 
                                          registration is closed we must guarantee 
                                          the number of attendees with the venue 
                                          hosting the event.</p>
                                        <p class="bold"><span class="bold3">I 
                                        ...
                                        <p><span class="bold">If you still have 
                                          questions, please email the FanFaire Team 
                                          at <a href="mailto:fanfaire@soe.sony.com" class="bold3">fanfaire@soe.sony.com</a>.</span><br>
                                        </p>
                                        <br>
                                      </div>
                                      </div>
