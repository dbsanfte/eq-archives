        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr>
                <td><span class="textBold">What is a Fan Faire? </span><span class="text"><br>
                  ...
                  will have plenty of opportunity to mingle freely with one another 
                  ...
                  <p class="bold"><span class="textBold">When and where are the 
                    Fan Faire events held?</span><span class="text"><br>
                    Fan Faire events are held in various regions throughout the 
                    U.S. and occur every 3-4 months. We try to choose locations 
                    that will accommodate as many players as possible. Our current 
                    goal is to hold at least one Fan Faire per year on the U.S. 
                    East and West coasts as well as a central location in the 
                    United States. Every so often, we may solicit your input on 
                    future locations of Fan Faire via polls on this site. </span></p>
                  <p class="bold"><span class="textBold">What do I get for my 
                    registration fee? </span><span class="text"><br>
                    You may attend a private reception with other players Friday 
                    evening. Then on Saturday, you will be able to meet representatives 
                    from SOE, and participate in any of several discussion panels 
                    with EQ representatives. There will be contests and drawings 
                    for prizes, plus you will receive a T-shirt and be served 
                    dinner Saturday evening. And best of all, you will get the 
                    unique experience of meeting hundreds of other Norrathian 
                    citizens!</span></p>
                  <p class="bold"><span class="textBold">I did not receive a confirmation 
                    email after I registered. Am I really registered?</span><span class="text"><br>
                    ...
                    the FanFaire Team (fanfaire@soe.sony.com) to check on your 
                    registration status. Also, be sure that you have an active 
                    current email address.</span></p>
                  <p class="bold"><span class="textBold">I can't get there in 
                    time for the early registration. Can I still get my Player 
                    Passport and get in when I arrive?</span><span class="text"><br>
                    Yes! Just check in when you get there. </span></p>
                  <p class="bold"><span class="textBold">Can children attend this 
                    event? </span><span class="text"><br>
                    Children can attend this event, but an adult must accompany 
                    all minors. The cost for children is the same as for adults. 
                    </span></p>
                  <p class="bold"><span class="textBold">My spouse and I both 
                    play EQ. Should we list one of us as a guest?</span><span class="text"><br>
                    No. A guest is someone that does not play EQ. Each player 
                    should register individually to get his or her personalized 
                    Player Passport.</span></p>
                  <p class="bold"><span class="textBold">My spouse does not play 
                    EQ but wants to come with me. What is the fee for someone 
                    that does not play? </span><span class="text"><br>
                    The fee is the same for players and non-players. Just list 
                    them as your guest on the registration form. </span></p>
                  <p class="bold"><span class="textBold">What about my hotel accommodations? 
                    ...
                    our event, and you may wish to take advantage of these.</span></p>
                  <p class="bold"><span class="textBold">What if I need to cancel 
                    my registration? Can I get a refund?</span><span class="text"><br>
                    ...
                    Please include your Station name with your email. <font size="2">Refunds 
                    can only be issued before the close of registration. </font>Once 
                    registration is closed we must guarantee the number of attendees 
                    with the venue hosting the event.</span></p>
                  <p class="bold"><span class="textBold">I am a guide. Do I register 
                    under my guide name or my player name? </span><span class="text"><br>
                    Please refer to the guide board periodically for information 
                    on this. </span></p>
                  <p class="bold"><span class="textBold">Can I wear a costume 
                    to Fan Faire?<br>
                    </span><span class="text">Of course you can wear a costume, 
                    in fact, we encourage it. Unfortunately, the Metreon and the 
                    Marriott do not allow weapons (steel or wood) in any public 
                    area. If you are found with one in your possession in a public 
                    area, you will be asked to return the item to your room.</span><br>
                  </p>
                  <p class="text">If you still have questions, please email the 
                    FanFaire Team at <a href="mailto:fanfaire@soe.sony.com" class="links">fanfaire@soe.sony.com</a>.</p>
                </td>
              </tr>
            </table>
            <!-- #EndEditable --></td>
