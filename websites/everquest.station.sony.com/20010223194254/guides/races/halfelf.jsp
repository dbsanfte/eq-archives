...
race = "halfelf"
mMale = "images/r_" + race + "male.gif"
mMale_anim = "images/r_" + race + "male_anim.gif"
mFemale = "images/r_" + race + "female.gif"
mFemale_anim = "images/r_" + race + "female_anim.gif"
animm = false
animf = false

function imageSwitch(mSex) {
  if (mSex == "male") {
    document.female.src=mFemale
    animf = false
    if (animm) {
      document.male.src=mMale
      animm = false
    } else {
      document.male.src=mMale_anim
      animm = true
    }
  } else {
    document.male.src=mMale
    ...
    if (animf) {
      ...
      document.female.src=mFemale_anim
      animf = true
    }
  } 
}
...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">49425 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<table width="130" border="0" cellspacing="0" cellpadding="0" background="">
  <tr> 
    <td width="130" valign="top" align="right" class="menu"> <b class="menuHeader"> 
      ...
      <a href="index.jsp"><b class="menuHeader">Races <img src="/images/2bm.gif" width="32" height="14" border="0" align="absmiddle"></b></a><br>
      <a href="barbarian.jsp">Barbarian <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="darkelf.jsp">Dark Elf <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="dwarf.jsp">Dwarf <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="elf.jsp">Elf <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="erudite.jsp">Erudite <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="gnome.jsp">Gnome <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="halfelf.jsp">Half Elf <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="halfling.jsp">Halfling <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="highelf.jsp">High Elf <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="human.jsp">Human <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="ogre.jsp">Ogre <img src="/images/3m_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      <a href="troll.jsp">Troll <img src="/images/3e_2l.gif" width="47" height="14" border="0" align="absmiddle"></a><br>
      ...
      <a href="../skills.jsp">Skills <img src="/images/2be.gif" width="32" height="14" border="0" align="absmiddle"></a><br>
...
<div align="center"> 
<div align="center"> 
<div align="center"><b><font face="Georgia, Times New Roman, Times, serif" color="#FF9900" size="4"><span class="header">Half 
Elf</span></font></b></div>
<table border="0" width="100%" cellpadding="10">
<tr> 
<td align="center"><a href="JavaScript:imageSwitch('male')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_halfelfmale.gif" width="167" height="254" name="male" border="0"></a></td>
<td align="center" valign="bottom"> 
<p><font size="2" face="Arial, Helvetica, sans-serif" color="#009999" class="subHeader">Click 
on pictures<br>
to animate</font></p>
<p>&nbsp;</p>
</td>
<td align="center"><a href="JavaScript:imageSwitch('female')"
                              onMouseOver="self.status='Animate Me!'; return true" 
                              onMouseOut="self.status=''; return true"><img src="images/r_halfelffemale.gif" width="167" height="254" name="female" border="0"></a></td>
<tr> 
<td align="center" colspan="3"> 
<div align="justify"><font face="Arial, Helvetica, sans-serif">Half-Elves, being 
a blend between humans and Woodland Elves, share some of the strengths and weaknesses 
of both races. They most closely resemble humans, except for their slightly pointed 
ears and sharper facial features. </font></div>
</td>
</table>
</div>
</div>
