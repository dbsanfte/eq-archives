...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/event_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/event_esp.jsp');">
                                  ...
                                  <td><!-- #BeginEditable "content" --> 
                                      ...
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2> 
                                            <P ALIGN="CENTER" class="bold"><b>Viernes, 
                                              19 de Abril</b> 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">6:00-8:00 p.m.
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Presentaci&oacute;n 
                                              e inscripci&oacute;n
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">08:00-10:00 p.m.
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Recepci&oacute;n
                                          </TD>
                                        </TR>
                                      </TABLE>
                                    </div>
                                    ...
                                    <div align="center"> 
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2> 
                                            <P ALIGN="CENTER" class="bold"><b>S&aacute;bado, 
                                              20 de Abril</b> 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">¡Comienza la Fan Faire!
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">1:30-3:30
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                        ...
                                        <TR> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Taller I
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">5:30-6:45
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Taller II
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">¡Cena y concesi&oacute;n 
                                              de premios!
                                          </TD>
                                        </TR>
                                      </TABLE>
                                    </div>
                                    <P align="center" class="bold">Los talleres 
                                      se centrar&aacute;n en muchos temas, como 
                                      magia, creaci&oacute;n de cofrad&iacute;as 
                                      m&aacute;s fuertes, habilidades gremiales 
                                      y producci&oacute;n y desarrollo de EverQuest.</P>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
