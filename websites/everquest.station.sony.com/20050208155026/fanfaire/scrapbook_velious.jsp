	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_velious.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_velious.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_velious.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr>
                <td><span class="text">The Velious Launch Party, held in the elegant 
                  Bellagio Hotel in Las Vegas, was a two-day extravaganza featuring 
                  discussions, demonstrations, contests, and the chance to meet 
                  some of the key developers that have helped make EverQuest the 
                  most popular massively multiplayer online RPG to date. The real 
                  star of the event, however, was none other than the much anticipated 
                  expansion to the world of EverQuest itself, The Scars of Velious. 
                  Twenty-five &quot;gaming stations&quot; set up around the outer 
                  wall of the gathering hall allowed fans to log in with pre-made 
                  characters and experience first-hand the frozen and forbidding 
                  continent of the South. </span> 
                  <p align=center><img src="images/costumes_sm.jpg" width="200" height="150"> 
                                      </p>
                                    
                  <p align="center"><a href="scrapbook_velious_photos.jsp" class="links"><b>Velious 
                    Launch Party Photo Album</b></a>
                </td>
              </tr>
            </table>
            <!-- #EndEditable --></td>
