...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>82681 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
...
width=590 bordercolor="#000000">
                                        <tr bgcolor="#000000"> 
                                          <td valign="TOP" colspan=2 background=""> 
                                            <p align="CENTER"><b><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><span class="bold"><font color="#FFFFFF">Viernes 
                                            19 de octubre</font> </span></font></b> 
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold"> 
                                              Inscripciones anticipadas</span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP"> 
                                        ...
                                        <tr> 
                                          <td width="50%" valign="TOP"> 
                                            <p class="bold"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold">Recepci&oacute;n</span></b></font> 
                                          </td>
                                          <td width="50%" valign="TOP"> 
                                        ...
                                        <tr bgcolor="#000000"> 
                                          <td valign="TOP" colspan=2 height="33" background=""> 
                                            <p align="CENTER"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><span class="bold"><font color="#FFFFFF">S&aacute;bado 
                                            20 de octubre
                                              </font></span></b></font> 
                                          </td>
                                        </tr>
...
ld"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>Inscripciones 
                                              tard&iacute;as</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bo
...
ld"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>&iexcl;Comienza 
                                              la Fan Faire!</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bo
...
ld"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>Real 
                                              Life Quest (misi&oacute;n en vivo)</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bo
...
ld"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>Paneles 
                                              de debate y misi&oacute;n en el 
                                              juego</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bo
...
ld"> 
                                            <p><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b>Cena 
                                              y entrega de premios</b></font> 
                                          </td>
                                          <td width="50%" valign="TOP" class="bo
