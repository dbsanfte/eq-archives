              ...
              <table width="95%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td align="center"> 
                    ...
                    <p align="center"><img src="images/hammerfel_title.gif" width="401" height="104"></p>
                    <table width="85%" border="0" cellspacing="0" cellpadding="0">
                      <tr>

                        <td> 
                          <p>Welcome to Hammerfel's Last Rites. Like my good friend 
                            Fippy, with his <a href="../fippyfacts/index.jsp">Facts</a>, 
                            and my fellow &quot;small person,&quot; <a href="http://everquest.station.sony.com/featured_content/mennix/weekly.jsp">Mennix</a>, 
                            I will be making the occasional appearance here on 
                            EverQuestLive.com. For the most part, my news will 
                            cover EverQuest on the web, but I will also share 
                            my experiences and tips from my days as a Cleric, 
                            healing the wounds of those in need and bringing the 
                            fallen back to life.</p>
                          <p>-High Priest Hammerfel</p>
                          <p></p>
                          <p>In the April edition of the Ha<font color="#4C1C22"><b>r</b></font>py's 
                            Head Herald, EQ's official email newsletter that goes 
                            o<b><font color="#4C1C22"><b>u</b></font></b>t 
                            to more than 200,000 subscr<font color="#4C1C22"><b>i</b></font>bers, 
                            we placed one puzzle and a hidde<font color="#4C1C22"><b>n</b></font><b> 
                            </b>clue within the content as a <b><font color="#4C1C22">s</font></b>pecial 
                            Easter Egg. This lead to further clues hinting at 
                            something we currently have in the works, to be announced 
                            in the near future.</p>
                          <p>The newsletter subscriber base was br<font color="#4C1C22"><b>o</b></font>ken 
                            down into nine groups, and each of these groups received 
                            a different piece of the puzzle. This called for a 
                            community effort to solve it. (Originally, there were 
                            8 pieces, but one gave too many letters away, so we 
                            split it in two) Congrats to The <a href="http://pub35.ezboard.com/fthesafehousethebackroomsecretsspoilers.showMessage?topicID=10774.topic">SafeHouse</a> 
                            community for being the first group to solve the puzzle.</p>
                          <p align="center"><b>Nine to Unfold<br>
                            </b><br>
                            Unity to bind<br>
                            A word of discovery<br>
                            An answer to<font color="#4C1C22"> <b>f</b></font>ind</p>
                          <p align="center">Nine to unfold<br>
                            Shattered and lost<br>
                            A power untold</p>
                          <p align="center">A domain of destination<br>
                            Outside the normal world<br>
                            The<font color="#4C1C22"> <b>b</b></font>oundary of 
                            imagination</p>
                          <p align="center">Veiled in darkest night<br>
                            Combined, the magic is revealed<br>
                            By a hand righteous of might</p>
                          <p align="center">A new world will beckon<br>
                            No longer concealed</p>
                          <table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#000000">
                            <tr> 
                              <td> 
                                <div align="center"><img src="images/1B7K320LF849_s.jpg" width="168" height="138"></div>
                              </td>
                              <td> 
                                <div align="center"><img src="images/2H7G619T45C3_s.jpg" width="191" height="148"></div>
                              </td>
                            </tr>
                            <tr> 
                              <td> 
                                <div align="center"><img src="images/3W82F63M10D9_s.jpg" width="234" height="194"></div>
                              </td>
                              <td> 
                                <div align="center"><img src="images/9D1734R68CKY2_s.jpg" width="117" height="211"></div>
                              </td>
                            </tr>
                            <tr> 
                              <td> 
                                <div align="center"><img src="images/5L2T851GN79Z3_s.jpg" width="91" height="102"></div>
                              </td>
                              <td> 
                                <div align="center"><img src="images/8LZ5I703Y129H_s.jpg" width="94" height="99"></div>
                              </td>
                            </tr>
                            <tr> 
                              <td> 
                                <div align="center"><img src="images/7XU4972PK013V_s.jpg" width="140" height="134"></div>
                              </td>
                              <td> 
                                <div align="center"><img src="images/4EK9V356J12S7_s.jpg" width="118" height="151"></div>
                              </td>
                            </tr>
                            <tr> 
                              <td colspan="2"> 
                                <div align="center"></div>
                                <div align="center"><img src="images/6AE2305WA91W7_s.jpg" width="203" height="129"></div>
                              </td>
                            </tr>
                            <tr>
                              <td colspan="2">
                                <div align="center"><img src="images/Nektulos_final_s.jpg" width="440" height="300"></div>
                              </td>
                            </tr>
                          </table>
                          <p align="center">&nbsp;</p>
                          <p><br>
                            Once all the pieces were combin<b><font color="#4C1C22">e</font></b>d, 
                            the word NEKTULOS appeared, and by <font color="#4C1C22"><b>f</b></font>ollowing 
                            the clues in the above riddle, the answer lay waiting 
                            at <a href="http://www.nektulos.com">www.nektulos.com</a>. 
                          </p>
                          <p>Once at <a href="http://www.nektulos.com">www.nektulos.com</a>, 
                            visitors were greeted with<b><font color="#4C1C22"> a</font> </b>
                            mysterious announcement and a black screen. If the 
                            mouse cursor was run over this black screen, a special 
                            image was revealed-a glimpse of what is to come.</p>
                          <p>That tab<b><font color="#4C1C22">l</font></b>et puzzle 
                            was not the only Easter Egg in this newsletter. If 
                            anyone happened to view source on the news<b><font color="#4C1C22">l</font></b>etter, 
                            they would have seen the comment line that read, &lt;!-- 
                            &quot;Now, don't get lost in the Sevac Gniliaw...&quot;, 
                            said the High Priest Hammerfel --&gt;. Sevac Gniliaw 
                            is Wailing Caves spelled backwards. Those who figured 
                            out the tablet puzzle first, th<font color="#4C1C22"><b>e</b></font>n 
                            came across this hidden comment of mine quickly figured 
                            out that <a href="http://www.wailingcaves.com">www.wailingcaves.com</a> 
                            had a surprise as well. </p>
                          <p>Keep watching for more Easter Eggs and puzzles in 
                            the coming weeks. The community pulled together very 
                            fast to solve this o<b><font color="#4C1C22">n</font></b>e. 
                            But who will be the first to unravel the big announcement 
                            just cresting the horizon?</p>
                          <p>-High Priest Hammerfel<br>
                            Nathan Pearce<br>
                            Director of Web Presence<br>
                          </p>
                          <p align="center">Image on<a href="http://www.nektulos.com"> 
                            www.nektulos.com</a></p>
                          <p align="center"><a href="images/NektulosScreen01.jpg"><img src="images/NektulosScreen01_s.jpg" width="300" height="225" border="0"></a> 
                          </p>
                          <p align="center">Image on <a href="http://pub35.ezboard.com/fthesafehousethebackroomsecretsspoilers.showMessage?topicID=10774.topic">www.wailingcaves.com</a></p>
                          <p align="center"><a href="images/WailingCave43.jpg"><img src="images/WailingCave43_s.jpg" width="300" height="225" border="0"></a></p>
                          <p align="left">&nbsp;</p>
                        </td>
                      </tr>
