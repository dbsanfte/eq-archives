...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/winners_seattle.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/winners_seattle.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <center>
                                      <img src="screenshots/ff_seattle/winners_montage_branded1.jpg" width="640" height="480">
</center><br>
                                    <br>
									<p class="bold">Live Quest Winners</p>
									<p>Team: The Rathe 1</p>
									  
									<table border="0" width="100%">
										<tr><td>Livius Maximus</td><td>High Elf Paladin</td></tr>
										<tr><td>Moonglumm Riptear</td><td>Iksar Monk</td></tr>
										<tr><td>Rhuigha Spirithealer</td><td>Barbarian Shaman</td></tr>
										<tr><td>Littlun Bigheart</td><td>Halfling Rogue</td></tr>
										<tr><td>Jaras Loupgeist</td><td>Halfling Druid</td></tr>
										<tr><td>Balshazzar Synapse</td><td>Gnome Necromancer</td></tr>
										<tr><td>Ironking</td><td>Human Paladin</td></tr>
										<tr><td>Riverraine</td><td>Human Magician</td></tr>
										<tr><td>Dolaf</td><td>Dwarf Paladin</td></tr>
										<tr><td>Breezar Wolfpup</td><td>High Elf Enchanter</td></tr>
										<tr><td>Wichy Wolfpup</td><td>Wood Elf Druid</td></tr>
										<tr><td>Valthor Runefang</td><td>Wood Elf Ranger</td></tr>
										<tr><td>Niborris Evarb</td><td>High Elf Paladin</td></tr>
										<tr><td>Rixma</td><td>Human Rogue</td></tr>
									</table>
									
									<p class="bold">Raffle Prizes</p>
									<table border="0" width="100%">									
										<tr><td>Vainglory of Luclin</td><td>Crystal Goblet from Renaissance Pewter</td></tr>
										<tr><td>Kilaka	of Bristlebane</td>
                                        <td>T-shirt from <a href="http://www.thesafehouse.org">The 
                                          Safe House</a></td>
                                      </tr>
										<tr><td>Allexi of Rodcet Nife</td>
                                        <td>Signed Original Iksar Drawing by <a href="http://www.keithparkinson.com">Keith 
                                          Parkinson</a></td>
                                      </tr>
										<tr><td>Arrina of The Nameless</td>
                                        <td>Leather Journal from <a href="http://eq.castersrealm.com">Casters 
                                          Realm</a></td>
                                      </tr>
										<tr><td>Tymmon of Luclin</td>
                                        <td>Leather Journal from <a href="http://eq.castersrealm.com">Casters 
                                          Realm</a></td>
                                      </tr>
										<tr><td>Vizagoth of Innoruuk</td>
                                        <td>Leather Journal from <a href="http://eq.castersrealm.com">Casters 
                                          Realm</a></td>
                                      </tr>
										<tr><td>Janya of Brell Serilis</td>
                                        <td>Leather Journal from <a href="http://eq.castersrealm.com">Casters 
                                          Realm</a></td>
                                      </tr>
										<tr><td>Myrs of Tallon Zek</td>
                                        <td>T-shirt from <a href="http://www.avatarsoffline.com">Avatars 
                                          Offline</a></td>
                                      </tr>
										<tr><td>Gintora of The Tribunal</td>
                                        <td>T-shirt from <a href="http://www.rpgwear.com">RPGwear</a></td>
                                      </tr>
										<tr><td>Himha of The Tribunal</td>
                                        <td>Customer T-shirt from <a href="http://www.rpgwear.com">RPGwear</a></td>
                                      </tr>
										<tr><td>Ebcha of Brell Serilis</td>
                                        <td><a href="http://www.intel.com">Intel's</a> 
                                          Pocket Concert Audio Player</td>
                                      </tr>
										<tr><td>Alokert of Bristlebane</td>
                                        <td><a href="http://www.intel.com">Intel's</a> 
                                          Pocket Concert Audio Player</td>
                                      </tr>
										<tr><td>Leatherneck</td>
                                        <td><a href="http://www.intel.com">Intel's</a> 
                                          Pocket Concert Audio Player</td>
                                      </tr>
										<tr><td>Salelar of Povar</td>
                                        <td><a href="http://www.white-wolf.com">White 
                                          Wolf</a> character storyline</td>
                                      </tr>
										<tr><td>Xean of Tunare</td>
                                        <td><a href="http://everquest.allakhazam.com">AllaKhazam</a> 
                                          subscription</td>
                                      </tr>
										<tr><td>Lindon of Tunare</td>
                                        <td><a href="http://everquest.allakhazam.com">AllaKhazam</a> 
                                          subscription</td>
                                      </tr>
										<tr><td>Talanie of Veeshan</td>
                                        <td><a href="http://everquest.allakhazam.com">AllaKhazam</a> 
                                          subscription</td>
                                      </tr>
										<tr><td>Arylcent of The Nameless</td>
                                        <td><a href="http://www.everquestraids.com">EverQuest 
                                          Raids</a> subscription</td>
                                      </tr>
										<tr><td>Mightymixx of Lanys T`Vyl</td>
                                        <td><a href="http://www.everquestraids.com">EverQuest 
                                          Raids</a> subscription</td>
                                      </tr>
										<tr><td>Salliero of Terris-Thule</td>
                                        <td><a href="http://www.everquestraids.com">EverQuest 
                                          Raids</a> subscription</td>
                                      </tr>
										<tr><td>Kadamn of Tholuxe Paells</td>
                                        <td><a href="http://www.everquestraids.com">EverQuest 
                                          Raids</a> subscription</td>
                                      </tr>
										<tr><td>Kim R.</td>
                                        <td>Hands-free mouse from <a href="http://www.cymouse.com">Cymouse</a></td>
                                      </tr>
										<tr><td>Jeff P.</td>
                                        <td>Hands-free mouse from <a href="http://www.cymouse.com">Cymouse</a></td>
                                      </tr>
