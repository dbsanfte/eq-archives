	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_seattle.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_seattle.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/winners_seattle.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
          ...
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <center>
                    <img src="screenshots/ff_seattle/winners_montage_branded1.jpg" width="604" height="480"> 
                  </center>
                  <br>
                  <br>
                  <p class="bold"><span class="text">Live Quest Winners</span></p>
                  <p class="text">Team: The Rathe 1</p>
                  <table border="0" width="100%">
                    <tr> 
                      <td class="text">Livius Maximus</td>
                      <td class="text">High Elf Paladin</td>
                    </tr>
                    <tr> 
                      <td class="text">Moonglumm Riptear</td>
                      <td class="text">Iksar Monk</td>
                    </tr>
                    <tr> 
                      <td class="text">Rhuigha Spirithealer</td>
                      <td class="text">Barbarian Shaman</td>
                    </tr>
                    <tr> 
                      <td class="text">Littlun Bigheart</td>
                      <td class="text">Halfling Rogue</td>
                    </tr>
                    <tr> 
                      <td class="text">Jaras Loupgeist</td>
                      <td class="text">Halfling Druid</td>
                    </tr>
                    <tr> 
                      <td class="text">Balshazzar Synapse</td>
                      <td class="text">Gnome Necromancer</td>
                    </tr>
                    <tr> 
                      <td class="text">Ironking</td>
                      <td class="text">Human Paladin</td>
                    </tr>
                    <tr> 
                      <td class="text">Riverraine</td>
                      <td class="text">Human Magician</td>
                    </tr>
                    <tr> 
                      <td class="text">Dolaf</td>
                      <td class="text">Dwarf Paladin</td>
                    </tr>
                    <tr> 
                      <td class="text">Breezar Wolfpup</td>
                      <td class="text">High Elf Enchanter</td>
                    </tr>
                    <tr> 
                      <td class="text">Wichy Wolfpup</td>
                      <td class="text">Wood Elf Druid</td>
                    </tr>
                    <tr> 
                      <td class="text">Valthor Runefang</td>
                      <td class="text">Wood Elf Ranger</td>
                    </tr>
                    <tr> 
                      <td class="text">Niborris Evarb</td>
                      <td class="text">High Elf Paladin</td>
                    </tr>
                    <tr> 
                      <td class="text">Rixma</td>
                      <td class="text">Human Rogue</td>
                    </tr>
                  </table>
                  <p class="bold"><span class="text">Raffle Prizes</span></p>
                  <table border="0" width="100%">
                    <tr> 
                      <td class="text">Vainglory of Luclin</td>
                      <td class="text">Crystal Goblet from Renaissance Pewter</td>
                    </tr>
                    <tr> 
                      <td class="text">Kilaka of Bristlebane</td>
                      <td class="text">T-shirt from <a href="http://www.thesafehouse.org" class="links">The 
                        Safe House</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Allexi of Rodcet Nife</td>
                      <td class="text">Signed Original Iksar Drawing by <a href="http://www.keithparkinson.com" class="links">Keith 
                        Parkinson</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Arrina of The Nameless</td>
                      <td class="text">Leather Journal from <a href="http://eq.castersrealm.com" class="links">Casters 
                        Realm</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Tymmon of Luclin</td>
                      <td class="text">Leather Journal from <a href="http://eq.castersrealm.com" class="links">Casters 
                        Realm</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Vizagoth of Innoruuk</td>
                      <td class="text">Leather Journal from <a href="http://eq.castersrealm.com" class="links">Casters 
                        Realm</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Janya of Brell Serilis</td>
                      <td class="text">Leather Journal from <a href="http://eq.castersrealm.com" class="links">Casters 
                        Realm</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Myrs of Tallon Zek</td>
                      <td class="text">T-shirt from <a href="http://www.avatarsoffline.com" class="links">Avatars 
                        Offline</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Gintora of The Tribunal</td>
                      <td class="text">T-shirt from <a href="http://www.rpgwear.com" class="links">RPGwear</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Himha of The Tribunal</td>
                      <td class="text">Customer T-shirt from <a href="http://www.rpgwear.com" class="links">RPGwear</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Ebcha of Brell Serilis</td>
                      <td class="text"><a href="http://www.intel.com" class="links">Intel's</a> 
                        Pocket Concert Audio Player</td>
                    </tr>
                    <tr> 
                      <td class="text">Alokert of Bristlebane</td>
                      <td class="text"><a href="http://www.intel.com" class="links">Intel's</a> 
                        Pocket Concert Audio Player</td>
                    </tr>
                    <tr> 
                      <td class="text">Leatherneck</td>
                      <td class="text"><a href="http://www.intel.com" class="links">Intel's</a> 
                        Pocket Concert Audio Player</td>
                    </tr>
                    <tr> 
                      <td class="text">Salelar of Povar</td>
                      <td class="text"><a href="http://www.white-wolf.com" class="links">White 
                        Wolf</a> character storyline</td>
                    </tr>
                    <tr> 
                      <td class="text">Xean of Tunare</td>
                      <td class="text"><a href="http://everquest.allakhazam.com" class="links">AllaKhazam</a> 
                        subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Lindon of Tunare</td>
                      <td class="text"><a href="http://everquest.allakhazam.com" class="links">AllaKhazam</a> 
                        subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Talanie of Veeshan</td>
                      <td class="text"><a href="http://everquest.allakhazam.com" class="links">AllaKhazam</a> 
                        subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Arylcent of The Nameless</td>
                      <td class="text"><a href="http://www.everquestraids.com" class="links">EverQuest 
                        Raids</a> subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Mightymixx of Lanys T`Vyl</td>
                      <td class="text"><a href="http://www.everquestraids.com" class="links">EverQuest 
                        Raids</a> subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Salliero of Terris-Thule</td>
                      <td class="text"><a href="http://www.everquestraids.com" class="links">EverQuest 
                        Raids</a> subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Kadamn of Tholuxe Paells</td>
                      <td class="text"><a href="http://www.everquestraids.com" class="links">EverQuest 
                        Raids</a> subscription</td>
                    </tr>
                    <tr> 
                      <td class="text">Kim R.</td>
                      <td class="text">Hands-free mouse from <a href="http://www.cymouse.com" class="links">Cymouse</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Jeff P.</td>
                      <td class="text">Hands-free mouse from <a href="http://www.cymouse.com" class="links">Cymouse</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Keith A.</td>
                      <td class="text">Hands-free mouse from <a href="http://www.cymouse.com" class="links">Cymouse</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Alexander T.</td>
                      <td class="text">Hands-free mouse from <a href="http://www.cymouse.com" class="links">Cymouse</a></td>
                    </tr>
                    <tr> 
                      <td class="text">Gary L.</td>
                      <td class="text">Hands-free mouse from <a href="http://www.cymouse.com" class="links">Cymouse</a></td>
                    </tr>
                  </table>
                  <p><br>
