...
<script language="JavaScript" src="http://www.station.sony.com/common/comm_opener.js"> </script>
...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">78981 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<table width="781" border="0" cellspacing="0" cellpadding="0" height="309">

  <tr> 

    <td colspan="3" valign=top height="208"> 

      <table width="781" border="0" cellspacing="0" cellpadding="0">

        <tr>

          <td width="226" valign=top height="330"> 
          ...
          <td width="344" height="330" valign=top> 

            <div align="center"><br>
              <img src="images/fanfaire.jpg" width="322" height="295"></div>
          </td>
          <td width="211" height="330"> 
                ...
                <tr> 
                  ...
                  <td>
                    <center>
                      ...
                      <p class="bold" align="center"><span class="bold">  The next Fan Faire will be June 15-16 in Minneapolis, Minnesota at Minneapolis Marriott City Center.  Rooms cost $99, and the deadline for registering for the event is June 4.</span>
                      <p class="bold">Note: If you have already registered for the Fan Faire and been quoted a price of $106 for the room, please note that the hotel will adjust this down to $99 when you are billed.</p>
                    </center>
                  </td>
                </tr>
        ...
        <tr>
          <td colspan="3" valign=top height="49">
