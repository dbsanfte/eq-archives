...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/sponsors_minneapolis_esp.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"><font size="3"><b>Y ahora, 
                                      unas palabras sobre nuestros patrocinadores</b></font> 
                                    </div>
                                    <p class="bold">Vimos muchos patrocinadores 
                                      en la Fan Faire de Minneapolis, y creedme, 
                                      estuvieron bastante ocupados. Desde vender 
                                      camisetas hasta hacer demostraciones de 
                                      nuevas tecnolog&iacute;as, los representantes 
                                      de las distintas empresas agregaron m&aacute;s 
                                      color a&uacute;n a una Fan Faire ya bastante 
                                      colorida y emocionante.</p>
                                    <p><a href="http://rpgwear.com" target="_blank" class="bold2">RPGwear 
                                      </a> </p>
                                    <p class="bold">RPGwear se especializa en 
                                      suministro de accesorios e indumentaria 
                                      para juegos online y de roles. Ellos son 
                                      los responsables de todas esas fant&aacute;sticas 
                                      camisetas de EQ que siempre vemos en las 
                                      Fan Faires y quienes suministran la camiseta 
                                      que viene de regalo con la inscripci&oacute;n 
                                      a la Fan Faire. Cory Rafiner, el mism&iacute;simo 
                                      Sr. RPGwear, es una persona muy dedicada. 
                                      Cuando hubo un problema en el transporte 
                                      de la mercader&iacute;a hacia Minneapolis, 
                                      alquil&oacute; un cami&oacute;n a &uacute;ltimo 
                                      momento y &eacute;l mismo transport&oacute; 
                                      la mercader&iacute;a desde Utah. </p>
                                    <p><br>
                                      <a href="http://www.keithparkinson.com/" target="_blank" class="bold2">Keith 
                                      Parkinson </a></p>
                                    <p class="bold">Este artista mundialmente 
                                      conocido es realmente impresionante, un 
                                      maestro en su arte. Su relaci&oacute;n con 
                                      EverQuest data de largo tiempo y ning&uacute;n 
                                      halago es suficiente para decribir todo 
                                      lo que ha logrado. &iquest;No me cre&eacute;is? 
                                      Visitad su sitio y vedlo con vuestros propios 
                                      ojos. </p>
                                    <p><br>
                                      <a href="http://www.olympus-eye-trek.com/" target="_blank" class="bold2">Olympus 
                                      </a></p>
                                    <p class="bold">Est&aacute; bien, aqu&iacute; 
                                      estaban estas personas con esas cosas que 
                                      parec&iacute;an gafas sobre la mesa. Se 
                                      trataba de sus propios productos Eye-Trek. 
                                      &iexcl;Aparatos! &iquest;A qui&eacute;n 
                                      no le gustan los aparatos? Por supuesto 
                                      que los examin&eacute; y prob&eacute; todos, 
                                      y qued&eacute; fascinado. Eye-Trek permite 
                                      ver v&iacute;deos y pel&iacute;culas para 
                                      televisi&oacute;n en un tama&ntilde;o increiblemente 
                                      grande, como si se estuviera viendo una 
                                      pantalla de 52&quot; desde una distancia 
                                      de dos metros. Conectaron el Eye-Trek a 
                                      una PlayStation2 y&#133;&iexcl;&iexcl;&iexcl; 
                                      POR DIOS !!! Todos deb&eacute;is visitar 
                                      su sitio y examinar estos artilugios. Ya 
                                      forman parte de mi lista de compras. </p>
                                    <p><br>
                                      <a href="http://www.pny.com"_blank" class="bold2" target="_blank">PNY 
                                      </a> <a href=http://www.nvidia.com/ target="_blank" class="bold2">y 
                                      NVIDIA </a></p>
                                    <p class="bold">En la computadora de mi trabajo, 
                                      uso una GeForce2. Ped&iacute; espec&iacute;ficamente 
                                      esta tarjeta de gr&aacute;ficos puesto que 
                                      deb&iacute;a ser capaz de jugar, ... ejem 
                                      ... quiero decir estudiar cualquiera de 
                                      nuestros juegos, en cualquier momento (no 
                                      voy a revelar qu&eacute; uso en la computadora 
                                      de mi casa). De m&aacute;s est&aacute; decir 
                                      que, puesto que no tengo la potencia gr&aacute;fica 
                                      en casa, no puedo jugar a muchos de los 
                                      pesados juegos actuales. Nancy Larson de 
                                      PNY Technologies, l&iacute;der mundial en 
                                      dise&ntilde;o, fabricaci&oacute;n y distribuci&oacute;n 
                                      de productos de expansi&oacute;n de memoria 
                                      para computadoras de escritorio, port&aacute;tiles, 
                                      servidores, estaciones de trabajo, impresoras, 
                                      c&aacute;maras digitales, ordenadores de 
                                      mano y otras aplicaciones de memoria personalizadas, 
                                      estaba siempre dipuesta a realizar demostraciones 
                                      de la GeForce3 de NVIDIA. Esta tarjeta &iexcl;ES 
                                      LO M&Aacute;XIMO! Y por lo que muchos de 
                                      los participantes de la Fan Faire estaban 
                                      diciendo, esta ser&aacute; la tarjeta de 
                                      gr&aacute;ficos preferida para la pr&oacute;xima 
                                      generaci&oacute;n de juegos online. </p>
                                    <p><br>
                                      <a href="http://gucomics.everlore.com/" target="_blank" class="bold2">/gu 
                                      Comics </a></p>
                                    <p class="bold">Woody Hearn de GUComics ten&iacute;a 
                                      una mesa para exhibir su trabajo. Cierto 
                                      que no lo escuch&eacute; personalmente, 
                                      pero algunas personas le preguntaban a Woody 
                                      su visi&oacute;n sobre el juego. Mmm, Woody 
                                      no trabaja para nosotros. Si as&iacute; 
                                      fuera, &iquest;cre&eacute;is que permitir&iacute;amos 
                                      que algunos de sus dibujos vieran la luz? 
                                      En la oficina, muchos de nosotros 'examinamos' 
                                      su revista cada vez que sale un nuevo n&uacute;mero. 
                                      Woody ha logrado captar ese algo tan especial 
                                      que nos recuerda cu&aacute;nto podemos reirnos 
                                      de nosotros mismos.</p>
                                    <p><br>
                                      <a href="http://www.wizards.com/" target="_blank" class="bold2">Wizards 
                                      of the Coast </a></p>
                                    <p class="bold">&iquest;Qui&eacute;n no los 
                                      conoce? Wizards of the Coast estaba presente 
                                      para actuar como anfitiri&oacute;n en los 
                                      juegos de Magic, the Gathering. Pas&eacute; 
                                      por sus habitaciones cuando se estaban jugando 
                                      algunas partidas y la concurrencia era numerosa. 
                                      Sin importar el lugar, todo el mundo disfruta 
                                      de un buen juego. Y por eso, a&uacute;n 
                                      se realizan torneos de Magic, the Gathering 
                                      en nuestra oficina. </p>
                                    <p><br>
                                      <a href="http://www.thestompinggrounds.com/" target="_blank" class="bold2">The 
                                      Stomping Ground</a></p>
                                    <p class="bold">Durante 96 horas seguidas, 
                                      The Stomping Ground se dedic&oacute; enteramente 
                                      a los jugadores de EverQuest. The Stomping 
                                      Grounds es un centro de juegos LAN (red 
                                      de &aacute;rea local) ubicado en el centro 
                                      de Minneapolis. Con m&aacute;s de 29 computadoras 
                                      y una conexi&oacute;n T1 punto a punto incre&iacute;blemente 
                                      r&aacute;pida, TSG es un destino obligado 
                                      para la comunidad de juegos online de Minneapolis. 
                                    </p>
                                    <p><br>
                                      <a href="http://www.bestbuy.com" target="_blank" class="bold2">Best 
                                      Buy </a></p>
                                    <p class="bold">Soy oriundo de Dayton Ohio, 
                                      y Best Buy es donde realic&eacute; la gran 
                                      mayor&iacute;a de mis compras. Fue genial 
                                      experimentar este 'regreso a casa' como 
                                      parte de la Fan Faire.</p>
                                    <p><br>
