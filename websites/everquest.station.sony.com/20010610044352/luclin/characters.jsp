...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">88684 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="1" background="images/sub_01_t.jpg"><img src="images/sub_char_01.jpg" width="260" height="59"></td>
  ...
  <tr>
    ...
    <td><img src="images/sub_char_02.jpg" width="260" height="29"></td>
  ...
  <tr>
    ...
    <td width="100%" valign="top" align="center"><br>
      <table width="75%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">EverQuest&reg;: The Shadows of Luclin&#153; will sport an enhanced 3D engine.  One of the benefits will be new, enhanced character models.  Sporting more detail and realism than previously possible with the constraints of the current engine, your favorite characters and personalities of Norrath will truly seem to take on new life.  Check back every now and then.  As we inch closer to the release of this new expansion, we'll have new character screenshots to share with you.</font></td>
        </tr>
      </table>
      <p>&nbsp;</p><table width="75%" border="0" cellspacing="0" cellpadding="8">
        <tr align="center">
          <td colspan="2">
            <div align="center"><font color="#FFFFFF"><b><font face="Verdana, Arial, Helvetica, sans-serif">Gnome</font></b></font></div>
          </td>
        </tr>
        <tr>
          <td width="50%">
            <div align="center"><a href="javascript:openWindow('screenshots/042301/04.html','480')"><img src="screenshots/042301/gn1_tn.jpg" width="200" height="150" border="0"></a></div>
          </td>
          <td width="50%" align="center"><a href="javascript:openWindow('screenshots/042301/09.html','480')"><img src="screenshots/042301/sngn02_tn.jpg" width="200" height="150" border="0"></a></td>
        </tr>
      </table>
    </td>
  </tr>
