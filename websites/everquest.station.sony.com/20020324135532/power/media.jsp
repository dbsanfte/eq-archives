...
<body onResize="gnav_init();" bgcolor="#000000" text="#FFFFFF" onLoad="MM_preloadImages('images/home_on.jpg','images/features_on.jpg','images/media_on.jpg','images/FAQ_on.jpg','images/planes_on.jpg','images/return_on.jpg')" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
...
<script language="JavaScript"> 
	...
	var adurl = "/common/global_nav/nav_ad.jsp?addhref=https%3A%2F%2Fad.doubleclick.net%2Fjump%2Fgames.everquest.spde.dart%2Fpower_bnr%3Bpwrhm%3Dpwrhm_1%21category%3Dpopup%3B%27+%2B+prof+%2B+%27sz%3D468x60%3Btile%3D1%3Bord%3D%27+%2B+ord+%2B+%27%3F&addiframe=https%3A%2F%2Fad.doubleclick.net%2Fadi%2Fgames.everquest.spde.dart%2Fpower_bnr%3Bpwrhm%3Dpwrhm_1%21category%3Dpopup%3B%27+%2B+prof+%2B+%27sz%3D468x60%3Btile%3D1%3Bord%3D%27+%2B+ord+%2B+%27%3F&addlayer=https%3A%2F%2Fad.doubleclick.net%2Fadl%2Fgames.everquest.spde.dart%2Fpower_bnr%3Bpwrhm%3Dpwrhm_1%21category%3Dpopup%3B%27+%2B+prof+%2B+%27sz%3D468x60%3Btile%3D1%3Bord%3D%27+%2B+ord+%2B+%27%3F&addimg=https%3A%2F%2Fad.doubleclick.net%2Fad%2Fgames.everquest.spde.dart%2Fpower_bnr%3Bpwrhm%3Dpwrhm_1%21category%3Dpopup%3B%27+%2B+prof+%2B+%27sz%3D468x60%3Btile%3D1%3Bord%3D%27+%2B+ord+%2B+%27%3F";
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/media.jsp?null');">
...
<table bgcolor="#000000" width="757" border="0" cellspacing="0" cellpadding="0" height="610" align="center">
  <tr> 
    <td colspan="4" height="85"><img src="images/spacer.gif" width="780" height="88"></td>
  </tr>
  <tr> 
    <td colspan="3" height="41"><!-- #BeginEditable "Bar" --><img src="images/rebar_media.jpg" width="650" height="40"><!-- #EndEditable --></td>
    <td rowspan="2" width="120" valign="top"><!-- #BeginLibraryItem "/Library/Ad.lbi" --><script language="JavaScript" type="text/javascript">
	<!--
	var axel = Math.random() + "";
	var ord = axel * 1000000000000000000;
	//-->
...
<script language="JavaScript" type="text/javascript">
  ...
  <tr> 
    ...
    <td height="30" width="193" valign="top" align="left"> 
      <table width="193" height="323" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
          ...
          <td height="22" align="left"><a href="index.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/home_on.jpg',1)"><img src="images/home.jpg" width="193" border="0" name="Image1"></a></td>
		</tr>
		<tr>
			
          <td height="30" align="left"><a href="features.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','images/features_on.jpg',1)"><img src="images/features.jpg" width="193" border="0" name="Image2"></a></td>
		</tr>
		<tr>
			
          <td height="17" align="left"><a href="media.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','images/media_on.jpg',1)"><img src="images/media.jpg" width="193" border="0" name="Image3"></a></td>
		</tr>
		<tr>
			
          <td height="19"><a href="FAQ.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','images/FAQ_on.jpg',1)"><img src="images/FAQ.jpg" width="193" border="0" name="Image4"></a></td>
		</tr>
		<tr>
			
          <td height="15" align="left"><a href="planes.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','images/planes_on.jpg',1)"><img src="images/planes.jpg" width="193" border="0" name="Image5"></a></td>
		</tr>
		<tr>
			
          <td height="107" align="left"><img src="images/tower.jpg" width="193"></td>
		</tr>
		<tr>
    ...
    <td height="30" width="467" valign="top"> <!-- #BeginEditable "Text" --> 
      <p class="link"><span class="link2"><br>
        Screenshots</span></p>
      <p class="link">Get a glimpse of what awaits in the Planes of Power.<br>
        <br>
        <a href="images/Fly_Man_InGame3.jpg"><img src="images/Fly_Man_InGame3_lo.jpg" width="200" height="150" border="0"></a> 
        <a href="images/trollproc.jpg"><img src="images/trollproc_thumb.jpg" width="200" height="150" border="0"></a></p>
      <p class="link"><span class="link2">Concept Art </span> </p>
      <p class="link">From the drawing board to the game, the evolution of Planes 
        of Power art.</p>
      <p class="link"><b>
        <center class="link">
          Evil Treant 
      ...
      <table border="0" align="center">
        <tr> 
          <td align="center" height="156"><a href="images/EvilTreant_Concept.jpg"><img src="images/EvilTreant_Concept_lo.jpg" width="125" height="156" border="0"></a></td>
          <td align="center" height="156"><a href="images/EvilTreant_Wireframe.jpg"><img src="images/EvilTreant_Wireframe_lo.jpg" width="200" height="156" border="0"></a></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td align="center"><a href="images/EvilTreant_Textured.jpg"><img src="images/EvilTreant_Textured_lo.jpg" width="200" height="156" border="0"></a></td>
          <td align="center"><a href="images/Treant_ingame.jpg"><img src="images/Treant_ingame_lo.jpg" width="200" height="150" border="0"></a></td>
        </tr>
        <tr> 
      ...
      <table border="0" align="center">
        <tr> 
          <td align="center"><a href="images/Nymph_Concept.jpg"><img src="images/Nymph_Concept_lo.jpg" width="122" height="156" border="0"></a></td>
          <td align="center"><a href="images/Nymph_Wireframe.jpg"><img src="images/Nymph_Wireframe_lo.jpg" width="200" height="156" border="0"></a></td>
        </tr>
        <tr> 
          <td valign="top" align="center" class="link">Concept Art</td>
          <td valign="top" align="center" class="link">Wireframe</td>
        ...
        <tr> 
          <td align="center"><a href="images/Nymph_Textured.jpg"><img src="images/Nymph_Textured_lo.jpg" width="200" height="156" border="0"></a></td>
          <td align="center"><a href="images/Nymph_InGame2.jpg"><img src="images/Nymph_InGame2_lo.jpg" border="0" width="208" height="156"></a></td>
        </tr>
        <tr> 
          <td valign="top" align="center" class="link">Textured</td>
          <td valign="top" align="center" class="link">In Game</td>
      ...
      <table border="0" align="center">
        <tr> 
          <td align="center"><a href="images/Fly_Man_Concept.jpg"><img src="images/Fly_Man_Concept_lo.jpg" width="120" height="156" border="0"></a></td>
          <td align="center"><a href="images/Fly_Man_Wireframe.jpg"><img src="images/Fly_Man_Wireframe_lo.jpg" width="200" height="156" border="0"></a></td>
        </tr>
        <tr> 
          <td valign="top" align="center" class="link">Concept Art</td>
          <td valign="top" align="center" class="link">Wireframe</td>
        ...
        <tr> 
          <td align="center"><a href="images/Fly_Man_Texture.jpg"><img src="images/Fly_Man_Texture_lo.jpg" width="200" height="156" border="0"></a></td>
          <td align="center"><a href="images/Fly_Man_InGame3.jpg"><img src="images/Fly_Man_InGame3_lo.jpg" width="200" height="150" border="0"></a></td>
        </tr>
        <tr> 
          <td valign="top" align="center" class="link">Textured</td>
          <td valign="top" align="center" class="link">In Game</td>
      ...
      <p class="link"><br>
        <span class="link2">Wallpaper</span></p>
      <p><span class="link">Paper your desktop with stunning artwork from The 
        Planes of Power.</span><br>
        <br>
      <center>
        <p><img src="images/Firelake_small.jpg" width="300" height="240"> </p>
      ...
      <br>
      <br>
      <!-- #EndEditable --><!-- #BeginLibraryItem "/Library/Legal.lbi" -->
<link rel="stylesheet" href="power.css" type="text/css">
<center>
  <a href="http://www.verant.com"><img src="images/sonylogo.gif" width="60" height="41" border="0"></a> 
</center>
      
<p align="center"><font color="#B64606" class="legal">E</font><font color="#B64606" class="legal">verQuest 
  is a registered trademark and The Planes of Power<br>
  is a trademark of Sony Computer Entertainment America Inc.<br>
  © 2002 Sony Computer Entertainment America Inc. All rights reserved. </font></p>
