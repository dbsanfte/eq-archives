...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>94785 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="center"><b>Thank you for attending 
                                      the Dallas Fan Faire. Please check back 
                                      here for future Fan Faire information.<br>
                                      <br>
                                      </b> </p>
                                    <!-- #EndEditable --></td>
                                </tr>
