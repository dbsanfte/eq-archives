...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_dallas.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="justify">
<p align="center"><b><font color="#000000"><span class="bold"><font size="3">Articles</font></span></font></b></p>
                                      <p align="justify"><a href="report_dallas.jsp" class="bold2">The 
                                        Mennix Report </a><span class="bold"> 
                                        - The Adam's Mark Hotel in beautiful downtown 
                                        Dallas welcomed hundreds of EQ players 
                                        for the fifth EverQuest Fan Faire conducted 
                                        on January 25-26, and Mennix was once 
                                        again on hand to provide his unique take 
                                        on the event.</span></p>
                                      <p><a href="winners_dallas.jsp" class="bold2">List 
                                        of Winners</a> <span class="bold">- Congratulations 
                                        to team Black Company of the Tarew Marr 
                                        server for winning the Real Life Quest 
                                        held at the Dallas Fan Faire. Each member 
                                        of the team will now be forever immortalized 
                                        in the world of Norrath as EQ NPCs tell 
                                        of their grand achievement. </span></p>
                                      <p><a href="poem_dallas.jsp" class="bold2">EQ 
                                        R Uber </a><span class="bold"> - Einaugenwilly 
                                        of the Iron Tower guild on Vallon Zek 
                                        graced the Dallas Fan Faire audience with 
                                        his poetry skills. With his permission, 
                                        we are proud to present to everyone, EQ 
                                        R Uber, an original work.</span> </p>
                                      <p><a href="guilds_dallas.jsp" class="bold2">Building 
                                        Better Guilds </a><span class="bold"> 
                                        - One of the workshops at the Dallas Fan 
                                        Faire was a discussion on how to build 
                                        a better guild conducted by Brian "Auric" 
                                        DeMarco. Brian provided guidelines on 
                                        what makes a guild successful and what 
                                        features players should look for when 
                                        contemplating joining one. </span></p>
                                      <p><a href="../media/Dallas%20Fan%20Faire.mov" class="bold2">The 
                                        Fan Faire Movie</a><span class="bold"> 
                                        - Get a feel for EverQuest Fan Faire with 
                                        this short movie we put together with 
                                        footage taken in Dallas. Special thanks 
                                        to Don &quot;GM Pelegorian&quot; Conley 
                                        and his wife Alexandra for providing the 
                                        video.</span><br>
                                      </p>
                                      <p align="center" ><b><font color="#000000" size="3"><a href="scrapbook_dallas_photos.jsp" target="_top" class="bold2"><font size="3">Photo 
