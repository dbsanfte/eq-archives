...
<style type="text/css">
<!--
#contentLayer		{position: absolute; visibility: hidden; z-index: 4; left:0;  top: 85; clip:rect( ); height: 1px; width: 1px}
#mainLayer			{position: absolute; visibility: hidden; z-index: 3; left:0;  top: 85; clip:rect( ); height: 890px; width: 780px}
#leftLayer			{position: absolute; visibility: hidden; z-index: 2; left:0;  top: 0; clip:rect( ); height: 1000px; width: 1px}
#rightLayer			{position: absolute; visibility: hidden; z-index: 1; left:0;  top: 0; clip:rect( ); height: 1000px; width: 1px}
#flashLayer			{position: absolute; visibility: hidden; z-index: 999999; left:0;  top: 85; clip:rect( ); height: 408px; width: 189px}
-->
</style>
<script>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/players.jsp?null');">
...
<img src="images/spacer.gif" width=1 height=955>
<div id="flashLayer">
<SCRIPT LANGUAGE=JavaScript>
<!--
var plugin = (navigator.mimeTypes && navigator.mimeTypes["application/x-shockwave-flash"]) ? navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin : 0;
...
<noscript>
 ...
 <div id="mainLayer"> 
  <table width="780" border="0" cellspacing="0" cellpadding="0" align="center" background="new_images/test_bg.gif" height="890">
    <tr>
      <td valign="top">
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="190" height="1" background="new_images/bg_top_left.jpg">
             <img src="new_images/spacer.gif" width=190 height=1>
            </td>
    	    <td width="0" background="new_images/test_bg.jpg" bgcolor="#081429" valign="top"><img src="new_images/bg_top_center1.jpg" width="296" height="59"></td>
	        <td width="0" background="new_images/test_bg.jpg" bgcolor="#081429" valign="top"><img src="new_images/bg_top_center2.jpg" width="172" height="59"></td>
            <td width="120" background="" align="right"><img src="new_images/bg_top_right.jpg" width="122" height="408"></td>
          </tr>
        </table>
                ...
                <tr> 
                  ...
                  <td colspan="3" align="center"> 
                    <table width="430" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="right" background="" width="320"> 
                          <p>&#147;OUR only problem is that we have two more budding 
                            EQ fans here and well we are runnin out of computers 
                            hehee...so now they get to learn the fun of sharing..hehe&#148;.</p>
                          <p>- Althrojr Lfye</p>
                        </td>
                        <td width="10" background=""><img src="new_images/spacer.gif" width="10" height="10"></td>
                        <td align="center" width="100" background=""><img src="new_images/char_01.gif" width="76" height="105"></td>
                      </tr>
                    </table>
                    ...
                    <table width="430" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="center" width="100" background=""><img src="new_images/char_02.gif" width="60" height="100"></td>
                        <td width="10" background=""><img src="new_images/spacer.gif" width="10" height="10"></td>
                        <td background="" width="320"> 
                          <p>&#147;It makes me quite happy to say that I am a 
                            member of the EverQuest community. Keep up the good 
                            work!&#148;</p>
                          <p>- Dan Slater</p>
                        </td>
                      </tr>
                    ...
                    <table width="430" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="right" background="" width="320"> 
                          <p>&#147;My granddaughter has had trouble with her spelling 
                            until EQ. It has improved over the year she has been 
                            playing. Did I mention she is only 9 yrs. old?&#148;.</p>
                          <p>- Pernia of the Titan Empire in Tarew Marr</p>
                        </td>
                        <td width="10" background=""><img src="new_images/spacer.gif" width="10" height="10"></td>
                        <td align="center" width="100" background=""><img src="new_images/char_03.gif" width="76" height="111"></td>
                      </tr>
                    </table>
                    <img src="new_images/spacer.gif" width="10" height="10"><br>
                    <img src="new_images/tribal_divider.gif" width="249" height="14"><br>
                    ...
                    <table width="430" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="center" width="100" background=""><img src="new_images/char_04.gif" width="92" height="110"></td>
                        <td width="10" background=""><img src="new_images/spacer.gif" width="10" height="10"></td>
                        <td background="" width="320"> 
                          <p>&quot;Not only was I a fan of the game, but I am 
                            now a fan of its developers, and Verant/Sony as well. 
                            Make more expansions....I'll buy them, make more games, 
                            I'll buy them too.&quot;</p>
...
<div id="leftLayer"> 
  <table width="1" height="100%" border="0" cellspacing="0" cellpadding="0" background="new_images/test_bg.gif">
      <tr> 
      <td valign="top"><img src="new_images/eq_left.jpg" width="112"></td>
    </tr>
  </table>
</div>
<div id="rightLayer"> 
  <table width="1" height="100%" border="0" cellspacing="0" cellpadding="0" background="new_images/test_bg.gif">
      <tr> 
      <td valign="top"><img src="new_images/eq_right.jpg" width="112"></td>
    </tr>
  </table>
</div>
</body>
