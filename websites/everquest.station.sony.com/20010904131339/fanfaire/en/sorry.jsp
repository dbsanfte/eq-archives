...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">49378 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                    ...
                    <tr>
                      <td>
                        <table width="151" border="0" cellspacing="0" cellpadding="0" background="">
                          ...
                          <tr>
                            <td><a href="http://everquest.station.sony.com/fanfaire/en/fanfaireAttendeeList.jsp?sku=EQALL-EV-EV0901-FANFRE-PARIS" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','../images/diamond_on.gif',1)"><img name="Image10" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Attendees</span></a></td>
                          </tr>
                          <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <font COLOR="#0851A0" size=6><b>Registration Closed</b></font>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                          ...
                          <tr> 
                            <td width="98%"  background="../images/translucent2.gif" valign=top height="291"> 
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --><span class="bold">Greetings- 
                                    </span> 
                                    <p class="bold">Sony Online Entertainment 
                                      and Ubi Soft today announced the postponement 
                                      of the European Fan Faire. Our European 
                                      community of EverQuest&reg; players has 
                                      seen much growth in the past year and we 
                                      are excited about all of our initiatives 
                                      in this market and beyond. While we regret 
                                      the delay in bringing what has been an incredibly 
                                      successful and one-of-kind event in the 
                                      U.S., we know that all of our international 
                                      initiatives will enhance the player experience, 
                                      increase our international fan base, and 
                                      lead us overseas in the coming months. </p>
                                    <p class="bold">We want to thank all of the 
                                      fans who had planned to participate in this 
                                      inaugural event and will be sending a full 
                                      refund in addition to a special gift from 
                                      our Fan Faire team. While we are disappointed 
                                      that we cannot meet you next month, we hope 
                                      that our presence in Europe continues to 
                                      grow. We will be able to better serve you 
                                      by postponing this event to a more suitable 
                                      time and place for everyone. We apologize 
                                      for any inconvenience.</p>
                                    <p class="bold">EverQuest boasts more than 
                                      410,000 players on a worldwide basis including 
                                      the U.S., England, France, Italy, Germany, 
                                      Canada, Singapore, Zimbabwe, Saudi Arabia, 
                                      and New Zealand. We recently announced the 
                                      availability of Game Cards on retail shelves 
                                      worldwide, giving cash holders the ability 
                                      to play in 90-day increments. And, the initial 
                                      phase of localization involving both human 
                                      and automated translating agents, beginning 
                                      with French, German, Japanese and Korean, 
                                      is well underway. Sony Online Entertainment 
                                      is continuing to build a bridge between 
                                      nations and is actively working toward new 
                                      server deployment plans with Europe as a 
                                      primary target. </p>
                                    <p class="bold">This winter, all EverQuest 
                                      players can look forward to the launch of 
                                      EverQuest: The Shadows of Luclin&#153;. 
                                      The new expansion pack will introduce an 
                                      enchanting moonscape packed with new adventure 
                                      zones, new items, creatures and spells, 
                                      a new playable character race and more. 
                                    </p>
                                    <p class="bold">Thank you for your continued 
                                      support!</p>
                                    <p class="bold">Cindy Archuleta<br>
