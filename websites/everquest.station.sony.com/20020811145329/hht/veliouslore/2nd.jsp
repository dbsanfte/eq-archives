        ...
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" --> 
            <center>
              ...
              The Exploration Continues </span> 
              <p>&nbsp;</p>
              <p align="left" class="subHeader">Day 2
              <P align="left"><a href="javascript:openWindow('screenshots/12.html', '600')"><img src="images/image12_lo.jpg" width="234" height="280" align="left" hspace="8" border="0"></a>The 
                adventuring party has been moving on, and has discovered an even 
                larger island, the third Icy Finger. This one is the largest and 
                is covered with enigmatic stone monoliths in the shape of dragon 
                heads. Our intrepid explorers were not quite sure what to make 
                of these figures, nor of the mysterious markings on their bases. 
                It seems to be an ancient ideographic language of some sort, though 
                no one knows for sure.<br clear=all>
                <a href="javascript:openWindow('screenshots/5.html', '775')"><img src="images/image5_lo.jpg" width="280" height="192" align="right" hspace="8" border="0"></a> 
              </p>
              <P align="left">Here, they found a bridge known as the <I>Gretespaign 
                </I>or Great Span<I>, a</I> gigantic bridge crafted of what seems 
                to be a magical form of ice. It arches up and away from the dragon’s 
                head and disappears into the mists. It’s massive size can be seen 
                in the accompanying picture, where it is barely possible to make 
                out the guardians at the foot of the bridge’s opening arch.<br clear=all>
              </p>
              <P align="left">In crossing this huge bridge which, curiously, resembles 
                nothing so much as it does the rib cage of a giant dragon, the 
                explorers found themselves on a great landmass. From their mages’ 
                aerial reconnaisance, it appears to be the tip of a new continent!<br clear=all>
              </p>
              <P align="left">The forlorn frigid landscape prompted the discoverers 
                to dub this landmass the &quot;Eastern Wastes.&quot; Trees and 
                other vegetation were in short supply when our adventurers arrived.<br clear=all>
              </p>
              <P align="left"><a href="javascript:openWindow('screenshots/11.html', '575')"><img src="images/image11_lo.jpg" width="280" height="174" align="left" hspace="8" border="0"></a>A 
                strange dune of ice and snow in the form of a giant, sleeping 
                dragon was discovered within the Eastern Wastes. Some of the more 
                superstitious among the gnomish explorers fear that this shape 
                is a warning of the existence of a fearsome draconic beast nearby.<br clear=all>
                <a href="javascript:openWindow('screenshots/4.html', '600')"><img src="images/image4_lo.jpg" width="226" height="280" align="right" hspace="8" border="0"> 
                </a> </p>
              <P align="left">A previously unknown race of giants has been discovered 
                on Velious. They have been dubbed &quot;frost giants&quot; due 
                to their habitats and appearance. As you can see from the picture 
                sent back, they do not resemble the more familiar northern giant 
                races. The earliest explorers report that these lumbering beasts 
                refer to themselves as &quot;Kromrif.&quot; The explorers report 
                that the first frost giants they encountered were strangely calm 
                in their presence. Until they were attacked, at least. The reports 
                differ widely regarding the affiliations of these curious beings.<br clear=all>
              </p>
              <P align="left"><a href="javascript:openWindow('screenshots/3.html', '775')"><img src="images/image3_lo.jpg" width="280" height="210" align="left" hspace="8" border="0"></a>These 
                Kromrif beings have constructed some of the most sturdy and formidable 
                fortifications known to exist. One of our more courageous, or 
                perhaps foolhardy adventurers ventured close enough to be able 
                to gather the likeness provided of one such structure. As can 
                be seen easily, this fort was designed with ease of defense in 
                mind.<br clear=all>
              </p>
              <P align="left">Other structures have also been noted by our friends 
                on Velious as well. A new clan of snow orcs was discovered in 
                this next building, which the explorers have determined is known 
                to the orcs as Ry`Gorr Keep. An enormous bonfire burns continoously 
                in its center which serves to ward off the extreme cold of the 
                ice continent’s weather.<br clear=all>
                <a href="javascript:openWindow('screenshots/6.html', '775')"><img src="images/image6_lo.jpg" width="280" height="210" align="right" hspace="8" border="0"></a> 
              </p>
              <P align="left">&nbsp;</P>
              <P align="center"><br>
              </P>
              <P align="center">&nbsp;</P>
              <P align="center"> <a href="1st.jsp"><br>
                Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="3rd.jsp">Next</a></P>
              </center>
            <!-- #EndEditable --></td>
        </tr>
      </table>
