...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/faq_de.jsp?null');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="left"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      ...
                                      <p class="bold"><span class="bold3">Was 
                                        passiert, wenn ich meine Anmeldung rückgängig 
                                        machen muss? Bekomme ich die Kosten rückerstattet?</span><br>
                                        Um Ihre Anmeldung rückgängig zu machen, 
                                        senden Sie bitte eine E-Mail an <a href="mailto:carchuleta@soe.sony.com" class="bold3">carchuleta@soe.sony.com</a>. 
                                        Bitte geben Sie dabei Ihren Station-Namen 
                                        an. Rückerstattungen können nur innerhalb 
                                        der Anmeldefrist gewährt werden.</p>
