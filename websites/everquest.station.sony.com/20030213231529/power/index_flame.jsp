...
<body bgcolor="#000000" text="#B64606"  onresize="resize();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/eqreturn_on.jpg')">
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/index_flame.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/index_flame.jsp');">
...

{
	...
	document.write('<img src="images/spacer.gif" border="0" height="13" width=1><br>');
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td> 
              <div id="stretch" style="width:640px; height:365;"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="780" height="438">
                  <param name=movie value="./images/pop.swf">
                  <param name=quality value=high>
                  <param name=menu value=false>
                  <embed src="./images/pop.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="780" height="438" menu="false">
                  </embed> 
                </object> </div>
            </td>
          </tr>
    ...
    <tr> 
      ...
      <td colspan="2"  height="368" width=780 valign="top"> 
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="640" height="305" align="center">
          <tr valign="top"> 

            <td colspan="2" align="center" height="117"> <img src="images/caption_fire.gif" width="178" height="20" align="top"> 

              <a href="http://everquest.station.sony.com" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/eqreturn_on.jpg',1)"><img src="images/eqreturn.jpg" width="640" height="90" border="0" name="Image1"></a></td>
          ...
          <tr valign="top"> 
            ...
            <td width="196" align="center" height="169"><img src="images/POPcover_sm.jpg" width="100" height="115"><br>
              ...
              <a href="http://www.keithparkinson.com" class="link">Box Art by Keith Parkinson</a></td>
