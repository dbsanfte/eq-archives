...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">44,338 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/legacy/lore.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/legacy/lore.jsp');">
...
<tr>
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td width="607" background="images/parch_tile.jpg" bgcolor="#928E73"><br> 
              <div style="padding-right: 10px;"> 
                <table width="419" border="0" cellspacing="0" cellpadding="0" align="center">
				<!--
                  <tr> 
                    <td><img src="images/lore_button-prophecy.gif" width="43" height="47" alt="" border="0"></td>
                    <td><img src="images/lore_button-blank.gif" width="43" height="47" alt="" border="0"></td>
                    <td><img src="images/lore_button-blank.gif" width="43" height="47" alt="" border="0"></td>
                    <td><img src="images/lore_button-blank.gif" width="43" height="47" alt="" border="0"></td>
                    <td><img src="images/lore_button-blank.gif" width="43" height="47" alt="" border="0"></td>
                    <td><img src="images/lore_button-blank.gif" width="43" height="47" alt="" border="0"></td>
				  ...
				  -->
                  <tr> 
                    <td colspan="9"><img src="images/spacer.gif" width="4" height="10" alt="" border="0"></td>
                  </tr>
                  <tr> 
                    <td colspan="9"><img src="images/lore_prophecy-teaser.jpg" width="415" height="169" alt="" border="0"></td>
                  </tr>
                </table>
    ...
    <tr backgorund="">
      <td valign="top" backgorund="">&nbsp;</td>
      <td valign="top" backgorund="">
