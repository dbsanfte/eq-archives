...
<table width="780" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr height="1"> 
    <td>
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/buy/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/gatesofdiscord/buy/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><table width="478" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><img src="images/top_left.jpg" width="478" height="65"></td>
              </tr>
              <tr> 
                <td valign="top"><img src="images/god_logo.jpg" width="478" height="177" border="0" usemap="#god" href="#"></td>
              </tr>
              <tr> 
                <td valign="top" class="buycontentbackground"> <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr> 
                      <td height="84">No waiting in lines! Forget traffic jams! 
                        Order the digital download version of EverQuest: Gates 
                        of Discord from the Station Store and  
                        experience the chaos and devastation of 
                        the once peaceful continent of Taelosia.</td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                <td><img src="images/station_store.gif" width="478" height="43" border="0" usemap="#Store"></td>
              </tr>
              <tr> 
                <td valign="top"> <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr> 
                      <td>Or, purchase the boxed version of EverQuest: 
                        Gates of Discord from one of our retail partners and get 
                        a special in-box and in-game item. The limited edition 
                        Taelosian Staff is a great keepsake, sure to be the envy 
                        of every Norrathian - and it will only be available in 
                        boxed versions of the expansion while supplies last.</td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                <td valign="top"><img src="images/retailers.gif" width="478" height="60" border="0" usemap="#Retail"></td>
              </tr>
              <tr> 
                <td valign="top"> <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr> 
                      <td><p>Regardless of your choice, digital download or boxed 
                          version, EverQuest: Gates of Discord will expand your<br>
                          adventures to new horizons.</p>
                        <p> For more information about EverQuest: Gates of Discord, 
                          including the list of features and screenshots, check 
                          out the <a href="http://everquest.station.sony.com/gatesofdiscord/" target="_blank"><strong>official 
                          website</strong></a>.</p>
                        <p> Thank You,<br>
                          Sony Online Entertainment</p>
                        <p align="center"><a href="../offers.jsp" target="_blank"><strong>For 
                          additional exclusive offers, click here!</strong></a></p></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td valign="top"><img src="images/god_box.jpg" width="302" height="326" border="0" usemap="#Store2"></td>
              </tr>
              <tr> 
                <td><table width="100%" border="0" cellspacing="10" cellpadding="0">
                    <tr> 
                      <td><div align="center"><a href="http://everquest.station.sony.com/gatesofdiscord/screenshots.jsp" target="_blank"><img src="images/screen1.jpg" width="124" height="100" border="0"></a></div></td>
                      <td><div align="center"><a href="http://everquest.station.sony.com/gatesofdiscord/screenshots.jsp" target="_blank"><img src="images/screen2.jpg" width="124" height="100" border="0"></a></div></td>
                    </tr>
                    <tr> 
                      <td><div align="center"><a href="http://everquest.station.sony.com/gatesofdiscord/screenshots.jsp" target="_blank"><img src="images/screen3.jpg" width="124" height="100" border="0"></a></div></td>
                      <td><div align="center"><a href="http://everquest.station.sony.com/gatesofdiscord/screenshots.jsp" target="_blank"><img src="images/screen4.jpg" width="124" height="100" border="0"></a></div></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                <td><table width="100%" border="0" cellpadding="0" cellspacing="2">
                    <tr> 
                      <td width="7%"><img src="images/button.jpg" width="18" height="18"></td>
                      <td width="93%" class="features">100 new Alternate Advancement 
                        abilities</td>
                    </tr>
                    <tr> 
                      <td><img src="images/button.jpg" width="18" height="18"></td>
                      <td class="features">Gain leadership experience</td>
                    </tr>
                    <tr> 
                      <td><img src="images/button.jpg" width="18" height="18"></td>
                      <td class="features">20 new zones</td>
                    </tr>
                    <tr> 
                      <td><img src="images/button.jpg" width="18" height="18"></td>
                      <td class="features">New Berserker class</td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
                      <td><a href="http://everquest.station.sony.com/gatesofdiscord/features.jsp" target="_blank"><strong>More 
...
<div align="center"><a href="http://www.station.sony.com/en/services/help/customer.jsp" class="ToS">Contact The Webmaster</a> 
  ...
  <a href="http://sonyonline.com/tos/tos.jsp" target="_tosWin" onclick="return openToS('http://sonyonline.com/tos/tos.jsp');" class="ToS">Sony Online Terms Of Service</a>
      ...
      <p class="legal">&copy; 2004 Sony Computer Entertainment America Inc. EverQuest 
        is a registered trademark and Gates of Discord is a trademark of Sony 
        Computer Entertainment America Inc. SOE, the SOE logo and Station.com 
        are registered trademarks or trademarks of Sony Online Entertainment Inc. 
        All Rights Reserved. All other trademarks are properties of their respective 
        owners.</p></td>
  </tr>
</table>
...
<map name="Retail">
  <area shape="rect" coords="35,8,228,49" href="http://www.ebgames.com/ebx/product/240960.asp" target="_blank">
  <area shape="rect" coords="245,6,438,53" href="http://www.gamestop.com/product.asp?product_id=645627" target="_blank">
</map>
<map name="Store" id="Store">
  <area shape="rect" coords="134,2,330,43" href="/gatesofdiscord/order.jsp">
</map>
<map name="Store2" id="Store2">
  <area shape="rect" coords="10,17,171,260" href="/gatesofdiscord/order.jsp">
  <area shape="rect" coords="84,113,91,116" href="#">
</map>
<map name="god" id="god">
  <area shape="rect" coords="65,22,401,154" href="http://everquest.station.sony.com/gatesofdiscord/">
  <area shape="rect" coords="277,87,279,109" href="#">
</map>
<map name="Map">
  <area coords="223,132,389,171" href="http://www.creative.com" target="_blank">
  <area coords="439,128,606,175" href="http://www.shop.kingston.com/specials/default.asp?bannersource=station" target="_blank">
  <area alt="" coords="130,107,216,188" href="http://www.soundblaster.com/" target="_blank">
</map>
</body>
</html>
