...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>56850 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" --> 
            <center>
              <br>
              <span class="bold">Orlando, Florida, will be the site of the next 
              EverQuest<sup>®</sup> Fan Faire! Join us on October 19-20 at <a href="http://www.omnirosen.com" target="_blank" class="bold2">The 
              Rosen Centre</a>, located minutes from Disney World and many other 
              great area attractions! With our special rates for this event, this 
              could be the perfect time to bring the whole family for some great 
              fun! </span> 
            </center>
            <p class="bold" align="center">Registration closes October 7, 2001 
              at midnight Pacific Time<br>
              Cost is $85</p>
            <p class="bold" align="center"><img src="../images/Disney%20logo.jpg" width="200" height="102"></p>
            <p class="bold" align="center">If you are attending the Orlando Fan 
              Faire, you are eligible to purchase<br>
              special discount tickets for Disney World! <br>
              <br>
              They have generously offered discount tickets for Fan Faire attendees! 
              For<br>
              pricing information and to order tickets, visit<br>
              <a href="https://secure.hes-services.com/wdwticket/everquest.asp" target="_blank" class="bold2">https://secure.hes-services.com/wdwticket/everquest.asp</a></p>
            <div align="center"></div>
            <!-- #EndEditable --></td>
        </tr>
      </table>
