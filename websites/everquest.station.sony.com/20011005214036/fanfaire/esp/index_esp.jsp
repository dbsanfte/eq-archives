...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>73603 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
        ...
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" --><br>
            ...
            <div align="center"> 
              ...
              <div align="center"> 
                <p class="bold">&iexcl;Orlando, Florida, ser&aacute; la sede de 
                  la pr&oacute;xima Fan Faire de EverQuest<sup>®</sup>! &iexcl;&Uacute;nete 
                  a nosotros el 19 y el 20 de octubre en <a href="http://www.omnirosen.com" target="_blank" class="bold2">The 
                  Rosen Centre</a>, situado a pocos minutos de Disney World y 
                  muchas otras fant&aacute;sticas atracciones en el &aacute;rea! 
                  Con nuestros precios especiales para este encuentro, &iexcl;&eacute;ste 
                  podr&iacute;a ser el momento perfecto para traer a toda la familia 
                  y divertirse much&iacute;simo!</p>
                <p class="bold">Las inscripciones cierran el 7 de octubre de 2001 
                  a la medianoche, Hora del Pac&iacute;fico. El costo es $85.</p>
                <p class="bold"><img src="../images/Disney%20logo.jpg" width="200" height="102"></p>
              </div>
              <p class="bold">Si vas a asistir a la Fan Faire de Orlando, puedes 
                comprar entradas para Disney World con un descuento especial! 
              </p>
              <p class="bold">&iexcl;Han ofrecido generosamente entradas con descuentos 
                especiales para los asistentes a la Fan Faire! Para informaci&oacute;n 
                sobre precios y comprar entradas, visita <a href="https://secure.hes-services.com/wdwticket/everquest.asp" onMouseOut="nd()" onMouseOver="return overlib('Esto te devolverá auna página en ingles.')" target="_blank" class="bold2">https://secure.hes-services.com/wdwticket/everquest.asp</a>.</p>
              <p class="bold"><br>
              </p>
