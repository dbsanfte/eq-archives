...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">34066 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" -->
            ...
            <p align="center">
            <P align="center" class="header"><font size="3" face="Arial, Helvetica, Geneva"><b><font size="4">Sullon Zek Point System</font></b></font></P>
            <P align="left">&nbsp;</P>
            <P align="left"><b>Deity Alliance Score System </b></P>
            <ul>
              <li> A base number of 100 points are awarded for a PvP kill when the victim is over level 20. Then 2 points are added per level difference of the killer and the victim. Example: If the killer was level 30 and the victim was level 35, the killer would receive 100 pts + (35 - 30) X 2 for 110pts total. If it was the other way around, the score would be 100pts + (30 - 35) X 2 for 90pts.<br>
                <br>
              </li>
              <li> There is a soft time limit of 1 hour for PvP kills. This means that killing the same person within the time limit will have diminished returns.<br>
                <br>
              </li>
              <li> Killing the same person again within the time limit will reward only 50pts. 25 points for the 3rd kill. Zero points for the 4th kill. And finally -25pts for each additional kill after 4 for the time limit.<br>
                <br>
              </li>
              <li> Being killed in PvP combat in the + or - 5 level range will result in a loss of 25 points. </li>
            </ul>
            <p><br>
              <b>Deity Insignia&#146;s </b></p>
            <ul>
              <li> Insignia&#146;s come in 4 flavors. Minor, Normal, Greater, and Superior. Only the first 3 can be obtained by looting. Ten lesser insignia&#146;s can be combined in a forge to produce a normal insignia. Ten normal insignia&#146;s can be combined to produce a greater insignia. You then may combine the 10 greater insignia&#146;s to produce a superior deity token.<br>
                <br>
              </li>
              <li> The insignias themselves each have a point value. 1 pt for lesser, 5 pts for normal, 10 pts for greater, and finally 25 pts for a superior.<br>
                <br>
              </li>
              <li> The superior tokens can be turned in for ingame rewards. This will be done either by quests or through a GM event. </li>
            </ul>
            <p><b><br>
              FAQ: </b></p>
            <p><b>[PvP&#146;er01 says]</b>, &#147;Say I&#146;m level 40 and this guys that&#146;s level 20 has just annoyed me to the point where I kill him a few extra times. Say 3 times within your soft time limit of one hour. How many points would I get for those 3 kills?&#148; </p>
            <p><b>[Answer]</b>: For the first kill you would get 60pts. For the second kill you would get 10pts, and for the 3rd kill you would get -15pts. For a total of 55 pts. The next time, which would be the 4th kill, you would get -40pts. For each additional time that you killed that player, you would get -65pts for each kill. Assuming all these kills were within 1 hour. </p>
            <p><b>[PvP&#146;er01 says]</b>, &#147;How come I lose points when I combine my insignias the forge?&#148; <br>
              </p>
            <p><b>[Answer]</b>: This is the reason for the point loss. I consider it more of a sacrifice. When we do implement rewards for insignias, the turn in insignia will be one of the higher rank insignias. You must either choose to turn them in for rewards and lose points, or keep the insignias and not get the reward. </p>
            <p><b>[PvP&#146;er01 says]</b>, &#147;Say I quit playing for a while and I have my name on the leader boards for PvP kills. How long will I stay up there?&#148; </p>
            <p><b>[Answer]</b>: You have approx. 30days and then you will be dropped from the boards and your points removed. Basically, if your character remains inactive for 30 days, it&#146;s as if you never played on the server.</p>
            <!-- #EndEditable --></td>
        </tr>
      </table>
    </td>
