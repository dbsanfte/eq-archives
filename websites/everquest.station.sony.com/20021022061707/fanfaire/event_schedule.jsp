...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">62,091 Players Online</div>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" -->
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr>
                <td>
                  <table border=1 cellspacing=0 cellpadding=5 class="textsmall" bordercolor="#0075BB" width="100%">
                    <tr> 
                      <td colspan=4 valign=top class="boldcolor"> 
                        <p><b>FRIDAY, NOVEMBER 8<sup>TH</sup></b></p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="boldcolor"> 
                        <p><b>TIME</b></p>
                      </td>
                      <td width=98 valign=top class="boldcolor"> 
                        <p><b>EVENT</b></p>
                      </td>
                      <td width=142 valign=top class="boldcolor"> 
                        <p><b>DETAILS</b></p>
                      </td>
                      <td width=153 valign=top class="boldcolor"> 
                        <p><b>LOCATION</b></p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="textsmall"> 
                        <p>10:00A – 6:00P</p>
                      </td>
                      <td width=98 valign=top class="textsmall"> 
                        <p>Registration</p>
                      </td>
                      <td width=142 valign=top class="textsmall"> 
                        <p>Attendees can begin checking  in</p>
                      </td>
                      <td width=153 valign=top class="textsmall"> 
                        <p> <a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 
                          2<sup>nd</sup> Floor, SoMa Room</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="textsmall"> 
                      ...
                      <td width=98 valign=top class="textsmall"> 
                        <p>SOE Phat Lewt Store</p>
                      </td>
                      <td width=142 valign=top class="textsmall"> 
                        <p>Don’t miss out on the show specials and new items and 
                          gear</p>
                      </td>
                      <td width=153 valign=top class="textsmall"> 
                        <p><a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 2<sup>nd</sup> Floor, SoMa Room</p>
                        <p>(at the Marriott after 7:30PM)</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="textsmall"> 
                      ...
                      <td width=98 valign=top class="textsmall"> 
                        <p>The Bazaar Opens</p>
                      </td>
                      <td width=142 valign=top class="textsmall"> 
                        <p>The Bazaar with multiple vendors, phat lewt store, 
                          and much more.</p>
                      </td>
                      <td width=153 valign=top class="textsmall"> 
                        <p>Marriott, Ballroom B1</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="textsmall"> 
                      ...
                      <td width=98 valign=top class="textsmall"> 
                        <p>Intel Arm Yourself for Adventure PC room</p>
                      </td>
                      <td width=142 valign=top class="textsmall"> 
                        <p>20 PCs available to play EQ –</p>
                        <p>MUST sign up for a time slot in the game room.</p>
                      </td>
                      <td width=153 valign=top class="textsmall"> 
                        <p><a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 2<sup>nd</sup> Floor, Digital Solutions/TEC 
                          Room</p>
                      </td>
                    </tr>
                    <tr> 
                      ...
                      <td width=142 valign=top class="textsmall"> 
                        <p>A time for meeting and greeting your fellow Norrathians</p>
                      </td>
                      <td width=153 valign=top class="textsmall"> 
                        <p>Marriott, Salon 9</p>
                      </td>
                    </tr>
                    <tr> 
                      <td colspan=4 valign=top class="boldcolor"> 
                        <p><b>SATURDAY, NOVEMBER 9<sup>TH</sup> </b></p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="boldcolor"> 
                    ...
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
                        <p>9:00A – 1:00P</p>
                      </td>
                      <td width=98 valign=top class="Normal"> 
                        <p>Registration    </p>
                      </td>
                    ...
                    <tr> 
                      ...
                      <td width=153 valign=top class="Normal"> 
                        <p><a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 2<sup>nd</sup> Floor, SoMa Room</p>
                        <p>(at the Marriott after 2:30PM)</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
                    ...
                    <tr> 
                      ...
                      <td width=98 valign=top class="Normal"> 
                        <p>The Future of MMOGs</p>
                      </td>
                      <td width=142 valign=top class="Normal"> 
                        <p>Exclusive Screening featuring a behind the scenes look 
                          at upcoming games from SOE (30 mins. runtime)</p>
                      </td>
                      <td width=153 valign=top class="Normal"> 
                        <p><a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 2<sup>nd</sup> Floor, Action Theater</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
                      ...
                      <td width=153 valign=top class="Normal"> 
                        <p><a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 4<sup>th</sup> Floor, Terrace </p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
                      ...
                      <td width=142 valign=top class="Normal"> 
                        <p>Scavenger hunt for prizes</p>
                      </td>
                      <td width=153 valign=top class="Normal"> 
                        <p>Kick off at the <a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 4<sup>th</sup> Floor, Terrace</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
                      ...
                      <td width=142 valign=top class="Normal"> 
                        <p>Panels stating every hour on the hour (45 mins. long). 
                          Topics Include:</p>
                        <p>Producers &amp; Developers</p>
                        <p>Lore &amp; Tradeskills </p>
                        <p>Zones &amp; New Content </p>
                        <p>Customer Service</p>
                        <p>Q&amp;A with the Producers of EQOA &amp; PlanetSide</p>
                      </td>
                      <td width=153 valign=top class="Normal"> 
                        <p>Marriott, Yerba Buena Grand Assembly, Various Salons</p>
                        <p><i>(see registration packet for exact location)</i></p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
                      ...
                      <td width=142 valign=top class="Normal"> 
                        ...
                        <p>Silent Auction Results</p>
                      </td>
                      <td width=153 valign=top class="Normal"> 
                        <p>Marriott, Salon 8 and 9</p>
                      </td>
                    </tr>
                    <tr> 
                      <td colspan=4 valign=top class="boldcolor"> 
                        <p><b class="boldcolor">SUNDAY, NOVEMBER 10<sup>TH</sup> 
                          </b></p>
                      </td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      ...
                      <td width=153 valign=top class="Normal"> 
                        <p><a href="images/EQ_events_Metreon_Directory.jpg" class="linkssmall" target="blank">Metreon</a>, 
                          2<sup>nd</sup> Floor, Digital Solutions/TEC Room</p>
                      </td>
                    </tr>
                    <tr> 
                      <td width=97 valign=top class="Normal"> 
