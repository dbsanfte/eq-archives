...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/hotel_de.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="center"> 
                                      <P class="bold">Besuchen Sie uns beim FanFest 
                                        in Seattle! </P>
                                      ...
                                      <P class="bold">Seattle, WA 98188<BR>
                                        Tel: (001)-206-246-8600 </P>
                                      <P class="bold">Das Hotel bietet uns einen 
                                        &Uuml;bernachtungspreis von 99,00 U.S.$ 
                                        pro Nacht. Bitte vergessen Sie nicht zu 
                                        vermerken, dass Sie am EverQuest FanFest 
                                        teilnehmen. Unser Buchungscode lautet 
                                        SOE. Das Hotel befindet sich in der N&auml;he 
                                        des Flughafens und bietet einen kostenlosen 
                                        Shuttleservice.</P>
                                      <P class="bold">Bitte reservieren Sie rechtzeitig, 
                                        bevor alle Zimmer belegt sind!</P>
                                    </div>
                                    <p align="center">&nbsp;</p>
