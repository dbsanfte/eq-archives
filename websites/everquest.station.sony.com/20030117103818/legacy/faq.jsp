          ...
          <tr> 
            ...
            <td width="607" background="images/parch_tile.jpg" bgcolor="#928E73"><br> 
              <div style="padding-right: 10px;"> 
                ...
                <p>The pre-order cost will be $17.99. On the live date and thereafter, 
                  the price will increase to $21.99 (price subject to change). 
                  This is a one-time charge and does not affect your subscription 
                  plan. </p>
                <br>
                <p><strong>2) Can I download files early?</strong></p>
                <p>By selecting 'yes' to the &quot;Predownload Ykesha&quot; option 
                  on the patcher or, in the advanced options, clicking the box 
                  next to &quot;Legacy of Ykesha (predownload)&quot;, you can 
                  begin downloading the files early to reduce your download on 
                  release day. </p>
                <br>
                <p><strong>3) How do I pay for this extension?</strong></p>
                <p>The easiest way to purchase the extension is to pre-order it. 
                  Starting on the January 15, 2003, you will be able to pre-order 
                  the extension just by clicking the button that will appear during 
                  login. Ordering from the EverQuest login will bill the charge 
                  directly to the credit card on account for your EverQuest subscription 
                  (though the card will not be billed until the day the extension 
                  goes live).</p>
                <p>If you do not wish to charge the extension to the same credit 
                  card that you have on record for your EverQuest account, or 
                  if you use Game Cards and do not have a credit card on account, 
                  you can pre-order the extension at our <a href="https://store.station.sony.com">online 
                  store</a>. Again, your credit card will not be charged until 
                  the day the extension goes live.</p>
                <p>Once The Legacy of Ykesha goes live you will only be able to 
                  purchase it from the <a href="https://store.station.sony.com">online 
                  store</a>, and the pre-order discount will no longer be available. 
                  Once you purchase the extension, and once The Legacy of Ykesha 
                  goes live, you will be able to download it immediately and begin 
                  your adventure.</p>
                <br>
                <p><strong>4) What if I want to cancel my pre-order?</strong></p>
                <p>You can cancel your pre-order up until 12:01 a.m. on the live 
                  date. Thereafter, all sales are final. To do so, just log in 
                  at our <a href="https://store.station.sony.com">online store</a> 
                  and visit the My Account link. You will be able to cancel your 
                  pre-order from there. Just follow these steps:</p>
                ...
                <p>This extension will only be available as a product download. 
                  There will be no box to buy in the stores, so all of the data 
                  needs to be downloaded from our servers. You will be able to 
                  incrementally download the files for the extension before the 
                  release date. We will make these files available for download 
                  during the EverQuest login procedure. Downloading the files 
                  gradually prior to the launch of the extension will minimize 
                  the size of your patch on launch day.</p>
                <p>If you purchase the extension after launch day, you will need 
                  to download all of the extension files (we estimate it will 
                  be about 120 megabytes). Purchasing the extension after launch 
                  will cause your account to be flagged and you will be able to 
                  download The Legacy of Ykesha extension files immediately.</p>
                <br>
                <p><strong>6) I have a dialup connection; any hints on patching?</strong></p>
                <p>If you do not have a broadband connection, your downloads will 
                  be slow. What you might do is try to manage the process by patching 
                  the new files while you work or sleep. To do that, in the patcher 
                  Advanced Options, keep the Legacy of Ykesha box unchecked (so 
                  that you aren't checking for and patching any available extension 
                  files before every play session). When you are done for the 
                  evening (or perhaps in the morning), open the patcher, check 
                  the Legacy of Ykesha box, and then rerun the patcher. That way, 
                  you don't have to sit idly at your machine and wait for it to 
                  patch for hours.</p>
                <p>Please be advised that we expect the final patch (on the live 
                  date) to exceed 50 megabytes and, depending on your connection 
                  speed, may take you several hours to download.</p>
              </div></td>
