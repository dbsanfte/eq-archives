	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/wedding_orlando.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/wedding_orlando.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/wedding_orlando.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <div align="center"><span class="textBold">Krissy and David 
                    Sitting in a Tree... </span> 
                    <p class="bold" align="left"><span class="text"><img src="images/wedding_orlando.jpg" width="158" height="118" border="0" align="left" alt="Krissy and David cutting their wedding cake.">It's 
                      very fortunate for David that Krissy was used to him spending 
                      time in front of a computer playing online games like Quake, 
                      Diablo, and so on. She agreed to marry him after all. She 
                      herself was hooked on Final Fantasy VIII. Then, EverQuest 
                      came out and they both found a game they could play together. 
                      On October 6 of this year, Krissy and David exchanged vows 
                      and married.</span></p>
                    <p class="bold" align="left"><span class="text">On October 
                      20th at the Orlando Fan Faire, David and Krissy got married 
                      again. This time as their play characters: the Human Cleric 
                      Forsty Snowawg and the Barbarian Shaman Jelean Spiritrunner 
                      on the Luclin server in the presence of hundreds of EverQuest 
                      players. As their characters on Luclin gathered in North 
                      Karana for the ceremony with their guild, Acolytes of Awg, 
                      the real life spectators watched the large view screen set 
                      up in the Rosen Centre Hotel Ballroom. There were cheers 
                      as the bride, Jelean, used her charming abilities to convince 
                      the massive griffon Great Wing to perform this most sacred 
                      online union.</span></p>
                    <p class="bold" align="left"><span class="text">Great Wing 
                      told the story of humans in ancient times, when they had 
                      two hearts and two souls. The gods decided to split them, 
                      and now each is driven to search for their missing half. 
                      The union of Julean and Forsty, declared Great Wing, was 
                      a case of two halves rejoining at last in a love that would 
                      endure throughout time.</span></p>
                    <p class="bold" align="left"><span class="text">Then Great 
                      Wing dozed off. Julean prodded the griffon, who awoke and 
                      begged pardon, blaming his breakfast.</span></p>
                    <p class="bold" align="left"><span class="text">Great Wing 
                      then asked for Julean and Forsty's commitments to one another. 
                      Finally, with the exchange of a kiss, the two were wed.</span></p>
                    <p class="bold" align="left"><span class="text">Fellow guild 
                      members in attendance at the Fan Faire stood as witnesses 
                      for the bride and groom:</span></p>
                    <p class="bold" align="left"><span class="text">Grobl<br>
                      Janen<br>
                      Darkrose<br>
                      Lawg<br>
                      Gwachoy<br>
                      ...
                      Nimzy</span></p>
                    <p class="bold" align="left"><span class="text">Great Wing 
                      was controlled by Event Master Andrea &quot;Belleza&quot; 
                      Rose.<br>
                      Lydia &quot;Zatozia&quot; Pope served as the wedding planner.<br>
                      Wedding narrated by Quest Trouper Bleunarion.</span></p>
                  </div>
                  <div align="justify"> 
