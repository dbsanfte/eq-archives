...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/sponsors_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="128,46,246,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/sponsors_de.jsp');">
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->                                    
                                    <div align="center" class="bold">Herzlichen 
                                      ...
                                      welche der Fanmesse in Seattle beiwohnten 
