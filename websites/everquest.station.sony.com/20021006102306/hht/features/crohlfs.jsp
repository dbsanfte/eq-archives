    ...
    <td valign="top"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        ...
        <tr valign="top"> 
          ...
          <td>
            <!-- #BeginEditable "body" -->
            <p class="header" align="center">Cory Rohlfs: EverQuest Artist</p>
            <p><br>
              Cory Rohlfs says he has always been an artist.  In fact, he doesn’t limit himself to visual art, but is interested in all forms of artistic media. Some might even say he has raised his gaming skills to the level of art as well.  </p>
            <p>Cory came to Verant Interactive from Tampa, Florida, where he has spent most of his life.  He graduated <i>cum laude</i> in May, 2000, from the University of Central Florida, with a Bachelor of Arts degree in graphic design and a minor in Applied Computer Science.  What better educational background could there be for an artist on the EverQuest Live Team!</p>
            <p>Rohlfs has been interested in gaming since he was very young. He says he spent many hours in front of his Atari 2600. His taste in games runs to things like <i>Metal Gear</i>, <i>Final Fantasy</i>, <i>Quake</i>, <i>Resident Evil</i>, <i>Unreal</i>, and <i>Counterstrike,</i> but the list goes on and on.  It’s not unusual to find Cory at his computer late at night, after a long work day, checking out the latest cool mod or new title.</p>
            <p>Verant is fortunate to have his skill and dedication on the team!  Here is a sample of some of the work Cory has contributed to EverQuest&reg; products:</p>
            <p>Coldain dwarf male, created for the EverQuest&reg;: The Scars of Velious&#153;<i> </i>expansion released in December, 2000.  These hardy dwarves, once thought lost, have lived on the ice continent for hundreds of years.<br>
              <img src="cr/Image18.jpg" width=240 height=214></p>
            <p> </p>
            <p>The Vah Shir appear to be distant relatives of the Kerran race who live on Kerra Isle and in the area known as Kerra Ridge.  Their society has evolved to be somewhat more sophisticated than their Norrathian cousins.  They were discovered to be living on the Norrathian satellite, Luclin, which is a ringed moon.<br>
              <img src="cr/Image19.jpg" width=238 height=217></p>
            <p>The &quot;Sword of the Gathering.&quot;  A special sword created as a prize for winners at the <a href="http://everquest.station.sony.com/fanfaire/en/"><font face="Verdana" size=2>EverQuest Fan Faires</font></a><font face="Verdana" size=2>, held at various locations<br>
              </font><img src="cr/Image20.jpg" width=320 height=94></p>
            <p>&nbsp;</p>
            <p><i>Some of the creatures created by Cory populate the ice continent of Velious.</i></p>
            <p>&nbsp;</p>
            <p>Walrusmen wander the wastelands.<br>
              <img src="cr/Image21.jpg" width=266 height=200></p>
            <p>Snow bunny prowls the tundra in the twilight’s gloom.<br>
              <img src="cr/Image22.jpg" width=288 height=216></p>
            <p>An otterman wizard experiments with his elemental magics.<br>
              <img src="cr/Image23.jpg" width=293 height=220></p>
            <p>Many species of cave bears inhabit the ice continent, making their homes in the labyrinthine caverns spread throughout the mountain ranges.<br>
              <img src="cr/Image24.jpg" width=293 height=220></p>
            <!-- #EndEditable --></td>
