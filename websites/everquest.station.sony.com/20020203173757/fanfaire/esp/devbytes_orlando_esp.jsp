...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>89794 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --><span class="bold"> 
                                    El Productor de EverQuest, Jeff Butler, y 
                                    el Productor Adjunto, Bill Coyle, responden 
                                    a las preguntas formuladas durante el Panel 
                                    de Debate del Productor en el Fan Faire de 
                                    Orlando. </span> 
                                    <p class="bold"><br>
                             
                                      <a href="../sounds/01-L1CM.mp3" class="bold2">Bill 
                                      Coyle se refiere al equilibrio entre PvP 
                                      y PvE.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/02-L1CM.mp3" class="bold2">Jeff 
                                      Butler dice que las casas participantes 
                                      no aparecen en la lista de desarrollo.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/03-L1CM.mp3" class="bold2">M&aacute;s 
                                      informaci&oacute;n sobre el albergue del 
                                      participante.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/04-L1CM.mp3" class="bold2">Derroche 
                                      de dinero y caracter&iacute;sticas deseadas</a></p>
                                    <p class="bold">
                                      <a href="../sounds/05-L1CM.mp3" class="bold2">&iexcl;Las 
                                      competiciones de Jousting ser&iacute;an 
                                      grandiosas!</a></p>
                                    <p class="bold">
                                      <a href="../sounds/06-L1CM.mp3" class="bold2">Preg&uacute;ntenle 
                                      a Lawrence. Pero, de todos modos les dar&eacute; 
                                      mi opini&oacute;n al respecto.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/07-L1CM.mp3" class="bold2">Tiempos 
                                      de resultados, guildas europeas y movimientos 
                                      del servidor.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/08-L1CM.mp3" class="bold2">Luchas 
                                      y formaci&oacute;n de equipos cruzados en 
                                      la carrera PvP.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/09-L1CM.mp3" class="bold2">Los 
                                      cl&eacute;rigos se fusionan a niveles altos.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/10-L1CM.mp3" class="bold2">M&aacute;s 
                                      cosas divertidas que se pueden hacer con 
                                      un cl&eacute;rigo.</a></p>
                                    <p class="bold">
                                      <a href="../sounds/11-L1CM.mp3" class="bold2">Navegar 
                                      por el extenso mar azul&#133; y navegar, 
                                      navegar y navegar.</a></p>
                                    <p><span class="bold">
                                      <a href="../sounds/12-L1CM.mp3" class="bold2">el 
                                      camino en Luclin</a><br>
                                      </span> </p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
