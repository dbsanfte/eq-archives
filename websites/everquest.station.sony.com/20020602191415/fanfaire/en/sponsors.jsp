...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/sponsors.jsp?null');">
...
target="_blank" class="bold2"><img src="../images/RPGwear_logo.gif" width="200" height="48" border=0> 
                                    ...
                                    <div align="center"> 
                                      ...
                                      <p><a href="www.alteclansing.com"><img src="../images/Altec-Stacked-Logo-CURRENT.gif" width="200" height="45" border="0"></a> 
                                      </p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
