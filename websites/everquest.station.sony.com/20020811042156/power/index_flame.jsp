...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/power/index_flame.jsp?null');">
...
if (navigator.appVersion.indexOf("Mac")!=-1)
{
	document.write('<img src="images/spacer.gif" border="0" height="13" width=1><br>');
      ...
      <td width="121" valign="top" rowspan="2"><!-- #BeginLibraryItem "/Library/Ad.lbi" --><script language="JavaScript" type="text/javascript">
	<!--
