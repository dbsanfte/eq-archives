...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>70072 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->								    
                                    ...
                                    <p align="left"><br>
                                        <span class="bold">The EverQuest Fan Faire is a real life social event held multiple times per year in various regions throughout the country.  Fan Faire is designed to allow EverQuest players the chance to meet other players in a fun environment, as well as to mingle with various SOE employees who are involved with the game. Though attendees will have plenty of opportunity to mingle freely with one another and make new friends, they'll also have the chance to participate in a number of panel discussions and game-themed live events.  Past events have included Live Quests with volunteers portraying various NPCs who hand out puzzles and tasks for participants to complete, and the running of an actual in-game event, projected onto a large screen, for attendees to watch.  Each successive Faire seems to get bigger and better.  So, as to what the future holds, who knows?</span><br>
                                    <p align="left">&nbsp;
