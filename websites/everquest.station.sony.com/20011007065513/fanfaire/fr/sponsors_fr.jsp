...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>81947 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/sponsors.gif" width="385" 
height="50">
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <center>
                                      <span class="bold">Revenez sur cette page 
                                      pour en savoir plus sur la prochaine Fan 
                                      Faire !</span><br>
                                    </center>
                                    <div align="center">
                                      <p align="center">&nbsp;</p>
