	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/event_schedule.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/event_schedule.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/event_schedule.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<div class=Section1>
  <table border=0 cellspacing=10 cellpadding=0 width="100%">
    <tr>
      <td valign=top class="Normal"><p align="center"><b>EverQuest Fan Faire – <st1:City
  w:st="on"><st1:place w:st="on">New Orleans – October 28-30, 2004 <br>
          Event Schedule </span></b></p>
        <table border=1 cellspacing=0 cellpadding=0 width="100%">
          <tr>
            <td colspan=4 valign=top class="Normal"><p><b>THURSDAY, October 28<sup>th</sup>  </span></b></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p><b>TIME</span></b></p></td>
            <td valign=top class="Normal"><p><b>EVENT</span></b></p></td>
            <td valign=top class="Normal"><p><b>DETAILS</span></b></p></td>
            <td valign=top class="Normal"><p><b>LOCATION</span></b></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>2:00pm – 8:00pm</span></p></td>
            <td valign=top class="Normal"><p>Early Bird Registration</span></p></td>
            <td valign=top class="Normal"><p>Attendees can begin checking in.</span></p></td>
            <td valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>5:00pm</span></p></td>
            <td valign=top class="Normal"><p>Silent Auction Begins</span></p></td>
            <td valign=top class="Normal"><p>Bid on one-of-a-kind EverQuest Merchandise, Fan Faire Flags, Signed Items and much more!</span></p></td>
            <td valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>6:00pm – 7:00pm</span></p></td>
            <td valign=top class="Normal"><p>Fan Faire Extravaganza Parade</span></p></td>
            <td valign=top class="Normal"><p>Let’s kick this Fan Faire off right!  We’ll start with cocktails then march through the French Quarter.  We’ll have a marching band, police escorts, beads and all!</span></p></td>
            <td valign=top class="Normal"><p>Trade</span> Center</span> (across the street from the Hilton)</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>7:00pm – 8:30pm</span></p></td>
            <td valign=top class="Normal"><p>Everything EverQuest kickoff party (immediately following parade)</span></p></td>
            <td valign=top class="Normal"><p>Join us for cocktails and appetizers and meet the participants in the <b><i>EQII Ultimate Elimination Challenge</i></b>.</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B</span></p></td>
          </tr>
          <tr>
            <td colspan=4 valign=top class="Normal"><p><b>FRIDAY, October 29<sup>th</sup>  </span></b></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p><b>TIME</span></b></p></td>
            <td valign=top class="Normal"><p><b>EVENT</span></b></p></td>
            <td width="36%" valign=top class="Normal"><p><b>DETAILS</span></b></p></td>
            <td width="20%" valign=top class="Normal"><p><b>LOCATION</span></b></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>9:30am</span></p></td>
            <td valign=top class="Normal"><p>“EQII Ultimate Elimination Challenge” kickoff (UEC)</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Players get familiarized with rules and get geared up to play!</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am</span></p></td>
            <td valign=top class="Normal"><p>“EQII Ultimate Elimination Challenge” officially starts</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Here we go!  Who will get the most XP and make it the whole 48 hours?</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am– 8:00pm</span></p></td>
            <td valign=top class="Normal"><p>Registration</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Attendees can begin checking in.</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am – 10:00pm</span></p></td>
            <td valign=top class="Normal"><p>Arm Yourself For Adventure Game Room</span></p></td>
            <td width="36%" valign=top class="Normal"><p>PCs and WiFi available to play EQ, PlanetSide and Champions:  Return to Arms - MUST sign up for a time slot in the game room. </span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am - 8:00pm</span></p></td>
            <td valign=top class="Normal"><p>SOE Phat Lewt Store and Bazaar</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Don't miss out on the show specials, new items and gear</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>12:00pm - 10:00pm</span></p></td>
            <td valign=top class="Normal"><p>EverQuest RPG Introduction &amp; Adventures with White Wolf Games</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Experience the fun of the EverQuest pen &amp; paper RPG, with a full introduction, how to and adventure in games run by White Wolf GMs</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>2:00pm – 3:00pm</span></p></td>
            <td valign=top class="Normal"><p>Panel Discussions</span></p></td>
            <td width="36%" valign=top class="Normal"><p>PlanetSide AfterShock</span></p>
              <p>Customer Service Improvements</span></p>
              <p>EQ Dev:  Maintaining a Living World</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>3:00pm – 4:00pm</span></p></td>
            <td valign=top class="Normal"><p>Panel Discussions</span></p></td>
            <td width="36%" valign=top class="Normal"><p>EQ Dev:  Maintaining a Living World <b>(CONT’D)</b></span></p>
              <p class=MsoBodyText2>EQ Lore and Expansions:  Creating a Compelling Storyline</p>
              <p>Art of EQ and the New Graphics Engine:  A Whole New Game</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>4:00pm – 5:00pm</span></p></td>
            <td valign=top class="Normal"><p>Panel Discussions</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Art of EQ and the New Graphics Engine:  A Whole New Game <b>(CONT’D)</b></span></p>
              <p class=MsoBodyText2>The Basics of EverQuest II</p>
              <p>Character Advancement through Spells and AAs</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B </span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>8:00pm&nbsp;- 10:00pm</span></p></td>
            <td valign=top class="Normal"><p>Fan Faire Grand Reception</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Welcome to New Orleans!  Meet and greet your fellow Norrathians, enjoy cocktails and hors d’ouevres and win fabulous door prizes!</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Grand Ballroom A - D</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00pm</span></p></td>
            <td valign=top class="Normal"><p>First round of Eliminations in the EQII UEC</span></p></td>
            <td width="36%" valign=top class="Normal"><p>5 players with the lowest XP are eliminated from the contest</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00pm&nbsp;- 1:00am</span></p></td>
            <td valign=top class="Normal"><p>Fan Faire After-Party</span></p></td>
            <td width="36%" valign=top class="Normal"><p>Join other Fan Faire attendees at the after-party! We'll keep the doors open late for you all-nighters swapping stories and having fun.</span></p></td>
            <td width="20%" valign=top class="Normal"><p>Grand Ballroom A - D</span></p></td>
          </tr>
          <tr>
            <td colspan=4 valign=top class="Normal"><p><b>SATURDAY, October 30<sup>th</sup>  </span></b></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p><b>TIME</span></b></p></td>
            <td valign=top class="Normal"><p><b>EVENT</span></b></p></td>
          ...
          <tr>
            <td valign=top class="Normal"><p>10:00am</span></p></td>
            <td valign=top class="Normal"><p>Second round of Eliminations in the EQII UEC</span></p></td>
            <td valign=top class="Normal"><p>5 more players with the lowest XP are eliminated from the contest</span></p></td>
            <td valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am&nbsp;- 8:00pm</span></p></td>
            <td valign=top class="Normal"><p>SOE Phat Lewt Store and Bazaar</span></p></td>
            <td valign=top class="Normal"><p>Don't miss out on the show specials and new items and gear</span></p></td>
            <td valign=top class="Normal"><p>Hilton</span> Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am&nbsp;- 8:00pm</span></p></td>
          ...
          <tr>
            <td valign=top class="Normal"><p>10:00am - 10:00pm</span></p></td>
            <td valign=top class="Normal"><p>Arm Yourself For Adventure Game Room</span></p></td>
            <td valign=top class="Normal"><p>PCs and WiFi available to play EQ, PlanetSide and Champions:  Return to Arms - MUST sign up for a time slot in the game room.</span></p></td>
            <td valign=top class="Normal"><p>Hilton Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00am&nbsp;- 10:00pm</span></p></td>
            <td valign=top class="Normal"><p>EverQuest RPG Introduction &amp; Adventures with White Wolf Games</span></p></td>
            <td valign=top class="Normal"><p>Experience the fun of the EverQuest pen &amp; paper RPG, with a full introduction, how to and adventure in games run by White Wolf GMs</span></p></td>
            <td valign=top class="Normal"><p>Hilton Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>12:00am&nbsp;- 2:00pm</span></p></td>
            <td valign=top class="Normal"><p>Live Quest sponsored by Intel</span></p></td>
            <td valign=top class="Normal"><p>Experience EverQuest in real life – and in the unique setting of the French Quarter!  More details to come…</span></p></td>
            <td valign=top class="Normal"><p>To be announced</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>2:00pm – 8:00pm</span></p></td>
            <td valign=top class="Normal"><p>EverQuest Best of the Best Tournament</span></p></td>
            <td valign=top class="Normal"><p>There can only be one!  Players from each server battle to be number one.</span></p></td>
            <td valign=top class="Normal"><p>Hilton Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>2:00pm –</span></p>
              <p>3:00pm</span></p></td>
            <td valign=top class="Normal"><p>Panel Discussions</span></p></td>
            <td valign=top class="Normal"><p>Fan Faire Q &amp; A </span></p>
              <p>The Basics of EverQuestII</span></p>
              <p>PlanetSide Aftershock</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B </span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>3:00pm –</span></p>
              <p>4:00pm</span></p></td>
            <td valign=top class="Normal"><p>Panel Discussions</span></p></td>
            <td valign=top class="Normal"><p>Customer Service Improvements</span></p>
              <p>The Art and Lore of EverQuest II</span></p>
              <p>Introduction to Station Players</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B </span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>4:00pm –</span></p>
              <p>5:00pm</span></p></td>
            <td valign=top class="Normal"><p>Panel Discussions</span></p></td>
            <td valign=top class="Normal"><p>Introduction to Station Players (<b>CONT’D)</b></span></p>
              <p>Community Relations in Online Games</span></p>
              <p>Book Signing with Scott Ciencin.  Come meet the author of “The Rogue’s Hour” and get your book signed.  A limited number will be for sale at the Phat Lewt store.</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B </span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>5:30pm – </span></p></td>
            <td valign=top class="Normal"><p>Silent Auction Ends</span></p></td>
            <td valign=top class="Normal"><p>Bidders gather, the silent auction ends, and the winners are posted!  <b>Players can pick up their banners at the Phat Lewt Store from 5:30 to 8:00pm, when dinner is served.</b></span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom D, Grand Salon A, Grand Salon B </span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>8:00pm&nbsp;- 10:00pm</span></p></td>
            <td valign=top class="Normal"><p>Masquerade Banquet</span></p></td>
            <td valign=top class="Normal"><p>Come dressed in your best costume and join us for dinner.  We’ll announce the winners of LiveQuest and give away fabulous prizes.  Costume contest immediately following.</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom A - D</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00pm</span></p></td>
            <td valign=top class="Normal"><p>Third round of Eliminations in the EQII UEC</span></p></td>
            <td valign=top class="Normal"><p>5 more players with the lowest XP are eliminated from the contest</span></p></td>
            <td valign=top class="Normal"><p>Hilton Exhibition Center</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:00pm – 10:30pm</span></p></td>
            <td valign=top class="Normal"><p>Costume Contest</span></p></td>
            <td valign=top class="Normal"><p>Try your best to combine your favorite EQ character with Halloween!  The most imaginative and unique win great prizes from our sponsors.</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom A - D</span></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p>10:30pm&nbsp;- 1:00am</span></p></td>
            <td valign=top class="Normal"><p>Fan Faire After-Party</span></p></td>
            <td valign=top class="Normal"><p>Join other Fan Faire Attendees at the After-Party! We'll keep the doors open late for you all-nighters swapping stories and having fun.</span></p></td>
            <td valign=top class="Normal"><p>Grand Ballroom A – D</span></p></td>
          </tr>
          <tr>
            <td colspan=4 valign=top class="Normal"><p><b>Sunday, October 31st  </span></b></p></td>
          </tr>
          <tr>
            <td valign=top class="Normal"><p><b>TIME</span></b></p></td>
            <td valign=top class="Normal"><p><b>EVENT</span></b></p></td>
          ...
          <tr>
            <td valign=top class="Normal"><p>8:59am </span></p></td>
            <td valign=top class="Normal"><p>EverQuestII Ultimate Elimination Challenge Ends</span></p></td>
            <td valign=top class="Normal"><p>Final winner will be announced.</span></p></td>
            <td valign=top class="Normal"><p>Hilton Exhibition Center</span></p></td>
          </tr>
        </table></td>
    </tr>
  </table>
  <p class=MsoBodyText>REMINDER:  DAYLIGHT SAVING TIME ENDS – TURN YOUR CLOCKS BACK ONE HOUR!!!!</p>
</div>
