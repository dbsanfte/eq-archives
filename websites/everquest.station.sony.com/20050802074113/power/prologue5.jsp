	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/prologue5.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/prologue5.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/prologue5.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
  ...
  <tr>
    <td background="images4/main_bg.jpg" valign="top"> <!-- #BeginEditable "Content" --> 
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> 
           <p align="center"> <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="415" height="70">
            ...
            <p class="link2">Contemplation</p>
            <p align="center"> <a href="index_prologue5.jsp"><img src="images/Contemplation_sm.jpg" width="415" height="169" border="0"></a> 
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td height="11"><a href="wallpapers.jsp#comtemplation" class="link2small">Click 
                  for Wallpaper</a></td>
                <td width="50%" align="right" height="11"><a href="index_prologue5.jsp" class="link2small">Click for Flash movie</a> </td>
              </tr>
            </table>
            <p class="link">Fahlia silently sat on the ocean's edge. The aurora 
              danced with its reflection, giving the horizon a mesmerizing effect. 
              The rhythmic sounds of the shore and the smooth whir of the windmill's 
              gears gave the aurora the music it needed to make the scene complete. 
              Yet, even with a scene as meditative as the one that moved before 
              her, Fahlia's mind continued to race. 
            <p class="link">Conflict and conspiracy have always existed. However, 
              the scale and nature of what was transpiring proved to be very unsettling. 
              There was some reassurance in the knowledge that their efforts had 
              paid off so far. Other than the trip to Kaesora and the assault 
              on the Libraries of Chardok, they had experienced very little opposition 
              while collecting materials for the elders. This was partially due 
              to the fact that so many people were collaborating with them. Fahlia 
              found it hard to fathom that so many people were looking for the 
              same answers. It was even harder to believe that these people were 
              willing to risk the same punishment should they be discovered.</p>
            <p class="link">The elders and scholars were working at that moment 
              to decipher the documents that had been gathered. Perhaps those 
              tomes and texts would give them some insight, some clue about what 
              they should do next. For now, she could only wait for her next assignment 
              and hope that destiny had some plan for them. Fahlia couldn't help 
              but wonder if he was out there, watching them with some understanding 
              of the tale that was about to unfold.</p>
            <p class="link">Just as that final thought filled her mind, a voice 
              disrupted the peaceful scene.</p>
            <p class="link">&quot;Fahlia, the elders have called for us again. 
              It seems they have located the last four. We must move to meet them 
              at once.&quot;</p>
            <p class="link">The speaker's voice was unnaturally deep for someone 
              with such a diminutive stature. He reached out to help her to her 
              feet and added, &quot;You'll be needing some extra cover to take 
              with you, lass. It's quite cold where we're heading.&quot;<br>
            </p>
          </td>
        </tr>
        <tr> 
