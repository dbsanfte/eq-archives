...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">93338 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <tr> 
                            <td width="98%"  background="images/translucent2.gif" valign=top height="291"> 
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> <div align="center"><font color="#000000" fa="fa" ce="Arial, Helvetica, sans-serif" size="2"><b><br>
