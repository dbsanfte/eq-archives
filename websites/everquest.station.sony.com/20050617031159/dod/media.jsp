	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/dod/media.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/dod/media.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/dod/media.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
			...
			<td background="images/en/tile_bg.jpg" valign="top"><table width="780" cellspacing="0" cellpadding="0" border="0" style="background-image:url(images/en/top_bg.jpg); background-repeat:no-repeat; background-position:top;">
				<tr>
					...
					<td valign="top" width="690">
						<img src="images/en/content/title_media.gif" width="690" height="71">
						<br>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr><td align="center" valign="top" width="50%"><a href="images/en/screenshots/000.jpg" target="_new"><img src="images/en/screenshots/thumbs/000.jpg" border="0" width="330" height="248"></a></td><td align="center" valign="top" width="50%"><a href="images/en/screenshots/001.jpg" target="_new"><img src="images/en/screenshots/thumbs/001.jpg" border="0" width="330" height="248"></a></td></tr><tr><td>&nbsp;</td></tr><tr><td align="center" valign="top" width="50%"><a href="images/en/screenshots/002.jpg" target="_new"><img src="images/en/screenshots/thumbs/002.jpg" border="0" width="330" height="248"></a></td><td align="center" valign="top" width="50%"><a href="images/en/screenshots/003.jpg" target="_new"><img src="images/en/screenshots/thumbs/003.jpg" border="0" width="330" height="248"></a></td></tr><tr><td>&nbsp;</td></tr>
						</table>
						
						<table border="0" width="100%">
							<tr>
								<td align="left">
									<a href="media.jsp?page=8"><img src="images/en/content/previous.gif" width="178" height="28" border="0"></a>
								</td>
								<td align="right">
									<a href="media.jsp?page=1"><img src="images/en/content/next.gif" width="113" height="28" border="0"></a>
								</td>
							</tr>
						</table>
					</td>
