	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/faq.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/legacy/faq.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="672" valign="top" style="background-image:  url(images/sub_bg.jpg); background-repeat: no-repeat;"> 
        <!-- InstanceBeginEditable name="Header Image" --><img src="images/faq_head.jpg" width="672" height="56" alt="" border="0"><br><!-- InstanceEndEditable -->
		<table width="672" border="0" cellspacing="0" cellpadding="0" background="">
          <tr> 
            ...
            <td width="607" background="images/parch_tile.jpg" bgcolor="#928E73">
				...
				<p>The cost is $21.99 (price subject to change). This is a one-time charge and does not affect your subscription plan. </p>
				<p><strong>2) How do I pay for this extension?</strong></p>
				<p>You can order The Legacy of Ykesha from our <a href="https://store.station.sony.com">online store</a>, download it, and start playing immediately.  You can also order the extension from the EverQuest server selection screen, and we will bill the charge directly to the credit card on account for your EverQuest subscription.</p>
				<p><strong>3) How does this download-only thing work?</strong></p>
				<p>SOE will be making this extension available as a product download -- those who order Legacy of Ykesha will need to download the necessary files from our servers. We will make these files available for download during the EverQuest login procedure. (We're guessing it will be about 120 megabytes.)</p>
				<p><strong>4) I have a dialup connection; any hints on patching?</strong></p>
				<p>If you do not have a broadband connection, your downloads will be slow. What you might do is try to manage the process so that you patch the new files while you work or sleep. To do that, in the patcher advanced options, keep The Legacy of Ykesha box unchecked (so that you aren't checking for and patching any available extension files before every play session) but, when you are done for the evening (or perhaps in the morning), open the patcher, check the Legacy of Ykesha box and then rerun the patcher. That way, you don't have to sit idly at your machine and watch it patch for hours.</p>
				<p><strong>5) Can I buy The Legacy of Ykesha extension at retail?</strong></p>
