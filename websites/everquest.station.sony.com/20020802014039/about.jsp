 ...
 <div id="contentLayer"> 
            ...
            <table width="467" border="0" cellspacing="0" cellpadding="0">
              <tr>
                        ...
                        <td width="415">Choose from <a href="http://eqlive.station.sony.com/library/races.jsp">13 
                          races</a> and <a href="http://eqlive.station.sony.com/library/classes.jsp">14 
                          classes</a>, including dwarves, ogres, trolls, rangers, 
                          wizards, and rogues. <a href="http://everquest.station.sony.com/luclin.jsp">The 
                          Shadows of Luclin</a> Expansion will introduce a new 
                          race known as the Vah Shir, and the new class, The Beastlord.</td>
                                      </tr>
                                      <tr background=""> 
                                        <td colspan="3" valign="top">&nbsp;</td>
                                      </tr>
                        ...
                        <td width="415"><a href="http://eqlive.station.sony.com/library/skills.jsp">Over 
                          40 unique skills</a> and innate abilities.</td>
                                      </tr>
                                      <tr background=""> 
                                        <td colspan="3" valign="top">&nbsp;</td>
                                      </tr>
                        ...
                        <td width="415">Thousands of items to discover and collect, 
                        ...
                        <td width="415"><a href="http://eqlive.station.sony.com/library/atlas/index.jsp">Five 
                          enormous continents</a> to explore, as well as other 
                          dimensions and planes of existence.</td>
                                      </tr>
                                      <tr background=""> 
                                        <td colspan="3" valign="top">&nbsp;</td>
                                      </tr>
                        ...
                        <td width="415"><a href="http://eqlive.station.sony.com/library/deities.jsp">Dozens 
                          of powerful deities</a> whose activities influence the 
                          ongoing history of the world.</td>
                                      </tr>
                                      <tr background=""> 
                                        <td colspan="3" valign="top">&nbsp;</td>
                                      </tr>
