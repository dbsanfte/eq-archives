...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">53201 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<td width="1" valign="top"><img src="images/newsbanner_r_stone1.gif" width="79" height="35"></td>
                  ...
                  <p><font face="Arial, Helvetica, sans-serif"><b>1.4 What opportunity 
                    will existing EverQuest customers have to upgrade to the Expansion?</b></font></p>
                  <p><font face="Arial, Helvetica, sans-serif">All existing EverQuest 
                    customers can upgrade to the Kunark Expansion by purchasing 
                    the upgrade package.</font><font face="Arial, Helvetica, sans-serif">This 
                    upgrade package includes an upgrade CD-ROM and a new world 
                    map and will be available for purchase via The Station Online 
                    Store. Note that it is subject to availability restrictions. 
                    </font><font face="Arial, Helvetica, sans-serif"></font></p>
                  <font face="Arial, Helvetica, sans-serif">
                  <p> IMPORTANT: The retail EverQuest box will be replaced with 
                    a new box that will include both EverQuest and the Expansion. 
                    If you are already an existing EverQuest customer you do NOT 
                    need to purchase the box at retail.
                  </font> 
