...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>68679 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <tr> 
                            <td width="98%"  background="../images/translucent2.gif" valign=top height="291"> 
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --><span class="bold">The 
                                    Orlando Fan Faire will be held at the <a href="http://www.omnirosen.com" target="_blank" class="bold2">Rosen 
                                    Centre</a>, located minutes from Disney World 
                                    and other great attractions. We've secured 
                                    a special rate with the hotel for Fan Faire 
                                    attendees. When reserving your room, mention 
                                    that you are with the EverQuest Fan Faire 
                                    and you should be able to get the rate of 
                                    $99 per night. For further information, visit 
                                    their <a href="http://www.omnirosen.com" target="_blank" class="bold2">web 
                                    site</a>.</span><br>
                                    <p align="left">&nbsp;</p>
                                    <br>
                                    <br>
