...
<title>EverQuest: Omens of War - Overview</title>
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/omensofwar/overview.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/omensofwar/overview.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/omensofwar/overview.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="224" valign="top"><table width="224"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><a href="/omensofwar/overview.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','/omensofwar/images/content_overview_on.jpg',1)"><img src="/omensofwar/images/content_overview_off.jpg" name="Image10" width="224" height="41" border="0"></a></td>
          </tr>
          <tr>
            ...
            <td width="97%" rowspan="3" valign="top"><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="620" valign="top" class="contentbg"><table width="100%"  border="0" cellspacing="0" cellpadding="10" class="contenttop">
                  <tr>
                    <td><p class="header">Overview</p>
 
<P><STRONG>Epic Weapons: </STRONG><BR>Epic weapons are a result of completing an "epic quest." These hand-tailored quests will be available to all classes. The quest themselves will be a combination of solo, group and raid content. However, these weapons are being designed for people at the upper end of the level spectrum.</P>
...
<P><STRONG>Level Cap Increase:</STRONG><BR>The level cap increase is being designed to allow players the ability to reach levels above 65. With the level cap increase, new items, spells and quests will be available.</P>
<P><STRONG>Guild Tribute System</STRONG><BR>This system is extremely similar to the Tribute system that's currently in game. However, the main difference is that Guild Tribute will affect the entire guild, instead of the individual.</P>
<P><STRONG>Task System:</STRONG><BR>The task system allows players to go to various zones and request a task. These tasks are being designed for quick completion and are initially aimed at lower level players.</P>
<P><STRONG>Custom PC Titles:</STRONG><BR>Players will be able to select titles for their characters based on various accomplishments. These titles will be available across all levels.</P>
<P><STRONG>New Disciplines/AAs/Items/Spells/Quests/Tradeskills :</STRONG><BR>New disciplines, AAs, items, spells, quests and tradeskills continue to make EverQuest the most compelling and persistent online world ever created.</P>
<P><STRONG>Improved Graphics:</STRONG><BR>Discover rich new zones, detailed environments with expanded graphical features, improved spell effects and all-new NPC character models to fight.</P>
