...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>38292 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="left" class="bold"><br>
                                      Faites d&egrave;s maintenant des projets 
                                      pour nous rejoindre les 25 et 26 janvier 
                                      <a href="http://www.adamsmark.com/dallas/index.asp" target="_blank" class="bold2">&agrave; 
                                      l'H&ocirc;tel Adam's Mark de Dallas</a>. 
                                      Inscrivez-vous &agrave; l'avance pour &eacute;viter 
                                      de manquer ces fabuleux moments !</p>
                                    <p align="left" class="bold">Nous avons n&eacute;goci&eacute; 
                                      avec la direction de l'h&ocirc;tel un tarif 
                                      sp&eacute;cial r&eacute;serv&eacute; aux 
                                      participants de la Fan Faire. En r&eacute;servant 
                                      votre chambre, indiquez que vous participez 
                                      &agrave; la Fan Faire d'EverQuest ; vous 
                                      devez obtenir le tarif de 99 dollars am&eacute;ricains 
                                      par nuit&eacute;e. Pour en savoir plus, 
                                      rendez vous sur<a href="http://www.adamsmark.com/dallas/index.asp" target="_blank" class="bold2"> 
                                      le site Web de l'h&ocirc;tel. </a> </p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
