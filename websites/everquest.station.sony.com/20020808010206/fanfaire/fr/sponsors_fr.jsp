...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/sponsors_fr.jsp?null');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="images/sponsors.gif" height="50"> </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center" class="bold">Merci à nos 
                                      sponsors et vendeurs pour leur participation 
                                      à la Fan Faire de Seattle et merci à tous 
                                      ceux qui ont pris le temps de nous rendre 
                                      visite et apprécier leurs articles. </div>
                                    <center>
 <br>
