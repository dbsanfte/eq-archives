...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/winners_orlando.jsp?null');">
        ...
        <tr> 
          <td> 
            <table width="75" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td><a href="index.jsp" onMouseOut="MM_swapImgRestore();nd()" onMouseOver="MM_swapImage('Image16','','../images/flag_en_on.gif',1);return overlib('Ce lien va vous diriger vers une page en anglais.')"><img name="Image16" border="0" src="../images/flag_en.gif" width="25" height="17"></a></td>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center"><b>Orlando Fan Faire Winners</b>
                                    </div>
                                    <p align="center"><br>
                                      <b>Live Quest Winners</b><br>
                                      ...
                                      James Miller<br>
                                      Tina Stafford</p>
                                    <p align="center"><b>Raffle Drawing Winners</b><br>
                                      James Imlay<br>
                                      Faye Johnston<br>
                                      Bud Anderegg<br>
                                      Glen Smith<br>
