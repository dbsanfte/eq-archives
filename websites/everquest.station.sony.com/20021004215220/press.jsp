...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">72,745 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/press.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/press.jsp');">
          ...
          <td background="new_images/test_bg.jpg" bgcolor="#081429" valign="top" height="400">
            ...
            <table width="467" border="0" cellspacing="0" cellpadding="0">
              <tr>
                              ...
                              <div align="left"><b><u>Consumer Press</u></b> <br>
                                <br>
                                Top Ten Hall of Fame Videogames for the 90's<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Entertainment 
                                Weekly<br>
                                <img src="new_images/spacer.gif" width="10" height="10"><br>
                                &quot;EverQuest is truly the next generation computer 
                                RPG destined to be a classic.&quot;<img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-USA 
                                Today<br>
                                <br>
                                #1 Best Selling PC Game at Launch<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-PC 
                                Data<br>
                                <br>
                                &quot;Say hello to MMORPGs-and say good-bye to 
                                life as you know it. MMORPGs are the hottest PC-gaming 
                                trend since Quake ushered in multiplayer Internet 
                                fragging. The most popular of these, the sword-and-sorcery 
                                style EverQuest, has a following of 375, 000 active 
                                players-all of whom can play at the same time. 
                                Imagine talking, fighting, and flirting in a virtual 
                                world bigger than many real-life cities.&quot;<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-MH-18<br>
                                <br>
                                &quot;When they write the history of the Internet, 
                                the past few years will look radically different 
                                than they seen today. The stories of dot-com failures 
                                and falling stock prices will face; new stories 
                                will emerge of Web companies quietly finding ways 
                                to succeed, stories like the impressively successful 
                                Sony Online Entertainment game EverQuest.&quot;<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Hosting 
                                Tech<br>
                                <br>
                                <b><u>Gaming Press</u></b><br>
                                <br>
                                <img src="new_images/spacer.gif" width="10" height="10"> 
                                &quot;Verant has done it again with another expansion 
                                [The Scars of Velious] that continues to enrich 
                                the EverQuest experience.&quot; 4 &frac12; out 
                                of 5 stars<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Computer 
                                Gaming World<br>
                                <br>
                                &quot;EverQuest raises the bar on online RPG's.&quot;<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-PC 
                                Gamer<br>
                                <br>
                                &quot;No online RPG captures a complete virtual 
                                world better than reigning online king, EverQuest.&quot;<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Inquest 
                                Gamer<br>
                                <br>
                                &quot;For the legions of EverQuest faithful, Shadows 
                                of Luclin is a fantastic addition to this, the 
                                greatest of all massively multiplayer online games.&quot;<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Game 
                                Informer<br>
                                <br>
                                #33 The Top 100 Games of All Time<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Game 
                                Informer<br>
                                <br>
                                #20 The 50 Best Games of All Time<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Game 
                                Informer<br>
                                <br>
                                #15 Top 50 Games of All Time<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-GameSpy.com<br>
                                <br>
                                #2 Game of the Millennium<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-IGN.com<br>
                                <br>
                                #6 Game that Changed the World<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Game 
                                Informer<br>
                                <br>
                                <b><u>EQ Awards</u></b> <img src="new_images/spacer.gif" width="10" height="10"> 
                                <br>
                                <br>
                                RPG of the Year<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">2000 
                                Premier Award Finalist<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle"><img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Computer 
                                Gaming World <img src="new_images/spacer.gif" width="10" height="10"> 
                                <br>
                                <br>
                                Best Multiplayer Gaming<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">2000 
                                Premier Award Finalist<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle"><img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Computer 
                                Gaming World <img src="new_images/spacer.gif" width="10" height="10"><br>
                                <br>
                                2001 Best Massive Multiplayer/Persistent World<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">EverQuest: 
                                The Ruins of Kunark<br>
                                <img src="new_images/spacer.gif" width="15" height="10" align="absmiddle"><img src="new_images/spacer.gif" width="15" height="10" align="absmiddle">-Academy 
                                of Interactive Arts &amp; Sciences <img src="new_images/spacer.gif" width="10" height="10"></div>
                            </td>
  ...
  <tr>
    ...
    <td align="center" background="new_images/test_bg.gif" valign="bottom" height="17"> 
      <div align="center"> <nobr><a href="http://www2.station.sony.com/en/termsofservice.jsp#privacy" target="_blank" class="bodylink"><b><br>
        ...
        <font size="-2" color="3A485F">EverQuest and You’re in Our World Now are registered trademarks and The Ruins of Kunark, The Scars of Velious, The Shadows of Luclin and The Planes of Power are trademarks of Sony Computer Entertainment America Inc.  The Station, SOE and the SOE logo are trademarks of Sony Online Entertainment Inc. © 2002 Sony Computer Entertainment America Inc.; portions copyright 2002 Sony Online Entertainment Inc. All other trademarks are properties of their respective owners. All rights reserved. </font>
        </td>
    </tr>
  </table>
</body>
