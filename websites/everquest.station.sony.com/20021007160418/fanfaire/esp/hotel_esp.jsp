...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/hotel_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/hotel_esp.jsp');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <center>
                          <img src="images/hotel.gif" width="413" height="39"> 
                        </center>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <P class="bold">¡&Uacute;nase a nosotros para 
                                      la Fan Faire de Seattle! </P>
                                    ...
                                    <P class="bold">El hotel nos ofrece un precio 
                                      especial de 99 d&oacute;lares norteamericanos 
                                      por noche. No se olvide de indicar que acude 
                                      a la Fan Faire de EverQuest. Nuestro c&oacute;digo 
                                      de reserves es SOE. Este hotel est&aacute; 
                                      muy cerca del aeropuerto y ofrece servicio 
                                      gratuito de enlace entre el aeropuerto y 
                                      el hotel.</P>
                                    <P class="bold">¡Haga su reserva pronto, antes 
                                      de que se agoten las plazas!</P>
<!-- #EndEditable --></td>
                                </tr>
                              </table>
                            </td>
