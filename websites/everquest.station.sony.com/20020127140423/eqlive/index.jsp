    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31229">Changes to Cleric Epic Quest</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31230">Love, Hormones, and Hairy Feet</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31228">Big Patch for January 23rd</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31221">SOE, Gateway, and Intel Announce Joint Effort</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31222">Dallas Fan Faire News</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31218">Improve Your Charisma!</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31215">Announcing The Intel "Arm Yourself for Adventure" Game Room</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="31104">EverQuest, the Comic Book</a>
                </td>
            </tr>
            </table>
        </td>
...
<P>EverQuest The Ruins of Kunark comic book is onsale now at comic stores everywhere and is sure to become a collector's item.</P>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="30996">ATI Graphical Issues</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            We are aware that some people are experiencing problems with the latest drivers from ATI. While we are working on the problems, ATI users having graphical issues should also submit a Problem Report with ATI at <A href="http://support.ati.com/problem/win9x.html">http://support.ati.com/problem/win9x.html</A>. This will ensure that the engineers at ATI are also notified of any problems using their drivers. Our programmers will then be better able to collaborate on a solution with ATI.
        </td>
    </tr>
    </table>
    <br>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="30699">Unable to Download Files with the New Patcher?</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            If you are having difficulty downloading files with the new EverQuest patcher, <a href="http://everquest.station.sony.com/support/EverQuest.zip">download this file</a> into your EverQuest directory (the default location is C:\Program Files\EverQuest\).  Unzip the file, replacing your old EverQuest.exe file with this newer version, and your problem should be solved.
        </td>
    </tr>
    </table>
    <br>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="30705">No 3D Devices Found Error</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <img src="http://everquest.station.sony.com/images/no3ddevices.gif" align="left">This error will appear when a customer has DirectX 8.0a installed, but the game is trying to use a DirectX 8.1 compliant driver. The solution is to upgrade to DirectX 8.1.
        </td>
    </tr>
    </table>
    <br>
    ...
    <tr>
        <td>
            ...
            Because Windows 95 does not support DirectX 8.1 and our new and improved EverQuest engine requires the use of this version of DirectX, we can no longer support Windows 95.<br>
<br>
We apologize for this inconvenience but in order to play EverQuest and enjoy the benefits of the new engine you must upgrade to Windows 98 or greater and install DirectX 8.1. <br>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="30701">Windows 98 or Higher Users!  Important DirectX Info</a>
                </td>
            </tr>
            </table>
        </td>
...
For help, consult our <a href="http://everquest.station.sony.com/support/luclin/directx8_install.jsp">guide to installing DirectX drivers</a>.
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="10">&nbsp; </td>
                <td class="subHeader" width="100%">
                    <a name="30696">How to Upgrade Your DirectX Drivers</a>
                </td>
            </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            We are receiving many technical inquiries regarding recent changes we have made in preparation for the launch of the new EverQuest engine. There is an extended downtime scheduled from 12:00 pm PST on December 3, 2001 through 8:00 am PST on December 4, 2001 to patch the Shadows of Luclin and upgrade the existing EverQuest Client. We believe this patch will fix most of the problems that you are experiencing and will add some great new features to the game. <br>
<br>
After tomorrow's patch, EverQuest will require DirectX 8.0a to play, although version 8.1 is recommended. DirectX 8 upgrade is easy, and the gains are exceptional.<br>
<br>
For information, consult our <a href="http://everquest.station.sony.com/support/luclin/directx8_install.jsp">guide to upgrading your DirectX drivers</a>.<br>
