...
<link rel="stylesheet" href="../fr/fanfaire.css" type="text/css">
...
<SCRIPT LANGUAGE="JavaScript" SRC="../fr/overlib_mini.js"></SCRIPT>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/winners_orlando_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/winners_orlando_de.jsp');">
              ...
              <tr>
                ...
                <td width="161">
                    ...
                    <tr>
                      <td>
                        <table width="151" border="0" cellspacing="0" cellpadding="0" background="">
                          ...
                          <tr>
                            <td><a href="../fr/index_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../images/diamond_on.gif',1)"><img name="Image3" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Page d'accueil</span></a></td>
                          </tr>
                          <tr>
                            <td><a href="../fr/info_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../images/diamond_on.gif',1)"><img name="Image4" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Infos générales</span></a></td>
                          </tr>
                          <tr>
                            <td><a href="../fr/faq_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../images/diamond_on.gif',1)"><img name="Image5" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">FAQ</span></a></td>
                          </tr>
                          <tr>
                            <td><a href="../fr/hotel_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../images/diamond_on.gif',1)"><img name="Image6" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Hébergement</span></a></td>
                          </tr>
                          <tr>
                            <td><a href="../fr/event_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','../images/diamond_on.gif',1)"><img name="Image7" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Bientôt</span></a></td>
                          </tr>
                          <tr>
                            <td><a href="../fr/sponsors_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','../images/diamond_on.gif',1)"><img name="Image8" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Sponsors et &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Distributeurs</span></a></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td><a href="../fr/scrapbook_fr.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image12','','../images/diamond_on.gif',1)"><img name="Image12" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Album</span></a></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <table width="156" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td> 
                        <div align="center"><a href="http://www.station.sony.com/everquest" onMouseOut="MM_swapImgRestore();nd()" onMouseOver="MM_swapImage('Image13','','../fr/images/backtoeq_on.gif',1);return overlib('Ce lien va vous diriger vers une page en anglais.')"><img name="Image13" border="0" src="../fr/images/backtoeq_off.gif" width="115" height="11"></a></div>
                      </td>
                    </tr>
                    <tr>
                      <td><center>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" -->
                        <div align="center"><br>
                          <img src="../fr/images/scrapbook.gif" width="321" height="50"> 
<br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center"><b>Fanmesse in Orlando: Siegerliste</b>
                                    </div>
                                    <p align="center"><br>
                                      <b>Live-Quest-Gewinner</b><br>
                                      Team X (winning team)<br>
                                      Christy and Brian Lube<br>
                                      Mark Howard<br>
                                      Dawn Walker<br>
                                      John Bockover<br>
                                      Tony Crocker<br>
                                      Tim Padawer<br>
                                      Heather Cpwan<br>
                                      John and Holly Cowan<br>
                                      Mike Judge<br>
                                      William Seemer<br>
                                      James Miller<br>
                                      Tina Stafford</p>
                                    <p align="center"><b>Die Gewinner der Verlosung</b><br>
                                      James Imlay<br>
                                      Faye Johnston<br>
                                      Bud Anderegg<br>
                                      Glen Smith<br>
