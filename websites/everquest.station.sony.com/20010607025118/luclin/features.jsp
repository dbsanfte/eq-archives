...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">92688 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="1" background="images/sub_01_t.jpg"><img src="images/sub_feat_01.jpg" width="260" height="59"></td>
  ...
  <tr>
    ...
    <td><img src="images/sub_feat_02.jpg" width="260" height="29"></td>
  ...
  <tr>
    ...
    <td width="100%" valign="top" align="center"><br>
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <p><font color="#FFFFFF" size="-1">Long ago, the great crystalline dragon Veeshan scarred Norrath and deposited her brood. Shortly thereafter, the gods made a pact to divide up the lands, each wanting to stake their claim with creatures of their own creation. </font></p>
            <p><font color="#FFFFFF" size="-1">Luclin watched from the shadows while the other gods went about making order out of chaos in their own twisted ways. She saw the meeting, the petty bickering, and the various power plays for which the gods have always been known. Abandoning Norrath, Luclin claimed the barren and forgotten ringed rock orbiting the planet for her own. Unopposed and through the sheer power of her will and magic, she gave life to the moon that now bears her name.</font></p>
            <p><font color="#FFFFFF" size="-1">In addition to the creations of the Mistress of Shadows, the moon of Luclin has since become home to several of Norrath&#146;s races, either by choice or by force. The Combine Empire, once powerful and nearly all encompassing, lies on Luclin, split and now a shadow of its former power. The Shissar, once the bane of Kunark, fled the deadly Green Mist and sealed themselves behind the hard vacuum of The Grey. The Vah Shir (Kerrans) were deposited forcefully by the Erudites in the disastrous test of the great weapon that created the abyss now known as The Hole. </font></p>
            <p><font color="#FFFFFF" size="-1">The moon of Luclin is in perfect balance -- one side bathed forever in light, and the other steeped in darkest night. The earliest arrivals felt an eerie and disturbing presence when approaching the Twilight between the two areas. Those not native to the moon quickly learned to avoid these dangerous lands. Ironically, it is said that those of good and honest nature made their homes in the darkness, and those of a darker nature chose the light.</font></p>
            <p><font color="#FFFFFF" size="-1">EverQuest&reg;: The Shadows of Luclin&#153;, projected to be available in December 2001, expands the EverQuest universe yet again and is poised to provide some mind blowing enhancements and additions to the current game!</font></p>
            <blockquote>
              <p><font color="#FFFFFF" size="-1">&middot; Eerie moonscape reveals over 25 new adventure zones including a new starting city<br>
            &middot; All new, highly detailed player-character models<br>
            &middot; Massively enhanced 3D graphics engine<br>
            &middot; Introducing an all-new player character race: The Vah Shir (Kerrans)<br>
            &middot; And an all-new player character class: The Beastlord<br>
            &middot; Additional non-level-based advancement options for those at level 60<br>
            &middot; Discover challenging new quests, items to trade and sell, NPCs and more! </font>
            </p>
            </blockquote>
          </td>
        </tr>
