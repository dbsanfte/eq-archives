...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_sandiego_fr.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="123,46,255,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/scrapbook_sandiego_fr.jsp');">
...
class="bold">- La Fan Faire est la rencontre de deux mondes, le monde du jeu et le Monde réel. La Fan Faire de ce Printemps à San Diego fut le théâtre de deux événements spéciaux, la Real Life Quest et un mariage jeu de rôle.</span></p>
                                      <p><a href="denise_fr.jsp" 
class="bold2">Comment on devient Firiona
...
/contemple les joueurs présents</a><span class="bold"> - Le gnoll préféré de tous, Fippy, était à la Fan Faire de San Diego et s'y est bien amusé. Lisez ici ses réflexions sur la Faire et ses participants... et ne vous en faites pas, pour un gnoll, il est très éloquent.</span></p>-->
                                      <p align="center" ><b><font color="#
000000" size="3"><a 
href="scrapbook_dallas_photos_fr.jsp" target="_top" class="bold2"><font size="3">L'Album 
                                        photos</font> </a></font></b> </p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
