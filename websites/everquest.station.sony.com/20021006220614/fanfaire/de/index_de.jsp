...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="53,46,124,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/index_de.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="128,46,246,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/de/index_de.jsp');">
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            <div align="center" class="bold">Vielen Dank f&uuml;r Ihren Besuch 
              an der Fanmesse in Seattle. Bitte schauen Sie ab und zu hier vorbei 
              um mehr &uuml;ber k&uuml;nftige Fanmessen zu erfahren. <br>
            </div>
            <p align="center">&nbsp; </p>
            <p align="center">&nbsp; </p>
