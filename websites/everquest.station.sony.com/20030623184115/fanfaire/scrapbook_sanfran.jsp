	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_sanfran.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_sanfran.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_sanfran.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  ...
                  <p align="justify" class="text"><a class="links" href="report_sanfran.jsp">Confessions 
                    of a Fan Faire Newbie </a> - This is the story of an over-forty 
                    guy&#8217;s first-time adventures at the EverQuest San Francisco 
                    Fan Faire, proving once again that EQ is a game for adults 
                    of all ages. </p>
                  <p align="justify" class="text"><a href="media/EQ_FanFaire_SanFrancisco200.mov" class="links">San 
                    Francisco Fan Faire Movie </a> - Relive the events and excitement 
                    of the EverQuest Fan Faire.</p>
                  <p align="center" class="text"><a href="scrapbook_sanfran_photos.jsp" class="links">Photo 
                    Gallery</a></p>
                  </td>
              </tr>
            </table>
