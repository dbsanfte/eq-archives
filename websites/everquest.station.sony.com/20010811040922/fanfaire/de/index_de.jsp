...
<html><!-- #BeginTemplate "/Templates/indexpage_de.dwt" -->
<head>
...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">103872 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
...
<!--**********************************************-->
                         ...
                         <td><a href="http://www.station.sony.com/services/stationid.jhtml" target="_blank" onClick="open_servwin('http://www.station.sony.com/services/stationid.jhtml');return false">
                            <img src="/common/images/global_nav/de//nav_comstation.gif" width="47" height="15" border="0" alt="" vspace=2>
                            <img src="/common/images/global_nav/de//nav_dish.gif" width=15 height="15" border=0 alt="" vspace=2>
                          </a></td>
...
//-->
	...
	<a href="http://www.station.sony.com/store" onMouseOut="nd()" onMouseOver="return overlib('Dieser Link leitet Sie an eine englische Seite weiter.')" target="_top">Geschäft</a> |
...
<table width="781" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td width="148" valign=top height="507"> 
              ...
              <tr>
                <td>
                  <table width="151" border="0" cellspacing="0" cellpadding="0" background="">
                    ...
                    <tr >
                      <td ><a class=menu ID="link1" STYLE="width:150;height:18" href="index_de.jsp" onMouseOut="MM_swapImgRestore(); link1.className='menu'; return true" onMouseOver="MM_swapImage('Image3','','../images/diamond_on.gif',1); link1.className='menuGlow'; return true"><img name="Image3" border="0" src="../images/diamond_off.gif.gif" width="14" height="15" align="texttop" hspace="5"><span class="menu">Home</span></a></td>
                    </tr>
                    <tr >
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>
            <div align="center"><a href="http://www.ubisoft.com" target="_blank"><br>
              <img src="images/ubisoftlogo.jpg" width="102" height="42" border="0"></a></div>
          </td>
        </tr>
      </table>
    </td>
    <td valign=top height="507" width="643">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="../images/photos.jpg" width="604" height="67"></td>
        </tr>
      </table>
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          <td width="398" valign="top">
            <div align="center">
              <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/fanfaire.jpg" width="228" height="213" align="top" vspace="7"></p>
            </div>
          </td>
          <td width="206" valign="top"><!-- #BeginEditable "right" --><br>
            <br>
            
            <div align="center">
              <p class="bold"><br>
                Die europ&auml;ische Fanmesse<br>
                Chateau de Malesherbes -- Paris, Frankreich<br>
                Samstag, den 15. September 2001</p>
              <p class="bold">Die Teilnahme an diesem Anlass kostet $85. Die Fanmesse 
                wird in englisch abgehalten. </p>
              <p class="bold">Die Registrierung ist nun er&ouml;ffnet.</p>
              <p class="bold">Wegbeschreibung zur Fanmesse<br>
              <p class="bold"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td>
                                          
                    <div align="center"><a href="plan_RER.jsp" class="bold2">Anreise per Zug</a></div>
                                        </td>
                                        <td>
                                          <div align="center"><a href="bycar.jsp" class="bold2">Anreise per Auto</a></div>
                                        </td>
                                      </tr>
                                    </table>
              <p class="bold"><br>
