...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/faq_esp.jsp?null');">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><!-- #BeginEditable "content2" --> 
                        <div align="center"><br>
                          <img src="images/faq.gif" width="407" height="50"> <br>
                        </div>
                        <!-- #EndEditable --></td>
                    </tr>
                    <tr> 
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      </b></font> 
                                      <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><span class="bold3">&iquest;Qu&eacute; 
                                        es una Fan Faire?</span><span class="bold"> 
                                        <br>
                                        La Fan Faire de EverQuest es un encuentro 
                                        auspiciado por Verant, dise&ntilde;ado 
                                        para brindarles a los jugadores la posibilidad 
                                        no s&oacute;lo de conocerse entre s&iacute;, 
                                        sino de conocer a muchas de las m&aacute;s 
                                        importantes personalidades de Verant. 
                                        Se trata de una gran oportunidad para 
                                        asociar un rostro y una persona real con 
                                        un avatar online. Si bien los participantes 
                                        tendr&aacute;n muchas oportunidades de 
                                        relacionarse libremente y hacer nuevos 
                                        amigos, tambi&eacute;n podr&aacute;n participar 
                                        en varios paneles de debate y atracciones 
                                        en vivo basadas en los juegos.</span></b></font> 
                                      </div>
                                      <p align="justify" class="bold"><span class="bold3">&iquest;D&oacute;nde 
                                        y cu&aacute;ndo se realizan las Fan Faires?</span><br>
                                        Las Fan Faires se realizan en diferentes 
                                        localidades cada 3 o 4 meses. Tratamos 
                                        de realizarlas en lugares donde haya espacio 
                                        para albergar la mayor cantidad de jugadores 
                                        posible. Actualmente, nuestro objetivo 
                                        es realizar al menos una Fan Faire por 
                                        a&ntilde;o en las costas este y oeste 
                                        de Estados Unidos, as&iacute; como en 
                                        alguna localidad ubicada en el centro 
                                        de dicho pa&iacute;s. Cada cierto tiempo, 
                                        y mediante encuestas en este sitio web, 
                                        podemos solicitar aportaciones de nombres 
                                        de futuras localidades donde se puedan 
                                        llevar a cabo las Fan Faires. </p>
                                      <p align="justify" class="bold"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><span class="bold3">&iquest;Qu&eacute; 
                                        incluye el pago de la inscripci&oacute;n?</span><span class="bold"> 
                                        <br>
                                        El viernes por la noche podr&aacute;s 
                                        asistir, junto a otros jugadores, a una 
                                        recepci&oacute;n privada. El s&aacute;bado 
                                        podr&aacute;s conocer a los representantes 
                                        de Verant, adem&aacute;s de obtener premios 
                                        mediante la participaci&oacute;n en concursos 
                                        y sesiones de dibujo. Asimismo, podr&aacute;s 
                                        asistir a paneles de debate con representantes 
                                        de EQ. El s&aacute;bado por la noche habr&aacute; 
                                        una cena y los participantes recibir&aacute;n 
                                        una camiseta de edici&oacute;n limitada. 
                                        &iexcl;Adem&aacute;s, vivir&aacute;s la 
                                        experiencia &uacute;nica de conocer a 
                                        otros cientos ciudadanos de Norrath!</span></b></font> 
                                      </p>
                                      <p align="justify" class="bold"><span class="bold3">No 
                                        podr&eacute; llegar a tiempo para la inscripci&oacute;n 
                                        anticipada. &iquest;A&uacute;n as&iacute; 
                                        puedo obtener mi Pasaporte de jugador 
                                        e ingresar cuando llegue?</span><br>
                                        S&iacute;&#133; s&oacute;lo debes inscribirte 
                                        al llegar. </p>
                                      <p align="justify" class="bold"><span class="bold3">&iquest;Los 
                                        ni&ntilde;os pueden asistir a este encuentro?</span> 
                                        <br>
                                        S&iacute;, los ni&ntilde;os pueden asistir 
                                        a este encuentro pero deben hacerlo acompa&ntilde;ados 
                                        por un adulto. El precio para los ni&ntilde;os 
                                        es el mismo que para los adultos. </p>
                                      <p align="justify" class="bold"><span class="bold3">Tanto 
                                        mi esposa como yo jugamos EQ. &iquest;Es 
                                        correcto que uno de nosotros ingrese como 
                                        invitado?</span><br>
                                        No. Un invitado es alguien que no juega 
                                        EQ. Cada jugador debe inscribirse de forma 
                                        individual para obtener su Pasaporte de 
                                        jugador personalizado.</p>
                                      <p align="justify" class="bold"><span class="bold3">Mi 
                                        esposa no juega EQ pero desea acompa&ntilde;arme 
                                        al encuentro. &iquest;Cu&aacute;l es el 
                                        precio que debe pagar alguien que no juega?</span> 
                                        <br>
                                        El precio para alguien que no juega a 
                                        EQ es igual al que debe pagar alguien 
                                        que asiste al encuentro y s&iacute; juega, 
                                        ya que los gastos son los mismos. Solo 
                                        ingr&eacute;salos como tus invitados en 
                                        el formulario de inscripci&oacute;n. </p>
                                      <p align="justify" class="bold"><span class="bold3">&iquest;Qu&eacute; 
                                        informaci&oacute;n me pueden dar acerca 
                                        del alojamiento?</span> <br>
                                        Cada participante debe efectuar sus propios 
                                        preparativos de viaje y alojamiento. Tambi&eacute;n 
                                        puedes aprovechar los arreglos que hemos 
                                        hecho con el hotel que alojar&aacute; 
                                        a nuestro grupo.</p>
                                      <!--<p align="justify" class="bold"><span class="bold3">&iquest;Qu&eacute; 
                                        tipo de premios se otorgar&aacute;n por 
                                        los dibujos? </span><br>
                                        &iexcl;Los premios de los concursos ser&aacute;n 
                                        tesoros relacionados con el juego! &iexcl;Si 
                                        tienes la suerte de estar entre los vencedores, 
                                        recibir&aacute;s un art&iacute;culo que 
                                        s&oacute;lo se puede obtener en una Fan 
                                        Faire oficial!</p>-->
                                      <p align="justify" class="bold"><span class="bold3">¿Qué ocurrirá si debo cancelar la inscripción? ¿Obtendré un reembolso?</span><br>
                                        Si desea cancelar su inscripción, envíe 
                                        un mensaje de correo electrónico con su 
                                        petición a <a href="mailto:carchuleta@soe.sony.com" class="bold3">carchuleta@soe.sony.com</a>. 
                                        Por favor, incluya su nombre de inscripción 
                                        cuando cancele la inscripción. Se realizarán 
                                        reembolsos sólo hasta que finalice el 
                                        plazo de inscripción .</p>
                                      <p align="justify" class="bold"><span class="bold3">Yo 
                                        soy gu&iacute;a. &iquest;Debo registrarme 
                                        con mi nombre de gu&iacute;a o con mi 
                                        nombre de jugador? </span><br>
                                        Por favor, dir&iacute;gete de forma peri&oacute;dica 
                                        al consejo de gu&iacute;as para obtener 
                                        informaci&oacute;n acerca de este tema. 
                                      </p>
                                      <p align="center" class="bold3"><span class="bold">Si 
                                        tienes alguna otra consulta,</span><a href="mailto:carchuleta@soe.sony.com" class="bold3"> 
                                        escribele a Cindy</a><br>
                                      </p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
