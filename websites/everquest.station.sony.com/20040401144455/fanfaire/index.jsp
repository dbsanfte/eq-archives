    ...
    <td width="606" background="images/right_bg.jpg"> <table width="604" border="0" cellspacing="0" cellpadding="0" height="100%" background="">
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table border="0" cellspacing="0" cellpadding="0" background="images/homePageBG.jpg">
              <tr>
              <td><img src="images/homePageAnimated.gif" alt="" width="596" height="438" border="0"></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
              <tr> 
                <td valign="top"> <p class="text">Sony Online Entertainment is 
                    proud to announce the 5th Anniversary Fan Faire! We will be 
                    hosting the event in Las Vegas, Nevada, at the Las Vegas Hilton 
                    on April 1-4, 2004.</p>
                  <p>We have space at the Hilton to make this the largest Fan 
                    Faire ever! We'll be admitting up to 3,000 Norrathians to 
                    this Fan Faire, so register now to reserve your spot at this 
                    epic and unparallelled 5th Anniversary event. The price for 
                    this event is $100 for pre-registered attendees and $110 at 
                    the door.</p>
                </td>
              </tr>
            </table>
