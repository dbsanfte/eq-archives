	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/life.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/life.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/life.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content1" --> 
            <table width="584" border="0" cellspacing="10" cellpadding="0">
              ...
              <tr> 
                <td>
                  <p align="center"><span class="textBold">EverQuest 
                    Meets Real Life</span></p>
                  <p class="bold"><span class="text"><br>
                    The San Diego Fan Faire was host to the first-ever live EverQuest 
                    roleplay wedding. Madolina, a lovely half elf bard, married 
                    her sweetheart Baldric, a barbarian warrior, before a crowd 
                    of nearly 1200 guests. Both are from the Xegony server. Asking 
                    for the blessings of their gods Erollisi Marr and the Tribunal, 
                    the two pledged their love to one another and exchanged rings. 
                    Some in the audience were moved to tears as the bride and 
                    groom were pronounced Baldric and Madolina Greyhaven, and 
                    toasted with champagne and cheers. When asked where they would 
                    honeymoon, the couple declined to say, but given the drizzly 
                    and chilly San Diego day, both confessed to wanting to go 
                    someplace warm!</span></p>
                  <p class="bold"><span class="text">The Real Life Quest has become 
                    an extremely popular mainstay at Fan Faire, and the name nearly 
                    explains it all. Players are broken into groups by server, 
                    and asked to pick a team name. They are then presented with 
                    mini-quests to complete that are scattered about-in this case-the 
                    Land of SheratonHotel. For this Fan Faire, participants had 
                    to collect platinum coins in order to buy six items to trade 
                    to NPCs for a greater item to win. </span></p>
                  <p class="bold"><span class="text">Approximately 120 teams vied 
                    for first place, and the competition proved fierce. Confronting 
                    Necromancers, Druids, Wyverns, and other NPCs, the teams were 
                    offered clues to help them complete the quest. Hopping through 
                    the halls of SheratonHotel was a white rabbit pleading for 
                    help in retrieving her lost items. A bard sang by the dining 
                    hall, while a Necromancer and his pet stood coolly aloof, 
                    only helping those who gave him the respect he demanded. There 
                    was even a report of a Festering Hag that came out of the 
                    shadows to offer a clue, while Pixies played tricks on passersby. 
                    As the Live Quest came down to its final minutes, many were 
                    scrambling to put the last few clues together.</span></p>
                  <p class="bold"><span class="text">At 3:30 the Quest ended. 
                    Tension was high as all anxiously awaited the announcement 
                    of the winners. The Baltimore Fan Faire was first to see winners 
                    rewarded with actual in-game items, the Staff of the Gathering 
                    or the Sword of the Gathering. The in-game prizes proved unanimously 
                    popular and were part of the rewards in San Diego. A roar 
                    erupted from the crowd as Team Wolf from the Seventh Hammer 
                    server was announced the official winner, and each member 
                    was awarded either the coveted Sword or Staff as their prizes.<br>
                    </span></p>
                  <p align="left" class="bold"><span class="text">Written by: 
                    Tessa Pier (<a href="mailto:tpier@soe.sony.com" class="links">tpier@soe.sony.com</a>)<br>
                    Edited by: Clayton Kroh (<a href="mailto:ckroh@soe.sony.com" class="links">ckroh@soe.sony.com</a>)</span></p>
                  <p></p>
                </td>
              </tr>
            </table>
