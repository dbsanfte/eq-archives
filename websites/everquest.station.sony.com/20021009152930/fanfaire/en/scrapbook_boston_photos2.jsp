...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston_photos2.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston_photos2.jsp');">
                                    ...
                                    <div align="justify"> 
                                      <table width="95%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td valign=top> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=altec" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=altec','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/altec_thumb.jpg" width="200" height="150" border="0"><br>
                                                Altec Lansing <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          ...
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=banner" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=banner','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/banner_thumb.jpg" width="200" height="150" border="0"><br>
                                                Fan Faire Banner <br>
                                                </a></p>
                                              <br>
                                            </center>
                                        ...
                                        <tr> 
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=brell" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=brell','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/brell_thumb.jpg" width="200" height="150" border="0"><br>
                                                LFG <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          ...
                                          <td valign=top> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=costume_a" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=costume_a','','width=480,height=640'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/costume_a_thumb.jpg" width="150" height="200" border="0"><br>
                                                Rare Spawn <br>
                                                </a></p>
                                              <br>
                                            </center>
                                        ...
                                        <tr> 
                                          <td> 
                                            <div align="center"> 
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=crealm" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=crealm','','width=480,height=640'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/crealm_thumb.jpg" width="150" height="200" border="0"><br>
                                                Casters Realm <br>
                                                </a></p>
                                              <br>
                                            </div>
                                          ...
                                          <td valign=top> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=crowd_lower" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=crowd_lower','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/crowd_lower_thumb.jpg" width="200" height="150" border="0"><br>
                                                Hill Giant Perspective <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          </td>
                                        ...
                                        <tr> 
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=duck" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=duck','','width=480,height=640'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/duck_thumb.jpg" width="150" height="200" border="0"><br>
                                                An Epic? <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          ...
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=foundry" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=foundry','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/foundry_thumb.jpg" width="200" height="150" border="0"><br>
                                                Fellowship Foundry <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          </td>
                                      ...
                                      <p align="center"><a href="scrapbook_boston_photos3.jsp" class="bold2">Page 
                                        3</a></p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
