...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">85217 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                          ...
                          <tr> 
                            <td width="98%"  background="images/translucent2.gif" valign=top height="291"> 
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->								    <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                    ...
                                    <p align="justify" class="bold"><span class="bold2">Where and when are the Fan Faire's held?</span><br>
                                    ...
                                    <p align="justify" class="bold"><span class="bold2">Will there ever be a Fan Faire outside the US?</span><br>
                                       We are very interested in hosting Fan Faires internationally.  Rest assured we are looking into the possibilities.
 </p>
                                    <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><span class="bold2">What do I get for my registration fee?</span><span class="bold"> <br>
                                      You will be attending a private reception with other players Friday evening. Then on Saturday, you will be able to meet representatives from Verant. There will be contests and drawings for prizes. You will be able to attend discussion panels with EQ representatives. You will get a limited edition T-shirt and be served dinner Saturday evening. You will also get the unique experience of meeting hundreds of other Norrathian citizens!</span></b></font>
                                      </div>
                                    <p align="justify" class="bold"><span class="bold2">I can't get there in time for the early registration. Can I still get my Player Passport and get in when I arrive?</span><br>
                                        Yes&#133; just check in when you get there. </p>
                                    <p align="justify" class="bold"><span class="bold2">Can children attend this event?</span> <br>
                                    ...
                                    <p align="justify" class="bold"><span class="bold2">My wife and I both play EQ.  Should we list one of us as a guest?</span><br>
                                    ...
                                    <p align="justify" class="bold"><span class="bold2">My spouse does not play EQ but wants to come with me. What is the fee for someone that does not play?</span> <br>
                                    ...
                                    <p align="justify" class="bold"><span class="bold2">What about my hotel accommodations?</span> <br>
                                        You are responsible for making your own hotel and travel arrangements. You might want to take advantage of the arrangements we have made with the hosting hotel for our group.</p>
                                    <p align="justify" class="bold"><span class="bold2">What kinds of prizes will be offered for the drawings? </span><br>
                                    ...
                                    <p align="justify" class="bold"><span class="bold2">I have to cancel my plans. Can I get a refund?</span><br>
                                        Refunds can be issued only until the registration deadline.</p>
                                    <p align="justify" class="bold"><span class="bold2">I am a guide. Do I register under my guide name or my player name? </span><br>
                                        Please refer to the guide board periodically for information on this. </p>
