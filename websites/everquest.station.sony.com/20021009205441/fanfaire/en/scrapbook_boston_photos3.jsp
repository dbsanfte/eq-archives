...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston_photos3.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/en/scrapbook_boston_photos3.jsp');">
                                    ...
                                    <div align="justify"> 
                                      <table width="95%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td valign=top> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=infant" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=infant','','width=480,height=640'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/infant_thumb.jpg" width="150" height="200" border="0"><br>
                                                EQ Infant <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          ...
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=massage" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=massage','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/massage_thumb.jpg" width="200" height="150" border="0"><br>
                                                Halfling Therapy <br>
                                                </a><br>
                                              </p>
                                            </center>
                                        ...
                                        <tr> 
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=quest" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=quest','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/quest_thumb.jpg" width="200" height="150" border="0"><br>
                                                Group Effort <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          ...
                                          <td valign=top> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=ranger" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=ranger','','width=480,height=640'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/ranger_thumb.jpg" width="150" height="200" border="0"><br>
                                                Taking Aim <br>
                                                </a></p>
                                              <br>
                                            </center>
                                        ...
                                        <tr> 
                                          <td> 
                                            <div align="center"> 
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=registration" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=registration','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/registration_thumb.jpg" width="200" height="150" border="0"><br>
                                                Registration <br>
                                                </a></p>
                                              <br>
                                            </div>
                                          ...
                                          <td valign=top> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=rpgwear" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=rpgwear','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/rpgwear_thumb.jpg" width="200" height="150" border="0"><br>
                                                RPGwear <br>
                                                </a></p>
                                              <br>
                                            </center>
                                        ...
                                        <tr> 
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=welcome" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=welcome','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/welcome_thumb.jpg" width="200" height="150" border="0"><br>
                                                Welcome <br>
                                                </a></p>
                                              <br>
                                            </center>
                                          ...
                                          <td> 
                                            <center>
                                              <p><a href="screenshots/ff_boston/screenshots.jsp?id=wwolf" onClick="MM_openBrWindow('screenshots/ff_boston/screenshots.jsp?id=wwolf','','width=640,height=480'); return false;" target="_blank" class="bold2"><img src="screenshots/ff_boston/wwolf_thumb.jpg" width="200" height="150" border="0"><br>
                                                White Wolf <br>
                                                </a></p>
                                              <br>
                                            </center>
                                      ...
                                      <p align="center"><a href="scrapbook_boston.jsp" class="bold2">Back 
                                        to Scrapbook</a></p>
                                    </div>
                                    <!-- #EndEditable --></td>
                                </tr>
