...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;">104315 Players Online</div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
                                ...
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->								    
                                    <div align="justify"><font color="#000000" face="Arial, Helvetica, sans-serif" size="2"><b><br>
                                      <span class="bold2">What is a Fan Faire?</span><span class="bold"> <br>
                                      The EverQuest Fan Faire is a Verant sponsored event designed to allow players the chance not only to meet one another, but also to meet many of the more prominent Verant personalities. Either way, it's a great opportunity to place a face and a real person with the online avatar. Though attendees will have plenty of opportunity to mingle freely with one another and make new friends, they'll also have the chance to participate in a number of panel discussions and game-themed live events. </span></b></font>
                                      <p class="bold"><span class="bold2">Where and when are the Fan Faire's held?</span><br>
                                        Fan Faires are held in various locations and occur every 3-4 months. We try to arrive at locations that will accommodate as many players as possible. Our current goal is to hold at least 1 Fan Faire per year on the US East and West coasts as well as a central location in the United States. Every so often, we may solicit your input on future locations of Fan Faires via polls on this site. </p>
                                      <p class="bold"><span class="bold2">Can children attend this event?</span> <br>
                                        Children can attend this event but all minors must be accompanied by an adult. The cost for children is the same as for adults. </p>
                                      <p class="bold"><span class="bold2">My wife and I both play EQ. Should we list one of us as a guest?</span><br>
                                        No. A guest is someone that does not play EQ. Each player should register individually to get their personalized Player Passport.</p>
                                      <p class="bold"><span class="bold2">My spouse does not play EQ but wants to come with me. What is the fee for someone that does not play? </span><br>
                                        The fee for someone that does not play EQ is the same for those attending the event that do. We still have to meet all of our expenses for all that attend. Just list them as your guest on the registration form. </p>
                                      <p class="bold"><span class="bold2">What about my hotel accommodations?</span> <br>
                                        You are responsible for making your own hotel and travel arrangements. </p>
                                      <p class="bold"><span class="bold2">What kinds of prizes will be offered for the drawings?</span> <br>
                                        The prizes for the contests will be in-game treasures! Should be among the victors, you will be awarded an item that can only be attained at an Official Fan Faire!</p>
                                      <p class="bold"><span class="bold2">I have to cancel my plans. Can I get a refund?</span><br>
                                        Refunds can be issued only until the registration deadline.</p>
                                      <p><span class="bold2">I am a guide. Do I register under my guide name or my player name?</span><span class="bold"> <br>
                                        Please refer to the guide board periodically for information on this. <br>
                                        </span>
                                      </p>
                                    </div>
                                    <p align="center" class="bold2"><span class="bold">If you still have questions,</span><a href="mailto:fanfaire@station.sony.com" class="bold2"> email Cindy</a><br>
                                      </p>
                                    <!-- #EndEditable --></td>
                                </tr>
                              </table>
