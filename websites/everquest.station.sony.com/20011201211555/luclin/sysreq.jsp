...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="100%" valign="top" align="center">
      <table width="95%" border="0" cellspacing="10" cellpadding="0">
        <tr>
          <td background="">
            <div align="center">
			  <a href="javascript:openWindow('screenshots/112101b/01.html','819')"><img src="screenshots/112101b/EQ000003_lo.jpg" width="200" height="150" border="0"></a><br>
              <b><i><font size="-2">Before</font></i></b><br>
			  <a href="javascript:openWindow('screenshots/112101b/02.html','819')"><img src="screenshots/112101b/EQ000012_lo.jpg" width="200" height="150" border="0"></a><br>
              <b><i><font size="-2">After</font></i></b><br>
              <a href="javascript:openWindow('screenshots/112101b/05.html','819')"><img src="screenshots/112101b/potential_DEF_old_ss12_lo.jpg" width="200" height="150" border="0"></a><br>
              <b><i><font size="-2">Before</font></i></b><br>
			  <a href="javascript:openWindow('screenshots/112101/02.html','819')"><img src="screenshots/112101/EQ000142_lo.jpg" width="200" height="150" border="0"></a><br>
              <b><i><font size="-2">After</font></i></b><br>
              <a href="javascript:openWindow('screenshots/112101b/06.html','819')"><img src="screenshots/112101b/HighelfFemale_lo.jpg" width="200" height="150" border="0"></a><br>
              <b><i><font size="-2">Before</font></i></b><br>
			  <a href="javascript:openWindow('screenshots/112101/07.html','819')"><img src="screenshots/112101/EQ000190_lo.jpg" width="200" height="150" border="0"></a><br>
              <b><i><font size="-2">After</font></i></b>
              <br>
              <a href="javascript:openWindow('screenshots/112101b/03.html','819')"><img src="screenshots/112101b/EQ000108_lo.jpg" width="200" height="150" border="0"></a><br>
              <br>
			  <a href="javascript:openWindow('screenshots/112101b/04.html','819')"><img src="screenshots/112101b/EQ000137_lo.jpg" width="200" height="150" border="0"></a><br>
              <br>
			  <a href="javascript:openWindow('screenshots/112101/10.html','819')"><img src="screenshots/112101/EQ000229_lo.jpg" width="200" height="150" border="0"></a><br>
              <br>
			  <a href="javascript:openWindow('screenshots/112101/13.html','819')"><img src="screenshots/112101/EQ000271_lo.jpg" width="200" height="150" border="0"></a>
             </div>
          </td>
          <td background="" valign="top">
            <div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><b>EVERQUEST&reg;: THE SHADOWS OF LUCLIN&#153; - MINIMUM SYSTEM REQUIRMENTS<br>
              </b></font>
              </div>
            <p align="left"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="-1"><br>
                </font></p>
            <p align="left">Luclin tested video cards and system configurations - <i><b>Coming Soon</b></i></p>
            <p align="left">During final testing of EverQuest: The Shadows of Luclin, set for release December 4th, we have found it necessary to increase the minimum specifications for your hardware platform.  Here we will explain how these changes may affect your system's ability to run this expansion.  The new specifications are listed below:</p>
            <blockquote>
  ...
  <ul>
    ...
    <li>1.5 GB+ hard drive space<br>
      <i><br>
    Note: DirectX 8.0 or greater is required. System requirements subject to change as the game progresses.</i></li>
  </ul>
</blockquote>

            <blockquote>
              <p><b>Internet Play:</b><br>
              EverQuest is an internet-only game, requiring players to connect to Sony Online Entertainment servers via their own Internet connection for which they are responsible. Additional online fees and valid credit card required.</p>
            </blockquote>
            <p align="left">EverQuest: The Shadows of Luclin is unique as an expansion to an existing product.  Rather than simply more zones, more items, and more encounters, Shadows of Luclin goes several leaps further and includes an almost entirely new graphics engine, and with that engine, new player character models which change the &quot;look and feel&quot; of the world dramatically.</p>
            <p>In creating these new player characters, the goal was to provide the highest quality models ever seen in a first person game.  Every model was made extremely detailed, in many cases ten times the complexity of the original models in EQ.  Rather than simply &quot;catch up&quot; with current technology, Shadows of Luclin raises the bar even higher.  </p>
            <p><b>Minimum Required RAM</b><br>
              The amount of memory required to display 40 all-new models with high quality textures, realistic bone structures, etc., greatly increased polygon counts and as such we have changed our minimum memory requirement to 256MB of RAM, and our recommended to 512MB of RAM.  </p>
            <p>Although technically below minimum specifications, EverQuest: The Shadows of Luclin WILL run with 128M of ram, and you will be able to see all the new zones, the new race (Vah Shir) and the new class (Beastlord) without much decrease in performance.  However, if you want to see all the new models you will need at least 256MB of RAM.  Even at 256MB you may need to modify new graphical options we will be providing.   If you want smooth performance and fast loading times, we recommend that you get 512MB of RAM.   </p>
            <p>Additional menus are added for those with 256MB of RAM to tune which models are loaded (among many other options we will be providing), further increasing performance.  For example, you may choose to see the Troll Male but not the Ogre Female.  Fewer new models will reduce the amount of memory EverQuest requires. </p>
            <p>We understand that this may be upsetting to those caught off guard by the increase in memory requirements.  But rather than reducing the detail of the character models we have in order to display them all at lower quality with 128MB RAM, with only minor improvements for players with 512MB of RAM, we felt it better to create models that would remain &quot;high quality&quot; for years to come.</p>
            <p><b>Hardware T&amp;L</b><br>
              Along with these changes, a new graphics engine which supports hardware T&amp;L is included.   If you have a graphics card with hardware T&amp;L, you should see much higher frame rates in all zones, not just Shadows of Luclin zones.  However, some older cards may have trouble displaying all the new player models with their increased polygon counts.  This is why we recommend a GeForce 2 or better video card.  See your video card manufacturer's website to determine if your card includes hardware T&amp;L support.  A list of models supported in EverQuest: The Shadows of Luclin will be presented on the official EverQuest website very soon.</p>
            <p>Again, no features of EverQuest: Shadows of Luclin will be lost even at 128M of RAM, except for the ability to see the new player models.  The rest of the rich world, along with the new graphics enhancements, will work.  The Shadows of Luclin still has more zones, more new NPCs, and more exciting encounters than any other expansion, as well as a new class AND a new race to enjoy.  As you upgrade your computer to 256MB and 512MB of RAM, and obtain future graphics cards, your EverQuest experience will be enhanced right along with them.</p>
            <p><i>Note:   The 450+ MB of hard drive space for the minimum requirement is needed for the installation of Shadows of Luclin.  The recommended 1.5+ GB of hard drive space is needed for the installation of Shadows of Luclin as well as the optional replacement of textures for the old world zones with the <a href="http://everquest.station.sony.com/luclin/features.jsp">new upgraded textures</a>.</i></p>
          </td>
        </tr>
      </table>
    </td>
