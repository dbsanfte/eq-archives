                ...
                <center>
                  <center>
                    ...
                    <table border="0" width="85%">
                      <tr> 
                        <td><font face="Arial, Helvetica, sans-serif">The following 
                          files are PDF versions of the printed manual included 
                          in the EverQuest: The Ruins of Kunark retail box. We 
                          recommend that all interested EverQuest players download 
                          these files and refer to them at their convenience. 
                          In order to view these files, you will need Adobe Acrobat 
                          Reader available at <a href="http://www.adobe.com/products/acrobat/readstep.html" target="_blank">www.adobe.com.</a> 
                          </font> 
                          <p></p>
                          <table width="75%" cellpadding="3" cellspacing="5" align="center">
                            <tr valign="bottom"> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_cover.pdf">Covers</a></font></td>
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch01.pdf">Contents&nbsp;&amp; 
                                Chapter&nbsp;1</a> </font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (0.4MB)</font></td>
                              <td nowrap width="285"> 
                                <p><font face="Arial, Helvetica, sans-serif" size="2">Table 
                                  of contents, </font><br>
                                  <font face="Arial, Helvetica, sans-serif" size="2">Chapter 
                                  1: </font><font face="Arial, Helvetica, sans-serif" size="2">Quick 
                                  Start. pp. 1-7 </font> </p>
                              </td>
                            </tr>
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch02.pdf">Chapter 
                                2 </a></font></td>
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch03.pdf">Chapter 
                                3 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.8MB)</font></td>
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch04.pdf">Chapter 
                                4 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.7MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch05.pdf">Chapter 
                                5 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.3MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch06.pdf">Chapter 
                                6 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (0.6MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch07.pdf">Chapter 
                                7 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.9MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/Man_ch08.pdf">Chapter 
                                8 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (0.3MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                          ...
                          <p><font face="Arial, Helvetica, sans-serif">In addition 
                            to the distributed PDF files, we've compiled a supplement 
                            that elaborates and corrects some issues in the printed 
                            manual. This supplement is available in both standard 
                            Text and MS-Word '97 DOC formats. In the near future, 
                            this supplement will be sent to your EverQuest directory 
                            during the patching process. We've included it here 
                            in order to allow you to view it prior to that occurring. 
                            </font></p>
                          <table width="75%" cellpadding="3" cellspacing="5" align="center">
                            <tr valign="bottom"> 
                              <td nowrap><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/manual_supplement.jsp">Manual&nbsp;Supplement.jsp</a></font></td>
                              <td> 
                                <center>
                                  <font face="Arial, Helvetica, sans-serif" size="2">(64KB) 
                                  </font> 
                                </center>
                              </td>
                              <td nowrap><font face="Arial, Helvetica, sans-serif" size="2">html 
                                page </font></td>
                            </tr>
                            <tr> 
                              <td width="97" nowrap><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/manual_supplement.txt">Manual&nbsp;Supplement.txt</a></font></td>
                              <td width="55"> 
                                <center>
                                  <font face="Arial, Helvetica, sans-serif" size="2">(34KB) 
                                  </font> 
                                </center>
                              </td>
                              <td nowrap><font face="Arial, Helvetica, sans-serif" size="2">text 
                                document</font></td>
                            </tr>
                            <tr> 
                              <td width="97" nowrap><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQManual_Supplement.doc">Manual&nbsp;Supplement.doc</a></font></td>
                              <td width="55"> 
                                <center>
                              ...
                              <td nowrap> 
                                <p><font face="Arial, Helvetica, sans-serif" size="2">Word 
                                  document</font></p>
                              </td>
                            </tr>
                          </table>
                          <p>The following links are to the manuals  for the EverQuest expansions: EverQuest: The Ruins of Kunark and EverQuest: The Scars of Velious.</p>
                          <table width="75%" cellpadding="3" cellspacing="5" align="center">
                            <tr valign="bottom"> 
                              <td nowrap><font face="Arial, Helvetica, sans-serif" size="2"><a href="../kunark/manual.jsp">The Ruins of Kunark</a></font></td>
                              <td> 
                                <center>
                                  <font face="Arial, Helvetica, sans-serif" size="2">NA</font>
                                </center>
                              </td>
                              <td nowrap><font face="Arial, Helvetica, sans-serif" size="2">html 
                                page </font></td>
                            ...
                            <tr> 
                              <td width="97" nowrap><nobr><a href="../velious/manual.jsp">The Scars of Velious</a></nobr></td>
                              <td width="55"> 
                                <center>
                                  <font face="Arial, Helvetica, sans-serif" size="2">NA</font> 
                                </center>
