...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="46,46,118,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/fr/event_fr.jsp?null');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" -->
                                    <div align="center"> 
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=1 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2> 
                                            <P ALIGN="CENTER" class="bold"><b>Vendredi 
                                              19 Avril</b> 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">18:00-20:00
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Arriv&eacute;e et 
                                              Inscription
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">20:00-22:00
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">R&eacute;ception
                                          </TD>
                                        </TR>
                                      </TABLE>
                                    </div>
                                    ...
                                    <div align="center"> 
                                      <TABLE BORDER CELLSPACING=1 CELLPADDING=1 WIDTH=337>
                                        <TR> 
                                          <TD VALIGN="TOP" COLSPAN=2> 
                                            <P ALIGN="CENTER" class="bold"><b>Samedi 
                                              20 Avril</b> 
                                          </TD>
                                        </TR>
                                        <TR> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">La Fan Faire commence&nbsp;!
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">13:30-15:30
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                        ...
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">16-17:15
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Atelier I
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                            <P class="bold">17:30-18:45
                                          </TD>
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">Atelier II
                                          </TD>
                                        </TR>
                                        <TR> 
                                          <TD WIDTH="36%" VALIGN="TOP"> 
                                          ...
                                          <TD WIDTH="64%" VALIGN="TOP"> 
                                            <P class="bold">D&icirc;ner et remise 
                                              des prix&nbsp;!
                                          </TD>
                                        </TR>
                                      </TABLE>
                                    </div>
                                    <P align="center" class="bold">Les ateliers 
                                      seront consacr&eacute;s &agrave; divers 
                                      sujets, dont la magie, la cr&eacute;ation 
                                      de guildes plus puissantes, la production, 
                                      les techniques commerciales et le d&eacute;veloppement 
                                      d'EverQuest.</P>
<!-- #EndEditable --></td>
                                </tr>
                              </table>
