...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">61,058 Players Online</div>
      ...
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="10">
        <tr> 
          <td height="100%" valign="top"><!-- #BeginEditable "Text" --> 
            <div align="center"><br>
              <p><img src="images/media_movies.jpg" alt="Movies" width="440" height="34" border="0"></p>
              <p>&nbsp;</p>
