	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/luclin.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/luclin.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/luclin.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                              ...
                              <td>
                                <table width="468" border="0" cellspacing="0" cellpadding="0" height="180" background="">
                                  ...
                                  <tr>
                                    ...
                                    <p><img src="new_images/luclin_banner.jpg" width="430" height="131"></p>
                                    <!-- InstanceEndEditable -->
                                    </td>
            ...
            <table width="467" border="0" cellspacing="0" cellpadding="0">
              <tr>
                    ...
                    <tr align="center"> 
                      ...
                      <td width="65%" align="left">The satellite of Luclin has been discovered, and now Norrathians can venture to the eerie moonscape in EverQuest&reg;: The Shadows of Luclin&#153;. This expansion pack  is playable by characters of all levels and provide s  thousands of online RPG fans with new zones, a new race and a new class, hundreds of new items, spells, and creatures to battle... all in addition to brand new character models supported by an enhanced 3D engine!</td>
                        <td width="35%"><a href="https://store.station.sony.com/hardgood.jsp?SKU=EQSOL-HG-SW1201-SHDWOF" target="_blank"><img src="new_images/luclin_box.gif" width="102" height="120" border="0"></a><br>
                          <a href="https://store.station.sony.com/hardgood.jsp?SKU=EQSOL-HG-SW1201-SHDWOF" target="_blank"><br>
                        Buy It!</a></td>
                    </tr>
                  ...
                  <table width="430" border="0" cellspacing="0" cellpadding="4">
                    ...
                    <tr align="center"> 
                      ...
                      <td><a href="javascript:openWindow('new_screenshots/sol/01.jsp','565')"><img src="new_screenshots/sol/01_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/sol/02.jsp','565')"><img src="new_screenshots/sol/02_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/sol/03.jsp','565')"><img src="new_screenshots/sol/03_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/sol/04.jsp','565')"><img src="new_screenshots/sol/04_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/sol/05.jsp','565')"><img src="new_screenshots/sol/05_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/sol/06.jsp','565')"><img src="new_screenshots/sol/06_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                      
                    <tr align="center"> 
                        
                      <td><a href="javascript:openWindow('new_screenshots/sol/07.jsp','565')"><img src="new_screenshots/sol/07_tn.jpg" width="202" height="70" border="0"></a></td>
                      <td><a href="javascript:openWindow('new_screenshots/sol/08.jsp','565')"><img src="new_screenshots/sol/08_tn.jpg" width="202" height="70" border="0"></a></td>
                    </tr>
                    
                  </table>
				  <p><center>
                                  <a href="http://www.esrb.org" target="_blank"><img src="images/ESRB.jpg" alt="Blood &amp; Gore
Violence
