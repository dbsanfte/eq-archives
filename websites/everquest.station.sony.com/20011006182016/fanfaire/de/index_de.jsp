...
<!-- End Sony Cross Nav -->
<nobr><div style="font-size: 8pt; width: 120px;"><font color=white>82767 Players Online</font></div></nobr>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="604" border="0" cellspacing="0" cellpadding="0" height="506">
        <tr>
          ...
          <td width="206" valign="top"><!-- #BeginEditable "right" -->
            <center class="bold">
              <p>Orlando, Florida wird Schauplatz f&uuml;r die n&auml;chste Everquest<sup>®</sup>-Fanmesse! 
                Kommen Sie mit uns am 19. - 20. Oktober ins <a href="http://www.omnirosen.com " class="bold2" target="_blank"> 
                The Rosen Centre</a>, nur ein paar Minuten von Disneyland und 
                vielen anderen großartigen Attraktionen entfernt. Mit unseren 
                Spezialtarifen für diesen Anlass, könnte dies der perfekte Zeitpunkt 
                sein, die ganze Familie mitzubringen und eine Menge Spaß zu erleben! 
              </p>
              <p><img src="../images/Disney%20logo.jpg" width="200" height="102"></p>
              <p><br>
                Die Registrierung schliesst am 7. Oktober 2001 um Mitternacht 
                pazifischer Zeit. Die Kosten sind $85. </p>
            </center>
            <div align="center"> 
              <p class="bold">Wenn Sie der Orlando-Fanmesse beiwohnen, k&ouml;nnen 
                Sie spezielle Eintrittskarten mit Rabatt f&uuml;r Disney World 
                erwerben! </p>
              <p class="bold">Der Vergn&uuml;gungspark hat gro&szlig;z&uuml;gigerweise 
                Eintrittskarten mit Rabatt f&uuml;r Fanmesse-Teilnehmer angeboten! 
                F&uuml;r Preisinformationen und um Karten zu bestellen, besuchen 
                Sie die Seite <a href="https://secure.hes-services.com/wdwticket/everquest.asp" onMouseOut="nd()" onMouseOver="return overlib('Dieser Link leitet Sie an eine englische Seite weiter.')" target="_blank" class="bold2">https://secure.hes-services.com/wdwticket/everquest.asp</a></p>
              <p class="bold"><br>
              </p>
            </div>
            <!-- #EndEditable --></td>
