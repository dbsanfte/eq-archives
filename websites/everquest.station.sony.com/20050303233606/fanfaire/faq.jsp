	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/faq.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/faq.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/faq.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="text">
              ...
              <tr>
                <td><p class="text"><strong>What is a Fan Faire?</strong> <br>
                    ...
                    one another, but also many of the more prominent SOE personalities. 
                    It's a great opportunity to meet the real people behind the 
                    online avatars and the game itself. Though attendees will 
                    have plenty of opportunity to mingle freely with one another 
                    and make new friends, they'll also have the chance to participate 
                    in a number of panel discussions and game-themed live events. 
                  </p>
                  <p class="text"><strong>What does this cost? </strong><br>
                    The Fan Faire registration costs $100 if you pre-register. 
                    If you do not pre-register, you can still get a ticket at 
                    the door for $110, plus Louisiana State and New Orleans local sales tax approximately 9%. This pass includes unlimited access to 
                    all the Fan Faire events. Please note that this cost DOES 
                    NOT include airfare/hotel accommodations.</p>
                  <p><strong>When and where are the Fan Faire events held?</strong><br>
                    ...
                    U.S. and occur twice a year: once in the Spring and once in 
                  ...
                  <p><strong>What do I get for my registration fee? </strong><br>
                    ...
                    weekend's worth of fun! On Friday evening, you'll get to attend 
                    a private reception with other players, hosted by SOE Staff. 
                    Then, on Saturday, you will be able to meet representatives 
                    from SOE and participate in any of several discussion panels 
                    with EQ representatives. Your registration allows you to participate 
                    in Saturday's Live Quest! There will be a costume contest 
                    and drawings for prizes, plus you will receive a T-shirt and 
                    be served dinner Saturday evening. And best of all, you will 
                    get the unique experience of meeting hundreds of other Norrathian 
                    citizens!</p>
                  ...
                  <p><strong>What if I need to cancel my registration? Can I get 
                    a refund?</strong><br>
                    To cancel your registration, please email your request to <a href="mailto:fanfaire@soe.sony.com" class="links">fanfaire@soe.sony.com</a>. Please include your Station name with your email. Refunds can only be issued before the close of registration. Once registration is closed we must guarantee the number of attendees with the venue hosting the event. After October 11th there will be no changes to registrations, cancellations, or refunds.
</strong></p>
                  ...
                  <p><strong>Can I wear a costume to Fan Faire?</strong><br>
                    Of course you can wear a costume! In fact, we encourage it. Unfortunately, the hotel does not allow weapons (steel, wood, or any other simulated weapon that may pose a danger to yourself or someone else) in any public area. If you are found with if you are found with a dangerous weapon in your possession in a public area, you will be asked to return the item to your room immediately.</p>
                  <p><br>
