...
<head>
<!-- #BeginEditable "title" --> 
<title>EverQuest: The Planes of Power - Screenshots</title>
<!-- #EndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/screenshots.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/power/screenshots.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/power/screenshots.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td><!-- #BeginEditable "header" --><img src="images4/headers_screenshots.jpg" width="577" height="51"><!-- #EndEditable --></td>
    ...
    <td background="images4/main_bg.jpg" valign="top"> <!-- #BeginEditable "Content" --> 
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> 
            <p align="center">&nbsp;</p>
            <p align="center"><img src="images/media_screenshots.gif" alt="Screenshots" width="440" height="34" border="0"></p>
            <p align="center" class="link">Get a glimpse of what awaits in the Planes of Power.</p>
            <table border="0" cellspacing="0" cellpadding="8" align="center">
              <tr> 
                <td><a href="image_pop.jsp?id=images/screenshots/Bat4.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Bat4.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Bat4.jpg" width="200" height="150" border="0"></a></td>
                <td><a href="image_pop.jsp?id=images/screenshots/Construct1.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Construct1.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Construct1.jpg" width="200" height="150" border="0"></a></td>
              </tr>
              <tr> 
                <td><a href="image_pop.jsp?id=images/screenshots/Construct4.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Construct4.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Construct4.jpg" width="200" height="150" border="0"></a></td>
                <td><a href="image_pop.jsp?id=images/screenshots/Gargoyle2.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Gargoyle2.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Gargoyle2.jpg" width="200" height="150" border="0"></a></td>
              </tr>
              <tr> 
                <td><a href="image_pop.jsp?id=images/screenshots/Gargoyle4.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Gargoyle4.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Gargoyle4.jpg" width="200" height="150" border="0"></a></td>
                <td><a href="image_pop.jsp?id=images/screenshots/Lepertoloth2.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Lepertoloth2.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Lepertoloth2.jpg" width="200" height="150" border="0"></a></td>
              </tr>
              <tr> 
                <td><a href="image_pop.jsp?id=images/screenshots/Lepertoloth3.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Lepertoloth3.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Lepertoloth3.jpg" width="200" height="150" border="0"></a></td>
                <td><a href="image_pop.jsp?id=images/screenshots/Tormentor1.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Tormentor1.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Tormentor1.jpg" width="200" height="150" border="0"></a></td>
              </tr>
              <tr> 
                <td><a href="image_pop.jsp?id=images/screenshots/Tormentor2.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/screenshots/Tormentor2.jpg','','width=1024,height=768'); return false;" target="_blank"><img src="images/screenshots/thumbs/Tormentor2.jpg" width="200" height="150" border="0"></a></td>
                <td><a href="image_pop.jsp?id=images/Justice_battle2.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/Justice_battle2.jpg','','width=800,height=640'); return false;" target="_blank"><img src="images/Justice_battle2_sm.jpg" width="188" height="150" border="0"></a></td>
              </tr>
              <tr> 
                <td> 
                  <div align="center"><a href="image_pop.jsp?id=images/flyman.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/flyman.jpg','','width=800,height=600'); return false;" target="_blank"><img src="images/flyman_tn.jpg" width="200" height="150" border="0"></a></div>
                </td>
                <td> 
                  <div align="center"><a href="image_pop.jsp?id=images/trollproc.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/trollproc.jpg','','width=800,height=600'); return false;" target="_blank"><img src="images/trollproc_thumb.jpg" width="200" height="150" border="0"></a></div>
                </td>
              </tr>
              <tr> 
                <td colspan="2"> 
                  <div align="center"><a href="image_pop.jsp?id=images/Justice_battle1.jpg" onClick="MM_openBrWindow('image_pop.jsp?id=images/Justice_battle1.jpg','','width=662,height=800'); return false;" target="_blank"><img src="images/Justice_battle1_sm.jpg" height="150" border="0"></a></div>
                </td>
              </tr>
            </table>
            <p class="link"><br>
