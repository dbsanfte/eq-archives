...
<body bgcolor="#000000" text="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/home_off.jpg','images/features_on.jpg','images/screenshots_on.jpg','images/concept_on.jpg','images/dungeons_on.jpg','images/lore_on.jpg')">
    ...
    <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td width="175" valign="top"> <table width="175" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><a href="dungeons.jsp?page=LDON%20Dungeon%20Index" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','images/dungeons_on.jpg',1)"><img src="images/dungeons_off.jpg" name="Image13" width="175" height="30" border="0"></a></td>
              </tr>
              <tr> 
                <td><a href="lore.jsp?page=LDON%20Lore%20Index" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image14','','images/lore_on.jpg',1)"><img src="images/lore_off.jpg" name="Image14" width="175" height="50" border="0"></a></td>
              </tr>
            </table></td>
          <td width="604" valign="top"><table width="604" border="0" cellpadding="0" cellspacing="0" class="text">
              ...
              <tr> 
                <td width="54" valign="top" background="images/content_sub_left_rpt.gif"><img src="images/content_sub_left_top.jpg" width="54" height="172"></td>
				 ...
				 <P>
<CENTER><IMG src="images/guk.jpg" border=0></CENTER>
<P></P>
      ...
      <table width="600" border="0" align="center" cellpadding="30" cellspacing="0">
        <tr>
          <td width="600"><div align="center"> 
              <p class="legal">EverQuest is a registered trademark and Lost Dungeons 
                of Norrath is a trademark of Sony Computer Entertainment America 
                Inc. &copy; 2003 Sony Computer Entertainment America Inc. All 
                rights reserved. </p>
              </div></td>
        </tr>
      </table>
