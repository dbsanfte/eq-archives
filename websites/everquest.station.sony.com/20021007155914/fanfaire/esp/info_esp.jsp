...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/info_esp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="151,46,219,63" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/esp/info_esp.jsp');">
                              ...
                              <table width="95%" border="0" cellspacing="0" cellpadding="8" background=../asdf align="center">
                                <tr> 
                                  <td><!-- #BeginEditable "content" --> 
                                    <p align="left"><br>
                                      <span class="bold">La Fan Faire de EverQuest 
                                      es todo un acontecimiento social realizado 
                                      varias veces por a&ntilde;o en distintas 
                                      regiones de todo el pa&iacute;s. La Fan 
                                      Faire est&aacute; dise&ntilde;ada para que 
                                      los jugadores de EverQuest puedan conocerse 
                                      en un ambiente divertido y relacionarse 
                                      con diversos empleados de SOE involucrados 
                                      en el juego. Aunque los participantes tendr&aacute;n 
                                      muchas oportunidades para relacionarse libremente 
                                      unos con otros y hacer nuevos amigos, tambi&eacute;n 
                                      podr&aacute;n participar en varios paneles 
                                      de debate y atracciones en vivo basadas 
                                      en los juegos. Los encuentros anteriores 
                                      incluyeron la proyecci&oacute;n de un episodio 
                                      real del juego en una gran pantalla y Live 
                                      Quests (misiones en vivo), en las que participantes 
                                      voluntarios representaron a diversos NPC 
                                      (personajes no jugadores), plantearon acertijos 
                                      y asignaron tareas a los dem&aacute;s jugadores. 
                                      Cada nueva Faire parece ser mejor y m&aacute;s 
                                      grande que la anterior. As&iacute; que, 
                                      &iquest;qui&eacute;n sabe qu&eacute; nos 
                                      depara el futuro?</span><br>
