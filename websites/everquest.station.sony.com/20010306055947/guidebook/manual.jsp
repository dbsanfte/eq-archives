...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">70438 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                      ...
                      <tr> 
                        <td><font face="Arial, Helvetica, sans-serif">The following 
                          ...
                          <table width="75%" cellpadding="3" cellspacing="5" align="center">
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH1.pdf">Contents&nbsp;&amp; 
                                Chapter&nbsp;1</a> </font></td>
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH2.pdf">Chapter 
                                2 </a></font></td>
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH3.pdf">Chapter 
                                3 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.8MB)</font></td>
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH4.pdf">Chapter 
                                4 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.7MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH5.pdf">Chapter 
                                5 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.3MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH6.pdf">Chapter 
                                6 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (0.6MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH7.pdf">Chapter 
                                7 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (1.9MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                            ...
                            <tr> 
                              <td width="71"><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/EQ_CH8.pdf">Chapter 
                                8 </a></font></td>
                              <td width="47"><font face="Arial, Helvetica, sans-serif" size="2"> 
                                (0.3MB)</font></td>
                              <td nowrap width="285"><font face="Arial, Helvetica, sans-serif" size="2"> 
                          ...
                          <table width="75%" cellpadding="3" cellspacing="5" align="center">
                            ...
                            <tr> 
                              <td width="97" nowrap><font face="Arial, Helvetica, sans-serif" size="2"><a href="media/manual_supplement.doc">Manual&nbsp;Supplement.doc</a></font></td>
                              <td width="55"> 
                                <center>
