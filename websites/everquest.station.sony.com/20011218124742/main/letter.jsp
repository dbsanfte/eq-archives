                      ...
                      <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr> 
                          ...
                          <td>
                            ...
                            <p>As we stated in our last Producer's letter back in March 2001, our priority is to focus strongly on communicating Customer Service policies to our customers and to better inform our player community about Customer Service in general.  At that time we posted our updated <a href="../support/policies/naming.jsp">Naming Policy</a>, and have recently posted our <a href="../support/security/secure.jsp">Account Security Statement</a>. We would now like to take the next step and post our <a href="../support/policies/reimbursement_policy.jsp">Reimbursement Policy</a> to clarify any misconceptions players may have regarding it. We have also created a <a href="../support/policies/reimbursement_faq.jsp">Reimbursement FAQ</a> to answer any questions you may have.  </p>
                            <p>Please take the time to familiarize yourself with our existing <a href="../support/policies/index.jsp">Game Policies</a>. And, in the near future we will be posting additional polices and FAQ's to better keep you informed. Our continued goal is to make it perfectly clear not only what we expect from you as player-citizens of Norrath, but also what you can count on from us here at SOE/Verant. </p>
                            <p>If you feel a GM is not adhering to any of our Customer Service policies, please feel free to email me directly at <a href="mailto:gscotto@station.sony.com">gscotto@station.sony.com</a>, or Michelle Butler, EQ Customer Service Manager, at <a href="mailto:mbutler@station.sony.com">mbutler@station.sony.com</a>.</p>
                            <p>Thank you very much,</p>
                            <p>George M. Scotto<br>
