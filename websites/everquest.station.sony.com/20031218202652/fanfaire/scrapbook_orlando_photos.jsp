	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_orlando_photos.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_orlando_photos.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://everquest.station.sony.com/fanfaire/scrapbook_orlando_photos.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
              ...
              <tr> 
                <td>
                  <table width="95%" border="0" cellspacing="0" cellpadding="10" align="center">
                    <tr> 
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?barbarian" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=barbarian','','width=400,height=600'); return false;" target="_blank"><img src="screenshots/FF_orlando/barbarian_sml.jpg" width="150" height="225" border="0"> 
                        </a> </td>
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?crowdshot1" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=crowdshot1','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/crowdshot1_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                    </tr>
                    <tr> 
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?fironia" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=fironia','','width=400,height=600'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/fironia_sml.jpg" width="150" height="225" border="0"> 
                        </a> </td>
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?group1" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=group1','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/group1_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                    </tr>
                    <tr> 
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?group2" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=group2','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/group2_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?group3" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=group3','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/group3_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                    </tr>
                    <tr> 
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?group4" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=group4','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/group4_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?jeff_and_bill" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=jeff_and_bill','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/jeff_and_bill_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                    </tr>
                    <tr> 
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?jeff_and_michelle" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=jeff_and_michelle','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/jeff_and_michelle_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?registration" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=registration','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/registration_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                    </tr>
                    <tr> 
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?troll_and_dwarf" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=troll_and_dwarf','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/troll_and_dwarf_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                      <td align="center"> <a href="screenshots/FF_orlando/screenshots.jsp?wedding_couple" onClick="MM_openBrWindow('screenshots/FF_orlando/screenshots.jsp?id=wedding_couple','','width=600,height=400'); return false;" target="_blank"> 
                        <img src="screenshots/FF_orlando/wedding_couple_sml.jpg" width="200" height="133" border="0"> 
                        </a> </td>
                    </tr>
                  </table>
                  <p align="center"><a href="scrapbook_orlando_photos2.jsp" class="links">Page 
                    2</a></p>
                                    </td>
              </tr>
            </table>
