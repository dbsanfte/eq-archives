...
<a href="http://remotead.cnet.com/cgi-acc/clickthru.acc?clickid=0000b4e095a5d0cf00000000&adt=001:00:100&edt=allakhazam&cat=1:3828:&site=CN" target="_top"><img src="http://a.r.tv.com/cnet.12h/Ads/Media/Images/Banners/microsoft.exp_broad_satisfaction_468x60.banner.gif" border="0" alt="Click Here!"  height="60" width="468"></a><img src=http://eqbeastiary.stomped.com/shared/spacetrackergif.gif?0.514806445688009 height=1 width=1 border=0>
</td></tr>
...
<table cellpadding=0 cellspacing=0 border=0 width=100%>
	 ...
	 <tr><td><hr size=1><Script>document.title = "Illia's Everquest Bestiary: ";</script><table width=100% border=0><tr><td valign=top><h2 style='font-size:22px;'></h2></td></tr>
<tr><td><em></em></td></tr><tr><td valign=top></td></tr><tr><td valign=top></td></tr><tr><td><b>Known Habitats</b>:</td></tr><tr><td></td></tr><tr><td colspan=2 align=right style='font-size:9px;'><a href='mailto:illia@allakhazam.com?Subject=Correction for &Body=On the page: http://eqbeastiary.allakhazam.com/search.shtml?id=

'>Click Here</a> to report a correction</td></tr></td></tr><script>mob_id = eshop.msn.com;</script>
</table></td></tr></table>
...
<input type=button value='Change' onClick='document.pref.submit();'>
	 ...
	 <input type=hidden name=id value=eshop.msn.com></td></tr><tr><td colspan=1 style='background: silver;font-size: 9.5px;'>This topic is <a href=/search.shtml?id=eshop.msn.com&start=0>1</a>  pages long</td><td style='background: silver;font-size: 9.5px;' align=right>&nbsp;</td></tr></table></form><ul></ul></form><A name="Post"></a>
	     ...
	     <input type=hidden name=sval value=eshop.msn.com><ul>
