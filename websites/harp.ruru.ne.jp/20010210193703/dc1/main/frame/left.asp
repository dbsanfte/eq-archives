...
<INPUT type="hidden" name="site">
			...
			<tr>
				<td colspan="2">
					<!--A href="../../chat3/index.html" onMouseOver="self.status='Open Chat';return true" target="downright"-->
					<A href=javascript:viewForm(3) onMouseOver="self.status='Open Chat';return true">
					<FONT face=arial,helvetica,sans-serif size=2><b>Chat</b></FONT></A>
				</td>
			<tr>
				<td colspan="2">
