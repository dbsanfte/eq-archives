...
<table border=0 width="92%" cellpadding=3><tr><td bgcolor="#ddffff">
	[<b>221</b>]<font color="blue"><b>紹介したいのですが</b></font>
	<small>　From: </small><b><font color="green">初心者ＳＨＭ</font></b>
	<small>　on 2001/08/17 13:03:08 　 </small></td></tr>
	<tr><td bgcolor="white">
	<blockquote>
		<font color="#800000">自分の周りにはＥＱ始めて１ヶ月とか<br>lvl20未満の人が多いのですが<br>ここのHPのショッピングバスケットを<br>みんなに紹介してもいいでしょうか？<br></font><!-- z211-19-74-26.dialup.wakwak.ne.jp -->
	</blockquote>
	<br><hr width="95%" size=1 class=r noshade>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="#000080"><b>Laldar</b><!-- h110.p008.iij4u.or.jp --> &gt;</font></td>
		<td><font color="#000080">いいですけど(^_^;)<br>最近の商品に対応してないのがなんとも（ｗ<br></font>
		<font size="1" color="#2222AA"><i>(2001/08/17 14:14:39)</i></font></td></tr></table>
	</td></tr>
</table>

<form action="./erialbbs.cgi" method="POST"><input type=hidden name="mode" value="msg"><input type=hidden name="resno" value="221">
	<table border=0 cellspacing=0 cellpadding=0 class="resform" bgcolor="whitesmoke"><tr>
	<td nowrap align="right">お名前</td>
	<td nowrap><input type="text" name="name" size="10" value=""></td>
	<td rowspan=2 nowrap><textarea cols="56" rows="2" name="comment" wrap="soft"></textarea></td>
...
<table border=0 width="92%" cellpadding=3><tr><td bgcolor="#ddffff">
	[<b>220</b>]<font color="blue"><b>ショッピングバスケット</b></font>
	<small>　From: </small><b><font color="green">Tenrai@Vee</font></b>
	<small>　on 2001/08/15 18:20:20 　 </small></td></tr>
	<tr><td bgcolor="white">
	<blockquote>
		<font color="#008040">あのバンデッドア－マ－セットM100ｐｐを購入したいんですが、ここで<br>注文できるのでしょうか？<br>もし、よければお願いします。<br>ちなみにPALのHEFです。<br></font><!-- n56cc-07p33.ppp11.odn.ad.jp -->
	</blockquote>
	<br><hr width="95%" size=1 class=r noshade>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="#008040"><b>Tenrai@Vee</b><!-- n56cc-07p33.ppp11.odn.ad.jp --> &gt;</font></td>
		<td><font color="#008040">ああ、すみません<br>サ－バ－がちがうようでした。申し訳ないです。取り消します。</font>
		<font size="1" color="#2222AA"><i>(2001/08/15 18:24:35)</i></font></td></tr></table>
	</td></tr>
</table>

<form action="./erialbbs.cgi" method="POST"><input type=hidden name="mode" value="msg"><input type=hidden name="resno" value="220">
	<table border=0 cellspacing=0 cellpadding=0 class="resform" bgcolor="whitesmoke"><tr>
	<td nowrap align="right">お名前</td>
	<td nowrap><input type="text" name="name" size="10" value=""></td>
	<td rowspan=2 nowrap><textarea cols="56" rows="2" name="comment" wrap="soft"></textarea></td>
...
<table border=0 width="92%" cellpadding=3><tr><td bgcolor="#ddffff">
	...
	<br><hr width="95%" size=1 class=r noshade>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="#C100C1"><b>Laldar</b><!-- h217.p117.iij4u.or.jp --> &gt;</font></td>
		<td><font color="#C100C1">機能してます。<br>使用するとメールで双方に注文内容が来ますよ。<br>サイズはＭで良いですか？<br></font>
		<font size="1" color="#2222AA"><i>(2001/08/09 11:16:01)</i></font></td></tr></table>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="blue"><b>Wclick</b><!-- as111.tsuyama.lucksnet.or.jp --> &gt;</font></td>
		<td><font color="blue">うう、なつかしいな～（ｗ<br>俺もLal3との初めての出会いは注文して商品貰った時だったな～（ｗ<br>Buffもらって盾マークがスゲー沢山（5個ぐらいだったが当時は驚いた）（ｗ<br>ついて感動した覚えが（ｗ　いや本当になつかしい（ｗ<br></font>
		<font size="1" color="#2222AA"><i>(2001/08/10 09:06:50)</i></font></td></tr></table>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="#800000"><b>初心者ＳＨＭ</b><!-- z211-19-75-168.dialup.wakwak.ne.jp --> &gt;</font></td>
		<td><font color="#800000">いえＬサイズでお願いしますー<br>ちゃんとショッピングバスケット使った方がいいのかな</font>
		<font size="1" color="#2222AA"><i>(2001/08/10 20:07:43)</i></font></td></tr></table>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="#000080"><b>Laldar</b><!-- h234.p008.iij4u.or.jp --> &gt;</font></td>
		<td><font color="#000080">ご注文承りました。<br>１１日の２２時以降にお渡しできるように作成ちうです(^_^;)<br>商品のお届の際には/tellしますので。<br>なお、Buffのさーびす付デス（ｗ</font>
		<font size="1" color="#2222AA"><i>(2001/08/11 01:06:54)</i></font></td></tr></table>
	<table border=0 cellspacing=0 cellpadding=0><tr><td nowrap valign="top">
	<font color="#800000"><b>初心者ＳＨＭ</b><!-- z211-19-75-226.dialup.wakwak.ne.jp --> &gt;</font></td>
		<td><font color="#800000">いろいろな不手際でどうもスイマセンでした。<br>作ってもらった装備のお陰でbuff無し状態でも<br>ＡＣが１００近く上がりました。<br>新しい装甲と掛けてもらった山のようなbuffで<br>狩り場で狩りまくることもできました。<br><br>どうもありがとうーー！（＾◇＾）</font>
		<font size="1" color="#2222AA"><i>(2001/08/12 08:55:52)</i></font></td></tr></table>
	</td></tr>
</table>
