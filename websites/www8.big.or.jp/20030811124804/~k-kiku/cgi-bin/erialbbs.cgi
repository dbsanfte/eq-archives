...
<table border=0 width="92%" cellpadding=3><tr><td bgcolor="#ddffff">
	[<b>244</b>]<font color="blue"><b>ffffff</b></font>
	<small>　From: </small><b><a href="mailto:kuro@yc5.so-net.ne.jp">影牢</a></b>
	<small>　on 2003/03/07 20:45:18 　 </small></td></tr>
	<tr><td bgcolor="white">
	<blockquote>
		<font color="blue" id="moe">fff</font><!-- p625ab4.ykhmac00.ap.so-net.ne.jp -->
	</blockquote>	</td></tr>
</table>

<form action="./erialbbs.cgi" method="POST"><input type=hidden name="mode" value="msg"><input type=hidden name="resno" value="244">
