        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td bgcolor="#BA9F70" background="themes/Chronicles/images/gen_background2.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                    <tr>
                      <td><font class="content"><center><font class="content">There are currently, 21 guest(s) and 3 member(s) that are online.<br><br>You are Anonymous user. You can register for free by clicking <a href="modules.php?name=Your_Account&amp;op=new_user">here</a></font></center></font></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
