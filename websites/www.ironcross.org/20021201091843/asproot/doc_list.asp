...
<table border="0" cellspacing="0" cellpadding="0" align="center" valign="center" Class="Box" width="50%">
  <th>Knights of the Iron Cross Documents
  </th>
<tr>
    <td Class="CONTENT" valign="top">
</td>
  </tr>  <tr><td Class="Sub">Documents Available to the Public:</td></tr><tr><td Class="CONTENT">
			  <OL Type="1">
	 
			  <LI><a href="ShowDoc.asp?Pull=22">Links</a>
			  <LI><a href="ShowDoc.asp?Pull=25">Earth and Beyond Map Links</a>
	 </OL>

    </td>
  </tr>
</table><!-- The Database Connection is correctly Closed -->
    </td>
  </tr>
</table>
</body>
