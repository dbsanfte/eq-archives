...
<br>
<form name="LoginInfo" Method="POST" action="index.asp">

<table border="0" cellspacing="0" cellpadding="0" align="center" valign="center" Class="Box" width="300">
  <th>Please Enter Your Login Information
  </th>
<tr>
    <td Class="CONTENT" valign="top">
  <div align="right">User Name: <input type="text" name="User" size="20"><br>
  Password: <input type="password" name="PW" size="20"><br>
  Remember Me: <input type="checkbox" value="true" name="StoreInCookie"></div><br>
...
<!-- The Database Connection is correctly Closed -->
    </td>
  </tr>
</table>
</body>
