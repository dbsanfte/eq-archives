...
//-->
	...
	<td width="*" ID="PageContent" valign="top"><br>
<table border="0" cellspacing="0" cellpadding="0" align="center" valign="center" Class="Box" width="300">
  <th>Access Denied
  </th>
<tr>
    <td Class="CONTENT" valign="top">You have requested a restricted-access page without logging in.<br> Please <a href="login.asp">log in</a>, or click <a href="index.asp">here</a> to go to the home page.
    </td>
  </tr>
