...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="150">
<tr valign="top"><td bgcolor="#595959">
<center><font size="2">There are currently, 7 guest(s) and 1 member(s) that are online.<br><br>You are Anonymous user. You can register for free by clicking <a href="user.php">here</a></font></center>
</td></tr></table>
<br>
...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="150">
<tr valign="top"><td bgcolor="#595959">
<form action="pollBooth.php" method="post"><input type="hidden" name="pollID" value="14"><input type="hidden" name="forwarder" value="pollBooth.php?op=results&amp;pollID=14"><font size="2"><b>Pop Quiz!! How many mo fish warriors died to Idol?</b></font><br><br>
<input type="radio" name="voteID" value="1"> <font size="2">1</font> <br>
<input type="radio" name="voteID" value="2"> <font size="2">2</font> <br>
<input type="radio" name="voteID" value="3"> <font size="2">3</font> <br>
<input type="radio" name="voteID" value="4"> <font size="2">4</font> <br>
<input type="radio" name="voteID" value="5"> <font size="2">5</font> <br>
<br><center><font size="2"><input type="submit" value="Vote"></font><br><font size="2">[ <a href="pollBooth.php?op=results&amp;pollID=14&amp;mode=&amp;order=&amp;thold="><b>Results</b></a> | <a href="pollBooth.php"><b>Polls</b></a> ]<br><br>Votes: <b>50</b> | Comments: <b>0</b>
