...
Menu2=new Array("Resources","history.html",4);
	Menu2_1=new Array("New Members","recruiting.html",4,20,160);	
		Menu2_1_1=new Array("Charter","charter.html",0,20,150);
		Menu2_1_2=new Array("Bylaws","bylaws.html",0);
		Menu2_1_3=new Array("Recruiting","recruiting.html",0);
        Menu2_1_4=new Array("FAQ","faq.html",0);                
	Menu2_2=new Array("Current Members","news.html",4);
...
Menu3=new Array("News","news.html",2);
	Menu3_1=new Array("News Archive","news.html",0,20,150);
	Menu3_2=new Array("Forum","http://pub33.ezboard.com/fappotusdominusdrunkenmastersfrm5",0);
...
Menu4=new Array("Links","links.html",5);
	...
	Menu4_4=new Array("Everlore","http://www.everlore.com/",0);
