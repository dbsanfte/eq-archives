...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US"><head><title>Darkflame Knights Account Page</title>
<link rev="made" href="mailto:darkweb%40natvig.com" />
<base href="http://darkflame.org/newuser.cgi" />
...
<TABLE CLASS="WRAP">
  ...
  <TR>
   ...
   <TD CLASS="MAINWRAP">
This will register a new application. A password will be emailed to you, so make sure the address is correct.<BR>
Make sure you enter the FIRST NAME of your character only, you'll fill out surname and all other details once you you receive your password.
<form method="post" action="/newuser.cgi" enctype="application/x-www-form-urlencoded">
<TABLE BORDER=0>
<TR><TD>Character First Name</TD><TD><input type="text" name="name"  size=32 maxlength=32 /></TD></TR>
<TR><TD>Your Email Address</TD><TD>
<input type="text" name="email"  size=32 maxlength=128 /></TD></TR>
</TABLE>
<input type="submit" name="button_name" value="Register" /></form></TD></TR></TABLE></body></html>
