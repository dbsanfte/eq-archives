...
<HTML><HEAD><TITLE>Darkflame Knights Account Page</TITLE>
<LINK REV=MADE HREF="mailto:darkweb%40natvig.com">
<BASE HREF="http://www.darkflame.org/newuser.cgi">
  ...
  <TR>
   <TD CLASS="MENUWRAP">
     ...
     <TABLE CLASS ="MENU">
      ...
      <TR><TD CLASS="MENUITEM"><A HREF="dump.cgi/iprog" CLASS="MENUITEM">EQ Item</A></TD></TR>
     </TABLE>
   </TD>
   <TD CLASS="MAINWRAP">
