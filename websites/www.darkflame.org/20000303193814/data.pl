  ...
  <TR>
   <TD CLASS="MENUWRAP">
     ...
     <TABLE CLASS ="MENU">
      ...
      <TR><TD CLASS="MENUITEM"><A HREF="user.cgi?user=" CLASS="MENUITEM">Modify</A></TD></TR>
     </TABLE><BR>
     <TABLE CLASS ="MENU">
      ...
      <TR><TD CLASS="MENUITEM"><A HREF="data.pl?spelllist=" CLASS="MENUITEM">Spelllist</A></TD></TR>
     </TABLE>
   </TD>
   <TD CLASS="MAINWRAP">
...
There are currently <B>3663</B> items and <B>1007</B> spells in the database.<BR>
