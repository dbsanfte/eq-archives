...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US"><head><title>Darkflame Knights Login</title>
<link rev="made" href="mailto:darkweb%40natvig.com" />
<base href="http://www.darkflame.org/login.cgi" />
...
<TABLE CLASS="WRAP">
  ...
  <TR>
   ...
   <TD CLASS="MAINWRAP">
<H1>Login</H1>
It's important that you have cookies enabled for the login to work. Most browsers always support cookies, but if you for some reason have turned them off, please turn them on again.<BR>
<TABLE BORDER=0>
<TR><TD>Character Name</TD><TD>
<form method="post" action="/login.cgi" enctype="application/x-www-form-urlencoded">
<input type="text" name="name"  size=16 maxlength=16 /></TD></TR>
<TR><TD>Password</TD><TD>
<input type="password" name="pw"  size=16 maxlength=16 /></TD></TR>
</TABLE>
<input type="submit" name="button_name" value="Login" /></form></TD></TR></TABLE></body></html>
