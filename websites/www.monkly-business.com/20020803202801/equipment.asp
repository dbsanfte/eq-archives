...
<tr>
<td>
      <p align=center><a href="/index2.asp"><img src="logo.gif" alt="Monkly Business" border="0"></a></p>
</td>
</tr>
</table>
...
<p><a href="/index2.asp">News</a></p>
    ...
    <td valign="top" align="left"> 
      <ul>
        <br>
        <br>
        <p class="MB_Heading">Equipment</p>
        <ul>
          <p class="MB_Subhead">Armor</p>
          <ul>
            <form name="form1" method="post" action="viewarmor.asp">
              <p class="MB_Body">Select a Slot: 
                <select name="SlotId">
          ...
          <p class="MB_Subhead">Weapons / Held Items</p>
		  <ul>
          <form name="form2" method="post" action="viewweapon.asp">
              <p class="MB_Body">Select a Type: 
                <select name="SlotId">
                  
                  <option value="20" >1 Hand Blunt</option>
                  
                  <option value="25" >1 Hand Slash</option>
                  
                  <option value="21" >2 Hand Blunt</option>
                  
                  <option value="24" >Hand to Hand</option>
                  
                  <option value="26" >Piercing</option>
                  
                  <option value="23" >Ranged</option>
                  
                  <option value="22" >Shield/Held</option>
...
<tr><td>
<span class="MB_HeadlineList"><a href="index2.asp#337">Boston Fan Faire....</a></span> 
</td></tr>

<tr><td>
<span class="MB_HeadlineList"><a href="index2.asp#336">UI Information</a></span> 
</td></tr>

<tr><td>
<span class="MB_HeadlineList"><a href="index2.asp#335">Patch Message 31st July</a></span> 
</td></tr>

<tr><td>
<span class="MB_HeadlineList"><a href="index2.asp#334">Hits Mode  and Link of the Day</a></span> 
</td></tr>

<tr><td>
<span class="MB_HeadlineList"><a href="index2.asp#333">Guides I wish I had wrote</a></span> 
</td></tr>
...
<tr><td>
<span class="MB_HeadlineList"><a href="articles2.asp?ArticleNum=168">Halls of Testing by Glencannon</a></span> 
</td></tr>
  	
<tr><td>
<span class="MB_HeadlineList"><a href="articles2.asp?ArticleNum=167">Chardok Ring Quests by Azazelo</a></span> 
</td></tr>
  	
<tr><td>
<span class="MB_HeadlineList"><a href="articles2.asp?ArticleNum=166">Bodi Kibadachi's Coldain Ring Guide</a></span> 
</td></tr>
  	
<tr><td>
<span class="MB_HeadlineList"><a href="articles2.asp?ArticleNum=165">Monk FAQ - Quests and Equipment (May 02)</a></span> 
</td></tr>
