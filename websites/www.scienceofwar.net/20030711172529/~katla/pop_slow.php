...
<DIV id=box>
	...
	<FIELDSET><LEGEND><FONT color=#cc9900>Mob Slow Status</FONT></LEGEND>
		<table>
			<tr>
				<td bgcolor="black">
					<a href="http://www.scienceofwar.net/~katla/eq_slow.php"><img src="http://www.scienceofwar.net/images/eq_logo.gif" width="125" height="43" alt="" border="0">
					<a href="http://www.scienceofwar.net/~katla/rok_slow.php"><img src="http://www.scienceofwar.net/images/rok_logo.gif" width="125" height="45" alt="" border="0">
					<a href="http://www.scienceofwar.net/~katla/sov_slow.php"><img src="http://www.scienceofwar.net/images/sov_logo.gif" width="125" height="29" alt="" border="0">
					<a href="http://www.scienceofwar.net/~katla/sol_slow.php"><img src="http://www.scienceofwar.net/images/sol_logo.gif" width="125" height="31" alt="" border="0">
					<a href="http://www.scienceofwar.net/~katla/pop_slow.php"><img src="http://www.scienceofwar.net/images/pop_logo.gif" width="125" height="25" alt="" border="0">
					<a href="http://www.scienceofwar.net/~katla/loy_slow.php"><img src="http://www.scienceofwar.net/images/loy_logo.gif" width="125" height="37" alt="" border="0">
				</td>
			</tr>
			</table>
	</FIELDSET>
...
<DIV id=box>
	<FIELDSET><LEGEND><FONT color=#cc9900>List</FONT></LEGEND>
		<table>
			<tr>
				<td>

<table border="0" cellspacing="2" cellpadding="22" bgcolor="#FFFFFF"><tr><td>
<pre><font face="Arial"><font size="5"><b>Planes of Power</b><font size="3"> 				<b>Slowability &nbsp; Mitigation</b> &nbsp; <font size="2">Confirmed by
<u><font size="2">
BoT		Agnarr the Storm Lord		<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla
BoT		Ekil Thundercall			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
BoT		Elif Whitewind			<font color="#FF0F0F">immune to slow<font color="#000000">		
BoT		Gaukr Sandstorm			<font color="#0033FF">magic slowable<font color="#000000">		
BoT		Hibdin Cyclone			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
BoT		Hreidar Lynhillig			<font color="#339900">disease slowable<font color="#000000">	yes	
BoT		Jolur Sandstorm			<font color="#0033FF">magic slowable<font color="#000000">		
BoT		Oljin Stormtide			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
BoT		Oreen Wavecrasher			<font color="#339900">disease slowable<font color="#000000">	yes	

Crypt of Decay	Crazed Bubonian Berzerker		<font color="#FF0F0F">immune to slow<font color="#000000">		Grizlor 7th
Crypt of Decay	Greater Corrupted Pusling		<font color="#FF0F0F">immune to slow<font color="#000000">		Vova
Crypt of Decay	Overlord Bamford Paffa		<font color="#0033FF">magic slowable<font color="#000000">		

Crypt of Decay	Carprin Deatharn			<font color="#FF0F0F">immune to slow<font color="#000000">		Vova
Crypt of Decay	Breddan Rutyl			<font color="#0033FF">magic slowable<font color="#000000">	fully	Vova
Crypt of Decay	Fran Prisoal			<font color="#0033FF">magic slowable<font color="#000000">	fully	Vova
Crypt of Decay	Avhi Escron			<font color="#FF0F0F">immune to slow<font color="#000000">		Vova
Crypt of Decay	Bishop Toluwon			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Crypt of Decay	Vindor Mawnil			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Crypt of Decay	Raex Pwodill			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay	High Priest Ultor Szanvon		<font color="#FF0F0F">immune to slow<font color="#000000">		Katla

Crypt of Decay b	Spectre of Corruption			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
Crypt of Decay b	Darwol Adan			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Feig Adan				<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Crypt of Decay b	Xhut Adan				<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Crypt of Decay b	Kavilis Adan			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Crypt of Decay b	Raddi Adan			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Wavadozzik Adan			<font color="#0033FF">magic slowable<font color="#000000">	fully	Torelorm
Crypt of Decay b	Zandal Adan			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Akkapan Adan			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Crypt of Decay b	Bhaly Adan			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Qezzin Adan			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Pzo Adan				<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Meedo Adan			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
Crypt of Decay b	Bertoxxulous			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla

Halls of Honor	Rydda'Dar				<font color="#339900">disease slowable<font color="#000000"> *	slightly	Katla

Halls of Honor b	Druhar Gandoc			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
Halls of Honor b	Edium, Guardian of Marr		<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
Halls of Honor b	Halon of Marr			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
Halls of Honor b	Lord Mithaniel Marr			<font color="#339900">disease slowable<font color="#000000"> *	partially	Katla
Halls of Honor b	Ralthazor, Champion of Marr		<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla

PoAir		An Elemental Masterpiece		<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoAir		Avatar of Dust			<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoAir		Avatar of Mist			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla
PoAir		Avatar of Smoke			<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoAir		Avatar of Wind			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla
PoAir		Baltaldor the Cursed			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla
PoAir		Chamberlain Escalardain		<font color="#0033FF">magic slowable<font color="#000000">	mostly	Vova
PoAir		Gakamenial Fir'Disralsi		<font color="#0033FF">magic slowable<font color="#000000">	mostly	Vova
PoAir		Inlokher the Warlord			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Vova
PoAir		Melernil Faal'Armanna		<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla
PoAir		Pherlondien Clawpike			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla
PoAir		Queen Silandria			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Vova
PoAir		Sigismond Windwalker		<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoAir		Xegony the Queen of Air		<font color="#0033FF">magic slowable<font color="#000000">	slightly	

PoDisease		Aramin the Spider Guardian		<font color="#0033FF">magic slowable<font color="#000000">	fully	Vova
PoDisease		Grummus				<font color="#FF0F0F">immune to slow<font color="#000000">		Vova
PoDisease		Gryme the Crypt Guardian		<font color="#FF0F0F">immune to slow<font color="#000000">		Vova

PoEarth		A Sludge Lurker			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Eleandra
PoEarth		Derugoak Bloodwalker		<font color="#0033FF">magic slowable<font color="#000000">	mostly	Saine Atreides
PoEarth		Tantisala Jaggedtooth			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Smaaltz

PoFire		Arch Mage Yozanni			<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		Babnoxis the Spider Queen		<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		Blazzax the Omnifiend		<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		Criare Sunmane			<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		General Druav Flamesinger		<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		General Reparm			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
PoFire		Jaxoliz Dawneyes			<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		Magmaton				<font color="#FF0F0F">immune to slow<font color="#000000">		Vova
PoFire		Pyronis				<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoFire		Quavonis Firetail			<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla

PoFire		Fennin Ro script nameds		<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoFire		Fennin Ro, The Tyrant of Fire		<font color="#0033FF">magic slowable<font color="#000000">	slightly	

PoInnovation	An Archaic Model			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoInnovation	Junk Beast			<font color="#0033FF">magic slowable<font color="#000000">		
PoInnovation	Manaetic Behemoth			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoInnovation	Manaetic Prototypes			<font color="#0033FF">magic slowable<font color="#000000">		Katla
PoInnovation	Xanamech Nezmirthafen		<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla

PoNightmare	Hobgoblin Anguish Lord		<font color="#FF0F0F">immune to slow<font color="#000000">		Tharaon
PoNightmare	Mujaki				<font color="#0033FF">magic slowable<font color="#000000">		
PoNightmare	Terror Matriarch			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoNightmare	Vhaksiz the Shade			<font color="#FF0F0F">immune to slow<font color="#000000">		Seredith
PoNightmare	Gargoyles (A Grotesque Statue)		<font color="#0033FF">magic slowable<font color="#000000">		Katla
PoNightmare	Terris Thule			<font color="#0033FF">magic slowable<font color="#000000">		Katla

PoStorms		Drornok Tok Vo'Lok			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Falto Lord of Thunder			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Faruek the Bold			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Gurebk Lord of Krendic		<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Koka'Vor Chieftans			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Koka'Vor Elders			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Laruken the Rigid			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Paruek the Strong			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Pendubk the Turbulent		<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Solnebk the Unruly			<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Ston'Ruak Ancient of the Trees		<font color="#FF0F0F">immune to slow<font color="#000000">		
PoStorms		Zertuken the Unyielding		<font color="#FF0F0F">immune to slow<font color="#000000">		

PoTactics		Tallon Zek (real)			<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoTactics		Tallon Zek (RZtW cycle)		<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoTactics		Vallon Zek (real)			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
PoTactics		Vallon Zek (most clones)		<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
PoTactics		Vallon Zek (RZtW cycle)		<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
PoTactics		Vallon Zek (the occasional clone)	<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoTactics		Rallos Zek				<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
PoTactics		Rallos Zek the Warlord		<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla

PoTorment		A Blood Soaked Guard		<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoTorment		Baraguj Szuul			<font color="#0033FF">magic slowable<font color="#000000">		
PoTorment		Salczek the Fleshgrinder		<font color="#0033FF">magic slowable<font color="#000000">	slightly	Katla
PoTorment		The Acolyte of Affliction		<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
PoTorment		Ta'Grusch the Abomination		<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoTorment		Maareq the Prophet			<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
PoTorment		The Keeper of Sorrows		<font color="#FF0F0F">immune to slow<font color="#000000">		Katla
PoTorment		Saryrn				<font color="#0033FF">magic slowable<font color="#000000">	partially	Katla
PoTorment		Sorrowsong			<font color="#0033FF">magic slowable<font color="#000000">	mostly	Katla

PoValor		Aerin'Dar				<font color="#0033FF">magic slowable<font color="#000000">		Katla
PoValor		The Sleep Walker			<font color="#0033FF">magic slowable<font color="#000000">		Vova

PoWater		Grioihin the Wise			<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoWater		Hydrotha				<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova
PoWater		Krziik the Mighty			<font color="#FF0F0F">immune to slow<font color="#000000">		Kylt
PoWater		Ofossaa the Enlightened		<font color="#0033FF">magic slowable<font color="#000000">	yes	Vova

Tower of Solusek Ro	Arlyxir				<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Tower of Solusek Ro	Jiva				<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Tower of Solusek Ro	Rizlona (the human)			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Tower of Solusek Ro	Rizlona (the dragon)			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Tower of Solusek Ro	Solusek Ro			<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Tower of Solusek Ro	The Protector of Dresolik		<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla
Tower of Solusek Ro	Xuzl				<font color="#0033FF">magic slowable<font color="#000000">	fully	Katla</font></u></pre>
</td></tr></table>
* Reported as magic slowable, but it's too hard to land for it to be worth the time/mana spent
...
<DIV id=box>
	<FIELDSET><LEGEND><FONT color=#cc9900>Legend</FONT></LEGEND>
		<table>
			<tr>
				<td>
					<font color="#0033FF">magic slowable</font> should be self explanatory<br>
					<font color="#339900">disease slowable</font> should be self explanatory<br>
					<font color="#FF0F0F">immune to slow</font> yields an 'Immune' message from the gameplay<br>
					<font color="#FF0F0F">unslowable</font> is in practice immune to slow, in theory however...
				</td>
			</tr>
		</table>	
	</FIELDSET>
...
<DIV id=box>
	<FIELDSET><LEGEND><FONT color=#cc9900>Help Update!</FONT></LEGEND>
		<table>
			<tr>
				<td>
					<p><b>Feedback please!</b> As expansions and patches are released things change. This resource is rather worthless without updates, 
					so we need YOUR input to keep it in top condition. If you have more information about one of the mobs or if you want to suggest a 
					change or additional mobs (or whatever) please respond to <a href="http://www.scienceofwar.net/forum/viewtopic.php?t=7122">this thread</a>!
				</td>
			</tr>
