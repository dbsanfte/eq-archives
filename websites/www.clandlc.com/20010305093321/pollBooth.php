...
<center><small><a href="http://www.absolutchaos.net/~optimus/wtf.html" onclick="NewWindow(this.href,'name','640','620','no');return false">more info</a></small><center></td></tr></table></td></tr></table><br>
    ...
    </td></tr><tr><td bgcolor=FFFFFF><font size=2>I've learned that no matter how you try to protect your children, they will eventually get arrested and end up in the local paper.<br><table align=right><small><b>-Author Unknown</b></small></table>
...
<li> <a href="pollBooth.php?pollID=4">If you ABSOLUTELY had to - who would you rather be ass-reamed by?</a> (<a href="pollBooth.php?op=results&pollID=4">Results</a> - 27 votes)
<li> <a href="pollBooth.php?pollID=5">blah</a> (<a href="pollBooth.php?op=results&pollID=5">Results</a> - 6 votes)
<li> <a href="pollBooth.php?pollID=6">Yesterday was your significant other's birthday. You completely forgot it. You:</a> (<a href="pollBooth.php?op=results&pollID=6">Results</a> - 22 votes)
...
<li> <a href="pollBooth.php?pollID=9">Who is your Favorite Boy Band?</a> (<a href="pollBooth.php?op=results&pollID=9">Results</a> - 7 votes)
