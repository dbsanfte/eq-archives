...
<font size=1 color=CCCCCC>Welcome our newest victim <a href="user.php?op=userinfo&uname=ethik">ethik</a></td> 
...
<li><a href=top.php>Top 10</a><br>
    ...
    </td></tr><tr><td bgcolor=FFFFFF><font size=2><li><a href="http://www.absolutchaos.net/~optimus/quote/dailyq.html" onclick="NewWindow(this.href,'name','300','130','no');return false">ICQ Quote of the Day</a><br>
<li><a href="http://www.absolutchaos.net/~optimus/sound/weeklys.html" onclick="NewWindow(this.href,'name','300','125','no');return false">Sounds Through the Week</a><br>
<center><small><a href="http://www.absolutchaos.net/~optimus/wtf.html" onclick="NewWindow(this.href,'name','640','620','no');return false">more info</a></small><center></td></tr></table></td></tr></table><br>
    <table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor=000000><tr><td>
    <table width=100% border=0 cellspacing=1 cellpadding=3><tr><td colspan=1 bgcolor=CCCCCC>
    <font size=2>Immortal's Block
    </td></tr><tr><td bgcolor=FFFFFF><font size=2><li><a href="http://immortal.absolutchaos.net/casemod">Immortal's Casemod</a><br>
<li><a href="http://www.virtualhideout.net">Virtualhideout</a></td></tr></table></td></tr></table><br>
    <table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor=000000><tr><td>
    <table width=100% border=0 cellspacing=1 cellpadding=3><tr><td colspan=1 bgcolor=CCCCCC>
    <font size=2>Daily NonInspiration
    </td></tr><tr><td bgcolor=FFFFFF><font size=2>If they ever come up with a swashbuckling School, I think one of the courses should be Laughing, Then Jumping Off Something.<br><table align=right><small><b>-Jack Handey</b></small></table>
<p align=right><font size=1><a href=submitquote.php>submit quote</a> 
</td></tr></table></td></tr></table><br><img src=images/pix.gif border=0 width=150 height=1></td><td>&nbsp;&nbsp;</td><td width=100% valign=top><table border=0 cellpadding=8><tr><td><font size=3><li> <a href="pollBooth.php?pollID=1">What do you think about PHP-Nuke?</a> (<a href="pollBooth.php?op=results&pollID=1">Results</a> - 6 votes)
<li> <a href="pollBooth.php?pollID=2">Should we keep this site?</a> (<a href="pollBooth.php?op=results&pollID=2">Results</a> - 31 votes)
<li> <a href="pollBooth.php?pollID=4">If you ABSOLUTELY had to - who would you rather be ass-reamed by?</a> (<a href="pollBooth.php?op=results&pollID=4">Results</a> - 29 votes)
<li> <a href="pollBooth.php?pollID=5">blah</a> (<a href="pollBooth.php?op=results&pollID=5">Results</a> - 7 votes)
<li> <a href="pollBooth.php?pollID=6">Yesterday was your significant other's birthday. You completely forgot it. You:</a> (<a href="pollBooth.php?op=results&pollID=6">Results</a> - 24 votes)
<li> <a href="pollBooth.php?pollID=7">EverQuest - What is it?</a> (<a href="pollBooth.php?op=results&pollID=7">Results</a> - 19 votes)
<li> <a href="pollBooth.php?pollID=8">Do you wash your hands after you pee?</a> (<a href="pollBooth.php?op=results&pollID=8">Results</a> - 18 votes)
<li> <a href="pollBooth.php?pollID=9">Who is your Favorite Boy Band?</a> (<a href="pollBooth.php?op=results&pollID=9">Results</a> - 9 votes)
<li> <a href="pollBooth.php?pollID=10">Which is Worse?</a> (<a href="pollBooth.php?op=results&pollID=10">Results</a> - 20 votes)
