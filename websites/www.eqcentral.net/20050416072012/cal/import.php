...
<h2><font color="#0060C0">Import</font></h2>

<form action="import_handler.php" method="POST" name="importform" enctype="multipart/form-data">
<div class="tabBox" style="clear:both;">
  <div class="tabArea">
    <a class="tab active" href="import.php?tab=0" style="font-weight:bold;font-size:18;">Palm Desktop</a>
    <a class="tab" href="import.php?tab=1" style="font-weight:bold;font-size:18;">vCalendar</a>
    <a class="tab" href="import.php?tab=2" style="font-weight:bold;font-size:18;">iCalendar</a>
  </div>
  <div class="tabMain">
    <div class="tabContent"><br>

<br>
This form will allow you to import entries from the Palm Desktop Datebook.<br><br>
<input type="hidden" name="ImportType" value="PALMDESKTOP">
<b>Exclude private records:</b>
<input type=radio name=exc_private value="1" checked>Yes<input type=radio name=exc_private value="0">No<br><br>
<table border=0>
<tr><td><b>Datebook File:</b></td>
  <td><input type="file" name="FileName" size=45 maxlength=50"></td></tr>
<tr><td colspan="2"><input type="submit" value="Import">
...
<OPTION VALUE="20050410" SELECTED>Apr 10 - Apr 16
