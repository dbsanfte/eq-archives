...
<p>
    ...
    <table cellpadding=0 cellspacing=0 border=0 width=700 align=center>
        <tr>
            ...
            <td valign=top align=left>
	            ...
	            <br>
                &nbsp;&nbsp;<img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/bar.gif" border=0><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/openfold.gif" border=0>&nbsp;&nbsp;メンバー登録
            </td>
            </tr>
            <tr>
        <td valign=bottom align=right>&nbsp; <a href="javascript:openScript('help.cgi?helpon=Registering',500,400)"><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/help_b.gif" border=0></a></td>
    </tr>
    </table>
    <p>
    ...
    <tr>
    <td bgcolor=#EEEEEE align=center><font face="ＭＳ Ｐゴシック" color=#333333 size=3>
    <b>掲示板使用規約</b>
    </td>
    </tr>
    <td bgcolor=#FFFFFF align=left><font face="ＭＳ Ｐゴシック" color=#333333 size=2>

     <b>メンバー登録において</b><p>

この掲示板は投稿された文章を読んだり、投稿することが出来ます。この掲示板に書かれてある記事や文章による如何なる損害や被害などの問題が生じてもこのボードの管理者及びこのソフトウェアの作成者に一切の責任を負わないものとします。<br>
もし、社会的に問題があるような投稿、一個人や団体を非難中傷する投稿、猥褻な表現などを含む投稿は投稿者に知らせることなく削除いたします。<br>
また、掲載されなかった等の苦情も一切受け付けておりませんのでご了承下さい。
尚、掲載を中止する依頼があってもすぐには対処できない場合もあります。
<p>
掲載されている内容や文章は、許可なく転載をする事を一切禁じます。<p>
