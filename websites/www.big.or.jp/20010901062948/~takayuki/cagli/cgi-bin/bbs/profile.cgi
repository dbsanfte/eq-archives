...
<p>
        ...
        <tr>
            ...
            <td valign=top align=left>
                <font face="ＭＳ Ｐゴシック" color=#333333 size=2>
	             ...
	             <br>
                 &nbsp;&nbsp;<img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/bar.gif" border=0><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/openfold.gif" border=0>&nbsp;&nbsp;プロフィール
            </td>
        </tr>
    </table>
    <p>
    ...
    <table cellpadding=6 cellspacing=1 border=0 width=100%>
        ...
        <td bgcolor=#FFFFFF valign=middle><input type=text name="membername" value="Guest" size=20></td></tr>
        <tr>
