<html>
  <head>
   <META HTTP-EQUIV="Content-Type" CONTENT="text/html;charset=Shift_JIS"> 
    <title>カリオストロ掲示板 - アナウンスメント</title>
	        ...
	        <table cellpadding=0 cellspacing=0 border=0 width=700 align=center>
	                <tr>
	                   ...
	                   <td valign=top align=left>
	                    ...
	                    <br>
                        &nbsp;&nbsp;<img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/bar.gif" border=0><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/openfold.gif" border=0>&nbsp;&nbsp;アナウンスメント
	                </tr>
                  </table>
	           <p>
	        <table cellpadding=0 cellspacing=0 border=0 width=700 bgcolor=#999999 align=center>
	                <tr>
	                    ...
	                    <table cellpadding=3 cellspacing=1 border=0 width=100%>
	                        ...
	                        <tr>
	                        <td bgcolor=#999999 align=center valign=top><font face="ＭＳ Ｐゴシック" color=#333333 size=3><b>&raquo; 掲示板新規オープン &laquo;</b></td></tr>
	                        <tr>
	                            <td bgcolor=#FFFFFF align=left><a href="announcements.cgi?action=delete&number=0"><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/a_delete.gif" border=0"></a> &nbsp; <a href="announcements.cgi?action=edit&number=0"><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/a_edit.gif" border=0"></a> &nbsp; <a href="announcements.cgi?action=add"><img src="http://www.big.or.jp/~takayuki/cagli/cgi-bin/bbs/public/images/a_add.gif" border=0"></a></td>
	                        </tr>
	                        <tr>
	                            <td bgcolor="#FFFFFF" valign=top><font face="ＭＳ Ｐゴシック" color=#555555 size=2>
	                        <p><blockquote>えー　ユーザー登録というのがかなりめんどくさいとは思うのですが、掲示板を作成いたしました。 <br> <br>ユーザー登録さえしてしまえばアイコンが使えたりといろいろ遊べる掲示板なので是非ご利用くださいませ。 <br>
</blockquote><p>
	                        </td>
	                        </tr>
	                        <tr>
	                            <td bgcolor="#FFFFFF" valign=middle>
	                        <font face="ＭＳ Ｐゴシック" color=#555555 size=2>投稿:: <b>6:49 pm : Mar. 6, 2001</b>
	                        </td>
	                        </font>
	                        </tr>
