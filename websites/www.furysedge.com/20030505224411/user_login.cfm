<html>
<head>
<title>Fury's Edge - Session Expired</title>
...
<table width="560">
 ...
 <tr><td class="tblhead" align="center" width="560">User Login</td></tr>
 <tr><td align="right">
 <p align="left">Enter your character's first name and password to log in. If you have forgotten your password, enter your name without it, and it will be e-mailed to the address that you supplied.</p>
 <br>
  	 <form action="user_login_process.cfm" method="post">
	 Username: <input type="text" name="CharacterName" value=""><br><br>
	 Password: <input type="password" name="Entered_Password" value=""><br><br>
	 <input type="submit" value="Enter Member's Area >>>"><br><br>
 </td></tr>
