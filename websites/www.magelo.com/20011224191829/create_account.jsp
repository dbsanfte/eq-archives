...
<tr><td class="cadre_bg"><table width="100%">
<tr>
	<td class="text">
		<form name="register" method="post" action="create_account.jsp;jsessionid=PJMMJBIGEIMH">
		...
		<tr>
			<td class="text">
				...
				<input class="input" type="text" name="username" size="20" maxlength="20"><br><br>
				Enter your desired password <br>
				<input class="input" type="password" name="pass1" size="20" maxlength="20"><br>
				...
				<input class="input" type="text" name="email" size="30" maxlength="50"><br>
				Enter your ICQ number<br>
				<input class="input" type="text" name="icq" size="12" maxlength="15"><br><br>
				Pick your Timezone&nbsp;
