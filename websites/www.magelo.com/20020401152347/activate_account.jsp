...
<tr>
	<td class="text">
			...
			<br>
			<div align="center"><a href="http://www.magelo.com"><img alt="Back to Magelo" border="0" src="img/back_to_magelo_off.gif" onmouseover="this.src='img/back_to_magelo_on.gif'" onmouseout="this.src='img/back_to_magelo_off.gif'"></a></div>
			<br>
	</td>
