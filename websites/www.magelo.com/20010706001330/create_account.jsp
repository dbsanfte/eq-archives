...
<br>
<form method="post" action="create_account.jsp;jsessionid=KLIMBHDFKNGF">
<table width="60%" align="center" border="0">
<tr>
	<td bgcolor="#406886" align="center">Login Information</td>
</tr>
<tr>
	<td>
		<br>
		Enter your login <br>
		<input type="text" name="login" size="20" maxlength="20"><br><br>
		Enter your desired password <br>
		<input type="password" name="pass1" size="20" maxlength="20"><br>
		Enter your password again<br>
		<input type="password" name="pass2" size="20" maxlength="20"><br><br>
	</td>
</tr>
<tr>
	<td bgcolor="#406886" align="center">User Profile</td>
</tr>
<tr>
	<td>
		<br>
		...
		<input type="text" name="icq" size="12" maxlength="15"><br><br>
		Pick your Timezone&nbsp;
...
<option>Pacific/Wallis
			...
			<br><br>
			Clock System <select name="am_pm"><option value="true">12 hours<option value="false">24 hours</select><br><br>
		</td>
	</tr>
	<tr><td align="center"><br><br><input type="submit" name="register" value="Create my account"></td></tr>
</table>
</form>
