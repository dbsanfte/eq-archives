...
<title>Create Character Profile: Step 1 of 2</title>
<!--
          ...
          <td align=left valign=top width=80%>
            <table height=10 cellpadding=0 cellspacing=4 WIDTH="100%" BORDER=0>
              <tr>
                <td>
                  <font face="verdana, arial, helvetica" size=+1>
                    <b>Create Character Profile: Step 1 of 2</b>
                  </font>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <font face="verdana, arial, helvetica" size=-1>
                    You can use this form to create a character profile for your character in order to access this site.<br>If you have more than one character, each of your characters will require a seperate profile.
                  </font>
                </td>
              </tr>
    ...
    <td valign="top">
      <table WIDTH="100%" BORDER="0" CELLSPACING="10" CELLPADDING="5">
        <tr>
          <td>
<!-- END HEADER -->
<form action="CreateProfile.asp" method="POST" id="form1" name="form1">
<table BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <TR>
    <td>
      <font face="Verdana,Arial,Helvetica" size=-1>
        <b>Please select the EverQuest Server your character plays on:</b>
      </font>            
    </td>
  </TR>
  <TR>
  ...
  <TR>
    <td>
      <INPUT type="submit" value="Next ->" name=btnStep2>
    </td>
  </TR>
