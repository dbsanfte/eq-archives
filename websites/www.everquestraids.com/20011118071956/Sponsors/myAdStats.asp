...
<table BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <tr>
    <td class=BodyText>
      <INPUT size=60 class=Dialogue type="text" id=SGUID name=SGUID value="">&nbsp;<INPUT class=Dialogue type="submit" value="Get Stats!" id=btnSubmit name=btnSubmit>
    </td>
  </tr>
