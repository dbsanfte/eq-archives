          ...
          <td align=left valign=top width=80%>
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              ...
              <tr>
                <td valign=top>
                  <font face="verdana, arial, helvetica" size=-1>
                    There are 4 news items posted within the last 7 days.
                  </font>
                </td>
              </tr>
...
<font face="verdana, arial, helvetica" size="-1">
The "Events" tab-menu now has an added tab called "My Events."<BR><BR>The "My Events" page lists all upcoming events which you are signed up for.<BR><BR>This should help since you can no longer tell which events you're signed up for in the Event List.
</font>
</td>
</tr>
<tr>
...
<td align=left>
<font face="verdana, arial, helvetica" size="-1">
<b>Modifications to Event List</b>
</font>
</td>
<td align=right>
<font face="verdana, arial, helvetica" size="-1">
<b>8/9/01 3:48:44 PM</b>
</font>
</td>
</tr>
<tr>
<td align=left colspan=2>
<font face="verdana, arial, helvetica" size="-1">
The event list page used to ping the database for each event listed to find out how many were signed up for that event, find out if the user viewing the list was a member of any locked events and find out if the user viewing the events had already signed up or not. The more events listed, the longer the query would take. And some timeouts occured as a result.<BR><BR>By removing the number of characters signed up for the event and the option to join or quit the event I've enhanced the response time of these queries.<BR><BR>Normally I would simply throw more hardware at the problem but this is a non-profit site and I don't have the resources to do that.<BR>
</font>
</td>
</tr>
<tr>
...
<td align=left>
<font face="verdana, arial, helvetica" size="-1">
<b>Your guild's event calendar on your website...</b>
</font>
</td>
<td align=right>
<font face="verdana, arial, helvetica" size="-1">
<b>8/4/01 11:41:08 PM</b>
</font>
</td>
</tr>
<tr>
<td align=left colspan=2>
<font face="verdana, arial, helvetica" size="-1">
Webmasters: Did you know that it's possible to have this website build a calendar with only your guild's raids listed? Users from your website do not need to log into EverQuestRaids.com in order to see this calendar. (However if they want to sign up for an event they will have to log in)<BR><BR>Simply click this link <a href="http://www.everquestraids.com/Guilds/Calendar/buildurl.asp">http://www.everquestraids.com/Guilds/Calendar/buildurl.asp</a> and EverQuestRaids.com will build a qualified URL for you to use within a frame on your website! The URL will contain your guild's ID in the query string. Calling that URL will show a simplified version of the Calendar listing only events for the guild matching that GuildID.<BR><BR>Enjoy
</font>
</td>
</tr>
<tr>
...
<td align=left>
<font face="verdana, arial, helvetica" size="-1">
<b>Hosting costs paid</b>
</font>
</td>
<td align=right>
<font face="verdana, arial, helvetica" size="-1">
<b>8/4/01 1:50:55 PM</b>
</font>
</td>
</tr>
<tr>
<td align=left colspan=2>
<font face="verdana, arial, helvetica" size="-1">
Many people were good enough to send in small donations. Enough people sent in donations to cover most of this month's payment.<BR><BR>It's nice to see so many who are willing to help out.<BR><BR>Thank you.
</font>
</td>
</tr>
<tr>
