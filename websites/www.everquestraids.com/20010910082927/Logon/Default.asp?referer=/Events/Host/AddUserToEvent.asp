  ...
  <tr>
    ...
    <td>
      <table width=100% border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          <td align=center valign=bottom>
            <a href="/sponsors/clickthru.asp?AdID=19&tURL=http%3A%2F%2Fwww%2Egoldenstaff%2Eorg" target="_New"><IMG SRC="/sponsors/sep2001/ogs_banner.jpg" width=120 height=60 alt="Golden Staff (paid until 10/1/01)" border=0></a>
          </td>
        </tr>
      </table>
    </td>
    <td>
      <table width=100% border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          <td align=center valign=bottom>
            <a href="/sponsors/clickthru.asp?AdID=20&tURL=http%3A%2F%2Fwww%2Enexusofsouls%2Ecom" target="_New"><IMG SRC="/sponsors/sep2001/nosbanner.gif" width=120 height=60 alt="Nexus of Souls (paid until 10/1/01)" border=0></a>
          </td>
        </tr>
      </table>
    </td>
...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width='100%'>
  <tr>
    ...
    <input name=referer value="/Events/Host/AddUserToEvent.asp" type=hidden>
    <input name=querystring value="referer=/Events/Host/AddUserToEvent.asp" type=hidden>
