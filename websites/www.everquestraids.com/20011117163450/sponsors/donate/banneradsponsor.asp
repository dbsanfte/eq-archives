...
<title>Sponsor EverQuestRaids.com</title>
<!--
            ...
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              <tr>
                <td valign=top class=TitleText>
                    Sponsor EverQuestRaids.com
                </td>
              </tr>
              
              <tr>
                <td valign=top class=TitleSubText>
                    Thank you for your interest in sponsoring EverQuestRaids.com!
                </td>
              </tr>
...
<table width=95% BORDER="0" CELLSPACING="0" CELLPADDING="0">
   <tr>
      <td class=BodyText>
         There are three ways you can support EverQuestRaids.com.
      </td>
   </tr>
   <tr>
      <td class=BodyText>
         1) <a href="http://www.everquestraids.com/Account/CreateAccount.asp">Subscribe to a Premium Content Subscription</a>
         <br>2) Sponsor the site with a banner ad
         <br>3) Just donate money
      </td>
   </tr>
   <tr><td class=BodyHead height=10></td>
   </tr>
   <tr>
      <td class=BodyHead>
         Banner Ads
   ...
   <tr>
      <td class=BodyText>
         <p>There are two types of banner ads. Global and Server-specific.
         <li>A Global banner ad is displayed to every user
         <li>A Server-Specific banner ad is displayed to users who have characters on a specific server
         <p>By donating $40 (or more) you can show your support by displaying a Global Banner for one month.
         <p>By donating $10 (or more) you can show your support by displaying a Server-Specific Banner for one month.
         <p>I'll be happy to create your banner ad for free or if you would like to use your own banner ad, that's OK too. 
      </td>
   </tr>
   <tr><td class=BodyHead height=10></td>
   <tr>
      <td class=BodyHead>
         Banner Ad Restrictions
      </td>
   </tr>
   <tr>
      <td class=BodyText>
         <li>120 pixels wide by 60 pixels high
         <li>Under 19k in file size
         <li>Either .gif or .jpg format
         <li>If animated, less than 15 frames.
      </td>
   </tr>
   <tr><td height=10></td></tr>
   <tr>
      <td class=BodyText>
         Please note that real estate is limited, only 4 banner ads can be displayed per month per server (including global ads). Banner ads are displayed on a first-come-first-serve basis.
      </td>
   </tr>
   <tr><td><hr size=2 noshade></td></tr>
   <tr>
      <td class=BodyText>
         Click here for a Global Banner Ad ($40)
      </td>
   </tr>
   ...
   <tr>
      <td class=BodyText>
         ...
         <input type="hidden" name="custom" value="12001">
         <input type="hidden" name="cmd" value="_xclick">
         <input type="hidden" name="business" value="cforsyth@cnw.com">
         <input type="hidden" name="item_name" value="Sponsor EverQuestRaids.com: 1 Month Global Banner Ad">
         <input type="hidden" name="item_number" value="4001">
         <input type="hidden" name="amount" value="40.00">
         <input type="hidden" name="no_shipping" value="1">
         <input type="hidden" name="return" value="http://www.everquestraids.com/Sponsors/Donate/complete.asp">
         <input type="hidden" name="cancel_return" value="http://www.everquestraids.com/Sponsors/Donate/canceled.asp">
   ...
   <tr>
      <td class=BodyText>
         Click here for a Server-Specific Banner Ad ($10)
      </td>
   </tr>
   <tr><td height=5></td></tr>
   <tr>
      <td class=BodyText>
         <!-- Begin PayPal Logo -->
         <form action="https://www.paypal.com/cgi-bin/webscr" method="post" id=form2 name=form2>
         <input type="hidden" name="custom" value="12002">
         <input type="hidden" name="cmd" value="_xclick">
         <input type="hidden" name="business" value="cforsyth@cnw.com">
         <input type="hidden" name="item_name" value="Sponsor EverQuestRaids.com: 1 Month Server-Specific banner Ad">
         <input type="hidden" name="item_number" value="4002">
   ...
   <tr>
      <td class=BodyText>
         If you don't want a banner ad, select the ammount you wish to donate and click the button.
      </td>
   </tr>
   <tr><td height=5></td></tr>
   <tr>
      <td class=BodyText>
         <!-- Begin PayPal Logo -->
         <form action="https://www.paypal.com/cgi-bin/webscr" method="post" id=form3 name=form3>
         <input type="hidden" name="custom" value="12003">
         <input type="hidden" name="cmd" value="_xclick">
         <input type="hidden" name="business" value="cforsyth@cnw.com">
         <input type="hidden" name="item_name" value="Donation to support EverQuestRaids.com">
         <input type="hidden" name="item_number" value="4003">
         ...
         <input type="hidden" name="no_shipping" value="1">
         <input type="hidden" name="return" value="http://www.everquestraids.com/Sponsors/Donate/thankyou.asp">
         <input type="hidden" name="cancel_return" value="http://www.everquestraids.com/sponsors/donate/canceled.asp">
         <input type="image" src="http://images.paypal.com/images/x-click-butcc-donate.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
         </form>
         <!-- End PayPal Logo -->
