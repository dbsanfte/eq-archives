...
<table width=95% BORDER="0" CELLSPACING="0" CELLPADDING="0">
   <tr>
      <td class=BodyText align=center>
         To find your PayPal.com Subscription Number, log on to <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_login-run" target="_New">PayPal.com</a> and click "History." Then click the "Active" link next to the "Subscription Creation" to Charles Forsyth.
      </td>
   </tr>
