      ...
      <table width=100% border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          <td align=center valign=bottom>
            <a href="/sponsors/clickthru.asp?AdID=18&tURL=http%3A%2F%2Fwww%2Eclanblackwatch%2Ecom" target="_New"><IMG SRC="/sponsors/aug2001/CBad.gif" width=120 height=60 alt="Clan Blackwatch (paid until 10/1/01)" border=0></a>
          </td>
        </tr>
      </table>
    </td>
...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width='100%'>
  <tr>
    ...
    <input name=referer value="/Guilds/Calendar/buildurl.asp" type=hidden>
    <input name=querystring value="referer=/Guilds/Calendar/buildurl.asp" type=hidden>
