...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers.jsp');">
...
<DIV align=center>
<P><BR><B>Special Servers</B> </P>
<P align=left>This Special Servers section of EverQuestLive.com includes the current Server Rule Sets for all the Zek servers and the Firiona Vie server. You will also find here the latest Sullon Zek points standings and the Sullon Zek zone control maps. </P>
<P align=left><A href="/library/sz_rule_sets.jsp">Specialty Server Rule Sets</A><BR>These are special rules sets for all the Zek servers and the Firiona Vie server.</P>
