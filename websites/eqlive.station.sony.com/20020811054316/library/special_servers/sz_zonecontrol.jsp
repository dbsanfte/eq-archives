...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers/sz_zonecontrol.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Zone&nbsp;Control&nbsp;Maps</font></b></div>
                        <!-- #EndEditable --></td>
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
                        <table border="0" width="100%" cellspacing="0" cellpadding="0" background="/library/atlas/images/parchtile.gif">
                          <tr> 
                            <td width="126" valign="top"><img src="/library/atlas/images/map_gryphon.gif" width="126" height="115"></td>
                            <td width="100%"> 
                              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  <td height="2" bgcolor="#000000"><img src="/library/atlas/images/seethru.gif" width="8" height="2"></td>
                                </tr>
                                <tr> 
                                  <td height="108" nowrap> 
                                    <div align="center"> 
                                      <center>
                                        <!-- <img src="/library/atlas/images/map_norrath.gif" width="162" height="64"><br> -->
                                        <p><img src="sz_header.gif" width="300" height="95"><br>
                                          <br>
                                          <font face="Times New Roman, Times, serif" size="-1" color="#000000">Click 
                                          on each continent to bring up its<br>
                                          </font><font face="Times New Roman, Times, serif" size="-1" color="#000000">Sullon 
                                          Zek zonecontrol view. <br>
                                          Click <a href="../sz_zone_history.jsp">here</a> 
                                          to see recent historical data. </font><font face="Times New Roman, Times, serif" color="#000000"> 
                            ...
                            <td align="right" valign="top" width="100"><img src="/library/atlas/images/map_eyball.gif" width="100" height="115"></td>
                          </tr>
                        </table>
                        <table border="0" width="100%" cellspacing="0" cellpadding="0" background="/library/atlas/images/parchtile.gif">
                          <tr> 
                            <td width="10"><img src="/library/atlas/images/seethru.gif" width="10" height="2"></td>
                            <td bgcolor="#000000" width="2"><img src="/library/atlas/images/seethru.gif" width="2" height="2"></td>
                            <td> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td> 
                                    <script>
<!--
	function openWindow(continent, w, h) {
		if (screen.height < h) {
			h = screen.height - 40;
		}
		
		wnd = window.open("continent.jsp?c=" + continent,continent,"height=" + h + ",width=" + w + ",resizable=yes,scrollbars=yes");
	}
//-->
</script>
                                    <p align="right"><img src="/library/atlas/images/map_ship1.gif" width="115" height="80"><a target=odus onClick="openWindow('odus', 325, 510); return false;" href="../atlas/continent.jsp"><img src="/library/atlas/images/map_odus.gif" width="100" height="144" align="right" border="0" alt="Odus"></a></p>
                                    <p align="center">&nbsp;</p>
                                    <p align="center">&nbsp;</p>
                                    <p align="center">&nbsp;</p>
                                    <p align="center">&nbsp;</p>
                                    <p align="right"><img src="/library/atlas/images/map_gator.gif" width="72" height="59"> 
                                    </p>
                                  </td>
                                  <td valign=top width="20%"> 
                                    <center>
                                      <!-- 798 -->
                                      <a target=antonica onClick="openWindow('antonica', 604, 848); return false;" href="../atlas/continent.jsp"><img src="/library/atlas/images/map_antonica.gif" width="183" height="245" border="0" alt="Antonica"></a> 
                                    </center>
                                  </td>
                                  <td rowspan="2"> 
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr> 
                                        <td> &nbsp; <img src="luclin_button.gif" border=0 alt="Coming Soon" width="79" height="24"> 
                                          &nbsp; <a target=planes onClick="openWindow('planes', 575, 625); return false;" href="continent.jsp"><img src="planes_button.gif" border=0 alt="The Planes" width="79" height="24"></a> 
                                          <br>
                                          <br>
                                          <a target=faydwer onClick="openWindow('faydwer', 527, 480); return false;" href="../atlas/continent.jsp"><img src="/library/atlas/images/map_faydwer.gif" width="198" height="142" alt="Faydwer" border="0"></a></td>
                                      </tr>
                                      <tr> 
                                        <td><a target=kunark onClick="openWindow('kunark', 575, 548); return false;" href="../atlas/continent.jsp"><img src="/library/atlas/images/map_kunark.gif" alt="Kunark" width="211" height="192" border="0"></a></td>
                                      </tr>
                                    </table>
                                  </td>
                                </tr>
                                  ...
                                  <td colspan="2"> 
                                    <center>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td>&nbsp;</td>
                                          <td width="42%"><a target=velious onClick="openWindow('velious', 575, 370); return false;" href="../atlas/continent.jsp"><img src="/library/atlas/images/map_velious.gif" alt="Velious" width="262" height="121" border="0"></a></td>
                                        </tr>
                                      </table>
                                    </center>
                                  </td>
                              ...
                              <!-- removed by tmf 08.30.2001 -->
                            </td>
                            <td bgcolor="#000000" width="2"><img src="/library/atlas/images/seethru.gif" width="2" height="2"></td>
                            <td width="7"><img src="/library/atlas/images/seethru.gif" width="7" height="2"></td>
                          </tr>
                        </table>
                        <table border="0" width="100%" cellspacing="0" cellpadding="0" background="/library/atlas/images/parchtile.gif">
                          <tr> 
                            <td width="109"><img src="/library/atlas/images/map_skull.gif" width="109" height="116"></td>
                            <td width="100%"> 
                              <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                ...
                                <tr> 
                                  <td height="2" bgcolor="#000000" nowrap><img src="/library/atlas/images/seethru.gif" width="8" height="2"></td>
                                </tr>
                                <tr> 
                                  <td height="9"></td>
                                </tr>
                            ...
                            <td align="right" valign="top" width="87"> <img src="/library/atlas/images/map_pixies.gif" width="87" height="116"></td>
                          </tr>
                        </table>
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
