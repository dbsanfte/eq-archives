	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/multimedia/tutorial.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/multimedia/tutorial.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/multimedia/tutorial.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<DIV align=center>
<P><A href="/multimedia/dnloads/EQTutorial.exe">Download the EverQuest Tutorial</A></P>
<P><B>EverQuest Tutorial Help</B><BR><BR></P></DIV>
<P>Because of our continued improvements to the EverQuest game, the original EverQuest Tutorial no longer works. If you would still like to take advantage of the Tutorial to learn the basics of EverQuest, we have a solution for you.</P>
<P></P>
<P>You can now download the EverQuest Tutorial as a complete and separate package. The download is a large one (52.5MB) but will allow you full use of the EverQuest Tutorial. Below are the estimated times of download:</P>
...
<P></P>
<P>28.8 Kb</P></TD>
<TD>4 hours 14 minutes 51 seconds</TD></TR>
<TR>
<TD>56 Kb</TD>
<TD>2 hours 11 minutes 04 seconds</TD></TR>
<TR>
<TD>Cable/DSL (250 Kb)</TD>
<TD>29 minutes 21 seconds</TD></TR>
<TR>
<TD>T1 Connection</TD>
<TD>43 seconds</TD></TR></TBODY></TABLE>
<P></P>
<P></P>
<P>To download the EverQuest Tutorial <A href="/multimedia/dnloads/EQTutorial.exe">click here</A>. Save the file to disk, preferably to the Desktop or other easily found location. Once you have completed the download, locate the file EQTutorial.exe and double-click on it. This will start the self-extractor. By default the EverQuest Tutorial will install to C:\\\\Program Files\\\\EQTutorial. Once the files are extracted, browse to the folder EQTutorial (C:\\\\Program Files\\\\EQTutorial) and double-click on the Tutorial.exe file. This will launch the EverQuest Tutorial.</P>
<P></P>
<P>IMPORTANT NOTE: The EverQuest Tutorial is not compatible with current EverQuest files, be sure NOT to install the EverQuest Tutorial files into your EverQuest folder as this will render the EverQuest game or the Tutorial unplayable.<BR></P>
