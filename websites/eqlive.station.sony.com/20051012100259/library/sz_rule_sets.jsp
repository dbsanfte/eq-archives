...
<P><STRONG>Sullon Zek rules:</STRONG></P>  <P>Welcome to Sullon Zek, the first Deity Team PvP server.</P>  <P>The Sullon Zek server is a new server with a new rule set. The rules for
  ...
  sports team.</P>  <OL>   <LI>Player v. Player
       ...
       is within 5 levels. The amount of experience lost will be the same
       amount that is lost if that character is killed by an NPC. Your corpse
       can be resurrected by a cleric to partially restore lost experience.</LI>   <LI>Characters will only
       ...
       have home towns that match their starting cities. Other cities are not
       considered home towns, despite being run and controlled by a certain
       race. For example, HighHold is not a human home town. Thurgadin is not a
       dwarven home town.</LI>   <LI>Rules such as the
       ...
       not affect characters more than 20 levels lower than the spell level. Existing
       spell restrictions on spells over 50<SUP>th</SUP> level will supercede
       this rule.</LI>   <LI>There will be
       ...
       undetermined at this time, but we are leaning towards a team reward
       rather than a personal reward.</LI>   <LI>Naked corpses WILL
  ...
  Good.</P>  <P>Monks will be able to worship Veeshan. The Temple in Qeynos has discovered some
  ancient writings that opened up new avenues.</P>  <P>We will be including a method for the Good and Neutral teams to use Summon
