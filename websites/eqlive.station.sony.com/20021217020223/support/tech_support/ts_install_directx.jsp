...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">88,898 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_install_directx.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_install_directx.jsp');">
...
<P>2) Download DirectX 8.1. You can find it on <A href="http://www.microsoft.com/directx/homeuser/downloads/default.asp"><FONT face=Arial size=2>Microsoft's site</FONT></A>. Make certain to get the correct version for your operating system. Store it in your new folder so you can find it when you need it in a few minutes, <B>but don't install it yet</B>. </P>
