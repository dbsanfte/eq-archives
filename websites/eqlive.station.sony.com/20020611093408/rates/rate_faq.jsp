...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/rates/rate_faq.jsp?null');">
...
<P align=left><B>What are the new EverQuest subscription rates?</B><BR>The new monthly subscription rate is $12.95. The new 3-month subscription rate is $35.85 and a 6-month subscription rate is $65.70. We continue to offer discounts in the new rate plan for multi-month subscriptions and encourage you to take advantage of this money saving option. </P>
<P><B>When will the subscription rate change?</B><BR>The new subscription rate took effect April 25, 2002. </P>
...
<P><B>Are there any discounts for longer subscription plans? </B><BR>For now, you can still extend your current subscription for an additional 12 or 24 months by signing up for the EverQuest 12 or 24 month subscription extension plan and reap great savings. </P>
<P>A 12-month subscription extension costs only $119.95 US&nbsp;- that's only $9.99 a month, a huge 23% discount off of the new monthly plan!</P>
<P>Even better, a 24-month subscription extension costs only $199.95 US&nbsp;- that's only $8.33 a month, a 35% savings off of the new monthly plan!</P>
<P>These are not recurring charges, meaning that you will be charged the one time fee in its entirety. </P>
<P><B>What if I want to extend before my renewal date? Can I still take advantage of the 12 and 24 month options?</B><BR>Yes, you may. To take advantage, follow these simple steps: </P>
<P>Launch the EverQuest Game and go to the Login screen. Click the" Account" button and then click "Change Account." <BR>Enter your Station Name and password, and then click "Edit Billing." <BR>Next you will see the EverQuest Subscription page on the left and the EverQuest Legends access page on the right. Choose the EverQuest Subscription page and then check mark one of the two options (12 month or 24 month) that you wish to take advantage of. <BR>You will be billed immediately, and your current subscription will be automatically extended by 12 months or 24 months, depending on which plan you elected. </P>
<P><B>Can you explain what "recurring" charges are?</B><BR>All pricing plans (except for the 12 and 24 month plans) are and have always been recurring, meaning you have been and will continue to be billed at the appropriate subscription rate interval, until you cancel your subscription. </P>
<P><B>Ok, how does all this really work? </B><BR>The new subscription rates are in effect for all signups and/or renewals that occur on and after April 25, 2002; the subscription extension rates listed above are effective April 25, 2002, as well. </P>
...
<P><B>Is there a website with more information about the EverQuest pricing changes?</B><BR>For more information, please visit <A href="/rates/index.jsp">eqlive.station.sony.com/rates/</A></P>
<P><BR></P>
