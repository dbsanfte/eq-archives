...
<P ALIGN="center"><STRONG><BR><STRONG>EverQuest Status Server Protocol</STRONG></STRONG></P>  <P><STRONG>NOTE:</STRONG> The information contained within this document is
  ...
  clients to refresh more than once every 20 to 30 seconds.</P>  <P><STRONG>REPLIES :</STRONG> After you send one of the commands to the
  Status Server, you will get a reply back for that command.&nbsp; For each of
  the commands above, there is an associated reply.&nbsp; The first 4 bytes of
  each reply contain the same 4 bytes that were sent as the command.&nbsp;
  After that, the rest of the reply is based on the command being sent.</P>  <P><STRONG><U>Request Server Names Reply</U></STRONG></P>  <P>This reply contains a listing of current server names, including the chat
