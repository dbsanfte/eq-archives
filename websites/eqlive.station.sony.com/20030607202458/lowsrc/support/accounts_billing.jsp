...
<P><A href="/lowsrc/rates/index.jsp"><SPAN class=header>EverQuest's Price Increase</SPAN></A><BR>An overview of the EQ subscription rate change, with information on billing as well as 12-month and 24-month subscription plans.</P>
<P><A href="/lowsrc/rates/rate_faq.jsp"><SPAN class=header>EverQuest's Price Increase FAQ</SPAN></A><BR>The EQ subscription rate change took effect on April 25, 2002. Find out more about it. </P>
<P><A href="/lowsrc/support/accounts_billing/ab_create_activate_account.jsp">Creating An Account</A><BR>A simple step-by-step guide to setting up your own EverQuest account. </P>
...
<P><A href="/lowsrc/support/accounts_billing/ab_pricing.jsp"><SPAN class=header>Pricing Plans</SPAN></A><BR>Find out about all EverQuest pricing plan options. </P>
...
<P><SPAN class=header><SPAN class=header><SPAN class=header><A href="/lowsrc/support/accounts_billing/ab_cancel.jsp">Canceling an EverQuest Account</A><BR>We'll hate to lose you, but here is where you can learn how to cancel your account.</SPAN></SPAN></SPAN>&nbsp;</P>
