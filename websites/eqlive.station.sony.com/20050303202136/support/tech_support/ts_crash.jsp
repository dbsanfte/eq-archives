...
<P ALIGN="center"><STRONG><BR><STRONG>General Tips for Crashing or Freezing During Gameplay</STRONG></STRONG></P>  <P>&nbsp;</P>  <P><STRONG>Quick Suggestions to Remedy Crashing or Freezing:</STRONG></P>  <P>&nbsp;</P>  <P>First, if you have not already done so, you will want to make sure you
  ...
  time attention from each device. However, this causes a problem with the new EverQuest
  client, because the other devices, using the same IRQ, never get to do
  anything. In cases with the video and/or sound card being shared with other
  devices, systems will experience connection problems, crashes, or lockups.</P>  <P>Your problem may stem from IRQ sharing on the machine in question. To
