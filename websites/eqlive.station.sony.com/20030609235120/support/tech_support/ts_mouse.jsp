	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_mouse.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_mouse.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_mouse.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<DIV align=center><STRONG><BR>Mouse Troubles</STRONG> </DIV>
<P>If your mouse freezes before entering the game, or you are unable to get your mouse to work in EverQuest then you may want to follow the suggestion below to get your mouse to work properly in EverQuest.</P>
<P>It may simply be a mouse driver problem, and sometimes changing the driver can fix it. In order to do this, perform the following steps:</P>
<UL>
<LI>Right click on the "My Computer" icon.<BR><BR>
<LI>Select "Properties" from the menu.<BR><BR>
<LI>Click on the "Device Manager" tab.<BR><BR>
<LI>Open the entry for "Mouse."<BR><BR>
<LI>Select the "Driver" tab.<BR><BR>
<LI>Hit "Update/Change Driver."<BR><BR>
<LI>Click the "Next" button.<BR><BR>
<LI>Select "Display A List of Drivers."<BR><BR>
<LI>Hit "Show All Drivers."<BR><BR>
<LI>Choose "Standard PS/2 Port Mouse", "Standard Serial Mouse", "Microsoft PS/2 Port Mouse", or "Microsoft Serial Mouse". You may have to experiment with the different options to find the one that works best for you.</LI></UL>
<P>&nbsp;</P>
