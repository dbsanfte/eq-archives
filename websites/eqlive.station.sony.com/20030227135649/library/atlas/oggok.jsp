...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/oggok.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/oggok.jsp');">
                                      ...
                                      <div align="center"> 
                                        <table border="0" width="90%" align="center">
                                          <tr> 
                                            ...
                                            <td valign="top"> 
                                              <p><font color="#000000" size="4">Sluice 
                                                of Oggok<br>
                                                Greenblood Guild<br>
                                                Citadel of Praak<br>
                                                Lether Armer<br>
