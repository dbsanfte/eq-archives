	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/news_section/newsfeed_basic.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/news_section/newsfeed_basic.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/news_section/newsfeed_basic.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<p>&nbsp;</p>
	...
	function toClip(obj)
	{
		if (document.all)
		{
			thisObj=eval("document.all."+obj);
			Copied=thisObj.createTextRange();
			Copied.execCommand("Copy");
                        ...
                        <p>&nbsp; </p>
                        <p>Now you too can have the latest EverQuestLive.com news 
                          on your own web page. Just place the HTML code below 
                          anywhere in your website source code, and your EQLive 
                          news will update when we update. Or, if you are an advanced 
                          user, you may want to try our <a href="newsfeed_advanced.jsp">EQLive 
                          Newsfeed Editor</a>. This simple to use tool will allow 
                          you to choose font styles, colors, and layout options.</p>
                        <p>Full page: Use this code to place EQLive news on your 
                          site in full page layout like the sample below.<br>
                        </p>
                        <h2>Full Page</h2>
                        <img src="/images/js_news_top.jpg" width="425" height="381"><br>
                        <p> 
                          <textarea id="full" READONLY WRAP="off" style="width:400px;height:100px;">
...
&lt;noscript&gt;The EverQuest Live news requires you to have JavaScript turned on.&lt;/noscript&gt;
                          ...
                          <br>
                          <input type="button" value="Copy To Clipboard (IE ONLY)" onclick="toClip('full');">
                        <h2>Left Aligned: </h2>
                        Use this code to left align EQLive news on your page like 
                        the sample below. <br>
                        <br>
                        <img src="/images/js_news_left.jpg" width="425" height="406"><br>
                        <p> 
                          <textarea id="left" READONLY WRAP="off" style="width:400px;height:100px;">
...
&lt;/div&gt;
                          ...
                          <br>
                          <input type="button" value="Copy To Clipboard (IE ONLY)" onclick="toClip('left');">
                        <h2>
                          <!-- end page content -->
                        </h2>
                        <!-- #EndEditable --></td>
