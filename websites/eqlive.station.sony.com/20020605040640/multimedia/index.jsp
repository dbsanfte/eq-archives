...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/multimedia/index.jsp?null');">
...
<P><A href="/multimedia/box_art_and_more.jsp">Box Art &amp; More</A>&nbsp;<BR>Grab what you need and spruce up your own website.</P>
<P><A href="/multimedia/tutorial.jsp">Tutorial</A><BR>Learn the basics of EverQuest with this offline tutorial.</P>
