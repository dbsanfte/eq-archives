...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp?null');">
...
<LI>
<P>After you find out what kind of Video and Sound Cards you have, click on the <A href="/support/tech_support/ts_av_index.jsp">Audio/Video Support</A> section to find our lists of supported devices. The lists also include links to the Manufacturer's web sites, where you can download the latest drivers for your Card. </P><BR><BR>
<LI>
...
<P align=left>If you are still having problems or have questions, after visiting this support section, you can contact our Technical Support Department via email using our <A target=_blank href="http://www.station.sony.com/services/everquest-technical.jhtml">online form</A>.<BR></P></TD></TR></TBODY></TABLE>
