	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_index.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<DIV align=center><STRONG><BR>Frequently Asked Questions</STRONG> </DIV>
<P>This is the main FAQ index. When we write a new FAQ, or update an existing one, this is the place you will find them.</P>
<P><A href="http://eqlive.station.sony.com/library/faqs/faq_eqlive.jsp"><EM>EverQuest</EM> FAQ</A><BR>The basics about EverQuest.</P>
<P><A href="http://eqlive.station.sony.com/library/faqs/faq_cs_contact.jsp">Customer Support Contact FAQ<BR></A>This FAQ helps to explain certain issues regarding contacting GMs and other Customer Service Representatives.<BR></P>
<P><A href="/library/faqs/faq_naming.jsp">Naming FAQ</A><BR>A guideline on creating proper character names for <EM>EverQuest</EM>.<BR></P>
<P><A href="/library/faqs/faq_reimbursement.jsp">Item Reimbursement FAQ</A><BR>We hope you don't lose an item, but this may help in getting that item returned.<BR></P>
<P><A href="http://eqlive.station.sony.com/library/faqs/faq_guide.jsp">GM/Guide FAQ</A><BR>All about our Game Masters and Guides.</P>
<P><EM><A href="http://eqlive.station.sony.com/library/faqs/faq_kunark.jsp">EverQuest: The </A></EM><SPAN class=header><A href="http://eqlive.station.sony.com/library/faqs/faq_kunark.jsp"><EM>Ruins of Kunark</EM> </A>FAQ</SPAN><BR>The basics about the&nbsp;first expansion pack, <EM>EverQuest: The Ruins of Kunark</EM>.<BR></P>
<P><SPAN class=header><EM><A href="http://eqlive.station.sony.com/library/faqs/faq_velious.jsp">EverQuest: The Scars of Velious</A></EM> FAQ</SPAN><BR>The basics about the second expansion pack, <EM>EverQuest: The Scars of Velious</EM>.<BR></P>
<P><SPAN class=header><EM><A href="http://eqlive.station.sony.com/library/faqs/faq_luclin.jsp">EverQuest: The Shadows of Luclin</A></EM> FAQ</SPAN><BR>The basics about the third expansion pack, <EM>EverQuest: The Shadows of Luclin</EM>.<BR></P><SPAN class=header></SPAN>
<P><SPAN class=header><EM><A href="http://eqlive.station.sony.com/library/faqs/faq_pop.jsp">EverQuest: The Planes of Power</A></EM> FAQ<BR></SPAN><SPAN class=header>The basics about the fouth expansion pack, <EM>EverQuest: The Planes of Power</EM>.</SPAN></P>
<P><SPAN class=header><A href="http://eqlive.station.sony.com/library/faqs/faq_loy.jsp"><EM>EverQuest: The Legacy of Ykesha</EM></A><BR>Basic information on how to purchase and download <EM>EverQuest's</EM> first downloadable extension.</P></SPAN>
<P><A href="https://store.station.sony.com/faq.jsp"><SPAN class=header>Station Store FAQ</SPAN></A><BR>How to purchase any of the <EM>EverQuest</EM> games and products online.<BR></P><SPAN class=header></SPAN>
