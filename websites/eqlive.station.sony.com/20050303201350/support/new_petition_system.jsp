                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P>New Petition System - Petitioning Process: </P>  <P>In order to assist you with the newly revised /petition system, we've
  provided a step-by-step guide.<BR><BR>1. To begin the process of petitioning, use /petition or the P key by
  default. Please note: you can also use the Help &quot;?&quot; icon in the
  Window Selector, but you will also need to click on the Customer Service
  button at the top of the window.<BR><BR>2. Knowledge Base is the first tab to pop up in the Customer Service window.
  You are required to search for and read at least one Knowledge Base entry
  before our system will allow you to submit a petition. Many of our petitioned
  questions have answers in the Knowledge Base, so please make the most of this
  search!<BR><BR>Note that the Create New Ticket button is grayed-out. This means you haven't
  read a Knowledge Base entry yet!<BR><BR>This is how the button appears when it allows you to click and start your
  petition.<BR><BR>3. If your question or issue is not answered by the Knowledge Base, please
  click the Create New Ticket button on the lower left of the petition window.
  Again, this will only work if you've double-clicked and read a Knowledge Base
  entry. If the button is still grayed-out, you may need to read through an
  additional Knowledge Base entry.<BR><BR>4. Select the Topic and Subtopic of your petition. These are important!
  Please take the time to choose the most appropriate category because this
  helps us to properly handle your petition.<BR><BR>5. Before you click the Begin button that allows you to enter the details of
  your petition, you should read the paragraph that begins as follows:
  &quot;Please select the issue you would like assistance with....&quot; Once
  ready, click the Begin button on the lower left corner of the window and tell
  us about your issue or question. Please make your petition as detailed as
  possible, including item names, NPC names, player names, approximate times,
  and any other information deemed appropriate. If you're petitioning for a
  name or surname change, please list the name/surname you'd like to have. This
  way we can assist you if you log offline. Since we're now able to respond to
  petitions offline, many issues can be handled while you're not in game.<BR><BR>6. Click the Submit button when you are finished entering the text for your
  petition. Do not click the Done button. This will close the window, and will
  not send us your petition.<BR><BR>7. The Open Tickets tab on the petition window is where you can check on the
  status of your petition. Messages and questions from the GMs will also appear
  in this window. It's important for you to check the status of your petition
  frequently while you're online because we might need more information to
  assist you! IMPORTANT: if your petition's status shows as &quot;Pending:
  Waiting for Player&quot; or &quot;Pending: Closed&quot;, we won't be able to
  see your petition as current and needing attention in our queue. A
  &quot;Pending: Waiting for Player&quot; status requires that you review the
  GM questions or comments and add further information as needed. A
  &quot;Pending: Closed&quot; status indicates that your issue has been
  addressed and needs no further attention. If you feel that your petition's
  status is incorrect, please delete your current petition and submit another,
  providing new information as needed.<BR><BR>8. If you need to give more information, or tell us about a change in the
  status of your issue, please use the Add Comment button on the lower left.
  This will not only leave a note for us, it will also change your petition's
  status if it isn't already &quot;Pending: Waiting for CSR&quot;.<BR><BR>9. Once the issue is resolved, please delete your petition! This will free up
  our system, allowing you to submit new petitions for additional issues when
  necessary.<BR><BR>10. If you have problems petitioning, please ask for assistance from your
  fellow players. Most have probably had the same problem you are having and
