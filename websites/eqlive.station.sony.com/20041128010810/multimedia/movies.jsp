	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/multimedia/movies.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/multimedia/movies.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Movies</font></b></div>
                        <!-- #EndEditable --></td>
...
<TR>
<TD colSpan=5>
<TABLE cellSpacing=0 cellPadding=0 width=468 background=new_images/test_bg.gif border=0>
<TBODY>
<TR>
<TD>
...
<TABLE cellSpacing=0 cellPadding=2 width=430 background="" border=0>
<TBODY>
<TR>
<TD align=middle><A href="/movies/fanfaire.jsp"><IMG height=104 src="/images/eq_fanfaire.jpg" width=424 border=0></A></TD></TR>
<TR>
<TD><A class=smalltitle href="/movies/fanfaire.jsp">EverQuest Fan Faire Movie:</A></TD></TR>
<TR>
<TD>Get a feel for EverQuest Fan Faire with this short QuickTime movie created with footage taken at the Dallas Fan Faire on January 25-26</TD></TR></TBODY></TABLE><BR>
<TABLE cellSpacing=0 cellPadding=2 width=430 background="" border=0>
<TBODY>
<TR>
<TD align=middle><A href="/movies/eq_lotr.jsp"><IMG height=104 src="/images/eq_lotr_a.gif" width=424 border=0></A></TD></TR>
<TR>
<TD><A class=smalltitle href="/movies/eq_lotr.jsp">EverQuest Big Screen Trailer</A></TD></TR>
<TR>
<TD>This EverQuest trailer ran in selected U.S. theaters before The Lord of the Rings: The Fellowship of the Ring, the 2001 live action film adaptation of J.R.R. Tolkein's classic fantasy novel.</TD></TR>
<TR>
<TD align=middle><A href="/movies/cnn.jsp"><IMG height=104 src="/images/cnncoverage.jpg" width=424 border=0></A></TD></TR>
<TR>
<TD><A class=smalltitle href="/movies/cnn.jsp">CNN Movie:</A></TD></TR>
<TR>
<TD>Still not sure just how enormous the world of EverQuest is? EverQuest has made such an impact on the gaming industry that it's making headlines everywhere. Check out this story covered by CNN.</TD></TR>
<TR>
<TD align=middle><A href="/movies/tri.jsp"><IMG height=104 src="/images/trilogy.jpg" width=424 border=0></A></TD></TR>
<TR>
<TD><A class=smalltitle href="/movies/tri.jsp">Trilogy Movie:</A></TD></TR>
<TR>
<TD>For the first time, you can have it all! The world of Norrath has evolved at an unprecedented rate, and now EverQuest: The Ruins of Kunark and EverQuest: The Scars of Velious have come together in this phenomenal Trilogy pack. With 38 new adventure zones making up a combined virtual gaming space more than 50% larger than Classic EverQuest, plus a new player race, greater character advancement opportunities, and hundreds of new items to discover, this collection will knock you off your feet. Take a peek at the world's #1 online multiplayer game.</TD></TR>
<TBODY></TBODY></TABLE><BR>
<TABLE cellSpacing=0 cellPadding=2 width=430 background="" border=0>
<TBODY>
<TR>
<TD align=middle><A href="/movies/luclin.jsp"><IMG height=104 src="/images/luclin.jpg" width=424 border=0></A></TD></TR>
<TR>
<TD><A class=smalltitle href="/movies/luclin.jsp">Luclin Movie:</A></TD></TR>
<TR>
<TD>The best game ever just keeps getting better. Your journey will now take you to the moonscape of Luclin, and you're not going to believe your eyes. A complete 3D overhaul gives Luclin and all previous lands in EverQuest a crisp new look. Play as one of the Vah Shir, the newest player race, or take on the role of BeastLord, a brand new player class. Then, mount up to travel on the newly added horses! With over 24 new perilous zones to explore, Luclin will keep you coming back for more. Have a look at this trailer, and welcome to our world!</TD></TR></TBODY></TABLE><BR>
<TABLE cellSpacing=0 cellPadding=2 width=430 background="" border=0>
<TBODY>
<TR>
<TD align=middle><A href="/movies/2ndann.jsp"><IMG height=104 src="/images/2ndannversary.jpg" width=424 border=0></A></TD></TR>
<TR>
<TD><A class=smalltitle href="/movies/2ndann.jsp">2nd Anniversary Movie:</A></TD></TR>
<TR>
<TD>Prepare yourself for the 3-D massively multiplayer phenomenon known as EverQuest&reg;. Journey into a world of fantasy, rich with diverse creatures, active economic systems, and volatile politics and alliances. Pick from a variety of races and classes to begin your quest, then strike out through the many continents of Norrath to find your destiny. Over 400,000 people have joined our world, now you can check it out on this trailer.</TD></TR>
<TBODY></TBODY></TABLE></TD>
<TD width=14 background=new_images/19_r.gif>&nbsp;</TD></TR>
<TR>
<TD width=14 background="" height=14></TD>
<TD width=282 background="" height=14></TD>
<TD width=112 background="" height=14></TD>
<TD width=46 background="" height=14></TD>
<TD width=14 background="" height=14></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
<TR>
<TD width=14 height=11></TD>
<TD width=282 height=11></TD>
<TD width=112 height=11></TD>
<TD width=46 height=11></TD>
<TD width=14 height=11></TD></TR></TBODY></TABLE></DIV>
