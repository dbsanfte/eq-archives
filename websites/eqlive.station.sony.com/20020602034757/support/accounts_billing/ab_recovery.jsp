...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_recovery.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Accounts&nbsp;and&nbsp;Billing</font></b></div>
                        <!-- #EndEditable --></td>
...
<DIV align=center>
<DIV align=center><STRONG><BR>Station Name and Password Recovery</STRONG> </DIV>
<P align=left><BR></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>If you are having difficulty remembering your Station Name or Password, please follow the directions below to help you recover them.</FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2><B>To recover your Station Name:</B></FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>If you have forgotten your Station name, please visit our Station Name Recovery Page at <A href="http://www.station.sony.com/services/forgottop.jhtml?forgot=station">http://www.station.sony.com/services/forgottop.jhtml?forgot=station</A>. You will be asked to fill out a form and your Station Name will be emailed to you at the email address you provided during registration. In order for us to send you your Station Name, you will need the following information when you fill out the form:</FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>Your email Address (The one you provided during registration)<BR>Your ZIP/Postal Code<BR>Your Birthdate (mm/dd/yy)</FONT></P>
<P align=left>&nbsp;</P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2><B>To recover your Password:</B></FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>If you have forgotten your password, please visit our Password Recovery Page at <A href="http://www.station.sony.com/services/forgottop.jhtml?forgot=password">http://www.station.sony.com/services/forgottop.jhtml?forgot=password</A>. You will be asked to fill out a form and your reset password will be emailed to you at the email address you provided during registration. In order for us to send you your new password, you will need the following information when you fill out the form:</FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>Your Station Name<BR>Your ZIP/Postal Code<BR>Your Birthdate (mm/dd/yy)</FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>After you receive your new password, we strongly suggest that you visit <A href="http://www.station.sony.com/services/accountinfo.dyn">http://www.station.sony.com/services/accountinfo.dyn</A>, sign in, and change your password to something unique that only you will know. We also suggest that after you have changed your password, you write down your Station Name and password for future reference.</FONT></P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>Unfortunately, we are unable to provide Station Name recovery or password reset services without the required verification information.</FONT></P>
<P align=left>&nbsp;</P>
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>If you do not remember the information required to recover your Station Name or to reset your Password, you can contact our Technical Support Department via email through our <A href="http://www.station.sony.com/services/everquest-technical.jhtml/t_blank">online form</A>.</FONT></P>
<DIV align=left></DIV>
<P align=left><BR></P></DIV><!-- #EndEditable -->
