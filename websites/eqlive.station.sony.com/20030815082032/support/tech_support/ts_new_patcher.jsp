...
<P align=left>And the second thing vitally important, this new patcher is much better looking than the previous one. As an added feature, the EverQuest Patcher will allow users to create their own skins or download some special skins that we create to customize the look of their patcher.</P>
<P align=left>This page has been created to help everyone get accustomed to the new patcher. Below, you will find some information on the new options and how they work with each other.</P><IMG height=328 src="/images/tech_support/patcher_grabs1.jpg" width=469> 
...
<P></P><IMG height=328 src="/images/tech_support/patcher_grabs2.jpg" width=469> 
...
<P></P><IMG height=328 src="/images/tech_support/patcher_grabs3.jpg" width=469> 
...
<P></P><IMG height=328 src="/images/tech_support/patcher_grabs4.jpg" width=469> 
...
<P>All anti-virus software should be disabled before running the patcher.</P><U>
<P></P>
