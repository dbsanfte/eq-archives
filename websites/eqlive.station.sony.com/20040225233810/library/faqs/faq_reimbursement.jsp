	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_reimbursement.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_reimbursement.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P>A: To have your reimbursement request investigated, it is imperative that you request in-game assistance using the /petition command as soon as you are able. If you are unable to reach a member of the CS Team in-game, please <STRONG><A href="http://www.station.sony.com/en/services/help/eqGM.jsp">contact your GM</A></STRONG>. </P><BR>
<P>Q: I just died how long do I have to loot my corpse before it decays?</P>
<P>A: If you are level 10 to 60 then you have seven days of time (offline or online) to loot your corpse. We strongly recommend that you loot your corpse as quickly as possible. <BR>
<P>Q: I used to have good faction with a particular NPC but now I have bad faction with that NPC. What can I do?</P>
<P>A: Actions taken on one end of Norrath can affect factions on the other end of Norrath. members of the CS Team may not discuss your faction standings or what has altered your faction standings with you. You may wish to consult your fellow adventurers as to possible solutions to your faction problem.</P><BR>
<P></P>
...
<P>A: Please request in-game assistance as soon as possible by using the /petition command. The loss will be investigated and may be replaced at the discretion of a GM.</P><BR>
...
<P>A: Please request in-game assistance as soon as possible by using the /petition command. The corpse decay will be investigated and if premature the character will be reimbursed.</P><BR>
...
<P>A: Please request in-game assistance as soon as possible by using the /petition command. Please make sure not to remove the affected item as visual verification will help to resolve the issue.</P><BR>
...
<P>A: Items that are dropped may be reimbursed after an investigation and at the discretion of a GM. However we recommend that you leave your item drop confirmation on at all times.</P><BR>
...
<P>A: Items lost due to the disappearance of NO-RENT containers will generally not be reimbursed. Please be wary when placing valuable items in NO-RENT containers so that you may prevent this from happening. </P><BR>
<P>Q: I destroyed something that I wanted to keep. Can I request to have it reimbursed?</P>
<P>A: Destroyed items may be reimbursed after an investigation and at the discretion of a GM. To prevent the accidental destruction of items, you may wish to set the "Fast item destroy" option to "off".</P><BR>
...
<P>A: Items consumed while using trade skills will not be reimbursed if lost in the normal practice of a trade skill. </P><BR>
...
<P>A: Items given to pets and other NPC's may be reimbursed after an investigation and at the discretion of a GM.To help prevent this, you should check to make certain that the name in the trade window is the name of the person or NPC that you wish to receive the items.</P><BR>
...
<P>A: Items accidentally sold to merchants may be reimbursed after an investigation and at the discretion of a GM. Please check which item you have highlighted before confirming the sale.</P><BR>
...
<P>A: Items lost in this manner may be reimbursed after an investigation and at the discretion of a GM. Please request in-game assistance as soon as possible by using the /petition command.</P><BR>
<P>Q: What safeguards do I have when trading items in game? </P>
<P>A: There are many safeguards to make your trades secure. For example always be sure of the name in the trade window of the person you are trading with. We also suggest that you always get something in return for your trades. Be sure to check all of the items in the trade window, either by right clicking on the item or using the alt key while your cursor is over the item. Only click&nbsp;trade when you are certain that you wish to commit to the trade. Do not click the trade button until all the items in the trade (including coins) are present in one trade window. Once the trade button is clicked, the trade is considered final. </P><BR>
<P><IMG height=30 src="/images/tribal_divider.gif" width=251></P>
...
<P>A: Items lost in this manner are generally not reimbursed. We recommend that you loot NPC corpses as quickly as possible to prevent such issues. </P><BR>
...
<P>A: Items lost in this manner are generally not reimbursed. It may assist in the determination for a reimbursal if you are able to /report the looting of major items.</P><BR>
...
<P>A: Items accidentally looted in this manner may be transferred after an investigation and at the discretion of a GM. Please make certain that you have the Loot No Drop flag off to help prevent these sorts of accidents.</P><BR>
<P></P>
<P align=center><IMG height=30 src="/images/tribal_divider.gif" width=251></P>
<P><U><B>Quest Related</B></U></P>
<P>Q: What is Multi-Questing?</P>
<P>A: Multi-Questing is when one or more persons assists with the turn in portion of a quest. We do not support Multi-Questing. GMs may be unable to assist you. It is recommended that the person wishing to receive the quest reward be the sole person to turn in the necessary items. </P><BR>
...
<P>Please request assistance in-game by using the /petition command. Be sure to tell the GM what item was lost and which character lost the item. Item reimbursement requests can take some time to investigate so please be patient. You may also <STRONG><A href="http://www.station.sony.com/en/services/help/eqGM.jsp">contact your GM</A></STRONG>.</P>
<P></P>
