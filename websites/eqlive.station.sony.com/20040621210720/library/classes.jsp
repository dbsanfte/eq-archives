	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/classes.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/classes.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/classes.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Classes</font></b></div>
                        <!-- #EndEditable --></td>
...
<img src="/images/classicons/beastlord_ani.gif" alt="Beastlord" border="0">
			
		</td>
		<td valign="top">
			<span class="libtitle">Beastlord</span>
			
			<span class="libsubtitle"></span>
			<br>
			<SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Beastlords are the masters of raw nature, who focus this energy into themselves and their warder pets. Beastlords are primarily a melee class, with the ability to wear leather armor and wield blunt weapons, or use their bare hands to attack.<BR><BR>Beastlords prepare for battle by calling on their animal warder and increasing the creature's natural abilities with spells. Beastlords share every battle with their warders, fighting along side these fierce companions or falling back to heal and aid. <BR><BR>Beastlords also gain spells to slow or damage their opponents. Beastlords can heal and add to an ally's health and mana regeneration as well, making them a well-rounded ally in battle.<BR><BR>Beastlords can adventure solo well in many places. They depend upon coordination with their warders and well planned spells to finish every fight, but they can also aid a group through their spells and melee abilities. The beastlord is a great class for players who like the option of solo melee fights, but want to be able to help in a group.</SPAN>
		</td>
	</tr>
	                      <tr> 
                            <td colspan="2" align="center" height="5">
...
<img src="http://eqlive.station.sony.com/images/classicons/beserker.gif" alt="Beserker" border="0">
			
		</td>
		<td valign="top">
			<span class="libtitle">Berserker</span>
...
<P>With the mastery of his innate rage, the berserker also gains the ability to become "berserk,"&nbsp;a deadly state which causes a great amount of damage as a berserker's blade swings with frenzy. As dangerous as berserkers are at these moments, they become more vulnerable to enemy attacks.</P>
<P>Berserkers do not fear death and they value speed and agility over personal defense. The berserker is at his best with a group of friends and adventurers that allow him to unleash his full anger on an enemy without interruption. When standing within arm's reach of his enemy, the berserker is one of the masters of offense, crippling and maiming with impressive speed and skill. And, in situations where an enemy must be fought at a distance, the berserker has the best throwing arm of any Norrathian. </P>
		</td>
	</tr>
	                      <tr> 
                            <td colspan="2" align="center" height="5">
...
<img src="/images/classicons/monk_ani.gif" alt="Monk" border="0">
			
		</td>
		<td valign="top">
			<span class="libtitle">Monk</span>
			
			<span class="libsubtitle"></span>
			<br>
			<SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Monks devote their energies to the pursuit of physical perfection, shaping their very bodies into deadly machines. Monks are a melee class with the ability to wear leather armor, wield blunt weapons, and use unarmed combat styles.<BR><BR>Monks forego heavy armor and almost all weapons in order to hone themselves into masters of combat, using their fists and a stout staff to make their mark upon Norrath. Monks learn many special attacks to enhance their damage dealing abilities, including the dragon punch and the legendary flying kick.<BR><BR>In their martial studies monks also learn other useful skills, including the ability to move silently and fall safely from great heights. Experienced monks also learn to feign death, slowing their body's functions enough to fool most observers into believing them dead - this trick often allows the monk to escape dangerous situations as monsters wander off, thinking the monk defeated.<BR><BR>Monks are a specialist class, focusing on physical combat to the exclusion of all else. Monks provide a powerful ally in a group, though it's not unusual to see a monk adventuring alone. The monk is a good choice for players who enjoy a strong offensive role in combat and leading groups in their dungeon adventures.</SPAN>
		</td>
	</tr>
	                      <tr> 
                            <td colspan="2" align="center" height="5">
...
<img src="/images/classicons/necromancer_ani.gif" alt="Necromancer" border="0">
			
		</td>
		<td valign="top">
			<span class="libtitle">Necromancer</span>
			
			<span class="libsubtitle"></span>
			<br>
			<SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Necromancers are servants of the dark gods, studying ancient and mysterious tomes to gain power over the world of the dead. Necromancers are primarily a magic-using class, with the ability to wear cloth armor and wield blunt weapons and daggers.<BR><BR>Necromancers are able to raise the dead, commanding them to do their bidding and aid them in battle. A skeletal servant often accompanies the necromancer in her adventures throughout Norrath. Necromancers have mastered the powers of poison and disease, allowing them to assault their enemies with damaging afflictions that savage their vitality over time. <BR><BR>Necromancers learn to control and mimic the dead, allowing them to escape harm, convert their health to mana, and bend the minds of the undead to serve their cause. The power of shadow also is within the domain of the necromancer, with spells that bind and choke their enemies in darkness, hide the necromancer in a cloak of invisibility, and teleport through the shadows to escape danger.<BR><BR>Necromancers are a very self-sufficient class and often choose to adventure alone, though they can provide great value to a group as well. The necromancer is an excellent choice for the independent player who enjoys a wide variety of abilities.</SPAN>
		</td>
	</tr>
	                      <tr> 
                            <td colspan="2" align="center" height="5">
...
<img src="/images/classicons/shadowknight_ani.gif" alt="Shadowknight" border="0">
			
		</td>
		<td valign="top">
			<span class="libtitle">Shadowknight</span>
			
			<span class="libsubtitle"></span>
			<br>
			<SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Shadowknights are unholy warriors who use fear, pain and disease to attack all that is good in the world. Shadowknights are primarily a melee class, able to wear plate armor and wield many kinds of weapons.<BR><BR>Shadowknights are deadly opponents who use evil spells to slow and cripple their enemies. They steal the strength and life from their victims, using this stolen power to strengthen themselves and their allies. When needed, shadowknights use their powerful harm touch ability to greatly damage their opponents.<BR><BR>Shadowknights can feign the appearance of death, fooling enemies into ignoring them. Combined with spells that degrade an enemy's ability to fight, a shadowknight becomes a fearsome foe.<BR><BR>Shadowknights can use their dark powers to adventure solo for a time. The shadowknight's lethal abilities are best used, however, with the support of a larger group. Players who like offensive melee fights but want a variety of ways to inflict harm on their opponents will enjoy playing a shadowknight.</SPAN>
		</td>
	</tr>
	                      <tr> 
                            <td colspan="2" align="center" height="5">
...
<img src="/images/classicons/shaman_ani.gif" alt="Shaman" border="0">
			
		</td>
		<td valign="top">
			<span class="libtitle">Shaman</span>
			
			<span class="libsubtitle"></span>
			<br>
			<SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Shamans serve as priests to the tribal races of Norrath, able to draw upon the power of the spirits and focus it for their own purposes. Shamans are primarily a magic-using class, able to wear chain armor and wield blunt weapons and spears.<BR><BR>Shamanic magic has two main focuses - enhancing the mind and body of the shaman's allies, and weakening or damaging their enemies. A shaman's enhancement spells are always in demand, massively improving the strength, stamina, health, and other physical aspects of the shaman's group. Shamans also are able to heal their allies and have excellent health regeneration spells.<BR><BR>The weakening and damaging spells in the shaman's arsenal are tremendously effective in battle. The shaman attacks his enemies with diseases and poisons that cause massive damage over time, while using cold and ice magic to inflict damage directly. A brutal line of crippling spells can slow a monster's attacks, hamper their resistance to spells, and lower their physical prowess.<BR><BR>Shamans are a well-rounded class with strong abilities in both group and solo situations. An experienced shaman can turn the tide of any battle, bolstering their allies while weakening their enemies significantly. The shaman is an excellent class for players who enjoy working in groups.</SPAN>
		</td>
	</tr>
	                      <tr> 
                            <td colspan="2" align="center" height="5">
