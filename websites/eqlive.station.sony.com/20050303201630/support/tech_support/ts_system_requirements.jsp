...
<P ALIGN="center"><STRONG><BR><STRONG>System Requirements</STRONG></STRONG></P>  <P><STRONG>Required Specs:</STRONG></P>  <UL>   <LI>Windows&reg;
       98/2000/ME/XP</LI>   <LI>Pentium&reg; II 400
       equivalent or greater</LI>   <LI>256 MB RAM</LI>   <LI>ATI Radeon
       7500/NVidia GeForce 1 equivalent or greater</LI>   <LI>DirectX Compatible
       Sound Card</LI>   <LI>28.8k + Internet
       Connection</LI>   <LI>4X Speed CD-ROM</LI>   <LI>500MB -
       2.6GB&nbsp;Available Hard Drive Space (depending on how many expansions
       are installed)</LI>   <LI>DirectX 9.0b</LI>   <LI>EverQuest Classic
       and a valid EverQuest account</LI>  </UL>  <P>* Note: All Direct 3D cards not supported.</P>  <P><STRONG>Recommended Specs:</STRONG></P>  <UL>   <LI>Windows&reg;
       98/2000/ME/XP</LI>   <LI>Pentium&reg; 4
       equivalent or greater</LI>   <LI>512 MB RAM</LI>   <LI>NVidia GeForce 3/ATI
       Radeon 8500 equivalent or greater</LI>   <LI>DirectX Compatible
       Sound Card</LI>   <LI>56.6k + Internet
       Connection</LI>   <LI>16X Speed CD-ROM</LI>   <LI>3.0+ GB Available
       Hard Drive Space</LI>   <LI>DirectX 9.0b</LI>   <LI>EverQuest Classic
       and a valid EverQuest account</LI>  </UL>  <P>*Note: DirectX 9.0b or greater is required for all Win98/ME/2000/XP</P>  <P>System requirements subject to change as the game progresses.</P>  <P ALIGN="center"><STRONG>DirectX 9.0b or Higher
  Required</STRONG></P>  <P>Sony Online Entertainment has exciting news for all EverQuest players. As
  the world of Norrath evolves and expands, so too does the technology powering
  EverQuest. Sony Online Entertainment is making significant upgrades to the
  EverQuest engine which will allow SOE to provide players with the great game,
  but on a much more stable and efficient platform. More information on this
  can be found at <A HREF="http://boards.station.sony.com/ubb/everquest/Forum3/HTML/051233.html">http://boards.station.sony.com/ubb/everquest/Forum3/HTML/051233.html</A>.<BR>Part of this change will result in the need for all EverQuest players to
  upgrade to DirectX 9 (DX9), the latest version of Microsoft's 3D software.</P>  <P>To determine what version of DirectX is currently installed on your
  system:</P>  <OL>   <LI>Click the Start
       menu.</LI>   <LI>Use the Run command.</LI>   <LI>In the Open field,
       type &quot;DXDIAG&quot; then click OK. This will launch the DirectX
       diagnostics tool.</LI>  </OL>  <BLOCKQUOTE>  <P>Your version of DirectX will be listed at the bottom of the System
  Information area. For example, version 9.0b is listed as &quot;DirectX 9.0b
  ...
  problems:</P>  </BLOCKQUOTE>  <UL>   <LI>Go to <A HREF="http://www.microsoft.com/windows/directx/default.aspx">http://www.microsoft.com/windows/directx/default.aspx</A>       and install the latest DirectX version available for your operating
       system.</LI>   <LI>Go to <A HREF="../../../../../support/tech_support/ts_video.jsp">http://eqlive.station.sony.com/support/tech_support/ts_video.jsp</A>       and install the drivers listed for your card per the list there. If you
       require assistance in how to uninstall/install your drivers, or how to
       determine what video card you have, please go to <A HREF="../../../../../support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A>       for more information (this site applies to Win2k and WinXP users).</LI>   <LI>Go to the website for
       your sound card manufacturer and follow the same procedure. If you use a
       SBLive sound card, you can run &quot;LiveUpdate&quot; from the Windows
       Control Panel off of your start menu. View our Sound FAQ on how to
       uninstall/install your drivers, or how to identify your sound card, at <A HREF="../../../../../support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A>       (for Win2k and WinXP users).</LI>  </UL>  <BLOCKQUOTE>  <P>If you experience any problems, please do the following:</P>  </BLOCKQUOTE>  <UL>   <LI>Run DXDIAG.EXE from
       your Start menu (click start, run, then type &quot;dxdiag&quot;)</LI>   <LI>Click the &quot;Save
       all Information&quot; button at the bottom of the program window.</LI>   <LI>Save the file as
       &quot;dxdiag.txt&quot;</LI>  </UL>  <P>Email that file to <A HREF="mailto:eqtech@soe.sony.com">eqtech@soe.sony.com</A>  along with a complete description of your problem, the &quot;dbg.txt&quot;
  file from your EverQuest directory, the text from any error messages that are
  presented, and if you are willing to assist our test department over the
  phone, a phone number where you can be reached. If you are still having
  problems after visiting this support section, you can contact our Technical
  Support Department via email using our online form.</P>
