...
<tr>
	...
	<a href="recent_updates.jsp?id=64070" class="tinylink">July 13, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64064" class="tinylink">June 29, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64049" class="tinylink">May 11th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64052" class="tinylink">May 18th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64045" class="tinylink">April 20th, 2005</a><br>
...
<h1>July 13, 2005</h1>
<P>*** Headlines ***<BR><BR>----------------------------------<BR><BR>Trouble grows in Norrath! Dark Elves have been seen traveling the lands
  reeking havoc as they pass. Cities are calling out to their citizens for help
  gathering supplies in preparation for possible war.&nbsp; Something big is happening in Norrath
  now as the Age of War continues.<BR><BR>*** Events ***<BR><BR>----------------------------------<BR><BR>- Players should no longer be KOS to Killvak or the troll raiders in
  Barrenzin's mission &quot;Trollish Bloodlust&quot;<BR><BR>*** Spells ***<BR><BR>----------------------------------<BR><BR>- Increased the damage, mana, and cast time of the Necromancer and
  Shadowknight spell Siphon Life to better fit the progression of the other
  spells of the same type.&nbsp; </P>  <P>- Fixed a problem that caused Shadowknights to proc the
  wrong effects from Spirit of the Puma and Spirit of the Jaquar.&nbsp; </P>  <P>- When a rogue /consider's an NPC that can see through
  normal forms of invisibility, and the rogue is hidden from the NPC due to
  their Shroud of Stealth, the player will continue to receive the
  &quot;indifferent&quot; consider message but will also receive the following
  message: &quot;Your Shroud of Stealth keeps you hidden from watchful
  eyes.&quot;</P>  <P>- We have fixed the gating issue when on a mount and you
  are in the same zone you are bound and your vertical location of your bind point
  is much lower than you are currently.&nbsp;
  You will no longer fall to your death.&nbsp; Yeah for falling!</P>  <P>- When casting bind, your current heading will now be
  saved.</P>  <P>- Dark Sieve and Dark Sieve Recourse now have 200 range.<BR><BR>*** Pet Focus ***<BR><BR>----------------------------------<BR><BR>- Increased the innate AC bonuses granted to level 66+ pets by focus
  effects.&nbsp; </P>  <P>- Increased the melee damage bonuses provided by pet focus
  effects on level 66-70 pets.</P>  <P>&nbsp;</P>  <P>&nbsp;</P>  <P>*** Items ***</P>  <P>----------------------------------</P>  <P>- The new potions will now be level restricted as they
  were previously intended to be. </P>  <P>- Some type 9 augmentations are now usable in the charm
  slot.</P>  <P>- Plaguebreeze will now drop more frequently.</P>  <P>- Removed Patorav&#8217;s Amulet from the
  &quot;bonus&quot; table on Overlord Mata Muram.</P>  <P>- Mask of the Heretic now has 12 AC.</P>  <P>- Blightbringer&#8217;s Cap of the Grave now modifies the
  Specialization: Conjuration by 12%.</P>  <P>- Any type 9 augment that fit in a visible slot now is
  also a type 12 augment.</P>  <P>- Jelvan has learned the technology of the printing press
  and will now distribute his writings more often.<BR><BR>*** Auto Consent ***<BR><BR>----------------------------------<BR><BR>- Auto-consent raid, group, or guild will now auto-consent all future and
  existing corpses.&nbsp; If you turn off
  auto-consent then consent for your group, raid, or guild will be removed from
  all existing corpses.&nbsp; Please note
  that in order for a group member or raid member to be able to drag one of
  your existing corpses, they had to be in your group or raid at the time your
  corpse was created.&nbsp; This is the
  functionality that has always been in place.<BR><BR>*** Tasks and Missions ***<BR><BR>----------------------------------<BR><BR>- The entrance to Everfrost is now a little easier to explore.</P>  <P>- The issue preventing some groups from entering the
  Unrest mission has been fixed.</P>  <P>&nbsp;</P>  <P>&nbsp;</P>  <P>*** Graphics ***<BR><BR>----------------------------------<BR><BR>- /viewport should work with Advanced Lighting on now.</P>  <P>- We have fixed a common Reset Device error.</P>  <P>- Fixed an issue with rendering trees and other alpha'ed textures
  when running on older hardware.</P>  <P>- We have fixed a common crash with our DLL.<BR><BR>*** Particles ***<BR><BR>----------------------------------<BR><BR>- We have made some fixes to the particle rendering.&nbsp; Some people were seeing square
  textures.<BR><BR>*** UI ***<BR><BR>----------------------------------<BR><BR>- You can now use the &quot;Enter World&quot; button at character select if
  you are camped in tutorialb.</P>  <P>- Merchants' items should now be sort correctly using the
  Quantity column.<BR><BR>*** Tradeskills ***<BR><BR>----------------------------------<BR><BR>- Changed one of Chef Chowderly&#8217;s recipes.&nbsp; Pan Seared Orange Tuna will now use a
  Non-Stick Frying Pan in the recipe instead of a Large Stewing Pot.<BR><BR>-- The EverQuest Team</P>
