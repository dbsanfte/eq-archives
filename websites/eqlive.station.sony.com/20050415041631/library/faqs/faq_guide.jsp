...
<P ALIGN="center"><STRONG><BR><STRONG>Guide FAQ</STRONG></STRONG></P>  <P>This FAQ is to better explain what
  the Guide Program is and what issues you can expect help with.</P>  <P><STRONG>What is the Guide Program?</STRONG><BR>The EverQuest Guide Program is a group made up of volunteer EverQuest
  players. They offer you a way to expand your game play experience. The Guide
  Program has been around since beta and has done wonders in helping EverQuest
  customers with a variety of issues. </P>  <P><STRONG>How is the Guide Program
  organized?</STRONG><BR>There are four levels of Guides that a customer may run into while playing
  EverQuest: Apprentice Guide, Full Guide, Senior Guide and Elder Guide. Each
  of these levels has one common goal, and that is to enhance your experience.</P>  <P><STRONG>Apprentice Guide:</STRONG><BR>These are the newest members of the Guide Program. An Apprentice Guide's
  duties mainly consist of learning how the world of Norrath works so they may
  not have every answer for you. <BR>Things an Apprentice can do:</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Answer basic in-game questions, not including spoiler information. </P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Assist in the performance of dynamic quests and events.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Learn as much as possible from the world and people that populate it.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Interact with the world around them, providing role-playing
  experiences including weddings.</P>  <P><STRONG>Full Guide:</STRONG><BR>The next level of access is Full Guide. The majority of members in the Guide
  Program are Full Guides and are the most commonly found. <BR>Things a Full Guide can do:</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Answer basic in-game questions, not including spoiler information. </P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Assist in the performance of dynamic quests and events.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Interact with the world around them providing role-playing experiences
  including weddings.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Assist Apprentices that are working towards promotion to Guide.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Learn as much as possible from the world and people that populate it.</P>  <P><STRONG>Senior Guide:</STRONG><BR>The Senior Guide access level is the highest level you will most likely see
  online. Senior Guides are Guides who are willing to invest extra time in the
  Program. They handle the more difficult problems, and the administration of
  their server. Senior Guides continue to assist players with requests for
  assistance and are also responsible for communicating with the Elders and SOE
  to administrate their servers. A Senior Guide can do everything a Full Guide
  can, and more.<BR>What a Senior Guide can do:</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Everything a Full Guide can do. </P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Manage the Guide Program on their server.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Train and mentor Guides and Apprentices.</P>  <P>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Assist the Program and Elders as needed.</P>  <P><STRONG>Elder Guides:</STRONG><BR>Elder Guides are the consulting and management arm of the Guide Program. They
  are responsible for the welfare of the Guide Program as a whole. Elder Guides
  are the highest escalation point in the Guide Program. Elders jointly share
  the responsibilities, each being responsible for a portion of the issues that
  arise on the servers, and for the team or teams that fall under his/her
  sphere of influence. Elders will periodically rotate their responsibilities
  in order to maintain an overall perspective of the issues of the Program as a
  whole. An Elder Guide can do everything a Senior Guide can do. As a player,
  you will most likely not see an Elder Guide, as they are mainly responsible
  for handling issues within the Guide Program.</P>  <P><STRONG>How do I contact a Guide?</STRONG><BR>A Guide may be contacted by using the /guidehelp command or /tell. Guides
  will not help with communication via /shout, /ooc, /auct or /emote.</P>  <P>Once the /guidehelp command is
  used it will add your petition to a queue for a Guide to answer. Petitions
  are answered in order that they are received. It is desired by the Guide
  Program to answer every petition, even if the answer is that they cannot
  help. </P>  <P><STRONG>There are no Guides online when I
  play, what can I do to get help?</STRONG><BR>If you find that there are no Guides online when you play, you may wish to
  still file a /guidehelp ticket. Sometimes Guides may appear to be invisible.</P>  <P><STRONG>What can I do if I have a
  complaint against a Guide?</STRONG><BR>You can email <A HREF="mailto:eqcs@soe.sony.com"><STRONG>eqcs@soe.sony.com</STRONG></A> to make a formal
  complaint. Please make sure to have proof of your claim, such as logs or a
  date that you have done a /report. We take these seriously and will follow up
  on each claim.</P>  <P><STRONG>How can I become a Guide?</STRONG><BR>To become a Guide, you will need to fill out the application located at <STRONG><A TARGET="_blank" HREF="https://guide.everquest.com/guideapp/">https://guide.everquest.com/guideapp/.</A></STRONG> This application is graded on
  knowledge, grammar and spelling. You must be 18 years or older to join the
  Guide Program. </P>  <P>Once
  you fill out an application, a team of Guides will grade it. At times, this
  can take close to a month. If you are accepted, you will be sent a welcome
  letter and a date on which you must train. You will need to go through this
  training before you are given access as an Apprentice Guide. You will also
  receive e-mail if you are not accepted into the Guide Program.</P>
