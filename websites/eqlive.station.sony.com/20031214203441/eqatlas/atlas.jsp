	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/eqatlas/atlas.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/eqatlas/atlas.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">EQ&nbsp;Atlas</font></b></div>
                        <!-- #EndEditable --></td>
...
<TBODY>
<TR>
<TD width=1 rowSpan=2><IMG height=179 src="http://eqlive.station.sony.com/eqatlas/images/atlas_box_w-cd.jpg" width=145></TD>
<TD><SPAN class=libsubtitle>EverQuest<FONT face=arial>&reg;</FONT> Atlas: The Maps of Myrist<FONT face=arial>&#153;</FONT></SPAN><BR><SPAN class=manualtitle2><EM><FONT color=#ffffff>By the EverQuest Team</FONT></EM></SPAN></TD></TR>
<TR>
<TD vAlign=bottom>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD><SPAN class=manualtitle2>Spiral bound<BR>550+ pages<BR>Projected Release Date, October 14<BR><A href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-HG-SG1002-EQATLS-MPCD1">Pre-orders Now Accepted </A><BR>$19.99</SPAN><BR></TD>
<TD width=1><IMG height=128 src="http://eqlive.station.sony.com/eqatlas/images/atlas_complete_21.jpg" width=190></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
<P>At last, the rich and mysterious world of EverQuest is opened to players in a full-color book that uncovers the wonders of Norrath in fantastic detail. Introducing the EverQuest&reg; Atlas: The Maps of Myrist&#153;, an invaluable reference for players of one of the most popular online game worlds ever created.</P>
<P>Written by the EverQuest team, the EverQuest Atlas: The Maps of Myrist is a compilation of Norrathian history compiled by Maelin Starpyre, the Grand Historian of Myrist of the Plane of Knowledge, just one of the many new zones that will be available in EverQuest's fourth expansion pack, EverQuest&reg;: The Planes of Power&#153;.</P>
<P>A grand tome of information, and collector's item, the EverQuest Atlas: The Maps of Myrist provides an inside look at the shared world of Norrath. </P>
<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
<TBODY>
<TR>
<TD width=1><IMG height=137 src="http://eqlive.station.sony.com/eqatlas/images/atlas_book.jpg" width=156></TD>
<TD vAlign=top>
<UL>
<P>&nbsp;</P>
<LI class=smalltitle>Detailed zone maps 
<LI class=smalltitle>Notable NPCs 
<LI class=smalltitle>Bestiary 
<LI class=smalltitle>Dangers</LI></UL></TD>
<TD vAlign=top>
<UL>
<P>&nbsp;</P>
<LI class=smalltitle>Benefits to be found 
<LI class=smalltitle>Recommended skill levels 
<LI class=smalltitle>Zone fiction 
<LI class=smalltitle>Sneak Preview CD</LI></UL></TD></TR></TBODY></TABLE>
<P class=smalltitle align=center><STRONG>Sample Content</STRONG></P>
<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
<TBODY>
<TR>
<TD colSpan=2 height=20><STRONG>Everfrost Peaks</STRONG><BR>Bestiary</TD></TR>
<TR>
<TD background=images/orange_tile.jpg colSpan=2 height=1><IMG height=1 src="http://eqlive.station.sony.com/eqatlas/images/orange_tile.jpg" width=9></TD></TR>
<TR>
<TD vAlign=top width="50%">
<P><STRONG>Monster Level:</STRONG></P>
<P>1 - 15</P></TD>
<TD vAlign=top width="50%">
<P><STRONG>Monster Examples:</STRONG><BR>Snow Leopards&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Goblins<BR>Skeletons<BR>Gnolls<BR>Snow Orcs&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P></TD></TR>
<TR height=1>
<TD background=images/orange_tile.jpg colSpan=2 height=1><IMG height=1 src="http://eqlive.station.sony.com/eqatlas/images/orange_tile.jpg" width=9></TD></TR></TBODY></TABLE><BR>
<CENTER><IMG src="http://eqlive.station.sony.com/eqatlas/images/everfrost_map.jpg"></CENTER>
<P><EM>"The harsh, rugged environment of the frozen north has toughened the native creatures to the point that travel in the peaks is a very dangerous prospect to young adventurers. The snow blanketing the entire region makes it difficult for one not familiar with this area to navigate their way through the peaks. </EM></P>
<P><EM>Sharp and ridged, the peaks are dangerous to scale.&nbsp; Adventurers who are unfamiliar with this territory are advised to maintain a cautious pace, for one misplaced step will plummet them to their death."</EM></P>
<P><A href="http://eqlive.station.sony.com/eqatlas/Everfrost_Peaks.pdf">You can download the actual pages</A>, in PDF format,&nbsp;about Everfrost Peaks as it appears in the EverQuest Atlas: The Maps of Myrist&nbsp;for an example of all the great content this book provides.</P>
<P class=smalltitle align=center><STRONG>About the Authors</STRONG></P>
<P>The EverQuest team is responsible for maintaining the current EverQuest world and for creating new and exciting content. Comprised of some of the most talented designers, artists, and programmers in the industry, the EverQuest team's passion for creativity and storytelling drive them to always be seeking new ways to entertain their audience.</P>
<P>&nbsp;</P>
<P class=smalltitle align=center><STRONG>As a Special Bonus</STRONG></P>
<P>Each copy of the EverQuest Atlas: The Maps of Myrist&nbsp;is boxed with a Special Sneak Preview CD. This CD will give you a few extra Planes of Power goodies and a sneak peak at EverQuest Online Adventures.</P>
<UL>
<LI>Music samples from The Planes of Power&nbsp; 
<LI>Exclusive Planes of Power and EverQuest&reg; Online Adventures&#153; screen savers&nbsp; 
<LI>Exclusive EverQuest Online Adventures movies 
<LI>Stunning wall papers from both of these&nbsp;breakthrough&nbsp;titles&nbsp;</LI></UL>
<P>&nbsp;</P>
<P><A href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-HG-SG1002-EQATLS-MPCD1">Pre-order your copy today!</A></P>
