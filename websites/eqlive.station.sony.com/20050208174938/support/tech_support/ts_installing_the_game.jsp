...
<P ALIGN="center"><STRONG><BR><STRONG>Installing the Game</STRONG></STRONG></P>  <P><STRONG>Before installing EverQuest, make sure that your PC specifications
  ...
  to install.</P>    <OL>   <LI>Select a directory
       ...
       DirectX drivers:<BR>After the installation of EverQuest, an option to install DirectX will be
       provided. EverQuest will not run with any version of DirectX previous to
       9.0 at this time. Select &quot;Yes&quot; to proceed, then follow the
