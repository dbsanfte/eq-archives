	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/rz_rule_sets.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/rz_rule_sets.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P align=left><B>Rallos Zek rules:</B></P>
<P>Welcome to Rallos Zek, the&nbsp;first PvP server in EverQuest.</P>
<P>Rallos Zek, was the first PvP server in EverQuest. As such, many of the mechanics of the server are very specific. Unlike Tallon Zek, Vallon Zek, and Sullon Zek, there are no set teams. The only restrictions set on PvP are level restrictions.</P>
<P>This document includes the PvP rules for Rallos Zek. </P>
<OL>
<LI>Player v. Player (PvP) combat can occur between any characters that are within a 4 level limit. For instance, a level 45 person may attack or be attacked by anyone from level 41 through 49. There are no other PvP restrictions, such as Race or Alignment.<BR>
...
<LI>In the event that you kill or are killed by another player on this server, the loot rules are "Coin + 1 item". You may loot (or have looted from you) all coin on the corpse, plus an item. Items in bags, in a melee slot (primary, secondary, ranged, or ammo), or item marked NODROP may not be looted.<BR>
...
<LI>/consider returns only three kinds of results when used against player characters: 'Green' means that the character is below your range. 'White' or 'black' means that the character is within your range. 'Red' means that they are above your range. 'In range' means +/- 4 levels.<BR>
