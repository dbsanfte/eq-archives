	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/fippy_facts_archive.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/fippy_facts_archive.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/community/fippy_facts_archive.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P ALIGN="center"><STRONG><BR><STRONG>Fippy's Facts</STRONG></STRONG></P>  <P>It would be a waste not to save Fippy's contributions to the EverQuest
  community. We sure know he's not contributing much in Qeynos.</P>  <P>&nbsp;</P>

<p>
<table border="0">

<tr>
	                        <td>01/21/2003 5:41 pm</td>
	                        <td><a href="fippy_facts.jsp?id=53736" class="smalltitle">Fippy's Epic Quest for Epic Data</a></td>
</tr>
...
<option value="53736">Fippy's Epic Quest for Epic Data 01/21/2003 5:41 pm</option>
