...
<tr>
	...
	<a href="dev_view.jsp?id=64040" class="tinylink">Update scheduled for April 6<SUP>th</SUP> has been re-scheduled</a><br>
	
	<a href="dev_view.jsp?id=64040" class="tinylink">Halflings are April Fools . . .</a><br>
	
	<a href="dev_view.jsp?id=64038" class="tinylink">Server Merges</a><br>
	
	<a href="dev_view.jsp?id=64039" class="tinylink">Movelogs begin 3/29/2005</a><br>
	
	<a href="dev_view.jsp?id=64037" class="tinylink">Spring showers may bring flowers . . .</a><br>
...
<option value="64040">Update scheduled for April 6<SUP>th</SUP> has been r... 04/05/2005</option>
...
<h1>Update scheduled for April 6<SUP>th</SUP> has been re-scheduled</h1>
<P>We know that there are a lot of changes in the upcoming
  update that all of us are looking forward to.&nbsp; Due to the complexity and the sheer volume
  of these changes, we'd rather not push these out too quickly and so we'll be
  moving the Update to next Tuesday.&nbsp;&nbsp;
  The repurcussions of these changes (removal of the fear cap, changes
  to direct damage spells, new item effects, and others) are widespread and
  impact many systems. We are not comfortable pushing these changes live
  without further testing.&nbsp; We'd
  like to encourage all of you to please spend time on our Test servers and
  submit any bugs or feedback as you see appropriate.&nbsp; The Test Server patch message will
  contain more details about the changes and what to check out.</P>  <P>Thank you
  for your understanding in this matter. </P>  <P>Jamey Ryan</P>  <P>Technical Director - EverQuest </P>  <P>&nbsp;</P>
