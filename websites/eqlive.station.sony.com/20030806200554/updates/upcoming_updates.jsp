	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/upcoming_updates.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/upcoming_updates.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/updates/upcoming_updates.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Upcoming&nbsp;Updates</font></b></div>
                        <!-- #EndEditable --></td>
...
<tr>
	...
	<a href="upcoming_updates.jsp?id=57689" class="tinylink">Upcoming for August 6th, 2003 - updated 7-31-03</a><br>
	
	
	
	<a href="upcoming_updates.jsp?id=57387" class="tinylink">Upcoming for July and August, 2003</a><br>
	
	
	
	<a href="upcoming_updates.jsp?id=57285" class="tinylink">Upcoming for July 9th</a><br>
	
	
	
	<a href="upcoming_updates.jsp?id=56683" class="tinylink">Upcoming for June and July</a><br>
	
	
	
	<a href="upcoming_updates.jsp?id=56363" class="tinylink">Upcoming for June 11</a><br>
	
	
	
	
	<p><a href="upcoming_updates_archive.jsp" class="tinylink">Archives &gt;&gt;</a>
	</td>
</tr>
</table>
...
<h1>Upcoming for August 6th, 2003 - updated 7-31-03</h1>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial>It's been a little hectic around here lately, with all the Live, Legends and expansion work going on.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We're busy in that good way, where you get a lot done every day but tomorrow there's just as much to do.</FONT></P>
...
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><B style="mso-bidi-font-weight: normal"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></B></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">New adventure unearthed in Lavastorm!</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>In the depths of the Lavastorm mountains there is only one ruler.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>But even his burning breath and power have their limits.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Rumor has it that there is wealth and danger in locations even further below the boiling lands than Lord Nagafen can reach.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>These tales have been spreading like ripples on a calm lake, and their point of origin appears to be an upstart barbarian named Morden.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Some say that he's already delved these fabled caverns and taken what there was of value.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Other say that he couldn't have carried it all off by himself.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>But most say that he's a rogue, a teller of tales, and not to be trusted.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Will you discover the truth and brave the heat, or will you sit beside your cozy campfire and listen to stories?</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><BR><FONT face=Arial><B style="mso-bidi-font-weight: normal">New fletching recipes will be added.</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We're adding a few new fletching recipes.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>The resultant items will only be usable by Rangers that worship Karana, and will be comparable to their Tunare counterparts.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">Guktan Illusion will be implemented.</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Yup, the long-awaited new illusions will be available.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>While the old Illusion: Froglok spell is just as popular as ever, folks have been asking for an illusion based on the new Froglok models.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>After our next update, both will be available.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">Adding summoned Burning Affliction items to the Magician's arsenal.</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Four new summoned items with the new Burning Affliction focus ability will be introduced.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This rounds out the Magician's ability to create summoned focus items.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P><FONT face=Arial><I>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><I><STRONG>UPDATE:</STRONG><SPAN style="mso-spacerun: yes">&nbsp; </SPAN><STRONG>Well, one of the hazards of trying to talk about what will happen in the future is that someone will make a mistake.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This time it was me.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>The upcoming update on August 6<SUP>th</SUP> will not include any code changes.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We hope to update again at the end of the month with the code changes that will move the features listed below to the Live servers.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>I'm sorry for the mistake. - Alan<o:p></o:p></STRONG></I></P><o:p></o:p></I></FONT>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">We will be adding platinum to the Shared Bank.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN></B>In order to allow folks to transfer money between characters on the same account in the same way that they can now transfer items, we will be adding a spot in the Shared Bank for placing platinum. <o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">New filters and chat message options will be added.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN></B>We have separated pet melee messages into their own category.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>You will be able to send them to whichever chat window you want, or filter them out completely in the Options window.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We have also added the ability to send /random messages to any chat window you'd like.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>There is no option to filter these messages, however, to prevent any loss of the information in cases where it is needed (meaning, you can't claim that you didn't see the /random that you lost just to force a re-roll).</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">/memspellset command will be added.</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This new command will allow you to memorize the spell set you indicate (using the corresponding number) from the command line or from a hot button.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>Also, as a heads up to players that have created their own user interfaces for EverQuest, these are the interface files that we expect to change next week.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>EQUI_BankWnd.xml<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>EQUI_BigBankWnd.xml<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>EQUI_OptionsWindow.xml</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial></FONT>&nbsp;</P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><SPAN style="mso-bidi-font-size: 10.0pt"><o:p></o:p></SPAN></FONT>&nbsp;</P>
