...
//window.alert(document.cookie);
  ...
  about to enter a world ripe with adventure and intrigue. Before you do,
  please familiarize yourself with this manual. If you are new to EverQuest, or
  have just purchased one of the expansions (EverQuest: The Ruins of Kunark,
  ...
  you use a SBLive sound card, you can run &quot;LiveUpdate&quot; from the Windows
  Control Panel off of your start menu. View our Sound FAQ: (<A HREF="../../../../../support/tech_support/ts_audio_trouble.jsp">http://eqlive.station.sony.com/support/tech_support/ts_audio_trouble.jsp</A>)
  ...
  please email your dbg.txt file from your EverQuest directory to <A HREF="mailto:EQtech@soe.sony.com">EQtech@soe.sony.com</A>.</P>
	...
	<STRONG>System Requirements</STRONG> <BR><BR>Before you install the game, make sure that your system meets the following
  ...
  installing the game, creating an account, running the tutorial and starting
  and stopping EverQuest.
  ...
  software, you should run ScanDisk and Disk Defragmenter to ensure that your
  hard drive is working properly and is problem-free. (To do so, click <STRONG>Start</STRONG>  &gt; <STRONG>Run</STRONG>, then type scandisk or defrag and click <STRONG>OK</STRONG>.) <BR><BR>The next step in installing the game is to make sure your system meets or
  ...
  If the directory does not exist, it will automatically be created. <BR><BR>6. (Optional) Install the DirectX 8.1 drivers.<BR>* The DirectX 8.1 files included on the game CD contain drivers for most
  video cards and sound cards. For brand-new or lesser-known hardware, you may
  need to contact your manufacturer to obtain the latest DirectX drivers.<BR>* If you already have DirectX 8.1 installed, click No when prompted. If you
  ...
  <BR><BR>12. A subscription window appears. Click <STRONG>Now</STRONG> to start a subscription.
  <BR><BR>13. Select a payment method and fill in all required billing information,
  ...
  Keep that in mind when choosing your campsite.
	...
	Once you log in and select a
  game server, the Character Select screen appears. It lets you create, manage and
  ...
  each time you log in, then click on a character slot to activate it.) <BR><BR>* Then click <STRONG>Enter World</STRONG> to start playing.
	...
	This screen lets you build
  your character through a series of steps: <BR><BR><STRONG>Step 1 - Pick a Race</STRONG> <BR><BR>Norrath has 13 known races, each of which was established in a specific
  ...
  famously with Ogres, sharing similar likes, dislikes and pastimes. Outdoorsy
  and not quite bright, they're easily recognizable due to their skin's natural
  ...
  is always his art. <BR><EM>Modifiers</EM>: +5 Strength, +10 Dexterity, +10 Charisma <BR><BR><STRONG><EM>Beastlord (only available with Shadows of Luclin)</EM></STRONG>: Beastlords are
  the spiritual warriors of the primitive cultures of Norrath and Luclin. Like
  the Shaman, the Beastlords have a close relationship with the spirit world.
  The Beastlord's fighting style is derived from tactics used by wild beasts
  thus they prefer to fight unarmed or with only small piercing weapons. But
  the Beastlord is best known for his life-long animal companion. <BR><EM>Modifiers</EM>: +10 Stamina, +5 Agility, +10 Wisdom, +5 Charisma <BR><BR><STRONG><EM>Berserker</EM></STRONG>:
  ...
  points. The amount differs by race and/or occupation. You can add these points
  to any ability - but you should probably add most of them to your green
  &quot;primary&quot; abilities. <BR><BR>* Click &quot;+&quot; to add a bonus point to an ability.<BR>* Click &quot;-&quot; to remove a bonus point from an ability. (You can't
  ...
  Character Creation screen. Depending on your occupation and race, you can either
  choose from several of 18 specific deities, or remain agnostic (not a
  ...
  are above your range. 'In range' means +/- 5 levels. <BR><BR>11. /consider will also display a message indicating what team the target is
  on. Members of your own team will be displayed as an 'ally'. <BR><BR>12. Faction hits for PvP will be taken for killing characters within their
  ...
  through combat. Causing experience loss by 'training' NPCs on other
  characters is not an offense that would warrant a warning this server. <STRONG>HOWEVER:
  All rules regarding general decency still apply</STRONG>. Cursing, threats and
  other such things will be dealt with sternly, and are still unacceptable
  behavior on any PvP server. <BR><BR>14. Beneficial effects can not be used on members of another team. <BR><BR>15. No character will be able to bind in dungeon zones. <BR><BR>16. 'Buff' spells will not affect characters more than 20 levels lower than
  ...
  of the test platform.</EM></P>
	...
	The EverQuest interface
  engine is designed to be easy to use and adjust for every player. With a few
  clicks of the mouse any player can customize the interface to meet their
  needs. But it also offers some very powerful customization ability for those
  that have some experience using XML. This manual only covers the options
  available within the interface. Those wishing to delve into the XML and
  'skin' the interface for themselves should read the AboutSIDL.doc located in
  the EverQuest directory. <BR><BR><EM>Tool Tip: Many items in the interface have tool tips attached to them.
  ...
  with a little note like this one.</EM>
	...
	The EverQuest interface is,
  basically, a selection of windows that provide information and tools that
  you'll need to play the game. Many of these windows have special purposes and
  special features. But there are some properties that most of these windows
  have in common. So the first thing we'll cover here are the very basic
  features of the windows themselves. We'll move on to describe individual
  windows later. <BR><BR><STRONG>For all of the descriptions that follow, we'll be assuming that you are
  ...
  shorter, you need to drag it from the top or the bottom. If you want to make
  it wider or thinner, drag it from one of the sides. If you point at the
  corners of the window, the arrows will be diagonal to the window. This allows
  you to drag the window in both directions at once.
  ...
  windows, have scroll bars on the right side that allow you to scroll through text
  or options. You can click the down or up arrows at the top and bottom of the
  scroll bar to scroll the text up or down incrementally. You can also click on
  the bar itself to scroll in larger increments. Or you can click and drag the
  scroll bar up or down. <BR><BR>Players with a wheel mouse can use the mouse wheel to scroll up and down in
  ...
  'inactive' part of the window (for example, you won't be able to open the
  menu if you click on one of the spell gems in the spells window, but you can
  click on the space between the gems). <BR><BR>Some windows have unique options on their setting menus. We'll discuss those
  ...
  shows up in the title bar for this window. The Target Window shows the relative
  health of the character that you currently have targeted.
  ...
  below your Player Window and has the word Group in the title bar. If you are
  not in a group, the only thing visible in this window will be the Invite and
  ...
  in the upper right of your screen, just inside the Player Window. The window
  title bar says Effects. This window displays the spells, poisons, diseases
  and other things that are currently affecting your character. <BR><BR><EM>Tool Tip: Pointing at one of the icons in your Effects Window will tell
  ...
  Tips for your Spells Window.</EM>
	...
	The Inventory Window is not open
  by default. You can click on the second icon from the left (the human figure
  icon) to open your inventory, or you can press &quot;i&quot; on your
  ...
  Luclin owners with characters over 50th level). It also give the character
  the option to send some of their experience points to their Alternate
  Experience pool. See <A HREF="../../../../../manual/manual.jsp%3fhandle=appendixd">Appendix D</A> for
  more details on Alternate Experience. <BR><BR><EM>Destroy Button</EM> - use this button to destroy items. If you are holding
  ...
  open by default. You can open it by clicking on the nut icon on the Window Selector,
  or by hitting <STRONG><EM>Alt-O</EM></STRONG>. The Options Window has four tabs; General,
  Display, Mouse and Keyboard. Each of these tabs allows you to change some of
  the basic settings of the game. Where an option is set by a button, the
  option is ON if the button is depressed, OFF if the button is out. <BR><BR><EM>Note: There is no 'done' or 'accept' button for the Options Window.
  ...
  Non-Player Characters over their heads. <BR><BR><EM>Level of Detail</EM>: When on the detail levels for distant NPCs and PCs
  are reduced. This may improve performance on slower computers. <BR><BR><EM>Video Modes</EM>: This button will bring up another window. In this window
  ...
  allows you to find keyboard commands by specific category, or you can just choose
  All to see all the commands at once. <BR><BR><EM>Changing an Option</EM>: To change the keystroke(s) that activate a
  command, just click on the item in the Keypress column that you wish to
  change. Text will appear asking you to press a key. The keystroke (or combination)
  that you press will appear in the column. <BR><BR><EM>Reload Defaults</EM>: This resets all keyboard options to their default. <BR><BR>Example: One of the most common Keyboard changes is to 'remap' the attack
  ...
  filtering out chat messages altogether (to have them not show up in a particular
  window, use the Chat Windows options). Any Chat Option that you choose to
  filter will not show up in any of your Chat Windows. Additionally, these
  messages will not be sent to your computer from the server. This has the
  advantage of reducing the information sent over the Internet, and can improve
  your performance in some cases. Listed below are the types of messages that
  you can filter out, and any options available on the particular filter. <BR><BR>Guild Chat<BR>Socials<BR>Group Chat<BR>Shouts<BR>Auctions<BR>Out of Character<BR>My Misses<BR>Others Misses<BR>Others Hits<BR>Attackers Missing Me<BR>Damage Shields<BR>NPC Spells<BR>PC Spells [All/Group/Off]<BR>Bard Songs [All/Me/Group/Off]<BR>Critical Spells [All/Me/Off]<BR>Critical Melee [All/Me/Off] <BR><BR><EM>Note: Keep in mind that you are choosing which messages you see. So
  ...
  open be default. It is designed to help you manage your Friends List. The Friends
  List is useful for keeping track of people that you meet in game. <BR><BR>Adding a friend to the list is easy. Just type their character name (you need
  ...
  open by default. It is designed to help characters with pets by providing a single
  window for pet information and commands. <BR><BR>At the top of the window will be the name of the pet (or No Pet if you have
  ...
  in game as you need it.
	...
	Right-clicking on a merchant will
  open the Merchant Window (if you are close enough - otherwise right-clicking
  the merchant is the same as using /consider) and your Inventory Window. <BR><BR>The merchant's name appears at the top of the window, with a display of the
  ...
  tips.</EM>
	...
	Right-clicking on a banker will
  open the Bank Window (if you are close enough - otherwise right-clicking the
  banker is the same as using /consider) and your Inventory Window. <BR><BR>The word Bank appears in the title bar of the window. Below that are eight
  ...
  your items have a place in your inventory after any trade.</EM>
	...
	To open the Give Window pick up
  an item and left-click on a Non-Player Character. The Give Window says Give
  in the title bar, and looks a lot like the Banker Window, and it works much
  the same way. There are four slots into which you can place items that you
  wish to give to the NPC, along with four coin slots. To complete or cancel
  the transaction, use the Give or Cancel buttons on the bottom of the window. <BR><BR><EM>Important Note: Never stack items when giving them to an NPC to complete a
  ...
  to False will turn off the display of pet health bars in these windows. </P>
	...
	The sit and camp buttons are located
  on the Main Tab of the Actions Window.<BR><BR>Whenever you're resting, you should sit down. This allows your character to
  ...
  the wilderness, you're fair game for any non-player predators out there. Gnoll
  pups are notorious for ganging up on solo travelers, as are Kobolds.
  Generally speaking, the farther you are from a friendly city the more
  dangerous the area will be.
	...
	In EverQuest, you can travel via
  several methods. You've already learned how to walk, run and swim (short
  distances). A few cities have docks from which you can catch a boat. Some
  powerful spell-casters can also cast teleportation spells. <BR><BR><EM>To take a boat:</EM> <BR><BR>* Find a pier and stand or sit nearby. Make sure you can see the end of the
  ...
  source of social interaction. You can chat with fellow players on message
  boards, or talk to NPCs and other players within the game. <BR><BR>In general, whenever you send a message all players in the immediate vicinity
  &quot;hear&quot; you, and whatever you typed appears in the scrolling text
  portion of their screens (their Chat Window). However, you can also send
  private messages. <BR><BR>You send messages using the Chat Bar (at the bottom of the Chat Window), and
  ...
  when you first walk into their store or selling booth, but they don't often like
  to talk about anything outside of their immediate realm of existence (in
  ...
  these chat modes by prefacing your message with the appropriate / command.
  For example, if you wish to Shout &quot;Hello World!&quot; to everyone in
  your current zone, you simply: <BR><BR>* Press <STRONG><EM>Enter</EM></STRONG> to open the Chat Bar.<BR>* Type: /shout Hello World!<BR>* Press <STRONG><EM>Enter</EM></STRONG> to send the message. <BR><BR>Here some of the available chat modes. <BR><BR><EM>Say</EM> (Default): Use /say [text]. Sends your message to all nearby
  ...
  world communicate using a Common Tongue by default, no matter who or what
  they are. However, most races also possess the ability to speak in a native
  ...
  to summon or enchant creatures and claim them as pets. Pets protect you and
  can follow a number of commands that you type in. See <A HREF="../../../../../manual/manual.jsp%3fhandle=usingpets">Using Pets</A> for
  details.
  ...
  detect hostility from a stranger. This ability, called consideration, lets
  you know (through a text message) how a targeted NPC/player/monster feels
  about you. In general, this helps you assess your target's perception of you.
  It also comes in handy when you're considering whether or not to attack a
  ...
  displays his shop goods. <BR><BR><EM>Note: Player characters (on most servers) will always appear to be
  Indifferent. Also, if an NPC does not know you are there (through
  invisibility or other means) it will appear to be indifferent. That does not
  mean that he is actually indifferent, it just means that he can't see you. He
  might like you or hate you, however, once he knows you are there.</EM>
  ...
  indispensable skill. If you're a pack rat you'll constantly need to reassess
  what you're carrying and figure out what to do with the items you've
  accumulated. <BR><BR>You can view your inventory by clicking on the Inventory Icon. <BR><BR><EM>You can also access your inventory by hitting <STRONG>i</STRONG></EM>. <BR><BR>The detailed view of your inventory is divided into several sections. You can
  ...
  the box provided.
	...
	Items stored in a general
  inventory slot are not in use. If you want to hold a weapon or wear a new
  item of armor or clothing, you've got to move it to the right location slot: <BR><BR>* Click on an item in a general inventory slot.<BR>* Once the item is floating on your cursor, click on an appropriate location
  ...
  as a representation of the item).<BR>* Click in an open inventory slot .
	...
	Whether you're new to EverQuest
  or a battle-tested veteran, you'll find that you need to buy and sell items
  on a regular basis. At the very least, you'll need to buy food and drink.
  Selling to merchants is different from selling to players. The following
  steps work with non-player shopkeepers; to sell to another player, see <A HREF="../../../../../manual/manual.jsp%3fhandle=giving">Giving/Trading Items</A>.
  <BR><BR><EM>To buy/sell an item:</EM> <BR><BR>* Right-click on a merchant NPC (<EM>Note: you will have to be relatively
  ...
  something you might want to trade for, click on their characters. This targets
  them and, if you're standing close enough to them, opens their Inventory
  window. It is often considered polite to ask permission before doing such an
  inspection. <BR><BR>See <A HREF="../../../../../manual/manual.jsp%3fhandle=giving">Giving/Trading
  ...
  you'll find that you sometimes need to get rid of valuable items. You may
  only need an item for a little while, perhaps to accomplish a quest. You
  might have just upgraded your armor and weapons, or maybe you've grown tired
  of your jewelry-making kit. Or, you could need a spell ingredient yourself -
  the old adage &quot;one man's trash is another man's treasure&quot; holds
  true in EverQuest as well. <BR><BR>Auctioning allows you to send out an area-wide message that all players in
  ...
  along with rat steaks, bear meat and fancier food items. You start the game
  with 20 skins of milk and 20 loaves of bread. Generally, you'll consume these
  at the rate of 1 per game day (about 6 hours playing time). <BR><BR>When you're running low on either item, your text display shows &quot;You are
  ...
  Banks</A> for more details). Most cities have banks in which you can store
  coins and general inventory items. <BR><BR><STRONG>Merchant Prices</STRONG> <BR><BR>When you buy something, coins automatically transfer from your inventory into
  ...
  better you become at it. When you improve a skill ranking, a message appears
  in your Chat Window. In order for a skill to improve, your character must
  know the basics (for some skills this will require expending at least one
  practice point in that skill). Skill rankings are tied to your experience
  level - you can only improve a skill so much at Experience Level 1, improve
  it a bit more at Level 2, more at Level 3, and so on. <BR><BR>You can develop as many skills as you like - there's no limit. Some skills,
  ...
  a skill onto a Hot Button. When you've done this, you simply click that
  button to use the skill: <BR><BR>* Click on the <STRONG>Abilities Tab</STRONG> of the Actions Window, then right-click
  ...
  casting).<BR><EM>Block</EM>: Deflect an attack using your body (Beastlords and Monks only).<BR><EM>Blunt, One-Handed</EM>: Fight with blunt, one-handed weapons.<BR><EM>Blunt, Two-Handed</EM>: Fight with blunt, two-handed weapons.<BR><EM>Defense</EM>: Avoid damage during combat.<BR><EM>Disarm</EM>: Knock weapon from enemy's hands.<BR><EM>Dodge</EM>: Avoid blows during combat.<BR><EM>Double Attack</EM>: Apply increased attack damage.<BR><EM>Dragon Punch</EM>: Special Monk attack.<BR><EM>Dual Wield</EM>: Use a weapon in each hand.<BR><EM>Eagle Strike</EM>: Special Monk attack.<BR><EM>Feign Death</EM>: Fake death (Monk only).<BR><EM>Flying Kick</EM>: Special Monk attack.<BR><EM>Hand-to-Hand</EM>: Fight without weapons.<BR><EM>Instill Doubt</EM>: Cause fear in your opponent.<BR><EM>Kick</EM>: Kick during combat.<BR><EM>Offense</EM>: Basic ability to inflict damage during combat.<BR><EM>Parry</EM>: Deflect blows with your weapon.<BR><EM>Piercing</EM>: Use piercing weapons.<BR><EM>Riposte</EM>: Respond to an attack with an attack of your own.<BR><EM>Round Kick</EM>: Special Monk attack.<BR><EM>Slam</EM>: Throw a shoulder into an opponent.<BR><EM>Slashing, One-Handed</EM>: Fight with edged, one-handed weapons.<BR><EM>Slashing, Two-Handed</EM>: Fight with edged, two-handed weapons.<BR><EM>Taunt</EM>: Anger an enemy to draw his attacks away from someone else.<BR><EM>Throwing</EM>: Use hand-thrown weapons.<BR><EM>Tiger Claw</EM>: Special Monk attack.
	...
	<EM>Abjuration</EM>: Deals
  primarily with defensive magic; for example, a spell that enables the
  character to take less damage from extreme cold. <BR><BR><EM>Alteration</EM>: Deals with changing things, whether it is illusion or an
  ...
  spells using less mana and with a higher rate of success.
	...
	<EM>Bind Wound</EM>: Heal target
  an amount based on skill level (requires bandages).<BR><EM>Mend Wounds</EM>: Heal oneself (Monk only).
  ...
  something without a key.<BR><EM>Pick Pocket</EM>: Steal from an NPC (or another player on a player
  vs-player server).<BR><EM>Sneak</EM>: Sneak up behind or past someone without being heard.
  ...
  experience and view your current experience level in the Inventory screen.
  Even though your text display sends you a message each time you advance a
  level, it's a good idea to occasionally check your stats and level status. <BR><BR>The yellow/orange bar is the experience that you've gain toward the next
  ...
  your progress towards your next level.
	...
	Grouping will make it easier
  to gain experience, especially after your first few levels. Three people
  hacking away at a Kobold or a Gnoll are much more effective than trying to
  take one on yourself. Each time a party defeats an opponent the experience
  points are split among the group members according to their experience
  levels. The higher your experience level, the larger your portion. There is a
  grouping experience bonus, the more people in your party, the larger the
  bonus.
	...
	In EverQuest, you can fight
  using short-range melee weapons (swords, clubs and so forth), ranged weapons
  (bow and arrow), or your bare hands. If you've got magical spells, you can
  use those in combat as well - see <A HREF="../../../../../manual/manual.jsp%3fhandle=magicusing">Using Magic</A>.
  ...
  basic weapon at the start of the game. As you earn money doing whatever you
  do, you can visit merchants to buy bigger, better weapons. However, make sure
  you hang onto your original weapon for a while - even a basic sword isn't
  cheap, and it's nice to have a backup in case you lose a better weapon along
  the way. A bank inventory slot is an excellent place to store unused weapons.
  <BR><BR><EM>Tip: If you're in a real financial bind but you own a pole and some bait,
  ...
  greater challenge.</EM>
	...
	You can fight manually in
  EverQuest by using weapon skills you've learned, but combat is generally
  easiest if you use the auto-attack function instead. Once you've got a target,
  you can simply press <STRONG><EM>q</EM></STRONG> (or whichever key you've remapped this
  function to), and your character will automatically make the attack. Your
  only task at that point is to stay close enough to the target to hit it. <BR><BR><STRONG><EM>q</EM></STRONG> Initiate auto-attack (on current target).<BR><STRONG><EM>Esc</EM></STRONG><EM>ape</EM> Remove current target from Target
  ...
  initially more vulnerable than other types of characters. Physical abilities are
  sacrificed for mental prowess, but eventually most spell casters become
  feared and revered citizens of Norrath. Building a life as a Wizard,
  Magician, Necromancer, Enchanter, Druid, Cleric or Shaman might be more
  difficult than pursuing other occupations at times, but the rewards can be
  great...
	...
	All spell casters carry a
  spell book. You can open the book at any time by clicking the book icon. Once
  you copy a spell from a scroll (scribe it), it is permanently recorded in
  your book. <BR><BR>You can &quot;memorize&quot; eight scribed spells at any one time by placing
  ...
  Resting or meditating restores your mana faster than standing.
	...
	Some classes (such as a Paladin's
  ability to Lay on Hands) have one or more spell-like abilities that are very
  much like skills and don't involve spell scrolls, scribing or meditating. You
  can use them as often as your level permits. For most spells, however, you
  must obtain a spell scroll, record it in your spellbook and memorize it
  before you can cast it. <BR><BR>You can buy spell scrolls from magic vendors, and if you're an aspiring spell
  ...
  special quests can also yield spells.
	...
	EverQuest has literally
  hundreds of spells that you can acquire and cast at various levels of
  experience. They're far too numerous to list here, but for the most part they
  can be classified into four types: <BR><BR><EM>Offensive</EM>: Spells that are, or add punch to, combat attacks. Examples
  ...
  time it takes you to memorize a spell by Meditating. This helps speed up the
  process of scribing and memorizing spells, but it's a skill-based ability. If
  you press the Meditate button but nothing happens, that means that you don't
  yet have the Meditate skill. If you have the skill, it will automatically be
  used whenever you memorize or scribe a spell. <BR><BR>Meditating for long periods of time helps you regain mana faster, and is more
  ...
  Window.
	...
	If you've chosen a magical
  occupation, you can cast certain spells as a beginner. As you gain experience
  levels, you can learn more advanced spells. <BR><BR>Here are a couple of the spells you can learn at Level 1 for each magical
  ...
  attacking. When you successfully taunt a monster, it turns and starts
  attacking you instead. You'll find that taunting is an indispensable group
  skill, especially if you want to keep the spell casters in your group alive. <BR><BR>Taunt is a combat skill. To use this skill you will need to set up a button
  ...
  and Dying</A>, for additional details on taking damage.
	...
	Guards immediately kill
  unfriendly creatures if they come too close. This can be good for you (if, for
  example, some creature is about to beat you to a pulp), and bad for you (if a
  guard kills a monster you won't get experience for it nor will you be able to
  loot the corpse). So it's a good idea to know where the local guards are.
  ...
  your class and purchase it before you can summon or charm a pet. Look for
  spells that begin with &quot;Summon,&quot; &quot;Befriend,&quot;
  &quot;Charm,&quot; or that contain the word &quot;Animal&quot; or
  &quot;Undead.&quot; A variety of pet-related spells also exist that you can
  use to heal your pet or boost its abilities. <BR><BR>Once you have a pet, you can instruct it to taunt your target, attack, follow
  ...
  a zone line.<BR><STRONG>/pet attack [target]</STRONG> - Tells the pet to attack the designated target.<BR><STRONG>/pet back off</STRONG> - Tells the pet to stop its attack.<BR><STRONG>/pet as you were</STRONG> - Returns the pet to neutral, belaying all prior
  orders.<BR><STRONG>/pet get lost</STRONG> - Will send the pet back to where it came from.<BR><STRONG>/pet report health</STRONG> - Reports the health of your pet in percentages.<BR><STRONG>/pet health report</STRONG> - Reports the health of your pet in percentages.<BR><STRONG>/pet health</STRONG> - Reports the health of your pet in percentages.<BR><STRONG>/pet taunt</STRONG> - Toggles pets taunting.<BR><STRONG>/pet notaunt</STRONG> - Tells the pet not to taunt its opponent.<BR><STRONG>/pet no taunt</STRONG> - Tells the pet not to taunt its opponent.<BR><STRONG>/pet taunt off</STRONG> - Tells the pet not to taunt its opponent.<BR><STRONG>/pet taunt on</STRONG> - Tells the pet to taunt its opponent.<BR><STRONG>/pet stand</STRONG> - Causes the pet to stand up.<BR><STRONG>/pet sit</STRONG> - Causes the pet to sit down. <BR><BR><EM>Note: Pets have a limited range at which they can hear commands. If a pet
  ...
  outside the city's gates, or in arenas within the city. The arena zones are
  clearly marked in your chat window when you enter them. <BR><BR>If you attack another player in the city, the guards might attack and kill
  you.
	...
	Several servers have been created
  specifically for player-vs-player (PvP) combat. Currently, there are four -
  Rallos Zek, Sullon Zek, Tallon Zek and Vallon Zek. <BR><BR>See <A HREF="../../../../../manual/manual.jsp%3fhandle=server">Server
  ...
  started. <BR><BR>* Don't join a PvP server for your first EverQuest experience. It's probably
  ...
  enough damage, his health bar falls to zero and he dies. The character doesn't
  permanently die - he regenerates near your starting city (at your 'spawn' or
  'respawn' point). <BR><BR>Until a character reaches tenth level, he respawns with all of his items. But
  ...
  hard, don't worry. Dying won't strip you of your possessions or coins - as long
  as your body is recoverable (for example, don't drown at the bottom of an
  aqueduct - it may be a difficult task to find that exact spot and resurface
  without dying again). <BR><BR>If your character dies he will 'respawn' at his 'bind point', which for new characters
  is just outside their starting city. Characters under level 10 will respawn
  with all of their items and can continue their adventures right away. But
  once a character reaches 10th level he will begin to leave a corpse on the
  ground at the location of his demise. In order to recover the character's
  items, you will need to find that corpse. <BR><BR>To reclaim what's rightfully yours, locate your body, right-click on it, and
  put the items into your inventory (see <A HREF="../../../../../manual/manual.jsp%3fhandle=pickingup">Picking
  Up/Dropping/Destroying Items</A>).
  ...
  the same zone (corpses cannot be dragged across zone lines). Permission can be
  granted to another player, a guild, a group, or raiding party. Type in
  ...
  &quot;locked.&quot; No one else can take what's in your inventory. The only
  trick is that you have a limited amount of time in which to find your body
  and transfer items to your inventory. <BR><BR>Corpses only remain in the world for a short while. Player corpses have a
  ...
  the timer on a corpse ticks down whether you are in game or not.</EM>
	...
	During gameplay you can view
  your character from several different camera angles, zoom in and out, or pan
  up and down. <BR><BR>To cycle between available views, press <STRONG><EM>F9</EM></STRONG>. <BR><BR><EM>First-person view (default)</EM> - View straight ahead (you can't see your
  ...
  Zoom view in / out
	...
	Every window in can be enabled or disabled for viewing by
  engaging the customizable hot-key combination for that feature and window.
  The only exception is the main Chat Window, which can never be disabled. The
  defaults are: <BR><BR><STRONG><EM>ALT - B</EM></STRONG>: Buff/Spell Effects Window<BR><STRONG><EM>ALT - P</EM></STRONG>: Party (Group) Window<BR><STRONG><EM>ALT - S</EM></STRONG>: Spell Gem Window<BR><STRONG><EM>ALT - H</EM></STRONG>: Hot Button Window<BR><STRONG><EM>ALT - T</EM></STRONG>: Target Window<BR><STRONG><EM>ALT - Y</EM></STRONG>: Self-Status Window<BR><STRONG><EM>ALT - M</EM></STRONG>: Menu Window<BR><EM><STRONG>ALT - C</STRONG></EM>:&nbsp;Compass Window
  ...
  can be dangerous. Joining a group can help you defeat monsters that you
  normally can't kill, carry items that won't fit into your inventory, and
  progress through levels faster than you would alone. <BR><BR>Any player can group with any other, however the amount of experience
  ...
  target group members 1-6 respectively. <BR><BR><EM>Communication</EM>: Keeping in touch with group members is crucial. Before combat,
  make sure everyone is present and prepared to do battle. <BR><BR><EM>Group Leader</EM>: Every group needs a leader. It's a good idea to elect
  someone to make decisions about important party matters. <BR><BR><EM>Group Health</EM>: The names of fellow group members appear in the group
  member window. Below each name is a bar that shows that member's current
  health status. <BR><BR><EM>Groups and Spells</EM>: Some spells affect all members of a group. If
  ...
  Items can't be split and should be fairly awarded on a case-by-case basis.
	...
	Guilds take the basic idea behind
  forming groups a step further by making the group an official organization,
  complete with a charter, or a written set of intentions and purposes. Guilds
  allow players with similar ideas to form semi-permanent groups. <BR><BR>The reasons for joining a guild mirror some of the reasons for joining a
  ...
  and meet its leader. When you hand over the right scroll, you form a lasting association
  with a group and agree to abide by its charter. <BR><BR>Player-created guilds have a leader (usually the creator) who invites other
  ...
  guilds from time to time. When this occurs, guild leaders may decide to declare
  war between their guilds. If both leaders agree, they can open hostilities by
  using the <STRONG>/guildwar</STRONG> command. <BR><BR>Guild wars may vary in duration from the default of 1 day to a maximum of 14
  ...
  that applies to EverQuest Expansions and is new to the original game. The
  bulk of this information regards new or changed skills and abilities
  available to those who have purchased the EverQuest: The Ruins of Kunark
  upgrade or retail box, the EverQuest: The Scars of Velious Expansion and/or
  the EverQuest: Shadows of Luclin Expansion.
  ...
  within Velious. There are traps, and they range from annoying to deadly throughout
  Velious. They are invisible and can only be detected and disarmed by rogues
  and bards. <BR><BR>Use &quot;Sense Traps&quot; to see if there are any traps in the vicinity. If
  ...
  directed towards the closest one.
	...
	Due to the importance of faction
  within Velious, we wanted to avoid a situation where a group could die in an
  area, and then easily bring in someone with good faction to drag all of the
  corpses out without consequence or risk. As such, there are some zones in
  Velious where dragging a corpse is considered &quot;assisting the enemy&quot;
  by the inhabitants of the area. They will react accordingly.
  ...
  notice &quot;Dragon Circles&quot; in the Iceclad  Ocean, the Great Divide, the Wakening Lands, and Cobalt Scar. These dragon circles
  are teleport locations for the wizard and druid teleports into Velious. <BR><BR>Dragon teeth were needed in order to teleport to these locations. That is no
  ...
  contains a file named EQCLIENT.INI. This file contains custom settings for
  most user preferences within EverQuest. The EQCLIENT.INI file is split up
  ...
  listed here alphabetically, they may not appear in this order in the .ini
  file. The order of their appearance in the file is inconsequential to their
  ...
  is set to TRUE, than the window that shows your buff icons and icons of
  spells cast upon you will not show up. You can easily get it to show again in
  game by hitting Alt-B. <BR><BR><STRONG>HideChatWin</STRONG> = TRUE or FALSE <BR><BR>This statement is the same as the Alt-C function in game. If this statement
  ...
  into the game. <BR><BR><STRONG>ScreenMode</STRONG> = NORMAL or FULL <BR><BR>Sets the default screen mode for when you enter the game. <BR><BR><STRONG>ServerFilter</STRONG> = [0-1] <BR><BR>0=No, 1=Yes. If this line is set to 1, than Server side filtering is
  occurring. Default is 0. If you are having problems with lag in a raid
  situation, or when many other players are in the same general area in
  EverQuest, it is best to have this set to 1. <BR><BR><STRONG>ShowDynamicLights</STRONG> = TRUE or FALSE <BR><BR>Setting this line to TRUE enables the player to see special graphics due to
  ...
  to kill it.&quot;
	...
	You may enter pauses in social
  batches with the /pause command. /pause takes an argument from 1 to 600 (600
  = One minute), with the value being equal to the number of tenths of seconds
  (i.e. /pause 100 will yield a 10 second pause). <BR><BR>For example, a social consisting of: <BR><BR>/sit off<BR>/cast 1<BR>/pause 100<BR>/sit on <BR><BR>...would cause you to stand up, cast the spell in slot 1, wait 10 seconds
  ...
  is specified first, it is executed AFTER the command on the same line. <BR><BR>For example: <BR><BR>/sit off<BR>/pause 100,/cast 1<BR>/sit on <BR><BR>...would have the same effect as the example above. It is important to note
  ...
  of the pure melee (Warriors, Monks, and Rogues) and hybrid (Paladin,
  Shadowknight, Ranger, and Bard) classes. These disciplines are listed&nbsp;on
  the combat UI screen which you can bring up by hitting Ctrl+C. You cannot use
  any other discipline until the reuse time of the last-used discipline has
  expired. The window will show&nbsp;which disciplines you have learned as well
  as the reuse times for any you have&nbsp;used.&nbsp;<BR><BR>Some disciplines, particularly the ones with long duration, have a
  disadvantage in addition to the advantage provided by the discipline. In all
  cases where this happens, the disadvantage is less severe than the advantage.
  For instance, where the Evasive Discipline allows a warrior to be hit by his
  ...
  riposte every attack landed on him by the opponent he is facing. This discipline
  lasts for 9 seconds, and has a base reuse time of 60 minutes. The reuse time
  for this discipline will decrease as the monk gains additional levels. <BR><BR>VOIDDANCE (Level 54): When using this discipline, the monk cannot be hit in
  ...
  decrease as the monk gains additional levels. <BR><BR>SILENTFIST (Level 59): When this discipline is activated, the next successful
  ...
  facing. This discipline lasts for 9 seconds, and has a base reuse time of 60
  minutes. The reuse time for this discipline will decrease as the warrior
  gains additional levels. <BR><BR>PRECISION (Level 57): The warrior will have a greater chance to hit his
  ...
  Only): Auto dodge and auto dual-wield. This discipline lasts for 10 seconds, and
  has a base reuse time of 72 minutes. <BR><BR>PURETONE (Level 60 - Velious Only): Makes it as if you are wielding the best
  ...
  72 minutes.
	...
	POTECTIVE SPIRIT (Level 55 -
  Luclin Only): When using this discipline, the Beastlord will take roughly
  1/3rd damage from most physical attacks. This discipline lasts for 12
  seconds, and has a base reuse time of 12 minutes. The reuse time for this
  discipline will decrease as the Beastlord gains additional levels. <BR><BR>BESTIAL RAGE (Level 60 - Luclin Only): When using this discipline, all hits
  ...
  Only): Critical Hits and Crippling Blows versus undead with an increased
  probability of going off. This discipline lasts for 2 minutes, and has a base
  reuse time of 72 minutes. <BR><BR>SANCTIFICATION (Level 60 - Velious Only): Immunity to most types of harmful spells.
  This discipline lasts for 10 seconds, and has a base reuse time of 72
  minutes.
  ...
  Only): Max to two times max bow damage with an increased hit probability. This
  discipline lasts for 2 minutes, and has a base reuse time of 72 minutes. <BR><BR>WEAPONSHIELD (Level 60 - Velious Only): Parry all melee attacks. This
  discipline lasts for 15 seconds, and has a base reuse time of 72 minutes.
	...
	UNHOLYAURA (Level 55 - Velious
  Only): 25% increase to damage done by Harmtouch in addition to making it
  nearly un-resistable. This discipline has a base reuse time of 72 minutes. <BR><BR>LEECHCURSE (Level 60 - Velious Only): Heal self for every point of melee
  ...
  form of information, assistance, or the occasional divine intervention. During
  these times, your best bet is to turn to EverQuest's battalion of Game
  ...
  without the hindrance of unforeseen problems.
	...
	To seek help, type /petition
  [text], where [text] is a concise message explaining what you need help with.
  <BR><BR>Since thousands of players may be online at the same time, GMs may be swamped
  ...
  Master</A>), explaining the fact that you have filed a /report, with a brief
  explanation of what the /report is meant to show.
	...
	<P>Due to variations in today's hardware
  and software, please check the following before you attempt to contact
  Customer Service: <BR><BR>* Your computer meets or exceeds the <A HREF="../../../../../manual/manual.jsp%3fchapter=2">EverQuest System
  ...
  /commands available within game. You can get a complete list of all /commands
  available to you in game by typing /help [type] where &quot;type&quot; is
  ...
  AFK message. <BR><BR><STRONG>/assist [<EM>target</EM>]</STRONG> or <STRONG>&lt;<EM>character name</EM>&gt;</STRONG> - if
  you target a character that is within 200', the /assist command will automatically
  target for you whoever that character has targeted at the moment- this can be
  very useful in heavy combat. To be most effective, it is best to set this as
  a Social (see IV.F above) <BR><BR><STRONG>/assist [<EM>ON/OFF</EM>]</STRONG> - Toggles the autoattack function associated
  ...
  is saved in your eqclient.ini file in the [Defaults] section as
  ChannelAutoJoin=&lt;channel-list&gt;. See the section in this manual about
  Chat Channels for more information. <BR><BR><STRONG>/autosplit [<EM>ON/OFF</EM>]</STRONG> - automatically splits any loot you get
  ...
  is used in full screen mode only to change the chat font size. <BR><BR><STRONG>/consent &lt;<EM>character name</EM>&gt;</STRONG> - gives the character
  permission to drag your corpse /consider or /con - gives vital statistics of
  a targeted PC or NPC. <BR><BR><STRONG>/corpse [<EM>target</EM>]</STRONG> - will summon the target's corpse if it is
  ...
  from your friends list. /friend &lt;<EM>character name</EM>&gt; will add the
  player to your list, and /friend &lt;<EM>character name</EM>&gt; again, for the
  same character, will remove him/her. /friend by itself will list the players
  in your friends list. A /who friend will let you know if anyone on your
  friends list is in the zone you are in, and a /who all friend will let you
  know if anyone on your friends list is on the server you are on. Your friends
  list can only contain 30 names per character. And be aware that in order to
  remove someone from the list, you must type their name precisely. <BR><BR><STRONG>/gems</STRONG> - This command allows a player to play the game Gems. <BR><BR><STRONG>/gsay &lt;<EM>text</EM>&gt;</STRONG> or <STRONG>/g &lt;<EM>text</EM>&gt;</STRONG> - text is
  ...
  <BR><BR><STRONG>/help [<EM>emote/guild/normal</EM>]</STRONG> - Shows the player all of the commands
  available in area specified. <BR><BR><STRONG>/hidecorpses [<EM>all/none/allbutgroup</EM>]</STRONG> - This command allows the
  ...
  in a new disk may.</EM> <BR><BR>If you have AutoPlay enabled on your computer (which is windows default), it
  ...
  probably not be able to play. <BR><BR><STRONG>/msg</STRONG> - This is the same as using <STRONG>/Tell</STRONG>. <BR><BR><STRONG>/note &lt;<EM>text</EM>&gt;</STRONG> - Allows the player to write notes when in-game
  to be referenced later out of game. This creates a notes.txt file of the
  text. Each line of text sent using /note is appended to the end of this file.
  There is a maximum number of 455 characters when creating a note. <BR><BR><STRONG>/ooc &lt;<EM>text</EM>&gt;</STRONG> - allows you to say something as yourself,
  ...
  (based on the clock on your computer). <BR><BR><STRONG>/trackfilter [<EM>Red/Yellow/White/Blue/Green</EM>]</STRONG> (Ranger only) - Specify
  here what NPC /con colors you do not want to see in your tracking display.
  For example, /trackfilter Red will remove all 'red' (dangerous) NPCs from
  your tracking display. <BR><BR><STRONG>/trackplayers [<EM>ON/OFF</EM>]</STRONG> - Allows those with the tracking skill
  to indicate whether or not they want player characters to show up in their
  ...
  closest NPC listed last, Rconsider has the tracking list from low level on top
  to high level below. <BR><BR><STRONG>/usercolor [<EM>Chat Type</EM>] Rvalue Gvalue Bvalue</STRONG>. - For example, For
  ...
  Manual
	...
	EverQuest: The Ruins of Kunark was released with a new
  printed manual, which is also available for download on the main EverQuest
  site at www.everquest.com. As with any static printed material associated
  with dynamic games such as EverQuest, information has a potential to be
  outdated. In addition to some obsolete information included in the manual,
  there were also several inaccuracies. These are listed below. Please refer to
  your printed or downloaded manual so that the comments may be taken in
  context.
  ...
  Player-versus-Player combat, and is against the rules.
	...
	p.35: Section should read: <BR><BR>As a new player, stick to the cities - they're relatively free of monsters,
  and other players can't kill you. (You have to become a player-killer, or PK,
  to give other player-killers &quot;permission&quot; to attack you. You do
  this by giving a Priest of Discord the <STRONG>Child of Discord</STRONG> book in your
  inventory.) If someone attacks you in the city, regardless of your PK status,
  numerous guards may immediately come to the rescue, <STRONG>providing that they
  are fond of you. Beware though, if the guards are fond of your attacker, and
  are not fond of you, they may choose to assist your enemy.</STRONG> <BR><BR>*Note: Changes to the original text are in bold text.
  ...
  you are considered a master of that skill. Though you will continue to gain skill
  points as you use the skill, the highest that will be reflected on the skill
  page is &quot;Master&quot;. <BR><BR>If your skill is over 100 you will also be shown the numeric value of your
  ...
  references text color associated with &quot;Considering&quot; your target.
  ...
  Yellow, Red. The listed descriptions apply in that order.
	...
	p.58: This section makes
  several references to separate &quot;auto-attack&quot; keys for the right and
  left hands. These functions were merged prior to the release of EverQuest,
  and are now controlled by a single auto-attack button (the &quot;Q&quot; key
  by default).
  ...
  command brings up an interface that allows you to choose a new face for your character
  using the new models for Shadows of Luclin. You <STRONG>must</STRONG> have the Luclin
  character model enabled for the race of the characters whose face you are
  trying to change. <BR><BR><EM>Note: This command will be reusable for a while after the release of
  ...
  the old models cannot ride horses, turning off the new model for a certain race/sex
  also turns off the ability to see them riding horses.</EM> <BR><BR>This line in the eqclient.ini file: <BR><BR><EM>LoadSocialAnimations=true</EM> <BR><BR>Turns on or off the new Shadows of Luclin character social animations. These
  ...
  Class Abilities:</STRONG> <BR><BR>There are three types of Alternate Abilities: General, Archetype and Class Abilities.
  Each is a stepping stone for the next. Attaining a certain number of General
  abilities is required before you can learn any abilities from your Archetype.
  Similarly, you will have to attain a prerequisite number of abilities from
  your Archetype to start gaining abilities from your Class group. There are
  also level requirements for each of these levels. Keep in mind that you can't
  gain any of these abilities unless you own Shadows of Luclin. <BR><BR>These requirements are in addition to any prerequisites needed for some
  ...
  abilities. <BR><BR><EM>Class abilities</EM>: A character must have spent twelve skill points on
  ...
  abilities.
	...
	Once you have gained enough experience
  points toward alternate advancement (enough to fill the experience bar) you
  will earn one skill point. It is these skill points that allow you to
  purchase alternate advancement abilities. Each ability will require a certain
  number of skill points to purchase one skill level with that ability. <BR><BR>Every ability available through the Alternate Advancement system has a skill
  ...
  characters will be granted a title to show their efforts. The title for anyone
  meeting the requirements for General Abilities will be given the title Baron
  or Baroness. Other titles will be given as the character progresses through
  their alternate advancement, but we don't want to spoil the fun by giving
  them all away here.
  ...
  two times, in game time and real life time. For every minute that passes in the
  real world, 20 minutes passes in the game world.
  ...
  this ability increases the character's base Agility by two points. <BR><BR><EM>Improved Natural Dexterity</EM>: (5 skill levels) - Each skill level with
  this ability increases the character's base Dexterity by two points. <BR><BR><EM>Improved Natural Intelligence</EM>: (5 skill levels) - Each skill level
  ...
  points. <BR><BR><EM>Improved Natural Poison Resistance</EM>: (5 skill levels) - Each skill
  level with this ability increases the character's base resistance to poison
  by two points. <BR><BR><EM>Improved Natural Disease Resistance</EM>: (5 skill levels) - Each skill
  ...
  character's base regeneration by one point every six seconds.
	...
	The Archetype abilities are available
  only characters level 55 and above that have spent six skill points on
  General Abilities. There are three Archetypes&nbsp;- Caster, Melee and
  ...
  third brings the decrease to 25%. Bards can not gain this Archetype Ability because
  they do not have 'casting times' over four seconds. <BR><BR><EM>Spell Casting Expertise</EM>: (3 skill levels) - Each skill level negates
  ...
  Archetype ability costs two skill points. The second skill level of each Archetype
  ability costs four skill points. The third skill level of each Archetype
  ability costs six skill points. All Archetype abilities are passive. <BR><BR><BR><EM>Channeling Focus</EM>: (3 skill levels) - Each skill level reduces the
  chances of spell interruption due to damage or movement. The first skill
  level reduces the chance of interruption but 5%, the second skill level
  ...
  to 15% and the third raises the increase to 30%.
	...
	The Class abilities are only available
  to characters level 59 and above that have spent twelve skill points to
  purchase Archetype Abilities. Obviously a character can only choose Class
  Abilities belonging to their class. <BR><BR>There are two types of Class ability. The first type is similar to the
  Archetype abilities, with three skill levels. The cost for those types of
  skills are always the same. The first skill level of these Class abilities
  cost three skill points. The second skill level costs six skill points. The
  third skill level costs nine skill points. <BR><BR>The second type of Class ability only has one skill level. However, that one
  ...
  level of both Mental Clarity and Improved Natural Healing. <BR><BR><EM>Extended Notes</EM>: (3 skill levels) - Each skill level increases the
  range that the Bard's group songs can reach. The first skill level increases
  the range of the Bard's group songs by 10%, the second raises the range
  increase to 15% and the third makes the increase 25%. <BR><BR><EM>Instrument Mastery</EM>: (3 skill levels) - Each skill level increases the
  ...
  ability gives the Bard one additional skill level in their Natural Durability,
  Combat Agility and Combat Stability abilities. <BR><BR><EM>Scribble Notes</EM>: (1 skill level - cost 3 skill points) - This ability
  ...
  to cast the spell Divine Aura on another character without the memorization of
  a spell or the expenditure of mana. The Refresh Timer for this ability is 144
  minutes (two days of game time). <BR><BR><EM>Celestial Regeneration</EM>: (1 skill level - cost 5 skill points -
  Prerequisite: 3 skill levels of the Priest Archetype ability Healing Gift) - This
  ability gives the Cleric the power to generate a large heal over time effect
  on a single target without the memorization of a spell or the expenditure of
  mana. The Refresh Timer for this ability is 72 minutes (one day of game
  time). <BR><BR><EM>Divine Resurrection</EM>: (1 skill level - cost 5 skill points -
  ...
  resurrection effects) from the target without the memorization of a spell or the
  expenditure of mana. The Refresh Timer for this ability is 72 minutes (one
  day of game time). <BR><BR><EM>Spell Casting Reinforcement Mastery</EM>: (1 skill level - cost 8 skill
  ...
  of game time).
	...
	<EM>Dire Charm</EM>: (1 skill level
  - cost 9 skill points) - This ability allows the Druid to charm an NPC
  ...
  Timer for this ability is 72 minutes (one day of game time). <BR><BR><EM>Enhanced Root</EM>: (1 skill level - cost 5 skill points) - This ability
  gives the Druid a 50% reduction to the chance that his direct damage spells
  will break the hold of root spells on his target. <BR><BR><EM>Exodus</EM>: (1 skill level - cost 6 skill points) - This ability gives the
  ...
  evacuation spells by 10%, the second skill level makes the reduction 25% and
  the third makes the reduction 50%. <BR><BR>Spell Casting Reinforcement Mastery: (1 skill level - cost 8 skill points -
  ...
  the Monk a chance to do a flying kick on ripostes in addition to the normal riposte.
  The first skill level with this ability gives the Monk a 25% chance of a
  Return Kick, the second skill level raises that chance to 35% and the third
  raises the chance to 50%.
	...
	<EM>Call to Corpse</EM>: (1 skill
  level - cost 6 skill points) - This ability gives the Necromancer the power
  to summon a corpse without the use of components or memorization of a spell.
  The Refresh Timer for this ability is 72 minutes (one day of game time). <BR><BR><EM>Dead Mesmerization</EM>: (1 skill level - cost 3 skill points) - This
  ...
  will use up to as much as twice the mana if the caster has that much
  available. The Refresh Timer for this ability is 72 minutes (one day of game
  time). <BR><BR><EM>Mend Companion</EM>: (1 skill level - cost 5 skill points) - This ability
  ...
  Each skill level increases the damage reduction. <BR><BR><EM>Adv. Trap Negotiation</EM>: (3 skill levels) - This ability reduces the
  Refresh Timer for the Bard's Sense Traps and Disarm Traps skills, making
  those skills available sooner after use. Each successive skill level further
  reduces the time needed between uses of these skills. <BR><BR><EM>Ambidexterity</EM>: (1 skill level - cost 9 skill points) - This ability
  ...
  alchemy skill. The first skill level reduces the failure chance by 10%, the
  second skill level raises the reduction to 25% and the third skill level
  raises the reduction to 50%. <BR><BR><EM>Cannibalization</EM>: (1 skill level - cost 5 skill points - Prerequisite:
  ...
  affect spell. The spell would benefit everyone in the area, not just the
  caster's group. This Ability causes the spell to use up to as much as twice
  as much mana. It will require at least the normal casting cost, and will use up
  to as much as twice the mana if the caster has that much available. The
  ...
  for this ability is 36 minutes (twelve hours of game time). <BR><BR><EM>Bandage Wound</EM>: (3 skill levels - Prerequisite: 3 skill levels of the
  General ability First Aid) - This ability allows the Warrior to use the Bind
  Wounds skill to greater effect. The first skill level makes his Bind Wound
  skill 10% more effective, the second skill level raises the increase to 25%
  and the third makes the increase 50%. <BR><BR><EM>Double Riposte</EM>: (3 skill levels) - This ability gives the Warrior a
  chance for a double riposte any time he successfully ripostes. The first
  ...
  - cost 6 skill points) - This ability gives the Druid the power to cast the
  spell Succor instantly and without the memorization of a spell or the
  expenditure or mana. The Refresh Timer for this ability is 72 minutes (one
  day of game time). <BR><BR><EM>Improved Familiar</EM>: (1 skill level - cost 9 skill points) - This
  ...
  open or join as many as 10 chat channels above and beyond the pre-created
  channels. The commands and discussion below only apply to these
  player-created channels, not to the game-wide channels such as /ooc or
  /shout. <BR><BR><BR>These are a few of the terms used to describe the chat channel functions: <BR><BR>[] = optional parameters, &lt;&gt; = required parameters <BR><BR>&lt;CHANNEL&gt;= &lt;CHANNEL-NAME 1..10 |&gt;[:&lt;PASSWORD&gt;]<BR>&lt;CHANNEL-LIST&gt;= &lt;CHANNEL&gt;[,...] <BR><BR>This means that any place below where it lists &lt;CHANNEL-ENTRY&gt;you can
  ...
  your channel number 1). The invitation arrives as a text message. If the channel
  is password protected, the invited person can enter the channel only once
  without a password.<BR><BR><EM>/chat grant &lt;character-name&gt; [channel]</EM> - Grants moderator
  ...
  password protected channel is the only type of channel that is
  semi-permanent. Such a channel will disappear after it has been empty for 24
  hours. All other channels cease to exist once they are empty.<BR><BR><EM>/chat kick &lt;character-name&gt; [channel]</EM> - Kicks the character
  named off of the chat channel listed. If no channel is specified the
  character will be kicked our of your first channel (whichever channel is your
  channel number 1).<BR><BR><EM>/chat moderate [channel]</EM> - Sets the specified channel to 'moderated'
  ...
  hours. All other channels cease to exist once they are empty.</EM> <BR><BR><EM>Note for advanced users: /chat and / can be replaced with a semicolon ( ;
	...
	Here are a few commands that you
  can use to make your chat channels even more friendly. <BR><BR><EM>/autojoin &lt;channel-list&gt;</EM> - Saves the channels listed and
  automatically ;sets you to those channels when you log in. This information
  is saved in your eqclient.ini file in the [Defaults] section as
  ...
  create separate windows for your combat text. This is a rather advanced
  feature, so it might take a little practice to get the results that you want.
  <BR><BR>Here is the technical jargon: <BR><BR>Usage: /hitsmode &lt;my|me|other&gt; &lt;on|off|m2|m3|m4|m5&gt; &lt;X&gt;
