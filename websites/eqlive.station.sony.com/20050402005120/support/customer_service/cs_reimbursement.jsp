	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_reimbursement.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_reimbursement.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_reimbursement.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P ALIGN="center"><STRONG><BR><STRONG>Reimbursement Policy</STRONG></STRONG></P>  <P><STRONG>In an effort to more efficiently assist our customer base, we have
  evaluated and revised our Reimbursement Policy. The primary goal of these
  modifications is to give our GMs more latitude in assisting our players. It
  is our goal to be able to keep our customers as satisfied as possible and to
  balance that with the overall integrity of the game. We are confident that
  the changes below will perform this task.</STRONG></P>  <P ALIGN="center"><EM>This policy is not
  all-inclusive and there are situations outside the scope of the policy that
  may be determined at the specific time to not warrant an item reimbursement.
  Please remember that no requests for reimbursals are guaranteed to be
  fulfilled.</EM></P>  <P><STRONG>1. Bind Death Loops</STRONG></P>  <P><STRONG>Bind Death Loops occur when a player is killed repeatedly upon
  return to his or her bind point with no available means of escape, typically
  due to the player's faction with the NPCs at their bind point.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;1.1. Any losses due to bind death loop situations may be
  reimbursed after an investigation and solely at the discretion of the Game
  Master.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.1.1 <EM>Note: Please remember to only
  be bound in safe places.</EM><EM><BR></EM><BR>&nbsp;&nbsp;&nbsp;1.2. If a player is in a bind death loop, the GM may remove
  the player from the loop once contacted.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2.1 <EM>Note: If you find yourself in a
  bind death loop, please do the following:</EM></P>  <BLOCKQUOTE>  <UL>   <LI><EM>Attempt to camp
       the affected character out of game.</EM></LI>   <LI><EM>Upon returning
       to the character select screen, either log in another character, or make
       a new character to log in game on the same server.</EM></LI>   <LI><EM>For assistance,
       petition in game on that same server with the name, location, and details
       of what is taking place.</EM></LI>  </UL>  </BLOCKQUOTE>  <P><STRONG>2. Coins</STRONG></P>  <P><STRONG>Coins are the cash that players use as currency with merchants and
  other players.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;2.1. Coins (platinum, gold, silver, and copper) may be
  reimbursed under some circumstances. Such a reimbursement would take place
  after an investigation and at the discretion of the GM.</P>  <P><STRONG>3. Containers</STRONG></P>  <P><STRONG>Containers as referred to herein are both world containers, such
  as forges, ovens, or pottery wheels, and mobile containers, such as spits or
  sewing kits. These containers are those that allow the creation of new items
  using player trade skills.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;3.1. Items lost when combined in world containers, such
  as forges, ovens, etc. (intentionally or accidentally) may be reimbursed
  after an investigation and at the discretion of the GM.&nbsp;&nbsp;&nbsp;</P>  <P><STRONG>4. Deleted/Missing Player Characters</STRONG></P>  <P><STRONG>Characters are deleted from the character select screen, which is
  only accessible using your account station name and password.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;4.1. Deleted/Missing characters may be restored after an
  investigation and at the discretion of the GM.&nbsp;&nbsp;&nbsp;4.1.1 <EM>Note:
  A restore of a deleted or missing character cannot be guaranteed, including
  any items of any kind that were on the character at the time of deletion. It
  is imperative that you contact a GM immediately if you wish to request a
  character restore.</EM></P>  <P><STRONG>5. Destroyed Items</STRONG></P>  <P><STRONG>Items are destroyed by using the Destroy option on your inventory
  screen in game. The option can be set to either Fast Destroy On or Off under
  your Options in game; this option allows you to confirm whether or not you
  wish to destroy an item.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;5.1. Items that are destroyed, intentionally or
  accidentally, may be reimbursed after an investigation and at the discretion
  of the GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.1.1 <EM>Note: To avoid accidentally
  destroying an item, we suggest you turn off the fast item destroy option.</EM></P>  <P><STRONG>6. Dropped Items</STRONG></P>  <P><STRONG>Items are dropped by targeting the item away from any PC, NPC, or
  the inventory screen and clicking the left mouse button. The option is
  available to set Item Dropping to Fast Drop, Confirm, or Never.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;6.1. Items dropped, intentionally or accidentally, may
  be reimbursed after an investigation and at the discretion of the GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6.1.1<EM>Note: To avoid accidentally
  dropping an item, we suggest you set the item dropping option to never.</EM><BR>&nbsp;&nbsp;&nbsp;6.2. Items that fall to the ground during trades due to a
  full inventory, or due to those items not fitting into a container may be
  reimbursed after an investigation and at the discretion of the GM.<BR>&nbsp;&nbsp;&nbsp;6.3. Any items that are thrown as a projectile, such as
  items placed in your range slot, intentionally or accidentally, may not be
  reimbursed.</P>  <P><STRONG>7. Experience</STRONG></P>  <P><STRONG>Varying amounts of experience are gained by killing NPCs and are
  lost upon death.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;7.1. Experience will not be restored for any death
  caused by latency (a.k.a. &quot;lag&quot;), Link-Death, or other forms of
  disconnection.<BR>&nbsp;&nbsp;&nbsp;7.2. If there is a known server-wide player drop,
  resurrections may be authorized.<BR>&nbsp;&nbsp;&nbsp;7.3. Experience may not be restored for any death caused by
  duels, Player vs. Player combat, or NPC attacks.</P>  <P><STRONG>8. Faction</STRONG></P>  <P><STRONG>A player's &quot;Faction&quot; is comprised of a combination of
  their race, class, deity, and deeds (what they've done in the world), and
  this combination defines how NPCs interact with you in the world. While race,
  class, and deity are fixed in nature, how other NPCs look at you can be influenced
  pro or con based on what you do in the world.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;8.1. Factions may be restored to a previous save after
  an investigation and at the discretion of a GM.</P>  <P>&nbsp;&nbsp;&nbsp;&nbsp; 8.1.1. Note: A restore of faction cannot be
  guaranteed. It is imperative that you contact a GM immediately if you wish to
  request a faction restore.</P>  <P><STRONG>9. NO RENT Items and Containers</STRONG></P>  <P><STRONG>NO RENT Items are items that remain on the character only until a
  player logs out of game. These items would include summoned bags, weapons, or
  any looted items with the NO RENT description.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;9.1. All items classified as NO RENT and all contents
  lost in NO RENT containers may be reimbursed after an investigation and at
  the discretion of a GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9.1.1. <EM>Note: If a player is
  disconnected from the game while they have NO RENT Items on their character,
  they have 30 minutes after the time of disconnection before the No Rent item
  is destroyed. If they log back on within this 30 minute period, the items
  should still be in game.</EM></P>  <P><STRONG>10. NPC's/Corpses of NPC's</STRONG></P>  <P><STRONG>An NPC is a non player character that upon death may leave a
  corpse in game.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;10.1. Any disappearing NPCs, items or corpses of an NPC,
  may be reimbursed after an investigation and at the discretion of a GM.
  However NPCs may not be spawned and items not looted will most likely not be
  reimbursed.<BR>&nbsp;&nbsp;&nbsp; 10.2. Mistakenly looted NO DROP items may be transferred
  after an investigation and at the discretion of a GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 10.2.1. <EM>*Note: Intentional
  Ninja-Looting will be dealt with as a separate issue. This only applies to
  situations of non-malicious looting.</EM></P>  <P><STRONG><EM>11. PC Corpse Decay</EM></STRONG></P>  <P><STRONG><EM>Under level 10 characters return from death with all of their
  items, so corpses decay quickly. If you are level 10 and above, then you have
  seven days of time (offline or online) to loot your corpse. We strongly
  recommend that you recover your corpse as quickly as possible. If you are
  level 10 and above, a corpse with no items on it will decay in three hours.</EM></STRONG></P>  <P><STRONG><EM>The Resurrection timer for any corpse is 3 hours of online
  time. Online time includes any time spent on any character on the account in
  question, any time spent on any character&nbsp;on the account in question,
  any time spent at the character select&nbsp;screen, or any time spent waiting
  in chat.</EM></STRONG></P>  <P><EM>&nbsp;&nbsp;&nbsp;11.1. Any corpse lost to normal decay rate,
  including any items on that corpse, may be reimbursed after an investigation
  and at the discretion of a GM.</EM></P>  <P><STRONG><EM>12. Quests</EM></STRONG></P>  <P><STRONG><EM>Quests are available in game to gain items and/or experience
  for performing certain tasks for one or more NPCs.</EM></STRONG></P>  <P><EM>&nbsp;&nbsp;&nbsp;12.1. Items lost in any Quest may be reimbursed
  after an investigation and at the discretion of a GM.</EM><BR><EM>&nbsp;&nbsp;&nbsp;12.2. Items that are lost or a reward given to wrong
  person due to Multi-Questing will not be transferred or reimbursed.</EM><BR><EM>&nbsp;&nbsp;&nbsp;12.3. NPCs in Quests that disappear or are killed may
  not be respawned, nor will items on the NPC's be reimbursed.</EM><BR><EM>&nbsp;&nbsp;&nbsp;12.4. Items lost in any Quest performed incorrectly may
  not be reimbursed.</EM><BR>&nbsp;&nbsp;&nbsp;12.5 Any item given to the Tribute Masters with the
  intention of gaining Tribute points will not be reimbursed.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12.5.1 Any items lost due to accidental
  turn in, may be reimbursed at the discretion of a GM in the way of a
  character restore to a previous save.<BR><EM>*Note: Any restores, to a previous save, will cause any gained items,
  experience, skills, or flags, to be lost.</EM><BR>If other items are traded, dropped, or otherwise removed from the character
  before it is restored, those items will be deleted from the restored
  character's inventory or the restoral denied.</P>  <P><STRONG>13. Trades</STRONG></P>  <P><STRONG>Trades are any items that are placed into the trade window and
  purposely given to another player, NPC or Pet (by mutual agreement between
  the two involved players), regardless of the intent behind the trade.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;13.1. Items traded to or sold to other players, pets or
  other NPCs, intentionally or accidentally, may be reimbursed after an
  investigation and at the discretion of a GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13.1.1. <EM>Note: GM's may not assist
  with any trade disputes. All trades are considered final.</EM>  &nbsp;&nbsp;&nbsp;<BR>&nbsp;&nbsp;&nbsp;13.2. Trade scams are not permitted in Norrath. Trade
  scammers may have disciplinary action taken against their account.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13.2.1. <EM>Note: If you would like to
  provide evidence of a trade scam based on an agreement with another player,
  then we ask that you please use the /report command to record the appropriate
  text and send it directly to the GMs. In order to /report, please do the
  following:</EM></P>  <BLOCKQUOTE>  <UL>   <LI><EM>Scroll up until
       the pertinent text is available in your viewing window</EM></LI>   <LI><EM>Type /report
       &lt;name of player you are trading with&gt;. For example, if you are
       trading with John, type &quot;/report John.&quot;</EM></LI>   <LI><EM>If you are in
       fact scammed and need assistance from the GM, then please request
       in-game assistance using the /petition at that time.</EM></LI>  </UL>  </BLOCKQUOTE>  <P><STRONG>14. Roll-backs</STRONG></P>  <P><STRONG>Roll-backs occur when players are disconnected from the server at
  a point between saves. Upon logging back in, players are then reset to their
  most recent save point, thus losing any items or experience gained beyond
  that point.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;14.1. Any lost items, experience, or faction due to a
  reset to a previous save may be reimbursed after an investigation and at the
  discretion of a GM.</P>  <P><EM>Should any unforeseen technical issue occur resulting in the loss of
  items to our player base as a whole, Customer Service will address these
  issues separately across all servers.</EM></P>  <P><EM>If you lose an item or experience due to a verifiable bug or a server
  problem, the item or experience may be reimbursed.</EM></P>  <P><EM>If your situation is not addressed in this policy, please use the
  /petition command for additional assistance.</EM></P>  <P><EM>Reimbursements of any kind, regardless of the circumstance, are not
  guaranteed.</EM></P>  <P><EM>Reimbursement issues can only be addressed by GMs (SOE employees), as
  they have sole responsibility for enforcing this policy.</EM></P>
