	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P><A href="http://www.station.sony.com/kb">Knowledge Base<BR></A>Your first stop for all your support needs. </P>
<P><A href="/support/customer_service.jsp">Customer Service</A><BR>Rules, policies and additional info to help you out.</P>
...
<P><A href="https://store.station.sony.com/eq_char_item_moves/">Character Transfer Service/All Items</A><BR>A fee-based service that allows you to tranfer your characters, with all items intact, between servers and/or accounts.</P>
