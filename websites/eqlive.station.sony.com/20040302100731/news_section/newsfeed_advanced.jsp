	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/news_section/newsfeed_advanced.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/news_section/newsfeed_advanced.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/news_section/newsfeed_advanced.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
  ...
  <tr>
    <td colspan="2">
	  ...
	  <div id="mlForums" class="mlevel1"> <a href="JavaScript:toggleMenuContent('mcForums');" class="mexpander"><img src="http://eqlive.station.sony.com/includes/images/menuDown.gif" width="12" height="12" border="0" id="iconmcForums"></a> 
        <a href="http://eqforums.station.sony.com/eq" class="mlinklevel1" onclick="forceMenuOpen('mcForums');">Forums</a> 
        <div id="mcForums" class="mlevel2"> 
          	<a href="http://eqforums.station.sony.com/eq/board?board.id=tech" class="mlinklevel2">Technical Help</a> 
		  <a href="http://eqforums.station.sony.com/eq/board?board.id=TNZ" class="mlinklevel2">The Newbie Zone</a> 
		  <a href="http://eqforums.station.sony.com/eq/board?board.id=Roleplaying" class="mlinklevel2">Harpy's  Head Tavern</a>
        </div>
      </div>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">EverQuest&nbsp;NewsFeed</font></b></div>
                        <!-- #EndEditable --></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <p>&nbsp;</p>
                        <p>This editor will allow you to customize the look of 
                          your EQLive newsfeed. </p>
                        <p><span class="manualtitle2">Container: </span>The container 
                          is the box the EQLive news will be displayed in. You 
                          can choose if you want a container or not.</p>
                        <p>Background color - determines the background color 
                          of the container.<br>
                          Border style - determines the boarder style surrounding 
                          the container.<br>
                          Border width - determines the thickness of the container 
                          border.<br>
                          Border color - determines the color of the container 
                          border.<br>
                          Float (align) - <br>
                          Padding - determines the space within the container 
                          between the border and the text.<br>
                          Width - determines how wide you want the container to 
                          be.</p>
                        <p>Titles: This function allows you to determine how EQLive 
                          newsfeed titles will appear. The three titles used are: 
                          Developers' Corner, Headlines, and Community News. </p>
                        <p><span class="manualtitle2">Headlines:</span><span class="manualtitle1"> 
                          </span>Headlines: Use this function to set how EQLive 
                          newsfeed headlines will appear on your site. In this 
                          section, you will also determine by checking the 'yes' 
                          or 'no' radio button if a new window will open when 
                          a headline link is clicked.<br>
                        </p>
                        <p></p>
                        <p>Once you determine your settings, click the Create 
                          Example button. A new window will open with an example 
                          based on your settings along with the appropriate HTML 
                          code and CSS code. Once you are satisfied with your 
                          settings, simply copy the HTML and CSS code to your 
                          website. <br>
                        </p>
                        <p>Or go back to the <a href="newsfeed_basic.jsp">Simple 
                          Examples</a>.</p>
                        <script language="JavaScript">
	function turnOn(objID)
	{
		obj=eval("document.forms[0]."+objID);
		if (obj.selectedIndex!=0)
		{
			document.forms[0].ContainerUse[0].checked=true;
		}
	}
</script>
                        <form action="js_result.jsp" method="post" target="_jsresult">
                          <div class="container"> 
                            <h2>Container</h2>
                            Use a container? 
                            <input type="radio" name="ContainerUse" value="1">
                            Yes 
                            <input type="radio" name="ContainerUse" value="0" checked>
                            No <br>
                            <b>If yes...</b> 
                            <div class="inset"> 
                              <table border="0">
                                <tr> 
                                  ...
                                  <td valign="top"> 
                                    <select name="ContainerBackgroundColor" onchange="turnOn('ContainerBackgroundColor');">
                                ...
                                <tr> 
                                  ...
                                  <td valign="top"> 
                                    <select name="ContainerBorderStyle" onchange="turnOn('ContainerBorderStyle');">
                                ...
                                <tr> 
                                  <td valign="top">Border Width</td>
                                  <td valign="top"> 
                                    <select name="ContainerBorderWidth" onchange="turnOn('ContainerBorderWidth');">
                                ...
                                <tr> 
                                  ...
                                  <td valign="top"> 
                                    <select name="ContainerBorderColor" onchange="turnOn('ContainerBorderColor');">
                                ...
                                <tr> 
                                  <td valign="top">Float (align)</td>
                                  <td valign="top"> 
                                    <select name="ContainerFloat" onchange="turnOn('ContainerFloat');">
                                ...
                                <tr> 
                                  ...
                                  <td valign="top"> 
                                    <select name="ContainerPadding" onchange="turnOn('ContainerPadding');">
                                ...
                                <tr> 
                                  ...
                                  <td valign="top"> 
                                    <select name="ContainerWidth" onchange="turnOn('ContainerWidth');">
                                      <option SELECTED>default</option>
                                      <option>25%</option>
                                      <option>50%</option>
                                      <option>100%</option>
                          ...
                          <div class="container"> 
                            ...
                            <table border="0">
                              ...
                              <tr> 
                                ...
                                <td valign="top"> 
                                  <select name="TitleFontFamily">
                                    <option SELECTED>default</option>
                                    <option>Arial, Helvetica</option>
                                    <option>Verdana, Arial, Helvetica</option>
                                    <option>Courier, mono</option>
                                  </select>
                                </td>
                              </tr>
                              <tr> 
                              ...
                              <tr> 
                                <td valign="top">Font Weight (bold)</td>
                                <td valign="top"> 
                              ...
                              <tr> 
                                <td valign="top">Text Decoration (underline)</td>
                                <td valign="top"> 
                                  <select name="TitleTextDecoration">
                                    <option SELECTED>default</option>
                          ...
                          <div class="container"> 
                            ...
                            <table border="0">
                              ...
                              <tr> 
                                ...
                                <td valign="top"> 
                                  <select name="HeadlineHoverColor">
                                ...
                                <td valign="top"> 
                                  <select name="HeadlineVisitedColor">
                              ...
                              <tr> 
                                <td valign="top">Font Family</td>
                                <td valign="top"> 
                                  <select name="HeadlineFontFamily">
                                    <option SELECTED>default</option>
                                    <option>Arial, Helvetica</option>
                                    <option>Verdana, Arial, Helvetica</option>
                                    <option>Courier, mono</option>
                              ...
                              <tr> 
                                <td valign="top">Font Weight (bold)</td>
                                <td valign="top"> 
                                  <select name="HeadlineFontWeight">
                                    <option SELECTED>default</option>
                                    <option>bold</option>
                                    <option>normal</option>
                                  </select>
                                ...
                                <td valign="top"> 
                                  <select name="HeadlineHoverFontWeight">
                                    <option SELECTED>default</option>
                                    <option>bold</option>
                                    <option>normal</option>
                                  </select>
                              ...
                              <tr> 
                                <td valign="top">Text Decoration (underline)</td>
                                <td valign="top"> 
                                  <select name="HeadlineTextDecoration">
                                    <option SELECTED>default</option>
                                    <option>underline</option>
                                    <option>none</option>
                                  </select>
                                ...
                                <td valign="top"> 
                                  <select name="HeadlineHoverTextDecoration">
                                    <option SELECTED>default</option>
                                    <option>underline</option>
                                    <option>none</option>
                                  </select>
							  ...
							  <tr>
							  	<td valign="top"> Open Links In The Same Window? 
                                </td>
								<td valign="top">
									<input type="radio" name="HeadlineWindow" value="" CHECKED>Yes
									<input type="radio" name="HeadlineWindow" value="_eqlive">No
								</td>
							  </tr>
                            </table>
                          </div>
                          <p> 
                            <center>
                              <input type="submit" value="Create Example">
                            </center>
                        </form>
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
