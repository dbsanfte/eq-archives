...
<tr>
	...
	<a href="recent_updates.jsp?id=64019" class="tinylink">October 25, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=63873" class="tinylink">October 13th, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=63582" class="tinylink">September 23rd, 2004</a><br>
...
<h1>October 25, 2004</h1>
<P>Headlines!</P>
<P>Items for Anguish!<BR>New Storybook entry.</P>
<P>&nbsp;</P>
<P>Omens of War<BR>________________<BR>Due to a database error, itemization of the Anguish zone was lost.&nbsp; We have re-itemized the zone and wish you luck in uncovering its riches.</P>
<P>&nbsp;</P>
<P>Tradeskills<BR>________________<BR>- Fire Beetle Eyes now stack.<BR>- The Smithing Chisel is no longer flagged Lore.<BR>- Lightning Core is now stackable.<BR>- Changed the name of the Gnomish Vanishing Device to Half Capacity Gnomish Vanishing Device.<BR>- Golanda Nuts now stack.<BR>- The Beauty of a Simple Stone should now have text.<BR>- The Sandblasted Ringmail Bracelet and Large Sandblasted Steel Girth should now fit the appropriate-sized races.<BR>- Caerlyna should no longer be dispensing no-drop bag tokens.<BR>- The cast time on the 5 and 10 dose Greater Elixir's of Concentration should now have the same cast time as the single-dose version.</P>
<P>&nbsp;</P>
<P>Berserkers<BR>________________<BR>Warcry and Hastened Warcry should now work as intended.</P>
<P>&nbsp;</P>
<P>AA points<BR>________________<BR>- You can now store more than 30 AAs if they come from a refund, a Customer Service Representative or an in-game script.&nbsp; AA's earned in-game from experience will still be capped at 30.</P>
<P>&nbsp;</P>
<P>-- The EverQuest Team<BR></P>
