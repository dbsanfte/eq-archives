	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_audio.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_audio.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_audio.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<DIV align=center><STRONG><BR>Supported Sound Cards</STRONG> </DIV>
<P align=left>The following is a list of supported sound cards.<BR>You SHOULD install the most recent driver version from your manufacturer.</P>
<DIV></DIV>
<P>&nbsp;</P>
<P align=center><SPAN class=subHeader>Aureal A3D Chipset</SPAN></P>
<P align=left>Unfortunately, the Aureal company is no longer in business, so support for the following sound cards is limited. Reference drivers for the A3D chipsets can be found at <A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm</A>.</P>
<P><I>Cards we have tested:</I></P>
<UL>
<LI><SPAN class=subHeader>Turtle Beach</SPAN><BR>Montego / Vortex A3D<BR><A href="http://www.voyetra-turtle-beach.com/" target=_blank>http://www.voyetra-turtle-beach.com/</A><BR><BR>
<LI><SPAN class=subHeader>Diamond Multimedia</SPAN><BR>Monster Sound MX300<BR><A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm/</A></LI></UL>
<P><I>Not Tested but Should Work:</I></P>
<UL>
<LI><SPAN class=subHeader>Diamond Multimedia</SPAN><BR>Monster Sound<BR>Monster Sound M80<BR>Monster Sound MX200<BR><A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Monster Sound MX400</SPAN><BR><A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Multiwave </SPAN><BR>AudioWave 16 PNP<BR>AudioWave Green 16<BR>AudioWave Platinum 16<BR>AudioWave 32PNP<BR><A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Orchid</SPAN><BR>Nusound 3D<BR><A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Xitel </SPAN><BR>Storm VX<BR><A href="http://www.vortexofsound.com/drivers/drivers.htm" target=_blank>http://www.vortexofsound.com/drivers/drivers.htm</A></LI></UL>
<P>&nbsp;</P>
<P align=center><SPAN class=subHeader>Creative Labs</SPAN><BR></P>
<P>The sound cards were tested under the Windows98 operating system.<BR>EverQuest should work with all Sound Blaster 16 compatible sound cards.</P>
<P><I>Cards we have tested:</I></P>
<UL>
<LI><SPAN class=subHeader>Sound Blaster Live! Family</SPAN><BR><A href="http://soundblaster.com/" target=_blank>http://soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster Live! then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster PCI512</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster PCI128</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/</A> <BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster AWE64 Gold</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster AWE 64 </SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster AWE 32 </SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster 16 </SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/</A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I></LI></UL>
<P>&nbsp;</P>
<P><I>Note: In order for the SBLive to work correctly, you must download BOTH Live!Ware 3.0 AND the latest SBLive drivers. You will then have to delete all previous SoundBlaster installations and re-install both downloaded packages. </I></P>
<UL>
<LI><SPAN class=subHeader>Sound Blaster PCI64</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><I><BR>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster Ensoniq Audio PCI</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster 32</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I></LI></UL>
<P>&nbsp;</P>
<P class=subHeader align=center>Crystal</P>
<P><I>Cards we have tested:</I></P>
<UL>
<LI><SPAN class=subHeader>Crystal PNP CS4236B and SoundBlaster 16 compatible</SPAN><BR><A href="http://www.cirrus.com/Drivers/audiodrv/index_new.cfm" target=_blank>http://www.cirrus.com/Drivers/audiodrv/index_new.cfm</A></LI></UL>
<P>&nbsp;</P>
<P class=subHeader align=center>Ensoniq</P>
<P><I>Cards we have tested:</I></P>
<P><I>Note: All Ensoniq Sound Card support is handled by Creative Labs. Use either the latest <B>Sound Blaster Ensoniq AudioPCI</B> drivers or the drivers that came with your Ensoniq card.</I></P>
<UL>
<LI><SPAN class=subHeader>Soundscape</SPAN><BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com/</A><BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing</I></LI></UL>
<P><I>Not tested but should work:</I></P>
<UL>
<LI><SPAN class=subHeader>Soundscape VIVO</SPAN><BR>Soundscape Elite<BR><A href="http://support.soundblaster.com/" target=_blank>http://support.soundblaster.com</A><BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing </I>
<P class=subHeader align=center><BR></P>
<DIV align=center>
<DIV align=left>
<P>&nbsp;</P>
<P>If you are still having problems after visiting this support section, you can contact our Technical Support Department through an email via our <A href="http://www.station.sony.com/en/services/help/premiumGames.jsp" target=_blank>online form</A>.</P></DIV></DIV></LI></UL>
<P><FONT size=-2><B>*WARNING: ALL OF THE DRIVERS LINKED TO OR OTHERWISE MADE AVAILABLE HEREUNDER ARE MADE AVAILABLE STRICTLY AS-IS AND SONY ONLINE ENTERTAINMENT INC, VERANT INTERACTIVE, INC. AND ANY AND ALL OF THEIR AFFILIATES, MAKE NO REPRESENTATIONS OR WARRANTIES, EXPRESS, IMPLIED, ARISING FROM COURSE OF DEALING OR USAGE OF TRADE, OR STATUTORY, AS TO THESE DRIVERS OR ANY MATTER WHATSOEVER CONNECTED HEREWITH, INCLUDING, WITHOUT LIMITATION, ANY REPRESENTATION THAT THE DRIVERS DO NOT CONTAIN COMPUTER CODE DESIGNED TO DISRUPT, DISABLE, HARM OR OTHERWISE IMPEDE IN ANY MANNER THE OPERATION OF A COMPUTER PROGRAM, WILL NOT DAMAGE OR DESTROY ANY DATA FILES RESIDING ON A COMPUTER OR WILL NOT ADVERSELY AFFECT THE HARDWARE OR OTHER SOFTWARE OF THE USER IN ANY WAY. IN PARTICULAR, ANY AND ALL WARRANTIES OF TITLE, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE ARE EXPRESSLY EXCLUDED. USE AT YOUR OWN RISK.</B></FONT></P>
