...
<P>&nbsp;&nbsp;&nbsp;10.1. Any disappearing NPCs, items or corpses of an NPC, may be reimbursed after an investigation and at the discretion of a GM. However NPCs may not be spawned and items not looted will most likely not be reimbursed.<BR>&nbsp;&nbsp;&nbsp; 10.2. Mistakenly looted NO DROP items may be transferred after an investigation and at the discretion of a GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 10.2.1.<EM> *Note: Intentional Ninja-Looting will be dealt with as a separate issue. This only applies to situations of non-malicious looting. </P>
<P><B>11. PC Corpse Decay</B></P>
<P><B>Under level 10 characters return from death with all of their items, so corpses decay quickly. If you are level 10 and above, then you have seven days of time (offline or online) to loot your corpse. We strongly recommend that you recover your corpse as quickly as possible. If you are level 10 and above, a corpse with no items on it will decay in three hours.</B></P>
...
<P>&nbsp;&nbsp;&nbsp;12.1. Items lost in any Quest may be reimbursed after an investigation and at the discretion of a GM.<BR>&nbsp;&nbsp;&nbsp;12.2. Items that are lost or a reward given to wrong person due to Multi-Questing will not be transferred or reimbursed.<BR>&nbsp;&nbsp;&nbsp;12.3. NPCs in Quests that disappear or are killed may not be respawned, nor will items on the NPC's be reimbursed.<BR>&nbsp;&nbsp;&nbsp;12.4. Items lost in any Quest performed incorrectly may not be reimbursed.<BR></EM>&nbsp;&nbsp;&nbsp;12.5 Any item given to the Tribute Masters with the intention of gaining Tribute points will not be reimbursed. <BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12.5.1 Any items lost due to accidental turn in, may be reimbursed at the discretion of a GM in the way of a character restore to a previous save.<BR><EM>*Note: Any restores, to a previous save, will cause any gained items, experience, skills, or flags, to be lost.<BR></EM>If other items are traded, dropped, or otherwise removed from the character before it is restored, those items will be deleted from the restored character's inventory or the restoral denied. </P>
<P></P>
<P><B>13. Trades</B></P>
