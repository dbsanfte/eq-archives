...
<h1>Future Plans for September, 2003</h1>
<FONT face="Times New Roman">
<P class=MsoNormal style="MARGIN: 0in 0in 0pt">Those of us behind the scenes here on the EverQuest team have plans for the future of the game.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Further Down the Line is where we will keep you informed about what those plans are.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Please understand that these are our long-term plans and may require a fair amount of research or development time.<?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></P></FONT>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><B style="mso-bidi-font-weight: normal"><FONT face="Times New Roman"></FONT></B>&nbsp;</P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><B style="mso-bidi-font-weight: normal"><FONT face="Times New Roman">Items in the Planes of Power<o:p></o:p></FONT></B></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">We will be looking at the quality of Planes of Power item rewards and improving them where appropriate.&nbsp; Items for many of the lower tier gods will be upgraded and more rare items and NPCs will be added to the following zones as needed:<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Crypt of Decay<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Plane of Torment<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Halls of Honor<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Plane of Tactics<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Plane of Innovation<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Bastion of Thunder<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><B style="mso-bidi-font-weight: normal"><FONT face="Times New Roman">Class Balance<o:p></o:p></FONT></B></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">We're still planning to take a look at improving the damage capabilities of melee classes, as they've fallen behind their magic-using counterparts at the very high end of the game.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Finding the proper solutions for this situation will take some time.&nbsp; Some options being considered are:<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Improve melee damage-increasing disciplines <o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Improve Planes of Power melee weapons <o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">Additionally, we're looking at the concerns from players about their spells, and changing them where appropriate.&nbsp; The goal here is to remove annoying issues with spells, not necessarily to increase caster power overall.<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><B style="mso-bidi-font-weight: normal"><FONT face="Times New Roman">Shields and blocking<o:p></o:p></FONT></B></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><o:p><FONT face="Times New Roman">&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face="Times New Roman">We're planning on reviewing the possibility of giving an innate chance to block when using a shield.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We've been hoping to do this for a while, and it should be getting a realistic review in the near future.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We'd like to increase the value of shields, and make it a worthwhile choice for players who might normally dual-wield weapons or use a two-handed weapon.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We plan on balancing this against classes which use shields by default, and therefore wouldn't be making any trade-offs to equip a shield.</FONT></P>
