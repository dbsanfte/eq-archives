...
//window.alert(document.cookie);
  ...
  servers. It is not one of the &quot;Zeks&quot;.</P>  <UL>   <LI>Beneficial buff
       spells will not work on characters 20 levels lower than the caster.</LI>   <LI>The Common language
       will not exist. A Human language will be added and only made easily
       available to certain races.</LI>   <LI>Only one character
