...
<body bgcolor="#000000" text="#CCCCCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" background="../images/rock_bg.jpg" onResize="handleResize();" onLoad="start=1;release=1;timead();MM_preloadImages('../images/subscribe_on.jpg')">
<!-- begin global nav -->
<center>
...
<script language="JavaScript"> 
	...
	function loadad() { // loads ads for Netscape
		...
		if(document.layers) {
			...
			adlayer1.left = gnav_getbrowserwidth()/2 - 85 
			}
...
if(IE4){
	if(navigator.appVersion.indexOf("Mac")>=0){
		document.write('<nobr><iframe name="adlayeri" src=' + adurl + ' z-index="3" width="468" height="60" scrolling="no" marginheight=0 marginwidth=0 frameborder="no"></iframe></nobr>')
	}
	else {
		document.write('<nobr><iframe name="adlayeri" z-index="3" width="468" height="60" scrolling="no" marginheight=0 marginwidth=0 frameborder="no"></iframe></nobr>')
	}
}
else if (Opera5 || NS6) {
	document.write('<nobr><iframe name="adlayeri" src=' + adurl + ' z-index="3" width="468" height="60" scrolling="no" marginheight=0 marginwidth=0 frameborder="0"></iframe></nobr>')
}
else if (eVilla) {
	document.write('<nobr><iframe name="adlayeri" src=' + adurl + ' z-index="3" width="468" height="60" scrolling="no" marginheight=0 marginwidth=0 frameborder="no"></iframe></nobr>')
}
else {document.write('<img src="/common/images/global_nav/seethru.gif" width=1 height=50>');}
//-->
</script>
            </div>
          </td>
        ...
        <tr bgcolor="#000000"> 
          <td> 
            <table width="302" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td align="right"><a href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/eqinvasion/sponsors.jsp?null');"><img src="/common/images/global_nav/SignIn.gif" width="62" height="18" border="0"></a></td>
                <td><a href="javascript:gnav_call('http://www.station.sony.com/services/register.jhtml');"><img src="/common/images/global_nav/Join_Free.gif" width="71" height="18" border="0"></a></td>
              </tr>
            </table>
          </td>
        </tr>
...
<table width="780" border="0" cellspacing="0" cellpadding="0" height="12" background="/common/images/global_nav/nav_bg.gif">
  <tr> 
    <td width="247"><img src="/common/images/global_nav/welcome.gif" border="0" width="150" height="9" hspace="20"></td>
    <td rowspan="2" width="533" valign="top"> 
...
<a href="javascript:gnav_call('http://www2.station.sony.com/en/');" onmouseover="gnav_showmenu();" onmouseout="gnav_hidemenu();"><img src="/common/images/global_nav/playgames_nav.gif" border="0" width="120"></a></td>
          <td valign="top" width=42> <a href="javascript:gnav_call('http://www2.station.sony.com/en/win/');"><img src="/common/images/global_nav/win_nav.gif" border="0" width="42"></a></td>
          <td valign="top" width=84> <a href="javascript:gnav_call('http://www.station.sony.com/services/talk.jhtml');"><img src="/common/images/global_nav/community_nav.gif" border="0" width="84"></a></td>
          <td valign="top" width=44> <a href="javascript:gnav_call('https://store.station.sony.com');"><img src="/common/images/global_nav/shop_nav.gif" border="0" width="44"></a></td>
          <td valign="top" width=85> <a href="javascript:gnav_call('http://www.station.sony.com/services/accountinfo.jhtml');"><img src="/common/images/global_nav/myaccount_nav.gif" border="0" width="85"></a></td>
          <td valign="top" width=93> <a href="javascript:gnav_call('http://services.station.sony.com/en/help.jsp');"><img src="/common/images/global_nav/help_nav.gif" border="0" width="92"></a></td>
        </tr>
      </table>
    </td>
  </tr>
  <tr> 
    <td width="247"><img src="/common/images/global_nav/spacer.gif" border="0" width="20" height="1"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#FFFFFF">&nbsp;</font></b></font></td>
  </tr>
</table>
                  ...
                  <table width="471" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="87" height="9" background="/images/sub_heading_bg.gif"> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">EQ Invasion</font></b></div>
                      </td>
...
<!-- #BeginEditable "Content" --> 
                        ...
                        <!-- begin page content -->
                        <p align="center"><b>This ultimate EverQuest gaming experience 
                          is brought to you by...</b></p>
                        <table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr> 
                            <td colspan="2"> 
                              <div align="center"><a href="http://www.intel.com/" target="_blank"><img src="images/pent4.gif" width="400" height="95" border="0"></a></div>
                            </td>
                          </tr>
                          <tr> 
                            <td> 
                              <div align="center"><a href="http://www.nvidia.com/" target="_blank"><img src="images/nvidia.gif" border="0"></a></div>
                            </td>
                            <td> 
                              <div align="center"><a href="http://www.alteclansing.com/index_flash.asp" target="_blank"><img src="images/altec.gif" width="200" height="44" border="0"></a></div>
                            </td>
                          </tr>
                          <tr> 
                            <td> 
                              <div align="center"><a href="http://www.att.net/" target="_blank"><img src="images/att.gif" width="200" height="63" border="0"></a></div>
                            </td>
                            <td> 
                              <div align="center"><a href="http://www.sony.com/vaio" target="_blank"><img src="images/vaio.gif" width="200" height="46" border="0"></a></div>
                            </td>
                          </tr>
                          <tr> 
                            <td> 
                              <div align="center"><a href="http://www.bestbuy.com/" target="_blank"><img src="images/best_buy.gif" border="0"></a></div>
                            </td>
                            <td> 
                              <div align="center"><a href="http://www.primagames.com/" target="_blank"><img src="images/prima.gif" border="0"></a></div>
                            </td>
                          </tr>
                          <tr> 
                            <td> 
                              <div align="center"><a href="http://www.gamers.com/cgw/index.jsp" target="_blank"><img src="images/cgw_logo.gif" border="0"></a></div>
                            </td>
                            <td> 
...
<p>&nbsp;</p>
          ...
          <td width="135" background="" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" background=""> 
                  <p><a href="index.jsp"><img src="../images/eqinvasion_button.jpg" width="120" height="81" border="0"></a><br>
                    <br>
                    <a href="../intel.jsp"><img src="../images/intel_ad02.jpg" width="120" height="110" border="0"></a></p>
                  </td>
              </tr>
              <tr> 
                <td align="center" background="">
...
//-->
                  ...
                  <p><a href="javascript:void(0);" onClick="window.open('http://www.newpanel.com/pop_sony/pop1.html','POPSONY','scrollbars=no,width=310,height=161')"><img src="../images/featured/europesurvey_button.jpg" width="120" border="0" height="50"></a> 
                  </p>
                </td>
              </tr>
              <tr> 
                <td align="center" background=""><br>
                  <a href="http://www.verant.com/"><img src="../images/soe_logo.gif" width="99" height="62" border="0"></a></td>
              </tr>
            </table>
          </td>
          <!-- end ads -->
...
<table width="780" border="0" cellspacing="0" cellpadding="5" align="center" background="../images/2nd_bg.jpg">
  <tr>
    <td align="center"><font size="-2" face="Arial, Helvetica, sans-serif" color="#FFFFCC">EverQuest, 
      ...
      America Inc. All rights reserved. All other trademarks belong to their respective owners.</font></td>
  </tr>
</table>
<!-- begin main body -->
