...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_optimization.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_optimization.jsp');">
...
<P><B>Shadows Of Luclin Optimization:</B></P>
<OL type=I>
<OL type=I>
<LI><B><FONT size=3>Pre-Game: Login Screen Options: </FONT></B>
<OL>
<OL type=a>
<LI>Launch EverQuest by running EverQuest.Exe. Once patching is complete, please hit Play. This will take you to the EverQuest Login Screen. Once on the Login Screen please select OPTIONS tab. <BR><IMG height=352 src="/images/tech_support/luclin_optimization1.jpg" width=469><BR><BR>
<LI>In OPTIONS, please select your Video Card from the provided list. Select desired language setting, and you will then enter the Luclin Options screen<BR><BR>
<LI>In Luclin Options screen, please note the recommended amount of models depending on how much ram is in your systems. For low-end video cards with less than 16mb of ram, we suggest you turn all player models off. <BR><IMG height=352 src="/images/tech_support/luclin_optimization2.jpg" width=469><BR><BR>
<LI>In the second Luclin Options screen, you will be able to change engine settings. 
<P>Setting <B>Social Animations</B> to Off will decreased load times. This option is highly recommended for users with 256mb of ram or less.</P>
<P>Setting <B>Sound</B> to off will increase frame rate for PC's with low-end CPUs.</P>
<P>Setting <B>Dynamic Lighting</B> to off will increase frame rate for PC's with low-end CPUs. </P>
<P>Using<B> Texture Compression</B> will decrease your load time. Please note this feature should NOT be turned on unless your video card specifically supports it. </P>
<P>For the <B>Resolution</B> setting we recommend you initially set it to 640x480, once in-game you will be able to change to a higher resolution depending on your system's performance.</P>
<P>Setting <B>Texture Quality</B> to low will slightly increase your load times while it will have a more significant positive effect on frame rate.<BR><IMG height=352 src="/images/tech_support/luclin_optimization3.jpg" width=469> 
<P>&nbsp;</P></LI></OL></OL></LI></OL></OL>
<OL type=I>
<OL type=I>
<LI><FONT size=3><B>In-Game: Display Options Menu:</B></FONT><B><FONT size=3> </FONT></B>
<OL>
<OL type=a>
<LI>Log into your selected EverQuest Server, then log into the world with desired character. Once in-game, please click on OPTIONS tab on the top left side of your screen. <BR><IMG height=352 src="/images/tech_support/luclin_optimization4.jpg" width=469><BR><BR>
<LI>Once in the OPTIONS menu, select the DISPLAY tab. <BR><IMG height=352 src="/images/tech_support/luclin_optimization5.jpg" width=469><BR><BR>
<LI>In DISPLAY options you will be able to change several setting without having to log out. The recommended settings for optimum frame rate on low-end systems are the following: <BR><IMG height=352 src="/images/tech_support/luclin_optimization6.jpg" width=469><BR><BR>Setting for <B>Sky</B> should be Single Layer or to 3D Sky Off for best performance. This will affect the quality of the sky or turn the sky animation completely off. 
<P>Setting for <B>Particle Density</B> should be set to Low or Off depending on your system. This setting will affect the spell effects and item and world particles. With it off you will not see any effects for spells and some items.</P>
<P>Setting for <B>Mip Map </B>should be Off unless you have a high-end video card.</P>
<P>Your DISPLAY settings should look like the following shoot if you selected the configuration with all options turned off.<BR></P><IMG height=352 src="/images/tech_support/luclin_optimization7.jpg" width=469><BR>
<LI>After completing all these changes, click on NEXT and you will get to the last page of the DISPLAY settings.<BR><BR>
<LI>Setting for <B>Clip Plane </B>will determine how far into the distance you will be able to see. Move the slider to the left if you want your clip plane to be lower. Your viewing distance will then be decreased as game performance (frame rate) increases significantly.<BR><IMG height=352 src="/images/tech_support/luclin_optimization8.jpg" width=469></LI></OL></OL></LI></OL></OL></TD></TR></TBODY></TABLE>
