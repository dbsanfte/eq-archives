	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_recovery.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_recovery.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_recovery.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>If you have forgotten your password, please visit our Password Recovery Page at <A href="https://www2.station.sony.com/secure/en/retrieve/password.jsp">https://www2.station.sony.com/secure/en/retrieve/password.jsp</A>. You will be asked to fill out a form and your reset password will be emailed to you at the email address you provided during registration. In order for us to send you your new password, you will need the following information when you fill out the form:</FONT></P>
...
<P align=left><FONT face="Arial, Helvetica, sans-serif" size=2>After you receive your new password, we strongly suggest that you visit <A href="https://www.station.sony.com/secure/en/registration/view.jsp">https://www.station.sony.com/secure/en/registration/view.jsp</A>, sign in, and change your password to something unique that only you will know. We also suggest that after you have changed your password, you write down your Station Name and password for future reference.</FONT></P>
