        ...
        <tr bgcolor="#000000"> 
          <td> 
            <table width="302" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td align="right"><a href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/eqinvasion/scrapbook.jsp?null');"><img src="/common/images/global_nav/SignIn.gif" width="62" height="18" border="0"></a></td>
