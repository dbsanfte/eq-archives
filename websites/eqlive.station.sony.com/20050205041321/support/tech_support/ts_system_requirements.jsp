...
<P ALIGN="center"><STRONG><BR><STRONG>System Requirements</STRONG></STRONG></P>  <P><STRONG>Required Specs:</STRONG></P>  <UL>   <LI>Windows&reg;
       ...
       equivalent or greater</LI>   <LI>512 MB RAM</LI>   <LI>NVidia GeForce
       3/ATI Radeon 8500 equivalent or greater</LI>   <LI>DirectX Compatible
  ...
  system:</P>  <OL>   <LI>Click the Start
       menu.</LI>   <LI>Use the Run
       command.</LI>   <LI>In the Open field,
  ...
  problems:</P>  </BLOCKQUOTE>  <UL>   <LI>Go to <A HREF="http://www.microsoft.com/windows/directx/default.aspx">http://www.microsoft.com/windows/directx/default.aspx</A>       and install the latest DirectX version available for your operating
       ...
       determine what video card you have, please go to <A HREF="../../../../../support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A>       for more information (this site applies to Win2k and WinXP users).</LI>   <LI>Go to the website
       for your sound card manufacturer and follow the same procedure. If you
       use a SBLive sound card, you can run &quot;LiveUpdate&quot; from the
       Windows Control Panel off of your start menu. View our Sound FAQ on how
       to uninstall/install your drivers, or how to identify your sound card,
       at <A HREF="../../../../../support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A>       (for Win2k and WinXP users).</LI>  </UL>  <BLOCKQUOTE>  <P>If you experience any problems, please do the following:</P>  </BLOCKQUOTE>  <UL>   <LI>Run DXDIAG.EXE
       from your Start menu (click start, run, then type &quot;dxdiag&quot;)</LI>   <LI>Click the
       &quot;Save all Information&quot; button at the bottom of the program
       window.</LI>   <LI>Save the file as
