...
<a href="/support/accounts_billing.jsp">Full Design Version</a>
</p>
...
<P><A href="/lowsrc/rates/index.jsp"><SPAN class=header><EM>EverQuest's</EM> Price Increase</SPAN></A><BR>An overview of the EQ subscription rate change, with information on billing as well as 12-month and 24-month subscription plans.</P>
<P><A href="/lowsrc/rates/rate_faq.jsp"><SPAN class=header><EM>EverQuest's</EM> Price Increase FAQ</SPAN></A><BR>The EQ subscription rate change took effect on April 25, 2002. Find out more about it. </P>
<P><A href="/lowsrc/support/accounts_billing/ab_create_activate_account.jsp">Creating An Account</A><BR>A simple step-by-step guide to setting up your own <EM>EverQuest</EM> account. </P>
<P><A href="/lowsrc/support/accounts_billing/ab_recovery.jsp">Station Name and Password Recovery</A><BR>If you've forgotten your Station name or password, here's what you do. </P>
<P><A href="/lowsrc/support/accounts_billing/ab_pricing.jsp"><SPAN class=header>Pricing Plans</SPAN></A><BR>Find out about all <EM>EverQuest</EM> pricing plan options. </P>
<P><A href="/lowsrc/support/accounts_billing/ab_subscriptions.jsp"><SPAN class=header><SPAN class=header>Changing Subscription Plans or Payment Methods</SPAN></SPAN></A><BR>Do you want to change your subscription plan or method of payment? </P>
<P><SPAN class=header><SPAN class=header><SPAN class=header><A href="/lowsrc/support/accounts_billing/ab_cancel.jsp">Canceling an <EM>EverQuest</EM> Account</A><BR>We'll hate to lose you, but here is where you can learn how to cancel your account.</SPAN></SPAN></SPAN>&nbsp;</P>
