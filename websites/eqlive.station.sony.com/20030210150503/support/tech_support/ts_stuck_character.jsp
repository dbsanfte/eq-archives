...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_stuck_character.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_stuck_character.jsp');">
...
<P>Another suggestion would be to temporarily disable your sound in EverQuest. In order to do this, create a new, blank text file and name it "NOSOUND.TXT". Save this file into your EverQuest directory (the default location is "C:\\\\Program Files\\\\EverQuest\\\\"). You will not have sound in the game while this file exists, but it can help us narrow down the cause of the problem.</P>
