...
<body bgcolor="#000000" background="../images/rock_bg.jpg" text="#CCCCCC" link="#FFFFCC" vlink="#FFFFCC" alink="#FFFFCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../images/guide/guide_buynow_on.jpg')" onresize="handleResize();" >
<!-- begin global nav -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/products/trilogy.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/products/trilogy.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/products/trilogy.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <nobr>
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">EverQuest: Trilogy Collectors Limited Edition</font></b></div>
                        </nobr>
                        <!-- #EndEditable --></td>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" -->
                        <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><img src="../images/guide/guide_top.jpg" width="564" height="111"></td>
                          </tr>
                          <tr>
                            <td><img src="../images/guide/guide_middle.jpg" width="564" height="140"></td>
                          </tr>
                          <tr>
                            <td height="264" valign="top"><table width="100%" height="264"  border="0" cellpadding="0" cellspacing="0">
                              <tr valign="top">
                                <td width="52%" height="282"><h3><a href="#"><img src="../images/guide/guide_map.jpg" width="296" height="264" border="0" onClick="MM_openBrWindow('../images/guide/1.html','','width=360,height=289')"></a></h3></td>
                                <td width="48%"><img src="../images/guide/guide_figures.jpg" width="268" height="264" border="0" usemap="#imageMap">
                                  </td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
                            <td height="168"><img src="../images/guide/guide_cds.jpg" width="564" height="168" border="0"> 
                            </td>
                          </tr>
                          <tr>
                            <td><img src="../images/guide/guide_expansions.jpg" width="564"></td>
                          </tr>
                          <tr>
                            <td><div align="center" class="legal style2"><strong><span class="style3 style4">NOTE: EverQuest Game Card is not included</span>. </strong></div></td>
                          </tr>
                          <tr>
                            <td><img src="../images/guide/guide_price.jpg" width="564"></td>
                          </tr>
                          <tr>
                            <td><a href="https://store.station.sony.com/shopping_cart.jsp?mode=addItem&sku=EQTRI-HG-SW0901-TRILOG" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image42','','../images/guide/guide_buynow_on.jpg',1)"><img src="../images/guide/guide_buynow_off.jpg" name="Image42" width="564" border="0"></a></td>
                          </tr>
                          <tr>
                            <td><div align="center">
                              <p>You only need one account key for the <strong><br>
                                EVERQUEST: TRILOGY COLLECTORS LIMITED EDITION!</strong></p>
                              <p align="left" class="style1">
                                NOTE: All Direct 3D cards not supported. System requirements subject to change as the game progresses</p>
                            </div></td>
                          </tr>
                        </table>
                        <!-- begin page content -->
...
<!-- #EndTemplate --><map name="imageMap">
                                    <area shape="rect" coords="4,72,109,233" onClick="MM_openBrWindow('../images/guide/2.html','','width=145,height=290')">
                                    <area shape="rect" coords="121,72,238,231" onClick="MM_openBrWindow('../images/guide/3.html','','width=247,height=293')">
                                  </map></html>
