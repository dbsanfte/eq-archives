...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/velious.jsp?null');">
                                  ...
                                  <tr> 
                                    ...
                                    <td width="100%"> 
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr> 
                                          <td height="108"> 
                                            <div align="center"> <img src="images/map_velious_title.gif" width="144" height="34"> 
                                  ...
                                  <tr> 
                                    ...
                                    <td> 
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          ...
                                          <td width="80%" height="256" rowspan="3"> 
                                            <center>
                                              <img src="images/map_velious_hi.gif" width="517" height="239" usemap="#cities" border="0">
                                              <map name="cities">
                                                <area shape="rect" coords="215,32,263,46" href="thurgadin.jsp">
                                              </map>
                                            </center>
                                          </td>
                                          <td width="20%"> 
                                      ...
                                      <table border="0" width="100%" cellpadding="20" cellspacing="0">
                                        <tr> 
                                          <td><font color="#FFFFCC">In ages past, 
                                            the great crystalline dragon Veeshan 
                                            chose Norrath as home for her brood, 
                                            clawing the earth and creating great 
                                            scars in which she deposited them, 
                                            to grow and flourish. In later times, 
                                            when ogres, giants and goblins had 
                                            conquered much of the planet, their 
                                            arrogance in attempting an assault 
                                            upon the Plane of Earth brought retribution 
                                            from The Rathe in the form of a great 
                                            curse. The once fertile homeland of 
                                            the giants was frozen along with those 
                                            of its surviving inhabitants who were 
                                            unable to flee. Only a group of shipwrecked 
                                            dwarves managed to find their way 
                                            beyond the Frigid Barrier to reach 
                                            the icy continent of Velious, and 
                                            they became the Coldain who were only 
                                            recently rediscovered by the gnomes 
                                            of Ak`Anon, with the help of their 
                                            marvelous ship, the Icebreaker.</font></td>
                                          <td> 
                                ...
                                <table border="0" width="100%" cellspacing="0" cellpadding="0" background="images/parchtile.gif">
                                  <tr> 
                                    ...
                                    <td align="right" valign="top" width="87"> 
                                      <img src="images/map_pixies.gif" width="87" height="116"></td>
                                  </tr>
                                </table>
                              </center>
                            </center>
