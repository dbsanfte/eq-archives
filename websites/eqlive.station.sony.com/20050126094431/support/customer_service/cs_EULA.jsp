...
<P>Please remember to review the current terms and conditions of the
  ...
  Corporations and other entities are not eligible to procure Accounts.</P>  <P>2. To play the Game, you must (a) purchase or receive through an SOE-authorized
  promotional offer (such as an authentic disc bundled with a game magazine)
  the Game CD-ROM (the &quot;<STRONG>CD-ROM</STRONG>&quot;) or applicable files
  which we may make available for direct download, which includes software
  required for the Game (the &quot;<STRONG>Software</STRONG>&quot;), (b) have a
  fully paid Account, and (c) have an Internet connection (which we do not
  provide) to access your Account. In addition to any fees described herein,
  you are responsible for paying all applicable taxes (including those we are
  not required to collect) and for all hardware, software, service and other
  ...
  policies of SOE while on such web sites and in connection with use of your Account
  and the Game, which terms and conditions, policies and customs are
