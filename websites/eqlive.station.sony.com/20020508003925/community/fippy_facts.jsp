...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/community/fippy_facts.jsp?null');">
...
<TR>
<TD>
<P><FONT face=Arial size=2><IMG height=160 src="/community/images/Image25.gif" width=200 align=left><B>Curious as to how many Vah Shir are being played and what the breakdown is for their classes? Well, Fippy has done the numbers. Take a look at what the Gnoll Statistician came up with.</B></FONT></P>
<P><B><FONT face=Arial size=2>When reviewing these numbers, the "newness" of the Vah Shir and Beastlord class must be taken into account. New races and classes are always extremely popular immediately following their introduction. </FONT></B></P>
<P><FONT face=Arial size=2>Total number of Vah Shir player characters: 208,591<BR>Percent of total Vah Shir who are Beastlords: 80%<BR>Percent of total Vah Shir who are other classes: 20%</FONT></P>
<P><FONT face=Arial>&nbsp;</FONT><B><FONT face=Arial>Out of 208,591 Vah Shir being played, 80 percent are Beastlords and 20 percent are of the other available Vah Shir classes.</FONT></B></P>
<P><B><FONT face=Arial>As an added bonus, Fippy has also taken a look at what types of horses are being bought by players:</FONT></B></P>
<P><FONT face=Arial size=2>Horses by color</FONT>: 
<TABLE cellSpacing=0 cellPadding=0 width=400 border=0>
<TBODY>
<TR>
<TD width=200><FONT face=Arial size=2>Tan </FONT></TD>
<TD width=200><FONT face=Arial size=2>10%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>White </FONT></TD>
<TD width=200><FONT face=Arial size=2>30%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>Black </FONT></TD>
<TD width=200><FONT face=Arial size=2>52%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>Brown</FONT></TD>
<TD width=200><FONT face=Arial size=2>8%</FONT></TD></TR></TBODY></TABLE>
<P><FONT face=Arial size=2></FONT><FONT face=Arial size=2>Horses by armor type:<BR></FONT>
<TABLE cellSpacing=0 cellPadding=0 width=400 border=0>
<TBODY>
<TR>
<TD width=200><FONT face=Arial size=2>Rope</FONT></TD>
<TD width=200><FONT face=Arial size=2>73%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>Leather </FONT></TD>
<TD width=200><FONT face=Arial size=2>11%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>Silken </FONT></TD>
<TD width=200><FONT face=Arial size=2>3%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>Chain</FONT></TD>
<TD width=200><FONT face=Arial size=2>12%</FONT></TD></TR>
<TR>
<TD width=200><FONT face=Arial size=2>Ornate Chain</FONT></TD>
<TD width=200><FONT face=Arial size=2>1%</FONT></TD></TR></TBODY></TABLE>
<P><FONT face=Arial size=2><IMG height=150 src="/community/images/Image26.gif" width=200 align=left></FONT><FONT face=Arial><B>According to the numbers, the majority of players that have purchased a horse have chosen the Rope Horse, which can be obtained at the Bazaar for around 9,000 platinum, depending on the buyer. The numbers also show that a majority of players who purchased a horse prefer the Black ones.</B></FONT></P>
