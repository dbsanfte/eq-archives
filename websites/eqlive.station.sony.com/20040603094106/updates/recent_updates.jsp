...
<tr>
	...
	<a href="recent_updates.jsp?id=61961" class="tinylink">April 28, 2004</a><br>
...
<h1>June 2, 2004</h1>
<P>June 2nd, 2004<BR>----------------------</P>
<P>Collision fixes collide with servers!</P>
<P><BR>Collision<BR>----------------------<BR>- When you are summoned by NPCs or players smaller than you, the collision system will now scan a limited area near the destination to find a place to put you so that you will not be stuck in the terrain.</P>
<P>- A problem related to collision data being out of sync on the client and server has been corrected and should solve the problems many of you have been seeing with NPCs being pushed into walls.</P>
<P>- The sunken NPC and character problem has been much improved. You will still find the occasional NPC at a spawn point that is sunk or elevated slightly, but the NPC should move normally once engaged.</P>
<P><BR>Cabilis Quests<BR>----------------------<BR>- The Battle plans from Dalnir should be a little easier to obtain.<BR>- The loyal follower in Dreadlands should no longer be a merchant with an empty inventory.<BR>- The traitor necromancers seek should be a little easier to find.<BR>- Wyzith's belongings should now combine correctly.</P>
