...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">71,466 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp');">
...
<P align=left>If you are still having problems or have questions, after visiting this support section, you can contact our Technical Support Department via email using our <A href="http://www.station.sony.com/services/everquest-technical.jhtml" target=_blank>online form</A>.<BR></P></TD></TR></TBODY></TABLE>
