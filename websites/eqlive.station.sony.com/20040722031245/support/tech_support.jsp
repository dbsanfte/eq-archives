                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <FONT size=4>(NOTE: Before accessing our </FONT><A href="http://soe.custhelp.com/"><FONT color=red size=4>Live Chat or e-mail</FONT></A><FONT size=4>, it's recommended that you first search our </FONT><A href="http://soe.custhelp.com/cgi-bin/soe.cfg/php/enduser/entry.php"><FONT size=4>Knowledge Base</FONT></A><FONT size=4> for relevant solutions. If the Knowledge Base search does not yield results, please click the "Live Help" tab to chat live with a Technical Support Representative or the "Ask a Question" tab to submit an e-mail.)</FONT>&nbsp;<BR>&nbsp; 
