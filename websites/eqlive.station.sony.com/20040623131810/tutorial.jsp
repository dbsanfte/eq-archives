	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/tutorial.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/tutorial.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/tutorial.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font size="2" face="Arial, Helvetica, sans-serif">Tutorial</font></b></div>
                        <!-- #EndEditable --></td>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td colspan="2" valign="top"> <div align="center"><img src="http://eqlive.station.sony.com/images/tutorial/tutorial_header.jpg" width="252" height="31"> 
                              </div>
                              <div style="font-size: 12px; color: #F6B831; font-weight: bold; font-family: Arial, Helvetica, sans-serif; padding: 0px 19px 0px 7px;">New 
                                to EverQuest? Now you can experience a new way 
                                of learning your way around the game with the 
                                introduction of our Tutorial.</div>
                              <div style="font-size: 12px; color: white; font-family: Arial, Helvetica, sans-serif; padding: 0px 5px 9px 7px;"> 
                                <p>Learn the techniques of basic gameplay and 
                                  be taught how to survive in the vast universe 
                                  of Norrath with an NPC guide who will assist 
                                  you in mastering every move. New players rejoice 
                                  - getting into the game has never been easier, 
                                  more compelling, or more fun.</p>
                              </div></td>
                          </tr>
                          <tr> 
                            <td width="50%"><a href="http://eqlive.station.sony.com/images/tutorial/Tut_ConWindow.jpg" target="_blank" style="padding: 10px 0px 0px 7px;"> 
                              &nbsp;&nbsp;&nbsp;<img src="http://eqlive.station.sony.com/images/tutorial/Tut_ConWindow_th.jpg" width="257" height="436" border="0"></a> 
                              <div align="center"> <a href="http://eqlive.station.sony.com/images/tutorial/Tut_ConWindow.jpg" target="_blank" style="font-size: 10px; color: #F6B831; font-family: Arial, Helvetica, sans-serif; padding: 0px 0px 0px 0px;" align="center">Click 
                                for larger version</a> <br>
                                <br>
                              </div></td>
                            <td width="50%" valign="top"><div style="font-size: 12px; color: white; font-family: Arial, Helvetica, sans-serif; padding: 0px 5px 0px 7px;"> 
                                <p>Upon creating a new character, you will be 
                                  given the option of running the tutorial, where 
                                  you will be guided through navigation and interaction 
                                  with the world of Norrath. Accompanying you 
                                  will be newly-recorded voiceover, along with 
                                  a unique quest. Running roughly fifteen minutes, 
                                  the tutorial is a small adventure in itself 
                                  - quick enough to get under your belt before 
                                  your first challenging newbie session of gameplay. 
                                  For those of you EQ veterans, create a new character 
                                  to check out the tutorial for yourself.</p>
                              </div>
                              <table width="280" border="0" align="center" cellpadding="5" cellspacing="0">
                                <tr> 
                                  <td><div align="center"><a href="/common/images/img_view.jsp?collection=tut_screenshots&name=EQ000030.jpg" target="_new" onclick="return imgViewPopUp('tut_screenshots', 'EQ000030.jpg');"><img src="http://eqlive.station.sony.com/images/tutorial/thumb_30.jpg" width="127" height="95" border="0"></a></div></td>
                                  <td><div align="center"><a href="/common/images/img_view.jsp?collection=tut_screenshots&name=EQ000031.jpg" target="_new" onclick="return imgViewPopUp('tut_screenshots', 'EQ000031.jpg');"><img src="http://eqlive.station.sony.com/images/tutorial/thumb_31.jpg" width="127" height="95" border="0"></a></div></td>
                                </tr>
                                <tr> 
                                  <td><div align="center"><a href="/common/images/img_view.jsp?collection=tut_screenshots&name=EQ000020.jpg" target="_new" onclick="return imgViewPopUp('tut_screenshots', 'EQ000020.jpg');"><img src="http://eqlive.station.sony.com/images/tutorial/thumb_20.jpg" width="127" height="95" border="0"></a></div></td>
                                  <td><div align="center"><a href="/common/images/img_view.jsp?collection=tut_screenshots&name=EQ000022.jpg" target="_new" onclick="return imgViewPopUp('tut_screenshots', 'EQ000022.jpg');"><img src="http://eqlive.station.sony.com/images/tutorial/thumb_22.jpg" width="127" height="95" border="0"></a></div></td>
                                </tr>
                              </table>
                              <p>&nbsp;</p></td>
                          </tr>
                          <tr> 
                            <td width="50%" valign="top"><div style="font-size: 12px; color: white; font-family: Arial, Helvetica, sans-serif; padding: 10px 5px 0px 7px;">Your 
                                character has been abducted by a gang of kobolds, 
                                and it is up to you to learn how to equip and 
                                arm your character and escape their lair. Follow 
                                the on-screen and voice instructions, aided with 
                                great graphic overlays and a storyline that lets 
                                you learn the game firsthand. Available through 
                                Level 5, the Tutorial is available to return to 
                                when your character starts adventuring in Norrath 
                                proper.</div></td>
                            <td width="50%"><div align="center"> 
                                <p><a href="http://eqlive.station.sony.com/images/tutorial/Tut_FirstQuest.jpg" target="_blank"><img src="http://eqlive.station.sony.com/images/tutorial/Tut_FirstQuest_th.jpg" width="265" height="323" border="0"></a></p>
                                <a href="http://eqlive.station.sony.com/images/tutorial/Tut_FirstQuest.jpg" target="_blank" style="font-size: 10px; color: #F6B831; font-family: Arial, Helvetica, sans-serif; padding: 0px 0px 0px 0px;">Click 
                                for larger version</a> </div></td>
                          </tr>
                        </table>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
