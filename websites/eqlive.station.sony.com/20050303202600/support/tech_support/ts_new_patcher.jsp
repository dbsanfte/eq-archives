	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_new_patcher.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_new_patcher.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_new_patcher.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P ALIGN="center"><STRONG><BR><STRONG>EverQuest Patcher Help</STRONG></STRONG></P>  <P><STRONG>Important Note: If you are unable to download files with the new
  patcher, </STRONG><A HREF="../../../../../support/tech_support/EverQuest.zip"><STRONG>download
  this file</STRONG></A><STRONG> to your EverQuest directory (default location is
  C:/Program Files/EverQuest/) and run it. You must have Internet Explorer
  installed on your system for the EverQuest patcher to work properly.</STRONG></P>  <P>One thing vitally important about the new EverQuest Patcher is its
  functionality. Not only do you have the ability to customize the patcher for
  your personal preferences, this patcher takes advantage of differential
  patching technology. Say for instance that we created an addendum to a
  certain file. Let's use EverQuest.exe as an example. In the past, we would
  have downloaded to you a brand new EverQuest.exe file. Now, with differential
  patching, we are only downloading the appended part of the EverQuest.exe file
  thus shortening the download process.</P>  <P>This page has been created to help everyone get accustomed to the new
  patcher. Below, you will find some information on the new options and how
  they work with each other.</P>  <P><STRONG>Checking Files</STRONG><BR>Like the previous EverQuest patcher, once you double click the EverQuest
  shortcut on your desktop, this new patcher launches and begins scanning for
  files that you need.</P>  <P>&nbsp;</P>  <P><STRONG>Patching</STRONG><BR>Once the patcher determines that your game should be updated, files are
  downloaded to your computer. The experience bar indicates how much of the
  file downloading process has occurred. The blue line will tell you how much
  of the current file has been downloaded, and the orange line will keep you
  informed of the overall status of the entire download. Once a couple of files
  have been downloaded to your system, a numerical time will appear below the
  experience bar estimating how long it will take to complete the download
  process.</P>  <P>&nbsp;</P>  <P><STRONG>Play now enabled</STRONG><BR>Once all files are downloaded, you can click the Play button to enter the
  game. If you notice the AutoPlay button, you will see a check box. Put a
  check in this box and you will not have use the Play button. Once you receive
  any needed files, you will be automatically taken to server select to begin
  playing. If Autoplay is selected and you wish to deselect while files are
  still being transferred to your system, simply hit the Cancel button. The
  transfer will be paused so that you can deselect Autoplay. To resume
  downloading, just use the Download button and the process will begin where it
  left off.</P>  <P><BR><BR><IMG BORDER="0" SRC="http://eqlive.station.sony.com/support/tech_support/images/patcher4.gif"></P>  <P><STRONG>Download button enabled</STRONG><BR>The Download button will be enabled depending on your choices under Advanced
  options. Keep reading for information on using Advanced options.</P>  <P><BR><BR><IMG BORDER="0" SRC="http://eqlive.station.sony.com/support/tech_support/images/patcher5.gif"></P>  <P><STRONG>Advanced Dialog Box</STRONG><BR>The Advanced dialog box is accessible by clicking on the Advanced button.
  This will allow EverQuest players to modify their downloading options. The
  first frame, &quot;Package Downloads&quot; indicates what EQ expansion packs
  you currently have installed on your system. Occasionally, a patch is offered
  that is specific to a certain expansion and can only be downloaded by choice.
  For example, say there are some new sounds added that are specific only to
  Kunark. To obtain these new sounds, you will need to make sure the box for
  Kunark is checked so that these files can be received. By putting a check in
  the appropriate boxes, you can stop wondering if you received the most
  current patch for an expansion. Click on the&quot; <STRONG>i</STRONG> &quot;
  next to each package to read the most current patch message for that package.</P>  <P>Also in this frame is the option to auto download files. Choosing this
  option will save you the extra step when launching the game by automatically
  downloading any files you may need. Deselect this option and manually
  download needed files by clicking on the Download button when it is activated.</P>  <P>Once you change any option, you can Save those options or cancel and start
  over. If you think one of your EverQuest files may be corrupted, then use the
  Complete File Check to run a complete scan of every file in your EQ
  directory.</P>  <P>&nbsp;</P>  <P><STRONG>General Issues</STRONG></P>  <P>All anti-virus software should be disabled before running the patcher.</P>  <P>&nbsp;</P>  <P><STRONG><U>Internet Explorer Issues</U></STRONG></P>  <P><STRONG>Set Dial Up Settings</STRONG></P>  <OL>   <LI>Under tools in the
       menu, click on Internet Options</LI>   <LI>Click on the
       Connections tab</LI>   <LI>Highlight your
       dialup and click the &quot;Settings&quot; button</LI>   <LI>At the bottom of the
       Settings page, uncheck &quot;Do not allow Internet Applications to use
       this connection&quot;</LI>   <LI>Click OK</LI>   <LI>Uncheck
       &quot;Perform system security check before dialing&quot;</LI>   <LI>Click OK</LI>  </OL>  <P><STRONG>Set Security to &quot;Medium&quot;</STRONG></P>    <P>All Internet Explorer Security settings should be set to &quot;Medium.&quot;
  To do this, follow these instructions:</P>      <OL>   <LI>Under Tools in the
       menu, click on Internet Options</LI>   <LI>Click on the
       Security tab</LI>   <LI>Click the
       &quot;Custom Level&quot; button</LI>   <LI>In the pull down
       menu under &quot;Reset custom settings,&quot; choose Medium</LI>   <LI>Click Reset</LI>   <LI>Click OK</LI>  </OL>    <P><STRONG>Use HTTP 1.1</STRONG></P>    <P>Follow these instructions to use HTTP 1.1:</P>      <OL>   <LI>Under Tools, click
       on Internet Options</LI>   <LI>Click on the
       Advanced tab.</LI>   <LI>Under HTTP 1.1
       Settings, check &quot;Use HTTP 1.1&quot; (unless you are running a
       proxy).</LI>  </OL>    <P>If you do not see this option, you should update your version of Internet
  Explorer. This can be done through Microsoft Windows Update (<A HREF="http://windowsupdate.microsoft.com/">http://windowsupdate.microsoft.com/</A>).</P>
