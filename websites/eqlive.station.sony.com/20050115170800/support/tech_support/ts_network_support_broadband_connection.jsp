	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_network_support_broadband_connection.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_network_support_broadband_connection.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_network_support_broadband_connection.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P ALIGN="center"><STRONG><BR><STRONG>Broadband Connection Troubleshooting</STRONG></STRONG></P>  <P>The following are things to check if you are having connection problems
  while playing EverQuest when using some form of Broadband connection (Cable
  Modem, DSL, etc.).</P>  <P>The first thing that you would want to check if you are losing connection
  to the game while playing is whether or not your network adapter is sharing
  an IRQ with your Video or Sound card. To check for this, right click on the
  &quot;My Computer&quot; icon on your desktop and choose
  &quot;Properties&quot; from the menu. Next, choose the &quot;Device
  Manager&quot; tab and double click the &quot;Computer&quot; entry at the top
  of the device list. This should bring up the IRQ Resource window. If your
  network card is sharing an IRQ with your Video or Sound card then you will
  need to move one of those devices to a different slot on your motherboard to
  resolve the conflict.</P>  <P>If you have a modem installed in your computer along with the network card
  for either your Cable or DSL modem then it may cause troubles. We recommend
  that you remove the modem from your computer completely, or at least disable
  it, so there is no conflict there between the modem and your network card.</P>  <P>There is a file in your EverQuest directory that is named Datarate.txt.
  This file determines the size of the packets of information that you receive
  during gameplay. The default value in the file is 5.0, but we recommend that
  you try setting it at 7.0. This should speed up certain aspects of the game
  such as zoning times. If you are encountering severe packet loss at either of
  those settings then you may want to try setting it at a value lower then 5.0.
  If you are using a standard dial up modem, do not set the value in that file
  higher then 5.0.</P>  <P>Remember that if you are running a firewall, then it could cause
  connection troubles to our servers. You will either need to disable any
  firewalls you may have running, or visit our <A HREF="../../../../../support/tech_support/ts_network_support_firewall_proxy_info.jsp">Firewall/Proxy
  Support page</A> for all the necessary modifications you would need in order
  to connect to EverQuest from behind your firewall.</P>  <P>If you are still having problems after visiting this support section, you
  can contact our Technical Support Department through <A HREF="mailto:eqtech@soe.sony.com">email</A>.</P>  <P>&nbsp;</P>
