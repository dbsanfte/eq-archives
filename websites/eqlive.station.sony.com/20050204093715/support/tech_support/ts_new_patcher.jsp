...
<P ALIGN="center"><STRONG><BR><STRONG>EverQuest Patcher Help</STRONG></STRONG></P>  <P><STRONG>Important Note: If you are unable to download files with the new
  ...
  process.</P>  <P>&nbsp;</P>  <P><STRONG>Play now enabled</STRONG><BR>Once all files are downloaded, you can click the Play button to enter the game.
  If you notice the AutoPlay button, you will see a check box. Put a check in
  this box and you will not have use the Play button. Once you receive any
  needed files, you will be automatically taken to server select to begin
  ...
  directory.</P>  <P>&nbsp;</P>  <P><STRONG>General Issues</STRONG></P>  <P>All anti-virus software should be disabled before running the patcher.</P>  <P>&nbsp;</P>  <P><STRONG><U>Internet Explorer Issues</U></STRONG></P>  <P><STRONG>Set Dial Up Settings</STRONG></P>  <OL>   <LI>Under tools in the
       ...
       dialup and click the &quot;Settings&quot; button</LI>   <LI>At the bottom of
       the Settings page, uncheck &quot;Do not allow Internet Applications to
       use this connection&quot;</LI>   <LI>Click OK</LI>   <LI>Uncheck
