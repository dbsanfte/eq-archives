...
<tr>
	...
	<a href="recent_updates.jsp?id=64519" class="tinylink">December 17, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=64488" class="tinylink">December 15, 2004</a><br>
...
<h1>December 17, 2004</h1>
*** Update Message 12/17/2004 ***
<P>------------------------------------- </P>
<P>We apologize for the recent issues with our attempt to ease backflagging. Our coders and designers have worked tirelessly through the night to come up with tonight's update which should resolve the backflagging solution issues. We have also identified a few other issues and added corrections for them as well. </P>
<P>- Backflagging issues have been resolved.</P>
<P>- Raids can again enter Anguish.</P>
<P>- Huntress / High Priestess titles should now display correctly based upon gender.</P>
<P>- An itemization issue in South Karana and Splitpaw has been corrected.</P>
<P>- The debuff in the Muramite Trial of Efficiency will not cast as often.</P>
<P>- The mirrors in the Tower of Frozen Shadow should once again function properly.</P>
<P>- The Monk AA Hastened Purification of the Body has been corrected to be 10% of the newly reduced reuse time for Purify Body.</P>
<P>- Added the spell Tranquility of the Glade to the ranger's repertoire, which rangers can recieve by turning in a rune. </P>
<P>- The berserker ability Crippling Strike should now have a fixed duration</P>
