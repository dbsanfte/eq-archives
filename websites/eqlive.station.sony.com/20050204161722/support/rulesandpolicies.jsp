...
<P>&nbsp;</P>  <P><A HREF="../../../../../support/customer_service/cs_EULA.jsp">License
  Agreement</A><BR>Standard agreement agreed to by players each time they log into EverQuest.</P>  <P><A TARGET="_tosWin" HREF="http://sonyonline.com/tos/tos.jsp">SOE Terms of
  Service</A><BR>Sony Online Entertainments Terms of Service which govern use of SOE branded
  games, Websites, and other properties.</P>  <P><A HREF="../../../../../support/customer_service/cs_rules_of_conduct.jsp">Rules
  of Conduct</A><BR>These rules have been establish to maintain consistent and fun entertainment
  for EverQuest.</P>  <P><A HREF="../../../../../support/customer_service/cs_naming_policy.jsp">Naming
  Policy</A><BR>This policy establishes what types of character names&nbsp; will be allowed
  to be used while playing EverQuest.</P>  <P><A HREF="../../../../../support/customer_service/cs_reimbursement.jsp">Item
  Reimbursement Policy</A><BR>Policy to establish how in-game items will be returned in case of loss.</P>  <P><A TARGET="_tosWin" HREF="http://sonyonline.com/tos/tos.jsp#privacy">SOE
  Privacy Policy</A><BR>This privacy statement is applicable to The Station, SOE content contained
  therein, and all services and forums provided thereon.</P>  <P><A HREF="../../../../../support/customer_service/cs_security_notices.jsp">COPPA
  and Privacy Notice</A><BR>How we use your information and guarding those 13 years of age and
  younger.&nbsp;&nbsp;</P>
