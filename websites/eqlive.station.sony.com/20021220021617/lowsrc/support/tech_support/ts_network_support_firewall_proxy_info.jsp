...
<LI>Go into the Unrestricted Applications group and look for all executable files listed under your EverQuest directory and move them to the EverQuest</LI></UL>Application Group you just created 
<UL>
<LI>Close the window and run EverQuest </LI></UL>
<P>If the walkthrough for your respective program do not resolve your issue, please contact the SOE Technical Support staff at (858)537-0898, or email them at eqtech@soe.sony.com. You can also reach them via Live Chat located at <A href="http://eqlive.station.sony.com/support/">http://eqlive.station.sony.com/support/</A>.</P>
