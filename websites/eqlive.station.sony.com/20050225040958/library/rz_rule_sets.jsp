...
//window.alert(document.cookie);
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><STRONG><U>Welcome to Zek </U></STRONG></P>  <P>On February 8<SUP>th</SUP> 2005, a new server will show up on your server
  selection list.&nbsp; Zek will host the combined characters of the four current
  PVP servers (Rallos, Tallon, Vallon and Sullon) and will use the Rallos Zek
  ruleset.&nbsp; It is our opinion that merging the four current PVP servers
  will revitalize the PVP environment, adding new challenges and players for
  you to test your skills against.</P>  <P><STRONG>Character Purge<BR></STRONG>Immediately preceding the merger, all characters that are below level 10
  and have not been accessed in the past six months or more will be purged from
  all four PVP servers.&nbsp; If you have a character on Rallos Zek, Tallon
  Zek, Vallon Zek or Sullon Zek that is below level 10 and has not been logged
  in for six months or more, you will need to log them in prior to the February
  8<SUP>th</SUP> downtime.&nbsp; Any character that is below level 10 and has
  not been logged in for 6 or more months will be deleted and will not be
  available after the server merge.</P>  <P><STRONG>Shared Banks<BR></STRONG>If you have characters on more than one of the PVP servers, you will need
  to clean out the shared bank on all but one of the existing PVP
  servers.&nbsp; Only one shared bank, from one of the four servers, will be
  available after the merger.</P>  <P><STRONG>Characters<BR></STRONG>If you have more than 8 characters combined between all of the current
  PVP servers, after the merger, only the first 8 (sorted alphabetically)
  characters will be displayed.&nbsp; Other characters beyond those 8 will not
  be available for selection until characters are deleted.&nbsp; The characters
  will be on your account provided they were not below level 10 and had been
  played within the last 6 months.</P>  <P><STRONG>Corpses</STRONG><BR>Prior to the downtime on the 8<SUP>th</SUP> of February, please make certain
  that you clear any character corpses from the world.&nbsp; Character corpses
  will not be transferred to the new merged server.&nbsp; All corpses will be
  purged once the merger is complete.</P>  <P><STRONG>Character Names</STRONG><BR>It is likely that characters will have duplicate names on these servers, in
  ...
  Character Move</STRONG><BR>Beginning shortly after the merge is complete, a one time move will be
  offered to all accounts on the new PVP server.&nbsp; Each account will be
  allowed to move the entirety of their account to the non-PVP server of their
  choice, with gear.&nbsp; This offer will only last for 30 days and includes
  all characters on an account.&nbsp; </P>  <P><STRONG><U>Zek Rules:</U></STRONG></P>  <P>This document includes the PvP rules for Zek.</P>  <OL>   <LI>Player v. Player (PvP)
       combat can occur between any characters that are within a 4 level limit.
       For instance, a level 45 person may attack or be attacked by anyone from
       level 41 through 49. There are no other PvP restrictions, such as Race
       or Alignment.</LI>   <LI>Characters will be immune
       to PvP combat until they have gained enough strength to survive the
       struggle. Characters below 6th level are not able to participate in PvP
       combat. As soon as a character 'dings' into 6th level, he or she will
       become PvP enabled.</LI>   <LI>Characters will not
