...
<tr>
	...
	<a href="recent_updates.jsp?id=64108" class="tinylink">September 22, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64104" class="tinylink">September 21, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64101" class="tinylink">September 16, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64097" class="tinylink">September 13, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64092" class="tinylink">September 7, 2005</a><br>
...
<h1>September 22, 2005</h1>
<P>*** Exploit ***<BR><BR>- Fixed an exploit with a character being created with the name of an
  existing character.<BR><BR>September 21st, 2005<BR>_____________________<BR><BR>*** Missions ***<BR><BR>- Lockout timers for missions are now fixed.&nbsp; You will no longer get the 50+ day
  lockout timers.&nbsp; Those that have
  these long lockout timers need to log those characters into the game to have
  those timers reset automatically for them.&nbsp; There is no need to petition to get
  them reset, they will be reset automatically.</P>  <P>- Orvin in West Commonlands should port players with the
  Zanivar quest.</P>  <P>- The chance that you would loot the required items for
  the mission Desert Crawl was increased.</P>  <P>- Corgoth has remembered his obligations and has returned
  to the Norrath&#8217;s Keeper faction. </P>  <P>- Adjusted the experience reward for some of the monster
  missions to be more in line with the time it is taking to complete them.</P>  <P>- Kathi Norman is on vacation.&nbsp; She will return to help Griffins find
  their eggs as soon as she can. (ooc: The mission she gave was just too easy
  and is being retrofitted with more fun and challenge).</P>  <P>-&nbsp; Lowered the
  difficulty of Warlord Drellak in the second mission of the Walls of Xill
  mission line in Stoneroot Falls.</P>  <P>-&nbsp; Some mission
  givers in Stoneroot Falls will now see through invisibility.&nbsp; You may now communicate with them
  while having invisibility up.<BR><BR>*** Items ***<BR><BR>- Evolving items that had the same recommended and required level will now
  only report the required level.</P>  <P>- Some Illsalin level 70 hard mission items have been
  slightly upgraded.</P>  <P>- A few belts throughout Darkhollow now increase the size
  of your potion belt.<BR><BR>*** Quests ***<BR><BR>&#8211; A few quest combines that had a lore result were failing.&nbsp; These should now work properly.&nbsp; In some cases, you will still have the
  container when you are done with it.&nbsp;
  Do with it what you want.&nbsp;
  This includes the combines for the Ranger and Druid epic 2.0 that were
  eating their containers.</P>  <P>- The unbridled fury of Korbuk Brimblade will no longer
  bring unwanted lag to Noble's Causeway.<BR><BR>*** Shrouds ***<BR><BR>- Modified the experience scaling for Spirit Shrouds, Evolving Items, and
  Leadership Abilities to grant more experience at lower levels.<BR><BR>*** AAs ***<BR><BR>- The AA description for some of the new DoD AAs will now show the proper
  required level.<BR><BR>*** Tradeskills ***<BR><BR>&#8211; Eureka! Players can now learn some of the Depths of Darkhollow
  recipes that were so forgettable. </P>  <P>- Nest Drake eggs now work with normal flour.</P>  <P>- The new snake eggs found in Darkhollow make scrumptious
  dough, noodles, egg batter, and snake egg oil.</P>  <P>- We have fixed an issue with a tradeskill combines where
  the container is lore and is also given back to the player after the combine
  is completed.&nbsp; You will now be
  able to complete these combines again.<BR><BR>- The EverQuest Team</P>
