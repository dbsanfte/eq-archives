...
<tr>
	...
	<a href="dev_view.jsp?id=64083" class="tinylink">Flag Change for
  Epic 1.5 and Epic 2.0</a><br>
...
<h1>Flag Change for
  Epic 1.5 and Epic 2.0</h1>
<P>&nbsp;</P>  <P>With the next update all 1.5 and 2.0 epics will be flagged
  as LORE.&nbsp; They will be LORE to
  each other, meaning you will only be able to possess either epic 1.5 OR epic
  2.0.&nbsp; Prior to the update it is
  advised that if you still possess both epic 1.5 and 2.0 that you delete 1.5,
  the code for this change will remove one of these from your possession but
  will not differentiate between the two.&nbsp;
  If the system does the deletion, there is a possibility your epic 2.0
  will be removed from your possession instead of the 1.5.</P>
