...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/faydwer.jsp?null');">
                                  ...
                                  <tr> 
                                    ...
                                    <td> 
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          ...
                                          <td width="80%" height="256" rowspan="3"> 
                                            <center>
                                              <img src="images/map_faydwer_hi.gif" width="407" height="256" usemap="#cities" border="0">
                                              <map name="cities">
                                                <area shape="rect" coords="36,99,90,117" href="kaladim.jsp">
                                                <area shape="rect" coords="188,45,241,64" href="kelethin.jsp">
                                                <area shape="rect" coords="319,32,369,49" href="felwithe.jsp">
                                                <area shape="rect" coords="300,177,354,195" href="akanon.jsp">
                                              </map>
                                            </center>
                                          </td>
                                          <td width="20%"> 
                                      ...
                                      <table border="0" width="100%" cellpadding="20" cellspacing="0">
                                        <tr> 
                                          <td><font color="#000000">Faydwer is 
                                            the home of the Dwarves, Wood Elves 
                                            and Gnomes. The High Elf civilization 
                                            from Antonica also relocated to Faydwer 
                                            after the death of the Elddar Forest. 
                                            Faydwer is also rumored to be the 
                                            home of two of the oldest creatures 
                                            on all of Norrath, Mayong Mistmoore, 
                                            the Elf-Vampire and Phinigel Autropos, 
                                            the last living Kedge. The name, Faydwer 
                                            was given to this continent by the 
                                            High Elves of Antonica when they landed 
                                            on its shores.</font></td>
                                          <td> 
