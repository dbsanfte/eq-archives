	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_EULA.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_EULA.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_EULA.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P>Please remember to review the current terms and conditions of the
  EverQuest User Agreement and Software License.</P>  <P>Thank you. EVERQUEST&reg; USER AGREEMENT AND SOFTWARE LICENSE THIS
  AGREEMENT DESCRIBES THE TERMS ON WHICH SONY ONLINE ENTERTAINMENT INC. (&quot;<STRONG>SOE</STRONG>&quot;)
  OFFERS YOU ACCESS TO AN ACCOUNT (THE &quot;<STRONG>ACCOUNT</STRONG>&quot;) TO
  PLAY THE EVERQUEST FANTASY ONLINE ROLE PLAYING COMPUTER GAME AND ANY
  EXPANSION PACKS (INDIVIDUALLY AND COLLECTIVELY, THE &quot;<STRONG>GAME</STRONG>&quot;).
  ...
  these terms and conditions, please contact customer service at <A HREF="mailto:eqmail@soe.sony.com">eqmail@soe.sony.com</A>.</P>  <P>1. Accounts are available only to adults or, in their discretion, their
  minor child. If you are a minor, your parent(s) or guardian(s) must complete
  the registration process, in which case they will take full responsibility
  for all obligations under this Agreement. By clicking the &quot;I
  Accept&quot; button and providing us with a credit card number, you represent
  that you are an adult and are either accepting this Agreement on behalf of
  yourself or your child. You may not transfer or share your Account with
  anyone, except that if you are a parent or guardian, you may permit one child
  to use the Account instead of you (in which case you may not use that
  Account). You are liable for all activities conducted through the Account,
  and parents or guardians are liable for the activities of their child.
  Corporations and other entities are not eligible to procure Accounts.</P>  <P>2. To play the Game, you must (a) purchase or receive through an
  SOE-authorized promotional offer (such as an authentic disc bundled with a
  game magazine) the Game CD-ROM (the &quot;<STRONG>CD-ROM</STRONG>&quot;) or
  applicable files which we may make available for direct download, which
  includes software required for the Game (the &quot;<STRONG>Software</STRONG>&quot;),
  ...
  you pursuant to this Agreement.</P>  <P>3. We may amend this Agreement at any time in our sole discretion.
  ...
  available for your review.</P>  <P>4. Upon registration, you must select a password. You may not disclose
  your password to any third party. We never ask you for your password by
  telephone or email, and you should not disclose it this way if someone asks
  you to do so. Although we may offer a feature that allows you to
  &quot;save&quot; or &quot;remember&quot; your password on your hard drive,
  please note that by using this feature third parties may be able to access
  your computer and thus your Account.</P>  <P>5. We describe our fees and billing procedures at a hotlink located at
  www.everquestlive.com, which are incorporated by reference. All fees are
  ...
  time your Account comes up for renewal, we have the right to charge your
  ...
  partial refunds for subscription periods that you have purchased.</P>  <P>6. We may terminate this Agreement (including your Software license and
  ...
  rules of conduct, which are posted at a hotlink at www.everquestlive.com. If
  we terminate this Agreement or suspend your Account under these
  circumstances, you will lose access to your Account for the duration of the
  suspension and/or the balance of any prepaid period without any refund. We
  may also terminate this Agreement if we decide, in our sole discretion, to
  discontinue offering the Game, in which case we may provide you with a
  prorated refund of any prepaid amounts.</P>  <P>7. Subject to the terms of this Agreement, we hereby grant to you a
  ...
  restricts your use of the Software.</P>  <P>8. We and our suppliers shall retain all rights, title and interest,
  including, without limitation, ownership of all intellectual property rights
  relating to or residing in the CD-ROM, the Software and the Game, all copies
  ...
  or to the CD-ROM, the Software or the Game, including, without limitation, in
  any character(s), item(s), coin(s) or other material or property, and that
  all such property, material and items are exclusively owned by us.</P>  <P>9. You may not use any third party software to modify the Software to
  change Game play. You may not create, facilitate, host, link to or provide
  any other means through which the Game may be played by others, such as
  through server emulators. You may not take any action which imposes an
  unreasonable or disproportionately large load on our infrastructure. You may
  not buy, sell or auction (or host or facilitate the ability to allow others
  to buy, sell or auction) any Game characters, items, coin or copyrighted
  material.</P>  <P>10. To obtain an Account, you will be required to choose both a login name
  ...
  publicity rights or other proprietary rights.</P>  <P>11. As part of your Account, you can upload content to our servers in
  various forms, such as in the selections you make for the Game and in chat
  rooms and similar user-to-user areas (collectively, your &quot;<STRONG>Content</STRONG>&quot;).
  Your Content shall not: (a) infringe any third party intellectual property,
  other proprietary or publicity/privacy rights; (b) violate any law or
  regulation; (c) be defamatory, obscene, child pornographic or harmful to
  minors; or (d) contain any viruses, trojan horses, worms, time bombs,
  ...
  expropriate any system, data or personal information. We may take any action
  with respect to your Content if we believe it may create liability for us or
  may cause us to lose (in whole or in part) the services of our ISPs or other
  suppliers. You hereby grant to us a worldwide, perpetual, irrevocable,
  royalty-free, sublicenseable (through multiple tiers) right to exercise all
  intellectual property rights, in any media now known or not currently known,
  associated with your Content.</P>  <P>12. We cannot ensure that your private communications and other personally
  ...
  or inquiries. Furthermore, if you request any technical support, you consent
  to our remote accessing and review of the computer you load the Software onto
  for purposes of support and debugging. You agree that we may communicate with
  you via email and any similar technology for any purpose relating to the
  Game, the Software and any services or software which may in the future be
  provided by us or on our behalf. You may choose to visit <A HREF="http://www.everquestlive.com/">www.everquestlive.com</A> or <A HREF="http://www.station.sony.com/">www.station.sony.com</A>, SOE's web sites
  (&quot;<STRONG>The Station</STRONG>&quot;) if such web sites offer services
  such as an EverQuest game themed chat room or other services of interest to
  you. You are subject to the terms and conditions, privacy customs and
  policies of SOE while on such web sites and in connection with use of your
  Account and the Game, which terms and conditions, policies and customs are
  incorporated herein by this reference. Since we do not control other web
  sites and/or privacy policies of third parties, different rules may apply to
  their use or disclosure of the personal information you disclose to others.
  Solely for the purpose of patching and updating the Game, you hereby grant us
  permission to (i) upload Game file information from the Game directory and
  (ii) download Game files to you. <STRONG>You acknowledge and agree that we
  may transfer Game and your Account information (including your personally
  identifiable information and personal data) to the United States or other
  countries or may share such information with our licensees and agents in
  connection with the Game.</STRONG></P>  <P>13. WE PROVIDE THE CD-ROM, THE SOFTWARE, THE ACCOUNT, THE GAME AND ALL
  OTHER SERVICES &quot;AS IS.&quot; WE AND OUR SUPPLIERS EXPRESSLY DISCLAIM ALL
  ...
  secure or virus-free operation of the CD-ROM, the Software, the Game, your Account
  or continued operation or availability of any given server. Some states do
  not allow limitations as to how long an implied warranty lasts and/or
  exclusions or limitations of consequential damages, so the above limitations
  and/or exclusions of liability may not apply to you. This warranty gives you
  specific legal rights and you may also have other legal rights which vary
  from state to state.</P>  <P>We are not liable for any delay or failure to perform resulting from any
  ...
  there may be extended periods of time when you cannot access your Account.</P>  <P>14. IN NO EVENT SHALL WE, OUR PARENT, OUR AFFILIATES OR OUR SUPPLIERS BE
  ...
  MALFUNCTION OF THE SOFTWARE, YOUR ACCOUNT, THE GAME, THE SOFTWARE OR THIS
  AGREEMENT. OUR LIABILITY TO YOU OR ANY THIRD PARTIES IS LIMITED TO $100. Some
  states do not allow the foregoing limitations of liability, so they may not
  apply to you.</P>  <P>15. You shall comply with all applicable laws regarding your use of the
  ...
  regulations, including, without limitation, the laws of the United States.</P>  <P>16. This Agreement is governed in all respects by the laws of the State of
  ...
  brought in the County of San Diego, State of California (if under State law)
  or the Southern District of California (if under federal law). If any
  ...
  assign or transfer this Agreement or your rights hereunder, and any attempt
  to the contrary is void. This Agreement sets forth the entire understanding
  and agreement between us and you with respect to the subject matter hereof.
  Except as provided herein, this Agreement may not be amended except in a
  writing signed by both parties.</P>  <P>17. All services hereunder are offered by Sony Online Entertainment Inc.,
  located at 8928 Terman Court, San Diego, California 92121. Our phone number
  is (858) 537-0898. Current rates for using the Game may be obtained from a
  hotlink at www.everquestlive.com, and such rates are subject to change at any
  time. If you are a California resident, you may have this same information
  emailed to you by sending a letter to the foregoing address with your email
  address and a request for this information.</P>  <P>The Complaint Assistance Unit of the Division of Consumer Services of the
  Department of Consumer Affairs may be contacted in writing at 400 R Street,
  Sacramento, CA 95814, or by telephone at (800) 952-5210.</P>  <P>Parental control protections (such as computer hardware, software, or
  ...
  providing information on such protections.</P>  <P>The Software is a &quot;commercial item&quot; if acquired under agreement
