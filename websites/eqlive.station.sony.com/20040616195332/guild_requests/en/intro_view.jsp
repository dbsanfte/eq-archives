                ...
                <td> 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      Welcome to the EverQuest Guild Application System.<br>
                      <br>
                      From this page, you can enter guild creation requests, view any existing requests you previously entered or cancel any pending guild requests.<br>
                      <br>
                      Click <a href="/guild_requests/index.jsp?page=CREATE_REQUEST">here</a> to submit a guild creation request.<br>
                      <br>
                      Click <a href="/guild_requests/index.jsp?page=VIEW_REQUESTS">here</a> to view your existing guild requests.<br>
                      <br>
