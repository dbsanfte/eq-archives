	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/future_plans.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/future_plans.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/updates/future_plans.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Future&nbsp;Plans</font></b></div>
                        <!-- #EndEditable --></td>
...
<tr>
	...
	<a href="future_plans.jsp?id=57691" class="tinylink">Future Plans for August, 2003</a><br>
	
	
	
	<a href="future_plans.jsp?id=57286" class="tinylink">Future Plans for July</a><br>
	
	
	
	<a href="future_plans.jsp?id=56364" class="tinylink">Future Plans, June 11, 2003</a><br>
	
	
	
	<a href="future_plans.jsp?id=55884" class="tinylink">A Message from the President, May 14, 2003</a><br>
	
	
	
	<a href="future_plans.jsp?id=55840" class="tinylink">Further Down the Line - May 9, 2003</a><br>
	
	
	<p><a href="future_plans_archive.jsp" class="tinylink">Archives &gt;&gt;</a>
	</td>
</tr>
</table>
...
<h1>Future Plans for August, 2003</h1>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial>Those of us behind the scenes here on the EverQuest team have plans for the future of the game.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Further Down the Line is where we will keep you informed about what those plans are.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Please understand that these are our long-term plans and may require a fair amount of research or development time.</FONT></P>
...
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B>Several partial zone revamps coming to the Live servers.</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Though delayed several weeks, we are working to complete the partial revamps of several zones:<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>The Deep, Charasis (Howling Stones), Dragon Necropolis, Siren's Grotto, The Hole, The City of Mist, and Velketor's Labyrinth.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We chose these zones to update based on feedback from players, and plan to implement changes that will make these zones more entertaining to play in.</FONT></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial><B style="mso-bidi-font-weight: normal">Plane of Mischief changes going to the Legends server later next month.</B><SPAN style="mso-spacerun: yes">&nbsp; </SPAN>The Plane of Mischief is the home of the trickster, Bristlebane.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>One of the most unusual places to visit in EverQuest, this zone is in need of a revamp.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We're looking at it now and plan to have changes ready for Legends later in August.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We'll be keeping the wacky style of the place while at the same time making it a bit more playable.</FONT></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt 0.25in"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><B style="mso-bidi-font-weight: normal"><SPAN style="mso-bidi-font-family: Arial">Items in the Planes of Power</SPAN></B><B style="mso-bidi-font-weight: normal"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></B></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p>&nbsp;</o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">We will be looking at the quality of Planes of Power item rewards and improving them where appropriate.&nbsp; Items for many of the lower tier gods will be upgraded and more rare items and NPCs will be added to the following zones as needed:</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 3pt"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p>&nbsp;</o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Crypt of Decay</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Plane of Torment</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Halls of Honor</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Plane of Tactics</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Plane of Innovation</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Bastion of Thunder</SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><FONT face=Arial><B style="mso-bidi-font-weight: normal"><SPAN style="mso-bidi-font-family: Arial">Class Balance</SPAN></B><B style="mso-bidi-font-weight: normal"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></B></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 3pt"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p>&nbsp;</o:p></SPAN></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><SPAN style="mso-bidi-font-size: 11.0pt"><FONT face=Arial>We're still planning to take a look at improving the damage capabilities of melee classes, as they've fallen behind their magic-using counterparts at the very high end of the game.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Finding the proper solutions for this situation will take some time.&nbsp; Some options being considered are:</FONT></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 3pt"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p>&nbsp;</o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Improve melee damage-increasing disciplines</SPAN><SPAN style="mso-bidi-font-family: Arial"> </SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial">Improve Planes of Power melee weapons</SPAN><SPAN style="mso-bidi-font-family: Arial"> </SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p></o:p></SPAN></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 3pt"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'"><o:p>&nbsp;</o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial"><FONT face=Arial>Additionally, we're looking at the concerns from players about their spells, and changing them where appropriate.&nbsp; The goal here is to remove annoying issues with spells, not necessarily to increase caster power overall.<o:p></o:p></FONT></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><B style="mso-bidi-font-weight: normal"><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial"><FONT face=Arial>Shields and blocking<o:p></o:p></FONT></SPAN></B></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><SPAN style="mso-bidi-font-size: 11.0pt; mso-bidi-font-family: Arial"><FONT face=Arial>We're planning on reviewing the possibility of giving an innate chance to block when using a shield.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We've been hoping to do this for a while, and it should be getting a realistic review in the near future.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We'd like to increase the value of shields, and make it a worthwhile choice for players who might normally dual-wield weapons or use a two-handed weapon.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We plan on balancing this against classes which use shields by default, and therefore wouldn't be making any trade-offs to equip a shield.<o:p></o:p></FONT></SPAN></P>
<P class=MsoBodyTextIndent style="MARGIN: 0in 0in 0pt"><o:p><FONT face=Arial>&nbsp;</FONT></o:p></P>
