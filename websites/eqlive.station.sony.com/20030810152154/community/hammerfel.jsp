...
<h1>December 2002 Newsletter Shipping Soon</h1>
<P>The December 2002 issue of the EverQuest newsletter, the Harpy's Head Herald, is about to start shipping, and this issue has a holiday surprise or two...or six. Have you signed up to get it? No? Well, while it's too late to get on the list for the December Newletter, you can sign up now and be on the list for January's edition.</P>
<P><A href="http://eqlive.station.sony.com/community/newsletter.jsp">Sign up to receive the Harpy's Head Herald</A>. </P>
<P>Each issue has EQ treats, tips, updates, screenshots or art you won't find anywhere else. And as with our past issues, the EQ newsletter is the first-hand source for some of the latest and biggest announcements, like the EverQuest II teaser (<A href="http://eqlive.station.sony.com/community/hammerfel.jsp?id=40095">remember that one?</A>). </P>
<P>Also, for those who do get the newsletter, you're going to notice a few nice changes in this issue. It should be easier to read and to navigate, and its design will echo the look and feel of the EverQuest Live site. 
<P>Have a good holiday, and get ready for the New Year--it's shaping up to be a great year for gaming!</P>
<P>-Hammerfel<BR>Director of Web Presence<BR><A href="http://www.sonyonline.com/">Sony Online Entertainment</A></P>
