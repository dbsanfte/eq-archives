	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P><A href="http://eqlive.station.sony.com/library/fv_rule_sets.jsp">Firiona Vie</A><BR>Firiona Vie is a roleplaying preferred server.</P>
<P><A href="http://eqlive.station.sony.com/library/rz_rule_sets.jsp">Rallos Zek</A><BR>The first +PvP server to launch. No team, everyone&nbsp;is on their own.</P>
<P><A href="http://eqlive.station.sony.com/library/tz_rule_sets.jsp">Tallon Zek</A><BR>Team based server based on race selection.<BR><BR><A href="http://eqlive.station.sony.com/library/vz_rule_sets.jsp">Vallon Zek</A><BR>Team based server based on race selection.</P>
<P><A href="http://eqlive.station.sony.com/library/sz_rule_sets.jsp">Sullon Zek</A><BR>Team based server based on Deity selection.</P>
