	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_subscriptions.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_subscriptions.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P ALIGN="center"><STRONG><BR><STRONG>Changing Subscription Plans or Payment Methods</STRONG></STRONG></P>  <P>Billing information can only be changed through the game interface. Load <EM>EverQuest</EM>,
  as you normally would to play. Click &quot;Account&quot;, instead of
  &quot;Connect&quot;, at the main screen, then click &quot;Change
  Account&quot;. You will have to login at this point, then click the
  &quot;Edit Billing&quot; button to re-enter your billing information.</P>  <P>Optionally, you can cancel your current subscription and wait for it to
  expire. Please note that you will still have access to <EM>EverQuest</EM>  until the account expires. Once your current subscription is expired, you
  will be prompted to re-subscribe. You may select any pricing plan you wish,
  or change the billing to a new credit card.</P>  <P>Your characters will not be affected in any way by canceling or changing
  your billing.</P>  <P>If you are still having problems after visiting this support section, you
  can contact our Technical Support Department via email using our <A HREF="http://www.station.sony.com/en/services/help/premiumGames.jsp">online
  form</A>.</P>
