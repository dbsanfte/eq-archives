<!-- #BeginTemplate "/Templates/sub_template.dwt" -->
<!-- DW6 -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/renames/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/renames/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
//window.alert(document.cookie);
          ...
          <td width="614" background="" valign="top">
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Character&nbsp;Rename&nbsp;Server&nbsp;List</font></b></div>
                        <!-- #EndEditable --></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
                        Click on a server name to view the complete list of renamed 
                        characters on that server. If a server's name is missing, 
                        that is because there have not yet been any renames on 
                        it. 
                        <p>
			...
			<a href="server.jsp?server=Al'Kabor">Al'Kabor</a><br>
			
			<a href="server.jsp?server=Antonius Bayle">Antonius Bayle</a><br>
			
			<a href="server.jsp?server=Ayonae Ro">Ayonae Ro</a><br>
			
			<a href="server.jsp?server=Bertoxxulous">Bertoxxulous</a><br>
			
			<a href="server.jsp?server=Brell Serilis">Brell Serilis</a><br>
			
			<a href="server.jsp?server=Bristlebane">Bristlebane</a><br>
			
			<a href="server.jsp?server=Cazic Thule">Cazic Thule</a><br>
			
			<a href="server.jsp?server=Cazic-Thule">Cazic-Thule</a><br>
			
			<a href="server.jsp?server=Drinal">Drinal</a><br>
			
			<a href="server.jsp?server=Druzzil Ro">Druzzil Ro</a><br>
			
			<a href="server.jsp?server=E'ci">E'ci</a><br>
			
			<a href="server.jsp?server=Erollisi Marr">Erollisi Marr</a><br>
			
			<a href="server.jsp?server=Fennin Ro">Fennin Ro</a><br>
			
			<a href="server.jsp?server=Firiona Vie">Firiona Vie</a><br>
			
			<a href="server.jsp?server=Innoruuk">Innoruuk</a><br>
			
			<a href="server.jsp?server=Kane Bayle">Kane Bayle</a><br>
			
			<a href="server.jsp?server=Karana">Karana</a><br>
			
			<a href="server.jsp?server=Lanys T'Vyl">Lanys T'Vyl</a><br>
			
			<a href="server.jsp?server=Luclin">Luclin</a><br>
			
			<a href="server.jsp?server=Maelin Starpyre">Maelin Starpyre</a><br>
			
			<a href="server.jsp?server=Mithaniel Marr">Mithaniel Marr</a><br>
			
			<a href="server.jsp?server=Morden Rasp">Morden Rasp</a><br>
			
			<a href="server.jsp?server=Morell Thule">Morell Thule</a><br>
			
			<a href="server.jsp?server=Morell-Thule">Morell-Thule</a><br>
			
			<a href="server.jsp?server=Povar">Povar</a><br>
			
			<a href="server.jsp?server=Prexus">Prexus</a><br>
			
			<a href="server.jsp?server=Quellious">Quellious</a><br>
			
			<a href="server.jsp?server=Rallos Zek">Rallos Zek</a><br>
			
			<a href="server.jsp?server=Rodcet Nife">Rodcet Nife</a><br>
			
			<a href="server.jsp?server=Saryrn">Saryrn</a><br>
			
			<a href="server.jsp?server=Solusek Ro">Solusek Ro</a><br>
			
			<a href="server.jsp?server=Stormhammer">Stormhammer</a><br>
			
			<a href="server.jsp?server=Stromm">Stromm</a><br>
			
			<a href="server.jsp?server=Sullon Zek">Sullon Zek</a><br>
			
			<a href="server.jsp?server=Tallon Zek">Tallon Zek</a><br>
			
			<a href="server.jsp?server=Tarew Marr">Tarew Marr</a><br>
			
			<a href="server.jsp?server=Terris Thule">Terris Thule</a><br>
			
			<a href="server.jsp?server=Terris-Thule">Terris-Thule</a><br>
			
			<a href="server.jsp?server=Test Server">Test Server</a><br>
			
			<a href="server.jsp?server=The Nameless">The Nameless</a><br>
			
			<a href="server.jsp?server=The Rathe">The Rathe</a><br>
			
			<a href="server.jsp?server=The Seventh Hammer">The Seventh Hammer</a><br>
			
			<a href="server.jsp?server=The Tribunal">The Tribunal</a><br>
			
			<a href="server.jsp?server=Tholuxe Paells">Tholuxe Paells</a><br>
			
			<a href="server.jsp?server=Torvonnilous">Torvonnilous</a><br>
			
			<a href="server.jsp?server=Tunare">Tunare</a><br>
			
			<a href="server.jsp?server=Vallon Zek">Vallon Zek</a><br>
			
			<a href="server.jsp?server=Vazaelle">Vazaelle</a><br>
			
			<a href="server.jsp?server=Veeshan">Veeshan</a><br>
			
			<a href="server.jsp?server=Xegony">Xegony</a><br>
			
			<a href="server.jsp?server=Xev">Xev</a><br>
			
			<a href="server.jsp?server=Zebuxoruk">Zebuxoruk</a><br>
