	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/en/intro_view.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/en/intro_view.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Guild&nbsp;Request&nbsp;System</font></b></div>
                        <!-- #EndEditable --></td>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <table width="160" border="0" cellspacing="0" cellpadding="5">
                          <tr> 
                            <td><div align="center"><img src="../../images/flags/flag_us_current.gif" width="44" height="27"></div></td>
                            <td><div align="center"><a href="../fr/intro_view.jsp" onMouseOver="MM_swapImage('Image1','','../../images/flags/flag_fr_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="../../images/flags/flag_fr_off.gif" name="Image1" width="44" height="27" border="0" id="Image1"></a></div></td>
                        ...
                        <p>Welcome to the EverQuest Guild Application System.<br>
                          <br>
                          From this page, you can enter guild creation requests, 
                          view any existing requests you previously entered or 
                          cancel any pending guild requests.<br>
                          <br>
                          Click <a href="/guild_requests/index.jsp?page=CREATE_REQUEST">here</a> 
                          to submit a guild creation request.<br>
                          <br>
                          Click <a href="/guild_requests/index.jsp?page=VIEW_REQUESTS">here</a> 
                          to view your existing guild requests.<br>
                          <br>
