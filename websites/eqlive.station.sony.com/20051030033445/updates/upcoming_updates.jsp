...
<P>The
  next scheduled update is planned for October
   27, 2005.
  Here are some of the things that are currently planned:</P>  <UL>   <LI>New Default UI Skin </LI>   <LI>Modifications to DoD
       Missions &amp; Loot</LI>   <LI>EverQuest will now use
       the Operating System's mouse so players can easily go between
       applications while in windowed mode</LI>   <LI>Take a look at
       Kithicor for some holiday fun </LI>   <LI>Players will have the
       ability to make their helms invisible </LI>   <LI>Improved controls in
       the guild bank </LI>   <LI>New command for opening a web browser from the game
       command prompt</LI>   <LI>New Audio Triggers
       command </LI>   <LI>Fix for the Pet HP for
       items </LI>   <LI>Fix for the loss of
       mana/HP while zoning</LI>  </UL>  <P>Please
  join us on the Test server to see some of the changes.</P>  <P><EM>This update is being pushed
  back to </EM><EM>10/27 in order
  to ensure adequate testing time. We apologize for any inconvenience this may
  cause</EM><EM></EM></P>
