...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_error_codes.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_error_codes.jsp');">
...
<P>Station Name:</P>
<P>If you have forgotten your Station name, please visit our Station Name Recovery Page at "http://www.station.sony.com/services/forgottop.jhtml?forgot=station". You will be asked to fill out a form and your Station Name will be displayed. You will need the following information when you fill out the form:</P>
<P>Your E-mail Address (The one you provided during registration)<BR>Your ZIP/Postal Code<BR>Your Birthdate (mm/dd/yy)</P>
<P>Password:</P>
<P>If you have forgotten your password, please visit our Password Reset Page at "http://www.station.sony.com/services/forgottop.jhtml?forgot=password". You will be asked to fill out a form and a new randomly generated password will be e-mailed to you, using the e-mail address you provided during registration. You will need the following information when you fill out the form:</P>
<P>Your Station Name<BR>Your ZIP/Postal Code<BR>Your Birthdate (mm/dd/yy)</P>
<P>After you receive your new password, we strongly suggest that you visit "http://www.station.sony.com/services/accountinfo.dyn" (you will have to sign in) and change it to a unique password that only you will know. We also suggest that after you have changed your password, you write down your Station Name and Password for future reference.</P>
