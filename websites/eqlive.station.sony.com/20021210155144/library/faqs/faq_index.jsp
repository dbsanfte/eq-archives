...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_index.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_index.jsp');">
...
<P><A href="http://eqlive.station.sony.com/rates/rate_faq.jsp">EverQuest Price Increase FAQ&nbsp;</A><BR>On April 25, 2002, the subcription rate for EverQuest increased to $12.95 per month. Check out this FAQ for all the details.</P>
...
<P><A href="/library/faqs/faq_naming.jsp">Naming FAQ</A><BR>A guideline on creating proper character names for EverQuest.<BR></P>
...
<P><A href="/library/faqs/faq_guide.jsp">GM/Guide FAQ</A><BR>All about our Game Masters and Guides.<BR></P>
<P><A href="/library/faqs/faq_eqlive.jsp">EverQuest FAQ</A><BR>The basics about EverQuest.<BR></P>
<P><A href="/library/faqs/faq_kunark.jsp"><SPAN class=header>Ruins of Kunark FAQ</SPAN></A><BR>The basics about the&nbsp;first expansion pack, The Ruins of Kunark.<BR></P>
<P><A href="/library/faqs/faq_velious.jsp"><SPAN class=header>Scars of Velious FAQ</SPAN></A><BR>The basics about the second expansion pack, The Scars of Velious.<BR></P>
<P><A href="/library/faqs/faq_luclin.jsp"><SPAN class=header>Shadows of Luclin FAQ</SPAN></A><BR>The basics about the third expansion pack, The Shadows of Luclin.<BR></P><SPAN class=header></SPAN>
<P><SPAN class=header><A href="/library/faqs/faq_pop.jsp">Planes of Power FAQ</A><BR></SPAN><SPAN class=header>The basics about the upcoming fouth expansion pack, The Planes of Power.</P></SPAN>
