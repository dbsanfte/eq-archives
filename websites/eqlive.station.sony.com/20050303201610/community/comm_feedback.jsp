                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
							...
							<P>Posting or sending a message on this form is subject to the <A HREF="../../../../../support/customer_service/cs_rules_of_conduct.jsp">EverQuest
  Rules of Conduct</A> and <A HREF="http://www2.station.sony.com/en/termsofservice.jsp">The Station Terms
  of Service</A>. You acknowledge that any comments or messages submitted to
  Sony Online Entertainment and/or Verant Interactive are public and not
  private communications and may be accessible by the general public.</P>  <P>Before you send us your comment, please read over the following
  paragraphs.</P>  <P>Examples of Community News include:</P>  <P>Fan Site updates<BR>In-game events<BR>Server news<BR>Guild announcements</P>
