                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P>Discord is a hardcore, limited life Player vs. Player server.&nbsp; ANY character
  slain for ANY reason will be recreated as a newbie.&nbsp; Characters will not
  be restored or resurrected for any reason, including deaths caused by server,
  Internet, or service provider outages.&nbsp; Once you're dead, you're dead.</P>  <P>There will be no in-game GM support on Discord.&nbsp; Keep in mind that
  this is indeed a hardcore server.</P>  <P>- Rules of Play on Discord:</P>  <P>* Any character that is slain for any reason whatsoever will be reset and
  placed back into newbie status.&nbsp; Characters and killer points (see
  contest rules below) will not be restored or resurrected for ANY reason
  whatsoever.&nbsp; Once you're dead, you're dead.</P>  <P>* Each account will only be allowed one character on this server.</P>  <P>* You may loot all tradeable items from the corpse of the character you
  have just killed.</P>  <P>* All player character corpses will decay in 30 minutes.</P>  <P>* The server will make use of the Firiona Vie no drop limitations (or lack
  thereof).</P>  <P>* The server will have the old world (Antonica, Faydwer, Odus) plus the Legacy
  of Ykesha extension and will only allow characters to reach level 50 with no
  AAs.</P>  <P>* The server will use an increased experience modifier to facilitate
  faster paced game play.</P>  <P>* Players will not be able to turn on /anonymous or /roleplay to hide their
  current location.</P>  <P>* Players may not transfer to or from this server with the exception of
  the 6 contest winners.</P>  <P>* The server will exist for a finite time (until Monday, January 12th,
  2004).</P>  <P>- Contest Rules and Rewards</P>  <P>When this cycle of Discord ends, we will be declaring 6 winners. Here are
  the rules and rewards for the contest:</P>  <P>* Any PvP death results in the killing player obtaining a number of points
  based on the levels of the characters involved.</P>  <P>* Higher level targets will earn more points.</P>  <P>* Players can only gain points from characters who are within 20 levels of
  them.</P>  <P>* Death will cause half of your killer points to be deducted from your
  total.</P>  <P>* The server will be up until Monday, January 12th, 2004. At that time the
  winners will be determined based on the number of PvP points they have
  collected.</P>  <P>* In order to be a winner, characters must be over 5th level.</P>  <P>* Characters with names that do not meet the EverQuest naming requirements
  can not win.</P>  <P>* The 6 characters meeting these requirements with the most killer points
  at the end of the cycle will be declared the winners for this cycle.&nbsp; We
  will announce the winners within 30 days after the cycle closes.</P>  <P>* Winners will be allowed to transfer their characters and all their gear
  off of Discord to a server of their choosing.</P>  <P>* Each winning character will have an item approptiate for their class
  named after their character in the upcoming expansion, the Gates of Discord.</P>  <P>* Each winning character will receive the item named after them shortly
  after Gates of Discord launches.</P>  <P>* Each winning character will be awarded a title.</P>  <P>Please be certain that you understand all of the rules and restrictions
  listed above before playing on Discord.</P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
