                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><STRONG>Tallon Zek Rules:</STRONG></P>  <P>Welcome to Tallon Zek,&nbsp;a PvP Teams servers.</P>  <P>Tallon Zek, like&nbsp;Vallon Zek and&nbsp;Sullon Zek, are PvP teams
  servers. In general the servers are based on the concept of a PvP teams
  server, like Sullon Zek, but with the teams chosen based on which race you
  choose at creation rather than your deity.</P>  <P>This document includes the PvP rules for Tallon and Vallon Zek.</P>  <OL>   <LI>Player v. Player
       ...
       hometown. Thurgadin is not a dwarven hometown.</LI>   <LI>On Tallon and Vallon
