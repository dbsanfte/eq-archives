	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_loy.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_loy.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P><STRONG>1) How much does this extension cost?</STRONG></P>
<P>The cost is $23.99 (price subject to change). This is a one-time charge and does not affect your subscription plan. </P>
<P><STRONG>2) How do I pay for this extension?</STRONG></P>
<P>You can order The Legacy of Ykesha from our <A href="https://store.station.sony.com/digital/view_details.jsp?SKU=EQLOY-DD-SW0303-LOYREL-EASDD">online store</A>, download it, and start playing immediately. You can also order the extension from the EverQuest server selection screen, and we will bill the charge directly to the credit card on account for your EverQuest subscription.</P>
<P><STRONG>3) How does this download-only thing work?</STRONG></P>
<P>SOE has made this extension available as a product download -- those who order Legacy of Ykesha will need to download the necessary files from our servers. These files are available for download during the EverQuest login procedure. (We're guessing it's about 120 megabytes.)</P>
...
<P>The CD is currently not available at retail.</P>
