...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/bb/qa_submit.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/bb/qa_submit.jsp');">
...
<TABLE cellSpacing=5 cellPadding=5 width="100%">
  ...
  <TR>
    <TD align=middle>
        <B><FONT SIZE="3" FACE="Verdana, Arial" COLOR="#4c1c22">Quality Assurance / Testing<BR>Comment Form</FONT></B>

        <P><BR>

<font color=#000000>You must be logged in with an account that has an active Everquest subscription.</font>