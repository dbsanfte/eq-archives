...
<P><STRONG>1) How much does this extension cost?</STRONG></P>  <P>The cost is $23.99 (price subject to change). This is a one-time charge
  and does not affect your subscription plan.</P>  <P><STRONG>2) How do I pay for this extension?</STRONG></P>  <P>You can order The Legacy of Ykesha from our <A HREF="https://store.station.sony.com/digital/view_details.jsp?SKU=EQLOY-DD-SW0303-LOYREL-EASDD">online
  store</A>, download it, and start playing immediately. You can also order the
  extension from the EverQuest server selection screen, and we will bill the
  charge directly to the credit card on account for your EverQuest subscription.</P>  <P><STRONG>3) How does this download-only thing work?</STRONG></P>  <P>SOE has made this extension available as a product download -- those who
  order Legacy of Ykesha will need to download the necessary files from our
  servers. These files are available for download during the EverQuest login
  procedure. (We're guessing it's about 120 megabytes.)</P>  <P><STRONG>4) I have a dialup connection; any hints on patching?</STRONG></P>  <P>If you do not have a broadband connection, your downloads will be slow.
  What you might do is try to manage the process so that you patch the new
  files while you work or sleep. To do that, in the patcher advanced options,
  keep The Legacy of Ykesha box unchecked (so that you aren't checking for and
  patching any available extension files before every play session) but, when
  you are done for the evening (or perhaps in the morning), open the patcher,
  check the Legacy of Ykesha box and then rerun the patcher. That way, you
  don't have to sit idly at your machine and watch it patch for hours.</P>  <P><STRONG>5) Can I buy The Legacy of Ykesha extension at retail?</STRONG></P>  <P>The CD is currently not available at retail.</P>
