...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_pop.jsp?null');">
...
//window.alert(document.cookie);
              ...
              <tr>
                <td align="center" background="">
                  <p><br>
                    <a href="http://sonyonline.com"><img src="../../images/soe_logo.gif" width="99" height="62" border="0"></a></p>
                  <p>&nbsp;</p>
                </td>
              </tr>
            </table>
...
<DIV align=center><BR><B>EVERQUEST:<SUP><FONT color=#cccccc>&reg;</FONT></SUP> THE PLANES OF POWER<FONT color=#cccccc>&#153;</FONT> </B></DIV>
<P class=link align=left><B><U>GENERAL INFORMATION</U></B><BR><B><BR>What is EverQuest?</B><BR>EverQuest is a real-time 3-D massively multiplayer online role-playing game (MMORPG) with fantasy elements featuring dragons, wizards, vast continents and dungeons full of treasure and mystery.</P>
<P class=link><B>What is EverQuest: The Planes of Power?</B><BR>EverQuest: The Planes of Power is the next installment in the best-selling EverQuest series. This expansion will focus mainly on providing content to the highest levels of the game, allowing players to become even more powerful. We plan to add twenty zones to the existing world in this expansion.</P>
<P class=link><B>When was the original EverQuest released?</B><BR>EverQuest was released March 16, 1999.</P>
<P class=link><B>What is an RPG?</B><BR>RPG stands for Role-Playing Game. When you play EverQuest, you'll first create a character. Immerse your character into our virtual world and make of it whatever you wish. You define your character's destiny in the lands of EverQuest. How well you play that role it is up to you. </P>
<P class=link><B>What is a "massively multiplayer online game"?</B><BR>While many modern computer games support multiplayer gaming, few are designed to support well over 1,000 simultaneous players. With EverQuest, you don't start the server program on a local network and invite a few of your friends over to play. Instead, you run the EverQuest client program and use the Internet to connect to our world servers. Call or email your friends and tell them what city or dungeon to meet you in or, better yet, log on and encounter hundreds of other people from all over the world and make a slew of new acquaintances. To date EverQuest has more than 98,000 simultaneous users during peak gaming hours.</P>
<P class=link><B>How many people play EverQuest?</B><BR>Currently, EverQuest has more than 420,000 monthly subscribers.</P>
<P class=link><B>What other EverQuest expansions have been released?</B><BR>EverQuest&reg;: The Ruins of Kunark&#153; expansion was released April 24, 2000. Since then it has become a part of the basic EverQuest package, giving players more than twenty new zones, a new playable race of lizard men called the Iksar and selling over 400,000 copies to date. The second expansion, EverQuest&reg;: The Scars of Velious&#153;, was released on December 5, 2000. It provides 19 more zones of content designed for level 30 characters and above and has sold more than 300,000 copies since its release. Selling over 120,000 copies it's first day at retail, the third expansion, EverQuest&reg;: The Shadows of Luclin&#153; takes players to the enchanting moonscape of Luclin--offering over 27 new adventure zones, all-new items, creatures and spells, a new playable character race and rideable horses. Supported by a complete graphic overhaul, the enhanced gameplay featured in Luclin allows players to witness their world in unprecedented splendor. </P>
<P></P>
<P class=link><B>Will I be able to download the game online?</B><BR>No, The Planes of Power will be available on CD-ROM only.</P>
<P class=link align=center>&nbsp;</P>
<P class=link><B><U>GAMEPLAY</U></B></P>
<P class=link><B>What features can we expect in the game?</B><BR>There are many new features planned for this expansion pack. Keep your eyes on the <A class=link href="http://eqlive.station.sony.com/">EverQuest Live</A> website and <A class=link href="http://www.planesofpower.com/">The Planes of Power</A> website for more information.</P>
<P class=link><B>Are there more battle animations?</B><BR>Player animations will not be added in this expansion. There will be at least 50 new NPCs with unique animations.</P>
<P class=link><B>How many new playable zones are you planning to add?</B><BR>Twenty</P>
<P class=link><B>How will I get to the Planes?</B><BR>The planes will be accessed through numerous portals throughout the existing world.</P>
<P class=link><B>Like EverQuest: The Scars of Velious, will I need a level 35 character or above to play the game?</B><BR>The Plane of Knowledge will be available to players of all levels and will be a source of many new quests, making travel throughout Norrath far more convenient. All other new planar zones will require players to be level 46 or above to enter. </P>
<P class=link><B>How will this expansion engage a level 60 players who has played EQ for the last 3 years yet appeal to the "newbie"?</B><BR>Veteran players will enjoy new content that will provide months of exciting gameplay. Players of all levels will benefit from the Plane of Knowledge that hosts scores of new and challenging quests. There are plans to include several great features that will appeal to new players as well. </P>
<P class=link align=center>&nbsp;</P>
<P class=link><B><U>BETA TESTING</U></B></P>
<P class=link><B>Will there be a beta? How do I get in?</B><BR>There will most certainly be a beta test; the requirements for acceptance have yet to be established.</P>
<P class=link align=center>&nbsp;</P>
<P class=link><B><U>SYSTEM REQUIREMENTS</U></B></P>
<P><SPAN class=link><B>What are the system requirements to run the game?</B><BR>Sony Online Entertainment does not plan to change the system requirements for The Planes of Power.<BR></SPAN></P>
<P class=link>&nbsp;</P>
