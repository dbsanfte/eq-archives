...
<a href="dev_view.jsp?id=&start=5">Older</a>
		...
		<a href="dev_view.jsp?id=64027">Zek Moves</a><br>
	

	
		<a href="dev_view.jsp?id=64026">Server Merges</a><br>
	

	
		<a href="dev_view.jsp?id=64025">A Hefty Halfling Hodgepodge</a><br>
	

	
		<a href="dev_view.jsp?id=64024">Dragons Hodgepodge</a><br>
	

	
		<a href="dev_view.jsp?id=64022">Mission NPCs are taking a short break. (updated)</a><br>
...
<h1>Zek Moves</h1>
	<P>Once the servers come up from the update on Thursday, Zek
  players will be able to begin the process of selecting a new server to have
  all characters on their account moved to.&nbsp; </P>  <P>Those Zek players who have already executed the /movelog
  command will be moved to the server they chose, unless that server was
  Solusek Ro, Firiona Vie or Kane Bayle.&nbsp;
  Zek players who chose either of these servers will need to execute the
  command again, choosing a new server.&nbsp;
  There will be no moves allowed to Firiona Vie at this time.</P>  <P>If you have changed your mind as to which server you would
  like to move to, the /movelog UI (after Thursdays update) will have a
  disregard button.&nbsp; Using the
  disregard button will cancel any pending movelog requests and allow you to
  execute a new movelog request.</P>  <P>We will begin processing the movelog requests on Friday
  night (March 4<SUP>th</SUP>) and will continue nightly for a period of 30
  days.&nbsp; Any accounts that have
  executed the movelog request will need to make certain they have no corpses
  in the world.&nbsp; If you have a
  shared bank already in use on your destination server, you will need to empty
  either shared bank out as only one will be available after the movelog is
  complete.</P>
