...
<P>Within your EverQuest directory is a file called
  ...
  This is primarily for people with lower memory configurations. This option
  can also be toggled in the OPTIONS menu located in the first menu as you
  enter the game.</P>  <P><STRONG>MipMapping=TRUE/FALSE</STRONG>&nbsp;- Mip mapping causes the world
  ...
  3=1280x1024, 4=1600x1200)</STRONG>&nbsp;- This setting denotes what resolution
  you run in game (this does not account for the front end, such as the login
  and server selection screens). This option can also be toggled in the OPTIONS
  menu located in the first menu as you enter the game, as well as in game
  under the Display tab of your Options menu.</P>  <P><STRONG>TextureQuality=1,2,3 (1=High, 2=Medium, 3=Low)</STRONG>&nbsp;-
  ...
  (Normal=Default, Distance=Track by distance from closest to farthest, Consider=Track
  by consider from high to low, RDistance=Track in reverse distance from far to
  near, RConsider=Track in reverse consider from low to high)</STRONG>&nbsp;-
  This allows you to customize what you wish to see on your tracking window
  based on the options listed above. This can also be adjusted in game via
  /tracksort normal/distance/consider/rdistance/rconsider.</P>  <P><STRONG>TrackFilterType=0 (red/yellow/white/blue/lblue/green)</STRONG>&nbsp;-
