...
<tr>
	...
	<a href="future_plans.jsp?id=60131" class="tinylink">February and Beyond</a><br>
...
<h1>February and Beyond</h1>
<P><STRONG><FONT face=Arial size=2>Upcoming for January and February 2004</FONT></STRONG></P>
<P><STRONG><FONT face=Arial size=2>Gates of Discord is currently in Beta and scheduled for a 2/10 release date.</FONT></STRONG></P>
<P><STRONG><FONT face=Arial size=2>Melee Enhancement, part 2</FONT></STRONG></P>
<P><FONT face=Arial size=2>Melee classes are currently enjoying the first part of the improved Melee system and the feedback we are receiving has been great.&nbsp; Early in 2004 we plan to move forward with the rest of the melee enhancement, the reaction abilities.&nbsp; The enhancement gives Monks, Rogues and Warriors the ability to use special skills in response to a mistake made by their opponent or an exceptional move of their own.&nbsp; This enhancement will be in addition to the existing system, allowing players to use the skills for more involved game-play and to improve the abilities of their characters.</FONT></P>
<P><STRONG><FONT face=Arial size=2>Graveyard Zone</FONT></STRONG></P>
<P><FONT face=Arial size=2>Tired of losing your corpse?&nbsp; The current EQ system removes corpses from the game after a week to reduce clutter and potential video lag.&nbsp; But we know there are times when your character dies and you just can't get it right away.&nbsp; Next thing you know a day turns into a week and BAM!&nbsp; Your corpse is gone.&nbsp; Since we can't leave the corpses sitting in game indefinitely, some inventive folks here have come up with another option.</FONT></P>
<P><FONT face=Arial size=2>We plan to create a "graveyard" zone that will only work if your corpse has decayed and disappeared.&nbsp; If you have lost your corpse due to decay in other parts of Norrath, you will be allowed to enter this zone and reclaim it.</FONT></P>
<P><STRONG><FONT face=Arial size=2>These are just a few of the things slated to come out of the EQ Live laboratory.&nbsp; Watch for other exciting announcements in the weeks ahead. </FONT></STRONG></P>
