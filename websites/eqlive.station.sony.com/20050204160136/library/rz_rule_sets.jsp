                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><STRONG>Rallos Zek rules:</STRONG></P>  <P>Welcome to Rallos Zek, the&nbsp;first PvP server in EverQuest.</P>  <P>Rallos Zek, was the first PvP server in EverQuest. As such, many of the
  mechanics of the server are very specific. Unlike Tallon Zek, Vallon Zek, and
  Sullon Zek, there are no set teams. The only restrictions set on PvP are
  level restrictions.</P>  <P>This document includes the PvP rules for Rallos Zek.</P>  <OL>   <LI>Player v. Player
       (PvP) combat can occur between any characters that are within a 4 level
       limit. For instance, a level 45 person may attack or be attacked by
       anyone from level 41 through 49. There are no other PvP restrictions,
       such as Race or Alignment.</LI>   <LI>Characters will be
       ...
       although the occasional loss of experience is to be expected.</LI>   <LI>All combat skills
       ...
       your range. 'In range' means +/- 4 levels.</LI>   <LI>Faction hits for
       PvP will be taken for killing characters within their racial hometowns.
       ...
       have no starting city. Erudites have hometowns that match their starting
       cities. Other cities are not considered hometowns, despite being run and
       controlled by a certain race. For example, HighHold is not a human
       hometown. Thurgadin is not a dwarven hometown.</LI>   <LI>On Rallos Zek,
       PvP-related Play Nice Policy situations are expected to be resolved
       ...
       not permitted in the PvP environment.</LI>   <LI>While corpse
       camping is no longer illegal, corpse camping someone until the point
       where his or her corpse decays is considered harassment, and will be
       treated as such.</LI>   <LI>All rules regarding
       ...
       by a player character, your corpse will disappear when it is looted.</LI>   <LI>The Hide skill and all
       'invisibility' spells will cause player characters to lose targeting on
       the character that has hidden or gone invisible.&nbsp;</LI>  </OL>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
