...
<title>EverQuestLive.com - Game Updates</title>
<!-- #EndEditable -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Game&nbsp;Updates</font></b></div>
                        <!-- #EndEditable --></td>
...
<P>In order to help keep our customers informed about the updates we have planned, we are opening a new feature here on the EverQuest Live site.</P>
<P>The idea here is a simple one.&nbsp; We'll be posting highlights from the most recent changes to the game along with featured items planned for our next update.</P>
<P><A href="http://eqlive.station.sony.com/updates/recent_updates.jsp">Recent Updates</A><BR>Information about the most current updates.</P>
<P><A href="http://eqlive.station.sony.com/updates/upcoming_updates.jsp">Upcoming Updates<BR></A>This section gives you a heads-up on what we'll be doing next.</P>
<P><A href="http://eqlive.station.sony.com/updates/future_plans.jsp">Future Plans<BR></A>A sneak peak at our long term goals.</P>
