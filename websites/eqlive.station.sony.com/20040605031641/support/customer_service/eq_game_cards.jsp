	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/eq_game_cards.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/eq_game_cards.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/eq_game_cards.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<DIV align=center><STRONG><BR>Game Card Information</STRONG> </DIV>
<P align=left>This card is a 90-day pre-paid subscription and may only be used once. You can purchase the EverQuest Game Card at your local video game retailer.</P>
<P align=left>Or, try one of these online stores:</P>
<DIV align=left>
<UL><A target=_blank href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-SU-GC1001-EQGCRD">The Sony Station Store</A><BR><A target=_blank href="http://www.ebgames.com/ebx/categories/products/product.asp?pf_id=206855">EBWorld</A> </UL><BR>
<P>Now that you have your new EverQuest subscription<B> Game Card</B>, follow these instructions to start playing! </P>
<P><B>For players new to EverQuest:</B></P>
<OL>
<LI>Launch EverQuest by double-clicking the 'EverQuest' desktop icon. 
<LI>After accepting the User Agreement and viewing the initial splash screens, Click on the Account button. 
<LI>Click the New Account button. 
<LI>Enter your registration information in the form provided. 
<LI>On the billing screen, select "Use Game Card" as the method of payment. 
<LI>Scratch off the gray area on the front of your Game Card to reveal your Coupon Number. 
<LI>Enter your Coupon Number. 
<LI>Click Finish. 
<LI>Confirm that you want to activate this Game Card. Once a game card is activated, it cannot be cancelled. 
<LI>Connect and play! </LI></OL><B>
<P>For existing EverQuest players:</P></B>
<P>NOTE: Game Cards can only be used when your existing account subscription has expired.</P>
<OL>
<LI>Launch EverQuest. 
<LI>Click the Account button. 
<LI>Click the Cancel Account button. This does not delete your characters, but cancels the recurring subscription billing to your credit card. 
<LI>After you receive the confirmation message that the account has been cancelled, Click the Change Billing button. You can only continue once your existing subscription has expired. 
<LI>On the billing screen, select "Use Game Card" as the method of payment. 
<LI>Scratch off the gray area on the front of your Game Card to reveal your Coupon Number. 
<LI>Enter your Coupon Number. 
<LI>Click Finish. 
<LI>Confirm that you want to activate this Game Card. Once a game card is activated, it cannot be cancelled. 
<LI>Connect and play! </LI></OL>
<P>When your Game Card subscription expires, you will be alerted the next time you log into EverQuest.</P>
<P>&nbsp;</P></DIV>
