...
<title>EverQuestLive.com - Upcoming Updates</title>
<!-- #EndEditable -->
		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/upcoming_updates.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/upcoming_updates.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
...
//window.alert(document.cookie);
	...
	<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial>The updates listed below were implemented on May 14th, 2003.&nbsp; We will have more detail for you about our next update and our future plans&nbsp;on June 4th, 2003.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><U><FONT face=Arial></FONT></U>&nbsp;</P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><U><FONT face=Arial>Upcoming for May 14<SUP>th</SUP>, 2003<?xml:namespace prefix = o /><o:p></o:p></FONT></U></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt"><FONT face=Arial>Here are some of the items we plan to include in the update for May 14th, 2003.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><SPAN style="FONT-SIZE: 10pt; mso-bidi-font-family: Arial"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>1)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>More improvements for new players are in the works.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We're opening up the Legacy of Ykesha map system for newbie zones to all EverQuest players.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This should be very helpful to new players trying to learn their way around the cities of Norrath.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>Context tips will become available.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>These are helpful tips that pop up when a player performs certain actions to help our new players to more easily understand the gameplay and controls for EverQuest.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.25in; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>2)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>The new Plane of Hate will be available on all servers!</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>3)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>Veksar will be introduced on Stormhammer.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This ancient city was a hub of the Iksar Empire before it fell. There are plenty of interesting things for daring adventurers to discover there.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>4)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>We've fixed an issue with the Divine Intervention line that caused a character's hit points to get out of sync.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This should be a boon to all players that cast or receive that spell.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>5)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>We have increased the power of the Child of Bertoxxulous Necromancer pet.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We'll be increasing its offensive power as well as giving it a useful spell ability similar to Banshee Aura.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>6)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>We've remedied the<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>long-standing situation that caused characters to lose all their buffs if they zoned with fewer hit points remaining than the bonus hit points provided by their items.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.25in; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>7)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>We have increased the maximum amount of mana that can be gained through the use of <STRIKE>items</STRIKE> buff spells&nbsp;by an additional 50%.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This should provide a noticeable increase in the mana available to many spell casters.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>8)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>We have completed what we hope will be the final adjustments to the Rathe Council encounter.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>The encounter should be at just the right difficulty level now, and should provide an interesting challenge to those that undertake it.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>9)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </SPAN><FONT face=Arial>Travel in two zones should be a little easier now.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We will be removing the restriction on Call of the Hero that existed in the Plane of Water, as well as removing the restriction that forbid the casting of Gate spells in Veeshan's Peak.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>10)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp; </SPAN><FONT face=Arial>Due to player concerns (and to make the zone a bit more fun to play in), we will be removing the ability to summon player characters recently added to some NPCs in the Halls of Honor.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We have introduced another mechanism to address the challenge level in that zone.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>11)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp; </SPAN><FONT face=Arial>There will be a couple of improvements to Alternate Advancement abilities as well.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We will be giving Beastlords access to the Mass Group Buff ability.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This is an ability that many Beastlords feel would be very useful to them and make some of their buffing tasks a bit easier.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>We will also be reducing the reuse timer for the Magician Elemental Form ability from 72 minutes to 15 minutes.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This will allow a Magician to keep the Elemental Form up for as long as he wants.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt 0.5in; TEXT-INDENT: -0.25in; mso-layout-grid-align: none; mso-list: l7 level1 lfo2; tab-stops: list .5in"><FONT face=Arial>12)</FONT><SPAN style="FONT: 7pt 'Times New Roman'">&nbsp; </SPAN><FONT face=Arial>We have corrected a problem that was causing some people to be unable to log back into the game quickly if the were disconnected.<SPAN style="mso-spacerun: yes">&nbsp; </SPAN>This has been a complicated problem to correct, and we're glad to have found and fixed it.</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></P>
...
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><SPAN style="FONT-SIZE: 10pt; mso-bidi-font-family: Arial"><FONT face=Arial>&nbsp;<o:p></o:p></FONT></SPAN></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>Targetwindow.xml</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>Playerwindow.xml</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>Groupwindow.xml</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>EQUI.xml</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial></FONT>&nbsp;</P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none"><FONT face=Arial>- The EverQuest Team</FONT></P>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-layout-grid-align: none">&nbsp;</P>


                        <p> <span class="smalltitle">Archive:</span><br>

	<a href="?id=55839">Upcoming for May 14</a><br>
