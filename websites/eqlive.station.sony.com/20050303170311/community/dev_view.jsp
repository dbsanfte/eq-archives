...
<P>Once the servers come up from the update on Thursday, Zek
  ...
  Solusek Ro or Kane Bayle.&nbsp; Zek
  players who chose either of these servers will need to execute the command
  again, choosing a new server.&nbsp; </P>  <P>If you have changed your mind as to which server you would
  ...
  executed the movelog request will need to make certain they have no corpses in
  the world.&nbsp; If you have a shared
  bank already in use on your destination server, you will need to empty either
  shared bank out as only one will be available after the movelog is complete.</P>
