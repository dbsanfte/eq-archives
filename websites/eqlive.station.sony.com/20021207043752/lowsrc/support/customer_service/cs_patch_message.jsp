...
<h2>Patch, December 4, 2002</h2>
<P>December 4, 2002&nbsp; 3:00 am<BR>------------------------------</P>
<P>** Zones **</P>
<P>- Updated the sage quests in the Plane of Knowledge.<BR>- Addressed several bugs with the Rallos Zek encounter.<BR>- Vallon Zek's script should now work correctly.</P>
<P><BR>** Spells **</P>
<P>- Fixed a bug with lull and harmony type spells that could cause zone-wide agro.<BR>- Reduced the fizzle rate on Beastlord spells to match that of all other hybrid classes.<BR>- Fixed a bug that was allowing some charmed NPCs to break mez.<BR>- Blinding spells will now affect characters on horseback.<BR>- Spells that automatically target your pet will now work (on your regular pet) when you have a Servant of Ro.<BR>- You should be able to heal and buff your regular pet when using Host of Elements or Wake the Dead.<BR>- Eldritch rune should now absorb more damage<BR>- The last patch changes to Mental Corruption made it too powerful for a level 52 spell.&nbsp; The damage has been toned down, and the mana recourse has been changed to scale from level 52 to 60</P>
<P><BR>** Music Player **</P>
...
<P>If you are working to explore Planes of Power without progressing through the storyline, you may find that the alternate methods to enter some zones now goes a little bit faster.</P>
