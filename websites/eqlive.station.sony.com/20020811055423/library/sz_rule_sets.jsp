...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/sz_rule_sets.jsp?null');">
...
<P align=left><FONT face=Arial size=2>This is a PvE (Player vs. Environment) server, NOT a PvP (Player vs. Player) server. In other words, it's a standard "blue" server with the same rules and features regarding PvP as the vast majority of our servers. it is not one of teh "Zeks".</FONT></P>
<UL>
