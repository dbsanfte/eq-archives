...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/community/index.jsp?null');">
...
<DIV align=left>Community, an interacting population of various kinds of individuals. </DIV>
<P><A href="/community/dear_mennix.jsp">Dear Mennix </A><BR>He is the Advice Giver Extraordiare, the Handsome Halfling of Norrath. If Mennix can't solve your woes, then he'll just make something up. </P>
<P><A href="/community/fippy_facts.jsp">Fippy's Facts </A><BR>When taking a break from rushing the Qeynos guards, the irascable Gnoll is a closet statitician. Fippy's Facts provides information from the mundane to the extraordinary.</P>
<P><A href="/community/hammerfel.jsp">Hammerfel's Last Rites</A><BR>Hammerfel's Last Rites is your first stop for all the news about the EverQuestLive.com site, and the occassional tips and tricks of being a Cleric.</P>
<P><A href="/community/newsletter.jsp">Newsletter - Harpy's Head Herald<BR></A>The official EverQuest email newsletter, the Harpy's Head Herald recaps the latest happenings about EverQuest, and includes a surprise or two. </P>
<P><A href="/community/articles_archive.jsp">Articles</A>&nbsp;<BR>Written by the pros, our articles run the gamut of families enjoying EQ together, to tips for the players.&nbsp;</P>
