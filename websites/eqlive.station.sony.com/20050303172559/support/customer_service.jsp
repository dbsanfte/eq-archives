...
<P>Our Customer Service Department will provide answers to your EverQuest
  questions on a wide range of topics, from player conduct, our user agreement
  specifics, the latest game patches, compatible system requirements, to all
  glitches and problems with game play and navigation.</P>  <P><A HREF="../../../../../library/faqs/faq_cs_contact.jsp">Customer Support
  Contact FAQ</A><BR>An extra aid when contacting a Customer Support Representative.</P>  <P><A HREF="http://help.station.sony.com/cgi-bin/soe.cfg/php/enduser/std_alp.php">Knowledge
  Base</A><BR>Your first stop for all support.</P>  <P><A HREF="https://store.station.sony.com/eq_char_moves/">Character Transfer
  Service</A><BR>A fee-based service for moving your characters between servers or accounts.</P>  <P><A HREF="../../../../../support/customer_service/cs_guilds.jsp">Guild
  Information<BR></A>A quick guide to guild creation,&nbsp;joining and quitting a&nbsp;guild,
  guild commands, and guild wars.&nbsp;</P>  <P><A HREF="../../../../../support/new_petition_system.jsp">Customer Service
  Petition System<BR></A>An easy way to contact customer service.</P>  <P><A HREF="../../../../../support/customer_service/cs_security_main.jsp">Account
  Security</A><BR>Protecting yourself should always come first.</P>  <P><A HREF="../../../../../support/customer_service/cs_game_cards.jsp">Game
  Cards</A><BR>A different way to pay for your EverQuest subscription without using a credit
  card.</P>
