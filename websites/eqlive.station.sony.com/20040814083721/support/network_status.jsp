...
<p>&nbsp;</p>
	...
	<span class="status_headline">All English Based Worlds will be coming down for an
  Emergency Update.</span><br>
	<span class="status_date">8/13/2004  2:00 PM PDT (-7 UTC)</span><br>
	<P>On August 13<SUP>th</SUP>,
   2004 at 2:20 PDT (-7
  UTC) all English based Everquest worlds will be coming down for an emergency
  update. Expected downtime is 1 hour. We are sorry for the inconvenience and
  are working as fast as we can.</P>  <P>-The SOE Game Operations Team</P>
