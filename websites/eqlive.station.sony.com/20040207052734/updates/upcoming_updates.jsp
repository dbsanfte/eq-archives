...
<tr>
	...
	<a href="upcoming_updates.jsp?id=60377" class="tinylink">Next Scheduled Update</a><br>
...
<h1>Next Scheduled Update</h1>
<P><STRONG><FONT face=Arial size=2>Our next scheduled update is planned for February 10th.&nbsp; This coincides with the launch of EverQuest: Gates of Discord.&nbsp; </FONT></STRONG></P>
<P><STRONG><FONT face=Arial size=2>Along with the launch of Gates, these changes are currently on Test server and will most likely go live with the update.</FONT></STRONG></P>
<P><STRONG><FONT face=Arial size=2>Tradeskill Interface Upgrade</FONT></STRONG></P>
<P><FONT face=Arial size=2>Opening a tradeskill container will now open a new user interface.&nbsp; In the window you will find an area that has all recipes that are currently available to you.&nbsp; This includes recipes that are at your skill level as well as some above it.&nbsp; Clicking on a recipe will display what items are necessary for its completion.&nbsp; Clicking the "combine" button will extract those required items from the player's inventory, and perform the recipe combine, placing the results on the player's cursor.&nbsp; The new system is nice and neat, with no dragging and dropping unless you want to try a combine that is way out of your league, which uses the old style of combination</FONT></P>
<P><FONT face=Arial size=2>The name of the Berserker armor will be changed to Bladesman.</FONT></P>
<P><FONT face=Arial size=2>The beastlord epic weapon will no longer "proc" for wielders below the 46th level.</FONT></P>
<P><STRONG><FONT face=Arial size=2>Let us know what you think by using the submit </FONT></STRONG><A href="http://eqlive.station.sony.com/community/dev_feedback.jsp"><U><FONT face=Arial color=#800080 size=2><STRONG>comment link</STRONG></FONT></U></A><STRONG><FONT face=Arial size=2>.</FONT></STRONG></P>
