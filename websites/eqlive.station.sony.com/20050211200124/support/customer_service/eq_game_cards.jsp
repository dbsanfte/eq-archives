...
<P ALIGN="center"><STRONG><BR><STRONG>Game Card Information</STRONG></STRONG></P>  <P>This card is a 90-day pre-paid subscription and may only be used once. You
  can purchase the EverQuest Game Card at your local video game retailer.</P>  <P>Or, try one of these online stores:</P>    <P><A TARGET="_blank" HREF="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-SU-GC1001-EQGCRD">The Sony Station Store</A><BR><A TARGET="_blank" HREF="http://www.ebgames.com/ebx/categories/products/product.asp?pf_id=206855">EBWorld</A></P>    <P>&nbsp;</P>  <P>Now that you have your new EverQuest subscription <STRONG>Game Card</STRONG>,
  follow these instructions to start playing!</P>  <P><STRONG>For players new to EverQuest:</STRONG></P>  <OL>   <LI>Launch EverQuest by
       double-clicking the 'EverQuest' desktop icon.</LI>   <LI>After accepting the
       User Agreement and viewing the initial splash screens, Click on the
       Account button.</LI>   <LI>Click the New
       Account button.</LI>   <LI>Enter your
       registration information in the form provided.</LI>   <LI>On the billing
       screen, select &quot;Use Game Card&quot; as the method of payment.</LI>   <LI>Scratch off the
       gray area on the front of your Game Card to reveal your Coupon Number.</LI>   <LI>Enter your Coupon
       Number.</LI>   <LI>Click Finish.</LI>   <LI>Confirm that you
       want to activate this Game Card. Once a game card is activated, it
       cannot be cancelled.</LI>   <LI>Connect and play!</LI>  </OL>  <P><STRONG>For existing EverQuest players:</STRONG></P>  <P>NOTE: Game Cards can only be used when your existing account subscription
  has expired.</P>  <OL>   <LI>Launch EverQuest.</LI>   <LI>Click the Account
       button.</LI>   <LI>Click the Cancel
       Account button. This does not delete your characters, but cancels the
       recurring subscription billing to your credit card.</LI>   <LI>After you receive
       the confirmation message that the account has been cancelled, Click the
       Change Billing button. You can only continue once your existing
       subscription has expired.</LI>   <LI>On the billing
       screen, select &quot;Use Game Card&quot; as the method of payment.</LI>   <LI>Scratch off the gray
       area on the front of your Game Card to reveal your Coupon Number.</LI>   <LI>Enter your Coupon
       Number.</LI>   <LI>Click Finish.</LI>   <LI>Confirm that you
       want to activate this Game Card. Once a game card is activated, it
       cannot be cancelled.</LI>   <LI>Connect and play!</LI>  </OL>  <P>When your Game Card subscription expires, you will be alerted the next
  time you log into EverQuest.</P>  <P>&nbsp;</P>
