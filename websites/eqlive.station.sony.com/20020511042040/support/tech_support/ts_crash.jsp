...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_crash.jsp?null');">
...
<P>If you have Windows 95 you can enter safe mode by hitting F8 when you see the message "Starting Windows95..." after rebooting your computer. With Windows 98, just hold down the left control (ctrl) key after rebooting your computer and you should shortly see a menu appear. The third (3) selection is for Safe Mode. </P>
