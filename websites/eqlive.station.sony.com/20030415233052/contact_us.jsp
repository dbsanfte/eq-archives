...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/contact_us.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/contact_us.jsp');">
...
<P align=justify><A href="mailto:dearmennix@soe.sony.com">dearmennix@soe.sony.com</A> <BR>Dear Mennix is a weekly in-character advice column found on the Harpy's Head Tavern pages. Letters sent to this address should be written in the voice of an in-game player character. Mennix will then choose which letters he wants to respond to for the week.</P>
<P align=justify>&nbsp;</P>
<P class=subHeader align=justify>Fan Faire Contacts</P>
