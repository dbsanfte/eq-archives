<!-- #BeginTemplate "/Templates/sub_template_stretchy.dwt" --><!-- DW6 -->
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/moves/move_french.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/moves/move_french.jsp');">
...
<table>
	<tr>
		<td><img src="spacer.gif" height="67" width="19"></td>
	</tr>
</table>
-->
<!-- end global nav -->
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        ...
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2"><nobr>Transferts gratuits de personnages avec objets 
                        et argent pour les serveurs europ&eacute;ens !
</font></b></div>
                        <!-- #EndEditable --></td>
...
<P>Afin de cilibrer le lancement ricent des trois nouveaux serveurs europiens&nbsp;(Venril Sathir en Angleterre, Sebilis en France et Kael Drakkal en Allemagne) et d'aider au diveloppement des communautis pour ces serveurs, Sony Online Entertainment et Ubi Soft ont dicidi d'offrir un transfert gratuit de personnages avec iquipement !</P>
<P>Pendant un laps de temps donni, nous effectuerons des transferts de personnages gratuits avec matiriel et argent pour les 1000 premiers joueurs qui souhaiteront venir sur les serveurs Kael Drakkal, Venril Sathir et Sebilis.</P>
<P>Les inscriptions sont aujourd'hui ouvertes et resteront accessibles jusqu'au 21 janvier 2003. Pour profiter de cette offre exclusive, nous vous invitons ` visiter les pages du transfert europien de personnages :</P>
<P>- <A href="https://store.station.sony.com/eq_local_cmoves/english">en anglais</A><BR>- <A href="https://store.station.sony.com/eq_local_cmoves/french">en frangais</A> <BR>- <A href="https://store.station.sony.com/eq_local_cmoves/german">en allemand </A></P>
<P>Attention, les rhgles suivantes s'appliquent au transfert :</P>
<UL>
<LI>Le transfert de personnages ne s'applique que vers les serveurs europiens suivants : Kael Drakkal, Venril Sathir and Sebilis. 
<LI>Tous les personnages du serveur que vous avez silectionni seront diplacis vers Kael Drakkal, Venril Sathir ou Sebilis (au choix). 
<LI>Les personnages transfiris garderont leurs objets et leur argent 
<LI>Les transferts de personnages depuis le serveur Legends ne sont pas autorisis 
<LI>Ce service n'est accessible qu'aux joueurs payant effectivement leur abonnement. Les joueurs en piriode gratuite ne peuvent pas en profiter 
<LI>Tous les transferts sont sujets aux rhgles posties ` cette adresse : <A class=link href="https://store.station.sony.com/eq_local_cmoves/french">https://store.station.sony.com/eq_local_cmoves/french</A></LI></UL>
<P>Les transferts seront gratuits pour les 1000 premiers joueurs qui s'enregistreront pour chacun des serveurs citis ci-dessus. Aprhs cette offre, les transferts se feront au prix standard du service transfert de personnage qui se trouve ici <A href="https://store.station.sony.com/eq_char_moves/french">https://store.station.sony.com/eq_char_moves/french</A><BR></P><BR>
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
