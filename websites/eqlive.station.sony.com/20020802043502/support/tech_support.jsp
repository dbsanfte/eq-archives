...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
                        <center>
                          <b>Technical Support News </b> 
                        </center><br>
                        
                         
                        
                        <p> <a href="news.jsp?id=44984" class="smalltitle">Scheduled Patch, June 12th</a> 
                        </p>
                        
                         
                        
                        <p> <a href="news.jsp?id=44048" class="smalltitle">Scheduled Patch June 5th</a> 
                        </p>
                        
                         
                        
                        <p> <a href="news.jsp?id=41035" class="smalltitle">Scheduled Maintenance for the Week of April 29th</a> 
                        </p>
                        
                         
                        
                        <p> <a href="news.jsp?id=41040" class="smalltitle">Knowledge Base, for Quick and Easy Answers</a> 
                        </p>
                        
                         
                        <table border="0" width="100%">
                          <tr> 
                            <td align="right"><a href="newsarchive.jsp" class="smalllink">Support 
                              Archives &gt;&gt;</a></td>
                          </tr>
                        </table>
                        <p align="center"><img src="/images/hr.gif"></p>
                         
                        <DIV align=center><STRONG><BR>EverQuest Technical Support</STRONG> </DIV>
<P>Welcome to the realm of Technical Support. The following links will take you to helpful information and resources to allow you a more fun gaming experience.</P>
<P><B>General Troubleshooting</B><BR><A href="http://help.station.sony.com/esupport/esupport/consumer/esupport.asp">Search the Knowledge Base</A><BR><A href="/support/tech_support/ts_crash.jsp">General Tips for Crashing or Freezing During Gameplay</A><BR><A href="/support/tech_support/ts_mouse.jsp">Mouse troubles</A><BR><A href="mailto:eqtech@soe.sony.com">Can't get it resolved? Email us.</A><BR><A href="/support/tech_support/ts_error_codes.jsp">Common EverQuest Error Codes</A><BR><A style="COLOR: #ff0000" onclick="window.open('http://www2.station.sony.com/en/instantchat.jsp', 'custclient', 'width=600,height=310'); return false;" href="">Chat Live With Customer Support</A> - Speak to somebody live from 9:00am - 9:00pm PST <BR></P>
<P><B>Connection Issues</B><BR><A href="/support/tech_support/ts_network_support_security.jsp">Security alert/hack attempt</A><BR><A href="/support/tech_support/ts_network_support_firewall_proxy_info.jsp">Firewall/Proxy info</A><BR><A href="/support/tech_support/ts_network_support_dialup_connection.jsp">Dial-up connection troubleshooting</A><BR><A href="/support/tech_support/ts_network_support_broadband_connection.jsp">Broadband troubleshooting</A><BR><A href="/support/tech_support/ts_network_support_bandwith.jsp">EverQuest bandwidth usage info</A><BR><A href="/support/tech_support/ts_status_protocol.jsp">EverQuest Status Server Protocol</A><BR></P>
<P><B>Audio Troubleshooting</B><BR><A href="/support/tech_support/ts_audio_trouble.jsp">General audio troubleshooting</A><BR><A href="/support/tech_support/ts_audio.jsp">Supported sound cards</A><BR><A href="/support/tech_support/ts_install_av_drivers_xp.jsp">Installing sound/video drivers Win XP/2000</A><BR></P>
<P><B>Video Troubleshooting</B><BR><A href="/support/tech_support/ts_video_trouble.jsp">General video troubleshooting</A><BR><A href="/support/tech_support/ts_video.jsp">Supported video cards</A><BR><A href="/support/tech_support/ts_install_directx.jsp">Installing DirectX 8.1 (required for Luclin)</A><BR><A href="/support/tech_support/ts_install_av_drivers_xp.jsp">Installing video/sound drivers for Win XP/2000</A><BR></P>
<P><B>Game Optimization</B><BR><A href="/support/tech_support/ts_options.jsp">Options (How to change the game interface)</A><BR><A href="/support/tech_support/ts_optimization.jsp">EverQuest: Shadows of Luclin Optimization</A><BR><A href="/support/tech_support/ts_default_settings.jsp">EQClient.ini settings</A> - Changing Default Visual Settings in Game<BR><A href="/support/tech_support/ts_keyboard.jsp">Keyboard layout</A><BR></P>
<P><B>General Support</B><BR><A href="/support/tech_support/ts_system_requirements.jsp">System Requirements</A><BR><A href="/support/tech_support/ts_installing_the_game.jsp">Installing the Game</A><BR><A href="/support/tech_support/ts_troubleshooting.jsp">Installation Troubleshooting</A><BR><A href="/support/tech_support/ts_stuck_character.jsp">Troubleshooting Stuck Characters</A><BR><A href="/support/tech_support/ts_new_patcher.jsp">EverQuest Patcher Help</A><BR><A href="/support/tech_support/ts_tested.jsp">Tested Systems</A><BR><A href="https://store.station.sony.com/eq_char_moves/">Character Transfers</A><BR></P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
