...
<tr>
	...
	<a href="recent_updates.jsp?id=64134" class="tinylink">December
   8th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64130" class="tinylink">December
   7th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64133" class="tinylink">November
   16th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64132" class="tinylink">October 27th, 2005</a><br>
...
<h1>December
   8th, 2005</h1>
<P><STRONG>***
  Events &amp; Missions ***</STRONG></P>  <P>- The holiday event will now allow
  a full group to partake instead of just 1 person.</P>  <P>- The Lower
   Guk and Freeport  monster missions will now properly drop Shards of Wisdom.</P>  <P>- /dzadd has been fixed and should
  work properly again.</P>  <P><STRONG>***
  Items ***</STRONG></P>  <P>- Some of Archaeologist
  Flottwit&#8217;s items were missing augmentation slots and spell
  effects.&nbsp; In addition, some of the
  items now have a lower required or recommended level.</P>  <P>- A small sample of bags that were
  incorrectly giving an error message that you were not the right class to use
  it as a tradeskill container have been fixed.</P>  <P>- Dreadspire invitations are now
  properly persistent.</P>  <P><STRONG>***
  NPCS ***</STRONG></P>  <P>- Commander Cogswain has returned
  to Lavastorm.</P>  <P><STRONG>-
  The EverQuest Team</STRONG></P>
