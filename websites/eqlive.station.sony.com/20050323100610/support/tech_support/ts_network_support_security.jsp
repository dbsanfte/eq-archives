...
<P ALIGN="center"><STRONG><BR><STRONG>Security Alert/Hack Attempt</STRONG></STRONG></P>  <P>The EverQuest servers and their networks are access-controlled, secured,
  ...
  congestion, route flapping, backbone circuit outage), the EQ clients and servers
  will retransmit packets at an increasing packet rate for up to 30 seconds. At
  the 10th or 20th second, this rate can be quite high and appear to be a flood
  or storm of traffic.</P>  <P>Most personal firewall software (e.g. ZoneAlarm, BlackIce, Norton Personal
  ...
  false alarms are:</P>  <UL>   <LI>&quot;Default Block Bla
       ...
       start one of our games that uses a patcher, your client PC will make a
       connection to one of our many patchers at port 7000, and our patchers
       will send updates back to you from port 7000. In order to optimize the patching
