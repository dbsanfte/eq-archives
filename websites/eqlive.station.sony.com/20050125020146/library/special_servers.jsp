...
<P><A HREF="../../../../../library/fv_rule_sets.jsp">Firiona Vie</A><BR>Firiona Vie is a roleplaying preferred server.</P>  <P><A HREF="../../../../../library/rz_rule_sets.jsp">Rallos Zek</A><BR>The first +PvP server to launch. No team, everyone&nbsp;is on their own.</P>  <P><A HREF="../../../../../library/tz_rule_sets.jsp">Tallon Zek</A><BR>Team based server based on race selection.<BR><BR><A HREF="../../../../../library/vz_rule_sets.jsp">Vallon Zek</A><BR>Team based server based on race selection.</P>  <P><A HREF="../../../../../library/sz_rule_sets.jsp">Sullon Zek</A><BR>Team based server based on Deity selection.</P>
