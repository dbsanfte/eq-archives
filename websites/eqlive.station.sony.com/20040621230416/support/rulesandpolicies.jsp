	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/rulesandpolicies.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/rulesandpolicies.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/rulesandpolicies.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Rules&nbsp;&amp;&nbsp;Policies</font></b></div>
                        <!-- #EndEditable --></td>
...
<BR>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_EULA.jsp">License Agreement</A><BR>Standard agreement agreed to by players each time they log into EverQuest.</P>
<P><A onclick="return openToS('http://sonyonline.com/tos/tos.jsp');" href="http://sonyonline.com/tos/tos.jsp" target=_tosWin>SOE Terms of Service</A><BR>Sony Online Entertainments Terms of Service which govern use of SOE branded games, Websites, and other properties.</P>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_rules_of_conduct.jsp">Rules of Conduct</A><BR>These rules have been establish to maintain consistent and fun entertainment for EverQuest.</P>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_naming_policy.jsp">Naming Policy</A><BR>This policy establishes what types of character names&nbsp; will be allowed to be used while playing EverQuest.</P>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_reimbursement.jsp">Item Reimbursement Policy</A><BR>Policy to establish how in-game items will be returned in case of loss.</P>
<P><A onclick="return openToS('http://sonyonline.com/tos/tos.jsp#privacy');" href="http://sonyonline.com/tos/tos.jsp#privacy" target=_tosWin>SOE Privacy Policy</A><BR>This privacy statement is applicable to The Station, SOE content contained therein, and all services and forums provided thereon.</P>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_security_notices.jsp">COPPA and Privacy Notice</A><BR>How we use your information and guarding those 13 years of age and younger.&nbsp;&nbsp;</P>
<SCRIPT language=JavaScript>
var ToSwinhandle=null;
function openToS(tosURL)
{	
