...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">52,528 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/multimedia/concept_art.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/multimedia/concept_art.jsp');">
...
<P><BR>Here you will find an early collection of sketches that show some early game ideas in development. Some of these will make great wallpaper for your desktop!</P>
...
<TD align=middle><A href="http://eqlive.station.sony.com/images/concept_art/woodelf.jpg" target=_blank><IMG height=200 src="http://eqlive.station.sony.com/images/concept_art/woodelf_lo.jpg" width=142 border=0></A></TD></TR></TBODY></TABLE>
<p>This is a collection of early sketches renowned fantasy artist Keith Parkinson did for the first EverQuest box and poster. It's interesting to see how elements changed either by flipping them left to right, or by simply moving them to try to achieve a desired effect.</p>
<br>
<TABLE cellSpacing=5 cellPadding=5 width="80%" border=0>
<TBODY>
<TR>
...
<TD align=middle width="50%"><A href="http://eqlive.station.sony.com/images/concept_art/FIGURES-.jpg" target=_blank><IMG height=200 src="http://eqlive.station.sony.com/images/concept_art/FIGURES-_sml.jpg" width=200 border=0></A></TD></TR></TBODY></TABLE><BR>
