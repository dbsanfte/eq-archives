...
<tr>
	...
	<a href="recent_updates.jsp?id=60570" class="tinylink">January 30, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=60470" class="tinylink">January 22, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=60264" class="tinylink">January 7, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=60004" class="tinylink">December 18, 2003</a><br>
...
<h1>January 30, 2004</h1>
<P>Tonight we have a small update to fix some general bugs.&nbsp; We are again changing charm (in exactly the way we thought we had last week)&nbsp; No this is not deja vu.&nbsp; You should also look for changes in that evolving zone of Nedaria's Landing.&nbsp; I wonder what is going on there?</P>
<P><BR>- An update to the zone, Nedaria's Landing.&nbsp; Make sure you check it out.</P>
<P>- Charm spell change: If an NPC is in the middle of casting a spell when charm is broken, it will interrupt the spell.</P>
<P>- Some general bug fixes.</P>
<P>Make sure you log onto the Test server to see what other changes we are cooking up.&nbsp; Our next Scheduled update is planned for February 10th.</P>
<P>Remember Gates of Discord is coming soon.&nbsp; Go to <A href="http://www.gatesofdiscord.com/">www.gatesofdiscord.com</A> or <A href="http://eqlive.station.sony.com/">EQlive.station.sony.com</A> for more information.</P>
