...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/community/newsletter.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Newsletter</font></b></div>
                        <!-- #EndEditable --></td>
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <div align="center"> 
                          <table border="0" align="center" width="550">
                            <tr> 
                              <td valign="top"><img src="../images/eq_newsletter1.gif" width="200" height="120"></td>
                              <td align="right" valign="top"> 
                                <p><span class="smalltitle">Recent Newsletters...</span><br>
                                  <span class="tinylink"><a href="newsletters/Everquest_March_Newsletter.htm">March 
                                  Issue</a></span><br>
                                  <span class="tinylink"><a href="newsletters/Everquest_Feb_Newsletter.htm">February 
                                  Issue</a></span><br>
                                </p>
                                </td>
                            </tr>
                        ...
                        <P>The Harpy's Head Herald is a monthly EverQuest newsletter providing exclusive content not found anywhere else. From original screenshots and concept art to game hints and secrets, this official newsletter is the insider's choice for all things EverQuest. </P>
<P>Please follow these directions to make sure that you get on our mailing list and receive your very own copy of the Harpy's Head Herald each and every month:</P>
<P>Launch EverQuest <BR>Click Change Account <BR>Log In <BR>Click Edit Registration <BR>Make any updates to your personal information, then click next <BR>Click Next again if no changes are needed <BR>Check yes for "Do you want to receive future Station emails with announcements of new games, contests, and more?" <BR>Click Finish <BR>And that's it. You should begin receiving the Harpy's Head Herald with the next published issue!<BR></P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
