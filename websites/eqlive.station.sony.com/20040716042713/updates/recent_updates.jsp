...
<h1>July 15, 2004</h1>
<P>July 15th, 2004<BR>---------------------</P>
<P>- Issues for shaman and druids with the Healing Adept AA have been corrected.</P>
<P>- Finishing Blow will correctly be capped by level.</P>
<P>- Kick Mastery, Vicious Smash and Strengthened Strike no longer increase the damage on all melee attacks.&nbsp; They now only apply to their intended attacks.</P>
<P>- You will again have to hide to use your rogue Sneak Attack abilities.</P>
<P>- Item recast timers should display correctly.</P>
<P>- Planar Durability will now add the correct amount of hit points.</P>
<P>- You now will be able to see mana displayed numerically on the default UI.&nbsp; To see the mana value, you will need to view the mana bar on your inventory screen.</P>
<P>- A casting time has been added to the Demi Lich Skullcap.</P>
<P>- Some clickable items from the new Veeshan's Peak have been modified.</P>
<P>- Berserkers who had purchased the AA, Fury of Ages, are being refunded the purchase points in order to fix a data error.&nbsp; You will be able to re-purchase the AA for the same cost.</P>
<P><BR>Clarification<BR>---------------------<BR>- Malcohm Thimbleton, in the Plane of Knowledge will now swap out the following Robe Graphic items for Tunic Graphic items:</P>
<P>- Guardian Robe<BR>- Shade Silk Robe<BR>- Shainai's Nightie<BR>- Bile Stained Robes<BR>- Cured Shade Silk Robe<BR>- Robe of the Azure Sky</P>
<P>&nbsp;</P>
