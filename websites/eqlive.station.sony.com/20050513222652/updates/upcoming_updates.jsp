...
<tr>
	...
	<a href="upcoming_updates.jsp?id=64010" class="tinylink">Upcoming for May</a><br>
...
<h1>Upcoming for May</h1>
<P>Our next update is tentatively scheduled
  for May 11th.&nbsp; This update will bring more re-envisioning changes
  including changes to spread spells out better from levels 1 to 50 and tuning
  changes to just about every single target heal in the game, including pet
  heals.&nbsp; In addition, all beneficial spells that last at least 24 seconds
  will now inform their owner when they wear off.</P>  <P>New augments have been added to
  the Dragons of Norrath mission vendors.&nbsp; These augments can be used to
  upgrade the armor purchased from those same mission vendors.</P>  <P>We've increased the experience you
  gain when completing many quests in starting cities.</P>  <P>We are also making improvements to
  the in game email system.&nbsp; You will now be able to email multiple
  players at once and blind carbon copy players.&nbsp; Guild members will now
  have a pre-populated distribution list of everyone in the guild. This list is
  automatically updated so if a player joins or leaves your guild, your guild
  distribution list will update to reflect those changes.&nbsp; In addition,
  your characters will now all share the same address book by default.&nbsp;
  This address book is private and will be stored on your client.&nbsp; If you
  wish, you can assign an address book to any of your characters making it easy
  to keep track of your contacts.&nbsp; Each contact will have a notes field
  and you will be able to sort your contacts by guild mates or friends.&nbsp;
  You will also have the option to automatically forward in-game emails to the
  email address you have registered to your Station account.</P>  <P>Finally, don&#8217;t forget that
  Veteran rewards will make their way to you on May 13th. Please see the
  following link for details: <A HREF="http://eqlive.station.sony.com/lowsrc/news_section/newsview.jsp?story=50003">http://eqlive.station.sony.com/lowsrc/news_section/newsview.jsp?story=50003</A></P>  <P>This update has been brought to you by the Brenlettes.</P>
