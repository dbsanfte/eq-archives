...
<P><B>The Nexus</B></P>
<P><A class=mlinklevel1 href="http://eqforums.station.sony.com/eq/board?board.id=Crier">The Town Crier</A><BR>Be the first one to get EverQuest announcements about new discussion forums, new game enhancements, new polls, and other game developments. </P>
<P><A class=mlinklevel1 href="http://eqforums.station.sony.com/eq/board?board.id=Guides">EverQuest Game Guides<BR></A>Would you like to post your very own EverQuest Game Guide? If so, send it off to <A href="mailto:Acrosby@soe.sony.com">Acrosby@soe.sony.com</A>. Note that all submitted guides are checked for content and accuracy. Also spoiler guides will not be posted. </P>
<P><B>The Wayfarer's Rest </B></P>
<P><A class=mlinklevel1 href="http://eqforums.station.sony.com/eq/board?board.id=TNZ">The Newbie Zone</A><BR>New to EverQuest? Looking for some pointers? Try asking your fellow players. The Newbie Zone boasts a strong community of players dedicated to helping their fellow adventurers. Please note that while this forum is moderated for content, SOE does not answer questions nor comments on issues in this forum. In addition, <STRONG>an active EverQuest account is required to post here</STRONG>.</P>
<P><A class=mlinklevel1 href="http://eqforums.station.sony.com/eq/board?board.id=Roleplaying">Harpy's Head Tavern (A Role-Play Forum)<BR></A>The Harpy's Head Tavern was created as a means for the EverQuest players to continue their roleplaying outside of the game. For more information, please read the first post, "Please Read Before Posting". This forum is for roleplaying posts, and only those posts written in-character will be allowed. All OOC posts will be deleted. <STRONG>An active EverQuest account is required to post here</STRONG>.</P>
<P><B>The Help Desk</B></P>
<P><A class=mlinklevel1 href="http://eqforums.station.sony.com/eq/board?board.id=tech">Technical Help</A><BR>Customer Service for Telephone Support&nbsp;is open from 9:00 A.M. to 6:00 P.M. Pacific Time Monday through Friday at (858) 537-0898.Customer Service for <A href="http://www.station.sony.com/en/instantchat.jsp">Live Chat </A>will be open from 9:00 A.M. to 6:00 P.M. Pacific Time (Monday through Friday). In addition, solutions to most common issues can be found easily in our <A href="http://help.station.sony.com/esupport/esupport/consumer/esupport.asp">Station Knowledge Base</A>. However, if you still cannot find the answer to your question, you may contact us by email at <A href="mailto:eqtech@soe.sony.com">eqtech@soe.sony.com</A></P>
