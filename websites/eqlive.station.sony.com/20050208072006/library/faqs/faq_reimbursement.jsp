...
<P ALIGN="center"><STRONG><BR><STRONG>Item Reimbursement FAQ</STRONG></STRONG></P>  <P><STRONG><U>General Questions</U></STRONG></P>  <P>Q: How much time do I have to contact a Guide/GM concerning a
  ...
  in-game assistance as soon as possible using the /petition command. The issue
  will be investigated and the character restored if the files are available.
  Due to the time constraints of the restore system, it is important that you request
  assistance for deleted characters as promptly as possible. Please do not make
  a new character with the same name in order to &quot;save&quot; the name.</P>  <P><BR><BR></P>  <P ALIGN="center"><IMG BORDER="0" SRC="../../../../../images/tribal_divider.gif"></P>  <P><STRONG><U>Dropped, Destroyed and Combined Items</U></STRONG></P>  <P>Q: I dropped my items on the ground and they vanished before I could pick
