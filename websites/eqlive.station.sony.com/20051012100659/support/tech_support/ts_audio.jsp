...
<P ALIGN="center"><STRONG><BR><STRONG>Supported Sound Cards</STRONG></STRONG></P>  <P>The following is a list of supported sound cards.<BR>You SHOULD install the most recent driver version from your manufacturer.</P>  <P ALIGN="center">Aureal A3D
  ...
  the following sound cards is limited. </P>  <P><EM>Cards we have tested:</EM></P>  <UL>   <LI>Turtle Beach<BR>Montego / Vortex A3D<BR><A TARGET="_blank" HREF="http://www.voyetra-turtle-beach.com/">http://www.voyetra-turtle-beach.com/</A></LI>   <LI>Diamond Multimedia<BR>Monster Sound MX300</LI>  </UL>  <P><EM>Not Tested but Should Work:</EM></P>  <UL>   <LI>Diamond
       ...
       driver listing</EM></LI>   <LI>Sound Blaster PCI512<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster PCI128<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see
       the driver listing</EM></LI>   <LI>Sound Blaster AWE64 Gold<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster AWE 64<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster AWE 32<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster 16<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver
       listing</EM></LI>  </UL>  <P><EM>Note: In order for the SBLive to work correctly, you must download
  ...
  packages.</EM></P>  <UL>   <LI>Sound Blaster PCI64<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A>       <EM><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></EM></LI>   <LI>Sound Blaster Ensoniq Audio PCI<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster 32<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
  ...
  either the latest </EM><STRONG><EM>Sound Blaster Ensoniq AudioPCI</EM></STRONG><EM>  drivers or the drivers that came with your Ensoniq card.</EM></P>  <UL>   <LI>Soundscape<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
       driver listing</EM></LI>  </UL>  <P><EM>Not tested but should work:</EM></P>  <UL>   <LI>Soundscape VIVO<BR>Soundscape Elite<BR><A HREF="http://us.creative.com/support/">http://us.creative.com/support/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
  ...
  through an email via our <A TARGET="_blank" HREF="http://www.station.sony.com/en/services/help/premiumGames.jsp">online form</A>.</P>  <P><STRONG>*WARNING: ALL OF THE DRIVERS LINKED TO OR OTHERWISE MADE AVAILABLE
  ...
  REPRESENTATIONS OR WARRANTIES, EXPRESS, IMPLIED, ARISING FROM COURSE OF
  DEALING OR USAGE OF TRADE, OR STATUTORY, AS TO THESE DRIVERS OR ANY MATTER
  WHATSOEVER CONNECTED HEREWITH, INCLUDING, WITHOUT LIMITATION, ANY
  REPRESENTATION THAT THE DRIVERS DO NOT CONTAIN COMPUTER CODE DESIGNED TO
  DISRUPT, DISABLE, HARM OR OTHERWISE IMPEDE IN ANY MANNER THE OPERATION OF A
  COMPUTER PROGRAM, WILL NOT DAMAGE OR DESTROY ANY DATA FILES RESIDING ON A
  COMPUTER OR WILL NOT ADVERSELY AFFECT THE HARDWARE OR OTHER SOFTWARE OF THE
  USER IN ANY WAY. IN PARTICULAR, ANY AND ALL WARRANTIES OF TITLE,
