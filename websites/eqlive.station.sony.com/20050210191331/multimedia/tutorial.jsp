...
<P ALIGN="center"><A HREF="../../../../../multimedia/dnloads/EQTutorial.exe">Download the
  EverQuest Tutorial</A></P>  <P ALIGN="center"><STRONG>EverQuest
  Tutorial Help</STRONG></P>  <P>Because of our continued improvements to the EverQuest game, the original
  EverQuest Tutorial no longer works. If you would still like to take advantage
  of the Tutorial to learn the basics of EverQuest, we have a solution for you.</P>  <P>&nbsp;</P>  <P>You can now download the EverQuest Tutorial as a complete and separate
  package. The download is a large one (52.5MB) but will allow you full use of
  the EverQuest Tutorial. Below are the estimated times of download:</P>    <TABLE STYLE="width:60.0%;mso-cellspacing:0in;mso-padding-alt:0in 0in 0in 0in"><TR STYLE="mso-yfti-irow:0;mso-yfti-firstrow:yes"><TD STYLE="padding:0in 0in 0in 0in"><P><BR><BR><BR><BR><BR><BR><BR><BR><BR></P>    <P>28.8 Kb</P></TD>    <TD STYLE="padding:0in 0in 0in 0in">4 hours 14 minutes 51 seconds</TD></TR>   <TR STYLE="mso-yfti-irow:1"><TD STYLE="padding:0in 0in 0in 0in">56 Kb</TD>    <TD STYLE="padding:0in 0in 0in 0in">2 hours 11 minutes 04 seconds</TD></TR>   <TR STYLE="mso-yfti-irow:2"><TD STYLE="padding:0in 0in 0in 0in">Cable/DSL (250 Kb)</TD>    <TD STYLE="padding:0in 0in 0in 0in">29 minutes 21 seconds</TD></TR>   <TR STYLE="mso-yfti-irow:3;mso-yfti-lastrow:yes"><TD STYLE="padding:0in 0in 0in 0in">T1 Connection</TD>    <TD STYLE="padding:0in 0in 0in 0in">43 seconds</TD></TR></TABLE>    <P><BR><BR><BR></P>  <P>To download the EverQuest Tutorial <A HREF="../../../../../multimedia/dnloads/EQTutorial.exe">click here</A>. Save
  the file to disk, preferably to the Desktop or other easily found location.
  Once you have completed the download, locate the file EQTutorial.exe and
  double-click on it. This will start the self-extractor. By default the
  EverQuest Tutorial will install to C:\\\\Program Files\\\\EQTutorial. Once
  the files are extracted, browse to the folder EQTutorial (C:\\\\Program
  Files\\\\EQTutorial) and double-click on the Tutorial.exe file. This will
  launch the EverQuest Tutorial.</P>  <P>&nbsp;</P>  <P>IMPORTANT NOTE: The EverQuest Tutorial is not compatible with current
  EverQuest files, be sure NOT to install the EverQuest Tutorial files into
  your EverQuest folder as this will render the EverQuest game or the Tutorial
  unplayable.</P>
