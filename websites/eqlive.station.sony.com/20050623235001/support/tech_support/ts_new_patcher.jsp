...
<P ALIGN="center"><STRONG><BR><STRONG>EverQuest Patcher Help</STRONG></STRONG></P>  <P><STRONG>Important Note: If you are unable to download files with the new
  ...
  left off.</P>  <P>&nbsp;</P>  <P><STRONG>Download button enabled</STRONG><BR>The Download button will be enabled depending on your choices under Advanced
  options. Keep reading for information on using Advanced options.</P>  <P>&nbsp;</P>  <P><STRONG>Advanced Dialog Box</STRONG><BR>The Advanced dialog box is accessible by clicking on the Advanced button.
  ...
  download needed files by clicking on the Download button when it is
  activated.</P>  <P>Once you change any option, you can Save those options or cancel and start
  over. If you think one of your EverQuest files may be corrupted, then use the
  Complete File Check to run a complete scan of every file in your EQ directory.</P>  <P>&nbsp;</P>  <P><STRONG>General Issues</STRONG></P>  <P>All anti-virus software should be disabled before running the patcher.</P>  <P>&nbsp;</P>  <P><STRONG><U>Internet Explorer Issues</U></STRONG></P>  <P><STRONG>Set Dial Up Settings</STRONG></P>  <OL>   <LI>Under tools in the
       ...
       &quot;Perform system security check before dialing&quot;</LI>   <LI>Click OK</LI>  </OL>  <P><STRONG>Set Security to &quot;Medium&quot;</STRONG></P>    <P>All Internet Explorer Security settings should be set to
  &quot;Medium.&quot; To do this, follow these instructions:</P>      <OL>   <LI>Under Tools in the
       menu, click on Internet Options</LI>   <LI>Click on the
