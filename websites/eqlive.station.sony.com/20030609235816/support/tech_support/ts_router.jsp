		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_router.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_router.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
...
<P><A name=DLink></A>D-Link&reg; DI-704P Ethernet Broadband Router:<BR><BR>1.&nbsp;Open a browser window and type 192.168.0.1 in the address field (or if you've changed the default IP of your router, type that IP into the window)<BR>2.&nbsp;In the System Password area, type admin as the password (unless you have changed the password, in which case you would put the password that you have changed it to)<BR>3.&nbsp;Click on the Tools link at the bottom of the page.<BR>4.&nbsp;Under Other Tools, click on Restore to Default.<BR>5.&nbsp;You will get a prompt window that says "Reset all setting to default?"&nbsp; Click yes.<BR>6.&nbsp;Unplug the power of your router for about 5 seconds, then plug it back in (this acts as a reboot of the router)<BR>7.&nbsp;If you have set the router to a static IP, then you would redo those settings at this point, or if your ISP requires a login, or you are using PPPoE**, then this is also the time to input those details.</P>
<P><A name=DLink1>D-Link&reg; DI-604 (revisions A/B/C) Express EtherNetworkTM 4-Port Ethernet Broadband Router</P>
...
<P><A name=DLink2>D-Link&reg; DI-614+ Enhanced 2.4GHz Wireless Router with built-in 4-Port Switch and advanced Firewall &amp; Parental Control<BR><BR>1.&nbsp;Leave the device powered on, do not disconnect the power<BR>2.&nbsp;Press the reset button and hold it (using a paper clip will suffice)<BR>3.&nbsp;Keep the button pressed for about 10 seconds<BR>4.&nbsp;Release the button<BR>5.&nbsp;Your router will then automatically reboot itself.<BR>6.&nbsp;If you have set the router to a static IP, then you would redo those settings at this point, or if your ISP requires a login, or you are using PPPoE**, then this is also the time to input those details</P>
<P><A name=DLink3>D-Link&reg; DI-714P+ Enhanced 2.4GHz Wireless Router with built-in 4-Port Switch and Print Server<BR><BR>1.&nbsp;Leave the device powered on, do not disconnect the power<BR>2.&nbsp;Press the reset button and hold it (using a paper clip will suffice)<BR>3.&nbsp;Keep the button pressed for about 10 seconds<BR>4.&nbsp;Release the button<BR>5.&nbsp;Your router will then automatically reboot itself.<BR>6.&nbsp;If you have set the router to a static IP, then you would redo those settings at this point, or if your ISP requires a login, or you are using PPPoE**, then this is also the time to input those details</P>
<P><A name=DLink4>D-Link&reg; DI-764 Multimode 2.4/5GHz Wireless Router<BR><BR>1.&nbsp;Leave the device powered on, do not disconnect the power<BR>2.&nbsp;Press the reset button and hold it (using a paper clip will suffice)<BR>3.&nbsp;Keep the button pressed for about 10 seconds<BR>4.&nbsp;Release the button<BR>5.&nbsp;Your router will then automatically reboot itself (this may take a few minutes)<BR>6.&nbsp;If you have set the router to a static IP, then you would redo those settings at this point, or if your ISP requires a login, or you are using PPPoE**, then this is also the time to input those details</P>
<P><A name=DLink5>D-Link&reg; DI-624 D-Link AirPlus Xtreme G High-Speed 2.4GHz Wireless Router<BR><BR>1.&nbsp;Leave the device powered on, do not disconnect the power<BR>2.&nbsp;Press the reset button and hold it (using a paper clip will suffice)<BR>3.&nbsp;Keep the button pressed for about 10 seconds<BR>4.&nbsp;Release the button<BR>5.&nbsp;Your router will then automatically reboot itself (this may take a few minutes)<BR>6.&nbsp;If you have set the router to a static IP, then you would redo those settings at this point, or if your ISP requires a login, or you are using PPPoE**, then this is also the time to input those details</P>
<P><A name=DLink6>D-Link&reg; 804V Broadband VPN Router<BR><BR>1.&nbsp;Leave the device powered on, do not disconnect the power<BR>2.&nbsp;Press the reset button and hold it (using a paper clip will suffice)<BR>3.&nbsp;Keep the button pressed for about 10 seconds<BR>4.&nbsp;Release the button<BR>5.&nbsp;Your router will then automatically reboot itself (this may take a few minutes)<BR>6.&nbsp;If you have set the router to a static IP, then you would redo those settings at this point, or if your ISP requires a login, or you are using PPPoE**, then this is also the time to input those details</P>
