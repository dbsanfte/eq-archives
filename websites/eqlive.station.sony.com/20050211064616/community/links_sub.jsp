	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/links_sub.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/links_sub.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/community/links_sub.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P ALIGN="center"><STRONG><BR><STRONG>Linking Guidelines</STRONG></STRONG></P>  <P><BR>To make changes to your current listing, just send an email to us at <A HREF="mailto:eqwebmaster@soe.sony.com">eqwebmaster@soe.sony.com</A></P>  <P>If you want to have your site added to our Links Page, please ensure that
  your site meets the following requirements. Each site will be reviewed before
  being linked to from EverQuest Live.</P>  <UL>   <LI>No guild sites</LI>   <LI>Sites may not contain
       illegal information or links to illegal information such as hacking,
       warez, or content unsuitable for minors.</LI>   <LI>Sites must be kept
       updated. No need to update daily, but if the site is reviewed and
       content is a month old, chances are we will pull the link.</LI>  </UL>  <P><BR>*We are going to strive to only link to those sites that are the most popular
  to the EverQuest community. Although we would like to be able to link to
  every EQ site available, our resources at this time do not allow for it.</P>  <P>&nbsp;</P>
