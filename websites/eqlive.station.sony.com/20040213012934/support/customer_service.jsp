	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_guilds.jsp">Guild Information<BR></A>A quick guide to guild creation,&nbsp;joining and quitting a&nbsp;guild, guild commands, and guild wars.&nbsp;</P>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_security_main.jsp">Account Security</A><BR>Protecting yourself should always come first. </P>
<P><A href="http://eqlive.station.sony.com/support/customer_service/cs_game_cards.jsp">Game Cards</A><BR>A different way to pay for your EverQuest subscription without using a credit card. </P>
