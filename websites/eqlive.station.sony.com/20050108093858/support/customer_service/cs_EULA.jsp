...
<P>Please remember to review the current terms and conditions of the
  ...
  sublicenseable (through multiple tiers) right to exercise all intellectual
  property rights, in any media now known or not currently known, associated
  with your Content.</P>  <P>12. We cannot ensure that your private communications and other personally
  ...
  or the Southern District of California (if under federal law). If any provision
  of this Agreement is held to be invalid or unenforceable, such provision
  shall be struck and the remaining provisions shall be enforced. Our failure
  to act with respect to a breach by you or others does not waive our right to
  act with respect to subsequent or similar breaches. You may not assign or
