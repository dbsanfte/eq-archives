...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">42,216 Players Online</div>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td valign="top"> <div align="center"><img src="images/eqim_header.jpg" width="255" height="135"> 
                              </div></td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><span class="title1">Keep in Touch Beyond EverQuest</span><br>
                              EQIM, the EverQuest Instant Messaging Service, is 
                              an exciting new way to chat with your EverQuest 
                              friends. With the ability to connect to the EverQuest 
                              chat server, players can now log on to this instant 
                              messaging service as one of their characters and 
                              chat directly with players on any server, create 
                              their own chat rooms, even over group or guild channels. 
                              Staying in touch with friends, guildmates and groupmates 
                              has never been so easy and convenient. </td>
                            <td width="60%"> <div align="center"><img src="images/eqim_top_right.jpg" width="295" height="254"></div></td>
                          </tr>
                        </table>
                        <br>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="22%"> <div align="center"><img src="images/eqim_mid_left.jpg" width="119" height="266"></div></td>
                            <td valign="top">
<p><span class="title1">What Can I Do With EQIM?</span><br>
                                There is almost no limit to the ways you can use 
                                EQIM. Stuck at work but want to monitor your guild&#8217;s 
                                big raid? No problem! EQIM will keep you in touch 
                                with people and on top of events in your EQ community 
                                while you&#8217;re not in the game. Plan the evening&#8217;s 
                                adventures before you enter EQ so you can get 
                                in and get on with the fun immediately&#8212;reduce 
                                or eliminate the time it takes to look for a group 
                                and to organize big raids!</p>
                              <p>Host guild meetings in private chat rooms that 
                                you can moderate.</p>
                              <p>Looking for a key player for an impromptu raid? 
                                Check EQIM to see if he is online. If you know 
                                his other aliases, check them all on any server!</p>
                              </td>
                          </tr>
                        </table>
                        <br>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="40%" valign="top"><span class="title1">Explore 
                              the EverQuest Community</span><br>
                              The global EverQuest community is just a click away 
                              with EQIM, keeping you in contact with old friends 
                              and opening new avenues to meet new friends. EQIM 
                              adds a completely new dimension to your EQ gaming 
                              experience. With an active subscriber base of more 
                              than 430,000 players and as many as 100,000 or more 
                              players logged on simultaneously, the world of EQ 
                              has potential to expand for you in unimagined ways. 
                            </td>
                            <td> <div align="center"><img src="images/eqim_bottom_left.jpg" width="300" height="257"></div></td>
                          </tr>
                        </table>
                        <p><strong>How Do I Get EQIM?</strong><br>
                          The EQIM client download will be made available very 
                          soon, so check back here at everquestlive.com often. 
                          There will be a trial period during which you will be 
                          able to try out the service for free. After this trial 
                          period there will be a subscription fee to use the service. 
                          You must have an active and valid EverQuest subscription 
                          with at least one character to use the EQIM service.<br>
                        </p>
                        <p><strong>If I Like It, Can I Keep Using It?</strong><br>
                          If you like EQIM, after the trial period has passed 
                          you can subscribe to the service for a nominal fee and 
                          continue using EQIM. The subscription fee will be announced 
                          soon. EverQuest Legends subscribers will get EQIM at 
                          no charge! </p>
                        <p>Get ready to enjoy EverQuest in a whole new way! 
                          <!-- end page content -->
                        </p>
                        <!-- #EndEditable --></td>
