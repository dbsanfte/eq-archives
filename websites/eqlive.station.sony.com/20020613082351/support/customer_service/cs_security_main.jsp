...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_security_main.jsp?null');">
...
<DIV align=center><STRONG><BR>Account Security</STRONG> </DIV>
<P>As the population of Norrath increases, so too do issues regarding stolen or compromised accounts, and/or accounts that have been transferred from one player to another in violation of the User Agreement. These issues - and the time it takes to investigate and attempt to resolve them - hugely detract from the time that SOE's customer service staff have to devote to providing quality customer service to issues that impact upon the gameplay experience. Accordingly, SOE must remind all players that: </P>
<P></P>
<P>(1) Account security -- whether it be password protection, running virus checks, disabling file sharing, or any other element of making sure accounts are not stolen or compromised -- is the sole responsibility of the account owner. </P>
<P></P>
<P>(2)Any and all stolen and/or compromised accounts that are reported to SOE will be *suspended*, and no items will be reimbursed. Any player found to be involved in an account theft will have any and all of his/her accounts banned. </P>
<P></P>
<P>Prior to banning any accounts reported as compromised, we will conduct a thorough review of the accounts in question and determine the appropriate course of action on those accounts. Accounts will only be banned based on information gathered through our investigation and not merely as a result of external allegations. </P>
<P>- The EverQuest Customer Service Team<BR></P>
<P><BR>If you are still having problems after visiting this support section, you can contact our Technical Support Department through an email via our <A href="http://www.station.sony.com/services/everquest-technical.jhtml" target=_blank>online form</A>.</P>
