	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/antonica.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/antonica.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/antonica.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                              ...
                              <center>
                                <table border="0" width="100%" cellspacing="0" cellpadding="0" background="images/parchtile.gif">
                                  <tr> 
                                    <td width="88">&nbsp;</td>
                                    <td width="100%">&nbsp;</td>
                                    <td align="right" valign="top" width="87">&nbsp;</td>
                                  </tr>
                                </table>
                                <table border="0" width="100%" cellspacing="0" cellpadding="0" background="images/parchtile.gif">
                                  <tr> 
                                    ...
                                    <td width="100%"> 
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr> 
                                          <td height="108"> 
                                            <div align="center"> <img src="images/map_antonica_title.gif" width="186" height="34"> 
                                    ...
                                    <td> 
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td width="437"> 
                                            <center>
                                              <img src="images/map_ship1.gif" width="115" height="80"> 
                                            </center>
                                          </td>
                                          <td width="780" height="426" rowspan="3"><img src="images/map_antonica_hi.gif" width="350" height="426" border="0" usemap="#Map_main">
                                            <map name="Map_main">
                                              <area shape="rect" coords="109,-8,149,16" href="halas.jsp">
                                              <area shape="rect" coords="1,169,49,188" href="qeynos.jsp">
                                              <area shape="rect" coords="122,139,182,157" href="rivervale.jsp">
                                              <area shape="rect" coords="306,104,348,120" href="neriak.jsp">
                                              <area shape="rect" coords="293,199,346,215" href="freeport.jsp">
                                              <area shape="rect" coords="161,292,206,309" href="oggok.jsp">
                                              <area shape="rect" coords="280,398,323,416" href="grobb.jsp">
                                            </map>
                                          </td>
                                          <td width="8"> 
                                            <center>
                                      ...
                                      <table border="0" width="100%" cellpadding="20" cellspacing="0">
                                        <tr> 
                                          <td><font color="#000000">Antonica is 
                                            the largest and most populated continent 
                                            on Norrath. The continent was known 
                                            as Tunaria, until it was recently 
                                            renamed by the human ruler of the 
                                            Free City of Qeynos, Antonius Bayle. 
                                            It is on Antonica where Tunare first 
                                            placed Her High Elves. Antonica is 
                                            also the birthplace of the Halflings, 
                                            Trolls, Ogres, and Humans. The evil 
                                            stain of Innoruuk, the Dark Elves, 
                                            also call Antonica home.</font></td>
                                          <td> 
