...
<P>In order to help keep our customers informed about the updates we have
  planned, we are opening a new feature here on the EverQuest Live site.</P>  <P>The idea here is a simple one.&nbsp; We'll be posting highlights from the
  most recent changes to the game along with featured items planned for our
  next update.</P>  <P><A HREF="../../../../../updates/recent_updates.jsp">Recent Updates</A><BR>Information about the most current updates.</P>  <P><A HREF="../../../../../updates/upcoming_updates.jsp">Upcoming Updates<BR></A>This section gives you a heads-up on what we'll be doing next.</P>  <P><A HREF="http://eqlive.station.sony.com/community/dev_view.jsp">Developer's
  Corner<BR></A>The latest news from the Dev Team</P>
