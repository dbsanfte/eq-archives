...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">86,518 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/eqfiction/lore_archive.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/eqfiction/lore_archive.jsp');">
...
<tr>
	<td>08/13/2002</td>
	<td><a href="../../library/eqfiction/lore.jsp?id=50539" class="smalltitle">Revealing New Portals</a></td>
</tr>
...
<P>
<form action="../../library/eqfiction/lore.jsp" method="GET">
<select name="id">

<option value="50539">Revealing New Portals 08/13/2002</option>
