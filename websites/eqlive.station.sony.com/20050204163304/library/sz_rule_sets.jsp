...
<P><STRONG>Sullon Zek rules:</STRONG></P>  <P>Welcome to Sullon Zek, the first Deity Team PvP server.</P>  <P>The Sullon Zek server is a new server with a new rule set. The rules for
  ...
  sports team.</P>  <OL>   <LI>Player v. Player
       ...
       become PvP enabled.</LI>   <LI>Characters will
       lose experience when killed in PvP combat if the character that killed
       them is within 5 levels. The amount of experience lost will be the same
       amount that is lost if that character is killed by an NPC. Your corpse
       can be resurrected by a cleric to partially restore lost experience.</LI>   <LI>Characters will
       only be able to loot coins from other characters, and then only if the
       victim was within 5 levels of the killer. Only the character getting the
       ...
       Evil team members will see each other as threatening.</LI>   <LI>Faction hits for
       PvP will be taken for killing characters within their racial home towns.
       ...
       with their conflicts through combat. Causing experience loss by 'training'
       NPCs on other characters would normally not be an offense that would
       warrant a warning this server. But training done to others on the same
       team, thus eliminating any PvP solution, is a violation of the Play Nice
       Policies. <STRONG>ALSO:</STRONG> All rules regarding general decency
       still apply. Cursing, threats and other such things will be dealt with
       sternly, and are still unacceptable behavior on any server.</LI>   <LI>Beneficial effects
       can not be used on members of another team.</LI>   <LI>No character will
       be able to bind in dungeon zones.</LI>   <LI>'Buff' spells will
       ...
       consists of: Bertoxxulous, Cazic Thule, Innoruuk, Rallos Zek</LI>   <LI>The Neutral
       Alliance consists of: Brell Serilis, Bristlebane, Karana, Prexus,
       Solusek Ro, The Tribunal, Veeshan.</LI>  </UL>  <P>There are no Agnostics on Sullon Zek. With the new influence of the gods,
