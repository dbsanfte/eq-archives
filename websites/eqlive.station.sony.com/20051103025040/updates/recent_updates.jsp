...
<tr>
	...
	<a href="recent_updates.jsp?id=64108" class="tinylink">October 12th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64108" class="tinylink">October 27th, 2005</a><br>
...
<h1>October 12th, 2005</h1>
October 12th, 2005<BR>_____________________<BR><BR>*** Headlines ***<BR><BR>A new edition of the city newspapers is hot off the presses. See your local
  Town Crier! <BR><BR><BR>Lesser Faydark and Mistmoore Castle have been returned to their previous
  states.<BR><BR><BR>*** Missions ***<BR><BR>- The mission, Brownies of Doom, has been made easier.&nbsp; We will continue to monitor this
  mission to see if it remains too difficult or too long.<BR><BR>- A character that is out of the instance when one of the five &#8220;Curse
  of Blood&#8221; raids is completed can get their &#8220;flag&#8221; and AA by
  zoning back in before the instance shuts down.&nbsp; There was a bug with the mechanism
  that handed out the AAs in this case and that has been fixed.&nbsp; The &#8220;flag&#8221; was being given
  out properly on zone in.<BR><BR><BR>*** Quests ***<BR><BR>- Many of the guests of Dreadspire were very easily satiated.&nbsp; Their hunger has grown and they can be
  fed more often.<BR><BR>- Ergrez Shortpaw in Iceclad now asks for Fatty Walrus Meat instead of Walrus
  Meat.<BR><BR>- There are reports of bandits robbing the Cargo Clockwork in Steamfont.&nbsp; Speak to Jarah in Ak`Anon to find out
  about the Cargo. (Cargo Clockwork&#8217;s quest should now work properly)&nbsp; <BR><BR>*** Spells ***<BR><BR>- Shield of Dreams is now a 451 pt. rune<BR><BR>- The triggered effect caused by Fickle Shadows will now only effect spells
  which do not have a duration.&nbsp;
  I.E. instant direct damage spells.<BR><BR>- The charges on the mage summoned Sphere of Air have been increased to
  5.&nbsp; The spell that summons this
  item has also had its mana cost increased.<BR><BR>- The ATK bonuses for Ward of the Hunter, Howl of the Predator, and Strength
  of the Hunter have been replaced with Double attack bonuses.<BR><BR><BR>*** AAs ***<BR><BR>- The casting times on several of the wizard AA familiars have been removed. <BR><BR>- Dragon Punch has been changed to a physical resist check, it should now be
  resisted less often.<BR><BR>*** Items ***<BR><BR>- The worn damage shield cap has been increased from 15 to 30.<BR><BR>- The following augmentations now have solvents:&nbsp; Stone of Focused Rage, Heart of
  Darkhollow Wilds, Darter Stone and Solidified Shadow Spine Magical Taint.<BR><BR>- The Illsalin Royalty Garment now has the click effect of Shield of Auras. <BR><BR>- The Shiliskin Good Luck Charm will now yield a lower max value.<BR><BR>- Pristine Illsalin Stonecraft Mask now has +3 regen and mana regen instead
  of Composure.<BR><BR>- The Berserker Epic 1.5 and 2.0 effects have been modified. They now
  increase crit rate, strength (and strength cap), and regen health for the
  duration of the effects.<BR><BR>*** NPCs ***<BR><BR>- Entalon in the burning woods will now take you to his master on completion
  of his quest. <BR><BR>- Though she has lived in Neriak since she was born, Ungia has decided to
  move to Grobb to follow the customer base she acquired during the troll exile.<BR><BR>- Graktar in Iceclad is waiting for a letter from Vkjor in Kael Drakkal.<BR><BR>- Earthcaller Stones should now appear in Shadeweaver's Thicket.&nbsp; This is related to a quest from
  Captain Karim.<BR><BR>- Sentry Kedra Kai of Shadeweaver&#8217;s Thicket will now reward players for
  adventuring into the Paludal Caverns. <BR><BR>*** Tradeskills ***<BR><BR>- Alchemists no longer automatically throw a tantrum and destroy the small
  vials used to make some potions if they fail to make the potion.<BR><BR>- Scrindites Mechanoinstruction Reader should now work as described in the
  book.<BR><BR>- The page needed to make the Unfired Scrindite&#8217;s Holepunch Mold has
  been moved from Poxysmit&#8217;s Book to Scrindite&#8217;s Book.<BR><BR>- Potters Unite! There are new culturally inspired charms made using the
  pottery skill.&nbsp; Consult the
  merchants that sell the culturally inspired books for a new book.<BR><BR>- Refined high quality ore can now be converted between block, large bricks
  and small bricks.<BR><BR>*** UI ***<BR><BR>- A done button has found its way back onto the Merchant Window.<BR><BR>Note: The updated UI that is currently on test will be pushed live in the
  next few weeks.<BR><BR>*** Leadership Points ***<BR><BR>- You will no longer lose leadership points if you are shrouded much lower
  than your regular level and you gain enough leadership experience to gain another
  point.<BR><BR>*** Atlas ***<BR><BR>- Depths of Darkhollow has been added to the atlas.<BR><BR>*** Miscellaneous ***<BR><BR>- The AC cap has been increased for bards levels 50+.<BR><BR>- The return on AC over the cap has been increased for clerics levels 50+.<BR><BR>- The EverQuest Team
