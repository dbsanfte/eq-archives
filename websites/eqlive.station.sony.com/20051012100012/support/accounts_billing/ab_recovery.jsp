...
<P ALIGN="center"><BR><STRONG>Station Name and Password Recovery</STRONG></P>  <P>If you are having difficulty remembering your Station Name or Password,
  please follow the directions below to help you recover them.</P>  <P><STRONG>To recover your Station Name:</STRONG></P>  <P>If you have forgotten your Station name, please visit our Station Name
  Recovery Page at <A HREF="https://www2.station.sony.com/secure/en/retrieve/stationName.jsp">https://www2.station.sony.com/secure/en/retrieve/stationName.jsp</A><A HREF="http://www.station.sony.com/services/forgottop.jhtml?forgot=station"></A>.
  You will be asked to fill out a form and your Station Name will be emailed to
  you at the email address you provided during registration. In order for us to
  send you your Station Name, you will need the following information when you
  fill out the form:</P>  <P>Your email Address (The one you provided during registration)<BR>Your ZIP/Postal Code<BR>Your Birthdate (mm/dd/yy)</P>  <P><STRONG>To recover your Password:</STRONG></P>  <P>If you have forgotten your password, please visit our Password Recovery
  Page at <A HREF="https://www2.station.sony.com/secure/en/retrieve/password.jsp">https://www2.station.sony.com/secure/en/retrieve/password.jsp</A>.
  You will be asked to fill out a form and your reset password will be emailed
  to you at the email address you provided during registration. In order for us
  to send you your new password, you will need the following information when
  you fill out the form:</P>  <P>Your Station Name<BR>Your ZIP/Postal Code<BR>Your Birthdate (mm/dd/yy)</P>  <P>After you receive your new password, we strongly suggest that you visit <A HREF="https://www.station.sony.com/secure/en/registration/view.jsp">https://www.station.sony.com/secure/en/registration/view.jsp</A>,
  sign in, and change your password to something unique that only you will
  know. We also suggest that after you have changed your password, you write
  down your Station Name and password for future reference.</P>  <P>Unfortunately, we are unable to provide Station Name recovery or password
  reset services without the required verification information.</P>  <P>If you do not remember the information required to recover your Station
  Name or to reset your Password, you can contact our Technical Support
  Department via email through our <A HREF="http://www.station.sony.com/en/services/help/premiumGames.jsp">online
  form</A>.</P>
