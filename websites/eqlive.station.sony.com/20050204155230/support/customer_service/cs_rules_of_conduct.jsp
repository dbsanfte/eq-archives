...
<P ALIGN="center"><STRONG>Rules Of Conduct</STRONG></P>  <P><STRONG><BR><STRONG>THE FOLLOWING ARE THE BASIC RULES OF CONDUCT THAT GOVERN PLAYER
  ...
  any transmissions to or from the servers running EverQuest.</STRONG></P>  <P><STRONG>12. You will not exploit any bug in EverQuest and you will not
  communicate the existence of any such exploitable bug (bugs that grant the
  user unnatural or unintended benefits in game), either directly or through
  public posting, to any other user of EverQuest. You will promptly report any
  such bug via the in-game &quot;/bug&quot; command or via the <A HREF="mailto:eqtesting@soe.sony.com">eqtesting@soe.sony.com</A> email
  address.</STRONG></P>  <P><STRONG>13. You will not attempt to play EverQuest on any server that is
  ...
  make an honest mistake. Its enforcement by the EverQuest Customer Service
  Staff will reflect this philosophy.</P>  <P>2. You may not ninjaloot.</P>  <P>Ninjalooting is defined as taking special equipment from a fallen creature
  ...
  EQCSR involved will make a determination as to whether or not a &quot;reasonable
  person&quot; would feel harassed and act accordingly.</P>  <P>6. You may not disrupt the normal playability of a zone or area.</P>  <P>Zone/Area Disruption is defined as any activity designed to harm or
  ...
  operate the game. We will not interfere with the communication of thoughts and
  ideas as long as the presentation is appropriate for all those capable of
  reading the forum.</P>  <P>You may not, however, post any material that:</P>  <UL>   <LI>Attacks or insults
       ...
       anyone's privacy rights.</LI>  </UL>  <P>Furthermore, you may not:</P>  <UL>   <LI>Make multiple
       posts on the same subject for the purpose of getting attention paid to
       your issue.</LI>   <LI>Post off-topic
       comments in threads for the purpose of drawing attention to another
       thread on a different subject.</LI>   <LI>Monopolize the
       ...
       in exchange for real-world money.</LI>   <LI>Advertise
       web-sites with content that violates these rules, the EverQuest EULA, or
       the Station Terms of Service.</LI>   <LI>Advertise products
  ...
  It could include any number of the following:</P>  <UL>   <LI>Editing of the
       post.</LI>   <LI>Deletion of the
