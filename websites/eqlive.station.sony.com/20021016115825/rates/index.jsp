...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">462 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/rates/index.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/rates/index.jsp');">
...
<DIV align=center><FONT size=3><B>EverQuest Price Increase</B></FONT><BR><FONT size=1>04/25/2002 </FONT></DIV>
<P>For further information, please read the <A href="/rates/rate_faq.jsp">EverQuest Rate Increase FAQ</A></P>
<P><BR>Due to the increased costs of running the EverQuest game service, we have increased our subscription rates. Effective April 25, the new subscription rate is $12.95/month. We will continue to offer discounts from the new rate plan on multi-month subscriptions. You don't have to do a thing; you will automatically be migrated to the new billing structure under your current subscription plan when your current subscription plan expires.</P>
<P>New EverQuest rates as of April 25, 2002: </P>
<P>$12.95 per Month <BR>$35.85 for 3 Months <BR>$65.70 for 6 Months </P>
