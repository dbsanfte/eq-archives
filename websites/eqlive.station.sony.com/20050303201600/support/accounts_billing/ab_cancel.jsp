...
<P ALIGN="center"><STRONG><BR><STRONG>Canceling an EverQuest Account</STRONG></STRONG></P>  <P>You may cancel your subscription by going into the EverQuest game client,
  click on &quot;Account&quot;, then click &quot;Cancel Account&quot;. All
  subscription cancellation requests become effective at the end of your
  current subscription cycle (i.e. at the end of your 3-Month subscription).
  You will still have access to EverQuest until your current subscription
  expires.</P>  <P>***NOTE: If you cancel within the free month, you will not be billed for
  your subscription and your EverQuest subscription will remain active until
  the end of the free month.</P>  <P>Our policy is that we do not give refunds for subscription you have
  already purchased after your free month is over.</P>  <P>If you cannot cancel your EverQuest subscription online or you are having
  problems canceling your account, you can contact The Station Customer Service
  team at (858) 537-0898. Customer Service Representatives are available
  weekdays from 8:30 AM to 5:30 PM PST (11:30 AM to 8:30 PM EST), except
  holidays.</P>  <P>If you are not in the USA,
  or can not call, email <A HREF="mailto:accounts@station.sony.com">accounts@station.sony.com</A>  with the following pieces of information:</P>  <P>EverQuest Station Name<BR>Account Key(s)<BR>Billing Address<BR>Birthdate<BR>Zip Code</P>  <P>If you are still having problems after visiting
  this support section, you can contact our Technical Support Department via
  email using our <A HREF="http://www.station.sony.com/en/services/help/premiumGames.jsp">online
  form</A>.</P>
