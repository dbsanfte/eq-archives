...
<STRONG>Guilds FAQ</STRONG> 
<OL>
<LI>'Our Guild is listed as 'Initial Approval' on the Guild page, but we have not yet received our E-Mail'<BR><BR>This is the first step of the approval process. The name has met the approval by a GM on the team, but has not yet received final approval from the Lead GM. When your guild is approved, the creator of the guild will receive an e-mail sent to their registered e-mail address with further instructions. You can also use the web-based <A href="http://eqlive.station.sony.com/guild_requests/intro_view.jsp">Guild Application System</A> to create new guild requests, or to check on what requests you have already made.<BR><BR>
<LI>'I can get my 10 members together, but not during GM hours. What should I do?'<BR><BR>We no longer require that 9 people be present with you at time of guild creation on server. All you need to do is petition on server after you have received your approval email. Please remember that the guild leader will be held responsible for having at least 9 other people in your guild aside from alternate characters when we do our guild maintenance. IMPORTANT: You will still need 9 other people in chat for initial guild registration.<BR><BR>
<LI>'Our Leader quit/left EQ/is not around and we need a new leader.'<BR><BR>You will need to /petition your server GM for this matter. When you /petition, you will need to have at least 50% of your guild members present. When the GM arrives, they will take a vote as to whom the guild members present would like as their guild leader. After the vote is taken, the person selected as the new guild leader will be granted the leader flag. <STRONG>We recommend that you create a new guild and move your current membership to that new guild. This would prevent any ownership disputes if the original guild owner returns and requests leadership of his/her guild back.</STRONG><BR><BR>
<LI>'How can I find out who is in my guild without having everyone online?'<BR><BR>The Legacy of Ykesha provided you with your guild management tool. This tool allows you to see a list of all the members of your guild, their race, class and level, as well as the rank in the guild. Also, a leader or officer can request a copy of the current characters in the guild. Please send requests to this address. <BR><BR>
<LI>'We're approved in chat, but we hate our name. Can we change it?'<BR><BR>Unfortunately, once your guild is approved and registered on your account the name is permanent. We cannot delete, erase, or change the name once it has been registered, so please make sure you take the time to consider your guild name before submitting it.<BR><BR>
<LI>'Help! Our name is wrong! We are missing the word "THE" in front of our name!'<BR><BR>All guilds are considered to have "THE" at the beginning of the name. At time of creation, you have the option to add "THE" to the beginning of the guild name. If you already have an existing guild but do not have "THE" in front of it then you will need to /petition for a GM to assist you. Only the leader of the guild can request this.<BR><BR>
<LI>'Why is my name coming up as not unique? I know there is no guild named 'My Guild' on my server.'<BR><BR>Guild names are universal across all servers. Any registered guild can be formed from the creator's account on any number of servers. Once a guild is formed, that name is reserved and cannot be used again by another account. Please remember that adding "THE" on the front of the guild name does not denote it as unique since all guilds are considered to have "THE" in front of them.<BR><BR>
<LI>'I have a guild name that the GM will not allow for me to have created in game. What do I do?'<BR><BR>There are rare occasions where a guild name will be approved in chat but are not permitted to be created in-game. We apologize profusely for this. Please respond to this email and it will be handled by the Lead GM that oversees EQGuilds. Be sure to put "<STRONG>For EQGuilds Lead GM</STRONG>" in the subject line in addition to the Out of Office AutoReply.<BR><BR>
<LI>'What happened? Suddenly our guild was disbanded for no reason!' <BR><BR>Sometime during the beginning of each month, guilds with less than 10 members are deleted from the system. If your guild was deleted, then you do not have to go back through the chat system, as your account will retain your guild name registration. Simply have the guild leader petition in game to have the guild recreated. Keep in mind that it is the responsibility of the guild leader to ensure that your guild has sufficient numbers. Should your guild be deleted more then three times, we will not be able to recreate the guild again.<BR><BR>
<LI>'Why can't I have the guild name I want?'<BR><BR>Guild names follow the same basic naming polices as character names do. There are some exceptions to the policy such as you can have titles in a guild name like Knights, Mages, etc. However, all of the other policies apply, including, but not limited to, those that are from popular media, religious references or things that are out of context for Norrath. To review the character naming policy you can click this <A href="http://eqlive.station.sony.com/support/customer_service/cs_naming_policy.jsp">link</A>. Keep in mind that we are often strict on guild names, so you may be asked to explain the meaning of your guild name in detail or possibly requested of other information before your guild is approved.<BR><BR>
<LI>'I made a guild way back when but now I want to make a new guild. Why can't I create a new one?'<BR><BR>Currently, you can only have one guild per account. You are welcome to recreate the previous guild as long as it has not been disbanded due to insufficient numbers more then three times or for disciplinary action.<BR><BR>
<LI>'I haven't received my guild approval email yet! When can I create my guild?'<BR><BR>If your guild is not showing up on the guild screen in chat and you haven't received your email yet then it is possible that you did not have the proper e-mail address listed in your registered account information. This is generally not a problem, as the guild leader can petition on server and ask your GM if your guild has been approved. If it has, the GM may create it for you at that time. You may wish to update your email address so that if the need arises we may have a way to contact you. Also be sure to use the <A href="http://eqlive.station.sony.com/guild_requests/intro_view.jsp">Guild Application System</A> to create new guild requests or to check on requests you have already made.<BR><BR></LI>
<LI>'Are there other ways to submit requests for a new guild?'<BR><BR>Yes! The new <A href="http://eqlive.station.sony.com/guild_requests/intro_view.jsp">Guild Application System</A> is a simple&nbsp;way to create new guild requests or view what requests you've already made. It's web-based, and is a useful tool to check out.<A href="http://eqlive.station.sony.com/guild_requests/intro_view.jsp"><BR></A></LI></OL>
<P>Good Luck with your Guild!</P>
