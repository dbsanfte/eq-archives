...
<tr>
	...
	<a href="?id=43095" class="tinylink">The Races</a><br>
...
<h1>Bind Points</h1>
<FONT size=2>
<P>Here are the top 10 zones that characters are currently bound in, across all worlds. (This includes the default binding at your home city.):</P>
<P>
<CENTER>
<TABLE cellSpacing=1 cellPadding=7 width=194 border=1>
<TBODY>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Greater Faydark</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>17%</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>West Freeport</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>13%</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Nektulos Forest</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>8 %</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>North Qeynos</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>7 %</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Field of Bone</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>6 %</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Everfrost</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>5 %</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Misty Thicket</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>4 %</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Steamfont Mountains</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>4%</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Butcherblock Mtns.</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>4%</FONT></P></TD></TR>
<TR>
<TD width="76%"><FONT size=2>
<P align=left>Feerrott</FONT></P></TD>
<TD width="24%"><FONT size=2>
<P align=left>3%</FONT></P></TD></TR></TBODY></TABLE>
<P></P>
<P>&nbsp;</P><FONT size=2></CENTER>
<P>You may well recognize these as the starting zones for most races? I did too, so I filtered out all characters Level 8 or under.</P><FONT size=2>
<P>Surprisingly, most of the same zones showed up in a slightly different order:</P><FONT size=2>
<P align=center>West Freeport<BR>Greater Faydark<BR>East Freeport<BR>Field of Bone<BR>Nektulos Forest<BR>North Qeynos<BR>Firiona Vie<BR>Everfrost<BR>Shadow Haven<BR>Bazaar</P><FONT size=2>
<P>I will let you draw your own conclusions. It seems that Freeport is just THE place to be seen these days.</P><FONT size=2>
<P>Intrigued by my research, I looked deeper:</P><FONT size=2>
<P>
<UL>
<LI>The zones with the least people bound in are: Kurn's Tower, The Deep and Ssra's Temple. 
<LI>Over 1.5 Million people are currently bound in Greater Faydark. That is a lot of Elves! 
<LI>At this time, 8 suicidal people are bound in Sleeper's Tomb. 
<LI>2800 people are bound on The Planes.</LI></UL>
<P></P><FONT size=2>
<P>Finally, this little gnoll was interested in the distribution of Bind Points across the continents:</P>
<P>
<CENTER>
<TABLE cellSpacing=1 cellPadding=7 width=169 border=1>
<TBODY>
<TR>
<TD width="56%"><FONT size=2>
<P>Antonica</FONT></P></TD>
...
<P>Planes</FONT></P></TD>
<TD width="44%"><FONT size=2>
<P>0.03 %</FONT></P></TD></TR></TBODY></TABLE>
<P></P></FONT></FONT>
<DIR><FONT size=2>
<P>&nbsp;</P></DIR></FONT></FONT></FONT></FONT></FONT></FONT></FONT></CENTER>
<P>-Fippy</P>
