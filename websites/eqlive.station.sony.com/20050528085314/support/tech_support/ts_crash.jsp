...
<P ALIGN="center"><STRONG><BR><STRONG>General Tips for Crashing or Freezing During Gameplay</STRONG></STRONG></P>  <P>&nbsp;</P>  <P><STRONG>Quick Suggestions to Remedy Crashing or Freezing:</STRONG></P>  <P>&nbsp;</P>  <P>First, if you have not already done so, you will want to make sure you
  ...
  voice-capable modems and sound cards. Aside from causing crashes, this
  conflict can also cause the Voice Modem to &quot;steal&quot; sound from your
  Sound Card, effectively turning it off in the game. Go to the &quot;Sound,
  Video, and Game Controllers&quot; section of the Device Manager (right click
  on your &quot;My Computer&quot; icon and choose &quot;Properties&quot;). You
  will see a listing for &quot;Wave Device for Voice Modem&quot; or something
  similar. Double click on this entry and mark the &quot;Disable in this
  Hardware Profile&quot; option. Most people never use the Voice functions on
  their modems, so disabling this will not change the way you connect to your
