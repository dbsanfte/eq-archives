...
<P ALIGN="center"><STRONG><BR><STRONG>General Audio Troubleshooting</STRONG></STRONG></P>  <P><STRONG>Is the
  ...
  completely replaced. Make sure you have the latest drivers for your sound card
  installed. To get the drivers we've currently tested, please visit the <A HREF="../../../../../support/tech_support/ts_audio.jsp">Supported Sound Cards</A>&nbsp;section.</P>  <OL>   <LI>If you have another video game that uses
       ...
       Vortex-based card - but it won't play games, only the demo. (They were the
       wrong drivers.)</LI>   <LI>Make sure there are no conflicts in the
  ...
  hear any music, then unload any sound fonts in the SoundFont area of the AudioHQ
  control panel. Load the default 2Mb GENERAL MIDI sound font that comes with
  the SBLive (default location is &quot;C:\\\\\\\\Program
  ...
  Multimedia, MIDI console). Each should sound different if the Windows multimedia
  system is working. If the sound font doesn't play correctly, then the problem
  may lay inside Windows itself. Please contact the vendor of the questionable
  hardware to determine the nature of the problem within the OS.</P>  <P>If you are
