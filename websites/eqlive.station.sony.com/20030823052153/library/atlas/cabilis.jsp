	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/cabilis.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/cabilis.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/cabilis.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                                          ...
                                          <td height="111"> 
                                            <div align="center"> 
                                              ...
                                              <table border="0" width="90%">
                                                <tr> 
                                                  <td width="110"> 
                                                    <div align="center"><a href="kunark.jsp"><img src="images/map_back.gif" width="106" height="37" border="0" alt="BACK TO FAYDWER MAP"></a></div>
                                                  </td>
                                                  <td> 
                                                    <div align="center"><img src="images/mc_cabilis_title.gif" width="131" height="34"></div>
                                                  </td>
                                                </tr>
                                              </table>
                                              <p align="justify">&nbsp; 
                                      ...
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          ...
                                          <td width="350" height="426"> 
                                            <div align="center"><img src="images/mc_cabilis.jpg" width="497" height="560" usemap="#CITIES" border="0"></div>
                                          </td>
                                          <td> 
                                            <center>
                                              &nbsp; 
                                          ...
                                          <tr> 
                                            ...
                                            <td valign="top"> 
                                              <p><font size="4" color="#000000"> 
                                                ...
                                                Court of Pain<br>
                                                The Block<br>
                                                Temple of Terror</font><font color="#000000"><br>
                                                <font size="4">The Gauntlet </font></font></p>
                                            </td>
                                            <td align="center" valign="top"> 
                                              <p><font size="4" color="#000000"> 
                                                F.<br>
                                            ...
                                            <td valign="top"> 
                                              <p><font size="4" color="#000000">Fortress 
                                                Talishan<br>
                                                To Warslick's Woods <br>
                                                To the Field of Bone<br>
                                                To the Lake of Ill Omen<br>
                                                To the Swamp of No Hope </font></p>
                                            </td>
                                          </tr>
                                        </table>
                                      </div>
                                      ...
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        <tr> 
                                          <td height="128"> 
                                            <div align="center"><br>
                                              <center>
                                                <p><font face="Times New Roman, Times, serif"><a href="kunark.jsp" class="maplink">Back 
                                                  to Kunark map</a></font></p>
