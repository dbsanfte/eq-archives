...
<h2>EverQuestLive.com Enhancements</h2>
Today we debut three new features on the EverQuestLive.com site. First, we've moved the Developers' Corner from the aging UBB system to the front page. This is part of our ongoing effort to continually improve EverQuestLive.com and to create a more dynamic source of EQ news for the community. It began with the <A href="/lowsrc/community/hammerfel.jsp?id=41103">redesign</A> and will continue as we add even more content and functionality. We're also adding "slugs" to the news entries on the front page (Absor prefers to use the more civilized term, 'taglines') to summarize each entry for your skimming pleasure. 
