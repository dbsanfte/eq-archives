...
<P ALIGN="center"><STRONG><BR><STRONG>Troubleshooting Stuck Characters</STRONG></STRONG></P>  <P>If you are having troubles accessing only one of your characters from the
  server select screen then please follow the directions below in order to
  remedy your problem.</P>  <P>First, exit the game to your Windows desktop, and double click on the
