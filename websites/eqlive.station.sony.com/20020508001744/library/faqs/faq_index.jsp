...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_index.jsp?null');">
...
<P><A href="/library/rates/rate_faq.jsp">EverQuest Price Increase FAQ&nbsp;</A><BR>On April 25, 2002, the subcription rate for EverQuest increased to $12.95 per month. Check out this FAQ for all the details.<BR></P>
