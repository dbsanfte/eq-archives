	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=<%=HttpUtils.getRequestURL(request).toString()+'?'+request.getQueryString()%>" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=<%=HttpUtils.getRequestURL(request).toString()+'?'+request.getQueryString()%>', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <p>Bienvenue dans le système d'enregistrement des guildes 
                          ...
                          de création de guilde, consulter vos précédentes requêtes 
