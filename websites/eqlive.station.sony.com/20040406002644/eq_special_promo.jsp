	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/eq_special_promo.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/eq_special_promo.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/eq_special_promo.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Terms&nbsp;Of&nbsp;Service</font></b></div>
                        <!-- #EndEditable --></td>
...
<STRONG>EverQuest Fifth-Year Anniversary 12-month Subscription Plan</STRONG> 
<P>Between March 16th, 2004 and March 30th, 2004, you can extend your current, valid EverQuest account for an additional 12 months or begin a new 12-month EverQuest account by signing up for the EverQuest Fifth-Year Anniversary 12-month Subscription Plan and reap great savings. 
<UL>
<LI>An EverQuest Fifth-Year Anniversary 12-month Subscription account costs only US$99.99-- that's only $9.08 a month, a huge 36% discount off of the current EverQuest monthly rate! </LI></UL>
<P>Terms: 
<P>Cost: $99.99 (plus taxes, if applicable). Residents of VAT-applicable European Union territories will also be charged a VAT tax equal to 17.5% of the applicable fee. 
<P>By electing the EverQuest Fifth-Year Anniversary 12-month Subscription Plan, you acknowledge and agree to all of the following: 
<P>This subscription enables one EverQuest account for twelve (12) months. SOE does not give full or partial refunds for unused subscription periods. 
<P>To be eligible for the EverQuest Fifth-Year Anniversary 12-month Subscription Plan, you must have a current, valid, EverQuest account on an SOE server (version of EverQuest published and hosted by SOE and not published or hosted by SOE partners outside of North America) that is not suspended or banned and is otherwise in good standing. EverQuest accounts registered on non-SOE servers, accounts using the GlobalCollect payment method with payment pending, EverQuest accounts being used in connection with combination subscription pricing plans like the SOE All Access plan (including EverQuest: Legends accounts that have also been enabled for the SOE All Access plan), or the Station Pass, EverQuest: Legends subscribers, EverQuest accounts currently suspended, banned, not otherwise in good standing, or registered with a promotional or provisional account key are not eligible. 
<P>The EverQuest Fifth-Year Anniversary 12-month Subscription Plan requires a valid credit card. If you currently use either a GameCard or GlobalCollect payment method for your EverQuest account, you must provide SOE with a valid credit card upon your election to subscribe to the EverQuest Fifth-Year Anniversary 12-month Subscription Plan. The new EverQuest Fifth-Year Anniversary 12-month Subscription Plan will take effect at the end of your current billing cycle and your credit card will then be billed at the end of your current billing cycle. 
<P>The EverQuest Fifth-Year Anniversary 12-month Subscription fee is a recurring charge; that means that, unless and until you cancel your account, you authorize SOE to charge your credit card the subscription amount at the beginning of each subscription period.&nbsp;Your use of the EverQuest software under the EverQuest Fifth-Year Anniversary 12-month Subscription plan and your game play remains strictly subject to the EverQuest User Agreement and Software License (and Rules of Conduct), as each may be amended or modified by SOE at any time in its sole discretion. 
<P>Your use of the EverQuest software under the EverQuest Fifth-Year Anniversary 12-month Subscription plan and your game play remains strictly subject to the EverQuest User Agreement and Software License (and Rules of Conduct), as each may be amended or modified by SOE at any time in its sole discretion. 
<P>Any account converted to the EverQuest Fifth-Year Anniversary 12-month Subscription plan during any no-charge subscription period will be immediately converted, and the remainder of such period(s) will be waived. </P>
