...
<title>EverQuestLive.com - Future Plans</title>
<!-- #EndEditable -->
		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/future_plans.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/future_plans.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
...
//window.alert(document.cookie);
	...
	<P><STRONG><U>A Message from the President</U></STRONG> 
<P>Greetings Norrathians, 
<P>Over the course of the next week you will be hearing a lot from SOE about <EM>EverQuest II</EM>. It's coming along extremely well, and it's something that we as a company are very proud of. We hope that when it is released you'll feel it lives up to its distinguished heritage. 
<P>All the talk about <EM>EQ II</EM> will lead many of you to ask the logical question: 
<P>What about <EM>EverQuest</EM>? 
<P>The simple answer is this: We are going to continue to support <EM>EverQuest</EM>. As a matter of fact, we have two new expansions in the works. The first one's coming this Fall, and its focus is on dungeons! Many members of the <EM>EQ</EM> team are already hard at work on it. We've increased the size of the <EM>EverQuest</EM> team to add more amazing things to the game, to further expand places you've explored before and to continue to update the game on a constant basis. Our goal is to make sure <EM>EverQuest</EM> remains a dynamic game that continues to grow for years to come. We recognize that you've spent a lot of time in <EM>EQ</EM> over the years--so have we. Making this world exciting for you is our passion. 
<P>We are also working hard on making <EM>EverQuest</EM> a better experience. One of the ways we're doing this is by improving the way we communicate with you. From this point on you will see a constantly updated Web page that shows what we're working on for the next patch, and what's down the road a little further. This can be found at <A href="http://eqlive.station.sony.com/updates/">http://eqlive.station.sony.com/updates/</A> 
<P>Above all else, we want you to know that our commitment to this game is very real. 
<P>The goal behind EverQuest II is not to replace <EM>EverQuest</EM>, but to offer a new experience with new ways to play. 
<P>I've had the privilege over the past few years to see how the <EM>EQ</EM> and <EM>EQ II</EM> design teams have worked together to make sure <EM>EQ II</EM> has the heart and soul of <EM>EverQuest</EM>, but is still different enough to attract new people to the MMORPG genre, and even bring back some players that have moved on to other things. We think that many of you are as excited about <EM>EQ II</EM> as we are. If we do our jobs right, you'll feel like <EM>EQ II</EM> is a remarkable gaming experience that you'll want to play for many years to come, and that it's not just "<EM>EQ</EM> with a new graphics engine." The designers have found some great ways to link the two games and to make the games actually affect each other. You'll hear more about this in the very near future. 
<P>So, would you rather play in <EM>EverQuest II's</EM> Age of Destiny? Or does <EM>EverQuest's</EM> Age of Turmoil still have plenty of exciting things you want to do? Our goal is to make that decision simple! Having spent so much time in <EM>EverQuest</EM>, you might feel torn between which game you want to play more. We realize that many of you will want to play both <EM>EQ</EM> and <EM>EQII</EM>, so we're introducing the SOE All Access&#153; subscription. It allows you to play a large mix of our most popular offerings for only $21.99 per month. Our Legends customers will receive this same access to our games at no additional charge. This makes it affordable and easy to play SOE's games, including: 
<UL>
<LI><EM>EverQuest&reg;</EM> (both PC and Mac version when it's released) 
<LI><EM>EverQuest II&reg;</EM> (when released) 
<LI><EM>EverQuest&reg; Online Adventures&#153; </EM>
<LI><EM>PlanetSide&#153;</EM> 
<LI>Station Pass&#153; Games (<EM>Infantry&#153;</EM>, <EM>Cosmic Rift&#153;</EM>, <EM>Tanarus&reg;</EM>) </LI></UL>
<P>Please note that <EM>Star Wars Galaxies: An Empire Divided&#153;</EM> will not be a part of this package, nor will partner published games be included. You will also need to buy the retail version of any game you don't already own. 
<P>We think the SOE All Access subscription is a great way to play our games for one low monthly price. If you add up the value of all the games in this package individually, you can see that this subscription offers significant savings. This low price will allow you to check out <EM>EQ II</EM>, but still play <EM>EQ</EM>. We don't want your decision on which game to play to be made based on cost, but rather on the kind of gaming experience you're looking for. We're offering a lot of great quality games in this package just to make sure you feel like you're getting your money's worth. You'll be hearing more about this subscription over the next week. 
<P>We'll be putting up a link on <EM>EverQuest</EM>.com that will contain all of the pertinent information about the SOE All Access subscription in the next few days, so I urge you to visit <A href="http://www.soeallaccess.com/">www.SOEAllAccess.com</A>. 
<P>We at SOE would like to thank you very much for your continued support. 
<P>John Smedley<BR>President, Sony Online Entertainment</P>
<P><A href="http://www.sonyonline.com/corp/press_releases/EQ2_incentives_051303.html">Read about&nbsp;SOE's plans for EQ II incentives</A>.</P>


<p>
<span class="smalltitle">Archive:</span><br>

	<a href="?id=55884">A Message from the President, May 14, 2003</a><br>

	<a href="?id=55840">Further Down the Line - May 9, 2003</a><br>
