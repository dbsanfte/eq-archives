	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_installing_the_game.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_installing_the_game.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_installing_the_game.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P class=header align=center><SPAN class=header><FONT face="Arial, Helvetica, sans-serif"><STRONG><BR>Installing the Game</STRONG></FONT></SPAN></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2><B>Before installing EverQuest, make sure that your PC specifications meet or exceed the <A href="/support/tech_support/ts_system_requirements.jsp">minimum requirements</A>. </B></FONT></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Insert the EverQuest game CD into your CD-ROM drive. If your CD-ROM drive has the AutoPlay function enabled, the installation will begin automatically. If AutoPlay is not enabled, Open the "My Computer" icon on your desk top, double-click on the CD-ROM icon, then double-left-click on "setup.exe". The installation process will then commence.</FONT></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>EverQuest requires at least 600MB of free disk space to install.</FONT></P>
<OL>
<OL>
<OL>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Select a directory in which you would like to install EverQuest. The default directory is C:\Program Files\EverQuest. If you would like to install the files into a different directory, change the path and proceed. If the directory does not exist, create a directory name (Example: C:\Program Files\Eqrules), then proceed. </FONT>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Installing the DirectX drivers:<BR><BR>After the installation of EverQuest, an option to install DirectX to your hard drive will be given. Select "Yes" to proceed, then follow the on-screen instructions. If you already have a better version of DirectX installed, you will be told that no update is possible.</FONT> 
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>After completing the installation, you will be prompted to restart your computer, select "Yes" and allow your system to reboot. </FONT></LI></OL></OL></OL>
<OL>
<OL>
<OL>
<P align=center><B><FONT face="Arial, Helvetica, sans-serif" size=2>DirectX 8.1 or Higher Required </FONT></B></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>With the release of EverQuest: The Shadows of Luclin expansion pack, we require DirectX 8.1 or higher. This is true not only for those purchasing Shadows of Luclin, but for everyone playing EverQuest. All details regarding this change can be found here: <A href="http://www.microsoft.com/windows/directx/default.asp">http://www.microsoft.com/windows/directx/default.asp</A></FONT></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>To determine what version of DirectX is currently installed on your system:</FONT></P>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Click the Start menu. </FONT>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Use the Run.. command.. </FONT>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>In the Open field, type "DXDIAG" then click OK. This will launch the DirectX diagnostics tool. </FONT>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Your version of DirectX will be listed at the bottom of the System Information area. For example, version 7.0a is listed as "DirectX 7.0 (4.07.00.0716)"</FONT></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Please do the following prior to playing EverQuest. It is very important that your drivers are installed in the order indicated to avoid potential problems:</FONT></P>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to <A href="https://www.microsoft.com/downloads/search.aspx?displaylang=en&amp;categoryid=2">https://www.microsoft.com/downloads/search.aspx?displaylang=en&amp;categoryid=2</A>&nbsp;and install the latest DirectX drivers for your operating system.</FONT> 
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to the website for your 3D accelerator. There are a number of different manufacturers, and it is preferred that you visit the website for the manufacturer of your card. At your option, you can go to the chipset manufacturer site. Most will be able to use either <A href="http://www.3dfx.com/t_blank">www.3dfx.com</A> (for Voodoo cards), <A href="http://www.atitech.com//t_blank">www.atitech.com</A> (for ATI cards) or <A href="http://www.nvidia.com/t_blank">www.nvidia.com</A> (for TNT/GeForce cards). Download and install the latest drivers appropriate for your card and operating system. See our <A href="/support/tech_support/ts_video.jsp">Supported Video Card list</A> and <A href="/support/tech_support/ts_install_av_drivers_xp.jsp">Driver Installation Guide</A> for more details.</FONT> 
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to the website for your sound card manufacturer and do the same. If you do not know what brand of sound card you have, you can right-click on "My Computer", select "properties", click on "Device Manager", and open the "Sound, Video, and Game Controllers" section. Your sound card will be listed there. If you use a SBLive sound card, you can run "LiveUpdate" from the Windows Control Panel off of your start menu. View our <A href="/support/tech_support/ts_audio.jsp">Supported Sound Card</A> list and <A href="/support/tech_support/ts_install_av_drivers_xp.jsp">Driver Installation Guide</A> for driver locations and more details. </FONT>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>If you experience any problems, please do the following:</FONT></P>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Run DXDIAG.EXE from your Start menu (click start, run, then type "dxdiag") </FONT>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Click the "Save all Information" button at the bottom of the program window. </FONT>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Save the file as "dxdiag.txt" </FONT></LI></OL></OL></OL>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Email that file to <A href="mailto:eqtech@soe.sony.com">eqtech@soe.sony.com</A> along with a complete description of your problem, the "dbg.txt" file from your EverQuest directory, the text from any error messages that are presented, and if you are willing to assist our test department over the phone, a phone number where you can be reached.</FONT></P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>
<P>If you are still having problems after visiting this support section, you can contact our Technical Support Department through <A href="mailto:eqtech@soe.sony.com">email</A>.</P></FONT>
<P></P>
<P align=center><FONT face="Arial, Helvetica, sans-serif" size=2><BR></FONT></P>
