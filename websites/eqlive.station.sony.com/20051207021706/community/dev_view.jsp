...
<tr>
	...
	<a href="dev_view.jsp?id=64124" class="tinylink">Halfling Hodgepodge Extreme</a><br>
	
	<a href="dev_view.jsp?id=64128" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64127" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64126" class="tinylink">Depths of Darkhollow Beta Participants</a><br>
	
	<a href="dev_view.jsp?id=64120" class="tinylink">Halfling Hodgepodge Extreme</a><br>
	
	<a href="dev_view.jsp?id=64119" class="tinylink">Happy Halloween!</a><br>
	
	<a href="dev_view.jsp?id=64118" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64117" class="tinylink">Dev Chat at House
  of Commons - Thursday October 27, 2005</a><br>
...
<option value="64124">Halfling Hodgepodge Extreme 11/28/2005</option>


<option value="64128">Halfling Hodgepodge 11/18/2005</option>


<option value="64127">Halfling Hodgepodge 11/11/2005</option>


<option value="64126">Depths of Darkhollow Beta Participants 11/09/2005</option>


<option value="64120">Halfling Hodgepodge Extreme 10/31/2005</option>


<option value="64119">Happy Halloween! 10/27/2005 5:30 PM PST</option>


<option value="64118">Halfling Hodgepodge 10/27/2005</option>


<option value="64117">Dev Chat at House
  of Commons - Thursday October 27... 10/25/2005</option>
...
<h1>Halfling Hodgepodge Extreme</h1>
<P>Welcome to Halfling HodgePodge Extreme!&nbsp; Your resident Community Halflings
  collected questions from the EQ Community then presented a selection of these
  questions to the EQ Developers.&nbsp;
  Here are the questions we selected and the responses to those
  questions!</P>  <P><EM>&nbsp;</EM></P>  <P><EM>Can you add more
  searching options for the /Barter window?&nbsp; If there are more than 200 buy lines,
  you can't view them all.&nbsp; It would
  be nice if we could at least search by /Buyer name and see all buy lines
  posted by that buyer. </EM></P>  <P>This stuff is technically feasible.&nbsp; When the feature was first designed it
  was assumed that, since you had the item, you'd be able to specify it by name
  when looking to see if anyone wanted it.&nbsp;
  More and more people seem to be doing vendor diving for barter buyers,
  though, which makes these requested features more useful.</P>  <P><EM>Since we now have a
  button to turn on/off helms in options, why can't this be done for switching
  between tunics and robes for monks? </EM></P>  <P>From a purely technical standpoint, these are 2 completely
  different things.&nbsp; Turning helms
  on and off merely is a flag to determine whether we should display the helm
  model associated with the item, or just display as if you weren't wearing a
  helm.&nbsp; This is why it didn't add
  helm graphics to helms that didn't already have them, as that would require
  going through all those items and specifying a graphic look.&nbsp; The tunic/robe thing would require
  adding a new field to the items specifying their &quot;alternative&quot;
  model, and a designer would then have to populate that field for everything. &nbsp;Why can't it be done?&nbsp; Well, it probably can, but it would
  take a lot more time than the helm thing did, and not just programmer time.</P>  <P><EM>Will the Spell
  Research skill get a trophy, now that it's a &quot;real&quot; tradeskill?</EM></P>  <P>One of the things that we've been discussing lately has
  been the possibility of extending the current line of trophies to be tiered,
  instead of just one trophy at 250 skill. The benefits of this would allow us
  to upgrade the trophies if / when we increase the tradeskill caps again, as
  well as reward those who have attained the higher skills with more stats and
  bigger modifiers. This extension would also include adding trophies for the
  skills that do not currently have any. </P>  <P><EM>Seriously though for
  tradeskilling many classes are not able to forage which means you either make
  an alt or pay massive bazaar prices. Why can&#8217;t there be more recipies
  that contain vendor drop items at the higher skill levels?</EM></P>  <P>Foraging is a beneficial skill that gives us a means of
  creating specific recipes aimed at a smaller section of the tradeskill
  community, however... It also should not be the gating factor for gaining
  skill points in any one specific tradeskill.</P>  <P>In many cases, the items that can be obtained via foraging
  are also able to be obtained via other means. This is a trend we plan on
  continuing as we move forward with as we introduce more recipes into the
  game. In the situations where a skill-up recipe does use foraged items, we'll
  make sure there's an equivalent recipe that uses a dropped counterpart. </P>  <P><EM>Why don't Troll
  Blacksmithing have the ability to make some old world cultural armor like the
  crimson darkscale or the fulvous darksplint or the blackened darkscale armor
  which are wearable by Trolls but can only be made by Ogres. </EM></P>  <P>This racial-gap in the 'old cultural' was one of the main
  concerns and causes of introducing the new cultural armor with Dragons of
  Norrath. We saw a number of gaps with the old cultural, as well as a need for
  upgrading the armor to something that more accurately reflected the content
  that players currently encounter in EverQuest. The new cultural fills in
  these gaps very well, so we currently have no plans to add any 'old cultural'
  recipes to the races that do not currently have it. </P>  <P><EM>Is fletching going
  to be fixed for non karana followers and/or foragers?</EM></P>  <P>We have several ideas on how to extend fletching beyond its
  current usefulness and limitations -- This includes adding additional means
  to obtain 300 skill for everyone, as well as adjusting the recipes which make
  it far too easy for certain races and / or classes to raise their skill.
  Without delving too deeply into the details, expect some changes in the near
  future (January / February timeframe). </P>  <P><EM>Can we get some
  details on the plans to address the tradeskill issues with regards to skill
  up paths?&nbsp; Specifically, tailoring
  for non-karana worshipers and fletching for non-wood elfs or non-karana
  worshipers have nearly impossible skill up paths to 300. </EM></P>  <P>This, much like the question asked above, is also on the
  board to be addressed by adding additional recipes as well as adjusting any
  of those recipes which are far too easy for certain races to gain skill
  with.&nbsp; </P>
