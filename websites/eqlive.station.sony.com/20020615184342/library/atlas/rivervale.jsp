...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/rivervale.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Atlas</font></b></div>
                        <!-- #EndEditable --></td>
                            ...
                            <center>
                              <center>
                                <table border="0" width="100%" cellspacing="0" cellpadding="0" background="images/parchtile.gif">
                                  <tr> 
                                    <td width="88"><img src="images/map_tree.gif" width="88" height="118"></td>
                                    <td width="100%"> 
                                          ...
                                          <td height="111"> 
                                            <div align="center"> 
                                              ...
                                              <table border="0" width="90%">
                                                <tr> 
                                                  <td width="110"> 
                                                    <div align="center"><a href="antonica.jsp"><img src="images/map_back.gif" width="106" height="37" border="0" alt="BACK TO ANTONICA MAP"></a></div>
                                                  </td>
                                                  <td> 
                                                    <div align="center"><img src="images/mc_rivervale_title.gif" width="172" height="34"></div>
                                                  </td>
                                                </tr>
                                              </table>
                                              <p align="justify">&nbsp; 
                                    ...
                                    <td align="right" valign="top" width="87"><img src="images/map_goblin.gif" width="82" height="118"></td>
                                  </tr>
                                </table>
                                <table border="0" width="100%" cellspacing="0" cellpadding="0" background="images/parchtile.gif">
                                  <tr> 
                                    <td width="2"><img src="images/seethru.gif" width="2" height="2"></td>
                                    <td bgcolor="#000000" width="2"><img src="images/seethru.gif" width="2" height="2"></td>
                                    <td> 
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td background="images/parchtile.gif">&nbsp; 
                                          </td>
                                          <td width="350" height="426"> 
                                            <div align="center"><img src="images/mc_rivervale.jpg" width="500" height="650" usemap="#CITIES" border="0"></div>
                                          </td>
                                          <td background="images/parchtile.gif"> 
                                            <center>
                                              &nbsp; 
                                      ...
                                      <div align="center"> 
                                        <table border="0" width="90%" align="center" background="images/parchtile.gif">
                                          <tr> 
                                            <td align="center" valign="top"> 
                                              <p><font size="4" color="#000000">A.<br>
                                                B.<br>
                                                C.</font></p>
                                            </td>
                                            <td valign="top"><font size="4" color="#000000"> 
                                              Chapel of Mischief<br>
                                              The Guardian Stronghold<br>
                                              Tagglefoot’s Farmstead</font></td>
                                            <td align="center" valign="top"> 
                                              <p><font size="4" color="#000000">D.<br>
                                                E.<br>
                                                F.</font></p>
                                            </td>
                                            <td valign="top"> 
                                              <p><font size="4" color="#000000">The 
                                                Fool’s Gold<br>
                                                To The Misty Thicket<br>
                                                To The Kithicor Woods</font></p>
                                            </td>
                                          </tr>
                                        </table>
                                      </div>
                                      <table border="0" width="100%" background="images/parchtile.gif">
                                        <tr> 
                                          <td><img src="images/seethru.gif" width="500" height="1">&nbsp; 
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                ...
                                <table border="0" width="100%" cellspacing="0" cellpadding="0" background="images/parchtile.gif">
                                  <tr> 
                                    <td width="107"><img src="images/map_gargoyle.gif" width="107" height="139"></td>
                                    <td width="100%"> 
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        <tr> 
                                          <td height="128"> 
                                            <div align="center"><br>
                                              <center>
                                                <p><font face="Times New Roman, Times, serif"><a href="antonica.jsp" class="maplink">Back 
                                                  to Antonica map</a></font></p>
                                    ...
                                    <td align="right" width="157"><img src="images/map_skeleton.gif" width="152" height="139"></td>
                                  </tr>
                                </table>
                              </center>
                            </center>
