...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">42,206 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/sz_rule_sets.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/sz_rule_sets.jsp');">
...
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Characters will not lose experience when killed in PvP combat, under most circumstances, although the occasional loss of experience is to be expected.</FONT> 
...
<P align=left><FONT face=Arial size=2><STRONG>Firiona Vie (A roleplayint preferred server)</STRONG></FONT></P>
