...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">41,530 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/community/hammerfel.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/community/hammerfel.jsp');">
...
<tr>
	...
	<a href="?id=51304" class="tinylink">EverQuestLive.com Enhancements</a><br>
...
<h1>EverQuestLive.com Enhancements</h1>
Today we debut three new features on the EverQuestLive.com site. First, we've moved the Developers' Corner from the aging UBB system to the front page. This is part of our ongoing effort to continually improve EverQuestLive.com and to create a more dynamic source of EQ news for the community. It began with the <A href="/community/hammerfel.jsp?id=41103">redesign</A> and will continue as we add even more content and functionality. We're also adding "slugs" to the news entries on the front page (Absor prefers to use the more civilized term, 'taglines') to summarize each entry for your skimming pleasure. 
<P>The Community news block has a new 'Submit News' link. Feel free to use this to inform us of fan site news, server events, and anything else community-oriented that you'd like to share. 
<P>We've also added a minimize function to the 5 content blocks, Dev Corner, Headlines, Community, Tech Support and Server Status. EverQuestLive.com has a lot of information to display, and now you can customize that information to your tastes while making more efficient use of screen real estate. Minimize the areas you're not interested in, and a cookie remembers your preference for your future visits. This function is only available to users of Internet Explorer 4.0 and above. <BR>
<P align=center><IMG src="/community/images/hammerfel/minimize_example.gif"></P>
<P>I'd also like to thank everyone for their continuing support and suggestions for the site. Your input is very valuable. :)</P>
