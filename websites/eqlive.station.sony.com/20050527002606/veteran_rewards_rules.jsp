...
<title>EverQuestLive.com - Veteran Rewards Rules</title>
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/veteran_rewards_rules.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/veteran_rewards_rules.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/veteran_rewards_rules.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Rules</font></b></div>
                        <!-- #EndEditable --></td>
...
<P><STRONG><U>EverQuest
  Sixth-Year Anniversary 12-month Subscription Plan<BR><BR></U></STRONG>Between April 11<SUP>th</SUP>, 2005 and May 11<SUP>th</SUP>, 2005, you
  can extend your current, valid EverQuest account for an additional 12 months
  or begin a new 12-month EverQuest account by signing up for the EverQuest
  Sixth-Year Anniversary 12-month Subscription Plan.&nbsp; <BR><BR>Terms: <BR><BR><U>Cost</U>:&nbsp; $99.99 (plus taxes,
  if applicable).&nbsp; Residents of
  VAT-applicable European Union countries or territories will also be charged
  VAT (value-added tax) equal to 17.5% of the applicable fee.&nbsp; Game software is sold separately.<BR><BR>By electing the EverQuest Sixth-Year Anniversary 12-month Subscription Plan,
  you acknowledge and agree to all of the following:<BR><BR>This subscription enables one EverQuest account for twelve (12) months. SOE
  does not give full or partial refunds for unused subscription periods.<BR><BR>To be eligible for the EverQuest Sixth-Year Anniversary 12-month Subscription
  Plan, you must have a current, valid, EverQuest account on an SOE server
  (version of EverQuest published and hosted by SOE and not published or hosted
  by SOE partners outside of North America) that is not suspended or banned and
  is otherwise in good standing.&nbsp;
  EverQuest accounts registered on non-SOE servers, accounts using the
  GlobalCollect payment method with payment pending, EverQuest accounts being
  used in connection with combination subscription pricing plans like the Station
  Access&#8482; plan (including EverQuest: Legends accounts that have also been
  enabled for the Station Access plan), or the Station Pass, EverQuest: Legends
  subscribers, EverQuest accounts currently suspended, banned, not otherwise in
  good standing, or registered with a promotional or provisional account key
  are not eligible.<BR><BR>The <A>EverQuest Sixth-Year Anniversary 12-month
  Subscription Plan </A>requires a valid credit card.&nbsp; If you currently use either a GameCard
  or GlobalCollect payment method for your EverQuest account, you must provide
  SOE with a valid credit card upon your election to subscribe to the EverQuest
  Sixth-Year Anniversary 12-month Subscription Plan.&nbsp; </P>  <P>The EverQuest Sixth-Year Anniversary 12-month Subscription
  fee is a <STRONG><U>recurring</U></STRONG> charge;
  that means that, unless and until you cancel your account, you authorize SOE
  to charge your credit card the subscription amount ($99.99 plus applicable
  taxes) immediately upon signing up for the Sixth-Year Anniversary 12-month
  subscription plan and again at the beginning of each subsequent 12-month
  subscription period. For this special offer, that means that you will be
  billed immediately in full on the day you initially sign-up for this special
  offer and then you will also be billed on the date that is 12 months from
  that date and so on.&nbsp; When your
  current EverQuest Sixth-Year Anniversary 12-month Subscription plan expires
  (the date that is 12-months from the end of your current EverQuest billing
  cycle), you will automatically be billed the full amount again unless you
  have affirmatively cancelled your EverQuest account using the prescribed
  methods of cancellation.&nbsp; SOE
  reserves the right, at any time in its sole discretion, to add new pricing
  options to EverQuest.<BR><BR>Your use of the EverQuest software under the EverQuest Sixth-Year Anniversary
  12-month Subscription plan and your game play remains strictly subject to the
  EverQuest User Agreement and Software License (and Rules of Conduct), as each
  may be amended or modified by SOE at any time in its sole discretion.<BR><BR>All prepaid but unused amounts for any EverQuest account that is converted to
  the Sixth-Year Anniversary 12-month Subscription Plan will be, at the time
  SOE converts the account, converted to days at the Sixth-Year Anniversary
  12-month Subscription Plan rate, and the first subscription period for that
  account will be extended by the applicable number of days. Any account
  converted to the EverQuest Sixth-Year Anniversary 12-month Subscription plan
  during any no-charge subscription period will be immediately converted, and
  the remainder of such period(s) will be waived.</P>  <P>&nbsp;</P>  <P ALIGN="center"><A HREF="http://eqlive.station.sony.com/news_section/newsview.jsp?story=50003">Back
  to Veteran Rewards details</A> | <A HREF="https://store.station.sony.com/subscriptions/subscription.jsp">Start an
  EverQuest Sixth-Year Anniversary Plan</A></P>
