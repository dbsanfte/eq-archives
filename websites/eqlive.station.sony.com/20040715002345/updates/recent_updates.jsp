...
<h1>July 14, 2004</h1>
<P>7/14/2004</P>
<P>Headlines!<BR>-------------------<BR>Veeshan's Peak has been re-worked.&nbsp; Enjoy the new challenge.<BR>A new Adventure Zone appears on Stormhammer.<BR>You can now remove augments without losing them.</P>
<P>Veeshan's Peak!<BR>-------------------<BR>With this revamp we have Updated the level and NPC list for the zone: Please note that this zone is now an elemental level zone!&nbsp; The entry quest to Veeshan's Peak has been changed. The original key quest has not been modified.&nbsp; However, the new entry quest uses the old key and offers an alternate quest to do instead of the original key quest. </P>
<P>- Items in the zone are now of elemental planes quality.<BR>- Faction now matters: Dragons in Veeshan's Peak will now speak to players if you have the correct faction and can understand them.<BR>- New quests and lore: The dragons in Veeshan's Peak will now give players the option to acquire items through questing for them.<BR>- The zone is now an exp zone as well: Hunting in the areas before the dragons yields experience and loot.</P>
<P><BR>New Adventure Zone for Stormhammer<BR>-------------------<BR>Stormhammer gains a new adventure zone. This is a 2 group adventure zone for characters of level 65.&nbsp; </P>
<P>Can you help the Eldritch Collective find and rescue Professor Bartleby Beckelbracker?&nbsp; Search the Desert of Ro for the whereabouts of Bartleby and his assistant Bomo and try to save them from the steel clutches of their enemies.</P>
<P><BR>Augment Removal *<BR>-------------------<BR>- You can now purchase special "distillers" that will remove augmentations without destroying them.&nbsp; These distillers are sold by a merchant in Butcherblock.&nbsp; The item inspect window for an augmentation will tell you which distiller is required to remove it.</P>
<P>- The existing solvents can still be used to destroy an augmentation if you don't want to keep it.&nbsp; You no longer need a different solvent for each augmentation slot.&nbsp; The interface will allow you to select which augmentation you wish to delete.</P>
<P>- For those with custom UI's, you will need to update your EQ_Container.xml file in order to use the new augment window.</P>
<P><BR>Pets *<BR>-------------------<BR>- Zoning pets are in. Persistent pet data includes: Items, Spell Effects, hit points, mana, name, height, and mana cost to summon them. All PC summoned pets should zone with you in all instances except for when you die. Pets will also follow the same rules as no rent items if you log with a pet.</P>
<P>- Pets can be shrunk again. Please wash them in only Cold water to prevent inadvertently reducing their size.</P>
<P><BR>Tribute Changes *<BR>-------------------<BR>- Some items have had their favor value lowered.</P>
<P>- Players will now "Pre-pay" for tribute benefits. When benefits are activated, the player will immediately be charged for those benefits from their Favor pool. After that, the player will be charged every 10 minutes for the next 10 minutes of benefit. If benefits are deactivated before the timer is depleted, no refund is given for the time remaining.</P>
...
<P>- When visiting a Tribute Master, the player's benefits will deactivate. Players may re-organize their selected benefit load, but will not be able to "preview" the benefits (seeing the effect on their character when the benefit is selected). Benefit descriptions should give the player a good indication of what the benefit will do when activated.</P>
<P>- The EQ Label that shows the Tribute Benefit Timer will now show green when benefits are active and gray when they are not.</P>
<P><BR>Item Changes<BR>-------------------<BR>- Manastones will no longer work in Forgotten Halls.&nbsp; It was not intended for the item to be used there and some naughty folks were taking advantage of the zone.</P>
<P>- Malcohm Thimbleton, in the Plane of Knowledge will now swap out some Robe Graphic items for Tunic Graphics. *</P>
<P>- The Staff of Revealed Secrets now has a 2hb weapon model instead of the little stick it had before.&nbsp; Enjoy your bigger stick.</P>
<P><BR>UI Changes<BR>-------------------<BR>- It is now possible to display your mana as a numeric value on your inventory screen. *<BR>- By mousing over your buff icons, you will now be able to see the buffs remaining duration. *</P>
<P>Berserkers<BR>-------------------<BR>- Berserkers now have innate crits beginning at level 12.<BR>- Tainted Axe of Hatred now comes in stacks of 20.</P>
<P><BR>Additional Notes<BR>-------------------<BR>- You now have the ability to sell back LDoN items and augments to the adventure merchants for a percentage of their original cost. *</P>
<P>- We have increased the number of NPC debuff slots from 30 to 50.&nbsp; Necromancers rejoice. *</P>
<P>- The Doppleganger AA's re-use timer has been reduced to 30 minutes. *</P>
<P>- Sprint and Planeswalk have had their movement rate increased. *</P>
<P>- Beware!&nbsp; Many named mobs in Gates will now summon. </P>
<P>- The Hide all traders option, for the Bazaar, will no longer need to be reset each time you enter the zone. *</P>
<P>- /stopspellcast will no longer give spells recast delays.</P>
<P>- Leadership: Group/Raid mark npc should now update for people that are added to the group or raid.</P>
<P>- Main assist will no longer clear if the main assist zones.</P>
<P>- Bards should once again play the stringed instrument animation when playing a stringed instrument song.</P>
<P>- Hynid fleshrippers, tide feasters, and shore stonemites in Natimbi no longer hit so hard.</P>
<P><BR>-- The EverQuest Team</P>
<P>*Denotes a change requested by the community</P>
