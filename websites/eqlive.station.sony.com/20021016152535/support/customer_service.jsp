...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">644 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service.jsp');">
...
<P>Our Customer Service Department will provide answers to your EverQuest questions on a wide range of topics, from player conduct, our user agreement specifics, the latest game patches, compatible system requirements, to all glitches and problems with game play and navigation.</P>
<P><A href="http://help.station.sony.com/esupport/esupport/consumer/esupport.asp">Knowledge Base</A><BR>Your first stop for all support. </P>
<P><A href="https://store.station.sony.com/eq_char_moves/">Character Transfer Service</A><BR>A fee-based service for moving your characters between servers or accounts. </P>
<P><A href="/support/customer_service/cs_rules_of_conduct.jsp">Rules of Conduct</A><BR>A must read. </P>
<P><A href="/support/customer_service/cs_naming_policy.jsp">Naming Policy</A><BR>Don't get caught with a bad name. Check out this policy to better immerse yourself in Norrath. </P>
<P><A href="/support/customer_service/cs_reimbursement.jsp">Reimbursment Policy</A><BR>Items are lost at times. Check here for our policy and getting that item back to you. </P>
<P><A href="/support/customer_service/cs_guilds.jsp">Guild Information<BR></A>A quick guide to guild creation,&nbsp;joining and quitting a&nbsp;guild, guild commands, and guild wars.&nbsp;</P>
<P><A href="/support/customer_service/cs_common.jsp">Common Game Play Questions</A><BR>Not the answer to the meaning of life, but it couldn't hurt to read them. </P>
<P><A href="/support/customer_service/cs_security_main.jsp">Account Security</A><BR>Protecting yourself should always come first. </P>
<P><A href="/support/customer_service/cs_EULA.jsp">EULA</A><BR>End User's License Aggreement. You agree to this every time you click Accept on logging in to EQ.</P>
<P><A href="/support/customer_service/cs_security_notices.jsp">COPPA and Privacy Notice</A><BR>How we use your information and guarding those 13 years of age and younger. </P>
<P><A href="/support/customer_service/cs_game_cards.jsp">Game Cards</A><BR>A different way to pay for your EverQuest subscription without using a credit card. </P>
<P><A href="/support/customer_service/cs_patch_message.jsp">Patch Message</A><BR>The latest patching information. </P>
<P><A href="http://eqlive.station.sony.com/library/faqs/faq_cs_contact.jsp">Customer Support Contact FAQ</A><BR>An extra aid when contacting a Customer Support Representative. </P>
<P><A href="http://www.station.sony.com/en/services/help/eqGM.jsp">Contact Your GM<BR></A>If you have not been able to find the answers you are looking for&nbsp;on EverQuest Live and by using our Knowledge base, this is another way to inquire about in-game support.&nbsp;</P>
