...
<tr>
	...
	<a href="recent_updates.jsp?id=64123" class="tinylink">November 16th,
   2005</a><br>
	
	<a href="recent_updates.jsp?id=64123" class="tinylink">October 27th, 2005</a><br>
	
	<a href="recent_updates.jsp?id=64122" class="tinylink">October 12th, 2005</a><br>
...
<h1>November 16th,
   2005</h1>
<P><STRONG>***
  Depths of Darkhollow***</STRONG></P>  <P>Many of the single group
  attainable rewards from the Depths of Darkhollow expansion have received
  significant upgrades.&nbsp; This includes more than 1,000 items from all over
  the expansion.&nbsp; Also, to allow players who have deleted items a chance
  to get them again, the rewards you get for completing a mission the first
  time are now given to you whenever you complete the mission and do not
  already have the reward.</P>  <P>We've also made many tuning
  changes to the DoD missions to provide a smoother ramp up in difficulty over
  the course of the expansion.&nbsp; In general, earlier missions are now a bit
  easier and missions further into the expansion are now a bit more
  challenging, particularly the hard level missions.</P>  <P><STRONG>***
  New Monster Missions ***</STRONG></P>  <P>- A gnollish zealot has been
  spotted near the bridge in South Karana.
  He speaks of the rift within Paw and the final whereabouts of the son of
  Ishva Mal. Perhaps there is still hope for the prisoners within.<BR>- The Solusek Mining Company has begun recruiting clockwork pilots for a
  special mission.&nbsp; Report to Clockwork Commander Widgetsworth in
  Lavastorm for further details. </P>  <P><STRONG>***
  Spells ***</STRONG></P>  <P>- Several of the abilities used by
  NPCs in the Demi-Plane of Blood have been modified.<BR>- The Enchanter spell Apathy of the Nihil has been replaced with Dreary
  Deeds, an upgrade to Forlorn Deeds.<BR>- E`ci's Frosty Breath and Glacier Breath are now much harder to resist.<BR>- Blood of the Spire is now a more potent mana preservation focus.<BR>- Ravenous Hunger has been changed. It is now named &quot;Ravenous
  Sloth&quot; and is a 40% duration extender on the spell &quot;Lingering
  Sloth&quot;.<BR>- The Aura of Arcanum line of spells should now have the correct spell
  description.</P>  <P><STRONG>***
  Items ***</STRONG></P>  <P>- Pumpkin lovers rejoice! Pumpkin
  items now stack.<BR>- The spell Servant of Marr now properly requires Ink of the Companion.<BR>- Some of the ores that did not stack before now stack. This is from a list
  provided by the community.<BR>- The drop rate on Shards of Dark Matter has been increased. The high-end
  Gates of Discord bosses will now drop at least one of them every time they
  are killed.<BR>- The weight on all versions of the Mask of Horror for the Halloween event
  has been decreased.<BR>- Ensorcelled Great Sword of the Night should now proc correctly for players
  at level 55 and greater who can wield the sword. The Greatsword is also more
  visually imposing.<BR>- All none/none flagged containers in the game are now flagged as all/all.
  This should fix some issues with containers not showing up in varied item
  searches in the bazaar and item point vendors.&nbsp; <BR>- Some of the &quot;Last Blood&quot; augmentations now have stronger focus
  effects.&nbsp; <BR>- Darkhollow Constitutional will now return a normal cork, not the dissolving
  kind.&nbsp; <BR>- Statuette of the Tranquil is now called &quot;Amice of the Tranquil&quot;
  and is a shoulder slot item. The AC has been increased and the avoidance has
  been replaced with accuracy. <BR>- Woven Shadow Shroud is now called &quot;Woven Shadow Stone&quot; and is a
  range slot item. The item now has points in backstab damage.&nbsp; <BR>- Razorsharp Shortsword is now not usable by berserkers.&nbsp; <BR>- Dragon Scale Tiara is now named &quot;Dragon Scale Eyepatch&quot;<BR>- Azure Sleeves of the Diplomat and Azure Cowl of the Diplomat have lost
  their +attack bonus.&nbsp; <BR>- Azure Slippers of the Diplomat have lost their attack bonus and have received
  a +2 to mana regen.&nbsp; <BR>- Eulogy, the Bloodthirsty Blade now has higher hit points. <BR>- Bard instruments will drop less frequently in the Demi-Plane of Blood and a
  maximum of once per kill.<BR>- The Insidious Hooded Cloak now has its specialization modifier set to
  alteration instead of conjuration.<BR>- The Ancient Werewolf Skull evolving item now has augmentation slots at each
  stage in evolution.<BR>- The Sharpshooting VI spell effect on Soulseeker, Death's Sigh is now worn
  instead of combat. <BR>- The Polished Chitin War Horn now has an augment slot.<BR>- Ancient Cudgel of Slaughter now has resistance modifiers. <BR>- Though it is still magnetic, a magnetic metal brick will no longer stick to
  your hands.&nbsp;&nbsp;&nbsp;&nbsp; </P>  <P><STRONG>***
  Missions, Tasks &amp; Quests ***</STRONG></P>  <P>- Adjusted the experience reward
  for monster missions to better reflect the amount of effort the mission
  requires.&nbsp; Missions that could be finished very quickly are now worth
  less experience and missions that are taking longer to complete are now worth
  more experience.<BR>- High Seas Rogues have regained the ability to evade!&nbsp; <BR>- All Drachnid Hive level 65 missions should now give out the appropriate one
  time rewards.&nbsp; <BR>- Artisan Dosan Vis&#8217;Moor, Vivian Selgan, and Gart Okken should now be
  accepting items for the tasks that they give.&nbsp; <BR>- Additional text has been added to the &quot;Investigate a
  Disappearance&quot; task that begins in Freeport  that should help clear up a confusing spot late in the task.&nbsp; <BR>- Aid Fimli in the Plane of Knowledge will now reward you with a cloak of
  lesser pernicity that matches the stats of the original cloak of greater
  pernicity. In addition the cloak of greater pernicity has been changed to be
  attunable.&nbsp; <BR>- The Misty for You quest now works properly.</P>  <P><STRONG>***
  UI ***</STRONG></P>  <P>- The GuildManagement window has a
  new tab &quot;Information&quot;, which contains the MOTD fields, as well as
  two new fields for Guild web URL and Guild channel specification. These new
  fields are changeable by the Guild leader only.</P>  <P><STRONG>***
  Tradeskills ***</STRONG></P>  <P>- The spell Light of Order will
  now use the proper ink.<BR>- Poison Vials made with Crows Special Brew now show properly in the
  Tradeskill UI.<BR>- Players baking with pumpkin will now get their tools back when they mess
  up.<BR>- Players making Spiced Pumpkin Cider no longer have to hold it in their
  hands. The recipe now requires a bottle.</P>  <P><STRONG>***
  NPCS ***</STRONG></P>  <P>- The Knight of the Dread Sun will
  now make his appearance more often.<BR>- Fixed an issue in Dreadspire that could cause some of the residents of the
  crypt to aggro through the roof.<BR>- Ogres will now be able to get the thread for their cultural armor without
  having to fight off guards.&nbsp; </P>  <P>&nbsp;<STRONG>- The EverQuest Team</STRONG><STRONG><EM></EM></STRONG></P>
