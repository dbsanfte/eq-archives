...
//window.alert(document.cookie);
  ...
  Entertainment Inc., 8928 Terman
    Court, San Diego, CA 92121  (&quot;Sponsor&quot;).</P>  <P><STRONG>Eligibility:</STRONG></P>  <P>(a) Contest is open only to natural persons who are legal residents of the
  50 United States  (including the District of Columbia)
  for the duration of the Contest. Void in Puerto Rico, Guam, all other U.S. and all
  foreign territories and possessions and wherever prohibited or restricted by
  law. The Contest will only be conducted on U.S. based servers. Contest may
  only be entered from and in eligible jurisdictions.<BR>(b) Participants must be 18 years of age or older at time of entry in order
  ...
  quest as many times as you wish, subject to Lost Dungeons of Norrath raid re-try
  restrictions. Any attempt at entry except as above stated is void. Any
  ...
  (5) business days from notification to accept the prize by e-mail or by U.S. mail to
  the address specified in the notification. Allow six to eight weeks for
  shipment of prizes to verified winners.</P>  <P><STRONG>Requirements of Winner:</STRONG> Potential winner of prize is
  ...
  person, entry, or e-mail address that Sponsor determines to be in violation of
  any term contained in these Official Rules. Sponsor, and the employees,
  ...
  computer virus, bug, worms, tampering, unauthorized intervention, fraud or
  other problem corrupts, prevents, or interferes with the administration,
  security, or proper play of the Contest or the awarding of prizes. In the
  event of such cancellation, Sponsor reserves the right to award prizes in a
  random drawing from all entries received prior to the time of cancellation.
  Any attempt by any person to undermine the legitimate operation of the
  Contest may be a violation of criminal and civil law, and, should such an
  attempt be made, Sponsor reserves the right to seek damages from any such
  person to the fullest extent permitted by law. Sponsor's failure to enforce
  any term of these Official Rules shall not constitute a waiver of that
  provision. In the event of a dispute as to any online entry, the authorized
  account holder of the e-mail address used to enter will be deemed to be the
  entrant. The &quot;authorized account holder&quot; is the natural person
  assigned an e-mail address by an Internet access provider, online service
  provider, or other organization responsible for assigning e-mail addresses
  for the domain associated with the submitted address. A potential winner may
  be required to show proof of being the authorized account holder. All
  information submitted to Sponsor as part of this Contest will be treated in
  accordance with Sponsor's privacy policy, available at <A HREF="http://sonyonline.com/tos/privacy.jsp">http://sonyonline.com/tos/privacy.jsp</A>.</P>  <P><STRONG>Disputes:</STRONG> Contest is governed by the laws of the United States and the State of California. As a
  condition of participating in the Contest, participant agrees that any and
  all actions or proceedings related to the Contest, or any prize awarded,
  shall be resolved individually, without resort to any form of class action,
  and shall be exclusively brought in the County of San Diego, State of
  California (if under state law) or the Southern District of California (if
  under Federal law), and the parties agree not to raise in connection
  ...
  Diego, CA 92121. Requests must be received no later than March 15, 2004. Vermont residents may
  omit return postage for Official Rules requests.</P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
