	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                                  ...
                                  <tr> 
                                    ...
                                    <td width="100%"> 
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> 
                                          <td height="2" bgcolor="#000000"><img src="images/seethru.gif" width="8" height="2"></td>
                                        </tr>
                                        <tr> 
                                          <td height="108" nowrap> 
                                            <div align="center"> 
                                              <center>
                                                <img src="images/map_norrath.gif" width="162" height="64"><br>
                                                <font face="Times New Roman, Times, serif" size="-1" color="#000000">Click 
                                                on each continent to bring up 
                                                a more detailed view.</font><font face="Times New Roman, Times, serif" color="#000000"> 
                                  ...
                                  <tr> 
                                    ...
                                    <td> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td width="36%"> 
                                            <p align="right"><img src="images/map_ship1.gif" width="115" height="80"><a href="odus.jsp"><img src="images/map_odus.gif" width="100" height="144" align="right" border="0" alt="Odus"></a></p>
                                            <p align="center">&nbsp;</p>
                                            <p align="center">&nbsp;</p>
                                            <p align="center">&nbsp;</p>
                                            <p align="center">&nbsp;</p>
                                            <p align="right"><img src="images/map_gator.gif" width="72" height="59"> 
                                            </p>
                                          </td>
                                          <td valign=top width="20%"> 
                                            <center>
                                              <a href="antonica.jsp"><img src="images/map_antonica.gif" width="183" height="245" border="0" alt="ANTONICA"></a> 
                                            </center>
                                          </td>
                                          <td rowspan="2" width="44%"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td><br>
                                                  <br>
                                                  <a href="faydwer.jsp"><img src="images/map_faydwer.gif" width="198" height="142" border="0"></a></td>
                                              </tr>
                                              <tr> 
                                                <td><a href="kunark.jsp"><img src="images/map_kunark.gif" width="211" height="192" border="0"></a></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
                                          ...
                                          <td colspan="2"> 
                                            <center>
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr> 
                                                  <td width="58%">&nbsp;</td>
                                                  <td width="42%"><a href="velious.jsp"><img src="images/map_velious.gif" width="262" height="121" border="0"></a></td>
                                                </tr>
                                              </table>
                                            </center>
                                          </td>
                                      ...
                                      <table border="0" width="100%" cellpadding="20" cellspacing="0">
                                        <tr> 
                                          <td valign="top" class="maplinks"><font face="Georgia, Times New Roman, Times, serif" color="#000000">The 
                                            known world of EverQuest is referred 
                                            to by scholars as Norrath, although 
                                            very few are aware of its entirety. 
                                            Five continents fill the hemisphere, 
                                            and whether other lands lay beyond 
                                            the oceans to the east and west, no 
                                            one knows, or at least admits to such 
                                            knowledge. Rumors of different planes 
                                            and dimensions even surface occasionally, 
                                            but most believe these to be mere 
                                            ramblings of madmen. </font></td>
                                          <td> 
                                      ...
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        <tr> 
                                          <td height="105"> 
                                            <div align="center"><br>
                                              <center>
                                                <p><font face="Times New Roman, Times, serif"><a href="odus.jsp"><span class="maplinks"><span class="maplink">To 
                                                  Odus map</span></span></a> <span class="maplink"><span class="maplinks"><img src="images/seethru.gif" width="12" height="2"></span></span><span class="maplinks"> 
                                                  <a href="antonica.jsp" class="maplink">To 
                                                  Antonica map</a> <img src="images/seethru.gif" width="12" height="2"> 
                                                  <a href="faydwer.jsp" class="maplink">To 
                                                  Faydwer map</a> <img src="images/seethru.gif" width="12" height="2"> 
                                                  <a href="kunark.jsp" class="maplink">To 
                                                  Kunark map </a></span></font></p>
                                                <p><font face="Times New Roman, Times, serif"><span class="maplinks"><a href="velious.jsp" class="maplink">To 
                                                  Velious map</a> </span></font></p>
                                              </center>
                                            </div>
                                          </td>
                                        </tr>
