...
<title>EQLive - The Library</title>
<!-- #EndEditable -->
...
<a href="/library/index.jsp">Full Design Version</a>
</p>
...
<P><A href="/lowsrc/manual/index.jsp">The EverQuest Manual</A><BR>The complete EverQuest manual to date.</P>
<P><A href="/lowsrc/library/faqs/faq_index.jsp">FAQs</A><BR>The standard Frequently Asked Questions about EverQuest.</P>
<P><A href="/lowsrc/interface/">User Interface<BR></A>Screenshots of graphical interface.</P>
<P><A href="/lowsrc/library/races.jsp">Races</A><BR>A brief description of the playable races that inhabit the world of EverQuest. </P>
<P><A href="/lowsrc/library/classes.jsp">Classes</A><BR>From Bard to Wizard, a breakdown of playable character classes. </P>
<P><A href="/lowsrc/library/skills.jsp">Skills</A><BR>Just the basics here, with more to discover as your adventures continue. </P>
<P><A href="/lowsrc/library/deities.jsp">Deities</A><BR>The Gods of Norrath that watch over their creations. </P>
<P><A href="/lowsrc/library/sub_deities.jsp">Sub-Deities</A><BR>Children of the Gods. Learn more about them and the realms they lord over. </P>
<P><A href="/lowsrc/library/atlas/index.jsp">Atlas</A><BR>Colorful maps of the world we share. </P>
