...
<P ALIGN="center"><STRONG><BR><STRONG>Contact Us</STRONG></STRONG></P>  <P>Customer
  ...
  Editor reserves the right to determine what news items will be posted and where.
  Another function of this address is to notify the EQ Webmaster of possible
  problems with the site so that they can be checked out.</P>  <P><A HREF="mailto:eqmoderator@soe.sony.com">eqmoderator@soe.sony.com</A><BR>This address is used to alert the EverQuest message boards moderator of posts
  ...
  email was originally sent to the wrong address and may have been buried in
  the recipients in-box until he or she found it and forwarded it to the right
