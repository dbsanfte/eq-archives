...
<p>&nbsp;</p>
  ...
  maintenance update</span><br>
	<span class="status_date">7/6/2004  6:55 PM PDT (-7 UTC)</span><br>
	<P>Firiona Vie is currently down
  for emergency maintenance. The estimated uptime is 8:00am PDT July 7<SUP>th</SUP>,
   2004(-7 UTC). We are sorry for the inconvenience.</P>  <P>All other servers are up and operational at this time.
...
<tr>
<td><span class="statusName">Chat Server</span></td>
...
<td width="20"><img src="/images/spacer.gif" border="0" width="20" height="10"></td>
						...
						<h1>Firiona Vie Emergency Downtime 7/06/04 8:00am PDT (-7 UTC)</h1>
						<p>We must bring the Firiona Vie server down for an emergency maintenance today at 8:00am PDT (-7 UTC). We are estimating an ETA of 8:00pm PDT (-7UTC).<p>
