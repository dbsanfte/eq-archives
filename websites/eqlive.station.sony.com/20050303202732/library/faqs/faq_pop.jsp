...
<P ALIGN="center"><BR><STRONG>EVERQUEST:<SUP>&reg;</SUP> THE PLANES OF POWER&#8482;</STRONG></P>  <P><STRONG><U>GENERAL INFORMATION</U></STRONG><BR><STRONG><BR><STRONG>What is EverQuest?</STRONG></STRONG><BR>EverQuest is a real-time 3-D massively multiplayer online role-playing game
  (MMORPG) with fantasy elements featuring dragons, wizards, vast continents
  and dungeons full of treasure and mystery.</P>  <P><STRONG>What is EverQuest: The Planes of Power?</STRONG><BR>EverQuest: The Planes of Power is the latest game expansion in the best-selling
  EverQuest series. This expansion will focus mainly on providing content to
  the highest levels of the game, allowing players to become even more
  powerful. We plan to add twenty zones to the existing world in this
  expansion.</P>  <P><STRONG>When was the original EverQuest released?</STRONG><BR>EverQuest was released March 16, 1999.</P>  <P><STRONG>What is an RPG?</STRONG><BR>RPG stands for Role-Playing Game. When you play EverQuest, you'll first
  create a character. Immerse your character into our virtual world and make of
  it whatever you wish. You define your character's destiny in the lands of
  EverQuest. How well you play that role it is up to you.</P>  <P><STRONG>What is a &quot;massively multiplayer online
  game&quot;?</STRONG><BR>While many modern computer games support multiplayer gaming, few are designed
  to support well over 1,000 simultaneous players. With EverQuest, you don't
  start the server program on a local network and invite a few of your friends
  over to play. Instead, you run the EverQuest client program and use the
  Internet to connect to our world servers. Call or email your friends and tell
  them what city or dungeon to meet you in or, better yet, log on and encounter
  hundreds of other people from all over the world and make a slew of new
  acquaintances. To date EverQuest has more than 98,000 simultaneous users
  during peak gaming hours.</P>  <P><STRONG>How many people play EverQuest?</STRONG><BR>Currently, EverQuest has more than 420,000 monthly subscribers.</P>  <P><STRONG>What other EverQuest expansions have been released?</STRONG><BR>EverQuest&reg;: The Ruins of Kunark&#8482; expansion was released April 24,
  2000. Since then it has become a part of the basic EverQuest package, giving
  players more than twenty new zones, a new playable race of lizard men called
  the Iksar and selling over 400,000 copies to date. The second expansion,
  EverQuest&reg;: The Scars of Velious&#8482;, was released on December 5, 2000.
  It provides 19 more zones of content designed for level 30 characters and
  above and has sold more than 300,000 copies since its release. Selling over
  120,000 copies it's first day at retail, the third expansion, EverQuest&reg;:
  The Shadows of Luclin&#8482; takes players to the enchanting moonscape of
  Luclin--offering over 27 new adventure zones, all-new items, creatures and
  spells, a new playable character race and rideable horses. Supported by a
  complete graphic overhaul, the enhanced gameplay featured in Luclin allows
  players to witness their world in unprecedented splendor.</P>  <P>&nbsp;</P>  <P><STRONG>Can I download the game online?</STRONG><BR>No, The Planes of Power is available on CD-ROM only.</P>  <P ALIGN="center">&nbsp;</P>  <P><STRONG><U>GAMEPLAY</U></STRONG></P>  <P><STRONG>What features can we expect in the game?</STRONG><BR>There are many new features planned for this expansion pack. Keep your eyes
  on the <A HREF="../../../../../">EverQuest Live</A> website and <A HREF="http://www.planesofpower.com/">The Planes of Power</A> website for more
  information.</P>  <P><STRONG>Are there more battle animations in PoP than in other
  expansions?</STRONG><BR>Player animations aren't included in this expansion. At least 50 new NPCs
  with unique animations are included in PoP.</P>  <P><STRONG>How many playable zones has PoP added to the game?</STRONG><BR>Twenty</P>  <P><STRONG>How do I get to the Planes?</STRONG><BR>The planes are accessed via numerous portals throughout the existing world.</P>  <P><STRONG>Like EverQuest: The Scars of Velious, will I need a
  level 35 character or above to play the game?</STRONG><BR>The Plane of Knowledge is available to players of all levels and is a source
  of many new quests, making travel throughout Norrath far more convenient. All
  other new planar zones require players to be level 46 or above to enter.</P>  <P><STRONG>How can this expansion engage a level-60 player that
  has played EQ for the last 3 years, yet also appeal to a&quot;newbie&quot;?</STRONG><BR>Veteran players have access to new content that provides months of exciting
  gameplay. And players at all skill levels benefit from the Plane of Knowledge
  and its scores of new and challenging quests.</P>  <P ALIGN="center">&nbsp;</P>  <P><STRONG><U>SYSTEM REQUIREMENTS</U></STRONG></P>  <P><STRONG>What are the system requirements to run the game?</STRONG><BR>See the EverQuest <STRONG><A HREF="../../../../../support/tech_support/ts_system_requirements.jsp">System
  Requirements</A></STRONG> page.</P>  <P>&nbsp;</P>
