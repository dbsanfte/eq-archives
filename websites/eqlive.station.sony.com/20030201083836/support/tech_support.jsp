...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support.jsp');">
...
<P><B>Game Optimization</B><BR><A href="http://eqlive.station.sony.com/support/tech_support/ts_default_settings.jsp">EQClient.ini settings</A> - Changing Default Visual Settings in Game<BR><A href="http://eqlive.station.sony.com/support/tech_support/ts_keyboard.jsp">Keyboard layout</A><BR></P>
