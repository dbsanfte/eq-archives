		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/forums/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/forums/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
...
<P><A class=mlinklevel1 href="http://boards.station.sony.com/ubb/everquest/cgi-bin/forumdisplay.cgi?action=topics&amp;forum=Events&amp;number=6&amp;DaysPrune=20&amp;LastLogin=">Events<BR></A>This forum is for discussion about official events such as the Test of Tactics and the Best of the Best. As with all the forums, the Station's Rules of Conduct apply. <STRONG>An active EverQuest account is required to post here.</STRONG><BR><FONT size=1>&nbsp;</FONT><BR></P>
