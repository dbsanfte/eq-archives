...
<P ALIGN="center"><STRONG>Rules Of Conduct</STRONG></P>  <P><STRONG><BR><STRONG>THE FOLLOWING ARE THE BASIC RULES OF CONDUCT THAT GOVERN PLAYER
  INTERACTION AND ACTIVITY WITHIN EVERQUEST AND IN THE OFFICIAL EVERQUEST
  FORUMS. FAILURE TO ACT RESPONSIBLY AND COMPLY WITH THESE RULES WITHIN
  EVERQUEST AND THE OFFICIAL EVERQUEST FORUMS MAY RESULT IN THE TERMINATION OF
  YOUR ACCOUNT WITHOUT ANY REFUND OF ANY KIND.</STRONG></STRONG></P>    <P><STRONG>1. You may not harass or threaten other players.</STRONG></P>  <P><STRONG>2. You may not use any sexually explicit, harmful, threatening,
  abusive, defamatory, obscene, hateful, racially or ethnically offensive
  language.</STRONG></P>  <P><STRONG>3. You may not impersonate any Sony Online Entertainment, Sony
  Computer Entertainment America, or Verant Interactive employee, past or
  present, including any Customer Support personnel.</STRONG></P>  <P><STRONG>4. You may not violate any local, state, national or international
  law or regulation.</STRONG></P>  <P><STRONG>5. You may not modify any part of the EverQuest Client, Server or
  any part of the EverQuest Web Page located at &lt;<A HREF="http://www.everquest.com/">http://www.everquest.com</A>&gt;.</STRONG></P>  <P><STRONG>6. You may not arrange for the exchange or transfer of any pirated
  or illegal software while on EverQuest or the EverQuest Web site.</STRONG></P>  <P><STRONG>7. You will follow the instructions of authorized personnel while
  in EverQuest or on the Official EverQuest Forums.</STRONG></P>  <P><STRONG>8. You may not organize nor be a member of any guilds or groups
  within EverQuest that are based on, or espouse, any racist, sexist,
  anti-religious, anti-ethnic, anti-gay, or other hate-mongering philosophy.</STRONG></P>  <P><STRONG>9. You may not give false information or intentionally hide any
  information when registering for your EverQuest account.</STRONG></P>  <P><STRONG>10. You will not upload or transmit on EverQuest, or on the
  EverQuest Web Site any copyrighted content that you do not own all rights to,
  unless you have the express written permission of the author or copyright
  holder.</STRONG></P>  <P><STRONG>11. You will not attempt to interfere with, hack into, or decipher
  any transmissions to or from the servers running EverQuest.</STRONG></P>  <P><STRONG>12. You will not exploit any bug in EverQuest and you will not communicate
  the existence of any such exploitable bug (bugs that grant the user unnatural
  or unintended benefits in game), either directly or through public posting,
  to any other user of EverQuest. You will promptly report any such bug via the
  in-game &quot;/bug&quot; command.</STRONG></P>  <P><STRONG>13. You will not attempt to play EverQuest on any server that is
  not controlled or authorized by Sony Computer Entertainment America, or its
  designees.</STRONG></P>  <P><STRONG>14. You will not create, use or provide any server emulator or
  other site where EverQuest may be played, and you will not post or distribute
  any utilities, emulators or other software tools related to EverQuest without
  the express written permission of Sony Computer Entertainment America.</STRONG></P>    <P><STRONG>1.1 Play Nice Policies - Activity within EverQuest</STRONG></P>  <P>In addition to the general guidelines listed in section 1.0, players are
  also subject to these supplementary rules while playing EverQuest. While by
  no means an all-inclusive list of the do's and don'ts in EverQuest, it
  provides a suitable foundation by which the player can determine what
  activities are appropriate:</P>    <P>1. You may not steal kills.</P>  <P>Kill Stealing is defined as the killing of an NPC for any reason that is
  already fighting or pursuing another player or group that is prepared to
  engage that same NPC without that group's specific permission.</P>  <P>The intent of this rule is discourage and make note of habitual Kill
  Stealers, not to punish those who honestly try to work together or those who
  make an honest mistake. Its enforcement by the EverQuest Customer Service Staff
  will reflect this philosophy.</P>  <P>2. You may not ninjaloot.</P>  <P>Ninjalooting is defined as taking special equipment from a fallen creature
  without the express permission of those who killed the creature if they are
  in attendance.</P>  <P>The purpose of this rule is to stop those who stand near creatures that
  carry special items and attempt loot that equipment prior to it being looted
  by the rightful owner.</P>  <P>3. You must comply with arbitration for contested spawns.</P>  <P>There are cases where two or more groups wish to kill the same NPC or hunt
  in the same area. In these cases, the groups are required to compromise.</P>  <P>If an equitable compromise cannot be reached between the players prior to
  EverQuest Customer Service Staff involvement, the EQCSR will mandate a
  compromise. Any such compromise is final and not open to debate. Refusing to
  abide by these terms will be considered disruption and may result in
  disciplinary action.</P>  <P>It is therefore <STRONG>strongly</STRONG> suggested that the groups make
  every attempt to reach a compromise that they can live with prior to
  involving an EQCSR, who may mandate a compromise that does not suit you to
  the extent that a player-devised compromise would.</P>  <P>Note: A &quot;group&quot; in this case is defined as a party of one or
  more characters that are united in a common belief or goal and are capable of
  completing that goal.</P>  <P>4. Foul language is not permitted, in any language.</P>  <P>Excessive use of foul language in an inappropriate context, including
  swear words, real-world racial slurs, and other language that is not
  consistent with the fantasy environment and designed to hurt, will be
  considered a disruption. The existence of the filter (/filter) is not a
  license to be profane.</P>  <P>5. You may not harass others.</P>  <P>Harassment is defined as specifically targeting another player or group of
  players to harm or inconvenience them. As harassment can take many forms, the
  EQCSR involved will make a determination as to whether or not a
  &quot;reasonable person&quot; would feel harassed and act accordingly.</P>  <P>6. You may not disrupt the normal playability of a zone or area.</P>  <P>Zone/Area Disruption is defined as any activity designed to harm or
  inconvenience a number of groups rather than a specific player or group of
  players. This includes, but is not limited to::</P>    <P>o Monopolizing most or all of the kills in an area.</P>  <P>o Deliberately blocking a doorway or narrow area so other players cannot
  get past.</P>  <P>o Refusing to cooperate with the other parties at a contested spawn site
  after having been instructed to do so by an EQCSR.</P>  <P>o Making excessive and inappropriate use of public channels of
  communications (/shout, /ooc, etc.).</P>  <P>o Intentionally causing excessive zone latency (creating excessive
  corpses, abusing spell effects, etc.).</P>  <P>o Causing intentional experience loss to other players (deliberately
  impeding fleeing players by blocking their escape route, intentionally
  training NPCs on other players, etc.).</P>  <P>&nbsp;</P>    <P>7. You may not defraud other players.</P>  <P>Fraud is defined as falsely representing one's intentions to make a gain
  at another's expense. Examples of this activity include, but are not limited
  to, using deception to deprive another player of items, slandering another
  player or impersonating them with the intention of causing harm to that
  player's reputation, or falsely representing one's identity in order to gain
  access to another player's account or account information.</P>  <P>Fraud in all transactions between players may result in disciplinary
  action when confirmed by an EQCSR.</P>  <P>&nbsp;</P>  <P>8. You may not abuse other players or Customer Service Representatives.</P>  <P>The following actions would be considered abuse:</P>    <P>o Hate Mongering - participation in or propagation of Hate literature,
  behavior, or propaganda related to real -world characteristics.</P>  <P>o Sexual Abuse or Harassment - untoward and/or unwelcome advances of a
  graphic and sexual nature. This includes, but is not limited to, virtual
  rape, overt sexual overtures, and stalking of a sexual nature.</P>  <P>o Attempting to Defraud a CS Representative - Petitioning with false
  information with the intent of receiving benefits as a result. This includes
  reporting bug deaths, experience or item loss, or accusing other players of
  wrongdoing without basis for it.</P>  <P>o Impersonating a Customer Service Representative - falsely representing
  yourself to another player as a Guide or a Verant Interactive employee.</P>  <P>o CS Personnel Abuse - This includes, but is not limited to, sending
  excessive /petitions (as an individual or group), sending excessive /tells to
  a CS Representative, excessively using say or other channels to communicate
  to a CS Representative, making physical threats, or using abusive language
  against a CS Representative.</P>  <P>o Implying Favoritism by EQCSRs - Stating that employees of SOE or members
  of the Guide program will show favor towards one or more parties involved in
  any given situation. This includes, but is not limited to, using threats of
  retribution or inferring that you will not be held accountable for your
  actions due to special consideration.</P>      <P><EM>Note: This list is not all-inclusive. Other actions may be determined
  as abuse at the discretion of the EQCSR.</EM></P>  <P>&nbsp;</P>    <P>9. &quot;Role-playing&quot; does not grant license to violate these rules.</P>  <P>Though EverQuest is a Role-playing game, the claim of
  &quot;Role-play&quot; will not be accepted in defense of any of the
  anti-social behaviors mentioned above. We strongly encourage role-playing,
  but cannot allow it to be done at the expense of others.</P>  <P>10. You may not operate a guild that habitually violates these rules.</P>  <P>Disciplinary issues involving guilds may be addressed with the entire
  guild. Guilds whose members habitually violate these rules may be issued
  guild warnings, and can even be permanently disbanded.</P>  <P>Guild Leaders and/or officers may be held accountable for any actions of
  their guild members, in addition to any other actions that may be taken. It
  is therefore the responsibility of the guild leadership to ensure that all
  guild members abide by these rules.</P>    <P><EM>Specific rules for PvP servers can be found at </EM><STRONG><EM>&lt;</EM></STRONG><EM><A HREF="../../../../../library/sz_rule_sets.jsp">http://eqlive.station.sony.com/library/sz_rule_sets.jsp</A></EM><STRONG><EM>&gt;</EM></STRONG></P>  <P>&nbsp;</P>  <P>&nbsp;</P>  <P><STRONG>1.2 Message Board Conduct</STRONG></P>  <P>As the Official EverQuest Forums are part of The Station, posting to these
  forums is bound by The Station's Terms of Service that can be found in their
  entirety <STRONG><A HREF="http://www.station.sony.com/en/termsofservice.jsp#commfeatures">here</A></STRONG>.
  In addition to these terms of service, we have a few supplemental rules that
  apply to the EverQuest Forums.</P>  <P>In general, you may post any material, written in a courteous and mature
  manner, providing that it is on-topic for the forum to which you are posting.
  This includes material that disagrees with the way that we, the developers,
  operate the game. We will not interfere with the communication of thoughts
  and ideas as long as the presentation is appropriate for all those capable of
  reading the forum.</P>  <P>You may not, however, post any material that:</P>  <UL>   <LI>Attacks or insults
       others on the board. Feel free to debate the idea, but do not turn your
       disagreement into an attack upon the poster.</LI>   <LI>Engages in
       name-calling, harassment, or threats. See above.</LI>   <LI>Contains obscenity,
       vulgarity, or profanity. Though we do have a filter in place to catch
       the unintentional obscenity from time to time, this is not a license to
       abuse it.</LI>   <LI>Disparages any
       religion, race, nation, gender, or sexual orientation.</LI>   <LI>Is considered
       inappropriate for children 13 or over as governed by general standards
       of decency in the United States.</LI>   <LI>Infringes on
       anyone's privacy rights.</LI>  </UL>  <P>Furthermore, you may not:</P>  <UL>   <LI>Make multiple posts
       on the same subject for the purpose of getting attention paid to your
       issue.</LI>   <LI>Post off-topic comments
       in threads for the purpose of drawing attention to another thread on a
       different subject.</LI>   <LI>Monopolize the
       front page of any forum by &quot;bumping&quot; threads of the same or
       similar content to the front. We may intervene by closing threads any
       time that this occurs.</LI>   <LI>Use the official
       forums as a staging-ground for creating general unrest within the game
       (e.g. Sit-ins).</LI>   <LI>Use the official
       forums as a place to advertise the sale of EverQuest characters or items
       in exchange for real-world money.</LI>   <LI>Advertise web-sites
       with content that violates these rules, the EverQuest EULA, or the
       Station Terms of Service.</LI>   <LI>Advertise products
       or websites that are not related to EverQuest or other Verant/Sony
       Online Entertainment products.</LI>  </UL>  <P>Action that we might take in regards to a post in violation of these rules
  on the Official EverQuest Forums will vary depending upon the transgression.
  It could include any number of the following:</P>  <UL>   <LI>Editing of the post.</LI>   <LI>Deletion of the
       post/thread.</LI>   <LI>Closing of the
       thread.</LI>   <LI>Suspension (results
       in user being unable to play EverQuest for the duration of the
       suspension).</LI>   <LI>Banishment (results
       in the user's station account being canceled. User will no longer be
       able to access EverQuest, or any Official EverQuest Forum).</LI>   <LI>&nbsp; Legal Action
       (I.e. Contacting law enforcement personnel in regard to a threat.)</LI>  </UL>  <P>People who violate the rules of the boards may or may not receive any
  warning before any action is taken. In the event that a warning is given, the
  warning will be recorded upon the game account and may result in further
  action should the player show a pattern of engaging in prohibited conduct.
  Philosophically and administratively, there is no difference between conduct
  in game, and conduct in the Official EverQuest Forums.</P>  <P>&nbsp;</P>  <P>If you are still having problems after visiting this support section, you
  can contact our Technical Support Department through an email via our <A HREF="../../../../../support/">online form</A>.</P>  <P>&nbsp;</P>  <P>&nbsp;</P>
