...
<P><STRONG>1) How much does this extension cost?</STRONG></P>  <P>The cost is $23.99 (price subject to change). This is a one-time charge
  ...
  charge directly to the credit card on account for your EverQuest
  subscription.</P>  <P><STRONG>3) How does this download-only thing work?</STRONG></P>  <P>SOE has made this extension available as a product download -- those who
  ...
  procedure. (We're guessing it's about 120 megabytes.)</P>  <P><STRONG>4) I have a dialup connection; any hints on patching?</STRONG></P>  <P>If you do not have a broadband connection, your downloads will be slow. What
  you might do is try to manage the process so that you patch the new files
  while you work or sleep. To do that, in the patcher advanced options, keep
  The Legacy of Ykesha box unchecked (so that you aren't checking for and
