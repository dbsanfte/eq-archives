...
<P><STRONG>Ngreth</STRONG> mentions
  that <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Trade&amp;message.id=8499#M8499">Journeyman's
  Charm Patterns are currently bugged</A>. </P>  <P><STRONG>Tanker</STRONG> <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=129214#M129214">explains</A>  the placement of the &#8220;done&#8221; button on the merchant screen.</P>  <P>In a discussion
  about <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=129075#M129075">intelligent
  and evolving items</A>, <STRONG>Zajeer</STRONG> talks about leveling these items.</P>  <P><STRONG>Oshran</STRONG>  talks about <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=128682#M128682">mission
  drops</A> and issues people have experienced with the Shiliskin
  Subterfuge mission.</P>  <P>Have you experienced issues with Plane of Time
  recently?&nbsp; Let <STRONG>Rashere</STRONG> know in the <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=128042#M128042">Plane
  of Time</A> thread.</P>  <P>Come tell the story of your first journey across Norrath
  in <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Fun&amp;message.id=4305#M4305">Ky&#8217;s
  Chatter Box</A>. </P>
