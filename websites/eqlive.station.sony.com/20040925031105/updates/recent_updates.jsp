...
<h1>September 23rd, 2004</h1>
<B>Recent Updates</B>
<P>Monk Epic<BR>--------------------- </P>
<P>- Speaking to certain monk epic mobs will no longer reset the monk's progression. </P>
<P>- Monks that turned in their letters will now be able to continue the quest from where they currently are.</P>
<P>- Monks should have an easier time locating the lost Disciple.</P>
<P><BR>Guild Tribute<BR>--------------------- 
<P>- Players with Gates, but not Omens, should now be able to open the Guild Tribute Master to both opt-in and donate for Guild Tribute Benefits.</P>
<P>- Suspended pets will no longer vanish when their owner turns invisible.</P>
<P>- Skies will now show correctly for Windows 98/ME users.</P>
<P>- Warriors will be reimbursed for their Press the Attack AA. They can buy the ability with its new range if they wish.</P>
<P>- Salvage will no longer return items that would be returned normally.</P>
<P><BR>-- The EverQuest Team</P>
