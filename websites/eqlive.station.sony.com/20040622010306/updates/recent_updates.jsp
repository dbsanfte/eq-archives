...
<tr>
	...
	<a href="recent_updates.jsp?id=62350" class="tinylink">June 2, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=62265" class="tinylink">May 26, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=62117" class="tinylink">May 12, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=62032" class="tinylink">May 5th, 2004</a><br>
...
<h1>June 16, 2004</h1>
<P>June 16th, 2004<BR>-----------------------</P>
<P>Headlines!</P>
<P>-Collision sees more improvements.<BR>-A portal to Gunthak has been added to the Plane of Knowledge.<BR>-/guidehelp is now available!<BR>-Gates of Discord sees more changes.</P>
<P><BR>Collision Updates<BR>-----------------------<BR>Many remaining collision issues have been fixed.<BR>-Floating NPCs in the Plane of Disease should be more down to earth.<BR>-NPC warping should be reduced.<BR>-The Emerald Jungle should no longer have NPCs below the world<BR>-You should once again collide with the dock in Natimbi.<BR>-The entrance to Najena should be easier to navigate.</P>
<P>Gunthak Portal<BR>-----------------------<BR>-We have added a tome to the Plane of Knowledge to allow for faster travel to and from Gunthak.&nbsp; Enjoy. *</P>
<P>Gates of Discord<BR>-----------------------<BR>-Increased the drop rate of quest items, for the Breakdown in Communication quest, in the sewers and mountain passes and Ikkinz. *<BR>-Increased the number of items that drop from the Qinimi and Barindu events for the Breakdown in Communication quest. *<BR>-Increased the drop rate of Breakdown in Communication quest items off the Yxtta bosses as well as making it possible to get them off other NPCs in the zone.<BR>-The Ikkinz Chamber of Might and Tipt boss mobs will now behave a little smarter when facing a strong defense.&nbsp; Beware!<BR>-Some tuning changes have been made to the Ikkinz single group trials and Tipt.<BR>-Changed the NPCs that guard Txevu so they are a longer re-spawn allowing you to get stragglers thru the zone much easier once you kill them.<BR>-Pathing in Txevu should be better. *<BR>-The bonus reward at the end of Inktu`ta will spawn in a chest instead of being handed directly to the player that triggers the dialogue.<BR>-Gates NPCs that dropped spells will now drop a token, which can be turned in for a class appropriate spell. *</P>
<P>The Plane of Time<BR>-----------------------<BR>-We have made changes to the scripting for the Plane of Time, which will allow the server to shut down unused instances of the zone.&nbsp; This will remove the problem of waiting for an instance that another group has finished to shut down, before you can start your attempt.&nbsp; *</P>
<P>The Plane of Hate<BR>-----------------------<BR>You can now access the Plane of Hate by talking to Relm M'Loch in the Plane of Tranquility and handing her a Fuligan Soulstone.&nbsp; *</P>
<P>Items<BR>-----------------------<BR>-The Tainted Axe of Hatred has had its damage increased. <BR>-Many Gates items have had their weight reduced. *<BR>-The Muramite Death Shroud is now equipable by beastlords and has a wind instrument modifier. *<BR>-The Onyx Ring of Prayer now has a stringed instrument modifier. *<BR>-The drop rate has been increased for the following items in the Plane of Hate *<BR>&nbsp;The Shattered Emerald of Corruption<BR>&nbsp;Decrepit Hide<BR>&nbsp;Staff of Elemental Mastery: Earth<BR>&nbsp;Essence of Vampire<BR>&nbsp;Eye of Innoruuk<BR>-The Diamond Tipped War Javelin should now look more javelin like. *</P>
...
<P>Raid Management<BR>-----------------------<BR>-Raid leaders now have the ability to add notes to the raid window.&nbsp; There is now a tabbed window in the Raid window, clicking on the Notes tab will show all the raid members in a single list, with notes next to their name.&nbsp; The Raid leader can click on a player, and change that player's note in the edit box below the list.&nbsp; The note will show on all raid members' raid windows.&nbsp; *</P>
<P>-Added an MOTD to Raid Window. On the Notes tab there is a window for an MOTD at the bottom.&nbsp; The Raid leader can edit this MOTD, and the new text will show on all Raid members' Raid windows.&nbsp; *<BR>-The escape key will now close your Raid Window.<BR>-Raid Leaders can now remove members from the raid, even across zones. *</P>
<P>Tradeskills<BR>-----------------------<BR>-There have been several upgrades to Gates Tradeskilled items. *<BR>-Gates smithed weapons have been adjusted. *<BR>-Gates fletched arrows have had their damage increased and are now magical. *<BR>-Tradeskill drinks from Gates of Discord have had their duration enhanced. *</P>
<P>Stopcasting<BR>-----------------------<BR>We have added a /stopcast command -- This command will not work when riding a horse. *</P>
<P>Undead Pets<BR>-----------------------<BR>Pets no longer go away after their master has feigned death for more than 2 minutes. *</P>
<P>Lay on Hands and Harm Touch<BR>-----------------------<BR>Lay on Hands and Harm Touch will no longer affect corpses. *</P>
<P>Corpse Dragging<BR>-----------------------<BR>We have increased the range of the /corpse command *</P>
<P>Spells<BR>-----------------------<BR>Many damage shields have had their damage and duration increased.&nbsp; *<BR>Increased the regeneration rate on the following spells:<BR>-Regrowth of the Dar Khura<BR>-Regrowth of the Grove<BR>-Regrowth<BR>-Replenishment<BR>-Blessing of Replenishment</P>
<P>Modified the heal rate for the following spells: *<BR>-Supernal Elixir<BR>-Quiescence<BR>-Holy Elixir<BR>-Breath of Trushar<BR>-Supernal Cleansing</P>
<P>Lowered the mana cost on the following spells: *<BR>-Black Steel<BR>-Ancient: Chaos Vortex<BR>-Sun Vortex</P>
<P>Increased the duration and mana cost on the following spells. *<BR>-Falcon Eye<BR>-Eagle Eye<BR>-Hawk Eye</P>
<P>Bards<BR>-----------------------<BR>Bards should no longer use instrument animations when wielding items other than instruments.&nbsp; (No more stabbing yourselves in the head with your Epic!)<BR>&nbsp;<BR>Character Creation<BR>-----------------------<BR>The character creation process now has Voice Over to guide you through new character creation. </P>
<P>Mouselook<BR>-----------------------<BR>Mouselook is much smoother and variable via a slider in the options window. If you use mouselook, make certain you adjust the new settings. </P>
<P>Tutorial<BR>-----------------------<BR>All characters should start with the tutorial bank items. <BR>&nbsp;</P>
<P>Filters<BR>-----------------------<BR>-The Focus effect should now filter haste messages.&nbsp; *<BR>-The Damage Shield filter should now work correctly.</P>
<P>-- The EverQuest Team</P>
<P>* Denotes an item that was requested by the EverQuest community.<BR></P>
