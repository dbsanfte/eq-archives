...
<P><STRONG>Updating your Video and/or Sound Drivers in Windows 2000 and
  ...
  (as listed under the Device area), and that the sound card is listed as a SB
  Audigy.</P>  <P>2. Via Device Manager</P>  <UL>   <LI>Right click on your
  ...
  allow you to continue with your installation.</P>  <P><BR><BR><IMG BORDER="0" SRC="http://eqlive.station.sony.com/support/tech_support/images/driverinstall13.jpg"><BR><BR></P>  <P>7. Once the installation is complete, you should be prompted to reboot
  your computer. Do so and when you're done, your computer should be updated
  with the drivers you just installed on your system.</P>  <P>If, after following these instructions, you still have issues, you can
