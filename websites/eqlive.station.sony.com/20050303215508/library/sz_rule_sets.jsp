...
<P><STRONG>Sullon Zek rules:</STRONG></P>  <P>Welcome to Sullon Zek, the first Deity Team PvP server.</P>  <P>The Sullon Zek server is a new server with a new rule set. The rules for
  this server are very different than those on any other EverQuest server. In
  ...
  worships rather than the race of the character.</P>  <P>This document includes the PvP rules for Sullon Zek, and a list of the
  teams for the server. The 'teams' will be referred to as 'alliances' in this
  document, as they represent an alliance of the gods, rather than some sort of
  sports team.</P>  <OL>   <LI>Player v. Player
       (PvP) combat can occur between any characters that are not on the same
       team, regardless of level. A level 50 character can attack and kill a
       level 6 character if that character is not a member of his alliance. But
       rules 2 and 3 apply.</LI>   <LI>Characters will be
       ...
       PvP combat. As soon as a character 'dings' into 6th level he or she will
       become PvP enabled.</LI>   <LI>Characters will lose
       experience when killed in PvP combat if the character that killed them
       is within 5 levels. The amount of experience lost will be the same amount
       that is lost if that character is killed by an NPC. Your corpse can be
       resurrected by a cleric to partially restore lost experience.</LI>   <LI>Characters will only
       be able to loot coins from other characters, and then only if the victim
       was within 5 levels of the killer. Only the character getting the
       killing blow will be able to loot the corpse.</LI>   <LI>Players may only
       have&nbsp;three character at a time on this server. However, all of
       these characters must be on the same team This should allow some freedom
       to create&nbsp;new characters without invalidating the team system.</LI>   <LI>Characters will not
       be able to group with anyone that is not on their Deity Team.</LI>   <LI>Characters will not
       be able to invite someone to join their guild that is not on their Deity
       Team.</LI>   <LI>All combat skills
       have their effective value capped at 2 levels above a players current
       level. Losing two levels will not cause you to lose any combat skill
       effectiveness. Losing more than that will cause those skill caps to be
       lowered so that they remain only two levels above your current level.</LI>   <LI>Resistance debuff
       ...
       your range. 'In range' means +/- 5 levels.</LI>   <LI>/consider will also
       display a message indicating what team the target is on. Members of your
       own team will be displayed as an ally. Evil and Good team members
       /considering Neutral team members will see them as apprehensive. Neutral
       team members will see Evil and Good folks as apprehensive also. Good and
       Evil team members will see each other as threatening.</LI>   <LI>Faction hits for PvP
       will be taken for killing characters within their racial home towns.
       Killing a human in any human starting city will cause a faction loss
       with the locals. Freeport, Qeynos and Surefall Glade are considered
       starting cities for humans. All of Greater Faydark and Felwithe are
       considered the starting city for high elves and wood elves. Half elves
       have no starting city. Erudites have home towns that match their
       starting cities. Other cities are not considered home towns, despite
       being run and controlled by a certain race. For example, HighHold is not
       a human home town. Thurgadin is not a dwarven home town.</LI>   <LI>Rules such as the
       Play Nice Policy do not apply to this server when there is a PvP
       solution available. Characters have the ability on this server to deal
       with their conflicts through combat. Causing experience loss by
       'training' NPCs on other characters would normally not be an offense
       that would warrant a warning this server. But training done to others on
       the same team, thus eliminating any PvP solution, is a violation of the
       Play Nice Policies. <STRONG>ALSO:</STRONG> All rules regarding general
       decency still apply. Cursing, threats and other such things will be
       dealt with sternly, and are still unacceptable behavior on any server.</LI>   <LI>Beneficial effects
       can not be used on members of another team.</LI>   <LI>No character will be
       able to bind in dungeon zones.</LI>   <LI>'Buff' spells will
       not affect characters more than 20 levels lower than the spell level.
       Existing spell restrictions on spells over 50<SUP>th</SUP> level will
       supercede this rule.</LI>   <LI>There will be
       'insignia' dropped on the corpses of characters over 20<SUP>th</SUP>       level that are killed by another character. We plan to allow those to be
       turned in for a reward of some sort. What that reward will be is
       undetermined at this time, but we are leaning towards a team reward rather
       than a personal reward.</LI>   <LI>Naked corpses WILL
       disappear when looted by a player character. If you are naked and killed
       by a player character, your corpse will disappear when it is looted.</LI>   <LI>Rogues will be able
       to pick the pockets of other player characters that are no more than
       five levels higher or lower than they are. They will only be able to
       gain coin in this fashion, they will not be able to gain as much as they
       can off of non-player characters (unless the player character is
       carrying an unusually large amount of coin), and a rogue will find it
       harder to steal from a player character than from a non-player
       character. A rogue will only be able to pick the pockets on any given
       player character once every 30 minutes. Also, rogues that get caught
       with their hands in other peoples pockets when other civilized folks are
       nearby will have to be very good indeed to escape with their skins.</LI>   <LI>The Hide skill and
       all 'invisibility' spells will cause player characters to lose targeting
       on the character that has hidden or gone invisible.</LI>  </OL>  <P><STRONG>The 'Teams':</STRONG></P>  <UL>   <LI>The Good Alliance
       consists of: Erollisi Marr, Mithaniel Marr, Rodcet Nife, Quellious,
       Tunare</LI>   <LI>The Evil Alliance
       consists of: Bertoxxulous, Cazic Thule, Innoruuk, Rallos Zek</LI>   <LI>The Neutral Alliance
       consists of: Brell Serilis, Bristlebane, Karana, Prexus, Solusek Ro, The
       Tribunal, Veeshan.</LI>  </UL>  <P>There are no Agnostics on Sullon Zek. With the new influence of the gods,
  ...
  god, then out of fear for their lives at the hands of fanatics.</P>  <P>Barbarian Shaman and Warriors can choose to worship Mithaniel Marr.
  Mithaniel Marr was unwilling to abandon all of the noble barbarians that
  served the good, and many declared themselves in favor of an alliance with
  Good.</P>  <P>Monks will be able to worship Veeshan. The Temple in Qeynos has discovered
  some ancient writings that opened up new avenues.</P>  <P>We will be including a method for the Good and Neutral teams to use Summon
  Corpse or something similar in the near future.</P>  <P>Keep in mind that we will probably be making some changes to this server
