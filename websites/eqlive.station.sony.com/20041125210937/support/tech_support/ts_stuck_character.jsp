	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_stuck_character.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_stuck_character.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<DIV align=center><STRONG><BR>Troubleshooting Stuck Characters</STRONG> </DIV>
<P>If you are having troubles accessing only one of your characters from the server select screen then please follow the directions below in order to remedy your problem.</P>
<P>First, exit the game to your Windows desktop, and double click on the "My Computer" icon. Go into the EverQuest directory (the default location is "c:\\program files\\everquest"), and delete the files for the zone that you were last in, or zoning into (the file names will start with the zone name). While in the EverQuest directory you will want to also delete all files ending in the ".opt" extension along with the zone files. </P>
<P>Another suggestion would be to temporarily disable your sound in EverQuest. In order to do this, log into EverQuest and click Options on the first menu. On the last page of the options you will see Sound. All you need to do is uncheck this and it will then be disabled until you recheck it.</P>
<P>If either of these do not allow you to login under your character, you will have to contact the GM for your server with a different character, so he or she can log in under your account and "walk" the character out of the zone it is stuck in.</P>
<P>
