	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/bios/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/bios/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Developer&nbsp;Bios</font></b></div>
                        <!-- #EndEditable --></td>
...
<tr><td valign="top">
	...
	<b>Artists</b><br>
	<a href="bio.jsp?id=58849">Allen&nbsp;Bond</a><br>

	<b>Community</b><br>
	<a href="bio.jsp?id=58850">Christina&nbsp;Delzer</a><br>

	</td><td valign="top"><b>Designers</b><br>
	<a href="bio.jsp?id=58848">Alan&nbsp;VanCouvering</a><br>

	</td><td valign="top"><b>Management</b><br>
	<a href="bio.jsp?id=58846">Robert&nbsp;Pfister</a><br>

	<b>Programmers</b><br>
	<a href="bio.jsp?id=58847">James&nbsp;Bill</a><br>
