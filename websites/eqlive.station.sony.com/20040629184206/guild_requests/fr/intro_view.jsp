...
<title>EverQuestLive.com - Guild Request System</title>
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/fr/intro_view.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/fr/intro_view.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/fr/intro_view.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
système&nbsp;de&nbsp;requêtes&nbsp;des&nbsp;guildes</font></b></div>
                        <!-- #EndEditable --></td>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <table width="160" border="0" cellspacing="0" cellpadding="5">
                          <tr> 
                            <td><div align="center"><a href="../en/intro_view.jsp" onMouseOver="MM_swapImage('Image3','','../../images/flags/flag_us_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="../../images/flags/flag_us_off.gif" name="Image3" width="44" height="27" border="0" id="Image3"></a></div></td>
                            <td><div align="center"><img src="../../images/flags/flag_fr_current.gif" name="Image1" width="44" height="27" border="0" id="Image1"></div></td>
                            <td><div align="center"><a href="../de/intro_view.jsp" onMouseOver="MM_swapImage('Image2','','../../images/flags/flag_de_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="../../images/flags/flag_de_off.gif" name="Image2" width="44" height="27" border="0" id="Image2"></a></div></td>
                          </tr>
                        </table>
                        <p>Bienvenue dans le système d'enregistrement des guildes 
                          d'Everquest.<br>
                          <br>
                          A partir de cette page vous pouvez accéder aux requêtes 
                          de création de guilde, consultez vos précédentes requêtes 
                          ou annuler des requêtes en cours.<br>
                          <br>
                          Cliquez <a href="/guild_requests/index.jsp?page=CREATE_REQUEST">ici 
                          </a> pour soumettre une requête de création de guilde.<br>
                          <br>
                          Cliquez <a href="/guild_requests/index.jsp?page=VIEW_REQUESTS">ici 
                          </a> pour afficher vos requêtes de guilde.<br>
                          <br>
                          Merci de jouer à EverQuest. 
                          <!-- end page content -->
                        </p>
                        <!-- #EndEditable --></td>
