	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_options.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_options.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P ALIGN="center"><STRONG><BR><STRONG>How to Change Your Options Through the Game Interface</STRONG></STRONG></P>  <P>If you are having performance problems, or you wish to change your
  graphics settings for EverQuest&reg;: The Shadows of Luclin&#8482;, you may
  do so through the game interface:</P>  <P>1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Launch EverQuest. At the main screen, click
  &quot;Options&quot; instead of &quot;Connect.&quot;</P>  <P ALIGN="center"><IMG BORDER="0" SRC="../../../../../images/tech_support/pregame_options1.jpg"></P>  <P>2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  You will be prompted for the Video Driver you
  wish to use. Normally, there will only be one option available. If you have
  multiple video cards, select the one you have experienced the best
  performance with and click OK to continue.&nbsp;</P>  <OL>   <LI>Select your desired
       language and click OK to continue.&nbsp;The game will automatically
       select a default group of models according to how much RAM you have. You
       may add or remove models as you wish, but note that adding more models
       will affect your game performance. Removing models from the list forces
       the game to use the original, less detailed, models. </LI>  </OL>  <P>Click Next to continue.&nbsp;</P>  <P>4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  The next screen will ask you to select which
  Graphic Engine settings you wish to use. Again, the system will automatically
  select default settings according to how much RAM you have:</P>  <OL>   <UL>    <LI><STRONG>Social
        Animations</STRONG> toggles the animations performed when using social
        commands (such as &quot;/wave&quot;, &quot;/laugh&quot;, etc.). Turning
        this option off will increase your performance by freeing up more
        memory.</LI>    <LI><STRONG>Texture
        Compression</STRONG> reduces the amount of memory required for textures
        if your video card supports this feature. Texture compression will
        increase load times when entering the game and when zoning. It is
        recommended that you leave this feature turned off unless you are sure
        your graphics card supports it.</LI>    <LI><STRONG>Sound</STRONG>        toggles sound effects in the game. Turning this option off will
        increase performance.</LI>    <LI><STRONG>Dynamic
        Lighting</STRONG> toggles the lighting and shadow effects. Turning this
        option off will use the default lighting (from the original game) and
        increase performance.</LI>    <LI><STRONG>Resolution</STRONG>        sets the screen size you will use. Higher resolution screens will have
        greater detail, but will slow down your performance.</LI>    <LI><STRONG>Texture
        Quality</STRONG> will set how detailed your textures will look. Higher
        quality will look better, but will decrease your performance and
        increase load times.<BR><BR></LI>   </UL>  </OL>  <P>5.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Click OK to finish</P>  <P>If you are still having problems after visiting this support section, you
  can contact our Technical Support Department via email using our <A TARGET="_blank" HREF="http://www.station.sony.com/en/services/help/premiumGames.jsp">online form</A>.</P>
