...
<P><STRONG>EverQuest Fifth-Year Anniversary 12-month
  Subscription Plan</STRONG> </P>  <P>Between March 16th, 2004 and March 30th, 2004, you can extend your
  current, valid EverQuest account for an additional 12 months or begin a new
  12-month EverQuest account by signing up for the EverQuest Fifth-Year
  Anniversary 12-month Subscription Plan and reap great savings.</P>  <UL>   <LI>An EverQuest
       Fifth-Year Anniversary 12-month Subscription account costs only
       US$99.99-- that's only $9.08 a month, a huge 36% discount off of the
       current EverQuest monthly rate!</LI>  </UL>  <P>Terms:</P>  <P>Cost: $99.99 (plus taxes, if applicable). Residents of VAT-applicable
  European Union territories will also be charged a VAT tax equal to 17.5% of
  the applicable fee.</P>  <P>By electing the EverQuest Fifth-Year Anniversary 12-month Subscription
  Plan, you acknowledge and agree to all of the following:</P>  <P>This subscription enables one EverQuest account for twelve (12) months.
  SOE does not give full or partial refunds for unused subscription periods.</P>  <P>To be eligible for the EverQuest Fifth-Year Anniversary 12-month
  Subscription Plan, you must have a current, valid, EverQuest account on an
  SOE server (version of EverQuest published and hosted by SOE and not
  published or hosted by SOE partners outside of North America) that is not
  suspended or banned and is otherwise in good standing. EverQuest accounts
  registered on non-SOE servers, accounts using the GlobalCollect payment
  method with payment pending, EverQuest accounts being used in connection with
  combination subscription pricing plans like the SOE All Access plan
  (including EverQuest: Legends accounts that have also been enabled for the
  SOE All Access plan), or the Station Pass, EverQuest: Legends subscribers,
  EverQuest accounts currently suspended, banned, not otherwise in good
  standing, or registered with a promotional or provisional account key are not
  eligible.</P>  <P>The EverQuest Fifth-Year Anniversary 12-month Subscription Plan requires a
  valid credit card. If you currently use either a GameCard or GlobalCollect
  payment method for your EverQuest account, you must provide SOE with a valid
  credit card upon your election to subscribe to the EverQuest Fifth-Year
  Anniversary 12-month Subscription Plan. The new EverQuest Fifth-Year
  Anniversary 12-month Subscription Plan will take effect at the end of your
  current billing cycle and your credit card will then be billed at the end of
  your current billing cycle.</P>  <P>The EverQuest Fifth-Year Anniversary 12-month Subscription fee is a
  recurring charge; that means that, unless and until you cancel your account,
  you authorize SOE to charge your credit card the subscription amount at the
  beginning of each subscription period.&nbsp;Your use of the EverQuest
  software under the EverQuest Fifth-Year Anniversary 12-month Subscription
  plan and your game play remains strictly subject to the EverQuest User
  Agreement and Software License (and Rules of Conduct), as each may be amended
  or modified by SOE at any time in its sole discretion.</P>  <P>Your use of the EverQuest software under the EverQuest Fifth-Year
  Anniversary 12-month Subscription plan and your game play remains strictly
  subject to the EverQuest User Agreement and Software License (and Rules of
  Conduct), as each may be amended or modified by SOE at any time in its sole
  discretion.</P>  <P>Any account converted to the EverQuest Fifth-Year Anniversary 12-month
  Subscription plan during any no-charge subscription period will be
  immediately converted, and the remainder of such period(s) will be waived.</P>
