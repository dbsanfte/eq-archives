...
<tr>
	...
	<a href="dev_view.jsp?id=64082" class="tinylink">Dev Chat at House
  of Commons - Tonight!!</a><br>
	
	<a href="dev_view.jsp?id=64081" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64079" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64077" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64076" class="tinylink">Wanted: Sr. Server Programmer</a><br>
	
	<a href="dev_view.jsp?id=64075" class="tinylink">The Next Fan Faire Location</a><br>
	
	<a href="dev_view.jsp?id=64074" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64073" class="tinylink">SOE Worlds Available</a><br>
...
<option value="64082">Dev Chat at House
  of Commons - Tonight!! 08/25/2005 12:05 PM PST</option>
...
<option value="62775">Robert Pfister on the
  Next EverQuest Update 07/07/2004 12:06 pm</option>
...
<h1>Dev Chat at House
  of Commons - Tonight!!</h1>
<P>Once again, we have a House of Commons with the Developers
  of <A HREF="http://www.everquest.com/">EVERQUEST</A> tonight, Thursday August
  25th. It will be at 6pm PST / 9pm EST in the #StraticsHoC channel on Stratics
  IRC.</P>  <P>We will be discussing the upcoming expansion: Depths of
  Darkhollow. The following will be In attendance, so do come and let your
  opinions be known and get your questions answered! </P>  <UL>   <LI>Ryan
       Barker ~ Rytan </LI>   <LI>Jonathan
       Craraker ~ Prathun </LI>   <LI>Craig
       Knapp ~ Zorillus, </LI>   <LI>Jason
       Mash ~ Maddoc, </LI>   <LI>Travis
       McGeathy ~ Rashere </LI>   <LI>Christina
       Delza ~ Kytherea, and... </LI>   <LI>Alan
       Van Couvering ~ Absor! </LI>  </UL>  <P>You can connect to one of our IRC servers through the use
  of your favorite IRC client, such as mIRC, ircle, xchat, or whichever you
  prefer. Connect to irc.stratics.com port 6668 or whichever server is closest
  to you: </P>  <P>stratics.frws.com port 6668, USA - Colorado </P>  <P>irc.glowfish.de port 6668, EU - Germany </P>  <P>stratics.afraidyet.net 6668, USA - Atlanta </P>  <P>irc.epaxsys.net port 6668, USA - Colorado</P>  <P>You may also connect through our handy Java link which may
  be found right <A HREF="http://chat.stratics.com/content/java/HoC/hoc1start.php">here</A>. You
  must have Java installed to use this which can be downloaded from the <A HREF="http://www.java.com/en/index.jsp">Java homepage</A>.</P>  <P>We will be giving away 5 CD-Keys to Depths of Darkhollow
  courtesy of SoE, so... see you there!</P>
