...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">46,424 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp');">
...
<DIV align=center><STRONG><BR>System Requirments</STRONG> </DIV>
...
<LI>4X speed CD-ROM 
<LI>450 MB+ hard drive space<BR></LI></UL><I>Note: Although technically below the minimum specs, players with 128 MB of RAM will still be able to run Luclin by turning off the new character models.</I> 
...
<LI>16X speed CD-ROM 
<LI>1.5 GB+ hard drive space<BR></LI></UL>
<P><I>Note: DirectX 8.1 or greater is required for Windows 98 ,XP, ME, and 2k.</I> </P>
<P>&nbsp;</P>
<P align=center><B>DirectX 8.1 or Higher Required</B> </P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>With the release of EverQuest: The Shadows of Luclin, we require DirectX 8.1 or higher. This is true not only for those purchasing Shadows of Luclin, but for everyone playing EverQuest. All details regarding this change can be found here: <A href="http://boards.station.sony.com/ubb/everquest/Forum1/HTML/000348.html">http://boards.station.sony.com/ubb/everquest/Forum1/HTML/000348.html</A></FONT></P>
...
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to <A href="https://www.microsoft.com/downloads/release.asp?ReleaseID=27741/t_blank">https://www.microsoft.com/downloads/release.asp?ReleaseID=27741</A>and install the latest DirectX drivers for your operating system.</FONT> 
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to the website for your 3D accelerator. There are a number of different manufacturers, and it is preferred that you visit the website for the manufacturer of your card. At your option, you can go to the chipset manufacturer site. Most will be able to use either <A href="http://www.3dfx.com/">www.3dfx.com</A> (for Voodoo cards), <A href="http://www.atitech.com/">www.atitech.com</A> (for ATI cards) or <A href="http://www.nvidia.com/">www.nvidia.com</A> (for TNT/GeForce cards). Download and install the latest drivers appropriate for your card and operating system. See our Video FAQ (<A href="http://everquest.station.sony.com/support/audio_video/general_video_troubleshooting.jsp">http://everquest.station.sony.com/support/audio_video/general_video_troubleshooting.jsp</A>) for more details.</FONT> 
...
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Save the file as "dxdiag.txt" </FONT></LI></OL>
...
<P>&nbsp;</P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>If you are still having problems after visiting this support section, you can contact our Technical Support Department via email using our <A href="http://www.station.sony.com/en/services/help/premiumGames.jsp">online form</A>.</FONT></P>
