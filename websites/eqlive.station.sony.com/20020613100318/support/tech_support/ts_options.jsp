...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_options.jsp?null');">
...
<DIV align=center><STRONG><BR>How to Change Your Options Through the Game Interface</STRONG> </DIV>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>If you are having performance problems, or you wish to change your graphics settings for EverQuest&reg;: The Shadows of Luclin&#153;, you may do so through the game interface:</FONT></P>
<OL>
<LI>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Launch EverQuest. At the main screen, click "Options" instead of "Connect."</FONT></P>
<P align=center><FONT face="Arial, Helvetica, sans-serif" size=2><IMG height=352 src="/images/tech_support/pregame_options1.jpg" width=469></FONT></P>
<LI>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>You will be prompted for the Video Driver you wish to use. Normally, there will only be one option available. If you have multiple video cards, select the one you have experienced the best performance with and click OK to continue.</FONT></P><FONT face="Arial, Helvetica, sans-serif" size=2><IMG height=352 src="/images/tech_support/pregame_options2.jpg" width=469></FONT> 
<P align=center>&nbsp;</P>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Select your desired language and click OK to continue.<BR><BR></FONT><FONT face="Arial, Helvetica, sans-serif" size=2><IMG height=352 src="/images/tech_support/pregame_options3.jpg" width=469></FONT> 
<P align=center>&nbsp;</P>
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>The game will automatically select a default group of models according to how much RAM you have. You may add or remove models as you wish, but note that adding more models will affect your game performance. Removing models from the list forces the game to use the original, less detailed, models. </FONT>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Click Next to continue.</FONT></P><FONT face="Arial, Helvetica, sans-serif" size=2><IMG height=352 src="/images/tech_support/pregame_options4.jpg" width=469></FONT> 
<P align=center>&nbsp;</P>
<LI>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>The next screen will ask you to select which Graphic Engine settings you wish to use. Again, the system will automatically select default settings according to how much RAM you have:</FONT></P><FONT face="Arial, Helvetica, sans-serif" size=2><IMG height=352 src="/images/tech_support/pregame_options5.jpg" width=469></FONT> 
<P align=center><FONT face="Arial, Helvetica, sans-serif" size=2><B></B></FONT></P>
<UL>
<LI><B>Social Animations</B> toggles the animations performed when using social commands (such as "/wave", "/laugh", etc.). Turning this option off will increase your performance by freeing up more memory. 
<LI><B>Texture Compression</B> reduces the amount of memory required for textures if your video card supports this feature. Texture compression will increase load times when entering the game and when zoning. It is recommended that you leave this feature turned off unless you are sure your graphics card supports it. 
<LI><B>Sound</B> toggles sound effects in the game. Turning this option off will increase performance. 
<LI><B>Dynamic Lighting</B> toggles the lighting and shadow effects. Turning this option off will use the default lighting (from the original game) and increase performance. 
<LI><B>Resolution</B> sets the screen size you will use. Higher resolution screens will have greater detail, but will slow down your performance. 
<LI><B>Texture Quality</B> will set how detailed your textures will look. Higher quality will look better, but will decrease your performance and increase load times. </LI></UL><FONT face="Arial, Helvetica, sans-serif" size=2><BR><BR></FONT>
<LI>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>Click OK to finish</FONT></P></LI></OL><FONT face="Arial, Helvetica, sans-serif" size=2><BR><BR></FONT>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>If you are still having problems after visiting this support section, you can contact our Technical Support Department via email using our <A target=_blank href="http://www.station.sony.com/services/everquest-technical.jhtml">online form</A>.<BR></FONT></P>
