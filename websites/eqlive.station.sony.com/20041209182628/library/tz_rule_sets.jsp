                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P align=left><B>Tallon Zek Rules:</B></P>
<P>Welcome to Tallon Zek,&nbsp;a PvP Teams servers.</P>
<P>Tallon Zek, like&nbsp;Vallon Zek and&nbsp;Sullon Zek, are PvP teams servers. In general the servers are based on the concept of a PvP teams server, like Sullon Zek, but with the teams chosen based on which race you choose at creation rather than your deity.</P>
<P>This document includes the PvP rules for Tallon and Vallon Zek. </P>
<OL>
<LI>Player v. Player (PvP) combat can occur between any characters that are within an 8 level limit. For instance, a level 42 person may attack or be attacked by anyone from level 34 through 50, assuming they are on opposing teams.<BR>
...
<LI>Characters will not lose experience when killed in PvP combat, under most circumstances, although the occasional loss of experience is to be expected.<BR>
<LI>In the event that you kill or are killed by another player on this server only coin may be looted from a fallen opponent.<BR>
<LI>All combat skills have their effective value capped at 2 levels above a player's current level. Losing two levels will not cause you to lose any combat skill effectiveness. However, losing more than that will cause those skill caps to be lowered so that they remain only two levels above your current level.<BR>
<LI>Resistance debuff spells have a 50% increased effectiveness against player characters.<BR>
<LI>/consider returns only three kinds of results when used against player characters: 'Green' means that the character is below your range. 'White' or 'black' means that the character is within your range. 'Red' means that they are above your range. 'In range' means +/- 8 levels.<BR>
<LI>Faction hits for PvP will be taken for killing characters within their racial hometowns. Killing a human in any human starting city will cause a faction loss with the locals. Freeport, Qeynos and Surefall Glade are considered starting cities for humans. All of Greater Faydark and Felwithe are considered the starting city for high elves and wood elves. Half elves have no starting city. Erudites have hometowns that match their starting cities. Other cities are not considered hometowns, despite being run and controlled by a certain race. For example, HighHold is not a human hometown. Thurgadin is not a dwarven hometown.<BR>
<LI>On Tallon and Vallon Zek, PvP-related Play Nice Policy situations are expected to be resolved using PvP solutions. However, Non PvP-related Play Nice Policy issues, such as training, causing intentional experience loss, bind point, zone, and portal camping, as well as other various forms of harassment, are not permitted in the PvP environment. <BR>
<LI>While corpse camping is no longer illegal, corpse camping someone until the point where his or her corpse decays is considered harassment.<BR>
<LI>All rules regarding general decency still apply. Cursing, threats, and other such things will be dealt with sternly, and are still unacceptable behavior on any server. <BR>
...
<LI>The Hide skill and all 'invisibility' spells will cause player characters to lose targeting on the character that has hidden or gone invisible. </LI></OL>
<P><B>The Teams:</B></P>
<UL>
<LI>Dark Races - Comprised of Iksar, Dark Elves, Ogres, and Trolls 
<LI>Short Races - Comprised of Dwarves, Halflings, and Gnomes. 
<LI>Elven Races - Comprised of Half Elves, Wood Elves, and High Elves. 
<LI>Human Races - Comprised of Humans, Erudites, Barbarians, and Vah Shir</LI></UL>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
