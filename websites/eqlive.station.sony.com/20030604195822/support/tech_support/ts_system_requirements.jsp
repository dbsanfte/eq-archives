		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
...
<LI>4X speed CD-ROM 
<LI>570&nbsp;MB+ hard drive space<BR></LI></UL><I>Note: Although technically below the minimum specs, players with 128 MB of RAM will still be able to run Luclin by turning off the new character models.</I> 
...
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to <A href="http://www.microsoft.com/windows/directx/default.aspx">http://www.microsoft.com/windows/directx/default.aspx</A>&nbsp;<A href="https://www.microsoft.com/downloads/release.asp?ReleaseID=27741/t_blank"></A>and install the latest DirectX drivers for your operating system.</FONT> 
<LI><FONT face="Arial, Helvetica, sans-serif" size=2>Go to the website for your 3D accelerator. There are a number of different manufacturers, and it is preferred that you visit the website for the manufacturer of your card. At your option, you can go to the chipset manufacturer site. Most will be able to use either <A href="http://www.3dfx.com/">www.3dfx.com</A> (for Voodoo cards), <A href="http://www.ati.com/">www.ati.com</A> (for ATI cards) or <A href="http://www.nvidia.com/">www.nvidia.com</A> (for TNT/GeForce cards), <A href="http://www.matrox.com/">www.matrox.com</A> (for Matrox cards). Download and install the latest drivers appropriate for your card and operating system. See our Video FAQ (<A href="http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A><A href="http://everquest.station.sony.com/support/audio_video/general_video_troubleshooting.jsp"></A>) for more details.</FONT> 
