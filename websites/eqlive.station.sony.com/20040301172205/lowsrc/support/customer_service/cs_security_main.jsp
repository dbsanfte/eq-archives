...
<a href="/support/customer_service/cs_security_main.jsp">Full Design Version</a>
</p>
...
<P>As the population of Norrath increases, so too do issues regarding stolen or compromised accounts, and/or accounts that have been transferred from one player to another in violation of the User Agreement. These issues - and the time it takes to investigate and attempt to resolve them - hugely detract from the time that SOE's customer support staff have to provide quality customer service. Accordingly, SOE must remind all customers that: </P>
<P>(1) Account security -- whether it be password protection, running virus checks, disabling file sharing, or any other element of making sure accounts are not stolen or compromised -- is the responsibility of the account owner. </P>
<P>(2) Any and all stolen and/or compromised accounts that are reported to SOE may be *suspended* in order to conduct an investigation. Lost items will generally not be reimbursed. Instead, a one time restoration based upon information gathered through our investigation may be offered at the discretion of a GM. However this offer is limited by the amount of time taken to report the compromised account. If the restoration period (7 days) has passed, then there will be no restoration or reimbursement available. Additionally, this restoration offer is <I>one time only</I>. Should the account become compromised in the future, no restoration of the character or reimbursement of items lost will be offered. Items and/or experience that are lost due to a restoration of this nature will not be reimbursed. </P>
<P>(3) Any customer found to be involved in an account theft may have any and all of his/her accounts banned. This includes accounts found to have knowingly received items stolen from a compromised account. Prior to taking any action against accounts reported as compromised, we will conduct a thorough review of the accounts and determine the appropriate course of action. Accounts will only face disciplinary action based on information gathered through our investigation and not as a result of external allegations. </P>
<P>- The EverQuest Customer Service Team</P>
<P><BR>If you are still having problems after visiting this support section, you can contact our Technical Support Department through an email via our <A href="http://www.station.sony.com/en/services/help/eqGM.jsp" target=_blank>online form</A>.</P>
