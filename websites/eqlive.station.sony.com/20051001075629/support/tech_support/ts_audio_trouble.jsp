...
<P ALIGN="center"><STRONG><BR><STRONG>General Audio Troubleshooting</STRONG></STRONG></P>  <P><STRONG>Is the
  ...
  card installed. To get the drivers we've currently tested, please visit the <A HREF="../../../../../support/tech_support/ts_audio.jsp">Supported Sound Cards</A>&nbsp;section.</P>  <OL>   <LI>If you have another video game that uses
       ...
       client now demands full time attention from video, sound, and communication
       devices. Your problem may stem from those devices sharing IRQs on the
       machine in question. Sharing occurs when you look at the list of used
       IRQs and see two devices listed multiply (when you have only one) or two
       devices assigned to a single IRQ (that should each be using a unique
       one). To check for this, right click the &quot;My Computer&quot; icon on
       your desktop and choose &quot;Properties&quot; from the menu. Next,
       choose the &quot;Device Manager&quot; tab, then double click the
       &quot;Computer&quot; entry at the top of the device list. This should
       bring up the IRQ Resource window. Start looking for multiple devices
       assigned to a single IRQ number. Make note of the IRQs being used by
       main devices such as sound, video, and communications devices. If these
       are shared, besides having an IRQ holder, you may experience some
       problems. In most cases, you will have to physically remove the device
       and re-seat it into a different motherboard slot to stop sharing. If you
       are not familiar with doing this, please take your machine to a local
       hardware technician for assistance.</LI>   <LI>Determine if you
       have installed DirectX since the last time the audio was working
       properly. Sometimes installing DirectX can change the audio driver,
       unbeknownst to the user. If this is the case, you can re-install the
       sound drivers. Make sure any previous drivers are removed from both the
       Device Manager and the Add/Remove Programs control panel. If the card in
       question doesn't have an obvious hardware conflict, the problem is
       likely to be a bad driver installation.</LI>  </OL>  <P>&nbsp;</P>  <P><STRONG>No Sound
  ...
  &quot;Properties&quot; from the menu. Next, open up the &quot;Sound, Video and
  Game Controllers&quot; section. Your sound card will be listed in this area.</P>  <P>After
  ...
  Try selecting another device from the drop-down menu and re-run EverQuest.
  Windows98 users can also try the following: Under &quot;Preferred
  Playback&quot;, click the &quot;Advance Properties&quot; button and choose
  the &quot;Performance&quot; tab. Lower the &quot;Hardware Acceleration&quot;
  ...
  Open the Multimedia control panel, and select the Audio section. Click Advanced
  Properties, then click Restore Defaults.</P>  <P>&nbsp;</P>  <P>If you are still
  having problems after visiting this support section, you can contact our
  Technical Support Department via email using our <A HREF="http://www.station.sony.com/en/services/help/premiumGames.jsp">online form</A>.</P>    <P>&nbsp;</P>
