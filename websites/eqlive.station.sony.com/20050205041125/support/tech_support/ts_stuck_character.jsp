...
<P ALIGN="center"><STRONG><BR><STRONG>Troubleshooting Stuck Characters</STRONG></STRONG></P>  <P>If you are having troubles accessing only one of your characters from the
  server select screen then please follow the directions below in order to remedy
  your problem.</P>  <P>First, exit the game to your Windows desktop, and double click on the
  &quot;My Computer&quot; icon. Go into the EverQuest directory (the default
  location is &quot;c:\\program files\\everquest&quot;), and delete the files
  for the zone that you were last in, or zoning into (the file names will start
  with the zone name). While in the EverQuest directory you will want to also
  delete all files ending in the &quot;.opt&quot; extension along with the zone
  files.</P>  <P>Another suggestion would be to temporarily disable your sound in
  EverQuest. In order to do this, log into EverQuest and click Options on the
  first menu. On the last page of the options you will see Sound. All you need
  to do is uncheck this and it will then be disabled until you recheck it.</P>  <P>If either of these do not allow you to login under your character, you
  will have to contact the GM for your server with a different character, so he
  or she can log in under your account and &quot;walk&quot; the character out
  of the zone it is stuck in.</P>  <P>&nbsp;</P>  <P>If you are still having problems after visiting this support section, you
