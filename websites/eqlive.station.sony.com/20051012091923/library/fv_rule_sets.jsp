...
//window.alert(document.cookie);
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><STRONG>Firiona Vie (A roleplaying preferred server)</STRONG></P>  <P>The Firiona Vie server is a roleplaying preferred server. To motivate
  players to take advantage of the roleplaying atmosphere, the following
  feature list was implemented.</P>  <P>This is a PvE (Player vs. Environment) server, NOT a PvP (Player vs.
  Player) server. In other words, it's a standard &quot;blue&quot; server with
  the same rules and features regarding PvP as the vast majority of our
  servers. It is not one of the &quot;Zeks&quot;.</P>  <UL>   <LI>Beneficial buff
       spells will not work on characters 20 levels lower than the caster.</LI>   <LI>The Common
       language will not exist. A Human language will be added and only made
       easily available to certain races.</LI>   <LI>Only one character
       can be created on each account.</LI>   <LI>The Trivial Loot
       Code will be in effect in all zones.</LI>   <LI>Very few items
       will be No-Drop. Exceptions will include things such as newbie notes and
       epic weapons.</LI>   <LI>Bind Affinity will be
       restricted for all characters to locations where melee characters can
       bind on other servers. </LI>  </UL>  <P><STRONG>Trivial Loot Code</STRONG></P>  <P>Briefly, the Trivial Loot Code works like this: If a characters kills an
  NPC and that NPC does not give them experience, then the Trivial Loot Code
  takes effect. This can happen when either a member of your group is too high
  in level to receive experience from killing the monster, or when a member of
  your group is outside of the level range of the group for receiving
  experience from the kill. If any member of the group does not get experience
  ...
  Normal items and coins will appear on the corpse in all cases as usual.</P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
