...
<P align=left>Unfortunately, the Aureal company is no longer in business, so support for the following sound cards is limited. Reference drivers for the A3D chipsets can be found at <A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm</A>.</P>
<P><I>Cards we have tested:</I></P>
<UL>
<LI><SPAN class=subHeader>Turtle Beach</SPAN><BR>Montego / Vortex A3D<BR><A target=_blank href="http://www.voyetra-turtle-beach.com/">http://www.voyetra-turtle-beach.com/</A><BR><BR>
<LI><SPAN class=subHeader>Diamond Multimedia</SPAN><BR>Monster Sound MX300<BR><A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm/</A></LI></UL>
<P><I>Not Tested but Should Work:</I></P>
<UL>
<LI><SPAN class=subHeader>Diamond Multimedia</SPAN><BR>Monster Sound<BR>Monster Sound M80<BR>Monster Sound MX200<BR><A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Monster Sound MX400</SPAN><BR><A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Multiwave </SPAN><BR>AudioWave 16 PNP<BR>AudioWave Green 16<BR>AudioWave Platinum 16<BR>AudioWave 32PNP<BR><A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Orchid</SPAN><BR>Nusound 3D<BR><A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm</A><BR><BR>
<LI><SPAN class=subHeader>Xitel </SPAN><BR>Storm VX<BR><A target=_blank href="http://www.vortexofsound.com/drivers/drivers.htm">http://www.vortexofsound.com/drivers/drivers.htm</A></LI></UL>
<P>&nbsp;</P>
...
<P><I>Cards we have tested:</I></P>
<UL>
<LI><SPAN class=subHeader>Sound Blaster Live! Family</SPAN><BR><A target=_blank href="http://soundblaster.com/">http://soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster Live! then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster PCI512</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster PCI128</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/</A> <BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster AWE64 Gold</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster AWE 64 </SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster AWE 32 </SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster 16 </SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I></LI></UL>
<P>&nbsp;</P>
...
<UL>
<LI><SPAN class=subHeader>Sound Blaster PCI64</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><I><BR>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster Ensoniq Audio PCI</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I> 
<LI><SPAN class=subHeader>Sound Blaster 32</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/ </A><BR><I>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the driver listing</I></LI></UL>
<P>&nbsp;</P>
<P class=subHeader align=center>Crystal</P>
<P><I>Cards we have tested:</I></P>
<UL>
<LI><SPAN class=subHeader>Crystal PNP CS4236B and SoundBlaster 16 compatible</SPAN><BR><A target=_blank href="http://www.cirrus.com/Drivers/audiodrv/index_new.cfm">http://www.cirrus.com/Drivers/audiodrv/index_new.cfm</A></LI></UL>
<P>&nbsp;</P>
...
<UL>
<LI><SPAN class=subHeader>Soundscape</SPAN><BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing</I></LI></UL>
<P><I>Not tested but should work:</I></P>
<UL>
<LI><SPAN class=subHeader>Soundscape VIVO</SPAN><BR>Soundscape Elite<BR><A target=_blank href="http://support.soundblaster.com/">http://support.soundblaster.com</A><BR><I>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the driver listing </I>
<P class=subHeader align=center><BR></P>
<DIV align=center>
<DIV align=left>
<P>&nbsp;</P>
<P>If you are still having problems after visiting this support section, you can contact our Technical Support Department through an email via our <A target=_blank href="http://www.station.sony.com/en/services/help/eqGM.jsp">online form</A>.</P></DIV></DIV></LI></UL>
