...
<tr>
	...
	<a href="recent_updates.jsp?id=64041" class="tinylink">April 12th, 2005</a><br>
	...
	<a href="recent_updates.jsp?id=64021" class="tinylink">February 15th,
   2005</a><br>
...
<h1>April 20th, 2005</h1>
 <p>*** Events ***<br> ---------------------------------- </p><ul> <li>The Girplan Guardian encounter in the wizard epic had its difficulty lowered to bring it more in line with other epic 1.5 fights. <br> <li>Rumors have been spread that the Ring of Scale have started to investigate the new vampires of Mistmoore(RoS faction quest is in).<br> <li>Eryke Stremstin for the monk epic in the bazaar should no longer fall under the world.</li></ul><p> *** Items ***<br> ---------------------------------- </p> <ul><li>Changed the name of the Basilisk Tooth to be Great Reptile Tooth.<br> <li>Changed the name of Racnar Hide to Great Reptile Hide. <br> <li>Great Reptile Teeth can now drop off crocs in Plane of Earth and Plane of Nightmare.<br> <li>Great Reptile Hides can now drop off raptors in Cazic Thule.<br> <li>Pile of Gravel can now drop off Gargoyles in Plane of Nightmare and the Hole.<br> <li>Tribute values on certain Kunark chest and legpieces has been decreased . <br> <li>Horn of Doomcalling now has +2 mana regen.<br> <li>Supple Crimson Choker now has a +2 mana regen.<br> <li>Clawhammer is now a 70 damage, 32 delay weapon.<br> <li>Many items with over 160hp in DoN raids and small events were incorrectly marked with type 4/7 augmentation slots. These now have type 8 augmentation slots. <br> <li>Shed Ikaav Skin drop rate/locations adjusted to include Ikaavs in the Ruined City of Dranik.<br> <li>Mindreaver's Shoes of Coercion now has the focus of Alacrity of the Aneuk.<br> <li>Earring of Dragonkin is now called "Earring of Wurmkin".<br> <li>Mask of Forbidden Rites is now flagged all/all.</li></ul> </p><p> *** Item Spells ***<br> ----------------------------------</p><p> <ul><li>Deafening Strike now increases the duration of Fellstrike Discipline.<br> <li>Ture's Anger now increases the duration of Blind Rage Discipline.</li></ul></p><p> *** Spells ***<br> ----------------------------------</p><p> <ul><li>Lowered the duration of many fear spells cast by NPCs. <br> <li>Reduced the number of NPCs who cast fear throughout the game. <br> <li>Changed all PC pets over level 52 so they are once again immune to fear. <br> <li>Several spells were not set to the correct proc values in the previous update to compensate for the change in pet base proc rates. The following spells have had their proc rates adjusted to be the same as they were before the previous patch: </li></ul> </p><p> Might of the Wild Spirits</p><p> Savage Wildcaller's Blessing</p><p> Hobble of Spirits</p><p> Primal Fusion</p><p> Elemental Conjunction</p><p> <ul><li>Corrected the hate generated by the enchanter spell Howl of Tashan and the monk ability Dragon Fang.</li></ul> </p><p> *** Miscellaneous ***<br> ----------------------------------</p><p> <ul><li>Added level up text for all levels between 11 and 70.<br> <li>A bug affecting skilling up in combat skills at all levels and tradeskills at low levels has been fixed. Skilling up at these levels should be back to normal. </li></ul></p><p> -- The EverQuest Team</p>
