                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><STRONG>Vallon&nbsp;Zek rules:</STRONG></P>  <P>Welcome to Vallon Zek,&nbsp;a PvP Teams servers.</P>  <P>Vallon Zek, like Sullon Zek,&nbsp;is a&nbsp;PvP teams servers. In general
  the servers are based on the concept of a PvP teams server, like Sullon Zek,
  but with the teams chosen based on which race you choose at creation rather
  than your deity.</P>  <P>This document includes the PvP rules for Tallon and Vallon Zek.</P>  <OL>   <LI>Player v. Player
       ...
       your range. 'In range' means +/- 8 levels.</LI>   <LI>Faction hits for
       ...
       hometown. Thurgadin is not a dwarven hometown.</LI>   <LI>On Tallon and
       Vallon Zek, PvP-related Play Nice Policy situations are expected to be
       resolved using PvP solutions. However, Non PvP-related Play Nice Policy
       issues, such as training, causing intentional experience loss, bind
       point, zone, and portal camping, as well as other various forms of
       harassment, are not permitted in the PvP environment.</LI>   <LI>While corpse
       camping is no longer illegal, corpse camping someone until the point
       where his or her corpse decays is considered harassment.</LI>   <LI>All rules regarding
