	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/kunark.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/kunark.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/kunark.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                                  ...
                                  <tr> 
                                    ...
                                    <td width="100%"> 
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr> 
                                          <td height="108"> 
                                            <div align="center"> <img src="images/kunark_title.gif" width="139" height="35"> 
                                  ...
                                  <tr> 
                                    ...
                                    <td> 
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          ...
                                          <td width="80%" height="256" rowspan="3"> 
                                            <center>
                                              <img src="images/map_kunark_hi.gif" width="400" height="363" usemap="#cities" border="0"> 
                                              <map name="cities"> 
                                                <area shape="rect" coords="274,165,322,185" href="cabilis.jsp">
                                              </map>
                                            </center>
                                          </td>
                                          <td width="20%"> 
                                      ...
                                      <table border="0" width="100%" cellpadding="20" cellspacing="0">
                                        <tr> 
                                          <td><font color="#333333">Kunark is 
                                            a continent of ancient ruins and hostile 
                                            lands. Records tell tale of empires 
                                            lost to time, their ruined cities 
                                            and hidden tombs still filled with 
                                            treasures. The evil hand of Cazic-Thule 
                                            touched this land and spawned the 
                                            Iksar, a powerful reptilian race. 
                                            Once the predominant force, they now 
                                            strive to rise from the ashes and 
                                            reclaim their glory. The creatures 
                                            in Kunark are quite formidable and 
                                            regard all as invaders. Only the elven 
                                            outpost of Firiona Vie offers safe 
                                            haven for adventurers. This is no 
                                            place for the weak.</font></td>
                                          <td> 
