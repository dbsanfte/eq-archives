		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/dev_feedback.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/dev_feedback.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=350'); return false;" 
...
menu["Class Related Issues"][0]=new Option("Druid","Druid");
	

	
menu["Class Related Issues"][1]=new Option("Wizard","Wizard");
	

	
menu["Class Related Issues"][2]=new Option("Beastlord","Beastlord");
	

	
menu["Class Related Issues"][3]=new Option("Shadowknight","Shadowknight");
	

	
menu["Class Related Issues"][4]=new Option("Ranger","Ranger");
	

	
menu["Class Related Issues"][5]=new Option("Warrior","Warrior");
	

	
menu["Class Related Issues"][6]=new Option("Necromancer","Necromancer");
	

	
menu["Class Related Issues"][7]=new Option("Magician","Magician");
	

	
menu["Class Related Issues"][8]=new Option("General","General");
	

	
menu["Class Related Issues"][9]=new Option("Bard","Bard");
	

	
menu["Class Related Issues"][10]=new Option("Cleric","Cleric");
	

	
menu["Class Related Issues"][11]=new Option("Shaman","Shaman");
	

	
menu["Class Related Issues"][12]=new Option("Rogue","Rogue");
	

	
menu["Class Related Issues"][13]=new Option("Paladin","Paladin");
	

	
menu["Class Related Issues"][14]=new Option("Monk","Monk");
	

	
menu["Class Related Issues"][15]=new Option("Enchanter","Enchanter");
...
menu["Race Related Issues"][0]=new Option("Wood Elf","Wood Elf");
	

	
menu["Race Related Issues"][1]=new Option("Human","Human");
	

	
menu["Race Related Issues"][2]=new Option("Halfling","Halfling");
	

	
menu["Race Related Issues"][3]=new Option("Barbarian","Barbarian");
	

	
menu["Race Related Issues"][4]=new Option("Gnome","Gnome");
	

	
menu["Race Related Issues"][5]=new Option("Dwarf","Dwarf");
	

	
menu["Race Related Issues"][6]=new Option("Vah Shir","Vah Shir");
	

	
menu["Race Related Issues"][7]=new Option("Ogre","Ogre");
	

	
menu["Race Related Issues"][8]=new Option("Froglok","Froglok");
	

	
menu["Race Related Issues"][9]=new Option("Iksar","Iksar");
	

	
menu["Race Related Issues"][10]=new Option("High Elf","High Elf");
	

	
menu["Race Related Issues"][11]=new Option("Dark Elf","Dark Elf");
	

	
menu["Race Related Issues"][12]=new Option("Half Elf","Half Elf");
	

	
menu["Race Related Issues"][13]=new Option("Erudite","Erudite");
	

	
menu["Race Related Issues"][14]=new Option("General","General");
	

	
menu["Race Related Issues"][15]=new Option("Troll","Troll");
	

	menu["Skill Related Issues"]=new Array();
menu["Skill Related Issues"][0]=new Option("Pick Locks","Pick Locks");
	

	
menu["Skill Related Issues"][1]=new Option("Language","Language");
	

	
menu["Skill Related Issues"][2]=new Option("Fishing","Fishing");
	

	
menu["Skill Related Issues"][3]=new Option("Begging","Begging");
	

	
menu["Skill Related Issues"][4]=new Option("General","General");
	

	
menu["Skill Related Issues"][5]=new Option("Tracking","Tracking");
...
menu["Skill Related Issues"][7]=new Option("Mend","Mend");
	

	
menu["Skill Related Issues"][8]=new Option("Hide","Hide");
	

	
menu["Skill Related Issues"][9]=new Option("Forage","Forage");
	

	
menu["Skill Related Issues"][10]=new Option("Alcohol Tolerance","Alcohol Tolerance");
	

	
menu["Skill Related Issues"][11]=new Option("Pick Pocketing","Pick Pocketing");
	

	
menu["Skill Related Issues"][12]=new Option("Swimming","Swimming");
...
menu["Trade Skill Related Issues"][0]=new Option("Baking","Baking");
	

	
menu["Trade Skill Related Issues"][1]=new Option("General","General");
	

	
menu["Trade Skill Related Issues"][2]=new Option("Fletching","Fletching");
	

	
menu["Trade Skill Related Issues"][3]=new Option("Tailoring","Tailoring");
...
menu["Trade Skill Related Issues"][5]=new Option("Alchemy","Alchemy");
	

	
menu["Trade Skill Related Issues"][6]=new Option("Jewelcraft","Jewelcraft");
	

	
menu["Trade Skill Related Issues"][7]=new Option("Brewing","Brewing");
	

	
menu["Trade Skill Related Issues"][8]=new Option("Tinkering","Tinkering");
	

	
menu["Trade Skill Related Issues"][9]=new Option("Smithing","Smithing");
