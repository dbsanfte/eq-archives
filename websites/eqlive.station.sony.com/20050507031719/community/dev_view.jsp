...
<P><STRONG><U>Merging Servers</U></STRONG></P>  <P>The
  most recent server merges are complete and both newly merged servers are showing
  a healthy population and, as with the combined Zek servers, exceeding their
  previous combined population totals.&nbsp;
  As such, beginning April 11th and continuing until the completion of
  the process, we will continue merging all standard rule-set servers.&nbsp; The servers will be merged in the
  following order, on the dates listed.</P>  <P>&nbsp;</P>  <P><STRONG>4/18</STRONG> Mithaniel Marr merges with
  ...
  each merge is completed, as characters log into their newly-combined server,
  the leader board will be re-populated with standings. Although your points
  will be unaffected by the transfer, your standing may have changed based on
  the new, combined population totals.</P>  <P><STRONG><U>Complimentary Character
