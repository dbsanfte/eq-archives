...
<P>EverQuest now requires that clients have DirectX 9.0b or higher installed.</P>  <P>To determine what version of DirectX is currently installed on your
  ...
  Information. DirectX Version 9.0b is listed as &quot;DirectX 9.0b (4.09.0000.0902)&quot;</P>  <P>Please do the following prior to playing EverQuest. It is very important
  that your drivers are installed in the order indicated to avoid potential
  problems:</P>  <P>1. Go to <A HREF="http://www.microsoft.com/windows/directx/default.aspx">http://www.microsoft.com/windows/directx/default.aspx</A>  and install the latest DirectX drivers for your operating system.</P>  <P>2. Go to the website for your video card manufacturer. There are a number
