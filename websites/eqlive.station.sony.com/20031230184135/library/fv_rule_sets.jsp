	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/fv_rule_sets.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/fv_rule_sets.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/fv_rule_sets.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P align=left><STRONG>Firiona Vie (A roleplaying preferred server)</STRONG></P>
<P align=left>The Firiona Vie server is a roleplaying preferred server. To motivate players to take advantage of the roleplaying atmosphere, the following feature list was implemented.</P>
<P align=left>This is a PvE (Player vs. Environment) server, NOT a PvP (Player vs. Player) server. In other words, it's a standard "blue" server with the same rules and features regarding PvP as the vast majority of our servers. It is not one of the "Zeks".</P>
<UL>
...
<LI>Bind Affinity will be restricted for all characters to locations where melee characters can bind on other servers. 
<P></P></LI></UL>
<P align=left><STRONG>Trivial Loot Code</STRONG></P>
<P align=left>Briefly, the Trivial Loot Code works like this: If a characters kills an NPC and that NPC does not give them experience, then the Trivial Loot Code takes effect. This can happen when either a member of your group is too high in level to receive experience from killing the monster, or when a member of your group is outside of the level range of the group for receiving experience from the kill. If any member of the group does not get experience for a kill, the Trivial Loot Code will take effect. The Trivial Loot Code prevents magical, lore, and no-dorp items from appearing on the corpse. Normal items and coins will appear on the corpse in all cases as usual.</P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
