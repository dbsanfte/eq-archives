...
<title>EQLive - Special Servers</title>
<!-- #EndEditable -->
...
<a href="/library/special_servers.jsp">Full Design Version</a>
</p>
...
<!-- End Menu -->
<!-- #BeginEditable "Main" --> 
<h1>Special Servers</h1>


<P><A href="/lowsrc/library/fv_rule_sets.jsp">Firiona Vie</A><BR>Firiona Vie is a roleplaying preferred server.</P>
<P><A href="/lowsrc/library/rz_rule_sets.jsp">Rallos Zek</A><BR>The first +PvP server to launch. No team, everyone&nbsp;is on their own.</P>
<P><A href="/lowsrc/library/tz_rule_sets.jsp">Tallon Zek</A><BR>Team based server based on race selection.<BR><BR><A href="/lowsrc/library/vz_rule_sets.jsp">Vallon Zek</A><BR>Team based server based on race selection.</P>
<P><A href="/lowsrc/library/sz_rule_sets.jsp">Sullon Zek</A><BR>Team based server based on Deity selection.</P>
