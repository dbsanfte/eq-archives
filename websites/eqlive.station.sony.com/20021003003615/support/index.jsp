...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">87,432 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/index.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/index.jsp');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Support</font></b></div>
                        <!-- #EndEditable --></td>
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
						...
						<DIV align=left>You have entered the realm of Support. The paths below take you to the various areas of Support.</DIV>
<P><A href="http://help.station.sony.com/esupport/esupport/consumer/esupport.asp">Knowledge Base</A><BR>Your first stop for all your support needs. </P>
<P><A href="/support/customer_service.jsp">Customer Service</A><BR>Rules, policies, and even a GM Roster. </P>
<P><A href="/support/tech_support.jsp">Tech Support</A><BR>Having technical problems? Find the help you need here. </P>
<P><A href="/support/accounts_billing.jsp">Accounts and Billing</A><BR>Help on managing your account. </P>
<P><A href="https://store.station.sony.com/eq_char_moves/">Character Transfer Service<BR></A>A fee-based service that allows you to transfer your character between servers and/or accounts.</P>
<P><A href="https://store.station.sony.com/eq_char_renames/">Name Change Service<BR></A>Not happy with your character's name? This fee-based service allows you to change a character's first name.</P>
<P><A href="/support/network_status.jsp">Network Status</A><BR>Check here for the latest status on the EverQuest servers.</P>
<P><A href="/support/scheduled_downtime.jsp">Scheduled Downtime</A></P>
<P><A href="http://eqlive.station.sony.com/support/server_status.jsp">Server Status</A></P>
<P><A href="https://guide.everquest.com/guideapp/">EverQuest Guide Application</A><BR>Interested in becoming an EverQuest Guide? </P>
...
<table width="780" border="0" cellspacing="0" cellpadding="5" align="center" background="../images/2nd_bg.jpg">
  <tr>
    <td align="center"> 
      <p><font size="-2" face="Arial, Helvetica, sans-serif" color="3A485F">EverQuest and You’re in Our World Now are registered trademarks and The Ruins of Kunark, The Scars of Velious, The Shadows of Luclin and The Planes of Power are trademarks of Sony Computer Entertainment America Inc.  The Station, SOE and the SOE logo are trademarks of Sony Online Entertainment Inc. © 2002 Sony Computer Entertainment America Inc.; portions copyright 2002 Sony Online Entertainment Inc. All other trademarks are properties of their respective owners. All rights reserved. </font></p>
      </td>
  </tr>
</table>
<!-- begin main body -->
