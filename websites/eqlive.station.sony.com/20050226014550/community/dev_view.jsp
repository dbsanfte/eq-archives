...
<tr>
	...
	<a href="dev_view.jsp?id=64025" class="tinylink">A Hefty Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64024" class="tinylink">Dragons Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64022" class="tinylink">Mission NPCs are taking a short break. (updated)</a><br>
	
	<a href="dev_view.jsp?id=64023" class="tinylink">To /movelog or not to /movelog</a><br>
	
	<a href="dev_view.jsp?id=64020" class="tinylink">Tomorrow: Dragons of Norrath</a><br>
	
	<a href="dev_view.jsp?id=64018" class="tinylink">EverQuest: Dragons of Norrath beta NDA lifted.</a><br>
	
	<a href="dev_view.jsp?id=64019" class="tinylink">Got Hodgepodge?</a><br>
...
<h1>Server Merges</h1>
<P>On March 22, 2005,
  we will begin the process of merging some of the EverQuest servers.&nbsp; As we have seen from the recent
  success of the Zek merger, combining some of the EQ worlds is beneficial for
  players&#8217; experience.&nbsp; In
  fact, we have been pleasantly surprised to find that the new Zek server now has
  a higher population than the four combined servers had prior to that
  merger.&nbsp; We hope that by merging
  some of our lower population servers with a higher population server, we will
  continue to enhance your gameplay experience</P>  <P><STRONG><U>Merging Servers</U></STRONG></P>  <P>On March 22nd, Antonius Bayle will merge with Kane Bayle
  ...
  allow you to display your server of origin, should you desire to do so.&nbsp; </P>  <P><STRONG><U>Unutilized Character
  Purge</U></STRONG></P>  <P>Immediately preceding the merger, all characters below level
  10 that have not been logged in for over six months will be deleted from each
  of the merging servers and will not be available after the server merge.&nbsp;
  If you have a character on any of the servers being merged that is below
  level 10 and has not been logged in for more than six months, you will need
  to log that character in prior to the scheduled merge date for the relevant server.&nbsp;
  </P>  <P><STRONG><U>Shared Banks on
  ...
  servers being merged together, only the first eight characters (in
  alphabetical order) will be displayed after the merge.&nbsp; Characters other
  than the eight displayed characters will not be available for selection until
  ...
  affected by a merge will have been purged.</P>  <P><STRONG><U>Duplicate Character
  Names</U></STRONG></P>  <P>It is possible that characters on servers affected by the
  ...
  appended to their name and will be eligible for a name change.&nbsp; Characters
  can use the in-game /changename command to request a new name.&nbsp; The new name is subject to the
  conditions set forth in our naming policy which can be found here: <A HREF="http://eqlive.station.sony.com/support/customer_service/cs_naming_policy.jsp">Naming
  Policy</A>.</P>  <P><STRONG><U>LDoN Leader
  Boards</U></STRONG></P>  <P>After each merge is completed, as characters log into their
  newly-combined server, the leader board will be re-populated with standings. Although
  your points will be unaffected by the transfer, your standing may have changed
  based on the new, combined population totals.</P>  <P><STRONG><U>Complimentary
