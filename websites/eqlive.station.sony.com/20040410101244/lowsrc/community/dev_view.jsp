...
<a href="dev_view.jsp?id=&start=5">Older</a>
		...
		<a href="dev_view.jsp?id=61672">Login Server Issues</a><br>
	

	
		<a href="dev_view.jsp?id=61593">Account Security</a><br>
	

	
		<a href="dev_view.jsp?id=61540">Intel Video Chipsets</a><br>
	

	
		<a href="dev_view.jsp?id=61513">Direct X 9 Required on all SOE servers and Venril Sathir</a><br>
	

	
		<a href="dev_view.jsp?id=61281">Round Two . . . FIGHT!</a><br>
...
<h1>Login Server Issues</h1>
	<P>Greetings all,</P>
<P>We are still experiencing issues with our login server which is affecting your ability to connect to the game servers.&nbsp; Our operations team is working on the issue and hopes to have a resolution for you soon.&nbsp; We do apologize for duration of this problem and thank you for the patience you have shown while we work on this. </P>
<P>Thanks all.</P>
<P>Brenlo</P>
