...
<P ALIGN="center"><STRONG><BR><STRONG>Creating An Account</STRONG></STRONG></P>  <P><BR>Please make sure that you have your registration code and e-mail address ready
  before creating an account.</P>  <P>After running the <EM>EverQuest</EM> executable and performing the patch
  ...
  this will bring up the account registration screen.</P>  <OL>   <LI>Enter your name,
       address, e-mail address, and date of birth by left clicking in the
       field, then typing in the information. The TAB key may be used to move
       the cursor to the next field. Once all of the information on each
       registration screen has been filled out, click on the &quot;Next&quot;
       key located at the bottom right side of the screen.</LI>   <LI>Enter your PC
       specifications and answer the other general interest questions. Please
       note that the PC and general interest questions are not required to
       create the account. After you have completed this section of the
       registration click the &quot;Next&quot; key to continue.</LI>   <LI>Select a Chat Handle
       and enter your EverQuest account key. An account key is included with <EM>EverQuest</EM>.
       ...
       few minutes. After acceptance, you may want to sign up for the <A HREF="http://www.station.sony.com/allaccess/"><STRONG>SOE All Access Plan</STRONG></A>,
       which includes <EM>EverQuest</EM> Online Adventures, PlanetSide, and The
       Station Pass games. Once accepted, you may then return to the front-end
       screen and select &quot;Connect&quot; to begin playing <EM>EverQuest</EM>.</LI>  </OL>  <P>If you encounter any problems with the billing process, please e-mail The Station
  using an easy-to-use form from <A TARGET="_blank" HREF="http://www.station.sony.com/en/services/help/help.jsp">Account
