	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Library</font></b></div>
                        <!-- #EndEditable --></td>
...
<DIV align=left>Welcome to the Library. Within our stacks, you will find the latest volumes of Norrathian information. Also be sure to visit our Norrath Lore wing will you will find histories, stories, and musings of some of our notable, and not so notable citizens.</DIV>
<P><A href="http://eqlive.station.sony.com/manual/index.jsp">The EverQuest Manual</A><BR>The complete EverQuest manual to date.</P>
<P><A href="http://eqlive.station.sony.com/library/faqs/faq_index.jsp">FAQs</A><BR>The standard Frequently Asked Questions about EverQuest.</P>
<P><A href="http://eqlive.station.sony.com/interface/">User Interface<BR></A>Screenshots of graphical interface.</P>
<P><A href="http://eqlive.station.sony.com/library/races.jsp">Races</A><BR>A brief description of the playable races that inhabit the world of EverQuest. </P>
<P><A href="http://eqlive.station.sony.com/library/classes.jsp">Classes</A><BR>From Bard to Wizard, a breakdown of playable character classes. </P>
<P><A href="http://eqlive.station.sony.com/library/skills.jsp">Skills</A><BR>Just the basics here, with more to discover as your adventures continue. </P>
<P><A href="http://eqlive.station.sony.com/library/deities.jsp">Deities</A><BR>The Gods of Norrath that watch over their creations. </P>
<P><A href="http://eqlive.station.sony.com/library/sub_deities.jsp">Sub-Deities</A><BR>Children of the Gods. Learn more about them and the realms they lord over. </P>
<P><A href="http://eqlive.station.sony.com/library/atlas/index.jsp">Atlas</A><BR>Colorful maps of the world we share. </P>
<P><A href="http://eqlive.station.sony.com/library/bazaar.jsp">Bazaar</A><BR>How to buy and sell items at the Bazaar on Luclin.</P>
<P><A href="http://eqlive.station.sony.com/library/dragorn_weapons.jsp">Dragorn Weapon Set<BR></A>A sneak-peak at the Dragorn&nbsp;weapons availalble in the Omens of War expansion.&nbsp;</P>
