...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">78,560 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/community/links_sub.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/community/links_sub.jsp');">
...
<DIV align=center><STRONG><BR>Linking Guidelines</STRONG> </DIV>
<P><BR>To make changes to your current listing, just send an email to us at <A href="mailto:eqwebmaster@soe.sony.com">eqwebmaster@soe.sony.com</A></P>
<P>If you want to have your site added to our Links Page, please ensure that your site meets the following requirements. Each site will be reviewed before being linked to from EverQuest Live.</P>
<UL>
<LI>No guild sites</LI>
<LI>Sites may not contain illegal information or links to illegal information such as hacking, warez, or content unsuitable for minors.</LI>
<LI>Sites must be kept updated. No need to update daily, but if the site is reviewed and content is a month old, chances are we will pull the link.</LI></UL>
<P><BR>*We are going to strive to only link to those sites that are the most popular to the EverQuest community. Although we would like to be able to link to every EQ site available, our resources at this time do not allow for it.</P>
<P><BR></P>
