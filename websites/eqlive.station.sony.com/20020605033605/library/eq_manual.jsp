...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/eq_manual.jsp?null');">
...
<P>The EverQuest manual provides basic information on how to install the game, create characters, get around in the world of Norrath, and much more.</P>
<P><A href="http://eqlive.station.sony.com/library/images/EQTrilogyManual.pdf">Download the EverQuest Manual<FONT color=#0000ff size=2></P></FONT></A>
<P>The manual is in PDF format and requires the Adobe Acrobat Reader to view it.</P>
<P><A href="http://www.adobe.com/products/acrobat/readermain.html">Download Adobe Acrobat Reader</A></P>
