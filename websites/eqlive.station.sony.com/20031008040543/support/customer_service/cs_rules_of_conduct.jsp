	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_rules_of_conduct.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_rules_of_conduct.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/cs_rules_of_conduct.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<P>As the Official EverQuest Forums are part of The Station, posting to these forums is bound by The Station's Terms of Service that can be found in their entirety <STRONG><A href="http://www.station.sony.com/en/termsofservice.jsp#commfeatures">here</A></STRONG>. In addition to these terms of service, we have a few supplemental rules that apply to the EverQuest Forums.</P>
...
<P></P>
<P>If you are still having problems after visiting this support section, you can contact our Technical Support Department through an email via our <A href="http://eqlive.station.sony.com/support/">online form</A>.</P></FONT><FONT face="Times New Roman" size=2>
