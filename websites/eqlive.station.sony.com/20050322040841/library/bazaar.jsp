...
<P><EM>&quot;Welcome to my stall!&nbsp; My, aren't you an attractive young
  lady.&nbsp; If I wasn't so busy selling my most prized possessions at
  embarrassingly low prices so that my poor widowed sister and her five
  starving children could eat, I'd invite you to have a drink with me.&quot;</EM></P>  <P><EM>&quot;What is that you say?&nbsp; You are unfamiliar with the
  Bazaar?&nbsp; Well, I do my best to inform and entertain while I make my
  meager living.&nbsp; Let me show you how you can find just the right
  bargain.&nbsp; First, you come to visit me, I always have the best bargains
  and the largest range of items for sale.&nbsp; But on those rare occasions
  that I can't provide you with exactly what you need at exactly the right
  price...&quot;</EM></P>  <P><BR><STRONG>The Bazaar is located on Luclin, near the Nexus.&nbsp; When you enter
  the Bazaar you will be greeted with a message.&nbsp; The message welcomes you
  to the Bazaar and tells you how many people are selling items and how many
  items are for sale.</STRONG></P>  <P><STRONG>There are two basic commands that you will need to know in order
  to use the Bazaar.&nbsp; /bazaar opens up the window for shopping.&nbsp;
  /trader opens up the trader window for those that have items they wish to
  sell.&nbsp; Let's start by talking about /bazaar.</STRONG></P>  <P><STRONG>Typing /bazaar will bring up this window, the Bazaar Search
  Window.&nbsp; This is the window you use to locate specific items for sale in
  the Bazaar.</STRONG></P>  <P><STRONG>At the top left is the Item Name box.&nbsp; Typing an item name in
  that box and clicking the Find button will display a list of items in the
  Search Results box on the right.&nbsp; It is important to know that the Item
  Name search only looks for items with the word or words you specify in their
  name.&nbsp; So if you search for Item Names with the word &quot;sword&quot;
  you will only find items that actually have the word &quot;sword&quot; in
  their name.&nbsp; In this case you might be better off using the Select by
  Type option and choosing either 1H Slash or 2H Slash to find specific weapons
  of that type.</STRONG></P>  <P><STRONG>You can also narrow or change your search using any of the selection
  boxes on the left.&nbsp; You can choose as many of these selections as you
  desire.&nbsp; Keep in mind, though, that if you are too specific you may not
  find any items meeting your search requirements.</STRONG></P>  <P><STRONG>For example, when you select 1H Slash you will probably see a
  rather long list when you click Find.&nbsp; You might choose to narrow that
  down by selecting Vah Shir in the Select by Race box (keeping the 1H Slash
  selection).&nbsp; That would restrict the listed items to 1H Slashing weapons
  usable by Vah Shir.&nbsp; But if you also require that the item be equipable
  in the Ranged slot, you might find that no items match your search.</STRONG></P>  <P><STRONG>If you want to clear the selections you've made for your search
  criteria, click the Reset button.</STRONG></P>  <P><STRONG>Once you have a list of items that interests you, you can right
  click on any item on the list to see information about that item.</STRONG></P>  <P><STRONG>The list of merchants is updated when first enter the
  Bazaar.&nbsp; The Update Traders button will update the list of Traders for
  your selection in the Traders box.&nbsp; However, whenever you search for
  items, all available items are checked.</STRONG></P>  <P><STRONG>Once you have located the item you are looking for and chosen a
  trader to buy it from, you will only need to find that trader and finalize
  the deal.</STRONG></P>  <P><STRONG>You can find any trader on your list by right-clicking on his name
  in the item list.&nbsp; Your character will turn to face the character whose
  name you have clicked on.&nbsp; This makes locating your merchant an easy
  task.</STRONG></P>  <P><STRONG>Once you have located your merchant, simply right-click on
  him.&nbsp; You can interact with a player merchant in exactly the same way
  that you interact with an NPC merchant.</STRONG></P>  <P><BR><EM>&quot;Hail sir!&nbsp; What can I do for you this fine day?&quot;</EM></P>  <P><EM>&quot;You say that you're a fledgling merchant and you don't know your
  way around?&nbsp; I suppose I could help you out, but I've got to keep my
  business open.&nbsp; I have a sister, you know.&nbsp; She's been ill for
  months.&nbsp; She can't support her seven children without my help.&nbsp; So
  I can't just go wandering around...&quot;</EM></P>  <P><EM>&quot;Well that's a reasonable off, I suppose.&nbsp; But for such a
  small amount of gold I can't be expected to tell you all of the tricks of the
  trade.&quot;</EM></P>  <P><BR><STRONG>In order to become a Trader in the Bazaar you will need a Trader's
  Satchel.&nbsp; You can purchase these from NPC merchants in the Bazaar.&nbsp;
  Place items that you wish to sell into the Trader's Satchel.&nbsp; Only items
  in your Trader's Satchels can be sold, and only from those satchels that you
  have on you (you can't sell items out of your bank).</STRONG></P>  <P><STRONG>Also, in order to become a trader you will need to be inside one
  of the many stalls in the Bazaar.</STRONG></P>  <P><STRONG>Typing /trader opens up the Bazaar Vendor window.</STRONG></P>  <P><STRONG>When you open this window it will check to see what items you were
  selling last and uses pricing information that was stored to set prices on
  those items.&nbsp; It will also show you all the items in Trader's Satchel
  that you can sell (note: it will not display no-drop items).&nbsp; Items
  added to the satchel after this window is open will not show.&nbsp; You will
  have to reopen the window if you want to see those items.</STRONG></P>  <P><STRONG>This is where you set the prices for your items.&nbsp; To do so,
  just click on the item.&nbsp; Then click on the appropriate coin(s) and type
  in the amount you wish to charge for the item.&nbsp; Once you have the proper
  price showing in the coin list, just click on the Set Price button.&nbsp; You
  will see a message with the item name and price in the window.</STRONG></P>  <P><STRONG>You can clear the price of any item by selecting that item and
  clicking on the Clear Price button.</STRONG></P>  <P><STRONG>Once you have set the price on your items, you are ready to sell
  them.</STRONG></P>  <P><STRONG>In order to be a Trader you must be in one of the stalls in the
  Bazaar.&nbsp; Once there, click the Begin Trader button and your items will
  be available for purchase by other player characters.</STRONG></P>  <P><STRONG>If you want to make an item on your list unavailable for sale you
  can click on the item and then click the Remove button.&nbsp; This will take
  the item off of your trader list and it will be unavailable for sale.&nbsp;
  To put the item back up for sale, just select it and click on the Add button.</STRONG></P>  <P><STRONG>Items that are for sale will be highlighted in green in your
  Trader Window.&nbsp; Leaving the stall area will automatically turn off your
  Trader status.</STRONG></P>  <P><STRONG>The List Items button prints out a list of all of the items you
  have for sale in the window.</STRONG></P>  <P><STRONG>Enjoy your time in the Bazaar.</STRONG></P>  <P><EM>&quot;It's not really as hard as everyone thinks.&nbsp; But don't you
  go tellin' everyone that.&nbsp; At least not unless they cough up a few coins
