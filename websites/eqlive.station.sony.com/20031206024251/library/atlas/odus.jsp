	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/odus.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/odus.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/odus.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                                  ...
                                  <tr> 
                                    ...
                                    <td width="100%"> 
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr> 
                                          <td height="108"> 
                                            <div align="center"> <img src="images/map_odus_title.gif" width="99" height="34"> 
                                    ...
                                    <td> 
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          ...
                                          <td width="228" height="273" rowspan="3"><img src="images/map_odus_hi.gif" width="228" height="273" usemap="#cities" border="0">
                                            <map name="cities">
                                              <area shape="rect" coords="118,15,161,32" href="erudin.jsp">
                                            </map>
                                          </td>
                                          <td> 
                                            <center>
                                        ...
                                        <tr> 
                                          <td rowspan="2">&nbsp;</td>
                                          <td> 
                                            <div align="center"><img src="images/map_gator.gif" width="72" height="59"></div>
                                          </td>
                                        </tr>
                                        <tr> 
                                          <td>&nbsp;</td>
                                      ...
                                      <table border="0" width="100%" cellpadding="20" cellspacing="0">
                                        <tr> 
                                          <td><font color="#333333">Odus was founded 
                                            by a human named Erud who, along with 
                                            his followers, left Antonica searching 
                                            for a place to establish a new enlightened 
                                            society. Like any "enlightened" conquerors, 
                                            the Erudites took it upon themselves 
                                            to forcibly relocate the native inhabitants 
                                            of Odus. The Kerra, a once proud and 
                                            noble feline race, have been pushed 
                                            from their lush homeland to a small 
                                            island off the western coast of Odus.</font></td>
                                          <td> 
