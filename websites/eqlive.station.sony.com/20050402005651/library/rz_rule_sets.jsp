                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><STRONG><U>Welcome to Zek </U></STRONG></P>  <P>On February 8<SUP>th</SUP> 2005, a new server appeared on your server
  selection list.&nbsp; Zek is the new host of the combined characters of the
  four current PVP servers (Rallos, Tallon, Vallon and Sullon) and it will use
  the Rallos Zek ruleset.&nbsp; It is our opinion that merging the four current
  PVP servers will revitalize the PVP environment, adding new challenges and
  players for you to test your skills against.</P>  <P><STRONG>Character Purge<BR></STRONG>Immediately preceding the merger, all characters that were below level 10
  and hadn't been accessed in the past six months or more were purged from all
  four PVP servers.&nbsp; Any character that was below level 10 and hadn't
  logged in for 6 or more months was purged after the server merge.</P>  <P><STRONG>Shared Banks<BR></STRONG>Only one shared bank from one of the four old servers is available to a
  player on the merged Zek server.&nbsp; </P>  <P><STRONG>Characters<BR></STRONG>If you had more than 8 characters combined between all of the old PVP
  servers, after the merger, only the first 8 (sorted alphabetically)
  characters will be displayed on the merged server.&nbsp; Other characters
  beyond those 8 are not be available for selection until characters are
  deleted.&nbsp; The characters will be on your account provided they were not
  below level 10 and had been played within the last 6 months.</P>  <P><STRONG>Corpses</STRONG><BR>Character corpses are not be transferred to the new merged server.&nbsp; All
  corpses were purged after the merger.</P>  <P><STRONG>Character Names</STRONG><BR>It is likely that characters might have duplicate names on these servers, in
  the event that characters do share a name, the character with the most played
  time will be entitled to keep the name, all other characters will have the
  letter X appended to their name and will be entitled to a name change.&nbsp;
  You can request your name change using the /petition system.</P>  <P><STRONG>Complimentary
  Character Move</STRONG><BR>After the merge was completed, a one time move was offered to all accounts on
  the new PVP server.&nbsp; Each account was allowed to move the entirety of
  their account to the non-PVP server of their choice, with gear.&nbsp; This
  offer only lasted for 30 days and included all characters on an
  account.&nbsp; </P>  <P><STRONG><U>Zek Rules:</U></STRONG></P>  <P>This document includes the PvP rules for Zek.</P>  <OL>   <LI>Player v. Player
       ...
       hometown. Thurgadin is not a dwarven hometown.</LI>   <LI>On Zek, PvP-related
       Play Nice Policy situations are expected to be resolved using PvP
       solutions. However, Non PvP-related Play Nice Policy issues, such as
       training, causing intentional experience loss, bind point, zone, and
       portal camping, as well as other various forms of harassment, are not
       permitted in the PvP environment.</LI>   <LI>While corpse
       ...
       on the character that has hidden or gone invisible.&nbsp;</LI>  </OL>  <P>&nbsp;</P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
