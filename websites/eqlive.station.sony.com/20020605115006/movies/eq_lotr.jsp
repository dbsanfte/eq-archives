...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/movies/eq_lotr.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
                        <!-- end page content -->
                        <p align="center"><img src="/images/eq_lotr_a.gif" width="424" height="104"></p>
                        <p align="center"><object classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" width="320"

height="262" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
                            <param name="SRC" value="eq_lotr.mov">
                            <param name="AUTOPLAY" value="true">
                            <param name="CONTROLLER" value="true">
                            <embed src="eq_lotr.mov" width="320" height="262" autoplay="true"
