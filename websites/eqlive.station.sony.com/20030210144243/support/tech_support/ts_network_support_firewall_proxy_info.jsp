...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_network_support_firewall_proxy_info.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_network_support_firewall_proxy_info.jsp');">
...
<P align=center><STRONG>Basic Troubleshooting</STRONG></P>
...
<P><STRONG>The EverQuest server IP addresses are on the subnets:</STRONG><BR>64.37.148.* , 64.37.149.* , 64.37.150.* , 64.37.151.* , 64.37.156.* , 64.37.157.* , 195.33.132.*, 195.33.108.*, 195.33.133.*, 199.108.1.*, 199.108.2*, 199.108.3.* </P>
...
<LI>Go into the Unrestricted Applications group and look for all executable files listed under your EverQuest directory and move them to the EverQuest Application Group you just created </LI>
