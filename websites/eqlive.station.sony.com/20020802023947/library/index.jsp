...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/index.jsp?null');">
...
<P><A href="http://eqlive.station.sony.com/library/eq_manual.jsp">The EverQuest Manual</A><BR>This manual, in PDF format, will explain the basics of getting started with playing EverQuest.</P>
<P><A href="/library/faqs/faq_index.jsp">FAQs</A><BR>The standard Frequently Asked Questions about EverQuest.</P>
...
<P><A href="/library/races.jsp">Races</A><BR>A brief description of the playable races that inhabit the world of EverQuest. </P>
<P><A href="/library/classes.jsp">Classes</A><BR>From Bard to Wizard, a breakdown of playable character classes. </P>
<P><A href="/library/skills.jsp">Skills</A><BR>Just the basics here, with more to discover as your adventures continue. </P>
<P><A href="/library/deities.jsp">Deities</A><BR>The Gods of Norrath that watch over their creations. </P>
<P><A href="/library/sub_deities.jsp">Sub-Deities</A><BR>Children of the Gods. Learn more about them and the realms they lord over. </P>
<P><A href="/library/atlas/index.jsp">Atlas</A><BR>Colorful maps of the world we share. </P>
