...
<P>There are a variety of skills in EverQuest, and learning and developing
  ...
  inflict even more damage to their foes after the initial strike. There are numerous
  steps to learn and perfect in order to use this skill effectively.</P>  <P><EM><STRONG>Backstab</STRONG></EM><STRONG><EM><BR></EM></STRONG>The rogue has many unique skills in his repertoire, including the
  ...
  cast spells using less mana and with a higher rate of success.</P>  <P><EM><STRONG>Swimming</STRONG></EM><STRONG><EM><BR></EM></STRONG>Many areas in the world of Norrath are covered by water, and one's ability
  to maneuver in that environment is directly related to one's skill level in
