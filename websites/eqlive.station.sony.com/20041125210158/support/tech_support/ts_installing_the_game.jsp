...
<P><FONT face="Arial, Helvetica, sans-serif" size=2><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Insert the EverQuest game CD into your CD-ROM drive. If your CD-ROM drive has the AutoPlay function enabled, the installation will begin automatically. If AutoPlay is not enabled, Open the "My Computer" icon on your desk top, double-click on the CD-ROM icon, then double-left-click on "setup.exe". The installation process will then commence</SPAN>.</FONT></P><FONT face="Arial, Helvetica, sans-serif" size=2>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">EverQuest and all its expansions require at least 2GB of free disk space to install.</SPAN></P>
<OL type=1>
<OL type=1>
<OL type=1>
<LI class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; mso-list: l0 level3 lfo1; tab-stops: list 1.5in"><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Select a directory in which you would like to install EverQuest. The default directory is C:\Program Files\Sony\EverQuest. If you would like to install the files into a different directory, change the path and proceed. Insert each successive disk (if required) as the prompts request it.</SPAN> 
<LI class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; mso-list: l0 level3 lfo1; tab-stops: list 1.5in"><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Installing the DirectX drivers:<BR>After the installation of EverQuest, an option to install DirectX will be provided. EverQuest will not run with any version of DirectX previous to 9.0 at this time. Select "Yes" to proceed, then follow the on-screen instructions. If you already have a better version of DirectX installed, you will be told that no update is possible.</SPAN><FONT face="Times New Roman" size=3> </FONT>
<LI class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; mso-list: l0 level3 lfo1; tab-stops: list 1.5in"><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">After completing the installation of DirectX, you will be prompted to restart your computer. Select "Yes" and allow your system to reboot. </SPAN></LI></OL></OL></OL>
<P class=MsoNormal style="MARGIN: 0in 0in 0pt; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; mso-list: l0 level3 lfo1; tab-stops: list 1.5in"><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial"></SPAN></FONT><FONT face="Arial, Helvetica, sans-serif" size=2>If you are still having problems after visiting this support section, you can contact our Technical Support Department through <A href="mailto:eqtech@soe.sony.com">email</A>.</FONT></P>
<LI></LI>
