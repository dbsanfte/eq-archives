		...
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_mouse.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_mouse.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P ALIGN="center"><STRONG><BR><STRONG>Mouse Troubles</STRONG></STRONG></P>  <P>If your mouse freezes before entering the game, or you are unable to get
  your mouse to work in EverQuest then you may want to follow the suggestion
  below to get your mouse to work properly in EverQuest.</P>  <P>It may simply be a mouse driver problem, and sometimes changing the driver
  can fix it. In order to do this, perform the following steps:</P>  <UL>   <LI>Right click on the
       &quot;My Computer&quot; icon.</LI>   <LI>Select
       &quot;Properties&quot; from the menu.</LI>   <LI>Click on the
       &quot;Device Manager&quot; tab.</LI>   <LI>Open the entry for
       &quot;Mouse.&quot;</LI>   <LI>Select the
       &quot;Driver&quot; tab.</LI>   <LI>Hit &quot;Update/Change
       Driver.&quot;</LI>   <LI>Click the
       &quot;Next&quot; button.</LI>   <LI>Select &quot;Display A
       List of Drivers.&quot;</LI>   <LI>Hit &quot;Show All
       Drivers.&quot;</LI>   <LI>Choose
       &quot;Standard PS/2 Port Mouse&quot;, &quot;Standard Serial Mouse&quot;,
       &quot;Microsoft PS/2 Port Mouse&quot;, or &quot;Microsoft Serial
       Mouse&quot;. You may have to experiment with the different options to
       find the one that works best for you.</LI>  </UL>  <P>&nbsp;</P>  <P>If you are still having problems after visiting this support section, you
