	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_rate.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_rate.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/faqs/faq_rate.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<p align="center"><b>EverQuest's Price Increase FAQ </b></p> <p>What are the new <b>EverQuest </b> subscription rates? </p> <ul> <li>$14.99 per Month </li> <li>$41.97 for 3 Months </li> <li>$77.94 for 6 Months </li> <li>$143.88 for 12 Months </li> <li>$199.95 for 24 Months </li> <li>EverQuest included in <a href="http://www.station.sony.com/stationaccess/">Station Access Plan </a> $21.99 per Month </li> </ul> <p><b>What are the new EverQuest subscription rates? </b></p> <p>The new monthly subscription rate will be US$14.99. The new 3-month subscription rate will be $41.97, the new 6-month subscription rate will now be $77.94 and the new 12-month subscription rate will now be $143.88. The 24-month subscription will continue to be $199.95. We continue to offer discounts in the new rate plan for multi-month subscriptions and encourage you to take advantage of this money saving option. </p> <p><b>When will the subscription rate change? </b></p> <p>The new subscription rate will take effect June 12, 2005. <br> <br> <b>Why was the subscription rate increased? </b></p> <p>Due to the increased costs of running the EverQuest game service, we will be increasing our subscription rates in June. While this announcement may be unpleasant, the cost of operating a top tier MMO has increased significantly over the past three years and this change will help us achieve our goal of seeing that every player has a consistently enjoyable experience in the world of EverQuest. <br> <br> EverQuest continues to be a great entertainment value ? even at $14.99. No other game offers the kind of detailed gameplay and tight-knit community that EverQuest offers. The monthly subscription fee allows us to provide the best possible gaming experience while also expanding the world of Norrath. The EverQuest team is dedicated to providing fresh and dynamic content to the players with in-game events, quests, zone re-vamps, game enhancements and great new expansion packs. <br> <br> <b>Are there any discounts for current EverQuest subscribers? </b></p> <p>In order to thank the EverQuest community, players can take advantage of a 6 or 12 month limited time promotional offer. Between May 12, 2005 and June 11, 2005 , you can take advantage of a 6 or 12 month limited time promotional subscription and reap great savings. </p> <ul> <li>For a limited time, a 6-month subscription costs only US$69.99 -- that works out to $11.67 a month, a 10% discount off of the new monthly plan. </li> <li>Even better, for a limited time a 12-month subscription costs only US$99.99 ? that works out to $8.33 a month, a 31% savings off of the new monthly plan. </li> </ul> <p>If you take advantage of this offer, you will be billed immediately, and your current subscription will automatically convert to the number of months of the subscription plan you elect. All prepaid but unused amounts for any EverQuest account that is converted to the 6 or 12 month limited time promotional subscription plan will be, at the time SOE converts the account, converted to days at the 6 or 12-month subscription plan rate (as applicable), and the first subscription period for that account will be extended by the applicable number of days. Any account converted to the special 6 or 12 month promotional subscription plan during any no-charge subscription period will be immediately converted, and the remainder of such no-charge period(s) will be waived. <br> <br> <b>What do I have to do now that the subscription rates have changed? </b></p> <p>You don't have to do a thing. When your current subscription plan expires, you will automatically be migrated to the new subscription structure based on your current subscription plan. The only thing that will change is the rate. <br> <br> <b>What if my renewal date does not fall between May 12th and June 11th? Can I still take advantage of the limited time promotional 6 and 12 month options? </b></p> <p>Yes, you may. To take advantage, follow these simple steps between the dates of May 12th and June 11 th , 2005 : </p> <ul> <li>Launch the EverQuest Game and go to the Login screen. Click the" Account" button and then click "Change Account." </li> <li>Enter your Station Name and password, and then click "Edit Billing." </li> <li>Next you will see the EverQuest Subscription page on the left and the EverQuest Legends access page on the right. Choose the EverQuest Subscription page and then checkmark either the 6 month or 12 month option that you wish to take advantage of. </li> </ul> <p>If you take advantage of this offer, you will be billed immediately, and your subscription will automatically convert to the number of months of the subscription plan you elect. All prepaid but unused amounts for any EverQuest account that is converted to the 6 or 12 month limited time promotional subscription plan will be, at the time SOE converts the account, converted to days at the 6 or 12-month subscription plan rate (as applicable), and the first subscription period for that account will be extended by the applicable number of days. Any account converted to the special 6 or 12 month promotional subscription plan during any no-charge subscription period will be immediately converted, and the remainder of such no-charge period(s) will be waived. </p> <p><b>Can you explain what "recurring" charges are? </b></p> <p>EverQuest subscriptions are and have always been recurring, meaning you have been and will continue to be billed at the appropriate subscription rate interval, until you affirmatively cancel your subscription. <br> <br> <b>Ok, how does all this really work? </b><br> The current subscription rates are in effect for all signups and/or renewals that occur on or prior to June 11, 2005; the new subscription rates are in effect for all signups and/or renewals that occur on and after June 12, 2005. Some examples: </p> <blockquote> <p>&#149;&nbsp; My current 3 month recurring subscription happens to expire/renew on May 20 th . </p> <p>&#149;&nbsp; If you do nothing, it will renew at the current rate and your rate will not be increased until the subscription renews again (on August 20). </p> <p>&#149;&nbsp; If on May 20th you elect the special 6 month promotional offer, you will be immediately billed on that date and your subscription will then become a "6 month recurring subscription" as of that date. </p> <p>&#149;&nbsp; My current 3 month recurring subscription happens to expire/renew on June 12 th . </p> <p>&#149;&nbsp; If you do nothing, it will renew on June 12 th at the new rates. </p> <p>&#149;&nbsp; If on May 20th you elect the special 6 month promotional offer, you will be immediately billed on that date, your subscription will then become a "6 month recurring subscription" as of that date and all prepaid but unused amounts for your current 3 month recurring subscription will be, at the time SOE converts the account, converted to days at the 6 month subscription plan rate, and the first subscription period for your account will be extended by the applicable number of days. </p> <p>&#149;&nbsp; I have a monthly recurring subscription. </p> </blockquote> <p>If you do nothing, the first renewal that occurs on and after June 12 th , 2005 will be at the new monthly rate. </p> <p><b>Does this affect the Legends service or SOE Station Access? subscriptions? </b><br> No. <br> <br> <b>Will I still receive my 30 days of game-play included with purchase of some of the retail package versions of EverQuest at no additional charge if I purchase and register a New Game? </b><br> Purchasers of the full version of EverQuest will receive 30 days of game-play at no additional charge (subject to certain restrictions) after supplying valid billing information. If you cancel your subscription during the free month, no charges will be made to your credit card. </p> <p><b>Will I be charged sales tax or Value-Added Tax on your subscription rates? <br> </b>You will be charged sales tax or value-added tax, as applicable, if you live in states that require sales tax or if you live in European Union countries or territories. </p> <p><b>How will my charge appear on my credit card statement? <br> </b>All subscription fees will appear on your credit card statement under the heading &quot;SOE*EverQuest&quot;. </p> <b>Is there a website with more information about the EverQuest pricing changes? <br> </b>For more information, please visit <a href="http://www.everquest.com/rates">www.everquest.com/rates </a>
