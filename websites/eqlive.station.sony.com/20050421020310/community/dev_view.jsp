...
<tr>
	...
	<a href="dev_view.jsp?id=64044" class="tinylink">Revised Server Merge Information</a><br>
	
	<a href="dev_view.jsp?id=64042" class="tinylink">EverQuest Producer's Letter</a><br>
	
	<a href="dev_view.jsp?id=64043" class="tinylink">We Got Hodgepodge, Yes We Do!</a><br>
	
	<a href="dev_view.jsp?id=64040" class="tinylink">Update scheduled for April 6<SUP>th</SUP> has been
  re-scheduled</a><br>
...
<option value="64044">Revised Server Merge Information 04/15/2005</option>
...
<h1>Revised Server Merge Information</h1>
<P><STRONG><U>Merging Servers</U></STRONG></P>  <P>The
  most recent server merges are complete and both newly merged servers are
  showing a healthy population and, as with the combined Zek servers, exceeding
  their previous combined population totals.&nbsp; As such, beginning April 11th and
  continuing until the completion of the process, we will continue merging all
  standard rule-set servers.&nbsp; The
  servers will be merged in the following order, on the dates listed.</P>  <P>&nbsp;</P>  <P><STRONG>4/18</STRONG> Mithaniel Marr merges with
  Saryrn and will be listed as Saryrn.</P>  <P><STRONG>4/18</STRONG> Karana merges with The
  Rathe and will be listed as The Rathe. </P>  <P><STRONG>4/21</STRONG> Ayonae Ro merges with The
  Tribunal and will be listed as The Tribunal.</P>  <P><STRONG>4/25 </STRONG>Veeshan merges with Luclin
  and will be listed as Luclin.</P>  <P><STRONG>4/28</STRONG> Tholuxe Paells merges with
  Bertoxxulous and will be listed as Bertoxxulous.</P>  <P><STRONG>5/2</STRONG> Innoruuk merges with The
  Nameless and will be listed as The Nameless.</P>  <P><STRONG>5/5</STRONG> Zebuxoruk merges with
  Xegony and will be listed as Xegony.</P>  <P><STRONG>5/9</STRONG> Vazaelle merges with
  Maelin Starpyre and will be listed as Maelin Starpyre.</P>  <P><STRONG>5/12</STRONG> Rodcet Nife and Quellious
  and will be listed as Quellious.</P>  <P><STRONG>5/16 </STRONG>Morrell Thule and Erollisi
  Marr and will be listed as Erollisi Marr.</P>  <P><STRONG>5/19</STRONG> Xev merges with Druzzil Ro
  and will be listed as Druzzil Ro.</P>  <P><STRONG>5/23</STRONG> Torvonnilous and Fennin Ro
  and will be listed as Fennin Ro</P>  <P><STRONG>5/26</STRONG> Terris Thule and Prexus
  and will be listed as Prexus.</P>  <P><STRONG>5/30</STRONG> E'ci and Tunare and will
  be listed as Tunare.</P>  <P>We
  understand that server identity is important to our customers and we will be
  integrating server titles into the title system to allow you to display your
  server of origin, should you desire to do so.&nbsp; The server title system will go live
  with our April 6th Update.</P>  <P><STRONG><U>Unutilized Character Purge</U></STRONG></P>  <P>Immediately
  preceding the merger, all characters below level 10 that have not been logged
  in for over six months will be deleted from each of the merging servers and
  will not be available after the server merge.&nbsp; If you have a character on any of the
  servers being merged that is below level 10 and has not been logged in for
  more than six months, you will need to log that character in prior to the
  scheduled merge date for the relevant server.&nbsp; </P>  <P>Shared
  Banks on Merging Servers</P>  <P>If
  you have characters on two servers which are being merged together, you will
  need to clean out the shared bank on one of those servers. After the merge,
  only one shared bank will be available on each merged server.</P>  <P><STRONG><U>Character Limitations</U></STRONG></P>  <P>If
  you have more than eight characters in total on the two servers being merged,
  only the first eight characters (in alphabetical order) will be displayed
  after the merge.&nbsp; Characters other
  than the eight displayed characters will not be available for selection until
  currently displayed characters are deleted.&nbsp; All characters from both servers will
  remain on your account provided that the character was above level 10 and had
  been logged into game within the last six months.</P>  <P><STRONG><U>Corpses</U></STRONG></P>  <P>Prior
  to the scheduled merge date for your server(s), please be sure that you clear
  any unclaimed character corpses from the world.&nbsp; Character corpses will not be
  transferred to the newly-merged server.&nbsp;
  Once the merger is complete, all corpses on the servers affected by a
  merge will have been purged.</P>  <P><STRONG><U>Duplicate Character Names</U></STRONG></P>  <P>It
  is possible that characters on servers affected by the merge will have
  duplicate names. In the event that characters on the new, combined server do
  share a name, the character with the most played time will be entitled to
  keep the name. All other characters will have the letter X appended to their
  name and will be eligible for a name change.&nbsp; Characters can use the in-game
  /changename command to request a new name.&nbsp; The new name is subject to the
  ...
  Policy</A>.</P>  <P><STRONG><U>LDoN Leader Boards</U></STRONG></P>  <P>After
  each merge is completed, as characters log into their newly-combined server, the
  leader board will be re-populated with standings. Although your points will
  be unaffected by the transfer, your standing may have changed based on the
  new, combined population totals.</P>  <P><STRONG><U>Complimentary Character
  Move</U></STRONG></P>  <P>Shortly
  after each merger is complete, we will allow all customers affected by a
  merge a one-time, complimentary character move to the server of their
  choice.&nbsp; For each customer with an
  account on a newly-merged server who requests such a move, all characters
  associated with that customer&#8217;s account will be transferred to the
  selected server.&nbsp; All characters
  will bring their items with them in the transfer. </P>  <P>Please
  make sure you are aware of your servers expected merge date and prepare
  accordingly.&nbsp; These dates are
  subject to change should we need to alter the timetable of merges.&nbsp; Should we need to change the dates we
  will post the new list with plenty of advance notice.</P>
