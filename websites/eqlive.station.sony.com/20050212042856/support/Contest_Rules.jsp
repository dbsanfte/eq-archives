	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/Contest_Rules.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/Contest_Rules.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/Contest_Rules.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
//window.alert(document.cookie);
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Contest&nbsp;Rules </font></b></div>
                        <!-- #EndEditable --></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P><BR><BR><STRONG>The EverQuest &quot;Complete the Synarcana Raid&quot; Contest 2003</STRONG><BR><BR><BR><BR><BR><BR><BR><STRONG>OFFICIAL RULES</STRONG><BR><BR></P>  <P>NO PURCHASE NECESSARY TO ENTER OR WIN.</P>  <P><STRONG>Agreement to Official Rules and Contest Period:</STRONG>  Participation constitutes participant's full and unconditional agreement to
  and acceptance of these Official Rules. Winning a prize is contingent upon
  fulfilling all requirements set forth herein. The EverQuest &quot;Complete
  the Synarcana Raid&quot; Contest 2003 (&quot;Contest&quot;) ends 11:59:59
  p.m. PT February 1, 2004, or upon the first verified, eligible completion of
  the Synarcana raid that occurs AFTER 5:00 p.m. PT December 28, 2003,
  whichever occurs first (&quot;Contest Period&quot;) Entries before or after
  the Contest Period are void. Contest is sponsored by Sony Online
  Entertainment Inc., 8928 Terman Court, San Diego, CA 92121
  (&quot;Sponsor&quot;).</P>  <P><STRONG>Eligibility:</STRONG></P>  <P>(a) Contest is open only to natural persons who are legal residents of the
  50 United States (including the District of Columbia) for the duration of the
  Contest. Void in Puerto Rico, Guam, all other U.S. and all foreign
  territories and possessions and wherever prohibited or restricted by law. The
  Contest will only be conducted on U.S. based servers. Contest may only be
  entered from and in eligible jurisdictions.<BR>(b) Participants must be 18 years of age or older at time of entry in order
  to participate.<BR>(c) Employees, officers, directors, and agents of Sponsor, its parent
  company, affiliates, subsidiaries, advertising, promotion, and fulfillment
  agencies, their immediate family members and persons living in their same
  household, are not eligible to participate in the Contest.<BR>(d) You must have had a valid EverQuest account in good standing, the
  EverQuest game, and the Lost Dungeons of Norrath Expansion by November 30,
  2003, or you are not eligible to participate.<BR>(e) Your character must be at least level 58, and you must have successfully
  completed at least two prior adventures in the Miragul's Menagerie Lost
  Dungeons of Norrath adventure theme.<BR>(f) Your raiding party must have at least 18 players and no more than 36 in
  total and must otherwise meet the requirements for commencing a Lost Dungeons
  of Norrath raid adventure. Members of any raiding party that completes the
  Synarcana raid prior to 5:00 p.m. PT December 28, 2003, are ineligible to
  win.</P>  <P><STRONG>How to Enter and Win:</STRONG> To enter the Contest, get together
  with fellow eligible EverQuest players and, within the game, form a Lost
  Dungeons of Norrath raiding party of between 18 and 36 players at the
  Everfrost Wayfarer's Camp on the continent of Antonica. After commencing and
  accepting the raid adventure by clicking on and following the appropriate
  prompts with Trelsa McKindle, the appropriate Lost Dungeons of Norrath
  adventure NPC, make your way to the Miragul's Menagerie dungeon zone within
  the required time in accordance with raid adventure rules and then attempt to
  complete the Synarcana raid. The first raiding party that successfully
  completes the Synarcana raid after 5:00 p.m. PT on December 28, 2003 wins.
  The Prize Winner will be randomly selected by Sponsor from among the
  surviving members of the winning raiding party. ONLY SURVIVING MEMBERS OF THE
  WINNING RAIDING PARTY WHO ARE ALIVE AND ARE PRESENT IN THE ZONE IMMEDIATELY
  FOLLOWING THE SUCCESSFUL COMPLETION OF THE SYNARCANA RAID WILL BE ELIGIBLE
  FOR THE DRAWING. You and your raiding party may attempt to complete this
  quest as many times as you wish, subject to Lost Dungeons of Norrath raid
  re-try restrictions. Any attempt at entry except as above stated is void. Any
  submission of robotic, automatic, or programmed entries, or any entries
  submitted by agencies, other third parties, or through other unapproved
  methods are void.</P>  <P><STRONG>Description of Grand Prize:</STRONG> One (1) Grand Prize: An
  autographed Curt Schilling baseball jersey from either the Boston Red Sox or
  Arizona Diamondbacks, in Sponsor's discretion (Approximate retail value
  US$499.00).</P>  <P><STRONG>General Limitations:</STRONG> No alternative prize, cash, or other
  substitution is permitted except by Sponsor in the event of prize
  unavailability. The Prize is non-transferable. All federal, state, and local
  taxes are solely the responsibility of Winner. A total of one (1) prize will
  be awarded. Winner must comply with the EverQuest EULA, and all other rules
  of conduct and terms of service. If no eligible winner is selected during the
  Contest Period, no prize will be awarded (for example, if no raiding party
  successfully completes the quest during the Contest Period).</P>  <P><STRONG>Odds:</STRONG> Odds of winning depend on the number of eligible
  entries received and the skill of the participants.</P>  <P><STRONG>Selection of Winner:</STRONG> A Potential winner (and alternates)
  will be determined by random drawing within two (2) weeks following the
  determination by Sponsor that a raiding party has completed the quest
  according to these Official Rules. The potential winners will be notified by
  an in-game message from Sponsor, or by e-mail or first class mail within
  fifteen (15) business days of the drawing. Potential winner will have five
  (5) business days from notification to accept the prize by e-mail or by U.S.
  mail to the address specified in the notification. Allow six to eight weeks
  for shipment of prizes to verified winners.</P>  <P><STRONG>Requirements of Winner:</STRONG> Potential winner of prize is
  required to sign and return a release of liability, declaration of
  eligibility, and where lawful, a publicity consent agreement, within ten (10)
  business days of prize notification. By accepting and/or using prize, winner
  agrees to the use of his/her name, voice and/or likeness for the purpose of
  advertising, trade, or promotion without further compensation, unless
  prohibited by law. If a selected potential winner cannot be contacted, is
  ineligible under these rules or due to a failure to comply with the EverQuest
  EULA, rules of conduct, or terms of service, fails to claim a prize, or fails
  to timely return the completed and executed releases/agreements as required,
  prize may be forfeited and an alternate potential winner selected.</P>  <P><STRONG>General Terms and Conditions:</STRONG> By entering, each
  participant agrees to be bound by these Official Rules and the decisions of
  Sponsor, which shall be final. Sponsor reserves the right to disqualify any
  person, entry, or e-mail address that Sponsor determines to be in violation
  of any term contained in these Official Rules. Sponsor, and the employees,
  officers, directors, shareholders, agents, and representatives of Sponsor,
  their parent companies, affiliates, subsidiaries, advertising, promotion, and
  fulfillment agencies, prize providers, advertisers, and legal advisors are
  not responsible for and shall not be liable for: (i) late, lost, delayed,
  damaged, misdirected, stolen, incomplete, illegible, unintelligible or
  postage-due entries, notices, releases, forms, affidavits, or other
  correspondence; (ii) telephone, electronic, hardware or software program,
  network, Internet, printer, or computer malfunctions, failures, interruptions
  or difficulties of any kind; (iii) failed, incomplete, garbled, or delayed
  computer transmissions; (iv) any condition caused by events beyond the
  control of the Sponsor that may cause the Contest to be disrupted or
  corrupted; (v) any injuries, losses, or damages of any kind arising in
  connection with or as a result of the prize, or acceptance, possession, or
  use of the prize, or from participation in the Contest or arising from the
  participant's access to and use of the EverQuest game (and all related
  websites of Sponsor), including without limitation, personal injury, death,
  and property damage, and claims based on publicity rights, defamation, or
  invasion of privacy, to the extent permitted by law; or (vi) any errors in
  any materials associated with the Contest. Participant further agrees that in
  any cause of action related to the Contest, Sponsor's liability will be
  limited to the cost of entering and participating in the Contest, and in no
  event shall the Sponsor be liable for attorney's fees. Participant waives the
  right to claim any damages whatsoever, including, but not limited to,
  punitive, consequential, direct, or indirect damages. Sponsor reserves the
  right, in its sole discretion, to suspend or cancel Contest at any time if a
  computer virus, bug, worms, tampering, unauthorized intervention, fraud or other
  problem corrupts, prevents, or interferes with the administration, security,
  or proper play of the Contest or the awarding of prizes. In the event of such
  cancellation, Sponsor reserves the right to award prizes in a random drawing
  from all entries received prior to the time of cancellation. Any attempt by
  any person to undermine the legitimate operation of the Contest may be a
  ...
  these Official Rules shall not constitute a waiver of that provision. In the
  event of a dispute as to any online entry, the authorized account holder of
  the e-mail address used to enter will be deemed to be the entrant. The
  &quot;authorized account holder&quot; is the natural person assigned an
  e-mail address by an Internet access provider, online service provider, or
  other organization responsible for assigning e-mail addresses for the domain
  associated with the submitted address. A potential winner may be required to
  show proof of being the authorized account holder. All information submitted
  to Sponsor as part of this Contest will be treated in accordance with
  Sponsor's privacy policy, available at <A HREF="http://sonyonline.com/tos/privacy.jsp">http://sonyonline.com/tos/privacy.jsp</A>.</P>  <P><STRONG>Disputes:</STRONG> Contest is governed by the laws of the United
  States and the State of California. As a condition of participating in the
  Contest, participant agrees that any and all actions or proceedings related
  to the Contest, or any prize awarded, shall be resolved individually, without
  resort to any form of class action, and shall be exclusively brought in the
  County of San Diego, State of California (if under state law) or the Southern
  District of California (if under Federal law), and the parties agree not to
  ...
  sufficiency of service of process or the like in any such action or suit
  brought in the State of California.</P>  <P><STRONG>Winners List and Official Rules:</STRONG> A winners list will be
  posted on the Web Site at <A HREF="http://www.everquestlive.com/">www.everquestlive.com</A>  at the conclusion of the Contest. To obtain a copy of the winners list or a
  copy of these Official Rules, send your request along with a stamped,
  self-addressed envelope to: Attn: Marketing Department: The EverQuest
  &quot;Complete the Synarcana Raid&quot; Contest 2003, 8928 Terman Court, San
  Diego, CA 92121. Requests must be received no later than March 15, 2004.
  Vermont residents may omit return postage for Official Rules requests.</P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
