...
<P>Remember that if you are running a firewall, then it could cause connection troubles to our servers. You will either need to disable any firewalls you may have running, or visit our <A href="http://eqlive.station.sony.com/support/tech_support/ts_network_support_firewall_proxy_info.jsp">Firewall/Proxy Support page</A> for all the necessary modifications you would need in order to connect to EverQuest from behind your firewall.</P>
<P>If you are still having problems after visiting this support section, you can contact our Technical Support Department through <A href="mailto:eqtech@soe.sony.com">email</A>. 
<P></P>
