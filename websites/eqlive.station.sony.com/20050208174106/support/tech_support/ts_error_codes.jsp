...
<P ALIGN="center"><STRONG><BR><STRONG>Common EverQuest Error Codes</STRONG></STRONG></P>  <P ALIGN="center"><STRONG>Error Codes at Login</STRONG></P>  <P><STRONG>Error 1001:</STRONG></P>  <P>This error states:</P>  <P>&quot;Could not connect to the EverQuest Server! Please try again
  shortly.&quot;</P>  <P>This error will only occur when you are unable to connect to the login server.
  You may receive this error when the EverQuest servers are brought down for
  their routine maintenance, and you try to log into EverQuest while they are
  down. Please remember that any type of firewall may prevent you from logging
  into EverQuest if you are blocking certain ports. Please visit our Firewall
  and Proxy Information page for more information regarding the port number for
  the login server. If you are having continual troubles, and are repeatedly
  receiving this error even when the EverQuest server are up then you may want
  to visit our Network/Connection support page for additional connection
  troubleshooting.</P>  <P><STRONG><BR><STRONG>Error 0023:</STRONG></STRONG></P>  <P>This error states:</P>  <P>&quot;Our Login Server and registration processes are temporarily
  ...
  desktop. In the start menu, click on run, and type in 'winipcfg' in the &quot;Open&quot;
  line. The IP configuration window should pop up and you will be able to check
  your subnet mask there. If it is set to 255.0.0.0, then you will want to
  release and renew your IP address until you get a subnet mask that is
  something other then 255.0.0.0. Ideally you will want to have 255.255.255.0.
  If you are unable to get a different subnet mask after releasing and renewing
  then you will need to contact your Internet Service Provider for further
  assistance.</P>  <P>The same mainly applies to broadband connections as well. Most troubles
