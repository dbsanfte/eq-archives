...
//window.alert(document.cookie);
	...
	<span class="status_headline">All English language based EverQuest Servers down for

  maintenance</span><br>
	<span class="status_date">6/2/2004  04:00 AM PDT (-7 UTC)</span><br>
	<P>All English language based EverQuest servers are down for

  a scheduled update. The estimated time for maintenance completion is 3 hours.

  </P>  <P>-The SOE Game Operations Team</P>
