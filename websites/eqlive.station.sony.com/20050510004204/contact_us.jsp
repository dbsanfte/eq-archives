...
<P ALIGN="center"><STRONG><BR><STRONG>Contact Us</STRONG></STRONG></P>  <P>Customer Service Related
  ...
  provide to the EverQuest player base when needed.</P>  <P><A HREF="mailto:eqtech@soe.sony.com">eqtech@soe.sony.com</A><BR>This is the main tech support email address. If you are having technical issues,
  use this address. When using this address, it is best to supply as much
  information about your system as possible. The more information Tech Support
  has, the better they will be able to help you. Another thing you can do is to
  send the dbg.text file that is found in the EverQuest directory along with
  your email. The dbg.txt file is a debug file that contains information that
  Tech Support may be able to use to help solve your technical problems.</P>  <P><A HREF="mailto:accounts@soe.sony.com">accounts@soe.sony.com</A><BR>This is the accounts/billing address. This is the place to send account and
  ...
  only deals with the out of character general discussion boards.&nbsp; </P>  <P><BR>Fan Faire Contacts</P>  <P><A HREF="mailto:fanfaire@soe.sony.com">fanfaire@soe.sony.com</A><BR>This is the address to use if you have any Fan Faire related questions.</P>  <P>More ways to contact us than you thought? One
