...
<tr>
  ...
  Bayle)</a><br>
	...
	<a href="dev_view.jsp?id=64065" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64063" class="tinylink">The Results are in!</a><br>
	
	<a href="dev_view.jsp?id=64062" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64061" class="tinylink">Update Re-Scheduled</a><br>
	
	<a href="dev_view.jsp?id=64060" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64059" class="tinylink">File Name Change</a><br>
...
<h1>Complimentary character moves for Antonius Bayle (Kane
  Bayle)</h1>
<P>Starting July 1st 2005  we will be allowing all customers affected by the merge with Kael Drakkal,
  Sebilis, Venril Sathir and Antonius Bayle (Kane Bayle) merge a one-time,
  complimentary character move to the server of their choice.&nbsp; This excludes Firiona Vie, Stormhammer
  and Test Server.&nbsp; For each
  customer with an account who requests such a move, all characters associated
  with that customer&#8217;s account will be transferred to the selected
  server.&nbsp; All characters will bring
  their items with them in the transfer.&nbsp;
  These movelogs will continue nightly for the next 30 days.</P>  <P>If you have changed your mind as to which server you would
  like to move to, the /movelog UI has a disregard button.&nbsp; Using the disregard button will cancel
  any pending movelog requests and allow you to execute a new movelog request.</P>  <P>Any accounts that have executed the movelog request will
  need to make certain they have no corpses in the world.&nbsp; If you have a shared bank already in
  use on your destination server, you will need to empty either shared bank out
  as only one will be available after the movelog is complete.</P>
