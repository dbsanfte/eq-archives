...
<h1>Halflings are April Fools . . .</h1>
<P>Rashere shares some lock out timer
  information and clarifies why these were implemented.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=71614#M71614">Lockout
  Timers</A></P>  <P>Grumbuk updates the community on
  the zone crashing issues. <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=testing&amp;message.id=5533#M5533">Crash
  Update</A></P>  <P>Join the fun that&#8217;s
  currently going on in the Pie Shop.&nbsp; Kytherea is entertaining us with a
  dynamic story.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Fun&amp;message.id=1941">Choose
  your own Adventure</A></P>  <P>Are you new to the world of
  EverQuest?&nbsp; Check out this new players post, read the advice he is given
  and ask questions of your own.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=TNZ&amp;message.id=164106">A
  Newbie's Diary</A></P>  <P>&nbsp;</P>
