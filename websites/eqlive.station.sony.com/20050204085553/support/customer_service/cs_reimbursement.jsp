...
<P ALIGN="center"><STRONG><BR><STRONG>Reimbursement Policy</STRONG></STRONG></P>  <P><STRONG>In an effort to more efficiently assist our customer base, we have
  ...
  the changes below will perform this task.</STRONG></P>  <P ALIGN="center"><EM>This policy is not all-inclusive
  and there are situations outside the scope of the policy that may be
  determined at the specific time to not warrant an item reimbursement. Please
  remember that no requests for reimbursals are guaranteed to be fulfilled.</EM></P>  <P><STRONG>1. Bind Death Loops</STRONG></P>  <P><STRONG>Bind Death Loops occur when a player is killed repeatedly upon
  ...
  bind death loop, please do the following:</EM></P>  <BLOCKQUOTE>  <UL>   <LI><EM>Attempt to
       camp the affected character out of game.</EM></LI>   <LI><EM>Upon returning
       to the character select screen, either log in another character, or make
       a new character to log in game on the same server.</EM></LI>   <LI><EM>For
       assistance, petition in game on that same server with the name,
       location, and details of what is taking place.</EM></LI>  </UL>  </BLOCKQUOTE>  <P><STRONG>2. Coins</STRONG></P>  <P><STRONG>Coins are the cash that players use as currency with merchants and
  ...
  accidentally, may be reimbursed after an investigation and at the discretion of
  the GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.1.1 <EM>Note: To avoid accidentally
  ...
  be reimbursed after an investigation and at the discretion of the GM.<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6.1.1<EM>Note: To avoid accidentally dropping
  an item, we suggest you set the item dropping option to never.</EM><BR>&nbsp;&nbsp;&nbsp;6.2. Items that fall to the ground during trades due to a
  ...
  class, and deity are fixed in nature, how other NPCs look at you can be
  influenced pro or con based on what you do in the world.</STRONG></P>  <P>&nbsp;&nbsp;&nbsp;8.1. Factions may be restored to a previous save after
  ...
  before it is restored, those items will be deleted from the restored character's
  inventory or the restoral denied.</P>  <P><STRONG>13. Trades</STRONG></P>  <P><STRONG>Trades are any items that are placed into the trade window and
  ...
  following:</EM></P>  <BLOCKQUOTE>  <UL>   <LI><EM>Scroll up
       until the pertinent text is available in your viewing window</EM></LI>   <LI><EM>Type /report
