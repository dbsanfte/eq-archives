...
<P ALIGN="center"><STRONG><BR><STRONG>Supported Sound Cards</STRONG></STRONG></P>  <P>The following is a list of supported sound cards.<BR>You SHOULD install the most recent driver version from your manufacturer.</P>  <P ALIGN="center">Aureal A3D
  Chipset</P>  <P>Unfortunately, the Aureal company is no longer in business, so support for
  the following sound cards is limited. </P>  <P><EM>Cards we have tested:</EM></P>  <UL>   <LI>Turtle Beach<BR>Montego / Vortex A3D<BR><A TARGET="_blank" HREF="http://www.voyetra-turtle-beach.com/">http://www.voyetra-turtle-beach.com/</A></LI>   <LI>Diamond Multimedia<BR>Monster Sound MX300</LI>  </UL>  <P><EM>Not Tested but Should Work:</EM></P>  <UL>   <LI>Diamond
       Multimedia<BR>Monster Sound<BR>Monster Sound M80<BR>Monster Sound MX200<BR><BR></LI>   <LI>Monster
       Sound MX400<BR><BR></LI>   <LI>Multiwave<BR>AudioWave 16 PNP<BR>AudioWave Green 16<BR>AudioWave Platinum 16<BR>AudioWave 32PNP<BR><BR></LI>   <LI>Orchid<BR>Nusound 3D<BR><BR></LI>   <LI>Xitel<BR>Storm VX</LI>  </UL>  <P ALIGN="center">Creative Labs</P>  <P>The sound cards were tested under the Windows98 operating system.<BR>EverQuest should work with all Sound Blaster 16 compatible sound cards.</P>  <P><EM>Cards we have tested:</EM></P>  <UL>   <LI>Sound Blaster Live! Family<BR><A TARGET="_blank" HREF="http://soundblaster.com/">http://soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster Live! then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster PCI512<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster PCI128<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster AWE64 Gold<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster AWE 64<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster AWE 32<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster 16<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>  </UL>  <P><EM>Note: In order for the SBLive to work correctly, you must download
  BOTH Live!Ware 3.0 AND the latest SBLive drivers. You will then have to
  delete all previous SoundBlaster installations and re-install both downloaded
  packages.</EM></P>  <UL>   <LI>Sound Blaster PCI64<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A>       <EM><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></EM></LI>   <LI>Sound Blaster Ensoniq Audio PCI<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>   <LI>Sound Blaster 32<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster ISA then you will see the
       driver listing</EM></LI>  </UL>  <P ALIGN="center">Crystal</P>  <P><EM>Cards we have tested:</EM></P>  <UL>   <LI>Crystal PNP CS4236B and SoundBlaster 16 compatible<BR><A TARGET="_blank" HREF="http://www.cirrus.com/Drivers/audiodrv/index_new.cfm">http://www.cirrus.com/Drivers/audiodrv/index_new.cfm</A></LI>  </UL>  <P ALIGN="center">Ensoniq</P>  <P><EM>Cards we have tested:</EM></P>  <P><EM>Note: All Ensoniq Sound Card support is handled by Creative Labs. Use
  either the latest </EM><STRONG><EM>Sound Blaster Ensoniq AudioPCI</EM></STRONG><EM>  drivers or the drivers that came with your Ensoniq card.</EM></P>  <UL>   <LI>Soundscape<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com/</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
       driver listing</EM></LI>  </UL>  <P><EM>Not tested but should work:</EM></P>  <UL>   <LI>Soundscape VIVO<BR>Soundscape Elite<BR><A TARGET="_blank" HREF="http://support.soundblaster.com/">http://support.soundblaster.com</A><BR><EM>Click on Audio &gt;&gt; Sound Blaster PCI then you will see the
       driver listing</EM> </LI>  </UL>  <P>&nbsp;</P>  <P>If you are still having problems after visiting
  this support section, you can contact our Technical Support Department
  through an email via our <A TARGET="_blank" HREF="http://www.station.sony.com/en/services/help/eqGM.jsp">online
  form</A>.</P>  <P><STRONG>*WARNING: ALL OF THE DRIVERS LINKED TO OR OTHERWISE MADE AVAILABLE
  HEREUNDER ARE MADE AVAILABLE STRICTLY 'AS-IS' AND SONY ONLINE ENTERTAINMENT
  INC, VERANT INTERACTIVE, INC. AND ANY AND ALL OF THEIR AFFILIATES, MAKE NO
  REPRESENTATIONS OR WARRANTIES, EXPRESS, IMPLIED, ARISING FROM COURSE OF DEALING
  OR USAGE OF TRADE, OR STATUTORY, AS TO THESE DRIVERS OR ANY MATTER WHATSOEVER
  CONNECTED HEREWITH, INCLUDING, WITHOUT LIMITATION, ANY REPRESENTATION THAT
  THE DRIVERS DO NOT CONTAIN COMPUTER CODE DESIGNED TO DISRUPT, DISABLE, HARM
  OR OTHERWISE IMPEDE IN ANY MANNER THE OPERATION OF A COMPUTER PROGRAM, WILL
  NOT DAMAGE OR DESTROY ANY DATA FILES RESIDING ON A COMPUTER OR WILL NOT
  ADVERSELY AFFECT THE HARDWARE OR OTHER SOFTWARE OF THE USER IN ANY WAY. IN
  PARTICULAR, ANY AND ALL WARRANTIES OF TITLE, MERCHANTABILITY AND FITNESS FOR
  A PARTICULAR PURPOSE ARE EXPRESSLY EXCLUDED. USE AT YOUR OWN RISK.</STRONG></P>
