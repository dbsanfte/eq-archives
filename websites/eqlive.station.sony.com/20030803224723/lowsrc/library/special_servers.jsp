...
<P align=left><A href="/lowsrc/library/special_servers/sz_zonecontrol.jsp">Sullon Zek Control Maps</A><BR>This map of Norrath indicates which faction controls which zones.</P><!--<P align=left><STRONG>Sullon Zek Current Standings<BR></STRONG>Updated daily, check here for the latest in Sullon Zek points standings.</P>-->
