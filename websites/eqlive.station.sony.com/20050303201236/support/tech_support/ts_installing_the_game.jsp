...
<P ALIGN="center"><STRONG><BR><STRONG>Installing the Game</STRONG></STRONG></P>  <P><STRONG>Before installing EverQuest, make sure that your PC specifications
  meet or exceed the </STRONG><A HREF="../../../../../support/tech_support/ts_system_requirements.jsp"><STRONG>minimum
  requirements</STRONG></A><STRONG>.</STRONG></P>  <P>Insert the EverQuest game CD into your CD-ROM drive. If your CD-ROM drive
  has the AutoPlay function enabled, the installation will begin automatically.
  If AutoPlay is not enabled, Open the &quot;My Computer&quot; icon on your
  desk top, double-click on the CD-ROM icon, then double-left-click on
  &quot;setup.exe&quot;. The installation process will then commence.</P>  <P>EverQuest and all its expansions require at least 2GB of free disk space
  to install.</P>    <OL>   <LI>Select a directory
       in which you would like to install EverQuest. The default directory is
       C:\Program Files\Sony\EverQuest. If you would like to install the files
       into a different directory, change the path and proceed. Insert each
       successive disk (if required) as the prompts request it.</LI>   <LI>Installing the
       DirectX drivers:<BR>After the installation of EverQuest, an option to install DirectX will
       be provided. EverQuest will not run with any version of DirectX previous
       to 9.0 at this time. Select &quot;Yes&quot; to proceed, then follow the
       on-screen instructions. If you already have a better version of DirectX
       installed, you will be told that no update is possible. </LI>   <LI>After completing the
       installation of DirectX, you will be prompted to restart your computer.
       Select &quot;Yes&quot; and allow your system to reboot.</LI>  </OL>    <P>If you are still having problems after visiting this support section, you
  can contact our Technical Support Department through <A HREF="mailto:eqtech@soe.sony.com">email</A>.</P>
