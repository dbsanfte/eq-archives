...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/library/special_servers.jsp?null');">
...
<P align=left><A href="/library/special_servers/sz_zonecontrol.jsp">Sullon Zek Control Maps</A><BR>This map of Norrath indicates which faction controls which zones.</P>
<P align=left><A href="/library/sz_summary.jsp">Sullon Zek Current Standings</A><BR>Updated daily, check here for the latest in Sullon Zek points standings.</P>
