...
<P><EM>&quot;Welcome to my stall!&nbsp; My, aren't you an attractive young
  ...
  of that type.</STRONG></P>  <P><STRONG>You can also narrow or change your search using any of the
  selection boxes on the left.&nbsp; You can choose as many of these selections
  as you desire.&nbsp; Keep in mind, though, that if you are too specific you
  may not find any items meeting your search requirements.</STRONG></P>  <P><STRONG>For example, when you select 1H Slash you will probably see a
  rather long list when you click Find.&nbsp; You might choose to narrow that
  down by selecting Vah Shir in the Select by Race
  box (keeping the 1H Slash selection).&nbsp; That would restrict the listed
  items to 1H Slashing weapons usable by Vah  Shir.&nbsp; But if you also require that the item be equipable in the Ranged
  slot, you might find that no items match your search.</STRONG></P>  <P><STRONG>If you want to clear the selections you've made for your search
