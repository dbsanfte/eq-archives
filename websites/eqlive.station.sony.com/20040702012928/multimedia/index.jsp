	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/multimedia/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/multimedia/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P><A href="http://everquest.station.sony.com/screenshot.jsp">Screenshots<BR></A>A collection of screenshots from EverQuest and its expansions.</P>
<P><A href="/multimedia/desktops.jsp">Desktops</A><BR>Turn your desktop into another part of Norrath with this stunning desktop art.</P>
<P><A href="/multimedia/movies.jsp">Movies</A><BR>The sights and sounds of the world of EverQuest.</P>
<P><A href="/multimedia/box_art_and_more.jsp">Box Art &amp; More</A>&nbsp;<BR>A collection of EverQuest images and other fun stuff.</P>
<P><A href="http://eqlive.station.sony.com/multimedia/concept_art.jsp">Concept Art<BR></A>Early sketches and concepts of the EverQuest world.</P>
<P><A href="http://eqlive.station.sony.com/multimedia/screensaver.jsp">Screensaver</A><BR>Even when you're not logged in, you can have a little EQ on your desktop.</P>
<P><A href="http://eqlive.station.sony.com/multimedia/tking_index.jsp">UI Art<BR></A>Stunning artwork to spruce up your user interface, courtesy of T.King.<BR></P>
