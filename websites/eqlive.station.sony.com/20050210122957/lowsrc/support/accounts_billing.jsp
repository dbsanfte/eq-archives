...
<P>Accounts and Billing provide comprehensive online customer account service
  features pertaining to registered <EM>EverQuest</EM> players. Please contact
  us if you would like to modify your user account information, have questions
  about your billing, or all other specific concerns about your account.</P>  <P><A HREF="../../../../../support/accounts_billing/ab_create_activate_account.jsp">Creating
  An Account</A><BR>A simple step-by-step guide to setting up your own <EM>EverQuest</EM>  account.</P>  <P><A HREF="../../../../../support/accounts_billing/ab_recovery.jsp">Station
  Name and Password Recovery</A><BR>If you've forgotten your Station name or password, here's what you do.</P>  <P><A HREF="../../../../../support/accounts_billing/ab_pricing.jsp">Pricing Plans</A><BR>Find out about all <EM>EverQuest</EM> pricing plan options.</P>  <P><A HREF="../../../../../support/accounts_billing/ab_subscriptions.jsp">Changing Subscription Plans or Payment Methods</A><BR>Do you want to change your subscription plan or method of payment?</P>  <P><A HREF="../../../../../support/accounts_billing/ab_cancel.jsp">Canceling an <EM>EverQuest</EM>  Account</A><BR>We'll hate to lose you, but here is where you can learn
  how to cancel your account.&nbsp;</P>
