...
<P ALIGN="center"><STRONG><BR><STRONG>Character Naming Policy</STRONG></STRONG></P>  <P ALIGN="center">&nbsp;</P>  <P>Character names in EverQuest should reflect the genre of the game.
  ...
  surname.</P>  <P>The following types of names are inappropriate:.</P>  <OL>   <LI>Vile, profane, rude,
       or racist names including common swear words, anatomical references,
       racial slurs, and homonyms of these words.</LI>   <LI>Combinations of
       words that produce an offensive result (e.g. Hugeaz, Tug Mcgroin). </LI>   <LI>Names of religious,
       occult, or significant historic origin (e.g. Jesus, Allah, Satan,
       Stalin, Angel, Devil, Demon).</LI>   <LI>Trademarked names of
       products, services, or concepts (e.g. , Marlboro, Sony, Band-Aid).</LI>   <LI>Non-fantasy oriented
       names from popular media. These names can be either fictional (e.g.
       Rambo, Darthvader) or non-fictional (e.g. Garth Brooks, Pierce Brosnan,
       Ronald Reagan, Michael Jordan).</LI>   <LI>Common words and
  ...
  member of the Customer Service Team will then use the following process:</P>  <UL>   <LI>For category 1 or 2
       offenses, a member of the Customer Service Team will change the name of
       the character as soon as it is discovered. You may be notified of this
       name change either in-game or by email. Depending on the nature of the
       offensive name, the account may also be subject to disciplinary action
       including suspension or banning. A GM will contact you to inform you if
       disciplinary action is taken.</LI>   <LI>For categories 3
  ...
  Policy.&nbsp;</P>  <P ALIGN="center"><STRONG>Surname Policy:</STRONG></P>  <UL>   <LI>Surnames may not
       contain spaces</LI>   <LI>Surnames may contain
       double capitals provided that the capital letters do not violate any of
       the prior policies.</LI>   <LI>Surnames may contain
       an accent ( ` ) provided that the division created does not violate any
       of the prior policies. This accent is the only non-alpha character that
       is allowed in surnames.</LI>   <LI>Any number of
