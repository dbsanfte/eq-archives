	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_video_trouble.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_video_trouble.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P ALIGN="center"><BR><STRONG>General Video Troubleshooting</STRONG></P>  <OL>   <LI>No 3D Device Found
       Error<BR><BR>If you are receiving the &quot;No 3D device found&quot; error then you
       will want to run the DirectX diagnostic tool. Clicking on Run from your
       Start menu and typing &quot;dxdiag&quot; does this. After the DirectX
       Diagnostic Tool loads, click on the Display tab. Voodoo1/Voodoo2 card
       users will select the Display2 tab. Under the section labeled DirectX
       Features, you should see two entries. The first is DirectDraw and the
       second is Direct3D. Make sure both are listed as &quot;Acceleration
       Enabled&quot;. If they are not, click the Enable button to the right of
       the respective entry. If there is no Direct3D available, or the Enable
       button is grayed out, your video card is not capable of using Direct3D
       and you will not be able to play the game with this hardware. Please
       refer to the Video FAQ available at <A HREF="http://www.everquest.com/">http://www.everquest.com</A>       for the list of supported video cards.<BR><BR>If your video card is listed as being supported and you are still
       showing a &quot;No 3D device found&quot; error, please make sure you are
       using the latest drivers. Also, right click on the My Computer icon,
       left click on Properties, then select the Performance tab. Left click on
       the Graphics button, and make sure the slider bar is set to full (all
       the way to the right).<BR>&nbsp;</LI>  </OL>  <P>If you are still having problems after visiting this support section, you
