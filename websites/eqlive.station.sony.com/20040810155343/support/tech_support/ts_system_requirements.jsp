	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<DIV align=center><STRONG><BR>System Requirements</STRONG> </DIV>
<P><B><FONT size=2>Required Specs:</FONT></B></P>
<UL>
<LI><FONT size=2>Windows&reg; 98/2000/ME/XP </FONT>
<LI><FONT size=2>Pentium&reg; II 400 equivalent or greater </FONT>
<LI><FONT size=2>256 MB RAM </FONT>
<LI><FONT size=2>ATI Radeon 7500/NVidia GeForce 1 equivalent or greater </FONT>
<LI><FONT size=2>DirectX Compatible Sound Card </FONT>
<LI><FONT size=2>28.8k + Internet Connection </FONT>
<LI><FONT size=2>4X Speed CD-ROM </FONT>
<LI><FONT size=2>500MB - 2.6GB&nbsp;Available Hard Drive Space (depending on how many expansions are installed)</FONT> 
<LI><FONT size=2>DirectX 9.0b </FONT>
<LI><FONT size=2>EverQuest Classic and a valid EverQuest account</FONT></LI></UL>
<P><FONT size=2>* Note: All Direct 3D cards not supported.</FONT></P>
<P><STRONG><FONT size=2>Recommended Specs:</FONT></STRONG></P>
<UL>
<LI><FONT size=2>Windows&reg; 98/2000/ME/XP </FONT>
<LI><FONT size=2>Pentium&reg; 4 equivalent or greater </FONT>
<LI><FONT size=2>512 MB RAM </FONT>
<LI><FONT size=2>NVidia GeForce 3/ATI Radeon 8500 equivalent or greater </FONT>
<LI><FONT size=2>DirectX Compatible Sound Card </FONT>
<LI><FONT size=2>56.6k + Internet Connection </FONT>
<LI><FONT size=2>16X Speed CD-ROM </FONT>
<LI><FONT size=2>3.0+ GB Available Hard Drive Space </FONT>
<LI><FONT size=2>DirectX 9.0b </FONT>
<LI><FONT size=2>EverQuest Classic and a valid EverQuest account</FONT></LI></UL>
<P><FONT size=2>*Note: DirectX 9.0b or greater is required for all Win98/ME/2000/XP</FONT></P>
<P><FONT size=2>System requirements subject to change as the game progresses.</FONT></P>
<P align=center><FONT size=2><STRONG>DirectX 9.0b or Higher Required</STRONG></FONT></P>
<P><FONT size=2>Sony Online Entertainment has exciting news for all EverQuest players. As the world of Norrath evolves and expands, so too does the technology powering EverQuest. Sony Online Entertainment is making significant upgrades to the EverQuest engine which will allow SOE to provide players with the great game, but on a much more stable and efficient platform. More information on this can be found at <A href="http://boards.station.sony.com/ubb/everquest/Forum3/HTML/051233.html">http://boards.station.sony.com/ubb/everquest/Forum3/HTML/051233.html</A>.<BR></FONT><FONT size=2>Part of this change will result in the need for all EverQuest players to upgrade to DirectX 9 (DX9), the latest version of Microsoft's 3D software.</FONT></P>
<P><FONT size=2>To determine what version of DirectX is currently installed on your system:</FONT></P>
<OL>
<LI><FONT size=2>Click the Start menu.</FONT> 
<LI><FONT size=2>Use the Run command.</FONT> 
<LI><FONT size=2>In the Open field, type "DXDIAG" then click OK. This will launch the DirectX diagnostics tool.</FONT></LI></OL>
<BLOCKQUOTE dir=ltr style="MARGIN-RIGHT: 0px">
<P><FONT size=2>Your version of DirectX will be listed at the bottom of the System Information area. For example, version 9.0b is listed as "DirectX 9.0b (4.09.0000.0902)"</FONT></P>
<P><FONT size=2>Please do the following prior to playing EverQuest. It is very important that your drivers are installed in the order indicated to avoid potential problems:</FONT></P></BLOCKQUOTE>
<UL>
<LI><FONT size=2>Go to <A href="http://www.microsoft.com/windows/directx/default.aspx">http://www.microsoft.com/windows/directx/default.aspx</A> and install the latest DirectX version available for your operating system.</FONT> 
<LI><FONT size=2>Go to <A href="http://eqlive.station.sony.com/support/tech_support/ts_video.jsp">http://eqlive.station.sony.com/support/tech_support/ts_video.jsp</A> and install the drivers listed for your card per the list there. If you require assistance in how to uninstall/install your drivers, or how to determine what video card you have, please go to <A href="http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A> for more information (this site applies to Win2k and WinXP users).</FONT> 
<LI><FONT size=2>Go to the website for your sound card manufacturer and follow the same procedure. If you use a SBLive sound card, you can run "LiveUpdate" from the Windows Control Panel off of your start menu. View our Sound FAQ on how to uninstall/install your drivers, or how to identify your sound card, at <A href="http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp">http://eqlive.station.sony.com/support/tech_support/ts_install_av_drivers_xp.jsp</A> (for Win2k and WinXP users).</FONT></LI></UL>
<BLOCKQUOTE dir=ltr style="MARGIN-RIGHT: 0px">
<P><FONT size=2>If you experience any problems, please do the following:</FONT></P></BLOCKQUOTE>
<UL>
<LI><FONT size=2>Run DXDIAG.EXE from your Start menu (click start, run, then type "dxdiag")</FONT> 
<LI><FONT size=2>Click the "Save all Information" button at the bottom of the program window.</FONT> 
<LI><FONT size=2>Save the file as "dxdiag.txt"</FONT></LI></UL>
<P><FONT size=2>Email that file to <A href="mailto:eqtech@soe.sony.com">eqtech@soe.sony.com</A> along with a complete description of your problem, the "dbg.txt" file from your EverQuest directory, the text from any error messages that are presented, and if you are willing to assist our test department over the phone, a phone number where you can be reached. If you are still having problems after visiting this support section, you can contact our Technical Support Department via email using our online form.</FONT> </P>
