...
<P>We have an update tentatively scheduled for&nbsp;July 14th.&nbsp; Some of the highlights include;</P>
<P>The ability to remove augments from items and retain them.</P>
<P>Pets should properly shrink.</P>
<P>A new adventure zone will move to Legends.</P>
<P>Pets will zone with their masters.</P>
<P>Mana will display a numeric value.</P>
<P>Buffs will show a countdown timer when moused over.</P>
<P>The new Veeshan's&nbsp;Peak!&nbsp;</P>
<P>And many other exciting changes.&nbsp; Stay tuned.</P>
