...
//window.alert(document.cookie);
  ...
  frequently while you're online because we might need more information to assist
  you! IMPORTANT: if your petition's status shows as &quot;Pending: Waiting for
  Player&quot; or &quot;Pending: Closed&quot;, we won't be able to see your
  petition as current and needing attention in our queue. A &quot;Pending:
  Waiting for Player&quot; status requires that you review the GM questions or
  comments and add further information as needed. A &quot;Pending: Closed&quot;
  status indicates that your issue has been addressed and needs no further
  attention. If you feel that your petition's status is incorrect, please
  delete your current petition and submit another, providing new information as
  needed.<BR><BR>8. If you need to give more information, or tell us about a change in the
