	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/recent_updates.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/updates/recent_updates.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Recent&nbsp;Updates</font></b></div>
                        <!-- #EndEditable --></td>
...
<tr>
	...
	<a href="recent_updates.jsp?id=63498" class="tinylink">Septmenber 14, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=63151" class="tinylink">August 11, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=62871" class="tinylink">July 16, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=62860" class="tinylink">July 15, 2004</a><br>
	
	
	
	<a href="recent_updates.jsp?id=62852" class="tinylink">July 14, 2004</a><br>
	...
	<p><a href="recent_updates_archive.jsp" class="tinylink">Archives &gt;&gt;</a>
	</td>
</tr>
</table>
...
<h1>Septmenber 14, 2004</h1>
<P>September 14, 2004<BR>-------------------</P>
<P><BR>Headlines<BR>-------------------<BR>Omens of War is live!<BR>New Teleportation Spells to Barindu.<BR>Just me and my shadooooow!<BR>Reflective Water?<BR>Register now for the New Orleans Fan Faire.</P>
<P><BR>Omens of War<BR>--------------------<BR>- Explore the war torn lands of Kuua and reap the benefits of new AAs, spells and items including the new, powerful, Epic 2.0.&nbsp; Lush new areas, filled with beautiful creatures and vibrant, living landscapes await you at every turn.&nbsp; We hope you enjoy all that EverQuest: Omens of War brings to the game.</P>
<P>Level 70<BR>--------------------<BR>Earn your way from level 65 to 70 and learn new spells and abilities along the way.</P>
<P>Travel to the Omens Zones<BR>-------------------<BR>The Priests of Discord in Norrath believe they have been granted a gift.&nbsp; A unique knowledge has been bestowed upon them which they believe was granted as a reward for preaching the way of Discord.&nbsp; That gift, they claim, is the knowledge of a way to a world that is enveloped by Discord itself -- an ethereal poison that wreaks havoc and strife upon all it touches.</P>
<P>Speak to a Priest of Discord to learn how to enter the World of Kuua.</P>
<P>The Task System<BR>-------------------<BR>Only have a short time to play or are you waiting for a group or raid?&nbsp; Immerse yourself in a Task.&nbsp; You can find Task Masters all over Norrath. They can be found in most home cities as well as in places like the East Commonlands, the Butcherblock Mountains, Toxxulia Forest and the Swamp of No Hope. For the more daring individuals, the most challenging tasks can be found by speaking with Task Masters in the Dreadlands and the Overthere.</P>
<P>You can open the task window by hitting Alt+Q and start enjoying this new game-play style and enhancement to the EverQuest experience.</P>
<P>Be mindful of turning in task items in stacks, as with all quests in EQ, please separate the items before turning them in for a reward.</P>
<P>Epic Weapons 2.0<BR>-------------------<BR>Will you be the first of your class to earn these powerful new items?</P>
<P>Guild Tribute<BR>-------------------<BR>Omens of War expansion brings a new Guild Tribute system. This system will allow guild members to donate items/cash for Tribute points, and allow officers to select benefits that the entire guild will receive, deducting the cost from the guild's tribute pool.&nbsp; </P>
<P>Guild Tribute is an extension of the tribute system introduced in Gates of Discord and purchasers of either expansion, will be able to reap the new benefits.</P>
<P>Retail Claim Item<BR>-------------------<BR>Those of you who purchased the retail version of EverQuest: Omens of War will need to use the /claim command in-game to receive your in-game items.&nbsp; Enjoy!</P>
<P>Select your title<BR>-------------------<BR>You can hit Shift+T to bring up the new Title selection UI which will allow you to choose from the titles you have earned, through AAs, levels or accomplishments, to be shown with your character name in-game.</P>
<P><BR>Voice Macros<BR>-------------------<BR>Using Ctrl+V will bring up the new Voice Macro UI.&nbsp; There you will see a list of available voice macros as well as the options of Play, Tell, Group and Raid.&nbsp; Selecting a macro and play will play the macro for you only.&nbsp; Selecting a macro and using one of the other options will send the voice macro to either a tell (using the person you have targeted as the recipient), group or raid.</P>
<P>To create your own voice macros, make a sound file using the same name as one of the existing voice macros, which can be found in your EverQuest&gt;Voice&gt;Default directory and place it in your EverQuest&gt;Voice&gt;User directory.&nbsp; </P>
<P>You can create hot keys of your favorite Voice Macros by selecting the macro you would like and clicking and holding on the Tell, Raid or Group button until the icon appears on your cursor. </P>
<P>We hope you enjoy this new way to immerse yourself into the EverQuest experience.</P>
<P><BR>New Spell Slot&nbsp;<BR>-------------------<BR>For the first time in EQ, you can open up a new spell slot by learning the Mnemonic Retention AA ability.&nbsp; 9 Spell slots!&nbsp; Wow, Why I remember in the early days of EQ, we only had 8 spell slots and we liked it.&nbsp; We cast spells all day, going uphill both ways.&nbsp; You whippersnappers have it easy =)</P>
<P>More Buff Slots<BR>-------------------<BR>If you find that you need more room for beneficial buffs on your character, activate the Mystical Attuning AA and open up more room in your buff slot window.</P>
<P><BR>Live Changes<BR>-------------------</P>
<P>Improved Customization for Graphics<BR>-------------------<BR>-There are now 3 sets of options (Spell, Environment, and Actor).&nbsp; All 3 sets have similar options that affect each type of particle.&nbsp; These options allow for more customization when setting up your display and filters.</P>
<P>-An "advanced" button has been added under the display tab in the options window.&nbsp; This will allow you to toggle some of the new settings, for our new customizable graphics and effects.&nbsp; You will most likely need to expand the options window to see the new Advanced button.</P>
<P>- Shadows; Toggles the new dynamic shadows.<BR>- Water Swap*: Switches between old style water, and new reflective water the next time you zone.<BR>- 2.X Pixel Shaders: Toggles the use of pixel shaders 2.0.<BR>- 1.X Pixel Shaders: Toggles the use of pixel shaders 1.0.<BR>- Vertex Shaders: Toggles the use of vertex shaders.<BR>- Sky Reflection Type*: Set to Static to use a preset reflection or Dynamic to have the sky reflected on the water.<BR>- Dynamic Update Interval: Control the CPU costs of the dynamic reflection by adjusting how often to update the reflection texture<BR>- Dynamic Sky Reflection Size*: Allows you to control how large the reflection texture is. <BR>(The * indicates a setting that will take effect next time you zone).</P>
<P><BR>- You can now see real time shadows within the world of Norrath.&nbsp; Use the shadows option in options&gt;Display&gt;advanced to turn them off and on.&nbsp; Now, even when soloing, you will never be alone.&nbsp; Those of you with older video cards may have some performance issues when attempting to use shadows.&nbsp; If your machine does not meet the recommended system specifications, we suggest that you play with shadows off.</P>
<P>- Enjoy sunsets and moonrises viewed above EverQuest's new reflective water which is available for everyone, wherever there is static water, e.g. Oceans, seas and lakes.&nbsp; You can toggle the new water shaders on and off using the Water Swap button, under options&gt;display&gt;advanced.</P>
<P>Zoning Screen<BR>-------------------<BR>When zoning, you will now see the loading splash screen.&nbsp; You have not crashed, do not be alarmed.&nbsp; </P>
<P><BR>New Improved Particles<BR>-------------------<BR>-You will now be affected by the environment around you, be sure to check out these effects especially under water, in frigid weather, dry climates and upon death.</P>
<P>Spells<BR>-------------------<BR>- Symbol and Aegolism spell lines no longer require reagents.&nbsp; Clerics and Paladins rejoice.<BR>- Necromancer pets will no longer require peridots.<BR>- The beastlord spell, Tureptan Spirit, now has a healing component.<BR>- New transportation spells are available in the Abysmal Sea.&nbsp; Check with your transportation spell contact for more information.<BR>- Bard PBAoE spells will no longer damage targets that are moving, however any other spell effects from the PBAoE spell will still be applied to the targets as usual.<BR>- Beneficial spells can now be used in the EverQuest tutorial.</P>
<P>Skill Cap Changes<BR>-------------------<BR>- Piercing now caps at 250 at level 60 for warriors, rangers and beastlords.<BR>- 1h Blunt and 2h Blunt now cap at 250 at level 60 for beastlords<BR>- Druids and Bards that exceeded their tracking skill limits, have had their tracking skill reset to the appropriate value.</P>
<P>Items<BR>-------------------<BR>- The Timespinner pet will no longer cast spells.<BR>- The Dagger of Death has had its AC value reduced.<BR>- Some of the new Omens of War items will now display an "Attunable" attribute, which means that they can be traded freely until they become are equipped or augmented.&nbsp; Attunable augments will become no-drop flagged when added to an augment slot, attunable items will become no-drop when equipped.&nbsp; You will not be able to auto-equip an attunable item that has not been attuned to your character.&nbsp; Please be mindful of the new Attunable flag before equipping or augmenting new items.</P>
<P>Alternate Advancement Abilities<BR>-------------------<BR>- Berserkers have received some new AAs. This should bring their AA selection up to par with comparable melee classes.<BR>- Added the ability for shadow knights to train the Gates of Discord ability Improved Theft of Life and the Planes of Power ability Suspended Minion.<BR>- The healing wards that priests can summon using their Gates of Discord AAs are now immune to most spells.<BR>- Lowered the reuse time on the Magician ability Host of the Elements to 15 minutes.<BR>- Added the ability to train Quick Damage to Magicians as a Luclin Class ability.<BR>- Increased the critical hit chance for the Wizard Gates of Discord AA Frenzied Devastation.</P>
<P>Fan Faire<BR>-------------------<BR>We are proud to announce the Halloween, New Orleans Fan Faire!&nbsp; The event dates are October 28-30, 2004, and space is going fast! The last day to guarantee your spot by pre-registering is October 11th.&nbsp; For more information, please go to <A href="http://everquest.station.sony.com/fanfaire/">http://everquest.station.sony.com/fanfaire/</A>.&nbsp; See you in New Orleans!<BR>&nbsp;</P>
<P>UI Changes<BR>-------------------<BR>The following XML files are new or have been modified:</P>
<P>- EQUI_Animations.xml<BR>- EQUI_BuffWindow.xml<BR>- EQUI_CastSpellWnd.xml<BR>- EQUI_DynamicZoneWnd.xml<BR>- EQUI_GuildManagementWnd.xml<BR>- EQUI_GuildTributeMasterWnd.xml<BR>- EQUI_OptionsWindow.xml<BR>- EQUI_TaskSelectWnd.xml<BR>- EQUI_TaskWnd.xml<BR>- EQUI_TitleWnd.xml<BR>- EQUI_TributeBenefitWnd.xml<BR>- EQUI_VoiceMacroWnd.xml<BR>- EQUI.xml<BR>- EQUI_AAWindow.xml<BR>- EQUI_AdvancedDisplayOptionsWnd.xml</P>
<P>&nbsp;</P>
