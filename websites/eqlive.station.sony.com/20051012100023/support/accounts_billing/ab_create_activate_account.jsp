	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_create_activate_account.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing/ab_create_activate_account.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
...
<P ALIGN="center"><STRONG><BR><STRONG>Creating An Account</STRONG></STRONG></P>  <P><BR>Please make sure that you have your registration code and e-mail address
  ready before creating an account.</P>  <P>After running the <EM>EverQuest</EM> executable and performing the patch
  process, you will be taken to the <EM>EverQuest</EM> front-end screen. Select
  &quot;Account&quot;, then left-click on the &quot;New Account&quot; button,
  this will bring up the account registration screen.</P>  <OL>   <LI>Enter your name, address,
       e-mail address, and date of birth by left clicking in the field, then
       typing in the information. The TAB key may be used to move the cursor to
       the next field. Once all of the information on each registration screen
       has been filled out, click on the &quot;Next&quot; key located at the
       bottom right side of the screen.</LI>   <LI>Enter your PC specifications
       and answer the other general interest questions. Please note that the PC
       and general interest questions are not required to create the account.
       After you have completed this section of the registration click the
       &quot;Next&quot; key to continue.</LI>   <LI>Select a Chat Handle and
       enter your EverQuest account key. An account key is included with <EM>EverQuest</EM>.
       The login name that you select will be used to connect to the EverQuest
       servers, and will also be seen while you are in the <EM>EverQuest</EM>       chat rooms.</LI>   <LI>Enter your Sony Station
       login and password. If you do not have a current Sony Station account,
       you may create one by simply entering a desired login name and password.
       After selecting a Station name and password, left-click on the
       &quot;Finish&quot; button located at the bottom right side of the
       screen.</LI>   <LI>You will then be
       required to enter your Station name and password, do so, then left-click
       on the &quot;Connect&quot; button. After you enter your Station name
       information, a window will appear asking you to subscribe. Left-click
       the &quot;Now&quot; button to begin a subscription. Select a method of
       payment and fill-in all required billing information, then left-click on
       the &quot;Finish&quot; button located at the bottom left side of the
       screen. Your billing information will then be processed; this may take a
       few minutes. After acceptance, you may want to sign up for the <A HREF="http://www.station.sony.com/stationaccess/"><STRONG>Station Access Plan</STRONG></A>,
       which includes <EM>EverQuest</EM> Online Adventures, PlanetSide, Star
       Wars Galaxies and The Station Pass games. Once accepted, you may then
       return to the front-end screen and select &quot;Connect&quot; to begin
       playing <EM>EverQuest</EM>.</LI>  </OL>  <P>If you encounter any problems with the billing process, please e-mail The
  Station using an easy-to-use form from <A TARGET="_blank" HREF="http://www.station.sony.com/en/services/help/help.jsp">Account
  Services</A>.</P>  <P>&nbsp;</P>  <P>&nbsp;</P>  <P>If you are still having problems after visiting this support section, you
