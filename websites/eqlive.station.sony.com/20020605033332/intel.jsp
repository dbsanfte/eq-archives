...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/intel.jsp?null');">
...
//window.alert(document.cookie);
          ...
          <td width="614" background="" valign="top">
            <table width="614" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="1"><img width="614" height="200" src="images/intel_header.jpg"></td>
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="/images/sub_heading_bg.gif"> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Intel&nbsp;Tech&nbsp;Update</font></b></div>
                      </td>
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"> 
                        ...
                        <center>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td width="176" valign="top"> 
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>EQ offers hundreds of playable character 
                                      combinations</b>, including the new Vah 
                                      Shir race and BeastLord character class. 
                                      Luclin brings to EverQuest entirely re-designed 
                                      player character models with high-res armor 
                                      and equipment, featuring over four times 
                                      the number of polygons of older character 
                                      models.</td>
                                  </tr>
                                </table>
                                
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top"> 
                                <div align="center">
                                  <p>Pentium&reg; 4 Processor Power</p>
                                  <p>&nbsp;</p>
                                  <p>&nbsp;</p>
                                  <p><img src="images/intel.jpg" width="72" height="88"><br>
                                    <br>
                                    <b>Speeds ranging<br>
                                    from 1.33 to 2.2 GHz</b> </p>
                                </div>
                              </td>
                              <td width="175" valign="top"> 
                                <p align="center">Customer Benefit</p>
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>EverQuest is optimized</b> <b>to take 
                                      advantage</b> of the power of the Intel&reg; 
                                      Pentium&reg; 4 Processor </td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                            <tr> 
                              <td width="176" valign="top"> 
                                <div align="center"><img src="images/hr_150.jpg" width="150" height="15"></div>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top">&nbsp;</td>
                              <td width="175" valign="top"> 
                                <div align="center"><img src="images/hr_150.jpg" width="150" height="15"></div>
                              </td>
                            </tr>
                            <tr> 
                              <td width="176" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>With over 140 exciting zones to explore</b>, 
                                      EverQuest offers challenges for all levels 
                                      of expertise. Already the #1 massively multiplayer 
                                      online game available, Luclin promises over 
                                      24 new mind-boggling zones.</td>
                                  </tr>
                                </table>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top">&nbsp;</td>
                              <td width="175" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>Experience smoother animations</b> 
                                      and frame rates with a multitude of creatures 
                                      and players onscreen. </td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                            <tr> 
                              <td width="176" align="right"> 
                                <div align="center"><img src="images/intel_mid_graphic1.jpg" width="178" height="146"></div>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top"><img src="images/intel_mid_graphic2.jpg" width="213" height="146"></td>
                              <td width="175" valign="top"> 
                                <div align="center"><img src="images/intel_mid_graphic3.jpg" width="173" height="146"></div>
                              </td>
                            </tr>
                            <tr> 
                              <td width="176" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>Take part in an enormous world with 
                                      thousands of in-game quests</b>, and a dynamically 
                                      progressing story in which you play an active 
                                      role.</td>
                                  </tr>
                                </table>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top">
                                <div align="center">
                                  <p>&nbsp;</p>
                                  <p><b>Intel&reg; NetBurst&#153;<br>
                                    micro-architecture</b></p>
                                </div>
                              </td>
                              <td width="175" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>Everquest is optimized to take advantage</b> 
                                      of the Intel&reg; Pentium&reg; 4 processor&#146;s 
                                      fast processing power.</td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                            ...
                            <tr> 
                              <td width="176" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>Join hundreds of thousands of real 
                                      people </b>and play cooperatively or competitively 
                                      as you strive for honor, fame, and fortune. 
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top">
                                <div align="center"> <br>
                                  <b>Less lag time due to<br>
                                  faster compression<br>
                                  and decompression<br>
                                  of data packets</b></div>
                              </td>
                              <td width="175" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>400,000+ EverQuest players </b>and 
                                      growing. This is one party you don't want 
                                      to miss out on.</td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr> 
                              <td width="176" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>Mount up, and cover great distances</b> 
                                      with the newly added horses.</td>
                                  </tr>
                                </table>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top">
                                <div align="center"><b><br>
                                  Faster frame rates with<br>
                                  higher resolution,<br>
                                  detail &amp; quality </b></div>
                              </td>
                              <td width="175" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>The smoother transitions</b>, quicker 
                                      load times and faster frame rates will amaze 
                                      you!</td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr> 
                              <td width="176" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>The complete 3D overhaul </b>in The 
                                      Shadows of Luclin will leave you breathless 
                                      as the entire world of EverQuest takes on 
                                      new clarity and detail.</td>
                                  </tr>
                                </table>
                              </td>
                              <td width="213" bgcolor="0A0A1C" valign="top">
                                <div align="center"> <b><br>
                                  Higher polygon counts<br>
                                  for ultra-realistic<br>
                                  environments. </b></div>
                              </td>
                              <td width="175" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                  <tr>
                                    <td><b>The world</b> of Norrath has never 
                                      looked better!</td>
                                  </tr>
                                </table>
                              </td>
            ...
            <table width="375" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td align="left">&nbsp; </td>
                <td align="right" width="1"><img src="images/intel_bottom_ad_text.jpg" width="195" height="65"> 
                </td>
                <td align="right" width="1"><img src="images/intel_bottom_ad_falcon.jpg" width="90" height="65"></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          </td>
