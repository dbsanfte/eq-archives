...
<tr>
	...
	<a href="dev_view.jsp?id=64015" class="tinylink">Farewell Fuzzbal</a><br>
	
	<a href="dev_view.jsp?id=64013" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64014" class="tinylink">EQ Stratics HoC Dev Chat Tonight!</a><br>
	
	<a href="dev_view.jsp?id=64011" class="tinylink">Fun with Quotes</a><br>
...
<h1>EverQuest: Dragons of Norrath beta NDA lifted.</h1>
<P>Feel free to tell your friends about Dragons of Norrath now that portions
  of the beta NDA have been lifted.&nbsp; However, keep in mind that we are
  lifting the NDA for discussion of game content and features and not with
  respect to bugs, feedback, communication between SOE and beta testers, or
  other confidential communication regarding the beta.</P>  <P>Let those Dragons Loose!</P>  <P>Brenlo</P>
