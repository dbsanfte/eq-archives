...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/movies/cnn.jsp?null');">
                  ...
                  <table width="584" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td width="564" colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
                        <!-- end page content -->
                        <p align="center"><img src="/images/cnncoverage.jpg" width="424" height="104"></p>
                        <p align="center"><object classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" width="192"

height="160" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
                            <param name="SRC" value="cnn.mov">
                            <param name="AUTOPLAY" value="true">
                            <param name="CONTROLLER" value="true">
                            <embed src="/movies/cnn.mov" width="192" height="144" autoplay="true"
