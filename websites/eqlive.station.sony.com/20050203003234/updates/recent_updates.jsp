...
<tr>
	...
	<a href="recent_updates.jsp?id=64005" class="tinylink">December 17th, 2004</a><br>
	
	<a href="recent_updates.jsp?id=64004" class="tinylink">December 15th, 2004</a><br>
	
	<a href="recent_updates.jsp?id=64003" class="tinylink">October 25th, 2004</a><br>
	
	<a href="recent_updates.jsp?id=64002" class="tinylink">October 13th, 2004</a><br>
...
<h1>January 26th, 2005</h1>
*** Update Headlines 1/26/2005 ***   <P>------------------------------------- </P>  <P>Mistmoore and SplitPaw revamps live for all servers<br>  New and improved Lavastorm!</P>  <p>Item Changes<br>     ------------------------------------- </P>     <P>- Many Epic 2.0 effects have been modified.  Please see the EQforums at <a
  href="Eqforums.station.sony.com">
  Eqforums.station.sony.com</a> for details.</P>  <P>- These items are now primary and secondary slot
  usable:<br>  <ul><li>Totem of Shattered Hope               <li>Wand
  of Twisted Fate               <li>Infernal
  Staff of Fiery Fate               <li>Bazu
  Claw Hammer</li></ul>  </P>  <P>- Increased the drop rates on some items from Planes of Power
  zones that were too rare.</P>  <P>- The ending effect (casts when the rune wears off) of the
  Enchanter 1.5 and 2.0 epics has been changed so that it won't cause initial
  aggro on surrounding NPCs.  It
  will only lower the enchanter's hate on NPCs in the area of effect that are
  already aggro on him/her.</P>  <P>- Mace of Grim Tidings is now No-Drop </P>  <P>- Added a Globe of Discordant Energy drop to Anguish.</P>  <P>- Fixed the combine for the cleric epic 1.5, AA points should now
  be rewarded.  People who missed
  their AAs can hail Tavon to receive their AAs, if they have spoken to Natvil
  already.</P>  <P>- Revised the various Anguish armor sets. Some pieces now have
  effects added. </P>  <P>- Earring of Eternal Flame - This item now has the focus effect
  of Flame of the Lightbringer </P>  <p>- Anuek Dagger of Eye Gouging - This item now has a +12% mod to
  backstab. </P>  <p>- Upgraded the +damage augments from Tacvi</p>  <p>Spell, Discipline & AA Changes<br>     ------------------------------------- </P>  <p>- The skills windows will now show the modified skill of the
  player, including buffs/item mods, etc.</p>  <p>- Added a negative resist modifier to Crippling Strike, Stunning
  Kick, and Eye Gouge.</p>  <p>- Modified Hastened Purification of the Body to reduce the base
  time.</p>  <p>- The spell, Elemental Simulacrum Recourse, should no longer be
  removed when the recipient is hit in melee.</p>  <p>- Hide will work while levitated again.</p>  <p>- Tiny companion will again switch target to the pet
  correctly.</p>  <p>- An exploit with Lifeburn has been corrected.</p>  <p>- /stopsong, /cast, and anything starting a song other than
  /melody now clears the /melody buffer as intended.</p>  <p>- Bard Chants should once again generate the correct amount of
  hate.</p>  <p>- Fixed problem with the Ranger AA Guardian of the Forest where
  if you had maxed buffs this AA would not reset if it did not take.</p>  <p>- High level shaman pet should now automatically dual
  wield.</p>  <p>- Modified the effect slots for Hobble of Spirits so that it will
  stack with other contact innates.</p>  <p>Code Changes<br>     ------------------------------------- </P>  <p>- Players will now receive a message when they are too close for
  ranged weapons to be used when /autofire is being used.</p>  <p>- Ranged weapons are no longer subject to additional z-distance
  limit checks.</p>  <p>- Server side collision fixes have corrected various problems in
  certain areas in new zones such as the ramp entering Abysmal that was causing
  warping problems for NPCs.</p>  <p>Event Changes<br>     ------------------------------------- </P>  <p>- Players can now select a type of LDoN Adventure (Rescue, etc.)
  when requesting one from the Recruiter.</p>  <p>- Lowered combat regeneration of the Dragorn and Bazu forms in
  the Trial of Adaptation.</p>  <p>- Modified the spawn timer on the Tyrant of Nightmare in the
  Plane of Nightmare and the Decaying Lightcrawler in the Plane of
  Disease.  Both should make more
  frequent appearances.</p>  <p>- Lowered spell resists significantly in all MPG Raid and Single
  Group trials.</p>  <p>- Fixed some oddness that happened sometimes when Memblurring
  Hanvar.</p>  <p>- The non-loot dropping version of Arch Magus Vangl will be
  easier than the loot dropping version.</p>  <p>Miscellaneous<br>  <p>- Changed the level 70 bard /who title from Performer to Harold,
  er, Herald.</p>           <P><BR>-- The EverQuest Team</P>
