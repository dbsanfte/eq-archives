	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/comm_feedback.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/comm_feedback.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/community/comm_feedback.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b>Submit&nbsp;Community&nbsp;News</b></div>
                        <!-- #EndEditable --></td>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        <!-- begin page content -->
							...
							<P>Posting or sending a message on this form is subject to the <A href="http://eqlive.station.sony.com/support/customer_service/cs_rules_of_conduct.jsp"><U>EverQuest Rules of Conduct</U></A> and <A href="http://www2.station.sony.com/en/termsofservice.jsp"><U>The Station Terms of Service</FONT></U></A>. You acknowledge that any comments or messages submitted to Sony Online Entertainment and/or Verant Interactive are public and not private communications and may be accessible by the general public. 
<P>Before you send us your comment, please read over the following paragraphs.</P>
<P>Examples of Community News include:</P>
<P>Fan Site updates<BR>In-game events<BR>Server news<BR>Guild announcements</P>
						
						
						<script language="JavaScript">
							function validateForm()
							{
								form=document.mailform;
								
								if (form.username=="")
								{
									window.alert("Please give a name so we can credit you.");
									return false;
								}
								
								if (form.UserEmail=="")
								{
									window.alert("Please give an email address so we can reply to you.");
									return false;
								}
								
								if (form.TopicSubject=="")
								{
									window.alert("Please give a subject for your message.");
									return false;
								}
						...
						<form name="mailform" action="comm_submitit.jsp" method="POST" onsubmit="return validateForm();">
							
							<table border="0" class="title1">
								<tr valign="top"> 
									
                              <td class="title1">Your Name:</td>
									<td> 
								...
								<tr valign="top"> 
									...
									<td> 
										<input type="text" name="UserEmail" value="" size="40">
									</td>
								</tr>
								...
								<tr valign="top"> 
									<td>Subject:</td>
									<td> 
										<input type="text" name="TopicSubject" value="" size="40">
									</td>
								</tr>
								
								<tr valign="top"> 
									<td class="title1">Message:</td>
									<td> 
