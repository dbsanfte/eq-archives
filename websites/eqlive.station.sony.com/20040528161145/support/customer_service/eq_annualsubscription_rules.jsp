	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/eq_annualsubscription_rules.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/eq_annualsubscription_rules.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/customer_service/eq_annualsubscription_rules.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<STRONG><U>EverQuest 12-Month Subscription Extension Plan Including Digital Downloads of First Seven Expansion Packs</U></STRONG> 
<P><U>Cost:</U> $119.95 (plus taxes, if applicable). Residents of VAT-applicable European Union territories will also be charged a VAT tax equal to 17.5% of the applicable fee. 
<P><U>Digital Download Expansion Packs Included in this Special Offer:</U> 
<P>EverQuest&reg;: The Ruins of Kunark&reg;<BR>EverQuest&reg;: The Scars of Velious&reg;<BR>EverQuest&reg;: The Shadows of Luclin&#153;<BR>EverQuest&reg;: The Planes of Power&#153;<BR>EverQuest&reg;: The Legacy of Ykesha&#153;<BR>EverQuest&reg;: Lost Dungeons of Norrath&#153;<BR>EverQuest&reg;: Gates of Discord&#153; 
<P>The digital download of EverQuest expansion packs included with this special offer are a digital software-only purchase. SOE will not send you anything. The software included with this EverQuest 12-month Subscription Extension will need to be downloaded to your computer, but no physical box, disks or other materials will be provided or mailed to you. These downloads may be quite large and take significant time to download. For patch hints, go to the EverQuest Patcher Help website at <A href="http://eqlive.station.sony.com/support/tech_support/ts_new_patcher.jsp">http://eqlive.station.sony.com/support/tech_support/ts_new_patcher.jsp</A>. 
<P><A href="http://eqlive.station.sony.com/support/tech_support/ts_system_requirements.jsp">System Requirements</A> 
<P>This subscription enables one EverQuest account for twelve (12) months. SOE will immediately charge your credit card the full amount upon successful completion of this transaction. SOE does not give full or partial refunds for unused subscription periods. 
<P>This 12-month EverQuest Subscription Extension fee is a <U><STRONG>recurring charge</STRONG></U>; that means that, unless and until you cancel your account, you authorize SOE to charge your credit card the 12-month subscription amount at the beginning of each 12-month subscription period. When the 12-month EverQuest Subscription Extension period expires, you will automatically be migrated to the then current 12-month EverQuest Subscription plan (the then-current 12-month rate may differ from this special offer price). 
<P>To be eligible for this 12-month EverQuest Subscription Extension, you must have a current, valid EverQuest account on an SOE server (version of EverQuest published and hosted by SOE and not published or hosted by SOE partners outside of North America) that is not suspended or banned and is otherwise in good standing. EverQuest accounts registered on non-SOE servers, accounts using any payment method other than valid credit cards (such as GameCards or the GlobalCollect payment method), EverQuest accounts being used in connection with combination subscription pricing plans like the SOE All Access plan (including EverQuest: Legends accounts that have also been enabled for the SOE All Access plan), or the Station Pass, EverQuest: Legends subscribers, EverQuest accounts currently suspended, banned, not otherwise in good standing, or registered with a rental, promotional or provisional account key are not eligible. 
<P>This special offer 12-month Subscription Extension requires a valid credit card. If you currently use a GameCard, GlobalCollect payment method or any payment method other than valid credit card for your EverQuest account, you must provide SOE with a valid credit card upon your election to subscribe to this EverQuest 12-month Subscription Extension. This new EverQuest 12-month Subscription Extension will take effect immediately, and your credit card will be billed immediately, upon successful completion of the transaction. 
<P>All prepaid but unused amounts of time for your EverQuest account that is converted to this special 12-month EverQuest subscription extension will be, at the time SOE converts the account, converted to days at this special offer 12-month EverQuest subscription extension rate, and the subscription period for that account will be extended by the applicable number of days. Any account converted to this special offer12-month EverQuest Subscription Extension during any no-charge subscription period will be immediately converted, and the remainder of such period(s) will be waived. 
<P>SOE will charge your credit card the subscription amount upon successful completion of this transaction. To download the seven digital expansion products available as part of this special offer, please do the following: 
<OL>
<LI>Complete this transaction (Once purchase is complete, the account used for the purchase will be enabled for the seven expansion packs listed above). 
<LI>Launch EverQuest patcher/updater from your computer. 
<LI>After the update (patch) has run, click on the Advanced tab. 
<LI>Mark the check boxes for games you want to download (you will only be able to play the expansions described in this offer for each Station account used to purchase this 12-month EverQuest Subscription Extension) and click Save. 
<LI>Click the Download button (where Play button normally is). 
<LI>After download is complete, click Play button. Enjoy! </LI></OL>
<P>Your use of the EverQuest software under this 12-month EverQuest Subscription Extension and your game play remains strictly subject to the EverQuest User Agreement and Software License (and Rules of Conduct) and Sony Online Entertainment Terms of Service, as each may be amended or modified by SOE at any time in its sole discretion. 
<P>Rated T for Teen. Game experience may change during online play. System requirements subject to change as the game progresses. </P>
