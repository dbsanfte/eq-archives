	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/chat.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/chat.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/chat.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">EQ&nbsp;Chat</font></b></div>
                        <!-- #EndEditable --></td>
...
<table><tr>
 ...
 <form action="chat.jsp">
  Enter your screen name for the chat session
  <p>
  <input type="text" name="handle" size="10" maxlength="12">
...
<p align="center">
<table width="90%" border="1" cellspacing="0" cellpadding="2" bordercolorlight="
#003333" bordercolordark="#333333">
<tr bgcolor="#222222">
<td colspan=4><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color=
"#FFFFFF"><b><font size="2">Command List</font></b> (All commands begin with /)</font></td>
</td>
<tr>
<td width="50" bgcolor="#222222"><font size="1" face="Verdana, Arial, Helvetica,sans-serif" color="#FFFFFF"><b>/HELP</b></font></td>
<td><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FFFFFF">Display the list of commands available with examples.</font></td>
<td width="50" bgcolor="#222222"><font size="1" face="Verdana, Arial, Helvetica,sans-serif" color="#FFFFFF"><b>/ME</b></font></td>
<td><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FFFFFF">Performs an action on the channel.</font></td>
</tr>
<tr>
<td width="50" bgcolor="#222222"><font size="1" face="Verdana, Arial, Helvetica,sans-serif" color="#FFFFFF"><b>/MSG</b></font></td>
<td><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FFFFFF">Sends a private message to someone on the channel.</font></td>
<td width="50" bgcolor="#222222"><font size="1" face="Verdana, Arial, Helvetica,sans-serif" color="#FFFFFF"><b>/IGNORE</b></font></td>
<td><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FFFFFF">Toggle ignore/unignore of all messages from someone.</font></td>
</tr>
</table>
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
