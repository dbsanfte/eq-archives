	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/events/gencon_2002_application.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/events/gencon_2002_application.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/events/gencon_2002_application.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
...
<BR>
<DIV align=center>
<P><IMG src="http://eqlive.station.sony.com/images/gladiator_banner.jpg"></P></DIV><FONT size=6><FONT size=6>
<P align=center><STRONG>EverQuest Gladiator Championship</STRONG></P>
<P align=center><STRONG>Event Rule Sheet</STRONG></FONT><FONT size=2> <BR></FONT><FONT size=6><STRONG>Gen Con 2002</STRONG></P></FONT><FONT size=5>
<P align=center><STRONG>August 8</STRONG><SUP><STRONG>th -11th </STRONG></P></FONT><FONT size=4>
<P align=center></P></FONT>
<P align=center><FONT size=3><U>Thursday and Friday's Events<BR></U></FONT><FONT size=3>Single Elimination 1 vs. 1 competition for all Warriors of Norrath.<BR>Contestants WILL be given a PREGENERATED LEVEL 24 Character to battle with each other.<BR></FONT><FONT size=3>The Characters will be exactly the same, hence the trial of skill required for this competition.</FONT></P><FONT size=3>
<P><BR>Gladiator Competition is slated as a Warrior versus Warrior Event. Each contestant will continue to fight until they lose or reach 8 wins total. If they reach 8 wins, their information is entered into a drawing. 8 Gladiators will be chosen to compete in the final Championship bracket. </P>
<P>All Matches are Single Elimination 1 vs. 1 competition for all rounds but final round.<BR><BR>Dates: August 8th and August 9th Gen Con Game Fair, Milwaukee, WI<BR>Event Sign up will be at our SOE booth from 10am to 11am each morning.</P>
<P>Gladiator Championship Bracket The 8 Winners of the Gladiator Competition will fight to the death in the championship event, and the victor will receive the Title of " The Gladiator", a one year subscription to EverQuest, as well as a championship ring for their play character.</P>
<P><U>Saturday's Event</U></P>
<P>Gladiator's Team Event This event will be a limited signup only event. Sign up August 10th&nbsp; from 10am to 11am. Each team of 3 members will be given 3 characters from a choice of 8 Classes of Norrath. This will be a bracketed event of up to 32 teams facing off to the death, with the winning team advancing. Each character will be level 51 equipped with Epic Weapons.</P>
<P>The Classes for this event are as follows: </P>
<P>Warrior<BR>Ranger<BR>Rogue<BR>Necromancer<BR>Shadowknight<BR>Druid<BR>Shaman<BR>Wizard</P>
<P>Each team may chose one class from the classes offered but only one class may be represented per team. Each of the classes will be equal in level and inventory.</P>
<P><U>Sunday's Event</U></P>
<P>Last day of competition will be a series of open combat events with prizes to be determined.</P>
<P><U>Combatant Rules</U>&nbsp; <BR><BR>Both Characters once in position will be removed of all buffs, once debuffed, they shall be asked if they are ready for the match to start. <BR><BR>Upon confirmation, an explosion and a verbal command will start the start the match. <BR><BR>Both Characters shall stay on the tiled area at all times. Standing on or behind the firepots is disallowed. Standing on or in the throne is disallowed. <BR><BR>Any use of exploits or bugs will result in immediate disqualification from the event, and is a break in the rules of conduct as set forth on <A href="http://www.everquest.com/">www.everquest.com</A>.<BR><BR>Each match may have a time limit accessed.</FONT></SUP></FONT></P>
