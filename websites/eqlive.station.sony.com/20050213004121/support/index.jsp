                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
						...
						<P>You have entered the realm of Support. The paths below
  take you to the various areas of Support.</P>  <P><A HREF="http://help.station.sony.com/cgi-bin/soe.cfg/php/enduser/std_alp.php">Knowledge
  Base</A><BR>Your first stop for all your support needs.</P>  <P><A HREF="../../../../../support/customer_service.jsp">Customer Service</A><BR>Rules, policies and additional info to help you out.</P>  <P><A HREF="../../../../../support/tech_support.jsp">Tech Support</A><BR>Having technical problems? Find the help you need here.</P>  <P><A HREF="../../../../../support/accounts_billing.jsp">Accounts and Billing</A><BR>Help on managing your account.</P>  <P><A HREF="https://store.station.sony.com/eq_char_moves/">Character Transfer
  Service<BR></A>A fee-based service that allows you to transfer your character between
  servers and/or accounts.</P>  <P><A HREF="https://store.station.sony.com/eq_char_item_moves/">Character
  Transfer Service/All Items</A><BR>A fee-based service that allows you to tranfer your characters, with all
  items intact, between servers and/or accounts.</P>  <P><A HREF="https://store.station.sony.com/eq_char_renames/">Name Change
  Service<BR></A>Not happy with your character's name? This fee-based service allows you
  to change a character's first name.</P>  <P><A HREF="https://guide.everquest.com/guideapp/">EverQuest Guide
  Application</A><BR>Interested in becoming an EverQuest Guide?</P>
