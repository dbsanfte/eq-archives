...
<tr>
	...
	<a href="dev_view.jsp?id=64085" class="tinylink">Halfling Hodgepodge</a><br>
	
	<a href="dev_view.jsp?id=64084" class="tinylink">Depths of Darkhollow Launch and Custom UI&#8217;s</a><br>
  ...
  of Commons - Tonight!! (August 25, 2005)</a><br>
...
<P>Zajeer reveals he has plans to evaluate the point system
  for LDoN's and shares some other information on LDoN's such as who they are
  intended for.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=114057#M114057">LDoN
  Plans</A></P>  <P>Rashere shares the BiC Quest's history.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Veterans&amp;message.id=113971#M113971">BiC
  Quest</A></P>  <P>Do you have a story where you encountered an exceptionally
  funny bug?&nbsp; Community member
  Dark_Elf_Maurix has, he shares his story, come and share yours, even Absor has
  one.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=TNZ&amp;message.id=198530#M198530">Funny
  Bug Situations</A></P>  <P>A few week's ago we asked which race best suits your
  personality, now we want to know which class.&nbsp; Join us on the Just for Fun forum and
  tell us which class best describes your real life personality.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Fun&amp;message.id=3751">Ky's
  Chatter Box</A></P>  <P>Did you enjoy reading the stories submitted for the Fan
  Fiction contest?&nbsp; We did too so
  much so that we can't pick a winner so we need your help, we choose 3 of our
  favorites pick the one you like best.&nbsp;
  <A HREF="http://eqforums.station.sony.com/eq/poll_view?poll.id=2077&amp;action=cast_vote">Vote</A></P>  <P>Brenlo's Coffee Diaries return but in a new forum.&nbsp; Check out the details!&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=brenlo&amp;message.id=70">Brenlo's
  World</A></P>  <P>&nbsp;</P>
