	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/de/intro_view.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/guild_requests/de/intro_view.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Gilden&nbsp;Antragssystem</font></b></div>
                        <!-- #EndEditable --></td>
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <table width="160" border="0" cellspacing="0" cellpadding="5">
                          <tr> 
                            ...
                            <td><div align="center"><img src="../../images/flags/flag_de_current.gif" name="Image2" width="44" height="27" border="0" id="Image2"></div></td>
                          </tr>
                        </table>
                        <p>Willkommen beim Gilden-Bewerbungssystem von EverQuest.<br>
                          <br>
                          Auf dieser Seite können Sie Anträge für neue Gilden 
                          stellen, Ihre vorherigen, bestehenden Anträge ansehen 
                          und solche, die noch in Bearbeitung sind, stornieren.<br>
                          <br>
                          Klicken Sie <a href="/guild_requests/index.jsp?page=CREATE_REQUEST">hier</a> 
                          um einen Antrag auf Erstellung einer Gilde zu stellen.<br>
                          <br>
                          Klicken Sie <a href="/guild_requests/index.jsp?page=VIEW_REQUESTS">hier</a> 
                          um Ihre bestehenden Gilden-Anträge anzusehen.<br>
                          <br>
                          Vielen Dank, dass Sie sich für EverQuest entschieden 
                          haben! 
                          <!-- end page content -->
                        </p>
                        <!-- #EndEditable --></td>
