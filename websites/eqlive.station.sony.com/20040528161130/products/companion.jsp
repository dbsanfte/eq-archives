...
<title>EverQuestLive.com - EverQuest Companion</title>
...
<body bgcolor="#000000" background="../images/rock_bg.jpg" text="#CCCCCC" link="#FFFFCC" vlink="#FFFFCC" alink="#FFFFCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../images/companion/top_buynow_on.jpg','../images/companion/bottom_buynow_on.jpg')" onresize="handleResize();" >
<!-- begin global nav -->
	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/products/companion.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/products/companion.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/products/companion.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">EverQuest&nbsp;Companion </font></b></div>
                        <!-- #EndEditable --></td>
                    ...
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <table width="557" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="557"><img src="../images/companion/top.jpg"></td>
                          </tr>
                          <tr> 
                            <td><table width="557" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="1"><img src="../images/companion/top_mid.jpg"></td>
                                  <td><a href="https://store.station.sony.com/shopping_cart.jsp?mode=addItem&sku=EQ1RE-HG-BK1003-INSDST" onMouseOver="MM_swapImage('Image1','','../images/companion/top_buynow_on.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="../images/companion/top_buynow.jpg" alt="Buy Now!" name="Image1" border="0" id="Image1"></a></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td height="75" valign="top">
<div style="padding: 0px 10px 0px 12px; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 10px;"> 
                                If you're an aspiring game developer or a major 
                                EQ fan-atic, Robert B. Marks' book, &quot;EverQuest 
                                Companion&quot;, will satisfy your every curiosity. 
                                It's a great in-depth inside look at the world 
                                of massively multiplayer online game creators 
                                and an examination of the creative process, using 
                                5 EverQuest as the industry model. Every page 
                                in this glossy beautiful book offers content from 
                                rich game graphics to conceptual art to in-game 
                                screenshots to developers' schematics.</div></td>
                          </tr>
                          <tr> 
                            <td><img src="../images/companion/chap2_top.jpg" width="557" height="33" border="0" usemap="#Map2"></td>
                          </tr>
                          <tr> 
                            <td><table width="557" height="73" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="1" height="73" valign="top"><img src="../images/companion/chap2_left.jpg" alt="Click here for large image" width="102" height="73" border="0" usemap="#Map3"></td>
                                  <td valign="top"> 
                                    <div style="padding: 4px 5px 0px 12px; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 10px;"><span style="font-weight: bold; color: FEC049; font-size: 11px;">CHAPTER 
                                      2: THE FOUNDING OF A GAME GENRE</span><br>
                                      This chapter explores the roots of the fantasy 
                                      game genre in fiction from Horace Walpole's 
                                      &quot;Castle of Otranto&quot; to Robert 
                                      E. Howard's Conan the Barbarian novels. 
                                      It further discusses the early days of the 
                                      Internet and the first online games from 
                                  Spacewar! to Zork to MUD1. </div></td>
                                  <td width="1" valign="top"><img src="../images/companion/right_edge1.jpg" width="21" height="73"></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td><img src="../images/companion/chap2_3_strip.jpg" width="557" height="38" border="0" usemap="#Map"></td>
                          </tr>
                          <tr> 
                            <td><table width="557" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="1"><img src="../images/companion/left_edge.jpg" width="34" height="73"></td>
                                  <td valign="top">
<div style="padding: 16px 5px 0px 40px; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 10px;"> 
                                      <div align="right"><span style="font-weight: bold; color: FEC049; font-size: 11px;">CHAPTER 
                                        3: THE ROAD TO EVERQUEST</span><br>
                                        This chapter tells the story of the development 
                                        and evolution of EverQuest through the 
                                        eyes of its creators.</div>
                                  </div></td>
                                  <td width="1"><img src="../images/companion/chap3_right.jpg" alt="Click here for large image" width="123" height="73" border="0" usemap="#Map5"></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td><img src="../images/companion/chap3_4_strip.jpg" width="557" height="36" border="0" usemap="#Map4"></td>
                          </tr>
                          <tr> 
                            <td><table width="557" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="1"><img src="../images/companion/chap4_left.jpg" alt="Click here for large image" width="102" height="74" border="0" usemap="#Map7"></td>
                                  <td valign="top">
<div style="padding: 16px 5px 0px 14px; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 10px;"><span style="font-weight: bold; color: FEC049; font-size: 11px;">CHAPTER 
                                      4: DISSECTING THE MMORPG: EVERQUEST'S DESIGN 
                                      ROOTS</span><br>
                                      This chapter discusses in depth the craft 
                                      and art involved in designing a massively 
                                  multiplayer online game.</div></td>
                                  <td width="1"><img src="../images/companion/right_edge2.jpg" width="19" height="74"></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td><img src="../images/companion/chap4_5_strip.jpg" width="557" height="37" border="0" usemap="#Map6"></td>
                          </tr>
                          <tr> 
                            <td><table width="557" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="1" height="74"><img src="../images/companion/left_edge.jpg" width="34" height="73"></td>
                                  <td valign="top">
<div style="padding: 3px 5px 0px 30px; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 10px;"> 
                                      <div align="right"><span style="font-weight: bold; color: FEC049; font-size: 11px;">CHAPTER 
                                        5: GOLD, ZONES, QUESTS, AND MONSTERS:<br>
                                        TOURING THE DESIGN OF THE GAME WORLD</span><br>
                                        This chapter delves even deeper into the 
                                        game design process, showing designer 
                                        schematics quest pitches, artist conceptual 
                                        zone maps concept character drawings, 
                                        etc</div>
                                  </div></td>
                                  <td width="1"><img src="../images/companion/chap5_right.jpg" alt="Click here for large image" width="123" height="74" border="0" usemap="#Map8"></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
                            <td><img src="../images/companion/chap5_8_strip.jpg" width="557" height="37" border="0" usemap="#Map9"></td>
                          </tr>
                          <tr> 
                            <td><table width="557" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="1"><img src="../images/companion/chap8_left.jpg" alt="Click here for large image" width="102" height="73" border="0" usemap="#Map10"></td>
                                  <td valign="top"> 
                                    <div style="padding: 9px 5px 0px 14px; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 10px;"><span style="font-weight: bold; color: FEC049; font-size: 11px;">CHAPTER 8: ZONING OUTSIDE THE PC</span><br>
                                      This chapter reveals the creative process 
                                      behind other Norrath-based games developed 
                                      for platforms other than the PC, such as 
                                      the PlayStation 2, wireless phone games, 
                                      and classic tabletop RPGs. </div></td>
                                  <td width="1"><img src="../images/companion/right_edge.jpg" width="18" height="73"></td>
                                </tr>
                              </table>
                              </td>
                          </tr>
                          ...
                          <tr> 
                            <td><img src="../images/companion/chap8_strip.jpg" width="557" height="31" border="0" usemap="#Map11"></td>
                          </tr>
                          <tr> 
                            <td> <p align="center" style="padding: 20px 35px 0px 45px; color: FEC049; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-style: italic;">Published 
                                by McGraw-Hill, EverQuest Companion: The Inside 
                                Lore of a Gameworld by Robert Marks is a full-color 
                                352-page book with 150 illustrations and 50 photos. 
                              </p>
                              <p align="center" style="color: white; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold;">It's 
                                available at the Station Store for $19.99.</p>
                              <p align="center"><a href="https://store.station.sony.com/shopping_cart.jsp?mode=addItem&sku=EQ1RE-HG-BK1003-INSDST" onMouseOver="MM_swapImage('Image2','','../images/companion/bottom_buynow_on.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="../images/companion/bottom_buynow.jpg" alt="Buy Now!" name="Image2" width="168" height="62" border="0" id="Image2"></a></p>
                              <p>&nbsp;</p></td>
                          </tr>
                        </table>
						<map name="Map">
                          <area shape="poly" coords="101,16,16,24,13,0,100,0" href="http://eqlive.station.sony.com/images/EQbook5.jpg" target="_blank">
                                
                          <area shape="poly" coords="445,14,530,20,528,38,444,38" href="http://eqlive.station.sony.com/images/eqbook6.jpg" target="_blank">
                          <area shape="rect" coords="113,6,197,18" href="http://eqlive.station.sony.com/images/EQbook5.jpg" target="_blank" alt="Click for Larger Image">
                        </map>
						<map name="Map2">
                          <area shape="poly" coords="7,16,93,10,94,33,8,33" href="http://eqlive.station.sony.com/images/EQbook5.jpg" target="_blank">
                                <area shape="poly" coords="105,18" href="#">
                        </map>
							  
                        <map name="Map3">
                          <area shape="poly" coords="9,0,94,0,99,73,14,73" href="http://eqlive.station.sony.com/images/EQbook5.jpg" target="_blank">
                        </map>
						<map name="Map4">
                          <area shape="poly" coords="438,16,437,0,524,0,522,21" href="http://eqlive.station.sony.com/images/eqbook6.jpg" target="_blank">
                                
                          <area shape="poly" coords="90,10,95,36,4,36,3,14" href="http://eqlive.station.sony.com/images/EQbook4.jpg" target="_blank">
                          <area shape="rect" coords="345,5,431,18" href="http://eqlive.station.sony.com/images/eqbook6.jpg" target="_blank" alt="Click for Larger Image">
                        </map>
						<map name="Map5">
                          <area shape="poly" coords="94,0,89,73,3,73,9,0" href="http://eqlive.station.sony.com/images/eqbook6.jpg" target="_blank">
                        </map>
						<map name="Map6">
                          <area shape="poly" coords="11,23,9,0,100,0,101,17" href="http://eqlive.station.sony.com/images/EQbook4.jpg" target="_blank">
                                
                          <area shape="poly" coords="450,9,536,17,533,37,447,37" href="http://eqlive.station.sony.com/images/EQbook2.jpg" target="_blank">
                          <area shape="rect" coords="115,5,200,18" href="http://eqlive.station.sony.com/images/EQbook4.jpg" target="_blank" alt="Click for Larger Image">
                        </map>
						<map name="Map7">
                          <area shape="poly" coords="4,-1,9,73,100,73,94,-1" href="http://eqlive.station.sony.com/images/EQbook4.jpg" target="_blank">
                        </map>
						<map name="Map8">
                          <area shape="poly" coords="13,0,101,0,93,74,7,74" href="http://eqlive.station.sony.com/images/EQbook2.jpg" target="_blank">
                        </map>
                        <map name="Map11">
                          <area shape="poly" coords="9,24,8,0,101,0,101,20" href="http://eqlive.station.sony.com/images/EQbook.jpg" target="_blank">
                          <area shape="rect" coords="114,4,198,16" href="http://eqlive.station.sony.com/images/EQbook.jpg" target="_blank">
                        </map>
						<map name="Map9">
                          <area shape="poly" coords="441,13,526,20,529,0,442,0" href="http://eqlive.station.sony.com/images/EQbook2.jpg" target="_blank" alt="Click for Larger Image">
                                
                          <area shape="poly" coords="4,22,95,15,98,37,6,37" href="http://eqlive.station.sony.com/images/EQbook.jpg" target="_blank">
                          <area shape="rect" coords="344,4,430,16" href="http://eqlive.station.sony.com/images/EQbook2.jpg" target="_blank" alt="Click for Larger Image">
                        </map>
						<map name="Map10">
                                      
                          <area shape="poly" coords="5,0,96,0,100,73,9,73" href="http://eqlive.station.sony.com/images/EQbook.jpg" target="_blank">
                                    </map>	  									
