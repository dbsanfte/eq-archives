...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">68,986 Players Online</div>
...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="318,18,389,36" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing.jsp?null');">
  <!-- Join free  --><area shape="rect" coords="393,19,471,35" href="javascript:gnav_call('https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/support/accounts_billing.jsp');">
...
<P>Accounts and Billing provide comprehensive online customer account service features pertaining to registered EverQuest players. Please contact us if you would like to modify your user account information, have questions about your billing, or all other specific concerns about your account.</P>
<P><A href="/rates/index.jsp"><SPAN class=header>EverQuest's Price Increase</SPAN></A><BR>An overview of the EQ subscription rate change, with information on billing as well as 12-month and 24-month subscription plans.</P>
<P><A href="http://eqlive.station.sony.com/rates/rate_faq.jsp"><SPAN class=header>EverQuest's Price Increase FAQ</SPAN></A><BR>The EQ subscription rate change took effect on April 25, 2002. Find out more about it. </P>
<P><A href="/support/accounts_billing/ab_create_activate_account.jsp">Creating An Account</A><BR>A simple step-by-step guide to setting up your own EverQuest account. </P>
...
<P><A href="/support/accounts_billing/ab_pricing.jsp"><SPAN class=header>Pricing Plans</SPAN></A><BR>Find out about all EverQuest pricing plan options. </P>
...
<P><SPAN class=header><SPAN class=header><SPAN class=header><A href="/support/accounts_billing/ab_cancel.jsp">Canceling an EverQuest Account</A><BR>We'll hate to lose you, but here is where you can learn how to cancel your account.</SPAN></SPAN></SPAN>&nbsp;</P>
