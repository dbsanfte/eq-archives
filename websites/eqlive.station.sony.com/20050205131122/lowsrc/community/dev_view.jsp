...
<a href="dev_view.jsp?id=&start=5">Older</a>
		...
		<a href="dev_view.jsp?id=64017">Yet another Halfling Hodgepodge </a><br>
	

	
		<a href="dev_view.jsp?id=64016">Welcome to Zek </a><br>
	

	
		<a href="dev_view.jsp?id=64015">Farewell Fuzzbal</a><br>
	

	
		<a href="dev_view.jsp?id=64013">Halfling Hodgepodge</a><br>
	

	
		<a href="dev_view.jsp?id=64014">EQ Stratics HoC Dev Chat Tonight!</a><br>
...
<h1>Yet another Halfling Hodgepodge </h1>
	<P>The Zek servers unite!!!&nbsp; The
  plans to merge the PvP servers have been posted.&nbsp; Join in the discussion
  with your fellow community members and give us your feedback on this exciting
  change.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=PVP&amp;message.id=9202">Zek
  Server</A></P>  <P>Share your romantic EverQuest
  story with the EQ Community.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Fun&amp;message.id=1154">EQ
  Romance</A> </P>  <P>Last week's edition featured never
  ending Trivia, join in the fun!!&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=Fun&amp;message.id=1063">Trivia</A></P>  <P>Have you been to Lavastorm
  lately?&nbsp; This zone has received a make over, check out what your fellow
  community members are saying about the changes, and join in the
  discussion.&nbsp; <A HREF="http://eqforums.station.sony.com/eq/board/message?board.id=TNZ&amp;message.id=150328">Lavastorm</A></P>  <P>Remember that you can join your
  fellow EQ community members in these and other discussions anytime you wish
  by visiting the <A HREF="http://eqforums.station.sony.com/eq">EverQuest
  forums</A></P>  <P>&nbsp;</P>
