...
function wow(totalSize, log_ver) {
	...
	if (!isCookie) {
		...
		bw = Math.round( totalSize / elapsedTime );
		var littleImage = new Image();
		littleImage.src= '/common/detector/98734hdlfjbas86d523jh.jsp?flashVer=' + flashVer + '&browser=' + browser + '&os=' + os + '&bw=' + bw + '&log_ver=' + log_ver + '&colors=' + colors + '&screen_res=' + screen_res + '&js=' + js;
