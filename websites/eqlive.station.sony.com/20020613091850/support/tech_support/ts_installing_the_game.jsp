...
<map name="Map"> 
  <!-- Sign in    --><area shape="rect" coords="88,46,149,62" href="javascript:gnav_call('https://login.station.sony.com/login/station/login.jsp?returnURL=http://eqlive.station.sony.com/support/tech_support/ts_installing_the_game.jsp?null');">
...
<P>&nbsp;</P>
<P><FONT face="Arial, Helvetica, sans-serif" size=2>If you are still having problems after visiting this support section, you can contact our Technical Support Department via email using our <A href="/support/tech_support/ts_contact_tech_support.jsp">online form</A>.</FONT></P>
