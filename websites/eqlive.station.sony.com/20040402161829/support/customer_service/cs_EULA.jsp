...
<P>Please remember to review the current terms and conditions of the EverQuest User Agreement and Software License. </P>
<P>Thank you. EVERQUEST&reg; USER AGREEMENT AND SOFTWARE LICENSE THIS AGREEMENT DESCRIBES THE TERMS ON WHICH SONY ONLINE ENTERTAINMENT INC. ("<STRONG>SOE</STRONG>") OFFERS YOU ACCESS TO AN ACCOUNT (THE "<STRONG>ACCOUNT</STRONG>") TO PLAY THE EVERQUEST FANTASY ONLINE ROLE PLAYING COMPUTER GAME AND ANY EXPANSION PACKS (INDIVIDUALLY AND COLLECTIVELY, THE "<STRONG>GAME</STRONG>"). BY PRESSING THE "I ACCEPT" BUTTON, YOU ACCEPT THE TERMS AND CONDITIONS BELOW. BY PRESSING THE "DECLINE" BUTTON, YOU DECLINE OUR OFFER, IN WHICH CASE YOU SHOULD CONTACT YOUR PLACE OF PURCHASE REGARDING ITS RETURN POLICY FOR THE APPLICABLE PRODUCT. If you have any questions regarding these terms and conditions, please contact customer service at <A href="mailto:eqmail@soe.sony.com">eqmail@soe.sony.com</A>. </P>
...
<P>2. To play the Game, you must (a) purchase or receive through an SOE-authorized promotional offer (such as an authentic disc bundled with a game magazine) the Game CD-ROM (the "<STRONG>CD-ROM</STRONG>") or applicable files which we may make available for direct download, which includes software required for the Game (the "<STRONG>Software</STRONG>"), (b) have a fully paid Account, and (c) have an Internet connection (which we do not provide) to access your Account. In addition to any fees described herein, you are responsible for paying all applicable taxes (including those we are not required to collect) and for all hardware, software, service and other costs you incur to access your Account. Neither this Agreement nor your Account entitles you to any subsequent releases of the Software, nor to any expansion packs or similar ancillary products, without paying applicable charges. You understand that we may update or otherwise enhance the Software at any time and in doing so incur no obligation to furnish such updates to you pursuant to this Agreement. </P>
...
<P>Parental control protections (such as computer hardware, software, or filtering services) are commercially available that may assist you in limiting access to material that is harmful to minors. If you are interested in learning about these protections, information is available at http://www.worldvillage.com/wv/school/html/control.htm or other similar sites providing information on such protections. </P>
<P>The Software is a "commercial item" if acquired under agreement with the U.S. Government or any contractor therewith in accordance with 48 CFR 12.212 of the FAR and, if acquired for Department of Defense (DoD) units, 48 CFR 227-7202 of the DoD FAR Supplement, or any succeeding similar regulations. </P>
