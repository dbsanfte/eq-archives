...
<P ALIGN="center"><STRONG><BR><STRONG>Contact Us</STRONG></STRONG></P>  <P>Customer
  Service Related Contacts:</P>  <P><A HREF="mailto:eqmail@soe.sony.com">eqmail@soe.sony.com</A><BR>This is the big dog of the contact addresses. This is the place to send
  ...
  help possible.</P>  <P>Design/Testing
  Contacts:</P>  <P><A HREF="mailto:eqfeedback@soe.sony.com">eqfeedback@soe.sony.com</A><BR>Have suggestions for the game? Think something can be done better? Send an
  ...
  publication on the EverQuest site. The news items accepted here are general
  news/announcements, in-game events, guild events, etc. The EverQuest.com
  Editor reserves the right to determine what news items will be posted and
  where. Another function of this address is to notify the EQ Webmaster of
  possible problems with the site so that they can be checked out.</P>  <P><A HREF="mailto:eqmoderator@soe.sony.com">eqmoderator@soe.sony.com</A><BR>This address is used to alert the EverQuest message boards moderator of posts
  ...
  general and game related discussions. The <A HREF="mailto:eqmoderator@soe.sony.com">eqmoderator@soe.sony.com</A> address
  only deals with the out of character general discussion boards.&nbsp; </P>  <P><BR>Fan Faire Contacts</P>  <P><A HREF="mailto:fanfaire@soe.sony.com">fanfaire@soe.sony.com</A><BR>This is the address to use if you have any Fan Faire related questions.</P>  <P>More ways to
  contact us than you thought? One of the complaints we hear at times from some
  players who email us with a concern is how long it took us to respond. When
  this happens, and it is not really that often, it is usually because the
  email was originally sent to the wrong address and may have been buried in the
  recipients in-box until he or she found it and forwarded it to the right
  department or person. By using the list above, and sending emails to the
  correct addresses, the chances of a slow response are greatly reduced.</P>
