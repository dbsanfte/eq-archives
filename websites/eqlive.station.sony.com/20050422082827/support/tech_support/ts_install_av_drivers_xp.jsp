...
<P><STRONG>Updating your Video and/or Sound Drivers in Windows 2000 and
  Windows XP</STRONG></P>  <P>To update your Video/Sound card drivers, first and most importantly, you
  need to find out what Video or Sound card you have in your system. There are
  two easy ways to do this:</P>  <P>1. Via DXDIAG</P>  <UL>   <LI>Click Start</LI>   <LI>Click Run</LI>   <LI>Type in the word
       DXDIAG:</LI>   <LI>You will see a
       screen similar to the one below:</LI>   <LI>There are two tabs
       ...
       (located under the Drivers area on the right side).</LI>  </UL>  <P>Here you see that the video card listed is a NVIDIA GeForce FX 5900 Ultra
  (as listed under the Device area), and that the sound card is listed as a SB Audigy.</P>  <P>2. Via Device Manager</P>  <UL>   <LI>Right click on your
       My Computer icon, click on Properties, click on the Hardware Tab, then
       click the Device Manager button</LI>   <LI>You will see a
       ...
       telling you exactly which sound and video card you have.</LI>   <LI>By double clicking
       on each piece of hardware, you can get more information, such as driver
       information.</LI>  </UL>  <P>So, now you know what video and sound card you're running. Now you need to
  go to our Audio (<A HREF="../../../../../support/tech_support/ts_audio.jsp">http://eqlive.station.sony.com/support/tech_support/ts_audio.jsp</A>)
  or Video (<A HREF="../../../../../support/tech_support/ts_video.jsp">http://eqlive.station.sony.com/support/tech_support/ts_video.jsp</A>)
  support pages to download the latest supported drivers for EverQuest.</P>  <P>1. Find the card that is closest to what your card describes itself as and
  under which Operating System, and click on that file to download.</P>  <P>2. Select to SAVE the file and choose a location you are comfortable with
  and that is easy to find.</P>  <P>3. Most of the drivers provided by the manufacturers are self extracting
  executables, meaning you can just double click on them and run them, so you
  shouldn't need an external program to get at the files you need.</P>  <P><STRONG>***Before installing new Video drivers, regardless of Make,
  ...
  uninstall them (just click on the driver and click the Change/Remove button)</STRONG></P>  <P><STRONG>When the uninstall is complete, reboot your computer and then
  continue with these instructions.</STRONG></P>  <P>4. Go to the location you saved your driver file at, and double click on
  the file that you saved. This should start the installation process. If you
  get a window that looks like this: then extract the files to an easy to find
  folder, and continue with the instructions.</P>  <P><BR><BR><IMG BORDER="0" SRC="http://eqlive.station.sony.com/support/tech_support/images/driverinstall12.jpg"><BR><BR></P>  <P>5. Most current ATi and nVidia driver files will do most of the work for
  you, and just double clicking that file you downloaded will be enough. Some
  other manufacturers require another step. In Step 4, we talked about an
  alternative to what double clicking the file you downloaded looks like. If it
  looks like the above picture, then you should go to the directory you
  extracted these files to, and look for the file SETUP.EXE. Double clicking on
  this file will begin the driver installation.</P>  <P>6. You may encounter a screen that looks similar to this: This is simply
  stating that the driver you are installing has not completed Windows Hardware
  Quality Labs Certification. This is ok,and clicking Continue Anyway will
  allow you to continue with your installation.</P>  <P><BR><BR><IMG BORDER="0" SRC="http://eqlive.station.sony.com/support/tech_support/images/driverinstall13.jpg"><BR><BR></P>  <P>7. Once the installation is complete, you should be prompted to reboot your
  computer. Do so and when you're done, your computer should be updated with
  the drivers you just installed on your system.</P>  <P>If, after following these instructions, you still have issues, you can
  contact our Tech Support department via email, phone, or Live Chat.</P>
