...
<tr>
	...
	<a href="upcoming_updates.jsp?id=64010" class="tinylink">Upcoming for April</a><br>
	
	<a href="upcoming_updates.jsp?id=62854" class="tinylink">Upcoming for August 2004</a><br>
...
<h1>Upcoming for April</h1>
<P>We
  have an update tentatively scheduled for the 6<SUP>th</SUP> of April.&nbsp; We expect some of the first class
  reenvisioning changes to go live with this update.</P>  <P>At
  character select, you will see a new button &quot;Go Home&quot; Which will
  move your character to its home city if it has not logged in for the previous
  6 hours.</P>  <P>Characters
  will now log in with full health and mana after having been logged out for
  more than 1 hour.</P>  <P>Stay
  tuned for more details.</P>  <P>Brenlo
  the Updated</P>
