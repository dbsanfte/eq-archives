	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/dev_feedback.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/community/dev_feedback.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/community/dev_feedback.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Developer's&nbsp;Corner&nbsp;Comment&nbsp;Form</font></b></div>
                        <!-- #EndEditable --></td>
...
<P>Posting or sending a message on this form is subject to the <A href="http://eqlive.station.sony.com/support/customer_service/cs_rules_of_conduct.jsp">EverQuest Rules of Conduct</A> and <A href="http://www2.station.sony.com/en/termsofservice.jsp">The Station Terms of Service</A>. You acknowledge that any comments or messages submitted to Sony Online Entertainment and/or Verant Interactive are public and not private communications and may be accessible by the general public. 
<P>Before you send us your comment, please read over the following paragraphs.</P>
<P>If you have changed your ISP since starting EverQuest, please <A href="http://www.station.sony.com/services/meminfo-signin.jhtml">click here</A> to update any information that has changed, such as your email address. Also please limit each comment to one subject per comment sent in. This aids us in the organization of the information submitted to us. </P>
<P>To let us know of any bugs you believe you have found in quests or in the game in general, please <A href="http://eqlive.station.sony.com/community/dev_feedback.jsp">click here</A> to submit a comment to our Quality Assurance forum. </P>
<P>If you are experiencing technical difficulties with the running of EverQuest on your computer, please <A href="http://boards.station.sony.com/ubb/everquest/cgi-bin/forumdisplay.cgi?action=topics&amp;forum=Technical+Help&amp;number=3&amp;DaysPrune=20&amp;LastLogin=">go here</A> and post the details of your problem in our Technical Help forum. Please use the search feature and see if there are existing threads related to your issue and, if you can't find a solution reading them, post your information in those threads. Also, please read over the forum explanation and look at a few examples to see what information we need and what format is preferred before posting information gathered using DXDiag and other diagnostic files. </P>
<P>Thanks in advance for your cooperation. <BR></P>


                       
<p style="color: red;">You must be a logged in EverQuest subscriber to use this form. Please log in via the navigation bar at the top of this page.</p>
		
						<script language="JavaScript">
var menu=new Array();
menu["Pick a category...."]=new Array();
menu["Pick a category...."][0]=new Option("No sub-category","No sub-category");


	menu["Class Related Issues"]=new Array();
menu["Class Related Issues"][0]=new Option("Beastlord","Beastlord");
	

	
menu["Class Related Issues"][1]=new Option("Shaman","Shaman");
	

	
menu["Class Related Issues"][2]=new Option("Enchanter","Enchanter");
	

	
menu["Class Related Issues"][3]=new Option("Necromancer","Necromancer");
	

	
menu["Class Related Issues"][4]=new Option("General","General");
	

	
menu["Class Related Issues"][5]=new Option("Monk","Monk");
	

	
menu["Class Related Issues"][6]=new Option("Paladin","Paladin");
	

	
menu["Class Related Issues"][7]=new Option("Wizard","Wizard");
	

	
menu["Class Related Issues"][8]=new Option("Cleric","Cleric");
	

	
menu["Class Related Issues"][9]=new Option("Warrior","Warrior");
	

	
menu["Class Related Issues"][10]=new Option("Rogue","Rogue");
	

	
menu["Class Related Issues"][11]=new Option("Bard","Bard");
	

	
menu["Class Related Issues"][12]=new Option("Druid","Druid");
	

	
menu["Class Related Issues"][13]=new Option("Magician","Magician");
	

	
menu["Class Related Issues"][14]=new Option("Ranger","Ranger");
	

	
menu["Class Related Issues"][15]=new Option("Shadowknight","Shadowknight");
	

	menu["Combat Related Issues"]=new Array();
menu["Combat Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Content Related Issues"]=new Array();
menu["Content Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Experience Related Issues"]=new Array();
menu["Experience Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Faction Related Issues"]=new Array();
menu["Faction Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Graphic Related Issues"]=new Array();
menu["Graphic Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Guild Related Issues"]=new Array();
menu["Guild Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Item Related Issues"]=new Array();
menu["Item Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Other Topic"]=new Array();
menu["Other Topic"][0]=new Option("No sub-category","No sub-category");
	

	menu["PvP Related Issues"]=new Array();
menu["PvP Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Quest Related Issues"]=new Array();
menu["Quest Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Race Related Issues"]=new Array();
menu["Race Related Issues"][0]=new Option("Vah Shir","Vah Shir");
	

	
menu["Race Related Issues"][1]=new Option("Iksar","Iksar");
	

	
menu["Race Related Issues"][2]=new Option("High Elf","High Elf");
	

	
menu["Race Related Issues"][3]=new Option("Gnome","Gnome");
	

	
menu["Race Related Issues"][4]=new Option("Barbarian","Barbarian");
	

	
menu["Race Related Issues"][5]=new Option("Erudite","Erudite");
	

	
menu["Race Related Issues"][6]=new Option("General","General");
	

	
menu["Race Related Issues"][7]=new Option("Troll","Troll");
	

	
menu["Race Related Issues"][8]=new Option("Dark Elf","Dark Elf");
	

	
menu["Race Related Issues"][9]=new Option("Wood Elf","Wood Elf");
	

	
menu["Race Related Issues"][10]=new Option("Froglok","Froglok");
	

	
menu["Race Related Issues"][11]=new Option("Ogre","Ogre");
	

	
menu["Race Related Issues"][12]=new Option("Human","Human");
	

	
menu["Race Related Issues"][13]=new Option("Halfling","Halfling");
	

	
menu["Race Related Issues"][14]=new Option("Half Elf","Half Elf");
	

	
menu["Race Related Issues"][15]=new Option("Dwarf","Dwarf");
	

	menu["Skill Related Issues"]=new Array();
menu["Skill Related Issues"][0]=new Option("Tracking","Tracking");
	

	
menu["Skill Related Issues"][1]=new Option("Swimming","Swimming");
	

	
menu["Skill Related Issues"][2]=new Option("Mend","Mend");
	

	
menu["Skill Related Issues"][3]=new Option("Forage","Forage");
	

	
menu["Skill Related Issues"][4]=new Option("Hide","Hide");
	

	
menu["Skill Related Issues"][5]=new Option("Pick Pocketing","Pick Pocketing");
	

	
menu["Skill Related Issues"][6]=new Option("Sneak","Sneak");
	

	
menu["Skill Related Issues"][7]=new Option("Alcohol Tolerance","Alcohol Tolerance");
	

	
menu["Skill Related Issues"][8]=new Option("General","General");
	

	
menu["Skill Related Issues"][9]=new Option("Begging","Begging");
	

	
menu["Skill Related Issues"][10]=new Option("Pick Locks","Pick Locks");
	

	
menu["Skill Related Issues"][11]=new Option("Fishing","Fishing");
	

	
menu["Skill Related Issues"][12]=new Option("Language","Language");
	

	menu["Sound Related Issues"]=new Array();
menu["Sound Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Spell Related Issues"]=new Array();
menu["Spell Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Trade Skill Related Issues"]=new Array();
menu["Trade Skill Related Issues"][0]=new Option("General","General");
	

	
menu["Trade Skill Related Issues"][1]=new Option("Tinkering","Tinkering");
	

	
menu["Trade Skill Related Issues"][2]=new Option("Smithing","Smithing");
	

	
menu["Trade Skill Related Issues"][3]=new Option("Alchemy","Alchemy");
	

	
menu["Trade Skill Related Issues"][4]=new Option("Poison Making","Poison Making");
	

	
menu["Trade Skill Related Issues"][5]=new Option("Jewelcraft","Jewelcraft");
	

	
menu["Trade Skill Related Issues"][6]=new Option("Brewing","Brewing");
	

	
menu["Trade Skill Related Issues"][7]=new Option("Fletching","Fletching");
	

	
menu["Trade Skill Related Issues"][8]=new Option("Tailoring","Tailoring");
	

	
menu["Trade Skill Related Issues"][9]=new Option("Baking","Baking");
	

	menu["Travel Related Issues"]=new Array();
menu["Travel Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["User Interface Related Issues"]=new Array();
menu["User Interface Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Web Page or Message Board Related Issues"]=new Array();
menu["Web Page or Message Board Related Issues"][0]=new Option("No sub-category","No sub-category");
	

	menu["Zone Related Issues"]=new Array();
menu["Zone Related Issues"][0]=new Option("No sub-category","No sub-category");
	



var descriptions=new Array();
descriptions["Pick a category...."]="";

descriptions["Class Related Issues"]="<b>Class Related Issues:</b> Suggestions for class abilities, equipment, spells are acceptable in this category."; 

descriptions["Combat Related Issues"]="<b>Combat Related Issues:</b> Combat related issues include resistances of spells, melee damage, spell damage, aggro range, or any other factors regarding combat. Comments about PvE (player vs. environment) should be sent in using this topic. PvP (player vs. player) suggestions or comments should be sent in using PvP as the subject."; 

descriptions["Content Related Issues"]="<b>Content Related Issues:</b> Please choose this as a category if you are submitting ideas about the history or lore of EverQuest."; 

descriptions["Experience Related Issues"]="<b>Experience Related Issues:</b> Any experience related issues such as multi-group experience on raids, hell levels, etc. can be posted here."; 

descriptions["Faction Related Issues"]="<b>Faction Related Issues:</b> Suggestions or comments on our faction system are wanted here. Faction issues that do not allow continuity for questing, as well as faction inconsistencies in terms of role playing can be sent to us here."; 

descriptions["Graphic Related Issues"]="<b>Graphic Related Issues:</b> Suggestions for improvements to existing graphics are welcome here. Submit issues regarding the improper functioning of your hardware to our Quality Assurance forum."; 

descriptions["Guild Related Issues"]="<b>Guild Related Issues:</b> Feel free to send us suggestions regarding anything related to guild operations or communications here."; 

descriptions["Item Related Issues"]="<b>Item Related Issues:</b> Feel free to send us suggestions regarding anything related to Items here."; 

descriptions["Other Topic"]="<b>Other Topic:</b> Other issue not listed above."; 

descriptions["PvP Related Issues"]="<b>PvP Related Issues:</b> Suggestions or comments regarding Player versus Player combat and other matters should go here. Please post any Sullon Zek issues under the Sullon Zek topic, not under this topic."; 

descriptions["Quest Related Issues"]="<b>Quest Related Issues:</b> Comments sent under this subject should include suggestions and feedback regarding any quest that is in game currently, including epic weapon quests."; 

descriptions["Race Related Issues"]="<b>Race Related Issues:</b> Race related examples would include Hide and Sneak for halflings, Ultravision for dark elves. Feel free to send us suggestions regarding Barbarians, Dark Elves, Dwarves, Erudites, Gnomes, Half Elves, Halflings, High Elves, Humans, Iksar, Ogres, Trolls, Vah Shir and Wood Elves."; 

descriptions["Server Related Issues"]="<b>Server Related Issues:</b> Please post any server related comments or suggestions here."; 

descriptions["Skill Related Issues"]="<b>Skill Related Issues:</b> Any suggestions or comments on any skills that are not trade related are wanted here."; 

descriptions["Sound Related Issues"]="<b>Sound Related Issues:</b> Suggestions or comments on any existing sound events, music, performance, are welcome here. Sound problems that seem to be bugs should be directed to our Quality Assurance forum. If you think it might be a hardware problem, you should post your information to our Technical Support forum."; 

descriptions["Spell Related Issues"]="<b>Spell Related Issues:</b> All sorts of spell issues should be sent under this topic, including spell stacking issues, spell levels, spell effects, and any other spell related subjects."; 

descriptions["Trade Skill Related Issues"]="<b>Trade Skill Related Issues:</b> Any trade skill suggestions or irregularities are welcome to be posted here."; 

descriptions["Travel Related Issues"]="<b>Travel Related Issues:</b> Comments on travel related issues are to be sent in here, such as boats, running speeds and similar issues. Issues about magical travel should be sent in under the topic of 'spell related issues'."; 

descriptions["User Interface Related Issues"]="<b>User Interface Related Issues:</b> This category should be used to make suggestions for User Interface (UI) improvements.  The user interface consists of the windows you see on screen, hot buttons, in-game chat and other things that allow you to interact with the game world."; 

descriptions["Web Page or Message Board Related Issues"]="<b>Web Page or Message Board Related Issues:</b> Any suggestions or comments on how our Web page or message boards are set up or operated are welcome here."; 

descriptions["Zone Related Issues"]="<b>Zone Related Issues:</b> Zone related issues are suggestions for the improvement of a particular zone, or aspect of an existing zone in game."; 

							
// Makes sure any string representations are safely converted to objects.
function getObj(obj)
{
...
/*
	 Takes a select box, clears it, then populates it 
	 with a list of elements (an array, populated with new Option(txt, val) )
	 
	 selectObject should be the actual object, not a sting
	 so use populateSelect(document.myForm.mySelect, optListA)
	 not populateSelect("document.myForm.mySelect", optListA)
	 That said, the code can handle the mistake.
*/
function populateSelect(selectObject, list)
{
	...
	if (list.length>1)
	{
		selectObject.options[0]=new Option("Please choose one....","Please choose one....");
		modifier=1;
	}
...
function selectChanged(parentSelectObject, childSelectObject, list)
{
	...
	setDefinition(parentValue);
}

function setDefinition(cat)
{
	if (navigator.userAgent.indexOf("MSIE")!=-1)
	{
		if (parseInt(navigator.appVersion)>=4)
		{
			if (descriptions[cat])
			{
				document.all.catDesc.innerHTML=descriptions[cat];
			}
		}
	}
}
...
if (document.mailform) {
	selectChanged(document.mailform.category, document.mailform.category2, menu);
}
						</script>
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
