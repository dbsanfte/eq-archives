...
<P ALIGN="center"><STRONG><BR><STRONG>Broadband Connection Troubleshooting</STRONG></STRONG></P>  <P>The following are things to check if you are having connection problems
  ...
  &quot;My Computer&quot; icon on your desktop and choose &quot;Properties&quot;
  from the menu. Next, choose the &quot;Device Manager&quot; tab and double
  click the &quot;Computer&quot; entry at the top of the device list. This
  should bring up the IRQ Resource window. If your network card is sharing an
  IRQ with your Video or Sound card then you will need to move one of those
  devices to a different slot on your motherboard to resolve the conflict.</P>  <P>If you have a modem installed in your computer along with the network card
  for either your Cable or DSL modem then it may cause troubles. We recommend that
  you remove the modem from your computer completely, or at least disable it,
  so there is no conflict there between the modem and your network card.</P>  <P>There is a file in your EverQuest directory that is named Datarate.txt.
  ...
  higher then 5.0.</P>  <P>Remember that if you are running a firewall, then it could cause connection
  troubles to our servers. You will either need to disable any firewalls you
  may have running, or visit our <A HREF="../../../../../support/tech_support/ts_network_support_firewall_proxy_info.jsp">Firewall/Proxy
