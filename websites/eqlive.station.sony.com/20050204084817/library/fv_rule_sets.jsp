...
//window.alert(document.cookie);
  ...
  servers. It is not one of the &quot;Zeks&quot;.</P>  <UL>   <LI>Beneficial buff
       ...
       Code will be in effect in all zones.</LI>   <LI>Very few items will
       be No-Drop. Exceptions will include things such as newbie notes and epic
       weapons.</LI>   <LI>Bind Affinity will be
