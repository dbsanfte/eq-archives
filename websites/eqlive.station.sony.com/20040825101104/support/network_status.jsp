...
<p>&nbsp;</p>
	...
	<span class="status_headline">All servers are up</span><br>
	<span class="status_date">8/24/2004  6:30 AM PDT (-7 UTC)</span><br>
	<P>All EverQuest servers are up and open for play. We are
  aware that the current Server Status page is showing a couple of the worlds
  as being down erroneously. We are looking into this issue and hope to have it
  rectified shortly.</P>  <P>-The SOE Game Operations Team</P>
