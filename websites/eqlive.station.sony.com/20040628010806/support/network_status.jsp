...
<p>&nbsp;</p>
	...
	<span class="status_headline">All Everquest Servers are Up.</span><br>
	<span class="status_date">6/17/2004 11:00 PM PDT (-7 UTC)</span><br>
	<P>All servers are up and open for play. Have Fun and Good
  Luck.</P>  <P>-The SOE Game Operations Team</P>
...
<td width="20"><img src="/images/spacer.gif" border="0" width="20" height="10"></td>
						...
						<h1>Small Downtime for 9 Everquest Servers at 3am on June 17th, 2004</h1>
						<p>At 3am pdt (-7 UTC) on June 17th, 2004, Brell Serilis, Lanys T'Vyl, Rallos Zek, The Rathe, Sullon Zek, Tallon Zek, Torvonnilous, Tunare and Vallon Zek will all be coming down for brief maintenance. Servers will be brought back up as each finishes its maintenance with the total expected downtime not expected to exceed 2 hours.
<P>
