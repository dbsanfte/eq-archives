...
<div id="gnav_players" style="position:absolute; top:20;left:485;width:165;height:15; clip:rect(0px 165px 15px 0px); color:#000000;font-family:Verdana,Arial,Helvetica;font-size:12px;font-weight:bold;text-align:center; z-index:22;">52,735 Players Online</div>
...
<P align=left>This card is a 90-day pre-paid subscription and may only be used once. You can purchase the EverQuest Game Card at one of the following retailers:</P>
<DIV align=left>
<UL>Best Buy<BR>Comp USA<BR>Fry's Electronics<BR>Electronics Boutique<BR>Babbages </UL></DIV>
<P align=left>Or, try one of these online stores:</P>
<DIV align=left>
<UL><A href="http://store.station.sony.com/" target=_blank>The Sony Station Store</A><BR><A href="http://www.ebworld.com/" target=_blank>EBWorld</A> </UL><BR><BR>
