	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/grobb.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/grobb.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/library/atlas/grobb.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                                            ...
                                            <div align="center"> 
                                              ...
                                              <table border="0" width="90%">
                                                <tr> 
                                                  ...
                                                  <td> 
                                                    <div align="center"><img src="images/mc_grobb_title.gif" width="117" height="34"></div>
                                                  </td>
                                                </tr>
                                              </table>
                                              <p align="justify">&nbsp; 
                                      ...
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          ...
                                          <td width="350" height="426"> 
                                            <div align="center"><img src="images/mc_grobb.jpg" width="500" height="593" usemap="#CITIES" border="0"></div>
                                          </td>
                                          <td> 
                                            <center>
                                              &nbsp; 
                                      ...
                                      <div align="center"> 
                                        <table border="0" width="90%" align="center">
                                          <tr> 
                                            ...
                                            <td valign="top"> 
                                              <p><font size="4" color="#000000">First 
                                                Bank of Grobb<br>
                                                To The Innothule Swamp</font></p>
                                            </td>
                                          </tr>
                                        </table>
                                      </div>
                                      ...
                                      <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
                                        <tr> 
                                          <td height="128"> 
                                            <div align="center"><br>
                                              <center>
                                                <p><span class="maplink"><font face="Times New Roman, Times, serif"><a href="antonica.jsp" class="maplink">Back 
                                                  to Antonica map</a></font></span></p>
