	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/eqim.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/eqim.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
				...
				<td width="81" height="26"><a href="https://www.station.sony.com/secure/en/registration/registration.jsp?returnURL=http://eqlive.station.sony.com/eqim.jsp?null" target="_top" onmouseover="gn2_swap(gn2_img_join,gn2_join_on);" onmouseout="gn2_swap(gn2_img_join,gn2_join_off);"><img src="/common/global_nav/images/gn2/gn2_btn_join_off.gif" width="81" height="26" border="0" alt="Join Free" name="gn2_img_join"></a></td>
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">New&nbsp;Service</font></b></div>
                        <!-- #EndEditable --></td>
...
<TBODY>
<TR>
<TD><SPAN class=title1><IMG height=135 src="http://eqlive.station.sony.com/images/eqim_header.jpg" width=255><BR>Keep in Touch Beyond EverQuest</SPAN><BR>EQIM, the EverQuest Instant Messaging Service, is an exciting new way to chat with your EverQuest friends. With the ability to connect to the EverQuest chat server, players can now log on to this instant messaging service as one of their characters and chat directly with players on any server, create their own chat rooms. Staying in touch with friends, guildmates and groupmates has never been so easy and convenient. </TD>
<TD width="60%">
<DIV align=center>
<P><IMG height=254 src="http://eqlive.station.sony.com/images/eqim_top_right.jpg" width=295></P>
<P>&nbsp;</P></DIV></TD></TR></TBODY></TABLE>
<DIV align=center>
<P><A onmouseover="MM_swapImage('Image39','','http://eqlive.station.sony.com/images/download_on.gif',1)" onmouseout=MM_swapImgRestore() href="ftp://eqftp.station.sony.com/eqim.exe"><IMG height=24 src="http://eqlive.station.sony.com/images/download_off.gif" width=140 border=0 name=Image39></A></P></DIV>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD width="22%">
<DIV align=center><IMG height=266 src="http://eqlive.station.sony.com/images/eqim_mid_left.jpg" width=119></DIV></TD>
<TD vAlign=top>
<P><SPAN class=title1>What Can I Do With EQIM?</SPAN><BR>There is almost no limit to the ways you can use EQIM. Stuck at work but want to monitor your guild's big raid? No problem! EQIM will keep you in touch with people and on top of events in your EQ community while you're not in the game. Plan the evening's adventures before you enter EQ so you can get in and get on with the fun immediatelyreduce or eliminate the time it takes to look for a group and to organize big raids!</P>
<P>Host guild meetings in private chat rooms that you can moderate.</P>
<P>Looking for a key player for an impromptu raid? Check EQIM to see if he is online. If you know his other aliases, check them all on any server!</P></TD></TR></TBODY></TABLE><BR>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top width="40%"><SPAN class=title1>Explore the EverQuest Community</SPAN><BR>The global EverQuest community is just a click away with EQIM, keeping you in contact with old friends and opening new avenues to meet new friends. EQIM adds a completely new dimension to your EQ gaming experience. With an active subscriber base of more than 430,000 players and as many as 100,000 or more players logged on simultaneously, the world of EQ has potential to expand for you in unimagined ways. </TD>
<TD>
<DIV align=center><IMG height=257 src="http://eqlive.station.sony.com/images/eqim_bottom_left.jpg" width=300></DIV></TD></TR></TBODY></TABLE>
<P><STRONG>How Do I Get EQIM?</STRONG><BR>Simply <A href="ftp://eqftp.station.sony.com/eqim.exe">download</A> the EQIM client and install it. You must have an active and valid EverQuest subscription with at least one created character to use the EQIM service.<BR></P>
<P><STRONG>If I Like It, Can I Keep Using It?</STRONG><BR>Yes, of course you can keep using it. At first, we were going to charge a small fee to defer the cost of production but with the popularity of the Planes of Power expansion pack, we've decided to make this a free EQ feature. We hope you enjoy it.</P>
<P><STRONG>Regarding in-game side effects resulting from the use of the EQIM, EverQuest lead designer Rich Waters has this to say:</STRONG><BR>Being logged into EQ Instant Messenger does not count towards any resurrection timers, corpse timers, and the like. It connects you to the chat server, but isn't connecting you to the game world in any way that would affect your character at all.</P>
<P style="FONT-WEIGHT: bold">The use of EQIM is subject to the terms of the EQIM End User License and Registration Agreement. However, the service and software are provided to you FREE OF CHARGE. </P>
