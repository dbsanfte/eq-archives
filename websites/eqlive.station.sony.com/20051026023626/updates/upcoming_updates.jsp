...
<P>The
  ...
  Here are some of the things that are currently planned:</P>  <UL>   <LI>New Default UI Skin </LI>   <LI>Modifications to DoD
       ...
       applications while in windowed mode</LI>   <LI>Take a look at Kithicor
       for some holiday fun </LI>   <LI>Players will have the
  ...
  back to </EM><EM>10/27 in
  order to ensure adequate testing time. We apologize for any inconvenience
  this may cause</EM><EM></EM></P>
