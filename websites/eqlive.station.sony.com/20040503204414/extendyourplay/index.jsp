	...
	<tr>
		<td><table width="780" height="26" cellpadding="0" cellspacing="0" border="0">
			<tr height="26">
				...
				<td width="162" height="26"><a href="https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/extendyourplay/index.jsp?null" 
					target="_login" onclick="window.open('https://login.station.sony.com/login/station/login_popup.jsp?returnURL=http://eqlive.station.sony.com/extendyourplay/index.jsp?null', '_login', 'titlebar=no,status=yes,toolbar=no,width=350,height=380,resizable=yes'); return false;" 
                  ...
                  <table width="593" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td rowspan="2" width="62" height="9" background="../images/sub_heading_bg.gif"><!-- #BeginEditable "Content Name" --> 
                        <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Extend&nbsp;Your&nbsp;Play</font></b></div>
                        <!-- #EndEditable --></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr valign="top" bgcolor="000016"> 
                      ...
                      <td colspan="6" bgcolor="#000016" rowspan="3"><!-- #BeginEditable "Content Goes Here" --> 
                        ...
                        <P>Thank you for giving EverQuest another try. We're excited to welcome you to our community. If you decide to continue your adventures after the 30-days of gameplay included with your purchase, you can take advantage of one of the following methods to subscribe.</P>
<TABLE border=0>
<TBODY>
<TR>
<TD vAlign=center><A href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-SU-GC1001-EQGCRD"><IMG src="http://eqlive.station.sony.com/images/extendedplay/gamecard.gif" border=0></A></TD>
<TD vAlign=top>Why hassle with a credit card when you can purchase an <A href="https://store.station.sony.com/hardgood.jsp?SKU=EQ1RE-SU-GC1001-EQGCRD">EverQuest&nbsp;Game Card</A>? This pre-paid game card for a 90-day subscription can be purchased online at the Station Store or at participating retailers, including GameStop and EBGames. </TD></TR>
<TR>
<TD vAlign=center><IMG src="http://eqlive.station.sony.com/images/extendedplay/globalcollect.gif" border=0></TD>
<TD vAlign=center>International gamers can now take advantage of Global Collect. This billing method will allow you to activate a subscription based on your local currency.</TD></TR>
<TR>
<TD vAlign=center><IMG src="http://eqlive.station.sony.com/images/extendedplay/creditcards.gif" border=0></TD>
<TD vAlign=center>We accept all major credit cards!</TD></TR>
<TR>
<TD vAlign=center><A href="http://www.station.sony.com/allaccess/"><IMG src="http://eqlive.station.sony.com/images/extendedplay/all_access.gif" border=0></A></TD>
<TD vAlign=center>Using a credit card, you can also take advantage of&nbsp;a <A href="http://www.station.sony.com/allaccess/">SOE All Access</A> subscription -&nbsp;7 great games for one very low price! </TD></TR></TBODY></TABLE>
<P>For more information and restrictions on subscription rates for EverQuest, please <A href="http://eqlive.station.sony.com/support/accounts_billing.jsp">click here</A>. </P>  
                        <!-- end page content -->
                        <!-- #EndEditable --></td>
