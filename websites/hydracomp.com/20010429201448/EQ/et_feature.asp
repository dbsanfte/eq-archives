...
<!------------ end of focusIN code ------------>
<hr size=0>
<CENTER><table border=0 cellpadding=5 bgcolor=#DDDDDD width=50% background='/images/table-head-bg.jpg'><tr><td background=''><table border=0 cellpadding=5 bgcolor=#BB0000 width=100%><tr><td width=50% background='/images/table-bg.jpg'><b><font size=+3 color=#FFF000><center>EverTools Feature List<center></font></b></td></tr></table></td></tr></table></center><HR SIZE=1 WIDTH=80%></CENTER><BR><B><U><FONT SIZE=+1>About the Feature Tracking System</FONT></U></B><BR>

<P>&nbsp&nbsp Below you will find a listing of the current features that are being
tracked and worked on to be added into EverTools, as well as the status of each feature.  If
you would like to see something added to EverGuild that is not currently in
the software, and is not listed in the below table, please let us know. Thanks!</p>

<center><table BORDER CELLSPACING=0 WIDTH='90%' background=''><tr BGCOLOR='#225555'><td><center><b>ID</b></center></td><td><center><b>Status</b></center></td><td><center><b>Priority</b></center></td><td><center><b>Module</b></center></td><td><center><b>Description</b></center></td></tr><tr><td><center>ETF-2</center></td><td><center>Planned</center></td><td><center>2</center></td><td><center>EverMon</center></td><td>Remember previous window size and position</td></tr></table></center><br><hr width=80% size=1><br><center><a href='/default.asp'><img src='/images/logoblack.jpg' border=0 alt='Home' width=50 height=38></a></center></table></table></center></BODY></HTML>