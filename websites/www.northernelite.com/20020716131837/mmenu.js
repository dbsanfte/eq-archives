...
{		
	...
	if(ns4){
		...
		ls="<table cellpadding="+(arg[2][9]/2)+" cellspacing=0><tr><td height=-1 align="+menu[7]+tdwd+"><a target=\"content\" href=\""+hlnk+"\" "+ltarg+" onclick=\"d.cookie=sel;\" style='color:#"
		...
		if(menu[13]!="form") {mt+="<a target=\"content\" href=\""+hlnk+"\"  "+ltarg+" style='text-decoration:none;'>"}
