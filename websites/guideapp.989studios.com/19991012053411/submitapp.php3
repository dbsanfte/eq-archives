...
<BODY BGCOLOR="#153033" TEXT="#FFFFFF" LINK="#FFCC33" VLINK="#33CCFF" ALINK="#CCFFFF">
<P>

<!--SELECT id FROM application WHERE stationname=''-->
Thank you for your application.<BR>
Please check back later to see if you have been graded.<BR>
<BR>You can check your score at the application site and logging in.  Your application results will be displayed to you then.<BR><BR>
</BODY>
</HTML>
