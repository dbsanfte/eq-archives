...
{
	element.style.backgroundImage = "url(/images/v4/localized/menu/bgspot_over.png)";
}
function rollOutMenu(element)
{
    element.style.backgroundImage = "url(/images/v4/localized/menu/bgspot_out.png)";
}
...
function rollOverButton(buttonId, color) {
    ...
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_left_roll.png)";
    element = document.getElementById(buttonId + "-middle");
    element.style.backgroundImage = "url(/images/v4/shared/buttons/" + color + "bouton_middle_roll.png)";
    element.style.color = "#FFFFFF";
    element = document.getElementById(buttonId + "-right");
    element.style.backgroundImage = "url(/images/v4/shared/buttons/" + color + "bouton_right_roll.png)";
}
function rollOutButton(buttonId, color) {
    ...
    var element = document.getElementById(buttonId + "-left");
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_left.png)";
    element = document.getElementById(buttonId + "-middle");
    element.style.backgroundImage = "url(/images/v4/shared/buttons/" + color + "bouton_middle.png)";
    element.style.color = "#3D5660";
    element = document.getElementById(buttonId + "-right");
    element.style.backgroundImage = "url(/images/v4/shared/buttons/" + color + "bouton_right.png)";
}
...
function rollOverUpgradeButton(buttonId, color) {
    ...
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_left_roll.png)";
    element = document.getElementById(buttonId + "-middle");
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_middle_roll.png)";
    element.style.color = "#FFFFFF";
    element = document.getElementById(buttonId + "-right");
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_right_roll.png)";
}
function rollOutUpgradeButton(buttonId, color) {
    ...
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_left.png)";
    element = document.getElementById(buttonId + "-middle");
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_middle.png)";
    element.style.color = "#3D5660";
    element = document.getElementById(buttonId + "-right");
    element.style.backgroundImage = "url(/images/v4/localized/buttons/" + color + "bouton_right.png)";
}
