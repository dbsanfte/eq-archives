...
function showItemTooltip(event,item,buildContent,useOriginalDesc)
{
	...
	{	
		new Insertion.Top(document.body,"<div id='tooltip'><img id='tooltipIcon' src='/images/v4/shared/blank.gif' width='40' height='40' class='png32'><div><img src='/images/v4/shared/tooltip/tooltip_top.png' height='11' width='330' class='png32'></div><div class='tooltipMiddle'><div id='tooltipBody'></div></div><div><img src='/images/v4/shared/tooltip/tooltip_bottom.png' height='11' width='330' class='png32'></div><div id='tooltipTitle'></div><img id='tooltipSep' src='/images/v4/shared/tooltip/tooltip_sep.png' width='318' height='2' class='png32'><img id='flecheSep' src='/images/v4/localized/tooltip/fleche_sep.png' width='14' height='33' class='png32'><img id='tooltipSupportIcon' src='/images/v4/localized/tooltip/support_icone.png' width='53' height='53' class='png32'></div></div>");
		tooltip = $('tooltip');
	}
    ...
    if(buildContent)
    {
	    if(isNumber(item))
	    {
			...
			$('tooltipIcon').src='/images/v4/shared/eq/item_icones/item_'+itemTooltips[item].iconNumber+'.png';
		}
		else
		{
			if(useOriginalDesc!=undefined)
			...
			$('tooltipIcon').src='/images/v4/shared/eq/item_icones/item_'+item.iconNumber+'.png';
		}
