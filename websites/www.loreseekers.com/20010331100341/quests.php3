...
<TR>
	...
	<DIV ALIGN="CENTER">
	<IMG SRC="graphics/questheader.jpg" WIDTH=170 HEIGHT=75 ALT="" BORDER="0">
	<TABLE WIDTH="460">
	<TR>
		<TD>
		<TABLE WIDTH="100%">
		<TR>
			<TD>
			<DIV ALIGN="CENTER">
			<FONT FACE="Arial" SIZE="2" COLOR="#000000">Welcome to the Seekers' "Quest Database".<BR> Here you will find answers to the quests of Norrath.</FONT>
			</DIV>
			</TD>
		</TR>
		<TR>
			...
			<DIV ALIGN="CENTER">
			<TABLE>
			<TR><TD COLSPAN="3">Enter a keyword or a part of a quest.</TD></TR>
			<FORM ACTION="quest_search.php3" METHOD="POST">
			...
			<TR><TD COLSPAN="3"><BR>Enter a quest name or a part of a quest name.</TD></TR>
			<FORM ACTION="quest_search.php3" METHOD="POST">
			...
			<TR><TD COLSPAN="3"><BR>Select a zone.</TD></TR>
			<FORM ACTION="quest_search.php3" METHOD="POST"> 
