...
function gn2_gamesOver()
{
	...
	{		
		...
		//lithium
		li_showHideBoardMenu(false);
	}
}

//lithium
function li_showHideBoardMenu( bool ){
	if ( document.getElementById("lidropdown") )
		document.getElementById("lidropdown").style.visibility = bool?"visible":"hidden";
}
