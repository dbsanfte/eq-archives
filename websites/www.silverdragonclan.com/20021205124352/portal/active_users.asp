...
<form action="/portal/active_users.asp" method="post" id="form2" name="form2"><input type="hidden" name="Method_Type" value="logout"></form>      <table width="100%" align="center" border="0">
        <tr>
          <td>
            <font face="Verdana, Arial, Helvetica" size="2"><img src="images/icon_folder_open.gif" border="0">&nbsp;<a href="default.asp">All Forums</a>
            <br>
            <img src="images/icon_bar.gif" border="0"><img src="images/icon_folder_open_topic.gif" border="0">&nbsp;Active Users </font><font face="Verdana, Arial, Helvetica" size="1">(Last Updated December 05 2002  11:43:39)</font>
          </td>
          <script language="JavaScript">
            <!--
            function autoReload()
          ...
          <td align="right"><font face="Verdana, Arial, Helvetica" size="2">
            <form name="ReloadFrm" action="active_users.asp" method="post"><br>
      ...
      <br>
            <table border="0" cellspacing="0" cellpadding="2" align="center" width="95%"><tr><td align="right"><font face="Verdana, Arial, Helvetica" size="1">[ <b><font color="red">Administrators</font></b> | <b><font color="green">Moderators</font></b> ]</font></td></tr></table>
      <table border="0" cellspacing="0" cellpadding="0" align="center" width="95%">
        <tr>
          <td bgcolor="black">
            <table border="0" width="100%" cellspacing="1" cellpadding="3">
              <tr>
                <td background="images/colortemplates/bgcat8.gif" border="0" height="20" valign="middle" width="5%" nowrap>&nbsp;</td>
                <td background="images/colortemplates/bgcat8.gif" border="0" height="20" valign="middle" nowrap><font face="Verdana, Arial, Helvetica" size="2" color="aliceblue"><b>Member Name</b></font></td>
                <td background="images/colortemplates/bgcat8.gif" border="0" height="20" align=center valign="middle" nowrap><font face="Verdana, Arial, Helvetica" size="2" color="aliceblue"><b>Active&nbsp;Since</b></font></td>
                <td background="images/colortemplates/bgcat8.gif" border="0" height="20" align=center valign="middle" nowrap><font face="Verdana, Arial, Helvetica" size="2" color="aliceblue"><b>Active&nbsp;Time</b></font></td>
              </tr>
              <tr>
                <td colspan="4" bgcolor="slateblue">
                  <font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><b>Active Guests : 1</b></font>
                </tr>
              </tr>
              <tr>
                <td bgcolor="whitesmoke" valign="middle" width="5%" nowrap>&nbsp;</td>
                <td bgcolor="whitesmoke" valign=middle nowrap><font face="Verdana, Arial, Helvetica" size="2" color="midnightblue">Guest #1</font></td>
                <td bgcolor="whitesmoke" align=center valign=middle nowrap><font face="Verdana, Arial, Helvetica" size="1" color="midnightblue"><b>December 05 2002</b><br> 11:15:43</font></td>
                <td bgcolor="whitesmoke" align=center valign=middle nowrap><font face="Verdana, Arial, Helvetica" size="2" color="midnightblue">28 Minutes</font></td>
              </tr>
            </table>
          </td>
        </tr>
