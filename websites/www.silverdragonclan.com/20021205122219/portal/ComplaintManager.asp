...
<form action="/portal/ComplaintManager.asp" method="post" id="form2" name="form2"><input type="hidden" name="Method_Type" value="logout"></form>
<script language="JavaScript">
function ChangePage(){
...
<table border="0" width="100%" align="center">
  <tr>
    ...
    <img src="images/icon_bar.gif" height=15 width=15 border="0"><img src="images/icon_folder_open.gif" height=15 width=15 border="0">&nbsp;<a href="admin_home.asp">Admin&nbsp;Section</a><br>
    <img src="images/icon_blank.gif" height=15 width=15 border="0"><img src="images/icon_bar.gif" height=15 width=15 border="0"><img src="images/reporterprofile.gif" height="14" width="20" border="0">&nbsp;Complaint&nbsp;Manager<br>
    </font></td>
  </tr>
</table>
