...
<table width="100%" border="0">
  <tr>
    ...
    <font face="Verdana, Arial, Helvetica" size="2"><img src="images/icon_folder_open.gif" border=0>&nbsp;<a href="default.asp">All Forums</a><br><img src="images/icon_bar.gif" border=0><img src="images/icon_folder_open_topic.gif" border=0>&nbsp;Active Topics Since     <select class="pulldown" name="ShowSinceDateTime" size="1" onchange="SetLastDate();">
        <option value="LastVisit" SELECTED>&nbsp;Last Visit on November 25 2002 11:41:03&nbsp;</option>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">  <tr>
	 ...
	 <tr>
		<td height="20" colspan="7" bgcolor="slateblue" valign="center">
			<a href="forum.asp?FORUM_ID=91"><font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><b>Fun Stuff</b></font>
			</a>
		</td>
	 </tr>
	 <tr>
		<td bgcolor="whitesmoke" align="center" valign="center"><a href="topic.asp?TOPIC_ID=211"><img src="images/icon_folder_new.gif" alt="New Topic" border="0"></a>
		</td>
       <td bgcolor="whitesmoke"><img src='images/icon_mi_9.gif' border="0" alt=""></td>		<td bgcolor="whitesmoke" valign="center">
			<font face="Verdana, Arial, Helvetica" size="2"><a href="topic.asp?TOPIC_ID=211">Sorry</a>&nbsp;</font>
<i><font face="Verdana, Arial, Helvetica" size="1"></font></i>		</td>
		<td bgcolor="whitesmoke" valign="center" align="center"> <font face="Verdana, Arial, Helvetica" size="2" color="midnightblue">Mukala</font></td>
		...
		<td bgcolor="whitesmoke" valign=center align="center"nowrap><font face="Verdana, Arial, Helvetica" size=1color=midnightblue><b>December 04 2002</b>&nbsp; 01:45:32<br>by: <a href="pop_profile.asp?mode=display&id=525">aljobeaux</a></font></td>
	</tr>
		</tr>
	</table>
	</td>
...
<!-- START JUMP TO -->
    <form name="Stuff">		<font face="Verdana, Arial, Helvetica" size="2"><b>Jump To:</b></font>
      ...
      <option value='default.asp'>Out of Character</option>       <option value='forum.asp?FORUM_ID=91'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fun Stuff</option>
