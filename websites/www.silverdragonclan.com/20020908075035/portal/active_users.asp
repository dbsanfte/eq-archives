...
<form action="/portal/active_users.asp" method="post" id="form2" name="form2"><input type="hidden" name="Method_Type" value="logout"></form>      <table width="100%" align="center" border="0">
        <tr>
          <td>
            ...
            <br>
            <img src="images/icon_bar.gif" border="0"><img src="images/icon_folder_open_topic.gif" border="0">&nbsp;Active Users </font><font face="Verdana, Arial, Helvetica" size="1">(Last Updated September 08 2002  07:50:35)</font>
          </td>
          <script language="JavaScript">
            <!--
            function autoReload()
          ...
          <td bgcolor="black">
            <table border="0" width="100%" cellspacing="1" cellpadding="3">
              ...
              <tr>
                ...
                <td bgcolor="whitesmoke" align=center valign=middle nowrap><font face="Verdana, Arial, Helvetica" size="1" color="midnightblue"><b>September 08 2002</b><br> 07:50:35</font></td>
                <td bgcolor="whitesmoke" align=center valign=middle nowrap><font face="Verdana, Arial, Helvetica" size="2" color="midnightblue">0 Minutes</font></td>
              </tr>
            </table>
          </td>
        </tr>
