...
<td class="body">
<center>
  <div class="menutitle"><font size="+3"><b>Utility Items</b></font></div>
  <font size="1">by <a href="mailto:ThottWeb@Afterlifeguild.org">Thott</a></font>
  <p>
</center>Pure melees gain, at minimum, these abilities that they don't already
have, through items:
<ul>
<li>damage shield
<li>invis
...
<li>regen
<li>SoW
<li>infra/ultravision
<li>+atk
<li>+str, etc. most stats
<li>haste
<li>slow
<li>very fast run speed (horses)
<li>illusions
<li>bind sight (albiet consumable)
<li>stat debuff
<li>locate corpse
<li>+all resistances
<li>blind
...
Yet utility classes gain very little.&nbsp; There are no
compensating increased power items.
<p>
Everyone should gain the same amount of capability from time invested
gaining items.
<p>
</td></tr></table>