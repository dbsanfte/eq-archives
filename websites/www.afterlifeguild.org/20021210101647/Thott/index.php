...
<td class="body">
<center>
  <div class="menutitle"><font size="+3"><b>Thott's Writings</b></font></div>
  <font size="1">by <a href="mailto:ThottWeb@Afterlifeguild.org">Thott</a></font>
  <p>
</center>This site contains a collection of individual writings, mostly related
to Everquest, not all of which are linked in on the left. &nbsp;This
isn't a serious attempt at a comprehensive site. &nbsp;Instead, this is
a convenient place to put common subject explainations, for easy linking.
<p>
Many of these writings are out of date, however, many still contain
useful concepts, so they're left online.
<p>
I can be contacted via
<a href="mailto:ThottWeb@Afterlifeguild.org">email</a>, IRC
[irc.stratics.com #afterlife] (although I'm typically idle, I will
eventually see the message and respond), or in EQ on the Mithaniel
Marr server, starting at 1730 PST.
</td></tr></table>