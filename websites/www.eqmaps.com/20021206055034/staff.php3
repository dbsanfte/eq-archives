...
Focus: Item Database<br>
Description: I'm currently in charge of adding new items, writing descriptions and quests, keeping the equipment database up to date and any other tasks I can find.  I try to respond to all the emails I receive so please email me any new items, quests, or any corrections.<br>
<br>
          </td>
