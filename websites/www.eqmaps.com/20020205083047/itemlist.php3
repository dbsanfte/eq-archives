      ...
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
          ...
          <td width="601" height="320" valign="top">
            <form action="itemlist.php3" method="get" name="itemsearch">
		  ...
		  <input type="text" name="maxw" size="2" maxlength="3" value="99"></td>
                ...
                <td width="80" align="right" rowspan="2">ALL / ALL <input type="checkbox" name="allall" checked></td>
              </tr>
              <tr>
                <td align="right">
                  Race:
...
<option value="MANA">MANA</option>
		  ...
		  <input type="text" name="maxl" size="2" maxlength="3" value="99"></td>
                <td width="80" align="right" valign="bottom" rowspan="2"><input type="submit" name="submit" value="Search"></td>
              </tr>
              <tr>
                <td colspan="2" align="right">
<select name="zone">
<option value="">Found In Any Zone</option>
<option value="acrylia">Acrylia Caverns
<option value="akanon">Ak'Anon
<option value="akheva">Akheva Ruins
<option value="antonica">Antonica
...
<option value="ID">ID</option>
  ...
  <li>The last four check boxes are used to show only magical,
  quest related, or remove no drop items from the search results.
  <li>The ALL/ALL check box includes items with ALL in the race or class field. When
  unchecked it allows you to narrow the results to items made specifically for your
