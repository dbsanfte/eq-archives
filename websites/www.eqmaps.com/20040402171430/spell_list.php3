      ...
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
          ...
          <td width="601" height="320" valign="top">
            <form method="GET" action="/spell_list.php3">
            <table width="580" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="180" align="right" height="30">Class:
                  <select name="class">
                ...
                <td width="200" align="right">Category:
                  <select name="category">
                    <option value="" selected>*</option>
                    <option value="Animation" >Animation</option>
                    <option value="Attributes" >Attributes</option>
                    <option value="Bard Attack" >Bard Attack</option>
                    <option value="Bard Buffing" >Bard Buffing</option>
                    <option value="Bard Healing" >Bard Healing</option>
                    <option value="Blinding" >Blinding</option>
                    <option value="Breath" >Breath</option>
                    <option value="Buffing" >Buffing</option>
                    <option value="Bugs/Misc" >Bugs/Misc</option>
                    <option value="Calm" >Calm</option>
                    <option value="Choking" >Choking</option>
                    <option value="Clarity" >Clarity</option>
                    <option value="Combustion" >Combustion</option>
                    <option value="Dead/Summon" >Dead/Summon</option>
                    <option value="Diseased" >Diseased</option>
                    <option value="Divine" >Divine</option>
                    <option value="Dizzying" >Dizzying</option>
                    <option value="DoT" >Damage Over Time</option>
                    <option value="Fear" >Fear</option>
                    <option value="Fire Attack" >Fire Attack</option>
                    <option value="Firework 1" >Firework 1</option>
                    <option value="Firework 2" >Firework 2</option>
                    <option value="Firework 3" >Firework 3</option>
                    <option value="Firework 4" >Firework 4</option>
                    <option value="Flame Attack" >Flame Attack</option>
                    <option value="Flare" >Flare</option>
                    <option value="Freezing" >Freezing</option>
                    <option value="Frost Attack" >Frost Attack</option>
                    <option value="Group Gate" >Group Gate</option>
                    <option value="Hand Skill" >Hand Skill</option>
                    <option value="Healing" >Healing</option>
                    <option value="Illusion" >Illusion</option>
                    <option value="Invisi/Gate" >Invisibility/Gate</option>
                    ...
                    <option value="Mem Blur" >Memory Blur</option>
                    <option value="Pain" >Pain</option>
                    <option value="Poison" >Poison</option>
                    <option value="Poison Atk" >Poison Attack</option>
                    ...
                    <option value="Wind" >Wind Attack</option>
                  </select>
                </td>
                <td width="200" align="right">Skill:
                  <select name="skill">
                    <option value="" selected>*</option>
                    ...
                    <option value="Stringed Instruments" >Stringed Instruments</option>
                    <option value="Wind Instruments" >Wind Instruments</option>
                  </select>
                </td>
              </tr>
              <tr>
                <td align="right" height="30">Target:
                  <select name="target">
                    <option value="" selected>*</option>
                    <option value="All" >All</option>
                    <option value="Animal" >Animals</option>
                    <option value="Corpse" >Corpses</option>
                    ...
                    <option value="Point Blank AoE" >Point Blank</option>
                    <option value="Projectile Aim" >Projectile Aim</option>
                    <option value="Self" >Self</option>
                    <option value="Summoned" >Summoned</option>
                    <option value="Target Based AoE" >Target Based AoE</option>
	      ...
	      <tr><td colspan="3"><hr width="100%" size="1"></td></tr>
              <tr>
                <td><img src="images/dot.gif" width="180" height="1"></td>
                <td><img src="images/dot.gif" width="200" height="1"></td>
                <td><img src="images/dot.gif" width="200" height="1"></td>
              </tr>
            </table>
	    </form>
