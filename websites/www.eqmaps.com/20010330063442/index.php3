...
<br>
[02/14] <a href="#227">*peeps his head out*</a>
<br>
[02/1] <a href="#226">Mega Map Update</a>
<br>
[01/19] <a href="#225">Baltimore Fan Faire</a>
<br>
[01/17] <a href="#224">Sleeper's Tomb Added</a>
<br>
[01/11] <a href="#223">Ack! Where's my comment??</a>
<br>
</td>
                <td width="220" valign="top"><b>Items Database</b> 4469 total
<br>
[03/29] <a href="zone.php3?tag=hateplane&item=4616">Cloak of the Assassin</a>
<br>
[03/29] <a href="zone.php3?tag=drakkal&item=4615">Boots of the Vindicator</a>
<br>
[03/29] <a href="zone.php3?tag=mistmoore&item=4614">Noble's Robe</a>
<br>
[03/28] <a href="zone.php3?tag=skyshrine&item=4613">Black Lord's Boots</a>
<br>
[03/28] <a href="zone.php3?tag=skyshrine&item=4612">Wolf Caller's Helm</a>
<br>
[03/28] <a href="zone.php3?tag=skyshrine&item=4611">Wolf Caller's Vambraces</a>
<br>
[03/28] <a href="zone.php3?tag=skyshrine&item=4610">Wolf Caller's Gauntlets</a>
<br>
[03/28] <a href="zone.php3?tag=drakkal&item=4609">Dazzeling Gloves</a>
<br>
		[-more-] <a href="itemadditions.php3">Last 200 Additions</a>
		</td>
                <td width="180" valign="top"><b>NPC Updates</b><br>
[03/26] <a href="zone.php3?tag=sro&npc=1140">An Orc Centurion</a>
<br>
[03/26] <a href="zone.php3?tag=thurgadin&npc=4633">A Scuttle Bat</a>
<br>
[03/26] <a href="zone.php3?tag=lavastorm&npc=3690">Hykallen</a>
<br>
[03/26] <a href="zone.php3?tag=karnor&npc=4119">Verix Kyloxs remains</a>
<br>
[03/26] <a href="zone.php3?tag=ecommons&npc=652">A Griffin</a>
<br>
[03/26] <a href="zone.php3?tag=rathemtn&npc=3334">Tarskuk</a>
<br>
[03/26] <a href="zone.php3?tag=neriakc&npc=4269">Verina Tomb</a>
<br>
[03/25] <a href="zone.php3?tag=drakkal&npc=4396">Tuuak</a>
<br>
		[-more-] <a href="npcupdates.php3">Last 200 Updates</a>
              ...
              <tr><td colspan="3"><a class="headline" name="231">Fourteen New Maps</a><br>
...
<br>
<br>
<a class="headline" name="227">*peeps his head out*</a><br>
Submitted by: <a href="mailto:niteraven@eqmaps.com">NiteRaven</a> on Wednesday, February 14th at 04:21am EST<br>
<br>
Yes I'm still alive, yes I'm still working on the site, and no I really don't have any news to post. Darnavian and I continue to add/update new items and NPC's on a daily bases. EQ Maps is still going on as usual despite in the insane costs of running it. I'm in the works of something that will allow me to continue the site for a long time to come, more at a later date.<br><br>
Oh yes, and of course, happy v-day! Go tell that special person in your life how you feel about them. No, I'm not talking about the neighbor whos dog keeps crapping in your front lawn. Ok bad joke, but it's 4:21 AM! Have a good one.<br><br>
Oh btw, one last thing. In case you didn't meet me at the Fan Faire, I was the idiot who stood up and shouted out as Cindy was announcing some of the EQ websites in attendance. It seems no one understood what I was saying, hence me looking like an idiot, heh.<br>
<br>
<br>
<a class="headline" name="226">Mega Map Update</a><br>
Submitted by: <a href="mailto:niteraven@eqmaps.com">NiteRaven</a> on Thursday, February 1st at 01:08am EST<br>
<br>
First off I want to apologize for the lack of news updates, there hasn't been anything added to the site besides the normal item and NPC updates. Second I want to apologize for waiting a month to get some new maps online. This especially goes to the authors of these maps who put a lot of time and effort into creating them. A lot has been going on lately in real life, including me taking a vacation to Florida and going home to see family and friends. I have also been in search of a job recently as this website no longer provides a stable income. If anyone is in need of a Web Developer in the Raleigh/RTP area, drop me an e-mail. (<a href="resume.php" target="_blank">resume here</a>)
<br><br>
I'll continue to work on this site as long as time allows me. I have a special place in my heart for EQ Maps, I consider it my baby, so I'll do my best to make sure it continues to grow. As it's looking now, this site will be turned over to the <a href="http://www.xrgaming.net/" target="_blank">Crossroad Network</a> starting Feb. 15th as I no longer can afford to keep it going myself.
<br><br>
Now onto the map update you all have been waiting for. Since most of these maps have gathering dust in my mailbox, I've collected 26 of them since my last map update. It will take to long to link to everyone one of them, so I'll just give you a quick run down. New maps: Plane of Air (map 3), Cobalt Scar (map 1), Crystal Caverns (set 1), Crystal Caverns (map 2), Eastern Wastes (map 3), Plane of Fear (map 6), Firepot Room (Timorous Deep), Tower of Frozen Shadow (map 2), Plane of Growth (map 2), Iceshard Keep (Kael Drakkal), Kael Drakkal (map 4), Lake of Ill Omen (map 4), Dragon Necropolis (map 2), Siren's Grotto (map 1), Skyfire (map 2), Skyshrine (map 2), Skyshrine (golem area), Skyshrine Maze (map 1, 2, 3), The Hole (map 3, 4), Thurgadin (map 2), Icewell Keep (map 1), Western Wastes (map 1), Norrath Zones (map 3).
<br><br>
On a final note, as I mentioned before, I'll be attending the EverQuest gathering in Baltimore this coming Friday and Saturday. It's going to be awesome to finally meet some fellow players and the webmasters from EverLore, Castersrealm, and Allakhazam. I play on the Karana server and am registered under the name Galendir. Since I look nothing like my in game character I doubt that will be helpful, heh. For those of you that are going, I'll see you Saturday!! Take care all!<br>
<br>
<br>
<a class="headline" name="225">Baltimore Fan Faire</a><br>
Submitted by: <a href="mailto:niteraven@eqmaps.com">NiteRaven</a> on Friday, January 19th at 10:25am EST<br>
<br>
I usually don't post stuff like this but since I'll be attending for the first time this is your chance to meet yours truly and give me money and stuff. Here's a press release from Cindy of Verant:
<br><br>
Registration for the Baltimore Fan Faire ends Monday! Make sure your name is on the attendees page of the <a href="http://everquest.station.sony.com/fanfaire/fanfaire.html" target="_blank">Fan Faire</a> if you have already signed up. If you still need to register, visit the site and do it quickly! We are almost sold out!<br>
<br>
<br>
<a class="headline" name="224">Sleeper's Tomb Added</a><br>
Submitted by: <a href="mailto:niteraven@eqmaps.com">NiteRaven</a> on Wednesday, January 17th at 10:50am EST<br>
<br>
I added the zone <a href="zone.php3?tag=sleepers">Sleeper's Tomb</a> under the dungeon list. I don't know much about this zone or even if it exists at all? I'm on vacation in Florida using a 3 year old notebook computer, so I don't have access to my EverQuest folder but I do believe there are files for it. Feel free to post some zone comments on where it can be found!
<br><br>
I also wanted to mention there are a few rumors going around about people finding the entrance to the <a href="zone.php3?tag=pom">Plane of Mischief</a>. I tend to believe most these people are just looking for attention or being mischievous (ha ha!). If you know the real truth, spit it out!<br>
<br>
<br>
<a class="headline" name="223">Ack! Where's my comment??</a><br>
Submitted by: <a href="mailto:niteraven@eqmaps.com">NiteRaven</a> on Thursday, January 11th at 07:04am EST<br>
<br>
I'm sorry to inform everyone who posted a comment to the site in the last three days, your comment was not added to the database. When I created the comment table I set the max ID value to be 32767. That number was reached a couple of days ago and the database would not allow any more inserts. I only realized this a few minutes ago and have corrected it; we are good for the next four billion comments or so.
<br><br>
I apologize if you wrote a long winded comment or had an important question. On the good side of things, Darnavian and I did receive all comments and will update the site accordingly. Please post your comment again, if you wish. I assure you this won't happen again.<br>
<br>
<br>
</td></tr>
            </table>
