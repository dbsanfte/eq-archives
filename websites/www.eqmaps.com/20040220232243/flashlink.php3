<html>
<head>
<title>Your Help is Need - Sign Up for Flashlink</title>
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="300" height="70" colspan="5" align="center" valign="top">
      <b class="headline">The page you are trying to access is part</b><br>
      <b class="headline">of the Flashlink Premium Gaming Network!</b><br><br>
      ( please read <a href="whyflashlink.php3">this page</a> to find out why )
      </td>
  </tr>
  <tr>
    <td width="300" height="20" colspan="5" bgcolor="#000033"><img src="images/key.gif" width="16" height="16" align="left" hspace="5"><b>FLASHLINK LOGIN</b></td>
  </tr>
  <tr>
    <td width="2" bgcolor="#000033" rowspan="3"><img src="images/dot.gif"></td>
    <td width="75" height="32" align="right" bgcolor="#666666"><b class="price">User Name:</b></td>
    <td width="221" align="center" colspan="2" bgcolor="#666666"><input type="text" name="username" size="20" maxlength="20"></td>
    <td width="2" bgcolor="#000033" rowspan="3"><img src="images/dot.gif"></td>
  </tr>
  <tr>
    <td width="75" height="32" align="right" bgcolor="#666666"><b class="price">Password:</b></td>
  ...
  <tr>
    ...
    <td width="100" class="price" bgcolor="#666666">&nbsp;&nbsp;save</td>
    <td width="121" bgcolor="#666666"><input type="submit" name="submit" value="Login"></td>
  </tr>
  <tr>
    <td colspan="5" height="2" bgcolor="#000033"><img src="images/dot.gif"></td>
  </tr>
  <tr>
    <td width="300" colspan="5"><br>
      <li>New user? <a href="http://www.flashlink.com/index.php?p=signup&s=1">Sign-up now</a> to get instant access!
      <li>Existing users please login above.
      <li>Forgot your password? Have it <a href="http://www.flashlink.com/index.php?p=sendpass&s=1">sent</a> to you.
    </td>
  </tr>
</table>
</form>
...
<hr width="600">
<br>
<b class="headline">More About Flashlink</b>
<br><br>
When you join FlashLink, you gain full access to over 35 independently owned and operated gaming websites.
...
to go offline.
<br><br>
Joining Flashlink is just like getting a subscription to a gaming magazine - except Flashlink is
a lot less expensive and offers more information.  All new subscribers to Flashlink will get a
<b class="price">FREE 14 day trial</b> and can visit all Flashlink sites with absolutely no risk.
If you want to know more about Flashlink and it's many great benefits,
<a href="http://www.flashlink.com/index.php?p=whyjoin&s=1">click here</a>.
<br><br><br>
	  </td>
