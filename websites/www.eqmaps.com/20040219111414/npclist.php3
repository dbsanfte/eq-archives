...
<center><a href="http://www.flashlink.com/index.php?s=1"><img src="images/flashlink.gif" width="100" height="60" alt="Premium Flashlink Gaming Site" border="0"></a></center></td>
    <td width="625" valign="top">
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <option value="Abhorent">Abhorent</option>
        <option value="Akheva">Akheva</option>
        <option value="Animated Armor">Animated Armor</option>
        <option value="Aviak">Aviak</option>
        <option value="Beetle">Beetle</option>
        <option value="Bixie">Bixie</option>
        <option value="Broken Clockwork">Broken Clockwork</option>
        <option value="Brontotherium">Brontotherium</option>
        <option value="Brownie">Brownie</option>
        <option value="Bubonian">Bubonian</option>
        <option value="Burynai">Burynai</option>
        <option value="Centaur">Centaur</option>
        <option value="Clockwork">Clockwork</option>
        <option value="Clockwork Beetle">Clockwork Beetle</option>
        <option value="Clockwork Dragon">Clockwork Dragon</option>
        <option value="Clockwork Golem">Clockwork Golem</option>
        <option value="Cockatrice">Cockatrice</option>
        <option value="Coldain">Coldain</option>
        <option value="Demi Lich">Demi Lich</option>
        <option value="Denizen">Denizen</option>
        <option value="Dervish">Dervish</option>
        <option value="Devourer">Devourer</option>
        <option value="Dopplegagner">Dopplegagner</option>
        <option value="Dracnid">Dracnid</option>
        <option value="Dragon">Dragon</option>
        <option value="Drake">Drake</option>
        <option value="Drixie">Drixie</option>
        <option value="Drolvarg">Drolvarg</option>
        ...
        <option value="Fay Drake">Fay Drake</option>
        <option value="Flying Monkey">Flying Monkey</option>
	  <option value="Froglok">Froglok</option>
        <option value="Froglok Ghoul">Froglok Ghoul</option>
        <option value="Fungal Fiend">Fungal Fiend</option>
        <option value="Fungusman">Fungusman</option>
	  <option value="Galorian">Galorian</option>
        ...
        <option value="Goranga">Goranga</option>
        <option value="Gorgon">Gorgon</option>
        <option value="Griffin">Griffin</option>
        <option value="Grimling">Grimling</option>
        <option value="Guard of Justice">Guard of Justice</option>
        <option value="Hag">Hag</option>
        <option value="Harpy">Harpy</option>
        <option value="Hobgoblin">Hobgoblin</option>
        <option value="Imp">Imp</option>
        <option value="Kahli Sha">Kahli Sha</option>
        <option value="Kerran">Kerran</option>
        <option value="Kobold">Kobold</option>
        <option value="Leech">Leech</option>
        <option value="Lepertoloth">Lepertoloth</option>
        <option value="Lightcrawler">Lightcrawler</option>
        <option value="Lizard">Lizard</option>
        <option value="Lugien">Lugien</option>
        <option value="Lyncanthrope">Lyncanthrope</option>
        <option value="Malarian">Malarian</option>
        <option value="Mammoth">Mammoth</option>
        <option value="Manticore">Manticore</option>
        <option value="Mephit">Mephit</option>
        <option value="Mermaid">Mermaid</option>
        <option value="Mimic">Mimic</option>
        <option value="Minotaur">Minotaur</option>
        <option value="Mutant">Mutant</option>
        <option value="Netherbian">Netherbian</option>
        <option value="Orc">Orc</option>
        <option value="Othmir">Othmir</option>
        <option value="Owlbear">Owlbear</option>
        <option value="Pegasus">Pegasus</option>
        <option value="Phoenix">Phoenix</option>
        <option value="Pixie">Pixie</option>
        <option value="Pulsing">Pulsing</option>
        <option value="Queztocoatal">Queztocoatal</option>
        <option value="Rallos Zek">Rallos Zek</option>
        <option value="Raptor">Raptor</option>
        <option value="Rat">Rat</option>
        <option value="Ratman">Ratman</option>
        <option value="Reanimated Hand">Reanimated Hand</option>
        <option value="Recuso">Recuso</option>
        <option value="Rock-gem Men">Rock-gem Men</option>
        <option value="Rockhopper">Rockhopper</option>
        <option value="Sarnak">Sarnak</option>
        <option value="Scarecrow">Scarecrow</option>
        <option value="Sea Horse">Sea Horse</option>
        <option value="Seru">Seru</option>
        <option value="Shade">Shade</option>
        <option value="ShikNar">ShikNar</option>
        <option value="Shissar">Shissar</option>
        <option value="Shrieker">Shrieker</option>
        <option value="Siren">Siren</option>
        <option value="Skeleton">Skeleton</option>
        <option value="Slarghilug">Slarghilug</option>
        <option value="Spectre">Spectre</option>
        <option value="Sphinx">Sphinx</option>
        <option value="StoneGrabber">StoneGrabber</option>
        <option value="Storm Mana">Storm Mana</option>
        <option value="Storm Taarid">Storm Taarid</option>
        <option value="Stormrider">Stormrider</option>
        <option value="Sun Revenant">Sun Revenant</option>
        <option value="Sunflower">Sunflower</option>
        <option value="Tarmok">Tarmok</option>
        <option value="Tegi">Tegi</option>
        <option value="Tentacle">Tentacle</option>
        <option value="Thought Horror">Thought Horror</option>
        <option value="Tin Soldier">Tin Soldier</option>
        <option value="Totem">Totem</option>
        <option value="Treant">Treant</option>
        <option value="Turtle">Turtle</option>
        <option value="Underbulk">Underbulk</option>
        <option value="Undetermined">Undetermined</option>
        <option value="Unicorn">Unicorn</option>
        <option value="Vampire">Vampire</option>
        <option value="Vegerog">Vegerog</option>
        <option value="Walrus">Walrus</option>
        <option value="Walrus Man">Walrus Man</option>
        <option value="Wasp">Wasp</option>
        <option value="Werewolf">Werewolf</option>
        <option value="Will O' Wisp">Will O' Wisp</option>
        <option value="Worm">Worm</option>
        <option value="Wraith">Wraith</option>
        <option value="Wrulon">Wrulon</option>
        <option value="Wurm">Wurm</option>
        <option value="Wyvern">Wyvern</option>
        <option value="Xalgoz">Xalgoz</option>
        <option value="Yak Man">Yak Man</option>
        <option value="Yeti">Yeti</option>
        <option value="Zelniak">Zelniak</option>
        ...
        <option value="Reptile">Reptile</option>
		  ...
		  <select name="eqsort">
              ...
              <tr>
                ...
                <td width="140"><img src="images/dot.gif" width="120" height="1"></td>
                <td width="240"><img src="images/dot.gif" width="120" height="1"></td>
                <td width="100"><img src="images/dot.gif" width="100" height="1"></td>
              </tr>
              <tr>
                <td width="260" colspan="2" height="30">
		  Found In:
                  <select name="zone">
...
<option value="antonica">Antonica
<option value="artifact">Artifacts
<option value="barindu">Barindu - The Hanging Gardens
<option value="bothunder">Bastion of Thunder
<option value="bazaar">Bazaar
<option value="befallen">Befallen
<option value="blackburrow">Blackburrow
...
<option value="faydwer">Faydwer
<option value="feerrott">Feerrott
<option value="ferubi">Ferubi - Temple of Telosia
<option value="firiona">Firiona Vie
<option value="neriaka">Foreign Quarter
...
<option value="beholder">King Xorbb's Maze
<option value="kithicor">Kithicor Forest
<option value="kodtaz">Kod`Taz - Sullied Ritual Hall
<option value="kunark">Kunark
<option value="kurntower">Kurn's Tower
<option value="nightmareb">Lair of Terris Thule
<option value="trappedones">Lair of Trapped Ones
...
<option value="letalis">Mons Letalis
<option value="najena">Najena
<option value="natimbi">Natimbi - The Broken Shores
<option value="nedaria">Nedaria's Landing
<option value="nektulos">Nektulos Forest
<option value="neriakc">Neriak 3rd Gate
<option value="neriakb">Neriak Commons
...
<option value="qcat">Qeynos Catacombs
<option value="qeytoqrg">Qeynos Hills
<option value="qinimi">Qinimi - Court of Nihilia
<option value="qvic">Qvic - Prayer Grounds
<option value="poearthb">Ragrax, Stronghold of Twelve
<option value="rathemtn">Rathe Mountains
<option value="powater">Reef of Coirnav
<option value="rivervale">Rivervale
<option value="riwwi">Riwwi - Coliseum of Games
<option value="lxanvom">Ruins of Lxanvom
<option value="rujarkian">Rujarkian Hills
<option value="runnyeye">Runnyeye Citadel
<option value="sseru">Sanctus Seru
...
<option value="abysmal">The Abysmal Sea
...
<option value="thurgadin">Thurgadin
<option value="timourous">Timorous Deep
<option value="tipt">Tipt - The Treacherous Crags
<option value="torgiran">Torgiran Mines
<option value="tofs">Tower of Frozen Shadow
<option value="tox">Toxxullia Forest
<option value="traksteeth">Trakanon's Teeth
<option value="twilight">Twilight Sea
<option value="txevu">Txevu - Lair of the Elites
<option value="umbral">Umbral Plains
<option value="unknown">Unknown
<option value="guktop">Upper Guk
<option value="uqua">Uqua - The Ocean God Chantry
<option value="vpeak">Veeshan's Peak
...
<option value="vexthal">Vex Thal
<option value="vxed">Vxed - The Crumbling Caverns
<option value="wakeland">Wakening Land
<option value="warsliks">Warsliks Wood
...
<option value="yxtta">Yxtta - Pulpit of Exiles
</select>
		</td>
                <td width="240" align="center">
		  Class:
