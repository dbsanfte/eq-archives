...
<td width="468"><!--CNet AdSpace--><a target="blank" href="http://remotead.cnet.com/cgi-acc/clickthru.acc?clickid=0000c41d5eb735da00000000&adt=001:00:100&edt=xroadscon&cat=1:3828:2662748:&site=CN"><img src="http://a.r.tv.com/cnet.12h/Ads/Media/Images/Banners/dsi.windows2000respack.banner.gif" border=0 alt="Microsoft Windows 2000 Professional Resource Pack"  height="60" width="468"></a><!--/AdSpace--></td>
<td width="72" align="center"><a href="http://www.gamecenter.com/?pt.xr.fd..gc" target="_blank"><img src="http://www.xrgaming.net/gfx/cnet_logo.gif" width=60 border=0 alt="C|Net Gamecenter Alliance"></a></td>
</tr>
</table>
</td>
  </tr>
      ...
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
          ...
          <td width="601" height="320" valign="top">
            <form action="/npclist.php3" method="post" name="npcsearch">
		  ...
		  Type:
                  <select name="eqtype">
                    ...
                    <option value="grd">Guard</option>
                    <option value="gld">Guildmaster</option>
		  ...
		  <select name="eqrace">
                    ...
                    <option value="Aviak">Aviak</option>
		  ...
		  Levels:
		  <input type="text" name="minlvl" size="2" maxlength="2" value="0"> -
		  <input type="text" name="maxlvl" size="2" maxlength="2" value="99"></td>
		  ...
		  <select name="eqsort">
                    ...
                    <option value="minlvl">minlvl</option>
                    <option value="maxlvl">maxlvl</option>
                  </select></td>
              </tr>
              <tr>
                ...
                <td width="120"><img src="images/dot.gif" width="120" height="1"></td>
                <td width="120"><img src="images/dot.gif" width="120" height="1"></td>
                <td width="140"><img src="images/dot.gif" width="140" height="1"></td>
                <td width="100"><img src="images/dot.gif" width="100" height="1"></td>
              </tr>
              <tr><td width="600" colspan="5"><hr width="100%" size="1"></td></tr>
              <tr>
                <td width="500" colspan="4"><img src="images/dot.gif" width="120" height="1"></td>
                <td width="100" align="right"><input type="submit" name="submit" value="Search"></td>
              </tr>
              <tr>
	        <td width="600" colspan="5" align="left" valign="top">
                                    <b>Advanced NPC List</b><br>
                   Welcome to the new EQmaps' Advanced NPC List. Using the drop down menus
                   above you can find virtually any Merchant, Banker, Guildmaster, Guard,
                   or MOB across the vast land of Norrath. Making the decision of where to
                   fight next will no longer be a challenge simply select the level range
                   of beast you wish to fight and a list will be returned. Most of the list
		   is self explanatory but I'll go through each part in detail.<br><br>
                   <li>Show: Select the type of NPC you are looking for.
                   <li>Race: Select the race of the NPC you are looking for. ALL returns
		   all NPC's regardless of race.
                   <li>Class: Select the class of the NPC you are looking for. ALL returns
		   all NPC's regardless of class.
                   <li>Levels: Select the level range of the NPC you are looking for. All
		   NPC's who's average level range falls between the two numbers you enter
		   will be returned.
                   <li>Sort: Select the field you want the NPC's sorted by.
		   <li>Search: After making your selections just hit Search.
                   <br><br>
		   If you have any suggestions for improvement don't hesitate to ask. Thanks!<br>
		   - NiteRaven
                   	        </td>
	      </tr>
            </table>
