...
eqr['*'] = new Array('BRD','BST','BER','CLR','DRU','ENC','MAG','MNK','NEC','PAL','RNG','ROG','SHD','SHM','WAR','WIZ');
eqr['HUM'] = new Array('BRD','CLR','DRU','ENC','MAG','MNK','NEC','PAL','RNG','ROG','SHD','WAR','WIZ');
eqr['BAR'] = new Array('BST','BER','ROG','SHM','WAR');
eqr['DEF'] = new Array('CLR','ENC','MAG','NEC','ROG','SHD','WAR','WIZ');
eqr['DWF'] = new Array('BER','CLR','PAL','ROG','WAR');
eqr['ERU'] = new Array('CLR','ENC','MAG','NEC','PAL','SHD','WIZ');
eqr['GNM'] = new Array('CLR','ENC','MAG','NEC','PAL','ROG','SHD','WAR','WIZ');
eqr['HEF'] = new Array('BRD','DRU','PAL','RNG','ROG','WAR');
eqr['HFL'] = new Array('CLR','DRU','PAL','RNG','ROG','WAR');
eqr['HIE'] = new Array('CLR','ENC','MAG','PAL','WIZ');
eqr['OGR'] = new Array('BST','BER','SHD','SHM','WAR');
eqr['TRL'] = new Array('BST','BER','SHD','SHM','WAR');
eqr['ELF'] = new Array('BRD','DRU','RNG','ROG','WAR');
eqr['IKS'] = new Array('BST','MNK','NEC','SHD','SHM','WAR');
eqr['VAH'] = new Array('BRD','BST','BER','ROG','SHM','WAR');
eqr['FRG'] = new Array('CLR','PAL','SHM','WAR','WIZ');

var eqe = new Array(15);
eqe['Armor'] = new Array('*');
eqe['Weapon'] = new Array('*','1HS','2HS','1HB','2HB','Piercing','2HP','H2H','Archery','Throwing');
eqe['Misc'] = new Array('*','Container','Instrument','Bakery','Brewery','Gem','Held','Potion','Tinkered','Augmentation');
...
function checkAll(theForm) {
  for (i=0,n=theForm.elements.length;i<n;i++)
    if (theForm.elements[i].name.indexOf('iid') !=-1) theForm.elements[i].checked = true;
}