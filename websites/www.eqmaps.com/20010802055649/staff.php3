      ...
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
          ...
          <td width="601" valign="top">
            <b>EQmaps Staff Members</b> (4)<br><br>
...
Focus: Programming, Items<br>
Description: I work with NiteRaven to provide new features for EQmaps, and help to keep things around the site up-to-date.<br>
<br>
Name: <a href="mailto:darnavian@eqmaps.com">Darnavian Stoneheart</a><br>
Focus: Equipment Guru<br>
Description: I'm currently in charge of adding new items, writing quest descriptions and keeping the equipment database up to date.  I also respond to emails and sort through all the comments and make sure the EQmaps databases have correct information.<br>
<br>
          </td>
