...
<select name="god" onChange="loadM(this)">
<option>Gates of Discord
<option>------------------------
<option value="abysmal">Abysmal Sea
<option value="barindu">Barindu
<option value="emanfurnace">Emanating Furnace
<option value="ferubi">Ferubi
<option value="ikkinz">Ikkinz
<option value="inkuta">Inkuta
<option value="kodtaz">Kod`Taz
<option value="trappedones">Lair of Trapped Ones
<option value="natimbi">Natimbi
<option value="poolsludge">Pool of Sludge
<option value="purifyplant">Purifying Plant
<option value="qinimi">Qinimi
<option value="qvic">Qvic
<option value="riwwi">Riwwi
<option value="tipt">Tipt
<option value="txevu">Txevu
<option value="uqua">Uqua
<option value="vxed">Vxed
      ...
      <table border="0" cellspacing="0" cellpadding="0" bgcolor="#122134">
        ...
        <tr>
          ...
          <td width="601" valign="top">
            <b>EQmaps Favorite Links</b> (15)<br><br>
<a href="redirect.php3?id=8" target="_blank">AllaKhazam's Magical Realm</a> [354762 visitors since 12/06/1999]<br>
This website is a wonderful source of information. It's been up since the release of EverQuest and just never stopped growing in size. You can find information about virtually anything but perhaps it's greatest strength is quests.<br><br>
<a href="redirect.php3?id=6" target="_blank">Cazic-Thule Corner</a> [16025 visitors since 11/18/1999]<br>
A website dedicated to bringing you news, events, and information surrounding the Cazic-Thule server. Very well done community site for anyone wishing to get more involved. There is also a nice beastry section which I'm sure will help anyone no matter the server.<br><br>
<a href="redirect.php3?id=5" target="_blank">EQ Armor & Weapons Database</a> [45288 visitors since 11/18/1999]<br>
This is a very cool website, quite similar to my own with a specialization towards armor and weapons. Last checked they had over 2100 armor peices and 1200 weapons, I'm sure it won't stop there. Since the website is dedicated only to armor and weapons the author has taken great detail in allowing you to view weapons by skill, class, race, and a search too!<br><br>
<a href="redirect.php3?id=10" target="_blank">EQ Caster's Realm</a> [169542 visitors since 12/20/1999]<br>
One of my favorite sites, this was once known as EQ Enchanters. They now cover all casting class with creation guides, spell lists, and strategies. They always keep you up to date on the lastest news and changes (or nerfs). Many of the questions are answered by the magic guy at Verant himself, GZ.<br><br>
<a href="redirect.php3?id=7" target="_blank">EQ Classes: Necro</a> [36431 visitors since 11/18/1999]<br>
You guessed it, a site for the dark side in us all. Masters of the undead, at least in summoning them to do their evil bidding, EQ Necro provides everything you would expect from a class specific website: spells, equipment, research, and quests!<br><br>
<a href="redirect.php3?id=4" target="_blank">EQ Druids</a> [26073 visitors since 11/18/1999]<br>
No doubt the best resource for the fun loving Druid class! Geez, what can these guys not do?! I think about half the EQ population is green with envy after making a nice Druid friend. "The coolest class in Norrath", hehe I'll bet a few ice comets against that. :P<br><br>
<a href="redirect.php3?id=12" target="_blank">EQ Links</a> [55696 visitors since 01/21/2000]<br>
This site might be best described as a portal site for EverQuest. They link to the best sites for information regarding news, class guides, zone guides, equipment, trade skills, and much more! They don't just link to the site itself but to the information you are looking for on the sites that have it. Great concept, check it out!<br><br>
<a href="redirect.php3?id=17" target="_blank">EQ Prices</a> [7174 visitors since 02/25/2002]<br>
EQ Prices provides up to the minute graphs and statistics tracking the virtual economy of EverQuest. This site is the first of its kind, and is the "ultimate reference" for quickly finding the average selling price of thousands of items broken down by server.<br><br>
<a href="redirect.php3?id=13" target="_blank">EQ Shaman</a> [19830 visitors since 02/15/2000]<br>
A great looking site for the shaman class. You'll find the standard components to a class specific website: spell lists, guides, skills, trade skills (alchemy), and quests! Well worth a look even if your not one of those crazy shamans. ;)<br><br>
<a href="redirect.php3?id=19" target="_blank">EQ Spoilers</a> [22921 visitors since 05/21/2002]<br>
EQ Spoilers is the most advanced EverQuest database in existence. Quests, Equipment, Bestiary, Zones, Spells and Faction are all 100% integrated into one comprehensive database. This unique set up allows for a level of detail not available on other websites.<br><br>
<a href="redirect.php3?id=18" target="_blank">EQ'Lizer</a> [15461 visitors since 03/09/2002]<br>
EQ'Lizer is proud to be the original and most complete EverQuest spoiler site on the internet. Boasting a completely searchable database with nearly 8,000 items, over 2,000 spells, hundreds of quests, and so much more, it is easy to see why hundreds of thousands of players visit this site every month to get "the edge" on the game.<br><br>
<a href="redirect.php3?id=11" target="_blank">EverLore</a> [48404 visitors since 01/18/2000]<br>
This website has been up since EverQuest went retail back in March, 1999. Since then that have grown to a monstrous size with over 100,000 player submitted articles, news stories, items, quests, bestiary, and player comments. They have one of the best databases out there.<br><br>
<a href="redirect.php3?id=2" target="_blank">EverQuest Stratics</a> [39346 visitors since 11/18/1999]<br>
This is among the best News and Information sites about EQ. They have been around since the beginning and will always bring you the latest in game and development news. I owe these guys a big thank you for helping me get my site off it's feet. Thanks guys for being cool and not wearing "Official Verant Knee Pads" (hehe, baggle) like a few other sites are.<br><br>
<a href="redirect.php3?id=3" target="_blank">Graffë's Wizard Compilation</a> [22511 visitors since 11/18/1999]<br>
A great Wizard only site that I have only been introduced to recently. If you play a Wizard this site is a must visit to stay up on the latest nerfs to our wonderful class (I play one on the Karana server). If you don't play one visit it anyways! You can learn how to turn our arrogance into our own destruction. MUHAHAHA ;P<br><br>
<a href="redirect.php3?id=14" target="_blank">Seekers of Lore</a> [27165 visitors since 06/08/2000]<br>
Straight from their webpage: "Founded by the glorious MadWand and lead by the mighty Sorontar, the Seekers of Lore are devoted to collecting and cataloging all the EQ lore they can! Be it maps, quests, items or creative works by the players of EQ, we will have it here or link to where you can find it!"<br><br>
... 906629 enlightened visitors.          </td>
