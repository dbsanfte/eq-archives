          ...
          <form>
            <td><span class="text">Show Active Topics since</span> 
              <select name="show" onChange=ShowTopics(this)>
                <option value="1" selected>Last visit on 22/Dec/2003 at 8:35am</option>
...
<td bgcolor="#A0B0c0" background="" colspan="6" class="text">There are no Active Topics since Last visit on 22/Dec/2003 at 8:35am to display</td>
   </table>
  </td>
 </tr>
</table>
