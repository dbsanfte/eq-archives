...
<form method="get" name="frmSearch" action="search.asp" onSubmit="return CheckForm();" onReset="return confirm('Are you sure you want to reset the form?');">
    <table width="620" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#181732" height="8">
     <tr> 
      <td height="2" width="680"> 
        <table width="100%" border="0" align="center"  height="8" cellpadding="4" cellspacing="1">
          <tr > 
            <td align="left" width="57%" height="2"  bgcolor="#A0b0c0" class="tHeading" background="">Search For</td>
            <td height="2" width="43%" bgcolor="#A0b0c0" class="tHeading" background="">Search In</td>
          </tr>
          <tr bgcolor="#A0B0c0" background=""> 
            <td align="left" width="57%"  height="2" bgcolor="#A0B0c0" background=""> 
    ...
    <table width="620" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#181732" height="8">
     <tr> 
      <td height="24" width="680"> 
        <table width="100%" border="0" align="center"  height="8" cellpadding="4" cellspacing="1">
          <tr > 
            <td align="left" width="57%" height="2"  bgcolor="#A0b0c0" class="tHeading" background="">Search Forum</td>
            <td height="2" width="43%" bgcolor="#A0b0c0" class="tHeading" background="">Sort Results By</td>
          </tr>
          <tr bgcolor="#A0B0c0" background=""> 
            <td align="left" width="57%"  height="12" bgcolor="#A0B0c0" background=""> 
              <select name="forum">
