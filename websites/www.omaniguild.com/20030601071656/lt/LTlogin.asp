...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr class="background"> 
    <td class="background"><font class=smaller>Omani database running on www.omaniguild.com<br>
      BADGER!!!</font></td>
    <td class="background"> 
      <div align="right"><font class=smaller>Website and database: <a href="mailto:Tets@omaniguild.com?subject=From DKP Database"><font class=bglink> 
        Tets@omaniguild.com</font></a><br>
        DKP Interface code: <a href="mailto:Liltree@omaniguild.com?subject=From DKP Database"> 
