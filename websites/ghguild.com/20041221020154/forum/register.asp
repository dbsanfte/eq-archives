...
<form action="register.asp" method="post" name="postform" onsubmit="return validateReg(this)">
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
	  <tr> 
        ...
        <table border="0" cellspacing="1" cellpadding="4" width="100%">
          ...
          <tr> 
            <td  bgcolor="dedede"  class="msg"><ol> <br><li><b>(REQUIRED) - Use the correct spelling - first name - !! ONLY !! of your in game character. <br><br>(REQUIRED) you have to use a valid email to receive your login info. <br><br>Any applicants that don't follow these rules will have their accounts deleted and you will need to make a new account.</b><br><br>Example of a <b>GOOD</b> account -    <b>Kilrav</b><br>Example of a <b>BAD</b> account -   <b>Kilrav_Sucks</b> (valid sentiment but it makes for unhappy admins)<br><br><li><b>Registration is open for non Grey Hawke members to the public boards. Your registration may be revoked at any time, for any reason.</b> <br><br><li><b>I am at least 14 years old</b> <br><br><li><b>Admin has the right to modify/delete my messages and I agree and accept unconditionally that all actions on ghguild.com will be fully logged and any attempt to circumvent security measures will be turned over to the proper authorities. In the US, this is the FBI, so no messing around.</b> <br><br><br></ol> <br><br><b>If you agree to the rules above and also agree that Kilrav does indeed suck, please check the box below.</b> <br></td>
          </tr>
		  <tr>
  ...
  <tr>
	...
	<br><font color="ffffff">0.051</font><br>
...
objFormValidator.add (theForm.agree, "(theForm.agree.checked)", "You have to agree with the forum agreement first!", "literal") 
 
objFormValidator.add (theForm.login, /.+/, "Missing Required Fields!")
objFormValidator.add (theForm.login, "!loginUnsafe(theForm.login.value)", "A login name cannot contain any of the following characters: \n \< \> \" \' \% \; \) \( \& \+ \- \,", "literal")
objFormValidator.add (theForm.login, "!nameFilter(theForm.login.value)", "The login name you entered has been banned. \n\n Please use another login name to complete the form.", "literal")
objFormValidator.add (theForm.login, "isNaN(theForm.login.value)", "For Login name, please use at least one non-numeric character!", "literal")

objFormValidator.add (theForm.email, /.+/, "Missing Required Fields!") 
objFormValidator.add (theForm.email, "(!validateEmail(theForm.email.value))", "Incorrect E-mail Syntax", "literal") 
objFormValidator.add (theForm.email, "(!domainFilter(theForm.email.value))", "The e-mail domain you entered has been banned.\n\n Please use your other e-mail account to complete the form.", "literal") 



objFormValidator.add (theForm.password, /.+/, "Missing Required Fields!") 
objFormValidator.add (theForm.password, "theForm.password.value==theForm.passcom.value", "Your passwords do not match!", "literal")
