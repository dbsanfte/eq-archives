...
if (theForm.__password) theForm.__password.value = ".+;;==|==theForm.passcom.value"
if (theForm._password) theForm._password.value = "Missing Required Fields!;;Your passwords do not match!"
//-->
</script> 
</body>
</html>
