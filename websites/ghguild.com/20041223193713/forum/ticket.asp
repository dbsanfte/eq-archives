...
function jumpTo(s){
	if (s.options[s.selectedIndex].value !='') {
		self.location.href = "ticket.asp?smode=" +s.options[s.selectedIndex].value+"&tmode=0&sort=1";
		return 1;
	}
}

function closeTicketConfirm(rid){
	if (confirm("Are you sure you want to close the ticket?")){
		self.location.href='ticketpro.asp?mode=closeticket&reportid=&currpage=1&smode=1&tmode=0&sort=1'
	}
}

function deleteTicketConfirm(rid){
	if (confirm("Are you sure you want to delete the ticket and all its responses?")){
		self.location.href='ticketpro.asp?mode=deleteticket&reportid=&currpage=1&smode=1&tmode=0&sort=1'
	}
}

function deleteResponseConfirm(resid){
	if (confirm("Are you sure you want to delete this response?")){
		self.location.href='ticketpro.asp?mode=deleteresponse&reportid=&currpage=1&smode=1&tmode=0&sort=1&responseid='+resid
	}
}
...
<AREA SHAPE="rect" ALT="" COORDS="24,101,67,114" HREF="http://ghguild.com">
 ...
 <td width="20%" background="http://ghguild.com/forum/rightextend2.jpg" height="115"><td width="1" height="115" rowspan="2"></td></td>
    ...
    <table width="98%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
        <td><b><a href='default.asp'>All Forums</a> >> Ticket List &nbsp;</b></td>
      </tr>	
      ...
      <tr> 
        <td bgcolor="004580"> 
          <table border="0" cellspacing="1" cellpadding="4" width="100%">
            <tr bgcolor="006699"> 
			  <th nowrap colspan="6"><font color="FFFFFF" class="subhead">Ticket List</font></th>
            </tr>		  
			<tr>
			  <td colspan="6"  bgcolor="e6e6e6" >
			   	<table cellspacing="4" cellpadding="2" border="0" width="100%">
				<tr>
				    <td class="subhead" width="45%">Ticket Status</td>
				    <td class="subhead" width="55%">Ticket Filter</td>
				</tr>
				<tr>
				    <td>
					<table width="350" border="0" cellspacing="0" cellpadding="0">
				      <tr> 
						...
						<tr>
						    <td  bgcolor="dedede"  width="50%">Last Update:</td>
							<td  bgcolor="dedede"  width="50%">--</td>
						</tr>
						<tr>
						    <td  bgcolor="e6e6e6" >Latest Ticket:</td>
							<td  bgcolor="e6e6e6" >--</td>
						</tr>
						<tr>
						    <td  bgcolor="dedede" >Total Tickets:</td>
					...
					<select name="smode" onchange="jumpTo(this)">
						<option value="1" selected>Tickets I created</option>
            ...
            <tr bgcolor="006699"> 
			  <th nowrap width="5%"><font color="FFFFFF" class="subhead"><a href="ticket.asp?currpage=1&tmode=1&sort=0&smode=1"><img src="image/asc.gif" border=0 align="absmiddle"></a> <font color="FFFFFF" class="subhead">Status</font> <a href="ticket.asp?currpage=1&tmode=1&sort=1&smode=1"><img src="image/desc.gif" border=0 align="absmiddle"></a></th>
              <th nowrap width="5%"><font color="FFFFFF" class="subhead"><a href="ticket.asp?currpage=1&tmode=2&sort=0&smode=1"><img src="image/asc.gif" border=0 align="absmiddle"></a> <font color="FFFFFF" class="subhead">Priority</font> <a href="ticket.asp?currpage=1&tmode=2&sort=1&smode=1"><img src="image/desc.gif" border=0 align="absmiddle"></a></th>
			  <th nowrap width="45%"><font color="FFFFFF" class="subhead">Message Subject & Reason</font></th>
			  <th nowrap width="14%" align="center"><font color="FFFFFF" class="subhead">Ticket Owner</font></th>
			  <th nowrap width="15%" align="center"><font color="FFFFFF" class="subhead">Date Created</font></th>
			  <th nowrap width="16%"><font color="FFFFFF" class="subhead"><a href="ticket.asp?currpage=1&tmode=0&sort=0&smode=1"><img src="image/asc.gif" border=0 align="absmiddle"></a> <font color="FFFFFF" class="subhead"><u>Last Replier</u></font> <a href="ticket.asp?currpage=1&tmode=0&sort=1&smode=1"><img src="image/desc.gif" border=0 align="absmiddle"></a></th>
            </tr>
			
			<tr>
			  <td colspan="6" class="subhead"  bgcolor="dedede"  align="center"> <br>No tickets are available for viewing<br><br>
			  
			  </td>
			</tr>
			
			<tr bgcolor="006699">
				<th class="subhead" colspan="6">
