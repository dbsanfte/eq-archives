...
if (theForm.__signature) theForm.__signature.value = "==|.length<=255"
if (theForm._signature) theForm._signature.value = "Your Signature is too long! (Max.  255)"
if (theForm.__saysomething) theForm.__saysomething.value = "==|.length<=255"
if (theForm._saysomething) theForm._saysomething.value = "You say too much! (Max.  255)"
