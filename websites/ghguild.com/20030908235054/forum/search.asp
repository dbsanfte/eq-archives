...
<body onload="document.sform.phrase.focus();" >
...
<form method="get" action="searchpro.asp" onsubmit="return validateSearch(this)" name="sform">
...
<option value="cat_58" >[Public]</option>
<option value="1" >- - Public Forum</option>
<option value="2" >- - Geek Life</option>			 
			 	</select>	  
  ...
  <tr>
	...
	<br><font color="ffffff">0.020</font><br>
