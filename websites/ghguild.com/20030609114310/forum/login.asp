...
<script language="JavaScript" src ='js/md52.js'></script>
...
function validateLogin(form) {
	if (form.Login.value.trim()!="" && form.password.value.trim()!=""){
		...
		if(md5_vm_test()){
			form.password.value = hex_md5(form.password.value+StringToHex("SQKVQLSXPPIBPAGOENGIVPOLUSEPBECIJRCCHMJY"))
			form.md5capable.value = "true";
		}
...
<body scroll="no" onload="document.forms[0].Login.focus();"   style="margin:0px 0px 0px 0px">
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
<form method="post" action="login.asp" onsubmit="return validateLogin(this)" AUTOCOMPLETE="off">
	<tr> 
	  <td bgcolor="004580" align="center"> 
		<table width='100%' border='0' cellspacing='1' cellpadding='4' height="100%">
		  ...
		  <tr> 
			<td  bgcolor="dedede" ><span class='c2'>Name: </span></td>
			<td  bgcolor="dedede" > 
	...
	<tr>
	  ...
	  <hr size="1" noshade><br>
		...
		<tr><td>
		<a href="lostpass.asp">My password ?</a>
		</td></tr>
		</table>
	  </td>
	</tr>
