<html>
 <head>
  <title>Prexus.com - Experience Calculator</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>                                                              
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_blue_01.jpg"><center><b>Experience Calculator</td>
		</tr>
		<tr>
		 <td>                            
	                                   

Select the Class, Race, and Level of your character.  Then select the level of the creatures you are fighting, along with the location.<br>
<br>
All Class/Race combinations are allowed, even those that do not exist, for those of you who would like to see how it would work out.<br>
<br>



      <center>
        <form action="/cgi-bin/exp_calculator2.pl" method="post">
      <table border=0 cellspacing=3 cellpadding=0>
        ...
        <tr><td>Mob Location</td>
		    <td><select name="moblocation">
                <option>Outdoors
                <option>Indoors
				</select>
			</td>
...
<br>
Data above level 50 may not be completely accurate.  Please <a href="mailto:Twygg@Prexus.com">Email me</a> to correct any errors you may find.<br>
<br>
