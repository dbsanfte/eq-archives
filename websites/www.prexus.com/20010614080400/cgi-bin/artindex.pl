<html>
 <head>
  <title>Prexus.com - Art Gallery</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>                                                              
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_blue_01.jpg"><center><b>Art Gallery</td>
		</tr>
		<tr>
		 <td>                            
		  ...
		  <br>
		  <a href="mailto:art@Prexus.com">Submit</a> your artwork for display in the gallery!<br>
		  <br>
		  <br>
          </td>
		 </tr>
