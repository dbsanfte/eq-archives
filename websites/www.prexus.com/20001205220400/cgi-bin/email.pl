<html>
 <head>
  <title>Prexus.com - Prexus.com Email</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>                                                              
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_blue_01.jpg"><center><b>Prexus.com Email</td>
		</tr>
		<tr>
		 <td>                            
	                                   

        So you'd like an email address that everyone you play with can remember?  Now you can have <i>yourgamename@Prexus.com</i>.<br>
		<br>
		Just fill out the short form below and we'll set you up with a new email address that will <b>forward</b> mail to your current address.  That way you won't have to worry about checking two different places each day for new messages.<br>
		<br>
		You are limited to one email forwarding address, so please use your main character's name.<br>
		<br>
		<center>
		<form action="/cgi-bin/email2.pl" method="post">
      <table border=0 cellspacing=3 cellpadding=0>
        <tr><td>Your Real Name</td>                  <td><input type="text" name="realname" size="40"></td></tr>
        <tr><td>Your Game Name(First name only)</td> <td><input type="text" name="gamename" size="40"></td></tr>
        <tr><td>Current Email Address</td>           <td><input type="text" name="email" size="40"></td></tr>
