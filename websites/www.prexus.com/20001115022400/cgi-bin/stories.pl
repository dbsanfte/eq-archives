<html>
 <head>
  <title>Prexus.com - Tales and Adventures</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>                                                              
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_blue_01.jpg"><center><b>Tales and Adventures</td>
		</tr>
		<tr>
		 <td>                            
		...
		<br>
		<br>
		<a href="mailto:stories@Prexus.com">Submit</a> your stories to have them displayed here!<br>
