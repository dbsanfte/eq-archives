<html>
 <head>
  <title>Prexus.com - The Prexus Language Fair</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>                                                              
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_blue_01.jpg"><center><b>The Prexus Language Fair</td>
		</tr>
		<tr>
		 <td>                            
	                                   

	    Every Wednesday evening, at 8:00pm eastern time, in the Great Tunnel of the East Commonlands, the master linguists of Norrath convene to share their knowledge of languages with each other.  It is a wonderous site to behold, as beings of all races speak in many different tongues, in an attempt to pass on their languages to those around them.<br>
		<br>
		Whether you come to teach, learn, or just watch, be sure to attend the Language Fair of Prexus!<br>
          </td>
		 </tr>
		</table>
