<html>
 <head>
  <title>Prexus.com - Edit Profile</title>
  <style type="text/css">
  <!--
    ...
    <tr>
     ...
     <td valign=top width=470>                                                              
      ...
      <table border=0 cellpadding=3 cellspacing=0 width=475>
	    <tr>
         <td style="font-weight: bold; font-size: 10pt;" background="/images/bg_heading_blue_01.jpg"><center><b>Edit Profile</td>
		</tr>
		<tr>
		 <td>                            
	                                   

	    <form action="/cgi-bin/profile_edit2.pl" method="post">
