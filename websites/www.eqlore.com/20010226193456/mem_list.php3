...
<TABLE CELLSPACING = 0 CELLPADDING = 0 BORDER = 0><TR><TD width="63"><IMG SRC = "graphics/topc000.jpg" WIDTH = 63 HEIGHT = 87></TD><TD width="473"><IMG SRC = "graphics/topc001.jpg" WIDTH = 473 HEIGHT = 87></TD><TD width="64"><IMG SRC = "graphics/topc002.jpg" WIDTH = 64 HEIGHT = 87></TD></TR><TD width="63"></TD><TD BGCOLOR="#BEA279" width="460"><DIV ALIGN="CENTER"><TABLE WIDTH="460" CELLPADDING="4"><TR><TD><DIV ALIGN="CENTER">List members sorted by server.<BR><FORM ACTION="members.php3" METHOD="POST"><INPUT TYPE="Hidden" NAME="action" VALUE="serversearch"><SELECT NAME="server"><OPTION>Rodcet Nife<OPTION>Bertoxxulous<OPTION>Innoruuk<OPTION>Veeshan<OPTION>Xegony<OPTION>Tarew Marr<OPTION>Morell-Thule<OPTION>Bristlebane<OPTION>The Rathe<OPTION>Quellios<OPTION>Tunare<OPTION>Tallon Zek<OPTION>Cazic-Thule<OPTION></SELECT>&nbsp;&nbsp;<INPUT TYPE="submit" VALUE="List members"></FORM></DIV><BR></TD></TR></TABLE><TD width="64"></TD><TR><TD><IMG SRC = "graphics/botc000.jpg" WIDTH = 63 HEIGHT = 87></TD><TD><IMG SRC = "graphics/botc001.jpg" WIDTH = 473 HEIGHT = 87></TD><TD><IMG SRC = "graphics/botc002.jpg" WIDTH = 64 HEIGHT = 87></TD></TR></TABLE></FORM><BR>
<SCRIPT LANGUAGE="JavaScript">
<!-- Hide from old browsers
now = new Date();
random = now.getTime();
