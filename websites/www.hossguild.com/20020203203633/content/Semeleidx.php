...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Semele Mooncaller<!-- 4 --></td>
	...
	<td background=temp6.jpg width=11%><!-- 5 -->Tunarian<!-- 6 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->2440<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->147<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->198<!-- 16 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 17 -->112<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->813<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->113<!-- 32 --></td>
	<td background=m2.jpg width=23%><b>Heat:</b></td>
	<td background=temp6.jpg width=10%><!-- 19 -->156<!-- 20 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 23 -->133<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	...
	<td background=temp6.jpg width=35%><!-- i9 -->Earring of Woven Bark<!-- i10 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Neck:</b></td>
	<td background=temp6.jpg width=35%><!-- i3 -->Gangels Talisman *<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Bone Ring of the Corpsemaster<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Diamond Wedding Band<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Bracer of Hammerfal<!-- i14 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i23 -->Meditative Blanket<!-- i24 --></td>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- 43 -->stats are self-buffed<br>
<br>
<br>
<br>
* Gangel.. the first dragon I tanked.. and lived!<!-- 44 -->
	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	...
	<p>Last Update: December 26, 2001</i><br>
	<a href=Semeleconfig.php>Edit Your Profile</a></font>
