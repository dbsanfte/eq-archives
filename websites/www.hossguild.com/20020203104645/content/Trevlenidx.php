...
<td width=100% valign=top>
	...
	<center><img src=C:\\WINDOWS\\Desktop\\Pics\\Trev Stats border=0></center>
	</td>
...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Trevlen<!-- 4 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->1648<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->113<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->102<!-- 16 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i1 -->Earring of Resistance<!-- i2 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i3 -->Amcillas Talisman<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Velum Diamond Wedding Band<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Velium Diamond Wedding Band<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Woven Grass Bracer<!-- i14 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i27 -->Silver Chains<!-- i28 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i29 -->Dweamorvine Garland =/<!-- i30 --></td>
	</tr>
	<tr>
	...
	<p>Last Update: January 25, 2002</i><br>
	<a href=Trevlenconfig.php>Edit Your Profile</a></font>
