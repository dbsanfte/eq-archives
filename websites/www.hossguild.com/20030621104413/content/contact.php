...
<!-- MAIN PART -->
	...
	<tr>
	<td height=25 width=17 background=titlel.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=25 width=* background=titlem.jpg style="font-family:arial;font-size:9pt;color:#D5D8F5"><b>Contact</b></td>
	<td height=25 width=17 background=titler.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	<td height=20 width=17 background=lo.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<font face=arial size=2>If you wish to contact members of Hoss you can either do this
over IRC (server: irc.enterthegame.com:6667, Channel: #Forsaken_heroes) or over the
messageboards.</p>

If you have any Feedback, questions or bug reports regarding our Site then you can mail to:<br>
<a href=mailto:andaas@hossguild.com>Andaas</a><br>
<a href=mailto:vegar@hossguild.com>Vegar</a></p>

Hehe and of course you can contact all of us in Everquest on the Druzzil Ro server =o
