...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Elyria<!-- 4 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->1952<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->100<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->60<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->759<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->147<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->45<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->514<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->92<!-- 32 --></td>
	<td background=m2.jpg width=23%><b>Heat:</b></td>
	<td background=temp6.jpg width=10%><!-- 19 -->70<!-- 20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>Mana:<b></td>
	<td background=temp6.jpg width=10%><!-- 41 -->3093<!-- 42 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->169<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i5 -->Dragon Scaled Mask<!-- i6 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i1 -->Black Sappire Electrum Earring<!-- i2 --></td>
	<td background=m2.jpg width=15%><b>Right Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i9 -->Black Sappire Electrum Earring<!-- i10 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i13 -->Bracer of the Deep Sea<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Silver Bracelet of Speed<!-- i20 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i17 -->Golden Efreeti Vambraces<!-- i18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Chest:</b></td>
	<td background=temp6.jpg width=35%><!-- i25 -->Robe of Benevolence<!-- i26 --></td>
	<td background=m2.jpg width=15%><b>Back:</b></td>
	<td background=temp6.jpg width=35%><!-- i27 -->Hierophants Cloak<!-- i28 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i33 -->Illusionists Shoes<!-- i34 --></td>
	</tr>
	<tr>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- 43 -->Unbuffed stats, Mana = +655 from items, +2400 for having 200 int at level 60, +36 for having 18 int over 200 at level 60, +2 for not being able to add<br>

(if thats what the mana equation is, anyways)<!-- 44 -->
	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	...
	<a href=Elyriaconfig.php>Edit Your Profile</a><br><i>If you are getting a blank screen after you click this link then you are most likely not logged in, you can log in <a href=http://www.hossguild.com/content/hglogin.php>here</a></font>
	</font>
</td>
