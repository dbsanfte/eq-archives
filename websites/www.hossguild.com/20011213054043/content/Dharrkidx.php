...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->3663<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->245<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->104<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->1315<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->217<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->97<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->1081<!-- 14 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 19 -->101<!-- 20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>Mana:</b></td>
	<td background=temp6.jpg width=10%><!-- 41 -->1927<!-- 42 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 35 -->125<!-- 36 --></td>
	<td background=m2.jpg width=23%><b>Poison:</b></td>
	<td background=temp6.jpg width=10%><!-- 23 -->99<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Wisdom:</b></td>
	<td background=temp6.jpg width=10%><!-- 37 -->81<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i27 -->Black Bear Pelt Cloak<!-- i28 --></td>
	</tr>
	<tr>
