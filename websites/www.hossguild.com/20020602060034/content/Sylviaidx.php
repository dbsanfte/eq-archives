...
<td width=100% valign=top>
	...
	<center><img src=http://www.hossguild.com/content/pics/syl1.jpg border=0></center>
	</td>
...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Sylvia Peacekeeper<!-- 4 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->3190<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->82<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->69<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->1061<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->90<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->68<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->737<!-- 14 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->86<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Truesight Helmet<!-- i8 --></td>
	<td background=m2.jpg width=15%><b>Face:</b></td>
	<td background=temp6.jpg width=35%><!-- i5 -->Sky Watchers Monocle<!-- i6 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i9 -->Earring of the Icecaster<!-- i10 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Neck:</b></td>
	<td background=temp6.jpg width=35%><!-- i3 -->Velium Black Sapphire Necklace<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Shadel Bandits Ring<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Golem Tear Ring<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Bracelet of Sense<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Supple Scale Armband<!-- i20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Hands:</b></td>
	<td background=temp6.jpg width=35%><!-- i15 -->Akkirus Gauntlets of the Risen<!-- i16 --></td>
	<td background=m2.jpg width=15%><b>Arms:</b></td>
	<td background=temp6.jpg width=35%><!-- i17 -->Chain Onyx Sleeves<!-- i18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Chest:</b></td>
	<td background=temp6.jpg width=35%><!-- i25 -->Chestplate of Stability<!-- i26 --></td>
	<td background=m2.jpg width=15%><b>Back:</b></td>
	<td background=temp6.jpg width=35%><!-- i27 -->Heirophants Cloak<!-- i28 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Shoulders:</b></td>
	<td background=temp6.jpg width=35%><!-- i23 -->Weight of the Gods<!-- i24 --></td>
	<td background=m2.jpg width=15%><b>Waist:</b></td>
	<td background=temp6.jpg width=35%><!-- i29 -->Bone-clasped Girdle<!-- i30 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Legs:</b></td>
	<td background=temp6.jpg width=35%><!-- i31 -->Onyx Chain Leggings<!-- i32 --></td>
	<td background=m2.jpg width=15%><b>Feet:</b></td>
	<td background=temp6.jpg width=35%><!-- i33 -->White Scale Boots<!-- i34 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Primary:</b></td>
	<td background=temp6.jpg width=35%><!-- i35 -->Blackstar, Mace of Night<!-- i36 --></td>
	<td background=m2.jpg width=15%><b>Secondary:</b></td>
	<td background=temp6.jpg width=35%><!-- i37 -->Orb of the Infinite Void<!-- i38 --></td>
	</tr>
	<tr>
...
Class:<!-- 44 -->
	...
	<p>Last Update: March 18, 2002</i><br>
	<a href=Sylviaconfig.php>Edit Your Profile</a></font>
