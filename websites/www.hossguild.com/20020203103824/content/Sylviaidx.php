...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=10%><!-- 37 -->214<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i11 -->Di`zok Begirdling<!-- i12 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i13 -->Ethereal Mist Bracer<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Boneweave, Bracer of the Enslaved<!-- i20 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i17 -->Akkirus Vambraces of the Risen<!-- i18 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i27 -->Iksar Hide Cape<!-- i28 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i33 -->Boots of Silent Striding<!-- i34 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Primary:</b></td>
	<td background=temp6.jpg width=35%><!-- i35 -->Water Spinkler of Nem`Ankh<!-- i36 --></td>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- 43 -->Need to update self buffed stats.<!-- 44 -->
	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	...
	<p>Last Update: January 31, 2002</i><br>
