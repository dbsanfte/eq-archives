...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Myztlee<!-- 4 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->2040<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->148<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->129<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->1005<!-- 12 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 17 -->106<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->893<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->112<!-- 32 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 41 -->3350<!-- 42 --></td>
	<td background=m2.jpg width=23%><b>Dextery:</b></td>
	<td background=temp6.jpg width=10%><!-- 33 -->121<!-- 34 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 35 -->99<!-- 36 --></td>
	<td background=m2.jpg width=23%><b>Poison:</b></td>
	<td background=temp6.jpg width=10%><!-- 23 -->106<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Wisdom:</b></td>
	<td background=temp6.jpg width=10%><!-- 37 -->238<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Wolf Callers Helm<!-- i8 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i1 -->Black Sapphire Electrum Earring<!-- i2 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i3 -->Onavas Talisman<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Ring of Winter<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Thorn Ring of the Seer<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Wolf Callers Bracer<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Wolf Callers Bracer<!-- i20 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i17 -->Wolf Callers Vambraces<!-- i18 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i27 -->Cloak of Piety<!-- i28 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Shoulders:</b></td>
	<td background=temp6.jpg width=35%><!-- i23 -->Shawl of Protection<!-- i24 --></td>
	<td background=m2.jpg width=15%><b>Waist:</b></td>
	<td background=temp6.jpg width=35%><!-- i29 -->Giant Scalemail Belt<!-- i30 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Legs:</b></td>
	<td background=temp6.jpg width=35%><!-- i31 -->Wolf Callers Greaves<!-- i32 --></td>
	<td background=m2.jpg width=15%><b>Feet:</b></td>
	<td background=temp6.jpg width=35%><!-- i33 -->Sirrans Boots of Insanity<!-- i34 --></td>
	</tr>
	<tr>
	...
	<a href=Myztleeconfig.php>Edit Your Profile</a></font>
