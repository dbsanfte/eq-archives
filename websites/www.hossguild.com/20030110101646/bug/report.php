...
<head>
    ...
    <title>phpBugTracker - Reporting</title>
  ...
  <tr>
	<td bgcolor="#000000" height="1" colspan="2"><img src="templates/default/images/spacer.gif" height="1" width="1"></td>
  	...
  	<tr>
		...
		<form method="post" action="/bug/report.php">
		&nbsp;
...
<form action="/bug/report.php">
Bug statistics for 
<select name="projectid" onChange="document.location.href='/bug/report.php?projectid='+this.options[this.selectedIndex].value">
	<option value="0">All projects</option>
	<option value="1">Bug Database</option></select>
<input type="submit" value="Go">
</form>

<h3>Bug Resolutions</h3>
