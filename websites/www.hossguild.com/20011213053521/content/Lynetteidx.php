...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=35%><!-- i17 -->Blighted Sleeves<!-- i18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Chest:</b></td>
	<td background=temp6.jpg width=35%><!-- i25 -->Netted Kelp Tunic / Blighted Robe<!-- i26 --></td>
...
(2404 Int, 390 Mana) According to Casters Realm...<!-- 44 -->
	...
	<a href=Lynetteconfig.php>Edit Your Profile</a><br><i>If you are getting a blank screen after you click this link then you are most likely not logged in, you can log in <a href=http://www.hossguild.com/content/hglogin.php>here</a></font>
	</font>
</td>
