...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Orrlaar<!-- 4 --></td>
	...
	<td background=temp6.jpg width=11%><!-- 5 -->Magician<!-- 6 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->-<!-- 10 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 15 -->-<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->-<!-- 12 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 17 -->-<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->-<!-- 14 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 19 -->-<!-- 20 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 21 -->-<!-- 22 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 23 -->-<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	...
	<td background=temp6.jpg width=35%><!-- i25 -->-<!-- i26 --></td>
	<td background=m2.jpg width=15%><b>Back:</b></td>
	<td background=temp6.jpg width=35%><!-- i27 -->-<!-- i28 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Shoulders:</b></td>
	<td background=temp6.jpg width=35%><!-- i23 -->-<!-- i24 --></td>
	<td background=m2.jpg width=15%><b>Waist:</b></td>
	<td background=temp6.jpg width=35%><!-- i29 -->-<!-- i30 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Legs:</b></td>
	<td background=temp6.jpg width=35%><!-- i31 -->-<!-- i32 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i35 -->-<!-- i36 --></td>
	...
	<a href=Orrlaarconfig.php>Edit Your Profile</a><br><i>If you are getting a blank screen after you click this link then you are most likely not logged in, you can log in <a href=http://www.hossguild.com/content/hglogin.php>here</a></font>
	</font>
</td>
