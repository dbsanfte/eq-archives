...
<td width=100% valign=top>
	...
	<center><img src=http://www.hossguild.com/Andaas/andaas.jpg border=0></center>
	</td>
...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Andaas<!-- 4 --></td>
	...
	<td background=temp6.jpg width=11%><!-- 5 -->Druid<!-- 6 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->1885<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->126<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->162<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->1114<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->111<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->136<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->793<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->130<!-- 32 --></td>
	<td background=m2.jpg width=23%><b>Heat:</b></td>
	<td background=temp6.jpg width=10%><!-- 19 -->140<!-- 20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>Mana:</b></td>
	<td background=temp6.jpg width=10%><!-- 41 -->4125<!-- 42 --></td>
	<td background=m2.jpg width=23%><b>Dextery:</b></td>
	<td background=temp6.jpg width=10%><!-- 33 -->106<!-- 34 --></td>
	<td background=m2.jpg width=23%><b>Magic:</b></td>
	<td background=temp6.jpg width=10%><!-- 21 -->154<!-- 22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Intelligence:</b></td>
	<td background=temp6.jpg width=10%><!-- 35 -->127<!-- 36 --></td>
	<td background=m2.jpg width=23%><b>Poison:</b></td>
	<td background=temp6.jpg width=10%><!-- 23 -->132<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Wisdom:</b></td>
	<td background=temp6.jpg width=10%><!-- 37 -->255<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->84<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Circlet of the Falinkan<!-- i8 --></td>
	<td background=m2.jpg width=15%><b>Face:</b></td>
	<td background=temp6.jpg width=35%><!-- i5 -->Mushroom Veil<!-- i6 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i1 -->Golden Leaf Earring<!-- i2 --></td>
	<td background=m2.jpg width=15%><b>Right Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i9 -->Treant Tear<!-- i10 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Neck:</b></td>
	<td background=temp6.jpg width=35%><!-- i3 -->Medal of Deep Thought<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Golden Championship Ring<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Velium Diamond Ring<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Velium Blue Diamond Bracelet<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Woven Grass Bracelet<!-- i20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Hands:</b></td>
	<td background=temp6.jpg width=35%><!-- i15 -->Gloves of Earthcrafting<!-- i16 --></td>
	<td background=m2.jpg width=15%><b>Arms:</b></td>
	<td background=temp6.jpg width=35%><!-- i17 -->Rowyls Metal Armguards<!-- i18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Chest:</b></td>
	<td background=temp6.jpg width=35%><!-- i25 -->Woven Grass Chestguard<!-- i26 --></td>
	<td background=m2.jpg width=15%><b>Back:</b></td>
	<td background=temp6.jpg width=35%><!-- i27 -->Cloak of the Sky<!-- i28 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Shoulders:</b></td>
	<td background=temp6.jpg width=35%><!-- i23 -->Wurm Claw Pauldrons<!-- i24 --></td>
	<td background=m2.jpg width=15%><b>Waist:</b></td>
	<td background=temp6.jpg width=35%><!-- i29 -->White Dragon Scale Sash<!-- i30 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Legs:</b></td>
	<td background=temp6.jpg width=35%><!-- i31 -->Woven Grass Greaves<!-- i32 --></td>
	<td background=m2.jpg width=15%><b>Feet:</b></td>
	<td background=temp6.jpg width=35%><!-- i33 -->White Dragonscale Boots<!-- i34 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Primary:</b></td>
	<td background=temp6.jpg width=35%><!-- i35 -->Sprinkler of the Spirits/<br>Primal Battlehammer/Epic<!-- i36 --></td>
	<td background=m2.jpg width=15%><b>Secondary:</b></td>
	<td background=temp6.jpg width=35%><!-- i37 -->Buckler of Insight<!-- i38 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Range:</b></td>
	<td background=temp6.jpg width=35%><!-- i39 -->Talisman of Benevolence<!-- i40 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	</table>
	...
	<p>Last Update: April 09, 2002</i><br>
	<a href=Andaasconfig.php>Edit Your Profile</a></font>
