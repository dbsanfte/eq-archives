...
<!-- MAIN PART -->
	...
	Comment:<br>
	<textarea name=comment cols=30 rows=10>no comment</textarea></p>
	
	<input type=submit value=\"Send File\"></p>
	Max file size is 150 Kbyte, also you can only upload jpg files.<br><font color=red><b></b></font>";
	}
	else {
	print "<center><b>Only Members of Hoss are able to upload pictures, you can view them <a href=ss1.php>here</a></b></center>
	";
	}
	?> 
	</form>
