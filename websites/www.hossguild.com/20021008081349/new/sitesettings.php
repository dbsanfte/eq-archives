...
<td width=548 background=images/bg1.jpg valign=top>
	...
	<td background=images/bg2.jpg width=502>
		...
		<td width=468 background=images/border2o.jpg height=17><font face=Arial size=2><b>Site Settings</b></font></td>
		...
		Counter: <b>139336</b> People have visited the Hossguild.com main site.<form action=changesettings.php method=post>
		...
		<tr>
		<td>Pass:</td>
		<td><input type=password size=15 name=APass></td>
		</tr>
		</table></p><b>News</b><br>
		Show <input type=text size=2 value=2 name=ShowNews> post(s).</p>
		<b>Roster</b><br>
		<input type=checkbox name=ShowAlts CHECKED>Show alternate character list.<br>
		<input type=checkbox name=ShowInactive >Show inactive members list.<br>
		<input type=checkbox name=ShowEmp >Show Emperor Key Status.<br>
		<input type=checkbox name=ShowVex >Show VexThal Key Status.</p>
		
		<center><input type=submit value="Change Settings"></center>
		</form>		</font></td>
