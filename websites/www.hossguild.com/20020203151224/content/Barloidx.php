...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Barlo<!-- 4 --></td>
	<td background=m2.jpg width=11%><b>Race:</b></td>
	<td background=temp6.jpg width=11%><!-- 25 -->Halfling<!-- 26 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->4385<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->225<!-- 28 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 11 -->1291<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->202<!-- 30 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 13 -->1154<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->126<!-- 32 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 41 -->OOM<!-- 42 --></td>
	<td background=m2.jpg width=23%><b>Dextery:</b></td>
	<td background=temp6.jpg width=10%><!-- 33 -->146<!-- 34 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 35 -->107<!-- 36 --></td>
	<td background=m2.jpg width=23%><b>Poison:</b></td>
	<td background=temp6.jpg width=10%><!-- 23 -->67<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Wisdom:</b></td>
	<td background=temp6.jpg width=10%><!-- 37 -->115<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->60<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Custom Champions Crown [AC 24 Str/Dex 2 Sta 7 HP 35 FR 3]<!-- i8 --></td>
	<td background=m2.jpg width=15%><b>Face:</b></td>
	<td background=temp6.jpg width=35%><!-- i5 -->Mask of the Sky [AC 12 HP 90 Saves 7]<!-- i6 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i1 -->Silver Gilded Tiny Skull Earring [AC 5 HP/Mana 20 DR 6]<!-- i2 --></td>
	<td background=m2.jpg width=15%><b>Right Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i9 -->Black Sapphire Electrum Earring [AC 2 HP 35 Mana 25]<!-- i10 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Neck:</b></td>
	<td background=temp6.jpg width=35%><!-- i3 -->Bile Etched Obsidian Choker [AC 10 Str/Sta/Dex 10 HP 100 Saves 5]<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Coldain Heros Insignia Ring [AC 9 Str/Sta 9 HP 50 MR 9 Shield of the Eighth]<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Velium Fire Wedding Ring [AC 6 HP 65]<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Bracelet of the Sky [AC 22 Str 5 HP 50 Saves 7]<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Silver Bracer of Speed [AC 38 Str/Sta/Wis/Int 10 HP 100 Saves 5 Haste]<!-- i20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Hands:</b></td>
	<td background=temp6.jpg width=35%><!-- i15 -->Guantlets of the Myrmidon [AC 27 Dex 8 HP 90]<!-- i16 --></td>
	<td background=m2.jpg width=15%><b>Arms:</b></td>
	<td background=temp6.jpg width=35%><!-- i17 -->Ancient Wyvern Hide Arms [AC 25 Sta 15 DR/PR 8]<!-- i18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Chest:</b></td>
	<td background=temp6.jpg width=35%><!-- i25 -->Breastplate of the Myrmidon [AC 54 Str 15 Dex/Agi 7 Sta 10 HP 90 FR/CR 5 DR/MR 10 Invigorate]<!-- i26 --></td>
	<td background=m2.jpg width=15%><b>Back:</b></td>
	<td background=temp6.jpg width=35%><!-- i27 -->Cloak of the Fearsome [AC 15 Str/Sta 15 HP 100]<!-- i28 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Shoulders:</b></td>
	<td background=temp6.jpg width=35%><!-- i23 -->Pauldrons of Ferocity [AC 20 Str/Sta 10 HP/Mana 20 Saves 5 Aura of Battle]<!-- i24 --></td>
	<td background=m2.jpg width=15%><b>Waist:</b></td>
	<td background=temp6.jpg width=35%><!-- i29 -->Belt of the Destroyer [AC 25 Str 10 Wis/Int 15 HP 75 FR 15 Haste]<!-- i30 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Legs:</b></td>
	<td background=temp6.jpg width=35%><!-- i31 -->Greaves of the Myrmidon [AC 40 Str/Dex/Agi 9 HP 40 MR 4]<!-- i32 --></td>
	<td background=m2.jpg width=15%><b>Feet:</b></td>
	<td background=temp6.jpg width=35%><!-- i33 -->Boots of the Vindicator [AC 30 Str/Sta/Wis/Int 5 HP 50 DR 13]<!-- i34 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Primary:</b></td>
	<td background=temp6.jpg width=35%><!-- i35 -->Sceptre of Destruction [12/18 Str/Dex/Sta 10 HP/Mana 50 proc: 288 DD stun]<!-- i36 --></td>
	<td background=m2.jpg width=15%><b>Secondary:</b></td>
	<td background=temp6.jpg width=35%><!-- i37 -->Primal Velium Warsword [13/20 AC 10 Stats 5 HP/Mana 50 Saves 5 proc Avatar]<!-- i38 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Range:</b></td>
	<td background=temp6.jpg width=35%><!-- i39 -->Primal Velium Bow [33/35 AC 10 Stats 5 HP/Mana 50 Saves 5 proc Avatar]<!-- i40 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	</table>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- 43 -->Chosen one of Rallos Zek, Professor of Beatology, Warlord of Rivervale. 4th Warrior Epic on Druzzil Ro.<br>
<br>
<br>
<br>
Resist Gear: 2 Velium Diamond Rings, Velium Jacinth Ring, Thex Dagger, Priceless Velium Warhammer, Crown of the Frogluk Kings, 2 Electrum Blue Diamond Earrings, Earring of Essence, Blue Resistance Stone, Shroud of the Dar Brood, Axe of Resistance.<br>
<br>
<!-- 44 -->
	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	...
	<a href=Barloconfig.php>Edit Your Profile</a></font>
