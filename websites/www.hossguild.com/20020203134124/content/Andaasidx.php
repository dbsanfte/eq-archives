...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=10%><!-- 15 -->170<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->989<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->94<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->117<!-- 18 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 31 -->120<!-- 32 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i5 -->Bone Mask of the Enslaved<!-- i6 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i1 -->Blue Diamond Electrum Earring<!-- i2 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i35 -->Sprinkler of the Spirits/Nature Walkers Scimitar<!-- i36 --></td>
	...
	<p>Last Update: January 15, 2002</i><br>
