...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Lepra<!-- 4 --></td>
	<td background=m2.jpg width=11%><b>Race:</b></td>
	<td background=temp6.jpg width=11%><!-- 25 -->Barbarian<!-- 26 --></td>
	<td background=m2.jpg width=11%><b>Class:</b></td>
	<td background=temp6.jpg width=11%><!-- 5 -->Shaman<!-- 6 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->2264<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->155<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->149<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->1148<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->153<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->137<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->lol<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->99<!-- 32 --></td>
	<td background=m2.jpg width=23%><b>Heat:</b></td>
	<td background=temp6.jpg width=10%><!-- 19 -->151<!-- 20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>Mana:</b></td>
	<td background=temp6.jpg width=10%><!-- 41 -->+700<!-- 42 --></td>
	<td background=m2.jpg width=23%><b>Dextery:</b></td>
	<td background=temp6.jpg width=10%><!-- 33 -->79<!-- 34 --></td>
	<td background=m2.jpg width=23%><b>Magic:</b></td>
	<td background=temp6.jpg width=10%><!-- 21 -->155<!-- 22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Intelligence:</b></td>
	<td background=temp6.jpg width=10%><!-- 35 -->119<!-- 36 --></td>
	<td background=m2.jpg width=23%><b>Poison:</b></td>
	<td background=temp6.jpg width=10%><!-- 23 -->104<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Wisdom:</b></td>
	<td background=temp6.jpg width=10%><!-- 37 -->232<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->74<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Mithril Helm<!-- i8 --></td>
	<td background=m2.jpg width=15%><b>Face:</b></td>
	<td background=temp6.jpg width=35%><!-- i5 -->Enshrouded Veil<!-- i6 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i1 -->Earring of Twisted Leaves<!-- i2 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i3 -->Amulet of the Dreadgazer<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->Ring of the Frozen Flame<!-- i12 --></td>
	<td background=m2.jpg width=15%><b>Right Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i21 -->Shadel Bandit Ring<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Bracelet of the Sky<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Boneweave<!-- i20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Hands:</b></td>
	<td background=temp6.jpg width=35%><!-- i15 -->Coldain Skin Gloves<!-- i16 --></td>
	<td background=m2.jpg width=15%><b>Arms:</b></td>
	<td background=temp6.jpg width=35%><!-- i17 -->Onyx Chain Sleeves<!-- i18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Chest:</b></td>
	<td background=temp6.jpg width=35%><!-- i25 -->Chestplate of Vindication<!-- i26 --></td>
	<td background=m2.jpg width=15%><b>Back:</b></td>
	<td background=temp6.jpg width=35%><!-- i27 -->Lodizal Shell Shield<!-- i28 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Shoulders:</b></td>
	<td background=temp6.jpg width=35%><!-- i23 -->Shawl of Perception<!-- i24 --></td>
	<td background=m2.jpg width=15%><b>Waist:</b></td>
	<td background=temp6.jpg width=35%><!-- i29 -->Grotesque Girdle<!-- i30 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Legs:</b></td>
	<td background=temp6.jpg width=35%><!-- i31 -->Wolf Caller Leggings<!-- i32 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i35 -->Sprinkler of the Spirits<!-- i36 --></td>
	<td background=m2.jpg width=15%><b>Secondary:</b></td>
	<td background=temp6.jpg width=35%><!-- i37 -->Shield of the Wurms<!-- i38 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Range:</b></td>
	<td background=temp6.jpg width=35%><!-- i39 -->Vyemms Left Eye<!-- i40 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	</table>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- 43 -->Stats unbuffed<br>
<br>
3 Innate Runspeed, 3 Innate Regen, 3 Mental Clarity, Cannibalization, 2 Quick Buff<br>
<br>
PoG BP / Spear of Fate / Jaundiced Bone Bracer bagged<!-- 44 -->
	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	...
	<p>Last Update: March 25, 2002</i><br>
	<a href=Lepraconfig.php>Edit Your Profile</a></font>
