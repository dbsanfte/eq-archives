...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Sirensa<!-- 4 --></td>
	<td background=m2.jpg width=11%><b>Race:</b></td>
	<td background=temp6.jpg width=11%><!-- 25 -->Dark Elf<!-- 26 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->2650<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->132<!-- 28 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 11 -->1112<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->167<!-- 30 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 33 -->82<!-- 34 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 35 -->121<!-- 36 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->67<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Halo of the Enlightened<!-- i8 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i1 -->Sanctum Guardians Earring<!-- i2 --></td>
	<td background=m2.jpg width=15%><b>Right Ear:</b></td>
	<td background=temp6.jpg width=35%><!-- i9 -->Blue Diamond Electrum Earring<!-- i10 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Neck:</b></td>
	<td background=temp6.jpg width=35%><!-- i3 -->Silver Charm of Tranquility<!-- i4 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i21 -->Shandel Bandit Ring<!-- i22 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i13 -->Akkirus Bracer of the Risen<!-- i14 --></td>
	<td background=m2.jpg width=15%><b>Right Wrist:</b></td>
	<td background=temp6.jpg width=35%><!-- i19 -->Akkirus Bracer of the Risen<!-- i20 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Hands:</b></td>
	<td background=temp6.jpg width=35%><!-- i15 -->Do`Vassirs Gauntlets of Might<!-- i16 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i25 -->Akkirus Chestplate of the Risen<!-- i26 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i31 -->Akkirus Greaves of the Risen<!-- i32 --></td>
	<td background=m2.jpg width=15%><b>Feet:</b></td>
	<td background=temp6.jpg width=35%><!-- i33 -->Akkirus Boots of the Risen<!-- i34 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i37 -->Orb of Infinite Void<!-- i38 --></td>
	</tr>
	<tr>
...
Rhedd sucks! =D<!-- 44 -->
	...
	<p>Last Update: December 17, 2001</i><br>
	<a href=Sirensaconfig.php>Edit Your Profile</a></font>
