...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->5897<!-- 10 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 11 -->1465<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->215<!-- 30 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 13 -->1367<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->240<!-- 32 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 33 -->215<!-- 34 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 37 -->117<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->109<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i7 -->Custom Crown of the Myrmidon<!-- i8 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i27 -->Cloak of the Fiercesome<!-- i28 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i33 -->Boots of the Myrmidon<!-- i34 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i37 -->Primal Velium Warsword<!-- i38 --></td>
	</tr>
	<tr>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- 43 -->AC/HP/ATK are buffed stats...since its \\\"Cool\\\" to show \\\"Unbuffed\\\" and Im not \\\"Cool\\\"<br>
...
<!-- 44 -->
	...
	<a href=Elkayconfig.php>Edit Your Profile</a><br><i>If you are getting a blank screen after you click this link then you are most likely not logged in, you can log in <a href=http://www.hossguild.com/content/hglogin.php>here</a></font>
	</font>
</td>
