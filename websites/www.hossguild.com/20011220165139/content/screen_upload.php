...
<td height=20 width=150 background=m2.jpg valign=top>
	...
	<td height=25 width=* background=titlem.jpg style="font-family:arial;font-size:9pt;font-weight:bold;color:#000000"><center>Navigation</center></td>
...
<a href=ss1.php onmouseover="Hover7()" onmouseout="Hover7_2()"><img src=screenshots.jpg border=0></a><br>	</td>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<center><a href=pics/noface.jpg target=_blank><img src=pics/noface.jpg width=100 height=100 border=0></a></center>	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	<td height=20 width=17 background=lu.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
...
<center><font face=Arial size=2><a href=hglogin.php>Member Login</a></font></center>
	...
	<td height=20 width=17 background=l.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=20 width=* background=m.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">
	<!-- NEW --><a href=index.php#9>December 18th: North Wing ToV</a><hr color=black><a href=index.php#8>stuff</a><hr color=black><a href=index.php#7>WTF - I'm the only one that do...</a><hr color=black><a href=index.php#6>Andy's boring no-screenshot ne...</a><hr color=black><a href=index.php#5>Narandi dies, Thurgadin saved</a><hr color=black><a href=index.php#4>Hossguild.com moving day</a><hr color=black><a href=index.php#3>Klandicar</a><hr color=black><a href=index.php#2>Vyemm and Vulak dead</a><hr color=black><a href=index.php#1>Ntov continued</a><hr color=black>	</td>
	<td height=20 width=17 background=r.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	<td height=20 width=17 background=lu.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
...
<!-- MAIN PART -->
	...
	<tr>
	<td height=25 width=17 background=titlel.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	<td height=25 width=* background=titlem.jpg style="font-family:arial;font-size:9pt;font-weight:bold;color:#000000"><!-- TITLE -->Upload a Screenshot</td>
	<td height=25 width=17 background=titler.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
	<td height=20 width=17 background=lo.jpg style="font-family:arial;font-size:9pt;color:#FFFFFF">&nbsp;</td>
	...
	<!-- TEXT -->
	<center><b>Only Members of Hoss are able to upload pictures, you can view them <a href=ss1.php>here</a></b></center>
