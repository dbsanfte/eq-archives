...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="nav">
  <tr>
	<td class="nav" valign="middle"><img name="title" src="../templates/default/admin/images/title.gif" width="500" height="50" border="0" alt="" hspace="0" vspace="0"></td>
  ...
  <tr>
	<td bgcolor="#9999FF" height="4" colspan="2"><img src="../templates/default/admin/images/spacer.gif" height="1" width="1"></td>
  </tr>
  <tr>
  ...
  <tr>
	<td bgcolor="#000000" height="1" colspan="2"><img src="../templates/default/admin/images/spacer.gif" height="1" width="1"></td>
  </tr>
  	<tr>
	    <td colspan="2" height="20" class="bottomnav">
		<form method="post" action="/bug/admin/site.php">
		&nbsp;
  ...
  <tr>
    ...
    <tr>
	<td bgcolor="#ffffff" height="20" colspan="2"><img src="../templates/default/admin/images/spacer.gif" height="1" width="1"></td>
  </tr>
</table>
