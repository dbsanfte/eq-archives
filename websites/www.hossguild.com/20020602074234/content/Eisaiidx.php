...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 -->Veteren Eisai Bot<!-- 4 --></td>
	...
	<td background=temp6.jpg width=10%><!-- 9 -->2868<!-- 10 --></td>
	<td background=m2.jpg width=23%><b>Strength:</b></td>
	<td background=temp6.jpg width=10%><!-- 27 -->200<!-- 28 --></td>
	<td background=m2.jpg width=23%><b>Cold:</b></td>
	<td background=temp6.jpg width=10%><!-- 15 -->125<!-- 16 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>AC:</b></td>
	<td background=temp6.jpg width=10%><!-- 11 -->1234<!-- 12 --></td>
	<td background=m2.jpg width=23%><b>Stamina:</b></td>
	<td background=temp6.jpg width=10%><!-- 29 -->188<!-- 30 --></td>
	<td background=m2.jpg width=23%><b>Disease:</b></td>
	<td background=temp6.jpg width=10%><!-- 17 -->44<!-- 18 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%><b>ATK:</b></td>
	<td background=temp6.jpg width=10%><!-- 13 -->1145<!-- 14 --></td>
	<td background=m2.jpg width=23%><b>Agility:</b></td>
	<td background=temp6.jpg width=10%><!-- 31 -->165<!-- 32 --></td>
	<td background=m2.jpg width=23%><b>Heat:</b></td>
	<td background=temp6.jpg width=10%><!-- 19 -->76<!-- 20 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 33 -->181<!-- 34 --></td>
	<td background=m2.jpg width=23%><b>Magic:</b></td>
	<td background=temp6.jpg width=10%><!-- 21 -->114<!-- 22 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 23 -->89<!-- 24 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	<td background=m2.jpg width=23%><b>Wisdom:</b></td>
	<td background=temp6.jpg width=10%><!-- 37 -->90<!-- 38 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=10%><!-- 39 -->65<!-- 40 --></td>
	<td background=m2.jpg width=23%>&nbsp;</td>
	<td background=temp6.jpg width=10%>&nbsp;</td>
	</tr>
	</table>
	...
	<td background=temp6.jpg width=35%><!-- i5 -->-Ancient Pirates Eyepatch<!-- i6 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i3 -->-Shadow Fang Necklace<!-- i4 --></td>
	<td background=m2.jpg colspan=2>&nbsp;</td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Left Finger:</b></td>
	<td background=temp6.jpg width=35%><!-- i11 -->-Reapers ring<!-- i12 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i15 -->-Mithril Guantlets<!-- i16 --></td>
	...
	<td background=temp6.jpg width=35%><!-- i29 -->-Ravenscale Belt<!-- i30 --></td>
	</tr>
	<tr>
	...
	<td background=temp6.jpg width=35%><!-- i33 -->-Ancient Wyvern Hide Boots<!-- i34 --></td>
	</tr>
	<tr>
	<td background=m2.jpg width=15%><b>Primary:</b></td>
	<td background=temp6.jpg width=35%><!-- i35 -->-Ancient Burrower Spine<!-- i36 --></td>
	<td background=m2.jpg width=15%><b>Secondary:</b></td>
	<td background=temp6.jpg width=35%><!-- i37 -->-Frosted Ice Spike<!-- i38 --></td>
	</tr>
	<tr>
	...
	<p>Last Update: April 20, 2002</i><br>
