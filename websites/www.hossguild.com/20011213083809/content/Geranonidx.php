...
<td width=100% valign=top>
	...
	<td background=temp6.jpg width=22%><!-- 3 --><!-- 4 --></td>
	<td background=m2.jpg width=11%><b>Race:</b></td>
	<td background=temp6.jpg width=11%><!-- 25 --><!-- 26 --></td>
	<td background=m2.jpg width=11%><b>Class:</b></td>
	<td background=temp6.jpg width=11%><!-- 5 --><!-- 6 --></td>
	<td background=m2.jpg width=11%><b>Level:</b></td>
	<td background=temp6.jpg width=11%><!-- 7 --><!-- 8 --></td>	
	</tr>
	</table>
	...
	<a href=Geranonconfig.php>Edit Your Profile</a><br><i>If you are getting a blank screen after you click this link then you are most likely not logged in, you can log in <a href=http://www.hossguild.com/content/hglogin.php>here</a></font>
	</font>
</td>
