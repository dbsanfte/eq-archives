...
<HEAD>
 ...
 <TITLE>Enlightened Dark - Send Private Message</TITLE>
...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
 <TR ALIGN="CENTER" VALIGN="BOTTOM">
  <TD ALIGN="CENTER" VALIGN="BOTTOM">
   <IMG SRC="http://www.enlighteneddark.org/Images/Banner11.jpg">
  </TD>
 </TR>
 <TR>
<TD>
...
<FORM ACTION="/Forums/sendpmsg.php" METHOD="POST">
	<TABLE BORDER="0" CELLPADDING="1" CELLSPACEING="0" ALIGN="CENTER" VALIGN="TOP" WIDTH="95%"><TR><TD  BGCOLOR="#030303">
	<TABLE BORDER="0" CALLPADDING="1" CELLSPACEING="1" WIDTH="100%">
	<TR ALIGN="LEFT">
		<TD  BGCOLOR="#030303"  width=25%>
...
<INPUT TYPE="TEXT" NAME="fromusername" SIZE="25" MAXLENGTH="40" VALUE=""> 
    ...
    <TR ALIGN="LEFT"> 
        <TD BGCOLOR="#030303" width=25%><b>Password:</b></TD> 
        <TD BGCOLOR="#202020"><INPUT TYPE="PASSWORD" NAME="password" SIZE="25" MAXLENGTH="25"></TD> 
    </TR> 
	<TR ALIGN="LEFT">
		<TD  BGCOLOR="#030303"  width=25%>
			<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<TD  BGCOLOR="#202020"><INPUT TYPE="TEXT" NAME="tousername" SIZE="25" MAXLENGTH="40" VALUE=""></TD>
	</TR>
	<TR ALIGN="LEFT">
		<TD  BGCOLOR="#030303" width=25%>
			<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
...
BBcode is:On<br>
		...
		<TD  BGCOLOR="#202020"><TEXTAREA NAME="message" ROWS=20 COLS=80 WRAP="VIRTUAL"></TEXTAREA></TD>
	</TR>
	<TR ALIGN="LEFT">
		<TD  BGCOLOR="#030303" width=25%>
			<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
