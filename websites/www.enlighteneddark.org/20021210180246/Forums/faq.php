...
<HEAD>
 ...
 <TITLE>Enlightened Dark - FAQ</TITLE>
...
<BODY onLoad="MM_preloadImages('http://www.enlighteneddark.org/Images/N-Login.gif','http://www.enlighteneddark.org/Images/N-News.gif','http://www.enlighteneddark.org/Images/N-Roster.gif','http://www.enlighteneddark.org/Images/N-Info.gif','http://www.enlighteneddark.org/Images/N-ScrapBook.gif','http://www.enlighteneddark.org/Images/N-Links.gif','http://www.enlighteneddark.org/Images/N-Keys.gif')">
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
 <TR ALIGN="CENTER" VALIGN="BOTTOM">
  <TD ALIGN="CENTER" VALIGN="BOTTOM">
   <IMG SRC="http://www.enlighteneddark.org/Images/Banner10.jpg">
  </TD>
 </TR>
 <TR>
<TD>
...
<table border="0" width="95%" bgcolor="#030303">
  <TR><TD>
<table border="0" width="100%" bgcolor=>
    <tr bgcolor="#030303">
        <td><font size="+1" face="sans-serif" color="#BCF5FE"><b>Frequently
          Asked Questions</font></b></td>
    </tr>
    <tr bgcolor="#202020">
        <td>
          <font size="2" face="sans-serif" color="#BCF5FE">
    ...
    <tr bgcolor="#030303">
        <td>
        <font color="#BCF5FE" size="2" face="sans-serif">
	...
	Registration is required.
        ...
        required to post your real name, however use of your primary EQ character's name is strongly encouraged. You are required to submit
	...
	<a href="/Forums/bb_register.php?mode=agreement">here</a></font>
	</td>
    </tr>
    <tr bgcolor="#030303">
        <td>
	...
	<table width="50%" ALIGN="CENTER" BGCOLOR="#030303" CELLSPACEING=1 BORDER="0">
	  <TR><TD>
	  <TABLE WIDTH="100%" BORDER="0">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_biggrin.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_smile.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_frown.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_eek.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_confused.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_cool.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_lol.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_mad.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_razz.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_redface.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_cry.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_evil.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_rolleyes.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
		...
		<td width="55">
			<IMG SRC="/Forums/images/smiles/icon_wink.gif">
		</td></tr>
		 <TR BGCOLOR="#202020">
		 <TD width="100">
		 	<FONT FACE="sans-serif" SIZE="2" COLOR="#BCF5FE">
	...
	<td>
	<font size="2" face="sans-serif" color="#BCF5FE">
	You may be able to use HTML in your posts.
	...
	administrator may have to edit your post (and flog you).
	</td>
	<tr bgcolor="#030303">
	<td>
...
<TR bgcolor="#202020"><TD><FONT SIZE="2" FACE="Verdana, Arial">
...
<tr bgcolor="#030303"><td>
<FONT SIZE="2" FACE="Verdana, Arial">
Email Links</FONT></td></tr>
<TR bgcolor="#202020"><TD>
<FONT SIZE="2" FACE="Verdana, Arial">
...
<P>
    ...
    <tr bgcolor="#202020">
	    ...
	    Moderators control individual
          ...
          <p>Anyone who posts just to increase their Enlightened Dark Forums stats or post topics out of
