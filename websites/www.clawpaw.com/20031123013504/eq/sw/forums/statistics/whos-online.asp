...
&nbsp;
   ...
   <td nowrap class="messagecellbody">22/11/2003  7:20 PM&nbsp;</td>   
   <td nowrap class="messagecellbody">22/11/2003  7:20 PM&nbsp;</td>
   
   <td nowrap class="messagecellbody"><span class="smalltext">Forums: Show Recent Threads&nbsp;</span></td>   
   
   <td nowrap class="messagecellbody">416&nbsp;</td>
...
&nbsp;
   ...
   <td nowrap class="messagecellbody">
   <a onclick="window.open('HTTP://www.clawpaw.com/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Beggly', 'bbspopup', 'height=575, width=575, scrollbars=yes'); return false;" target="bbspopup" href="/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Beggly">Beggly</a>&nbsp;
   </td>
   
   <td nowrap class="messagecellbody">22/11/2003  7:00 PM&nbsp;</td>   
   <td nowrap class="messagecellbody">22/11/2003  7:00 PM&nbsp;</td>
   
   <td nowrap class="messagecellbody"><span class="smalltext">Forums: Show Recent Threads&nbsp;</span></td>   
   
   <td nowrap class="messagecellbody">816&nbsp;</td>
...
Debug mode- seconds to render page: 0.046875
</body>