...
<html>
<head>
<title>Silent Watchers : Who's Online?</title>
<LINK REL="STYLESHEET" HREF="../schemes/retrieve-scheme.asp?schemeid=0">
<meta http-equiv="content-type" content="text-html; charset=utf-8"> 
<META HTTP-EQUIV="Refresh" Content = "300; URL=/eq/sw/forums/statistics/whos-online.asp&#63;">
...
<tr><td colspan="2"><div class="headercontrolbox"><span class="smalltext">You are currently browsing as a guest.<BR>You should <a href="HTTP://www.clawpaw.com/eq/sw/forums/logon.asp?redirect=/eq/sw/forums/statistics/whos-online.asp&#63;">logon</a> to access more features
</span></div></td></tr>
</table><hr width="90%" size="1"><div align="center" class="smalltext">[Random Quote] - Mr Churchill you are Drunk....Yes Madam, and you are ugly but in the morning I will be sober....<span style="white-space : nowrap"> - (Added by: <a onclick="window.open('HTTP://www.clawpaw.com/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Drokken', 'bbspopup', 'height=575, width=575, scrollbars=yes'); return false;" target="bbspopup" href="/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Drokken">Drokken</a>)</span></div><hr width="90%" size="1">

<table class="bbstable" cellspacing="1" width="85%" align="center">
<tr><td nowrap class="messagecellheader" colspan="6">Who's online right now : Silent Watchers</td></tr>

<tr><td nowrap class="messagecellheader2" width="15">&nbsp;</td>
    <td nowrap class="messagecellheader2">Username</td>
    
    <td nowrap class="messagecellheader2">Logon Time</td>    
    <td nowrap class="messagecellheader2">Last Activity</td>
    
    <td nowrap width="100%" class="messagecellheader2">Action</td>
    
    <td nowrap class="messagecellheader2" width="30">Total&nbsp;posts</td>
    
</tr>

<tr>
   <td nowrap class="messagecellbody">
&nbsp;
   </td>
   <td nowrap class="messagecellbody">
   <a onclick="window.open('HTTP://www.clawpaw.com/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Dictator_Sowmany', 'bbspopup', 'height=575, width=575, scrollbars=yes'); return false;" target="bbspopup" href="/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Dictator_Sowmany">Dictator_Sowmany</a>&nbsp;
   </td>
   
   <td nowrap class="messagecellbody">1/9/2003  2:42 AM&nbsp;</td>   
   <td nowrap class="messagecellbody">1/9/2003  2:42 AM&nbsp;</td>
   
   <td nowrap class="messagecellbody"><span class="smalltext">Forums: Show Recent Threads&nbsp;</span></td>   
   
   <td nowrap class="messagecellbody">349&nbsp;</td>
   
 </tr>
 

</table>
<table align="center" width="85%"><tr><td align="right">(Names are removed after 30 minutes of inactivity)</td></tr></table><BR>
...
Debug mode- seconds to render page: 0.082031
</body>