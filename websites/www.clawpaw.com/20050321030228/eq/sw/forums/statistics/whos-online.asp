...
</table><hr width="90%" size="1"><div align="center" class="smalltext">[Random Quote] - 2 most used quotes around...rez inc Bassalisk, rez inc Drokken<span style="white-space : nowrap"> - (Added by: <a onclick="window.open('HTTP://www.clawpaw.com/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Drokken', 'bbspopup', 'height=575, width=575, scrollbars=yes'); return false;" target="bbspopup" href="/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Drokken">Drokken</a>)</span></div><hr width="90%" size="1">
...
<a target="_blank" href="http://premium.xanga.com/home.aspx&#63;user=Billybobtheranger"><img alt="homepage" border=0 src="HTTP://www.clawpaw.com/eq/sw/forums/images/homepage.gif"></a>&nbsp;
   </td>
   <td nowrap class="messagecellbody">
   ...
   <td nowrap class="messagecellbody">20/3/2005  9:10 PM&nbsp;</td>   
   <td nowrap class="messagecellbody">20/3/2005  9:10 PM&nbsp;</td>
   
   <td nowrap class="messagecellbody"><span class="smalltext">Forums: Thread View&nbsp;</span></td>   
   
   <td nowrap class="messagecellbody">807&nbsp;</td>
