...
</table><hr width="90%" size="1"><div align="center" class="smalltext">[Random Quote] - Never tick off the Druid you might need Him/Her someday :)<span style="white-space : nowrap"> - (Added by: <a onclick="window.open('HTTP://www.clawpaw.com/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Trissleena', 'bbspopup', 'height=575, width=575, scrollbars=yes'); return false;" target="bbspopup" href="/eq/sw/forums/edit-profile.asp?action=view&amp;viewusername=Trissleena">Trissleena</a>)</span></div><hr width="90%" size="1">
...
&nbsp;
   ...
   <td nowrap class="messagecellbody">12/4/2005  5:35 PM&nbsp;</td>   
   <td nowrap class="messagecellbody">12/4/2005  5:37 PM&nbsp;</td>
   
   <td nowrap class="messagecellbody"><span class="smalltext">Forums: Thread View&nbsp;</span></td>   
   
   <td nowrap class="messagecellbody">1454&nbsp;</td>
