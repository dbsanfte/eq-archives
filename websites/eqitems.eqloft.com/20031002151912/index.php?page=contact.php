...
<table width="500" CLASS="table_bord" cellpadding="1" cellspacing="1">
  	<td>
	<table width="500" cellspacing="0" cellpadding="0">
    	<tr>
      		<td CLASS="main_entete">Contact
	  		</td>
		</tr>
		<tr>
			<td CLASS="main_corps">
			<b>Si vous souhaitez me contacter pour me faire part de vos suggestions, remarques, critiques, observations et j'en passe :</b><br><br>
			Sur l'Auberge EQLoft : Kinderpingui<br>
			Par mail : kinderpingui@eqloft.com<br>
			In game : Musaraigne sur le serveur Erollisi Marr
			<br>
			<br>
			<b>Remerciements :</b>
			<br>
			<a href="http://www.eqloft.com">Eqloft</a> pour l'hébergement<br>
			Zqren pour son aide à la conception du site<br>
			Cyril pour son aide à la conception de la base de données<br>
