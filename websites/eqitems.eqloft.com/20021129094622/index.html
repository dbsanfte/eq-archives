...
<table width="760">
  ...
  <table width="460" CLASS="table_bord" cellpadding="1" cellspacing="1">
    <td>
      <table width="460" cellspacing="0" cellpadding="0">
        <tr>
	  <td CLASS="main_entete">11/10/2002</td>
	</tr>
	<tr>
	  <td CLASS="main_corps">- Mise à jour du moteur de recherche : plus de stats disponibles, et affichage des résultats sur la même page<br><br>- Mise à jour des items<br><br>Les zones et le moteur de recherche des spells arrivent bientôt.. en Verant Time (tm) :P</td>
	</tr>
      </table>
    </td>
  </table>
  ...
  <table width="460" CLASS="table_bord" cellpadding="1" cellspacing="1">
    <td>
      <table width="460" cellspacing="0" cellpadding="0">
        <tr>
	  <td CLASS="main_entete">30/08/2002</td>
	</tr>
	<tr>
	  <td CLASS="main_corps">Mise à jour des items :<br>
- ajout des focus items<br>
- ajout d'items variés : poisons rogues, crafted items etc</td>
	</tr>
      </table>
    </td>
  </table>
  ...
  <table width="460" CLASS="table_bord" cellpadding="1" cellspacing="1">
    <td>
      <table width="460" cellspacing="0" cellpadding="0">
        <tr>
	  <td CLASS="main_entete">26/08/2002</td>
	</tr>
	<tr>
	  <td CLASS="main_corps">EQItems ouvre ses portes :)<br><br>Pour l'instant seuls la recherche d'items et la liste des sorts par classe sont disponibles, le reste viendra sous peu.<br><br>N'hésitez pas à me faire part de vos commentaires, critiques ou observations !</td>
	</tr>
      </table>
    </td>
  </table>
