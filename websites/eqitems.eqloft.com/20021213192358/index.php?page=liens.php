...
<table width="500" CLASS="table_bord" cellpadding="1" cellspacing="1">
	...
	<table width="500" cellspacing="0" cellpadding="0">
    	<tr>
      		<td CLASS="main_entete">Liens
	  		</td>
		</tr>
		<tr>
			<td CLASS="main_corps">

	<b><a href="http://www.eqloft.com" target="_new">EQLoft :</a></b><br>
	Le site de la communauté européenne d'Everquest.
	<br><br>	
	
	<b><a href="http://irreductibles.eqloft.com/Webtrade/" target="_new">Webtrade :</a></b><br>
	Vous ne souhaitez plus passer des heures au tunnel ou au bazaar pour vendre vos items ? Passez votre annonce ici !
	<br><br>	
	
	<b><a href="http://equetes.eqloft.com" target="_new">EQuetes :</a></b><br>
	Base de données des quêtes d'Everquest avec un moteur de recherche.
	<br><br>	
	
	<b><a href="http://pub35.ezboard.com/bthesafehouse" target="_new">Safehouse :</a></b><br>
	Un très bon forum sur la classe de Rogue et EQ en général
	<br><br>	
