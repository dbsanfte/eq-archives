...
<table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
  <tr>
    ...
    <table border="0" width="500" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td class="header">Retrieve Password</td>
      </tr>
      <tr>
        <td class="txt">If your here because you've forgotten your password, enter your character name in the box below and hit retrieve.
		Your current password will be delivered to the email address you have registered for your account.</td>
      </tr>
	  <tr>
  	    <td class="notice"></td>
	  </tr>
      <tr>
        <td align="center" class="txt">Username
		<input type="text" name="username" size="20" value="">
		<input type="submit" value="Retrieve my Password" class="formInput"></td>
      </tr>
