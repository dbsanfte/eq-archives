...
<head>
<title>Dark Templars Everquest Guild</title>
<meta name="ROBOTS" content="index, follow">
<meta name="description" content="Dark Templars, an online player guild for the SOE game, Everquest.">
<meta name="keywords" content="dark templars, guild, everquest, uk raiding guilds, guilds, eq guilds, online gaming, mmorpg">
<meta name="author" content="al@functionfirst.co.uk">
<meta name="abstract" content="Dark Templars Guild, an everquest raiding guild on the Xegony server.">
  ...
  <tr>
    <td valign="top" width="50%">
	  <table border="0" cellspacing="0" cellpadding="0" width="100%">
	    <tr>
		  <td width="4" height="4"><img src="images/headTL.jpg" border="0"></td>
		  <td background="images/headT.jpg"><img src="images/shim.gif" height="4" width="1"></td>
		  <td width="4" height="4"><img src="images/headTR.jpg" border="0"></td>
		</tr>
		<tr>
		  <td background="images/headL.jpg" width="4"><img src="images/shim.gif" height="1" width="4" border="0"></td>
		  <td background="images/headDBG.jpg">
		    <table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr>
			    <td colspan="3"><img src="images/shim.gif" height="12" width="1"></td>
			  </tr>
			  <tr>
			    <td width="10"><img src="images/shim.gif" height="1" width="10"></td>
			    <td><img src="images/headNews.jpg"></td>
				<td width="10"><img src="images/shim.gif" height="1" width="10"></td>
			  </tr>
			  <tr>
			    <td colspan="3"><img src="images/shim.gif" height="12" width="1"></td>
			  ...
			  <tr>
			    <td><img src="images/shim.gif" height="1" width="1"></td>
				<td>
				  <table border="0" cellspacing="1" cellpadding="5" bgcolor="#000000" width="100%">
				    <tr>
					  <td background="images/headLBG.jpg" class="txt">[10/04] <img src="images/bullet.gif"><a href="index.asp?id=118" class="link">Gods, GoD and OMG I zone slow in OoW</a><br>
[22/07] <img src="images/bullet.gif"><a href="index.asp?id=117" class="link">Part of the pack....?</a><br>
[04/07] <img src="images/bullet.gif"><a href="index.asp?id=116" class="link">Bored of BoT??</a><br>
[09/06] <img src="images/bullet.gif"><a href="index.asp?id=115" class="link">They think its all over...</a><br>
[01/05] <img src="images/bullet.gif"><a href="index.asp?id=114" class="link">Innoruuk the face down clown</a><br>

					  <img src="images/shim.gif" height="4" width="1" alt="Spacer"><br>
					  <a href="archives.asp" class="smllnk"><img src="images/headViewArchives.jpg" border="0"></a></td>
					</tr>
				  </table>
				</td>
			  ...
			  <tr>
			    <td colspan="3"><img src="images/shim.gif" height="10" width="1"></td>
			  </tr>
			</table>
		  </td>
		  <td background="images/headR.jpg" width="4"><img src="images/shim.gif" height="1" width="4" border="0"></td>
		</tr>
		<tr>
		  <td width="4" height="4"><img src="images/headBL.jpg" border="0"></td>
		  <td background="images/headB.jpg"><img src="images/shim.gif" height="4" width="1"></td>
		  <td width="4" height="4"><img src="images/headBR.jpg" border="0"></td>
		</tr>
	  </table>
	</td>
	<td valign="top" width="50%">
<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
		  ...
		  <td background="images/headDBG.jpg">
		    <table border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <tr>
			    <td width="10"><img src="images/shim.gif" height="1" width="10"></td>
			    <td><img src="images/headWelcome.jpg"></td>
				<td width="10"><img src="images/shim.gif" height="1" width="10"></td>
			  </tr>
			  <tr>
			    <td colspan="3"><img src="images/shim.gif" height="12" width="1"></td>
			  ...
			  <tr>
				...
				<td>
				  <table border="0" cellspacing="1" cellpadding="5" bgcolor="#000000" width="100%">
				    <tr>
					  <td background="images/headLBG.jpg" class="txt">[11/02] <img src="images/bullet.gif"><a href="viewdetails.asp?mID=334" class="link">Aryes</a><br>[26/10] <img src="images/bullet.gif"><a href="viewdetails.asp?mID=333" class="link">Reizvoll</a><br>[26/10] <img src="images/bullet.gif"><a href="viewdetails.asp?mID=332" class="link">Touanne</a><br>[22/10] <img src="images/bullet.gif"><a href="viewdetails.asp?mID=331" class="link">Sherish Broganie</a><br>[22/10] <img src="images/bullet.gif"><a href="viewdetails.asp?mID=330" class="link">Kroste</a><br>
					  <img src="images/shim.gif" height="4" width="1" alt="Spacer"><br>
					  <a href="rolecall.asp" class="smllnk"><img src="images/headViewMembers.jpg" border="0"></a></td>
					</tr>
				  </table>
				</td>
				<td><img src="images/shim.gif" height="1" width="10"></td>
  ...
  <tr>
    <td colspan="2"><b>Gods, GoD and OMG I zone slow in OoW - 10/04/2004</b>
  <div class="txt"><h3>What have you guys been up to ?</h3>

Well, we have been a bit quiet recently with doing backflagging for Time to get our newer recruits flagged to join the fun. But when not messing with PoP Gods we have been in GoD, farming Yxxta and messing a bit in Uqua, whilst working on the final Ikkinz trial which is about to fall beneath us (if only I wasnt LD again)....
<br>
<h3>Omens of War</h3>
As you know this expansion came out a couple of weeks ago, and with it came the laborious task of getting to 70 as soon as possible. 
Props go to Alizia after only a few days she became our first Vanquisher and Level 70 :-)
<br>
Guild activity since OoW has been a little scarce what with working on Epics (OMG I thought we had finished with these), Leveling and new AAs etc, but we have done a fair few raid encounters, killing first time this guy
<br>
<br>
<IMG src="http://everquest.allakhazam.com/monsterpics/Hulcror.JPG"  border="0" alt="Hulcror">
<br>
Was a close call, but we got him, grats to the winners
<br>
<br>
<h4>Other corpses baring DT shaped cuts and bruises</h4>
<br>
<IMG src="http://img.photobucket.com/albums/v437/Pinato/Velitorkin.jpg" border="0" alt="Isnt this the same picture as above ?">
<br>
<br>
<IMG src="http://everquest.allakhazam.com/monsterpics/Pyrique_Redwing.JPG" border="0" alt="Who is this hotty?">
<br>
and a host of other Rune dropping guys in Nobles Causeway, let the farming commence.
<br>
<br>
PS.
<h3>Recruitment is now CLOSED</h3>
Due to an increase in applications over the last few weeks we have really reached bursting point, thus Applications are currently closed to all but EXCEPTIONAL cases. Please review our REQUIREMENTS on the Forums to see how you match up before applying.
<br>
<br>
PPS. The Murkglider Hivequeen handed us our asses...twice, so we gave up in favour of going to bed as it was late.....next time
<br>
<IMG src="http://img.photobucket.com/albums/v437/Pinato/Murky_biatch.jpg" border="0" alt="Who brought the vinegar?">
<br>
<br>
PPPS. Just for Kral
<br>
<IMG src="http://www.drfoot.co.uk/pictures/Two_feet.jpg" border="0" alt="Couldn''''''''''''''''''''''''''''''''t have an update without feet !">
</div>
  <div class="txt">Posted by : <b>Bertil</b></div>
</td>
  </tr>
</table>
