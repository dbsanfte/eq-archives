...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
 <form method="POST" action="register.asp" name="registerForm" onSubmit="JavaScript:return validateRegistration()">
  <tr>
    <td class="header">Registration</td>
  </tr>
  <tr>
    <td class="txt">This form is for registration of existing and trial members only. If you are neither of these but wish to apply please complete an application
	on the <a href="http://forums.darktemplars.co.uk/forumdisplay.php?forumid=3" class="link">Dark Templars Forums</a>.<br><br>
	<b>For Existing/Trial Members</b><br>
	Please fill in the information below, once an administrator has accepted your registration you will receive an email verifying your username
	and password.</td>
  </tr>
  
  <tr>
    <td class="wtxt" align="center"><br>
      <table border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Character Name&nbsp;</td>
          <td bgcolor="#B0ACA3"><input type="text" name="rUsername" size="26"></td>
        </tr>
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Race :&nbsp;</td>
          <td bgcolor="#B0ACA3">
          <select size="1" name="rRace">
          <option>Select
          <option>Barbarian
          <option>Dark Elf
          <option>Dwarf
        ...
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Class :&nbsp;</td>
          <td bgcolor="#B0ACA3">
          <select size="1" name="rClass">
            <option>Select
            <option>Bard
			<option>Beastlord
            <option>Cleric
        ...
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Level :&nbsp;</td>
          <td bgcolor="#B0ACA3"><input type="text" name="rLevel" size="4"></td>
        </tr>
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Email :&nbsp;</td>
          <td bgcolor="#B0ACA3"><input type="text" name="rEmail" size="30"></td>
        </tr>
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Password :&nbsp;</td>
          <td bgcolor="#B0ACA3"><input type="password" name="rPassword" size="26"></td>
        </tr>
        <tr>
          <td class="txt" align="right" bgcolor="#898376">Verify Password :&nbsp;</td>
          <td bgcolor="#B0ACA3"><input type="password" name="rPassword2" size="26"></td>
        </tr>
        <tr>
          <td align="center" colspan="2" bgcolor="#B0ACA3"><input type="submit" style="font: 10px" value="Register!" class="formInput"></td>
        </tr>
      </table>
    </td>
