...
<head>
<title>Dark Templars | Forgotten Password?</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
   ...
   <form method="POST" action="forgotpw.asp">
    <table border="0" width="420" cellspacing="0" cellpadding="2" align="center">
      <tr>
        <td width="100%" align="center" height="10">
        </td>
      </tr>
      <tr>
        <td width="100%" align="center"><p align="center"><font face="Arial" size="2">Forgotten your password?
          Put your character name in the box below and your password will be delivered to your
          Registered email address.</font></p>
        </td>
      </tr>
      <tr>
        <td width="100%" align="center"><input type="text" name="username" size="20" value=""></td>
      </tr>
      <tr>
        <td width="100%" align="center"><input type="submit" value="Send my Password" name="B1"></td>
      </tr>
    </table>
