...
<BR>
Topic: <FONT COLOR="#2f2f4f">On the use of buffs</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Themis on 03-16-2001 06:06 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I too, also buff myself first as to set the group on a timer  :) But besides the regular hp/hp+ac/symbol buffs, I'm a fan of resist buffs as well, if the situation warrants it.

What helps for me is what other classes are in my group, and me knowing what they can and cannot do.

I usually have a lvl 49+ paladin in my group, which he buffs the casters (besides the chanter) with AoFaith. If we battle mobs that like to cast/proc disease, he handles the Resist Disease buffs.

Ditto for SKs and their RC spell.

And its always such a big help for me when druids and shamans are in the group to help out with certain buffs that we all share  :)

------------------
[50 cleric] Themis Silverlight (Human) 
[b][URL=http://thedarkknights.8k.com]Dark Vigilance[/URL][/b]
The Agnostic Cleric
[URL=http://www.innoruuk.com/]Innoruuk[/URL] Server</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="On the use of buffs">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000004">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="005784.cgi">
