...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Jubal on 04-16-2001 10:54 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">My groups are almost always buffed to the limit as it is... seems that symbol is always the first to eat a dispel though =(</TEXTAREA>
</td></tr>
</table>
