...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Delheru:
[B]Bleah actually I was very disappointed in the greaves effect. It's a damn waste for peridots (unless it doesn't require them, then it's pretty whooping).

I'd personally would have preferred something on the lines of theft of thought (drool  ;) ), invis (warriors get it, but we still don't have it), SHeal or whatever. Verant is making very big changes in caster tactics due to their "vision" (not being negative here).

-- Delheru Tanreall
Exiled Legion, Rodcet Nife[/B][/QUOTE]
