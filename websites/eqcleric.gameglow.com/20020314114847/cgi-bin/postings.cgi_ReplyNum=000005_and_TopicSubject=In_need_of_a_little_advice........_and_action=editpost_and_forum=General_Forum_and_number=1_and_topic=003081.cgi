...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Nizdaar on 06-02-2000 01:23 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Permafrost, near the entrance.

I went there with a 4 person group that was exactly the same level and composure (well, druid instead of ranger).  We cleaned up.

Have the bard pull, they have a lull song that works wonders in the flag room.

You should be able to sweep from the entrance up to (and possible into) the flag room, then work your way back.  It's a 28 minute respawn time in there (or was back in September, that may have changed).

Perma is out of the way though, with closest place to bind being Halas.

------------------
Nizdaar
46 High-Elf Cleric
Innoruuk Server
 [URL=http://www.maximumeq.com]http://www.maximumeq.com[/URL]</TEXTAREA>
</td></tr>
</table>
