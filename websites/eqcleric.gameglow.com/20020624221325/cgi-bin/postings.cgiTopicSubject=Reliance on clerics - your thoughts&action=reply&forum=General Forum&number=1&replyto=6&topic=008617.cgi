...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by xxxhammer:
[B]How about this: 

Maybe the game is designed so that the classes are supposed to be *different* in what they do.  Sure, sounds like a dumb statement, but the cleric is designed to heal people and is the best at it.  Unfortunately, since the game is designed on hitpoints there are always going to be more clerics required for the task of taking out high end mobs.  I doubt there is going to be anything done to change this, like giving druids or shamans cheal.  That would basically make the characters more alike, and water the game down.  imho, this is how it's supposed to be and there is nothing that can be done about it.  There is no solution to the "problem."  Just too bad that because of that fact, a lot of clerics are bots. [/B][/QUOTE]
