...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by electrae on 03-26-2001 01:18 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">It seems like there's always a few people that get hit with costs that benefit the entire raid but they don't get reimbursed for.

Seems like there's a couple of ways to handle that:  

1. change a raid entrance fee to cover costs
2. maintain a guild treasury
3. charge a loot fee, if you win a lotto you pay Xpp to help defray the costs.</TEXTAREA>
</td></tr>
</table>
