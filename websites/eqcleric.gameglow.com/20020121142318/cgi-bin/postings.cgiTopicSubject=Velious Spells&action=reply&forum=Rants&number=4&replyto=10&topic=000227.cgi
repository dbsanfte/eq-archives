...
[B]"For example you say cleric buffs are better than druids???? Then please explain to me, while I'm at level 44, and Druid buffs STILL override cleric buffs (people of the same level)."

Which buffs are you referring to?  IIRC, a higher level spell will overwrite a lower level.  I think the caster level comes into play if the spells are the same level.

If both are equal, I'm not sure whether the hit point or AC side of the spell is what determines what overwrites.  In either case, I still maintain that the cleric buffs are better, given the mana costs.

"And Druids do too get every single spell in this game, except, rez, clarity and obviously pet spells, but I didn't mention that because its pretty obvious... although they can turn themself and others into wolves, so in reality it somewhat the same."

Your previous point specified "top of the line".  THAT is what I dispute.  Are you claiming that druids DO, in fact, get Complete Heal, Ice Comet, etc.?  That's what triggered my response - that and the class envy/bashing.[/B][/QUOTE]
