...
[B]Time to update the walkthrough.  :)

I think this is a good change. Camping Ragefire can now be done by just the cleric, with the exception of requiring some help clearing FGs every eight hours. No more frantic call to arms when he spawns- just turn in your bit and get his bit.

The second part will be like any other Kunark dragon- when he pops, first one there with the forces gets him, including any epic bits on him. If you miss him, there's always next time. It would be better if it was triggered, like the Faydedar spawn, but this is still better for those who don't have the large block of time to do the old Ragefire camp. For those that do, I hope you already have your epic (you probably do  :) because this will be somewhat more inconvenient for you, but I hope you can at least see, if not agree with, the perspective that it opens things up for more of us overall.
