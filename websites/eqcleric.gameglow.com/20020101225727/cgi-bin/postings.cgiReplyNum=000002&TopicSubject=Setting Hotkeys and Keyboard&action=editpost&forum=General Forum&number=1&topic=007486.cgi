...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Tundar on 11-26-2001 08:21 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I got 5 spells and 5 others.
CH
Remedy
Stun
CelHeal
Root
Sit
Pet (I group alot with mages)
Assist (for stunning what the enc is trying to mez etc.)
Main Assist
CH Macro

On my 2nd most used keybank are:
DA
DB
Spell #8 (dispell, buff, holy might etc)
Spellbook
Dispell macro (dispelled %T)
Sit
Root macro (rooted %T)
CelHeal macro
MA
...
I like to have a few represented on both banks for panic situations.</TEXTAREA>
</td></tr>
</table>
