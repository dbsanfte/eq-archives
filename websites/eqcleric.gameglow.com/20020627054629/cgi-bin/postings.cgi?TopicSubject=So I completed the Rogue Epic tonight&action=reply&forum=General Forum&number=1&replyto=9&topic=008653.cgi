...
[B]BTW, if you happen to like Beastlords, now's the time to do their epic...  With so few high level beastlords around right now, the mobs (which can take awhile to spawn) are almost always up.

There's only one piece that's tough, an ore drop from a mob in The Grey which gets bugged and doesn't respawn (so you need to get it right after a server up).

My BST's is almost done.  :)  Just two more battles (have all the drops) to go.  :)[/B][/QUOTE]
