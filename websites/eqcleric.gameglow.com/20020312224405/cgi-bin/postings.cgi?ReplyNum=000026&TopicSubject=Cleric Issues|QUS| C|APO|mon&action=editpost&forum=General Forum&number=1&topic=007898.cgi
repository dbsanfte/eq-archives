...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Dikmer on 02-09-2002 10:47 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">As far as the Velious BP's go, FAR more clerics have one of the 4 Velious BP's than have the SPELL MoK.

Kinda sad, really, as that is a rather blunt way of saying that SPELL DROPS SUCK!

I purchased MoK (for like 1500 or so, I forget), then moved it to the back of my spell book about a week later when I got my BP of Forbidden Rites. Haven't used it since.

I understand VI not wanting us to become "mechanical" casters (I.E. casters who can get by solely on the effects of their armor/jewelery), but they made the effects we DO have practically worthless with stupidly long casting times. Yes, I have saved my group a few times using my legs to heal, but the casting time is such that it's a real tossup which is better, try to med or use the legs. Hell, even the boots and bracers have such a long casting time, you are almost better off summoning by spell and sitting back down.

I don't think clerics have any real "issues" outside of Ragefire, but if I could have 3 wishes, they would be:

#1, shorter cast times on armor effects. 
#2, Bash (just for fun)
#3, Stackable invis potions. I would even put up with a casting time on those invis potions (instead of instant like they are now) if they could be stacked.</TEXTAREA>
</td></tr>
</table>
