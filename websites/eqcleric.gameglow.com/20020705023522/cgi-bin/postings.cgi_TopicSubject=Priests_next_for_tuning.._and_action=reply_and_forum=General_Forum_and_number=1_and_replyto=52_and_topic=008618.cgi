...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Priests next for tuning..</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Fhylden:
[B]I always found it an interesting sequence of events that VI changed the effect on Bard Singing Steel armor to no longer summon food/water, because they felt that summoning food and water was not an appropriate effect for the level of difficulty, and then a few weeks later they released cleric armor that does the EXACT SAME THING (possibly 4 at a time instead of 1 at a time).  (Yes that was one single sentence).

Left hand, I'd like to introduce you to Right hand.  Why don't you two get to know each other better?
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Priests next for tuning..">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="008618.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<A HREF="http://eqcleric.gameglow.com/ubb/Forum1/HTML/008618.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
