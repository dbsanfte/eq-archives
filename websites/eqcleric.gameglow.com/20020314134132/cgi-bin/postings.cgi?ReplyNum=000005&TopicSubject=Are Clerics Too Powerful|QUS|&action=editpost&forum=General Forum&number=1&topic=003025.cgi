...
<BR>
Topic: <FONT COLOR="#2f2f4f">Are Clerics Too Powerful?</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by A11e on 05-30-2000 09:32 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I play both a druid (level 41 so far) and a cleric.  One thing I have begun to realize is that druids "mature" earler than clerics.   This means that they reach their peak around 29.  They continue to gain in power after that but not significantly.  

In my opinion clerics don't start to mature until level 39 when they get complete heal and resuscitate (exp rez).  Clerics continue to grow in power significantly after that and are essential to the success of high level groups.  Druids, on the other hand, remain a jack of all trades and a master of none.  They can be useful to groups, but at high levels druids have no unique ability that cannot be done better by some other class.

Clerics rock!</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Are Clerics Too Powerful?">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000005">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="003025.cgi">
