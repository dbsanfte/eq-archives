...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Mendin on 04-17-2001 06:15 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">No offense to anyone, but now, with the "improved" moderation (propaganda) of the boards, I seriously doubt that anything Verant does not want to hear will be posted.

They are not ready to/capable of dealing with the Clerics' requests. Therefore the odds of seeing Absor pass on one such request would be the rough likelihood that a giant easter bunny goes around hiding its eggs every year.</TEXTAREA>
</td></tr>
</table>
