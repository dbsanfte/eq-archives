...
<BR>
Topic: <FONT COLOR="#2f2f4f">High priest in Acrylia</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Tundar on 05-24-2002 05:09 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">We had a small guildhunt in Acrylia last night with the goal of checking out that High priest spawn cycle.

We had a blast but were a bit short on melee. You die some and you learn some  :)

I was wondering:
1) Should we take the fight outside to the place with all the untargetable worshippers?
2) Spawn rate on named high priest? We only managed to get through 1 cycle before most had to log.
3) What's that norent key for? Someone mentioned a pretty nasty fight, but with just 10 ppl and on a time limit we weren't really up for anything silly.

Btw, next time we will just invis up and run to the high priest. Those "#%"¤ grimlings have insane high ac and hp now  :(</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="High priest in Acrylia">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000000">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="008619.cgi">
