...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Banthur Spiritforge on 02-19-2002 12:15 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">WTF is the differance between a raid group and a normal group? Raid groups don't need exrta healing? I don't get it, why is it when a person comes up with a good thing that takes pressure off another class that class has to bash it stomp on it. Personally I appluad the necro. I would like to meet more necros like him. As for you class bashers, you make me puke</TEXTAREA>
</td></tr>
</table>
