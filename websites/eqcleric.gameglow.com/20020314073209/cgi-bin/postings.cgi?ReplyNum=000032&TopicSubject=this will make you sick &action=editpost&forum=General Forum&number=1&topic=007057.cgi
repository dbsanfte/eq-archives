...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Sumamael on 02-19-2002 12:04 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]
The difference is that the spells he is talking about using to regain his hit points (BoD and Lifetap) won't work on those raid-level mobs.
[/QUOTE]

Its true for most Kunark and NToV dragons and lots of PoH2 mobs. 

However a high enough level necro can lifetap gods (CT and Innoruuk) and most of ToV mobs (like the keeper) and even the Dain or the Statue since the mob resist changes and the advent of disease based lifetap.

You cant base a raid group's healing on a necro tho....they use healing over time spells what arent simply fast enough in most raid zones to counter damage. I cant save an enchanter getting stomped after a broken mez nor can I complete heal a main tank....thats why we have clerics.


------------------
[60 Warlock] [URL=http://www.magelo.com/eq_view_profile.html?num=100319]Sumamael [/URL] (Dark Elf) &lt;Stormbringers&gt;</TEXTAREA>
</td></tr>
</table>
