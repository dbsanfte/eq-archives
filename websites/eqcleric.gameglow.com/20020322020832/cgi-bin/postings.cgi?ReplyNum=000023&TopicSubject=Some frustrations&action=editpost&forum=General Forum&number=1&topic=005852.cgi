...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Khalim - Innoruuk on 03-29-2001 05:06 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">  Add incarnadine BP to the list of War/SK items for self invis, which clerics used to be able to use from inventory.  It was nerfed this last patch, and must be equipped to use.  As far as I'm concerned, that was directed at clerics and paladins directly.  No other class really benefitted from it, since they can all self-invis one way or another.
