...
<BR>
Topic: <FONT COLOR="#2f2f4f">Problem in KC</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Nalance on 04-12-2001 11:38 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I play on Jake's server and every time I've been in Karnor (for a couple of months now), the loot rule was need before greed.  This is the first group I've heard of that is FFA.  

I do not know which side is right in this case as I was not there.  As to the person seen selling gauntlets previously, that was only confirmed by a member in the chanter or monk's guild (I can't remember which) and may or may not be true. 

I know I would be upset if a piece of Donal's dropped and it was a FFA looting.  I have been there for a few months and have yet to see any Donal's drop.  I do have a lot of Jarcrap (oh I mean Jarsath) armor, but most of that rots cause you can't even give it away easily.  :)</TEXTAREA>
</td></tr>
</table>
