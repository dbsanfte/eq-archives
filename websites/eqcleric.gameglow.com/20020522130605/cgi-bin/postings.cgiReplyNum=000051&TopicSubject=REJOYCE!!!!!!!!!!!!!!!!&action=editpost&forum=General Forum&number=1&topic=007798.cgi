...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by ixif on 01-24-2002 03:10 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">The one thing that truly upsets me about this whole thing is the fact that they changed it to make the Guide's/GM's lives easier, NOT the players.

Whether the quest is better or worse now is a matter of opinion ( and what server you're on ) and can be debated forever.</TEXTAREA>
</td></tr>
</table>
...
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000051">
