...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Fruito on 05-24-2002 03:02 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">As long as end game encounters are focused on hitpoints and damage, clerics will always be in high demand. No other class comes close to the healing power of a cleric and that's pretty much the way things should be.

So if the only way Verant scales an encounter is to give the mob more HP and make the mob dish out more dmg, then such encounters will require more and more clerics to make it happen.

The real question is, would it take too much brainpower to design a few encounters where something other than HP and heals matter?</TEXTAREA>
</td></tr>
</table>
