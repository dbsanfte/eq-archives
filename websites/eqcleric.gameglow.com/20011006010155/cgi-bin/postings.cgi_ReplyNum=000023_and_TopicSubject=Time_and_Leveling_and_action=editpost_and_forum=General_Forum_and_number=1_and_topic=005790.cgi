...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Kannayyan on 03-16-2001 04:56 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]Originally posted by Aquinas:
[b]

If you're comparing a necro who's a player's first character with a cleric started much later (and probably twinked somewhat) it would not be surprisng at all to see the cleric level much faster.[/b][/QUOTE]

I'm sorry, I have to laugh here...the generalizations are cracking me up now...if..if...if....</TEXTAREA>
</td></tr>
</table>
