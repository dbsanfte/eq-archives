...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by naxy on 09-15-2000 12:58 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Hear, hear, Seliris!

/rant on

Most people complaining about bugs, fixes, nerfs etc. quite clearly have never worked on a large software project and it is dubtful that they even have the remotest idea what it takes to pull off the feat which Verant has done. Having dozens of "servers" running 24 hour a day with a dynamic environment which is entertaining enough to keep 200,000+ people coming back on a near dayly basis for over a year. Try it yourself and you will see that Verant in fact are doing a very good job.

Now, I recommend that you lay off on the personal attacks. They do not belong in this kind of disussion and they certainly do not improve Everquest in any way. I also think that you vastly underestimate Verant if you think that Gordon has that much to say about how things are implemented in the game. Customer feedback is very important, but Verant has clearly shown that design integrity is very very important to them. And you should be very glad that this is the case. If they would have implemented every little "improvement suggestion" which comes their way, we would all have stopped playing this game a long time ago.

Sure, even Verant has stuff that needs to be worked on and improved. But tell me a company which is producing something worthwile which doesn't? 

In fact everything in Everquest has improved over the 12 months which I have played it, it continues to get better and this includes having Gordon around. It was not that good without him.

Go back to the game, enjoy it and if it isn't fun, stop complaining and MAKE it fun. Ever created quests for lower levels? Done architecure visits to Mistmoore? Raided Oggok? There is lots of fun if you just stop complaining and see the good things in Everquest.

/rant off


------------------
Naxy Dent, Cleric of Karana on Bristlebane
while (dead_horse) beat();</TEXTAREA>
</td></tr>
</table>
