...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Mirixia Elamshinae on 05-28-2002 07:35 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">
A good example of cleric vs druid "versatility" can be illustrated by moving either class to ToV, when you're on Kael faction.

The druid will:

1) Buff himself with SoW and levitation
2) Teleport himself to CS
3) Invis himself and run to SG entrance
4) Zone in and egress himself to WWL zone
5) Zone into WWL, recast levitation and invis
6) Run to ToV entrance


Now, as a cleric, the most realistic way of handling this, is to group with the said druid or a wizard, to get proper escort to ToV, including invis and levitation. 

The extreme lack of utility spells for clerics is my major peeve with the class. I can't understand why *warriors* should have several available invis items to choose from, when clerics get none. 

If druids become better healers, then clerics should be given improved versatility to remove the "portable bandaid" part of the class, when almost everything in the game including basic travel requires the help of others.



------------------
Mirixia, teir'dal templar
Zarloth, teir'dal warlock
Vallon Zek</TEXTAREA>
</td></tr>
</table>
