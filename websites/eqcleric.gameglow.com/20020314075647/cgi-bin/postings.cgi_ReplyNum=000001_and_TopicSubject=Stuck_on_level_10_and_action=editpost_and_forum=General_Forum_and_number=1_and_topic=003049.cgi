...
<BR>
Topic: <FONT COLOR="#2f2f4f">Stuck on level 10</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Dalur - Veeshan on 05-31-2000 10:52 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Depends if you want to travel around or not.  I'm sure there are lots of places.  The area that comes to mind for me is the skeleton tower/ruins in Butcher block mountain.  The tower is fairly close to the guard post so if you run into trouble you can run to the guards.  There are also gobblin camps and orc camps around the area that you can hunt in if you get bored with the skeletons.


------------------
Dalur Stouthealer
53rd Dwarven Vicar
Veeshan Server</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Stuck on level 10">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000001">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="003049.cgi">
