...
[B]I go with the hotkey to cast first, talk later.  So I dont lose precious 1/10ths of anything when hitting a hotkey versus just hitting the spell.

/cast #
/g remedy on %T.
/em bestows a remedy upon %T.
/pause 5 (add this in your case)
/cast # (add this in your case)

Just how I would do it.  But then I spam people alot with my healing, hehehe.
