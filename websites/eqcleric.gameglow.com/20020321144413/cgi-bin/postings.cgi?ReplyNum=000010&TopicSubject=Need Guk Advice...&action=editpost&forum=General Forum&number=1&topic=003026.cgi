...
<BR>
Topic: <FONT COLOR="#2f2f4f">Need Guk Advice...</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Morrun on 06-01-2000 11:59 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Pulling stuff through Upper Guk to either Lower zone is not a good idea, in general.

Not only do you greatly incovenience anyone who's hunting Shins etc. at the zone, but you run a risk of killing anyone who's just zoned out from a train Lower Guk.  I would be most upset if I'd escaped from Lower Guk with 50hp left, only to be promptly killed by a horde of angry level 25 Ton warriors.

Use root/atone, and don't run if one hits you.  Alternatively, try a Pacify, and just walk right past  :)


------------------
Morrun Catspaw
Halfling Cleric (46th)
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Need Guk Advice...">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000010">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="003026.cgi">
