...
<BR>
Topic: <FONT COLOR="#2f2f4f">Screenshot of Skyshine quest bp.</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Caleal on 03-20-2001 01:46 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Tailchaser, the Kael chestplate has 4 more ac, but 1 less STA and a lot lower resists than the Skyshrine quest chestplate. I REALY like a lot of resists. I would also rather have the +5agi of the Skyshrine chest than the +5 str of the Kael chest. Both chests beat the **** out of my chestplate of stability anyway.  =)

As for dificulty, after running around in ToV watching some +giant people kill stuff and doing a CR for them, I would have to say Skyshrine quest armor is lower dificulty to aquire, heh. +dragon faction people are not KOS to anything between the zone in and the testing hall, so CR is fast and easy. Working Yelinak faction up is only slightly more tedious than working Tormax faction up.

Had to add another comment, the Skyshine chest is NOT PURPLE on DEs, the Keal one is. That alone makes the Skyshrine quests far preferable to me. I don't sit with the "purple people" anymore! =0

------------------
Caleal P`Terak
BATTLE CLERIC of Innoruuk
Cazic-Thule server
Officer, Shadowed Soul

[This message has been edited by Caleal (edited 03-20-2001).]</TEXTAREA>
</td></tr>
</table>
