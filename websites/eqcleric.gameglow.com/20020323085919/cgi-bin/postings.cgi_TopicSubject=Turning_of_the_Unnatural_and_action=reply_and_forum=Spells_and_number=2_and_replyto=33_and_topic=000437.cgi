...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Badany:
[B]I have Turning of the Unnatural, and I just want to say that it is the most useless spell in my spell book.  

As for the price, I wouldn't recommend anyone pay more then 20pp for the spell... it isn't worth it.  The spell does 400 damage in 90 seconds.  It is too slow and does too little damage to be *ever* usefull.

Well, possibly if it was like a level 29 spell, you might cast it around that level, as 400 damage is significant then.

Trackman, I suggest you just give it to any Cleric friend of yours, any Cleric that knows how this spell works will find it useless, and any Cleric that doesn't know how it works, you would be ripping them off by charging more then 20pp.

This spell really needs it's damage increased to about 800, OR it's duration dropped down to 30 seconds (30 seconds, still 400 damage).
