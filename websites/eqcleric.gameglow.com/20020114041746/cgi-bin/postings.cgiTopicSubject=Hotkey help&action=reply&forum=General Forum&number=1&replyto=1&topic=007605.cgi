...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Hotkey help</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Thorphin:
[B]I believe my fizzle catcher is as follows
...
I think you can put the pause on the same line as another command as long as you use a comma between them.[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Hotkey help">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="007605.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Caalin</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Ok, i know this has been discussed, and i dont know why i havnt done it already, but I need to set up my hotkeys to recast if i fizzle, and i cant remember the proper syntax to do that. Isnt it something like /pause X where X is the amount of seconds? thanks for your help.</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Thorphin</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I believe my fizzle catcher is as follows<P>/sit off<BR>"casting (heal) on %t"<BR>/cast (#)<BR>/pause 5<BR>/cast (#)<P>I think you can put the pause on the same line as another command as long as you use a comma between them.</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Tundar</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">The number you type is 1/10 of a second so 5 will be half a sec.<BR>Should be enough to catch a fizzle.</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Cali</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I go with the hotkey to cast first, talk later.  So I dont lose precious 1/10ths of anything when hitting a hotkey versus just hitting the spell.<P>/cast #<BR>/g remedy on %T.<BR>/em bestows a remedy upon %T.<BR>/pause 5 (add this in your case)<BR>/cast # (add this in your case)<P>Just how I would do it.  But then I spam people alot with my healing, hehehe.<P>------------------<BR><B>~Calimayrn Anam'Cara</B><BR>Templar of Tunare<BR><B>~Calizana Rhinelander</B><BR>Floating Barbarian Champion<BR>Farstorm ~ Veeshan</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">ShelseaDruid</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">How long are the pauses on the different spells??  I have my hotkeys set up the following way but couldnt figure out the pause timing:<P>/sit off<BR>/cast 3<BR>/g %T - Stay in Range ->>> Casting Complete Healing <<<-<BR>/em gives %T some cleric loving<P>(Yes I like emotes they are fun)<P>was going to add the pause line and then a sit command but didnt know how long to set the pause for.<P>/hugs</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Boanerges</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I would not use a long /pause block because even with a fizzle cather there is the chance you will be standing there for the entire time unable to do anything. Remember, as long as /pause is in effect your client is basically locked up.<P>To do an auto sit however, do the following AT YOUR OWN RISK<P>/cast #<BR>/g your CH message...<BR>/pause 100<BR>/sit<P>My 2cp is I'd rather spam them twice if I fizzle than run the risk of standing there unable to do anything.<P>------------------<BR>Boanerges Thundercry<BR>High Priest of Prexus<BR><A HREF="http://www.cohort.cc" TARGET=_blank>Cohort Chalybeius</A><BR>Cazic Thule Server</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Twinskey Bab0linskey</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Emote's are enough to catch a fizzle.  All my hot keys are somthing like<P>/cast 7<BR>/g %t is getting.....<BR>/clap<BR>blank line that I use for /gu or /shout on raids<BR>/cast 7<P>This will catch fizzle's and the times I hit a hot key before my spells are cycled.</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Lifeheart</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I don't think I have any pauses in mine at all and I've never had a problem with it not catching the fizzle (unless something strange like a huge lagspike occured).  I just separate the casts with a line or two of /groupsay, it takes a couple milliseconds to process the /g Healing %T in the button.<P>I think mine just look like:<BR>/sit off<BR>/cast 1<BR>/g Completely Healing %T<BR>/cast 1<P>I had a friend who loved the pauses...he even timed it down to sit back down after casting.<P>------------------<BR>Lifeheart<BR>56 Templar of Innoruuk<BR>Povar</FONT></TD></TR></TABLE>
</FONT>
