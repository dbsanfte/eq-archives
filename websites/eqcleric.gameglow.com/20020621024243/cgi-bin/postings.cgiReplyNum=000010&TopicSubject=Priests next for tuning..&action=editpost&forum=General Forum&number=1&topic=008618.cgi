...
<BR>
Topic: <FONT COLOR="#2f2f4f">Priests next for tuning..</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Ainder on 05-24-2002 11:49 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">If clerics are able to buff offense, they will be stepping on other class abilities, just like clerics are worried about having their healing abilities infringed upon.  Rangers in particular are known for attack buffs, and they use most of the spell attribute slots for that already.  That's considered by many rangers to be our main contribution to a raid currently, and you wouldn't be able to add an atk buff without having major stacking issues.</TEXTAREA>
</td></tr>
</table>
