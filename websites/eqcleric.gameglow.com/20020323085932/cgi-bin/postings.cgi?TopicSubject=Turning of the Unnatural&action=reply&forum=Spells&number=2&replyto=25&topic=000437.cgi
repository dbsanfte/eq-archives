...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Dazzadi Forest Gump:
[B]got it off guardian wurms a few months ago memed it a few times and noted it took way too long for the dmg it does.[/B][/QUOTE]
