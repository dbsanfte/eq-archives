...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Changes on Test Server 4/1/02</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Aerillea:
[B]Haven't seen anyone post this, but some good changes ahead I hope.

Most interestingly, it looks like they have made changes so you will receive quest items back that are not needed.  So no more losing quest pieces to the wrong quest mob!

Test Patch Message: April 1, 2002[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Changes on Test Server 4/1/02">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="008299.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Aerillea</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Haven't seen anyone post this, but some good changes ahead I hope.<P>Most interestingly, it looks like they have made changes so you will receive quest items back that are not needed.  So no more losing quest pieces to the wrong quest mob!<P>Test Patch Message: April 1, 2002<BR>--------------------------------------------------------------------------------<BR> ** Monday, April 1 2002, 11:00 am.<P><BR>* Internal changes we need to make sure didn't break anything, but things should behave the same.<P>/who all<BR>- Meditation<BR>- Stationary NPCs. If you can make them move or they warp around, that's a bug.<BR>- Targetting/Looting and: Eyes of Zomm, Familiars, Corpses, Warders.<BR>- A few hundred new strings added to the localization string table.<P>* Familiars should be able to zone from qcat to qeynos2 with their master.<P>* NPCs who shout names while they DT should be fixed.<P>* Skiffs should be working.<P>* Tinkered compass should truly grant a sense heading boost.<P>* Random frame lag in guktop, oasis. Believe it or not, it was related to alligators. (I know -- I had to have it explained to me, too.)<P>* Rogue hotbutton lockups due to pickpocket/beg should no longer be possible. The client didn't realize that these two have always used the same skill timer.<P>* AA turn summoned should work as described.<P>* Mage AA reclaim should work with epic pet.<P>* HP on food items should be taken into account. Be careful how you eat - You can kill yourself if you run out of bonus food at an inopportune moment!<P>* Potions should work on horses.<P>* PC spell filters reworked - Problems with of taking damage without being able to see it, or the client over-reporting damage taken should be fixed.<P>* Re-enabled focus items and AAs for clickable items that affect a spell's duration.<P>* Dealt with some DS stacking issues.<P>* Updated all non-pet NPCs to return items they don't care about. Charmed NPCs will still accept items while they are charmed. (Naturally, the Rivervale and GFay Priests of Discord are exempt from this rule.  <P>* Fixed a bug in mage QuickSummon AA that was preventing it from affecting Call of the Hero and Manifest Elements.<P>* High level NPCs in Cazic Thule should now be tauntable.<P>* Res boxes being automatically dismissed by other windows.<P>* /yell and lifetap string problems.<P><BR>- The EverQuest Development Team</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Cali</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Interesting.  If this all works they just killed multiquesting and fixed the resurrection bug with the inventory.<P>Wonder how it will all turn out in the live servers.<P>Thanks!<P>------------------<BR><B><A HREF="http://www.magelo.com/eq_view_profile.html?num=47541" TARGET=_blank>~Calimayrn Anam'Cara</A> </B><BR>High Priestess of Tunare<BR><A HREF="http://www.magelo.com/eq_view_profile.html?num=107896" TARGET=_blank>~Calbrazan Deo'Cara</A><BR>Tribunal Shamanette<BR>Farstorm ~ Veeshan</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Cassilda</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Why do you say they nerfed MQ?  It says they will return items they no longer want.  They want the quest items.  This should solve when you hand in the wrong stone with the wrong piece of armour or forget to have your plat bar enchanted, etc.  At least that is how I would think it should fix it....... The actual change remains to be seen<BR></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Velisaris</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">If they had changed it so that quest NPCs will only accept ALL needed quest items at one time from one person, then MQ'ing would be considered broken. Having multiple people turn in required items should still work.</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Serina Moonprism Elay</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">* Re-enabled focus items and AAs for clickable items that affect a spell's duration.<BR>_______________________________________<P>Wonder what this means...faster ch's again? Prob not but one could hope.<P>------------------<BR><B><A HREF="http://www.magelo.com/eq_view_profile.html?num=26064" TARGET=_blank>Serina Moonprism Elay</A></B><BR>60th High Priestess<BR><A HREF="http://www.prophecyguild.com" TARGET=_blank>Prophecy Guild</A> <BR>Member of the Elay Brotherhood<BR>Bertoxx Server<BR><I>"Be kind for everyone you meet is fighting a harder battle."</I>-Plato <BR><I>"Insanity is the root of all genius."</I> -Jen Meyskens</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">NightGod</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial"> <BLOCKQUOTE><font size="1" face="Verdana, Arial">quote:</font><HR>Originally posted by Serina Moonprism Elay:<BR><B>* Re-enabled focus items and AAs for clickable items that affect a spell's duration.<BR>_______________________________________<P>Wonder what this means...faster ch's again? Prob not but one could hope.<P></B><HR></BLOCKQUOTE><BR>I would think it means that, say, Donal's arms buff will have its duration extended by focii/AA. I'm guessing there was a problem before with this.<P>------------------<BR>Higar Mettlebender<BR>Templar of the 55th Prayer and Luclin Loot Ho<BR>Weilder of the Water Sprinkler of Nem`Ankh<BR>Guardians of the Keep<BR><A HREF="http://www.magelo.com/eq_view_profile.html?num=20669" TARGET=_blank>Higar's Profile</A><BR>Master Drinker (200) <BR>Master Jeweler (188)Master Fletcher (185)Master Smith (183) Master Brewer (175) Master Potter (168) Master Tailor (163)Master Baker (162) (Anyone got any dragon meat lying around??) <BR>Proud wearer of the 7th prayer shawl.<BR>Coldfyre <BR>Warrior of the 14th Blade<BR>Grandmaster Mule (255) Grandmaster Trader (255) <P>Drinal Server <BR>"These balls are making me testy!"</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Kolevii</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial"> High Lv mobs in Cazic Thule should now  be tauntable <P>WOOOOOO!!!!!<P>  Dealth with some DS stacking issues <P>  ><<P>Sounds like there are alot of good changes made, I love the new CT,that taunt change helps alot<P><p>[This message has been edited by Kolevii (edited 04-06-2002).]</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Talura cwnZeylon</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">This wasn't some bizarre April Fool's prank done by VI was it? I mean, toss in some good things that have been requested for a while now and then laugh and say it was a joke...  <IMG SRC="http://eqcleric.gameglow.com/ubb/smile.gif"></FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Panteroo</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I certainly hope that the ability to MQ isn't broken or disabled. It would certainly suck for the cleric friend of mine whose paladin guildy was the only person standing to loot the epic note to MQ for my friend on a Chardok wipeout.<P>It would also suck for me since I have in my bank 3 velious armor pieces that I intend to MQ for guildmates who were unable to be present when they dropped.<P>I certainly don't think that MQ'ing is detrimental(sp?) to the game, even if it has a bad side it's pitfalls do not outweigh its advantages IMHO<P><P>------------------<BR><A HREF="http://www.magelo.com/eq_view_profile.html?num=12024" TARGET=_blank>Panteroo Mcgillakudy</A><BR>High Priest of Fennin Ro</FONT></TD></TR></TABLE>
</FONT>
