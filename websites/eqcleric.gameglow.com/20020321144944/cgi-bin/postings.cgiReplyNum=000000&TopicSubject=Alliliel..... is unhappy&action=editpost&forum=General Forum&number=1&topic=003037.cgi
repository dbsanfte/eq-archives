...
<BR>
Topic: <FONT COLOR="#2f2f4f">Alliliel..... is unhappy</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Alliliel on 05-30-2000 01:00 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I have a little problem here.

I've doing the Planes more and more lately, and I'm starting to get some of the purple stuff.

The problem is that the pieces I'm getting are inferior to stuff I have.

Currently I have arms and gloves. The EM arms were superior to the quest arms for me, so there was no troubles there.

When I got the EM gloves and replaced my quest gloves, my AC went down by 2.

Seeing how Boots and Bracers are more common, I might get those next. Should I replace my efreeti boots and quest bracers with EM? I really dont want too.

Now here is what my problem is- I feel as though I really should wear the EM stuff I get, even if it is inferior (1) because seniority is so much a part of these trips, and it's one way to demonstrate some type of veteran status with these planes raids. 

But do the plus 5 int and plus 5 dex on EM gloves help my group as much as the plus 2 AC from the quest gloves? nope. I also fear that the boots are not going to be as useful as my Efreeti boots.

Now, I understand that when you have the whole set of EM, this problem will go away, but when you only have a few pieces, and they are not the really good pieces, should you wear them? I'm really tossed up about this.

(1) Note I don't mean inferior in ALL cases, but inferior for me, with the base stats and gear I already have.
...
Tunare Server</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Alliliel..... is unhappy">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000000">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="003037.cgi">
