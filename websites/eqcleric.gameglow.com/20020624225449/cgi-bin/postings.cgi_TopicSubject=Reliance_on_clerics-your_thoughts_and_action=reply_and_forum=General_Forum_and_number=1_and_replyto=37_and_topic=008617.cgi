...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Borick:
[B]Qwen,

     I agree with your comments to a point.  I am proud of my skills as a cleric and I don't think that any second-boxed cleric can compare.  However, a second-boxed cleric CAN do the job, even if they aren't that great.  We use a lot of second-boxed clerics for our bigger fights, and the skills aren't that difficult to manage.


Compare a cleric to, say, a monk.  I can second-box a cleric for healing, but I can't second-box a monk for a puller.  Pulling requires more practice and skill than healing, from my perspective.

So yes, no 'robot' cleric is going to be as good as I am, but at least the 'bot can do a halfassed job and get by.[/B][/QUOTE]
