...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Lladra on 12-12-2001 12:48 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Well yesterday the zone "The Grey" was brought down for an update, ie nerf, and totally screwed casters(wis and int) over again.

As a cleric I had fun soloing for once because there were light blue and blue undead creatures that I could use the new level 52 undead dot on and root the mobs.  This for once gave me an option to be something other than a CH/Aego whore.  Also AoE groups were nice in this zone allowing for you to get a change of pace from doing AoE Seb groups for once.

But oh well Verant's Image of the game seems to resort back to the holy trinity (warrior/tank, cleric and enchanter) again.

Bravo Verant.</TEXTAREA>
</td></tr>
</table>
