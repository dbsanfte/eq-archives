...
<BR>
Topic: <FONT COLOR="#2f2f4f">Days played with second character</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Boanerges on 06-07-2000 03:14 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Couple of comments...

First, your first char will almost always have more /played time simply for learning curve.

Second (and this plays a BIG role, whether or not you admit it) you probably twinked your second char using the first (no shame in that).

But nice progress for 2 45 chars  :)
