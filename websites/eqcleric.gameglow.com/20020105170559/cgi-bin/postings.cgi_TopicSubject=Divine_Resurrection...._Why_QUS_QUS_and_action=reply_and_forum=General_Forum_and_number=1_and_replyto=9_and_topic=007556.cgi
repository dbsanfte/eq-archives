...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by EQPurity:
[B]I never have a fizzle make me miss a complete heal.  My macro is as follows:

1) /sit off
2) /cast 1 (complete heal)
3) /g CH on %t
4) /cast 1
5) /cast 1

By doing this 3 times, if I do get a fizzle, it instanly tries again.
