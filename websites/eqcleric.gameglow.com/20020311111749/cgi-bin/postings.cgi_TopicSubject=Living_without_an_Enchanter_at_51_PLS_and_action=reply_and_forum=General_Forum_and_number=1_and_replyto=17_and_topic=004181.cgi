...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Tael:
[B]My favorite combination is this:
...
Wizards and their evacuation capacity are good substitutes for the necromancer or the mage.

Being an evil race guild on a team server we don't have access to bards or druids.

I particularly like necromancers and shamans in groups because they have such versatile capacities.  With these two in your group you can usually get by without an enchanter.
