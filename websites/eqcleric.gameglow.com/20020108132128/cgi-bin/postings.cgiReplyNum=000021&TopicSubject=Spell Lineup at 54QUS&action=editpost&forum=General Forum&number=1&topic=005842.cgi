...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Badany on 03-26-2001 02:42 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Amalthea,

Divine Aura/Barrior WOULD HAVE HELPED!

You must not be aware, that the Divine series is the ULTIMATE anti-taunt, casting it will temprorarly drop you 20%-30% off of the mobs hate list!

The logic for this is easy to see, the Mob will realize he can't hurt you, and move on to the next person on the hate list.

I *ALWAYS* have both Divine's loaded, and even if the mob turns on me, and I'm at 80% health, I will occasionally cast it, just to make it easy for the mob to switch to another target.

I personally use Divine to aid in controlling aggro =)

------------------
[URL=http://eq.castersrealm.com/players/view_profile.asp?Id=8476]Badany Greatheal[/URL]
Vicar of the Prime Healer Rodcet Nife
The Rathe</TEXTAREA>
</td></tr>
</table>
