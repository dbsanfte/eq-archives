...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Geneze on 02-19-2002 02:27 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">What's the difference between regular and raid grouping? Well for one, you can't run a pact-rotation to keep a main tank alive. In regular groups, you don't normally fight mobs that can't be slowed, or that quad fro 600+ damage. 

Raids have more than one group for a reason. The mobs have insanely high hitpoints that can't be removed efficiently by a small group of people. Similarly, they hit hard enough that they often require special healing strategies. 

Basically, there are TONS of differences in regular and raid groups. I know it doesn't really seem like it when all you are raiding is PoF and PoH, but it will become more evident later on, trust me. </TEXTAREA>
</td></tr>
</table>
