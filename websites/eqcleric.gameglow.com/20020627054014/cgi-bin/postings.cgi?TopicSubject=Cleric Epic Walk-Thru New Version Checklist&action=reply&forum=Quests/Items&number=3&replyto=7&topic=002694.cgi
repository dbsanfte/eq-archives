...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Kraegan:
[B]Ok, question on step 1 I have heard you need to be level 51 to start this and also that it is better to just kill Lavawalker and then kill spirit of flame and skip the whole Bergurgle part.  Does this work?
