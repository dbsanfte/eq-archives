...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Rayne on 05-31-2002 03:51 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Problems with Phinny:

1) Rare drop.  I've killed him more times than I cared to x 3.

2) Who wants to go to Kedge at 60?

3) Takes 4 at best to kill him (not a problem): 2 melee, 1 healer, 1 wizard.  Actually, could do with three I'm sure (monk, priest, wizard).  Technically, not even sure if Wizard needs to be there (MQ?).  Just a pita.

Problem with VS: I haven't seen him alive in almost 2 years.  Sure as hell dead by time I get home on patch day.  Not motivated enough to camp Karnor's waiting on respawn.

But I guess you could call it easy if you normally have a chance to do the mobs.</TEXTAREA>
</td></tr>
</table>
