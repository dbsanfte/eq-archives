...
[B]Have to wait for 46 on Shaman epic due to the  Planar pieces but this shows that for some the only limiting factor is that Verant decided to put a piece of each on at least one plane.[/B][/QUOTE]
