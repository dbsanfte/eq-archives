...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Pavis:
[B]Absor posted that priest classes should be undergo balancing after pet classes are finished.

I would trade CH for better solo options (even if only against undead). Judgment is nice at 925, but DD breaks root fast.

how many of you don't let atleast one or more members of your guild bot you when [/B][/QUOTE]
