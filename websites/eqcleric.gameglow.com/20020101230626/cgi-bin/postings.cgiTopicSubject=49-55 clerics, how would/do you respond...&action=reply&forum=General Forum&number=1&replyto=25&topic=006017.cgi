...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Aliach:
[B]I've been hit with it too:

/tell Dead_persons_corpse_owner, "Would you like a rez?".

Dead_persons_corpse_owner tells you, "what level?".

/tell Dead_persons_corpse_owner, "Forget it!".

If they're a cleric I /who to see what level they and if their's is better than mine, and explain to them that if they want it, it's theirs..

Being Considerate on our server is not too much the common place.. /sigh
