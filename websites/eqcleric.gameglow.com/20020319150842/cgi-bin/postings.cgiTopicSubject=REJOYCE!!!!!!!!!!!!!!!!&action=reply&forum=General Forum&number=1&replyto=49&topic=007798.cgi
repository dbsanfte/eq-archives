...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by NightGod:
[B]Difference with the new Rage and Sev (for warrior epic) is that Rage drops the heart EVERY TIME, whereas Sev doesn't drop a green scale every time.
