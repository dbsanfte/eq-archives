...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Tabb on 02-06-2002 05:42 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I havent seen an 'issues' thread here in a long time, so thought it would be wise to start one.

What I mean is, what are the nagging problems clerics are dealing with.  What is wrong with the class if anything.  What does verant need to do, to fix certain aspects of the class.  Long standing problems is fine.  Long standing problems that have gotten the answer 'working as intended' is fine.  Long standing problems that have been said 'we cannot code that' is fine.

I want to compile a list of issues.

So please, hit reply, and lets discuss  :)</TEXTAREA>
</td></tr>
</table>
