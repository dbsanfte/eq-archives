...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Saarem on 05-24-2002 10:43 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Sorry I disagree... CH is defining yes but it is also a big damn chain around our neck that been the reason VI have said bend over here comes Bubba every time there been talk about changes... Shamans with CH will never happend (or they better nerf Canni line (;  ) but I got no issue with seeing druids with it. Why? Because then I dont have to bother to sit in the CH chain, I can bring my ranger along and let a druid do it instead of having to go play cleric that I did not feel like.

Do I think VI will give away CH without some other form to clerics? Maybe, they done so before (only look at our major "upgrades") but I will have some hope. I expect alot better solo options and to bring more to a group to compensate the lack of group(s) there would be from it. And if they dont? Well there is always my ranger and EQ+AM3 and the cancel button (=
