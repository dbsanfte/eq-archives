...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Cayleu on 01-23-2002 01:13 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">"A killable version of Zordak will appear independent of the pearl turn-in every few days (except after a server goes down, then he will appear a little faster). "

So, no, handing in the shimmering pearl does not spawn Ragefire in skyfire. The two spawns are unrelated.</TEXTAREA>
</td></tr>
</table>
