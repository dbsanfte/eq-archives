...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Adon on 01-23-2002 11:07 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">One would hope:

a) Skyfire Rage is like Naggy and not Talendor (I hope I have the right dragon)

b) The loot is removed completely from him except the container

c) The container is NO DROP/NO RENT until combined with the pearl, when it becomes NO DROP only

This will clear up most issues with the changes IMHO.
