...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Mephana:
[B]There is one Zordac in Solb, he spawns near the BRidge of FireGiants (you have to pass the first 3 firegiants if you come over the long passage (stone spider)..he spaws once all 24 hours..no triggered Ragefire in Solb

I did it..i am now trying to find the other one
