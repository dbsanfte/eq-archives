...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Eidolon Hammerstroke on 03-24-2001 12:53 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">1. Remedy/Divine Light/Superior Heal (depending on the situation)
2. Complete Heal
3. Celestial Heal
4. Alt 1
5. Alt 2
...
Alt 1, Alt 2 and Alt 3, respectively, are usually a DD spell, Root, Atone for travelling, then get swapped out for Buffs (Heroic Bond, ShOW, Symbol) or Root & 2 Stuns when grouped, and other spells as required. 

I used to keep gate memmed all the time as well but now I just mem it when needed. </TEXTAREA>
</td></tr>
</table>
