...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Grogs on 04-03-2002 12:32 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">/agree with Grumbles ref. the dwarf thing :-)

Actually, just about any race is fine for a cleric.  There are trade offs for each.  High elves get the most Wis, dwarves get the highest Str and Sta, halflings get the highest Agi and hide skill, and humans are pretty much middle of the road in all stats.

As for gear, I'd personally focus on +hp, AC, and +mana (in that order).  Up to level 10 you can tank nearly as well as the melees, and up to 20 you can still do it pretty well.  Having good AC and hps means you can fight a battle or 2 without having to worry about rooting the mob and back off to heal.  At level 10, 1 Wis gets you 2 mana, so even a +5 Wis item is only getting you +10 mana (and a +10 mana item will probably be much cheaper than a +5 Wis one).  Get Ivory bracers (+15 mana) for the wrists as an example, and +AC/hp/mana jewelry.  Once you get around level 20-25, the +Wis will start to do a lot more good and you can swap them out.
