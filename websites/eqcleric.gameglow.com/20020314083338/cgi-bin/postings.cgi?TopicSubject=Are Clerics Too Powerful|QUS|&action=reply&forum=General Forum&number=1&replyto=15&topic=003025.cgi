...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by WarBringer!:
[B]Thank you, Dalur
...
Clerics have ALWAYS been left alone .. As Clerics, we should be happy.  No other class has ever smiled after a proctology exam by Verant.  The Cleric class wouldn't be an exception, either.[/B][/QUOTE]
