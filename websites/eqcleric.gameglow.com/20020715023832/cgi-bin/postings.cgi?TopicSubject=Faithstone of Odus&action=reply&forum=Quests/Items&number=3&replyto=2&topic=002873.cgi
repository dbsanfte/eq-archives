...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Faithstone of Odus</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by NocturneXev:
[B]Yeah, you'll find my name all over the threads in Fishing, Brewing, and Pottery about this particular Faithstone.

I was kind of hoping that someone may have figured it out without realizing that nobody else had.   ;)[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Faithstone of Odus">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Quests/Items">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002873.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">NocturneXev</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I'm kinda baffled by the almost complete lack of discussion of Faithstones on these boards.  What's up?  These things are amazing, yet the cleric community is virtually silent (except to ask where the Tunare one drops you).<P>In any case, I'm an Erudite Cleric of Quellious (...the few, the proud, yada yada).  I would really like to get my paws on a Faithstone of Odus, but have been completely unable to find the recipe for Odus Essence.<P>The book "Reconstructing Mythology, Notes", sold by a baker in Skyshrine, contains the recipe for Faithstones / Spiritstones, including a list of ingredients.<P> <IMG SRC="http://www.guildseofon.com/images/reconmyth.jpg"> <P>As you can see, the list includes "Barren Flounder", which is the only ingredient not found so far (I've been checking over on EQ Traders).  Based on the fact that all other Faithstones have been created, this ingredient *must* be for the Faithstone of Odus.<P>This fish used to be caught in Erud's Crossing, but has disappeared recently (when they merged the fishing and foraging tables, apparently), and noone has been able to find it since.<P>Also, nobody has found an alternate recipe for Odus Essence (tried all fishables, as well as Odus Pearl, Star of Odus, Words of Odus, etc.).<P>Does *anyone* here have any information that might help with this?<p>[This message has been edited by NocturneXev (edited 06-12-2002).]</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Bezil</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Theres a reference on eq traders about this.  The barren flounder which is needed for the odus essence was apparently removed from the fishing tables some time ago, and hasnt been put back in yet.<BR> <A HREF="http://www.eqtraders.com/secrets/recipes_may8.htm#brewing" TARGET=_blank>http://www.eqtraders.com/secrets/recipes_may8.htm#brewing</A> </FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">NocturneXev</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Yeah, you'll find my name all over the threads in Fishing, Brewing, and Pottery about this particular Faithstone.<P>I was kind of hoping that someone may have figured it out without realizing that nobody else had.   <IMG SRC="http://eqcleric.gameglow.com/ubb/wink.gif"></FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Boanerges</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have e-mailed Verant about this issue and the Initiate Symbol of Prexus (or the lack of one).<P>I got a form letter response Tuesday but I guess they couldn't fit it into the Wed patch assuming they even had one to put in.<P>I suggest you e-mail Verant (or use the Dev boards if they're fixed) and let them know about the problem. 2 complaints are better than 1.<P>------------------<BR>Boanerges Thundercry<BR>High Priest of Prexus<BR><A HREF="http://www.cohort.cc" TARGET=_blank>Cohort Chalybeius</A><BR>Cazic Thule Server</FONT></TD></TR></TABLE>
</FONT>
