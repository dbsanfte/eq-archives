...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Gniss Fleshmender on 03-23-2001 02:03 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">usually an enchanter has enough options that a bad group only kills them once. after that, it's recover corpse, gate, and say f you all, morons. (with cleaner language)   =)

------------------
The patchwork cleric
Domus Divinae
Prexus</TEXTAREA>
</td></tr>
</table>
