...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Tommara:
[B]A cleric [i]should[/i] be replaceable by two of the other healing classes.  That's very basic premise/axiom in my opinions about class balance and if you disagree with that, we are unlikely to agree on anything about class balance issues, so best to just move on and agree to disagree.

But that wasn't what my comment was about.  My comment relates to whenever clerics complain about how boring/stressful, etc. we are, we get told "STFU, whiny cleric!  You can res and everybody needs you!"  Like I said, Gee, lucky me for having neato spells just so that I can make it much more fun for other people!
