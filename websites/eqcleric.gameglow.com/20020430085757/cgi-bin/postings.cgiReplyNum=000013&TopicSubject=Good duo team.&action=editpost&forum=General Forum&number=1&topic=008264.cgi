...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Zeeta on 04-08-2002 03:22 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]Hmm, in the mage compendium it says that when grouped the pet barely takes any exp. That in average it only takes 0.5 to 1% of the exp.
[/QUOTE]

This was indeed stated by Verant about 1 year ago but was recently clarified following some testing done.
