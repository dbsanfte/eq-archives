...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Aenae on 01-12-2001 08:54 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">To post your file, try creating a file repository on Geocities.com or some equivalent, and then just link to it from here.

This is what I use for my signature pictues (ezboard) and other misc posts.

- Aenae Webspinner
- Priestess of Luclin</TEXTAREA>
</td></tr>
</table>
