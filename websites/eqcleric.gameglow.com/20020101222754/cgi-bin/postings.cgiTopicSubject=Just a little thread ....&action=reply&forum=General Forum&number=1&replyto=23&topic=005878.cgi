...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Sollwin:
[B]My comment was, how those threads have a tendancy to to point to problem, then blame the cleric and lead right into how the world would be great if Druids and Shaman had the ability.

Should I be replaceable by 2 other preist classes that can heal?  Most likely, that does make sense, and I never said it did not.

Let's not forget, that a cleric is not the only class that can provide res.

I think the root of the problem, is that not every res capable class wants to travel to all ends of Norrath to res them.  Thier dead, lost a lot of xp and are in a reallly bad mood.  Thats tends to impact their thinking.

Yes, I think Druids and Shamans needed better healing, but not for free.  As it is, they received one heck of an upgrade at no cost.  IMHO they have to much solo and group capabilites to be considered "balanced"
