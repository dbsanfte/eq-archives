...
<BR>
Topic: <FONT COLOR="#2f2f4f">cleric bots</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Band Aid on 05-21-2002 07:07 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Im working on leveling 2 characters on a differnt account, a cleric on one and a monk on another so i thought a quick way to level both is to group them together. My question is, is can i use a bot to control my cleric without me actually having to play it ???
