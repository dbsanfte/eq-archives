...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">June 12th Patch Message</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Lolli:
[B]I have a macro that executes Sense Heading and /loc bound to my forward key. This way I always know where I am and what direction I am facing.[/B][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="June 12th Patch Message">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="008724.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Quotison</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">PATCH MESSAGE, JUNE 12, 2002 <P>NPC Spell Caster Changes<P>-NPCs are now bound by spell casting distance rules, meaning that an NPC's spell will no longer connect from halfway across the zone <BR>-NPCs now have a chance to be interrupted by normal combat when casting newer spells <BR>-NPCs that are much lower level than their target have had their potential casting damage reduced using a similar mechanic to the one that player characters' level differences use <BR>-NPC Wizards no longer have an inherent bonus to their fire and cold based spells <BR>Most NPCs that had previously had their spellcasting level inflated to make up for poor spell selection have been brought back into line with their actual level <BR>-NPCs no longer automatically get free access to rarely dropped spells, such as Garrison's Superior Sundering and Funeral Pyre of Kelador. <P>Spells<P>-True North now works while on horseback <BR>-"Harmonize" songs should now last 12 minutes <BR>-PC Enchanters will always resist their own single-target mesmerization spells. <BR>-Player characters will no longer use mana on targeted spell casts that do not connect due to Line of Sight <BR>-The Bind/Cast Sight line of spells now works as it used to. You do not need to have line of sight to your target to use this spell. <BR>-The sight effects granted by illusions should now remain when someone with permanent illusion zones <P>Items<P>-Stanos' Pouch has had its charges increased to 20 <BR>-Blessed Knight's Mask is now tradable <BR>-Mask of the Grimling Hunter is now wearable <BR>-Faun Flute is now usable by Vah Shir <BR>-Shrouded Boots are now magical <BR>-Pickbringers Chainmail is now usable by Gnomes <BR>-Acrylia Reinforced Armor is now usable by short races <BR>-Crystal Chitin Leggings can now be used by rogues <BR>-Sacred Grimling Fishing Spear can now be used by all rogue races and can no longer be used by bards <BR>-Dark Animist Gloves can now be used by Vah Shir <BR>-Kylong Chestplate can now be used by Rangers, Dwarves, Halflings and Gnomes <BR>-All Kylong armor is now usable by Vah Shir, Barbarians, Trolls and Ogres <BR>-Marr's Sustenance should provide the proper effect now <BR>-Shadowhaven Faction Amulet should be more useful now <BR>-Wind Spirits armor can now be worn by Half Elf bards <P>Pets<P>-Familiars and Warders will once again disappear when their buff is clicked off <BR>-Restored the range limit on /pet attack <BR>-'/pet notaunt' and '/pet no taunt' turn taunt off <BR>-'/pet taunt off' turns it off as well <BR>-'/pet taunt on' turns taunt on instead of toggling it <BR>-NOTE: '/pet taunt' still toggles taunt as it did before <BR>-'/pet health report' reports a pet's health <BR>-'/pet health' also reports a pet's health <BR>-'/pet stand' causes the pet to stand up <BR>-'/pet sit' causes the pet to sit down <P>Quests<P>-Loremaster Borannin should be responding properly again <P>Trade Skills<P>-Improved many of the smithed Acrylia items <BR>-Large Blocks, Blocks, and Small Blocks of Magic Clay are now stackable <BR>-Brick of Deathsteel Ore is now stackable <BR>-Several blacksmithed cultural armor set pieces have received a slight improvement to their armor class. <BR>-Tarnished and Fine Steel Weapons may now be recycled into ore by placing them into a forge with a water flask. <P>Miscellaneous<P>-Resurrection timers have been fixed, they count down as normal <BR>-NPCs that began regenerating too fast after the last patch have been fixed <P><BR>- The EverQuest Live Team <BR> <P><BR>------------------<BR><B><A HREF="http://www.magelo.com/eq_view_profile.html?num=42628" TARGET=_blank>Quotison Iachwer</A></B><BR>51st Level Vicar of Brell<BR><B><A HREF="http://www.knightseternity.com" TARGET=_blank> <Knights of Eternity></A></B> <BR>Tarew Marr Server<p>[This message has been edited by Quotison (edited 06-12-2002).]</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Fhylden</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial"> <BLOCKQUOTE><font size="1" face="Verdana, Arial">quote:</font><HR>Originally posted by Quotison:<BR>-True North now works while on horseback <BR>[/B]<HR></BLOCKQUOTE><P>Does anyone actually USE true north?  Especially at the level you can afford a horse?<P>------------------<BR><A HREF="http://www.magelo.com/eq_view_profile.html?num=118148" TARGET=_blank>Fhylden daBlanc</A><BR>level 53 Vicar of Bristlebane<BR>Ayonae Ro<BR>Member of &lt;Prism&gt;</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Lolli</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have a macro that executes Sense Heading and /loc bound to my forward key. This way I always know where I am and what direction I am facing.</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Advert</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">used just about every spell I got but the True north...<BR>Dwarfs don't need a spell to tell em what dir North is.<P>------------------<BR>Advert Silverhand<BR>Cleric of Brell<P>Drunken bartender of Brell<BR>(But I only Drink stuff I can summon)</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">SleepyBhr</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">In the patch: "-Resurrection timers have been fixed, they count down as normal"<P>What is normal for them?  They are not goign to start counting down now if you are logged out and exit EverQuest, are they?  That would be tragic on several counts, not the least of which being you counldn't easily put the game down when you need to step a way for a while.<P>Sanctu<BR>a High Elven Cleric of Tunare<BR>who checks to see if corpses are on-line by considering them a few times</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Tundar</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Dueled a friend last night so he could go buy something in Bazaar and the timer on his corpse was not working properly.<BR>The rez timer was not in sync with the corpse decay timer.<BR>Sometimes it would lack behind with a few secs other times it just didn't count down.<P>I have a screenie of it on my other PC - will make a link when I get time.</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Lynet</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">When I travel I con pc corpses to see if it is worth offering a drive-by rez.<P>I often see<BR>"monkeyjoe's corpse has 3 hours 00 minutes remaining on its resurrection timer.<BR>"monkeyjoe's corpse will expire in 1 day 12 hours"<P>or something similar.<P>I won't get into the question of whether Monkeyjoe is a stupid enough name that they don't get offered a drive-by rez.  If you are near Jersey, the Monkey Joe nut company makes GOOD cashews.<P>Lynet Beaumains, The Damosel Savage</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Balanar</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">heh this "Bug" was a god send for me. went afk at the rage camp for around 2 hours..in that time 3 guild wiped to Talandar at the spot and then killed him on the 4th try.<P>I ended up with around 5 bodies all laying in various parts of the zone. took me a full 4 days to find them all(no body to locate corpses) none of them decayed and all got xp Rez'd just fine.<P>This would have been a GREAT time to do PoS IMO...to bad they changed it.<P>------------------<BR>Balanar Scaleheart<BR>55th Templar<BR>Order of Concord<BR>Tunare Server<BR><A HREF="http://www.magelo.com/eq_view_profile.html?num=224632" TARGET=_blank>Loot</A></FONT></TD></TR></TABLE>
</FONT>
