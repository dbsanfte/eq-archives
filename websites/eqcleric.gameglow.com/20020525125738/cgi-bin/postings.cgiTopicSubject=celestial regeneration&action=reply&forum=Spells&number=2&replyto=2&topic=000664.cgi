...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by eqshirley:
[B]thanks for the info.  This doesn't sound as useful as the description makes it sound tho.  do you know if it stacks w/ CE?[/B][/QUOTE]
