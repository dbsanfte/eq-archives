...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Derenath:
[B]I honestly believe he needs a few more people helping him do his job. It seems he misinterprets many requests or comments and could have a more open mind about some issues, the abolish disease in particular.

What bugs me the most is his attitude. It is mostly adverserial and on the civil side of snooty. Abashi seems to believe all the players are out to get an easy time of it with little effort. I could be wrong but that certainly isn't what I see for the most part. My favorite was the cleric quest armor.

Clerics: "Hey, these armor quests take forever to complete"
Abashi: "Not broken, as intended"
Clerics: "No, really it's broken"
Abashi:"Oh hush, it's perfectly fine"
Clerics: "We're pretty sure this isn't what you intended"
Abashi: "Ok fine, I'll take a look at it"
Clerics wait 8 months for a response....
Abashi: "We've noticed that the cleric armor quests aren't working as intended and we will be changing them in the next patch"


And when the requests for skills for rangers or AC for monks are denied, one of the common rationales is "Well, we have 14 bijillion subscribers and have sold 20 skillion boxes so we must be right." That is resigning yourself to mediocrity, accepting the good as opposed to striving for the best. I guess we're all guilty of that, but for someone in his particular job he should try to open his mind a little bit.
