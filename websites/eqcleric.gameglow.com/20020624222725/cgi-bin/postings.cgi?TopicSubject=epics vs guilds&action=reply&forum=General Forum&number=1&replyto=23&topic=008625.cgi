...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by stevec:
[B]There are a bunch of people on Rallos Zek who have done this (left the guild/group that got them their Epic for another guild/group), DurokH. I know of a number who were originally in my raid group -- which, due in a large part to people leaving for other guilds/groups, is basically dead now.
