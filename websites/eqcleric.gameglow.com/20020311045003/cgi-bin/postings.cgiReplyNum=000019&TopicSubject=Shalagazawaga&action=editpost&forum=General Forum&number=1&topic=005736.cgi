...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Kimbera on 03-13-2001 09:16 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">"I'm reasonably certain that I learned about contractions in elementary school. Possibly even YOU were exposed to them once or twice on Saturday morning cartoons (Schoolhouse Rock)."

I think I missed that Schoolhouse Rock.  Ah, well.  :(

Besides, everyone knows that the proper way to both contract "you are" and to write the second person possessive is "ur", right?</TEXTAREA>
</td></tr>
</table>
