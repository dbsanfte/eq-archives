...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Saarem on 01-23-2002 05:53 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Why SF people ask?

The reason is rather straight forward. We are to fight a RF dragon (aka big red dragon). That is not a global file. There are currently 4 zones that got it:
...
Somehow I doubt (and so do many others) that it would be in SoV for a RoK quest.

Added to the fact is:
RF loves fire. SF is full of lava (much like Sol B).
It is close to his allies (Chardok).
It was suggested several times to have him in SF.
It gives VI a easy way out to do him (clone current T. and voila, new RF).
Dangrim, 60 muppet of Tide</TEXTAREA>
</td></tr>
</table>
