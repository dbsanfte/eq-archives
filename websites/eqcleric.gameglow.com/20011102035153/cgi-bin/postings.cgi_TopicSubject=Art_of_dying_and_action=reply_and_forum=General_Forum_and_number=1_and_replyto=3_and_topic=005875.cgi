...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Cenge:
[B]Let me clear that up, neg points if you die, neg even more points if you fiz out of mana and die.
