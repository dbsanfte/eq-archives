...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Lhon on 04-16-2001 10:09 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Normal dispells by caster mobs take off a random buff, not the top buff.  Putting on crap buffs will reduce the chance of the symbol getting dispelled, but it won't prevent it for sure, no matter what order they are in.</TEXTAREA>
</td></tr>
</table>
