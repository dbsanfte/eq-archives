...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Dumbledory:
[B]Where exactly the merchant in SolB spawn ? Its a random place ?[/B][/QUOTE]
