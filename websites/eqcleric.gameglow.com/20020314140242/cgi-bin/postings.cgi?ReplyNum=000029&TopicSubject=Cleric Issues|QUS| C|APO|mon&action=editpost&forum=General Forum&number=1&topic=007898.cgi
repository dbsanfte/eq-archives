...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Tymothy on 02-12-2002 03:08 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">My 2 cp

Change SoV boots and bracer to self only  not needing food or drink . So when your wearing them you just dont consume food and water. 

AA skills 
Healing adept and Gift . so basically Druids and shammy get our innate 10 percent heal bonus and we have to waste points on this  for some of our class skills. Change the critical heal one to use half mana instead. you cant crit a CH or as far as i know a CE. 
The heal bonus for clerics should be 5 10 20.
That way both remedy and DL become better heals.

Also with SoL there is now Blessed Water  12 dmg vs vampires. Give us either a Summon spell for it. Or better yet a Bless Water spell. The code is already in the game for it just base it off chanter enchant metal. Give it to use instead of sanctuary. course the player made version would have less dmg maybe 6 or something


Also a bracer with Mark of Retrubution would be nice and one with a right click undead nuke or dot would be nice. Then we could free up some spell slots for fun spells. =) cant wait  for a SoV BP to move MoK to the back of the book



------------------
[URL=http://www.magelo.com/eq_view_profile.html?num=52866]Baron Tymothy LyfeGiver[/URL]
Lvl 60 High Priest of Tunare
Zeb</TEXTAREA>
</td></tr>
</table>
