...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Cytox:
[B]I think what Josiefuz is referring to is the fact that laptops can't be upgraded like desktops can. I'm in the same boat. My 8MB ATI chip in the laptop doesn't exactly scream 'Luclin Compatible'.

Hopefully Verant will release some information for laptop users, or provide ways to turn down/off new graphics for users of slower machines. Apparently you can turn off the new character models, but I haven't heard anything about the new zones.[/B][/QUOTE]
