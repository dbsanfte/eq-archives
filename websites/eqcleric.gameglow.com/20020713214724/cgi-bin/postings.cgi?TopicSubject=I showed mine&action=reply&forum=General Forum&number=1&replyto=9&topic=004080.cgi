...
[B]Umm, a plot?
I know its asking for alot but gm events just dont cut it.  Would be nice if skeletons invaded a town for a few days or something.  This game is the same ol thing every day!  Camp a mob for exp/items.  Go to new area, do EXACT same thing. Have monk pull, ench mez, wiz blast, cleric heal.  Same proceedure just in a different place.  
Would be nice to have to get back to your 'home' asap cause the ogres are killing your kinfolk.

I play on RZ, we actually had some stuff like this in the beginning of EQ (all player ran).  Would be nice if gms put a little plot/flavor into the game.[/B][/QUOTE]
