...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Caleal on 05-02-2001 06:51 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Me and another level 60 cleric in my guild were bord one night so we dueled. Almost 2 hours later we decided it was futile, so we called it, heh.

Ok, so we were both using stuff that isn't allowed in the BoTB, but still, its amusing as hell to stand there in a fight using a manastone and CE to keep a constant flow of mana like my friend was. I was stoning down and CHing myself with a Donal's chestplate when I got low mana, it was just sad.

I tried it with another cleric not using manastones, I beat him in about 40 min using pure melee with an Etched Velium Brawl Stick.

I highly doubt the cleric BotB will be 1 on 1 pvp due to the length of the fights. Cleric melee just takes to long and our spells are usless offensivly. If it was straight pvp, the cleric that nukes will lose, no question about it. My UNBUFFED magic resistance is over 150 with just 3 item changes, leaving my unbuffed ac still over 1000. Even with a journymans walking stick my MR would still be to high for cleric nukes to land effectivly, if at all. I'm sure many many other clerics can say the same, heh.
