...
<BR>
Topic: <FONT COLOR="#2f2f4f">Heals memmed at 44?</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Dikmer on 03-28-2001 04:31 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]Originally posted by Darianne:
[b]Once I dinged 51, SHeal got replaced with Remedy... and I find myself using the level 49 AE Heal a bit.[/b][/QUOTE]

While I agree with the Remedy part, I find I only sit and mem Word of Healing when the Fit hits the Shan and eveyone is down 2 bubs. If you are using that mana HOG (600mana, isn't it?) alot, then you need to have a talk with your tanks about the use of /assist.
</TEXTAREA>
</td></tr>
</table>
