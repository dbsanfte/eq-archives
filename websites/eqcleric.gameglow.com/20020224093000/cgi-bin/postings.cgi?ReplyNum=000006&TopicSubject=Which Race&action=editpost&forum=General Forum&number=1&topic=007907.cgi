...
<BR>
Topic: <FONT COLOR="#2f2f4f">Which Race</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by JanSorensen on 02-07-2002 07:30 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Any race can and will do well - but if you are looking for the more intricate things...

Dark Elf - Gets a snare necklace from a quest. Granted, the snare has a short duration - but no other cleric race gets this.

Halflings gets sneak - This is usefull for doing quests or using merchants where you just need indifferent. 

I play a dwarf - and I wouldnt change it for any other race - but I do admit that sneak and/or snare would have come in handy at times - more so than the dorfen roll or my water to ale necklace. Incidently those 2 races are also the ones with hide which would be pretty nice to have too.

------------------
[URL=http://www.magelo.com/eq_view_profile.html?num=4264]Mikar of the Nexus[/URL]
High Priest of Brell
[URL=http://companions.windsofstorm.net/]The Companions[/URL]
The Tribunal</TEXTAREA>
</td></tr>
</table>
