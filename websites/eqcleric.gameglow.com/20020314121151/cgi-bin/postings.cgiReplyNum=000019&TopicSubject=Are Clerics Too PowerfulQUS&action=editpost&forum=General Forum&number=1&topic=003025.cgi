...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by By-Tor on 05-30-2000 04:20 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">The initial example given was in a plane run.  Clerics are a necessity on plane/dragon runs, but other than that we can be replaced.  Here is how I feel the cleric class demand is.

Planes/dragon groups: Cleric is a must in every group.  Enchanter, Warrior and puller (monk or SK) are also a must.

Normal groups:  Shaman, druid or paladin can help heal; if the pulls are light no cleric is needed.  If a shaman/enchanter is there hardly anyone will take damage.

Solo: Near impossible.  After high 40s its tough for a cleric to solo.  Clerics can only try and solo single undeads and have very long down times.  Almost every other class can solo better than a cleric.

In closing, enchanters and necros are by far the most powerful classes all around.  Clerics need others in order to become "powerful".  Without the warriors clerics pretty much have no extreme healing powers.  Bless them big lugs!</TEXTAREA>
</td></tr>
</table>
