...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Riffi:
[B]My group consists of a warrior, druid, wizard and two clerics.  If pulls are at singles and doubles, we are fine.  Four people with roots, two with snares (in opportunities to Fear them), and two sets of CHeals for powerful munching critters.

True, we can't effect the critters' attack speeds, nor instill better speed upon our warrior, like a Shaman or Enchanter can, but we can handle doubles.

Triples on up are a different story ....


Riffi Gemstone
gnomish vicar
Bertoxxulous server
"Praise Brell!"[/B][/QUOTE]
