...
<BR>
Topic: <FONT COLOR="#2f2f4f">The truth about Revive...</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Talx on 02-19-2002 03:13 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">
Not quite correct, a corpse can only get experience back on the very first rez it gets.  You can revive(or exp rez) a corpse that has already been Rezzed (within the 3 hours limit, of course).  This is useful in limited situations, but it can be useful...

For example, when in PoA, if someone dies that person no longer needs a key to the next isle (assuming you will be moving to the next isle within 3 hours).  Experience rez them, then within 3 hours, you can summon that same corpse and revive them.  

Or for smaller guilds, when the 56+ cleric on the raid dies, 49 rez them back and have them leave a corpse.  If they die again within 3 hours, they can take a revive on the old corpse and they can rez themselves to gain back that extra 6% exp.  Just make sure you revive the old corpse, or that same cleric won't be happy.   :)</TEXTAREA>
</td></tr>
</table>
