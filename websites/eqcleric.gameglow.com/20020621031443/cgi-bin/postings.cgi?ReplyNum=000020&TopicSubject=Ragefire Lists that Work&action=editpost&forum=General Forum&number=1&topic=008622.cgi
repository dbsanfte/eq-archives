...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by electrae on 06-04-2002 02:18 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I think that's been the line of thinking that's kept Drinal from making progress on anything, Grumbles.  There's enough interest and support in the list that any guild is going to be hard pressed to mobilize against those who have vowed to support it.

Most servers who do have lists have occassional guild who don't observe the list.  They're ignored and somehow the lists manage to succeed, sometimes even outlast the offending guilds.</TEXTAREA>
</td></tr>
</table>
