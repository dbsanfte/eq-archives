...
<BR>
Topic: <FONT COLOR="#2f2f4f">what do you do when?</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Serenya on 12-17-2001 01:05 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Even with a chanter I've found that stunning and rooting often comes into play for CC.  I started playing a wee bit with that new stun aoe from Luclin w/my 39 cleric.  I would suggest practicing with that a bit -- it does damage, so less useful with a chanter, but you can use it to stun everything near your melee (it's targeted, so target your main tank and stay out of range) and then start rooting.  Obviously, that will work better if there is someone else in your group who can root as well (there's a wizzie in mine) as you'll get it done faster and more effectively.  </TEXTAREA>
</td></tr>
</table>
