...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">My letter to Rich Waters</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Malore:
[B]why is it that all tuning for druids is done with healing?  They were never meant to be the greatest healers, and hopefully no one plays them for that reason.  why not give them stronger spells of different types, like lure ac debuffs, great for luclin mobs.

like dikmer said, on many occasions secondary healers don't do there job as it stands right now concerning healing, so giving them a better heal wouldn't be that helpful.[/B][/QUOTE]
...
<A HREF="http://eqcleric.gameglow.com/ubb/Forum1/HTML/008628.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
