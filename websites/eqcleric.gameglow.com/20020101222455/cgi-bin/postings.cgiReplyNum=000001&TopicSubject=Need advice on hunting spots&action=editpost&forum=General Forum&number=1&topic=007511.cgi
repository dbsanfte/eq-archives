...
<BR>
Topic: <FONT COLOR="#2f2f4f">Need advice on hunting spots</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Kornaena on 11-29-2001 11:14 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Yes it is harder to exp in old world zones.  Cazic is only PL and farmers on my server.  Lguk has very few camps.  The area where the BE stuff drops is never camped.  That used to be one of best exp camps in the game on my server.  

What to do?  I soloed specs from level 36 to 44 on and off.  Is a single spec by a tree outside fear and 2 rigth inside the hidden wall to fear.  Also is oasis, but pulling singles is hard when full popped.  Sol b is also as option, can go all the way to level 60 there</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Need advice on hunting spots">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000001">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="007511.cgi">
