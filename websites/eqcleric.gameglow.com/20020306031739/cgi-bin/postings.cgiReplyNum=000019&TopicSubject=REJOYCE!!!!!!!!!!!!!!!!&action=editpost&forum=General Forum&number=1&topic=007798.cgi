...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Phalia on 01-23-2002 04:30 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I am not understanding where you are getting the info that Rage will spawn in Skyfire..I have gone back and re-read the thread, and don't see it.  I only want to be sure because I am very nearly to that part of the quest.  I am glad to see that I don't have to camp in Sol for days on end tho :)  Like someone else said, all I have do now is check on him when I know I will have the forces available.</TEXTAREA>
</td></tr>
</table>
