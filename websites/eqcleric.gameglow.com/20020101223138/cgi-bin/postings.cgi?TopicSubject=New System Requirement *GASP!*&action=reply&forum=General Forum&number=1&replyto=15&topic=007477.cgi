...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Elsatia_Diotallevi:
[B]Playing on a laptop isnt all that bad for EQ really.  There are lots of laptops which are affordable in the last year which should be able to handle SoL.  I recently purchased a p3 850 with 384MB of ram with a 16MB DDR Geforce2go graphics card.  Toshiba and Dell both carry geforce2go's in some of their laptops.  Another good card in laptops are the Mobility Radeons.  Both cards are availiable with 32 MB or DDR as well.  Nvidia will also be realeasing soon a new chipset for laptops which is based on the Geforce3 line even, and from reviews and demos I have seen its completely amazing for a laptop.  basically for about 1500 bucks you can get a super laptop that will have no problem running SoL at all.  yeah yeah not everyone wants to run out and blow 1500 bucks, but I will be on the go from now on and damn I really like playing EQ =P.  The other machine i have is an AMD 850 with a 32ddr radeon, and relaly the laptop runs EQ at the same level of performance, which is more or less perfectly.  While what I have now doenst exactly meet the recommended specs for SoL I am confident it will be more than sufficent anyways.

Not saying how fantastic it would be to spend a bunch of money to keep playing eq, but I thought I would let you know there are many mobile computing options.  Ah yes, and tonight I downloaded the Dx8 patch.  Dear god performance is 2 tiems better now.. albiet soemthing is seriously wrong with objects popping in at a distance but if you ugys havent done that yet give it a try@!
