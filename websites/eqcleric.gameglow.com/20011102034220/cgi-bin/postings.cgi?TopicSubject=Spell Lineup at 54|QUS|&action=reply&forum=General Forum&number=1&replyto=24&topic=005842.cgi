...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Spell Lineup at 54?</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Frothgar:
[B]Here's my level 53 lineup:
...
DA
CelH
Retribution/Banish Undead
Sound of Force (swap for buffs)
Root
Gate
DB

It's interesting to see how many use Divine Light.  I just can't justify (yet) a fourth healing spell that is somewhere between Remedy and Celestial Healing.  Oh, and although I use the damaging stuns, I won't cast 'em on a MOB if the Enchanter is trying to mez it (I'll cast root instead).  Anyhow, these spell mem posts are always a good read.

Frothgar, Cleric of Butcherblock
...
<A HREF="http://eqcleric.gameglow.com/ubb/Forum1/HTML/005842.html" target=_blank> *** Click here to review this topic. ***</A>
</FONT>
