...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Armag:
[B]Hehe, pretty funny, he's few

Taunting a lvl 51 gnoll, cause your favorite cleric hit "a" while trying to talk to him: +10
You favorite cleric is able to gate and zone: +20

Falling for 1000+ damage of the ramp in EK: -10
If you were running up the ramp while drunk and almost made it to the top: +20

Thinking Dvinn won't follow you into the moat after you cast DA: +5

Druid/Ranger types:
Snared self instead of casting SoW: +5
You were kiting something: +5
What you were kiting was a sand giant and some drybone friends: +20
Root self instead of casting damage shield: +5
You are able to recast damage shield: +5
The damage shield does more damage than your weapons/spells: +10
