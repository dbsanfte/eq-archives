...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Emmhim:
[B]The text says:
...
Does anybody know what the requirements are if SoL character models are disabled? Is it only the RAM requirementw which are reduced, or are the CPU, video card, etc. requirements reduced too?

Greetings Emmhim
Lvl 57 Templar
Not-so-happy-owner-of-a-2½-year-old-PC :-)[/B][/QUOTE]
