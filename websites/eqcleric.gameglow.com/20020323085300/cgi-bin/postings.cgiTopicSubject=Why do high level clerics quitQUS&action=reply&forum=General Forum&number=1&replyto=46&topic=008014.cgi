...
[B]The only other possible class that could be a raid stopper is the Warrior. Some raids you just can't do with out at least 1 warrior to CH. But, you can get by with 1, most of the time.

Some raids are hard without alot of rogues for damage output, but you can get by without them.

But the cleric is THE make or break class for any raid. Can't do a CH rotation with 1 cleric.[/B][/QUOTE]
