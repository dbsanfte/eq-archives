...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Kessina on 05-28-2002 04:06 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">What's up with this anti-druid sentiment?

I know we all have limited trust on Verant's ability to balance classes but for Tunare's sake, let them try first.  Whatever the opinion is, Verant has heard them all, more than once, more than 100 times.  These rant sessions are getting tiring.

In my roaming of all the boards, clerics, druids, rangers, and pallies are the "whinniest" (<-- is there such a word?).  I thought we are better than that.  Let's stop the whinning and elevate ourselves above that level.
