...
[B]I have to cast another vote for the bard, and add something to it:  let THEM pull.  The bard lament song is actually a WICKED effective indoor alternative to harmony.

Plus most bards will be thrilled if you ask them to pull instead of meekly sitting in the corner and playing clarity *chuckle*.  It isn't a 51+ experience like the topic being discussed here, but my bard had an absolute blast being primary crowd control (via pulls as well as mez/charm) in the chapel area of Kaesora.  The clarity song is just an added bonus in cases like that one.

Of course, bards are not common, especially 51+  =\.
