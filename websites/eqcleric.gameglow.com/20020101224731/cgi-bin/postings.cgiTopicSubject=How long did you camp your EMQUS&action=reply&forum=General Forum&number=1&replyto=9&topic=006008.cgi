...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Myc:
[B]I've been to Hate twice I believe, and almost have a full set.  The first time I went basically I got to loot everything except BP and legs.  I ended up getting boots, arms (really like them), helm (really like it), and a shield.  Second time I was forced into looting gauntlets :P

In both times we've had bracers, BPs, and legs drop.  Just didn't win the roll, or weren't allowed to roll for them.  So it shouldn't take too many sessions to get a bunch of EM, just depends on the luck.[/B][/QUOTE]
