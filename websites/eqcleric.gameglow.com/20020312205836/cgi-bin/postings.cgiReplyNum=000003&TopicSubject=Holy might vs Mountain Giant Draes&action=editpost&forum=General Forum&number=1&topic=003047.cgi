...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Dalur - Veeshan on 05-31-2000 10:15 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I believe there are only a couple of things that fit on the large scale that are stunnable.

1)  Dino in OOT
2)  Wurm (and wurm line) in BW, Skyfire and elsewhere where the wurms live.
