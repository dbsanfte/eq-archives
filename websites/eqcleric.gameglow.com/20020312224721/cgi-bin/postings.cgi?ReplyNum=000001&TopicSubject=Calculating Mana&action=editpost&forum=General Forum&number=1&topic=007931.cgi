...
<BR>
Topic: <FONT COLOR="#2f2f4f">Calculating Mana</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by JanSorensen on 02-11-2002 07:42 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Magelo calculates mana as:

2*Level + Level/5 * Wisdom_upto200 + Level/10 * Wisdom_from200to255

At 60 with above 200 wis thats:

2*60 + 12*200 + 6*(Wis-200).

Castersrealms does nearly the same but uses 5.8 instead of 6.

I cannot comment on Alla's as I am not a member there and hence cannot access your profile. 

My own tests (as posted here a while back) let me to the formula Magelo uses.
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Calculating Mana">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000001">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="007931.cgi">
