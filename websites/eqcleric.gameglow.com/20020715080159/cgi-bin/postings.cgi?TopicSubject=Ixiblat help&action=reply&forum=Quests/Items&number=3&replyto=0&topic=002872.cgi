...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Ixiblat help</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Txaxx Clearwater:
[B]Anyone have a guide or help as to what is needed for Ixi raid....have 2 clerics with shell ready for Naxton.  Plan on settin up a raid so that we both can get him.  Any help is appreciated.
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Ixiblat help">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Quests/Items">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002872.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Txaxx Clearwater</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Anyone have a guide or help as to what is needed for Ixi raid....have 2 clerics with shell ready for Naxton.  Plan on settin up a raid so that we both can get him.  Any help is appreciated.<P>Thx <P>Txaxx Clearwater<BR>52 Vicar<BR>Tunare Server</FONT></TD></TR></TABLE>
</FONT>
