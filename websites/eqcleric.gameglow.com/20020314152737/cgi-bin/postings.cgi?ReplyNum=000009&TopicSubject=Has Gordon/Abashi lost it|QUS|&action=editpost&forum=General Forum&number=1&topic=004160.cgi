...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Aunoa on 09-14-2000 06:02 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">The one thing i think that really comes across strongly from his posts is that he has no real appreciation of the nature of the game at high levels (insert 'any levels' actually) and therefore fails to understand some of the problems & gripes that the player base has to deal with day to day.
