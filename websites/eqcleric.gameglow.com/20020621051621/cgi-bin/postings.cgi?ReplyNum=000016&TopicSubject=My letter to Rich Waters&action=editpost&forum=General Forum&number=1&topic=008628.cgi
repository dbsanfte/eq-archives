...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Kero on 05-28-2002 04:10 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]
Clerics nuke much better than druids heal, but druids are still pumping all their mana through very poor heal spells.[/QUOTE]

Let me just say first off that this statement got my curiosity going.  To see the results, go to [URL=http://www.skybyrd.net/clericvsdruid.htm]http://www.skybyrd.net/clericvsdruid.htm[/URL] 

It seems to prove Lind wrong, but I'm welcome to criticism, if I did things wrong.  For percentage, it's "Percentage of (heal/damage) that (class) has."  If that made any sense at all.

Anyway, tell me what you think.</TEXTAREA>
</td></tr>
</table>
