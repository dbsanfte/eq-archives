...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Dorad on 05-30-2000 01:39 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">LOL choices choices choices - well all cleric are going to be in this position once they start doing the planes.

Once you have your AC above 800 and your wisdom around 200 - it all about looks. 

Now you have options make your Dwarf a bit stylish - it time to get rid of those gator scale leggings.

Alliliel, no one says you have to wear the purple stuff HELL you don't even have to be in the lotto for it. Just tell your raid/party that you want in on the leggs /BP and Helm.

As for "veteran status" just because you have purple armor doesn't determin how many time you have been to POH. Well maybe it does in your groups but in my guild we have all that planed way out in advanced. If anything people look at your armor and say she has way better equipment then "mofo" cleric - mofo cleric should get the BP.

Dorad Clericus

[This message has been edited by Dorad (edited 05-30-2000).]</TEXTAREA>
</td></tr>
</table>
