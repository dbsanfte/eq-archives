...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Kimbera:
[B]"Why do druids get every type of spell in the game? And I'm not talking weak spells, they get the top of the line... except rez spells. I never did understand why a druid (supposedly one with the animals) has the ability to teleport himself and others to another land. Obviously one of the top Verant employees plays a druid."

ROFLMAO!  Now that's funny!

Besides the resurrection line, Druids do not get top of the line Healing or Pet spells.  Most of the druid DDs are fire-based, which limits their versatility in certain areas.  I don't know for sure about the DoTs, but I think both Shaman and Necromancer lines are better.  Also, Shaman and Cleric buffs are both better IMO than Druids'.

As far as teleports go, I suspect that has to do with ley lines.  I believe that some old Arthurian stories list Merlin (a druid) as moving entire armies quickly.

Besides, if a top Verant employee played a druid, why would they look like newbies for so much of their careers?  :)[/B][/QUOTE]
