...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Anyone having troubles logging on??</FONT></td></tr></table>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Anyone having troubles logging on??">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="General Forum">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="007513.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000080">
<P>
...
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=1 WIDTH="95%"><TR bgcolor="#D5E6E1"><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#000080" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Vamenea</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have been for the past couple days (ie before the patch) but I didnt think of it till tonight as I had only planned to log on give a friend something then log off the previous few nights.<P><BR>I keep getting to the password selection screen I type my password in and I keep getting this message "Error 1001: Could not connect to Everquest Server. Try again shortly.<P>Try again shortly??  what 3 days isnt short enought for you? and I know there is no patch at the moment.<P>Already posted on the help section on the official everquest board with no response as of yet and my main server board and havent gotten anything that helps..<P><BR>Gah this turned out more like a rant then a question lol'  and Im suppose to be helping friends right now with last stages of there epics tonight /sigh<P><BR>Vamenea Deryther<BR>Templar of Innoruuk<BR>Tholuxe Paells</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Spawrhawk</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Well, atm I'm downloading new drivers for my graphics card as a last resort to try and solve the problem of me trying to log INTO EQ. Seems I can get to the server select screen then /wave goodbye to EQ and kicks me back to desktop... I'm very frustrated atm. <P>The log in server though is kinda screwy. I get that on occasion and just blast it away with me return/enter key. After a while the log in server says, "oh, so you want IN do ya? Okay all right already!" *smirks* Yes, this is my official tech response to the problem. If all else fails, see what speed you're running at. If you have anything under 28.8, reconnect (if you are on dial-up).<P>Hope that helps =P<P>Spawrhawk Wormwood<BR>57 Templar of Fennin Ro<BR><A HREF="http://www.magelo.com/eq_view_profile.html?num=15286" TARGET=_blank>http://www.magelo.com/eq_view_profile.html?num=15286</A> <p>[This message has been edited by Spawrhawk (edited 11-30-2001).]</FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Bram</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">I have a different problem.  Downloaded new patcher, now I can't even run EQ.  <sigh>.<P>Bram</FONT></TD></TR><TR bgcolor="#f7f7f7"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Spawrhawk</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Found this at the Safehouse...<BR> <A HREF="http://boards.station.sony.com/ubb/everquest/Forum1/HTML/000400.html" TARGET=_blank>http://boards.station.sony.com/ubb/everquest/Forum1/HTML/000400.html</A> <P>It's a start, hope it helps. <P>P.S. I finally got my video card to behave. Added the following to myeqclient.ini file....<P>USETnL=FALSE<P>Now I don't know if you're supposed to do that or not but everything is just like it was before...except faster. So I'm not complaining (nor am I going to touch any settings for a while =P)<BR></FONT></TD></TR><TR bgcolor="#dedfdf"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">Aladain</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">Verant nerfed aussies, Vam =)<P>/hug vamiena<P>Aladain</FONT></TD></TR></TABLE>
</FONT>
