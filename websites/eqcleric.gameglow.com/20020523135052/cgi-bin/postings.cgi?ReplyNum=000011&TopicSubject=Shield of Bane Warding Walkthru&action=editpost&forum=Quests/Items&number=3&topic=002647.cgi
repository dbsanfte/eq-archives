...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Talura cwnZeylon on 03-04-2002 03:11 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Cool, thanks for the info all. Sounds like it's something I can get help from just about anyone willing to suffer through countless hours of boring camptime.  :)
Was I correct in seeing that the shield is not NODROP? Is it possible to do this quest concurrently with a group of people? Could be a way to entice people.
Safehouse is a beast to find stuff in -- ezboard does not seem to have a working search function (I at least have yet to make a successful search on it), and their boards are extremely active  ;) so things tend to fall off the front pages quickly. Having a direct link makes it easy though.</TEXTAREA>
</td></tr>
</table>
