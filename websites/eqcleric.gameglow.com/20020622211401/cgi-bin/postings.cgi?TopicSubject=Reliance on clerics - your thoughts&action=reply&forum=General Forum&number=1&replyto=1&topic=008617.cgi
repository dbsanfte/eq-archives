...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Mirixia Elamshinae:
[B]
Naturally, all classes should be somewhat balanced and equally desired on raids. When I created my necro, I never saw a sign that warned me that I'd be one of the least desired raiding classes in the high end game. 
