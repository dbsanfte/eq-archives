...
<BR>
Topic: <FONT COLOR="#2f2f4f">39 and Complete Heal</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Khaidu Ilkhanate on 03-25-2001 01:20 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">If I recall didn't use CH much at 39.  It doesn't get real mana efficient till the mid 40's or so.  Then you will start to see major mana savings using ch over other heals.  The trick to the long casting time is you have to time the heal and start it for example when your tank is at 2 bubbles of life, then the heal will go off when he has like half a bubble or life.  It takes practice to get used to.  :)
