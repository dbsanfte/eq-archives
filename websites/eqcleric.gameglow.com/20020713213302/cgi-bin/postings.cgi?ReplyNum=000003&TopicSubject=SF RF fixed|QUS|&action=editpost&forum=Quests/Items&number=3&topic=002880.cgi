...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Phalia on 06-16-2002 05:01 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">I included the time before the patch, since he had camp for a couple of days before the patch.  I did not count the time the servers were down during the patch.</TEXTAREA>
</td></tr>
</table>
