...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Sherazade on 06-13-2002 02:58 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">Yes, I am one of this PoS clerics that doesn't have the BoA yet - and that doesn't want  to (can) pay the 35 kpp that are asked for it on our server. (Luclin mobs are being camped / pharmed by one guild and its tough to find even one up that we could kill... :\ )

So I took a few people to the High Priest cycle in AC to make the HP spawn in hope he will drop a spell (hopefully BoA).

We managed to make him spawn once, but then there was confussion what to do with this no rent key - should we give it the Vah Shir prisoner? How can we make the HP spawn again? Or does he have a specific spawntime after he got killed?

Do both versions (Gakkernog and a High Priest) drop spells? 

We had to call it anyway, because Trak was up :b but I definitly would like to do it once again

------------------
[b][URL=http://www.magelo.com/eq_view_profile.html?num=57292]Sherazade Akamas[/URL][/b]
[URL=http://www.shiningalliance.com]Shining Alliance[/URL]
Prexus

It's a good thing Clerics have magical means of reviving a character.

Imagine giving mouth to mouth to an ogre.

[This message has been edited by Sherazade (edited 06-13-2002).]</TEXTAREA>
</td></tr>
</table>
