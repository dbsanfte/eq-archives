...
<BR>
Topic: <FONT COLOR="#2f2f4f">Proposed revision to Ragefire.....</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Belhaven on 04-05-2002 11:57 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">hmm - here's another idea....

Change the current result from the quest to be a sceptre with unlimited charges of Resurrection (49 - 90%) and ->no  other stats<- and make the quest doable once a day.  

Extend the quest, adding additional steps as necessary to get the original item, and set the new one on the 1 or 2 a week cycle.  

I wonder how many folks would get the first bit and never go on to get the REAL piece.

[This message has been edited by Belhaven (edited 04-05-2002).]</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Proposed revision to Ragefire.....">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Quests/Items">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000005">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="3">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="002755.cgi">
