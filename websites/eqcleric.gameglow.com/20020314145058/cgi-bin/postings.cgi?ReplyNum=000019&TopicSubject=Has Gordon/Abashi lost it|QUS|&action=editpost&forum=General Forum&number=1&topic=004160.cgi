...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Advert on 09-15-2000 04:21 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">To ban people from a online game is wrong and prolly NOT legal, The user have paid money for a product and if the manufacture wants to take back the product the they have to: 

First : Ask the user if he wants to give it back . (remember that the user have paid for the product)

second : Pay the user back the money spent on purchesing the product before the product is given back.

This means the because that EQ is a game that you can only play online, Verant can NOT Ban users from playing EQ without giving back the users money .

If you could play it offline then Verant  MIGHT be able to ban users from their networks, (not realy sure about this part because the EQ game info stats that it is a game that users can play online, and if verant changes it so that users can't play online any more then it is something wrong with the product they sold and they have to take it back and reimburse (think it is called reimbursed) the users.

So Verant or any people from verant are WRONG to ban people. 

If I was ever baned from eq for any reason I would contact my company lawyer and have him pay verant a visit.

Whats wrong with the world when u can't express you opinion about a product that you have paid for. (it like u live in a police state and if u say something wrong you will get prison for it)

Verant should realy start to try to work on makeing people happy about their company and not makeing the users hate them.

Gordon is just the front of a company with a bad PR.
And sometimes he might say or do the wrong thing but lets not forget that it is VERANT that setup the rules that allow users for getting baned for expressing their opinion about their product.

Well thats all I have to say , see ye all in the game, bye

(finaly got past hell lev 1  :)  :)  :)  :)(stupid of verant to make it just a hell lev when u group and not when u play solo, I read somewhere that they wanted u to group so why make it a hell lev only when u group ??))


------------------
Advert Lifebringer
Cleric of Brell
On the bertoxx.. server
</TEXTAREA>
</td></tr>
</table>
