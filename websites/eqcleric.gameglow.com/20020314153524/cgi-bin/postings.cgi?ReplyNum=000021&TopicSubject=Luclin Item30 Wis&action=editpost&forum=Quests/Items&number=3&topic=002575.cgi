...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Adon on 02-01-2002 01:58 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">The guild on my server that first got this breast plate sent me hoots and hollers when they got it.

Then I discovered that its pink plate /shrug

Anyway

My BP is 
Ac +45 +25 str +45 stam +125 hp +25 sv disease +25 sv poison and has the same effect as a fungi tunic. It also weighs nothing (0.1 stone).

The spectacular ac on the Jenny bp, +60 ac and +30 wisdom are great too  :)

I'd say the two bp are about equal, but my bp looks cooler  :)
