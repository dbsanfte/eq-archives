...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Hinanar on 04-30-2001 10:42 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">
A guild that expects things like that will lose a lot of clerics.  It is unreasonable to expect anyone to do something when they are not available.

I think you did the right thing under the circumstances.  It is always sad to leave a guild, but in this case, it appears to be the right thing to do.</TEXTAREA>
</td></tr>
</table>
