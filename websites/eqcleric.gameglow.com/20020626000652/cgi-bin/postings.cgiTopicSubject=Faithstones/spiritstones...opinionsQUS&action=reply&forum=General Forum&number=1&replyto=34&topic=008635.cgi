...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by Sherazade:
[B]Very often Clerics have to change their bindpoint - I think I change mine twice a week at least.

You can't imagine how glad I am that I get a new kind of escape - I admit gating to Qeynos or even worse Cabilis isn't as good as a gate to Felwithe - but at least you can run within 10 min to Surfall Glade - you just need a druid to pick you up. This might be easier then find one in Western Wastes, Temple of Ssra or Akheva.

(Ok maybe not all of you are so clumpsy to click gate before they check /charinfo)
