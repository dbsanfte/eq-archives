...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">[QUOTE]Originally posted by DaSmiter:
[B]Fruito, I think you still missed a small part of my point. Healing is not the only way VI can give classes to negate damage, Runes doesn't HAVE to be as expensive as it is. Regen CAN do more to offset damege taken during high end raids. They COULD give some class a spell that literally negates x% of damage taken over a period of time(hyper runes). ALL of these things would be as effective as CH in some situations, but not in others.

The goal here should be for VI to give the players/classes more different options, not to give more classes the current options of one class.  :D[/B][/QUOTE]
