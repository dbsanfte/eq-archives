...
<BR>
Topic: <FONT COLOR="#2f2f4f">Reagent costs and guild support</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Xitara Du'Vie -Xegony- on 03-23-2001 03:14 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL">My guild has recently been collecting a lot of equipment that nobody would use, so we have decided to sell some of it off to other players in order to pay for gems/coffins etc.</TEXTAREA>
</td></tr>
</table>
