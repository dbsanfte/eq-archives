...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#2f2f4f">Originally posted by Siren on 03-21-2002 02:51 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=10 COLS=45 WRAP="VIRTUAL"> [QUOTE]Why do they even have clerics around anymore? CH and the 96% rez? [/QUOTE]
Uh... yes.  And for Aego.

Why are there mages around?  For mod rods.
Why are there necros around?  For twitching!
Why are there druids around?  For ports
Why are there shaman around?  For slow
Why are there enchs around?  For clarity/haste.

Do you see how silly that sounds?  We are a specialized class.  We excel in one area.  We are not a hybrid class that is decent at lots of things, master of none.  We heal best, buff the most HP's, rezz the best rezz.  The rest is just fluff. 
</TEXTAREA>
</td></tr>
</table>
