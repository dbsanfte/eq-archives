...
<HTML>
<HEAD>
<TITLE>EQVault Image Display</TITLE>
</HEAD>
<BODY BGCOLOR=white>
...
<script language="JavaScript">
<!--
addTag('size=468x60&genre=rpg&network=ign&category=pc&site=pc','j1');
// -->
</script>

<noscript>
<a href="http://adserver.ign.com/click-ng/size=468x60&genre=rpg&network=ign&category=pc&site=pc" target="_new">
<img src="http://adserver.ign.com/image-ng/size=468x60&genre=rpg&network=ign&category=pc&site=pc" width=468 height=60 border=0 alt="banner ad"></a>
</noscript>
<!-- end RPG genre banner ad -->
</center>
...
<A HREF="javascript:history.go(-1)"><IMG SRC="/images/back.jpg" BORDER=0 width=130 height=38></A>
...
<script language="JavaScript">
<!--
target="size=468x60&page=h&network=ign&category=pc&site=pc";
...
target="size=468x60b&network=ign&category=pc&site=pc";
bottom_ad = '<layer src="http://adserver.ign.com/html-ng/' + target + '?' + random + '" ID=layerj2 visibility=hide bgcolor=white onload="moveToAbsolute(j2.pageX, j2.pageY); visibility='show';"></layer>';

if (hasLayers && obeysNoscript) {
	document.write(top_ad);
	document.write(bottom_ad);
}
