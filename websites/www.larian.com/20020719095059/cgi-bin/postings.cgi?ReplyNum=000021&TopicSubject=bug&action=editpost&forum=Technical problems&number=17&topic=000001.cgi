...
<FONT SIZE="2" FACE="Verdana, Arial" color="#F0DCA0">
<B>
Forum: <FONT COLOR="#D0BC90">Technical problems </FONT>
<BR>
Topic: <FONT COLOR="#D0BC90">bug</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#D0BC90">Originally posted by eddie on 05-05-2002 08:46 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">Whoooeeeiii!  :)  :)
It works! Yessssssssss!  :)  :D

The only thing that was different, was rebooting. So, perhaps I should reboot when the game mysteriously crashes?  ;)

Anyway, during the loading there was no white screen...
Strange...

But.. it works!!  :)
Back to play agian (is the 4th time or so that I need/want to start over)  :D</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="bug">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Technical problems">
