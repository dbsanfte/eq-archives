...
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Walkthrough</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">[QUOTE]Originally posted by Clannad:
[I]Nice work !

I have 3 minor thingies.

1.
You dont have to drop any axes when you want to give the Slasher to smiruk, the conversation lets you choose which one to give.

2.
You may want to tell how to ditch Gregor Brock when you say that you can do it. 

3.
This might be a bug but after you kill Thelryon, you could actually just flee north out of the chamber and Mardaneus will come out and talk to you, when he leaves all the monsters are dead and you can go back and pick up the goodies  :).[/I][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Walkthrough">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Help/Tips/Tricks">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="16">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000040.cgi">
<CENTER>
 <FONT SIZE="2" FACE="Verdana, Arial" COLOR="#F0DCA0">
<P>
...
<IFRAME FRAMEBORDER=1 ALIGN=CENTER width=100% HEIGHT=200 SCROLLING=YES SRC="http://www.larian.com/ubb/Forum16/HTML/000040.html">
<A HREF="http://www.larian.com/ubb/Forum16/HTML/000040.html" target=_blank> *** Click here to review this topic. ***</A>
</IFRAME>
</FONT>
