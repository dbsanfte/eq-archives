...
<table border=0>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Forum:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Divine Divinity News</FONT></td></tr>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Divinity Demo: First Impressions at RPGDot.com</FONT></td></tr></table>
...
<tr ><td colspan=2><B><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">If you are an administrator or moderator, you do not need to type a forum password.  If you are not, you must supply the forum password in order to post a message in this forum, unless you have been given specific permission by your administrator.</FONT></B></td></tr><tr ><td><FONT SIZE="2" FACE="Verdana, Arial" color="#F0DCA0">Forum Password:</FONT></td><td><INPUT TYPE="TEXT" NAME="ForumPassword"
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Divinity Demo: First Impressions at RPGDot.com">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Divine Divinity News">
...
<IFRAME FRAMEBORDER=1 ALIGN=CENTER width=100% HEIGHT=200 SCROLLING=YES SRC="http://www.larian.com/ubb/Forum14/HTML/000029.html">
<TABLE BORDER=0 cellpadding=4 border=0 cellspacing=0 WIDTH="95%"><TR ><TD COLSPAN=2><CENTER><FONT SIZE="2" COLOR="#F0DCA0" FACE="Verdana, Arial">T O P I C  &nbsp;&nbsp;&nbsp; R E V I E W</font></CENTER></TD></TR><TR background="http://www.larian.com/ubb/forumtextureL.jpg"><TD valign=top><FONT SIZE="2" FACE="Verdana, Arial">lynn</FONT></TD><TD><FONT SIZE="2" FACE="Verdana, Arial">RPGDot.com has played the  <IMG ALIGN=top SRC="http://www.larian.com/ubb/div.gif"> demo and would like to share some impressions with you. Here's a snippet:<P><I>Divine Divinity integrates components from many games. The story and dialogue trees appear as good as anything Ultima or Baldur's Gate has offered. The graphics are crisp and detailed enough for an isometric RPG. The combat combines the wild massacre abandonment of Diablo (I bagged me well over a hundred monsters in 5 levels of a dungeon) with the real-time-pause functionality of Baldur's Gate. This stops it from becoming an all out potion chugging hack-fest as you can issue orders and use some basic tactics without having to have highly developed reflexes.</I><P>Read the full article <A HREF="http://www.rpgdot.com/index.php?hsaction=10053&ID=319" TARGET=_blank>here</A>.<P>------------------<BR><I>They say don't judge a book by its cover, and in equal measure don't judge a game by its name</I></FONT></TD></TR></TABLE>
</IFRAME>
</FONT>
