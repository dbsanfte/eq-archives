...
<table border=0>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Forum:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">Technical problems</FONT></td></tr>
<TR><TD><FONT Face="Verdana, Arial" size="2"><B>Topic:</B></font></td><TD><FONT Face="Verdana, Arial" size="2">bug</FONT></td></tr></table>
...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">[QUOTE]Originally posted by eddie:
[I]I now have problems with starting the game...
During the load-screen, when initializing the videocard (where the screen goes white for a brief moment), it quits with the error 'parsing error in itemstat.txt' (don't know the exact phrase  :o)

Also, when I clicked the 'play' button in de loader, I get an error 'Cannot change resolution'...


[This message has been edited by eddie (edited 18-05-2002).][/I][/QUOTE]
...
<IFRAME FRAMEBORDER=1 ALIGN=CENTER width=100% HEIGHT=200 SCROLLING=YES SRC="http://www.larian.com/ubb/Forum17/HTML/000001.html">
<A HREF="http://www.larian.com/ubb/Forum17/HTML/000001.html" target=_blank> *** Click here to review this topic. ***</A>
</IFRAME>
</FONT>
