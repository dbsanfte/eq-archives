...
<FONT SIZE="2" FACE="Verdana, Arial" color="#F0DCA0">
<B>
Forum: <FONT COLOR="#D0BC90">Allgemein (Deutsch) </FONT>
<BR>
Topic: <FONT COLOR="#D0BC90">NASEVOLL</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#D0BC90">Originally posted by SirVogel on 08-09-2002 05:01 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">nette Reaktionen..leider keine von denen dies angeht..
1. ..alle Spiele die man kauft haben Bugs bei Auslieferung..
     GUT ERKANNT!! genau das meinte ich..NeverWinterNights, Morrowind, 
     Dungeonsiege..usw..Warum wartet der Hersteller mit dem Relaese nicht
     bis die Bugs behoben sind??? schlechtes Betatesting? oder einfach nur
     auf die Dummheit der Spieler vertrauen?? die werden schon genug Bugs
     finden.... natürlich sitzen die Supporter NÄCHTELANG!!??? (hüstel)
     an Lösungen..DAS IST DEREN JOB!!! die werden dafür bezahlt..und das 
     nich zu knapp! und zwar mit dem Geld das Spieler fuer das Produkt 
     zahlen. </TEXTAREA>
</td></tr>
</table>
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="NASEVOLL">
...
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000244.cgi">
