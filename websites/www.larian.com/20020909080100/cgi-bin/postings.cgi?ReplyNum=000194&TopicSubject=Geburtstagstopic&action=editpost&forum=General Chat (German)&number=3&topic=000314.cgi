...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Alix on 09-04-2001 09:10 AM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">Ddraig, die Torte ist groß, es reicht schon noch für Dich!

PS: EO so schwierig ist es nicht mich in Chemnitz zu finden, mein Wohnort gehört erst seit einiger Zeit dazu. Wenn Du von Süden kommst (aus Annaberg oder Zschopau gibt es keine Umleitungen und Baustellen, nur die  "Einsiedler Bier" Brauerei, aber wenn Du die gefunden hat ist es nur noch ein Kilometer)
</TEXTAREA>
</td></tr>
</table>
...
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000194">
