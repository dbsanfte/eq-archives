...
<BR>
Topic: <FONT COLOR="#F0DCA0">Project C - Questions</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Bobby on 11-03-1999 10:51 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">I think that the combat mode used would depend on how important and difficult combats in Project C will be. If combats were easy (e.g. you only control one character, the enemies are weak, combat options are very limited) and "just for fun" then real-time shouldn't be so much of a problem. But if combat were to get a little more involved (several party members, strong enemies, lots of combat options), then I would clearly prefer a turn based combat system, since I hate the chaos and very frequent save-and-reload associated with making
them real-time. E.g. Baldur's Gate was a little of a mixed bag. Some fights were very easy, others were ridiculously difficult. Since combat was very frequent (way too frequent for my taste), implementing BG in turn-based throughout would have made the game pretty sluggish. For the more difficult fights however I would have liked turn-based. This means that I wouldn't have a problem with having some fights in real-time, while having others in turn-based. Leaving the decision for that to us, while providing defaults would also be
interesting.
Also, just to make turn-based a little more balanced and similar to real-time it would be nice if the determination of whose turn it is would be individually determined for any character or monster involved in a fight. E.g. something similar to the pencil and paper Shadowrun and not the usual "all my party members go, then all of yours" and so on.</TEXTAREA>
</td></tr>
</table>
