...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#D0BC90">Originally posted by Spam on 10-22-2002 08:40 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">And if you want proof of that point - do the math!
...
Max score of 5 stars for each category, for a Max Total of 35

Now if they counted multiplayer as a Zero score, the total for DD was 19.5, giving an average of 19.5/7 = 2.8
However if you dont count the multiplayer category at all (since it doesn't apply to the game, duh!) you get 19.5/6 = 3.25 - which they've obviously rounded up to 3.5 stars!

SO QUIT YER MOANING!!</TEXTAREA>
</td></tr>
</table>
