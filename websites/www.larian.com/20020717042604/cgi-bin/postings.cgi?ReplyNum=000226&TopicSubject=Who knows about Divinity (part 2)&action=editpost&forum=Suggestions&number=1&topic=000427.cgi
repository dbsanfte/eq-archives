...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by lar on 04-14-2002 10:06 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">&gt;&gt;1) What do the different item colors mean? First time I've seen these blue and green (Master Broad Axe of...) items. Blue seems to be special items. But what does green mean?&lt;&lt;

It indicates the "uniqueness" of the item - Range is gray,blue,green,yellow and gold. Still need some fancy names for them so if you can come up with some, much appreciated.

&gt;&gt;2) Noticed that the number, indicating how much damage your char does to an enemy, is written in blue and red. Is that just eye candy or do red numbers stand for melee damage and blue numbers for magic damage?&lt;&lt;

Correct. Red is melee, blue is magic.
