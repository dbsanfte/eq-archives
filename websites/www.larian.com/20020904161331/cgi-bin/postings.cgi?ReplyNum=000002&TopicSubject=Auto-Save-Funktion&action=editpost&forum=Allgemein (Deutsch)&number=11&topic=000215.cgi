...
<BR>
Topic: <FONT COLOR="#D0BC90">Auto-Save-Funktion</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#D0BC90">Originally posted by Chambeul on 08-07-2002 06:11 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">naja aber wenn man strg+s drückt speichert er ja auch unter autosave und diese funktion, mit der er den autosave speichert auf die "auto-save"-funktion übertragen. er überspeichert dann also immer nur den einen speicherplatz, damit hält sich die größe in grenzen und der ladebalken kann ruhig im spiel erscheinen, wenn er mal nen auto-save hinlegt, dann weiß man wenigstens, dass er gespeichert hat ^^ . und wen das stört, der muss das ganze ja nicht aktivieren.  :D</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Auto-Save-Funktion">
...
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000215.cgi">
