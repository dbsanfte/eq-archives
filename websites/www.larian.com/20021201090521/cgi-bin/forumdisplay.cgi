<HTML>
<HEAD>
<TITLE>Larian Studios Bulletin Board</TITLE>
...
<A HREF="Ultimate.cgi?action=intro&BypassCookie=true"><IMG SRC="http://www.larian.com/ubb/bbtitle5.jpg" BORDER=0></a>
<P><BR><blockquote>
...
<OPTION value="">
<OPTION value="">
<OPTION value="">Category: Larian Studios
<OPTION VALUE="">--------------------
<OPTION value="5">About this website
<OPTION value="">
<OPTION value="">Category: Divine Divinity
<OPTION VALUE="">--------------------
<OPTION value="14">Announcements
<OPTION value="9">General (English)
<OPTION value="11">Allgemein (Deutsch)
<OPTION value="12">Algemeen (Nederlands)
<OPTION value="1">Suggestions
<OPTION value="16">Help/Tips/Tricks
<OPTION value="19">Hilfe/Tips/Tricks (Deutsch)
<OPTION value="17">Technical problems
<OPTION value="18">Technische Probleme (Deutsch)
<OPTION value="2">Larian Studios Games
<OPTION value="">
<OPTION value="">Category: Chat
<OPTION VALUE="">--------------------
<OPTION value="6">General RPG Chat (German)
<OPTION value="3">General Chat (German)
<OPTION value="4">General RPG Chat (English)
<OPTION value="7">General Chat (English)
<OPTION value="10">General Chat (Anything)
<OPTION value="">
<OPTION value="">Category: Internal Forums
<OPTION VALUE="">--------------------
<OPTION value="8">Discussion
<OPTION value="13">Fansite datamine
