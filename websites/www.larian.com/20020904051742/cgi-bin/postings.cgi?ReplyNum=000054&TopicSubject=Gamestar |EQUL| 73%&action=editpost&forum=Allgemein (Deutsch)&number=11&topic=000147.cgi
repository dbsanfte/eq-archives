...
<BR>
Topic: <FONT COLOR="#D0BC90">Gamestar = 73%</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#D0BC90">Originally posted by UriahHeep on 08-04-2002 06:51 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL"> [QUOTE]Originally posted by Wichtel:
[i] Endlich mal ein Game das nicht gleich die Hälfte der Komplexität verliert nur weil man eben dem Mainstream folgen will und einen MP Modus noch mit rein schustern will   :) Nene das passt schon so wie es ist ohne so einen Gammel MP   :)[/i][/QUOTE]
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Gamestar = 73%">
