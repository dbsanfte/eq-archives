...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Skimm on 07-31-2001 10:36 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">Bummer, so we have to wait some longer before it comes out. 
But better to make it stable and complete then to rush it, right?

One thing, as soon as the game is complete, pubish it! Don't do it like Sierra with Arcanum, the game is on the lose in the warez area, but you can't buy it yet! </TEXTAREA>
</td></tr>
</table>
