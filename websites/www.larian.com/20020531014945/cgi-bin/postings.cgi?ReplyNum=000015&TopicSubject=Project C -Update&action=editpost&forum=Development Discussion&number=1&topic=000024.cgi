...
<FONT SIZE="2" FACE="Verdana, Arial" color="#F0DCA0">
<B>
Forum: <FONT COLOR="#F0DCA0">Development Discussion </FONT>
<BR>
Topic: <FONT COLOR="#F0DCA0">Project C -Update</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Bronthion on 11-06-1999 10:48 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">Ok Marian, Lar, ...

you asked for it:
(fortunately you have the burden on how to create the effects in the game. sorry guys, I can't make it easy for you)

1) Polymorphing: 
* polymorph enemies into chickens, cats, etc. for 30 s or so
* shapeshift yourself into goblin, oger, wolf, etc. for 3 min or so
2) Time
* change timeflow for yourself or others
3) Elements
* make somebody a living torch
* shockwave
* lightnings out of your fingertips
* make yourself an iceman with the ability to freeze others by touch or trough a distance
* storm
4) Magic
* steal mana from opponents
5) Illusions
* create illusions from giants, dragons, etc.
* give the attacker the illusion of holding a snake instead of an sword, bow
6) Plants
* quick plant growth to entangle enemy or hide mage
* plants can be poisonous (gas attack, flying thorns)
7) Misc
* make somebody very heavy, motionless, slow
* make all party members invisible
* teleport yourself or opponent
* sonic attack: your voice produces a sound that breaks throug walls/doors, produces unconsciousness or stunning
* produce darkness or blending light
* of course: conjuration of demons (maybe with side-effects)
* some magicians might be stronger at night or day, or at full moon.
8) Circle of power
* let more than one magican form a circle and combine their ability, mana and power (maybe something for a group of enemies)

Important is, that the spells aren't too powerfull or give some nasty side-effects (I like the necromancers, very powerful, but the disadvantages...) Mages and warriors must be balanced, or even better, be a good complementary team.
...
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Project C -Update">
