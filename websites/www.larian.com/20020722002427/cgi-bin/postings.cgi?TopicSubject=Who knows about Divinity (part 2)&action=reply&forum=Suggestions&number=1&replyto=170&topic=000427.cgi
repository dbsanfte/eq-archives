...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">[QUOTE]Originally posted by Nemisis Dragon:
[I]I think the demo is nearly to be finished [i]or[/i] is finished. If this is the fact, we need to wait for CDV's OK, so that they want to publish it.[/I][/QUOTE]
