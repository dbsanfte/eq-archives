...
<BR>
Topic: <FONT COLOR="#F0DCA0">Warning message</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Crythe on 05-23-2002 09:05 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">You do actually get a warning. 

The equipment icon has a yellow repair sign over it, signalling you need to repair. But it's true, it is really hard to notice something like that when you're busy doing something.  :(

Maybe something easily noticed should be put on the screen and then a sound effect for every one durability lost and then a louder or different sound effect for when the weapon is down to one durability

------------------
The object of a game is not to die for your sake but to make the other bastard die for his</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Warning message">
<INPUT TYPE="HIDDEN" NAME="forum" VALUE="Suggestions">
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000001">
<INPUT TYPE="HIDDEN" NAME="number" VALUE="1">
<INPUT TYPE="HIDDEN" NAME="topic" VALUE="000509.cgi">
