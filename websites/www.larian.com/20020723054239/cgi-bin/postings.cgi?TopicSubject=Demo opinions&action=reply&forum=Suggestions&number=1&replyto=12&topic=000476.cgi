...
<td>
<TEXTAREA NAME="ReplyMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">[QUOTE]Originally posted by Lord_Darkmoon:
[I]I really love the demo, it is great!
But I think it would make combat a little bit easier and less frustrating (especially if you are surrounded by many enemies) if the character would defend himself, and not just stand around and let himself be beaten up if one is not able to click fast enough.[/I][/QUOTE]
