...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Dante on 05-06-2002 04:38 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">Hey Vipy!

Umm... of course I took a look at your sshots, but all of them (except for the last) are graphics & objects bugs... and that's Lar. (I'm only the super-important-programmer of the story engine and the story itself  ;)  :D )

About the last one (tombs closing again) - yeah... I'd hoped you wouldn't mind, because the story there uses the tomb object in an ... err... not intended way.  ;) (read: I misuse it there to be the entrance of a passage leading down - it does not remember its state (open/closed) but I can't recall why that is the case for tombs).

So, in short: it is as intended.  ;)
</TEXTAREA>
</td></tr>
</table>
...
<INPUT TYPE="HIDDEN" NAME="ReplyNum" VALUE="000112">
