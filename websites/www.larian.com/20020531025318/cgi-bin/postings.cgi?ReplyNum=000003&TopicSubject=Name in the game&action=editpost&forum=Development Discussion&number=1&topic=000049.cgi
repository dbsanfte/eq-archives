...
<BR>
Topic: <FONT COLOR="#F0DCA0">Name in the game</FONT>
</B>
</FONT>
...
<td><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#F0DCA0">Originally posted by Bronthion on 01-03-2000 09:36 PM<BR></FONT>
<TEXTAREA NAME="EditedMessage" ROWS=20 COLS=75 WRAP="VIRTUAL">Hi lar,

I am honored that my name will "appear" in your game.    :D 
Even if you use it for a drow.    :(

Very nice. Now you have to implement a fox, a cat, a bee, a couple of dragons and a bat in your game. I am very curious.   ;)

BTW, you are very good in making sure, every forum member WILL buy your game, eh?    ;)


P.S. I hope, the drows will be victorious  ;)


[This message has been edited by Bronthion (edited 03-01-2000).]</TEXTAREA>
</td></tr>
</table>

<p>
<INPUT TYPE="HIDDEN" NAME="action" VALUE="submitedit">
<INPUT TYPE="HIDDEN" NAME="TopicSubject" VALUE="Name in the game">
