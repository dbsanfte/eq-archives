...
<th colspan=2><input name="time" type="hidden" value="972222903"><input name="action" type="submit" value="Preview">  <input name="action" type="submit" value="Save">  <input type="reset" value="Reset">  <input name="action" type="submit" value="Clear"></th></tr></form></table></center><p align=center><font size=1>If you have any question contact <a href=mailto:BlackWizard@mail.ru><b>Webmaster<b></a></font>.</body></html>
