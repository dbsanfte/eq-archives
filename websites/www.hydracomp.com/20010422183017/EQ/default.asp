...
<B><U><FONT SIZE=+1>4-6-2001 : EverTools Release 7 status...</FONT></U></B><BR>

<P>EverTools Release 7 is now posted, and avalible for download.  Due to the
fact that this udpate updates system files, and the old version of the
updater could not update system files, everyone will need to manually
download the update.  If you already have EverTools installed, you can get
the Update version.  If you are new, then you will need to get the Full version.</P>

<P>Keep watching the <a href=et_news.asp>News page</a> for additional information on the relesae and
further development of EverTools.</P>
