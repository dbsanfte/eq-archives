...
<TITLE>EQ Extreme - Skills - Blunt, Slashing, & Piercing Weapons</TITLE>
...
<!-- START OF TABLE TWO -->
        <TABLE BORDER="0" WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
                ...
                <TD BGCOLOR="#CCCCCC"><IMG SRC="../images/button3.gif" BORDER=0 WIDTH="11" HEIGHT="11"><FONT FACE="ARIAL" SIZE=2 COLOR="#000000"><B>Blunt, Slashing, & Piercing Weapons</B></FONT></TD>
...
<tr><td bgcolor="#eeeeee"><FONT SIZE="-1" FACE="Trebuchet MS,Arial">Combat is rather integral to the game, and there are a variety of weapons available to the combatant. In general, these weapons are broken up into three categories, blunt, slashing, and piercing, as well as whether they require one or two hands to wield. The better one is at these skills, the more effective they are with that weapon.</font></td></tr>
