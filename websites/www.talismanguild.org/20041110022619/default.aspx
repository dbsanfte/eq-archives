...
<table name="158" class="ControlTable" cellSpacing="0" cellPadding="0" width="100%" align="center">
	...
	<tr>
		<td class="TextNormal" colspan="3" width="100%">
			<table  class="TextNormal" width="100%" border="0">
        <tr>
          <td>
		  <table class="TextNormal">
			<tr><td width="131">
            <img src="images/110504/Signets.jpg" width="102" height="168">&nbsp;<br />
            <img src="images/110504/TrialRunes.jpg" width="101" height="149">
			</td>
			<td width="356">
			<p>Not a lot of Big News (tm), but in recent weeks Talisman
              has been working towards Anguish. No, no, not anguish over the
              upcoming releases of EverQuest 2, World of Warcraft, or even Halo
              2 and what those releases might do to our raiding numbers. No we
              have been actively working towards the zone of Anguish.</p>
			<p>	This has required a multi-pronged (not pr0ned) approach in that
              we have to keep 70-ish people motivated enough to break into groups
              to work on a signet quest, and then also raid together enough to
              beat several raid-level trials for access.</p>
			<p>Well, after repeatedly beating the trials for Adaption (not Adaptation
              curiously enough), Corruption, Endurance, Foresite, and Specialization,
              we did finally beat the trial for Hate. Hate took us longer than
              most because we were actively trying to find a way to beat it *without*
              gimping it. We tried it over and over and got down to the final
              mob &quot;the good way,&quot; only to find out from 'sources' that
              we are SUPPOSED to gimp the trial. Wow... what a design. Woo.</p>
			</td></tr>
			<tr><td colspan="2">
            <p align="center"><img src="images/110504/MasteryOfAll.jpg" width="491" height="121"></p>
			</td></tr>
			<tr><td colspan="2">
            <p>&nbsp;</p>
            <p>Anyway, we have decided for the moment to hold off on Anguish
              until more of our numbers are flagged/keyed/cool enough to go.
              So tune in soon for our adventures in Anguish!</p>
            <p>Mixed in among all those trials, we of course continue to beat
              down the Riftseeker's Rabble whenever we see them up. We also make
              a point of setting aside time each week to knock out the raid-ish
              level encounters for our folks' epics. We're so sweet. :)</p>
            <p>That's about all I have to say about that.</p>
            <p><img src="images/110504/KaitsHead.jpg" width="50" height="54"> So now, we turn to the <font size="+1">Talisman Opinion Page...</font></p>
            <p>Well the holiday season is fast approaching and with it comes
              the impending release of EverQuest 2. I won't comment on the state
              of the game but as a good-will gesture, let me offer SOE something
              to make their marketing and financial people very happy - perhaps
              distracting them from pushing EQ2 out the door until it's finished...
              /cough</p>
            <p>What is it that every little kid likes? What is it that computer
              geeks and geekettes secretly adore? And further, and perhaps most
              importantly to The Suits, what is it in the Anime/Manga world that
              is all the rage?</p>
            <p>Why, <strong>Plush Toys</strong> of course!</p>
            <p>SOE has wholly overlooked this segment of the market. They've
              tried action figures of about 6 types. They've tried cell-phone
              EQ (WTF???), and they've done the back-pack. They even custom-made
              an EQ fanny pack for Beldon, but we're not sure what he paid them
              with, nor do we really wish to know.</p>
            <p>But what they really need are EQ plush toys.</p>
            <p>Imagine the possibilities. You could have whole collections of
              them. EQ Plush Toys fall into several easily-markettable categories
              or sets. The first could be:</p>
		    <table>
			<tr><td colspan="2"><strong>&quot;EQ: Mobs of the Old World&quot;</strong></td>
			</tr>
			<tr><td class="TextNormal" width="130">
            <ul><li>Orc Pawn</li>
              <li>Bixie</li>
              <li>Caiman</li>
              <li>Fire Beetle</li>
			...
			<td  class="TextNormal" width="349">
            Re-live your EQ Childhood with a wonderful representation of all
              the little mobs we started with. Come on ... how CUTE would your
              own little stuffed Orc Pawn be!?!? You could hug him and squeeze
              him and then ruin his lands!</td>
			</tr>
			</table>
            <p>Once SOE has whetted our appetites, they could then release:</p>
		    <table>
			<tr><td colspan="2"><strong>&quot;EQ: The Dragon Collection&quot;</strong></td>
			</tr>
			<tr><td class="TextNormal" width="150">
              <ul><li>Lady Vox</li>
              <li>Lord Nagafen</li>
              <li>Klandicar</li>
              <li>Gorenair</li>
			...
			<td class="TextNormal" width="329">
			Some were the Great End-All Beasts of the land when we were little.
              Then as the expansions arrived more dragons were added. A lot of
              us have fought them with our pixelated-selves, but for some, having
              their own Plush version is as close as they may come.</td>
			</tr>
			</table>
            <p>Then, SOE ups the ante with:</p>
			<table>
			<tr valign="top"><td class="TextNormal" width="50%">
              <strong>&quot;Collection 1 - Goddesses of EQ&quot;</strong>
              <ul><li>Tunare</li>
              <li>Xegony</li>
              <li>Terris Thule</li>
              <li>Saryn (Due to mature themes, ages 18+)</li>
			  </ul>
			</td>
			<td class="TextNormal" width="50%">
              <strong>&quot;Collection 2 - Gods of EQ&quot;</strong>
              <ul><li>Tallon Zek</li>
              <li>Vallon Zek</li>
              <li>Rallos Zek</li>
              <li>Bertoxxulos</li>
            ...
            <tr><td class="TextNormal" colspan="2">Oooooo the gods and goddesses! Rule over your pretend lands with
              these dieties of the fantasy world. They're powerful. They're scary.
              And they are so squeezably loveable!</td>
			  </tr>
			</table>
            <p>And finally, to cap it off, SOE introduces the special offers.
              Some would be limited editions. Some would be promotional. And
              some would require outright bribes. SOE is well-known for the ultra-rare
              items, so they obviously can't have every one be able to just *buy*
              their whole Plush Line! Pfffft, silly people.</p>
		    <table width="100%">
			<tr><td><strong>Specials:</strong></td>
			</tr><td class="TextNormal">
              <ul><li>Talking Fippy Darkpaw</li>
              <li>Zerafym (Sleeper)</li>
              <li>Quarm</li>
              <li>Gates of Discord &quot;Goat&quot; (Pixxt)</li>
              <li>EQ2 Baby Dragon</li>
			  </ul>
			  </td></tr></table>
            <p>To celebrate where it all began, a special edition plush toy would
              be the Talking Fippy Darkpaw! Squeeze his fuzzy belly and he utters
              his famous battle cry, <em>&quot;&lt;BBBBBAAAARRRKKKK!!!!!&gt; You
              humans will pay for ruining your homeland!! GRRRRRRRR!!!! Family
              Darkpaw of the Sabretooth Clan will slay you all!!&lt;BARK!&gt;&quot;</em></p>
            <p>Release the Sleeper on your unsuspecting Lego hoardes with the
              Plush Zerafym. If you never got to experience the thrill of releasing
              the virtual version, you now can with your very own hugable version
              of the most rare of the dragons.</p>
            <p>For those who never made it to the end of the Plane of Time, now
              you can have your own four-headed dragon. And for those that did
              - you know you want one too!</p>
            <p>To reclaim some fun and satisfaction from an otherwise lousy expansion,
              SOE can offer the GoD &quot;Goat&quot; plush toy. Now really, how
              cute would your own plush goat be!?!?! Pliable (and safe!) little
              spines to hold the colorful pennants. The happy little smile each
              of the Pixxts have as they crush your raid. Fun!</p>
            <p>(I would submit that they should give a free Plush Goat to every
              registered GoD buyer as compensation for the expansion, but I digress...)</p>
            <p>And finally, to celebrate the (pushed back) release of EQ2, get
              your own little EQ2 Baby Dragon! The adorability factor is almost
              unbearable!</p>
            <p>Buy them for your kids, buy them for your friends (you know you
              don't have many, so it will be cheap), and above all else - buy
              them for yourself!</p>
            <p>Once you have enough, you can conduct your own raids. Just listen
              to this testimonial:</p>
            <p align="center"><img src="images/110504/RaidPlayset.gif" width="469" height="70"> </p>
            <p>Next time you are online, be sure to /feedback that you want to
              see SOE produce a line of plush toys. I did!</p>
            <p>&nbsp;</p>
            <p><font size="+1">Last word:</font></p>
			<p>Lest you think we have no lives, let it be known that for really large 
			events, our officers are there for us.  Just look at one of our recent MOTD's 
			informing us of a celestial event.  Thank you Qhue!!!</p>
            <p align="center"><img src="images/110504/EclipseMOTD.gif" width="476" height="59"></p>
			</td></tr>
		</table>
		</td>
        </tr>
