...
<TABLE background="" id="Table1" height="198" width="100%"  border="0">
	...
	<TR>
			...
			<!-- toplinks  -->
			<a href="usercp.php?s=fe15371bc796675a176033c56c6dd805">
			[User Control Panel]
			</a>
			<a href="register.php?s=fe15371bc796675a176033c56c6dd805&action=signup">
			[Register]
			</a>
			<a href="calendar.php?s=fe15371bc796675a176033c56c6dd805">
			[Calendar]</a>
			<a href="memberlist.php?s=fe15371bc796675a176033c56c6dd805">
			[Members]
			</a>
			<a href="misc.php?s=fe15371bc796675a176033c56c6dd805&action=faq">
			[FAQ]</a>
			<a href="http://www.talismanguild.org/TalismanVB/vbstats.php?action=stats&s=fe15371bc796675a176033c56c6dd805">
			[Stats]</a>
			<a href="search.php?s=fe15371bc796675a176033c56c6dd805">
			[Search]
			</a>
			<a href="index.php?s=fe15371bc796675a176033c56c6dd805">
			[Home]</a>
			<!-- /toplinks -->
			</td>			
	</TR>
...
<form action="forumdisplay.php" method="get"><tr><td>
	...
	<input type="hidden" name="s" value="fe15371bc796675a176033c56c6dd805">
	<input type="hidden" name="daysprune" value="">
	<b>Forum Jump:</b><br>
	<select name="forumid"
	onchange="window.location=('forumdisplay.php?s=fe15371bc796675a176033c56c6dd805&daysprune=&forumid='+this.options[this.selectedIndex].value)">
		...
		<option value="-1">--------------------</option>
		<option value="17" > SidlWidl</option><option value="18" >-- General</option><option value="3" > Talisman Public</option><option value="5" >-- General</option><option value="20" >-- Membership Information</option><option value="6" >-- Membership Applications</option><option value="10" >-- Screen Shots</option><option value="13" >-- Points</option>
	</select><!-- go button -->
