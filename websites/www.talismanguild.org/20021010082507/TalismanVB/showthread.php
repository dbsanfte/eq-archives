...
<TABLE background="" id="Table1" height="198" width="100%"  border="0">
	...
	<TR>
			...
			<!-- toplinks  -->
			<a href="usercp.php?s=f046423b6c701430a2f513a2726c995d">
			[User Control Panel]
			</a>
			<a href="register.php?s=f046423b6c701430a2f513a2726c995d&action=signup">
			[Register]
			</a>
			<a href="calendar.php?s=f046423b6c701430a2f513a2726c995d">
			[Calendar]</a>
			<a href="memberlist.php?s=f046423b6c701430a2f513a2726c995d">
			[Members]
			</a>
			<a href="misc.php?s=f046423b6c701430a2f513a2726c995d&action=faq">
			[FAQ]</a>
			<a href="http://www.talismanguild.org/TalismanVB/vbstats.php?action=stats&s=f046423b6c701430a2f513a2726c995d">
			[Stats]</a>
			<a href="search.php?s=f046423b6c701430a2f513a2726c995d">
			[Search]
			</a>
			<a href="index.php?s=f046423b6c701430a2f513a2726c995d">
			[Home]</a>
			<!-- /toplinks -->
			</td>			
	</TR>
...
<form action="forumdisplay.php" method="get"><tr><td>
	...
	<input type="hidden" name="s" value="f046423b6c701430a2f513a2726c995d">
	<input type="hidden" name="daysprune" value="">
	<b>Forum Jump:</b><br>
	<select name="forumid"
	onchange="window.location=('forumdisplay.php?s=f046423b6c701430a2f513a2726c995d&daysprune=&forumid='+this.options[this.selectedIndex].value)">
		...
		<option value="-1">--------------------</option>
		<option value="17" > SidlWidl</option><option value="18" >-- General</option><option value="3" > Talisman Public</option><option value="5" >-- General</option><option value="6" >-- Membership</option><option value="10" >-- Screen Shots</option><option value="13" >-- Points</option>
	</select><!-- go button -->
