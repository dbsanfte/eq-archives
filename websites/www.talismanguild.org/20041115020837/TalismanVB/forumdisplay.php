...
<TABLE background="" id="Table1" height="198" width="100%"  border="0">
	...
	<TR>
			...
			<!-- toplinks  -->
			<a href="usercp.php?s=2d725ea68b3a1a6a090776256be5bfe6">
			[User Control Panel]
			</a>
			<a href="register.php?s=2d725ea68b3a1a6a090776256be5bfe6&action=signup">
			[Register]
			</a>
			<a href="calendar.php?s=2d725ea68b3a1a6a090776256be5bfe6">
			[Calendar]</a>
			<a href="memberlist.php?s=2d725ea68b3a1a6a090776256be5bfe6">
			[Members]
			</a>
			<a href="misc.php?s=2d725ea68b3a1a6a090776256be5bfe6&action=faq">
			[FAQ]</a>
			<a href="http://www.talismanguild.org/TalismanVB/vbstats.php?action=stats&s=2d725ea68b3a1a6a090776256be5bfe6">
			[Stats]</a>
			<a href="search.php?s=2d725ea68b3a1a6a090776256be5bfe6">
			[Search]
			</a>
			<a href="index.php?s=2d725ea68b3a1a6a090776256be5bfe6">
			[Home]</a>
			<!-- /toplinks -->
			</td>			
	</TR>
...
<form action="forumdisplay.php" method="get"><tr><td>
	...
	<input type="hidden" name="s" value="2d725ea68b3a1a6a090776256be5bfe6">
	<input type="hidden" name="daysprune" value="">
	<b>Forum Jump:</b><br>
	<select name="forumid"
	onchange="window.location=('forumdisplay.php?s=2d725ea68b3a1a6a090776256be5bfe6&daysprune=&forumid='+this.options[this.selectedIndex].value)">
