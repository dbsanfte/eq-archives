...
<form action="forumdisplay.php" method="get"><tr><td>
	...
	<input type="hidden" name="s" value="d104ce92ad3a5facc9613787d070034a">
	<input type="hidden" name="daysprune" value="">
	<b>Forum Jump:</b><br>
	<select name="forumid"
	onchange="window.location=('forumdisplay.php?s=d104ce92ad3a5facc9613787d070034a&amp;daysprune=&amp;forumid='+this.options[this.selectedIndex].value)">
