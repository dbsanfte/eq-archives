...
<TABLE background="" id="Table1" height="198" width="100%"  border="0">
	...
	<TR>
			...
			<!-- toplinks  -->
			<a href="usercp.php?s=f9297138332fdb6c8413f78d37a75912">
			[User Control Panel]
			</a>
			<a href="register.php?s=f9297138332fdb6c8413f78d37a75912&action=signup">
			[Register]
			</a>
			<a href="calendar.php?s=f9297138332fdb6c8413f78d37a75912">
			[Calendar]</a>
			<a href="memberlist.php?s=f9297138332fdb6c8413f78d37a75912">
			[Members]
			</a>
			<a href="misc.php?s=f9297138332fdb6c8413f78d37a75912&action=faq">
			[FAQ]</a>
			<a href="http://www.talismanguild.org/TalismanVB/vbstats.php?action=stats&s=f9297138332fdb6c8413f78d37a75912">
			[Stats]</a>
			<a href="search.php?s=f9297138332fdb6c8413f78d37a75912">
			[Search]
			</a>
			<a href="index.php?s=f9297138332fdb6c8413f78d37a75912">
			[Home]</a>
			<!-- /toplinks -->
			</td>			
	</TR>
...
<form action="forumdisplay.php" method="get"><tr><td>
	...
	<input type="hidden" name="s" value="f9297138332fdb6c8413f78d37a75912">
	<input type="hidden" name="daysprune" value="">
	<b>Forum Jump:</b><br>
	<select name="forumid"
	onchange="window.location=('forumdisplay.php?s=f9297138332fdb6c8413f78d37a75912&daysprune=&forumid='+this.options[this.selectedIndex].value)">
		...
		<option value="-1">--------------------</option>
		<option value="3" > Talisman Public</option><option value="5" >-- General</option><option value="20" >-- Membership Information</option><option value="6" >-- Membership Applications</option><option value="10" >-- Screen Shots</option><option value="13" >-- Points</option><option value="21" > World of Warcraft</option><option value="22" >-- General</option>
	</select><!-- go button -->
