...
<HEAD>
<TITLE>EQrealms - Equipment - Weapons</TITLE>
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="weapons.gif" WIDTH="146" HEIGHT="44" ALT="Weapons"></TD>
...
<FORM NAME="CFForm_1" ACTION="weapons_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
<B>Class</B>:<BR>
<SELECT NAME="class">
<OPTION>ALL
<OPTION>Bard
...
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<FORM NAME="CFForm_2" ACTION="weapons_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_2(this)">
<B>Keyword Search:</B><BR>
Enter a partial or full weapon name.<BR>
