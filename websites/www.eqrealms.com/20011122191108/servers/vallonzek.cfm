...
<HEAD>
<TITLE>EQrealms - Servers - Vallon Zek (Teams)</TITLE>
...
WHERE server_name = 'Vallon Zek (Teams)'"<P>Data Source = "EQREALMS2"<P><p>The error occurred while processing an element with a general identifier of (CFQUERY), occupying document position (21:1) to (21:67) in the template file E:\WEB12REPLICATION\PRODUCTION\WWW.EQREALMS.COM\SERVERS\SERVERNEWS.cfm.</p><P><P>Date/Time: 11/22/01 11:10:52<BR>Browser: ia_archiver<BR>Remote Address: 172.16.1.251<P></TD></TR></TABLE><P><HR>
</BODY></HTML>