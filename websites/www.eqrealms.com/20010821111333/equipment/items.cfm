...
<HEAD>
<TITLE>EQrealms - Equipment - Items</TITLE>
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="items.gif" WIDTH="99" HEIGHT="44" ALT="Items"></TD>
...
<FORM NAME="CFForm_1" ACTION="items_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
<B>Category</B>:<BR>
<SELECT NAME="category">
<OPTION>Containers
<OPTION>Food and Drink
<OPTION>Misc
<OPTION>Potions
<OPTION>Quest Item
</SELECT>
...
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<FORM NAME="CFForm_2" ACTION="items_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_2(this)">
<B>Keyword Search:</B><BR>
Enter a partial or full item name.<BR>
