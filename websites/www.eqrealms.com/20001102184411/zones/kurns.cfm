...
<HEAD>
<TITLE>EQrealms - Zones - Kurn's Tower</TITLE>
...
<TR><TD bgcolor="#bfbf80" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Kurn's Tower</B></FONT></TD></TR>
...
<B>Level Range</B>: 10-25<BR><BR>

Kurn's Tower is a nice place for groups of folks 10th level and up, it's full of undead as well as Burynai, this big fat 
badger things.  The tower is found at the far end of the pit in the Field of Bone, which is directly out from Cabilis down the path, at the far 
edge of the pit past the dragon bones you'll start to see a large tower in the distance.<BR><BR>

Directly inside of Kurn's you'll find many skeletons, Scalebone Skeletons are the lowest level, there are also 
Greater Skeletons as well as Greater Scalebone Skeletons.  Even further you'll find Icebone Skeletons, the lower 
areas in the basement are full of Burynai, Burynai seem to be Shadowknights and Necromancers. (probably simple 
warrior ones as well)  The Burynai start at about level 12.<BR><BR>

I'll be updating this guide with more information, currently I've only been inside with my Iksar and he's level 12 at the moment 
so I haven't seen very much.  If you have more info on the mobs, the drops, or the geography, please feel free to submit 
it to <A HREF="mailto:info@eqrealms.com">info@eqrealms.com</A>.<BR><BR>
...
<B>Armor:</B><BR>
<SELECT NAME="name">
<OPTION>Burynai Hide Boots

<OPTION>Burynai Hide Pants

<OPTION>Burynai Hide Sleeves

<OPTION>Reinforced Rhino Arm Guards

<OPTION>Reinforced Rhino Boots

<OPTION>Reinforced Rhino Chest Guard
