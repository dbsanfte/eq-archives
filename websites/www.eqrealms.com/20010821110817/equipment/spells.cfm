...
<HEAD>
<TITLE>EQrealms - Equipment - Spells</TITLE>
...
function  _CF_checkCFForm_6(_CF_this)
...
function  _CF_checkCFForm_7(_CF_this)
...
function  _CF_checkCFForm_8(_CF_this)
...
function  _CF_checkCFForm_9(_CF_this)
...
function  _CF_checkCFForm_10(_CF_this)
...
function  _CF_checkCFForm_11(_CF_this)
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="spells.gif" WIDTH="103" HEIGHT="44" ALT="Spells"></TD>
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Spells by Level</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">

<BLOCKQUOTE>

<FORM NAME="CFForm_1" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
<FONT SIZE="3"><B>Bard Songs:</B></FONT>
<INPUT TYPE="hidden" name="class" value="Bard">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_2" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_2(this)">
<B><FONT SIZE="3">Cleric Spells:</FONT></B>
Level
...
<INPUT TYPE="hidden" name="class" value="Cleric">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_3" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_3(this)">
<B><FONT SIZE="3">Druid Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>1
<OPTION>5
...
<INPUT TYPE="hidden" name="class" value="Druid">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_4" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_4(this)">
<B><FONT SIZE="3">Enchanter Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>1
<OPTION>4
...
<INPUT TYPE="hidden" name="class" value="Enchanter">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_5" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_5(this)">
<B><FONT SIZE="3">Magician Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>1
<OPTION>4
...
<INPUT TYPE="hidden" name="class" value="Magician">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_6" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_6(this)">
<B><FONT SIZE="3">Necromancer Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>1
<OPTION>4
...
<INPUT TYPE="hidden" name="class" value="Necromancer">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_7" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_7(this)">
<B><FONT SIZE="3">Paladin Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>9
<OPTION>15
...
<INPUT TYPE="hidden" name="class" value="Paladin">
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_8" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_8(this)">
<B><FONT SIZE="3">Ranger Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>9
<OPTION>15
...
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_9" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_9(this)">
<B><FONT SIZE="3">Shadow Knight Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>9
<OPTION>15
...
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_10" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_10(this)">
<B><FONT SIZE="3">Shaman Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>1
<OPTION>5
...
<INPUT TYPE="submit" VALUE="Go">
</FORM><FORM NAME="CFForm_11" ACTION="spells_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_11(this)">
<B><FONT SIZE="3">Wizard Spells:</FONT></B>
Level
<SELECT NAME="levelneeded">
<OPTION>1
<OPTION>4
...
<INPUT TYPE="hidden" name="class" value="Wizard">
<INPUT TYPE="submit" VALUE="Go">
</FORM>
