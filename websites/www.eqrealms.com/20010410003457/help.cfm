...
<HEAD>
<TITLE>EQrealms - Help Wanted</TITLE>
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="helpwanted.gif" WIDTH="192" HEIGHT="44" ALT="Help Wanted"></TD>
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Join the Crew</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">

EQrealms is a huge effort to bring a load of different types of EQ content all together on one site which is 
organized for quick and easy navigation.  We bring together news, class guides, zone guides, bestiaries, 
item information, links, and even more.  As you can probably tell, keeping up a site like this isn't entirely easy
and we're happy to accept all the help we can get.  We're looking for folks who can help us out in the following 
areas:

<UL>
<LI><B>News</B>: Updates, gathering news, reporting and also writing editorials and adding in news content.
<LI><B>Item Info</B>: Looking for folks who have big time knowledge and connections to get stat shots and 
information about items, quests, mobs, and zones to help add in existing information and new discoveries
to our DB.
</UL>

If you are interested in volunteering your time to EQrealms and becoming part of our crew, drop a 
line to <A HREF="mailto:dantes@eqrealms.com">dantes@eqrealms.com</A> to let me know and please 
explain which area you'd like to contribute to.  Any questions are welcomed as well.  What do you get out of 
helping EQrealms?  Recognition, and hopefully Fun too!<BR><BR>

</font>
</TD></TR>
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Submit Info</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">

One way to help out EQrealms in a big way is to submit your vast knowledge of the game to us, we'll be
to review it and post it if we feel it benefits the EQ community.  You'll get full credit for any type of guide, map, 
whatever it may be that you submit to us to include in the site.  What are we looking for? Class guides for the 
classes that we don't have guides for, zone guides for the zones we don't have guides for, any new 
quests or items that you find in the game, and maps or screenshots of key areas in the game.  Submit 
and information to <A HREF="mailto:info@eqrealms.com">info@eqrealms.com</A>.  Feel free to paste your 
name on any stat shots of items you submit, after all if you found it for us you deserve the credit.  The 
info email link is also on most pages so if you are browing a page and you notice that we have incorrect 
or incomplete information that you know, please feel free to submit it!  Thanks!
