...
<tr>
	<td WIDTH=220><a href="/"><img src="img/bandeau01.jpg" width="220" height="119" border="0" alt="EQ Loft"></a></td>
	<td  WIDTH=271><a href="/"><img src="img/bandeau02.jpg" width="271" height="119" border="0" alt="EQ Loft"></a></td>
...
<table border=0 cellspacing=1 cellpadding=1 width="100%"><form name="formevents" action="/archives.php" method="post">
...
<tr>
	...
	<td colspan=5 class=colcentre><b><center>October 2002</center></b></td>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('01/10/2002', '1')">1</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('02/10/2002', '1')">2</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('03/10/2002', '1')">3</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('04/10/2002', '1')">4</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('11/10/2002', '1')">11</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('16/10/2002', '1')">16</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('17/10/2002', '1')">17</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('21/10/2002', '1')">21</a></A></TD>
...
<td class="menu"><a href="page.php?url=uk/News/" class="menu" target="">EQ New Dawn FAQ</a></td>
...
<td class="menu"><a href="http://www.everquest-europe.com/" class="menu" target="">EverQuest New Dawn</a></td>
...
<td class="menu"><a href="uk/Support/General_FAQ/" class="menu" target="">General FAQ</a></td>
...
<td class="menu"><a href="uk/Support/Tech_FAQ/" class="menu" target="">Technical Help FAQ</a></td>
...
<td class="menu"><a href="uk/Support/Requirements/" class="menu" target="">Game Requirements</a></td>
...
<td class="menu"><a href="uk/Support/Beginner/" class="menu" target="">Beginner Guide</a></td>
...
<td class="menu"><a href="uk/Support/Contact/" class="menu" target="">Contact</a></td>
...
<td class="menu"><a href="uk/Encyclopedia/Lesser_Gods/" class="menu" target="">Lesser Gods</a></td>
...
<tr valign=top>
		...
		<tr valign=bottom>
			...
			<td background="img/artefact_fond1.gif" class="titrepage"><nobr>-&nbsp;_archivenews(October )&nbsp;-</nobr><br><img src="img/blind.gif" width="1" height="2"></td>
...
<tr valign=top>
	...
	<td align=right background="img/bas_recentnews.gif"><img src="img/corn_bd.gif" width="18" height="18" border="0" alt=""></td>
		...
		<form name="formulaire" action="archives.php" method="post">
		<input type="hidden" name="languesite" value="">
		<table>
		<tr>
			<td><select name="mois_archives">
						<option value="1" >January						<option value="2" >February						<option value="3" >March						<option value="4" >April						<option value="5" >May						<option value="6" >June						<option value="7" >July						<option value="8" >August						<option value="9" >September						<option value="10" SELECTED>October						<option value="11" >November						<option value="12" >December						</select></td>
			<td><select name="annee_archives">
						<option value="2002" >2002						</select></td>
...
<img src="/img/titr-bet-corner.gif" width="134" height="22" border="0" alt="Beta-testers Corner"><br>



	<table border=0 cellspacing=0 celppadding=0>
...
<tr>
	...
	<td background="img/fond_d.jpg" width="134">
	...
	<center><table border=0 cellspacing=0 celppadding=2>
...
<td class="menu"><a href="page.php?url=uk/Beta/beta.htm" class="menu" target="">Beta fun</a></td>
...
<td class="menu"><a href="page.php?url=uk/Beta/beta_faq.htm" class="menu" target="">Beta FAQ</a></td>
...
<td class="menu"><a href="page.php?url=uk/Beta/beta_journal.htm" class="menu" target="">Beta journal</a></td>
...
<td class="menu"><a href="page.php?url=uk/Beta/NDA.htm" class="menu" target="">NDA</a></td>
	...
	<center><img src="img/frise_d.gif" width="31" height="11"></center>
...
<noscript><img src="http://ehg-ubisoft.hitbox.com/HG?hc=we91&cd=1&hv=6&ce=u&hb=&n=News&vcon=WebSite/Everquest/Retention/&seg=&cmp=&gp=" border='0' width='1' height='1'>
</noscript><!--//-->
