...
function gotomoissuivant() {
	document.formevents.moisdate.value='07';
	document.formevents.anneedate.value='2004';
	document.formevents.submit();
}
...
<table border=0 cellspacing=1 cellpadding=1 width="100%"><form name="formevents" action="/eq_referral.php" method="post">
...
<tr>
	...
	<td colspan=5 class=colcentre><b><center>June 2004</center></b></td>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('02/06/2004', '1')">2</a></A></TD>
			
			<TD class=case><center>3</A></TD>
			
			<TD class=case><center>4</A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('05/06/2004', '1')">5</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('09/06/2004', '1')">9</a></A></TD>
			
			<TD class=case><center>10</A></TD>
			
			<TD class=case><center>11</A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('12/06/2004', '1')">12</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('16/06/2004', '1')">16</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('17/06/2004', '1')">17</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('18/06/2004', '1')">18</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('26/06/2004', '1')">26</a></A></TD>
...
function verif_form() {
	var form_ok=1;
	var msg_erreur="_error_basic\n";

	
	if (document.formulaire.ref_email.value=="" || verif_mail(document.formulaire.ref_email.value)>0) {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_email\n";
	}
	
	if (document.formulaire.ref_username.value=="") {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_username\n";
	}
	
	if (document.formulaire.ref_firstname.value=="") {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_firstname\n";
	}
	
	
	if (document.formulaire.jour[document.formulaire.jour.selectedIndex].value=="") {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_day\n";
	}

	if (document.formulaire.mois[document.formulaire.mois.selectedIndex].value=="") {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_month\n";
	}

	if (document.formulaire.annee[document.formulaire.annee.selectedIndex].value=="") {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_year\n";
	}
	
	if (document.formulaire.ref_refbyname.value=="") {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_refbyname\n";
	}
	
	
	if (document.formulaire.ref_refbyemail.value=="" || verif_mail(document.formulaire.ref_refbyemail.value)>0) {
		var form_ok=0;
		var msg_erreur=msg_erreur+"-_err_refbyemail\n";
	}
...
function verif_mail(email)
{
	...
	if(email == ""){
		...
		erreur = 2;
			...
			if (decoupe1[decoupe1.length-1].length > 3){
			erreur = 2;
			}
		}
	}
...
<style type="text/css">
.titreref {font-size:11px; font-weight:bold; background-color:#687B87; color:#000000}
.titretableau {font-size:13px; font-weight:bold; background-color:#384B58; color:#FFFFFF; text-align:center}
.bouton {font-size:13px; font-weight:bold; color:#000000; text-align:center}
...
<tr valign=top>
	...
	<td width="100%">		<table border=0 cellspacing=0 cellpadding=0>		<tr valign=bottom>			<td><img src="img/artefact_gauche1.gif" width="162" height="35" border="0" alt=""></td>			<td background="img/artefact_fond1.gif" class="titrepage"><nobr>-&nbsp;_eqreferral&nbsp;-</nobr><br><img src="img/blind.gif" width="1" height="2"></td>			<td><img src="img/artefact_droite1.gif" width="137" height="21" border="0" alt=""></td>		</tr>		</table>				<table border=0 cellspacing=0 cellpadding=0 width="100%">		<tr valign=top>			<td class="fondtexte"><img src="img/ht_ga.gif" width="17" height="18" border="0" alt=""></td>			<td width="100%">			<table border=0 cellspacing=0 cellpadding=0 width="100%">			<tr valign=top>				<td class="fondtexte"><img src="img/artefact_bas1.gif" width="91" height="18" border="0" alt=""></td>				<td width="100%"><table border=0 cellspacing=0 cellpadding=0 width="100%">					<tr valign=top>						<td class="encadrefondtexte"><img src="img/blind.gif" width="10" height="1"></td>					</tr>					<tr>						<td class="fondtexte"><img src="img/blind.gif" width="10" height="17"></td>					</tr>					</table>					</td>			</tr>			</table>						</td>			<td class="fondtexte"><img src="img/ht_dr.gif" width="18" height="18" border="0" alt=""></td>		</tr>		</table>		<table border=0 cellspacing=0 cellpadding=0 width="100%"><tr valign=top>	<td class="encadrefondtexte"><img src="img/blind.gif" width="1" height="1"></td>	<td class="fondtexte" width="10"><img src="img/blind.gif" width="10" height="1"></td>	<td class="contenu" width="100%">	_faq_referral

<table border=0 cellspacing=1 cellpadding=2 width=420>
<tr>
	<td colspan=2 class=titretableau>_eqreferral</td>
</tr>
<form name="formulaire" action="valid_referral.php" method=post>
<input type="hidden" name="languesite" value="">
<tr>
	<td class=titreref>_your_username</td>
	<td><input type="text" name="ref_username" value="" size=30></td>
</tr>
<tr>
	<td class=titreref>_your_firstname</td>
	<td><input type="text" name="ref_firstname" value="" size=30></td>
</tr>
<tr>
	<td class=titreref>_your_email</td>
	<td><input type="text" name="ref_email" value="" size=30></td>
</tr>
<tr>
	<td class=titreref>_datecrea_account</td>
	<td>
	<select name="jour">
	<option value="" SELECTED>_dd<option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select>	
	<select name="mois"><option value="" SELECTED>_mm<option value="1">January</option><option value="2">February</option><option value="3">March</option><option value="4">April</option><option value="5">May</option><option value="6">June</option><option value="7">July</option><option value="8">August</option><option value="9">September</option><option value="10">October</option><option value="11">November</option><option value="12">December</option></select>
	
	<select name="annee"><option value="" SELECTED>_yyyy<option value="1999">1999</option><option value="2000">2000</option><option value="2001">2001</option><option value="2002">2002</option><option value="2003">2003</option><option value="2004">2004</option></select>
...
<table border=0 cellspacing=1 cellpadding=2 width=420>
<tr>
	<td colspan=2 class=titretableau>_referredby</td>
</tr>
<tr>
	<td class=titreref>_ref_username</td>
	<td><input type="text" name="ref_refbyname" value="" size=30></td>
</tr>
<tr>
	<td class=titreref>_ref_email</td>
	<td><input type="text" name="ref_refbyemail" value="" size=30></td>
</tr>
<tr>
	<td></td>
	<td><br><input type="button" name="" value="_eqref_ok" onclick="verif_form()" class=bouton>&nbsp;&nbsp;<input type="reset" name="" value="_eqref_cancel" class=bouton></td>
</tr>
</form>
</table>		</td>	<td class="fondtexte" width="10"><img src="img/blind.gif" width="10" height="1"></td>	<td class="encadrefondtexte"><img src="img/blind.gif" width="1" height="1"></td></tr></table>		<table border=0 cellspacing=0 cellpadding=0 width="100%"><tr valign=top>	<td background="img/bas_recentnews.gif"><img src="img/corn_bg.gif" width="17" height="18" border="0" alt=""></td>	<td background="img/bas_recentnews.gif" width="100%"><center><img src="img/frise_bas.gif" width="121" height="28" border="0" alt=""></center></td>	<td align=right background="img/bas_recentnews.gif"><img src="img/corn_bd.gif" width="18" height="18" border="0" alt=""></td></tr></table></td>
	<td><img src="img/blind.gif" width="10" height="1"></td>
</tr>
</table>
...
<script language="javascript">
var _pn="_eqreferral"; 	//page name(s)
...
<noscript><img src="http://ehg-ubisoft.hitbox.com/HG?hc=we91&cd=1&hv=6&ce=u&hb=&n=_eqreferral&vcon=WebSite/EverQuest/Retention/&seg=&cmp=&gp=" border='0' width='1' height='1'>
</noscript><!--//-->
