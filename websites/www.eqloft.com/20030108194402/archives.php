...
<tr>
	...
	<td colspan=5 class=colcentre><b><center>January 2003</center></b></td>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('01/01/2003', '1')">1</a></A></TD>
			
			<TD class=case><center>2</A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('03/01/2003', '1')">3</a></A></TD>
			
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('04/01/2003', '1')">4</a></A></TD>
...
<TR>
			...
			<TD class=casespecial><center><a class=lienevent href="javascript:ouvrir_event('09/01/2003', '1')">9</a></A></TD>
...
<tr valign=top>
		...
		<tr valign=bottom>
			...
			<td background="img/artefact_fond1.gif" class="titrepage"><nobr>-&nbsp;_archivenews(January )&nbsp;-</nobr><br><img src="img/blind.gif" width="1" height="2"></td>
	...
	<td align=right background="img/bas_recentnews.gif"><img src="img/corn_bd.gif" width="18" height="18" border="0" alt=""></td>
		...
		<tr>
			<td><select name="mois_archives">
						<option value="1" SELECTED>January						<option value="2" >February						<option value="3" >March						<option value="4" >April						<option value="5" >May						<option value="6" >June						<option value="7" >July						<option value="8" >August						<option value="9" >September						<option value="10" >October						<option value="11" >November						<option value="12" >December						</select></td>
			<td><select name="annee_archives">
						<option value="2002" >2002						<option value="2003" >2003						</select></td>
