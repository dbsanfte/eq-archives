    ...
    <tr> 
      <td> 
        <table width="753" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td background="" width="549"><img src="/images/headeqloft1.jpg" width="755" height="101"></td>
          </tr>
        </table>
      </td>
    </tr>
        ...
        <table width="135" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top"> 
            <td background="../../images/navfondmain.gif"><img src="../../images/tgactu.gif" width="135" height="21"><br>
              ...
              <img src="../../images/navflech.gif" width="16" height="8"><a href="../../actu/archives/arch_juil00.html">Archives</a><br>
              <img src="../../images/navflech.gif" width="16" height="8"><a href="/jeux/jeuxroles/everquest/actu/serveurs/index.php">&Eacute;tats 
              des serveurs</a><br>
              <img src="../../images/navflech.gif" width="16" height="8"><a href="../../actu/screenshots/screenshot0700.html">Captures 
              d'&eacute;crans </a><br>
        ...
        <table width="474" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td background="../../images/statusfond.gif" align="left" valign="middle">&nbsp;&nbsp;<font class="status2"><font face="Arial, Helvetica, sans-serif" size="1" color="#6E7866"><a href="../../index.html"><font face="Arial, Helvetica, sans-serif" size="1" color="#1C3800">Accueil</font></a> 
              &gt; <i>Communaut&eacute; &gt; EQList</i></font></font></td>
      ...
      <td colspan="3" valign="top"> 
        <table width="483" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td colspan="3" bgcolor="#57654E"><a name="inter01"></a><img src="../../images/blank.gif" width="4" height="15"><font class="titre">EQLIST</font></td>
...
function validate1(){
	if (isFirstName() && isLastName() && isEMail() && isValidEmail()){
	...
	if (ligne != "")
	{
		...
		for (var c = 0; c < ligne.length; c++)
		{
    		var leCh=ligne.substring(c,c+1);
      		if ((leCh < "a" || "z" < leCh) && (leCh < "A" || "Z" < leCh) && 
	           (leCh < "0" || "9" < leCh) && (leCh != "-") && 
    	       (leCh != "_") && (leCh != "@") && (leCh != ".")){
        	     alert("Votre adresse e-mail n'est pas valable! (ex.: votrenom@gameloft.com) '" + leCh + "'")
            	 return false;
	       	}
   		}
	   	c = 0
...
<b>Warning</b>:  SQL error: [unixODBC][SYBASE][ODBC 20101 driver][20101]ct_connect(): network packet layer: internal net library error: Net-Lib protocol driver call to connect two endpoints failed, SQL state 60 in SQLConnect in <b>/var/www/EQLOFT/www.eqloft.com/communaute/eqlist/db.php</b> on line <b>36</b><br>
...
<form method="post" action="index.php">
  <table width="75%" border="0">
	...
	<tr> 
      <td colspan="2"><b><u>Inscription</u></b></td>
    </tr>
    <tr> 
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr> 
      ...
      <td width="78%"> 
        <input type="text" name="first_name" size="30" maxlenght="30">
      </td>
    </tr>
    <tr> 
      <td width="22%">&nbsp;</td>
	...
	<tr> 
      <td width="22%">Nom :</td>
      <td width="78%"> 
        <input type="text" name="last_name" size="30" maxlenght="30">
      </td>
    </tr>
	<tr> 
      <td width="22%">&nbsp;</td>
    ...
    <tr> 
      <td width="22%">Adresse électronique :</td>
      <td width="78%"> 
        <input type="text" name="email" size="30" maxlenght="30">
      </td>
    </tr>
  </table>
  <br><br>
</form>  <a href=javascript:validate1()><b><u>S'inscrire</u></b></a><br><br><a href=eqlist.php?printMainPage=1><b><u>Retour à la page principale</u></b></a><br>
<b>Warning</b>:  Supplied argument is not a valid ODBC-Link resource in <b>/var/www/EQLOFT/www.eqloft.com/communaute/eqlist/db.php</b> on line <b>42</b><br>
 </td>
          </tr>
          <tr> 
        ...
        <!-- #BeginLibraryItem "/Library/copyright.lbi" --><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><br> Copyright © 2000 Ubi Soft Entertainment- All rights reserved</font></div>
<!-- #EndLibraryItem --><br>
      </td>
    </tr>
  </table>
