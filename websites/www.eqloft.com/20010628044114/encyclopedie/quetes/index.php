...
<td colspan="2" bgcolor="#364334" valign="top"> <!-- php script here --> 
            ...
            <td width="70%" height="38"><input type="text" name="item_name"></td>
    						...
    						<td width="70%" height="27"><select name=zone><option value=' '></option><br>
<b>Warning</b>:  SQL error: [unixODBC][SYBASE][ODBC 20101 driver][SQL Server]zone not found. Specify owner.objectname or use sp_help to check whether the object exists (sp_help may produce lots of output).
, SQL state 53 in SQLExecDirect in <b>/var/www/EQLOFT/www.eqloft.com/encyclopedie/quetes/functions.php</b> on line <b>150</b><br>
<br>
<b>Warning</b>:  Supplied argument is not a valid ODBC result resource in <b>/var/www/EQLOFT/www.eqloft.com/encyclopedie/quetes/functions.php</b> on line <b>151</b><br>
</select>
				 			 </td>
              </tr>
							 <tr> 
