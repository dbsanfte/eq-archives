...
<title>Message System: Message Sent Notification</title>
<!--
              ...
              <tr>
                <td valign=top>
                  <font face="verdana, arial, helvetica" size=+1>
                    <b>Message System: Message Sent Notification</b>
                  </font>
                </td>
              </tr>
    ...
    <td valign="top">
      <table WIDTH="100%" BORDER="0" CELLSPACING="10" CELLPADDING="5">
        <tr>
          <td>
<!-- END HEADER -->
<form action="UserNotesThankYou.asp" method="POST" id="form1" name="form1">
...
<table BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <tr>
    <td>
      <INPUT type="submit" value="Back" name=btnSubmit>
    </td>
  </tr>
</TABLE>
</form>
