...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0">
  ...
  <tr>
    <td colspan=2>
      <font face="verdana,arial,helvetica" size=+1>
        Support will be provided for $20 per incident. Feedback or Bug reports are free.
      </font>
    </td>
  </tr>
...
<input type="hidden" name="return" value="http://www.everquestraids.com/feedback/default.asp">
Pay for your support incident here: <input type="image" src="http://images.paypal.com/images/x-click-but02.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
</form>
<!-- End PayPal Logo -->
