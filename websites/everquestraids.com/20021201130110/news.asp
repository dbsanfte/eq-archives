...
<!--
  ...
  if ((navigator.appVersion.indexOf('MSIE 3') != -1)) GMToffset = GMToffset * (-1);

  function changetype(){
  var URL = "news.asp?etid=" + document.form.EventTypeID.options[document.form.EventTypeID.selectedIndex].value;
  window.location.href = URL;
  }

  function changezone(){
  var URL = "news.asp?zid=" + document.form.ZoneID.options[document.form.ZoneID.selectedIndex].value;
  window.location.href = URL;
  }
...
<script LANGUAGE="javascript" src="/common/Scripts/timeconversionfunctions.js"></script>

<table WIDTH=95% ALIGN=CENTER BORDER=0 CELLSPACING=0 CELLPADDING=5>
   <tr>
      <td align=left valign=top><table WIDTH=100% ALIGN=CENTER BORDER=0 CELLSPACING=0 CELLPADDING=4><tr>
<td colspan=2 class=BodyHead>
EverQuestRaids.com News
</td>
</tr>
<tr><td colspan=2 height=10></td></tr>
<tr>
<td align=left class=CellVLGray  style="FONT-WEIGHT: 600;" colspan=2>
Have a problem? Need help from me?
</td>
</tr>
<tr>
<td align=left colspan=2 class=CellNormal>
<b>Things to remember when asking for help</b><BR><BR>1) If you're a premium member, always include your subscription number and real name in emails to me. It's preferable that you include your Premium Subscription Number in the subject of your email.<BR><BR>If you do not include your premium subscription number, I will assume you are a freeloader, not paying me for my time, and get to your email whenever I feel like it.<BR><BR>2) Always reply to emails from me including past coorispondance. Don't assume that out of 10's of thousands of users I'll remember you, and all of your problems.<BR><BR>3) Always include a specific description of your problem, do not be generic. (i.e. Do not say "I'm having a problem" and expect me to read your mind as to what problem you're havging.)<BR><BR>4) If no error message is displayed for you and what you wanted to do doesn't work, then you probably have anti-popup software running that prevents my script from making a popup window that displays the error message that would normally give you some clue as to what the problem is.<BR><BR>5) If an error message is displayed to you, always include the entire and exact error message. Do not paraphrase it. <BR><BR>6) Always include the exact URL of the web page causing your problem<BR><BR>I would think these things would be common sense. But they are not. More and more people for some reason, expect me to be a mind reader and have an elephant's memory.<BR><BR>Give me a break, this site does not generate enough money to pay me a wage for the time I'm spending just answering emails. Keep that in mind, especially if you do not help support the site yourself and you need help from me.<BR><BR>Thanks.<BR><BR><BR>
</td>
</tr>
<tr>
<td align=left class=CellVLGray>
Posted: <script LANGUAGE="javascript">document.write(DisplayDateTime('2002','10','27','17','59','39'));</script>
</td>
<td align=right class=CellVLGray nowrap>
- Administrator
</td>
</tr>
