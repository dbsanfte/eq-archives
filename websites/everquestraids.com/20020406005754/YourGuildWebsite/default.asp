...
<table width=95% BORDER=0 CELLSPACING=0 CELLPADDING=0>
   <tr>
      <td class=BodyText>
         EverQuestRaids.com has teamed up with a web hosting provider to get you monthly web hosting at low volume prices!
      </td>
   </tr>
   <tr><td height=10></td></tr>
   <tr>
      <td class=BodyHead>
         Here's what you get with your guild website:
      </td>
   </tr>
   ...
   <tr>
      <td class=BodyText>
         <li>Domain Name: YourGuildName.org (.net and .com also available)
         <li>1-year web site hosting
         <li>Unlimited POP3 Email Addresses yourname@yourguildname.org!
         <li>Web-based Email Administration
         <li>Web-based Email Client
         <li>500 MB storage
         <li>Unmetered bandwidth
         <li>Static IP address
         <li>Fast fiber optic connection
         <li>Your own MS Access Database
      </td>
   </tr>
   <tr><td height=5></td></tr>
   <tr>
   ...
   <tr>
      <td class=BodyText>
         <li>Guild Event Calendar (tied in with EverQuestRaids.com)
         <li>Guild Administration tools
         <li>Guild News page
         <li>Logon Security
         <li>Custom Message Boards
         <li>Member List w/Profiles for each member
         <li>Customize Awards & Medals for members
         <li>Other features available at extra cost
      </td>
   </tr>
   <tr><td height=20></td></tr>
   <tr>
      <td class=BodyHead valign=middle>
         <a href="order.asp"><IMG SRC="images/ordernow.gif" border=0 align=absmiddle></a>
      </td>
   </tr>
   <tr><td height=5></td></tr>
   <tr>
      <td class=BodyText>
         <a href="contact.asp">Click here if you'd like to request more information.</a>
      </td>
   </tr>
   <tr><td height=10></td></tr>
</table>
