           ...
           <table width=100% border=0 cellpadding=0 cellspacing=0>
             <tr>
               <td align=center valign=bottom>
                 ...
                 <a href='/sponsors/clickit.asp?AdID=125' target='_New'><IMG SRC='http://www.everquestraids.com/sponsors/eqr2.gif' width=120 height=60 alt='3d glasses (paid until 6/1/2002)' border=0></a>
...
<table WIDTH=95% BORDER=0 CELLSPACING=0 CELLPADDING=0 ALIGN=CENTER>
  <tr>
    ...
    <input name=querystring value="EID=9486&referer=/Events/EventDetails.asp" type=hidden>
