...
<table BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <tr>
    <td class=BodyText>
         Before you begin, you will need to create a <b>FREE</b> <a href="/profile/createprofile.asp">Character Profile</a>.
         <p>A Character Profile stores basic information about your character like what server you play on. This information is used by the script to generate dynamic content just for you.
         For example: If you play on Cazic-Thule the Event List page will display only events scheduled on Cazic-Thule.
         <p>Once you create a Character Profile, links to the pages available to you will be displayed on the nav-bar located at the top of every page. 
         <br>Note that some features and links are only available to <a href="/Account/NewAccount.asp">Premium Subscribers</a>.
    </td>
  </tr>
  <tr><td height=10></td></tr>
  <tr>
    <td class=BodyHead>
      With a FREE Character Profile you will be able to:
    </td>
  </tr>
  <tr>
    <td class=BodyText>
         <UL>
         <li>View Events on the Event List Page.</li>
         <li>Sort and Filter Events on the Event List Page.</li>
         <li>View details of Event(s).</li>
         <li>Join or Quit Event(s).</li>
         <li>Create and Host your own Event(s).</li>
         <li>Edit your Character Profile information. (including a one-click Ding! feature)</li>
         <li>View Private Messages sent to your Character Profile.</li>
         <li>Delete your Character Profile.</li>
         <li>Create a Guild Profile (if you are the leader of a Guild on your server)</li>
         <li>Change or Assign a Guild to your Character Profile. (This will allow you to join Guild-Locked events)</li>
         <li>List guilds registered on your server.</li>
         <li>View and Search the links registered on the Links page.</li>
         <li>Add your own non-guild link to the Links page.</li>
         <li>Submit Feedback to Rordin.</li>
         <li>Access all help documentation pertaining to this website.</li>
         </UL>
    </td>
  </tr>
  <tr><td height=10><hr noshade size=2></td></tr>
            ...
            <table border=0 align=left cellpadding=0 cellspacing=10>
              ...
              <tr>
                <td class=BodyText>
                    ...
                    <br>Guild locked events are marked with the <img SRC="/events/images/locked.gif" width="20" height="20" border="0" align="absmiddle"> (locked) icon.
                    <br>To view details of an event in the list, click the zone name for that event.
                    <br>To join an event, click the <img SRC="/events/images/join.gif" height="20" width="24" border="0" align="absmiddle"> (join) button
                    <Br>To quit an event you have joined, click the <img SRC="/events/images/quit.gif" height="20" width="24" border="0" align="absmiddle"> (quit) button.
