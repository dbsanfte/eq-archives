...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0">
  <tr>
    <td colspan=2 class=BodyHead>
      Please refer to the <a href="/help/faq.asp">Frequently Asked Questions</a> page before submitting a question. Including asking what your character's password is.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class=BodyText>
      ...
      <INPUT class=Dialogue type="text" name=EmailName value="">
    </td>
  </tr>
  <tr>
    <td class=BodyText>
    ...
    <td class=BodyText>
      ...
      <INPUT class=Dialogue type="text" name=EmailAddress value="">
    </td>
  </tr>
  <tr>
    <td class=BodyText>
    ...
    <td class=BodyText>
      <INPUT class=Dialogue type="text" name=EmailSubject value="" size=50>
    </td>
  </tr>
  <tr>
    ...
    <td class=BodyText>
      <TEXTAREA class=Dialogue rows=8 cols=60 name=EmailBody wrap=TRUE></TEXTAREA>
    </td>
  </tr>
  ...
  <tr>
    <td colspan=2 class=BodyText>
      <INPUT class=Dialogue type="submit" value="Submit Email" name=btnSubmit>
    </td>
  </tr>
</table>
</form>
