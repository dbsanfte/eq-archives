          ...
          <td align=left valign=top width=80%>
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              ...
              <tr>
                <td valign=top>
                  <font face="verdana, arial, helvetica" size=-1>
                    There are 3 news items posted within the last 7 days.
                  </font>
                </td>
              </tr>
...
<font face="verdana, arial, helvetica" size="-1">
Just wanted to add a note. Keep in mind when manually converting the GMT starting time for events as posted on the Event List that Daylight Savings affects that calculation. Make sure you know if you are in daylight savings or not and make the adjustment when calculating your correct start time.
</font>
</td>
</tr>
<tr>
...
<td align=left>
<font face="verdana, arial, helvetica" size="-1">
<b>Change: Event List</b>
</font>
</td>
<td align=right>
<font face="verdana, arial, helvetica" size="-1">
<b>6/5/01 8:44:28 PM</b>
</font>
</td>
</tr>
<tr>
<td align=left colspan=2>
<font face="verdana, arial, helvetica" size="-1">
Two people from Europe have complained about times being off. So I have written code so that the GMT times stored in the database are displayed on the Event list right next to the converted local time. This way you can all manually convert the time if you like. Some browsers and platforms do not send the correct timezone offset that the user is on. So you'll see the wrong times listed. There's nothing I can do about that, it's a bug in your browser or your local computer's operating system.
</font>
</td>
</tr>
<tr>
...
<td align=left>
<font face="verdana, arial, helvetica" size="-1">
<b>All EverQuest Servers going down at 3am PST today</b>
</font>
</td>
<td align=right>
<font face="verdana, arial, helvetica" size="-1">
<b>6/5/01 5:01:45 AM</b>
</font>
</td>
</tr>
<tr>
<td align=left colspan=2>
<font face="verdana, arial, helvetica" size="-1">
Just thought I'd repost here that the servers will be coming down at 3am PST today. This means mobs will be respawned =) Start scheduling those epic raids!
</font>
</td>
</tr>
<tr>
