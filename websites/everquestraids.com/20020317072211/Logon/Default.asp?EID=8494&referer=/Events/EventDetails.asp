      ...
      <table WIDTH="100%" cellpadding=0 cellspacing=0 BORDER=0>
        <tr>
          <td class=Title valign="top" nowrap>
            ...
            <IMG SRC="/images/TitleImage.jpg" height=76 width=234 alt="Rordin's EverQuest Event Planner">
           ...
           <table width=100% border=0 cellpadding=0 cellspacing=0>
             ...
             <tr>
               <td align=center valign=bottom>
                 ...
                 <a href='/sponsors/clickit.asp?AdID=120' target='_New'><IMG SRC='http://www.everquestraids.com/Sponsors/Donate/supportsitead.gif' width=120 height=60 alt='Support EverQuestRaids.com (paid until 3/1/2003)' border=0></a>
...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width='100%'>
  <tr>
    ...
    <input name=querystring value="EID=8494&referer=/Events/EventDetails.asp" type=hidden>
