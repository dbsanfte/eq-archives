...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width='100%'>
  <tr>
    ...
    <input name=referer value="/Guilds/Calendar/EmailPassword.asp" type=hidden>
    <input name=querystring value="referer=/Guilds/Calendar/EmailPassword.asp" type=hidden>
