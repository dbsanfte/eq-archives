...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width='100%'>
  <tr>
    ...
    <input name=referer value="/Events/Host/EditEventDetails.asp" type=hidden>
    <input name=querystring value="referer=/Events/Host/EditEventDetails.asp" type=hidden>
