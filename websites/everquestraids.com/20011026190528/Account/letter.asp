...
<title>A letter from Rordin</title>
<!--
...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width=90% align=center>
   ...
   <tr>
      <td class=BodyText>
         Over two years ago while trying to organize raids in-game 
         I had a vision of a tool that everyone who plays EverQuest 
         could use. A tool that would save EverQuest 
         players a lot of time. Out of thousands of hours of coding and
         considerable personal expense came EverQuestRaids.com. ... and the rest is, 
         as they say, history.<p>

         Tens of thousands of EverQuest players have visited my website and created
         character profiles. 
         I get emails every day from strangers telling me how much my site helps them
         play EverQuest. Many tell me they can't imagine EverQuest without it. 
         That always made me feel good, knowing that I helped so many people.<p>
        
         Looking back, I can't believe I spent all the time I did on making this website.
         I had a good job at Boeing and I'm not a greedy person, so I kept all portions 
         of it free for everyone to use as long as I could.<p>
         
         But now, with the attacks on the WTC and Pentagon my employer (Boeing) is laying me off.<p>
         I'm unable to find a job, so I'm asking that everyone help me out by hiring me to work 
         full-time on EverQuestRaids.com.<p>

         If enough people open Premium Accounts I won't have to worry about putting food on my table. I'll also be able to add
         some of the many features and enhancements that have been accumulating over the last
         two years in my TODO list.<p>
         
         I hope that I can count on your support. Together we can make this website the most
         useful EverQuest site on the net!<p>
         
         With fondest regards,<br>
         Charles A. Forsyth<br>
         (AKA Rordin)<br>
   ...
   <tr>
      <td class=BodyHead>
         <a href="/account/createaccount.asp">Create Account</a>
      </td>
   </tr>
</table>
<!-- BEGIN FOOTER -->
