           ...
           <table width=100% border=0 cellpadding=0 cellspacing=0>
             <tr>
               <td align=center valign=bottom>
                 <a href='/sponsors/clickit.asp?AdID=136' target='_New'><IMG SRC='http://www.everquestraids.com/Sponsors/DogsofWar.gif' width=120 height=60 alt='Dogs of War (paid until 10/1/2002)' border=0></a>
               </td>
             </tr>
           </table>
         </td>
