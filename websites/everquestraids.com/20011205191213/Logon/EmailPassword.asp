...
<table BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <tr>
    <td class=BodyHead>
        Please enter your Email Address as appears in your Character Profile:&nbsp;
    </td>
  </tr>
  <tr>
   <td>
      <table>
         <tr>
            ...
            <td>
              <INPUT class=Dialogue type="text" name=email value="" size=30>&nbsp;
            </td>
            <td>
              <INPUT class=Dialogue type="submit" value=" Send " name=btnSubmit tabindex=0>
            </td>
         </tr>
      </table>
   </td>
