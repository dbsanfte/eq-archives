...
<title>Guild Websites from $20 a month!</title>
<!--
      ...
      <table WIDTH="100%" cellpadding=0 cellspacing=0 BORDER=0>
        <tr>
          ...
          <td class=Title align=left valign=middle>
            ...
            <input type="hidden" name="item_name" value="EverQuestRaids.com Donation">
            <input type="hidden" name="item_number" value="6000">
           ...
           <table width=100% border=0 cellpadding=0 cellspacing=0>
             <tr>
               <td align=center valign=bottom>
                 ...
                 <a href='/sponsors/clickit.asp?AdID=122' target='_New'><IMG SRC='http://www.everquestraids.com/images/onemonthfree_ad.gif' width=120 height=60 alt='One Month Free Premium Access (paid until 4/1/2002)' border=0></a>
            ...
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              <tr>
                <td valign=top class=TitleText>
                    Guild Websites from $20 a month!
                </td>
              </tr>
    ...
    <td valign="top" align=center>
      <table WIDTH="95%" BORDER="0" CELLSPACING="0" CELLPADDING="5">
        <tr>
          <td align=left>
<!-- END HEADER -->
<form action="contact.asp" method="POST" id="form1" name="form1">
<table width=95% BORDER=0 CELLSPACING=0 CELLPADDING=0>
   <tr>
      <td class=BodyText>
         Use the form below to request more information about this limited time offer for a custom Guild Website plus Web Hosting.
      </td>
   </tr>
   ...
   <tr>
      <td class=BodyHead>
         <table BORDER=0 CELLSPACING=0 CELLPADDING=0>
            ...
            <tr>
               <td class=BodyHead colspan=2>
                  <TEXTAREA cols=60 rows=5 name="MyBody"></TEXTAREA>
               </td>
            </tr>
            <tr>
               <td class=BodyHead colspan=2>
