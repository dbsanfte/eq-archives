...
Froglok race added, along with zones
</td>
</tr>
<tr>
<td align=left colspan=2 class=CellNormal>
Thanks to Hoppa of Terris-Thule for reminding me to add Froglok race and the new zones.
</td>
</tr>
<tr>
<td align=left class=CellVLGray>
Posted: <script LANGUAGE="javascript">document.write(DisplayDateTime('2003','2','2','21','8','10'));</script>
</td>
...
<tr>
<td align=left colspan=2 class=CellNormal>
Well it has sure been a long time since someone found a bug. Thanks to Kaite Knightwalker for directing my attention to a bug in the Update Character Profile interface. The problem has been fixed. Only those who had an account created before the year 2001 should have experienced this bug.<BR><BR>Wow, has it been that long? <BR><BR>This site has been around since late 1999 and it's still going strong thanks to the generous support of Premium Subscribers and Guilds who sponsor. Thanks to you all!
</td>
</tr>
<tr>
<td align=left class=CellVLGray>
Posted: <script LANGUAGE="javascript">document.write(DisplayDateTime('2003','0','23','23','24','27'));</script>
</td>
<td align=right class=CellVLGray nowrap>
- Administrator
</td>
...
<tr>
<td align=left colspan=2 class=CellNormal>
A couple people have complained that their accounts were expired even though they paid.<BR><BR>The reason this happened is because PayPal.com's IPN notification service was down for maintenance at the exact time their renewal subscriptions went thru.<BR><BR>This may happen to more people in the future so I thought I'd take the time to let you know about it.<BR><BR>Don't worry though. If you paid I can easily look it up on PayPal.com and then manually update your account to expire when  it's supposed to expire. If your account expired but you paid, just send me an email using the same email address you used to pay for your account on PayPal.com and I'll be happy to investigate your account for you.<BR><BR>Thanks to all those who support this site by subscribing to premium content. Without you, this site would not stay alive because the rent would not get paid.
</td>
</tr>
<tr>
<td align=left class=CellVLGray>
Posted: <script LANGUAGE="javascript">document.write(DisplayDateTime('2003','0','13','21','57','14'));</script>
</td>
<td align=right class=CellVLGray nowrap>
- Administrator
</td>
