...
<font face="verdana, arial, helvetica" size="-1">
My apologies to those who have submitted change requests or bug reports and to my friends on Bristlebane.<BR><BR>As many of you know from my posting a while back, Boeing is laying off many thousands of employees due to the 9/11 attacks on the WTC. Americans aren't flying and as a result and airlines are canceling their orders for airplanes. <BR><BR>Unfortunately, I'm one of those being laid off.<BR><BR>I won't be playing EverQuest or doing any work on any of my sites including this one until I find a job and a steady income.<BR><BR>I did have a thought a while back that I may make this website a partial pay site. What I mean is basic features like adding an event, joining events and viewing the list of upcoming events would be free. <BR><BR>For $1 a month (yeah only one buck) you can have all the more advance features. An example of advance features would be the ability to assign players groups within your event, search profiles, view the calendar, have a my events list, etc. You'd also get free support.<BR><BR>The revenue would cover my salary, hosting and maintenance of the website. I'd also have much more time to be able to update the site and make it even more valuable to everyone. I'd love to generalize the site even more and include other games like AO and the new Star Wars MMPORG coming out, etc. The revenues from this site would allow me to do that.<BR><BR>What do you all think? Would you pay a buck a month to have the advance features of the site? (including some new ones I currently have in my todo list)<BR><BR>
</font>
</td>
</tr>
<tr>
...
<td align=left>
<font face="verdana, arial, helvetica" size="-1">
<b>Firiona Vie added to server list</b>
</font>
</td>
<td align=right>
<font face="verdana, arial, helvetica" size="-1">
<b>10/14/01 7:35:43 PM</b>
</font>
</td>
</tr>
<tr>
<td align=left colspan=2>
<font face="verdana, arial, helvetica" size="-1">
By popular request I've added Firiona Vie to the Server List. Sorry I didn't do it sooner. Thanks to all those who gave me the heads up.
</font>
</td>
</tr>
<tr>
