  ...
  <td class=NavBar valign=middle align=center>
    <table align=center cellpadding=0 cellspacing=0 border=0>
      <tr>
        ...
        <td nowrap align=center valign=middle>
          <a class=NavBar href="/Profile/CreateProfile.asp">Create FREE Character Profile</a>
        </td>
        <td nowrap align=center valign=middle>
          <font class=NavBar>&nbsp;|&nbsp;</font>
        </td>
            ...
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              ...
              <tr>
                <td valign=top class=TitleSubText>
                    Use this form to find your account(s) with the matching email address you provide here and email those accounts their password. If you changed your email address, this will not work. The address you enter below must match that stored in the account(s) and be a valid email address for you to receive email there.
                </td>
              </tr>
   ...
   <td>
      <table>
         <tr>
            ...
            <td>
              <INPUT type="submit" value=" Send " name=btnSubmit tabindex=0>
            </td>
         </tr>
      </table>
   </td>
