            ...
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              ...
              <tr>
                <td valign=top class=TitleSubText>
                    This page displays your banner-ad's total click-thru statistics.
                </td>
              </tr>
...
<form action="myAdStats.asp" method="POST" id="form1" name="form1">
<input name=Recursive value="true" type=hidden>
<table WIDTH=95% BORDER=0 CELLSPACING=0 CELLPADDING=0 ALIGN=CENTER>

  <tr>
    <td class=BodyText>
      Please enter your Banner Ad's Pass Code:&nbsp;
    </td>
  </tr>
  <tr>
    <td class=BodyText>
      <INPUT size=60 class=DTxtArea type="text" id=SGUID name=SGUID value="">&nbsp;<INPUT class=DSbmtBttn type="submit" value="Get Stats!" id=btnSubmit name=btnSubmit>
    </td>
  </tr>
