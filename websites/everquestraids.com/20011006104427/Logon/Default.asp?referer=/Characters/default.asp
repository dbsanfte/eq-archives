      ...
      <table width=100% border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          <td align=center valign=bottom>
            <a href="/sponsors/clickthru.asp?AdID=21&tURL=http%3A%2F%2Fwww%2Eintrepidspirits%2Ecom%2Fwelcome%2Ehtm" target="_New"><IMG SRC="/sponsors/oct2001/islogo.gif" width=120 height=60 alt="Intrepid Spirits (paid until 12/1/01)" border=0></a>
          </td>
        </tr>
      </table>
    </td>
...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" width='100%'>
  <tr>
    ...
    <input name=referer value="/Characters/default.asp" type=hidden>
    <input name=querystring value="referer=/Characters/default.asp" type=hidden>
