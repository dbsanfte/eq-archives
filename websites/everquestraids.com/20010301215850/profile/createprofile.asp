...
<tr>
  <td class=NavBar valign=middle align=center bgcolor="" height=22>
    ...
    <a class=NavBar onmouseover="dtTip('Read the latest news about EverQuestRaids.com.', 200, -100, 20); return(true);" onmouseout="dcleartTip(); return(true);" href="/default.asp?referer=/profile/createprofile.asp">News</a>
    <font class=NavBar>&nbsp;|&nbsp;</font>
    ...
    <font class=NavBar>&nbsp;|&nbsp;</font>
      ...
      <a class=NavBar onmouseover="dtTip('Use this form to create a character profile for each of your EverQuest characters.', 200, -100, 20); return(true);" onmouseout="dcleartTip(); return(true);" href="/Profile/CreateProfile.asp?referer=/profile/createprofile.asp">Create Profile</a>
      <font class=NavBar>&nbsp;|&nbsp;</font>
          ...
          <td align=left valign=top width=80%>
            <table height=10 cellpadding=0 cellspacing=4 WIDTH="100%" BORDER=0>
              ...
              <tr>
                <td>
                  <font face="verdana, arial, helvetica" size=-1>
                    You can use this form to create a character profile for your character in order to access this site.<br>If you have more than one character, each of your characters will require a seperate profile.<p><b>WARNING:</b> If you do not log on to this website at least once in three days, your character profile will automatically be deleted from the database. You will be unable to log on if you do not provide a valid email address since the logon password will be emailed to you.
                  </font>
                </td>
              </tr>
...
<table BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <TR>
    <td>
      <font face="Verdana,Arial,Helvetica" size=-1>
        <b>Select the EverQuest Server your Character plays on:</b>
      </font>            
    </td>
  </TR>
  <TR>
        ...
        <tr>
          <td align=center>
            <font class=Footer size=-2>
              <b>62832</b> unique sessions since <b>14-NOV-2000</b>
            </font>
          </td>
        </tr>
