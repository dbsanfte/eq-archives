            ...
            <table border=0 align=left cellpadding=0 cellspacing=10>
              <tr>
                <td>
                  <font face="Verdana,Arial,Helvetica" size=-1>
                    <b>My Alternates</b>
                    <br>This form allows users who have multiple character profiles to store them in a list. 
                    <br>Once stored, you can use this form to quickly switch between characters without having to log on for each character.
                  </font>
                </td>
              </tr>
              <tr>
