...
<option value=20>Other</option>
  ...
  <tr>
    <td valign="top" class=BodyText>
      Default Query Results - 40 matching records found.
    </td>
  </tr>
    ...
    <td class=BodyText>
      <table WIDTH="100%" BORDER="0" CELLSPACING="2" CELLPADDING="0">
        <tr>
          ...
          <tr>
            <td valign="top" nowrap class=BodyText>
                <a href="http://pub45.ezboard.com/beqguilder" target="_New">Bristlebane EQ Guilder!</a>&nbsp;
            </td>
            <td valign="top" class=BodyText>
                A website to help characters find guilds and guilds find characters! If you fit either description please post here! Thank You&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Global Site&nbsp;
            </td>
          ...
          <tr>
            <td valign="top" nowrap class=BodyText>
                <a href="http://www.eqtraders.com/index.htm" target="_New">EQ Traders Corner</a>&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Well organized trade skill information site. Also has some quest information.&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Bristlebane&nbsp;
            </td>
          ...
          <tr>
            <td valign="top" nowrap class=BodyText>
                <a href="http://www.eqplatsecrets.com" target="_New">Everquest Unlimited Platinum Secrets</a>&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Find out how to make up to 10,000 Platinum every day on Everquest&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Global Site&nbsp;
            </td>
...
and their skills.&nbsp;
          ...
          <tr>
            <td valign="top" nowrap class=BodyText>
                <a href="http://www.monkly-business.com/" target="_New">Monkly Business</a>&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Monk Site containing a message board, Monk Quest Guides, Skill levels, Equipment, all you need to know for the Monk class.&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Global Site&nbsp;
            </td>
          ...
          <tr>
            <td valign="top" nowrap class=BodyText>
                <a href="http://pub51.ezboard.com/bterristhule31041" target="_New">Terris Thule Message Board</a>&nbsp;
            </td>
            <td valign="top" class=BodyText>
                This is a message board for the Terris Thule Server.&nbsp;
            </td>
            <td valign="top" class=BodyText>
                Terris-Thule&nbsp;
            </td>
