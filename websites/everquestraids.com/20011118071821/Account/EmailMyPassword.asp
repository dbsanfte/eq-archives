...
<title>Request Premium Account Credentials</title>
<!--
            ...
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              <tr>
                <td valign=top class=TitleText>
                    Request Premium Account Credentials
                </td>
              </tr>
              
              <tr>
                <td valign=top class=TitleSubText>
                    Use either of the forms below to request Account credentials from your paid Premium Account.<br>The information will be emailed to the address associated with your paid Premium Account.
                </td>
              </tr>
    ...
    <td valign="top">
      <table WIDTH="100%" BORDER="0" CELLSPACING="10" CELLPADDING="5">
        <tr>
          <td>
<!-- END HEADER -->
<form action="EmailMyPassword.asp" method="POST" id="form1" name="form1">
                  ...
                  <table border="0" CELLSPACING="0" CELLPADDING="0" align=center>
                     <tr>
                        <td nowrap class=BodyLogon colspan=2 align=center>
                           <b>Use your account user name</b>
                        </td>
                     </tr>
                     <tr><td height=10></td></tr>
                     <tr>
                        <td nowrap align=right class=BodyLogon valign=middle>
                            Account User Name:&nbsp;
                        </td>
                        <td nowrap align=left class=BodyLogon valign=top>
                           <INPUT class=Dialogue type="text" id=AccountName name=AccountName value="">
                        </td>
                     </tr>
                     <tr>
                        <td nowrap align=right class=BodyLogon valign=middle>
                     ...
                     <tr>
                        <td nowrap class=BodyLogon colspan=2 align=center>
                           <INPUT class=Dialogue type="submit" value=" Send Account Credentials " id=btnSend1 name=btnSend1>
                        </td>
                     </tr>
                     <tr><td height=10></td></tr>
                  </table>
            ...
            <tr>
               <td nowrap align=right>
                  <table border="0" CELLSPACING="0" CELLPADDING="0" align=center>
                     <tr>
                        <td nowrap class=BodyLogon colspan=2 align=center>
                           <b>Use your PayPal Subscription #</b>
                        </td>
                     </tr>
                     <tr><td height=10></td></tr>
                     <tr>
                        ...
                        <td nowrap align=left class=BodyLogon valign=top>
                           <INPUT class=Dialogue type="text" id=subscr_id name=subscr_id value="" size=50>
                        </td>
                     </tr>
                     <tr>
                        <td nowrap align=right class=BodyLogon valign=middle>
                     ...
                     <tr>
                        <td nowrap class=BodyLogon colspan=2 align=center>
                           <INPUT class=Dialogue type="submit" value=" Send Account Credentials " id=btnSend2 name=btnSend2>
                        </td>
                     </tr>
                     <tr><td height=10></td></tr>
                  </table>
