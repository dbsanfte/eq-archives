...
<title>Premium Account Authentication</title>
<!--
            ...
            <table height=10 cellpadding=0 cellspacing=0 WIDTH="100%" BORDER=0>
              ...
              <tr>
                <td valign=top class=TitleSubText>
                    Use this form to be authenticated as a Premium Subscriber.
                </td>
              </tr>
    ...
    <td valign="top">
      <table WIDTH="100%" BORDER="0" CELLSPACING="10" CELLPADDING="5">
        <tr>
          <td>
<!-- END HEADER -->
<form action="AccountLogon.asp" method="POST" id="form1" name="form1">
...
<table width=95% BORDER="0" CELLSPACING="0" CELLPADDING="0">
               ...
               <td nowrap align=right>
                  <table border="0" CELLSPACING="0" CELLPADDING="0" align=center>
                     ...
                     <tr>
                        ...
                        <td nowrap align=left class=BodyLogon valign=top>
                           <INPUT class=Dialogue type="password" id=UserPass name=UserPass>
                        </td>
                     </tr>
                     <tr>
                        <td nowrap align=right class=BodyLogon valign=middle>
                              
                            <INPUT type="checkbox" id=AutoLogon name=AutoLogon value=1>&nbsp;
                        </td>
                        <td class=BodyLogon valign=top>
                           Remember my password. <sup>*</sup>
                        </td>
                     </tr>
                     <tr><td height=10 colspan=2></td></tr>
                     <tr>
                        <td nowrap class=BodyLogon colspan=2 align=center>
                           <INPUT class=Dialogue type="submit" value=" Authenticate Me " id=btnLogon name=btnLogon>
                        </td>
                     </tr>
                     <tr><td height=10 colspan=2></td></tr>
                     <tr>
                        <td nowrap class=BodyLogon colspan=2 align=center>
                           <a href="/Account/EmailMyPassword.asp">Email me my Account Information</a>
                        </td>
                     </tr>
                  </table>
                </td>
   ...
   <tr>
      <td nowrap class=BodyTextSM colspan=2 align=center>
         <sup>*</sup> To remember your password you must have Cookies enabled.
      </td>
   </tr>
