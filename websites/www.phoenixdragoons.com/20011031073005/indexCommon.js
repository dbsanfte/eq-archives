...
function clockShow()
{
	...
	var str = ((dateYear > 29) ? "19" : "20") + dateYear + "-" + GetMonth(dateMonth) + "-" + ((dateDay < 10) ? 0 : "") + dateDay;
	if (bNetscape)
	{
	...
	{
		tdDate.innerText = ((dateYear > 29) ? "19" : "20") + dateYear + "-" + GetMonth(dateMonth) + "-" + ((dateDay < 10) ? 0 : "") + dateDay;
	}
