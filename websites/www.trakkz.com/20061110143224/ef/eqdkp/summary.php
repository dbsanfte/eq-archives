...
<title>Order of Eternal Flame RP: News Summary</title>
<style type="text/css">
form { display: inline; }
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <b>Ending Date:</b> <input type="text" name="mo2" size="3" maxlength="2" value="11" class="input" />/<input type="text" name="d2" size="3" maxlength="2" value="10" class="input" />/<input type="text" name="y2" size="3" maxlength="2" value="06" class="input" />
    </td>
  </tr>
  <tr>
