...
var gDocTable = new Array(
   ...
   new hrefList("slide0290.htm", 1, 9),
   new hrefList("slide0313.htm", 1, 10),
   new hrefList("slide0305.htm", 1, 11),
   new hrefList("slide0318.htm", 1, 12),
   new hrefList("slide0315.htm", 1, 13),
   new hrefList("slide0319.htm", 1, 14),
   new hrefList("slide0300.htm", 1, 15),
   new hrefList("slide0296.htm", 1, 16),
   new hrefList("slide0316.htm", 1, 17),
   new hrefList("slide0317.htm", 1, 18)
);
