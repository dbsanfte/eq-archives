...
var gDocTable = new Array(
   ...
   new hrefList("slide0301.htm", 1, 12),
   new hrefList("slide0283.htm", 1, 13),
   new hrefList("slide0308.htm", 1, 14),
   new hrefList("slide0303.htm", 1, 15),
   new hrefList("slide0307.htm", 1, 16),
   new hrefList("slide0309.htm", 1, 17)
);
