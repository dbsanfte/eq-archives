...
<HTML><HEAD><TITLE>EQPrices.Com - Global Search</TITLE>
  ...
  <TR>
    ...
    <TD vAlign=top width=625>
      <TABLE bgColor=#122134 border=0 cellPadding=0 cellSpacing=0>
            ...
            <TABLE border=0 cellPadding=0 cellSpacing=0 width=600>
              ...
              <TR>
                <TD colSpan=3><IMG height=5 
                  src="../pixel.jpg" width=5></TD></TR>
	     <TR WIDTH=100%>

		<TD align=left><A href="http://games.everyone.net/" OnMouseOut="window.status=''; return true" OnMouseOver="window.status='Everyone Net Games Division'; return true"><IMG src="../games_lite.gif" width="100" height="60" border="0" alt="Everyone.net Games Division"></A></TD>
	     <TD ALIGN=CENTER>
		<b><a href="../quick.shtml" onMouseOver="return overlib('Just fill in the item name (and the price if you know it), and we\'ll do the rest!', CAPTION, 'Quick Submit', FGCOLOR, '#DCDDF2', BGCOLOR, '#B7B8C9', CAPCOLOR, '#122134');" onMouseOut="nd();">Quick Item Submit</a> -
	  	<a href="mailto:feedback@eqprices.com" onMouseOver="return overlib('Compliment.  Complain.  Whatever your reasons, we want to hear from you!.', CAPTION, 'We want to hear from you!', FGCOLOR, '#DCDDF2', BGCOLOR, '#B7B8C9', CAPCOLOR, '#122134');" onMouseOut="nd();">Send E-Mail</a><br>
		<a href="../Staff.shtml" onMouseOver="return overlib('These are the people who make this site a reality.', CAPTION, 'EQPrices.Com Staff', FGCOLOR, '#DCDDF2', BGCOLOR, '#B7B8C9', CAPCOLOR, '#122134');" onMouseOut="nd();">Staff</a> - 
		...
		<TD align=right><a href="http://gameglow.com/index.shtml" OnMouseOut="window.status=''; return true" OnMouseOver="window.status='Hosted by GameGlow.com'; return true"><img src="../gg-banner88.jpg" width="88" height="31" alt="GameGlow.com" border="0"></a><br></TD>
		</TR>

		<TR><TD COLSPAN=3><HR></TD></TR><BR><BIG>You must enter a string to search for.</BIG><BR><BR>          </TBODY>
         </TABLE>
