...
<tr><td class="menulink">&nbsp;&nbsp;<a class="menulink" href="mailto:pon@castersrealm.com">Email Us</a></td></tr>
  ...
  <table border='0' width='100%' cellspacing='0' cellpadding='5'>
    <tr>
      <td width='95%' align='left' valign='top' bgcolor='black' colspan=2 class='header'>ARMOR, ITEM AND WEAPON LISTS</font></b></td>
    </tr>
    <tr>
		<td align='left' bgColor='#ebd8c3' class='spti' colSpan='2' height='21' vAlign='top'>Popular Searches&nbsp;</td>
    </tr>
    <tr>
		<td align='left' bgColor='#ebd8c3' height='21' vAlign='top' width='50%'><a href='items.asp?Action=LatestItems&ClassSelect=ANY'>Recently Added/Updated Items</a></td>
		<td align='left' bgColor='#ebd8c3' height='21' vAlign='top' width='50%'><a href='items.asp?Action=SearchAC&ClassSelect=ANY'>Highest AC Items</a></td>
    </tr>
    <tr>
		<td align='left' bgColor='#ebd8c3' height='21' vAlign='top' width='50%'><a href='items.asp?Action=SearchSpeed&ClassSelect=ANY'>Fastest Weapons</a></td>
		<td align='left' bgColor='#ebd8c3' height='21' vAlign='top' width='50%'><a href='items.asp?Action=SearchDMG&ClassSelect=ANY'>Most Damaging Weapons</a></td>
    </tr>
    <tr>
		<td align='left' bgColor='#ebd8c3' height='21' vAlign='top' width='50%'>&nbsp;</td>
		<td align='left' bgColor='#ebd8c3' height='21' vAlign='top' width='50%'>&nbsp;</td>
    </tr>
    <tr>
		<td align='left' bgColor='#ebd8c3' class='spti' colSpan='2' height='21' vAlign='top' ><span class='spti'>Class Searches</span>&nbsp;</td>
    </tr>
  <tr>
	 <td colspan=2>
...
<td width=50% align=left class='db2'><a href=items.asp?Action=ClassSelect&ClassSelect=Wizard>Wizard</a></td>
    ...
    <tr>
		<td align='left' class='spti' colSpan='2' height='21' vAlign='top'>Advanced Search</td>
    </tr>
    <tr>
		<td align='left' colSpan='2' height='21' vAlign='top'>Click <a href='items_advanced.asp'>here</a> for more advanced search options</td>
    </tr>
    <tr>
		<td align='left' class='spti' colSpan='2' height='21' vAlign='top'><br>Quick Search</td>
    </tr>
    <tr>
		<td align='left' colSpan='2' height='21' vAlign='top'>Enter item name: <form action=items.asp method=get id=form1 name=form1><input type=text name=SearchString><input type=hidden name=Action value=QuickSearch><input type=submit value='Go!'></form></td>
    </tr>
    <tr>
		<td align='left' colSpan='2' height='21' vAlign='top'><small>e.g. Enter 'efreeti' to search for 'Efreeti Belt' or 'Efreeti War Axe'</small></td>
    </tr>
</table>
