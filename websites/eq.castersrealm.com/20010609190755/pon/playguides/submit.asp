										...
										<tr>
											<td width="100%" valign="top">					
												...
												<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													...
													<form method='POST' action='submit.asp?Action=Preview'>
<input type=hidden name='Class' value='Paladin'>
  <table border='0' width='100%' cellpadding=5>
    <tr><td class='header'bgcolor='black' colspan='3'>SUBMIT A STRATEGY</td></tr>    <tr>
      <td valign='top' class='SPTI' width='267'>Category:</td>
      <td valign='top' class='SPTI' width='13'></td>
      <td valign='top' class='SPTI' width='562'><select name='category'>
    ...
    <tr>
      <td valign='top' class='SPTI' width='267'>Your Name:</td>
      <td valign='top' class='SPTI' width='13'></td>
      <td valign='top' class='SPTI' width='562'><input type='text' name='player' size='61'></td>
    </tr>
    <tr>
      <td valign='top' class='SPTI' width='267'>Strategy Title</td>
      <td valign='top' class='SPTI' width='13'></td>
      <td valign='top' class='SPTI' width='562'><input type='text' name='Title' size='61'></td>
    </tr>
    <tr>
      <td valign='top' class='SPTI' width='267'>Your Server:</td>
      <td valign='top' class='SPTI' width='13'></td>
      <td valign='top' class='SPTI' width='562'><select name='Server'><option value='0'>Please select a server</option><option>Ayonae Ro</option><option>Bertoxxulous</option><option>Brell Serilis</option><option>Bristlebane</option><option>Cazic-Thule</option><option>Drinal</option><option>Druzzil Ro</option><option>E'ci</option><option>Erollisi Marr</option><option>Fennin Ro</option><option>Innoruuk</option><option>Karana</option><option>Lanys T'vyl</option><option>Luclin</option><option>Mithaniel Marr</option><option>Morell-Thule</option><option>Povar</option><option>Prexus</option><option>Quellious</option><option>Rallos Zek</option><option>Rodcet Nife</option><option>Saryrn</option><option>Seventh Hammer</option><option>Solusek Ro</option><option>Tallon Zek</option><option>Tarew Marr</option><option>Terris-Thule</option><option>Test Server</option><option>The Nameless</option><option>The Rathe</option><option>The Tribunal</option><option>Tholuxe Paells</option><option>Torvonnilous</option><option>Tunare</option><option>Vallon Zek</option><option>Vazaelle</option><option>Veeshan</option><option>Xegony</option><option>Xev</option><option>Zebuxuruk</option></select></td>
    </tr>
    <tr>
      <td valign='top' class='SPTI' width='267'>Your Strategy:</td>
      <td valign='top' class='SPTI' width='13'></td>
      <td valign='top' class='SPTI' width='562'><textarea rows='14' name='strategy' cols='53'></textarea></td>
    </tr>
    <tr>
      <td valign='top' class='SPTI'></td>
    </tr>
    <tr>
      <td valign='top' class='SPTI' colspan='2' width='284'></td>
    </tr>
    <tr>
      <td valign='top' class='SPTI' colspan='2' width='284'></td>
      <td valign='top' class='SPTI' width='562'><input type='submit' value='Click here when your strategy is complete!'></td>
<tr><td colspan='3' width='100%'><HR SIZE=1>
<FONT class=spti>IMPORTANT POSTING INFORMATION</FONT>
<P>Strategies you submit must be entered with valid HTML code.  Here is a 
list of common elements:</P>
<UL>
<LI>&lt;b&gt;Bold Text&lt;/b&gt;  will produce this look: <B>Bold Text</B> 
<LI>&lt;i&gt;Italic Text&lt;/i&gt; will produce: <I>Italic Text</I> 
<LI>&lt;u&gt;Underlined Text&lt;/u&gt; will produce: <U>Underlined Text</U> 
</LI></UL>
<P>You must also separate your paragraphs.  To do this you should structure a 
post like follows:</P>
<BLOCKQUOTE>
<P>&lt;p&gt;This is our first paragrah.&lt;/p&gt;<BR>&lt;p&gt;This is our second 
paragraph&lt;/p&gt;</P></BLOCKQUOTE></td></tr>    </tr>
  </table>
</form>
