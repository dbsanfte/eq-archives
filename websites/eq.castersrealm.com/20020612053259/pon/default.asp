										...
										<tr>
											<td width="100%" valign="top">					
												...
												<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													...
													<table border='0' width='100%'><tr><td><table border=0 width=100% align=center cellpadding='5'>
<tr><td vAlign='absmiddle' align='left' width='80%' colSpan='4' bgcolor='#000000' class='header'><img border='0' src='http://eq.castersrealm.com/pon/images/cricon.gif' align='absmiddle'> PALADINS OF NORRATH CURRENT NEWS - NEW POLL!</td></tr>
<tr><td class='newspostheader'>With the new Deity PvP Server, how many Paladins play on PvP Servers?</td></tr>
<form action='http://eq.castersrealm.com/pon/survey/add.asp' method=post>
<input type=hidden name=pollId value=13>
<tr><td align='top'><input type=radio name=voteId value=1> I play a Paladin on a PvP Server</td></tr>
<tr><td align='top'><input type=radio name=voteId value=2> I play another charcter on a PvP Server</td></tr>
<tr><td align='top'><input type=radio name=voteId value=3> I would never play on a PvP Server</td></tr>
<tr><td align='top'><input type=radio name=voteId value=4> I would play on a PvP server if it was done right</td></tr>
<tr><td><input type=submit value='Click Here to Vote!'></td></tr>
</form>
</table><td><td valign='middle' align='center'><img src='http://eq.castersrealm.com/pon/images/sbwatermark.gif'></td></tr></table>
<tr>
      ...
      <tr>
        <td height='23' width='100%'>
                        <table cellpadding='3' cellspacing='0' border='0' width='100%'>
                          <tr>
                          <td vAlign='ABSMIDDLE' align='left' width='100%' bgcolor='#000000' class='header'><img border='0' src='./images/cricon.gif' ALIGN='ABSMIDDLE'> Wednesday June 5, 2002</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    <td class='newsbody' width='100%'><br><p class='newspostheader'><b>NEW PATCH</b></P>
<div class='newspost'>  Many things where changed in this patch, focus effects were added to many items and they FIXED the Lucan skeleton bug!
Below has the full message</div>
<p class='newspost'>Click <a class='newspost' href='viewarticle.asp?Article=205'><b>here</b></a> for details.</p>  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 11:53 AM</p>
					 </td>
			</tr>
			<tr>
  ...
  <td valign='top' width='100%'>
      ...
      <tr>
        <td height='23' width='100%'>
                        <table cellpadding='3' cellspacing='0' border='0' width='100%'>
                          <tr>
								<td vAlign='ABSMIDDLE' align='left' width='100%' bgcolor='#000000' class='header'><img border='0' src='./images/cricon.gif' ALIGN='ABSMIDDLE'> Wednesday May 29, 2002</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    <td class='newspost' width='100%'><br><p class='newspostheader'><b>HYBRIDS...THE ONLY "ENCHANCED" CLASSES</b></P>
<div class='newspost'>  Recently Absor was questioned on the lack of the AAXP Ability Physical Enchancement on the parts of Non-Hybrids.  He response below solidifies the balance he wants other classes to have with pure melee.</div>
<p class='newspost'>Click <a class='newspost' href='viewarticle.asp?Article=204'><b>here</b></a> for details.</p>  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 10:05 AM</p>
					 </td>
			</tr>
			<tr>
			  <td height='32' width='100%'>
  ...
  <td valign='top' width='100%'>
      ...
      <tr>
        <td height='23' width='100%'>
                        <table cellpadding='3' cellspacing='0' border='0' width='100%'>
                          <tr>
								<td vAlign='ABSMIDDLE' align='left' width='100%' bgcolor='#000000' class='header'><img border='0' src='./images/cricon.gif' ALIGN='ABSMIDDLE'> Friday May 10, 2002</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    <td class='newspost' width='100%'><br><p class='newspostheader'><b>HOLY STEED AND OTHER HORSES</b></P>
<div class='newspost'>  Just for those who are questioning, there is no bug. The animation speed has been decreased to the point it looks slow but is actually the same speed as before.</div>
  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 4:14 PM</p>
					 </td>
			</tr>
			<tr>
			  <td height='32' width='100%'>
  ...
  <td valign='top' width='100%'>
      ...
      <tr>
        <td height='23' width='100%'>
                        <table cellpadding='3' cellspacing='0' border='0' width='100%'>
                          <tr>
								<td vAlign='ABSMIDDLE' align='left' width='100%' bgcolor='#000000' class='header'><img border='0' src='./images/cricon.gif' ALIGN='ABSMIDDLE'> Thursday May 9, 2002</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    <td class='newspost' width='100%'><br><p class='newspostheader'><b>PATCH RANTS</b></P>
<div class='newspost'>  Lets see where to start...

<p>Holyforge now critting on non-Undead...who knows
<p>Yaulp IV no longer stacks with Speed of Shissar or Augment...whether this is a mistake or intentional, who knows.

<p> There is an emergency patch tomorrow and hopefully these will be taken care of!</div>
  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 12:55 AM</p>
					 </td>
			</tr>
			<tr>
			  <td height='32'>
