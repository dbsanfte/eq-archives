...
<table border='0' width='75%' cellspacing='0' cellpadding='5' height='613'>
  <tr>
    <td width='100%' bgcolor='black' class='sbti2' colspan='2' height='21'>
      <p align='center'><span class='header'>Item and Armour Explanations</span></td>
  </tr>
  <tr>
    <td width='100%' colspan='2' height='249'>We have attempted to provide a
      ...
      of the site:
      <p><span class='spti'>Popular Searches</span></p>
      ...
      <p><span class='spti'>General Searches</span></p>
      ...
      <p><span class='spti'>Terminology</span></td>
  </tr>
  <tr>
    <td width='19%' valign='top' height='40'><b>Rarity:</b></td>
    <td width='81%' valign='top' height='40'>How rare the item
  ...
  <tr>
    <td width='19%' valign='top' height='20'><b>Damage/Delay Ratio:</b></td>
    <td width='81%' valign='top' height='20'>This is the basic damage
      of the weapon divided by its delay.&nbsp; It is the roughest indicator of
      weapon performance.</td>
  </tr>
  <tr>
    <td width='19%' valign='top' height='40'><b>Actual Attack Speed:</b></td>
    <td width='81%' valign='top' height='40'>If an item has inherent
  ...
  <tr>
    <td width='19%' valign='top' height='21'><b>Max Attack Speed:</b></td>
    <td width='81%' valign='top' height='21'>The lowest possible
      delay that can be obtained with this weapon at the haste cap limit.</td>
  </tr>
  <tr>
    <td width='19%' valign='top' height='40'><b>Max Damage:</b></td>
    <td width='81%' valign='top' height='40'>This reflects a formula
      which approximates the maximum damage which could be done by a level 60
      with 250 skill in the weapon and 255 strength. </td>
  </tr>
  <tr>
    <td width='19%' valign='top' height='40'><b>Performance Score:</b></td>
  ...
  <tr>
    <td width='19%' valign='top' height='40'><b>Proc Level:</b></td>
    <td width='81%' height='21' valign='top'>If a weapon or item has a special procedure
