  ...
  <td valign='top' width='100%'>
      ...
      <tr>
        <td height='23' width='100%'>
                    ...
                    <tr>
                    <td class='newsbody' width='100%'><br><p class='newspostheader'><b>HORSE MEDITATION GONE...DURING COMBAT ONLY</b></P>
  ...
  <td valign='top' width='100%'>
      ...
      <tr>
        <td height='23' width='100%'>
                        <table cellpadding='3' cellspacing='0' border='0' width='100%'>
                          <tr>
								<td vAlign='ABSMIDDLE' align='left' width='100%' bgcolor='#000000' class='header'><img border='0' src='./images/cricon.gif' ALIGN='ABSMIDDLE'> Monday December 17, 2001</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    <td class='newspost' width='100%'><br><p class='newspostheader'><b>SOL QUEST LISTS</b></P>
<div class='newspost'>  I'm working hard compiling a SoL Quest List for Paladins.  Will be finished by Christmas (hopefully).</div>
  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 12:55 AM</p>
<p class='newspostheader'><b>SOL DROPPED SPELLS</b></P>
<div class='newspost'>  Here is a list of places I've seen our spells dropped (as of 12-17)</p>
<body>

<ul>
  <li>Thunder of Karana -- Fungus Grove</li>
  <li>Quelious'sWord of Tranquility -- Maiden's Eye</li>
  <li>Breath of Tunare -- Ankheva Ruins</li>
  <li>Healing Wave of Prexus -- Ssra's Temple</li>
  <li>Remove Greater Curse -- ????</li>
  <li>Brell's Mountainous Barrier -- ????</li>
</ul>

</body>

</div>
  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 12:53 AM</p>
					 </td>
			</tr>
			<tr>
			  <td height='32' width='100%'>
  ...
  <td valign='top' width='100%'>
      ...
      <tr>
        <td height='23' width='100%'>
                        <table cellpadding='3' cellspacing='0' border='0' width='100%'>
                          <tr>
								<td vAlign='ABSMIDDLE' align='left' width='100%' bgcolor='#000000' class='header'><img border='0' src='./images/cricon.gif' ALIGN='ABSMIDDLE'> Wednesday December 12, 2001</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                    <td class='newspost' width='100%'><br><p class='newspostheader'><b>SPELL INFO UPDATE</b></P>
<div class='newspost'>  We at Castersrealm are fervently working on fully upgrading our spell databases, please be patient. Thanks.</div>
  <p class='newssig'>- Submitted by <a class='newssig' href='mailto:gloyn@castersrealm.com'><b>Gloyn</b></a>, 3:36 AM</p>
					 </td>
			</tr>
			<tr>
			  <td height='32'>
