										...
										<tr>
											<td width="100%" valign="top">					
												...
												<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													...
													<form action=default.asp method=get><table align='center' cellpadding=5 width='85%'>  <tr><td bgcolor='black' class='header' colspan=2 width='100%'>PALADIN STRATEGIES AND PLAYGUIDES</td></tr>  <tr><td  colspan=2>&nbsp;</td></tr>  <tr><td  colspan=2>Please select a class</td></tr>  <tr><td >Class: </td><td ><select name=Class><option value='Bard'>Bard</option><option value='Beastlord'>Beastlord</option><option value='Cleric'>Cleric</option><option value='Druid'>Druid</option><option value='Enchanter'>Enchanter</option><option value='Magician'>Magician</option><option value='Monk'>Monk</option><option value='Necromancer'>Necromancer</option><option value='Paladin'>Paladin</option><option value='Ranger'>Ranger</option><option value='Rogue'>Rogue</option><option value='Shadowknight'>Shadowknight</option><option value='Shaman'>Shaman</option><option value='Warrior'>Warrior</option><option value='Wizard'>Wizard</option></select></td></tr>  <tr><td  colspan=2 align=left><input type=submit value='Continue'></td></tr>
</table></form>
