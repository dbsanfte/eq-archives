    ...
    <body>
        <div class="container">
            ...
            <section class="contact-info">
                If you are the owner of this website, please contact your hosting provider: <a href="mailto:webmaster@eq.stratics.com">webmaster@eq.stratics.com</a>
            </section>
        ...
        <footer>
            <div class="container">
                <a href="http://www.cpanel.net" target="cpanel" title="cPanel, Inc.">
                    ...
                    <div class="copyright">Copyright © 2014 cPanel, Inc.</div>
                </a>
            </div>
        </footer>
    </body>
