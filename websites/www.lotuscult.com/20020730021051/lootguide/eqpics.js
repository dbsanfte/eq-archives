function writepic(item_name,magic,lore,nodrop,slot,dmg,delay,skill,dmgbonus,ac,str,dex,sta,cha,wis,int_,agi,hp,mana,svfire,svdis,svcold,svmagic,svpois,weight,range,size,classlist,racelist,effect,reclevel,specmods,bardskill) {
