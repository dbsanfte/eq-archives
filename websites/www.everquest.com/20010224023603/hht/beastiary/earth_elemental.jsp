...
<!-- #EndEditable --></td>
    ...
    <td valign="top"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top">
          <td> 
            <p align="center"><font size="+2"><font face="Arial, Helvetica, sans-serif" color="#FF9900"><font face="Georgia, Times New Roman, Times, serif" class="header">Earth 
              Elementals&nbsp;&nbsp; </font></font></font></p>
            <p><font face="Arial, Helvetica, sans-serif">Earth Elementals are 
              powerful creatures comprised of earth and stone. They attack with 
              their fists, doing considerable damage to anything they happen to 
              bludgeon. </font></p>
            <p>&nbsp;</p>
            <p><font face="Arial, Helvetica, sans-serif" size="-1"> </font></p>
          </td>
          <td width="7">&nbsp;</td>
          <td width="167"><img src="images/b_earth_elemental.gif" border="0" width="167" height="254"> 
          </td>
