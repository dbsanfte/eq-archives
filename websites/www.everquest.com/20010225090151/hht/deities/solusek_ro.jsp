      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" --> 
            <div align="center" class="header"><b><font face="Georgia, Times New Roman, Times, serif" color="#FF9900" size="4"><span class="header">Solusek 
              Ro</span></font></b> 
              <table width="100%">
                <tr> 
                  <td> 
                    <p align="right"><font size="+2"><font face="Arial, Helvetica, sans-serif" color="#FF9900"><font face="Georgia, Times New Roman, Times, serif" class="subHeader">The 
                      Burning Prince</font><i><font face="Georgia, Times New Roman, Times, serif" class="subHeader"> 
                      </font></i></font></font></p>
                    <p><font face="Arial, Helvetica, sans-serif" size="-1">The 
                      Followers of Solusek Ro belive in the raw and unbridled 
                      power of fire. Fire birthed the world and in fire shall 
                      it be consumed. True aggressive action is the only way for 
                      one to obtain what is desired. Power is gained by superior 
                      force. Followers of Ro have little fear. They are bold and 
                      brash, and say what they mean, and do what they say. Social 
                      graces are something they neither possess nor desire. They 
                      demand the respect of their peers and more often than not, 
                      earn it as well. Those who seek true elemental power follow 
                      Solusek Ro, and thus many wizards turn to his burning embrace. 
                      </font></p>
                    <p>&nbsp; 
                    <p>&nbsp; 
                  </td>
                  <td>&nbsp;</td>
                  <td width="164"> <img src="images/d_solusek_ro.gif" border="0" width="167" height="254"> 
                  </td>
                </tr>
              </table>
            </div>
