...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">36456 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" -->
            <div align="center"><span class="header">In Development </span> </div>
            <p>&nbsp;</p>
            <p><font size="-2">3/22/2001</font><br>
              Looks like last week's patch made the last &quot;In Development&quot; obsolete.  Here's what we're working on for the future:</p>
            <ul>
              <li> <b>Server-side chat and combat filters:</b>  At some point, players will be able to choose to have messages filtered server-side.  Alan &quot;Absor&quot; VanCouvering will be explaining what this means to a greater degree on the EverQuest Message boards in the near future.<br>
                <br>
              </li>
              <li> <b>Evaluation of High Level Epic Encounters on Hold:  </b>We're holding off any re-evaluation of high level epic encounters in Velious until after integration of server-side filtering.  This is due to the potential effect of the change, as it may raise the soft-cap on the number of people you can bring on a raid.  Before, it was widely held to be true that bringing more than 30 or 40 people would result in many linkdeaths.  Following the change, the next out-of-game softcap is the ability to maintain framerate.  We are not opposed to the idea of having encounters that take over 100 people to overcome, we just want to be sure that if that's what's necessary, the technology supports it.<br>
                <br>
              </li>
              <li><b>Loot rules in the Warrens:</b>  We plan to continue modifying the special loot rules in the Warrens.  We will be eliminating several ways around the current &quot;Trivial Combat Code&quot; as well as looking at the problem of &quot;spell twinking&quot; in regards to the loot rules.  We'll have to see how it goes, and see what people think.<br>
                <br>
              </li>
              <li> <b>Stonebrunt Mountains:</b>  The next &quot;free&quot; zone will be the Stonebrunt Mountains, which will be located off the Warrens.  It will support a level range roughly equivalent to that in Lake of Ill Omen. We're expecting to release the zone sometime this summer.<br>
                <br>
              </li>
              <li> <b>Dungeon Touchups/Revamps:</b>  We have plans for some updates and/or revamps for some of the dungeons in the world.  Stay tuned for more specific information as it is released.<br>
                <br>
              </li>
              <li> <b>Big Changes Planned for PvP:</b>  We've had a number of meetings lately to plan changes to the PvP environments in EverQuest.  We'll probably begin releasing our plans in the next week or so.<br>
                <br>
                  </li>
              <li> <b>Continued UI Enhancements:</b>  A number of things are planned, from allowing people the ability to buy stacks of items at one time, to improving the way things look on the screen.<br>
                <br>
              </li>
              <li> <b>3D Engine Enhancements:</b>  One of the first things up is the enhancement of the engine to support 32bit color with a 24bit z-buffer.  This will get rid of the &quot;moving stair step&quot; visual artifact that you see in distant places where surfaces meet at odd angles.  For the best explanation of this, look at the blockiness of the river in the Great Divide or the lava river in Skyfire, and finally look at the emblem at the entrance to Veeshan's Peak while moving off at a distance.  For those with video cards that support a 24bit z-buffer, appearance will be greatly improved.<br>
                <br>
              </li>
              <li> <b>Deity Specific Quests:  </b>We're going to continue expanding on some deity-specific quests that went into game several months ago.  We like the idea of these and have more in the works.<br>
                <br>
              </li>
              <li><b>The History Unfolds:  </b>Keep an eye on the Harpy's Head Tavern site.  As dynamic events take place across all of the servers, more information about the history and the future of the world will be made known. </li>
            </ul>
            <p><br>
              We'll fire off more updates as we have information available for release.  Until then, enjoy EQ!</p>
