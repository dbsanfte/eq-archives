...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">71843 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_shaman.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p><font face="Arial, Helvetica, sans-serif" color="#FF9900" size="+2"><font face="Georgia, Times New Roman, Times, serif"> 
                                <span class="header">Shaman</span></font></font> 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                They are similar to the Cleric, but are more of 
                                a tribal witch doctor and are typically found 
                                amongst the more primitve races. Their primary 
                                focus is largely healing and other Clerical type 
                                spells, but they also have a good deal of offensive 
                                spells.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
