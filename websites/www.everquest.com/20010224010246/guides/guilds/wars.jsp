              ...
              <center>
                <center>
                  <center>
                    <center>
                      <center>
                        <p class="header"><font size="4" face="Georgia, Times New Roman, Times, serif" color="#FF9900" class="header">Guild 
                          Wars</font> </p>
                        <p align="justify"><font face="Arial, Helvetica, sans-serif" size="3">Conflict 
                          may arise between guilds from time to time. When this 
                          occurs, guild leaders may decide to declare war between 
                          their guilds. If both leaders agree, they can open hostilities 
                          by using the <font color="#FFFFFF"><b class="subHeader">/guildwar</b></font> 
                          command.</font></p>
                        <p align="justify"><font face="Arial, Helvetica, sans-serif" size="3">&#9;Guild 
                          wars may vary in duration from the default of 1 day 
                          to a maximum of 14 days. During this period of time 
                          members from either guild may cause harm to each other 
                          regardless of their adherence to the tenants of Order 
                          or Discord.</font></p>
                        <p align="justify"><font face="Arial, Helvetica, sans-serif" size="3">&#9;If 
                          the forces in conflict decide that peace would be a 
                          better option before the war has run its course an early 
                          end to the war may be declared. In order to accomplish 
                          this, both guild layers must issue the <font color="#FFFFFF"><b class="subHeader">/guildpeace</b></font> 
                          command.</font></p>
          </center>
                    </center>
                    </center>
