...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">66713 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
                    ...
                    <center>
                      <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          ...
                          1, 2001 - Thursday</p>
                            <p>As we approach the two-year anniversary of EverQuest, we can’t help but look back at the changes that have taken place in the world of Norrath.  In the beginning our Customer Service Department was small and the rules both we and the players were expected to follow were still being hammered out on a day-to-day basis.  We then grew quickly; as did our expectations, and as time went on we developed and refined a number of rules providing varying levels of communication between us and the player community.  Now, as we move into the third year of our lives in Norrath, we plan to focus strongly on this aspect of communication and dialogue. Henceforth, we will strive to even better communicate our Customer Service policies to the player community at large.</p>
                            <p>For some time now we’ve had a large Customer Service Department responsible for paying close attention to the requests, wishes and yes, even complaints, of our customers.  We constantly discuss ways to accommodate those needs in the most equitable of methods we can devise. Our main intention, as always, is to provide the best response we can to the largest number of people without upsetting the balance of the game. This can, of course, be a difficult endeavor.</p>
                            <p>In response to many emails and petitions we receive, our team has been working hard on developing new comprehensive policies and lists of frequently asked questions (FAQ’s) which we believe will better inform our player community about Customer Service in general. Our emphasis will be to make sure we have the best possible communication with you, our player community. To that end, we’ve started work on a player’s &quot;Bill of Rights&quot; which will hopefully communicate what to expect and what not to expect from our Customer Service personnel.  And we want to assure you we’ll do everything in our power to act consistently within those policies. </p>
                            <p>Communication will be the key and, naturally, it’s a two way street. Your concerns have been voiced to us, and we are responding. As you read this, several policies are in the process of being refined.  Within the coming weeks, we will be posting several new policy FAQ’s at <a href="http://www.everquest.com/support/index.jsp">http://www.everquest.com/support/index.jsp</a>. Our goal is to make it perfectly clear not only what we expect from you as player-citizens of Norrath, but also what you can count on from us here at Verant/SOE. </p>
                            <p>Our first step in response to players’ concerns was posted recently.  Our new and updated Naming Policy (<a href="http://www.everquest.com/support/naming.jsp">http://www.everquest.com/support/naming.jsp</a>) should hopefully be clearer, more consistent, and bring us even closer to a healthy role-playing environment. Subsequently, we will be conducting a thorough review of all current character names on all servers, including surnames and guild names. Names not necessarily in line with the updated Naming Policy will be evaluated and handled accordingly.   </p>
                            <p>Meanwhile, I’d like to take this opportunity to thank all of you for your continued feedback and support of our game.  Please let us know if we’re improving – we can’t do this without you.</p>
                            <p>Thanks very much,</p>
                            <p>George M. Scotto</p>
                            <p>Director, Customer Service</p>
                            <p>Sony Online Entertainment Inc.</p>
                            <p>&nbsp;</p><table width="95%" cellpadding="0" border="0" cellspacing="0" align="center">
                              <tr> 
                                <td width="1" valign="top"><b class="subHeader"><img src="/images/newsbanner_l_stone1.gif" width="79" height="35"></b></td>
                                <td width=100% background="/images/newsbanner_stone1_bkgd.gif">&nbsp;</td>
                                <td width="1" valign="top"><img src="/images/newsbanner_r_stone1.gif" width="79" height="35"></td>
