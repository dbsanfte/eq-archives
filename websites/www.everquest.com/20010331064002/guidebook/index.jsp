          ...
          <td><!-- #BeginEditable "body" --> 
            <div align="center">
              <center>
                <center>
                  <center>
                    <b class="header">The Guidebook</b> 
                  </center>
                  <br>
                  <table border="0" width="85%" cellspacing="0" cellpadding="0" align="center">
                    <tr> 
                      <td>Here you will find a vast amount of information that will help you become more familiar with the world of EverQuest.
                        <p align="justify"><b><a href="manual.jsp">Manual</a></b> - Manuals for the original EverQuest game, as well as the manuals for the two expansions, in Adobe Acrobat format.  Manual supplements are contained here as well.</p>
                        <p align="justify"><a href="races.jsp">Races</a> - A brief description of each of Norrath's 13 races.</p>
                        <p align="justify"><a href="classes.jsp">Classes</a> - A brief description of each of the 14 playable professions in Norrath.</p>
                        <p align="justify"><a href="skills.jsp">Skills</a> - Explanations of some of the skills that can be learned and perfected in game.</p>
                        <p align="justify"><a href="equipment.jsp">Equipment</a> - A general reference of Norrathian armor and weaponry, along with representative inventory icons to help you get a better idea of what's available.</p>
                        <p align="justify"><a href="atlas/index.jsp">Atlas</a> - A general overview of the five continents of Norrath as well as a few of the major cities.</p>
                        </td>
                    </tr>
                  </table>
                  <p align="center"><img src="images/characters.jpg" width="444"
    height="167" alt="Player Characters"> </p>
                </center>
                </center>
              </div>
            <!-- #EndEditable --></td>
