...
<p align="justify">Selection of a Deity is done during the creation of a character. 
It is not required to pick a Deity, unless the character is of a religious profession 
(Cleric, Shaman, etc). The choice of a Deity is an important one, as the character 
will have this Deity for the full of it's life, and that Deity brings with it 
certain faction assumptions. For example, choosing Innoruuk, the Prince of Hate, 
will most certainly not make your character popular around the temple Rodcet Nife, 
the Prime Healer. And, being human and choosing Innoruuk will not necessarily 
make you welcome in Neriak, the home of the Dark Elves. 
<p align="justify"> For further research, select from the list of Deities. 
</center>
                    </center>
                    </center>
                  </center>
