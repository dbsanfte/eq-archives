...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">41623 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<table width="130" border="0" cellspacing="0" cellpadding="0" background="">
  <tr> 
    <td width="130" valign="top" align="right" class="menu"> 
      ...
      <b class="menuHeader"><a href="http://station.sony.com/velious/">The Scars 
      of Velious</a></b><br>
      <b class="menuHeader"><a href="/hht/index.jsp">Harpy's Head Tavern</a></b><br>
      <b class="menuHeader"><a href="http://www.station.sony.com/fanfaire">Fan 
      Faire</a></b><br>
      ...
      <a href="http://www.station.sony.com/store/" target="_top">Buy EverQuest 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" -->
            ...
            <p>From the desk of the EQ Live team…</p>
            <ul>
              <li><b>New Melee Bind Points</b>: We have added some new melee bindable 
                areas that act as little cities for the purpose of the Bind Affinity 
                Spell. There is an NPC to indicate this new area. The new bind 
                points have been placed in North Karana, Field of Bone, and Frontier 
                Mountains.</li>
              <li><b>Fear and Hate Planes upgrades: </b>Both the Plane of Hate 
                and the Plane of Fear are being revamped for higher levels. They 
                are both going from level 46-50 PC reward and difficulty to level 
                46-60 PC reward and difficulty. Both gods Cazic Thule and Innoruuk 
                are being increased to level 60 PC difficulty and their loot tables 
                are being changed to match this increase. Their old loot can still 
                be found on other mobs in both the planes who are equal in difficulty 
                to the current incarnation of Cazic and Innoruuk. In addition, 
                many new items, including much awaited Iksar planar armor, are 
                being added to both these zones.</li>
              <li><b>Epic Weapon Quest Changes: </b>Quite a few of the Epic Weapon 
                quests are being modified to ease the dissention caused by some 
                of their quest components dropping off spawns which are desirable 
                to many others not involved in the quest. The classes whose Epic 
                Quests are being modified are Warrior, Ranger, Druid, Shadowknight, 
                Bard, Necromancer, Magician, Wizard, and Enchanter.</li>
              <li><b>New Free Download Zone, The Warrens: </b>A new dungeon on 
                the Continent of Odus named The Warrens is now in its final testing 
                stage on Test Server. This kobold lair is a level 2-25 dungeon 
                similar in style to the famed Blackburrow.</li>
              <li><b>Bane Spells: </b>New spells are in development that will 
                allow wizards to effectively fight some of the extremely high 
                level encounters in Velious. Quests will be implemented to obtain 
                these spells.</li>
              <li><b>Additional Velious Quests:</b> New quests are being added 
                in the Velious zones to further draw players into the political 
                struggle of the continent.<font face="Arial"></font> 
                <center>
                  <p>&nbsp;</p>
                </center>
              </li>
