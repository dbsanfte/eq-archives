              ...
              <center>
                <center>
                  <center>
                    <center>
                      <center>
                        <p class="header" align="center"><font size="4" face="Georgia, Times New Roman, Times, serif" color="#FF9900" class="header">Creating 
                          Guilds</font> </p>
                        <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">If 
                          you decide that none of the existing guilds are quite 
                          what you are looking for, you may found your own guild. 
                          In order to establish your guild you must have an acceptable 
                          name, charter, and a membership of 10 players who wish 
                          to form this guild. </font></p>
                        <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">The 
                          following process needs to be followed to gain approval 
                          for you guild:</font></p>

                        <ol>
                          <ol>
                            <li>
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">The 
                                person who is to be the leader of the guild must 
                                enter the chat server and issue the <b class="subHeader">#makeguild</b> 
                                command. This will create a private guild channel. 
                                The name of the guild should be used as the name 
                                of the channel, although this name can be edited 
                                later during the creation process.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">Once 
                                the channel has been created, the guild leader 
                                needs to invite the members of his guild into 
                                the channel. To do this he needs to tell the guild 
                                members the name of the channel and the password 
                                for access.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">Once 
                                a total of 10 members are in the channel and have 
                                issued the <b class="subHeader">#guildapprove</b> 
                                command, the guild leader can then issue the <b class="subHeader">#makeguild</b> 
                                command. This will move the guild leader to the 
                                guild creation screen. </font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">In 
                                the guild creation screen, the guild leader needs 
                                to enter a summary of the guild’s charter. This 
                                summary should focus on the guild’s role in Norrath 
                                and the goals it will pursue. Details of the internal 
                                working of your guild need not be included. You 
                                may also edit your guild’s name in this screen. 
                                Once completed, hit FINISH and the guild will 
                                be submitted for approval.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">The 
                                leader of the guild may check the status of the 
                                guild by activating the GUILDS button from chat. 
                                If the status of the guild indicates a need for 
                                revision, the guild leader should select his guild 
                                and hit the EDIT button. Comments regarding the 
                                nature of the needed revision appear at the bottom 
                                of the guild creation screen. The guild leader 
                                can edit the charter and the guild name as needed 
                                and hit the FINISH button to resubmit the guild 
                                for approval. IMPORTANT: If the leader is only 
                                viewing the revisions needed, hit CANCEL to exit 
                                this screen. If the leader hits FINISH the guild 
                                will be resubmitted for approval and the leader 
                                will be unable to re-enter the guild creation/edit 
                                screen.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">Once 
                                the name and charter have been approved, the guild 
                                leader will be notified via email that the guild 
                                is ready to be created. Please verify that your 
                                email is correct in our files by going to account:change 
                                account:edit registration from the login screen.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">Once 
                                the verification email that the guild has been 
                                approved has been received, it is the responsibility 
                                of the Guild Creator to petition in game to have 
                                the guild created and the necessary 9 other members 
                                online and in the same area as the Guild Creator.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">For 
                                fastest service, try to petition between 2PM and 
                                10PM PST. If this is not possible, you may either 
                                petition and allow a Guide to assist you further 
                                or locate and request the assistance of the Chat 
                                GM.</font></p>
                            </li>
                            <li> 
                              <p align="justify"><font size="2" face="Arial, Helvetica, sans-serif">If 
                                neither the Chat GM is available, nor a Guide 
                                online, please email <a href="mailto:eqguilds@station.sony.com">EQGuilds@station.sony.com</a> 
                                and we will arrange time to have your guild created. 
                                Note that the 10-member requirement is not only 
                                to have your guild created, but to maintain it 
                                as well. Guilds that fall under 10 members are 
                                subject to removal during our monthly guild checks. 
                                Note also that the term '10 members' means 10 
                                different accounts, not 5 characters on 2 accounts.</font></p>
                            </li>
                          </ol>
                        </ol>
                        </center>
