...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">64795 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<p align="justify">The Iksar have an interesting and unique variation of classes available to them due to their unique history and circumstances. Being currently in a tribal setting limits their general mystic abilities to being shamans, yet the fallen Iksar Empire's rich history and knowledge of necromancy also allows them to choose the path of the necromancer or shadowknight. It also offers them a special opportunity until now limited only to the human race, and that is the ability to become monks. Their unique reptilian body type gives Iksar monks special, magically enhanced attacks.</p>
