...
<!-- #EndEditable --></td>
    ...
    <td valign="top"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top">
          <td> 
            <p align="center"><font size="+2"><font face="Arial, Helvetica, sans-serif" color="#FF9900"><font face="Georgia, Times New Roman, Times, serif" class="header">Fire 
              Goblin&nbsp;&nbsp; </font></font></font></p>
            <p><font face="Arial, Helvetica, sans-serif">Fire Goblins are imp-ish 
              like creatures that inhabit underground regions. Their name comes 
              from the color of their skin -- they have no innate fire abilities, 
              but constant exposure to heat has made them almost immune to its 
              effects. </font></p>
            <p>&nbsp;</p>
            <p><font face="Arial, Helvetica, sans-serif" size="-1"> </font></p>
          </td>
          <td width="7">&nbsp;</td>
          <td width="167"><img src="images/b_fire_goblin.gif" border="0" width="167" height="254"> 
          </td>
