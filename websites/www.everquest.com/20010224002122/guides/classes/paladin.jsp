                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_paladin.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p><font face="Arial, Helvetica, sans-serif" color="#FF9900" size="+2"><font face="Georgia, Times New Roman, Times, serif"> 
                                <span class="header">Paladin</span></font></font> 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                Paladins are the very picture of a holy knight, 
                                fighting for the cause of good in all aspects 
                                of his life. They share some of the power of a 
                                Cleric, and a good deal of the fighting ability 
                                of a Warrior, but have a few powers all their 
                                own.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
