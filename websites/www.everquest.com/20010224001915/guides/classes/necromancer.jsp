                    ...
                    <center>
                      <center>
                        <table border="0" width="95%">
                          <tr> 
                            <td width="100" align="right"><img src="images/c_necromancer.gif" width="71" height="177"></td>
                            <td width="18">&nbsp;</td>
                            <td> 
                              <p><font face="Arial, Helvetica, sans-serif" color="#FF9900" size="+2"><font face="Georgia, Times New Roman, Times, serif"> 
                                <span class="header">Necromancer</span></font></font> 
                              <p><font face="Arial, Helvetica, sans-serif" size="-1"> 
                                These are the dark brotherhood of the arcane arts, 
                                dabbling in death. Through evil spiritually based 
                                spells, they are able to animate dead bodies and 
                                skeletons to do their bidding, as well as having 
                                spells which leach life from their victims.</font></p>
                            </td>
                            <td width="18">&nbsp;</td>
                          </tr>
                        </table>
