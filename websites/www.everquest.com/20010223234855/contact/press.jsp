...
<!-- End Sony Cross Nav -->
<div style="font-size: 8pt; color: #ffffff">68563 Players Online</div>
				  </td>
			  </tr>
			</table>
		  </td>
...
<td> 
<center>
<b class="header">Press Relations</b> 
</center>
<br>
            <table border="0" width="95%">
              ...
              <tr> 
                <td> 
                  <div align="center"><a href="http://www.verant.com" target="_blank"><img src="images/verant_small.gif" width="110" height="109" border="0"></a></div>
                </td>
                <td> 
                  <p><font face="Arial, Helvetica, sans-serif" size="2">We're 
                    here to help you. For technical issues dealing with EverQuest,<br>
                    please use one of the easy-to-use <a href="Javascript:onClick=open_servwin('http://www.station.sony.com/services/help.jhtml')">technical 
                    support forms</a>.</font></p>
                </td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td> 
                  <center>
                    <font size="4"><!-- CONTENT SECTION ENDS HERE --> </font> 
                  </center>
                  <p align="center"><font color="#FF9900" face="Arial, Helvetica, sans-serif" size="4"><a href=Javascript:onClick=open_servwin('http://www.station.sony.com/services/help.jhtml')><b>Technical 
                    <br>
                    Support</b></a></font><font face="Arial, Helvetica, sans-serif" size="2"><br>
                    </font></p>
                </td>
                <td><font face="Arial, Helvetica, sans-serif" size="2"><br>
                  Other questions or comments should be sent to <a href="mailto:eqmail@verant.com">eqmail@verant.com</a>.</font></td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
