        ...
        <tr valign="top"> 
          <td><!-- #BeginEditable "body" --> 
            <center>
              ...
              New Continent Discovered! </span> 
              <p>&nbsp;</p>
              <p align="left" class="subHeader">Day 1
              <P align="left"><a href="javascript:openWindow('screenshots/2.html', '600')"><img src="images/image2_lo.jpg" width="271" height="280" align="left" hspace="8" border="0"></a>We 
                have received recent reports from Ak`Anon that a new continent 
                has been discoveredNew marine technology recently developed by 
                the gnomes enabled the Ak`Anon Marines to break through the Frigid 
                Barrier to the south of Odus and in doing so, they discovered 
                lands previously unknown.<br clear=all>
              </p>
              <P align="left">A remarkable marine craft created by the gnomish 
                inventors is capable of actually breaking through thick ice, enabling 
                them to reach new waters, dubbed the &quot;Iceclad Ocean&quot;. 
                The ship has been named &quot;Icebreaker&quot; by its inventors, 
                for obvious reasons.<br clear=all>
              </p>
              <P align="left">The islands first encountered by the gnomes have 
                been christened &quot;The Icy Fingers&quot; due to their shape 
                and climate. The gnomes who discovered the continent explored 
                these islands making various camps, many of which still remain 
                and serve as outposts.<br clear=all>
                <a href="javascript:openWindow('screenshots/1.html', '775')"><img src="images/image1_lo.jpg" width="280" height="210" align="right" hspace="8" border="0"></a> 
              </p>
              <P align="left">Geologists and historians theorize that these are 
                the lands first populated by dragonkind in the earliest days of 
                Norrath’s existence. Mages levitating over the continent report 
                that the scars of the great crystalline dragon Veeshan can be 
                seen on this continent, and preliminary archaeological reports 
                indicate that it was also here that the first dragons were hatched 
                and where they dwelled.<br clear=all>
              </p>
              <P align="left">The great body of water known as the Iceclad Ocean 
                is filled with dangerous icebergs and monsters of the deep. The 
                ingenious design of The Icebreakerenabled it to cut its way through 
                the many icebergs to the the first island in a group called the 
                Icy Fingers. There, they discovered what seems to be the only 
                dock in the entire Iceclad Ocean.<br clear=all>
              </p>
              <P align="left"><a href="javascript:openWindow('screenshots/9.html', '468')"><img src="images/image9_lo.jpg" width="180" height="280" align="left" hspace="8" border="0"></a>The 
                first Icy Finger is the smallest of the islands, where the intrepid 
                group of explorers discovered a small band of gnomish pirates 
                plying their trade on the northern side of the island. To travel 
                from the first icy finger to the second, the band of adventurers 
                found it necessary to travel from ice floe to ice floe, risking 
                the perilously cold waters.<br clear=all>
              </p>
              <P align="left">The second Icy Finger was found to be larger than 
                the first, and on its outer edges, groups of snow gnolls live 
                out their meager existence in small fishing villages. While exploring 
                a small forest of pine trees, they discovered a formidable edifice 
                apparently named the <B>Tower of Frozen Shadow</B>. The mysterious 
                structure has no visible means of entrance, and seems to have 
                been constructed solely of shadow and ice.<br clear=all>
              </p>
              <P align="left">Not much is yet known about the original builders 
                of the Tower, but the Icebreaker’s crew reports that the building 
                is approximately seven stories tall and that the entire structure 
                is believed to be filled with fearsome, unearthly beings.<br clear=all>
              </p>
              <P align="left">&nbsp;</P>
              <P align="center"><a href="2nd.jsp">Next</a></P>
            </center>
            <!-- #EndEditable --></td>
        </tr>
      </table>
