          ...
          <td><!-- #BeginEditable "body" --> 
            <center>
              <center>
                ...
                <p>&nbsp;</p>
                <p><span class="header">Minimum System Requirements: </span> </p>
                <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
                  <tr> 
                    <td> 
                      <ul>
                        <li>Windows&reg; 95/98 or Windows&reg; 2000</li>
                        <li>Pentium 200 (Note older Model Cyrix processors WILL 
                          NOT WORK with EverQuest.) </li>
                        <li>64 megabytes RAM </li>
                        <li>28.8 Internet connection</li>
                        <li>Direct3D or Glide compliant accelerator card w/ 8MB 
                          RAM </li>
                        <li>600 MB+ hard drive space</li>
                        <li>DirectX 7.0a compatible sound card </li>
                        <li>Microsoft compatible mouse </li>
                        <li>2x CD-ROM drive</li>
                        <li>
                          <div align="justify">A valid credit card for the monthly 
                            access fee</div>
                        </li>
                      </ul>
      </td>
                ...
                <p></p>
                <p><span class="header">Recommended System Requirements:</span> 
                </p>
                <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
                  <tr> 
                    <td> 
                      <ul>
                        <li>Windows&reg; 95/98 or Windows&reg; 2000</li>
                        <li>Pentium II 266/Pentium II 350 or greater for Scars 
                          of Velious </li>
                        <li>128 megabytes RAM </li>
                        <li>28.8 Internet connection</li>
                        <li>Direct3D or Glide compliant videocard w/ 16MB RAM</li>
                        <li>600 MB+ hard drive space</li>
                        <li>DirectX 7.0a compatible sound card</li>
                        <li>Microsoft compatible mouse </li>
