...
<td valign="top" align="left"><a href="index.php?s=9121037282f8a915aabdd4ef8f6481d1"><img src="images/shamanlogo.gif" border="0"></a></td>
<td valign="bottom" align="right">
<br>

<!-- toplinks -->
<A HREF="usercp.php?s=9121037282f8a915aabdd4ef8f6481d1"><img width="67" height="25" src="images/top_profile.gif" alt="Edit your profile" border=0></A><A HREF="register.php?s=9121037282f8a915aabdd4ef8f6481d1&action=signup"><img width="67" height="25" src="images/top_register.gif" alt="Registration is free!" border=0></A><A HREF="calendar.php?s=9121037282f8a915aabdd4ef8f6481d1"><img width="67" height="25" src="images/top_calendar.gif" alt="Calendar" border=0></A><A HREF="memberlist.php?s=9121037282f8a915aabdd4ef8f6481d1"><img width="67" height="25" src="images/top_members.gif" alt="Find other members" border=0></A><br><A HREF="misc.php?s=9121037282f8a915aabdd4ef8f6481d1&action=faq"><img width="67" height="25" src="images/top_faq.gif" alt="Frequently Asked Questions" border=0></A><A HREF="search.php?s=9121037282f8a915aabdd4ef8f6481d1"><img width="67" height="25" src="images/top_search.gif" alt="Search" border=0></A><A HREF="index.php?s=9121037282f8a915aabdd4ef8f6481d1"><img width="67" height="25" src="images/top_home.gif" alt="Home" border=0></A><!--
<A HREF="member.php?s=9121037282f8a915aabdd4ef8f6481d1&action=clearcookies"><img width="67" height="25" src="images/top_logout.gif" alt="Logout" border=0></A>  -->
<!-- /toplinks --></td></tr>
</table>
<!-- /logo and buttons -->
...
<tr>
	<td bgcolor="#52527A" width="100%"><FONT face="arial, helvetica" size="2" color="#FFFFFF">No forum specified. If you followed a valid link, please notify the <a href="mailto:sunmoon@interealms.com">webmaster</a></font></td>
</tr>
</table>
</td></tr></table>
