...
<tr>
	<TD ALIGN=LEFT VALIGN="middle" BACKGROUND="images/topextender.gif">
		<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0><TR>
			<TD><img align=absmiddle name="topleft" src="images/topleft.gif" alt="eq.guildmagic.com - the free and easy guild management system" width="331" height="123" border="0" HSPACE=0 VSPACE=0></TD>
			<TD><!-- VC active -->
...
<NOSCRIPT>
<A HREF="http://kansas.valueclick.com/redirect?host=hs0200131&size=468x60&b=a180121&v=0" TARGET="_top"><IMG BORDER="0" WIDTH="468" HEIGHT="60" ALT="Click here to visit our sponsor"
SRC="http://kansas.valueclick.com/cycle?host=hs0200131&size=468x60&b=a180121&noscript=1"></A>
</NOSCRIPT>
<!-- vc active --></TD>
		</TR></TABLE>
</TD>
...
<tr>
	<TD ALIGN=LEFT>
		<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0>
			<TR>
				<td valign=top width="142" background="images/leftextender.gif"><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0>
<!-- Row 4 --><tr>
...
<!-- Row 6 --><tr>
<td height="26"><A HREF="faq.cfm"><img name="button4" src="images/button4.gif" alt="faq" width="142" height="26" border="0"></A></td>
</tr>

<!-- Row 7 --><tr>
<td height="26"><img name="button5" src="images/button5.gif" alt="eq.guildmagic.com - the free and easy guild management system" width="142" height="26" border="0"></td>
</tr>
...
<NOSCRIPT>
<A HREF="http://kansas.valueclick.com/redirect?host=hs0200131&size=120x60&b=b180121&v=0" TARGET="_top"><IMG BORDER="0" WIDTH="120" HEIGHT="60" ALT="Click here to visit our sponsor"
SRC="http://kansas.valueclick.com/cycle?host=hs0200131&size=120x60&b=b180121&noscript=1"></A>
</NOSCRIPT>
<!-- vc active -->
				</td>
...
<TR>
	<TD COLSPAN=2>
		Your username does <B>not</B> need to be the same as one of your everquest character names. Also do <B>not</B> choose the same username and password as your Everquest account. Once you have created your user then you can use it to create as many characters as you like.<P>
	</TD>
</TR>
