...
<HEAD>
<TITLE>EQrealms - Servers - Bristlebane</TITLE>
...
<TR><TD bgcolor="4a0000" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="#ffff80"><B>Bristlebane News</B></FONT> &nbsp; &nbsp; <FONT FACE="Verdana, Arial, Helvetica" SIZE="-2"><A class="b" HREF="submit_news.cfm?server_id=3">Submit News</a> - <A class="b" HREF="archive.cfm?server_id=3">Archives</a></font></TD></TR>
</TABLE>

		<TABLE width="100%" border="0" cellpadding="5" cellspacing="0">
		<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Thursday, May 25, 2000</B></FONT></TD></TR>
		...
		<BR>
			...
			<a name="115"></a>
			<FONT COLOR="4a0000"><B>Events needed!</B></FONT><BR>
			<TABLE border="0" cellpadding="2" cellspacing="1"><TR>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2"><a href="responses.cfm?id=115">Add Comment</A> (1)</font> &nbsp; &nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">General</font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Server: All</font>&nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Posted By: <A HREF="mailto:jimihaha2@hotmail.com">Wyen</A></font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">09:26 AM</font>&nbsp;</TD>
			</TR></TABLE>
			Hey everyone! I am really trying to get more events to post for the site, they can be any type of event, any server, any time, any where... you get the picture! Send them to <A HREF="mailto:info@eqrealms.com"> info@eqrealms.com </A> and help make your event get the attention it deserves! 
			<br><br>
		...
		<TABLE width="100%" border="0" cellpadding="5" cellspacing="0">
		<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Friday, May 12, 2000</B></FONT></TD></TR>
		<TR><TD bgcolor="#cdcd9c" valign="top">
		<FONT FACE="Arial, Verdana, Helvetica" size="-1">
		<BR>
			...
			<a name="80"></a>
			<FONT COLOR="4a0000"><B>Bristlebane Event</B></FONT><BR>
			<TABLE border="0" cellpadding="2" cellspacing="1"><TR>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2"><a href="responses.cfm?id=80">Add Comment</A> (0)</font> &nbsp; &nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Events</font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Server: Bristlebane</font>&nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Posted By: <A HREF="mailto:dlpierce@west.raytheon.com">Aweena</A></font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">04:03 PM</font>&nbsp;</TD>
			</TR></TABLE>
			On Sunday evening May 14th, around 7pm EST (thats 4pm PDT)  time, the allied guilds The Sisters of Mercy and The Servants of Honor of the Bristlebane Server will be manning two First Aid Tents! One will be just outside the entrance to Unrest, the second will be just inside of Crushbone. They will be available for healing, buffing, and to assist with corpse recovery. In Crushbone they will also help in the derailment of Trains and to help the unfortunate runner. In Unrest for those in their low to mid teens there will be groups forming to learn about Unrest and some of the grouping tactics which will be led by some of our more experienced members 
			<br><br>
		...
		<TABLE width="100%" border="0" cellpadding="5" cellspacing="0">
		<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Monday, May 1, 2000</B></FONT></TD></TR>
		<TR><TD bgcolor="#cdcd9c" valign="top">
		<FONT FACE="Arial, Verdana, Helvetica" size="-1">
		<BR>
			...
			<a name="39"></a>
			<FONT COLOR="4a0000"><B>Iksar quests</B></FONT><BR>
			<TABLE border="0" cellpadding="2" cellspacing="1"><TR>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2"><a href="responses.cfm?id=39">Add Comment</A> (8)</font> &nbsp; &nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Spoilers</font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Server: All</font>&nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Posted By: <A HREF="mailto:korie@eqrealms.com">Korie</A></font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">05:53 PM</font>&nbsp;</TD>
			</TR></TABLE>
			I've been adding a couple Iksar Warrior quests as I do them in the game. I know there are many, many more quests in Cabilis for all the classes, so don't be shy about emailing the details to us. The quest section is pretty scarce at the moment, so help is appreciated.  
			<br><br>
		...
		<TABLE width="100%" border="0" cellpadding="5" cellspacing="0">
		<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Thursday, April 27, 2000</B></FONT></TD></TR>
		<TR><TD bgcolor="#cdcd9c" valign="top">
		<FONT FACE="Arial, Verdana, Helvetica" size="-1">
		<BR>
			...
			<a name="15"></a>
			<FONT COLOR="4a0000"><B>Server Splits in Progress</B></FONT><BR>
			<TABLE border="0" cellpadding="2" cellspacing="1"><TR>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2"><a href="responses.cfm?id=15">Add Comment</A> (0)</font> &nbsp; &nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">General</font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Server: Multiple</font>&nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Posted By: <A HREF="mailto:dantes@eqrealms.com">Dantes</A></font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">11:47 PM</font>&nbsp;</TD>
			</TR></TABLE>
			Servers are being split right now, as promised, a new update was placed up just recently on the <a href="http://everquest.station.sony.com/downtime_fs.html">scheduled downtime</a> page to add 2 more hours to the downtime for those servers being split.  Click the article link to read the full downtime update. <a href="../article.cfm?id=15">Read More...</a>
			<br><br>
			...
			<a name="13"></a>
			<FONT COLOR="4a0000"><B>Thoughts on the Iksar</B></FONT><BR>
			<TABLE border="0" cellpadding="2" cellspacing="1"><TR>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2"><a href="responses.cfm?id=13">Add Comment</A> (4)</font> &nbsp; &nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Daily Rants</font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Server: Multiple</font>&nbsp;</TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">Posted By: <A HREF="mailto:korie@eqrealms.com">Korie</A></font> &nbsp; &nbsp; </TD>
			<TD bgcolor="#aaaaaa"><font face="Verdana, Arial, Helvetica" size="-2">03:19 PM</font>&nbsp;</TD>
			</TR></TABLE>
			Hi folks, first let me introduce myself. Most of the people in the EQ realm know me as Korie, bard of Norrath and Knight of Valorblade on the Brell Serilis server. Dantes suckered me into helping him with this website in return for letting me post my ramblings on a worldclass site such as this one. My first target.. er, topic, is the Iksar. Didn't see that coming, did you? Feel free to post comments and critiques, just promise to keep them clean and well thought out.  <a href="../article.cfm?id=13">Read More...</a>
			<br><br>
...
<TR><TD>
<IMG SRC="discussion.gif" WIDTH="150" HEIGHT="29" ALT="Discussion"><BR>
</TD></TR>
</TABLE>
<TABLE width="150" border="0" cellpadding="5" cellspacing="0">
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Verdana, Helvetica" size="-2">
<DIV align="center"><B><A HREF="http://216.240.130.13/forums/categories.cfm?catid=92&currentsiteid=22" target="_blank">Bristlebane Forums</A></B></DIV>
</font>
</TD></TR></TABLE>
<TABLE width="150" border="0" cellpadding="0" cellspacing="0">
<TR><TD>
...
<TABLE width="150" border="0" cellpadding="0" cellspacing="0">
<TR><TD>
<IMG SRC="links.gif" WIDTH="150" HEIGHT="29" ALT="Links"><BR>
</TD></TR>
</TABLE>
<TABLE width="150" border="0" cellpadding="5" cellspacing="0">
<TR><TD bgcolor="#cdcd9c">
...
<TABLE width="150" border="0" cellpadding="0" cellspacing="0">
<TR><TD>
<IMG SRC="guilds.gif" WIDTH="150" HEIGHT="29" ALT="Guilds"><BR>
</TD></TR>
</TABLE>
<TABLE width="150" border="0" cellpadding="5" cellspacing="0">
<TR><TD bgcolor="#cdcd9c">
