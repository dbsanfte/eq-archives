...
<HEAD>
<TITLE>EQrealms - Staff/Contacts</TITLE>
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="staff.gif" WIDTH="96" HEIGHT="44" ALT="Staff/Contacts"></TD>
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Contact EQrealms</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">

Below are three general email addresses you can use to contact the folks at EQrealms, also below in 
the staff section we'll have individual addresses listed for us.

<UL>
<LI><A HREF="mailto:webmaster@eqrealms.com">webmaster@eqrealms.com</A> - For feedback and questions about EQrealms.
<LI><A HREF="mailto:pics@eqrealms.com">pics@eqrealms.com</A> - To submit pics for the shot of the day.
<LI><A HREF="mailto:info@eqrealms.com">info@eqrealms.com</A> - To submit item info, item stat pics, your links, quest info, guides and other info.
</UL>

</font>
</TD></TR>
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>EQrealms Crew</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">

<TABLE cellpadding="5">
<TR><TD bgcolor="#bfbf80" valign="top">
<IMG SRC="bio_dantes.jpg" WIDTH="100" HEIGHT="100" ALT="Dantes">
</TD>
<TD bgcolor="#bfbf80" valign="top" width="250">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Handle:</B> Dantes<BR>
<B>Email:</B> <A HREF="mailto:dantes@eqrealms.com">dantes@eqrealms.com</A><BR>
<B>RL Name:</B> Matt Rowell<BR>
<B>Characters:</B><BR>
Dantes, Wood Elven Warrior, Brell Serilis<BR>
Tvurok, Iksar Shaman, Brell Serilis<BR>
Dantes, Wood Elven Ranger, Test
</font>
</TD>
<TD bgcolor="#bfbf80" valign="top">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Function:</B> Dantes designed the EQrealms graphics and layout, and also produced much of the code 
backing up the site for item and information DBs.  He heads up production on the EQrealms site.
...
<TABLE cellpadding="5">
<TR><TD bgcolor="#bfbf80" valign="top">
<IMG SRC="bio_korie.jpg" WIDTH="100" HEIGHT="100" ALT="Korie">
</TD>
<TD bgcolor="#bfbf80" valign="top" width="250">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Handle:</B> Korie<BR>
<B>Email:</B> <A HREF="mailto:jlogsdon@home.com">jlogsdon@home.com</A><BR>
<B>RL Name:</B> Jerry Logsdon<BR>
<B>Characters:</B><BR>
Korie, Wood Elven Bard, Brell Serilis<BR>
Scithe, Iksar Warrior, Brell Serilis<BR>
Kori, Halfling Druid, Test
</font>
</TD>
<TD bgcolor="#bfbf80" valign="top">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Function:</B> Korie works to keep item and DB information up to date and is responsible for hundreds of the 
weapons and items that have been added to our DB here on EQrealms.  Korie has also written many of 
our indepth guides that we have available here.
...
<TABLE cellpadding="5">
<TR><TD bgcolor="#bfbf80" valign="top">
<IMG SRC="bio_carra.jpg" WIDTH="100" HEIGHT="100" ALT="Carramaena">
</TD>
<TD bgcolor="#bfbf80" valign="top" width="250">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Handle:</B> Carramaena<BR>
<B>Email:</B> <A HREF="mailto:louise.hand@virgin.net">louise.hand@virgin.net</A><BR>
<B>RL Name:</B> Louise Hand<BR>
<B>Characters:</B><BR>
Carramaena, Human Enchanter, Lanys T'Vyl<BR>
Calliste, Dark Elf Necromancer, Lanys T'Vyl</font>
</TD>
<TD bgcolor="#bfbf80" valign="top">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Function:</B> Carramaena is a news editor here at EQrealms and is responsible for many of the early updates.  Carra 
will also be bringing us lots of editorial content as well.
...
<TABLE cellpadding="5">
<TR><TD bgcolor="#bfbf80" valign="top">
<IMG SRC="bio_van.jpg" WIDTH="100" HEIGHT="100" ALT="Vaninadisc">
</TD>
<TD bgcolor="#bfbf80" valign="top" width="250">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Handle:</B> Vaninadisc<BR>
<B>Email:</B> <A HREF="mailto:russmc@iols.net">russmc@iols.net</A><BR>
<B>RL Name:</B> Russ McMackin<BR>
<B>Characters:</B><BR>
Vaninadisc, Human, Wizard, Brell<BR>
Norago, WoodElf, Warrior, Brell</font>
</TD>
<TD bgcolor="#bfbf80" valign="top">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<B>Function:</B> Vaninadisc keeps up stuff behind the scenes on the database, he is responsible for 
a huge portion of the spell information added for many classes.
