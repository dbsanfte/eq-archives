...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="beasts.gif" WIDTH="110" HEIGHT="44" ALT="Beasts"></TD>
...
<FORM NAME="CFForm_1" ACTION="beast_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
<INPUT TYPE="hidden" Name="search" Value="NO">
<INPUT TYPE="hidden" Name="byzone" Value="YES">
<B>Beasts by Zone</B>:<BR>
...
<TD><FONT FACE="Arial, Verdana, Helvetica" size="-1">
<FORM NAME="CFForm_2" ACTION="beast_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_2(this)">
<INPUT TYPE="hidden" Name="search" Value="NO">
<INPUT TYPE="hidden" Name="byzone" Value="NO">
<B>Beasts by Category</B>:<BR>
...
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<FORM NAME="CFForm_3" ACTION="beast_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_3(this)">
<B>Keyword Search:</B><BR>
Enter a name for Mob/NPC/Beast.<BR>
