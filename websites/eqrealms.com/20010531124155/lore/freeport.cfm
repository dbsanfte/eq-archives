...
<HEAD>
<TITLE>EQrealms - Game Lore - Freeport History</TITLE>
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>The Story of Freeport</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1"><BR>

<BLOCKQUOTE>
The land that Freeport now stands on was once an Elven outpost called Wielle during the later part of the Age of Monuments and perhaps into the Age of Blood. Shortly before the Elven nation split into three factions, there were rebels intent on gaining power for themselves. They first showed their resistance by slaughtering the entire outpost of Wielle. Time passed and the Combine Empire came into power and the vanished again, leaving the human race wandering the plains of Karana and venturing across the continent of Tunaria, which shortly after was renamed Antonica. The humans established the city of Freeport, which served as the port of call to travelers of the Ocean of Tears. The seedy origins of Freeport still show today in the run down areas of the city, the lax attitude towards evil races, and the corrupt guards in the Militia. Due to Freeport being mainly a trade city, items of all types can be purchased here. Many artisans call Freeport home due to the availability of raw materials. The only guilds not represented in Freeport are the druids, rangers, and shamans. Finally, Freeport is the gate to the continent of Faydwer, with a boat leaving for there many times a day.
</BLOCKQUOTE>
