...
<HEAD>
<TITLE>EQrealms - Zones - Solusek's Eye A</TITLE>
...
<TR><TD bgcolor="#bfbf80" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Old Sebilis</B></FONT></TD></TR>
...
<B>Level Range</B>: 47-60<BR><BR>

<B>What is Sebilis?</B><BR>
Sebilis was once a great Iksar city which now is in ruins deep in the Jungle of Trakanon's Teeth.  Within these 
ruins is an entrance to the old city which is underground. (at loc -2030, -4450) To get inside the city you first must 
obtain a key to be granted access, to receive a key you have to give 2 medallions to Emporer Ganak (at -2740, +2850).  The two medallions come 
from the Froglok Forager and the Froglok Hunter in Trakanon's Teeth.  You must have 1 of each to get the completed key. The Frogs are a constant spawn, 
once they die they will immediately respawn, however a named mob can spawn in their place and must be killed before more Hunters or Foragers
will spawn.  You use the key on the orb and you are teleported into Sebilis, once inside you can't zone out.  It's not a 
good idea to go down into Sebilis if you are a class which cannot gate out unless you already have a group lined up. 
A recent patch change has made the Sebilis keys and keys to other dungeons stay with you when you respawn if you 
die instead of being on your corpse, before people used to duel at the entrance and leave a key on a corpse there incase
they died and had to get back in. (they would have 2 keys)<BR><BR>

Sebilis is inhabited by Frogloks, Undead, and Golems. The lowest level frogs are the Dars, starting at around 45th level
and there are also Boks, and the 50+ start with Krups who are 51st or higher.  Below the old city in the caves and crypts
you'll find the undead and the ghosty iksar, as well as undead frogloks.  An important thing to have in Sebilis is a Rogue, there 
are several locked doors in Sebilis and without a Rogue there can sometimes be no other option to get by the door.<BR><BR>

Sebilis is home to some of the best loot in the game, as well as the second half of the class armor that can be found in <br>
Karnor's Castle.  Sebilis is also the home of the famed Trakanon, the poison dragon!  Trakanon has been slain on some 
servers and is known to drop the class based breastplates among other great items.  All in all Sebilis is a great place to 
hunt for your 50+ spells, as well as a good place for melee loot.  With the proper 50+ group and a rogue you can get pretty far.
Word of advice, when fighting mobs with pets; the mob can walk right through the locked door to attack you without opening it but the 
pet can't.  It's a good idea to have the rogue open the door for the pet so that you aren't trained on.<BR><BR>

Another important note is that as you get near the first door in Sebilis, close to the entrance, it's a good idea to have the group all camp 
and log back in to avoid a very serious pathing bug which could cause a huge train.
...
<B>Weapons:</B><BR>
<SELECT NAME="name">
<OPTION>Beetle Stinger

<OPTION>Brell's Keg Popper

<OPTION>Cane of Harmony

<OPTION>Cane of the Tranquil

<OPTION>Ebon Mace

<OPTION>Knuckle Dusters

<OPTION>Nathsar Greatsword

<OPTION>Rod of Annihilation

<OPTION>Sword of Skyfire
...
<B>Armor:</B><BR>
<SELECT NAME="name">
<OPTION>Blood Ember Vambracers

<OPTION>Bone Mask of the Jarsath

<OPTION>Cobalt Vambraces

<OPTION>Deepwater Vambracers

<OPTION>Donal's Boots of Mourning

<OPTION>Donal's Vambracers of Mourning

<OPTION>Froglok Bonecaster's Robe

<OPTION>Froglok Scale Tunic

<OPTION>Fungi Covered Scale Tunic

<OPTION>Gangrenous Beetle Mask

<OPTION>Hierophant's Cloak

<OPTION>Iksar Hide Boots

<OPTION>Jaundiced Bone Vambracers

<OPTION>Mrylokar's Vambraces

<OPTION>Obulus Mantle

<OPTION>Robe of Living Fungus

<OPTION>Sebilite Scale Boots

<OPTION>Sebilite Scale Cape

<OPTION>Sebilite Scale Coat

<OPTION>Sebilite Scale Leggings

<OPTION>Sebilite Scale Mask

<OPTION>Sebilite Scale Neckguard

<OPTION>Sebilite Scale Vambracers

<OPTION>Seblisian Berserker Cloak

<OPTION>Tolan's Darkwood Vambraces

<OPTION>Tolapumj's Robe
...
<OPTION>Arch Duke Iatol

<OPTION>Baron Yosig

<OPTION>Crypt Caretaker

<OPTION>Emporer Chottal

<OPTION>Froglok Pickler

<OPTION>Heirophant Prime Grekal

<OPTION>Myconid Spore King
