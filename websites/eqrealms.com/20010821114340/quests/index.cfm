...
    if  (!_CF_hasValue(_CF_this.string, "TEXT" )) 
        {
        if  (!_CF_onError(_CF_this, _CF_this.string, _CF_this.string.value, "Error!  You must enter something into the search field."))
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="quests.gif" WIDTH="126" HEIGHT="44" ALT="Quests"></TD>
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Browse</B></FONT></TD></TR>
...
<FORM NAME="CFForm_1" ACTION="quests_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_1(this)">
<INPUT TYPE="hidden" Name="search" Value="NO">
<INPUT TYPE="hidden" Name="byzone" Value="YES">
<B>Quests by Zone</B>:<BR>
<SELECT NAME="zone"> <OPTION>Ak'Anon
<OPTION>Befallen
<OPTION>Beholder's Maze
<OPTION>Black Burrow
<OPTION>Broken Teeth
<OPTION>Burning Wood
<OPTION>Butcherblock
...
<OPTION>Fironia Vie
<OPTION>Freeport
<OPTION>Frontier Mountains
<OPTION>Greater Faydark
<OPTION>Grobb
<OPTION>Halas
<OPTION>Highhold Keep
<OPTION>Highhold Pass
...
<OPTION>Kedge
<OPTION>Kerra Ridge
<OPTION>Kithicor Woods
<OPTION>Kurn's Tower
<OPTION>Lake of Dismay
...
<OPTION>Splitpaw
<OPTION>Steamfront
<OPTION>Surefall Glade
<OPTION>Swamp of No Hope
<OPTION>Temple of Droga
<OPTION>Temple of Solusek Ro
<OPTION>Timorous Deep
<OPTION>Trakanon's Teeth
<OPTION>Tuxxulia Forest
<OPTION>Unrest
<OPTION>Upper Guk
<OPTION>Veeshan's Peak
<OPTION>Warslik's Woods
<OPTION>West Commons
<OPTION>West Karana</SELECT><INPUT TYPE="submit" VALUE="Go">
</FORM>
</BLOCKQUOTE>
</FONT></TD>
<TD><FONT FACE="Arial, Verdana, Helvetica" size="-1">
<FORM NAME="CFForm_2" ACTION="quests_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_2(this)">
<INPUT TYPE="hidden" Name="search" Value="NO">
<INPUT TYPE="hidden" Name="byzone" Value="NO">
<B>Quests by Class</B>:<BR>
<SELECT NAME="class">
<OPTION>Bard
<OPTION>Cleric
<OPTION>Druid
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>Search</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<FORM NAME="CFForm_3" ACTION="quests_select.cfm" METHOD=POST onSubmit="return _CF_checkCFForm_3(this)">
<B>Keyword Search:</B><BR>
Enter a descriptive name or item name.<BR>
<INPUT TYPE="text" NAME="string" SIZE="25"> <INPUT TYPE="submit" VALUE="Go">
