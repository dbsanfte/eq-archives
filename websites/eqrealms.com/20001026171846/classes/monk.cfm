...
<HEAD>
<TITLE>EQrealms - Classes - Monk</TITLE>
...
document.writeln("jscheck='1';");
document.writeln("<\/SCRIPT>");
if(jscheck == 1) {
document.writeln("<SCRIPT language='JavaScript1.2' src='http://ads5.gamecity.net/modperl/jsformat.pl?REGION=RG-EQrealms_banner'>");
document.writeln("var rand = Math.floor(Math.random() * 200);");
document.writeln("document.writeln('<a href=\"http://ads5.gamecity.net/cgi-bin/redirect.cgi/' + rand + '\">');");
document.writeln("document.writeln('<img src=\"http://ads5.gamecity.net/cgi-bin/getimage.cgi/' + rand + '?REGION=RG-EQrealms_banner\"></a>');");
document.writeln("<\/SCRIPT>");
}
else {
var rand = Math.floor(Math.random() * 200);
document.writeln('<a href="http://ads5.gamecity.net/cgi-bin/redirect.cgi/' + rand + '">');
document.writeln('<img src="http://ads5.gamecity.net/cgi-bin/getimage.cgi/' + rand + '?REGION=RG-EQrealms_banner"></a>');
}
// -->
</SCRIPT>
<NOSCRIPT>
<a href="http://ads5.gamecity.net/cgi-bin/redirect.cgi/unique_id">
<img src="http://ads5.gamecity.net/cgi-bin/getimage.cgi/unique_id?REGION=RG-EQrealms_banner"></a>
</NOSCRIPT>
<!-- END ADCODE -->
...
<TR><TD bgcolor="4a0000" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="#ffff80"><B>Monk Guide</B></FONT></TD></TR>
...
<B>In-House Monk Guide Needed!</B><BR>
Think you are a skilled Monk?  Want to share your teachings and tactics with the rest of the world? 
Mail <A HREF="mailto:info@eqrealms.com">info@eqrealms.com</A> if you would like to submit a Monk Guide or Monk information.  Thanks!
...
<TR><TD bgcolor="#bfbf80" width="100%" valign="top" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="guides"></a><B>Other Monk Guides</B></FONT></TD></TR>
<TR>
<TD bgcolor="#cdcd9c" width="100%" valign="top" colspan="2">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<UL>
<LI><A HREF="http://www.gameznet.com/eq/class/monk2.html">Monk Guide</A> - Guide by Azuris Trenten.

<LI><A HREF="http://www.gameznet.com/eq/class/monk3.html">Monk Guide</A> - Guide by Roon Dragonclaw.
</font></UL>
</TD></TR>
<TR><TD bgcolor="#bfbf80" width="50%" valign="top"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="weapons"></a><B>Monk Weapons</B></FONT></TD>
<TD bgcolor="#bfbf80" width="50%" valign="top"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="armor"></a><B>Monk Armor & Items</B></FONT></TD></TR>
...
<INPUT TYPE="hidden" Name="class" Value="Monk">
<BLOCKQUOTE>
<B>Weapon Type</B>:<BR>
<SELECT NAME="skill">
<OPTION>1H Blunt
...
<TR><TD bgcolor="#bfbf80" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="quests"></a><B>Monk Quests</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c" colspan="2">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<UL>
...
<TR><TD bgcolor="#bfbf80" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="skills"></a><B>Monk Skills</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c" colspan="2">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<BLOCKQUOTE>
[INSERT MONK SKILLS!]
...
<TR><TD bgcolor="#bfbf80" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="links"></a><B>Monk Links</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c" colspan="2">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<UL></font></UL>
</TD></TR>
<TR><TD bgcolor="#bfbf80" colspan="2"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><a name="screenshots"></a><B>Monk Related Screenshots</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c" colspan="2">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">
<CENTER> 
</CENTER>
...
document.writeln("<\/SCRIPT>");
if(jscheck == 1) {
document.writeln("<SCRIPT language='JavaScript1.2' src='http://ads5.gamecity.net/modperl/jsformat.pl?REGION=RG-EQrealms_banner_b'>");
document.writeln("var rand = Math.floor(Math.random() * 200);");
document.writeln("document.writeln('<a href=\"http://ads5.gamecity.net/cgi-bin/redirect.cgi/' + rand + '\">');");
document.writeln("document.writeln('<img src=\"http://ads5.gamecity.net/cgi-bin/getimage.cgi/' + rand + '?REGION=RG-EQrealms_banner_b\"></a>');");
document.writeln("<\/SCRIPT>");
}
else {
var rand = Math.floor(Math.random() * 200);
document.writeln('<a href="http://ads5.gamecity.net/cgi-bin/redirect.cgi/' + rand + '">');
document.writeln('<img src="http://ads5.gamecity.net/cgi-bin/getimage.cgi/' + rand + '?REGION=RG-EQrealms_banner_b"></a>');
}
// -->
</SCRIPT>
<NOSCRIPT>
<a href="http://ads5.gamecity.net/cgi-bin/redirect.cgi/unique_id">
<img src="http://ads5.gamecity.net/cgi-bin/getimage.cgi/unique_id?REGION=RG-EQrealms_banner_b"></a>
</NOSCRIPT>
<!-- END ADCODE -->
</CENTER>
</TD></TR>
