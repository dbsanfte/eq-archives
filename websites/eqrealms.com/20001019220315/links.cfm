...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
<TR><TD width="159"><IMG SRC="links.gif" WIDTH="95" HEIGHT="44" ALT="Links"></TD>
...
<TR><TD bgcolor="#bfbf80"><FONT FACE="Arial, Verdana, Helvetica" SIZE="+1" color="4a0000"><B>General Links</B></FONT></TD></TR>
<TR><TD bgcolor="#cdcd9c">
<FONT FACE="Arial, Verdana, Helvetica" size="-1">

This links page is a temporary list if general EQ sites I've grown to know and love in the past, please 
check them out if you haven't.  I'll be changing the links section soon so include guild links by server, 
zone guide links, class guide links, class page links, and so on.

<UL>

<LI><B><A HREF="http://everquest.allakhazam.com/">Allakhazam's Magical Realm</A></B>: One of the best sites out there for quest and item info.

<LI><B><A HREF="http://eq.castersrealm.com/">Casters Realm</A></B>: Awesome source for spell information and caster class guides.

<LI><B><A HREF="http://eq.stratics.com">EQ Stratics</A></B>: One of the best sites for EQ data and also news.

<LI><B><A HREF="http://www.eqtradingpost.com">EQ Trading Post</A></B>: A place to list items for sale and make trades.

<LI><B><A HREF="http://www.eqlinks.com">EQlinks</A></B>: A huge collection of all types of links.

<LI><B><A HREF="http://www.eqmaps.com">EQmaps</A></B>: A great site for maps and zone guides.

<LI><B><A HREF="http://www.eqvault.com">EQvault</A></B>: The definitive general EQ news site.

<LI><B><A HREF="http://www.everlore.com">Everlore</A></B>: A huge site with tons of item info and guides, as well as tons of daily news.

<LI><B><A HREF="http://monks.volitionx.com/">Relentless Monks</A></B>: A site with some awesome indepth zone guides, also monk news/info.

<LI><B><A HREF="http://www.valorblade.com">Valorblade</A></B>: My own EQ guild on Brell Serilis.
