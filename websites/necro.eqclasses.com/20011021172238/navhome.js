...
tempMenu.addItem(new NavBarMenuItem("Hunting Guides", "http://necro.eqclasses.com/hunting.asp"));
...
tempMenu.addItem(new NavBarMenuItem("Faction Guide", "http://necro.eqclasses.com/faction.asp"));
tempMenu.addItem(new NavBarMenuItem("Emote Guide", "http://necro.eqclasses.com/emotes.asp"));
myNavBar.addMenu(tempMenu);
...
tempMenu.addItem(new NavBarMenuItem("Submitted Art", "http://necro.eqclasses.com/art.asp"));
...
tempMenu.addItem(new NavBarMenuItem("Message Board", "http://necro.eqclasses.com/forumsnew"));
tempMenu.addItem(new NavBarMenuItem("Chat", "http://necro.eqclasses.com/chatchat"));
tempMenu.addItem(new NavBarMenuItem("Email Staff", "mailto:lifebane@telocity.com barling@theplanet.com"));
tempMenu.addItem(new NavBarMenuItem("Email Reionik", "mailto:barling@theplanet.com"));
tempMenu.addItem(new NavBarMenuItem("Email Lifebane", "mailto:lifebane@telocity.com"));
myNavBar.addMenu(tempMenu);

tempMenu = new NavBarMenu(80, 180);
tempMenu.addItem(new NavBarMenuItem("Guilds", ""));
tempMenu.addItem(new NavBarMenuItem("Shadowclan", "http://necro.eqclasses.com/Shadowclan/"));
myNavBar.addMenu(tempMenu);
