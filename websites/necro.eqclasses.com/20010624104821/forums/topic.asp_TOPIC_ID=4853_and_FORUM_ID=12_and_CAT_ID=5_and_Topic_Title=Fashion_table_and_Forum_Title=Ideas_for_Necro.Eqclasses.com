...
<table border="0" width="95%">
  <tr>
	...
	<img src="icon_blank.gif" height=15 width=15 border="0"><img src="icon_bar.gif" height=15 width=15 border="0"><img src="icon_folder_open_topic.gif" height=15 width=15 border="0">&nbsp;Fashion table
    </font></td>
    ...
    <a href="post.asp?method=Reply&TOPIC_ID=4853&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Fashion+table"><img src="icon_reply_topic.gif" height=15 width=15 border=0></a>&nbsp;<a href="post.asp?method=Reply&TOPIC_ID=4853&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Fashion+table">Reply to Topic</a>
  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="4">
      <tr>
        ...
        <td align="center" bgcolor="slategray" width="100%" ><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=4898&Topic_Title=necros+need+sow&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_prev.gif" height=15 width=15 alt="Previous Topic" border="0" align="absmiddle" hspace="6"></a><b><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream">&nbsp;Topic&nbsp;</font></b><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=4436&Topic_Title=Return+of+The+Duck&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_next.gif" height=15 width=15 alt="Next Topic" border="0" align="absmiddle" hspace="6"></a></font></b></td>
      ...
      <tr>
		...
		<a href="pop_profile.asp?mode=display&id=159">
        	
		<font color="white" face="Verdana, Arial, Helvetica" size="2"><b>Aeuda</a>
        </b></font>
        ...
        <br><font color="white" face="Verdana, Arial, Helvetica" size="1"><small>56 Posts</small></font></td>
        <td bgcolor="dimgray" colspan="2" ><img src="icon_posticon.gif" border="0" hspace="3"><font color="white" face="Verdana, Arial, Helvetica" size="1">Posted&nbsp;-&nbsp;05/16/2001&nbsp;:&nbsp; 11:50:21</font>

        
		&nbsp;<a href="pop_profile.asp?mode=display&id=159"><img src="icon_profile.gif" height=15 width=15 alt="Show Profile" border="0" align="absmiddle" hspace="6"></a>
        
			&nbsp;<a href="JavaScript:openWindow('pop_mail.asp?id=159')"><img src="icon_email.gif" height=15 width=15 alt="Email Poster" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="post.asp?method=TopicQuote&TOPIC_ID=4853&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Fashion+table"><img src="icon_reply_topic.gif" height=15 width=15 alt="Reply with Quote" border="0" align="absmiddle" hspace="6"></a>

        <hr noshade size="1">
        
        <font color="white" face="Verdana, Arial, Helvetica" size="2">Have been looking at the equipment sections on Allakhazam's and Graffe's, and I just love the fashion sections they have.  </P><P>Think it would be possible, at least with the chest pieces, to put together a small screenshot collection of all Necro-wearable robes and tunics?  Especially with the new Velious robes, fashion will dictate a great deal when choosing which quest to pursue.  <img src=icon_smile.gif border=0 align=middle></P><P>Aeuda D'Frel<BR>Sister of The Dead<BR>Legion of Ka - Luclin</font></td>
      </tr>
      ...
      <tr>
		...
		<font color="white" face="Verdana, Arial, Helvetica" size="2"><b>Reionik</a>
        </b></font>

        <br><font color="white" face="Verdana, Arial, Helvetica" size="1"><small>The VISIONtm</small></font>

        <br><img src=icon_star_purple.gif border=0><img src=icon_star_purple.gif border=0><img src=icon_star_purple.gif border=0>
        <br>
        <br><font color="white" face="Verdana, Arial, Helvetica" size="1"><small>USA</small></font>
        <br><font color="white" face="Verdana, Arial, Helvetica" size="1"><small>671 Posts</small></font></td>
        <td bgcolor="dimgray" colspan="2" ><img src="icon_posticon.gif" border="0" hspace="3"><font color="white" face="Verdana, Arial, Helvetica" size="1">Posted&nbsp;-&nbsp;05/16/2001&nbsp;:&nbsp; 15:07:01</font>
        ...
        &nbsp;<a href="http://"><img src="icon_Homepage.gif" height=15 width=15 alt="Visit Reionik's Homepage" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="JavaScript:openWindow('pop_messengers.asp?mode=AIM&AIM=Starving101&M_NAME=Reionik')"><img src="icon_aim.gif" height=15 width=15 alt="Send Reionik an instant message" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="post.asp?method=ReplyQuote&REPLY_ID=36248&TOPIC_ID=4853&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Fashion+table&M="><img src="icon_reply_topic.gif" height=15 width=15 alt="Reply with Quote" border="0" align="absmiddle" hspace="6"></a>


        <hr noshade size="1">
        
        <font color="white" face="Verdana, Arial, Helvetica" size="2">Great idea.  I will pass it on to Lifey.</P><P><BR> <a href="#top"><img src="icon_go_up.gif" height=15 width=15 border="0" align="right" alt="Go to Top of Page"></a></font></td>
      </tr>
