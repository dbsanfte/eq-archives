 ...
 <tr>
  <td>
          <font face="arial" size="2" color="#000000">
            [ Active Members: <b><font color="#000000">46</font></b> | 
            Anonymous Members: <b><font color="#000000">0</font></b> | 
            Guests: <b><font color="#000000">15</font></b> ]&nbsp;&nbsp;[ 
            Total: <b><font color="#000000">61</font></b>
		]
<font face="arial" size="2" color="#000000">&nbsp;[ Newest Member: <font color="#000000"><span class="spnMessageText"><a href="pop_profile.asp?mode=display&id=26996" title="View yten's Profile" onMouseOver="(window.status='View yten\'s Profile'); return true" onMouseOut="(window.status=''); return true">yten</a></span></font> ]</font>
  </td>
 </tr>
</table>
  </td>
...
<table bgcolor="#ECECEC" align="center" border="0" cellPadding="0" cellSpacing="0" width="100%">
  <tr>
    ...
    function ChangePage(fnum){
      ...
      <form action="/forum/search2.asp?mode=DoIt" name="SearchForm" id="SearchForm" method="post">
      <table border="0" width="50%" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td bgcolor="#000000">
            <table border="0" width="100%" cellspacing="1" cellpadding="4">
              <tr>
                <td colspan="2" align="center" bgcolor="#e9e9e9" background="images/table-header.gif"><table width="100%"><tr><td align="left"><b>&nbsp;Search Forums</b></td><td align="right"><font size="1"><a href="search.asp">Quick Search</a>&nbsp;</font></td></tr></table></td>
              </tr>
              <tr>
                <td colspan="2" bgcolor="#e9e9e9" background="images/table-header.gif"><b><font face="arial" color="#000000" size="2">Search Terms</font></b></td>
              </tr>
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Keywords</b><br /></font>
<font face="arial" size="2" color="#000000">for good results choose words relevant to your search (e.g. if you are looking for posts on 'apples' do not use the word 'grapefruit', and also common words such as 'the' should be avoided.)
</font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><input class=newlogin type="text" name="Search" size="25" value=""><br />
</font></td>
              </tr>
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Search for:</b>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000">                <input type="radio" name="andor" value="1" checked><b>All</b> of these keywords (x <b>and</b> y)<br />
                <input type="radio" name="andor" value="2"><b>Any</b> of these keywords (x <b>or</b> y)<br />
                <input type="radio" name="andor" value="3"><b>Exact phrase</b>
</font></td>
              </tr>
              <tr>
                <td colspan="2" bgcolor="#e9e9e9" background="images/table-header.gif"><b><font face="arial" color="#000000" size="2">Post or Topic Authors</font></b></td>
              </tr>
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Author</b><br /></font>
<font face="arial" size="2" color="#000000">(exact name must be entered)</font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><input class=newlogin name="SearchMember" value="" size="25">
</font></td>
              </tr>
              <tr>
                <td colspan="2" bgcolor="#e9e9e9" background="images/table-header.gif"><b><font face="arial" color="#000000" size="2">Type of Search</font></b></td>
              </tr>
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Perform Search in:</b></font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000">                <select name="SearchMessage">
                	<option value="0">Entire Message</option>
                	<option value="1">Subject Only</option>
                </select>
                &nbsp;&nbsp;<input type="checkbox" name="ARCHIVE" value="true">Archived Posts
</font></td>
              </tr>
              <tr>
                <td colspan="2" bgcolor="#e9e9e9" background="images/table-header.gif"><b><font face="arial" color="#000000" size="2">Misc. Search Options</font></b></td>
              </tr>
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Choose Forum</b></font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000">                <select name="Forum" size="1">
              ...
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Search for Posts Starting:</b></font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><select name="start_month">
...
<option value="2003" selected>2003</option>
              ...
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>And Ending:</b></font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><select name="end_month">
<option value="1">January</option>
<option value="2">February</option>
<option value="3">March</option>
<option value="4">April</option>
...
<option value="2003" selected>2003</option>
              ...
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Sort Topics By</b></font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000">                      <select name="sortfield">
                      <option value="topic">Title</option>
                      <option value="author">Author</option>
                      <option value="topicstart">Start Date</option>
                      <option value="lastpost" selected>Last Post Date</option>
              ...
              <tr>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000"><b>Results per page:</b></font></td>
                <td width="50%" bgcolor="#e9e9e9"><font face="arial" size="2" color="#000000">                      <select name="results">
                      <option value="10">10</option>
      ...
      <br><input class=buttons type="submit" value="Search"><br><br>
        </td>
        </tr>
            </table>
          </td>
...
<font face="arial" size="2" color="#000000">This page was reanimated in 0.08 seconds.</font>
</td>
