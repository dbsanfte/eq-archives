 ...
 <tr>
  <td>
          <font face="arial" size="2" color="#000000">
            ...
            Guests: <b><font color="#000000">19</font></b> ]&nbsp;&nbsp;[ 
            Total: <b><font color="#000000">54</font></b>
		]
<font face="arial" size="2" color="#000000">&nbsp;[ Newest Member: <font color="#000000"><span class="spnMessageText"><a href="pop_profile.asp?mode=display&id=27059" title="View terni's Profile" onMouseOver="(window.status='View terni\'s Profile'); return true" onMouseOut="(window.status=''); return true">terni</a></span></font> ]</font>
  </td>
 </tr>
</table>
  </td>
    ...
    <td colspan="3">
      <table width="100%" border="0">
        <tr>
          ...
          <img src="images/icon_bar.gif" width="15" height="15" border="0" alt="" title="" /><img src="images/icon_folder_open_topic.gif" width="15" height="15" border="0" alt="" title="" />&nbsp;Forgot your Password?<br />
        </tr>
      </table>
      <p><form action="password.asp" method="Post" id="Form1" name="Form1">
        ...
        <tr>
          <td bgcolor="#000000">
            <table border="0" width="100%" cellspacing="1" cellpadding="4">
              <tr>
                <td colspan="2" align="center" bgcolor="#e9e9e9" background="images/table-header.gif" valign="top"><b><font face="arial" size="2" color="#000000">Forgot your Password?</font></b></td>
              </tr>
              <tr>
                <td colspan="2" align="left" bgcolor="#ECECEC" valign="top"><font face="arial" size="2" color="#000000">This is a 3 step process:
                <ul>
                 <font color="#000000"><li><b>First Step:</b><br />Enter your username and e-mail address in the form below to receive an e-mail containing a code to verify that you are who you say you are.</li></font>
              ...
              <tr>
                <td width="50%" align="right" bgcolor="#ECECEC" nowrap><b><font face="arial" size="2">&nbsp;UserName:&nbsp;</font></b></td>
                <td width="50%" bgcolor="#ECECEC"><input type="text" name="Name" size="25" maxLength="25"></td>
              </tr>
              <tr>
                <td width="50%" align="right" bgcolor="#ECECEC" nowrap><b><b><font face="arial" size="2">E-mail Address:&nbsp;</font></b></td>
                <td width="50%" bgcolor="#ECECEC"><input type="text" name="Email" size="25" maxLength="50"></td>
              </tr>
              <tr>
                <td colspan="2" bgcolor="#ECECEC" align="center"><input type="submit" value="Submit" id="Submit1" name="Submit1">&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset" id="Submit1" name="Submit1"></td>
              </tr>
            </table>
          </td>
        </tr>
