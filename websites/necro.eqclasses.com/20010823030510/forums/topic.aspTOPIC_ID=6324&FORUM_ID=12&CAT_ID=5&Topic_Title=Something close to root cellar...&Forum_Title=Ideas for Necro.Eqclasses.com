...
<table border="0" width="95%">
  <tr>
	...
	<img src="icon_blank.gif" height=15 width=15 border="0"><img src="icon_bar.gif" height=15 width=15 border="0"><img src="icon_folder_open_topic.gif" height=15 width=15 border="0">&nbsp;Something close to root cellar...
    </font></td>
    ...
    <a href="post.asp?method=Reply&TOPIC_ID=6324&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Something+close+to+root+cellar%2E%2E%2E"><img src="icon_reply_topic.gif" height=15 width=15 border=0></a>&nbsp;<a href="post.asp?method=Reply&TOPIC_ID=6324&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Something+close+to+root+cellar%2E%2E%2E">Reply to Topic</a>
  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="4">
      <tr>
        ...
        <td align="center" bgcolor="slategray" width="100%" ><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=6364&Topic_Title=lifetap+resists&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_prev.gif" height=15 width=15 alt="Previous Topic" border="0" align="absmiddle" hspace="6"></a><b><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream">&nbsp;Topic&nbsp;</font></b><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=6257&Topic_Title=Visited+link+colors%3F&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_next.gif" height=15 width=15 alt="Next Topic" border="0" align="absmiddle" hspace="6"></a></font></b></td>
      ...
      <tr>
		...
		<a href="pop_profile.asp?mode=display&id=227">
        	
		<font color="white" face="Verdana, Arial, Helvetica" size="2"><b>Buzter</a>
        </b></font>
        ...
        <td bgcolor="dimgray" colspan="2" ><img src="icon_posticon.gif" border="0" hspace="3"><font color="white" face="Verdana, Arial, Helvetica" size="1">Posted&nbsp;-&nbsp;08/04/2001&nbsp;:&nbsp; 10:14:11</font>

        
		&nbsp;<a href="pop_profile.asp?mode=display&id=227"><img src="icon_profile.gif" height=15 width=15 alt="Show Profile" border="0" align="absmiddle" hspace="6"></a>
        
			&nbsp;<a href="JavaScript:openWindow('pop_mail.asp?id=227')"><img src="icon_email.gif" height=15 width=15 alt="Email Poster" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="post.asp?method=TopicQuote&TOPIC_ID=6324&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Something+close+to+root+cellar%2E%2E%2E"><img src="icon_reply_topic.gif" height=15 width=15 alt="Reply with Quote" border="0" align="absmiddle" hspace="6"></a>

        <hr noshade size="1">
        
        <font color="white" face="Verdana, Arial, Helvetica" size="2">I have a great idea. We need to start something akin to the root cellar from safehouse. You know where it is a password protected board based on user logins, and that every server has a "warden" to allow access to "proven" members of the necro community. This would be a place to discuss sensitive information that we don't want Verant to nerf. Kinda like a post made in general discussion that might be taken down so it's not nerfed. 8)</P><P> </font></td>
      </tr>
