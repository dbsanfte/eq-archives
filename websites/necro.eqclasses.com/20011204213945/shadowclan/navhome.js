...
tempMenu.addItem(new NavBarMenuItem("Dark Elf Guide", "http://necro.eqclasses.com/shadowclan/htmlmain/delf.htm"));
tempMenu.addItem(new NavBarMenuItem("Iksar Guide", "http://necro.eqclasses.com/shadowclan/htmlmain/iksar.htm"));
tempMenu.addItem(new NavBarMenuItem("Ogre Guide", "http://necro.eqclasses.com/shadowclan/htmlmain/ogre.htm"));
tempMenu.addItem(new NavBarMenuItem("Troll Guide", "http://necro.eqclasses.com/shadowclan/htmlmain/troll.htm"));
tempMenu.addItem(new NavBarMenuItem("Dark Elf Language", "http://necro.eqclasses.com/shadowclan/htmlmain/langdelf.htm"));
tempMenu.addItem(new NavBarMenuItem("Iksar Language", "http://necro.eqclasses.com/shadowclan/htmlmain/langiksar.htm"));
tempMenu.addItem(new NavBarMenuItem("Ogre Language", "http://necro.eqclasses.com/shadowclan/htmlmain/langogre.htm"));
tempMenu.addItem(new NavBarMenuItem("Troll Language", "http://necro.eqclasses.com/shadowclan/htmlmain/langtroll.htm"));
tempMenu.addItem(new NavBarMenuItem("Generic Language", "http://necro.eqclasses.com/shadowclan/htmlmain/langgen.htm"));
...
tempMenu.addItem(new NavBarMenuItem("Dark Elf Roster",  "http://necro.eqclasses.com/shadowclan/htmlmain/clandelf.htm"));
tempMenu.addItem(new NavBarMenuItem("Iksar Roster",  "http://necro.eqclasses.com/shadowclan/htmlmain/claniksar.htm"));
tempMenu.addItem(new NavBarMenuItem("Ogre Roster",  "http://necro.eqclasses.com/shadowclan/htmlmain/clanogre.htm"));
tempMenu.addItem(new NavBarMenuItem("Troll Roster",  "http://necro.eqclasses.com/shadowclan/htmlmain/clantroll.htm"));
...
tempMenu.addItem(new NavBarMenuItem("Character Background",  "http://necro.eqclasses.com/shadowclan/htmlmain/background.htm"));
...
tempMenu.addItem(new NavBarMenuItem("The Bank",  "http://pages.cthome.net/drano/Auction.htm "));
