...
<table align="center" border="0" cellPadding="0" cellSpacing="0" width="100%">
  <tr>
    ...
    <table border="0" cellPadding="2" cellSpacing="0">
      ...
      <form action="/forumsnew/topic.asp" method="post" id=form1 name=form1>
...
<table border="0" width="95%">
  <tr>
	...
	<img src="icon_blank.gif" height=15 width=15 border="0"><img src="icon_bar.gif" height=15 width=15 border="0"><img src="icon_folder_open_topic.gif" height=15 width=15 border="0">&nbsp;Something useful we can steal
    </font></td>
  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="4">
      <tr>
        ...
        <td align="center" bgcolor="slategray" width="100%" ><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=8469&Topic_Title=Luclin+Forums&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_prev.gif" height=15 width=15 alt="Previous Topic" border="0" align="absmiddle" hspace="6"></a><b><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream">&nbsp;Topic&nbsp;</font></b><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=8280&Topic_Title=Player+listings&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_next.gif" height=15 width=15 alt="Next Topic" border="0" align="absmiddle" hspace="6"></a></font></b></td>
      ...
      <tr>
		...
		<a href="pop_profile.asp?mode=display&id=462">
        	
		<font color="white" face="Verdana, Arial, Helvetica" size="2"><b>Nilarko</a>
        </b></font>
        ...
        <br><font color="white" face="Verdana, Arial, Helvetica" size="1"><small>158 Posts</small></font></td>
        <td bgcolor="dimgray" colspan="2" ><img src="icon_posticon.gif" border="0" hspace="3"><font color="white" face="Verdana, Arial, Helvetica" size="1">Posted&nbsp;-&nbsp;12/06/2001&nbsp;:&nbsp; 03:17:42</font>

        
		&nbsp;<a href="pop_profile.asp?mode=display&id=462"><img src="icon_profile.gif" height=15 width=15 alt="Show Profile" border="0" align="absmiddle" hspace="6"></a>
        
			&nbsp;<a href="JavaScript:openWindow('pop_mail.asp?id=462')"><img src="icon_email.gif" height=15 width=15 alt="Email Poster" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="post.asp?method=TopicQuote&TOPIC_ID=8460&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Something+useful+we+can+steal"><img src="icon_reply_topic.gif" height=15 width=15 alt="Reply with Quote" border="0" align="absmiddle" hspace="6"></a>

        <hr noshade size="1">
        
        <font color="white" face="Verdana, Arial, Helvetica" size="2">Since my alt is a wizard, and I can only browse the wizard boards while at work since the stupid ass firewall filters out eqnecro, I think we should steal an idea from them.<BR>If you haven't been there, go check out their General Forum.<BR><a href="http://pub23.ezboard.com/bgraffeswizardcompilation" target="_blank">http://pub23.ezboard.com/bgraffeswizardcompilation</a><BR>They have three(3) sticky subjects that stay up top that they are putting information about Luclin into.<BR>On thread each for Spell Location, New Items, and New Quests.<BR>I think this would really help us organize better and help get information out quicker.</P><P></P><P>Nilarko<BR>Gnome Necromancer</font></td>
      </tr>
