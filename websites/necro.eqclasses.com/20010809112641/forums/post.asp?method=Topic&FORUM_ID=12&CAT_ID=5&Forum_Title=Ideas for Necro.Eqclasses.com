...
<table border="0" width="100%" align=center>
  <tr>
    ...
    <img src="icon_bar.gif" border="0"><img src="icon_folder_open.gif" border="0">&nbsp;<a href="FORUM.asp?CAT_ID=5&FORUM_ID=12&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom">Ideas for Necro.Eqclasses.com</a><br>
...
<b>Note:</b> You must be registered in order to post a Topic.<br>To register, <a href="policy.asp">click here</a>. Registration is FREE!<br>
</font></p>
<table border="0" cellspacing="0" cellpadding="0" align=center>
  <tr>
    ...
    <table border="0" cellspacing="1" cellpadding="1">
  	...
  	<form name="Screensize" method="POST" action="post.asp?method=Topic&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&TOPIC_ID=+&REPLY_ID=+&Topic_Title=+">
		...
		<input name="FORUM_Title" type="hidden" value="Ideas for Necro.Eqclasses.com">
...
<select name="color" onChange="showcolor(this.options[this.selectedIndex].value)">
	...
	<option value="limeGreen">LimeGreen</option>
      ...
      <tr>
        <td bgColor="black" noWrap vAlign="top" align="right"><font face="Verdana, Arial, Helvetica" size="2"><b>Subject:</b></font></td>
        <td bgColor="black"><input maxLength="50" name="Subject" value="" size="40"></td>
      </tr>
      ...
      <tr>
        <td bgColor="black">&nbsp;</td>
        <td bgColor="black"><input name="Submit" type="submit" value="Post New Topic">
