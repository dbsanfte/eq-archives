...
<table border="0" width="100%" align=center>
  <tr>
    ...
    <img src="icon_bar.gif" border="0"><img src="icon_folder_open.gif" border="0">&nbsp;<a href="forum.asp?FORUM_ID=7">Ideas and Questions for EQclasses.com</a><br>
...
<table border="0" cellspacing="0" cellpadding="0" align=center>
  <tr>
    ...
    <table border="0" cellspacing="1" cellpadding="1">
  	...
  	<form name="Screensize" method="POST" action="post.asp?method=Topic&FORUM_ID=7&CAT_ID=2&Forum_Title=Ideas+and+Questions+for+EQclasses%2Ecom&TOPIC_ID=+&REPLY_ID=+&Topic_Title=+">
		...
		<input name="FORUM_Title" type="hidden" value="Ideas and Questions for EQclasses.com">
...
<select name="color" onChange="showcolor(this.options[this.selectedIndex].value)">
	...
	<option value="limeGreen">LimeGreen</option>
      ...
      <tr>
        <td bgColor="black">&nbsp;</td>
        <td bgColor="black"><input name="Submit" type="submit" value="Post New Topic">        &nbsp;<input name="Preview" type="button" value=" Preview " onclick="OpenPreview()">        &nbsp;<input name="Reset" type="reset" value="Reset Fields"></td>
      </tr>
    </table>
    </td>
  </tr>
...
<!-- timer
<center>
<font face="Verdana, Arial, Helvetica" size="1">75541.63</font>
</center>
end timer -->
</html>
