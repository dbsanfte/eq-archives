...
<table border="0" width="95%">
  <tr>
	...
	<img src="icon_blank.gif" height=15 width=15 border="0"><img src="icon_bar.gif" height=15 width=15 border="0"><img src="icon_folder_open_topic.gif" height=15 width=15 border="0">&nbsp;UPDATE ALL WEAPONS ARMOR ETC.
    </font></td>
    ...
    <a href="post.asp?method=Reply&TOPIC_ID=8898&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=UPDATE+ALL+WEAPONS+ARMOR+ETC%2E"><img src="icon_reply_topic.gif" height=15 width=15 border=0></a>&nbsp;<a href="post.asp?method=Reply&TOPIC_ID=8898&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=UPDATE+ALL+WEAPONS+ARMOR+ETC%2E">Reply to Topic</a>
  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="4">
      <tr>
        ...
        <td align="center" bgcolor="slategray" width="100%" ><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=8894&Topic_Title=Change+screenshot+of+the+day%21&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_prev.gif" height=15 width=15 alt="Previous Topic" border="0" align="absmiddle" hspace="6"></a><b><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream">&nbsp;Topic&nbsp;</font></b><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=8263&Topic_Title=Looking+for+Discussion+Board+software&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_next.gif" height=15 width=15 alt="Next Topic" border="0" align="absmiddle" hspace="6"></a></font></b></td>
      ...
      <tr>
		...
		<a href="pop_profile.asp?mode=display&id=3475">
        	
		<font color="white" face="Verdana, Arial, Helvetica" size="2"><b>BooyeaRZ</a>
        </b></font>
        ...
        <br><font color="white" face="Verdana, Arial, Helvetica" size="1"><small>6 Posts</small></font></td>
        <td bgcolor="dimgray" colspan="2" ><img src="icon_posticon.gif" border="0" hspace="3"><font color="white" face="Verdana, Arial, Helvetica" size="1">Posted&nbsp;-&nbsp;12/21/2001&nbsp;:&nbsp; 21:45:19</font>

        
		&nbsp;<a href="pop_profile.asp?mode=display&id=3475"><img src="icon_profile.gif" height=15 width=15 alt="Show Profile" border="0" align="absmiddle" hspace="6"></a>
        
			&nbsp;<a href="JavaScript:openWindow('pop_mail.asp?id=3475')"><img src="icon_email.gif" height=15 width=15 alt="Email Poster" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="post.asp?method=TopicQuote&TOPIC_ID=8898&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=UPDATE+ALL+WEAPONS+ARMOR+ETC%2E"><img src="icon_reply_topic.gif" height=15 width=15 alt="Reply with Quote" border="0" align="absmiddle" hspace="6"></a>

        <hr noshade size="1">
        
        <font color="white" face="Verdana, Arial, Helvetica" size="2">This site could be the MOHTER of all Necro sites, all it needs is updating and like castersrealm a way too profile the necros gear. I have all kinds of gear that this site dosent even list. Plz do this cause then I can stop drinking and lay off the ludes!<BR>Baron Booyea level 60 Warlock<BR><a href="http://www.Ascendingdawn.com" target="_blank">www.Ascendingdawn.com</a></P><P><BR> </font></td>
      </tr>
