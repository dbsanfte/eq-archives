...
<table border="0" width="95%">
  <tr>
	...
	<img src="icon_blank.gif" height=15 width=15 border="0"><img src="icon_bar.gif" height=15 width=15 border="0"><img src="icon_folder_open_topic.gif" height=15 width=15 border="0">&nbsp;Luclin Forums
    </font></td>
    ...
    <a href="post.asp?method=Reply&TOPIC_ID=8469&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Luclin+Forums"><img src="icon_reply_topic.gif" height=15 width=15 border=0></a>&nbsp;<a href="post.asp?method=Reply&TOPIC_ID=8469&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Luclin+Forums">Reply to Topic</a>
  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="4">
      <tr>
        ...
        <td align="center" bgcolor="slategray" width="100%" ><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream"><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=8263&Topic_Title=Looking+for+Discussion+Board+software&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_prev.gif" height=15 width=15 alt="Previous Topic" border="0" align="absmiddle" hspace="6"></a><b><b><font face="Verdana, Arial, Helvetica" size="2" color="mintcream">&nbsp;Topic&nbsp;</font></b><a href=topic.asp?cat_id=5&FORUM_ID=12&TOPIC_ID=8460&Topic_Title=Something+useful+we+can+steal&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom><img src="icon_topic_next.gif" height=15 width=15 alt="Next Topic" border="0" align="absmiddle" hspace="6"></a></font></b></td>
      ...
      <tr>
		...
		<a href="pop_profile.asp?mode=display&id=2482">
        	
		<font color="white" face="Verdana, Arial, Helvetica" size="2"><b>Brujo Cuatlique</a>
        </b></font>
        ...
        <td bgcolor="dimgray" colspan="2" ><img src="icon_posticon.gif" border="0" hspace="3"><font color="white" face="Verdana, Arial, Helvetica" size="1">Posted&nbsp;-&nbsp;12/06/2001&nbsp;:&nbsp; 08:19:17</font>

        
		&nbsp;<a href="pop_profile.asp?mode=display&id=2482"><img src="icon_profile.gif" height=15 width=15 alt="Show Profile" border="0" align="absmiddle" hspace="6"></a>
        
			&nbsp;<a href="JavaScript:openWindow('pop_mail.asp?id=2482')"><img src="icon_email.gif" height=15 width=15 alt="Email Poster" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="JavaScript:openWindow('pop_messengers.asp?mode=ICQ&ICQ=123669838&M_NAME=Brujo Cuatlique')"><img src="http://online.mirabilis.com/scripts/online.dll?icq=123669838&img=5" height=15 width=15 alt="Send Brujo Cuatlique an ICQ Message" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="JavaScript:openWindow('http://edit.yahoo.com/config/send_webmesg?.target=nseads&.src=pg')"><img src="icon_yahoo.gif" height=15 width=15 alt="Send Brujo Cuatlique a Yahoo! Message" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="JavaScript:openWindow('pop_messengers.asp?mode=AIM&AIM=nscotteads&M_NAME=Brujo Cuatlique')"><img src="icon_aim.gif" height=15 width=15 alt="Send Brujo Cuatlique an instant message" border="0" align="absmiddle" hspace="6"></a>

        &nbsp;<a href="post.asp?method=TopicQuote&TOPIC_ID=8469&FORUM_ID=12&CAT_ID=5&Forum_Title=Ideas+for+Necro%2EEqclasses%2Ecom&Topic_Title=Luclin+Forums"><img src="icon_reply_topic.gif" height=15 width=15 alt="Reply with Quote" border="0" align="absmiddle" hspace="6"></a>

        <hr noshade size="1">
        
        <font color="white" face="Verdana, Arial, Helvetica" size="2">Preferably Separated into the following Sub Forums</P><P>Alternate Advancement<BR>Spells<BR>Content - Zones, MOBs, Items, Strategies</P><P>The general forum is really getting overworked at the moment.</P><P>Brujo Cuatlique<BR>58th Defiler<BR>Dark Advocates<BR>Test Server<BR><img src="http://www.darkadvocates.org/brujosig.jpg" border=0></font></td>
      </tr>
