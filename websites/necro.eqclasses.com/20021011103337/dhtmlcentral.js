...
oM.makeMenu('m10','','Registry','characterlist.asp');
oM.makeMenu('m11','m10','Registry Listing','characterlist.asp');
oM.makeMenu('m12','m10','Registry Search','charactersearch.asp');
oM.makeMenu('m13','m10','Add an Entry','characteradd.asp');
