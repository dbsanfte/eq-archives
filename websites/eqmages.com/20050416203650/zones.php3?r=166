...
<TITLE>EverQuest Zone Maps and Information
</TITLE>
</HEAD>
...
<img src='img/eqmages_zones_header.gif'><br><br>




<form action='zones.php3'>Part zonename: <input type='text' name='zone' size='10'> <input type='submit' value='Search'></form><br></center>
