...
<TITLE>EverQuest Magician Quest Guides</TITLE>
</HEAD>
...
<img src='img/eqmages_quests_header.gif'><br><br>




<form>
View by Level: <input type='text' size='2' name='reqlvl' value=65><input type='submit' value='Go' action='quest.php3'></form><br><br>

 Lvls 24 - 65. <a href='index2.php3?page=earthboots'>Earthen Boots</a> (<i>Rating: 5.333</i>)<br><br>Lvls 24 - 65. <a href='index2.php3?page=qnsbdge'>Qeynos Badge of Nobility Quests</a> (<i>Rating: 5.5</i>)<br><br>Lvls 55 - 65. <a href='index2.php3?page=poparmour'>Planes of Power Quested Armors</a> (<i>Rating: 7.333</i>)<br><br>Lvls 4 - 49. <a href='index2.php3?page=lowfocus'>Low level pet focus</a> (<i>Rating: 8.258</i>)<br><br>Lvls 20 - 65. <a href='index2.php3?page=zommbrac'>Instaclicky Eye of Zomm</a> (<i>Rating: 8.001</i>)<br><br>Lvls 46 - 65. <a href='index2.php3?page=tacticsflg'>Plane of Tactics group flag quest</a> (<i>Rating: 7.667</i>)<br><br>Lvls 40 - 65. <a href='index2.php3?page=thurgqst'>Thurgadin Quested Armours</a> (<i>Rating: 1.5</i>)<br><br>Lvls 46 - 65. <a href='index2.php3?page=kaelqst'>Kael Quested Armours</a> (<i>Rating: Not Rated</i>)<br><br>Lvls 46 - 65. <a href='index2.php3?page=codkey'>Bangle of Disease (Instaclick +40 DR, and key to CoD)</a> (<i>Rating: 7.833</i>)<br><br>Lvls 46 - 65. <a href='index2.php3?page=skysqst'>SkyShrine Quested Armours</a> (<i>Rating: 7</i>)<br><br>Lvls 56 - 65. <a href='index2.php3?page=godarm'>Unsolved: GoD Quest Armors</a> (<i>Rating: 7</i>)<br><br>Lvls 40 - 65. <a href='index2.php3?page=whtdrgnsc'>White Dragonscale Cloak</a> (<i>Rating: 5</i>)<br><br><br><br>

<b>We need your guides and advice!</b> - Write a hunting/quest guide for fellow mages, just email it to us at <a href="mailto:hunting@eqmages.com">hunting@EQMages.com</a>. Please include what levels it would be appropiate for.<br><br><br><br>
