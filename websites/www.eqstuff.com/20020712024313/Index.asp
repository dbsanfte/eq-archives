...
<!--Time Start: 7/11/2002 10:48:07 PM -->
...
<table align="left" valign="top" cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
			...
			<table cellpadding="3">
				<tr>
					<td class="top">
						...
						<input type="text" name="KeyWords" style="width: 100px;">&nbsp;<input type="button" onClick="javascript:VerifyKeyWords()" value="Go" id="button1" name="button1">
						<br>
						<br>
						</form>
					</td>
		...
		<td valign="top" align="center" valign="top">
			...
			<!--Time Finish: 7/11/2002 10:48:07 PM -->
