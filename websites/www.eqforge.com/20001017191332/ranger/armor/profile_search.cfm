<html>
<head>
<title>the ranger's glade: Armor</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">



<link rel="stylesheet" href="/ranger/images/ranger.css">
</head>

<body bgcolor="#FFFFFF" marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" link="#666633" vlink="#666633" alink="#FFFFCC">
  ...
  <tr>
    ...
    <td align="left" valign="middle"> 
      <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><a href="http://www.eqforge.com/cgi-bin/Ultimate.cgi?action=intro&amp;category=10"><img src="/ranger/includes/forums.gif" width="71" height="20" border="0" alt="forums"></a></td>
  ...
  <tr valign="top" align="center"> 
    <td> 
      <form action="profile_summary.cfm?ordertype=ArmName" method="POST">
          ...
          <tr>
            <td height="62"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr align="center" valign="middle" bgcolor="#666633"> 
        ...
        <p><font size="2" face="Arial, Helvetica, sans-serif"><a href="../guides/bob-main.html">Best 
          of the Best Armor Guide</a><br>
          </font></p>
        <p><font size="2" face="Arial, Helvetica, sans-serif"><a href="profile_all.cfm?ordertype=ArmName">View 
          ALL Armor</a></font></p>
