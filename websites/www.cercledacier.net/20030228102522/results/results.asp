...
<head>
	...
	<script language="javascript">
		function ProcessURL(strService, strClickURL, strSiteURL, strDFactor)
		{
			...
			document.CollectInfo.ClientIPAddress.value = "209.237.238.160"
...
<table border="0" width="100%" cellpadding="4" cellspacing="0" valign="top">
	<tr>
		<td width="85%" align="left" valign="top">
			...
			<table width="75%" cellspacing="0" cellpadding="3" border="0" valign="top">
				<tr>
					<td height="25">
						<font size="2" color="6B6D6B"><b>Web Search</b></font>
					</td>
				</tr>
				<tr>
					<td valign="top" width="75%">
						<table align="left" border="0" cellspacing="0"></table>
...
<!-- FindWhat: http://netster.xmlsearch.findwhat.com/bin/findwhat.dll?getresults&base=&dc=22&aff_id=47057&ip_addr=209.237.238.160&df=1&mt= -->
<!-- Google: http://www.google.com:80/search?q=&num=10&client=netster&output=xml_no_dtd&adtest=off&ip=209.237.238.160&useragent=ia%5Farchiver&ie=utf8&oe=utf8&adsafe=off&spelling=suggestion+ -->
<!-- MyGeek: http://xmlsearch.mygeek.com/feed.jsp?partnerid=98531&pagesize=7&adultfilter=off&query=&ip=209.237.238.160 -->
