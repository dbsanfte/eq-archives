...
<li><a href=top.php>Top 10</a><p></p></td>
	...
	<br>
		...
		<td align=right>
			...
			<tr>
			<td width=10></td>
			<td class=ctnegro><br><font size=1><center>Pages vues depuis <br>2001 : <b>447395</b></center></font><hr width=80%>
...
<font size=4><b>Soumettre un Article</b><font size=2><p><FORM action="submit.php" method=post name=adminForm><b>Votre nom</b>  <font size=2>[ <a href="user.php">Nouvel Utilisateur</a> ]</font>        <P><B>Títre</B>
        (Faites simple !)<BR>
        <input class=textbox type="text" NAME="subject" SIZE=55 maxlength=80><BR><FONT size=2>(Mais ne titrez pas -un article-, ou -à lire-,...)</FONT>
        <BR>
        <p><b>Sujet</b> <SELECT class=textbox NAME=topic>
...
<option  value="54">sortileges</option>
<option  value="51">Techniques de jeu</option>
</select><P><B>Texte d'introduction</B> (Les spécialistes peuvent utiliser du HTML, mais attention aux erreurs !)<BR><TEXTAREA class=textbox wrap=virtual cols=40 rows=12 name=story></TEXTAREA><P><B>Texte complet</B></br><TEXTAREA class=textbox wrap=virtual cols=40 rows=12 name=bodytext></TEXTAREA>        <br><FONT size=1>&nbsp;(Avez-vous tout verifié ?)
        <br><br><INPUT type=submit name=op value="Prévisualiser"> -
        Vous devez prévisualiser avant de pouvoir envoyer</font></FORM></td></tr></table></td></tr></table>
