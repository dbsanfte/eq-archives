...
var subM = new ItemStyle(22, 0, '', 15, 3, '#6692C1', '#003162', 'lowText', 'highText', 'itemBorder', 'itemBorder', 90, 90, 'hand', 'default');
...
startMenu('mLinks', true, -15, 23, 170, subM);
addItem('<--- Class Communities', 'mClass', 'sm:');
addItem('<--- Server Communities', 'mServer', 'sm:');
addItem('<--- Spoiler Sites', 'mSpoiler', 'sm:');
addItem(':: Mortalis Loot System', 'http://loot.mortalis.com','').onclick='mainDiv.load("http://loot.mortalis.com/")'; 
...
addItem('EQ Atlas', 'http://www.eqatlas.com', 'window.open("http://www.eqatlas.com")');
