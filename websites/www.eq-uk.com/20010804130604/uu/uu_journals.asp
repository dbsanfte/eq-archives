...
<html>
<head>
	<title>Unseen University Journals</title>
	  ...
	  <!-- MAIN CONTENT START -->
			<script>
				<!--
					...
					{
						window.open("uu_journal_add.asp","JournalAdd","top=60,left=60,width=400,height=300,menubars=0,scrollbars=yes");
					}
					
					function viewEntry(id)
					{
						window.open("uu_journal_view.asp?jid="+id,"JournalView","top=60,left=60,width=400,height=300,menubars=0,scrollbars=yes");
					}
				//-->
			</script>
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
          <p class="headline" align="center">Unseen University Journals</p>
          ...
          <p>
						...
						<table width="100%">
							...
							<tr>
								<td>Ickle Dorff</td>
								<td><a href="javascript:viewEntry('4');">Adventures in Lake of Ill Omen</a></td>
								<td>Thursday, February 08, 2001</td>
							</tr>
								
							<tr>
								<td>Cadfiel</td>
								<td><a href="javascript:viewEntry('5');">Cadfiels Epic</a></td>
								<td>Wednesday, February 28, 2001</td>
							</tr>
								
							<tr>
								<td>Bodi Kibadachi</td>
								<td><a href="javascript:viewEntry('6');">Bodi's Adventures, levels 1 to 17</a></td>
								<td>Wednesday, June 13, 2001</td>
							</tr>
								
							<tr>
								<td>Bodi Kibadachi</td>
								<td><a href="javascript:viewEntry('7');">Bodi's Adventures Part 2</a></td>
								<td>Wednesday, June 13, 2001</td>
							</tr>
								
							<tr>
								<td>Bodi Kibadachi</td>
								<td><a href="javascript:viewEntry('8');">Bodi's Adventures Part 3</a></td>
								<td>Wednesday, June 13, 2001</td>
							</tr>
								
							<tr>
								<td>Bodi Kibadachi</td>
								<td><a href="javascript:viewEntry('9');">Bodi's Adventures Part 4</a></td>
								<td>Wednesday, June 13, 2001</td>
							</tr>
