...
<DIV ALIGN="center">
  <TABLE WIDTH="600">
<TR>
	  <TD>If you are interested in becoming a member of the Fires Within guild 
        please fill out the application below. Keep in mind you may not hear a 
        response from us as at times we are only inviting certain class types. 
        If we are interested you will be contacted.<BR> <B><U>Minimum requirements to join are as follows.</U></B><BR>
Must be of lvl 56 or greater<BR>
		Must have a minimum of 60 on resists <BR>
		Must have a Cobalt Scar key<BR>
		*note all resists must be at least 60 but do not have to be 60 all at the same time.<BR>
		Twinks or other characters in other guilds are not permitted If you choose 
		to join this guild all of your characters must join<BR>
...
<INPUT TYPE="Hidden" NAME="IP" VALUE="209.247.40.98">
<TABLE>
<TR>
