...
NEW 02/12/2020:
EQCaster has a csv export function, so I extracted all the spdats to CSVs and merged them into a single .xlsx sheet with a new column for SPDAT date. This allows for checking differences between patches much more easily. I included some sheets with the differences between Kunark Beta (March 2000) and Kunark Launch (April 2000) as an example (and to help P99).
